[缩略图](https://zh.wikipedia.org/wiki/File:Koenigs-theorem-graph.svg "fig:缩略图")的最大[匹配](../Page/匹配_\(图论\).md "wikilink")（蓝）和最小覆盖（红）的基数都等于6.\]\] 在[图论](../Page/图论.md "wikilink")中，**柯尼希定理（英：Kőnig's Theorem）**，由提出：

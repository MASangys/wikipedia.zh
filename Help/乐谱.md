...
LilyPond代码衍生自[Latex](https://zh.wikipedia.org/wiki/Latex "wikilink")，大小写敏感，无视连续空格和换行。代码必须用围起来。音符必须放在大括号里面 `{...}`。百分比号 `%` 后的代码视为[注释](https://zh.wikipedia.org/wiki/注释 "wikilink")。

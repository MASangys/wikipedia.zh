...
您使用維基百科的標記所編輯的文章，在被閱覽時會透過名為[MediaWiki的軟體](../Page/MediaWiki.md "wikilink")，轉換成[網頁瀏覽器能夠辨識的形式](../Page/網頁瀏覽器.md "wikilink")**[XHTML](../Page/XHTML.md "wikilink")**。此依標記的方式可能無法產生理想的XHTML格式。本條目頁面在此舉出被推薦的範例和非推薦的範例，來加以解說列表寫法的標記方式。
...
具有[視覺障礙的人使用](../Page/視覺障礙.md "wikilink")[聲音讀出瀏覽器來閱覽維基百科](../Page/聲音讀出瀏覽器.md "wikilink")。這時若遇到上述的[例2會怎麼讀出呢](../Page/#例2.md "wikilink")。
...
如何？明明沒有讀出定義詞彙卻突然跑出個「剛剛的定義詞彙」，意思說不通。那麼在[正確範例中又是如何呢](../Page/#定義的列表寫法.md "wikilink")。
...
另外還有傳輸資料量的問題。請將[例1與](../Page/#例1.md "wikilink")[例2所產生的XHTML](../Page/#例2.md "wikilink")，和[正確範例的情況做比較](../Page/#定義的列表寫法.md "wikilink")。變得更加簡潔了。只有一兩個雖然沒有太大差別在，當重複10次20次時就會出現明顯的差異。
...
像這樣在用語後面換列結果和[被推薦的範例是完全一樣的](../Page/#被推薦的範例.md "wikilink")。說明部分變長的時候用這種方式編輯應該會比較容易觀看原始檔。
...
## 維基百科特定幫助
  ...
  - and  - Dots and bullets for horizontal link lists, such as in
    [navboxes](../Page/Template:Navbox.md "wikilink"), which look like
    lists, but do not use HTML list mark-up.

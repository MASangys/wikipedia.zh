...
截至2019年4月24日，[GFW会对所有语言版本的维基百科](https://zh.wikipedia.org/wiki/GFW "wikilink")（所有以`.wikipedia.org`结尾的[域名](../Page/域名.md "wikilink")）进行[DNS污染和基于](../Page/域名服务器缓存污染.md "wikilink")[SNI检测的](../Page/服务器名称指示.md "wikilink")[TCP连接重置](../Page/TCP重置攻击.md "wikilink")。对此您可以在设置修正域名解析（具体方法参见下文）后先访问未被封锁的维基媒体基金会旗下的其他项目（例如[元维基或](https://zh.wikipedia.org/wiki/元维基 "wikilink")[维基数据](../Page/维基数据.md "wikilink")）再切换至维基百科，即可在接下来的一段时间内正常访问。如果上述操作无效，可以等待几分钟后重试，通常即可成功连接。您也可以[使用代理服务访问维基百科以获得更加稳定的体验](https://zh.wikipedia.org/wiki/#代理服务器 "wikilink")。

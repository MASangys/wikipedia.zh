...
day}}[UTC](https://zh.wikipedia.org/wiki/UTC "wikilink")）之间，因为该参数代表的是编者在维基百科查看网络来源进行校验的声明。由于编者可能位于早于[协调世界时](../Page/协调世界时.md "wikilink")一天的地区，所以多加一天是可以接受的。
...
当[引文格式1和](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")[引文格式2模板使用](https://zh.wikipedia.org/wiki/Help:引文格式2 "wikilink")时，其会校验[ISMN值是否为恰当的长度](https://zh.wikipedia.org/wiki/ISMN "wikilink")（13位），是否使用了恰当的可选分隔符（单空格或连字符），并根据ISMN规范校验末尾的[校验码](https://zh.wikipedia.org/wiki/校验码 "wikilink")。因为整个值包含于[COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")[元数据](../Page/元数据.md "wikilink")的引用中，所以在字段中只允许存在一个ISMN值。参见[:en:Wikipedia:COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")。若ISBN值超过一个或值内含有非ISBN字符，则会造成COinS元数据损坏。
...
当[引文格式1和](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")[引文格式2模板使用](https://zh.wikipedia.org/wiki/Help:引文格式2 "wikilink")时，其会校验[ISSN值是否为恰当的长度](https://zh.wikipedia.org/wiki/ISSN "wikilink")（8位），并根据ISSN规范校验末尾的[校验码](https://zh.wikipedia.org/wiki/校验码 "wikilink")。因为整个值包含于[COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")[元数据](../Page/元数据.md "wikilink")的引用中，所以在字段中只允许存在一个ISSN值。参见[:en:Wikipedia:COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")。ISSN通常显示为由连字符分隔的两个4位数字。
...
当列于[PMID](../Page/PMID.md "wikilink")页的一个姓名含有一个小写的贵族前缀时偶尔也会导致错误。如将“Magnus

...
给赋值或移除即可解决该问题。编者应该尝试确定为什么该引用的缺少。例如，该引文可能从未存在、或该因链接到一个侵犯版权的网站而已被删除（见[维基百科:版权信息\#链接到有版权的材料](https://zh.wikipedia.org/wiki/维基百科:版权信息#链接到有版权的材料 "wikilink")），或该因已失效而被（错误的）删除。若该从未存在或因侵犯版权而已被删除，则应将移除。若该因已失效而被删除，则应恢复该，并尝试修复或替换网址（如聯絡[網站管理員或使用](../Page/網站管理員.md "wikilink")[網路存檔服務](https://zh.wikipedia.org/wiki/網路存檔 "wikilink")，见[维基百科:失效链接](https://zh.wikipedia.org/wiki/维基百科:失效链接 "wikilink")）。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有访问日期但无网址的引用的页面 |
Category:含有访问日期但无网址的引用的页面 |
[:Category:含有访问日期但无网址的引用的页面](https://zh.wikipedia.org/wiki/Category:含有访问日期但无网址的引用的页面 "wikilink")}}。\[1\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有存档网址错误的引用的页面 |
Category:含有存档网址错误的引用的页面 |
[:Category:含有存档网址错误的引用的页面](https://zh.wikipedia.org/wiki/Category:含有存档网址错误的引用的页面 "wikilink")
}}。\[4\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：arXiv |
Category:引文格式1错误：arXiv |
[:Category:引文格式1错误：arXiv](https://zh.wikipedia.org/wiki/Category:引文格式1错误：arXiv "wikilink")
}}。\[8\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：章节参数被忽略 |
Category:引文格式1错误：章节参数被忽略 |
[:Category:引文格式1错误：章节参数被忽略](https://zh.wikipedia.org/wiki/Category:引文格式1错误：章节参数被忽略 "wikilink")}}。\[9\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：arXiv|
Category:引文格式1错误：arXiv|
[:Category:引文格式1错误：arXiv](https://zh.wikipedia.org/wiki/Category:引文格式1错误：arXiv "wikilink")}}。\[11\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：ASIN| Category:引文格式1错误：ASIN
|
[:Category:引文格式1错误：ASIN](https://zh.wikipedia.org/wiki/Category:引文格式1错误：ASIN "wikilink")}}。\[12\]
...
引文格式1/2模板中的使用的未来日期限于当前日期+1年；也就是说，若当前为{{\#time:Y}}，在模板中使用可{{\#time:Y|now
+1 year}}，不可使用{{\#time:Y|now +2 year}}。

1582年以前的日期会被视为[儒略曆日期](../Page/儒略曆.md "wikilink")，1582年以后的日期会被视为[公历日期](https://zh.wikipedia.org/wiki/公历 "wikilink")。儒略曆在一些地方一直被沿用至约1923年。有三个儒略曆日期只存在于儒略曆中，分别为1700年、1800年及1900年的2月29日，使用这三个日期会出现错误信息，因为在公历中这三年不是闰年。

会对访问日期（）进行校验，以确认其位于2001年1月15日（维基百科成立日期）至今年加一天（目前{{\#time:Y"年"Fj"日"|today+1
day}}[UTC](https://zh.wikipedia.org/wiki/UTC "wikilink")）之间，因为该参数代表的是编者在维基百科查看网络来源进行校验的声明。由于编者可能位于早于[协调世界时一天的地区](../Page/协调世界时.md "wikilink")，所以多加一天是可以接受的。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：日期 | Category:引文格式1错误：日期 |
[:Category:引文格式1错误：日期](https://zh.wikipedia.org/wiki/Category:引文格式1错误：日期 "wikilink")}}。\[13\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：DOI | Category:引文格式1错误：DOI |
[:Category:引文格式1错误：DOI](https://zh.wikipedia.org/wiki/Category:引文格式1错误：DOI "wikilink")}}。\[14\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有ISBN错误的引用的页面 |
Category:含有ISBN错误的引用的页面 |
[:Category:含有ISBN错误的引用的页面](https://zh.wikipedia.org/wiki/Category:含有ISBN错误的引用的页面 "wikilink")}}。\[15\]
...
当[引文格式1和](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")[引文格式2模板使用](https://zh.wikipedia.org/wiki/Help:引文格式2 "wikilink")时，其会校验[ISMN值是否为恰当的长度](https://zh.wikipedia.org/wiki/ISMN "wikilink")（13位），是否使用了恰当的可选分隔符（单空格或连字符），并根据ISMN规范校验末尾的[校验码](https://zh.wikipedia.org/wiki/校验码 "wikilink")。因为整个值包含于[COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")[元数据的引用中](../Page/元数据.md "wikilink")，所以在字段中只允许存在一个ISMN值。参见[:en:Wikipedia:COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")。若ISBN值超过一个或值内含有非ISBN字符，则会造成COinS元数据损坏。

确保值的正确，且只存在一个ISMN，长度为13位，使用了恰当的可选分隔符，并不包含其他字符，即可解决该问题。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：ISMN | Category:引文格式1错误：ISMN
|
[:Category:引文格式1错误：ISMN](https://zh.wikipedia.org/wiki/Category:引文格式1错误：ISMN "wikilink")}}。\[16\]
...
当[引文格式1和](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")[引文格式2模板使用](https://zh.wikipedia.org/wiki/Help:引文格式2 "wikilink")时，其会校验[ISSN值是否为恰当的长度](https://zh.wikipedia.org/wiki/ISSN "wikilink")（8位），并根据ISSN规范校验末尾的[校验码](https://zh.wikipedia.org/wiki/校验码 "wikilink")。因为整个值包含于[COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")[元数据的引用中](../Page/元数据.md "wikilink")，所以在字段中只允许存在一个ISSN值。参见[:en:Wikipedia:COinS](https://zh.wikipedia.org/wiki/:en:Wikipedia:COinS "wikilink")。ISSN通常显示为由连字符分隔的两个4位数字。

确保值的正确，且只存在一个ISMN，不包含其他字符（可用字符包括0-9、X及-），即可解决该问题。若校验码为小写“x”，则应改为大写“X”。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：ISSN | Category:引文格式1错误：ISSN
|
[:Category:引文格式1错误：ISSN](https://zh.wikipedia.org/wiki/Category:引文格式1错误：ISSN "wikilink")}}。\[17\]
...
参数为[美国国会图书馆控制号](https://zh.wikipedia.org/wiki/美国国会图书馆控制号 "wikilink")。当[引文格式1和](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")[引文格式2模板使用](https://zh.wikipedia.org/wiki/Help:引文格式2 "wikilink")时，其会校验LCCN值是否为恰当的长度（8至12位），并具有恰当的初始码。LCCN值的长度决定了初始三个字符的形式；后八位总为数字。\[18\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：LCCN | Category:引文格式1错误：LCCN
|
[:Category:引文格式1错误：LCCN](https://zh.wikipedia.org/wiki/Category:引文格式1错误：LCCN "wikilink")}}。\[19\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：message-id |
Category:引文格式1错误：message-id |
[:Category:引文格式1错误：message-id](https://zh.wikipedia.org/wiki/Category:引文格式1错误：message-id "wikilink")}}。\[21\]
...
为[开放图书馆识别码参数](../Page/开放图书馆.md "wikilink")。模板会校验最后一个字符是否为A（作者）、M（书名）或W（作品名）。此外不进行进一步的校验。

确保值正确即可解决该问题。不要在值中填入“OL”。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：OL | Category:引文格式1错误：OL |
[:Category:引文格式1错误：OL](https://zh.wikipedia.org/wiki/Category:引文格式1错误：OL "wikilink")}}。\[22\]
...
参数值只能为维基百科条目名。[引文格式1会校验上述参数值是否存在](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")[Wiki标记语言及](../Page/Wiki标记语言.md "wikilink")[URI格式](../Page/统一资源标志符.md "wikilink")（<http://>、<https://>、协议相对字符`//`等）。
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：参数链接 | Category:引文格式1错误：参数链接
|
[:Category:引文格式1错误：参数链接](https://zh.wikipedia.org/wiki/Category:引文格式1错误：参数链接 "wikilink")}}。\[23\]
...
为[美国公共医学中心](https://zh.wikipedia.org/wiki/美国公共医学中心 "wikilink")（PubMed
Central）识别码参数。美国公共医学中心从1开始编号。[引文格式1会校验PMC值大于](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")0且小于600万，且仅为数字。此外不进行进一步校验。

确保值正确，且不含其他文本、标点符号及字符，即可解决该问题。不要在值中填入“PMC”。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：PMC | Category:引文格式1错误：PMC |
[:Category:引文格式1错误：PMC](https://zh.wikipedia.org/wiki/Category:引文格式1错误：PMC "wikilink")}}。\[24\]
...
为[PubMed识别码参数](../Page/PubMed.md "wikilink")。[引文格式1会校验PMID值](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")，以确认其不含标点符号或空格，并大于0且小于3000万，且仅为数字。此外不进行进一步校验。

确保值正确即可解决该问题。如果发现某处PMID以PMC开头，请将其移至下。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：PMID | Category:引文格式1错误：PMID
|
[:Category:引文格式1错误：PMID](https://zh.wikipedia.org/wiki/Category:引文格式1错误：PMID "wikilink")}}。\[25\]
...
模板会校验URL以确保其不包含空格。URL可为协议相对（以`//`开头）。若URL不含空格且非协议相对，则该格式必须符合RFC
3986。\[26\]
...
模板会校验顶级及二级域名的格式是否恰当。一般而言，顶级域名必须包含两个或以上的字母；二级域名必须包含两个或以上的字母、数字或连字符（第一个和最后一个字符必须是字母或数字）。支持以下单字母的二级域名：
  ...
  -
    ...
    [.com顶级域名的某些字母](../Page/.com.md "wikilink")（q、x、z）
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有网址格式错误的引用的页面 |
Category:含有网址格式错误的引用的页面 |
[:Category:含有网址格式错误的引用的页面](https://zh.wikipedia.org/wiki/Category:含有网址格式错误的引用的页面 "wikilink")}}。\[27\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有过时参数的引用的页面‎ |
Category:含有过时参数的引用的页面 |
[:Category:含有过时参数的引用的页面](https://zh.wikipedia.org/wiki/Category:含有过时参数的引用的页面 "wikilink")}}。\[28\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：无主作者的合作者 |
Category:引文格式1错误：无主作者的合作者 |
[:Category:引文格式1错误：无主作者的合作者](https://zh.wikipedia.org/wiki/Category:引文格式1错误：无主作者的合作者 "wikilink")}}。\[29\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：合作者 | Category:引文格式1错误：合作者 |
[:Category:引文格式1错误：合作者](https://zh.wikipedia.org/wiki/Category:引文格式1错误：合作者 "wikilink")}}。\[30\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：合作者 | Category:引文格式1错误：合作者 |
[:Category:引文格式1错误：合作者](https://zh.wikipedia.org/wiki/Category:引文格式1错误：合作者 "wikilink")}}。\[31\]
...
当引用的来源含有超过4位编者时，可将剩下的编者加入引文，或设置为`3`或较小的值，将编者列表截断。若恰好有4位编者，则设置为`4`或更大的值以显示所有的编者，如此则不再会显示“*et
al.*（或“等.”）”。

在引入[Lua之前](https://zh.wikipedia.org/wiki/WP:Lua "wikilink")，引文格式1模板不支持显示4个以上的编者名。如果指定了4个（或更多）编者名，则模板只会显示3个编者名并在之后加入“*et
al.*（或“等.”）”来表示该列表已被截断。部分编者使用这样的方法来制作“*et al.*”（或“等.”）标签。例如：

基于Lua的引用模板可以容纳任意数量的编者名参数。基于Lua的引用模板也能使用参数显示“*et al.*（或“等.”）”标签。

旧式模板最多只支持4个编者名，所以基于Lua的引用模板不能判断维基百科编者建立的引文是否恰好有4位编者。当引文中恰好有4个编者但没有使用时即会出现该错误。为了保留旧式引文的形式，基于Lua的引用模板在第4位编者名后仍会显示“*et
al.*（或“等.”）”标签。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有旧式缩略标签的引用的页面 |
Category:含有旧式缩略标签的引用的页面 |
[:Category:含有旧式缩略标签的引用的页面](https://zh.wikipedia.org/wiki/Category:含有旧式缩略标签的引用的页面 "wikilink")}}。\[32\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有空引用的页面 | Category:含有空引用的页面 |
[:Category:含有空引用的页面](https://zh.wikipedia.org/wiki/Category:含有空引用的页面 "wikilink")}}。\[33\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：外部链接 | Category:引文格式1错误：外部链接
|
[:Category:引文格式1错误：外部链接](https://zh.wikipedia.org/wiki/Category:引文格式1错误：外部链接 "wikilink")}}。\[34\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：缺少作者或编者 |
Category:引文格式1错误：缺少作者或编者 |
[:Category:引文格式1错误：缺少作者或编者](https://zh.wikipedia.org/wiki/Category:引文格式1错误：缺少作者或编者 "wikilink")}}。\[35\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有格式却不含网址的引用的页面 |
Category:含有格式却不含网址的引用的页面 |
[:Category:含有格式却不含网址的引用的页面](https://zh.wikipedia.org/wiki/Category:含有格式却不含网址的引用的页面 "wikilink")}}。\[36\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：无效参数值 |
Category:引文格式1错误：无效参数值 |
[:Category:引文格式1错误：无效参数值](https://zh.wikipedia.org/wiki/Category:引文格式1错误：无效参数值 "wikilink")}}。\[37\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | 引文格式1错误：缺少作者或编者| 引文格式1错误：缺少作者或编者 |
[:Category:引文格式1错误：缺少作者或编者](https://zh.wikipedia.org/wiki/Category:引文格式1错误：缺少作者或编者 "wikilink")}}。\[38\]

<section end=missing_name_help_text />

\==缺少或|title{{=}}为空==
存在两种略不相同的错误条件，其均会导致[引文格式1模板出现缺少适当标题的错误信息](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")。不同错误的解决方法不同。
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有裸露网址的引用的页面 | Category:含有裸露网址的引用的页面
|
[:Category:含有裸露网址的引用的页面](https://zh.wikipedia.org/wiki/Category:含有裸露网址的引用的页面 "wikilink")}}。\[39\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有缺少标题的引用的页面 | Category:含有缺少标题的引用的页面
|
[:Category:含有缺少标题的引用的页面](https://zh.wikipedia.org/wiki/Category:含有缺少标题的引用的页面 "wikilink")}}。\[40\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有缺少网址的网站引用的页面‎ |
Category:含有缺少网址的网站引用的页面‎ |
[:Category:含有缺少网址的网站引用的页面‎](https://zh.wikipedia.org/wiki/Category:含有缺少网址的网站引用的页面‎ "wikilink")}}。\[41\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有冗余参数的引用的页面 | Category:含有冗余参数的引用的页面
|
[:Category:含有冗余参数的引用的页面](https://zh.wikipedia.org/wiki/Category:含有冗余参数的引用的页面 "wikilink")}}。\[42\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有未命名参数的引用的页面 |
Category:含有未命名参数的引用的页面 |
[:Category:含有未命名参数的引用的页面](https://zh.wikipedia.org/wiki/Category:含有未命名参数的引用的页面 "wikilink")}}。\[43\]
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：翻译标题 | Category:引文格式1错误：翻译标题
|
[:Category:引文格式1错误：翻译标题](https://zh.wikipedia.org/wiki/Category:引文格式1错误：翻译标题 "wikilink")}}。\[44\]

<section end=trans_missing_title_help_text />

\==<span id="parameter_ignored">已忽略未知参数|xxxx=</span><span id="parameter_ignored_suggest">
</span>==
...
在旧式模板中，其可能只是简单的将包含的信息作为未识别的参数忽略掉。基于[Lua的引文格式](../Page/Lua.md "wikilink")1/2模块则无法忽略未识别的参数。引文是为了正确的标识来源；而不是作为备注或辅助信息的存储库。
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:含有未知参数的引用的页面 | Category:含有未知参数的引用的页面
|
[:Category:含有未知参数的引用的页面](https://zh.wikipedia.org/wiki/Category:含有未知参数的引用的页面 "wikilink")}}。\[45\]
...
<span class="error">不支持的参数使用了arXiv</span>
只可使用于[引文格式1的部分模板参数中](https://zh.wikipedia.org/wiki/Help:引文格式1 "wikilink")。当不支持的参数使用了时即会导致该错误。

删除不支持的参数即可解决该问题。见支持[Template:Cite
arxiv的完整模板参数列表](https://zh.wikipedia.org/wiki/Template:Cite_arxiv "wikilink")。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：arXiv|
Category:引文格式1错误：arXiv |
[:Category:引文格式1错误：arXiv](https://zh.wikipedia.org/wiki/Category:引文格式1错误：arXiv "wikilink")}}。\[46\]
...
<span class="error">网址－维基内链冲突</span>
外部链接的显示内容是由网址控制参数，、等，与标题控制参数，、等整合的结果。标题控制参数可链接至另一维基条目，但若同时存在网址控制参数时则维基内链会被忽略，而链接至外部网站。

如果在标题控制参数中使用部分模板时也会导致该错误。该错误出现于模板产生维基内链时。如在模板中输出了维基内链，這種情況可以通過改爲`{{Cite
web|script-title=ja:日本語タイトル}}`来修复。模板的网址控制参数也可能损坏引用的[COinS元数据](https://zh.wikipedia.org/wiki/WP:COinS "wikilink")。一般情况下，应避免在标题控制参数中使用模板，除非已知其对该模板的影响是完全可见的（如等）。
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：网址－维基内链冲突 |
Category:引文格式1错误：网址－维基内链冲突 |
[:Category:引文格式1错误：网址－维基内链冲突](https://zh.wikipedia.org/wiki/Category:引文格式1错误：网址－维基内链冲突 "wikilink")}}。\[47\]
...
当引文使用时即会导致该错误。[温哥华格式限制作者或编者名由拉丁字母组成](https://zh.wikipedia.org/wiki/温哥华格式 "wikilink")。对于该检测，[Module:Citation/CS1以](https://zh.wikipedia.org/wiki/Module:Citation/CS1 "wikilink")[Unicode拉丁字符集作为定义范围](https://zh.wikipedia.org/wiki/Unicode "wikilink")：
  ...
  -
    ...
    C1 Controls and Latin-1 Supplement\[49\] (00C0–00D6, 00D8–00F6,
    00F8–00FF)
...
当列于[PMID页的一个姓名含有一个小写的贵族前缀时偶尔也会导致错误](../Page/PMID.md "wikilink")。如将“Magnus
von Knebel Doeberitz”列为“Doeberitz Mv”是错误的。该作者名应为。\[52\]
...
同样，出现在PubMed上的中国复姓也如此。如：“Wang Hsien-yu”在PubMed上列为“Wang
Hy”会导致温哥华格式错误。确认该名称正确后将其用双括号包裹即可。

含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：温哥华格式 |
Category:引文格式1错误：温哥华格式 |
[:Category:引文格式1错误：温哥华格式](https://zh.wikipedia.org/wiki/Category:引文格式1错误：温哥华格式 "wikilink")}}。\[55\]
...
<span class="error">参数`|param=`值左起第*n*位存在<字符>字符</span>
当引文参数值含有不可见或不可打印字符时即会导致该错误。[Module:Citation/CS1会检测出含有以下任意字符的参数值](https://zh.wikipedia.org/wiki/Module:Citation/CS1 "wikilink")：
  ...
  -
    ...
    [換行符](../Page/換行.md "wikilink")，U+0010 (LF)
    [回车符](../Page/回车符.md "wikilink")，U+0013 (CR)
    [刪除符](https://zh.wikipedia.org/wiki/刪除符 "wikilink")，U+007F (DEL)
    [C0控制符](https://zh.wikipedia.org/wiki/C0控制符 "wikilink")，U+0000–U+001F
    (NULL–US)
    [C1控制符](https://zh.wikipedia.org/wiki/C1控制符 "wikilink")，U+0080–U+009F
    (XXX–APC)
...
含有该错误的页面会被自动归入{{\#ifeq:  | Category:引文格式1错误：不可见字符 |
Category:引文格式1错误：不可见字符 |
[:Category:引文格式1错误：不可见字符](https://zh.wikipedia.org/wiki/Category:引文格式1错误：不可见字符 "wikilink")}}。\[56\]

...
閱讀這一節的內容要求你有一點點的[HTML和](../Page/HTML.md "wikilink")[CSS基礎知識](https://zh.wikipedia.org/wiki/CSS "wikilink")，透過在原始碼中設定特定的class（[HTML屬性](../Page/HTML.md "wikilink")）值，就可以實現指定版面的可摺疊性，並由[MediaWiki:Common.js中的](https://zh.wikipedia.org/wiki/MediaWiki:Common.js "wikilink")[javascript腳本自動完成相關的](https://zh.wikipedia.org/wiki/javascript "wikilink")[DHTML動作](https://zh.wikipedia.org/wiki/DHTML "wikilink")。

在中文維基百科，**摺疊顯示**應用在很多條目的[導航模板](../Page/WP:导航模板.md "wikilink")、[討論頁面等地方](../Page/WP:TALK.md "wikilink")，透過滑鼠的點擊就可以展開和收縮一些版面，以方便讀者進行導航閱讀。摺疊功能並不是Mediawiki軟體自帶的，是中文維基百科透過[MediaWiki:Common.js](../Page/MediaWiki:Common.js.md "wikilink")、[MediaWiki:Common.css自行維護的界面功能](../Page/MediaWiki:Common.css.md "wikilink")。它的代碼主要維護者是[User:Fdcn](../Page/User:Fdcn.md "wikilink")。

此外，中文維基百科在2011年7月引入了新的折疊效果，其客製性更強，有關詳情參見[\#新摺疊效果](../Page/#新摺疊效果.md "wikilink")。
...
閱讀這一節的內容要求你有一點點的[HTML和](../Page/HTML.md "wikilink")[CSS基礎知識](../Page/CSS.md "wikilink")，透過在原始碼中設定特定的class（[HTML屬性](../Page/HTML.md "wikilink")）值，就可以實現指定版面的可摺疊性，並由[MediaWiki:Common.js中的](../Page/MediaWiki:Common.js.md "wikilink")[javascript腳本自動完成相關的](../Page/javascript.md "wikilink")[DHTML動作](../Page/DHTML.md "wikilink")。
...
### 定義摺疊塊
  ...
  - **div.NavFrame** 或 **table.collapsible**
    ：指示該區域或表格是可折疊的，該值是該元素可以摺疊所必須。我們稱這樣的一個元素為**摺疊塊**。
...
```
  ...
  - **div.collapsed** 或 **table.collapsed**
    ：指示該摺疊塊的初始狀態是已摺疊的，如果沒有設定該值，則摺疊塊的預設初始狀態是展開的。下面只列出div的示例代碼，table的類似。
...
<!-- end list -->
  ...
  - **div.autocollapse** 或 **table.autocollapse**
    ：指示該摺疊塊的初始狀態是否摺疊由該頁面的可摺疊塊數量控制，也可以叫它自動摺疊塊。目前系統定義為如果有2個及以上的摺疊塊，則自動摺疊塊就摺疊，否則自動摺疊塊展開。
...
如果你對摺疊標題的系統自動生成“顯示▲/隱藏▼”的指示不滿意，只需要滿足將你的自訂指示要放在摺疊標題中的**\<span
class="NavToggle"\>自訂指示文字\</span\>**元素裡。
...
自訂摺疊標題的指示→ <span class="NavToggle"> <span class="toggleShow">把我打開</span>
<span class="toggleHide">把我關上</span> </span>

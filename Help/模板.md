...
**注意：**维基系统名字空间的参数名是不同的，它们是`$1, $2, ...`，参见[Help:名字空间](https://zh.wikipedia.org/wiki/Help:名字空间 "wikilink")、[Special:所有消息和](https://zh.wikipedia.org/wiki/Special:所有消息 "wikilink")[MediaWiki:Blockedtext](../Page/MediaWiki:Blockedtext.md "wikilink")。

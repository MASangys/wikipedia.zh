...
新建模板后，请在[Wikipedia:模板消息内添加您新建的模板的信息](https://zh.wikipedia.org/wiki/Wikipedia:模板消息 "wikilink")，并请对模板进行分类。模板分类的方法请参考[:Category:维基百科模板以及](https://zh.wikipedia.org/wiki/Category:维基百科模板 "wikilink")[:Category talk:维基百科模板中的相关内容](https://zh.wikipedia.org/wiki/:Category_talk:维基百科模板 "wikilink")。
...
**注意：**维基系统名字空间的参数名是不同的，它们是`$1, $2, ...`，参见[Help:名字空间](https://zh.wikipedia.org/wiki/Help:名字空间 "wikilink")、[Special:所有消息和](https://zh.wikipedia.org/wiki/Special:所有消息 "wikilink")[MediaWiki:Blockedtext](https://zh.wikipedia.org/wiki/MediaWiki:Blockedtext "wikilink")。

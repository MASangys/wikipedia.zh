...
要显示[婆罗米系文字](https://zh.wikipedia.org/wiki/婆罗米系文字 "wikilink")，从下列的链接下载安装字体：
  ...
  - [悉昙文](https://zh.wikipedia.org/wiki/悉昙文 "wikilink")：[Muktamsiddham](http://mihafont.seesaa.net/article/167209339.html)、[ApDevaSiddham](http://siddham.shikisokuzekuu.net/)（需要 [Graphite](../Page/Graphite.md "wikilink") 技术支持）

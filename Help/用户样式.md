...
所有皮肤都享有（继承）[MediaWiki:Common.css文件中定义的样式](https://zh.wikipedia.org/wiki/MediaWiki:Common.css "wikilink")，其他的样式则依选择的皮肤不同而存放在分离的文件中。例如，中文维基百科中默认的样式为：
  ...
  - 在元维基中则为：
  - <http://meta.wikimedia.org/style/monobook/main.css> 及 [MediaWiki:Monobook.css](https://zh.wikipedia.org/wiki/MediaWiki:Monobook.css "wikilink")
  ...
  - <http://meta.wikimedia.org/style/cologneblue.css> 及 [MediaWiki:Cologneblue.css](https://zh.wikipedia.org/wiki/MediaWiki:Cologneblue.css "wikilink")

登录用户不仅可以设置维基百科参数，还可以通过[Special:Mypage/common.css和](../Page/Special:Mypage/common.css.md "wikilink")[Special:Mypage/common.js实现更强大的自定义](../Page/Special:Mypage/common.js.md "wikilink")。

[common.css里编写](../Page/Special:Mypage/common.css.md "wikilink")[CSS](../Page/CSS.md "wikilink")，可以定制页面的字体、颜色、链接的位置等等。[common.js里编写](../Page/Special:Mypage/common.js.md "wikilink")[JavaScript](../Page/JavaScript.md "wikilink")（JS），可以在网页上增加功能。注意在维基百科上编写的样式表和JS代码都是在[GFDL下公开发布的](../Page/GFDL.md "wikilink")。
...
在用户样式设定的时候，首先要选中一个[皮肤](../Page/meta:Skins.md "wikilink")，然后系统会确定相应的[层叠样式表](../Page/层叠样式表.md "wikilink")（CSS）。用户可针对每个皮肤对字体、颜色等做不同的选择。CSS是用选择器\[[http://www.w3.org/TR/REC-CSS2/selector.html\]来定制的，每个选择器作用的对象包括](http://www.w3.org/TR/REC-CSS2/selector.html%5D来定制的，每个选择器作用的对象包括)[HTML元素](../Page/HTML元素.md "wikilink")、class和id。它们在具体的HTML代码中定义。因此，只要查看HTML源代码，便可知道一个皮肤可以怎么样调整。尤其是那些class和id越多，则变化就越多。

所有皮肤都享有（继承）[MediaWiki:Common.css文件中定义的样式](../Page/MediaWiki:Common.css.md "wikilink")，其他的样式则依选择的皮肤不同而存放在分离的文件中。例如，中文维基百科中默认的样式为：

  - <http://zh.wikipedia.org/style/monobook/main.css> 及
    [:zh:MediaWiki:Monobook.css](../Page/:zh:MediaWiki:Monobook.css.md "wikilink")
  - <http://zh.wikipedia.org/style/wikistandard.css> 及
    [:zh:MediaWiki:Standard.css](../Page/:zh:MediaWiki:Standard.css.md "wikilink")
  - <http://zh.wikipedia.org/style/cologneblue.css> 及
    [:zh:MediaWiki:Cologneblue.css](../Page/:zh:MediaWiki:Cologneblue.css.md "wikilink")（科龙香水蓝）
  - <http://zh.wikipedia.org/style/nostalgia.css> 及
    [:zh:MediaWiki:Nostalgia.css](../Page/:zh:MediaWiki:Nostalgia.css.md "wikilink")（怀旧）
  - 在元维基中则为：
  ...
  - <http://meta.wikimedia.org/style/wikistandard.css> 及
    [MediaWiki:Standard.css](../Page/MediaWiki:Standard.css.md "wikilink")
  - <http://meta.wikimedia.org/style/cologneblue.css> 及
    [MediaWiki:Cologneblue.css](../Page/MediaWiki:Cologneblue.css.md "wikilink")
  - <http://meta.wikimedia.org/style/nostalgia.css> 及
    [MediaWiki:Nostalgia.css](../Page/MediaWiki:Nostalgia.css.md "wikilink")
  - [MediaWiki:Myskin.css](../Page/MediaWiki:Myskin.css.md "wikilink")

放在样式目录的文件是供特定的皮肤使用的，它们在各个维基项目中大致上相同。样式表目录的名字在安装的时候就设置好了，参见[LocalSettings.php\#Stylesheet_Location](../Page/LocalSettings.php#Stylesheet_Location.md "wikilink")。

在vector皮肤中，你可以通过[JavaScript以及](../Page/JavaScript.md "wikilink")[CSS改变](../Page/CSS.md "wikilink")[1](http://zh.wikipedia.org/style/vector/main.css)
及
[:zh:MediaWiki:Vector.css的样式定义](../Page/:zh:MediaWiki:Vector.css.md "wikilink")。然后将这些改变存放在你的用户页子页面[Special:Mypage/vector.css和](../Page/Special:Mypage/vector.css.md "wikilink")[Special:Mypage/vector.js中](../Page/Special:Mypage/vector.js.md "wikilink")。

你同样可以改变标准皮肤；用户页面应该这样起名：User:*用户名/* standard.css 和User:*用户名/*
standard.js（其它的皮肤类推）。
...
维基百科的登录用户才能使用[Mediawiki系统提供的自定义CSS](../Page/Mediawiki.md "wikilink")，设置的CSS也只应用于维基百科，其他网站不受影响。
...
| :link.new                  | [example](../Page/example.md "wikilink")                          |                                                                     |
...
HTML属性名可以是可变的。[HTML
Tidy在服务器端移除名字不合法的属性](../Page/w:en:HTML_Tidy.md "wikilink")，因此其结果不依赖于是否忽略属性值的浏览器兼容性设置，而且传送的数据量也减少了。请参考[w:en:Wikipedia:HiddenStructure和](../Page/w:en:Wikipedia:HiddenStructure.md "wikilink")了解“class”值的可能变化。
...
[Tillwe](../Page/User:Tillwe.md "wikilink") 14:05, 30 May 2004 (UTC)

Update (01.06.04): Now also displays table formatted things more or less
correctly. -- [Tillwe](../Page/User:Tillwe.md "wikilink") 17:45, 1 Jun
2004 (UTC)

#### 移动分类链接

Moves category links in the upper right corner of content area, and
paints them gray -- [Tillwe](../Page/User:Tillwe.md "wikilink") 21:22,
31 May 2004 (UTC)

  -
    Small fix --[Ævar Arnfjörð
    Bjarmason](../Page/User:Ævar_Arnfjörð_Bjarmason.md "wikilink")
...
[getElementById](../Page/w:getElementById.md "wikilink"). The position
of insertion may be specified by insertBefore

请参考[帮助:维基用户脚本开发指南](../Page/帮助:维基用户脚本开发指南.md "wikilink")。
...
[framed](../Page/File:Bottom_tabs_position_corrected.png.md "wikilink")
[framed](../Page/File:Bottomlinks.png.md "wikilink")
...
Since alt-d is also a shortcut to the address bar in most browsers, you
...
[MediaWiki:Monobook.js](../Page/MediaWiki:Monobook.js.md "wikilink").
...
[w:en:MediaWiki:Monobook.js](../Page/w:en:MediaWiki:Monobook.js.md "wikilink")
...
以下是Mediawiki启用JS后产生的部分变量，用户脚本可以访问。完整的列表请参见[配置选项和](../Page/mw:Manual:Configuration_settings/zh.md "wikilink")[mw:Manual:Interface/JavaScript](../Page/mw:Manual:Interface/JavaScript.md "wikilink")。
...
### 关于JS的外部链接
  ...
  - **[mw:ResourceLoader](../Page/mw:ResourceLoader.md "wikilink")**
  - **[mw:ResourceLoader/Default
    modules](../Page/mw:ResourceLoader/Default_modules/zh.md "wikilink")**：MediaWiki提供的可被JS使用的对象和方法。
...
## 參見
  ...
  - [Gallery of user
    styles](../Page/Gallery_of_user_styles.md "wikilink")
  - [Skin projects](../Page/Skin_projects.md "wikilink")

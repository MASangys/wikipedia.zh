  ...
  -
    ...
    4.勾選封禁的型態。
      -
        ...
        **自动封禁该账户使用的IP地址**：仅可用于帐户封禁，由[MediaWiki系統自行封禁用戶最後使用的IP地址](https://zh.wikipedia.org/wiki/MediaWiki "wikilink")，並套用與此封禁相同的設定。*默認啟用*。见[WP:自动封禁](https://zh.wikipedia.org/wiki/WP:自动封禁 "wikilink")

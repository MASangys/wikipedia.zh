...
这个手册主要是指导如何维护和管理维基百科的一些技术方法。关于维护和管理的政策和守则请参看[方针与指引](https://zh.wikipedia.org/wiki/wikipedia:方针与指引 "wikilink")，关于维护和管理的技术资料请参看[Wikitech](../Page/wikitech:.md "wikilink")。
<onlyinclude>

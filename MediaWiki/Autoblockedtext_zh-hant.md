> 本文内容由[MediaWiki:Autoblockedtext/zh-hant](https://zh.wikipedia.org/wiki/MediaWiki:Autoblockedtext/zh-hant)转换而来。
...
[代理服務器使用者被封禁時](https://zh.wikipedia.org/wiki/代理服務器 "wikilink")，系統會[自動封禁使用同一代理服務器的用戶以免維基百科再受破壞](https://zh.wikipedia.org/wiki/Wikipedia:自動封禁 "wikilink")，故這類用戶也不可編輯。不便之處，尚祈見諒。
...
您可以發電子郵件至[解封郵件列表](mailto:unblock-zh@lists.wikimedia.org)，並於信函正文註明上列內容及申請理由，以便管理員處理或解答。

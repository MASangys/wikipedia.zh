> 本文内容由[MediaWiki:Blockedtext-partial](https://zh.wikipedia.org/wiki/MediaWiki:Blockedtext-partial)转换而来。
...
<p><strong>您目前不能编辑此页面</strong></p>
</div>
<div style="text-align: center; ">
<div style=" display: inline-block; padding: 0 2em; border-radius: 3px;">
<p><strong>您可以浏览此页面</strong>，但不能编辑{{Blockedtext/ifIP|ip=|name=</p></td>
<td><p>、移动}}或建立此页面</p>
</div>
</div>
</div>
...
<td><p>段}}IP地址编辑中文维基百科。<strong>如果您的账户本身未被封禁，请尝试更换您的IP地址或者转移到其他地方重试</strong><span id="mw-blocked-text-ipblockexemptmsg" style="display:none;">，如果符合指定条件，也可申请<a href="https://zh.wikipedia.org/wiki/Wikipedia:IP封禁例外" title="wikilink">IP封禁例外权限</a></span>。</p>
<div>
</div>
...
<div>
<p><strong>联络管理员</strong>：联络<a href="https://zh.wikipedia.org/wiki/User_talk:{{{4" title="wikilink">$4}}}或者其他的</a><a href="https://zh.wikipedia.org/wiki/{{MediaWiki:Grouppage-sysop}}" title="wikilink"><span style="color: #36c">管理员</span></a>，讨论这次封禁。{{Blockedtext/ifIP|ip=|name=</p></td>
<td><p>如果您希望使用“电邮用户”功能联络管理员，请注意您必须已于您的<a href="https://zh.wikipedia.org/wiki/Special:Preferences" title="wikilink"><span style="color: #36c">参数设置</span>中设置了一个有效的电子邮件地址并且尚未被禁止使用此功能</a>。}}</p>
</div>
</div>

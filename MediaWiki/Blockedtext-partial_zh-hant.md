...
<p>}}</p>
<div style="margin-bottom: 0.4em;">
<p><strong>郵件申訴</strong>：將您的用戶名和申訴理由寫入電子郵件，發送至。這樣該列表中的管理員就會知悉您對此次封禁有所疑問或希望獲得複核。請注意郵件發送可能會有延時，請勿重複多次發送。</p>
</div>
<div>
...
<td><p>如果您希望使用「電郵用戶」功能聯絡管理員，請注意您必須已於您的<a href="https://zh.wikipedia.org/wiki/Special:Preferences" title="wikilink"><span style="color: #36c">偏好設定</span>中設定了一個有效的電子郵件地址並且尚未被禁止使用此功能</a>。}}</p>
</div>
</div>

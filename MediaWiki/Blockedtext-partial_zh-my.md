> 本文内容由[MediaWiki:Blockedtext-partial/zh-my](https://zh.wikipedia.org/wiki/MediaWiki:Blockedtext-partial/zh-my)转换而来。
...
<p>}}</p>
<div style="margin-bottom: 0.4em;">
<p><strong>邮件申诉</strong>：将您的用户名和申诉理由写入电邮，发送至。这样该列表中的管理员就会知悉您对此次封禁有所疑问或希望获得复核。请注意邮件发送可能会有延时，请勿重复多次发送。</p>
</div>
<div>
...
<td><p>如果您希望使用“电邮用户”功能联络管理员，请注意您必须已于您的<a href="https://zh.wikipedia.org/wiki/Special:Preferences" title="wikilink"><span style="color: #36c">参数设置</span>中设置了一个有效的电邮地址并且尚未被禁止使用此功能</a>。}}</p>
</div>
</div>

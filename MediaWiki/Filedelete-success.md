...
根据删除的原因，你可能要移除所有[到本页的链接](https://zh.wikipedia.org/wiki/Special:Whatlinkshere/{{FULLPAGENAME}} "wikilink")。
{{\#ifeq:|||{{\#ifexist:|
[Information.svg](https://zh.wikipedia.org/wiki/File:Information.svg "fig:Information.svg")
本页存在有一个**[对话页](https://zh.wikipedia.org/wiki/{{TALKPAGENAME}} "wikilink")**（<small class="plainlinks">\[

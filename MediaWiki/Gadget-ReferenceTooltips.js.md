...
// enwiki settings var REF_LINK_SELECTOR = '.reference, a\[href^="\#CITEREF"\]',
...
// "Global" variables var SECONDS_IN_A_DAY = 60 \* 60 \* 24,
...
settingsString = mw.cookie.get( 'RTsettings', '' ); if ( settingsString ) {

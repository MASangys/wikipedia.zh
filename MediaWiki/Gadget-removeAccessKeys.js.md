...
page before editing \*\* // \*\* \*\* //
\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*
// Imported from version as of: 2007-04-17T22:22:27 // Deactivating
access keys, see [talk
page](https://zh.wikipedia.org/wiki/Wikipedia_talk:WikiProject_User_scripts/Scripts/removeAccessKeys "wikilink")

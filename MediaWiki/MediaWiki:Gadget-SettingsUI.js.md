...
', { id: 'sui_cfg_' + s.name + '_wrap' }).data('cfg', s),
...
', { style: 'margin-top:5px; margin-bottom:5px;' }).slider({
...
').css('text-align', 'center').appendTo($btnOuter);
...
}; // Add members to prototype SUI.fn = SUI.prototype = smMembers;

// Expose globally window.mw.libs.SettingsUI = SUI;

...
**可能出现此提示的其他原因：**
  ...
  - 如果您刚刚创建了{{\#switch:|Image=这一图像|这一页面}}，有可能是-{zh-hans:数据库;zh-hant:資料庫}-太忙而没来得及更新；请等待几分钟并尝试\[
    刷新缓存\]。
...
<!-- end list -->
  ...
  - 还有可能是{{\#switch:|Image=这一图像|这一页面}}已被删除。请检查**\[
    删除日志\]**和[Wikipedia:删除守则上的一些理由](https://zh.wikipedia.org/wiki/Wikipedia:删除守则 "wikilink")。

...
|在创建这一页面前，请详阅[:子页面](https://zh.wikipedia.org/wiki/{{ns:Project}}:子页面 "wikilink")。}}}}
  ...
  - **\[ {{\#switch:|User
    talk=给“”留言|开始编辑“”{{\#if:|页面|条目}}}}\]**{{\#switch:|=，你也可以使用[创建条目向导](https://zh.wikipedia.org/wiki/Wikipedia:创建条目向导 "wikilink")，或者[向其他编者请求这个条目](https://zh.wikipedia.org/wiki/{{ns:Project}}:条目请求 "wikilink")}}。

> 本文内容由[MediaWiki:Noarticletext/zh-sg](https://zh.wikipedia.org/wiki/MediaWiki:Noarticletext/zh-sg)转换而来。
...
[维基学院](https://zh.wikipedia.org/wiki/v:Special:Search/{{PAGENAME}} "wikilink")（自由的研习社群）
  ...
  - **\[ {{\#switch:|User talk=给“”留言|开始编辑“”{{\#if:|页面|条目}}}}\]**{{\#switch:|=，你也可以使用[创建条目向导](https://zh.wikipedia.org/wiki/Wikipedia:创建条目向导 "wikilink")，或者[向其他编者请求这个条目](https://zh.wikipedia.org/wiki/{{ns:Project}}:条目请求 "wikilink")}}。

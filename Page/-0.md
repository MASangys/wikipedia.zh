**-0**或**负零**代表**[0](../Page/0.md "wikilink")**的[相反数](../Page/加法逆元.md "wikilink")，等于0。特定情况下，-0可能具有特殊意义。
在[计算机科学中](../Page/计算机科学.md "wikilink")，-0主要用来表达[浮点数](../Page/浮点数.md "wikilink")，以及在某些时候对整数进行[有符号数处理](../Page/有符号数处理.md "wikilink")。

在普通应用中，-0有可能被用来表示一个可以[四舍五入为零的](../Page/數值修約規則.md "wikilink")[负数](../Page/负数.md "wikilink")，或者是一个从负方向上[趋近于零的数](../Page/极限.md "wikilink")。

在[统计力学中](../Page/统计力学.md "wikilink")，特定的系统在[反转分布的状态下](../Page/居量反轉.md "wikilink")，可以被认为拥有-0的[绝对温度](../Page/热力学温标.md "wikilink")。

## 计算机科学

### 表示法

[IEEE_754_Single_Negative_Zero.svg](https://zh.wikipedia.org/wiki/File:IEEE_754_Single_Negative_Zero.svg "fig:IEEE_754_Single_Negative_Zero.svg")[單精度浮點數表示負零](../Page/單精度浮點數.md "wikilink")\]\]
在对于整数的1+7位元的[符号数值表示法中](../Page/有符号数处理#符号数值表示法.md "wikilink")，负零是用二进制代码10000000表示的。在8位元[二进制反码中](../Page/有符号数处理#二进制反码.md "wikilink")，负零是用二进制代码11111111表示，但[二補數表示法則沒有負零的概念](../Page/二補數.md "wikilink")。在[IEEE
...
在编程语言中，例如[C](../Page/C语言.md "wikilink")，[C\#](../Page/C♯.md "wikilink")，[C++和](../Page/C++.md "wikilink")[Java](../Page/Java.md "wikilink")，一个表达式的结果可能是负零（比如对一个负数算术下溢时的结果），此时负零和正零是等效的。因此一个简单的比较不能够确定一个数是负零。确定一个数是负零的办法包括：
...
4.  在C语言中，使用一个依赖于本地[硬件表示法的不方便的办法](../Page/计算机硬件.md "wikilink")。例： `*(int
    *)&var == 0x80000000`（`var`在[IEEE
...
## 延伸阅读
  ...
  - ——[UNIVAC](../Page/UNIVAC.md "wikilink")® 1100
    系列电脑中的[二进制反码](../Page/有符号数处理#二进制反码.md "wikilink")

...
**.exit**是一个被[Tor](../Page/Tor.md "wikilink")用户所使用的[伪顶级域](https://zh.wikipedia.org/wiki/伪顶级域 "wikilink")（英文：pseudo-top-level domain），用于指示Tor在连接到诸如[网页服务器的服务时应该使用的首选](../Page/網頁伺服器.md "wikilink")[出口节点](https://zh.wikipedia.org/wiki/Tor#Tor出口節點封鎖 "wikilink")，而无需编辑配置文件 Tor（torrc）。

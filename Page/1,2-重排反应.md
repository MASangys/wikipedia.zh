**1,2-重排**或**1,2-遷移**或**1,2-移位**或**特莫爾1,2-移位**是一種[有機反應](https://zh.wikipedia.org/wiki/有機反應 "wikilink")，從化學化合物的其中一個原子的取代基移動到的另一個原子上。一個1，2移位運動為兩個相鄰的原子相較於移動越過較大距離是可能的。例如，從碳原子C2上的取代基R移動到C3上的例子。

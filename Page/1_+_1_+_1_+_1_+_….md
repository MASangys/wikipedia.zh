...
\(\sum_{n=1}^{\infin} 1^n\)或\(\sum_{n=1}^{\infin} 1\)，是一個[發散級數](../Page/發散級數.md "wikilink")，表示其部份和形成的數列不會[收斂](../Page/收斂數列.md "wikilink")。數列1<sup>*n*</sup>可以視為[公比為](../Page/公比.md "wikilink")1的[等比級數](../Page/等比級數.md "wikilink")。不同於其他公比為有理數的等比級數，此級數不但在實數下不收斂，在某些特定數字p的[p進數下也不收斂](../Page/p進數.md "wikilink")。若在[擴展的實數軸中](../Page/擴展的實數軸.md "wikilink")，因為部份和形成的數列[單調遞增且沒有上界](../Page/单调函数.md "wikilink")，因此級數的值如下

  -
    \(\sum_{n=1}^{\infin} 1 = +\infty \, ,\)

此發散級數無法用[切薩羅求和及](../Page/切薩羅求和.md "wikilink")[阿貝爾和的](../Page/阿貝爾和.md "wikilink")[求和法求和](../Page/求和法.md "wikilink")。
...
上述二個公式在\(s=0\)時不成立，必需利用[解析连续定义](../Page/解析连续.md "wikilink")。
...
⋯](../Page/1_+_2_+_3_+_4_+_⋯.md "wikilink")=–1/12，ζ(-2)=1 + 4 + 9 +
... = 0，其通式為
...
在同一年內，有兩位傑出的[物理學家](../Page/物理學家.md "wikilink")[斯拉夫诺夫](../Page/斯拉夫诺夫.md "wikilink")（A.
Slavnov）和F. Yndurain
分别在[巴塞羅那作了学术演讲](../Page/巴塞羅那.md "wikilink")。两场学术演讲的主题不同，但是在這兩個人的介紹當中，都说到了一句令觀眾非常難忘的话：“各位都知道，1
+ 1 + 1 + 1 + … = −1⁄2”，某程度意味著「如果觀眾不知道这个，那么继续听下去是没有意义的。」 \[3\]

## 參考資料

[分類:一](../Page/分類:一.md "wikilink")
[分類:數學悖論](../Page/分類:數學悖論.md "wikilink")

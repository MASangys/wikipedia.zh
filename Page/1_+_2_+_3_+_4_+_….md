...
[無窮級數中](../Page/無窮級數.md "wikilink")**1 + 2 + 3 + 4 +
…**為所有[自然数的和](../Page/自然数.md "wikilink")，是一个[发散级数](../Page/发散级数.md "wikilink")，其數學式也寫作
\(\sum_{n=1}^{\infin} n\)

此級數前 *n*
项的[部分和即是](../Page/部分和.md "wikilink")[三角形數](../Page/三角形數.md "wikilink")：

\[\sum_{n=1}^n n = \frac{n(n+1)}{2}\]
尽管這個级数的和第一眼看起来不会有任何有意义的值，透過與[拉馬努金求和等方法可產生一有限值](../Page/拉馬努金求和.md "wikilink")
\(-\frac{1}{12}\)，表示為：

\[1+2+3+4+\cdots=-\frac{1}{12}\]
此結果在[复分析](../Page/复分析.md "wikilink")、[量子力学及](../Page/量子力学.md "wikilink")[弦理论等領域中有所应用](../Page/弦理论.md "wikilink")。
...
当 *s* 的实部大于 1，*s* 次方的[黎曼ζ函数等于求和](../Page/黎曼ζ函数.md "wikilink")
\(\sum_{n=1}^\infty {n^{-s}}\)。当 *s* 的实部小于或等于 1 时和式发散，但当 *s* = −1 时 由
ζ(s) 的[解析延拓给出](../Page/解析延拓.md "wikilink") ζ(−1) 为 \(-\frac{1}{12}\)。

1 + 2 + 3 + 4 + …
的和不存在，但拉马努金另外給其定義，其[拉马努金和為](../Page/拉马努金求和.md "wikilink")
\(-\frac{1}{12}\)\[1\]。

## 物理

在[玻色弦理論中](../Page/玻色弦理論.md "wikilink")，我们想算出一个弦的可能的能量级，特别是最低能量级。非正式地说，每一个弦的谐波可以视为
一组 \(D\) 无关[量子谐振子](../Page/量子谐振子.md "wikilink")，这里 \(D\)
是时空的维数。如果基本振子频率是 \(\omega\) 则一个振子对 \(n\)
级谐波的贡献是 \(\frac{n\hbar\omega}{2}\)。所以利用发散级数我们发现在所有谐波上求和是
\(-\frac{\hbar\omega (D-2)}{24}\)。最后这确实是正确的，与一起，导致波色弦理论在维数不为 26 时是不一致的。

一个类似的计算是计算[卡西米尔力](../Page/卡西米尔力.md "wikilink")。

## 历史

在[拉马努金写给](../Page/拉马努金.md "wikilink")[戈弗雷·哈羅德·哈代的第二封信中](../Page/戈弗雷·哈羅德·哈代.md "wikilink")（日期为1913年2月27日）：

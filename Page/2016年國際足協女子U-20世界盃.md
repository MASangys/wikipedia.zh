...
|name_PNG= |win_PNG=0 |draw_PNG=0 |loss_PNG=3 |gf_PNG=1 |ga_PNG=22
|status_PNG=H |name_BRA= |win_BRA=1 |draw_BRA=1 |loss_BRA=1
|gf_BRA=12|ga_BRA=5 |name_SWE= |win_SWE=1 |draw_SWE=1 |loss_SWE=1
|gf_SWE=7 |ga_SWE=3 |name_PRK= |win_PRK=3 |draw_PRK=0 |loss_PRK=0
|gf_PRK=13|ga_PRK=3 |res_col_header=Q |result1=KO |result2=KO
...
|hth_USA=美國憑較佳公平競技分領先法國。 |hth_FRA=USA |res_col_header=Q |result1=KO
...
|status_GER=S |name_VEN= |win_VEN=0 |draw_VEN=0 |loss_VEN=3
|gf_VEN=3 |ga_VEN=9 |name_MEX= |win_MEX=2 |draw_MEX=0 |loss_MEX=1
|gf_MEX=5 |ga_MEX=5 |name_KOR= |win_KOR=1 |draw_KOR=0 |loss_KOR=2
|gf_KOR=3 |ga_KOR=4 |res_col_header=Q |result1=KO |result2=KO
|col_KO=green1 |text_KO=晉級淘汰賽 }}
...
|show_groups=yes |team1=PRK |team2=FRA |team3=JPN |team4=USA |team5=GER
|team6=ESP |team7=MEX |team8=BRA |team9=NGA |team10=SWE |team11=KOR
|team12=NZL |team13=GHA |team14=VEN |team15=CAN |team16=PNG
|name_PRK=**** |group_PRK=A |win_PRK=6 |draw_PRK=0 |loss_PRK=0
|gf_PRK=21 |ga_PRK=7 |name_FRA= |group_FRA=C |win_FRA=3
|draw_FRA=2 |loss_FRA=1 |gf_FRA=8 |ga_FRA=6 |name_JPN=
|group_JPN=B |win_JPN=4 |draw_JPN=0 |loss_JPN=2 |gf_JPN=16
|ga_JPN=4 |name_USA= |group_USA=C |win_USA=2 |draw_USA=2
|loss_USA=2 |gf_USA=7 |ga_USA=6 |name_GER= |group_GER=D |win_GER=3
|draw_GER=0 |loss_GER=1 |gf_GER=8 |ga_GER=2 |status_GER=S
|name_ESP= |group_ESP=B |win_ESP=2 |draw_ESP=0 |loss_ESP=2
|gf_ESP=9 |ga_ESP=5 |name_MEX= |group_MEX=D |win_MEX=2 |draw_MEX=0
|loss_MEX=2 |gf_MEX=6 |ga_MEX=7 |name_BRA= |group_BRA=A |win_BRA=1
|draw_BRA=1 |loss_BRA=2 |gf_BRA=13 |ga_BRA=8 |name_PNG=
|group_PNG=A |win_PNG=0 |draw_PNG=0 |loss_PNG=3 |gf_PNG=1
|ga_PNG=22 |status_PNG=H |name_SWE= |group_SWE=A |win_SWE=1
|draw_SWE=1 |loss_SWE=1 |gf_SWE=7 |ga_SWE=3 |name_NGA=
|group_NGA=B |win_NGA=2 |draw_NGA=0 |loss_NGA=1 |gf_NGA=5
|ga_NGA=8 |name_CAN= |group_CAN=B |win_CAN=0 |draw_CAN=0
|loss_CAN=3 |gf_CAN=1 |ga_CAN=13 |name_GHA= |group_GHA=C
|win_GHA=0 |draw_GHA=2 |loss_GHA=1 |gf_GHA=3 |ga_GHA=4 |name_NZL=
|group_NZL=C |win_NZL=1 |draw_NZL=0 |loss_NZL=2 |gf_NZL=2
|ga_NZL=5 |name_VEN= |group_VEN=D |win_VEN=0 |draw_VEN=0
|loss_VEN=3 |gf_VEN=3 |ga_VEN=9 |name_KOR= |group_KOR=D |win_KOR=1
|draw_KOR=0 |loss_KOR=2 |gf_KOR=3 |ga_KOR=4 |result1=1st

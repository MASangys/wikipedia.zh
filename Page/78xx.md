[7800_IC_regulatorsa.jpg](https://zh.wikipedia.org/wiki/File:7800_IC_regulatorsa.jpg "fig:7800_IC_regulatorsa.jpg")封裝\]\]
**78xx**，又被稱作**L78xx**、**LM78xx**、**MC78xx**...等，是一種固定式電壓輸出[線性電壓調節器的集合](https://zh.wikipedia.org/wiki/線性調節器 "wikilink")。通常被用在需要穩定電源的電路中，具有便利性（易於使用）且低成本的優點。xx指的是其輸出[電壓](../Page/電壓.md "wikilink")，例如LM7812的輸出電壓為12[伏特](../Page/伏特.md "wikilink")。此種調節器輸出之電壓相對於[接地點為高](../Page/接地.md "wikilink")，故被稱作正電壓型調節器。可以和負電壓型調節器**LM79xx**搭配使用，以同時提供電路正負電壓。
...
[TS7805_voltage_regulator.JPG](https://zh.wikipedia.org/wiki/File:TS7805_voltage_regulator.JPG "fig:TS7805_voltage_regulator.JPG")
此種元件較常見的類型有7805、7806、7808、7809、7810、7812、7815、7818、以及7824。其中，7805較為常見，因為對於多數[電晶體－電晶體邏輯元件而言](../Page/電晶體－電晶體邏輯.md "wikilink")，5伏特之電壓源相對較為便利。此外，為了輸出的穩定，各種類型都有其各自不同之最小輸入電壓，例如7805的最小輸入電壓為7.3伏特\[1\]。
...
較不常見的版本則有[美國國家半導體所製造的LM](../Page/美國國家半導體.md "wikilink")78Mxx系列（500 毫安培）以及LM78Lxx系列（100 毫安培）。有些類型提供較不尋常的電壓，例如[意法半導體所製造的LM](../Page/意法半導體.md "wikilink")78L62系列（6.2 伏特）、LM78L82系列（8.2 伏特）以及L78L33ACZ系列（3.3 伏特）。
...
78xx系列[積體電路內部也整合有](https://zh.wikipedia.org/wiki/積體電路 "wikilink")[過電流](https://zh.wikipedia.org/wiki/過電流 "wikilink")／[短路保護和過熱保護](../Page/短路.md "wikilink")，以避免器件工作時損壞。這使得78xx系列的器件在大部分實作場合中十分耐用，有些應用中，78xx系列的器件提供的限流保護不僅保護其本身，還為電路的其他部分也起到一定的保護作用。
...
和[LM317等一類的線性電壓調節器一樣](https://zh.wikipedia.org/wiki/LM317 "wikilink")，輸入電流和輸出電流基本一致，而輸入電壓總高於輸出電壓，此時通過電流乘以這個電壓降的乘積就是78xx內分壓電阻的損耗[功率](../Page/功率.md "wikilink")。這意味著輸入78xx的電功率要比78xx輸出的電功率要大，而這部分輸入功率和輸出功率之差，即為損耗功率，工作時便以廢熱的形式散耗，意味著78xx器件工作時是需要[散熱器輔助散熱的](https://zh.wikipedia.org/wiki/散熱器 "wikilink")。如果[穩壓器的壓差越高](https://zh.wikipedia.org/wiki/穩壓器 "wikilink")，電流不變的情況下，這個散耗功率便越大，此時78xx器件會變得很沒效率。如果需要較大的電功率和較高的效率，但又要求12伏、5伏左右的低電壓，則需要降低78xx器件的輸入電壓以降低壓差，或是改用效率更高的[交換式供電模組](https://zh.wikipedia.org/wiki/交換式電源供應器 "wikilink")。
...
### 其他
  ...
  - [Reverse engineering a 7805 voltage
    regulator](http://www.righto.com/2014/09/reverse-engineering-counterfeit-7805.html)，內有7805如何運作的詳細資訊，並含有數量眾多的參考連結。

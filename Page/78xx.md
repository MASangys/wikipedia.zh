...
和[LM317等一類的線性電壓調節器一樣](../Page/LM317.md "wikilink")，輸入電流和輸出電流基本一致，而輸入電壓總高於輸出電壓，此時通過電流乘以這個電壓降的乘積就是78xx內分壓電阻的損耗[功率](../Page/功率.md "wikilink")。這意味著輸入78xx的電功率要比78xx輸出的電功率要大，而這部分輸入功率和輸出功率之差，即為損耗功率，工作時便以廢熱的形式散耗，意味著78xx器件工作時是需要[散熱器輔助散熱的](https://zh.wikipedia.org/wiki/散熱器 "wikilink")。如果[穩壓器的壓差越高](https://zh.wikipedia.org/wiki/穩壓器 "wikilink")，電流不變的情況下，這個散耗功率便越大，此時78xx器件會變得很沒效率。如果需要較大的電功率和較高的效率，但又要求12伏、5伏左右的低電壓，則需要降低78xx器件的輸入電壓以降低壓差，或是改用效率更高的[交換式供電模組](https://zh.wikipedia.org/wiki/交換式電源供應器 "wikilink")。

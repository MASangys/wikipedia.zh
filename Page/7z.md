...
(262144)次\[1\]（这种技术称为[密钥延伸](../Page/密钥延伸.md "wikilink")），使得对口令的[暴力解码更加困难](https://zh.wikipedia.org/wiki/暴力破解法 "wikilink")。当前基于GPU的或是自制硬件限制了这种密钥延伸的有效性\[2\]，所以选择一个强口令仍然很重要。7z格式提供了选项可以加密文件名。

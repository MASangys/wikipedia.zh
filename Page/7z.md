...
7z格式支持256位键钥[AES算法](https://zh.wikipedia.org/wiki/AES "wikilink")[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")。键钥则由用户提供的[暗码进行](https://zh.wikipedia.org/wiki/暗码 "wikilink")[SHA-256](https://zh.wikipedia.org/wiki/SHA "wikilink")[hash算法得到](https://zh.wikipedia.org/wiki/hash函数 "wikilink")（使用大量[迭代以使得对暗码的](../Page/迭代.md "wikilink")[暴力解码更加困难](https://zh.wikipedia.org/wiki/暴力破解法 "wikilink")）.

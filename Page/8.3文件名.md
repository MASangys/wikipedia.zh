...
Windows的](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")[Windows
95及](../Page/Windows_95.md "wikilink")[Windows
NT](../Page/Windows_NT.md "wikilink")
3.5以前的版本中，在[FAT](../Page/FAT.md "wikilink")[檔案系統中的常用方法](https://zh.wikipedia.org/wiki/檔案系統 "wikilink")。在以前的[CP/M及某些的](https://zh.wikipedia.org/wiki/CP/M "wikilink")[通用資料和](https://zh.wikipedia.org/wiki/通用資料 "wikilink")[迪吉多](../Page/迪吉多.md "wikilink")[微型電腦作業系統中使用](https://zh.wikipedia.org/wiki/微型電腦 "wikilink")。

8.3檔案名稱最多只可以含有8個字元，跟著最多3個字元的[副檔名](../Page/文件扩展名.md "wikilink")，利用『`.`』號將兩者連接起來。檔案及[目錄名稱是全部使用](https://zh.wikipedia.org/wiki/目錄_\(電腦\) "wikilink")[大寫字母的](../Page/大寫字母.md "wikilink")。

## 對於8.3與長檔名的相容性

[VFAT](https://zh.wikipedia.org/wiki/VFAT "wikilink")，是對於FAT系統中的加強版，在Windows
95和Windows NT
3.5加入。VFAT檔案系統可允許比傳統的8.3檔名，支援更長、而且能大小寫混合的長檔名（[LFN](https://zh.wikipedia.org/wiki/VFAT "wikilink")）。
...
4.  從Windows
    2000開始，如果最少4個檔案或資料夾的短檔名的首6個字元是相同的話，該長檔名會另行將檔名轉作基本名稱的首2位字元（或如果基本名稱只有1個字元的話，便全取檔案名稱1個字元），再以4位[十六進位的檔案名稱的切細值連接上](https://zh.wikipedia.org/wiki/十六進位 "wikilink")，接著\~號，再接著一位的數字及`.`號，最後以首3位的副檔名作為結尾。結果，相比之中，這檔名是已經分拆及改用全大寫字母。
...
OS檔案名稱的兼容性有所增加](https://zh.wikipedia.org/wiki/Mac_OS "wikilink")。

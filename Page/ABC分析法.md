...
、ABC分类法、分類管理法、重點管理法、ABC管理法、abc管理、巴雷特分析法，是一种根据[帕累托最优原则设计的分类方法](../Page/帕累托最优.md "wikilink")，是确定[库存等级的技术](https://zh.wikipedia.org/wiki/库存 "wikilink")，常用于[物资管理中](https://zh.wikipedia.org/wiki/物资管理 "wikilink")，也称为*选择性库存控制*。
ABC分析法包括:
...
每种类别没有明确界限，可根据目标、规则分类。ABC分析与[帕累托原则类似](https://zh.wikipedia.org/wiki/帕累托原则 "wikilink")，在'A'物品中，一般占数量较少，价值较高。\[4\]
ABC分类示范：
...
## 参见
  ...
  - [库存](https://zh.wikipedia.org/wiki/库存 "wikilink")
  - [库存管理](https://zh.wikipedia.org/wiki/库存管理 "wikilink")
  - [存货](https://zh.wikipedia.org/wiki/存货 "wikilink")
  - [帕累托法则](../Page/帕累托法则.md "wikilink")
  - [帕累托分析法](https://zh.wikipedia.org/wiki/帕累托分析法 "wikilink")

...
| Sun<sup>TM</sup> | Solaris<sup>TM</sup> 8&9            | Sun ONE<sup>TM</sup> Studio 8                                      | X      | X      |
|                  |                                     |                                                                    |        |        |
...
這個簡單的範例中，包含了幾個實用的三維實體建構方法（[建構程序SWF](http://interactive.chinese.googlepages.com/sink2-HQ.html)）：

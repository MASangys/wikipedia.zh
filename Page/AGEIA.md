...
2008年2月4日，[NVIDIA宣佈收購AGEIA](https://zh.wikipedia.org/wiki/NVIDIA "wikilink")\[1\]。使其[G80及之後的產品支援PhysX加速](https://zh.wikipedia.org/wiki/GeForce_8 "wikilink")。

[物理處理器](../Page/物理處理器.md "wikilink")是專用來執行物理運算，而速度則比傳統处理器快上多倍。而PhysX物理處理器則采用NovodeX作為其[中间件](../Page/中间件.md "wikilink")，用於遊戲軟體中。現時已有多款電腦遊戲及平台，使用和支援PhysX技术。遊戲引擎方面，[虛幻引擎](https://zh.wikipedia.org/wiki/虛幻引擎 "wikilink")3已使用PhysX技术作為其物理引擎。由於PhysX物理引擎开发包（前稱NovodeX SDK）是免費的（源代碼要5萬[美元](../Page/美元.md "wikilink")一份），所以吸引了不少的用戶使用\[2\]。而公司會透過售賣物理加速卡來賺錢。

...
test**）是一個[決定型](../Page/確定性演算法.md "wikilink")[質數測試](../Page/素性測試.md "wikilink")[演算法](../Page/演算法.md "wikilink")
，由三個來自的計算機科學家，、和，在2002年8月6日發表於一篇題為**質數屬於P**的論文。\[1\]作者們因此獲得了許多獎項，包含了2006年的[哥德爾獎和](../Page/哥德爾獎.md "wikilink")2006年的。這個演算法可以在[多項式時間之內](../Page/多項式時間.md "wikilink")，決定一個給定整數是[質數或者](../Page/質數.md "wikilink")[合數](../Page/合數.md "wikilink")。

## 重要性

AKS最關鍵的重要性在於它是第一個被發表的**一般的**、**多項式的**、**確定性的**和**無仰賴的**質數判定算法。先前的算法至多達到了其中三點，但從未達到全部四個。

  - AKS算法可以被用於檢測任何**一般的**給定數字是否為質數。很多已知的高速判定算法只適用於滿足特定條件的質數。例如，[卢卡斯-莱默检验法僅對](../Page/卢卡斯-莱默检验法.md "wikilink")[梅森質數適用](../Page/梅森質數.md "wikilink")，而[Pépin測試僅對](../Page/Pépin測試.md "wikilink")[費馬數適用](../Page/費馬質數.md "wikilink")。
  - 算法的最長運行時間可以被表為一個目標數字長度的**[多項式](../Page/多項式.md "wikilink")**。[ECPP和](../Page/橢圓曲線質數測試.md "wikilink")[APR能夠判斷一個給定數字是否為質數](../Page/Adleman–Pomerance–Rumely質數測試.md "wikilink")，但無法對所有輸入給出多項式時間範圍。
  - 算法可以**[確定性](../Page/确定性算法.md "wikilink")**地判斷一個給定數字是否為質數。隨機測試演算法，例如[米勒-拉宾检验和](../Page/米勒-拉宾检验.md "wikilink")[Baillie–PSW](../Page/Baillie–PSW.md "wikilink")，可以在多項式時間內對給定數字進行校驗，但只能給出概率性的結果。
  - AKS算法並未“仰賴”任何未證明[猜想](../Page/猜想.md "wikilink")。一個反例是[确定性米勒检验](../Page/米勒-拉宾检验.md "wikilink")：該算法可以在多項式時間內對所有輸入給出確定性結果，但其正確性卻基於尚未被證明的[廣義黎曼猜想](../Page/廣義黎曼猜想.md "wikilink")。
...
這個定理是[費馬小定理的一般化](../Page/費馬小定理.md "wikilink")，並且可以簡單的使用[二項式定理跟](../Page/二項式定理.md "wikilink")[二項式係數的這個特徵](../Page/二項式係數.md "wikilink"):

\[{n \choose k} \equiv 0 \pmod{n}\] ，對任何 \(0<k<n\) ，若且唯若 *n* 是質數
來證明出此定理。

雖然說關係式 (1)
基本上構成了整個質數測試，但是驗證花費的時間卻是[指數時間](../Page/指數時間.md "wikilink")。因此，為了減少[計算複雜度](../Page/計算複雜性理論.md "wikilink"),
...
在上文引用的論文的第一版本中，作者們證明了算法的漸近時間為[O](../Page/大O符號.md "wikilink")\((\log^{12}(n))\)。換言之，算法使用少於*n*的[二進制數字長度的十二次方](../Page/二進制.md "wikilink")。但是，論文證明的時間上界卻過於寬鬆；事實上，一個被普遍相信的關於[索菲熱爾曼質數分佈的假設如果為真](../Page/索菲熱爾曼質數.md "wikilink")，則會立即將最壞情況減至O\((\log^6(n))\)。
...
出於對這些變體和其他回复的回應，論文“質數屬於P”稍後被進行了更新，新版本包括了一個AKS算法的正規公式化表述和其正確性證明。（這一版本在[数学年刊上發表](../Page/数学年刊.md "wikilink")。）雖然基本思想沒有變化，\(r\)卻被採用了新方法進行選擇，而正確性證明也變得更加緊緻有序。與舊證明依賴於許多不同的方法不同，新版本幾乎只依賴於[有限域上的分圓多項式的特徵](../Page/有限域.md "wikilink")。新版本同時也優化了時間複雜度的邊界到O\((\log^{10.5}(n))\)。通過[篩法獲得的其他結果可以將其進一步簡化到O](../Page/篩法.md "wikilink")\((\log^{7.5}(n))\)。

在2005年，[Carl Pomerance和](../Page/Carl_Pomerance.md "wikilink")[H. W.
Lenstra,
Jr.展示了一個AKS的變體](../Page/endrik_Lenstra.md "wikilink")，可以在\(O(log^6(n))\)次操作內完成測試（\(n\)是被測試數）。對於原算法的\(O(log^{12}(n))\)邊界而言，這是一個顯著的改進。\[2\]
...
另外，這裡的*log*
代表以二為底的對數，\(\scriptstyle\varphi(r)\)則是*r*的[歐拉函數](../Page/歐拉函數.md "wikilink")。
...
## 外部連結
  ...
  - [The Prime Facts: From Euclid to
    ...
    Aaronson](../Page/Scott_Aaronson.md "wikilink") (PDF)
...
2.  [亨德里克·倫斯特拉](../Page/亨德里克·倫斯特拉.md "wikilink") and [Carl
    Pomerance](../Page/Carl_Pomerance.md "wikilink"), "[Primality

**ALOHA网络**（，或），也称为**ALOHA系统**（），是由美国[夏威夷大学所开发的实验性](../Page/夏威夷大学.md "wikilink")[电脑网络系统](https://zh.wikipedia.org/wiki/电脑网络 "wikilink")。在1971年6月开始成功运作，是世界上第一个无线资料网络。
...
移动电话的频段来进行有限的控制与信号传输。1990年代，[马帝·马柯能与芬兰电信](https://zh.wikipedia.org/wiki/马帝·马柯能 "wikilink")（Telecom
Finland）的工程师，为了在 2G
行动电路中发展[短信功能](https://zh.wikipedia.org/wiki/短信 "wikilink")，大幅度扩展了ALOHA频段。

## ALOHA协议

**ALOHA协议**处于[OSI模型中的](../Page/OSI模型.md "wikilink")[数据链路层](../Page/数据链路层.md "wikilink")。它属于[随机存取协议](https://zh.wikipedia.org/wiki/随机存取协议 "wikilink")（Random

**FireStream**是[ATi研發的一个流处理器系列](https://zh.wikipedia.org/wiki/ATi "wikilink")，在AMD收購ATI後改為
Firepro S
...
6800处理音频數據](https://zh.wikipedia.org/wiki/GeForce_6 "wikilink")，ATI亦做過同樣的試驗。而且[史丹佛大學的Folding](../Page/史丹佛大學.md "wikilink")@Home研究项目亦可利用Radeon
X1900作運算加速\[1\]；通过GPU来模拟蛋白质合成，进而找尋有關蛋白质的疾病。

自[R520系列顯核問世以來](https://zh.wikipedia.org/wiki/Radeon_X1_Series "wikilink")，基於它的可編程結構，ATi已投入大量資源研究GPGPU，意即使用顯核來作非3D運算，處理一般在主流伺服器和桌面處理器上運行的軟體，据称性能比CPU高出10-30倍，并于稍后宣佈其“流计算（通用计算）”（Stream
...
[GDDR3記憶體](https://zh.wikipedia.org/wiki/GDDR3 "wikilink")，频率是1300
...
X1900显示卡上的ATI](https://zh.wikipedia.org/wiki/Radeon_X1_Series "wikilink")
R580顯示核心作為基礎。ATI FireStream
580并可以作為AMD的[Torrenza协处理平台的附件加速芯片](https://zh.wikipedia.org/wiki/Torrenza "wikilink")。
...
[R600流处理器](https://zh.wikipedia.org/wiki/Radeon_R600 "wikilink")，借助1个通用的MADD计算，這個系统每秒就能完成1万亿次浮点计算，性能是目前頂級系統的10倍。這是由於流处理器核心擁有大量平行处理器，能輕易提升浮点运算性能。
...
Layer（CAL），成为一个完整的软体编写与开发平台，让开发人员利用高级编程语言（例如：[C语言或](https://zh.wikipedia.org/wiki/C语言 "wikilink")[C++等](../Page/C++.md "wikilink")，以及其他专有[函式库](https://zh.wikipedia.org/wiki/函式库 "wikilink")，如：[Brook+或](https://zh.wikipedia.org/wiki/Brook "wikilink")[RapidMind等](https://zh.wikipedia.org/wiki/RapidMind "wikilink")）编写程序，并经过CTM界面，进行低级（[機器代碼](https://zh.wikipedia.org/wiki/機器代碼 "wikilink")）微调。
...
8.12開始，主流顯示卡將可以使用到Stream技術，對抗[NVIDIA的](https://zh.wikipedia.org/wiki/NVIDIA "wikilink")[CUDA技術](../Page/CUDA.md "wikilink")。\[3\]

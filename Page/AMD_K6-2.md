...
**K6-2**是一個由AMD製造的[x86處理器](https://zh.wikipedia.org/wiki/x86 "wikilink")，也是AMD整个奔腾时期最成功的一个处理器序列。K6-2可以在200至550
MHz的時鐘速度運行。它有64Kb一級緩存（32KB指令集和32KB資料），在2.2[伏特的電壓下運行](../Page/伏特.md "wikilink")。使用[0.25微米製程](https://zh.wikipedia.org/wiki/0.25微米製程 "wikilink")，擁有930萬個[電晶體](https://zh.wikipedia.org/wiki/電晶體 "wikilink")，以及只能使用於處理器插座是[Socket
...
K6-2设计目的是作为当时比较老、更重要的是比较贵的[Intel](https://zh.wikipedia.org/wiki/Intel "wikilink")
[Pentium
II的竞争对手](https://zh.wikipedia.org/wiki/Pentium_II "wikilink")。这两种CPU的性能很相似：K6-2的前代[K6趋向于日常计算应用](https://zh.wikipedia.org/wiki/AMD_K6 "wikilink")，而Intel的在浮点任务中无疑更强大。K6-2是一款非常成功的CPU，并为[AMD提供了市场基础和财政稳定性](https://zh.wikipedia.org/wiki/AMD "wikilink")，为日后发布[Athlon做好准备](https://zh.wikipedia.org/wiki/Athlon "wikilink")。

K6-2是第一款引入浮点单指令多数据结构（[SIMD](https://zh.wikipedia.org/wiki/SIMD "wikilink")）指令集——[3DNow\!的处理器](../Page/3DNow!.md "wikilink")，这套指令集大大推动了执行3维立体处理能力的进步。3D
Now\!成功打败了Intel在数月后推出的、相似但更复杂的[SSE](../Page/SSE.md "wikilink")。

几乎所有的K6-2都是在100MHz [前端总线](../Page/前端总线.md "wikilink")（FSB）的[Super
7平台上开发的](https://zh.wikipedia.org/wiki/Super_7 "wikilink")，这套平台为CPU性能提高提供了基础。在K6-2初期，K6-2
300MHz版本是卖得最好的。这个版本的热卖，为K6-2在市场上造就了一个极好的名声，并与[Intel](https://zh.wikipedia.org/wiki/Intel "wikilink")
[Celeron](https://zh.wikipedia.org/wiki/Celeron "wikilink")
300A在市场上剧烈地竞争。[Celeron提供了一个小但快的缓存和卓越的浮点运算单元](https://zh.wikipedia.org/wiki/Celeron "wikilink")；K6-2提供更快的RAM访问（得益于Super
7主板）和3D Now\!的3D绘图能力的扩充。两者不仅热卖，并且吸引的很多双方的支持者使用对方的系统。（在那时候，最快的[Pentium
II尽管比最快K](https://zh.wikipedia.org/wiki/Pentium_II "wikilink")6-2和Celeron快一点，但价格却高出不少）
...
鲜为人知的K6-2+是整合了128KiB二级缓存并采用[0.18微米工艺的处理器](https://zh.wikipedia.org/wiki/0.18微米製程 "wikilink")（从本质上来说，这是[K6-III的简化版](https://zh.wikipedia.org/wiki/AMD_K6-III "wikilink")）。K6-2+是明确为低功耗移动型（但它的發熱量很大）CPU，而且推出的时候正是主流台式机快速转型到诸如Athlon之类的新平台。这款CPU在其目标市场销量一般，但尽管AMD没有努力为其作宣传，K6-2+依然出现在传统台式机市场中销售。台式机版本的K6-2+在市场中完全被Athlon和K6-III遮盖着锋芒（两者都比K6-2+快多了），甚至连较慢、只便宜一点点的原版K6-2也不例外，因为K6-2更知名和更容易找到匹配的主板。K6-2+最高频率为570MHz。

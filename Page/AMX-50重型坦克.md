AMX-50重型坦克是一款冷戰前期由法國AMX公司設計製造的試驗型重型坦克。該坦克採用了FAMH公司設計的[搖擺式炮塔](../Page/搖擺式炮塔.md "wikilink")，兩種子型號AMX-50
100、AMX-50 120分別安裝了100毫米和120毫米火炮。該坦克最終並未投入量產，研發計劃也在1950年代末期終止。
...
45式坦克的構造佈局與納粹德國的[虎II坦克相似](https://zh.wikipedia.org/wiki/虎II坦克 "wikilink")，同樣使用了交錯負重輪的設計（不過交錯負重輪並不是一個理想的設計，不僅可靠性差，而且自重也很高），不過炮塔是焊接式的。爲了符合設計方案中重量不能超過30噸的要求，AMX
M4 45式坦克不得不縮小尺寸並減少裝甲——全車裝甲最厚處也只有30毫米\[2\]。AMX M4
45一共製造了2輛原型車，但因爲這輛坦克防護過於薄弱，軍方拒絕接受該設計方案，並要求AMX重新進行設計。1949年，AMX公司完成了1輛新式重型坦克的原型車。該車的裝甲防護較AMX
M4 45有較大提高，炮塔也改爲了重新設計的搖擺炮塔，仍然裝備90毫米SA
45戰車炮\[3\]。1950年，90毫米主炮被一門100毫米火炮取代，改造後的坦克即AMX-50
100坦克\[4\]。

設計人員曾基於AMX M4設計出了一款更輕的衍生型（重34噸），即AMX CDC(，「Chasseur de
Char」意爲[驅逐戰車](../Page/驅逐戰車.md "wikilink"))。該車同樣使用90毫米SA
45坦克炮。但該方案僅停留在藍圖階段\[5\]。同期，法國亦設計了一款使用AMX M4坦克底盤、重34公噸的驅逐戰車AMX AC
1946年式，但該驅逐戰車最終也並未投入量產。
...
福煦式，但該驅逐戰車最終並未投入量產\[8\]。

## 生产情况

AMX-50 100和AMX-50 120都未投入量產。至該計劃被放棄，只有5輛AMX-50坦克的樣車完工。
...
[一些AMX-50坦克的图片](http://www.peachmountain.com/5star/Museum_Tanks_AMX-50_tanks.asp)
...
1.  Duncan Crow (ed.), 1978, *Modern Battle Tanks*, Profile Publications
    Limited, pp 102-104

2.  Spencer Tucker, 2004, *Tanks: An Illustrated History of Their
    Impact*, ABC-CLIO p. 143

3.

4.  Richard Ogorkiewicz, *Tanks: 100 years of evolution*Bloomsbury
    Publishing 357 pp.
...
7.  [AMX-50 Heavy
    Tank](http://www.militaryfactory.com/armor/detail.asp?armor_id=532)

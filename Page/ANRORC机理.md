...
1）反应主要产物是溴被氨基取代而产生的4-苯基-6-氨基嘧啶（2）。反应不生成5-取代异构体，说明反应不经过[苯炔中间体](../Page/苯炔.md "wikilink")。
...
4）将嘧啶的两个氮原子各用3%的 <sup>14</sup>N 标记，发现最终产物 4
中同位素含量大约减少一半，说明一个环氮原子已被所用试剂中的氮原子所替代。


[ANRORC_isotopeScrambling.png](https://zh.wikipedia.org/wiki/File:ANRORC_isotopeScrambling.png "fig:ANRORC_isotopeScrambling.png")

## 参见

  - [Zincke反应](../Page/Zincke反应.md "wikilink")：ANRORC机理的另一个例子

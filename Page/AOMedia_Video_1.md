...
AV1可以与[Opus音频格式一起封装在](../Page/Opus_\(音频格式\).md "wikilink")[WebM](../Page/WebM.md "wikilink")容器格式中，并可用于HTML5网络视频和[网页即时通信](../Page/WebRTC.md "wikilink")\[4\]。

## 技术

AV1是一种使用传统的基于区块编码但也加入了新技术的频率变换格式，AV1所使用的编码技术主要来源于谷歌[VP9](../Page/VP9.md "wikilink")的下一代视频压缩格式VP10，但同时也包含了由[Xiph.Org 基金会的主要赞助者](https://zh.wikipedia.org/wiki/Xiph.Org_基金会 "wikilink")[Mozilla](../Page/Mozilla.md "wikilink")开发的[Daala](../Page/Daala.md "wikilink")视频压缩格式和由Cisco开发的[Thor视频压缩格式中所使用的视频编码技术](../Page/Thor_\(視頻編碼\).md "wikilink")。

[开放媒体联盟根据](../Page/開放媒體聯盟.md "wikilink")[FreeBSD 2许可证发布了一个用](https://zh.wikipedia.org/wiki/BSD授權條款 "wikilink")[C语言和](https://zh.wikipedia.org/wiki/C语言 "wikilink")[汇编语言](../Page/汇编语言.md "wikilink")编写的编解码器参考实例`libaom`。该参考实例的开发接受开放媒体联盟成员资助并且公开进行。

**高级打包工具**（，缩写为）是[Debian及其衍生的](../Page/Debian.md "wikilink")[Linux軟體包管理器](../Page/软件包.md "wikilink")。APT可以自动下载，配置，安裝二进制或者源代码格式的[软件包](../Page/软件包.md "wikilink")，因此简化了[Unix系統上管理软件的过程](../Page/Unix.md "wikilink")。APT最早被設計成[dpkg的前端](../Page/dpkg.md "wikilink")，用來處理[deb格式的軟件包](../Page/deb.md "wikilink")。現在經過APT-RPM組織修改，APT已經可以安裝在支援[RPM的系統管理](../Page/RPM套件管理員.md "wikilink")[RPM套件](../Page/RPM套件管理員.md "wikilink")。

## 構成

APT由以下的幾個主要的命令構成：

  - [apt-get](../Page/apt-get.md "wikilink")
  - [apt-cache](../Page/Apt-get.md "wikilink")
  - [apt-file](../Page/Apt-get.md "wikilink")

在Debian系統中，APT建構於dpkg之上。

## 安裝源

APT的軟體安裝來源在[Debian安裝的時候即可進行初始](../Page/Debian.md "wikilink")[設置](../Page/設置.md "wikilink")，除了Debian官方的網路安裝來源之外，也可以使用Debian的安裝[光碟](../Page/光碟.md "wikilink")，甚至可以從非官方的安裝來源中下載非官方的軟體。APT同時也可以從一些安裝來源中下載原始碼軟體，並且自行編譯、安裝。
...
[Debian系統的一大特色即為](../Page/Debian.md "wikilink")「永不停機」，事實上，APT達到了這一點。在軟體被升級的時候，它仍然可以繼續服務。APT可以智能地從安裝來源下載最新版本的軟體並且安裝，而無須在安裝後重新啟動電腦（除了更新[Linux內核之外](../Page/Linux內核.md "wikilink")）。所有的配置都可以得到保留，升級軟體不再是一個棘手的問題。

## 發行版升級

APT最使人稱道的特點在於可以從一個Debian發行版升級到新的Debian發行版，例如從[woody升級到](../Page/woody.md "wikilink")[sarge](../Page/sarge.md "wikilink")。APT可以升級絕大部分滿足依賴關係的軟體，但是也可能要刪除，或添加新的軟體以滿足依賴關係。
...
| 名稱                                         | 運行界面 | 最新版本       |
| ------------------------------------------ | ---- | ---------- |
| [aptitude](../Page/aptitude.md "wikilink") | 字符終端 | 0.2.15.9-2 |
| [Synaptic](../Page/Synaptic.md "wikilink") | 圖形界面 | 0.75.13    |
| [GNOME 軟體](../Page/GNOME_軟體.md "wikilink") | 圖形界面 | 0.4.7-1.2  |
| [wajig](../Page/wajig.md "wikilink")       | 兼容   | 2.0.25     |
...
与apt-get相似的一个叫做[aptitude的程序在aptitude](../Page/aptitude.md "wikilink")
...
软件编写者特地将Disco（迪斯可）一词改为"Discow"，以体现"Cow"（[奶牛](../Page/奶牛.md "wikilink")）之意。

## 參見

  - [Yum](../Page/Yellow_Dog_Updater_Modified.md "wikilink")

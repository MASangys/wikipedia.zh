**ARCH模型**（**A**uto**r**egressive **c**onditional **h**eteroskedasticity
...
如果方差用[ARMA模型来表示](../Page/ARMA模型.md "wikilink")，则ARCH模型的变形为[GARCH模型](https://zh.wikipedia.org/wiki/GARCH模型 "wikilink")（波勒斯勒夫（Bollerslev），1986年）。
...
ARCH模型能准确地模拟时间序列变量的波动性的变化，它在[金融工程学的](https://zh.wikipedia.org/wiki/金融工程学 "wikilink")[实证研究中应用广泛](../Page/觀察研究.md "wikilink")，使人们能更加准确地把握[风险](../Page/风险.md "wikilink")（波动性），尤其是应用在[风险价值](https://zh.wikipedia.org/wiki/风险价值 "wikilink")（Value
at Risk）理论中，在[华尔街是人尽皆知的工具](../Page/华尔街.md "wikilink")。

## ARCH模型的变形和发展

  - 波勒斯勒夫（Bollerslev）提出[GARCH模型](https://zh.wikipedia.org/wiki/GARCH模型 "wikilink")（Generalized
    ARCH）；

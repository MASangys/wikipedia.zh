...
图 2
的效果更加有戏剧性。一旦看到了三维效果，观察者渐渐远离屏幕，垂直線将会變得更深，因而增加立体效果，水平或者竖直方向稍微移动也会产生有趣的效果。
...
有人在[电子邮件末尾或者新闻文章后面用立体图作为](../Page/电子邮件.md "wikilink")“签名”，图 4 就是一个这样的例子。
...
## 外部链接
  ...
  - [3D Stereogram Ascii Image
    Generator](http://www.kammerl.de/ascii/AsciiStereo.php) and [Movie
  ...
  - [ASCII art stereogram
    generator](http://aa-project.sourceforge.net/aa3d/) from AA-Project

> 本文内容由[ASCII立体图](https://zh.wikipedia.org/wiki/ASCII立体图)转换而来。
...
图 3 根据与单图像随机点立体图（Single Image Random Dot Stereogram，简称 [SIRDS](https://zh.wikipedia.org/wiki/SIRDS "wikilink")）同样的思想显示了一个单图像随机文本立体图（Single Image Random Text Stereogram，简称 SIRTS）。当立体图像变得清楚的时候就可以看到浮雕中的“Hi”。
...
有人在[电子邮件](../Page/电子邮件.md "wikilink")末尾或者新闻文章后面用立体图作为“签名”，图 4 就是一个这样的例子。
...
图 1、2、3 与 4 分别归属于 David B. Thomas、[Jonathan Bowen](https://zh.wikipedia.org/wiki/Jonathan_Bowen "wikilink")、Charles Durst 与 Marty Hewes。这四幅立体图出现在公开的 *alt.3d* [USENET](../Page/Usenet.md "wikilink") [新闻组](../Page/新闻组.md "wikilink") 中。图 5 是一位维基人现场作出来的。

最初由 *[ASCII Stereograms](https://web.archive.org/web/20080517013244/http://archive.museophile.org/3d/ascii-3d.html)* 的作者改编而来，并且得到了作者的许可。

## 外部链接

  - [3D Stereogram Ascii Image Generator](http://www.kammerl.de/ascii/AsciiStereo.php) and [Movie Generator](http://www.kammerl.de/ascii/AsciiStereoMovie.php)
  - [ASCII Stereograms](https://web.archive.org/web/20080517013244/http://archive.museophile.org/3d/ascii-3d.html) by [Jonathan Bowen](https://zh.wikipedia.org/wiki/Jonathan_Bowen "wikilink")
  - [Random-ASCII Stereograms](https://web.archive.org/web/20050218074826/http://www.mindspring.com/~dcovin/stereo.html)
  - [ASCII art stereogram generator](http://aa-project.sourceforge.net/aa3d/) from AA-Project
  - [Random-ASCII Stereograms](http://www.3dtupianku.com)

[Category:視錯覺](https://zh.wikipedia.org/wiki/Category:視錯覺 "wikilink") [Category:三维成像](https://zh.wikipedia.org/wiki/Category:三维成像 "wikilink") [Category:ASCII艺术](https://zh.wikipedia.org/wiki/Category:ASCII艺术 "wikilink") [Category:數位藝術](https://zh.wikipedia.org/wiki/Category:數位藝術 "wikilink")
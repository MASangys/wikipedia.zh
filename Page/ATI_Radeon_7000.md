...
這是Radeon
100的最重要賣點。在硬件T\&L技術支援下，能每秒生成3000万个三角形。這个几何引擎能令立體画面更真实和更柔和。此外，Radeon
100最大的功能是支持三重纹理贴图，其理论性能已经超过当时的Geforce2 GTS。但不幸的是，Geforce 2
GTS使用在应用程序中广泛受到支持的每周期两重纹理贴图，由于支持三重纹理贴图的应用程序太少，Geforce2
GTS事实上的性能超越Radeon 100。

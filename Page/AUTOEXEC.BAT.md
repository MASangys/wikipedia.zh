**AUTOEXEC.BAT**，又常被稱為**開機執行檔**，是[個人電腦上的一個系統指令檔](https://zh.wikipedia.org/wiki/個人電腦 "wikilink")，始源於[MS-DOS](../Page/MS-DOS.md "wikilink")。AUTOEXEC.BAT
...
-{zh-hans:运行;zh-tw:執行}-的[作業系統中皆適用](https://zh.wikipedia.org/wiki/作業系統 "wikilink")：
...
的執行次序僅次於
[CONFIG.SYS](https://zh.wikipedia.org/wiki/CONFIG.SYS "wikilink")
之後。在視窗作業系統下，這兩個檔案皆於[圖形使用者介面](https://zh.wikipedia.org/wiki/圖形使用者介面 "wikilink")（GUI）啟動之前執行的。

AUTOEXEC.BAT
最常見的實際應用是設定作業系統的[環境參數](https://zh.wikipedia.org/wiki/環境參數 "wikilink")，例如載入鍵盤、滑鼠等[驅動程式](https://zh.wikipedia.org/wiki/驅動程式 "wikilink")、磁碟檢查工具或病毒掃瞄程式。部分[電腦病毒亦會更改](https://zh.wikipedia.org/wiki/電腦病毒 "wikilink")
AUTOEXEC.BAT，以使其在開機後自動-{zh-hans:运行;zh-tw:執行}-。

AUTOEXEC.BAT
通常位於[開機磁碟中的](https://zh.wikipedia.org/wiki/開機磁碟 "wikilink")[根目錄](https://zh.wikipedia.org/wiki/根目錄 "wikilink")。
...
AUTOEXEC.BAT
內的指令。然而，在這些作業系統下啟動[命令提示-{zh-hans:符;zh-tw:字元}-時](https://zh.wikipedia.org/wiki/Cmd.exe "wikilink")，將會自動執行批次檔

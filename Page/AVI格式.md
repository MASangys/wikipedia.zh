> 本文内容由[AVI格式](https://zh.wikipedia.org/wiki/AVI格式)转换而来。


**AVI**是英语**Audio Video Interleave**（“音频视频交织”或译为“音频视频交错”）的首字母缩写，由[微软](../Page/微软.md "wikilink")在1992年11月推出的一种[多媒体文件格式](../Page/视频文件格式.md "wikilink")，用于对抗[苹果](../Page/苹果.md "wikilink")[Quicktime的技术](https://zh.wikipedia.org/wiki/Quicktime "wikilink")。现在所说的AVI多是指一种封装格式。
...
AVI将视频和音频封装在一个文件裡，其顺序是：若干视频帧（Video Frame）之后接着若干音频帧（Audio Frame），再然后是视频帧、音频帧，故名为“音频视频交织”，意即音频和视频按帧交错排列，以此达到音频同步于视频播放的效果。和DVD视频格式一样，AVI文件支持多视频流和音频流，虽然这些功能很少使用。大多数AVI文件还支持由[Matrox](../Page/Matrox.md "wikilink") OpenDML集团于1996年2月开发的格式后缀。这些文件非正式的称为“AVI 2.0”，并得到微软的支持。
...
较知名的有
  ...
  - [AVI-Mux](https://zh.wikipedia.org/wiki/AVI-Mux "wikilink")（命令行版本及GUI版本AVI-Mux GUI）
...
## AVI能使用的編碼
  ...
  - 影像檔案種類（括号内表示的是此视频的[FourCC](https://zh.wikipedia.org/wiki/FourCC "wikilink")）
      ...
      - [Indeo Video](https://zh.wikipedia.org/wiki/Indeo "wikilink")（IV31/IV32）
      - [Cinepak](https://zh.wikipedia.org/wiki/Cinepak "wikilink")（cvid）
      - [Microsoft Video 1](https://zh.wikipedia.org/wiki/Microsoft_Video_1 "wikilink")（CRAM）
...
## AVI影片播放器
  ...
  - [DivX Player](https://zh.wikipedia.org/wiki/DivX_Player "wikilink")：屬於DIVX公司
  - [GOM Player](../Page/GOM_Player.md "wikilink")：屬於Gretech Corporation，只能運行於Windows平台
  - [Windows Media Player](https://zh.wikipedia.org/wiki/Windows_Media_Player "wikilink")：屬於Microsoft，只能運行於Windows平台上

## 参见

  - [MKV](https://zh.wikipedia.org/wiki/MKV "wikilink")
  - [ASF](https://zh.wikipedia.org/wiki/ASF "wikilink")
  - [DirectShow Media](https://zh.wikipedia.org/wiki/DirectShow_Media "wikilink")
...
[Category:擴展名](https://zh.wikipedia.org/wiki/Category:擴展名 "wikilink") [Category:视频文件格式](https://zh.wikipedia.org/wiki/Category:视频文件格式 "wikilink")
...
在[计算机科学中](../Page/计算机科学.md "wikilink")，**AVL树**是最早被发明的[自平衡二叉查找树](../Page/自平衡二叉查找树.md "wikilink")。在AVL树中，任一节点对应的两棵子树的最大高度差为1，因此它也被称为**高度平衡树**。查找、插入和删除在平均和最坏情况下的[時間複雜度都是](../Page/時間複雜度.md "wikilink")\(O(\log{n})\)。增加和删除元素的操作则可能需要藉由一次或多次[树旋转](../Page/树旋转.md "wikilink")，以实现树的重新平衡。AVL树得名于它的发明者[G.
M. Adelson-Velsky和](../Page/格奥尔吉·阿杰尔松-韦利斯基.md "wikilink")，他们在1962年的论文《An
...
AVL树的基本操作一般涉及运作同在不平衡的[二叉查找树所运作的同样的算法](../Page/二叉查找树.md "wikilink")。但是要进行预先或随后做一次或多次所谓的"AVL旋转"。
...
*n*)时间，因为AVL树总是保持平衡的。不需要特殊的准备，树的结构不会由于查找而改变。（这是与[伸展樹搜尋相对立的](../Page/伸展樹.md "wikilink")，它会因为搜尋而变更树结构。）
...
高度為h的AVL樹，總節點數N最多\(2^h -1\)； 最少節點數\(N_h\)如以斐波那契數列可以用數學歸納法證明：
\(N_h\) = \(F_{h+1}\) - 1
(\(F_{h+1}\)是斐波那契数列的第h+1项，根据[斐波那契多项式得来](../Page/斐波那契多项式.md "wikilink"))。
即:
...
## 引用
  ...
  - G. Adelson-Velskii and E.M. Landis, "An algorithm for the
    ...
    146:263–266,
    1962（[Russian](../Page/Russian_language.md "wikilink")）.
    [English](../Page/English_language.md "wikilink") translation by
    Myron J. Ricci in *Soviet Math. Doklady*, 3:1259–1263, 1962.

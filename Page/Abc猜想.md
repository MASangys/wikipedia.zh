**abc猜想**（）是一個未解決的數學猜想，最先由[約瑟夫·奧斯特莱及](../Page/約瑟夫·奧斯特莱.md "wikilink")[大衛·馬瑟在](../Page/大衛·馬瑟.md "wikilink")1985年提出。abc猜想以三個互質正整數a,
b,
c描述，c是a及b的和，猜想因此得名。此猜想有數個宣稱的證明，最近提出的正在檢查中，至2014年9月此猜想仍然未得證明。对此也衍生出一[BOINC項目](../Page/BOINC.md "wikilink")「[ABC@Home](../Page/ABC@Home.md "wikilink")」。

abc猜想若得證，數論中很多著名猜想可以立時得出。[多利安·哥德費爾德稱abc猜想為](../Page/多利安·哥德費爾德.md "wikilink")「[丟番圖分析中最重要的未解問題](../Page/丟番圖方程.md "wikilink")」。

## 內容

對正整數*n*，\(\operatorname{rad}(n)\)表示\(n\)的[質因數的](../Page/質因數.md "wikilink")[積](../Page/積.md "wikilink")，稱為*n*的**根基**（radical）。例如
...
*c*，是較特殊的情況。[ABC@Home計劃目的在尋找更多這樣的例子](../Page/ABC@Home.md "wikilink")。
...
如果abc猜想得證，那麼有很多結果可以推導出來。其中一些結果，在abc猜想提出後，已經以其他方法得到證明，一些則仍然為猜想。
  ...
  -
  - [費馬大定理對所有足夠大指數的情形](../Page/費馬大定理.md "wikilink")（[安德魯·懷爾斯已證一般情形](../Page/安德魯·懷爾斯.md "wikilink")）


  - （[格爾德·法爾廷斯已證一般情形](../Page/格爾德·法爾廷斯.md "wikilink")）

  - ，除了有限多的反例。

  - 存在無限多[非維費里希素數](../Page/韋伊費列治素數.md "wikilink")

  - 的弱形式

  -
  - 用[勒讓德符號構成的](../Page/勒讓德符號.md "wikilink")[L函數](../Page/狄利克雷L函數.md "wikilink")*L*(*s*,
    *χ<sub>d</sub>*)沒有（需要abc猜想在[代數數域上的一致形式](../Page/代數數域.md "wikilink")，不只在有理整數上。）

  - 對有至少3個簡單零點的多項式*P*(*x*)，在整數*x*取的所有值中，只有有限個[次方數](../Page/次方數.md "wikilink")。\[1\]
...
abc猜想導出*c*有*abc*的根基的接近線性函數的[上界](../Page/上界.md "wikilink")；不過，現在已知的是[指數上界](../Page/指數函數.md "wikilink")。確切結果如下：
...
*c*的常數，而*K*<sub>2</sub>和*K*<sub>3</sub>是（以[可有效計算的方式](../Page/可計算函數.md "wikilink")）依賴於ε的常數，但不依賴於*a*,
*b*, *c*。上述的上界對*c* \> 2的三元組都成立。

## 計算結果

2006年，荷蘭的[萊頓大學數學系與](../Page/萊頓大學.md "wikilink")[Kennislink科學研究所合作](../Page/Kennislink.md "wikilink")，開展[ABC@Home計劃](../Page/ABC@Home.md "wikilink")。這個計劃是[網格計算系統](../Page/網格計算.md "wikilink")，目的在找出更多的正整數三元組*a*,
*b*, *c*使得rad(*abc*) \<
...
2007年，[呂西安·施皮羅嘗試給出證明](../Page/呂西安·施皮羅.md "wikilink")，後來被發現有錯誤。\[7\]

2012年8月，[日本](../Page/日本.md "wikilink")[京都大學數學家](../Page/京都大學.md "wikilink")[望月新一發表長約五百頁的abc猜想的證明](../Page/望月新一.md "wikilink")，以他建立的[宇宙際泰赫米勒理論](../Page/宇宙際泰赫米勒理論.md "wikilink")（inter-universal
Teichmüller theory）為基礎\[8\]\[9\]\[10\]。該證明目前正由其他數學專家檢查中。\[11\]当Vesselin
Dimitrov和Akshay
Venkatesh在2012年10月发现一处错误时，望月新一在他的网站确认了此错误，并声称这个错误能够在近期修补，不会影响最后的结果\[12\]。2012年12月，望月新一在自己主页贴出了自己对所有四篇文章的修改稿。主要包含27条重要的修改。2012年12月-2013年2月，他又屡次对文章进行了修订，新修正了18处错误，當中很多也是打字错误\[13\]。望月新一在網上公開了2013年\[14\]以及2014年\[15\]的檢驗進度報告。2018年8月，[皮特·舒爾策和](../Page/皮特·舒爾策.md "wikilink")指出，望月新一的證明論文中
...
## 外部連結
  ...
  - [ABC@home](http://abcathome.com/)
    [分布式计算项目](../Page/分布式计算.md "wikilink")[ABC@Home](../Page/ABC@Home.md "wikilink").
  ...
  - [The ABC's of Number
    ...
    by [Noam D. Elkies](../Page/Noam_D._Elkies.md "wikilink")

  - [Questions about
    Number](http://www.math.harvard.edu/~mazur/papers/scanQuest.pdf) by
    [Barry Mazur](../Page/Barry_Mazur.md "wikilink")
  ...
  - [ABC
    ...
    [Polymath project](../Page/Polymath_project.md "wikilink") wiki page
    linking to various sources of commentary on Mochizuki's papers.

...
Acid1在一个网页上测试了浏览器的许多特性，而网页最后的渲染结果应该和标准的对照图片相同。所有的主流浏览器都通过了Acid1测试\[1\]。托德凡奈（Todd
Fahrner）开发了Acid1以提高浏览器间的兼容性，而他当时被各种浏览器对Web标准的解释各不相同所困扰。凡奈的灵感来自于布雷登麦克丹尼尔（Braden

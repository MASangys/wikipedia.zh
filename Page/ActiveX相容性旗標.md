**相容性旗標**（）是一個主要用於[微軟在其](../Page/微軟.md "wikilink")[Internet
Explorer](../Page/Internet_Explorer.md "wikilink")[瀏覽器的保安設定](../Page/瀏覽器.md "wikilink")。透過指定某一特定[ActiveX控制項軟件的特定數值](../Page/ActiveX.md "wikilink")，不論是由Microsoft或其他第三方的軟件，都可以讓Internet
...
Windows作業系統內建的](../Page/Microsoft_Windows.md "wikilink")[Windows
Update功能進行更新](../Page/Windows_Update.md "wikilink")。

具體的說，killbit其實是Windows內登錄的一個[旗標](../Page/旗標.md "wikilink")，透過軟件的[GUID來辨識](../Page/GUID.md "wikilink")。由於微軟的ActiveX控制項規定必須要有獨一的GUID作辨識，Internet

...
Explorer](../Page/Internet_Explorer.md "wikilink")[瀏覽器的保安設定](https://zh.wikipedia.org/wiki/瀏覽器 "wikilink")。透過指定某一特定[ActiveX控制項軟件的特定數值](../Page/ActiveX.md "wikilink")，不論是由Microsoft或其他第三方的軟件，都可以讓Internet

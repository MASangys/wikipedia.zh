...
<!-- end list -->
  ...
  - 2015年5月13日：開源團隊開啟支援Linux ubuntu計畫。安裝腳本說明詳見
    [1](http://www.noobslab.com/2015/05/adobeair-is-now-available-for-ubuntu.html)
  - 2015年7月8日：發佈AIR 18.0版本。
  - 2015年9月21日：發佈AIR
    19.0版本。增加安全性和增加IOS支援[2](https://helpx.adobe.com/flash-player/release-note/fp_19_air_19_release_notes.html)。
...
[Flash
CS3则需要升级才可使用](../Page/Adobe_Flash.md "wikilink")。\[4\]该运行环境跨平台的特性意味着，只要搭配上AIR
SDK，任何网页编辑器都可以创建AIR应用。AIR自身使用[WebKit网页渲染引擎](../Page/WebKit.md "wikilink")，同时还使用了Flash和PDF技术。
...
## 外部連結
  ...
  - [Adobe Labs AIR
    Wiki](https://archive.is/20130424202547/http://labs.adobe.com/wiki/index.php)

...
Adobe
Brackets支持增加[外掛程式以提供額外的功能擴展](https://zh.wikipedia.org/wiki/外掛程式 "wikilink")，目前可用的外掛程式例如支持增加[偵錯](https://zh.wikipedia.org/wiki/偵錯 "wikilink")、[瀏覽器特定](https://zh.wikipedia.org/wiki/瀏覽器 "wikilink")[CSS前綴](https://zh.wikipedia.org/wiki/CSS "wikilink")、[JSDoc註解等](https://zh.wikipedia.org/wiki/JSDoc "wikilink")。
...
## 外部連結
  ...
  - [Adobe
    Brackets外掛程式列表](https://github.com/adobe/brackets/wiki/Brackets-Extensions)

...
2
Duo处理器的平台时](https://zh.wikipedia.org/wiki/Core_2_Duo "wikilink")）和2008年3月（Adobe发布Shockwave
11时，对英特尔平台的苹果电脑提供原生支持的第一个版本）之间。
...
Shockwave Player最开始是一个由Director团队成员Christan Hunt和David
Walker出于实验互联网上的多媒体概念的目的而为[Netscape开发的助手程序](https://zh.wikipedia.org/wiki/Netscape "wikilink")。1.0版独立于Director
4发布，它的开发计划从Director 5开始与Director系列合并，所以Shockwave没有2-4版。

### Shockwave 1

用于[Netscape
Navigator](https://zh.wikipedia.org/wiki/Netscape_Navigator "wikilink")
[2.0的Shockwave插件与Afterburner一并发布于](https://zh.wikipedia.org/wiki/網景_\(瀏覽器\)#Netscape_Navigator（1.0~4.08版本） "wikilink")1995年。第一个使用Shockwave的网站是
[Intel微处理器25年纪念](https://web.archive.org/web/19970103021015/http://www1.intel.com/intel/museum/25anniv/index.htm)。
...
支持[Mac OS X
10.3和更早版本操作系统的最后一个版本](https://zh.wikipedia.org/wiki/Mac_OS_X_10.3 "wikilink")。
...
Macromedia还发布了一款在线查看[Macromedia
...
根据[Adobe的数据](https://zh.wikipedia.org/wiki/Adobe_Systems "wikilink")，Adobe
Shockwave Player在52.3%的PC上安装。\[2\]

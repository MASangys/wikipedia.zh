**Ameba**（；或直譯為**變形蟲**）是由[日本](../Page/日本.md "wikilink")所推出的[社交網路服務](../Page/社交網路服務.md "wikilink")。包含網誌「**Ameba
部落格**（）」、社群遊戲「**Ameba Pigg**（）」等服務。
...
2012年6月開放網路社群遊戲[API](https://zh.wikipedia.org/wiki/API "wikilink")，讓用戶能透過[Twitter](../Page/Twitter.md "wikilink")、[Facebook等帳號登入網站](../Page/Facebook.md "wikilink")\[6\]。同年11月推出針對智慧型手機的服務「Ameba
Smart Phone（）」，耗資約30億日圓廣告費宣傳\[7\]。
...
## 沿革
  ...
  - 2012年10月 - 推出針對智慧型手機的遊戲「[-{zh-cn:临时女友;
    zh-tw:女友伴身邊}-](https://zh.wikipedia.org/wiki/臨時女友 "wikilink")（）」\[13\]。
  - 2012年12月 - 宣佈因財政理由關閉「Ameba Pico」。
  - 2019年3月15日 - 手機APP「Pigg EDEN」停止營運。\[14\]
  - 2019年12月2日
    -因Adobe不再支援[Flash的緣故](https://zh.wikipedia.org/wiki/Flash "wikilink")\[15\]，關閉電腦版「Ameba
    Pigg」、「Pigg Life」、「PiGG BRAVE」、「Pigg WORLD」、「Pigg CAFE」、「Pigg
    ISLAND」、及連帶影響到的「mobile Pigg」和「到哪都可以Pigg Life」等8項服務。\[16\]

## 主要服務

  - Ameba Blog（）
    提供[網誌服務](../Page/網誌.md "wikilink")。除了基本的網誌撰寫之外，也提供了讀者登錄、網誌排名等等附加的功能。
  - Ameba News（）
  ...
  - Ameba Now（）
    [使用者介面類似](https://zh.wikipedia.org/wiki/使用者介面 "wikilink")
    [Twitter](../Page/Twitter.md "wikilink")
    的微網誌服務。能夠發表140字以內的文字、表情符號和照片。也能「關注」其他會員，以及觀看名人、藝人所發表的文章。

## Ameba Pico關閉

2012年11月，亦即Ameba Pico關閉前一個月，Ameba
Pico宣佈該遊戲即將於12月7日關閉，引起玩家們很大的反應，更一度發起連署行動要求不要關閉。

在遊戲關閉的前後，不斷傳出不同說法的關閉傳聞，其中一個是指有一名婦女，說她的女兒差點被一名在Ameba
Pico認識的40幾嵗男人綁架並強奸，她強烈譴責Ameba
Pico並沒有阻止該一事件發生，更入稟法院起訴Ameba Pico，最終該名婦女起訴成功，Ameba
Pico要賠償大量罰金，導致資金不足而要關閉\[17\]。
...
## 外部連結
  ...
  - [Ameba
    Now](https://web.archive.org/web/20111005193442/http://now.ameba.jp/)

  - [Ameba Pigg](http://pigg.ameba.jp/)

  - [Pigg
    Life](https://web.archive.org/web/20111005154813/http://pigg-life.ameba.jp/)

**Apache
Camel**是一个基于规则路由和中介引擎，提供企业集成模式的Java对象(POJO)的实现，通过[应用程序接口](../Page/应用程序接口.md "wikilink")（或称为陈述式的Java领域特定语言（DSL））来配置路由和中介的规则。领域特定语言意味着Apache
...
FuseSource提供Camel的经测试、认证并提供支持的企业级版本，称作[FUSE Mediation
Router](http://fusesource.com/products/enterprise-camel/)。
...
## 外部链接
  ...
  - [Free chapter of Camel in
    Action](http://fusesource.com/fuse/apache-books/)
  - [CamelOne 2012 Conference](http://camelone.fusesource.com)
  - [Fuse Mediation Router based on Apache
    Camel](http://fusesource.com/products/enterprise-camel/)
  - Methods & Tools article - [Camel, an Open Source Routing
    Framework](http://www.methodsandtools.com/tools/tools.php?camel)
  - JDJ article - [SOA Made Easy with Open Source Apache
    Camel](http://opensource.sys-con.com/read/504392.htm)
  - DZone article - [Apache Camel: Integration
    Nirvana](http://architects.dzone.com/articles/apache-camel-integration)

...
2016年9月，時任Apache OpenOffice專案副總裁Dennis
Hamilton因缺乏足夠的人力維護，向專案成員發出電子郵件提議關閉OpenOffice專案。\[21\]
...
<File:AOO> Writer 4.0.0 Windows in Wine.png|Apache OpenOffice 4.0 Writer
<File:OpenOffice> Calc 4.0.png|Apache OpenOffice 4.0 Calc
<File:OpenOffice> Base 4.0.png|Apache OpenOffice 4.0 Base

  - 其他

[OpenOfficeorg3openfile.png](https://zh.wikipedia.org/wiki/File:OpenOfficeorg3openfile.png "fig:OpenOfficeorg3openfile.png")

  - 快速啟動:一個會在電腦開機時執行的小程式。該程式會將OpenOffice.org執行所需要的核心檔案和函式庫載入記憶體中，以便讓其他組件能更快速的被啟動。OpenOffice.org
    1.0版最為人詬病的一個缺點就是程式啟動花費時間過長，而這個小程式就是希望能改善這個問題。2.0版在這個部分作很多改善，而此後版本亦在此方面不斷提升。

<!-- end list -->

  - 巨集錄製器:可用來記錄使用者的操作並且可重複播放以自動化地完成一些重複性的工作。這個工具從最早期就是套件中的一員，它是從[StarOffice的BASIC衍生出來的](../Page/StarOffice.md "wikilink")。
...
## 外部連結
  ...
  - [Apache
    OpenOffice免安装版](http://portableapps.com/apps/office/openoffice_portable)（非官方）
  - [Apache
    OpenOffice官方正體中文站](http://zh.openoffice.org/new/zh_tw/index.html)
      - [Apache
        OpenOffice正體中文wiki站](http://wiki.services.openoffice.org/wiki/Zh-TW)
      - [OpenOffice補給站](http://ooo.tn.edu.tw/) - 提供Apache
        OpenOffice最新版下載、中文使用手冊及許多教學連結，還有討論版
      - [OpenOffice商用支援網站](http://www.openoffice.com.tw/)
      - [Apache
        OpenOffice範本繁體中文站](http://templates.openoffice.org/zh-hant)
  - [Apache
    OpenOffice官方简体中文站](http://zh.openoffice.org/new/zh_cn/index.html)
      - [Apache
        OpenOffice模板简体中文站](http://templates.services.openoffice.org/zh-hans)

### 參與中文翻譯

  - [OpenOffice.org開發及中文計劃](https://web.archive.org/web/20080504204402/http://zh.openoffice.org/new/zh_tw/dev-ooo-zh.html)
  - [Apache
    OpenOffice中文計劃說明](http://wiki.services.openoffice.org/wiki/Zh_project)
  - [Apache
    OpenOffice中文翻譯流程](http://wiki.services.openoffice.org/wiki/Zh-CN/HowTos/TransWorkflow)
  - [Apache
    OpenOffice中文翻譯須知](http://wiki.services.openoffice.org/wiki/Zh-CN/HowTos/TransGuide)
...
8.  [Oracle Donates OpenOffice.org To The Apache
    Foundation](http://techie-buzz.com/foss/oracle-openoffice-apache.html)

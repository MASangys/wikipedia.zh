**Apache
Tuscany**提供一个[面向服务的核心架构以支持简单快速地开发和运行面向服务的应用程序](https://zh.wikipedia.org/wiki/面向服务的架构 "wikilink")。其轻巧的运行环境为嵌入或加载到不同的平台而设计。Apache
...
[Category:面向服务体系相关产品](https://zh.wikipedia.org/wiki/Category:面向服务体系相关产品 "wikilink")
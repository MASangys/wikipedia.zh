...
最初，APR是作为[Apache
HTTP服务器的一部分而存在的](https://zh.wikipedia.org/wiki/Apache "wikilink")，但是[Apache软件基金会](../Page/Apache软件基金会.md "wikilink")将其延伸成一个单独的项目。其他的应用程序可以使用APR来实现平台无关性。
...
## 类似的项目
  ...
  - [Qt是具有类似功能的应用开发框架](https://zh.wikipedia.org/wiki/Qt_\(toolkit\) "wikilink"),
    同时支持[图形用户界面](../Page/图形用户界面.md "wikilink")开发。

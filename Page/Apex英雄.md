...
《Apex英雄》适用经典的大逃杀游戏规则，但加入了[英雄系统](https://zh.wikipedia.org/wiki/射击游戏 "wikilink")。游戏背景设定在《[-{zh-hans:泰坦天降2;
zh-hant:泰坦隕落2;}-](https://zh.wikipedia.org/wiki/泰坦隕落2 "wikilink")》的30年以后。游戏中并不会出现泰坦，但包含了很多《泰坦》的元素和特征。

游戏以3人小队为单位进行游戏，每局游戏最多有60人。队伍空投落地后需要寻找武器、弹药及其他装备，小队间互相战斗至最后存活一队为胜。游戏特有复活系统，如有队友死亡，玩家可以在时限内(60s)取得阵亡队友的旗帜，并将其携至重生点即可复活队友。同时，游戏也设有较为详细的标记功能，也可进行队伍语音。
...
| 地图                                                | 《Apex》 |
| ------------------------------------------------- | ------ |
| **-{zh-hans:诸王峡谷;zh-hant:王者峽谷;}-** (Kings Canyon) | 启用     |

### 英雄角色

每位玩家可以选择一位传奇角色进行游戏，每位英雄都有其独特的技能，玩家可以自定义其外观。目前游戏共有9位传奇英雄，其中“侵蝕”“幻象”和“辛烷”需要用游戏内货币解锁。

| 英雄                                             | 类型                          |
| ---------------------------------------------- | --------------------------- |
| **-{zh-hans:寻血猎犬;zh-hant:尋血犬;}-** (Bloodhound) | \-{zh-hans:信息;zh-hant:情報;}- |
| **直布罗陀** (Gibraltar)                           | \-{zh-hans:重装;zh-hant:坦克;}- |
| **-{zh-hans:命脉;zh-hant:生命線;}-** (Lifeline)     | 辅助                          |
| **探路者** (Pathfinder)                           | 辅助                          |
| **恶灵** (Wraith)                                | \-{zh-hans:输出;zh-hant:攻擊;}- |
| **-{zh-hans:班加罗尔;zh-hant:邦加羅爾;}-** (Bangalore) | \-{zh-hans:输出;zh-hant:攻擊;}- |
| **侵蚀** (Caustic)                               | \-{zh-hans:重装;zh-hant:坦克;}- |
| **幻象** (Mirage)                                | \-{zh-hans:输出;zh-hant:攻擊;}- |
|                                                |                             |
| **-{zh-hans:动力小子;zh-hant:辛烷;}-** (Octane)      | \-{zh-hans:输出;zh-hant:攻擊;}- |
...
游戏发布后，获得了玩家的积极评价。发布8小时后，玩家数达到100万\[10\]；24小时后，玩家数达到250万\[11\]；72小时内，玩家数达到1000万，同时在线玩家数突破了100万\[12\]。

根據統計,遊戲中有73%以上玩家使用過非法程式。

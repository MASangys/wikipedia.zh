...
Lisp程序员之间的一个争议是，该种语言的[S-表达式](../Page/S-表达式.md "wikilink")是否及应在多大程度上应该用其他形式的语法来补充。格雷厄姆认为当纯粹的S表达式过于冗长的情况下，应该使用额外的语法，他说：“我不认为我们应该在宗教上反对引入语法到Lisp。”格雷厄姆也认为，应该给程序员一个好的[性能分析](../Page/性能分析.md "wikilink")器解决方案来解决效率问题。\[6\]

### 反响

在2008年发布后，Arc产生了多种反应，有人称它只是Lisp或[Scheme](../Page/Scheme.md "wikilink")的一个扩展，而不是一个独立的编程语言。其他人则称赞Arc拆去了Lisp非必要的东西。Arc发布不久后，它被移植到[JavaScript](../Page/JavaScript.md "wikilink")，以及被一个基于[Eclipse](../Page/Eclipse.md "wikilink")的[IDE](../Page/集成开发环境.md "wikilink")“Schemescript”支持。\[7\]

## 範例

Arc的[Hello world程式碼](https://zh.wikipedia.org/wiki/Hello_world "wikilink")：

``` lisp
 (prn "Hello, World")
```

保罗·格雷厄姆（Paul Graham）使用了一个程序来说明Arc的简洁性。\[8\]它产生一个表单，包含一个字段，url"/said"。提交表单后会被带到一个带有“click here”链接的页面，该页面本身则会带回包含原来输入字段值的页面。
...
由于官方Arc分支发展缓慢，部分Arc社区的成员已开启非官方代码库存放非官方的修订、扩展和库。其中之一是**Anarki**，\[12\] permitted\[13\] anyone to submit changes to the project. 社区管理的wiki\[14\]是比官方网站更好的信息来源。

**Rainbow**\[15\]是以[Java](../Page/Java.md "wikilink")实现的一个Arc。

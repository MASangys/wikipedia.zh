...
2001年，[保罗·格雷厄姆](../Page/保罗·格雷厄姆.md "wikilink")宣布正在制作一个名为“Arc”的新的[Lisp](../Page/LISP.md "wikilink")。多年以来，他已撰写数篇文章描述该语言的特点与目标，并且Y
Combinator的一些内部项目已经用Arc编写，最受关注的是[Hacker
News网络论坛和新闻聚合程序](../Page/Hacker_News.md "wikilink")。Arc本身以[Racket](../Page/Racket.md "wikilink")编写。\[1\]
...
Arc的第一个公开发布版本出现于2008年1月29日，\[9\]以[Racket](../Page/Racket.md "wikilink")（那时为“PLT-Scheme”）实现。该版本以.tar压缩包形式发布，包含Arc的Racket源代码。一份教程\[10\]

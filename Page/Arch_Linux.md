...
Arch Linux 以社区 [Wiki](../Page/Wiki.md "wikilink") 的形式提供文档，称为 [ArchWiki](https://wiki.archlinux.org/index.php/Main_page_\(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87\))\[6\]\[7\]\[8\]。该 Wiki 经常编有特定主题的最新信息，受到了 Linux 社区的广泛认可，内容也应用在 Arch Linux 以外的领域。\[9\]

## 历史

  - 由[加拿大](../Page/加拿大.md "wikilink")程式設計師兼吉他手 Judd Vinet 从 2001 年早期开始开发 Arch Linux，并在 2002 年 3月 11 日正式发行 0.1 版。
  - 2007 下半年，Judd Vinet 退出了 Arch Linux 的开发，改由 [Aaron Griffin](https://zh.wikipedia.org/wiki/Aaron_Griffin "wikilink") 接手。\[10\]
  ...
  - 2017 年 1 月，宣布将放弃 [i686](https://zh.wikipedia.org/wiki/P6_微架構 "wikilink") 架构的支持，2017 年 2 月发布的安装介质中不再包含 [i686](https://zh.wikipedia.org/wiki/P6_微架構 "wikilink") 环境。\[12\]并与2017年11月底彻底抛弃 i686 支持。\[13\]

## 设计及原则

Arch Linux 是由二进制[軟體包組成的](https://zh.wikipedia.org/wiki/軟體包 "wikilink")，這些軟體包會针对 [x86-64](https://zh.wikipedia.org/wiki/x86-64 "wikilink") 优化以配合目前的硬體。類似 [Ports](../Page/Ports.md "wikilink")/[ebuild](https://zh.wikipedia.org/wiki/ebuild "wikilink") 也在 Arch Linux 上發展，即「Arch Build System」。

Arch Linux 项目（对开发者而言）注力于简洁主义，其贡献在于对发行版的组件提供具有良好注释的配置文件，而非带有图形界面的配置工具。\[14\] 因此該發行版被稱為適合“不惧怕命令行的中高级Linux用户”。\[15\]
...
以下原则构成了通常所指的 Arch 之道，或者说 Arch 的哲学。
  ...
  - 以用户为中心：Arch Linux 适用于乐于自己动手的用户，他们愿意花时间阅读文档，解决自己的问题。也鼓励每一个用户 参与 和贡献，报告和帮助修复 [bugs](https://bugs.archlinux.org/)，提供软件包补丁和参加核心 [项目](https://projects.archlinux.org/)，活跃的贡献者也有机会成为开发人员\[16\]。

## 优势

[Archlinux-gnome.png](https://zh.wikipedia.org/wiki/File:Archlinux-gnome.png "fig:Archlinux-gnome.png")

  - Arch Linux是针对特定处理器而优化过的，能够更好地利用[CPU周期以提高性能](https://zh.wikipedia.org/wiki/CPU "wikilink")。Arch Linux简单的设计让它容易被轻松扩展和配置成为任何想要的系统类型。
  ...
  - 與[Gentoo類似](https://zh.wikipedia.org/wiki/Gentoo "wikilink")，不同於其他大部分主流Linux發行版比如[Fedora](../Page/Fedora.md "wikilink")和[Ubuntu](../Page/Ubuntu.md "wikilink")。Arch Linux不採跨版本升級而採用「[滾動更新](https://zh.wikipedia.org/wiki/滾動更新 "wikilink")」，故Arch Linux的軟件包時常會維持在開發者的最新版本。

## 缺点

  - 安装过程简陋，缺乏直观的错误处理與[圖形化安裝界面](../Page/图形用户界面.md "wikilink")，需要用户有一定的Linux环境常识才能正确安装使用。
  - 包管理系统pacman在升级过程缺乏对系统核心组件的回溯保护，比如當用戶升級到錯誤的[內核會造成系統無法啟動](https://zh.wikipedia.org/wiki/內核 "wikilink")。
  - 系统软件缺乏严谨的测试管理机制，稳定性、可靠性不如[Redhat](https://zh.wikipedia.org/wiki/Redhat "wikilink")、[CentOS](../Page/CentOS.md "wikilink")、[Debian](../Page/Debian.md "wikilink")等发行版\[17\]，难以在企业用户中推广。

## 软件-{zh-hans:包; zh-hant:套件}-管理
...
*unstable*仓库已在2008年7月撤销，其中的大部分软件包也已移动至其他仓库。\[19\] 在官方仓库以外还存在一些非官方的用户仓库，其中最知名的是托管在Arch Linux站点上的[Arch User Repository](https://zh.wikipedia.org/wiki/#AUR "wikilink")（AUR）。此外也有不少用户独立建立的非官方仓库。\[20\]

### Arch 编译系统

Arch 编译系统 （Arch Build System，ABS）是一套能從源代码编译软件的类 [ports](https://zh.wikipedia.org/wiki/ports "wikilink") 系统。Pacman 是 Arch 下特定的二進制安裝包管理工具（也包括管理那些從 ABS 構建的二進制安裝包），而 ABS 則是 Arch 下特定的編譯工具，將源代碼編譯為一個可供安裝的 .pkg.tar.xz 包。

2017年5月15日，Arch Linux宣布放弃支持ABS，并推荐用户切换到 [ASP](https://github.com/falconindy/asp) \[21\]。
...
官方的Arch安裝程序是基於[CLI命令行界面](https://zh.wikipedia.org/wiki/CLI "wikilink"),對於那些需要[GUI圖形界面安裝環境的用戶](https://zh.wikipedia.org/wiki/GUI "wikilink")，可以選擇這些Live CD:
  ...
  - [Manjaro Linux](../Page/Manjaro_Linux.md "wikilink") - 一个提供[XFCE](../Page/Xfce.md "wikilink")/[KDE](../Page/KDE.md "wikilink")/[GNOME](../Page/GNOME.md "wikilink")桌面环境的发行版。
...
其他流行的衍生發行版包括Arch Linux ARM等。\[22\]

## 歷史版本

Arch Linux 的首个版本发行于 2002 年，但是发行周期较不规律 \[23\]，从 2012 年 7 月开始安装介质改为每月发行一次。目前 Arch Linux 安装是採用網路進行下載與升級。

...
Arctur-2是由30個Sugon節點構建的系統，每個節點有兩個[Intel Xeon](https://zh.wikipedia.org/wiki/至強 "wikilink") E5-2690v4處理器，其中每8個節點都配備4個[NVIDIA Tesla](../Page/NVIDIA_Tesla.md "wikilink") M60 GPU，此外每8個節點具有1024 [吉位元組的](https://zh.wikipedia.org/wiki/吉位元組 "wikilink")[內部儲存空間](../Page/電腦記憶體.md "wikilink")\[3\]\[4\]，並由Arctur所管理\[5\]。

...
Arduino这个名字来自意大利伊夫雷亚的一家酒吧，该项目的一些创始人过去常常会去这家酒吧。 酒吧以伊夫雷亚的Arduin命名，他是伊夫雷亚邊疆伯爵，也是1002年至1014年期间的[意大利国王](https://zh.wikipedia.org/wiki/意大利国王 "wikilink")\[2\]。

## 關於

它使用 [Atmel](https://zh.wikipedia.org/wiki/Atmel "wikilink") AVR 單片機，採用開放原始碼的軟硬體平台，構建於開放原始碼 simple I/O 介面板，並具有使用類似 Java，C 語言的 Processing/Wiring 開發環境。

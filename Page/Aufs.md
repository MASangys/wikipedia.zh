**aufs**（全称：**advanced multi-layered unification
filesystem**，**高级多层统一文件系统**）用于为[Linux](../Page/Linux.md "wikilink")[文件系统实现](../Page/文件系统.md "wikilink")。该名称最初是**AnotherUnionFS**的[首字母縮略字](../Page/首字母縮略字.md "wikilink")，但从第2版开始它代表“advanced
multi-layered unification filesystem”。

aufs是之前的的完全重写，2006年由开发\[1\]。它旨在提高可靠性和性能，但也引入了一些新概念，例如可写分支平衡\[2\]和其他改进——其中一些目前已在UnionFS
2.x分支中实现。

aufs被拒绝合并到主线Linux。它的代码被批评为是“稠密，不可读，无[注释](../Page/注释_\(计算机语言\).md "wikilink")”。\[3\]相反，[OverlayFS已被合并到Linux内核](../Page/OverlayFS.md "wikilink")。\[4\]\[5\]在数次尝试后，作者已经放弃。\[6\]
...
数个[Linux发行版已选择aufs作为UnionFS的替代品](../Page/Linux发行版.md "wikilink")，包括：
  ...
  - [Xandros](../Page/Xandros.md "wikilink") Linux发行版，可在ASUS [Eee
    PC](https://zh.wikipedia.org/wiki/華碩Eee_PC "wikilink") 901型号中使用
  ...
  - [Gentoo Linux](../Page/Gentoo_Linux.md "wikilink") LiveDVD
    11.2\[10\]
  ...
  - [Puppy
    Linux可以完全在内存中运行](../Page/Puppy_Linux.md "wikilink")，而更改在关机时保存。例如，Slacko
    5.3.3可运行为一个LiveCD。
...
## 外部链接
  ...
  - [A simple
    example](http://bbs.archlinux.org/viewtopic.php?pid=314698)
...
1.
2.  [Goals and new features of aufs in the project's
...
6.
7.
8.  [Linux Live scripts](http://www.linux-live.org/?changes) use AUFS

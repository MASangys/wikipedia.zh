**AutoKey**是一个用于[Linux和](../Page/Linux.md "wikilink")[X11的文本扩展](https://zh.wikipedia.org/wiki/X11 "wikilink")、替换软件。\[1\]它的灵感主要来自于商业的Windows软件‘PhraseExpress’。\[2\]它通过多种方法的其中一种来接收键盘事件并使用X事件进行扩展。\[3\]AutoKey可用来把缩写替换成完整的短语，还能纠正拼写错误和其他输入错误。\[4\]已知AutoKey目前可用于[GNOME和](../Page/GNOME.md "wikilink")[KDE桌面环境中](../Page/KDE.md "wikilink")。
...
## 另请参阅
  ...
  - [Xnee](https://zh.wikipedia.org/wiki/Xnee "wikilink"),
    可用来录制和重复操作的程序。

## 外部链接

  - [AutoKey](http://code.google.com/p/autokey) at [Google

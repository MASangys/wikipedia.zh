...
Autopackage是用來安裝那些二進制，或是預編譯的非核心應用程式（如[文書處理器](https://zh.wikipedia.org/wiki/文書處理器 "wikilink")、[網頁瀏覽器](https://zh.wikipedia.org/wiki/網頁瀏覽器 "wikilink")、或是[電腦遊戲](https://zh.wikipedia.org/wiki/電腦遊戲 "wikilink")），而不是核心[函式庫](../Page/函式庫.md "wikilink")或是如[作業系統殼層等的核心應用程式](../Page/殼層.md "wikilink")。
...
Autopackage包的程式會被安裝在[寫死](../Page/寫死.md "wikilink")的系統路徑，可能會導致與已有的軟體包衝突，

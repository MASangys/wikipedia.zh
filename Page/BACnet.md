...
在BACnet通訊協定問世後，美國Alerton公司就在1996年推出了一系列支援BACnet的[HVAC產品](https://zh.wikipedia.org/wiki/HVAC "wikilink")，從小型的[變風量控制器到操作員的工作站](https://zh.wikipedia.org/wiki/變風量控制器 "wikilink")。後來也有許多廠商開發支援BACnet的產品。到2016年12月為止，已有1089家公司申請了支援BACnet需要的設備商識別碼（Vender
ID）\[6\]。
...
每個BACnet設備都會有一份名為「[协议实现一致性声明](https://zh.wikipedia.org/wiki/协议实现一致性声明 "wikilink")」（Protocol

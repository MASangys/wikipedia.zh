**BD-J**（**Blu-ray Disc
Java**）為[藍光光碟](../Page/藍光光碟.md "wikilink")（[BD-Video](https://zh.wikipedia.org/wiki/BDMV "wikilink")）之互動式內容的基盤，由
...
[MHP](https://zh.wikipedia.org/wiki/Multimedia_Home_Platform "wikilink")（GEM）的封包媒體標準協定，GEM
為[數位電視之應用服務標準](https://zh.wikipedia.org/wiki/數字電視 "wikilink")。多用途的播放標準協定有
[Multimedia Home
Platform](https://zh.wikipedia.org/wiki/Multimedia_Home_Platform "wikilink")（DVB-MHP）；北美有線電視使用的標準協定有
OpenCable Application Platform（OCAP）；在美國播放用的標準協定有 Advanced Common
Application Platform（ACAP）。GEM 為
[ETSI](https://zh.wikipedia.org/wiki/歐洲電信標準協會 "wikilink")
的標準，DVB-MHP 為 [DVB](../Page/DVB.md "wikilink") 的標準。GEM
基礎類的標準一切皆遵循[昇陽電腦公司之](https://zh.wikipedia.org/wiki/昇陽 "wikilink")
...
## 使用 BD Live 的產品
  ...
  - [星艦戰將 3 :
    掠奪者](https://zh.wikipedia.org/wiki/星艦戰將_3_:_掠奪者 "wikilink")
...
## 相關條目
  ...
  - [HDi](https://zh.wikipedia.org/wiki/HDi "wikilink") - [HD

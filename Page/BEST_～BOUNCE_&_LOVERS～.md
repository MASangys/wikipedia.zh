...
<!-- end list -->
  ...
  - 本次『期間限定生産』僅發行「CD+DVD」（未發行「CD ONLY」、「通常盤」）。
...
5.  **Pearl Moon**
      -
        2nd專輯『grow into one』收錄曲。
6.  **Rain**
      -
        3rd專輯『feel my mind』收錄曲。
7.  **華**
      -
        3rd專輯『feel my mind』收錄曲。
8.  **hands**
      -
        14th單曲。
9.  **最後の雨〜Time Heals Version〜（最後的雨〜Time Heals Version〜）**
      -
        9th單曲的B面曲。\[
10. **Promise（承諾）**
      -
...
11. **you〜Piano Version〜**
      -
        19th單曲的改編版。本作品收錄在12張單曲連發的購買者特典「限定配信」單曲，首度CD化。
12. **come back**
      -
        1st專輯『affection』收錄曲。
13. **奇跡（奇蹟）**
...
14. **walk**
      -
        1st專輯『affection』收錄曲。幾乎固定為LIVE的最後一首結尾曲。
...
2.  **Crazy 4 U**
3.  **JUICY**
4.  **So Into You〜Short Version〜**
5.  **Selfish**
6.  **Candy feat.Mr. Blistah**

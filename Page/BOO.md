...
下面是一个在-{zh-hans:命令行; zh-hant:命令提示字元;}-上輸出[Hello
World的小程式](../Page/Hello_World.md "wikilink")：
...
官方網站提供了很好的入門課程：[BOO
Tutorial](https://web.archive.org/web/20080406194704/http://boo.codehaus.org/Tutorials)
...
目前有支援**BOO**的整合開發環境並不多：
  ...
  - [BooLangStudio](http://www.codeplex.com/BooLangStudio)在2008年八月釋出Alpha
    1，可以整合在Visual Studio 2008裡。

## 參見

  - [IronPython](../Page/IronPython.md "wikilink") -
    一個.Net平台上的[Python實作](../Page/Python.md "wikilink")，接近[Jython](../Page/Jython.md "wikilink")。
  - [Nemerle](../Page/Nemerle.md "wikilink") -
    一個高階的.Net靜態程式語言。他提供了函數導向、物件導向的特性，並提供了macro的特性。

**柏克萊封包過濾器**（Berkeley Packet Filter，縮寫 BPF），是[类Unix系统上](https://zh.wikipedia.org/wiki/类Unix "wikilink")[数据链路层](../Page/数据链路层.md "wikilink")的一种原始接口，提供原始链路层[封包的收发](https://zh.wikipedia.org/wiki/封包 "wikilink")，除此之外，如果网卡驱动支持[洪泛模式](https://zh.wikipedia.org/wiki/洪泛 "wikilink")，那么它可以让网卡处于此种模式，这样可以收到[网络上的所有包](https://zh.wikipedia.org/wiki/网络 "wikilink")，不管他们的目的地是不是所在[主机](https://zh.wikipedia.org/wiki/主机 "wikilink")。
...
## 外部链接
  ...
  - [讲述BPF的一份1993年的USENIX论文](http://www.tcpdump.org/papers/bpf-usenix93.pdf) (PDF)

...
HEVC全稱「」，意为「[高效率视频编码](../Page/高效率视频编码.md "wikilink")」。BPG的[容器格式旨在更符合一个通用图像格式](../Page/视频文件格式.md "wikilink")，而非HEVC中使用的原始比特流格式（通常放在其他容器格式中使用，例如[MP4](../Page/MP4.md "wikilink")文件格式）\[5\]\[6\]。

## 專利

BPG由於採用了部分HEVC技術，因此相信亦包含了部分HEVC持有的專利；基於這個技術上的門檻，[LWN.net](../Page/LWN.net.md "wikilink")認為BPG很難取代JPEG的地位\[7\]。

## 參看

  - [JPEG](../Page/JPEG.md "wikilink") - [H.265](https://zh.wikipedia.org/wiki/H.265 "wikilink")\[8\]
...
## 外部連結
  ...
  - [GitHub](../Page/GitHub.md "wikilink")上的[簡單BPG瀏覽器](https://github.com/asimba/pybpgviewer)

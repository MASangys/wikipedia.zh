...
**扔紙團：巡迴世界之旅**（*Paper Toss: World Tour*）是扔紙團的續集，遊戲背景為世界各地名勝。\[7\]

### 港口浩劫3D

**港口浩劫3D**（*Harbor Havoc 3D*）是一個模擬遊戲。遊戲中，玩家要指揮不同船隻駛進碼頭。\[8\]

### 玩偶衝擊2

**玩偶衝擊**（*Ragdoll Blaster 2*） 是玩偶衝擊的續集。\[9\]

### 觸擊騎士

**觸擊騎士**（*Strike Knight*）是一個模擬遊戲。\[10\]
...
**NinJump**是一個動作遊戲。遊戲中，玩家成為[忍者](../Page/忍者.md "wikilink")，攀爬牆壁、避開障礙和攻擊敵人。攀爬越高，分數越高。\[13\]

### 黑暗軍隊：防衛

**黑暗軍隊：防衛**（*Army of Darkness: Defense*）是一城堡防衛遊戲，目的是防止敵人到達城堡。

### Dragonvale

**Dragonvale**是一個模擬遊戲，中文名稱為「龍谷」，目的是盡量獲取最多的[龍](https://zh.wikipedia.org/wiki/龍 "wikilink")。根據公司的統計，本款遊戲的龍，品種多達上百種，每一種的長相、屬性都不同。

### Buganoids

**Buganoids**是一個動作遊戲。遊戲中，玩家成為太空人，攻擊各星球上的蟲。

### 豪華版NinJump

**豪華版NinJump**（*NinJump Deluxe*）是NinJump的改良版。遊戲增加了3個新關卡。

### Backflip老虎機

**Backflip老虎機**（Backflip Slots）是一個賭場老虎機遊戲。

### 麻將維度

**麻將維度**（*Mahjongg Dimensions*）是一個典型疊麻將遊戲。

### 形狀轉移

**形狀轉移**（*Shape Shift*）是一個模擬遊戲，玩家能轉換同色形狀以完成關卡。

## Android apps

### 扔紙團

**Android版扔紙團**是由iphone OS版扔紙團移至Android平台的遊戲。\[14\]

### Ninjump

**Android版Ninjump**是由iphone OS版Ninjump移至Android平台的遊戲。

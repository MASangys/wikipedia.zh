> 本文内容由[BamHI](https://zh.wikipedia.org/wiki/BamHI)转换而来。
...
`G `<span style="border-left:1px solid green;border-bottom:1px solid green">`G`</span><span style="border-bottom:1px solid green">` A T C`</span>` C`
`C C T A `<span style="border-right:1px solid green">`G`</span>` G`

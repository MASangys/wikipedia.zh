> 本文内容由[Berryz工房Single V Clips ③](https://zh.wikipedia.org/wiki/Berryz工房Single_V_Clips_③)转换而来。
...
1.  ジリリ キテル （Dance Shot Ver.）
2.  笑っちゃおうよ BOYFRIEND （Dance Shot Ver.）
3.  胸さわぎスカーレット （Dance Shot Ver.）
4.  胸さわぎスカーレット （Close-up Ver.）
5.  VERY BEAUTY （Dance Shot Ver.）
6.  告白の噴水広場 （Close-up Ver.）
7.  付き合ってるのに片思い （Close-up Ver.）

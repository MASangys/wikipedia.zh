...
`:name:type:offset:magic:mask:interpreter:flags`
  ...
  - `name`为二进制格式的名称。
  - `type`应为`E`或`M`类型
      - 若类型为`E`，则可执行文件格式由其[文件扩展名](../Page/文件扩展名.md "wikilink")进行识别：`magic`是与二进制格式相关联的文件扩展名；此时忽略`offset`和`mask`参数。
...
binfmt_misc可使[Java](../Page/Java.md "wikilink")程序直接传递至[Java虚拟机](../Page/Java虚拟机.md "wikilink")。\[6\]

除此之外，用户也可通过[Wine](../Page/Wine.md "wikilink")直接执行[可移植可执行](../Page/可移植可执行.md "wikilink")文件（为[MS-DOS](../Page/MS-DOS.md "wikilink")或[Microsoft Windows编译](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")）。举个例子，下列配置将使用[Wine](../Page/Wine.md "wikilink")运行DOS和Windows [EXE文件](../Page/EXE格式.md "wikilink")（根据“MZ”识别）：

`:DOSWin:M::MZ::/usr/bin/wine:`

要使用[Mono](../Page/Mono.md "wikilink")运行EXE（.NET）文件：\[7\]\[8\] `:CLR:M::MZ::/usr/bin/mono:`
...
[Category:Linux内核功能](https://zh.wikipedia.org/wiki/Category:Linux内核功能 "wikilink") [Category:特殊目的自由文件系统](https://zh.wikipedia.org/wiki/Category:特殊目的自由文件系统 "wikilink") [Category:标题中含下划线的条目](https://zh.wikipedia.org/wiki/Category:标题中含下划线的条目 "wikilink")
...
8.  [Guide:Running Mono Applications](http://www.mono-project.com/Guide:Running_Mono_Applications)
9.
...
### PCIe采集和播放
  ...
  - DeckLink HD Extreme
    3D：是支持[3D的](https://zh.wikipedia.org/wiki/3D "wikilink")[SD](https://zh.wikipedia.org/wiki/SD "wikilink")/[HD](https://zh.wikipedia.org/wiki/HD "wikilink")/2K
    4:4:4采集卡。
  - DeckLink 4K
    Extreme：是支持4:4:4和[3D的SD](https://zh.wikipedia.org/wiki/3D "wikilink")/HD/2K/4K采集卡。
...
### 视频处理
  ...
  - Teranex
    2D和3D处理器：是支持上、下、交叉、标准转换，以及[降噪等功能](https://zh.wikipedia.org/wiki/降噪 "wikilink")，配备Thunderbolt接口的转换器。
...
### 胶片修复
  ...
  - DaVinci
    Revival：是胶片修复软件，为Linux平台提供自动和[交互式工作流程](https://zh.wikipedia.org/wiki/交互式 "wikilink")。

### 转换器

  - Mini Converters：是广播级转换器。
  - Mini Converter Heavy
    Duty：是用高强度金属打造的小型转换器，适用于现场制作。该设备还有一款带有内部电池的版本：Battery
    Converters。
...
### 监看
  ...
  - DVI
    Extender：可用SDI电缆和矩阵传输或切换[电脑](https://zh.wikipedia.org/wiki/电脑 "wikilink")[显卡输出信号](https://zh.wikipedia.org/wiki/显卡 "wikilink")。
  - SmartView：是支持SD、HD和2K的LCD
    SDI[监视器](https://zh.wikipedia.org/wiki/监视器 "wikilink")。

...
### 先進功能
  ...
  - 在Blender，物體與數據是分離的，這使其可以快速塑模。
  - 可以將多個[場景合併至單一檔案](https://zh.wikipedia.org/wiki/場景 "wikilink")（稱為「.blend」的檔案）。
  - 所有blender所生成的「.blend」檔案均有完善的[向前](https://zh.wikipedia.org/wiki/向前兼容 "wikilink")、[向後版本的兼容性](https://zh.wikipedia.org/wiki/向後兼容 "wikilink")，同時亦具有完整的跨平台支援。
  - 自動定時儲存「.blend」免得因當機而出現資料遺失。
  - 所有場景、[物件](https://zh.wikipedia.org/wiki/物件 "wikilink")、[材料](../Page/材料.md "wikilink")、[材質](https://zh.wikipedia.org/wiki/材質 "wikilink")、[聲音](https://zh.wikipedia.org/wiki/聲音 "wikilink")、[圖片](https://zh.wikipedia.org/wiki/圖片 "wikilink")、[後期製作](https://zh.wikipedia.org/wiki/後期製作 "wikilink")[特效均可整合至最後生成的](https://zh.wikipedia.org/wiki/特效 "wikilink")「.blend」動畫檔。
...
[Architectural_render_02_(Blender).jpg](https://zh.wikipedia.org/wiki/File:Architectural_render_02_\(Blender\).jpg "fig:Architectural_render_02_(Blender).jpg") Cycles 是一種[路徑追蹤](https://zh.wikipedia.org/wiki/路徑追蹤 "wikilink")[算繪引擎](https://zh.wikipedia.org/wiki/算繪 "wikilink")，其設計為互動式且易於使用，同時支援許多製作特點。\[3\] 它以預設的附加元件方式安裝，在頂部標題列中啟用。

### 開放著色器程式語言（OSL）

Blender使用者可以使用[開放著色器程式語言](https://zh.wikipedia.org/wiki/開放著色器程式語言 "wikilink")（OSL）建立自己的節點，儘管需要注意的是GPU上不支援它。\[4\]
...
国家航空航天局 （[NASA](../Page/美国国家航空航天局.md "wikilink")）为[火星探测车“好奇”着陆三周年纪念日作出了交互web](../Page/火星科学实验室.md "wikilink")-软件\[7\]。探测车的动作、摄影机和机械手的操纵是基于 Blender 和 [Blend4Web](../Page/Blend4Web.md "wikilink") 创造的软件\[8\]实现的，也打了一些著名的使命事件\[9\]\[10\]。软件是在[SIGGRAPH](../Page/SIGGRAPH.md "wikilink")2015大会WebGL部分的开始在年提出的\[11\]。
...
第一套使用Blender專業影片是-{zh-hans:[蜘蛛侠2](https://zh.wikipedia.org/wiki/蜘蛛侠2 "wikilink");zh-hant:[蜘蛛人2](../Page/蜘蛛人2.md "wikilink");}-，在該片製作中用來繪製分鏡腳本。\[12\]

### 大象之梦（開源影片計劃：橙）

在2005年9月，有部份使用Blender的藝術家打算使用自由軟體製作一套短片，並將此計劃命名為「橙」。此計劃同時亦回饋了一些功能至Blender\[13\]\[14\]。

### 大雄兔（開源影片計劃：桃）

2007年10月1日「桃」開始運作，片名為[大雄兔](../Page/Big_Buck_Bunny.md "wikilink")，於2008年5月30日上映，是Blender基金會第2部開放版權、[創作共用授權的動畫電影](https://zh.wikipedia.org/wiki/創作共用 "wikilink")。不同於上一個影片[大象之梦](../Page/大象之梦.md "wikilink")，本篇全程無語音。
...
[Agent_327_-_A_feature_film_in_progress.webm](https://zh.wikipedia.org/wiki/File:Agent_327_-_A_feature_film_in_progress.webm "fig:Agent_327_-_A_feature_film_in_progress.webm") *特務327：Operation Barbershop*是為其動畫長片的三分鐘前導預告，它的故事根據於經典漫畫系列 - [Agent 327而來](https://zh.wikipedia.org/wiki/Agent_327 "wikilink")。

### Hero（英雄）

[HERO_-_Blender_Open_Movie-full_movie.webm](https://zh.wikipedia.org/wiki/File:HERO_-_Blender_Open_Movie-full_movie.webm "fig:HERO_-_Blender_Open_Movie-full_movie.webm") *Hero*是第一個開放電影專案，以展示了Blender 2.8 中的蠟筆工具的功能。

### Spring（春天）

[Spring_-_Blender_Open_Movie.webm](https://zh.wikipedia.org/wiki/File:Spring_-_Blender_Open_Movie.webm "fig:Spring_-_Blender_Open_Movie.webm") 2017年10月25日，混合機動畫工作室宣布製作一部即將上映的動畫短片，名為*Spring*。*Spring*已在2019年4月4日發布。\[15\]\[16\] 其目的是在Blender 2.8正式發布前測試其功能。\[17\]從影片中的描述是，“春天是一個牧羊女和她的狗，面對古老的靈魂，以繼續生命循環的故事。這部富有詩意和視覺震撼的短片，是由Andy Goralczyk創作和導演，靈感來自他在德國山區的童年。
...
11.
12.
13. [hair rendering](http://orange.blender.org/blog/hairy-issues)
14. [橙色影片計劃在Blender的介紹網站](http://orange.blender.org/)
15.
16.
17.
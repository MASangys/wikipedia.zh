...
术语Ｂ树可以指一个特定的方案，也可以指大体上一类方案。狭义上，一个Ｂ树在它内部节点中存储键值，但不需在叶子节点上存储这些键值的记录。大体上的一类包含一些变体，如[B+树](../Page/B+树.md "wikilink")和[Ｂ\*树](https://zh.wikipedia.org/wiki/Ｂ*树 "wikilink")。

...
(TR1)**[（英文）是](../Page/:en:C++_Technical_Report_1.md "wikilink")**ISO/IEC
TR 19768, C++ Library
Extensions（函式庫擴充）**的一般名稱。TR1是一份文件，內容提出了對[C++標準函式庫的追加項目](../Page/C++標準函式庫.md "wikilink")。這些追加項目包括了[正则表达式](../Page/正则表达式.md "wikilink")、[智能指针](../Page/智能指针.md "wikilink")、[哈希表](../Page/哈希表.md "wikilink")、[随机数生成器等](../Page/随机数生成器.md "wikilink")。TR1自己並非標準，他是一份草稿文件。然而他所提出的項目大多数已成為下次的官方標準（C++11）的一部分。這份文件的目標在於「為擴充的C++標準函式庫建立更為廣泛的現成實作品」。
...
新的組件被放置在`std::tr1`的[命名空間](../Page/命名空間.md "wikilink")（*[namespace](../Page/:en:namespace.md "wikilink")*）裡，以和現在的標準函式庫做區別。
...
#### 引用包装器(Reference Wrapper)
  ...
  - 可以对算法（*algorithms*）或仿函数（*function
    objects*）传递[引用](../Page/引用.md "wikilink")（*[references](../Page/:en:Reference#Computer_science.md "wikilink")*），而不是传递副本。
...
#### 智能指针(Smart Pointers)
  ...
  - 将*[Resource Acquisition Is
    Initialization](../Page/:en:Resource_Acquisition_Is_Initialization.md "wikilink")*(RAII)手法用於内存管理和異常安全性。
...
| 函数名                                                                                 | 函数原型                                                               | 数学表达式                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [连带拉盖尔多项式](../Page/拉盖尔多项式#广义拉盖尔多项式.md "wikilink")                                   | double **assoc_laguerre**( unsigned n, unsigned m, double x ) ;   | \({L_n}^m(x) = (-1)^m \frac{d^m}{dx^m} L_{n+m}(x), \text{ for } x \ge 0\)                                                                                                                                                                                                                                                                                                                                                                                                             |
| [连带勒让德多项式](../Page/连带勒让德多项式.md "wikilink")                                          | double **assoc_legendre**( unsigned l, unsigned m, double x ) ;   | \({P_l}^m(x) = (1-x^2)^{m/2} \frac{d^m}{dx^m} P_l(x), \text{ for } x \ge 0\)                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Beta 函数](../Page/Β函数.md "wikilink")                                                | double **beta**( double x, double y ) ;                            | \(\Beta(x,y)=\frac{\Gamma(x) \Gamma(y)}{\Gamma(x+y)}\)                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [第一类完全椭圆积分](../Page/椭圆积分#第一类完全椭圆积分.md "wikilink")                                   | double **comp_ellint_1**( double k ) ;                           | \(K(k) = F\left(k, \textstyle \frac{\pi}{2}\right) = \int_0^{\frac{\pi}{2}} \frac{d\theta}{\sqrt{1 - k^2 \sin^2 \theta}}\)                                                                                                                                                                                                                                                                                                                                                            |
| [第二类完全椭圆积分](../Page/椭圆积分#第二类完全椭圆积分.md "wikilink")                                   | double **comp_ellint_2**( double k ) ;                           | \(E\left(k, \textstyle \frac{\pi}{2}\right) = \int_0^{\frac{\pi}{2}} \sqrt{1 - k^2 \sin^2 \theta}\; d\theta\)                                                                                                                                                                                                                                                                                                                                                                         |
| [第三类完全椭圆积分](../Page/椭圆积分#第三类完全椭圆积分.md "wikilink")                                   | double **comp_ellint_3**( double k , double nu ) ;               | \(\Pi\left(\nu, k, \textstyle \frac{\pi}{2}\right) = \int_0^{\frac{\pi}{2}} \frac{d\theta}{(1 - \nu \sin^2 \theta)\sqrt{1 - k^2 \sin^2 \theta}}\)                                                                                                                                                                                                                                                                                                                                     |
...
| [第一类变形贝塞尔函数](../Page/第一类变形贝塞尔函数.md "wikilink")                                      | double **cyl_bessel_i**( double nu, double x ) ;                 | \(I_\nu(x) = i^{-\nu} J_\nu(ix) = \sum_{k = 0}^\infty \frac{(x/2)^{\nu + 2k}}{k! \; \Gamma(\nu + k + 1)}, \text{ for } x \ge 0\)                                                                                                                                                                                                                                                                                                                                                      |
| [第二类变形贝塞尔函数](../Page/第二类变形贝塞尔函数.md "wikilink")                                      | double **cyl_bessel_j**( double nu, double x ) ;                 | \(J_\nu(x) = \sum_{k = 0}^\infty \frac{(-1)^k \; (x/2)^{\nu + 2k}}{k! \; \Gamma(\nu + k + 1)}, \text{ for } x \ge 0\)                                                                                                                                                                                                                                                                                                                                                                 |
| [第三类变形贝塞尔函数](../Page/第三类变形贝塞尔函数.md "wikilink")                                      | double **cyl_bessel_k**( double nu, double x ) ;                 | \(\begin{align}
K_\nu(x) & = \textstyle\frac{\pi}{2} i^{\nu+1} \big(J_\nu(ix) + i N_\nu(ix)\big) \\
         & = \begin{cases}
             ...
             \end{cases}
\end{align}\) |
| [柱诺依曼函数](../Page/柱诺依曼函数.md "wikilink") [第二类柱贝塞尔函数](../Page/第二类柱贝塞尔函数.md "wikilink") | double **cyl_neumann**( double nu, double x ) ;                   | \(N_\nu(x) = \begin{cases}
                 \displaystyle \frac{J_\nu(x)\cos \nu\pi - J_{-\nu}(x)}{\sin \nu\pi}, & \text{for } x \ge 0 \text{ and } \nu \notin \mathbb{Z} \\[10pt]
                 \displaystyle \lim_{\mu \to \nu} \frac{J_\mu(x)\cos \mu\pi - J_{-\mu}(x)}{\sin \mu\pi}, & \text{for } x < 0 \text{ and } \nu \in \mathbb{Z} \\
             \end{cases}\)                                                                                                         |
| [第一类不完全椭圆积分](../Page/椭圆积分#第一类不完全椭圆积分.md "wikilink")                                 | double **ellint_1**( double k, double phi ) ;                     | \(F(k,\phi)=\int_0^\phi\frac{d\theta}{\sqrt{1-k^2\sin^2\theta}}, \text{ for } \left|k\right| \le 1\)                                                                                                                                                                                                                                                                                                                                                                                  |
| [第二类不完全椭圆积分](../Page/椭圆积分#第二类不完全椭圆积分.md "wikilink")                                 | double **ellint_2**( double k, double phi ) ;                     | \(\displaystyle E(k,\phi)=\int_0^\phi\sqrt{1-k^2\sin^2\theta}d\theta, \text{ for } \left|k\right| \le 1\)                                                                                                                                                                                                                                                                                                                                                                             |
| [第三类不完全椭圆积分](../Page/椭圆积分#第三类不完全椭圆积分.md "wikilink")                                 | double **ellint_3**( double k, double nu, double phi ) ;          | \(\Pi(k,\nu,\phi)=\int_0^\phi\frac{d\theta}{\left(1-\nu\sin^2\theta\right)\sqrt{1-k^2\sin^2\theta}}, \text{ for } \left|k\right| \le 1\)                                                                                                                                                                                                                                                                                                                                              |
| [指数积分](../Page/指数积分.md "wikilink")                                                  | double **expint**( double x ) ;                                    | \(\mbox{E}i(x)=-\int_{-x}^{\infty} \frac{e^{-t}}{t}\, dt\)                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [埃爾米特多項式](../Page/埃爾米特多項式.md "wikilink")                                            | double **hermite**( unsigned n, double x ) ;                       | \(H_n(x)=(-1)^n e^{x^2}\frac{d^n}{dx^n}e^{-x^2}\,\!\)                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [超几何级数](../Page/超几何级数.md "wikilink")                                                | double **hyperg**( double a, double b, double c, double x ) ;      | \(F(a,b,c,x)=\frac{\Gamma(c)}{\Gamma(a)\Gamma(b)}\sum_{n = 0}^\infty\frac{\Gamma(a+n)\Gamma(b+n)}{\Gamma(c+n)}\frac{x^n}{n!}\)                                                                                                                                                                                                                                                                                                                                                        |
...
| [黎曼zeta函数](../Page/黎曼zeta函数.md "wikilink")                                          | double **riemann_zeta**( double x ) ;                             | \(\Zeta(x) =
          \begin{cases}
             ...
             \end{cases}\)                                                                                                                                                                                                       |
| [第一类球贝塞尔函数](../Page/第一类球贝塞尔函数.md "wikilink")                                        | double **sph_bessel**( unsigned n, double x ) ;                   | \(j_n(x) = \sqrt{\frac{\pi}{2x}} J_{n+1/2}(x), \text{ for } x \ge 0\)                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [球诺依曼函数](../Page/球诺依曼函数.md "wikilink") [第二类球贝塞尔函数](../Page/第二类球贝塞尔函数.md "wikilink") | double **sph_neumann**( unsigned n, double x ) ;                  | \(n_n(x) = \left(\frac{\pi}{2x}\right)^{\frac{1}{2}}N_{n+\frac{1}{2}}(x), \text{ for } x \ge 0\)                                                                                                                                                                                                                                                                                                                                                                                      |
...
#### 哈希表(Hash Tables)
  ...
  - 完全是新的實作，不衍生自既有之程式庫。與既有之程式庫[API並不完全相容](../Page/API.md "wikilink")
...
[C++被設計成與](../Page/C++.md "wikilink")[C語言兼容](../Page/C語言.md "wikilink")，但由於不同的標準，C++並不是C的嚴格超集合。TR1試圖調和這些差異，透過對各種標頭檔，如<complex>、<locale>、<cmath>等進行擴充。
這些改變幫助C++能夠與[C99版本的C標準更為一致](../Page/C99.md "wikilink")（並非所有C99都包含於TR1）。

## 關聯項目

  - [C++11](../Page/C++11.md "wikilink")，C++新標準
  - [C99](../Page/C99.md "wikilink")，C語言標準
  - [Boost
    library](../Page/Boost_C++_Libraries.md "wikilink")，提供大量的C++程式庫，數個包含於TR1
  - [STL標準模板庫](../Page/标准模板库.md "wikilink")，現行[C++標準程式庫的一部分](../Page/C++標準程式庫.md "wikilink")

...
| [合流超几何函数](https://zh.wikipedia.org/wiki/合流超几何函数 "wikilink")                                                               | double **conf_hyperg**( double a, double c, double x ) ;          | \(F(a, c, x) = \frac{\Gamma(c)}{\Gamma(a)} \sum_{n = 0}^\infty \frac{\Gamma(a + n) x^n}{\Gamma(c + n) n!}\)                                                                                                                                                                                                                                                                                                                                                                           |

在计算机科学中，**C3算法**主要用于确定[多重继承](../Page/多重继承.md "wikilink")时，子类应该继承哪一个父类的[方法](../Page/方法_\(電腦科學\).md "wikilink")，即**方法解析顺序**（Method Resolution Order，**MRO**）。
...
1996年的[OOPSLA会议上](https://zh.wikipedia.org/wiki/OOPSLA "wikilink")，论文"A Monotonic Superclass Linearization for "\[1\]首次提出了C3超类线性化。被[Python](../Page/Python.md "wikilink") 2.3选作方法解析的默认算法\[2\]\[3\]。[Perl 6](../Page/Perl_6.md "wikilink")\[4\] [Parrot](../Page/Parrot虚拟机.md "wikilink"),\[5\], [Solidity](../Page/Solidity.md "wikilink"), 等面向对象语言\[6\]。也作为可选的、默认不是MRO的语言如[Perl 5从版本](../Page/Perl.md "wikilink")5.10.0.\[7\] 早期版本Perl 5的一个扩展实现，称为`Class::C3`发布于[CPAN](https://zh.wikipedia.org/wiki/CPAN "wikilink").\[8\]
...
给定 [C3_linearization_example.svg](https://zh.wikipedia.org/wiki/File:C3_linearization_example.svg "fig:C3_linearization_example.svg")
...
[Category:面向对象的程序设计](https://zh.wikipedia.org/wiki/Category:面向对象的程序设计 "wikilink") [Category:程式語言翻譯](https://zh.wikipedia.org/wiki/Category:程式語言翻譯 "wikilink")

1.
2.  [Python 2.3's use of C3 MRO](https://www.python.org/download/releases/2.3/mro/)
...
4.  \[<http://doc.perl6.org/type/Metamodel>::C3MRO Perl 6's use of the C3 MRO\]
5.  [Parrot uses C3 MRO](http://aspn.activestate.com/ASPN/Mail/Message/perl6-internals/2746631)
6.
7.  [C3 MRO available in Perl 5.10 and newer](https://metacpan.org/module/mro)
8.  \[<https://metacpan.org/module/Class>::C3 Perl 5 extension for C3 MRO on CPAN\]
9.
{{ infobox software | name = CGIProxy | developer = 詹姆士·马歇尔 | latest
release version = 2.1.8 (稳定) | latest release date = 2013-10-22 |
language = [Perl](../Page/Perl.md "wikilink") | genre =
[基于CGI的代理服务器](../Page/代理服务器.md "wikilink") | license =
...
1.  [CGIProxy常见问题 --
    CGIProxy的授权使用执照是什么?](http://www.jmarshall.com/tools/cgiproxy/faq.html#q9)
2.  [CGIProxy安裝指南](http://www.jmarshall.com/tools/cgiproxy/#install)
3.  <http://www.jmarshall.com/tools/cgiproxy/> 2012年4月官网更新列表
4.  <http://www.jmarshall.com/tools/cgiproxy/CHANGES.txt>
    官网'CHANGES.txt'链接
...
## UMing 問題
  ...
  - 不符合[兩岸三地任一字形標準](../Page/漢字標準列表.md "wikilink")，如「起」使用台港寫法「」，「角」使用中國大陸寫法「」，未必適合教育機構使用\[6\]。
  - UMing字型的「[陝西](https://zh.wikipedia.org/wiki/陝西 "wikilink")」之「-{陝}-」出錯，應是「阝+㚒（大+兩個『入』）」，現在卻是「阝+-{夾}-（大+兩個『人』）」，變成了另一个字（「-{陜}-」，「-{狹}-」的[本字](../Page/本字.md "wikilink")）。
...
## 外部連結
  ...
  - [CJKUnifonts的freedesktop.org主页](https://www.freedesktop.org/wiki/Software/CJKUnifonts/)

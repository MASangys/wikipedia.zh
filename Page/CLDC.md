...
是为运行在资源非常有限的设备（例如寻呼机或者手机）上的[J2ME应用程序制订的](../Page/J2ME.md "wikilink")[架构](../Page/架构.md "wikilink")。规范内容包括目标机器的特性、[虚拟机规范和基本的API等等](../Page/虚拟机.md "wikilink")。
有1.0和1.1两个版本。

## 典型需求

16/32位[CPU](../Page/CPU.md "wikilink")，至少160KB(1.0)或者192KB(1.1)[内存对](../Page/内存.md "wikilink")[Java平台可用](../Page/Java平台.md "wikilink")，某种网络的有限（经常是无线、低带宽和间歇）的连接。低功耗，可能是电池供电。

## 限制

  - CLDC 1.0 不支持[浮点运算](../Page/浮点.md "wikilink")，CLDC
    1.1支持（这是两个版本的最主要区别）。

## Profile

### [Mobile Information Device Profile](../Page/MIDP.md "wikilink")

为手机制订，包含面向[LCD的GUI](../Page/LCD.md "wikilink") API，而在MIDP
2.0则包括了基本的2D游戏API。为此编写的应用程序称为[MIDlet](../Page/MIDlet.md "wikilink")，它和applet在某些地方概念上似乎有些类似。
2005年以来，大多数新手机都支持MIDP，使其称为供下载的手机游戏的事实上的标准。

### [Information Module Profile](../Page/IMP.md "wikilink")（[JSR](../Page/JSR.md "wikilink") 195）

它是为类似[售货机](../Page/售货机.md "wikilink")、[网卡](../Page/网卡.md "wikilink")、[路由器](../Page/路由器.md "wikilink")、[电话等只有简单的或者根本没有显示功能的系统设计](../Page/电话.md "wikilink")，

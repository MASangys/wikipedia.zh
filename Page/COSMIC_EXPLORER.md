...
## 概要
  ...
  - 專輯以通常盤（CD）、初回限定盤A（CD+CD+Blu-ray
    Disc）及初回限定盤B（CD+CD+DVD）三種形態發售。初回限定盤CD收錄了單曲「FLASH」和純音樂版本，以及三人主持的電台節目。
...
## 外部連結
  ...
  -
  - [「COSMIC
    EXPLORER」專輯特設網站](http://sp.universal-music.co.jp/perfume/ce/)

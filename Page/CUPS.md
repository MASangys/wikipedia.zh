**CUPS**（）是一個[類Unix](../Page/類Unix.md "wikilink")[操作系統的組合式印刷系統](../Page/操作系統.md "wikilink")，允許一台電腦作為打印服务器。CUPS接受一個客戶端的電腦進程，並送到相應的[打印機](../Page/打印機.md "wikilink")。

CUPS是[自由軟件](../Page/自由軟件.md "wikilink")，使用[GNU通用公共许可证和](../Page/GNU通用公共许可证.md "wikilink")[GNU宽通用公共许可证的第](../Page/GNU宽通用公共许可证.md "wikilink")2版。

## 歷史

迈克尔·斯维特，Easy Software
Products的擁有者，於1997年開始開發CUPS。首次公開測試版於1999年發佈。\[1\]原本設計的CUPS使用，但由於LPD的限制和供應商不兼容，所以由[互聯網列印協定](../Page/互聯網列印協定.md "wikilink")(IPP)代替。CUPS被迅速預設為一些[Linux發行版的打印系統](../Page/Linux發行版.md "wikilink")，如[Red
Hat
Linux](../Page/Red_Hat_Linux.md "wikilink")。2002年3月，[蘋果公司在](../Page/蘋果公司.md "wikilink")[Mac
OS X
...
CUPS有一個web-based管理界面運行在631[端口](../Page/TCP/IP端口列表.md "wikilink")。\[4\]它可以遠程組織、監測打印作業並添加打印隊列和打印機。
...
GNOME CUPS
Manager可以添加新的打印機和管理CUPS的打印機和隊列。還有其他的第三方[應用程序用作管理打印](../Page/應用程序.md "wikilink"),如[GtkLP](http://gtklp.sourceforge.net)及其聯繫工具GtkLPQ及[GtkPSproc](https://web.archive.org/web/20080515193523/http://www.rastersoft.com/gtkpsproc.html)。

GNOME的窗口部件工具包，在2006年發佈的[GTK+](../Page/GTK+.md "wikilink")
...
1.  Michael Sweet (June 9, 1999), ["A Bright New Future for Printing on
    ...
    *[Linux Today](../Page/Linux_Today.md "wikilink")* & followup from
    Michael Sweet (June 11, 1999), ["The Future Brightens for Linux
...
2.  *Easy Software Products*, [CUPS Licensed for Use in Apple Operating
    ...
    ([press release](../Page/press_release.md "wikilink")), March 1,
    2002.

...
在某些专家眼中，CW复形的[同倫範疇](../Page/同倫範疇.md "wikilink")即使不是唯一的同伦范畴（基于技术原因，实际使用的版本是带基点的空间），也是同伦范畴的最佳候选。\[4\]因此，可能会得出非CW复形的空间的辅助构造需尽量避免。在这方面的基本结论是[布朗可表性定理](https://zh.wikipedia.org/wiki/布朗可表性定理 "wikilink")：同伦范畴上的[可表函子](../Page/可表函子.md "wikilink")可以借助CW复形来相当精简地刻划。

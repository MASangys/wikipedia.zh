...
使用者可以匯入電子書至calibre的電子書庫，不論是手動加入或是與閱讀器同步皆可。也可將線上內容加入並轉換為電子書。這個被稱做「recipes」的小程式是使用一種基於[Python](../Page/Python.md "wikilink")的語言寫成。電子書也可經由[USB或是郵件伺服器匯出到所有支援的閱讀器](https://zh.wikipedia.org/wiki/通用序列匯流排 "wikilink")。也可以直接郵寄電子書，例如傳送私人文件到[Kindle](../Page/Kindle.md "wikilink")電子書閱讀器。

如果主機端電腦正在運行，書庫的內容可以在遠端以網路瀏覽器訪問。在這種情況下，那些內容可以設定為以固定的間隔傳送至遠端（或稱為「訂閱」）。

calibre也支援轉換外部內容，如[RSS](../Page/RSS.md "wikilink")、[聚合器](../Page/聚合器.md "wikilink")協議等；同時也支援[網頁伺服器](../Page/網頁伺服器.md "wikilink")（[HTTP](../Page/超文本传输协议.md "wikilink")）。

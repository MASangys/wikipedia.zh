...
为了满足这些要求Canny使用了[变分法](../Page/变分法.md "wikilink")，这是一种寻找满足特定[功能](../Page/功能.md "wikilink")的[函数](../Page/函数.md "wikilink")的方法。最优检测使用四个[指数函数](../Page/指数函数.md "wikilink")项的和表示，但是它非常近似于[高斯函数](../Page/高斯函数.md "wikilink")的一阶[导数](../Page/导数.md "wikilink")。

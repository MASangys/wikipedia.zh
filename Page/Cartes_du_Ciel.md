...
它有一些在最昂貴的天文軟體中才有的應用程式中的許多功能。例如，Cartes du Ciel
can可以下載數位化的巡天星圖，和在星圖上添加影像。也有望遠鏡的使用介面和許多用途廣泛的顯示選項。

根據程式設計師的說法，將這個程式釋放成免費軟體，是因為「我寧願讓業餘的觀測者花錢買新的目鏡，也不願意他們花錢買天文軟體
\[1\]。」。派翠克還創建了一個月面圖的軟體：虛擬月面圖，這也是一個免費軟體\[2\]。
...
## 外部連結
  ...
  - [Cartes du Ciel Version 2.76首頁(Windows
    only)](http://astrosurf.com/astropc/oldversion/cartes/telecharg.html)
...
2.  [Virtual Moon Atlas -
    Sourceforge](http://sourceforge.net/projects/virtualmoon/)
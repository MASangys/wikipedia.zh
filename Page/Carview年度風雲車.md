...
#### 募集方法
  ...
  - ㊀使用網路登錄的情況完成投票「參加網誌企劃」（），用按鈕表示。
  - ㊁按下按鈕，顯示自己的網頁投稿畫面，投票內容將自動被顯示出來。
  - ㊂請在網頁上請填寫[片假名](../Page/片假名.md "wikilink")**2006年度風雲車！（）**的標題。
...
<!-- end list -->
  ...
  - ㊃網頁投稿畫面的主題上寫「網頁企劃用」，再交給我們。
  - ㊄之後，即使就那樣投稿也很好，等寫不完整的中斷評論自由地編輯，請投稿。
...
#### 募集條件
  ...
  - 依使用者為對象。成員登記是[這裏](http://carlife.carview.co.jp/startup/)。
...
1.  [カービュー・カー・オブ・ザ・イヤー 2006-2007](http://carlife.carview.co.jp/campaign/blog/2006cvcoty/)，{{〈}}carview.co.jp{{〉}}
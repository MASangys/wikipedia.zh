...
ChemSpider数据库以公开的网络数据库为主要数据来源。以下为ChemSpider的主要数据来源列表：

  -
<!-- end list -->

  - [美国食品药品监督管理局](../Page/美国食品药品监督管理局.md "wikilink")（FDA）

<!-- end list -->

  - 人类代谢组数据库（Human Metabolome Database）

<!-- end list -->

  - 《杂环化学》（Journal of Heterocyclic Chemistry）

<!-- end list -->

  - [京都基因与基因组百科全书](../Page/KEGG.md "wikilink")
...
<!-- end list -->
  ...
  - 《自然化学生物学》（Nature Chemical Biology）
...
<!-- end list -->
  ...
  -
此外，ChemSpider还允许注册用户添加化合物结构和光谱数据。
...
## 外部链接
  ...
  - [Chemspider网站](http://www.chemspider.com)

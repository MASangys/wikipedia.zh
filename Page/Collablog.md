**Collablog**是一個[網際網路內容出版系統](../Page/網際網路.md "wikilink")，也是一種[內容管理系統](../Page/內容管理系統.md "wikilink")（CMS）、部落格程式，它是以[PHP語言撰寫](../Page/PHP.md "wikilink")，並搭配[MySQL資料庫使用](../Page/MySQL.md "wikilink")。
...
## 特點
  ...
  - 支援[W3C網頁標準](../Page/W3C.md "wikilink")。
  - 支援XML-PRC離線編輯功能。
  - 支援IE、Mozilla Firefox、Opera、Safari等網際網路瀏覽器。
  - 支援模組、模板佈景。
  - 支援小工具、外掛、多國語言文件。
  - 支援[RDF](../Page/RDF.md "wikilink") 1.0、
    [ATOM](../Page/Atom.md "wikilink") 0.3
    、[RSS](../Page/RSS.md "wikilink") 2.0。
  - 支援[WAP](../Page/WAP.md "wikilink") 行動網頁格式。
  - 支援迴響驗證碼。
  - 支援[Trackback](../Page/Trackback.md "wikilink")。
  - 支援廣告迴響、引用過濾。
  - 支援搜尋內容時讓搜尋結果關鍵字點亮。
  - 顯示[RSS](../Page/RSS.md "wikilink") 功能於大多數網頁。
  - 內建網站狀態資訊顯示。
  - 內建來源網址(reference link)資訊顯示。
  - 支援[LDAP](../Page/LDAP.md "wikilink")。
  - 支援電子郵件認證。
  - 張貼文章可選擇多分類。
  - 可設定文章張貼排程。
...
## 支援模組
  ...
  - 行事曆Cal 模組可顯示平日行事曆與社群網路，支援RSS。
  - 網路相簿Album 模組提供簡單的上傳功能，與collablog本身的介面一致，支援RSS。
  - 討論區Forum 模組是簡單風格的討論板程式，支援RSS。
  - 待辦事項List 模組，支援RSS。

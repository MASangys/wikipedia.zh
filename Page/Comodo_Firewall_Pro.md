...
## 特点
  ...
  - Comodo Firewall是少数完全实现TCP/UDP全状态检测的个人防火墙。Comodo Firewall自身集成了COMODO已认证程序数据库，包括了近20,000个通过认证的可执行文件的数字认证（校验）信息。
...
[Category:防火墙软件](https://zh.wikipedia.org/wiki/Category:防火墙软件 "wikilink") [Category:免費軟件](https://zh.wikipedia.org/wiki/Category:免費軟件 "wikilink")

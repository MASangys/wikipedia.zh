...
## 外部链接
  ...
  -
  - [CoreOS 实战：CoreOS
    及管理工具介绍](http://www.infoq.com/cn/articles/what-is-coreos)

  - [CoreOS首页、文档和下载 - 服务器操作系统 -
    开源中国社区](https://www.oschina.net/p/coreos)

[分类:操作系统](https://zh.wikipedia.org/wiki/分类:操作系统 "wikilink")

...
注：观察期望比：即CpG位点的观察值（片段实际含有的CpG位点数目）和“期待值”的比值。“期待值”通常有两种算法：（C\*G）/LS\[4\]或（（C+G）/2）^2/LS\[5\]。其中，C、G代表胞嘧啶和鸟嘌呤的数目；LS代表片段长度（length
of sequence）。

很多哺乳动物基因组中的CpG岛和基因的起始位点相联系\[6\]。因此，CpG岛的存在对于基因的预测和解释具有帮助作用。

在哺乳动物基因组中，CpG岛的序列长度通常为300-3000bp，在约40%的基因的[啟動子附近都有发现](../Page/啟動子.md "wikilink")\[7\]。在人基因组中则有约70%的基因[啟動子有高CpG含量](../Page/啟動子.md "wikilink")。如前文提及，CpG位点的实际存在率比随机概率的结果要低得多\[8\]。
...
CpG岛以至少达到60%的理论CpG位点含量（可达到4-6%）为特征，而基因组中平均CpG含量只有约1%（CG抑制）。和在基因[编码区中的CpG位点不同](../Page/编码区.md "wikilink")，在基因正常表达时，位于基因启动子区中的CpG位点往往不会被[甲基化](../Page/DNA甲基化.md "wikilink")；这种现象表明启动子序列中的CpG位点的[甲基化很可能导致基因表达被抑制](../Page/DNA甲基化.md "wikilink")。DNA甲基化和组蛋白修饰是[基因铭印的核心过程](../Page/基因組銘印.md "wikilink")\[10\]。大多数组织间或正常样本和癌症样本间的甲基化差异发生在CpG岛附近（CpG

**cω**是一種尚在研究中的[程序设计语言](https://zh.wikipedia.org/wiki/程序设计语言 "wikilink")，專門應用於[平行運算的編程語言](https://zh.wikipedia.org/wiki/平行運算 "wikilink")。這種語言由[微軟研究院開發](../Page/微軟研究院.md "wikilink")。

...
Basic的快速开发能力](../Page/Visual_Basic.md "wikilink")。C\#由[安德斯·海尔斯伯格主持开发](../Page/安德斯·海尔斯伯格.md "wikilink")，微软在2000年发布了这种语言，希望借助这种语言来取代[Java](../Page/Java.md "wikilink")。C\#已经成为[Ecma国际和](../Page/Ecma国际.md "wikilink")[国际标准组织的标准规范](../Page/国际标准组织.md "wikilink")。
...
由於[顯示器](../Page/顯示器.md "wikilink")（標準[字體](../Page/字體.md "wikilink")、[瀏覽器等](../Page/瀏覽器.md "wikilink")）的技術限制，且大部分的[鍵盤配置上不存在](../Page/鍵盤配置.md "wikilink")[升記號](../Page/升記號.md "wikilink")（♯），所以[井號](../Page/井號.md "wikilink")（\#）被用於此[程式語言的名稱中](../Page/程式語言.md "wikilink")，約定在ECMA-334
C\#語言規範中\[1\]。
...
ECMA标准列出的C\#设计目标：
  ...
  - 此种语言的实现，应提供对于以下软件工程要素的支持：强类型檢查、数组维度检查、未初始化的变量引用检测、[自动垃圾收集](../Page/垃圾回收_\(计算机科学\).md "wikilink")（Garbage
...
原Borland公司的首席研发设计师[安德斯·海爾斯伯格](../Page/安德斯·海爾斯伯格.md "wikilink")（Anders
Hejlsberg）在微軟開發了[Visual J++](../Page/Visual_J++.md "wikilink")
1.0，很快的Visual
J++由1.1版本升級到6.0版。[SUN公司认为Visual](../Page/昇陽電腦.md "wikilink")
J++ 违反了Java开发平台的中立性，对微软提出了诉讼。2000年6月26日微软在奥兰多举行的“职业开发人员技术大会”（PDC
2000）上，發表新的语言C\#。C\#语言取代了Visual J++，語言本身深受Visual
Basic、Java、C和C++ 的影響。
...
<tbody>
<tr class="odd">
<td><p><a href="../Page/Ecma国际.md" title="wikilink">ECMA</a></p></td>
<td><p><a href="../Page/国际标准组织.md" title="wikilink">ISO</a>/<a href="../Page/国际电工委员会.md" title="wikilink">IEC</a></p></td>
<td><p>Microsoft</p></td>
<td></td>
<td></td>
</tr>
<tr class="even">
<td><p>C# 1.0</p></td>
<td><p><a href="http://www.ecma-international.org/publications/files/ECMA-ST-WITHDRAWN/ECMA-334,%202nd%20edition,%20December%202002.pdf">2002年12月</a></p></td>
<td><p><a href="http://www.techstreet.com/cgi-bin/pdf/free/378672/ISO+IEC+23270-2003.pdf">2003年4月</a></p></td>
...
<td><p>2003年4月</p></td>
<td><p>{{tsl|en|.NET Framework 1.1</p></td>
<td><p>.NET Framework 1.1}}</p></td>
</tr>
<tr class="even">
<td><p>{{tsl|en|C Sharp 2.0</p></td>
<td><p>C# 2.0}}</p></td>
<td><p><a href="https://web.archive.org/web/20121202194727/http://www.ecma-international.org/publications/files/ECMA-ST/Ecma-334.pdf">2006年6月</a></p></td>
<td><p><a href="http://standards.iso.org/ittf/PubliclyAvailableStandards/c042926_ISO_IEC_23270_2006(E).zip">2006年9月</a></p></td>
...
<tr class="even">
<td><p>{{tsl|en|C Sharp 4.0</p></td>
<td><p>C# 4.0}}</p></td>
<td><p>2010年4月</p></td>
<td><p>2010年4月</p></td>
<td><p><a href="../Page/.NET_Framework_4.0.md" title="wikilink">.NET Framework 4</a></p></td>
</tr>
<tr class="odd">
<td><p>C# 5.0</p></td>
...
<td><p>C# 6.0</p></td>
<td><p>colspan="2" rowspan="2" </p></td>
<td><p><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/language-specification/">草案</a></p></td>
<td><p>2015年7月</p></td>
<td><p><a href="../Page/.NET_Framework_4.6.md" title="wikilink">.NET Framework 4.6</a></p></td>
</tr>
<tr class="odd">
<td><p>C# 7.0</p></td>
<td></td>
<td><p>2017年3月</p></td>
<td><p><a href="../Page/.NET_Framework_4.6.2.md" title="wikilink">.NET Framework 4.6.2</a></p></td>
<td><p><a href="../Page/Microsoft_Visual_Studio.md" title="wikilink">Visual Studio 2017</a></p></td>
</tr>
<tr class="even">
<td><p>C# 7.1</p></td>
<td></td>
...
相對於[C和](../Page/C语言.md "wikilink")[C++](../Page/C++.md "wikilink")，這個語言在許多方面進行了限制和增強：

  - [-{zh-hans:指针;zh-hant:指標}-](../Page/指標.md "wikilink")（Pointer）只能用於不安全模式之中。大多數對象訪問通過安全的引用实现，以避免無效的調用，並且有許多-{zh-hans:算法;zh-hant:演算法}-用於-{zh-hans:验证;zh-hant:檢查}--{zh-hans:溢出;zh-hant:溢位}-，-{zh-hans:指针;zh-hant:指標}-只能用於調用值类型，以及受[垃圾收集控制的托管對象](../Page/垃圾回收_\(计算机科学\).md "wikilink")。
  - 對象不能被顯式釋放，代替為當不存在被引用時通過垃圾回收器回收。
  - 只允許[單一繼承](../Page/單一繼承.md "wikilink")（single
    inheritance），但是一個類可以實現多個[-{zh-hans:接口;zh-hant:介面}-](../Page/接口.md "wikilink")（interfaces）。
  - C\#比C++更加[類型安全](../Page/類型安全.md "wikilink")。-{zh-hans:默认;zh-hant:預設}-的安全轉換是[隱含轉換](../Page/隱含轉換.md "wikilink")，例如由短整型轉換為長整型和從派生類轉換為基類。而-{zh-hans:接口;zh-hant:介面}--{zh-hans:布尔型;zh-hant:布林數}-同整型，及枚举型同整型不允許隱含轉換，非[空-{zh-hans:指针;zh-hant:指標}-](../Page/空指標.md "wikilink")（通過引用相似對象）同用戶定義類型的隱含轉換字段被顯式的確定，不同於C++的複製構造函數。
  - 数组-{zh-hans:声明;zh-hant:宣告的}-語法不同（"int\[\] a = new int\[5\]"而不是"int
    a\[5\]"）。
  - [枚举位於其所在的](../Page/枚举.md "wikilink")[命名空間中](../Page/命名空間.md "wikilink")。
  ...
  - [屬性支持](../Page/屬性.md "wikilink")，使用類似訪問成員的方式調用。
  - 完整的[反射支持](../Page/反射_\(電腦科學\).md "wikilink")。
...
分部類別这个特性允许将一个類別的编写工作分配给多个人，一人写一个文件，便于[版本控制](../Page/版本控制.md "wikilink")。它又可以隔离自动生成的代码和人工书写的代码，例如设计[窗体应用程序时](../Page/窗体应用程序.md "wikilink")。

### 泛型

[泛型](../Page/泛型编程.md "wikilink")，或参数化类型，是被C\#支持的.NET
...
generics使用[具化生成泛型参数](../Page/具化.md "wikilink")，它允许优化和保存类型信息。\[2\]

### 静态類別

静态類別它不能被实例化，并且只能有静态成员。这同很多过程语言中的[模块概念相类似](../Page/模块_\(程序设计\).md "wikilink")。
...
类似于[Python中使用的](../Page/Python_\(消歧义\).md "wikilink")`yield`
...
匿名方法类似于函数式编程中的[闭包](../Page/闭包_\(计算机科学\).md "wikilink")。\[3\]
...
[委托签名的](../Page/委托_\(.NET\).md "wikilink")[协变和逆变](../Page/协变和逆变.md "wikilink"),\[4\]
...
[可空类型](../Page/可空类型.md "wikilink")（跟个问号，如`int? i =
...
假设`MyList`实现了`System.Collections.IEnumerable`且有一个`Add`方法method\[7\]
...
局部变量[类型推断](../Page/类型推断.md "wikilink")：
...
它只是一个[语法糖](../Page/语法糖.md "wikilink")，这个特性被匿名类型声明时所需要

### Lambda表达式

[Lambda表达式](../Page/Lambda表达式.md "wikilink")（無函式名稱的物件方法在程式語言中的表達語法）:
...
编译器翻译Lambda表达式为强类型委托或强类型[表达式树](../Page/表达式树.md "wikilink").
...
[扩展方法指](../Page/扩展方法.md "wikilink")，一个静态类包含this关键字作为方法的第一参数时，这个方法将被添加到该this的类型中：
...
允许代码生成器生成方法声明作为扩展点，如果有人在另一个部分类实现了它才会被包含于原代码编译。\[8\]
...
[Python或](../Page/Python_\(消歧义\).md "wikilink")[Ruby](../Page/红宝石.md "wikilink")。
...
在C\#中打開一個[Word文件](../Page/詞_\(語言\).md "wikilink")：
...
C\#
4.0支援[协变和逆变](../Page/协变和逆变_\(计算机科学\).md "wikilink")，例如在泛型介面可以加上in、out-{zh:修饰字;zh-hk:修饰字;zh-cn:关键字}-。
...
加入 out 變數；能夠直接宣告一個變數在它要傳入的地方，當成一個 out 的引數\[9\]
...
C\#并不被编译成为能够直接在[计算机上执行的](../Page/计算机.md "wikilink")[二进制本地代码](../Page/二进制.md "wikilink")。与[Java类似](../Page/Java编程语言.md "wikilink")，它被编译成为中间代码（Microsoft
Intermediate Language），然后通过[.NET
Framework的](../Page/.NET框架.md "wikilink")[虚拟机](../Page/虚拟机.md "wikilink")——被称为[-{zh-hans:通用语言运行库;zh-hant:通用語言執行層}-](../Page/通用語言運行庫.md "wikilink")——执行。
...
23270）。现在有一些独立的实现正在进行，包括：
  ...
  - [Baltie](../Page/Baltie.md "wikilink") - C\# IDE for children and
    young [Baltie](http://www.sgpsys.com)
...
C\# 有5個著名的編譯器（compilers）:
  ...
  - 最標準的C\# 的實作當屬[微軟自己推出](../Page/微軟.md "wikilink")、並被包含在[.NET
  ...
  - 由Novell贊助的[Mono](../Page/Mono_\(消歧義\).md "wikilink")
    ...
    Framework](../Page/.NET框架.md "wikilink")-{zh:类库;zh-hans:类库;zh-hant:類別庫}-。而Mono後來衍伸出由微軟認可的第三方套件[Xamarin](../Page/Xamarin.md "wikilink")。
  - [Dot GNU](../Page/DotGNU.md "wikilink") 專案也提供了另一個自由版本的C\#
    編譯器，也提供了[.NET
    Framework](../Page/.NET框架.md "wikilink")-{zh:类库;zh-hans:类库;zh-hant:類別庫}-的實作。
  - Borland提供了專案级的C\#
    -{zh:集成;zh-hans:集成;zh-hant:整合}-開發環境，內部所使用的編譯器仍是[微軟](../Page/微軟.md "wikilink")[.NET
    Framework所提供的C](../Page/.NET框架.md "wikilink")\#
    編譯器（這也意味著你仍須安裝[微軟的](../Page/微軟.md "wikilink")[.NET

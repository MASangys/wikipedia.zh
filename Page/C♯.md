...
<td><p><a href="https://zh.wikipedia.org/wiki/国际标准组织" title="wikilink">ISO</a>/<a href="../Page/国际电工委员会.md" title="wikilink">IEC</a></p></td>
<td><p>Microsoft</p></td>
<td></td>
<td></td>
</tr>
...
<td><p>2010年4月</p></td>
<td><p>2010年4月</p></td>
<td><p><a href="https://zh.wikipedia.org/wiki/.NET_Framework_4.0" title="wikilink">.NET Framework 4</a></p></td>
</tr>
<tr class="odd">
<td><p>C# 5.0</p></td>
...
<td><p>2015年7月</p></td>
<td><p><a href="https://zh.wikipedia.org/wiki/.NET_Framework_4.6" title="wikilink">.NET Framework 4.6</a></p></td>
</tr>
<tr class="odd">
<td><p>C# 7.0</p></td>
<td></td>
<td><p>2017年3月</p></td>
<td><p><a href="https://zh.wikipedia.org/wiki/.NET_Framework_4.6.2" title="wikilink">.NET Framework 4.6.2</a></p></td>
...
相對於[C和](https://zh.wikipedia.org/wiki/C语言 "wikilink")[C++](../Page/C++.md "wikilink")，這個語言在許多方面進行了限制和增強：
...
分部類別这个特性允许将一个類別的编写工作分配给多个人，一人写一个文件，便于[版本控制](../Page/版本控制.md "wikilink")。它又可以隔离自动生成的代码和人工书写的代码，例如设计[窗体应用程序时](https://zh.wikipedia.org/wiki/窗体应用程序 "wikilink")。
...
静态類別它不能被实例化，并且只能有静态成员。这同很多过程语言中的[模块概念相类似](https://zh.wikipedia.org/wiki/模块_\(程序设计\) "wikilink")。
...
[委托签名的](https://zh.wikipedia.org/wiki/委托_\(.NET\) "wikilink")[协变和逆变](https://zh.wikipedia.org/wiki/协变和逆变 "wikilink"),\[4\]
...
局部变量[类型推断](https://zh.wikipedia.org/wiki/类型推断 "wikilink")：
...
[Lambda表达式](https://zh.wikipedia.org/wiki/Lambda表达式 "wikilink")（無函式名稱的物件方法在程式語言中的表達語法）:
...
编译器翻译Lambda表达式为强类型委托或强类型[表达式树](https://zh.wikipedia.org/wiki/表达式树 "wikilink").
...
[扩展方法指](https://zh.wikipedia.org/wiki/扩展方法 "wikilink")，一个静态类包含this关键字作为方法的第一参数时，这个方法将被添加到该this的类型中：

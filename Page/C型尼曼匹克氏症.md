> 本文内容由[C型尼曼匹克氏症](https://zh.wikipedia.org/wiki/C型尼曼匹克氏症)转换而来。


**C型尼曼匹克氏症**(NP-C)是一種遺傳、不可逆性然而是可治療的慢性惡化性腦脊髓交感神經疾病，最低發生率粗估為1:100,000-1:120,000。\[1\]大部分患者的疾病特徵為漸進性、致殘性神經症狀與提早死亡。此疾病發病年齡差異甚大，可能會影響嬰兒、兒童與成人。

## 病理生理學

C型尼曼匹克氏症(NP-C)的主要生物性缺陷為細胞內脂質運送功能障礙，導致溶酶體脂質出現毒性囤積現象。\[2\]在周邊組織例如皮膚，囤積的主要是未酯化膽固醇，\[3\]然而在肝臟與脾臟內，會出現多種不同類型的脂質囤積，包括未酯化膽固醇、糖神經鞘脂質、磷脂質以及神經磷脂。\[4\]糖神經鞘脂質的囤積主要發生在中樞神經系統(CNS)，包括大腦內部。\[5\]

在正常細胞內，低密度脂蛋白(LDL)膽固醇會經由細胞吞噬作用，從LDL受體進入細胞並且被運送至後期核內體與溶酶體內，然後在此進行水解並以游離膽固醇型態被釋放出去。\[6\]\[7\]未酯化膽固醇會被運送至細胞質膜及內質網(ER)並於細胞內被回收。\[8\]

罹患NP-C時，LDL-膽固醇會被困在溶酶體內，導致未酯化膽固醇的運送作用大幅下降\[9\]\[10\]\[11\]。最終結果即為脂質囤積至有毒濃度，導致細胞及組織受損，造成NP-C症狀。\[12\]
...
NPC1與NPC2的基因產物(NPC1與NPC2蛋白質)對膽固醇的正常運輸作用非常重要。

  - NPC1蛋白質為大型膜糖蛋白，在脂質於晚期核內體、內質網(ER)以及細胞質膜之間的移動作用中具重要影響。\[17\]\[18\]

<!-- end list -->

  - NPC2蛋白質為小型可溶性溶酶體蛋白質，會在晚期核內體與溶酶體內，透過高親和力與膽固醇結合並進行運送。\[19\]\[20\]
...
[不同發病的年齡所表現出不同的NPC臨床症狀.png](https://zh.wikipedia.org/wiki/File:不同發病的年齡所表現出不同的NPC臨床症狀.png "fig:不同發病的年齡所表現出不同的NPC臨床症狀.png")

C型尼曼匹克氏症(NP-C)的症狀會因人而異，並可能會發生在不同疾病階段，有時候甚至完全不會出現。\[24\]這意謂著這些症狀不一定會立刻被發現並聯想到是C型尼曼匹克氏症(NP-C)，這可能會嚴重延誤診斷。\[25\]

NP-C的症狀可分為兩種－影響體內其他器官的非神經系統性(內臟系統症狀)，以及影響腦部及中樞神經系統的神經系統症狀。
...
由於C型尼曼匹克氏症(NP-C)是一種漸進性疾病，因此及早診斷是確保患者及早接受NP-C疾病特定療法，以達到穩定或延緩疾病惡化，並維持身體功能以及生活品質的關鍵，這是目前NP-C特定治療所能達到的最佳治療目標。其他治療策略同時包含非特異性之症狀療法。\[37\]

  - NP-C疾病特定療法

對NP-C更多的瞭解促進了NP-C治療的發展，NPC疾病特定療法進而可減緩疾病的惡化速度。\[38\]這種藥物又稱為鞘糖脂合成抑制劑，於2009年1月在歐盟取得上市許可，可協助預防負責運輸與儲存脂肪分子的蛋白質功能障礙所造成的脂肪分子堆積現象。研究顯示，此藥物可改善或穩定NP-C兒童、青少年以及成人患者漸進性神經系統疾病的重要病徵。\[39\]

  - 症狀療法

症狀療法無法影響疾病的惡化，但可改善生活品質，這些治療包括：\[40\]

  - 三環抗憂鬱劑或CNS興奮劑可治療發笑時造成的突發性肌肉無力/塌陷(痴笑性猝倒)
...
## 台灣的資源
  ...
  - 台大兒童醫院(可執行Filipin染色法及plasma oxysterol血漿氧固醇檢測法)
  - 彰化基督教醫院(可執行DNA鑑定法)
  - \[www.tfrd.org.tw 財團法人罕見疾病基金會\]
  - [罕見遺傳疾病一點通](https://web.archive.org/web/20150924021421/http://www.genes-at-taiwan.com.tw/genehelp/database/case/record_58_NPC.htm)

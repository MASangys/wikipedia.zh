...
D3.js除了有提供將載入的資料直接繪成物件的功能之外，也支援從檔案讀取資料並直接生成SVG圖像。此應用使得D3.js可以用簡單的程式碼完成與地理資訊相關的資料視覺化，而新版本的D3.js也改善了地理座標的轉換系統\[10\]，因此能準確地呈現包含地理資訊的圖表，例如「japan.json」中存了[日本的](../Page/日本.md "wikilink")[GeoJSON地理資訊](https://zh.wikipedia.org/wiki/GeoJSON "wikilink")，則D3.js可以直接並載入並顯示日本地圖：

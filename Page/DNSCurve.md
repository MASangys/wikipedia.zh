...
DNSCurve使用\[1\][椭圆曲线加密算法建立](https://zh.wikipedia.org/wiki/椭圆曲线加密算法 "wikilink")[Salsa20使用的密钥](../Page/Salsa20.md "wikilink")，配以MAC函数，用来加密和验证[解析器与身份验证服务器之间的DNS](../Page/域名系统.md "wikilink")[網路封包](https://zh.wikipedia.org/wiki/網路封包 "wikilink")。远端验证服务器的[公钥放在NS记录中](../Page/公开密钥加密.md "wikilink")，以便递归解析器了解服务器是否支持DNSCurve。键值以[魔术字符串](https://zh.wikipedia.org/wiki/魔术字 "wikilink")`uz5`开头，后随51字节的编码的服务器的255位公钥。例如，以[BIND格式来看](../Page/BIND.md "wikilink")：
...
服务超过5000万用户的于2010年2月23日宣布其递归解析器支持DNSCurve。\[14\]2011年12月6日，OpenDNS宣布名为[DNSCrypt的新工具](https://zh.wikipedia.org/wiki/DNSCrypt "wikilink")\[15\]该工具能保护OpenDNS与其用户之间的信道。\[16\]尚无其他类似的权威DNS提供商部署DNSCurve。

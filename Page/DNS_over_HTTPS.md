...
### 软件
  ...
  - **Firefox** — 浏览器支持\[14\]
  - **DNSCrypt-proxy** — Local DNS → DNS over HTTPS [proxy](https://zh.wikipedia.org/wiki/proxy "wikilink").\[15\]
...
9.  [Running a DNS over HTTPS - Cloudflare Resolver](https://developers.cloudflare.com/1.1.1.1/dns-over-https/cloudflared-proxy/)

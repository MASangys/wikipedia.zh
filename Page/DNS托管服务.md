...
通过在 通用[互联网托管服务](../Page/互联网托管服务.md "wikilink") 上运行 [域名解析系统软件](https://zh.wikipedia.org/wiki/域名解析系统 "wikilink")，你可以自己搭建一个DNS。

## 免费DNS

一些网站在提供付费的[二级域名](https://zh.wikipedia.org/wiki/二级域名 "wikilink")（或三级域名）注册登记、代管服务的同时，提供免费的DNS托管服务，也就是说，在这些网站注册或代管您的网站的时候，他们将协助您完成DNS服务的部署。 这些服务通常还包括动态DNS解析。 免费DNS提供商通常也提供针对 [A记录](https://zh.wikipedia.org/wiki/A记录 "wikilink")、邮件交换记录（[MX记录](../Page/MX记录.md "wikilink")）、别名指向记录（CNAME记录）、TXT和域名解析服务器记录（NS记录）等域名资源的管理服务。\[3\]大多数时候这些免费DNS服务的功能是受到限制的，通过付费购买高级版本，用户可以获得包括流量分析等在内的增值服务。

## 另见

  - [域名系统](../Page/域名系统.md "wikilink")
  - 快通DNS
  - [远程备份服务](https://zh.wikipedia.org/wiki/在线备份 "wikilink")
  - [列表DNS记录的类型](../Page/域名伺服器記錄類型列表.md "wikilink")

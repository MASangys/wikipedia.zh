...
**deb**是[Debian](../Page/Debian.md "wikilink")[软件包格式](https://zh.wikipedia.org/wiki/软件包 "wikilink")，[文件扩展名为](../Page/文件扩展名.md "wikilink")**.deb**，跟*Debian*的命名一样，deb也是因Debra
Murdock（Debian创始人[Ian
Murdock的前妻](https://zh.wikipedia.org/wiki/Ian_Murdock "wikilink")）而得名。
...
通过[Alien工具](../Page/Alien.md "wikilink")，可以将deb包转换成其他形式的[软件包](https://zh.wikipedia.org/wiki/软件包 "wikilink")。
...
deb 檔是使用 tar 包裝，包含了三個檔案：
  ...
  - control.tar.gz -
    ...
    <small>在dpkg 1.17.6 之后添加了对
    [xz](https://zh.wikipedia.org/wiki/xz "wikilink") 压缩和不压缩的 control
    元数据的支持。\[1\]</small>
  - data.tar.\* - 實際安裝的內容

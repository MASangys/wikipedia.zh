...
[机器架构](https://zh.wikipedia.org/wiki/机器架构 "wikilink")：
...
[安装程序](https://zh.wikipedia.org/wiki/安装程序 "wikilink")：

  - 新的模块化的精致安装程序[debian-installer](https://zh.wikipedia.org/wiki/debian-installer "wikilink")，包括整合在内的[硬件识别](https://zh.wikipedia.org/wiki/硬件识别 "wikilink")、[无人值守安装](https://zh.wikipedia.org/wiki/无人值守安装 "wikilink")
  - 支持30种语言
  - 包括多种显卡的图形界面配置
  - 改良的灵活任务选择系统，[debconf工具整合进许多软件包以增强易用性与友好性](https://zh.wikipedia.org/wiki/debconf "wikilink")
  - 可从DVD、CD、USB盘、软盘或网络安装
  - 从低版本升级可使用[aptitude或者](https://zh.wikipedia.org/wiki/aptitude "wikilink")[apt-get包管理工具](https://zh.wikipedia.org/wiki/apt-get "wikilink")，无须停机

[软件包](https://zh.wikipedia.org/wiki/软件包 "wikilink")：

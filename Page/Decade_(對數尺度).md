...
**decade**是在[對數尺度下](../Page/對數尺度.md "wikilink")，二個數量級之間10倍的差距。decade和[octave都是用來表示二個](../Page/octave_\(電子\).md "wikilink")[頻率之間的比例](../Page/頻率.md "wikilink")，也可能視為是對數單位\[1\]\[2\]。decade常用來描述頻率或是電子系統（如及[电子滤波器](../Page/电子滤波器.md "wikilink")）的[頻率響應](../Page/頻率響應.md "wikilink")。

## 計算

decade中10倍的差距可以和參考值相乘或相除，因此100 往上一個decade是1000 Hz，往下一個decade是10 Hz。重點是10倍的差距，單位本身不是重點，因此3.14 rad/s是31.4 rad/s往下一個decade。

若要確認二個頻率\(f_1\)及\(f_2\)之間相距多少decade，可以計算二個頻率的[對數](../Page/對數.md "wikilink")：
...
在表示電子電路的[頻率響應](../Page/頻率響應.md "wikilink")（例如[波德圖](../Page/波德圖.md "wikilink")），常常會在橫軸以頻率的decade對數尺度來表示，不會用其他線性的單位，因為用線性方式無法表示很大的頻率。例如的頻段是在20
...
電子設備的頻率響應常以per
decade的方式表示。例如圖中的波德圖在停止帶的斜率是-20 [dB](../Page/分貝.md "wikilink")/decade，表示頻率越增加10倍，其增益減少20 dB。

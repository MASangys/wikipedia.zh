**DenyHosts**是针对[SSH服务器的一个基于日志的](https://zh.wikipedia.org/wiki/SSH "wikilink")[入侵预防安全工具](../Page/入侵预防系统.md "wikilink")，是用[Python](../Page/Python.md "wikilink")编写的。其通过监测身份验证登录日志中失败的登录尝试，屏蔽这些登录者的IP地址，从而预防对SSH服务器的[暴力破解](https://zh.wikipedia.org/wiki/暴力破解法 "wikilink")。DenyHosts是由Phil
Schwartz开发的，他也是的开发者。

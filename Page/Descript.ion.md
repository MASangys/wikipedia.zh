**Descript.ion**是一种为文件提供注释的[文本文件](../Page/文本文件.md "wikilink")。文件扩展名 .ion 并没有特别的含义，只是和前文一起组成英文单词 Description，含义为‘描述、注释、备注’，其命名方式类似于*美味书签* 的网址 [Del.icio.us](https://zh.wikipedia.org/wiki/Del.icio.us "wikilink")。

## 格式

格式很简单，可视为[自由檔案格式](../Page/自由檔案格式.md "wikilink")。每行为一个文件的注释，由‘文件名+空格+注释行’组成，格式如下：
...
由于采用纯文本文件存储文件注释，**Descript.ion**风格文件注释拥有纯文本的一系列特点：

  - 文件注释便于用户编辑，用户可以用任何[文本编辑器](../Page/文本编辑器.md "wikilink")对文件注释进行修改。
  - 支持**Descript.ion**风格文件注释的软件能够在多种[操作系统](../Page/操作系统.md "wikilink")上提供一致的文件注释。
  - 多种软件之间能够互相兼容**Descript.ion**风格文件注释。
...
[Category:圖像檢視器](https://zh.wikipedia.org/wiki/Category:圖像檢視器 "wikilink") [Category:文件管理器](https://zh.wikipedia.org/wiki/Category:文件管理器 "wikilink")
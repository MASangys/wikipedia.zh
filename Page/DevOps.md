...
传统的软件组织将开发、IT运营和[质量保障设为各自分离的部门](../Page/品质保证.md "wikilink")，在这种环境下如何采用新的开发方法（例如[敏捷软件开发](../Page/敏捷软件开发.md "wikilink")），是一个重要的课题。按照从前的工作方式，开发和部署，不需要IT支持或者QA深入的跨部门的支持；而现在却需要极其紧密的多部门[协作](../Page/协作.md "wikilink")。而DevOps考虑的还不止是软件部署，它是一套针对这几个部门间[沟通与协作问题的流程和方法](../Page/沟通.md "wikilink")。\[5\]
...
从2009年起，相关的工作组、专业组织和[博客快速涌现](../Page/博客.md "wikilink")。\[9\]\[10\]\[11\]\[12\]

DevOps的引入能对产品交付、[测试](../Page/测试.md "wikilink")、功能开发和[维护](../Page/軟體維護.md "wikilink")（包括──曾经罕见但如今已屡见不鲜的──“[热补丁](../Page/hot_fix.md "wikilink")”）起到意义深远的影响。在缺乏DevOps能力的组织中，开发与运营之间存在着信息“鸿沟”──例如运营人员要求更好的可靠性和安全性，开发人员则希望[基础设施响应更快](../Page/基础设施.md "wikilink")，而业务用户的需求则是更快地将更多的特性发布给最终用户使用。这种信息鸿沟就是最常出问题的地方。

以下几方面因素可能促使一个组织引入DevOps：

1.  使用敏捷或其他[软件开发过程与方法](../Page/软件开发过程.md "wikilink")
2.  业务[负责人要求加快产品交付的速率](../Page/持份者.md "wikilink")
3.  [虚拟化](../Page/虚拟化.md "wikilink")\[13\]和[云计算基础设施](../Page/云计算.md "wikilink")（可能来自内部或外部供应商）日益普遍
4.  [数据中心自动化技术](../Page/数据中心.md "wikilink")\[14\]和[配置管理工具的普及](../Page/軟件配置管理.md "wikilink")
5.  有一种观点认为，目前占主导地位的“传统”美国式管理风格（“[斯隆模型](../Page/Alfred_P._Sloan.md "wikilink")
    vs
    模型”）\[15\]会导致“烟囱式[自动化](../Page/自动化.md "wikilink")”，从而造成开发与运营之间的鸿沟，因此需要DevOps能力来克服由此引发的问题。

DevOps经常被描述为“开发团队与运营团队之间更具协作性、更高效的关系”。由于团队间协作关系的改善，整个组织的[效率因此得到提升](../Page/效率.md "wikilink")，伴随频繁变化而来的生产环境的风险也能得到降低。
...
[Agile-vs-iterative-flow.jpg](https://zh.wikipedia.org/wiki/File:Agile-vs-iterative-flow.jpg "fig:Agile-vs-iterative-flow.jpg")
  ...
  - 减少变更范围:
    与传统的[瀑布式开发模型相比](../Page/瀑布式开发.md "wikilink")，采用敏捷或[迭代式开发意味着更频繁的发布](../Page/迭代式开发.md "wikilink")、每次发布包含的变化更少。由于部署经常进行，因此每次部署不会对生产系统造成巨大影响，应用程序会以平滑的速率逐渐生长。
    加强发布协调:
    靠强有力的发布协调人来弥合开发与运营之间的技能鸿沟和沟通鸿沟；采用[电子数据表](../Page/电子数据表.md "wikilink")、[电话会议](../Page/电话会议.md "wikilink")、[即时消息](../Page/即时消息.md "wikilink")、企业门户（wiki、sharepoint）等协作工具来确保所有相关人员理解变更的内容并全力合作。
...
一般而言，当企业希望将原本笨重的开发与运营之间的工作移交过程变得流畅无碍，他们通常会遇到以下三类问题：
  ...
  - 发布管理问题:
    很多企业有[发布管理问题](../Page/发布管理.md "wikilink")。他们需要更好的发布计划方法，而不止是一份共享的电子数据表。他们需要清晰了解发布的风险、依赖、各阶段的入口条件，并确保各个角色遵守既定流程行事。
...
发布协调人的角色（也被称为部署协调人或集成协调人）源自[发布管理或发布工程团队](../Page/发布管理.md "wikilink")。这个角色与[航空交通管制有些类似](../Page/航空交通管制.md "wikilink")──实时协调不同团队的行动，有效使用共享的资源（空域、航道、跑道、航站门），达到组织的总体目标（安全起降）。

传统意义上的发布管理往往只关注软件变更的计划与管理，发布协调则需要控制“将特定软件变更发布至生产环境”的整个过程。这项工作需要系统地管理所有与“将代码构建并部署到生产环境”相关的技术任务，也被称为“发布工程”。

[变更管理是跟踪企业IT环境中各种变化](../Page/变更管理.md "wikilink")──不管是应用程序还是基础设施的变化──的基本原则。变更管理是[ITIL](../Page/ITIL.md "wikilink")
v3的核心之一。
...
<!-- end list -->
  ...
  - [Nolio ASAP](http://www.noliosoft.com)

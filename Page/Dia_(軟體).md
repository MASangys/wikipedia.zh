**Dia**
\[1\]是[開放源碼的](https://zh.wikipedia.org/wiki/開放源碼 "wikilink")，是[GNU計劃的一部分](../Page/GNU.md "wikilink")，程式創立者是Alexander
Larsson。Dia使用[單一文件介面模式](https://zh.wikipedia.org/wiki/單一文件介面 "wikilink")，類似於[GIMP與](../Page/GIMP.md "wikilink")[Inkscape](../Page/Inkscape.md "wikilink")。

Dia將多種需求以模組化來設計，如[流程圖](https://zh.wikipedia.org/wiki/流程圖 "wikilink")、、[電路圖等](../Page/電路圖.md "wikilink")。各模組之間的符號仍是可以通用的，並沒有限制。
...
Dia能夠將流程圖匯出為多種格式如下：
  ...
  - [VDX](https://zh.wikipedia.org/wiki/VDX "wikilink")（Microsoft
    [Visio格式](https://zh.wikipedia.org/wiki/Visio "wikilink")）

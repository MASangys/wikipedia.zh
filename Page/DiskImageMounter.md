...
OS
X中的](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")[磁盘映像的实用工具](../Page/磁盘映像.md "wikilink")。和[BOMArchiveHelper一样](https://zh.wikipedia.org/wiki/BOMArchiveHelper "wikilink")，[双击它之后并不会出现](https://zh.wikipedia.org/wiki/双击 "wikilink")[GUI](../Page/图形用户界面.md "wikilink");

...
当下载整个[网页](https://zh.wikipedia.org/wiki/网页 "wikilink")，用户可以使用[通配符](../Page/通配符.md "wikilink")或[正则表达式](../Page/正则表达式.md "wikilink")匹配过滤器，从而选择只下载某几类文件（如所有[PDF文件](https://zh.wikipedia.org/wiki/PDF "wikilink")）。
...
## 外部链接
  ...
  - [DownThemAll\!在Firefox Add-ons网站中的下载页面](https://addons.mozilla.org/firefox/addon/201)

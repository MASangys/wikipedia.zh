...
`          --`[`template``   ``to``   ``display``   ``flag``   ``icon``
 ``and``   ``team``   ``link``   ``(e.g.``   ``fb,``   ``fbw,``
 ``bk,``   ``ih)``   ``e.g.``   ``"FIFA``   ``World``   ``Rankings"``
 ``=``   ``'fb',``   ``"FIFA``   ``Women's``   ``World``
 ``Rankings"``   ``'fbw',``   ``"FIBA``   ``World``   ``Rankings"``
 ``=``   ``'bk',``   ``"IIHF``   ``World``   ``Ranking"``   ``=``
 ``'ih'``   ``tries``   ``with``   ``country``   ``code,``   ``then``
 ``if``   ``error,``   ``tried``   ``with``   ``country``

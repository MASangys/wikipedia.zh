...
size (default=frameless) -- It will return a standard wiki-markup for
each image with a selectable size and separator (which may be html) --
e.g. {{\#invoke:Wikidata|getImages|P18|FETCH_WIKIDATA}} -- e.g.
...
`           out[#out + 1] = "`[`"``   ``..``   ``imgsize``   ``..``
 ``"`](https://zh.wikipedia.org/wiki/"_.._"File:"_.._filename_.._" "wikilink")`"`
`       end`

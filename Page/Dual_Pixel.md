> 本文内容由[Dual Pixel](https://zh.wikipedia.org/wiki/Dual_Pixel)转换而来。
...
Dual Pixel虽然名称中带有像素(Pixel)称呼，但却是一种在子像素(Subpixel)层面的改进设计，在[拜耳滤镜](../Page/拜爾濾色鏡.md "wikilink")（Bayer filter）结构前提下，于每一个彩色微透镜下布置互相独立的成对光电二极管\[5\]。根据不同需求，读取半(子)像素或全像素信息以进行后期处理。
...
Dual Pixel构造最初用于加强片上相位对焦点的分布与成像能力。究其原因在于数码单反相机[实时取景](https://zh.wikipedia.org/wiki/实时取景 "wikilink")（Live View）时，反光镜构造下的传统对焦系统无法工作，而佳能的对比度对焦算法相对较为缓慢。
...
佳能公司在2016年发布的[EOS 5D Mark IV上](https://zh.wikipedia.org/wiki/佳能_EOS_5D_Mark_IV "wikilink")，推出了 **Dual Pixel RAW** 功能。支持以RAW格式记录全部光电二极管获取信息，得到的RAW文件相比正常约为两倍大小\[11\]。
...
相机器材媒体们对Dual Pixel RAW功能提供的三项微调颇有微词，例如DP Review认为解像感补偿仅仅视作后期的一种AF微调手段\[13\]，而Photoblog.hk则表示鬼影控制功能略显不够彻底\[14\]。

而 IMAGING RESOURCE 转载了Iliah Borg（为RAWDigger图像查看器作者）文章，表示 Dual Pixel RAW 可以给出额外的一档宽容度空间\[15\]。
...
\*;ASUS
  ...
  -   - [ZenFone 4 (2017)](https://zh.wikipedia.org/wiki/華碩ZenFone_4_\(2017\) "wikilink")
      - [ZenFone 4 Pro](https://zh.wikipedia.org/wiki/ZenFone_4_Pro "wikilink")
...
## 外部链接
  ...
  - [全像素双核CMOS AF](http://www.canon.com.cn/specialsite/dualpixelcomsaf/) - 佳能（中国）
  - [EOS 70D开发访谈](https://web.archive.org/web/20160830065008/http://www.canon.com.cn/specialsite/eos70d/interview.html) - 佳能（中国）
  - [In-Depth Look Setting a New Standard in Mobile Photography: The Camera of the Galaxy S7 and Galaxy S7 edge](https://news.samsung.com/global/faces-of-innovation-galaxy-s7-s7-edge-why-happy-users-are-more-important-than-a-spec-sheet) - Samsung Newsroom
  - [《草评Canon Dual Pixel CMOS AF》](http://blog.sina.com.cn/s/blog_537633d70101cdqt.html) By 撞针

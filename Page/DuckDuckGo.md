...
DuckDuckGo的搜尋結果彙集了超過400個來源的內容\[10\]，包括、[Wolfram
Alpha](../Page/Wolfram_Alpha.md "wikilink")、[Bing](../Page/Bing.md "wikilink")、它的網路爬蟲程序DuckDuckBot\[11\]\[12\]\[13\]。它也會使用源於众包網站的數據（包括維基百科），把它們填入頁面上方的資訊框內，用以作主題的簡要介紹和展示其他相關主題。
...
溫伯格為了提高他的搜尋引擎結果質量，而把一些他相信為[內容農場的網站從中刪去](../Page/內容農場.md "wikilink")，其中包括聘請了自由職業作者來擇寫每日4000多篇文章的[EHow](../Page/EHow.md "wikilink")。溫伯格指它們是「為了在google搜尋引擎目錄中能獲得較佳的排名而產生的低質內容」。除此之外DuckDuckGo也會過濾含有大量廣告的頁面\[15\]。

### 即時答案

除了經索引的搜尋結果，DuckDuckGo還會在頁面的上方顯示跟關鍵詞相關的「即時答案」。即時答案的內容源於第三方[应用程序接口或靜態數據來源](../Page/应用程序接口.md "wikilink")。即時答案也被稱為「zeroclickinfo」的原因在於它意圖直接向用戶返回其所需要的答案，而不是提供一系列可能含有答案的相關網頁以供用戶點選。截至2019年4月6日，可用的即時答案類型已有1236種\[16\]。

即時答案的源代码是[開放的](../Page/开放源代码.md "wikilink")\[17\]，並寄存在GitHub上，使任何人都可以維護和修改之。

### Tor匿名服務

2010年8月，DuckDuckGo引入了只可通過[Tor網絡訪問的匿名化搜尋服务](../Page/Tor.md "wikilink")，並開設一個專用的出口節點，以其為經由Tor訪問DuckDuckGo的首選節點。這能使流量在經過一系列受到加密的中繼後才路由至目的地，保障用戶的匿名性。溫伯格指出：「我認為這很符合我們的私隱政策。若你在使用Tor的同時以DDG搜尋網絡的話，你就能享有經過端到端加密的搜尋服务。除此之外，若你使用了我們經加密的主頁，你的搜尋活動同樣會受到端到端加密」\[18\]。

### 語音搜尋

DuckDuckGo在2011年引進了服務，但只有在[Google
Chrome安裝了相關擴充功能的用戶才能使用](../Page/Google_Chrome.md "wikilink")\[19\]。

### Bangs

DuckDuckGo擁有一系列的「\!Bang」關鍵詞，這能讓用戶從DuckDuckGo跳轉至特定的第三方網站進行搜尋，其格式為「\!〔代表某個特定網站的關鍵詞〕〔搜尋關鍵詞〕」或「〔搜尋關鍵詞〕
\!〔代表某個特定網站的關鍵詞〕」（可用半角或全角），例如「\!g
wikipedia」即表示從DuckDuckGo跳轉到Google，要其搜尋「wikipedia」這一關鍵詞\[20\]。截至2019年4月，DuckDuckGo共有12,345個bangs關鍵詞，以供用戶跳轉至不同網站進行搜尋\[21\]。在2018年12月，共有約2,000個bangs關鍵詞遭到刪除，其中一些因網站關閉而被刪去，另一些則因為責任問題而被刪除（例如連結至盜版分享網站）\[22\]。
...
duck
goose」（跟「丢手绢」類近的一款遊戲）的影響，但除此之外沒有其他的關聯或隱喻。」\[37\]DuckDuckGo曾在[TechCrunch的Elevator](../Page/TechCrunch.md "wikilink")
Pitch Friday上亮相\[38\]。在BOSS Mashable挑战赛中，DuckDuckGo进入了决赛圈\[39\]。
...
[GNOME在](../Page/GNOME.md "wikilink")2013年9月26日發佈的[GNOME
Web](../Page/GNOME_Web.md "wikilink")3.10中把DuckDuckGo設為預設搜尋引擎，這一設置於其後版本中維持不變。\[50\]\[51\]
...
2014年11月10日，DuckDuckGo成為[Firefox的搜尋引擎選項之一](../Page/Firefox.md "wikilink")\[59\]。2016年5月30日，Tor專案公司把DuckDuckGo設為[Tor瀏覽器的預設搜尋引擎](https://zh.wikipedia.org/wiki/Tor瀏覽器 "wikilink")\[60\]\[61\]\[62\]。
...
湯姆·郝瓦達（Thom
Holwerda）在為《OSNews》評估各大搜尋引擎時，讚掦DuckDuckGo對私隱的重視及跳轉至其他特定網站搜尋的快捷方式。並批評Google「跟蹤你的差不多所有活動」，這一批評主要是基於[美國政府會把相關活動資訊視作傳喚證據的風險而作](https://zh.wikipedia.org/wiki/美國政府 "wikilink")\[71\]。在2012年，Google對批評其為壟斷企業的指責進行了回應，在回應中Google把DuckDuckGo視為競爭對手看待。溫伯格對此感到「捧腹不已般的高興」\[72\]。

学习编程的开源社区自由编程营（Free Code
Camp）创始人昆西·拉森说“如果有人对[谷歌极度不放心](https://zh.wikipedia.org/wiki/谷歌 "wikilink")，他会强烈推荐他们使用另一款搜索引擎DuckDuckGo。……谷歌的创建以黑客伦理为基础，他们在某些方面是把原则置于[利润之上的](https://zh.wikipedia.org/wiki/利润 "wikilink")”
\[73\]。
...
Garling）對此回應道：「我認為這篇文章在邏輯上犯了一些根本性的錯誤，因為流量的確增加了，且可從中看出作者對DuckDuckGo的理解有限」\[76\]。
...
## 外部連結
  ...
  -
[Category:搜尋引擎](https://zh.wikipedia.org/wiki/Category:搜尋引擎 "wikilink")

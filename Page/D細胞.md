...
D細胞分泌的體抑素能通過[G蛋白偶聯受體刺激胃部的](https://zh.wikipedia.org/wiki/G蛋白偶聯受體 "wikilink")[壁細胞](https://zh.wikipedia.org/wiki/壁細胞 "wikilink")（parietal cells），抑制腺苷酸环化酶的活性，使得[組織胺](../Page/組織胺.md "wikilink")的作用效果減弱，進而抑制胃酸的分泌。另外，D細胞還可以通過抑制促胃液素、[促胰液素](https://zh.wikipedia.org/wiki/促胰液素 "wikilink")（secretin）、組織胺等激素的分泌間接減少胃酸的分泌。體抑素的最終生理效果是大幅減慢消化的速度。

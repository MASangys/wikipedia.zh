**D語言**是一种[程式語言](../Page/程式語言.md "wikilink")，具备[多範型](../Page/多範型程式語言.md "wikilink")，例如[物件導向](../Page/物件導向程式設計.md "wikilink")、[指令式](../Page/指令式程式設計.md "wikilink")。由[沃尔特·布莱特和](../Page/沃尔特·布莱特.md "wikilink")[安德烈·亞歷山德雷斯庫所開發](../Page/安德烈·亞歷山德雷斯庫.md "wikilink")，起源自[C++](../Page/C++.md "wikilink")，深受C++的影響，然而其不是C++的变种，而是重新设计来自C++的部分特性，并受到其它程式語言觀念的影響，如[Java](../Page/Java.md "wikilink")、[C\#以及](../Page/C_Sharp.md "wikilink")[Eiffel](../Page/Eiffel.md "wikilink")。2007年1月2日釋出1.0穩定版本。版本2.0釋出於2007年1月17日。

Walter Bright本身是[Symantec C++](../Page/Symantec_C++.md "wikilink")
編譯器的作者，另一名作者[Andrei
Alexandrescu是](../Page/Andrei_Alexandrescu.md "wikilink")[Facebook的研究科学家](../Page/Facebook.md "wikilink")，他与一个团队用D语言重写一些Facebook的重要操作。\[1\]

## 特性

D的設計來自實際的C++用法的經驗教訓，而不是從理論的角度。D沿用了很多C/C++觀念，同時摒弃了一些概念，因此D並不完全相容C/C++代码。D实现了C++的功能，实现了[契約式設計](../Page/契約式設計.md "wikilink")（design
by
contract）、[單元測試](../Page/單元測試.md "wikilink")、真正的[模組性](../Page/模組性.md "wikilink")、[自動化記憶體管理](../Page/垃圾回收器.md "wikilink")（垃圾回收）、[第一類](../Page/第一類物件.md "wikilink")[数组](../Page/数组.md "wikilink")（first
class
array）、[关联数组](../Page/关联数组.md "wikilink")、[动态数组](../Page/动态数组.md "wikilink")、[数组切片](../Page/数组切片.md "wikilink")、[嵌套函数](../Page/嵌套函数.md "wikilink")（巢狀函式）、[內部類別](../Page/內部類別.md "wikilink")、[閉包的限制形式](../Page/闭包_\(计算机科学\).md "wikilink")、匿名函式、[編譯時期函式執行](../Page/編譯時期函式執行.md "wikilink")、[惰性計算以及革新的](../Page/惰性計算.md "wikilink")[模板語法](../Page/模板.md "wikilink")。D保有C++的性能以進行[低階程式設計](../Page/低階程式設計語言.md "wikilink")，並加入完整的[內聯](../Page/內聯組譯器.md "wikilink")[組譯器支援](../Page/組合語言.md "wikilink")。C++的[多重繼承改以Java](../Page/多重繼承.md "wikilink")
[單繼承與](../Page/多重繼承.md "wikilink")[介面混合的風格取代](../Page/接口_\(Java\).md "wikilink")。D的宣告、語句和表達式[語法幾乎和C](../Page/語法學.md "wikilink")++一樣。

內聯組譯器（inline
assembler）象徵了D和[Java](../Page/Java.md "wikilink")、[C\#等應用程式語言的不同](../Page/C_Sharp.md "wikilink")。內聯組譯器讓程式員輸入機器特定的[組合語言碼](../Page/組合語言.md "wikilink")，如同標準D代碼—通常由系統程式員使用的技術，以存取[處理器的低階功能](../Page/CPU.md "wikilink")，直接以[硬體下的界面執行程式](../Page/硬體.md "wikilink")，如[作業系統以及](../Page/作業系統.md "wikilink")[驅動程式](../Page/驅動程式.md "wikilink")。

D內建支援文件註解，不過目前為止，只有Digital
Mars實作版本有提供[文件產生器](../Page/文件產生器.md "wikilink")。
...
以模板組合、編譯時期函式執行、[多元組以及字串混合來支援元程式設計](../Page/多元組.md "wikilink")。

### 記憶體管理

記憶體通常以[垃圾回收管理](../Page/垃圾回收器.md "wikilink")，不過當這些物件超出作用域時，可立即結束指定的物件。還是可以使用[重載運算子new和delete](../Page/運算子重載.md "wikilink")，以及簡單的直接呼叫[C的malloc函数和free函数以進行顯示的記憶體管理](../Page/C語言.md "wikilink")。垃圾回收可禁用個別的物件或事件，以健全整個程式，如果在記憶體管理上有更多的控制，則更為理想。當垃圾回收在程式中有所不足時，手冊還提供許多如何實作不同的高度最佳化記憶體管理方案的範例。

### 與其它系統的相互作用

支援[C的](../Page/C語言.md "wikilink")[應用程式二進制介面（ABI）](../Page/ABI.md "wikilink")，以及C的基本和衍伸型態，就能直接存取現有的C代碼以及程式庫。C的標準[函式庫也是D標準的一部分](../Page/函式庫.md "wikilink")。除非你使用非常清楚的命名空間，它可以稍微散亂的存取，因為它散佈遍及於D模組—不過純粹的D標準函式庫也通常夠用，除非要與C代碼接合。

並未完整支援C++的ABI，儘管D可以存取寫給C
ABI的C++代碼，且可存取C++[COM（元件物件模型）代碼](../Page/元件物件模型.md "wikilink")。D語法分析器了解外部（C++）呼叫約定，以連結C++物件，不過它只實作在[D
2.0](../Page/#D_2.0.md "wikilink")。

## D 2.0

D 2.0，D
新一代版本，D2.0与D1.0是不兼容的，类似Python2和Python3的区别。目前D2已经稳定下来。其中一部分特性包括支援強制[常數正確性](../Page/常數正確性.md "wikilink")（const-correctness），以及有限的支援連結以
[C++](../Page/C++.md "wikilink") 編寫的代碼。

## 实现

目前D直接[編譯成](../Page/編譯器.md "wikilink")[原生碼以高效執行](../Page/原生碼.md "wikilink")。

D语言1.x版本已稳定，不再功能变更或扩展，2.0版本是其正式版本，不完全相容舊版本的語言和編譯器。官方編譯器由[Walter
Bright定義語言本身](../Page/Walter_Bright.md "wikilink")。

  - [DMD編譯器](http://www.digitalmars.com/d/dcompiler.html)：Digital Mars
    D編譯器，由Walter Bright編寫的官方D編譯器。編譯器前端的授權許可为[Artistic
    License和](../Page/Artistic_License.md "wikilink")[GNU](../Page/GNU.md "wikilink")
    [GPL兩者](../Page/GPL.md "wikilink")；前端的原始碼連同編譯器執行碼一起發佈。編譯器的後端則是私有的。
...
recurring template pattern）的使用](../Page/CRTP.md "wikilink")。

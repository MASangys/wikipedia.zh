...
此系统和[嵌入式](https://zh.wikipedia.org/wiki/嵌入式 "wikilink")[Linux](../Page/Linux.md "wikilink")系统的差异是它采用静态链接[(static library)的方式](https://zh.wikipedia.org/wiki/\(static_library\) "wikilink")，最低编译核心可小至10K的级别，适合用于做[bootloader增强](https://zh.wikipedia.org/wiki/bootloader "wikilink")，或者用于构建微小型系统。 eCos的发行版还包括[RedBoot](https://zh.wikipedia.org/wiki/RedBoot "wikilink")，一个[开放原始码的](https://zh.wikipedia.org/wiki/开放原始码 "wikilink")[应用程序](../Page/应用程序.md "wikilink")。它使用[硬件抽象层提供](https://zh.wikipedia.org/wiki/硬件抽象层 "wikilink")[嵌入式系统](../Page/嵌入式系统.md "wikilink")的启动[固件](https://zh.wikipedia.org/wiki/固件 "wikilink")。

除了自由版本以外，eCos还有一个称为**eCosPro**的商业版本。它是eCos的一个商业分支，由[eCosCentric开发](https://zh.wikipedia.org/wiki/eCosCentric "wikilink")，并包含有私有组件。它是稳定并经过测试和认证的版本\[4\]。在2017年，2017, eCosCentric发布了\[5\]对于全部树莓派单板计算机的eCos移植，并同时发布了这些移植的自由版本。
...
eCos可以在一系列平台上运行，包括如下架构：
  ...
  - [CalmRISC](https://zh.wikipedia.org/wiki/CalmRISC "wikilink")
  - [FR-V](https://zh.wikipedia.org/wiki/FR-V "wikilink")
  - [Hitachi H8](https://zh.wikipedia.org/wiki/Hitachi_H8 "wikilink")
  - [IA-32](https://zh.wikipedia.org/wiki/IA-32 "wikilink")
  - [Motorola 68000](https://zh.wikipedia.org/wiki/Motorola_68000 "wikilink")
  - [Matsushita AM3x](https://zh.wikipedia.org/wiki/Matsushita_AM3x "wikilink")
...
[Category:实时操作系统](https://zh.wikipedia.org/wiki/Category:实时操作系统 "wikilink") [Category:自由作業系統](https://zh.wikipedia.org/wiki/Category:自由作業系統 "wikilink") [Category:嵌入式操作系统](https://zh.wikipedia.org/wiki/Category:嵌入式操作系统 "wikilink")

...
EDE桌面环境没有像KDE、GNOME等桌面环境那样广泛应用于linux。EDE在MINIX 3中作为可选包，\[2\] [Mandriva Linux](../Page/Mandriva_Linux.md "wikilink")（2009.0之后的版本）以及Arch Linux也支持该桌面环境。\[3\]

## 参考文献

## 外部链接

  - [EDE Website](http://equinox-project.org)

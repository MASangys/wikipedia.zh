...
1.  [DDC/CI
    specifications](http://www.boichat.ch/nicolas/ddcci/specs.html)
2.  [read-edid software for Linux and
    Windows](http://www.polypux.org/projects/read-edid/)
3.  [Powerstrip for Windows
    (Shareware)](http://www.entechtaiwan.com/util/ps.shtm)
4.  [SwitchResX for Mac OS X shows EDID and customizes display
    timings](http://www.madrau.com/)
5.  [DisplayConfigX for Mac OS X shows EDID and customizes display
    timings](http://www.3dexpress.de/)
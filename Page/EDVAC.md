...
**离散变量自动电子计算机**（，）是一台[美国早期](../Page/美国.md "wikilink")[电子计算机](https://zh.wikipedia.org/wiki/电子计算机 "wikilink")。与它的前任[ENIAC不同](https://zh.wikipedia.org/wiki/ENIAC "wikilink")，EDVAC采用[二进制](https://zh.wikipedia.org/wiki/二进制 "wikilink")，而且是一台[冯·诺伊曼结构的计算机](../Page/冯·诺伊曼结构.md "wikilink")。
...
EDVAC的初步[预算为十万](https://zh.wikipedia.org/wiki/预算 "wikilink")[美元](../Page/美元.md "wikilink")，但最终的成本大约超过估计的4倍，约五十万美元。

## 技术说明

EDVAC使用了大约6000个[真空管和](../Page/真空管.md "wikilink")12000个[二极管](https://zh.wikipedia.org/wiki/二极管 "wikilink")，占地45.5[平方米](../Page/平方米.md "wikilink")，重达7850千克，消耗电力56[千瓦](https://zh.wikipedia.org/wiki/千瓦 "wikilink")
...
物理上包括：
  ...
  - 一个磁带记录仪
  - 一个连接[示波器的控制单元](../Page/示波器.md "wikilink")
  - 一个分发单元，用于从控制器和内存接受指令，并分发到其他单元
  - 一个运算单元
  - 一个[定时器](https://zh.wikipedia.org/wiki/定时器 "wikilink")
  - 使用[汞延迟线的存储器单元](../Page/延迟线存储器.md "wikilink")

## 安装与运行

EDVAC于1949年8月交付给弹道研究实验室。在发现和解决许多问题之后，直到1951年EDVAC才开始运行，而且局限于基本功能。延迟的原因是因为莫奇利和艾克特从宾夕法尼亚大学离职，开始组建莫奇利-艾克特电子计算机公司并带走了大部分高级工程师，由此与宾夕法尼亚大学产生了[专利纠纷](../Page/专利.md "wikilink")。

到1960年，EDVAC每天运行超过20小时，平均8小时[无差错时间](https://zh.wikipedia.org/wiki/无差错时间 "wikilink")。EDVAC的硬件不断升级，1953年添加穿孔卡片输入输出；1954年添加额外的磁鼓内存；1958年添加[浮点运算单元](https://zh.wikipedia.org/wiki/浮点运算单元 "wikilink")。

直到1961年，EDVAC才被[BRLESC所取代](https://zh.wikipedia.org/wiki/BRLESC "wikilink")；在其运行周期里，EDVAC被证明是一台可靠和可生产的计算机。

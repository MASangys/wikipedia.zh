...
許多中使用的[自動化通訊協定以EIA](../Page/自動化通訊協定列表.md "wikilink")-485為其物理層，其中也包括了常見的[Modbus](../Page/Modbus.md "wikilink")及[Profibus](https://zh.wikipedia.org/wiki/Profibus "wikilink")。 配合許多使用相同通訊協定的設備，EIA-485可以讓個人電腦和工業控制系統可以在[局域网](../Page/局域网.md "wikilink")上進行通訊\[7\]。EIA-485也用在[可编程逻辑控制器](../Page/可编程逻辑控制器.md "wikilink")以及工厂的数据通信。EIA-485的差動特性可以抵抗馬達设备和焊接设备的电磁干扰。

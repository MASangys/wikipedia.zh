...
eMule StulleMule
Mod继承了MorphXT的强大的资源发布能力和诸多其他功能，而且还融合了IP更换重新请求、推进小文件与稀有文件、快速启动等功能\[1\]\[2\]。

StulleMule内置了吸血骡过滤名单而不支持DLP动态反吸血库，因而有网友自行编译内置最新版DLP库或其他DLP库的StulleMule。另外它还拥有能够屏蔽恶意攻击的Sivka
Ban\[3\]。

...
## MBTI偏好
  ...
  - **E——外倾**相对于内倾。通常感觉在与他人的互动中有积极性。于社交中，他们获得能量（同样的情况下，内倾者消耗能量）。\[4\]
  - **N——直觉**相对于感觉。則著眼未來, 著重可能性及預感, 從潛意識及事物間的關聯來理解世界。\[5\]
  - **T**——**理性**相對於情感：ENTJ通常認為客觀標准高於個人偏好。在做決定的時候，他們通常更多地基於邏輯，而不是對人情世故的考慮。\[6\]
...
Te組織、安排環境和想法，好成功達成目標。Te更倾向于逻辑中的推理和狭义逻辑，Te尋求行動、事件和結論的合理解釋，並試圖找到邏輯的錯誤和序列中的間隔。\[8\]

### 辅助功能：內傾直覺（Ni）

Ni將看起來矛盾的事物合成出先前無法想象的成果，同時它也被象征性的東西吸引。這些成果的實現通常伴隨着需要行動來完成的確定性，同時其解決辦法中可能包括复雜的系統或一般性的真理。.\[9\]

### 第三功能：外倾感觉（Se）

Se集中于当下的、物质的世界所带来的体验和感觉。以对当下周遭事情的敏锐察觉，它带来关于前方的相对事实和细节，而且可能导致自发的行动。\[10\]

### 劣势功能：内倾情感（Fi）

Fi過濾信息，這種過濾的基礎是緣於標准（經常是無形的）形成的判斷。Fi时常協調價值觀。在各种情形下，它天生地和微妙的差别相合，並知道什麼是對什麼是錯。.\[11\]

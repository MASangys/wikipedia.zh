...
病毒隔離系統是文件回退的一項技術，ESET
NOD32殺毒軟件在查找到可能被感染了病毒的文件時，如果該文件是系統或某個程序所需要的重要文件，而你又不確定該檔是否真的感染了病毒，害怕刪除該文件後會對系統或程序造成損壞時，就可以選擇將它隔離。ESET
...
Files\\Eset\\infected」。如果你有特殊的需要，要把隔離區轉移到其它路徑中，在ESET
NOD32控制中心面板中，依次點擊「ESET
NOD32系統工具/設定/進階設定」選項，點擊「隔離」欄的「瀏覽」按鈕指定一個新路徑，點擊「確定」按鈕即可。
...
[Category:斯洛伐克公司](https://zh.wikipedia.org/wiki/Category:斯洛伐克公司 "wikilink")

...
ESTCube-1搭載的微處理器使用了兩個作業系統，分別為負責衛星指令進行、數據處理和攝影控制的[FreeRTOS](../Page/FreeRTOS.md "wikilink")、以及負責通訊模組以及其他低功率的使用設備[TinyOS](../Page/TinyOS.md "wikilink")。其中衛星的任務控制系統是由[塔爾圖大學的學生製作而成](https://zh.wikipedia.org/wiki/塔爾圖大學 "wikilink")，並且由資訊科技公司[CGI
Group負責監督](https://zh.wikipedia.org/wiki/CGI_Group "wikilink")。而在衛星通訊部分，愛沙尼亞方面向註冊了兩個頻率：437.250兆赫與437.505兆赫。其中前者用於經常性但並不緊急的通訊中，其傳輸速度為[每分鐘](../Page/單詞每分鐘.md "wikilink")18個單詞，而主要目的為每隔3分鐘至5分鐘傳送最重要的衛星參數。後者則採用了[頻率偏移調變的技術以提供衛星特定任務指示的快速連結](https://zh.wikipedia.org/wiki/頻率偏移調變 "wikilink")，除了擁有9600[鮑的傳輸率外也符合](https://zh.wikipedia.org/wiki/鮑率 "wikilink")之標準。儘管由於使用業餘無線電頻率的使用使得傳輸速度最高只到25千赫，不過由於頻率偏移調變的技術使得其必要時可以達到每秒19,200比特的傳輸速度\[5\]。
...
## 外部連結
  ...
  - [Research in Estonia:race for quality and
    competitiveness](http://www.nature.com/nature/supplements/regionalreport/estonia/pdf/regionalreport_estonia.pdf)

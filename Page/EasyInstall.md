...
`easy_install`是一個附帶设置工具的模块，和一個[第三方函式庫](https://zh.wikipedia.org/wiki/第三方软件组件 "wikilink")。這樣是旨在加快Python函式庫的分配程式的速度。\[1\]這個程式類似用於[Ruby語言的](../Page/Ruby.md "wikilink")[RubyGems](../Page/RubyGems.md "wikilink")
。

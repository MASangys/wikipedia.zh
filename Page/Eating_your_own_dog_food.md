...
[-{zh-hans:电气电子工程师学会;
zh-hant:電機電子工程師學會;}-](../Page/电气电子工程师学会.md "wikilink")[软件杂志的编辑曾指出这句俚语的几个可能的来源](https://zh.wikipedia.org/wiki/IEEE软件杂志 "wikilink")\[2\]：
...
在网络媒体**的一则文章中曾评论说这种行为应该是透明而诚实的：

在业界中常认为强制让产品设计者去实际使用他们所设计的产品可提高产品的质量和[可用性](https://zh.wikipedia.org/wiki/可用性 "wikilink")，但软件开发者自己可能也并不看重可用性（或者说，易用性）：他们懂得怎样让软件正常工作，而[最终用户或许就缺乏相关知识](https://zh.wikipedia.org/wiki/最终用户 "wikilink")\[10\]。在2008年，时任微软[CIO的Ed](https://zh.wikipedia.org/wiki/CIO "wikilink")
Sperling就有注意到一点，他曾如此表示：

另一方面也有人认为dogfooding策略可能会有负面效果：使用Dogfooding策略的时机必须有所选择，太早进行可能会使可行性大打折扣；另一方面说被迫使用产品的开发者在碰到问题时可能会假定已经有其他人回报而不再提出，有的甚至习惯于用一些临时性的解决措施来应付使用问题，而不是从根源上消除之。Dogfooding也可能是很不现实的，因为顾客也常一起使用多个不同公司的产品，这时产品的实际应用就会和本来设计预想的功能有所不同。除此以外，采用dogfooding策略还可能导致开发团队的效率和士气都有所降低\[11\]，极端情况下甚至会导致[NIH综合症](https://zh.wikipedia.org/wiki/NIH综合症 "wikilink")\[12\]。而公开进行dogfooding也有一定风险：具体来说，当一个公司在使用自己的产品时出现问题的时候，公众可能也会对该公司的产品失去信心，这也正是当今公开进行dogfooding的行为相当少的原因\[13\]。

## 实例

[苹果电脑公司总裁](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")在1980年曾在一份备忘录中如此写到：“立即生效！别再购买或租用（或以其他方式获取）更多的打字机了。”并以之宣示要在1981年1月1日清理掉公司内的所有打字机并以电脑代之\[14\]
。
...
## 参见条目
  ...
  - [軟件版本週期](../Page/軟件版本週期.md "wikilink")
...
## 外部链接
  ...
  - [What Is The Work Of Dogs In This
    Country?](http://www.joelonsoftware.com/articles/fog0000000012.html)
    ([Joel
    Spolsky](https://zh.wikipedia.org/wiki/Joel_Spolsky "wikilink") on
    Fogbugz's dogfooding, *Joel On Software*, 5 May 2001)
  - ['Chowing down on
    dogfood'](http://buzz.blogger.com/2006/10/chowing-down-on-dogfood.html)
    - (Google dogfooding [Blogger](../Page/Blogger.md "wikilink"))
...
4.   Quote: "\[Paul\] Maritz also poked fun at himself by claiming that
    one of his only contributions to the IT world is coining the

...
用戶也可藉著EditGrid的刊登網誌功能從第三方網站瀏覽EditGrid試算表。開發人員可使用EditGrid的[API](https://zh.wikipedia.org/wiki/API "wikilink")(應用程序編程介面)開發自訂應用程式。在EditGrid上提供的Grid2Map外掛應用程式就是其一個將EditGrid上的經緯點轉化為[Google Maps上的坐標的API應用程式](https://zh.wikipedia.org/wiki/Google_Maps "wikilink")。

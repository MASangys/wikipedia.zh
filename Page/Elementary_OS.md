...
这个发行版是从为Ubuntu设计的一套主题和应用程序发展而来的\[3\]。由于是基于Ubuntu的，因此与Ubuntu的仓库和包完全兼容。它使用Ubuntu自己的[软件中心来处理软件的安装和卸载](https://zh.wikipedia.org/wiki/Ubuntu软件中心 "wikilink")。其类似于[macOS的界面致力于使新用户不需要费太大力气就可以根据直觉使用](../Page/macOS.md "wikilink")。2018年被評為最好的桌面發行版\[4\]
...
elementary OS *Luna*默认安装了以下应用程序\[5\]。
  ...
  - Phanteon
    Greeter：基于[LightDM的会话管理器](https://zh.wikipedia.org/wiki/LightDM "wikilink")。
  - WingPanel：上面板，类似于Ubuntu的[Unity和](../Page/Unity_\(使用者介面\).md "wikilink")[GNOME
    Shell的上面板](https://zh.wikipedia.org/wiki/GNOME_Shell "wikilink")。
  ...
  - Scratch：简单的[文本编辑器](../Page/文本编辑器.md "wikilink")。
  - Pantheon
    Terminal：[终端模拟器](https://zh.wikipedia.org/wiki/终端模拟器 "wikilink")。
  - Pantheon Files:
    [文件管理器](https://zh.wikipedia.org/wiki/文件管理器 "wikilink")。

## 安装

elementary
OS作为一个[LiveCD版本发行](https://zh.wikipedia.org/wiki/LiveCD "wikilink")，允许用户不需要安装就可以试用此系统。安装程序是[Ubiquity](../Page/Ubiquity_\(软件\).md "wikilink")——Ubuntu及其继承版本的默认安装程序。

## 版本

elementary OS的第一个，同时也是在2013年以前唯一的稳定版本是*Jupiter*\[6\]，于2011年3月发布，基于Ubuntu
10.10。从2012年十月开始停止支持，并且在elementary OS的官方网站上也仅出现在历史版本下载中\[7\]\[8\]。

2012年11月，代号为*Luna*的第一个beta版本发布，它使用Ubuntu 12.04
LTS作为基础版本\[9\]。第二个beta版本于2013年5月发布\[10\]。
...
2016年6月，代號為*Loki*的第一個beta版本發佈\[14\]，其基於Ubuntu 16.04 LTS進行開發。

2017年5月17號發佈Loki 0.4.1版本。

2018年10月17號發佈基於Ubuntu 18.04 LTS的Juno 5.0 \[15\]版本。
...
## 外部链接
  ...
  -
  -
[Category:Live_CD](https://zh.wikipedia.org/wiki/Category:Live_CD "wikilink")
...
9.  ["elementary OS Luna Beta 1 Available For
    Testing"](http://www.webupd8.org/2012/11/elementary-os-luna-beta-1-available-for.html).
    Web UPD8, 2012-11.

...
## 特性
  ...
  - 完善的文档支持。
  - 通过[消息传递](https://zh.wikipedia.org/wiki/消息传递 "wikilink")（[参与者模式](https://zh.wikipedia.org/wiki/参与者模式 "wikilink")）支持 Shared-nothing 并行事务。
...
经典的 [Hello world](https://zh.wikipedia.org/wiki/Hello_world "wikilink") 例子:
...
1.
2.  {{ cite web |url=[http://vimeo.com/53221562|title=Elixir](http://vimeo.com/53221562%7Ctitle=Elixir) - A modern approach to programming for the Erlang VM | accessdate=2013-02-17}}
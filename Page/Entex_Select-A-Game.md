...
主機的電源可以由4枚C型電池提供，也可以使用外部[電源供應器](../Page/電源供應器.md "wikilink")。但是電源供應器在當時需要經郵件購買，以現在來說難以入手，而使用[交流適配器](../Page/交流適配器.md "wikilink")也可以令主機正常運作。

## 遊戲列表

  - *Space Invaders 2*（[太空侵略者](../Page/太空侵略者.md "wikilink")2，與主機同時發售）
  - *Basketball 3*（籃球3）
  - *Football 4*（足球4）
  - *Pinball*（彈珠台）
  - *Baseball 4*（棒球4）
...
## 參見
  ...
  - [Entex Adventure Vision](../Page/Entex_Adventure_Vision.md "wikilink")

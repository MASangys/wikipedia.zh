...
2018年12月6日，在[遊戲大獎的頒獎典禮期間正式推出Epic](https://zh.wikipedia.org/wiki/遊戲大獎 "wikilink") Games商城，同時宣布有數款獨立遊戲在商城上架。\[12\]\[13\]按照規劃，初期商店在[Windows與](https://zh.wikipedia.org/wiki/Windows "wikilink")[MacOS](../Page/MacOS.md "wikilink")平台推出，未來將拓展到[Android](../Page/Android.md "wikilink")與其他平台。在Android上的目標是透過自家商店來銷售產品，不再需要透過[Google Play而被額外抽成](../Page/Google_Play.md "wikilink")。相對於普遍的30%抽成，Epic Games商城的12%抽成優勢也有可能讓Google Play感到壓力。另一方面，由於[蘋果公司在](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")[iOS平台擁有壟斷地位](https://zh.wikipedia.org/wiki/iOS "wikilink")，目前Epic Games暫時沒有機會在iOS上與其抗衡。\[14\]

早在商城推出之前，其發行策略總監Sergey Galyonkin於2015年建立了[Steam Spy網站](../Page/Steam_Spy.md "wikilink")，該網站專門透過Steam使用者的公開個人檔案來收集與統計Steam遊戲的銷售數據。當初他只是將這網站當作次要的經營目標，但這些Steam銷售的分析經驗確實帶給他不少幫助，往後在建構Epic Games商城時便能採用更益於銷售的策略。\[15\]此外，Epic games旗下遊戲《[堡垒之夜](https://zh.wikipedia.org/wiki/堡垒之夜 "wikilink")》的成功也是商城推出的助力之一。\[16\]

## 反響

在Epic Games商城對外公布的前幾天，2018年12月1日，Valve宣布以往Steam平台的30%抽成政策將會進行調整，如果一款遊戲在Steam上的銷售額超過金則抽成會調降到25%、如果超過則會調降到20%。\[17\]這消息引發不少玩家與遊戲開發者的議論，有些獨立開發者擔心Valve此舉是為了挽留[3A遊戲開發者與發行商](https://zh.wikipedia.org/wiki/3A遊戲 "wikilink")，而非考量到小型遊戲的開發者。\[18\]

在Epic Games商城公布之後，有些媒體認為該新興平台的政策將會對Steam造成一定衝擊，同時透露出近年來遊戲開發商與Steam之間發生的關係變化。\[19\]\[20\]此外，一些獨立開發者宣布將未發售的新作或已發售的作品轉移到Epic Games商城上獨佔發售、或是限時獨佔後才會到其他平台上架，有些遊戲原本在Steam有上架但在轉移到Epic Games商城後便從Steam下架。\[21\]\[22\]

2019年1月9日，[育碧](../Page/育碧.md "wikilink")宣布旗下的《[湯姆克蘭西：全境-{}-封鎖2](../Page/湯姆克蘭西：全境封鎖2.md "wikilink")》將會透過Epic Games商城進行販售（以及自家的Uplay），並且不會在Steam平台發售，未來也計畫在Epic Games商城推出更多自家遊戲。這是首次有第三方大廠加入Epic Games商城的行列。\[23\]

2019年1月29日，發行商[Deep Silver宣布原定要在Steam上發售的](../Page/Deep_Silver.md "wikilink")《[戰慄深隧：流亡](../Page/戰慄深隧：流亡.md "wikilink")》將改在Epic Games商城獨佔發售，獨佔滿一年後才會在Steam與其他PC數位平台發售。在Epic Games商城上的定價（美國區）將會比其他數位平台減少10美金。\[24\]

## 争议

2019年3月15日，Epic Games Store被用户发现会收集[Steam](../Page/Steam.md "wikilink")的用户信息，其中包括用户的好友列表、游戏时间、游戏云存档，这些文件被Steam封装在localconfig.vdf文件内，之后会被Epic Games读取并加密保存到Epic Games文件夹。Epic技术副总裁Daniel Vogel对此回应称，该文件仅在用户允许导入Steam好友时，才会发送至Epic，对此解释，有网友测试发现，在同步Steam好友时，该文件根本没有被访问；至于游戏云存档，Daniel Vogel尚未做出解释。\[25\]而在[一般資料保護規範](https://zh.wikipedia.org/wiki/一般資料保護規範 "wikilink")（GDPR）实行后，Steam已经默认将用户的好友列表、游戏时间设置为私密（仅好友）了，这意味着，除非动用本地文件或者向Valve申请授权的API，否则这些信息第三方都是无法获取的。\[26\]

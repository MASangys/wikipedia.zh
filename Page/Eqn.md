...
，擴展了原始語法。[UNIX 手冊](../Page/手冊頁.md "wikilink") 的編譯軟體  亦包含了一套獨立的
eqn 處理器。
...
在 eqn 中 [空白鍵](../Page/空白鍵.md "wikilink") 是很重要的， 空白鍵用來分隔不同的
[單詞](../Page/語法分析#單詞.md "wikilink") ； 只有對
[波浪號](../Page/波浪號.md "wikilink") `~` 、 大括號 `{}` 、
[雙引號](../Page/雙引號.md "wikilink") `"` 來說， 空白鍵是可省的。 例如
`f(pi r sup 2)` 產生 \(\scriptstyle{f(pi r^{2)}}\) . 然而
`f( pi r sup 2 )` 產生 \(\scriptstyle{f(\pi r^2)}\).

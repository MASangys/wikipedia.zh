**Eric**是一个[自由的软件](../Page/自由软件.md "wikilink")[集成开发环境](../Page/集成开发环境.md "wikilink")，主要为开发[Python和](../Page/Python.md "wikilink")[Ruby语言编写的程序而设计](../Page/Ruby.md "wikilink")。历史上某个时期中，Eric4是这款软件针对Python
...
## 特色
  ...
  - 与版本控制系统整合，当前版本内建支持[Mercurial和](../Page/Mercurial.md "wikilink")[Subversion](../Page/Subversion.md "wikilink")，可通过可选插件支持[Git](../Page/Git.md "wikilink")；
  - 与Qt整合，可以直接调用[Qt
    Creator中包含的Qt设计师](../Page/Qt_Creator.md "wikilink")、Qt语言家等Qt开发工具；
...
## 外部連結
  ...
  - [官方主页](http://eric-ide.python-projects.org/)
...
[Category:用Python编程的自由软件](https://zh.wikipedia.org/wiki/Category:用Python编程的自由软件 "wikilink")

...
**Erlang**（）是一種通用的-{zh-hans:并发;zh-hant:平行導向;}--{zh-hans:[程序设计语言](../Page/编程语言.md "wikilink");zh-hant:[程式語言](../Page/程式語言.md "wikilink");}-，它由[喬·阿姆斯特朗](../Page/喬·阿姆斯特朗.md "wikilink")（Joe
Armstrong）在[瑞典電信設備製造商](../Page/瑞典.md "wikilink")[愛立信所轄的電腦科學研究室開發](../Page/愛立信.md "wikilink")，目的是創造一種可以應付大規模并發活動的-{zh-hans:[程序设计语言](../Page/程序设计语言.md "wikilink");zh-hant:[程式語言](../Page/程式語言.md "wikilink");}-和[執行環境](../Page/執行環境.md "wikilink")。Erlang於1987年釋出正式版本，最早是愛立信擁有的私有軟體，經過十年的發展，於1998年發表[開放源碼版本](../Page/開放源代碼.md "wikilink")。

Erlang是運作於[虛擬機的](../Page/虛擬機.md "wikilink")-{zh-hans:[解释型语言](../Page/直譯式語言.md "wikilink");zh-hant:[直譯式語言](../Page/直譯式語言.md "wikilink");}-，但是現在也包含有[烏普薩拉大學高性能Erlang計劃](../Page/烏普薩拉大學.md "wikilink")（HiPE）\[1\]開發的原生程式碼[編譯器](../Page/編譯器.md "wikilink")，自R11B-4版本開始，Erlang也支持-{zh-hans:[脚本方式执行](../Page/脚本语言.md "wikilink");zh-hant:[腳本直譯器](../Page/脚本語言.md "wikilink");}-。在[編程範型上](../Page/編程範型.md "wikilink")，Erlang屬於多重典範程式語言，涵蓋[函數式](../Page/函數式編程.md "wikilink")、-{zh-hans:[并行](../Page/Concurrent_computing.md "wikilink");zh-hant:[平行式](../Page/Concurrent_computing.md "wikilink");}-及-{zh-hans:[分布式](../Page/分布式計算.md "wikilink");zh-hant:[分散式](../Page/分布式計算.md "wikilink");}-。循序執行的Erlang是一个[及早求值](../Page/及早求值.md "wikilink"),
[單次賦值和](../Page/單次賦值.md "wikilink")-{zh-hans:[动态类型](../Page/动态类型.md "wikilink");zh-hant:[動態資料形態](../Page/類型系統.md "wikilink");}-的[函數式程式語言](../Page/函數編程語言.md "wikilink")。

## 開發及演變歷史

Erlang得名於[丹麥](../Page/丹麥.md "wikilink")[數學家及](../Page/數學家.md "wikilink")[統計學家Agner](../Page/統計學家.md "wikilink")
...
1998年起，Erlang發布[開放源碼版本](../Page/開放源代碼.md "wikilink")，稱為[開源電信平台](../Page/開源電信平台.md "wikilink")。**開源電信平台**採用修改過的[Mozilla公共許可證協議發放](../Page/Mozilla公共許可證.md "wikilink")，同時爱立信仍然提供商業版本的技術支持。目前，Erlang最大的商業用户是爱立信，其他知名用户有[北電網路](../Page/北电网络.md "wikilink")、[-{zh-hans:亚马逊;
zh-hant:亞瑪遜}-以及](../Page/Amazon.com.md "wikilink")[T-Mobile等](../Page/T-Mobile.md "wikilink")\[3\]。
...
### 語言特色
  ...
  - **[及早求值或嚴格求值](../Page/及早求值.md "wikilink")**
  ...
  - **-{zh-hans:[快速失败](../Page/Fail-fast.md "wikilink");zh-hant:[錯誤先發](../Page/Fail-fast.md "wikilink");}-**
...
Erlang-{zh-hans:程序;zh-hant:程式;}-結構以函數定義為主。函數是一組將輸入分別對應到輸出的規則，對應方式遵守[數學函數的慣例](../Page/函數.md "wikilink")。此外，Erlang語言由幾項構句要素所組成，包括[文字(或稱原子)](../Page/文字_\(數理邏輯\).md "wikilink")、數字、列表、[值組](../Page/多元組.md "wikilink")、字元、字串、二進位資料、模組、與特定用途的關鍵字如fun
...
<tr class="odd">
<td><p>列表</p></td>
<td><p>列表是與<a href="../Page/連結串列.md" title="wikilink">鏈接序列相同的資料結構</a>。任一列表大致區分為頭部與尾部，頭部是列表的第一項，尾部是列表除第一項之外的其他部份。</p>
<ol>
...
<li>任何不可見的字元，可使用以 $ 開頭、後接該字元符號的<a href="../Page/转义序列.md" title="wikilink">-{zh-tw:逸出序列表達</a>。</li>
</ol></td>
<td><ul>
<li>$3</li>
<li>$)</li>
...
請記得，Erlang是以true和false表示[布林資料類型](../Page/布尔型.md "wikilink")。 | (略) |- |
運算子 | Erlang提供常用的運算子方便基本運算。運算子是用在**中序**的表達式裏，包含 + - \* / div(商) rem(餘)
等。位元算算有 bnot, band, bor, bxor, bsl(算術左移), bsr(算術右移) 等。用於列表有 ++(列表銜接)
--(列表剔除) 等。各種運算式皆可用 ( ) 調整運算優先順序。 | (略) |- |
...
[開源電信平台包括一個Erlang直譯器](../Page/開源電信平台.md "wikilink")、一個Erlang編譯器、程序節點通訊協定、[CORBA](../Page/CORBA.md "wikilink")、一個分散式資料庫[Mnesia](http://en.wikipedia.org/wiki/Mnesia)、以及許多程式庫\[4\]。
...
Erlang支持[函數式程式設計的一般特色](../Page/函數程式語言.md "wikilink")，特色包括[單次賦值](../Page/單次賦值.md "wikilink")、[遞迴定義](../Page/遞歸.md "wikilink")、[λ演算與](../Page/λ演算.md "wikilink")[高階函數等等](../Page/高階函數.md "wikilink")。Erlang函数大致寫法如下，以整數[階乘模組为例](../Page/階乘.md "wikilink")：
...
以下是[費氏數列求解函數](../Page/費氏數列.md "wikilink")：
...
函數式程式設計容許使用[高階函數求解](../Page/高階函數.md "wikilink")。以下例子說明Erlang實做[複合函數](../Page/複合函數.md "wikilink")。
( f o g ，唸作 f *after* g 。)
...
Erlang程式員可以使用[惰性求值](../Page/惰性求值.md "wikilink")。不過，必須使用[λ演算式](../Page/λ演算.md "wikilink")，才能做到惰性求值。
...
## 應用
  ...
  - [Wings
    3D](../Page/Wings_3D.md "wikilink")，一个用Erlang编寫的[三维計算機圖形軟體](../Page/三维計算機圖形軟件.md "wikilink")。
  ...
  - [ejabberd](http://www.process-one.net/en/ejabberd/),世界上最流行的[XMPP即时通讯服务器](../Page/XMPP.md "wikilink")

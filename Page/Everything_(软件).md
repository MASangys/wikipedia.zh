**Everything**是一个[私有的](../Page/专有软件.md "wikilink")[免费Windows](https://zh.wikipedia.org/wiki/免费软件 "wikilink")[桌面搜索引擎](https://zh.wikipedia.org/wiki/桌面搜索 "wikilink")，可以在[NTFS卷上快速地根据名称查找文件和目录](../Page/NTFS.md "wikilink")。由澳大利亚人大卫·卡彭特（David
Carpenter）开发。2009年10月30日，在拥有70,000用户的[Wakoopa网站排名中](../Page/Wakoopa.md "wikilink")，Everything在1757个应用程序中排名第857，超越了老牌压缩工具[WinZip](../Page/WinZip.md "wikilink")\[1\]。直到2013年，Everything仍处于开发状态。
...
基于前面描述的工作原理，使得Everything的缺点和它的优点一样明显。
  ...
  - **仅支持NTFS卷**\[8\]：不支持目前大量移动设备使用的[FAT文件系统](../Page/FAT.md "wikilink")，也不支持除Windows外的其他操作系统中常见的文件系统，如Linux\[9\]\[10\]。不过，从Everything

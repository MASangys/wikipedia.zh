...
1作業系統中\[1\]。由於[NTFS](../Page/NTFS.md "wikilink")檔案系統的一些資料格式規定所限，對[快閃記憶體而言exFAT顯得更具優勢](https://zh.wikipedia.org/wiki/快閃記憶體 "wikilink")，是一種較適合於快閃記憶體的檔案系統。
...
exFAT比過去的[FAT](../Page/FAT.md "wikilink")文件系統的劣勢在於：
  ...
  - 使用exFAT的設備將不能用[Windows
    Vista的](../Page/Windows_Vista.md "wikilink")[ReadyBoost](../Page/ReadyBoost.md "wikilink")功能。（Windows

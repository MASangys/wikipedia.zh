...
Expect自动化控制命令行工具，但是对[图形用户界面就失效了](../Page/图形用户界面.md "wikilink")。Windows提供了不少有价值的工具，很多是基于图形用户界面的，这就是Expect失效的地方了。Windows下图形界面程序可以通过像[Autohotkey或者](../Page/AutoHotkey.md "wikilink")[AutoIt等工具来实现自动化控制](../Page/AutoIt.md "wikilink")。

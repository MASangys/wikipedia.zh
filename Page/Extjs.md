...
4.0版，引入了Config和Mixins概念，另外還新增class，開發人員可以在一个class包含另一个class。

2014年6月2日，發布Ext JS 5.0，於新版本中支援Touch-screen，新架構MVVM提升運作效率，提供更多的chart與UI
component.
...
Ext整合了CSS样式文件，窗口、面板都有现成的样式，甚至都不需要美工进行特别的美化就可以直接使用。功能涵盖了一个Web
2.0网站所需要的几乎所有的功能，非常完备。但是相应的文件大，加载速度并不理想，而且在低版本的浏览器上显示效果不佳。

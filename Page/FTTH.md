...
光纖[網絡目前有多種競爭中的技術可供使用](https://zh.wikipedia.org/wiki/網絡 "wikilink")。
...
把多個用戶的光纖在[電信交換中心合在一起使用](https://zh.wikipedia.org/wiki/電信交換 "wikilink")。使用這方式的技術需配合[主動式光纖網路（AON）或](https://zh.wikipedia.org/wiki/#主動式光纖網路（Active_optical_network） "wikilink")[被動式光纖網路（PON）](https://zh.wikipedia.org/wiki/#被動式光纖網路（Passive_optical_network） "wikilink")。
...
台灣發展最大宗由[中華電信主推之FTTx](https://zh.wikipedia.org/wiki/中華電信 "wikilink")（這是為了其大量使用之FTTC避免與FTTH混淆），線路[最後一哩架構多以](https://zh.wikipedia.org/wiki/最後一哩 "wikilink")[VDSL](../Page/VDSL.md "wikilink")（VDSL2）為主，其上[DSLAM架設於道路旁交接箱或是大樓電信室內](https://zh.wikipedia.org/wiki/DSLAM "wikilink")。主要是對於乙太網路的熟悉及訂單影響，目前的網路速度主流約為100Mbps/40Mbps。中華電信在2010年開始大量設置FTTH設備，並表示2015年高速寬頻指標「80%的家庭可接取100Mbps有線寬頻」及「光纖用戶達600萬戶」之政策目標。
...
[MTel亦於試業時開始鋪設光纖管道](https://zh.wikipedia.org/wiki/MTel電信 "wikilink")（目前已覆蓋全澳超過三成），並開始為少量樓宇提供光纖到戶服務。

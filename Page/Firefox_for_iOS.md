...
Firefox Home是一款基於Firefox Sync技術的iPhone和iPod
Touch應用程式\[6\]\[7\]，可同步書籤、歷史和分頁等紀錄，還包含智慧位址列（Awesome
Bar）的功能。Firefox
Home並非瀏覽器，開啟時依然使用Safari瀏覽器\[8\]\[9\]。Mozilla於2012年9月將Firefox
Home從App
Store下架，表示將把資源集中在其他計劃上，隨後將原始碼提交到[GitHub](../Page/GitHub.md "wikilink")\[10\]。

## 参考资料

## 外部链接

  - [App Store](../Page/App_Store_\(iOS\).md "wikilink") 商店中的[Firefox
    for
    iOS](https://itunes.apple.com/app/firefox-web-browser/id989804926)

...
flv文件中的元信息，是一些描述flv文件各类属性的信息。这些信息以[AMF格式保存在文件的起始部分](https://zh.wikipedia.org/wiki/AMF "wikilink")。adobe官方的标准flv元信息项目如下\[5\]：
...
两个常用的操作metadata的工具是*[flvtool2](https://zh.wikipedia.org/wiki/flvtool2 "wikilink")*和*[FLVMDI](https://zh.wikipedia.org/wiki/FLVMDI "wikilink")*，都是把keyframes作为一个默认的元信息项目。
...
這些播放程式包括：
  ...
  - [ExtraPlayer](https://zh.wikipedia.org/wiki/ExtraPlayer "wikilink")

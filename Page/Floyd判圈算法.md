...
Algorithm**)，又称**龟兔赛跑算法**(**Tortoise and Hare
Algorithm**)，是一个可以在[有限状态机](../Page/有限状态机.md "wikilink")、[迭代函数或者](../Page/迭代函数.md "wikilink")[链表上判断是否存在](../Page/链表.md "wikilink")[环](https://zh.wikipedia.org/wiki/環_\(圖論\) "wikilink")，求出该环的起点与长度的算法。该算法据[高德纳称由美国科学家](../Page/高德纳.md "wikilink")[罗伯特·弗洛伊德发明](../Page/罗伯特·弗洛伊德.md "wikilink")，但这一算法并没有出现在[罗伯特·弗洛伊德公开发表的著作中](../Page/罗伯特·弗洛伊德.md "wikilink")[1](https://en.wikipedia.org/wiki/Cycle_detection#Tortoise_and_hare)。
...
## 参考链接
  ...
  - [Floyd's Cycle Detection Algorithm (The Tortoise and the
    Hare)](http://www.siafoo.net/algorithm/10)
  - [Brent's Cycle Detection Algorithm (The Teleporting
    Turtle)](http://www.siafoo.net/algorithm/11)

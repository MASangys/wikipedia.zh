...
**Flyme**是由[珠海魅族科技有限公司开发的基于](https://zh.wikipedia.org/wiki/魅族科技 "wikilink")[Android的手机操作系统](https://zh.wikipedia.org/wiki/Android "wikilink")。

## 軟件

Flyme内置了自家软件，並大幅修改原生[Android界面](https://zh.wikipedia.org/wiki/Android "wikilink")，且中国版不预装[GMS](https://zh.wikipedia.org/wiki/GMS "wikilink")，[Eico Design亦有參與設計](https://zh.wikipedia.org/wiki/Eico_Design "wikilink")\[1\]。
...
**Flyme雲服務**
Flyme雲服務是[魅族科技開發的](https://zh.wikipedia.org/wiki/魅族科技 "wikilink")[雲端功能](https://zh.wikipedia.org/wiki/雲端 "wikilink")，同時開放網頁端。使用者可以綁定Flyme賬戶，將聯絡人、短信、相冊及系統設定上傳同步至伺服器進行備份，並且使用電腦或者其他Flyme裝置存取數據。可以在網頁端修改、增添和刪除相關數據。找回手機功能可以允许用户在網頁端使用找回手機功能定位手機當前位置，同時可以查看該裝置的狀態、所使用的手機號碼，並可以遠端控制手機發聲、鎖定、远程同步和擦除數據。若手機處於離線狀態，用戶还可選擇透過運營商發送一條短信遠端激活該功能。
...
<tr class="odd">
<td><p>Flyme 4</p></td>
<td><p>Android 4.4、5.1或YunOS 3.0</p></td>
<td><p>4.5</p></td>
<td></td>
</tr>
<tr class="even">
<td><p>Flyme 5</p></td>
<td><p>Android 5.1或YunOS航海版Air、5、Atom</p></td>
<td><p>5.2</p></td>
<td></td>
</tr>
<tr class="odd">
<td><p>Flyme 6</p></td>
<td><p>Android 5.1、Android 6.0、Android 7.X</p></td>
<td><p>6.3</p></td>
<td><p>[2]</p></td>
</tr>
<tr class="even">
...
mBack是魅族手机使用的Home键方案。在手机正面采用一个支持[触摸感应的按键](https://zh.wikipedia.org/wiki/触摸操作 "wikilink")，来代替原生Android的三个按键。触摸主键执行返回操作，按压主键执行回到桌面，从主键两侧的屏幕底部上滑打开多任务卡片。\[4\]主键亦可支持[指纹识别](../Page/指纹识别.md "wikilink")，用于指纹解锁、[微信和](https://zh.wikipedia.org/wiki/微信 "wikilink")[支付宝](../Page/支付宝.md "wikilink")的指纹支付。魅族手机自魅蓝note2以后均采用mBack，但未全部搭载指纹识别。在魅族PRO 6 Plus上，主键还包括活体指纹检测和心率检测功能。

### 评价

mBack用一个按键替换原生Android三个按键的做法被认为符合魅族一贯简洁的设计风格。mBack发布后中国大陆市场开始较多出现类似的实体键Android设备也被认为是对mBack的肯定\[5\]\[6\]。

但亦有评论指出，轻触返回容易造成误触，或按压过重而返回桌面，用户学习成本高，需要一段时间来适应\[7\]。
...
#### 魅族系列
  ...
  - [魅族M8](../Page/魅族M8.md "wikilink")
  - [魅族M9](https://zh.wikipedia.org/wiki/魅族M9 "wikilink")
  ...
  - [魅族MX5](https://zh.wikipedia.org/wiki/魅族MX5 "wikilink")
  - [魅族MX6](https://zh.wikipedia.org/wiki/魅族MX6 "wikilink")
...
#### 魅蓝系列
  ...
  - [魅藍](https://zh.wikipedia.org/wiki/魅藍 "wikilink")
...
#### 其他
  ...
  - 由官方或民间团体或个人根据Flyme开源的Patchrom适配的机型

## 參考連結

  - [Flyme OS全球](http://www.flyme.cn/en/)

  - [Flyme OS中國](http://www.flyme.cn/)

  - [Flyme OS香港](http://www.flyme.cn/hk/)

  - [Flyme OS台灣](http://www.flyme.cn/tw/)

  - [Flyme OS印度](http://www.flyme.cn/in/)

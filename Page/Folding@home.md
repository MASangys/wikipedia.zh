**Folding@home**（簡稱**FAH**或**F@h**）是一个研究[蛋白质折叠](../Page/蛋白质折叠.md "wikilink")、误折、聚合及由此引起的相关疾病的[分布式计算工程](../Page/分布式计算.md "wikilink")。由[斯坦福大学](../Page/史丹佛大學.md "wikilink")[化學系的潘德实验室](../Page/化學.md "wikilink")（Pande
Lab）主持，於2000年10月1日正式啟動。Folding@home現時是世界上最大的分布式計算計劃，於2007年為[吉尼斯世界纪录所承認](../Page/吉尼斯世界纪录.md "wikilink")\[1\]。

2004年3月8日，研究[基因結構的](../Page/基因.md "wikilink")計劃終止，併入Folding@home。
...
[亨丁頓舞蹈症起因於第](../Page/亨丁頓舞蹈症.md "wikilink")4對染色體異常，病發時會無法控制四肢，就像手舞足蹈一樣，並伴隨著智能減退，最後因吞嚥、呼吸困難等原因而死亡。
...
Folding@home和另一個分布式计算計劃[Rosetta@home都做和蛋白質相關的研究](../Page/Rosetta@home.md "wikilink")，導致公眾常常把兩者的目標混淆，或不知道應該參加哪個計劃。為此，Folding@home的管理者、潘德实验室的領導人教授解說道：\[4\]
...
>
>   -
>     同時，人們也該明白，用電腦去準確預測蛋白質的結構，比起進行真正的實驗，仍是更艱難的。而從Folding@home所獲得的有關蛋白質折疊和誤折的資料（例如速度、能量）是和實驗結果相符合的，也告訴我們更多實驗不能發現的東西。而Rosetta@home，雖然已進行了很長時間，也取得一些很可觀的成果，但當要在Rosetta@home預測的結構和晶體結構（crystal
>     structure）之間選擇時，都會選取晶體結構。因為他們的努力，我相信這將會改變，但要這夢想成真，還有一段很長的路要走。
>
> <!-- end list -->
>
>   -
...
一台PlayStation
3遊戲機的標稱功率為380W，由於Folding@Home是設計供CPU使用，因此會造成主機功耗達100%。但根據斯坦福方面有關PS3主機的常見問題，指出每台主機「在執行該程式時，其估計功率約為200W左右\[6\]」。截至2008年5月底，共有51,000多台PS3主機為該計劃提供1,400多TFlops的運算能力，每台PS3平均提供近30,000MFlops，以史丹福的每台主機200W輸出（使用90nm製程的處理器）估計，每瓦輸出提供150多MFlops\[7\]。隨著PS3的Cell處理器改用更微細的65nm及45nm製程，處理器的功耗會進一步下降，其每瓦輸出提供的運算的能力也會提高。
...
## 外部链接
  ...
  - [Folding@home Chrome
    Client](http://nacl.foldingathome.org/)（免安裝，只支援CPU摺疊，須使用Chrome瀏覽器）
  - [Folding@home 中文網](http://www.equn.com/folding/)
  - [Folding@Home 简体中文论坛（中国队 China Folding@Home
    Power 3213）](http://www.equn.com/forum/forum-21-1.html)
  - [Folding@home 滄者極限團隊
    繁體中文論壇（台灣隊:31403）](http://www.coolaler.com/forumdisplay.php/295-%E3%80%8CFolding-HOME%E3%80%8D%E6%BB%84%E8%80%85%E6%A5%B5%E9%99%90%E5%9C%98%E9%9A%8A)
  - [FAH部落格](http://folding.typepad.com/)
  - [Folding@home
    Wiki](https://web.archive.org/web/20080608092700/http://fahwiki.net/index.php/Main_Page)
...
[Category:PlayStation_3软件](https://zh.wikipedia.org/wiki/Category:PlayStation_3软件 "wikilink")
...
1.  [Sony's Folding@home project gets Guinness
    record](http://www.news.com/8301-13772_3-9808500-52.html)
2.  參閱 [Folding@home
    網站上的論文列表](http://www.stanford.edu/group/pandegroup/folding/papers.html)。
3.
4.  原文：[Quote from Mr. Vijay
    Pande](http://forum.folding-community.org/viewtopic.php?p=125338#125338)
5.  [NVIDIA
    GPU通用计算将加入Folding@Home](http://news.mydrivers.com/1/106/106847.htm)
6.  [Folding@Home on the
    PS3](http://www.stanford.edu/group/pandegroup/folding/FAQ-PS3.html)

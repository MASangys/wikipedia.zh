...
单词“foobar”或分离的“foo”与“bar”常出现于程序设计的案例中，如同[Hello World程序一样](../Page/Hello_World.md "wikilink")，它们常被用于向学习者介绍某种程序语言。

“foo”“bar”常被作为函数／方法的名称或变量名。

下面是一段通过“foo”和“bar”来演示如何在[Java](../Page/Java.md "wikilink")、[C及](https://zh.wikipedia.org/wiki/C語言 "wikilink")[C++](../Page/C++.md "wikilink")中连接两个字符串的实例程序：
...
## 外部链接
  ...
  - [The Jargon File entry on foobar](http://www.catb.org/~esr/jargon/html/F/foobar.html)
  - RFC 3092 - Origin and usage of *foobar*
  - [Foobar2000 is an advanced audio player for the Windows platform](https://web.archive.org/web/20160324/http://www.maximumpc.com/how-to-manage-your-music-the-power-user-way-with-foobar/)
  - RFC 1639 - FTP Operation Over Big Address Records (FOOBAR)

[Category:化名](https://zh.wikipedia.org/wiki/Category:化名 "wikilink") [Category:变量](https://zh.wikipedia.org/wiki/Category:变量 "wikilink")

1.  [《新黑客辞典》](http://www.catb.org/jargon/html/F/foobar.html)（The Jargon File）
**福傳**（），源自於「公式翻译」（）的縮寫，是一種[程式語言](../Page/程式語言.md "wikilink")。1957年由[IBM開發出](../Page/IBM.md "wikilink")，是世界上第一个被正式采用並流传至今的[高级编程語言](../Page/高階語言.md "wikilink")。
...
704](../Page/IBM_704.md "wikilink")[大型主機](../Page/大型主機.md "wikilink")。\]\]
[Punch-card--fortran.jpg](https://zh.wikipedia.org/wiki/File:Punch-card--fortran.jpg "fig:Punch-card--fortran.jpg")

Fortran语言是為了滿足[数值计算的需求而發展出來的](../Page/数值计算.md "wikilink")。1953年12月，IBM公司工程師[約翰·巴科斯](../Page/約翰·巴科斯.md "wikilink")（J.
Backus）因深深體會編寫程序很困難，而寫了一份備忘錄給董事長（Cuthbert
Hurd），建議為IBM704系統設計全新的電腦語言以提升開發效率。當時IBM公司的顾问[冯·诺伊曼强烈反对](../Page/冯·诺伊曼.md "wikilink")，因為他認為不切實際而且根本不必要。但赫德批准了這項計劃。1957年，[IBM公司开发出第一套FORTRAN语言](../Page/IBM公司.md "wikilink")，在IBM704電腦上運作。歷史上第一支FORTRAN程式在[馬里蘭州的西屋貝地斯核電廠試驗](../Page/馬里蘭州.md "wikilink")。1957年4月20日星期五的下午，一位IBM軟體工程師決定在電廠內編譯第一支FORTRAN程式，當程式碼輸入後，經過編譯，印表機列出一行訊息：“原始程式錯誤……右側括號後面沒有逗號”，這讓現場人員都感到訝異，修正這個錯誤後，印表機輸出了正確結果。而[西屋電氣公司因此意外地成為FORTRAN的第一個商業用戶](../Page/西屋電氣公司.md "wikilink")。1958年推出FORTRAN
Ⅱ，幾年後又推出FORTRAN Ⅲ，1962年推出FORTRAN Ⅳ後，開始廣泛被使用。

1966年，[美国标准化协会制定了Fortran](../Page/美国国家标准学会.md "wikilink")（x3.9-1966，也就是Fortran
66）和Fortran（x3.10-1966）标准。这时Fortran语言还不是结构化的程序设计语言。

1976年，[美国标准化协会重新对Fortran](../Page/美国国家标准学会.md "wikilink")（x3.9-1966）进行了评估，公布了新的Fortran标准，也就是Fortran
77。Fortran
77是具有结构化特性的编程语言。Fortran77在短时间内取得了巨大的成功，广泛地应用于科学和工程计算，几乎统治了[数值计算领域](../Page/数值计算.md "wikilink")。

1980年，Fortran 77被ISO接纳为国际标准。

1991年发布的Fortran
90大幅改进了旧版Fortran的型式，加入了面向对象的观念与提供指针，并同时加强[数组的功能](../Page/陣列.md "wikilink")。
...
最早的FORTRAN版本應用於IBM 704系統上，包含了32种语句，包括：
  ...
  - 以`IF`這個陳述式檢查例外情況（`ACCUMULATOR OVERFLOW`, `QUOTIENT OVERFLOW`和`DIVIDE
    CHECK`）；`IF`语句以处理[判断开关和判断指示灯](../Page/front_panel.md "wikilink")
  ...
  - `FREQUENCY`语句（为编译器提供[优化帮助](../Page/optimization_\(computer_science\).md "wikilink")）
...
IBM繼續開發*FORTRAN
III*至1958年時已可以內建[組合語言碼並新增其它功能](../Page/組合語言.md "wikilink")；然而這個版本卻從未推出。有如704
...
TAPE`）同時新增一些新的功能，如`LOGICAL`資料型別。[布尔类型](../Page/布林運算式.md "wikilink")（TRUE或者FALSE）與*逻辑IF语句*則取代了*算术IF语句*。FORTRAN
IV於1962年推出，最早應用於[IBM
7030](../Page/IBM_7030.md "wikilink")（"Stretch"）計算機之上，以及其接續的[IBM
7090和](../Page/IBM_7090.md "wikilink")[IBM
7094版本](../Page/IBM_7094.md "wikilink")。

### FORTRAN 66

早期的FORTRAN語言發展史上最重要的一件大事也許是**美國標準協會**（*American Standards
Association*，即今日的[ANSI](../Page/ANSI.md "wikilink")）的委員們開始為FORTRAN制定標準規格，名為"American
...
66*（大家仍習慣稱之為FORTRAN IV）。FORTRAN 66有效的成功第一套工業標準版的FORTRAN。其功能如下：
  ...
  - `DATA`和`FORMAT`语句中的[霍尔瑞斯常数](../Page/霍尔瑞斯常数.md "wikilink")，作为子程序的实际参数
  - 最长六个字母的标识符
  - 注释行
...
77編譯器並未引入ANSI FORTRAN 77標準。一些新功能最終合併到Fortran 90標準版。
  ...
  - [位处理内部函数](../Page/位处理.md "wikilink")，基于类似的包含在[工业实时Fortran（ANSI/ISA
    S61.1（1976））中的函数](../Page/Industrial_Real-Time_Fortran.md "wikilink")

1991年推出[IEEE](../Page/IEEE.md "wikilink") 1003.9
[POSIX標準版](../Page/POSIX.md "wikilink")，為Fortran-77的程式人員提供了POSIX
...
90*，最终于1992年作为ANSI标准发表。这一大版本添加了许多新特性以反映自1978年标准以来发展的在编程方面显著的变化：
  ...
  - [自由格式源代码输入](../Page/free-form_language.md "wikilink")，以及小写的Fortran关键字
  - [模块](../Page/module_\(programming\).md "wikilink")，将有关联的[过程和数据组合在一起](../Page/subprogram.md "wikilink")，使它们可以被其它程序单元调用，包括允许限制一些模块的特定部分访问。
  - [`RECURSIVE`过程](../Page/recursion.md "wikilink")
  - 极大地改善了参数传递机制，允许在编译时检查[接口](../Page/type_signature.md "wikilink")
  - 通用过程的用户自定义接口
  - [運算子多載](../Page/運算子多載.md "wikilink")
  - 衍生／[抽象数据类型](../Page/abstract_data_type.md "wikilink")
  ...
  - [`POINTER`属性](../Page/指针.md "wikilink")，指针赋值和`NULLIFY`语句以便于创建和操作动态[数据结构](../Page/数据结构.md "wikilink")
  - `CASE`结构以用于多路选择
...
Fortran的規格](../Page/High_Performance_Fortran.md "wikilink")：

  - `FOR ALL`和嵌套的`WHERE`结构以帮助向量化
  - 用户定义的`PURE`和`ELEMENTAL`过程

Fortran
95的一个重要补充是[ISO技术报告](../Page/国际标准化组织.md "wikilink")*[TR-15581：增强的数据类型工具](ftp://ftp.nag.co.uk/sc22wg5/N1351-N1400/N1379.pdf)*，非正式名称是*可分配的TR*。这一标准定义了`ALLOCATABLE`数组的增强的应用，先于与完全的Fortran
...
95保证的，当它们退出范围时会被自动释放掉，避免了[内存溢出的可能性](../Page/内存溢出.md "wikilink")。另外，[别名也不再是优化数组引用时的一个问题](../Page/aliasing_\(computing\).md "wikilink")，可以使编译器生成比用指针时更快的代码。）

Fortran
95的第二个补充是[ISO技术报告](../Page/国际标准化组织.md "wikilink")*[TR-15580：浮点异常处理](ftp://ftp.nag.co.uk/sc22wg5/N1351-N1400/N1378.pdf)*，非正式名称是*IEEE
TR*。这一标准定义了对[IEEE浮点算术和](../Page/IEEE_754.md "wikilink")[浮点](../Page/浮点.md "wikilink")[异常处理的支持](../Page/异常处理.md "wikilink")。

### Fortran 2003

*Fortran 2003*有著更大幅度的改版。[ISO](../Page/国际标准化组织.md "wikilink") [Fortran
Working Group (WG5)](http://www.nag.co.uk/sc22wg5/)的官方网站有关于Fortran
...
据该文所述，本版本的主要改进包括：
  ...
  - 支持[面向对象编程](../Page/面向对象编程.md "wikilink")：[扩展类型和继承](../Page/继承_\(计算机科学\).md "wikilink")，[多态](../Page/多态.md "wikilink")，动态类型分配，以及类型绑定过程。
  - 改善了数据操作：可分配的组件（编入IEEE TR
    15581），延期的类型参数，[`VOLATILE`属性](../Page/易变变量.md "wikilink")，在数组构造和分配语句中显式定义类型，增强的指针，扩展的初始化表达式，增强的内部过程。
  - 增强的输入／输出：[异步传输](../Page/asynchrony.md "wikilink")，流访问，用户指定衍生类型的传输操作，用户在格式转换时指定舍入控制，为连接前单元指定常数，`FLUSH`语句，关键字的规范，访问错误信息。
  - [过程指针](../Page/函数指针.md "wikilink")。
  - 支持[IEEE浮点算法和](../Page/IEEE_754.md "wikilink")[浮点](../Page/浮点.md "wikilink")[异常处理](../Page/异常处理.md "wikilink")（编入IEEE
    TR 15580）。
  - 与[C语言的交互性](../Page/C语言.md "wikilink")
  - 支持国际化：访问[ISO
    10646](../Page/ISO_10646.md "wikilink")4字节字符和在格式化的数字输入／输出中选择数字或者逗号。
  - 与宿主操作系统增强的集成：访问[命令行参数](../Page/命令行.md "wikilink")，[环境变量和处理器错误信息](../Page/环境变量.md "wikilink")。
...
如同February 2007，新的功能包括了
  ...
  - [Co-array Fortran](../Page/Co-array_Fortran.md "wikilink") –并行處理模式
...
## FORTRAN的特性
  ...
  - Fortran语言的最大特性是接近[数学公式的自然描述](../Page/数学公式.md "wikilink")，在计算机里具有很高的执行效率。
  - 易学，语法严谨。
  - 可以直接对[矩阵和](../Page/矩阵.md "wikilink")[复数进行运算](../Page/复数.md "wikilink")，這點[Matlab有繼承](../Page/MATLAB.md "wikilink")。
  - 自诞生以来广泛地应用于数值计算领域，积累了大量高效而可靠的[源程序](../Page/源程序.md "wikilink")。
  - 很多专用的大型数值运算计算机针对Fortran做了优化。
  - 广泛地应用于[并行计算和](../Page/并行计算.md "wikilink")[高性能計算领域](../Page/高性能计算.md "wikilink")。
  - Fortran 90，Fortran 95，Fortran 2003的相继推出使Fortran语言具备了现代高级编程语言的一些特性。
  - 其矩陣元素在記憶空間儲存順序是採用[列優先](../Page/列優先.md "wikilink")（Column
    major），[Matlab也承襲這點](../Page/MATLAB.md "wikilink")，目前最多使用的[C語言則採用](../Page/C語言.md "wikilink")[行優先](../Page/行優先.md "wikilink")（Row
    major）。

## FORTRAN的Hello World程式

下面是一个在标准输出设备上输出[Hello
World的简单程序](../Page/Hello_World程序.md "wikilink")，这种程序通常作为开始学习编程语言时的第一个程序：
  ...
  - Windows操作系统下：
      - **Visual Fortran**系列
          - **Fortran Power Station** 4.0（FPS
            4.0），[微软公司开发的Fortran编译器](../Page/微软公司.md "wikilink")。1997年3月转让给[DEC公司](../Page/DEC公司.md "wikilink")。
          - **Digital Visual Fortran**（DVF），Fortran Power
            Station的DEC公司版本，版本号为5.0.x \~
            6.0.x。1998年1月，DEC公司被[康柏公司收购](../Page/康柏公司.md "wikilink")，Digital
            Visual Fortran更名为Compaq Visual Fortran。
          - **Compaq Visual Fortran**（CVF），上述DVF的进一步发展，版本号6.5.x \~
            6.6.B。2002年5月康柏公司已并入[惠普公司](../Page/惠普公司.md "wikilink")，但仍然称为Compaq
            Visual Fortran，版本号升级到6.6.C。
          - **Intel
            Fortran**，[英特尔公司开发的Fortran编译器](../Page/英特尔公司.md "wikilink")。事实上，惠普购买了Compaq的Fortran编译器技术之后不久，便留下了用于[Linux](../Page/Linux.md "wikilink")／[UNIX系统的相关技术](../Page/UNIX.md "wikilink")，而将[Windows平台上的Fortran编译器相关权利全部转售给Intel](../Page/Windows.md "wikilink")。因此从CVF
      ...
      - **Silverfrost FTN95**，个人用户可免费使用的Fortran
        ...
        Studio](../Page/Visual_Studio.md "wikilink")，调试器使用SDBG。
...
## 參見
  ...
  - [High Performance
    Fortran](../Page/High_Performance_Fortran.md "wikilink")
    -[高性能計算專用的Fortran程式語言](../Page/高效能運算.md "wikilink")

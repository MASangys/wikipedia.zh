...
Fossil是一个服务器，可以运行于[Linux](../Page/Linux.md "wikilink")、[BSD](../Page/BSD.md "wikilink")衍生系统、[MacOS](../Page/MacOS.md "wikilink")和[Windows等各种平台](https://zh.wikipedia.org/wiki/Windows "wikilink")。它能够提供分布式版本控制、问题跟踪、[wiki服务和博客](https://zh.wikipedia.org/wiki/wiki "wikilink")。该软件有一个内置的[网络接口](../Page/用户界面.md "wikilink")，这降低了[项目跟踪的复杂性](https://zh.wikipedia.org/wiki/项目 "wikilink")，并提升了[状态意识](../Page/状态意识.md "wikilink")。用户可以简单地键入“fossil ui”，Fossil就会自动在用户的[网页浏览器](../Page/网页浏览器.md "wikilink")中打开一个网页，提供详细历史和状态信息。
...
[SQLite](../Page/SQLite.md "wikilink")项目使用Fossil来进行版本控制，而它本身又是Fossil的一个组件。SQLite是2009年9月由[CVS转而使用Fossil作版本控制的](https://zh.wikipedia.org/wiki/协作版本系统 "wikilink")。\[3\]

使用Fossil的其它一些项目的例子：

  - [Tcl](../Page/Tcl.md "wikilink")/Tk项目
...
以下网站为Fossil代码库提供免费源码托管服务：
  ...
  - [Chisel](http://chiselapp.com/)。原网站所有者詹姆斯·特纳（James Turner）宣布，该网站将于2013年5月1日停止运作。\[4\]在2013年5月1日域名所有权转移之后，它得以继续运作。\[5\]

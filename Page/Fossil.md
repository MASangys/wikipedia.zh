**Fossil**是一个[分布式版本控制系统](https://zh.wikipedia.org/wiki/分布式版本控制系统 "wikilink")、[缺陷跟踪管理系统以及在](../Page/缺陷跟踪管理系统.md "wikilink")[软件开发中使用的](https://zh.wikipedia.org/wiki/软件开发 "wikilink")[wiki软件服务器](https://zh.wikipedia.org/wiki/wiki软件 "wikilink")，它由创建。
...
内容是使用[SQLite数据库存储的](../Page/SQLite.md "wikilink")，因此[事务是](../Page/数据库事务.md "wikilink")的，即使是因掉电或宕机而中断。\[1\]

Fossil是[自由软件](../Page/自由软件.md "wikilink")，遵循[BSD许可证发布](../Page/BSD许可证.md "wikilink")。\[2\]（由先前的[GPL](https://zh.wikipedia.org/wiki/GPL "wikilink")）。

## 应用

[SQLite项目使用Fossil来进行版本控制](../Page/SQLite.md "wikilink")，而它本身又是Fossil的一个组件。SQLite是2009年9月由[CVS转而使用Fossil作版本控制的](https://zh.wikipedia.org/wiki/协作版本系统 "wikilink")。\[3\]

使用Fossil的其它一些项目的例子：

  - [Tcl/Tk项目](../Page/Tcl.md "wikilink")
...
以下网站为Fossil代码库提供免费源码托管服务：
  ...
  - [Chisel](http://chiselapp.com/)。原网站所有者詹姆斯·特纳（James
    Turner）宣布，该网站将于2013年5月1日停止运作。\[4\]在2013年5月1日域名所有权转移之后，它得以继续运作。\[5\]
  - [SourceForge](../Page/SourceForge.md "wikilink")（非官方的、通过网页的托管服务\[6\]）

**FreeBSD**是一个[类Unix的](../Page/类Unix系统.md "wikilink")[操作系统](../Page/操作系统.md "wikilink")，也是FreeBSD项目的发展成果。\[1\]FreeBSD是第一个[开放源代码的系统](../Page/开源.md "wikilink")，他是由基于[BSD
Unix的源代码衍生而来的](../Page/BSD.md "wikilink")。BSD
Unix是[加州大学伯克利分校在](../Page/加州大学伯克利分校.md "wikilink")1975年至1993年开发的操作系统。FreeBSD被开发为自由软件，这意味着其源代码开放，人人都可以使用FreeBSD。任何人都可以获得并使用它来满足各种需求，也可以修改它，然后再重发布它。此功能专为个人和公司量身定制，可用于创建各种基于FreeBSD的商业和非商业产品。尽管FreeBSD直接从BSD衍生，但是从法律的角度来看，FreeBSD并不是“UNIX”。因为现在“UNIX”商标是属于[国际开放标准组织的](../Page/国际开放标准组织.md "wikilink")。\[2\]FreeBSD的第一个版本于1993年发布。
...
除了支持一些流行的平台(如 [x86](../Page/x86.md "wikilink")
、[x86-64等等](../Page/x86-64.md "wikilink")。 FreeBSD还支持
[ARM](../Page/ARM架构.md "wikilink")、[MIPS](../Page/MIPS架构.md "wikilink")
...
FreeBSD支持两种数据加密基础体系：和。两者操作均在磁盘层级上。是由所编写的，并在遵守[双BSD许可证](../Page/双BSD许可证.md "wikilink")（即“简化BSD许可证”和“FreeBSD许可证”二者）的情况下发布的。而则是的替代品，它第一次在FreeBSD
6.0上出现，由帕·雅·戴夫（Pawel Jakub Dawidek）编写。

FreeBSD支持[UFS](../Page/UFS.md "wikilink")、[ZFS等多种文件系统](../Page/ZFS.md "wikilink")。
...
FreeBSD在[BSD許可證下发布](../Page/BSD許可證.md "wikilink")\[7\]，允许任何人在保留版权和许可协议信息的前提下随意使用和发行。BSD许可协议并不限制将FreeBSD的[源代码在另一个协议下发行](../Page/源代码.md "wikilink")，因此任何团体都可以自由地将FreeBSD代码融入它们的产品之中去。
...
也可以說是Submitter，无FreeBSD的[CVS的存取權限](../Page/CVS.md "wikilink")，但是可以透過其它的方式，例如提交Problem
Reports或是在Mailing list上面參與討論，來對FreeBSD做出貢獻。 \[8\]

### Committer

有对FreeBSD的[Subversion存取的权限](../Page/Subversion.md "wikilink")，可以将他的[源代码或是](../Page/源代码.md "wikilink")[文件送到版本库里面](../Page/文件.md "wikilink")。一个committer必须要在过去的12个月中有commit的动作。而一个活跃的committer指在每个月至少都有一次以上的commit动作。
...
1，完整支持平台）目前包括[i386](../Page/X86.md "wikilink")、[AMD64](../Page/AMD64.md "wikilink")。第二线平台（Tier
2，发展平台）包括[ARM](../Page/ARM.md "wikilink")、[IA-64](../Page/IA-64.md "wikilink")、[PC98](../Page/PC98.md "wikilink")、[PowerPC](../Page/PowerPC.md "wikilink")、。对于第一线与第二线平台，FreeBSD会维持维护及稳定性，同时大多数的新功能也都会被要求在这些平台上能够正常运作。

第三线平台（Tier
3，实验平台）目前包括了[MIPS及](../Page/MIPS.md "wikilink")，这个等级的平台不被FreeBSD正式支持。
...
<tbody>
<tr class="odd">
<td><p><a href="../Page/x86.md" title="wikilink">IA-32</a></p></td>
<td><p>Tier 1</p></td>
<td><p>參見"i386"</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p><a href="../Page/Itanium.md" title="wikilink">Itanium (IA-64)</a></p></td>
<td><p>Tier 2</p></td>
<td></td>
</tr>
<tr class="odd">
<td><p><a href="../Page/NEC_PC-9801.md" title="wikilink">NEC PC-9801</a></p></td>
<td><p>Tier 2</p></td>
<td><p>參見"pc98"</p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><a href="../Page/Sun_Microsystems.md" title="wikilink">Sun</a> <a href="../Page/SPARC.md" title="wikilink">SPARC</a></p></td>
<td><p>Tier 2</p></td>
...
FreeBSD的发展始于1993年，起源于。\[11\]然而，因为386BSD原始码的合理性受到质疑以及[Novell](../Page/Novell.md "wikilink")（当时[UNIX的版权拥有者](../Page/UNIX.md "wikilink")）与[柏克莱接连而来的诉讼](../Page/柏克莱.md "wikilink")，FreeBSD在1995年1月发布的2.0-RELEASE中以[柏克莱加州大学的](../Page/柏克莱加州大学.md "wikilink")4.4BSD-Lite
Release全面改写。[FreeBSD
Handbook](http://www.freebsd.org/doc/en_US.ISO8859-1/books/handbook/)中有更多FreeBSD的发展历史。

FreeBSD 2.0最值得注意的部份也许是对[卡内基美隆大学的Mach](../Page/卡内基美隆大学.md "wikilink")
Virtual Memory系统翻修以及FreeBSD Ports
system的发明。前者对于高负荷的系统优化，后者则是建立了一套简单且强大的机制维护第三方软件。有不少大型站台都使用FreeBSD，像是cdrom.com（一个巨大的软件收集站台），[Hotmail以及](../Page/Hotmail.md "wikilink")[Yahoo](../Page/Yahoo.md "wikilink")。

FreeBSD 3.0则引入了ELF
binary格式，并开始支持多CPU系统（[SMP](../Page/對稱多處理機.md "wikilink")，Symmetric
multiprocessing）以及64位[Alpha平台](../Page/Alpha.md "wikilink")。3.x对于系统做了非常多的改革，这些措施在当时并没有带来好处，但却是4.X成功的基石。

### FreeBSD 4

4.0-RELEASE于2000年3月发行，最后一个版本4.11-RELEASE于2005年1月发行，并支持到2007年1月\[12\]。FreeBSD
4也是FreeBSD最长寿的主版本。在FreeBSD
4所发展出来的[kqueue也被移植到各种不同BSD平台](../Page/kqueue.md "wikilink")。
...
另外一个重大的改变在于自5.3开始支持m:n[线程的](../Page/线程.md "wikilink")[KSE](../Page/KSE.md "wikilink")（Kernel
...
7.3-RELEASE正式发布\[16\]。新增的功能包括了：
  ...
  - [SCTP](../Page/SCTP.md "wikilink")（實做完成）\[17\]
  - [日志式](../Page/日志式.md "wikilink")[UFS](../Page/UFS.md "wikilink")[文件系统](../Page/文件系统.md "wikilink")：gjournal（实做完成）\[18\]
  - 移植[升阳所发展的](../Page/升阳.md "wikilink")[DTrace](../Page/DTrace.md "wikilink")（实做完成，但还未交付至[CVS](../Page/CVS.md "wikilink")）
  - 移植升阳所发展的[ZFS文件系统](../Page/ZFS.md "wikilink")（实做完成）\[19\]
  - 使用[GCC](../Page/GCC.md "wikilink")4（移植完成，目前為4.2.1）\[20\]
  - 對[ARM與](../Page/ARM.md "wikilink")[MIPS平台的支援](../Page/MIPS.md "wikilink")
  - 重寫過的[USB](../Page/USB.md "wikilink")
    stack（實做完成，但還未交付至[CVS](../Page/CVS.md "wikilink")）
  - Scalable concurrent malloc實做（已經可以使用）\[21\] \[22\]
  - [ULE](../Page/ULE.md "wikilink")[排程表](../Page/排程表.md "wikilink")2.0（SCHED_ULE，實做完成）\[23\]，並修改加強為SCHED_SMP（實做完成），在交付至CVS時的正式名稱為ULE
    3.0\[24\]，這個版本在8核心的機器上以sysbench
    [MySQL測試的結果](../Page/MySQL.md "wikilink")，速度上比[Linux](../Page/Linux.md "wikilink")
    2.6快大約10%（無論是使用[Google的](../Page/Google.md "wikilink")[tcmalloc或是](../Page/tcmalloc.md "wikilink")[glibc](../Page/glibc.md "wikilink")+cfs）\[25\]
...
2010年7月24日发布FreeBSD 8.1-RELEASE, \[30\] 增加如下新特性：\[31\]
  ...
  - 基于[Juniper
    Networks提供](../Page/Juniper_Networks.md "wikilink")[MIPS处理器的实验性支持](../Page/MIPS.md "wikilink")。
  - [SMP扩展性的增强](../Page/對稱多處理機.md "wikilink")，显着改善在16核心处理器系统中的性能。
  - [VFS加锁的重新实现](../Page/VFS.md "wikilink")，显着改善文件系统的可扩展性。
  - 显着缓解缓冲区溢出和内核空指针问题。
...
FreeBSD 9.0于2012年1月发布，该版本是第一个9.x的FreeBSD稳定分支。该版本具有以下特性：
  ...
  - 采用了新的安装程序bsdinstall
  - [ZFS和](../Page/ZFS.md "wikilink")[NFS文件系统得到改进](../Page/NFS.md "wikilink")
  - 升级了ATA/SATA驱动并支持AHCI
  - 采用[LLVM](../Page/LLVM.md "wikilink")/[Clang代替GCC](../Page/Clang.md "wikilink")
  - 高效的[SSH](../Page/SSH.md "wikilink")（HPN-SSH）
...
FreeBSD 10.0於2014年1月發布，这一版本包含的重要改进包括：
  ...
  - 在支持的平台上， [clang](../Page/clang.md "wikilink")(1) 取代
    [GCC](../Page/GCC.md "wikilink")
    成为了默认的系统[编译器](../Page/编译器.md "wikilink")。
  - 系統中引入了 Unbound 作为本地的緩存 [DNS](../Page/DNS.md "wikilink") 服務器。
  - 基本系统中删除了 BIND。
  - 使用来自 [NetBSD](../Page/NetBSD.md "wikilink") 的 bmake(1) 取代了原有的
    [make](../Page/make.md "wikilink")(1)。
  - 使用了新的 pkg(7) 作为包管理工具。
  ...
  - 為 [ZFS](../Page/ZFS.md "wikilink") 添加了用於
    [SSD](../Page/SSD.md "wikilink") 的 TRIM 支持。
...
FreeBSD 10.2於2015年8月13日正式發布。主要改進包括\[42\]：
  ...
  - [resolvconf](../Page/resolvconf.md "wikilink")(8) 更新至
    3.7.0，改进了[DNS隐私保护](../Page/DNS.md "wikilink")。
  - [ntp](../Page/ntp.md "wikilink") 更新至 4.2.8p3，修正了大量先前版本的问题。
  - 新增了用于支持[虚拟化环境的](../Page/虚拟化.md "wikilink") rc(8) 脚本
    [growfs](../Page/growfs.md "wikilink")，用于在系统首次引导时扩大根文件系统。
  - 对 [Linux](../Page/Linux.md "wikilink")(R)
    ABI兼容支持进行了更新，以支持[Centos](../Page/Centos.md "wikilink")(TM)
    6 ports.
  - 将 [drm](../Page/drm.md "wikilink") 更新至
    [Linux](../Page/Linux.md "wikilink")(R) 3.8.13，支持同时运行多个 [X
    server](../Page/X_server.md "wikilink")。
...
<!-- end list -->
  ...
  -
    在 -CURRENT分支所使用的[CVS](../Page/CVS.md "wikilink")
    Tag为`.`，固定被称为A-CURRENT，如目前的
    -CURRENT分支为12-CURRENT，这个版本只建议开发者使用，通常在[邮件论坛上测试过觉得没有什么大问题的功能会先被加到这个分支里](../Page/邮件论坛.md "wikilink")。
...
<!-- end list -->
  ...
  -
    在 -STABLE分支里所使用的[CVS](../Page/CVS.md "wikilink") Tag为`RELENG_A`，如目前的
    -STABLE分支为`RELENG_10`与`RELENG_9`。许多新的功能在
    -CURRENT分支测试一段期间觉得没有问题后就会将该项功能逆向移植（MFC，Merge
    from current）回`RELENG_10`。
...
<!-- end list -->
  ...
  -
    在 -RELEASE分支里所使用的[CVS](../Page/CVS.md "wikilink")
...
FreeBSD包含了[GNU通用公共许可证](../Page/GNU通用公共许可证.md "wikilink")、[GNU宽通用公共许可证](../Page/GNU宽通用公共许可证.md "wikilink")、[ISC许可证](../Page/ISC许可证.md "wikilink")、[通用开发与散布许可证和](../Page/通用开发与散布许可证.md "wikilink")[啤酒软件许可证的程序代码](../Page/啤酒软件.md "wikilink")，也有使用三条款和四条款的BSD许可证的程序代码。另外有些驱动程序也包涵了[二进制大型物件](../Page/二进制大型物件.md "wikilink")，像是[Atheros公司的](../Page/Atheros.md "wikilink")[硬件抽象层](../Page/硬件抽象层.md "wikilink")。这使得所有人都可以自由地使用还有再散布FreeBSD。

不过，FreeBSD的核心和新开发的程序代码大多都使用两条款的[BSD许可证释出](../Page/BSD许可证.md "wikilink")，许多使用GPL的程序代码都必须经过[净室工程](../Page/净室#作为软件工程的术语.md "wikilink")，以其他授权方式重写，这主要是避免整个核心受到GPL影响。
...
## 相关书籍
  ...
  - *The Design and Implementation of the FreeBSD Operating System*.
    [Marshall Kirk
    McKusick](../Page/Marshall_Kirk_McKusick.md "wikilink") and George
    V. Neville-Neil. Pearson Education. ISBN 0-201-70245-2. Expected
...
## 参见
  ...
  - [FreeSBIE](../Page/FreeSBIE.md "wikilink")

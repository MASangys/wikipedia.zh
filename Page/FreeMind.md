...
可设置节点文字和背景颜色、形状（叉状/泡状）、自动布局、闪烁节点等。节点可导出，并支持多种格式的导出，如HTML、XHTML、OpenOffice Writer、PNG、JPEG、Applet、Flash、SVG、PDF等。支持多种语言，如中文。

### 扩展性

由于FreeMind使用Java编写，支持使用[Python](../Page/Python.md "wikilink")编写的扩展插件。另外文件格式是[xml的](https://zh.wikipedia.org/wiki/xml "wikilink")。

## 缺陷

  - 无法多个思维中心点展开（亦有人认为这样是优点可以让人们专心于眼前的事）
  - 部分中文[输入法](../Page/输入法.md "wikilink")无法在FreeMind输入（只是部分, 存在可以正常输入中文的输入法）
...
[Category:思維導圖軟件](https://zh.wikipedia.org/wiki/Category:思維導圖軟件 "wikilink") [Category:SourceForge專案](https://zh.wikipedia.org/wiki/Category:SourceForge專案 "wikilink")
**FreeRTOS**是一個熱門的\[1\][嵌入式裝置用](../Page/嵌入式裝置.md "wikilink")[即時作業系統核心](../Page/即時作業系統.md "wikilink")\[2\]\[3\]，它于2003年由Richard
Barry设计，并已被經成功移植到35種不同的[微控制器上](../Page/微控制器.md "wikilink")\[4\]。FreeRTOS採用[MIT许可证授權](../Page/MIT许可证.md "wikilink")。

## 實作

FreeRTOS的設計小巧且簡易，整個核心程式碼只有3到4個C檔案，為了讓程式碼容易閱讀、移植和維護，大部分的程式碼都是以[C語言編寫](../Page/C語言.md "wikilink")，只有一些函式（多數是架構特定排班副程式）採用[組合語言編寫](../Page/組合語言.md "wikilink")。

FreeRTOS提供許多方法以實現多[线程](../Page/线程.md "wikilink")（threads）、多[作業](../Page/作業_\(電腦\).md "wikilink")（task）、[互斥鎖](../Page/互斥鎖.md "wikilink")（mutex）、[號誌](../Page/信號標.md "wikilink")（semaphore）和[軟體計時器](../Page/軟體計時器.md "wikilink")（software
...
Windows等典型作業系統具有的先進特徵](../Page/Microsoft_Windows.md "wikilink")，例如、先進[記憶體管理機制](../Page/記憶體管理.md "wikilink")、使用者管理和網路管理，FreeRTOS著重在執行的簡潔與速度，FreeRTOS有時會被視為是一個『執行緒函式庫』而非『作業系統』，儘管可以找到[命令列介面和類似](../Page/命令列介面.md "wikilink")[POSIX](../Page/POSIX.md "wikilink")
I/O 介面的插件。

FreeRTOS實作了多執行緒，主程式會在規律的短時間區間內呼叫一個執行緒時計方法，這個方法會以[循環制依照任務的優先順序進行任務切換](../Page/循環制.md "wikilink")，一般來說，這個短時間區間介於
...
## 主要特色
  ...
  - [排程器可以設定成](../Page/排程器.md "wikilink")[可搶先](../Page/抢占式多任务处理.md "wikilink")（preemptive）或（cooperative
    operation）
...
## 支援平台
  ...
  - [ARM architecture](../Page/ARM_architecture.md "wikilink")

      - [ARM7](../Page/ARM7.md "wikilink")

      - [ARM9](../Page/ARM9.md "wikilink")

      -
      - [ARM Cortex-A](../Page/ARM_Cortex-A8.md "wikilink")

  - [Atmel](../Page/Atmel.md "wikilink")
  ...
  -   -
  - [Fujitsu](../Page/Fujitsu.md "wikilink")
  ...
  - [Intel](../Page/Intel.md "wikilink")
      ...
      - [8052](../Page/英特爾8051#8052.md "wikilink")
  ...
  - [Texas Instruments](../Page/德州儀器.md "wikilink")
  ...
  - [Xilinx](../Page/Xilinx.md "wikilink")
      ...
      -
      - [Zynq-7000](../Page/Xilinx#Zynq.md "wikilink")

## 相關系統

### SafeRTOS

SafeRTOS的功能和FreeRTOS類似，但是是為實現[安全關鍵系統所設計](../Page/安全關鍵系統.md "wikilink")。FreeRTOS的機能模型經過完全的[HAZOP](../Page/危害與可操作性分析.md "wikilink")，其機能模型及API因為使用者誤用或是硬體失效造成的弱點都已經識別且修正。最後的需求經過完整[IEC
...
Ltd
為其合作夥伴\[5\]。SafeRTOS和FreeRTOS有相同的排程演算法，相似的[API](../Page/API.md "wikilink")，其他方面也相當類似\[6\]，不過是因為不同的目標而設計的\[7\]。SafeRTOS只用C語言進行開發，以符合IEC61508的認證需求\[8\]。
...
## 参见
  ...
  - [嵌入式操作系统](../Page/嵌入式操作系统.md "wikilink")

...
Project**是游戏《》源代码的延伸，原开发者[Volition公司于](../Page/Volition_\(公司\).md "wikilink")2002年释放了[源代码](../Page/源代码.md "wikilink")，在那之后，多个项目使用了该引擎。其中最为知名的是基于和宇宙背景的一个游戏。此引擎以一个开源非商业的协议发布。
...
## 外部链接
  ...
  - [Official FreeSpace Source Code Project
    网站](http://scp.indiegames.us/)
  - [Freespace Open Installer](http://www.fsoinstaller.com/) A project
    to compile the source code into an installer
  - [*FreeSpace 2* source
    code](https://web.archive.org/web/20091215074200/http://www.gamespot.com/pc/sim/freespace2/download_2862847.html)
  - [Hard Light Productions](http://www.hard-light.net/) A current
    community centre of *FreeSpace 2*.
  - [Game Warden](http://www.game-warden.com/forum/index.php) Hosts
    numerous *FreeSpace* projects including the *Starfox* and
    *Battlestar Galactica* total conversions
  - *[Imperial
  ...
  - [*FreeSpace* Wiki](http://www.hard-light.net/wiki/index.php) The
    complete *FreeSpace* reference Wiki

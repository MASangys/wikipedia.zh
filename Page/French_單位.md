...
French單位由發明。他是一名19世纪巴黎的外科手术器械制造商人，並制定了「French單位代表導管直徑的三倍」的关系\[2\]。

## 計算與定義

French單位代表導管直徑的三倍。一个1\(Fr\)的圆形導管的外部[直徑为](../Page/直径.md "wikilink") 毫米\[3\]。因此，圆形導管的直徑可通过French的大小除3來得出\[4\]：
...
French單位度量的是導管的外徑，而非內徑。举例来说，20\(Fr\)的[雙腔導管和相同的](https://zh.wikipedia.org/wiki/雙腔導管 "wikilink")\(Fr\)值的[三腔導管相比](https://zh.wikipedia.org/wiki/三腔導管 "wikilink")，雖然兩種皆擁有同樣口徑的外徑，但雙腔導管的內徑會比三腔導管大。

## 值的換算

[缩略图](https://zh.wikipedia.org/wiki/File:French_catheter_scale.gif "fig:缩略图")
...
2.
3.
4.  直徑使用「\(d\)」來表示，且單位使用[毫米](../Page/毫米.md "wikilink")
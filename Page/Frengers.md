> 本文内容由[Frengers](https://zh.wikipedia.org/wiki/Frengers)转换而来。
...
1.  "Am I Wry? No"（背景動畫）
2.  "Symmetry"（背景動畫）
3.  "Behind The Drapes"（背景動畫）
4.  "Eight Flew Over, One Was Destroyed"（背景動畫）
5.  "King Christian"（背景動畫）
6.  "I Should Have Been A Tsin-Tsi (For You)"（背景動畫）
7.  "Mica"（背景動畫）
8.  "Comforting Sounds"（背景動畫）
9.  "The Pestilence"
10. "Comforting Sounds"（音樂錄影帶）
11. "156"（音樂錄影帶）
...
<!-- end list -->
  ...
  - Patrick Warren—鋼琴（第1、8首）
  - Damon Tutunjian—演唱（第2首）、吉他（第9首）
  - Becky Jarrett—演唱（第4首）
  - Nick Watts—鋼琴（第4、10首）、鍵盤（第9、10首）
  - Rich Costey—固定拍鈸（第6首）
  - Stina Nordenstam—演唱（第6首）
  - Tobias Bertram—唱機（第6、8首）
  - Klaus Nielson—鋼琴（第6首）
  - Bo Rande—小號（第10首）

...
**F型连接头**是一种[同轴](https://zh.wikipedia.org/wiki/同轴 "wikilink")[射频连接器](https://zh.wikipedia.org/wiki/射频 "wikilink")，通常用于“空中传播”的[无线电视](https://zh.wikipedia.org/wiki/无线电视 "wikilink")、[有线电视以及普遍用于](../Page/有线电视.md "wikilink")[无线电视和](https://zh.wikipedia.org/wiki/无线电视 "wikilink")[cable
...
F型连接头并不昂贵，可是它对于75欧姆却有着良好的[阻抗匹配能高达](https://zh.wikipedia.org/wiki/阻抗匹配 "wikilink")1Ghz，而且可用[带宽高达几GHz](../Page/带宽.md "wikilink")。它的成本如此低廉的一个原因是由于其使用了特定型号的[同轴电缆的固态导体](../Page/同轴电缆.md "wikilink")（缆芯）作为其公型连接头的探针。此种设计受限于其内部导体的表面特性（其必须是固体导线）而且不是防腐蚀的，因此对于野外使用（例如布置在空中时）时需要采用防水的型号。公型连接头的身体通常是压进或者有时候是旋进外露的编织金属网。电缆行业标准现在是采用压力连接头。母型连接头有一个
3/8-32
...
它适用于地面、有线以及卫星电视的设备安装，并且比在欧洲地面接收器上使用的[Belling-Lee连接头有重要的改进](https://zh.wikipedia.org/wiki/Belling-Lee连接头 "wikilink")。它要求在安装公头到电缆上的时候比Belling-Lee连接头更加小心，而对于连接头的质量总是需要关注的，同时要注意与电缆尺寸匹配。另外需要注意的是，在中国大陆有两种规格的F头，分别称为“公制”（中国标准）和“英制”（国际标准），公制F头内径比英制大0.5mm，两者互不兼容，使用时需注意。
...
## 参见
  ...
  - [卫星天线](https://zh.wikipedia.org/wiki/卫星天线 "wikilink")

...
使用[編譯程式定向](https://zh.wikipedia.org/wiki/編譯程式定向 "wikilink")（[compiler directive](https://zh.wikipedia.org/wiki/編譯程式定向 "wikilink")）的控制碼：「`pragma License (Modified_GPL);`」就能夠使[GNAT編譯器以Modified](https://zh.wikipedia.org/wiki/GNAT "wikilink") GPL的授權方式進行查核確認。
...
## 參見
  ...
  -
[Category:GNU](https://zh.wikipedia.org/wiki/Category:GNU "wikilink") [Category:自由軟體授權](https://zh.wikipedia.org/wiki/Category:自由軟體授權 "wikilink") [Category:Ada程式語言](https://zh.wikipedia.org/wiki/Category:Ada程式語言 "wikilink")
...
<!-- end list -->
  ...
  -
    名稱源自於九大天使階級之一的「[熾天使](../Page/熾天使.md "wikilink")（Seraphim）」。
...
<!-- end list -->
  ...
  -
    隱藏機體天使長GUNDAM首度從背後現身，擊墜變革者機體「加萊佐」及其駕駛員布林格。
...
<!-- end list -->
  ...
  -
    與變革者機體「加迪薩」交戰，首次同時使用六把GN光束軍刀並將其擊墜，駕駛員里凡穆駕駛核心戰機逃脫時被天使長GUNDAM俘虜。
...
<!-- end list -->
  ...
  -
    與變革者機體「加迪薩」及「加萊佐」交戰，於二機使用「Trans-AM」系統後被斬去雙臂墜落至變革者宇宙要塞「天上人」表面。
...
兩把收納於手腕裝甲內，四把各藏在四門GN加農砲的隱藏手臂中。

對於以砲擊為主要攻擊模式的熾天使GUNDAM，粒子束軍刀只是預備性的裝備而已，但藉由伸出隱藏在GN加農砲中的粒子束軍刀能使近身戰鬥力提高，從而令戰術運用更為豐富。甚至可以與隱藏手臂連動同時使用六把光束軍刀，以極為罕見的「六刀流」壓制對手。
...
在GN-008GNHW/B 熾天使鋼彈 GNHW/B所呈現的新設計武裝。

裝置於腰部兩側，和普通的GN加農砲一樣能攻擊敵機，唯一不同之處就是沒有隱藏手臂及GN光束軍刀。一樣可與其他武裝連動強化火力。

## 特殊裝置

### Trans-AM系統（Trans-AM System）

做為新生天上人的第四(3.5)代GUNDAM共通的設計，各機均以使用Trans-AM系統為前提而進行設計。

同時，與舊世代機體使用Trans-AM系統時主要是提升機動性相比，現在則可以依不同機體特性而強化不同能力。

熾天使GUNDAM的Trans-AM系統主要為提高GN火箭砲Ⅱ及GN加農砲的輸出威力，提升火力。

### 巨臉爆發模式（Face burst Mode）

將背包隱藏的巨型鋼彈臉展開後的模式。在此模式下可以將儲存的GN粒子在短時間內高度壓縮後放出，同時也能提高GN-Drive的輸出功率，藉此強化GN火箭砲II與GN加農砲的火力、GN力場的強度以及機體手臂的臂力。熾天使引以為傲的超絕重火力模式就是在Trans-AM模式下發動巨臉爆發的成果。

## GN-Drive

與第三世代GUNDAM和其他第四世代GUNDAM不同，熾天使的GN-Drive放置在背後的GUNDAM臉內。

這是考慮到背部隱藏機體（天使長GUNDAM）分離主體時能作為動力來源。在兩者分離時，GN-Drive位置在天使長鋼彈，且由於機體內藏大型電容器，因此與GN-Drive分離後仍能在一定時間內繼續行動。

## 變化型

### GN-008GNHW/B 熾天使GUNDAMGNHW/B（Seravee Gundam GNHW/B）
...
追加的GN加農砲（沒有隱藏手臂及GN粒子束軍刀）裝置於腰部兩側，GN力場強化裝置之位置和數量皆與第三世代的德天使GUNDAM相同。
...
<!-- end list -->
  ...
  -
    大型GN容器（Large GN Condenser）×4
    GN推進器（GN Vernier）×2
    GN力場強化裝置（GN Field Occurrence Strengthening Part）×4
    Trans-AM系統（Trans-AM System）
...
<!-- end list -->
  ...
  -
    型號中的「GNHW」是「GN Heavy Weapon（GN重型武裝）」的意思，「B」是粒子束（Beam）。

### GN-008GNHW/3G 熾天使GUNDAMGNHW/3G（Seravee Gundam GNHW/3G）
...
<!-- end list -->
  ...
  -
    GN火箭砲Ⅱ（GN BazookaⅡ）×2
    GN加農砲（GN Cannon）×8
    GN粒子束軍刀（GN Beam Saber）×8
    GN粒子束機槍（GN Beam Machine Gun）×2
    GN盾牌（GN Shield）×2
    GN力場（GN Field）
...
### GN-009 天使長GUNDAM（Seraphim Gundam）

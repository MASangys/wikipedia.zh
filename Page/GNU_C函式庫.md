...
**GNU
C函式庫**（，常简称为**glibc**）是一种按照[LGPL许可协议发布的](https://zh.wikipedia.org/wiki/LGPL "wikilink")，自由的，公开[源代码的](../Page/源代码.md "wikilink")，方便从网络下载的C的编译程序。GNU
C运行期库，是一种C[函式库](https://zh.wikipedia.org/wiki/函式库 "wikilink")，是程序运行时使用到的一些[API集合](https://zh.wikipedia.org/wiki/API "wikilink")，它们一般是已预先[编译好](https://zh.wikipedia.org/wiki/编译 "wikilink")，以[二进制代码形式存在](https://zh.wikipedia.org/wiki/二进制 "wikilink")[Linux类系统中](../Page/Linux.md "wikilink")，GNU

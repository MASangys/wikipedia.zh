**GNU TeXmacs**是一个[自由的科学](../Page/自由软件.md "wikilink")[文本编辑器](../Page/文本编辑器.md "wikilink")和[GNU](../Page/GNU.md "wikilink")项目的[排版](../Page/排版.md "wikilink")軟體。它吸收了[和](../Page/TeX.md "wikilink")[Emacs](../Page/Emacs.md "wikilink")的特点，尽管未使用这两者的代码。TeXmacs使用[](../Page/TeX.md "wikilink")[字体](../Page/字体.md "wikilink")。\[1\]它由Joris van der Hoeven等人开发和维护。该程序能够以[所见即所得的](https://zh.wikipedia.org/wiki/所见即所得 "wikilink")[用户界面](../Page/用户界面.md "wikilink")创建结构化文档。用户可以自行创建新的文档样式。编辑器采用高质量的[排版](../Page/排版.md "wikilink")[算法](../Page/算法.md "wikilink")和[](../Page/TeX.md "wikilink")[字体](../Page/字体.md "wikilink")用于专业出版。

## 特点

TeXmacs可作為一系列[计算机代数系统的前端](https://zh.wikipedia.org/wiki/计算机代数系统 "wikilink")，例如[Maxima](../Page/Maxima.md "wikilink")和[Sage](../Page/Sage.md "wikilink")。將計算或推導得出的數學公式直接顯示在筆記中，無須重複輸入和語法翻譯。

作為[所见即所得的](https://zh.wikipedia.org/wiki/所见即所得 "wikilink")[文本编辑器](../Page/文本编辑器.md "wikilink")（如[Microsoft Word](../Page/Microsoft_Word.md "wikilink")），TeXmacs提供一套設計良好的GUI界面,用戶不需要記憶排版引擎的DSL語法。

TeXmacs同时支持[Scheme](../Page/Scheme.md "wikilink")扩展语言[Guile](../Page/GNU_Guile.md "wikilink")，用于定制程序和编写扩展，提供用戶深度自訂的自由。

TeXmacs不是[的前端程序](https://zh.wikipedia.org/wiki/LaTeX "wikilink")，但TeXmacs文档可以被自由转换成[或](../Page/TeX.md "wikilink")[格式](https://zh.wikipedia.org/wiki/LaTeX "wikilink")，唯目前轉換效果並不完美還需要進行少量的手動修改。同時也可以容易的將文檔轉換為[HTML](../Page/HTML.md "wikilink")、[PDF](https://zh.wikipedia.org/wiki/PDF "wikilink")、[MathML和](https://zh.wikipedia.org/wiki/MathML "wikilink")[XML](../Page/XML.md "wikilink")。

TeXmacs目前可运行在大部分基于[Unix的系统平台下](https://zh.wikipedia.org/wiki/Unix "wikilink")，包括[Linux](../Page/Linux.md "wikilink")、[FreeBSD](../Page/FreeBSD.md "wikilink")、[Cygwin](../Page/Cygwin.md "wikilink")和[Mac OS X](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")，不過許多發行版必須自行編譯。可以容易的在[Microsoft Windows下安裝和使用](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")。

TeXmacs还包含[演示文稿模式](https://zh.wikipedia.org/wiki/演示文稿 "wikilink")，可以非常容易的製作投影片（slide/PPT）。目前已經含有一定的[图像编辑功能](https://zh.wikipedia.org/wiki/图像编辑 "wikilink")，可以繪製樹圖等。

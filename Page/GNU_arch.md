...
[Bazaar（或称'bzr'）此后也成为了正式的GNU项目](https://zh.wikipedia.org/wiki/GNU_bzr "wikilink")，可以考虑作为GNU
arch的替代。但注意bzr不是GNU
arch的一个[复刻](https://zh.wikipedia.org/wiki/复刻_\(软件工程\) "wikilink")。\[2\]
...
也有人批评GNU
arch采用极不寻常的文件命名约定（），这给在脚本中使用它、在一些[shell中使用它](https://zh.wikipedia.org/wiki/shell "wikilink")、将它移植到非Unix操作系统带来了困难。
GNU arch还因其运行缓慢一直被批评，而这竟然作为其设计决策一部分，以减少内部代码的复杂性的。\[5\]
...
## 参见
  ...
  -
  - [版本控制软件比较](../Page/版本控制软件比较.md "wikilink")
...
## 外部链接
  ...
  -
  - [LWN.net article on arch](http://lwn.net/Articles/125792/)
...
[Category:Discontinued_development_tools](https://zh.wikipedia.org/wiki/Category:Discontinued_development_tools "wikilink")
[Category:2001_software](https://zh.wikipedia.org/wiki/Category:2001_software "wikilink")

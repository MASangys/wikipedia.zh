...
上述命令使用[空字符](../Page/空字符.md "wikilink")来分隔文件名。
...
## 参见
  ...
  - [PPSS - (Distributed) Parallel Processing Shell Script](https://github.com/louwrentius/PPSS)
...
[Category:用Perl编程的自由软件](https://zh.wikipedia.org/wiki/Category:用Perl编程的自由软件 "wikilink") [Category:GNU计划软件](https://zh.wikipedia.org/wiki/Category:GNU计划软件 "wikilink") [Category:Unix进程和任务管理相关软件](https://zh.wikipedia.org/wiki/Category:Unix进程和任务管理相关软件 "wikilink")

**GNU variants**（**GNU
變種**）是一個[自由軟件基金會提出的概念](https://zh.wikipedia.org/wiki/自由軟件基金會 "wikilink")，指使用来自[GNU](../Page/GNU.md "wikilink")的[應用軟件及](https://zh.wikipedia.org/wiki/應用軟件 "wikilink")[函式庫](../Page/函式庫.md "wikilink")（即“用户态”）的操作系统。它的內核不一定是[GNU
...
GNU/Linux一詞是[GNU](../Page/GNU.md "wikilink")计划支持者对由GNU用戶態和GNU[系統軟件搭配](https://zh.wikipedia.org/wiki/系統軟件 "wikilink")[Linux內核构成的](https://zh.wikipedia.org/wiki/Linux內核 "wikilink")[操作系統的称呼](https://zh.wikipedia.org/wiki/操作系統 "wikilink")。其中一个著名的例子是[Debian
GNU/Linux](https://zh.wikipedia.org/wiki/Debian_GNU/Linux "wikilink")。

## FreeBSD 變種

**Debian GNU/kFreeBSD** 是一个基于[Debian](../Page/Debian.md "wikilink")
[软件包管理系统](../Page/软件包管理系统.md "wikilink")和[FreeBSD](../Page/FreeBSD.md "wikilink")核心的GNU发行版。
...
<references>
  ...
  - [Debian GNU/kFreeBSD
    ISO](http://glibc-bsd.alioth.debian.org/install-cd/kfreebsd-i386/20090729/debian-20090729-kfreebsd-i386-install.iso)

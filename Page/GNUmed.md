...
GNUmed專案由社群開發者所開發與維護。

## 歷史

第一版的GNUmed由Horst Herb所建立。當Herb不再積極開發時，GNUmed的開發就由Karsten Hilbert接手，他也成為了專案的領導者，並重新審閱了一部份的專案。

Karsten Hilbert並不是獨自作戰，許多其他的開發者也加入了團隊並協助專案開發：Syan Tan、Ian Haywood、Hilmar Berger、Sebastian Hilbert、Carlos Moro、Michael Bonert、Richard Terry、Tony Lembke以及其他人。雖然大部份都是程式碼的貢獻，還是有一些其他的貢獻，如Jim Busser與Rogerio Luz Coelho就協助了建立文件等等。

這個專案的名稱最初是將榮譽給[GNU計劃](../Page/GNU計劃.md "wikilink")，並將GNUmed連結到醫學界。它的標誌則描繪了[角马](../Page/角马.md "wikilink")（Gnu，代表了[GNU計劃](../Page/GNU計劃.md "wikilink")）與[Python](../Page/Python.md "wikilink")（代表程式語言）的結合。

目前GNUmed的目標是成為既定[電子健康紀錄](../Page/電子健康紀錄.md "wikilink")系統的[自由软件](../Page/自由软件.md "wikilink")替代品\[1\]。

## 使用

GNUmed主要是用來管理電子健康紀錄。它提供了紙本紀錄的歸檔功能，並為這些紀錄加上後設資料。它還可以執行一些管理工作，如新增病人資料，或是紀錄性的工作，如病人的過敏或免疫紀錄等等\[2\]。
...
## 外部連結
  ...
  - [GNUmed郵件清單歸檔](http://lists.gnu.org/archive/html/gnumed-devel/)

  -
  - [給大眾看的GNUmed](http://gnumed.blogspot.com/) 給非技術人員（一般使用者與測試員）看的部落格

[Category:GNU计划软件](https://zh.wikipedia.org/wiki/Category:GNU计划软件 "wikilink") [Category:健康照護](https://zh.wikipedia.org/wiki/Category:健康照護 "wikilink")

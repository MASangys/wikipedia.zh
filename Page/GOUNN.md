...
與單曲同名之巡演“桃色幸運草Z JAPAN TOUR 2013「GOUNN」”於9月28日開始。\[2\]\[3\]
...
5.  你之前给的（off vocal ver.）
6.  桃色太鼓的DO-DON节奏（off vocal ver.）
...
**GOUNN**
  ...
  - Guitar & Programming：
  - Bass：（（）、）
  - Drum：[Pierre中野](https://zh.wikipedia.org/wiki/Pierre中野 "wikilink")（（）、[凛冽时雨](https://zh.wikipedia.org/wiki/凛冽时雨 "wikilink")（））
  - Electric tabla：
  - Programming：木村篤史
...
## 外部連結
  ...
  - [官方網站](http://www.momoclo.net/discography/single16.html)

**Gaon Chart K-POP大獎**（；）是依據Gaon
Chart統計數據授獎的年度大型頒獎禮，自2012年開始於每年二月頒發前一年的獎項。其由管理，韓國文化體育觀光部贊助，於2012年正式開始，主要頒發給過去一年裡在韓國音樂界有優秀成就的藝人。

## 概要

  - [Gaon
    Chart最初只在網上公佈專輯的線上銷量及實體專輯銷量](https://zh.wikipedia.org/wiki/Gaon_Chart "wikilink")，直至2012年才舉辦頒獎典禮。
  - 頒獎典禮是根據Gaon
    Chart統計過去一年裡的音源數據，頒發給音樂界有優秀成就的藝人。頒獎禮頒發對象除歌手外，還包括作曲家、作詞家、製作人及相關產業公司等。
...
頒獎典禮有「實體專輯銷量榜」和「線上單曲銷量榜」兩個主要的部門（類別），分別列出國內及國際歌手的單曲和專輯每週、每月和年度的銷量數字。頒獎典禮根據Gaon
Chart統計的實體專輯銷量數據及音源數據作授獎指標。
...
「線上單曲銷量榜」只結算單曲於線上及數位銷量，包括瀏覽次數、下載量、BGM、手機鈴聲、卡啦OK及综合銷量。如單曲以Remix版本重新發行，排行榜會視為獨立的條目，不會將新版本的銷量結算在原作的銷量中。單曲榜的統計方法是由Bugs、Dosirak、Melon、Mnet、Soribada、Cyworld、Naver
Music等線上音樂供應商提供統計數據作出結算。每一個月單曲線上及數位銷量最高者為得獎者。

## 常設獎項類別

  - 音源部門年度歌手獎（每月音源銷量第一名）
  - 2017年第6届Gaon
    Chart頒獎禮音源部門評選新規則：2016年12個音源部門獲獎者的評選，以歌曲發佈之日起往後30天累計的音源成績作為該歌曲評選當月音源部門年度歌手獎的音源成績（無論歌曲是每個月的幾號發佈，皆算滿30天），且只有當月發佈的歌曲才能成為評選的候補歌曲，其他月份發佈的歌曲不參與當月音源部門年度歌手獎的評選。
  - 專輯部門年度歌手獎（每季專輯銷量第一名）
  - 2017年第6届Gaon
    Chart頒獎禮專輯部門評選新規則：2016年4個專輯部門獲獎者的評選，以專輯發售之日起往後6周的銷售量作為該張專輯評選該季度的專輯部門年度歌手獎的銷量成績（無論專輯是每個季度的什麼時間發售，皆算滿6周），且只有該季度發售的專輯才能成為評選的候補專輯，其他季度發售的專輯不參與該季度專輯部門年度歌手獎的評選。
  - 年度新人獎（年度成績最亮眼的新人）
  - 發現潛力獎（發展潛力高的藝人）
  - 作詞家獎
  - 作曲家獎

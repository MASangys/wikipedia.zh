...
它是一個標準化和離散式的空間信息管理平台，旨在使來自各種來源的地理參考數據庫、地圖產品以及相關的元數據能夠被存取，同時使用互聯網以加強組織和其使用者之間的空間信息交換和共享。它使用[Z39.50協議訪問遠程目錄](https://zh.wikipedia.org/wiki/Z39.50 "wikilink")，使得其他目錄服務可使用其數據。截至2007年，OGC的Web目錄服務正在實施。\[1\]

[Geoservices_GeoNetwork.png](https://zh.wikipedia.org/wiki/File:Geoservices_GeoNetwork.png "fig:Geoservices_GeoNetwork.png")
...
## 參閱
  ...
  - [GIS軟體比較](https://zh.wikipedia.org/wiki/GIS軟體比較 "wikilink")
  - [GIS軟體列表](https://zh.wikipedia.org/wiki/GIS軟體列表 "wikilink")
  - [開放原始碼軟體列表](https://zh.wikipedia.org/wiki/開放原始碼軟體列表 "wikilink")
  - [開源地理空間基金會](https://zh.wikipedia.org/wiki/開源地理空間基金會 "wikilink")

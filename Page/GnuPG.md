**GNU Privacy
Guard**（**GnuPG**或**GPG**）是一个[密码学软件](../Page/密码学.md "wikilink")，用于[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")、[签名通信内容及管理](../Page/數位簽章.md "wikilink")[非对称密码学的密钥](../Page/公开密钥加密.md "wikilink")。GnuPG是[自由软件](../Page/自由软件.md "wikilink")，遵循[IETF訂定的](https://zh.wikipedia.org/wiki/互聯網工程工作小組 "wikilink")[OpenPGP技術標準設計](https://zh.wikipedia.org/wiki/OpenPGP "wikilink")，并与[PGP保持兼容](../Page/PGP.md "wikilink")。\[1\]

GnuPG是[自由軟件基金會的](https://zh.wikipedia.org/wiki/自由軟件基金會 "wikilink")[GNU計劃的一部份](../Page/GNU計劃.md "wikilink")，曾受[德國政府資助](https://zh.wikipedia.org/wiki/德國 "wikilink")。\[2\]

## 歷史

GnuPG的早期版本由[维尔纳·科赫开发](../Page/維爾納·科赫.md "wikilink")，经过近两年迭代后于1999年9月7日正式发布1.0.0版。软件实现遵循OpenPGP标准，兼容[菲尔·齐默尔曼开发的](../Page/菲爾·齊默爾曼.md "wikilink")[PGP](../Page/PGP.md "wikilink")。2000年，[德國聯邦經濟及科技部資助了](https://zh.wikipedia.org/wiki/德國聯邦經濟及科技部 "wikilink")31.8万马克，用于移植GnuPG到[Microsoft
Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")。\[3\]
...
2.0的新的軟件架構不支援某些用途，所以1.x與2.0是兩個分支版本。\[4\]
...
[packages进行安装](https://zh.wikipedia.org/wiki/Software_package_\(installation\) "wikilink")。\[5\]此外，[GPGMail项目](https://zh.wikipedia.org/wiki/GPGMail "wikilink")\[6\]可以使[Apple

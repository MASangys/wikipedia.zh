****（又稱****\[1\]）是[Google開發的一种](../Page/Google.md "wikilink")[静态](../Page/静态类型.md "wikilink")[强类型](../Page/强类型.md "wikilink")、[編譯型](../Page/編譯語言.md "wikilink")、[-{zh-hant:並發型;zh-hans:并发型}-](../Page/並發計算.md "wikilink")，并具有[垃圾回收功能的](../Page/垃圾回收_\(計算機科學\).md "wikilink")[编程语言](../Page/编程语言.md "wikilink")。
...
OS X平台上进行了實現](../Page/Mac_OS_X.md "wikilink")，后来追加了Windows系统下的实现。\[4\]
在2016年，Go被軟體評價公司TIOBE 選為「TIOBE 2016 年最佳語言」。\[5\] ​
目前，Go每半年发布一个二级版本（即从a.x升级到a.y）。

## 描述

Go的语法接近[C语言](../Page/C语言.md "wikilink")，但对于有所不同。Go支持[垃圾回收功能](../Page/垃圾回收_\(计算机科学\).md "wikilink")。Go的并行模型是以[東尼·霍爾的](../Page/東尼·霍爾.md "wikilink")[交談循序程式](../Page/交談循序程式.md "wikilink")（CSP）为基础，采取类似模型的其他语言包括[Occam和](../Page/Occam.md "wikilink")[Limbo](../Page/Limbo.md "wikilink")，\[6\]，但它也具有[Pi运算的特征](../Page/Pi运算.md "wikilink")，比如通道传输。在1.8版本中開放插件（Plugin）的支持，這意味著現在能從Go中動態載入部分函式。

与C++相比，Go並不包括如[枚举](../Page/枚举.md "wikilink")、[异常处理](../Page/异常处理.md "wikilink")、[继承](../Page/繼承_\(計算機科學\).md "wikilink")、[泛型](../Page/泛型.md "wikilink")、[断言](../Page/斷言_\(程式\).md "wikilink")、[虚函数等功能](../Page/虚函数.md "wikilink")，但增加了
...
| pkg | [編譯時](../Page/編譯.md "wikilink")，生成的 |
| bin | 編譯後的程式                              |
...
当前有两个Go[编译器分支](../Page/编译器.md "wikilink")，分别为官方编译器gc和[gccgo](../Page/gccgo.md "wikilink")。官方编译器在初期使用C写成，后用Go重写从而实现\[11\]。Gccgo是一个使用标准GCC作为后端的Go编译器\[12\]。

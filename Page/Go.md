****（又稱****\[1\]）是[Google開發的一种](../Page/Google.md "wikilink")[静态](https://zh.wikipedia.org/wiki/静态类型 "wikilink")[强类型](https://zh.wikipedia.org/wiki/强类型 "wikilink")、[編譯型](https://zh.wikipedia.org/wiki/編譯語言 "wikilink")、[-{zh-hant:並發型;zh-hans:并发型}-](https://zh.wikipedia.org/wiki/並發計算 "wikilink")，并具有[垃圾回收功能的](../Page/垃圾回收_\(計算機科學\).md "wikilink")[编程语言](../Page/编程语言.md "wikilink")。

，[羅勃·派克](../Page/羅勃·派克.md "wikilink")（Rob
Pike）及[肯·汤普逊於](../Page/肯·汤普逊.md "wikilink")2007年9月开始设计Go，\[2\]，稍後Ian
Lance Taylor、Russ
Cox加入專案。Go是基於[Inferno作業系統所開發的](../Page/Inferno.md "wikilink")。\[3\]Go於2009年11月正式宣布推出，成為開放原始碼專案，并在[Linux及](../Page/Linux.md "wikilink")[Mac
OS
X平台上进行了實現](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")，后来追加了Windows系统下的实现。\[4\]
在2016年，Go被軟體評價公司TIOBE 選為「TIOBE 2016 年最佳語言」。\[5\] ​
目前，Go每半年发布一个二级版本（即从a.x升级到a.y）。

## 描述

Go的语法接近[C语言](https://zh.wikipedia.org/wiki/C语言 "wikilink")，但对于有所不同。Go支持[垃圾回收功能](https://zh.wikipedia.org/wiki/垃圾回收_\(计算机科学\) "wikilink")。Go的并行模型是以[東尼·霍爾的](../Page/東尼·霍爾.md "wikilink")[交談循序程式](https://zh.wikipedia.org/wiki/交談循序程式 "wikilink")（CSP）为基础，采取类似模型的其他语言包括[Occam和](https://zh.wikipedia.org/wiki/Occam "wikilink")[Limbo](https://zh.wikipedia.org/wiki/Limbo "wikilink")，\[6\]，但它也具有[Pi运算的特征](https://zh.wikipedia.org/wiki/Pi运算 "wikilink")，比如通道传输。在1.8版本中開放插件（Plugin）的支持，這意味著現在能從Go中動態載入部分函式。

与C++相比，Go並不包括如[枚举](../Page/枚举.md "wikilink")、[异常处理](../Page/异常处理.md "wikilink")、[继承](https://zh.wikipedia.org/wiki/繼承_\(計算機科學\) "wikilink")、[泛型](../Page/泛型.md "wikilink")、[断言](../Page/斷言_\(程式\).md "wikilink")、[虚函数等功能](../Page/虚函数.md "wikilink")，但增加了
切片(Slice) 型、并发、管道、垃圾回收、接口（Interface）等特性的语言级支持\[7\]。Go
2.0版本將支持泛型\[8\]，對於断言的存在，則持負面態度，同時也為自己不提供型別繼承來辯護。

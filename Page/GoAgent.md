...
**GoAgent**是使用跨平台语言[Python开发](../Page/Python.md "wikilink")、基于[GPL自由软件协议的代理软件](https://zh.wikipedia.org/wiki/GPL "wikilink")。它利用[Google
App
Engine](https://zh.wikipedia.org/wiki/Google_App_Engine "wikilink")（GAE）的服务器充當代理。该软件在[中国大陆被廣泛用于突破大陆官方建立的](../Page/中国大陆.md "wikilink")[防火长城](../Page/防火长城.md "wikilink")（GFW），以瀏覽被封鎖的內容。
...
GoAgent的其他特性如下：
  ...
  - 支持[Google App
    Engine](https://zh.wikipedia.org/wiki/Google_App_Engine "wikilink")，[PHP和](../Page/PHP.md "wikilink")[PaaS三種模式](https://zh.wikipedia.org/wiki/PaaS "wikilink")。
...
Engine的服务器作爲中傳](https://zh.wikipedia.org/wiki/Google_App_Engine "wikilink")，將數據封包後傳送至[Google服务器](../Page/Google.md "wikilink")，再由Google服务器轉發至目的服务器，接收數據時方法也類似\[2\]
。由于服务器端软件基本相同，该中转服务器既可以是用户自行架设的服务器，也可以是由其他人架设的开放服务器。

因为[中國大陸的](https://zh.wikipedia.org/wiki/中國大陸 "wikilink")[防火长城难以完全封锁](../Page/防火长城.md "wikilink")，或出于其他考虑不能完全封锁此Google服務，到目前为止幾經更新的GoAgent仍旧可以正常使用，儘管在2014年5月底開始，Google又一次遭到中國政府防火長城的大規模封鎖，Google首頁至今仍不能從中國大陸正常存取。\[3\]\[4\]

GoAgent可以通过HTTP和[HTTPS两种方式连接Google服务器](https://zh.wikipedia.org/wiki/HTTPS "wikilink")，用户可以根据自己的网络情况酌情选择。

由于[防火长城的屏蔽策略调整](../Page/防火长城.md "wikilink")，[Google](../Page/Google.md "wikilink")
IP被悉数封锁，因而该工具的破网效率已大不如前。但是由于Google采用了[任播技术](../Page/任播.md "wikilink")，只要用户能够自行找到可用的Google
...
在中国大陆，[防火长城为了屏蔽GreatFire](../Page/防火长城.md "wikilink")、GoAgent等项目而屏蔽了[Amazon
...
目前，GreatAgent已部署830個適用於GoAgent的AppID和1210個適用於WallProxy的AppID，兩者在功能上有所不同。GreatAgent-ga版本僅支援Google的搜尋和[YouTube的在線視訊](../Page/YouTube.md "wikilink")，並且不支援中國大陸國內網站的訪問；而GreatAgent-wp則沒有上述限制，被稱為「電影
...
由于GAE有流量限制和应用数量限制，所以有志愿者收集和维护了开放的AppID的列表供大家使用，这样，用户便可以在不花钱的情况下，通过类似[负载均衡的机制绕过流量限制](../Page/负载均衡.md "wikilink")。

### 浏览器

有些民间志愿者将GoAgent配置好，并将其与[Chromium等开源的浏览器整合](../Page/Chromium.md "wikilink")，制作成整合包，从而做到一键启动，例如天行浏览器（Xskywalker）、畅游无限浏览器等。

### 枫叶香蕉

枫叶香蕉是一个用[Delphi语言编写的](../Page/Delphi.md "wikilink")，基于GoAgent、[WallProxy等代理工具的代理客户端](https://zh.wikipedia.org/wiki/WallProxy "wikilink")。
...
在其[Twitter中发表声明](../Page/Twitter.md "wikilink")，称其“从未在
GoAgent 获得直接或间接的经济利益，也未接受过任何境外和境内组织的捐助；从未提供基于 GoAgent
的公共服务和政治看法”。phus.lu

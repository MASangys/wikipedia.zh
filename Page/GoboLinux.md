...
GoboLinux的设计受一些较早操作系统的影响，如[NEXTSTEP](https://zh.wikipedia.org/wiki/NEXTSTEP "wikilink")，[AtheOS](https://zh.wikipedia.org/wiki/AtheOS "wikilink") and [BeOS](../Page/BeOS.md "wikilink")，另保留原有的文件系统结构以保持对UNIX的兼容性。 GoboLinux目录树的根目录下，有6个目录：Programs, Users, System, Files, Mount and Depot. 每个目录的内容如下：

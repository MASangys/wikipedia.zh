**GoldenDict**是一種[開源的](https://zh.wikipedia.org/wiki/開源 "wikilink")[辭典軟體](https://zh.wikipedia.org/wiki/辭典 "wikilink")，可為不同語言提供詞彙、詞組釋義。其允許同時使用多種流行的辭典檔案格式且無需轉換。
...
## 特性
  ...
  - 該程式是[自由及开放源代码软件](../Page/自由及开放源代码软件.md "wikilink")（FOSS）。
  - 支援多種電子辭典檔案格式\[1\]，具體如下：
      - （XML Dictionary eXchange Format）辭典\[2\]

      - [Babylon](../Page/Babylon.md "wikilink")（.bgl），附圖像和資源。

      - [StarDict](https://zh.wikipedia.org/wiki/StarDict "wikilink")（.ifo、.dict、.idx、.syn）
      ...
      - [Sdictionary](https://zh.wikipedia.org/wiki/Sdictionary "wikilink")（.dct）。該格式也稱為sdict。

      - [Aard](https://zh.wikipedia.org/wiki/Aard "wikilink")（.aar）

      - Zip檔中的音訊包

      - [MDict](../Page/MDict.md "wikilink")（.mdx、.mdd）\[3\]

      - 格式辭典\[4\]
  - 支援使用萬用字元（\*，?）搜尋。
  - 支援全文搜尋。\[5\]
  - 支援收藏我的最愛(Favorites)。\[6\]

**Google Code
Jam**是一项由[Google主办的国际程序设计竞赛](../Page/Google.md "wikilink")。该项赛事始于2003年，旨在帮助Google发掘潜在的工程领域顶级人才\[1\]。比赛内容包括一系列的[算法问题](../Page/算法.md "wikilink")，参赛者必须在指定时间内解决。参赛者允许使用任意自选[编程语言和](../Page/编程语言.md "wikilink")[开发环境来解答问题](../Page/集成开发环境.md "wikilink")。

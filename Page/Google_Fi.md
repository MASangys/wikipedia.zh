...
在 Project Fi 改名为 Google Fi 之前，普通的 SIM 卡仅可用于 Google 自家的 Android 设备（如
Nexus、Pixel 系列手机）以及极少数其他品牌的 Android 设备（如 Moto X 手机）上；而仅数据（Data Only）的
SIM 卡则可用于任意带蜂窝移动网络功能的设备上。
...
[Category:移动虚拟运营商](https://zh.wikipedia.org/wiki/Category:移动虚拟运营商 "wikilink")

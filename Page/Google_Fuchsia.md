**Fuchsia**是[Google开发的](../Page/Google.md "wikilink")[操作系统](../Page/操作系统.md "wikilink")\[1\]。和以前Google开发的操作系统，如基于[Linux内核的](../Page/Linux内核.md "wikilink")[Chrome
OS和](../Page/Chrome_OS.md "wikilink")[Android等不同](../Page/Android.md "wikilink")，Fuchsia基于新的名为Zircon的[微内核](https://zh.wikipedia.org/wiki/微内核 "wikilink")\[2\]，受Little
Kernel启发\[3\]，用于嵌入式系统，主要使用[C语言和C](https://zh.wikipedia.org/wiki/C语言 "wikilink")++编写\[4\]。Fuchsia的设计目标之一是可运行在众多的设备上，包括[移动电话和](../Page/移动电话.md "wikilink")[个人电脑](../Page/个人电脑.md "wikilink")。\[5\]

Fuchsia在[GitHub的](../Page/GitHub.md "wikilink")[象征是一个](https://zh.wikipedia.org/wiki/象征 "wikilink")[紫红色的无限符号](https://zh.wikipedia.org/wiki/紫红色 "wikilink")。

作为免费和[开源软件分发](../Page/开源软件.md "wikilink")，采用[三句版BSD](../Page/BSD许可证.md "wikilink")，[MIT和](../Page/MIT許可證.md "wikilink")[Apache
2.0软件许可证](https://zh.wikipedia.org/wiki/Apache_2.0 "wikilink")。
...
2017年5月，Ars
Technica编写了关于Fuchsia的新[用户界面的文章](../Page/用户界面.md "wikilink")，从8月首次披露时的命令行界面上升级，以及开发人员表示“此项目不是玩具项目，不是20%时间项目，不是我们不再关心的死去的项目的垃圾场”，多家媒体写到“Fuchsia项目”和[Android似乎有密切联系](../Page/Android.md "wikilink")，有人猜测Fuchsia可能是“重做”\[8\]或替换Android\[9\]\[10\]以在某种程度上修复该平台上的问题。

2017年11月，对[Swift语言提供了初始支持](../Page/Swift_\(程式語言\).md "wikilink")。\[11\]

2018年1月3日，Google允许开发者以Google Pixelbook为目标设备，下载Fuchsia
OS进行开发与测试\[12\]\[13\]\[14\]。
...
## 外部链接
  ...
  - [(非官方）Google Fuchsia
    Wiki](https://fuchsia.miraheze.org/wiki/Main_Page)
...
3.
4.  <cite class="citation web">["Google Is Building A New Operating
    System From Scratch:
    'Fuschia'"](http://www.tomshardware.com/news/google-fuchsia-new-operating-system,32475.html).
    2016-08-15<span class="reference-accessdate">. </span></cite>
...
10.
11.
12. [Preparing to install Fuchsia on
    Pixelbook](https://github.com/fuchsia-mirror/docs/blob/master/hardware/pixelbook.md).GitHub.\[2018-01-03\].
13. [Putting Fuchsia on a
    Device](https://github.com/fuchsia-mirror/docs/blob/master/fuchsia_paver.md#paving).GitHub.\[2018-01-03\].
14. [Google允许以自家Pixelbook测试Fuchsia
    OS](http://technews.cn/2018/01/03/google-is-now-testing-its-mysterious-fuchsia-os-on-the-pixelbook/)
    .科技新報.\[2018-01-03\].
15.
16.
17.
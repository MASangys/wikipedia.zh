...
只要在欲觀察的頁面放入**GA**所提供的一小段[JavaScript](../Page/JavaScript.md "wikilink")代碼後，每當執行這個網頁時，即會傳送如：瀏覽者的所在國家、經由什麼關鍵字進入該頁等相關資料至GA伺服器，並整合成易讀的資訊給網站站長。
...
## 外部連結
  ...
  - [Google Analytic追蹤程式原始碼](http://harshad.wordpress.com/google-analytics-urchin-module)

...
Google Now使用自然語言使用者介面（Natural language user
interface）透過一系列的[Web服務來進行回答問題](https://zh.wikipedia.org/wiki/Web服務 "wikilink")、提供建議、執行動作之行為。在回應使用者時，Google
Now會基於使用者過往的的搜尋習慣來預測其所可能需要的資訊。Google Now最初被包含在[Android 4.1 Jelly
Bean](https://zh.wikipedia.org/wiki/Android歷史版本#Android_4.1.x "wikilink")（譯為雷根糖或果凍豆）之中，首先支援的智慧型手機為[Galaxy
Nexus](../Page/Galaxy_Nexus.md "wikilink")。

美國雜誌《[科技新时代](https://zh.wikipedia.org/wiki/科技新时代 "wikilink")》（Popular
...
2012年10月29日，[Google
Play商店更新Google](https://zh.wikipedia.org/wiki/Google_Play商店 "wikilink")
Now，增加了的Gmail的卡片功能。\[7\]Google
...
Now送至至[蘋果公司審核](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")，且正等待批准，但他後來澄清此非事實。\[9\]。之後，蘋果也否認了此事。儘管如此，在2013年4月29日，開始可以在iOS的Google搜尋3.0版本的行動應用程式內使用Google
Now。\[10\]Google Now在Android版本與iOS版本之中的所有功能並非完全相同。\[11\]
...
即時資訊卡片清單：
  ...
  - 活動摘要（顯示過去一個月使用者所步行或騎行的大略距離）

<!-- end list -->

  - 生日（在使用者生日當天顯示關於使用者出生日期的趣聞，並提醒好友的生日）

<!-- end list -->

  - 附近活動（在附近有重大活動舉辦之前顯示，包括使用者喜愛的歌手舉辦演唱會，或其他預定舉辦的熱門活動）

<!-- end list -->

  - 航班（在使用者所搜尋的航班即將起飛前顯示）

<!-- end list -->

  - Gmail：預訂活動與入場票券（在Gmail確認的預定活動開始前顯示。購買電影票之後，系統會在使用者需要出發前往電影院時提醒使用者）

<!-- end list -->

  - Gmail：航班（在Gmail確認的航班起飛前，或在Gmail中收到登機證時顯示）

<!-- end list -->

  - Gmail：旅館（當使用者收到確認電子郵件及預定退房前顯示）

<!-- end list -->

  - Gmail：包裹（在使用者收到線上購物的寄貨通知時顯示。部分出貨商的卡片會依照運貨狀態更新，如顯示出貨中或已到貨。使用者可透過各張卡片的連結，查詢詳細的追蹤資訊）

<!-- end list -->

  - Gmail：餐廳（在Gmail確認的餐廳訂位時間將至前顯示）

<!-- end list -->

  - 電影（顯示附近電影院正在上映的電影；如果附近正在播出使用者感興趣的電影，卡片也會告訴使用者）

<!-- end list -->

  - 新聞更新（顯示與使用者最近閱讀過的新聞報導相關之最新內容）
...
<!-- end list -->
  ...
  - 附近拍照景點（當使用者在熱門拍照景點附近時顯示）

<!-- end list -->

  - 地方資訊（顯示附近的商家與其他使用者可能感興趣的地方。如果使用者在博物館或商店，可以使用相機查詢藝術作品或取得產品資訊）

<!-- end list -->

  - 災害快報（顯示國家氣象局、美國地質調查中心和其他類似服務單位針對使用者的所在位置提供的公開公告資訊）

<!-- end list -->

  - 大眾運輸（在公車站、火車站或其他大眾運輸車站附近時顯示相關時刻表）

<!-- end list -->

  - 房地產（如果使用者已廣泛搜尋過物件資訊，或是接近銷售的物件，卡片即會顯示）

<!-- end list -->

  - 研究主題（當使用者近期使用Google搜尋研究特定主題（例如計劃中的旅行）時顯示）

<!-- end list -->

  - 運動賽事（在使用者感興趣的隊伍比賽開始、進行中及結束後顯示）

<!-- end list -->

  - 股票（定期顯示使用者所關注的股票。如需瞭解詳情，請參閱關於股票卡）
...
<!-- end list -->
  ...
  - 旅遊：貨幣（顯示所在位置最新的貨幣換算資訊）

<!-- end list -->

  - 旅遊：附近景點（當使用者在知名景點（例如餐廳、博物館和咖啡廳）附近時顯示）

<!-- end list -->

  - 旅遊：居住地時間（當使用者在和平時不同的時區時定時顯示）

<!-- end list -->

  - 旅遊：翻譯（當使用者在國外旅行時顯示，以協助使用者翻譯字詞與語句）

<!-- end list -->

  - 氣象（定時顯示住家、工作地點或目前位置目前的天氣資訊和氣象預測）

## 评价

CNET的斯科特·韦伯斯特称赞了Google
Now中基于过往位置历史和签到的事件提醒能力，并推荐了其提供的不需用户请求的“清晰、直观的即时信息”。\[21\]另外，Ars
Technica的瑞安保罗在评论中表示，与其他大多数语音控制应用（包括[Siri](../Page/Siri.md "wikilink")）相似，语音识别是一个重要的问题。然后，保罗指出，输入查询能力为用户提供了更多的选择。\[22\]
...
2014年2月27日，Google在[Play
Store上架了Google即时桌面](../Page/Google_Play.md "wikilink")。Google即时桌面可于[Android
4.4以上的Android系统執行](https://zh.wikipedia.org/wiki/Android历史版本 "wikilink")，它整合了Android原生启动器与Google即时，桌面-{zh-hant:主畫面;zh-hans:主屏}-中会显示Google即时贴，在-{zh-hant:主畫面;zh-hans:主屏}-中随时说出“OK
Google”即可开始语音搜索。
...
2.  [Streamlining Notifications on
    Desktop](https://blog.chromium.org/2015/10/streamlining-notifications-on-desktop.html)

3.  [Google Feed is now called Discover and available on Google's mobile
    site](https://www.androidcentral.com/google-feed-now-called-discover-and-available-googles-mobile-site)
...
15.
16. [Goodbye Google Now, hello new feed that obsessively tracks your
    interests](https://www.pcworld.com/article/3209034/google-replaces-google-now-with-new-feed.html)

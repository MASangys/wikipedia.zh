...
Googl搜索解析可以对数个不同的条目的搜索行为进行比较，也可以针对一个条目在不同的地区和时间上的搜索行为进行比较。Google搜索解析还提供一些条目未来的搜索趋势预测。Google搜索解析现在还提供一项新功能，向用户提供条目搜索分析的[HTML](../Page/HTML.md "wikilink")代码，这样用户就可以在自己的[web页面中嵌入条目的搜索分析结果](https://zh.wikipedia.org/wiki/web "wikilink")。

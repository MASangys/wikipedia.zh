...
Spreadsheets**。Writely是由软件公司[Upstartle创建的基于](https://zh.wikipedia.org/wiki/Upstartle "wikilink")[Web的独立](https://zh.wikipedia.org/wiki/Web "wikilink")[字处理软件](https://zh.wikipedia.org/wiki/字处理 "wikilink")，发布于2005年8月。\[2\]原先的功能包括[协同文字编辑套装以及](https://zh.wikipedia.org/wiki/协同编辑软件 "wikilink")[访问控制功能](https://zh.wikipedia.org/wiki/访问控制 "wikilink")。菜单、键盘快捷键和对话框的展现方式与使用[GUI的字处理软件](https://zh.wikipedia.org/wiki/GUI "wikilink")，例如[Microsoft
Word和](../Page/Microsoft_Word.md "wikilink")[OpenOffice.org
Writer十分相似](../Page/OpenOffice.org_Writer.md "wikilink")。

  - 2006年3月9日，Google公司宣布并购Upstartle。\[3\]在并购发生的时候，Upstartle总共拥有4名员工，\[4\]与此同时Writely停止注册直到整体服务移入Google服务器的操作完成。\[5\]2006年8月，Writely向那些位于申请等待列表上的用户发送帐户邀请，紧接着于8月23日向公众开放。Writely依旧使用自己的用户系统直至2006年9月19日与[Google账户整合完成](https://zh.wikipedia.org/wiki/Google账户 "wikilink")。\[6\]Writely原先运行于[微软公司](https://zh.wikipedia.org/wiki/微软公司 "wikilink")[ASP.NET技术上](../Page/ASP.NET.md "wikilink")，使用[视窗操作系统](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")。然而从2006年7月开始，Writely的服务器被发现已转移到基于[Linux的操作系统](../Page/Linux.md "wikilink")。\[7\]而与此同时，Google开发了Google
  ...
  - 2006年10月10日，Google將[Writely與旗下Google](https://zh.wikipedia.org/wiki/Writely "wikilink")
    Spreadsheets整合為**Google Docs & Spreadsheets**。
  - 2007年2月，Google向[Google
    Apps中提供了Google文件服务](https://zh.wikipedia.org/wiki/Google_Apps "wikilink")。
  ...
  - 2008年4月1日，Google文档开始通过[Google
    Gears提供离线编辑功能](https://zh.wikipedia.org/wiki/Google_Gears "wikilink")。\[10\]
...
用户可以在Google文件中创建文档、電子製表和演示文件，也可以通过[web界面或](https://zh.wikipedia.org/wiki/web "wikilink")[电子邮件导入到Google文件中](../Page/电子邮件.md "wikilink")。默认情况下这些文件保存在Google的服务器上，用户也可以将这些文件以多种格式（包括[OpenOffice](https://zh.wikipedia.org/wiki/OpenOffice "wikilink")、[HTML](../Page/HTML.md "wikilink")、[PDF](https://zh.wikipedia.org/wiki/PDF "wikilink")、[RTF](../Page/RTF.md "wikilink")、[文本文件](../Page/文本文件.md "wikilink")、[Word](https://zh.wikipedia.org/wiki/Word "wikilink")）[下载到本地电脑中](../Page/下载.md "wikilink")。正在编辑的文件会被自动保存以防止数据丢失，编辑更新的历史也会被记录在案。为方便组织管理，文件可以存档或加上自定义的[标签](https://zh.wikipedia.org/wiki/标签_\(元数据\) "wikilink")。

Google文件支援多用户协同工作。文档可以同时被多个用户共享，開啟和编辑。在電子製表中，用户可以设置通过[电子邮件提醒任何指定区域的更改](../Page/电子邮件.md "wikilink")。程式支援[ISO标准的](https://zh.wikipedia.org/wiki/ISO "wikilink")[开放文档格式格式](../Page/开放文档格式.md "wikilink")。支援流行的[Office的文件格式](../Page/Microsoft_Office.md "wikilink")，包括[.doc](https://zh.wikipedia.org/wiki/.doc "wikilink")，[.docx](https://zh.wikipedia.org/wiki/.docx "wikilink")，[.xls](https://zh.wikipedia.org/wiki/.xls "wikilink")(行動應用程式已不支援編輯儲存)和[.xlsx](https://zh.wikipedia.org/wiki/.xlsx "wikilink")。对[PDF格式仅支援上传和共享](https://zh.wikipedia.org/wiki/PDF "wikilink")。\[15\]
...
10和](../Page/Internet_Explorer_10.md "wikilink")[Safari等多种浏览器登入Google文件](../Page/Safari.md "wikilink")\[19\]。（尽管[Opera并不是官方声明支援的浏览器](https://zh.wikipedia.org/wiki/Opera電腦瀏覽器 "wikilink")，但它通过“伪装成Firefox”功能也能够使用Google文件的所有功能。）
...
移动版的Google文件\[21\]允许用户在其[移动浏览器中浏览Google文件](../Page/移动浏览器.md "wikilink")。用户可以查看文档，也可以查看和编辑電子製表。Google文件针对[iPhone和](https://zh.wikipedia.org/wiki/iPhone "wikilink")[Android的版本中](https://zh.wikipedia.org/wiki/Google_Android "wikilink")，不仅为这些设备单独设计了交互界面，还包括功能强大的電子製表编辑功能和演示查看功能。另一方面，人们在任何移动设备上都无法查看或编辑的开放格式的数据库文件。

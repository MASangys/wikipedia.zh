...
## 另见
  ...
  - [Yahoo\! Pipes](https://zh.wikipedia.org/wiki/Yahoo!_Pipes "wikilink")
  - [Microsoft Popfly](https://zh.wikipedia.org/wiki/Microsoft_Popfly "wikilink")

[Category:已終止的Google服務](https://zh.wikipedia.org/wiki/Category:已終止的Google服務 "wikilink")

1.  {{ cite web | url = <http://googlemashupeditor.blogspot.com/2009/01/from-mashup-editor-to-app-engine.html> | title = Google Mashup Editor Blog: From Mashup Editor to App Engine | author = Paul McDonald, Google Mashup Editor Team | date = 2009-01-14 | accessdate = 2009-08-07 }}
...
GOTO语句被大部分[高级语言支持](https://zh.wikipedia.org/wiki/高级语言 "wikilink")，只有很少的高级语言不支持GOTO语句。例如，`goto`是一个[Java](../Page/Java.md "wikilink")语言的[保留字](../Page/保留字.md "wikilink")，但是不允许使用。
...
[C语言](https://zh.wikipedia.org/wiki/C语言 "wikilink")、[C++](../Page/C++.md "wikilink")和[Java](../Page/Java.md "wikilink")中的[switch语句高效地实现了一个多路](https://zh.wikipedia.org/wiki/switch语句 "wikilink")*goto*，跳转目标由表达式的值来选择。

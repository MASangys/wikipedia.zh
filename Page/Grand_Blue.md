> 本文内容由[Grand Blue](https://zh.wikipedia.org/wiki/Grand_Blue)转换而来。
...
## 收視率
  ...
  - 以下紀錄《**Grand Blue**》節目收視，收視最低的集數以表示，收視最高的集數以表示，而空格則表示該集的收視沒有相關數據。
...
## 外部連結
  ...
  - [官方網站](https://programs.sbs.co.kr/enter/grandbleu)

...
，簡稱，中文俗稱為“**油猴**”，是[Firefox的一個附加元件](../Page/Firefox.md "wikilink")。它讓使用者安裝一些[腳本使大部分HTML為主的](https://zh.wikipedia.org/wiki/腳本語言 "wikilink")[網頁於使用者端直接改變得更方便易用](../Page/網頁.md "wikilink")。
...
大部分Greasemonkey使用者腳本都是自行撰寫，使用對某網站專用的[JavaScript代碼](../Page/JavaScript.md "wikilink")，透過[文檔對象模型](https://zh.wikipedia.org/wiki/文檔對象模型 "wikilink")（DOM）介面對網頁內容做操作。\[//userscripts.org/
userscripts.org\]維護了個Greasemonkey資料庫。該資料庫描述哪個[網址網頁對應到哪個腳本](https://zh.wikipedia.org/wiki/URL "wikilink")。（注意：[廢棄腳本倉庫](https://web.archive.org/web/20071026044928/http://dunck.us/collab/GreaseMonkeyUserScripts#head-5387d9022c1a64b4092b5c3ec546fccb2be4220a)**可能**還保留許多還沒合併到\[//userscripts.org/
...
使用者群已發展大量的腳本，以下是其中的一些應用：
  ...
  - 調整[Gmail讓](../Page/Gmail.md "wikilink")[Google
    Reader內嵌](https://zh.wikipedia.org/wiki/Google_Reader "wikilink")，因而提供[RSS新聞訂閱的選項](../Page/RSS.md "wikilink")。
  ...
  - 增刪網頁上的某些功能。
  - 讓使用者從某些影片站點如[Google
    Video以及](https://zh.wikipedia.org/wiki/Google_Video "wikilink")[YouTube存下](../Page/YouTube.md "wikilink")[FLV或](https://zh.wikipedia.org/wiki/FLV "wikilink")[MP4影片檔案](../Page/MP4.md "wikilink")。
...
Greasemonkey可直接用於Firefox、[Flock](../Page/Flock.md "wikilink")、與[Epiphany](https://zh.wikipedia.org/wiki/Epiphany "wikilink")。Epiphany
Greasemonkey是Epiphany附加元件包的一部分。然而，該附加元件並不完全相容於2.15.1版，導因於某些Greasemonkey[應用程式介面功能](https://zh.wikipedia.org/wiki/應用程式介面 "wikilink")（例如：*GM_getValue*）不支援。此外，也有自訂版本的[SeaMonkey](../Page/SeaMonkey.md "wikilink")：。
...
[Konqueror的網頁修改工具](../Page/Konqueror.md "wikilink")，其目的在相容於Greasemonkey腳本與後資料集。它以一種[KPart而存在](https://zh.wikipedia.org/wiki/KPart "wikilink")。
...
## 類似軟體
  ...
  - [MouseHole](https://archive.is/20060708074158/http://mousehole.rubyforge.org/wiki/wiki.pl?MouseHole)是一種開源軟體，客戶端[代理伺服器](https://zh.wikipedia.org/wiki/代理伺服器 "wikilink")，允許對網頁內容透過[Ruby動手腳](../Page/Ruby.md "wikilink")。
...
在沒有附加元件像Greasemonkey的情況下，修改網站也可以透過下面幾種方式：
  ...
  - 使用本地端HTTP代理伺服器，如[WebWasher](https://zh.wikipedia.org/wiki/WebWasher "wikilink")、[Privoxy或](../Page/Privoxy.md "wikilink")[Proxomitron以更改HTML](../Page/Proxomitron.md "wikilink")。
  - 使用Opera瀏覽器 + 使用者.js腳本。

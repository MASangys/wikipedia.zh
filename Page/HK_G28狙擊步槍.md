...
HK G28使用了[STANAG](../Page/标准化协议.md "wikilink")
...
條縱向長型散熱，既能夠減輕重量也增加了剛性，而且提高了散熱效率，其內膛亦經鍍鉻處理。槍管整體設計和製造工藝遵循[北約](https://zh.wikipedia.org/wiki/北大西洋公约组织 "wikilink")「ST[标准化协议](../Page/标准化协议.md "wikilink")」（STANAG）2310輕武器製造標準，並已經通過了使用北約AB22[全金屬被甲](https://zh.wikipedia.org/wiki/子彈#全金属被甲弹（FMJ_-_Full_Metal_Jacket） "wikilink")（，簡稱：FMJ）[彈藥的NATO](https://zh.wikipedia.org/wiki/彈藥 "wikilink")-AC225/D14槍管阻塞測試。其槍管口部的槍口裝置是採用[黑克勒-科赫新設計的一個與](../Page/黑克勒&科赫.md "wikilink")[M16步槍類似的鳥籠型](../Page/M16突擊步槍.md "wikilink")，據稱其既具有消焰功能，還有助於提高射擊[精度](../Page/準確與精密.md "wikilink")，亦預留裝上[消聲器的空間](../Page/抑制器.md "wikilink")。\[5\]
...
### [電子遊戲](https://zh.wikipedia.org/wiki/電子遊戲 "wikilink")
  ...
  - 2013年—《[-{zh-cn:使命召唤：幽灵;
    zh-tw:決勝時刻：魅影;}-](../Page/決勝時刻：魅影.md "wikilink")》：型號為E3（巡邏型），命名為「MR-28」，沙色槍身，20發（故事模式）、24發（聯機模式，可使用改裝：延長彈匣增至36發）和8發（滅絕模式，可使用改裝：延長彈匣增至12發）[彈匣](../Page/彈匣.md "wikilink")，初始攜彈量為100發（故事模式）、48發（聯機模式）和24發（滅絕模式），最高攜彈量為120發（故事模式）、144發（聯機模式）和64發（滅絕模式），具有其預設狙擊鏡和[前握把](../Page/輔助握把.md "wikilink")。故事模式之中被美國精銳部隊「魅影」（Ghosts）成員勞根·沃克（Logan

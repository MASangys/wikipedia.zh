...
HD2](../Page/HTC_HD2.md "wikilink")；后被内置在大多数HTC手机中。由于微軟公司不允許手機公司更改[Windows
Phone平台所預設的使用者介面](../Page/Windows_Phone.md "wikilink")，所以HTC公司不再开发Windows
Phone平台的HTC Sense。
...
修改自 Android 1.5 (開發代號 Cupcake)，首先搭載於 [HTC
Hero](../Page/HTC_Hero.md "wikilink") 手機。此版的 Sense 將某些程式加入與 Facebook 和
Twitter 等社交網路相連的功能。
...
修改自 Android 2.1 (開發代號 Eclair)，首款搭載於 [HTC
Desire](../Page/HTC_Desire.md "wikilink") 及 [HTC
...
修改自 Android 2.3 (開發代號 Gingerbread)，Sense 3.0 初次發表於 [HTC
Sensation](../Page/HTC_Sensation.md "wikilink") 手機。此版內建了 HTC Watch
線上影片服務，並重新設計螢幕解鎖畫面，可快速開啟常用程式並可選擇要顯示天氣或照片等小工具。同時滑動主畫面時加入了 3D
轉場特效。
...
修改自 Android 4.0，首款搭載於 [HTC One X](../Page/HTC_One_X.md "wikilink"), [HTC
One S](../Page/HTC_One_S.md "wikilink"), HTC Evo 4G LTE 與 [HTC One
V](../Page/HTC_One_V.md "wikilink")。此版比舊版更輕巧快速，簡化了 3D
特效，於主畫面下方加入了程式捷徑列，可放置常用程式，並修改了加入小工具的方式。

### Sense 4.1 (2012)

2012 年 8 月 18 日發佈，搭載於 HTC One X, HTC One S, HTC J 與 HTC Evo 4G LTE
手機，升級到 Android 4.0.4 和 HTC Sense 4.1。
...
2013 年 10月發佈，搭載於[HTC One Max](../Page/HTC_One_Max.md "wikilink")。為sense
5.0的升級及改進，加強blinkfeed功能，通知欄快捷鍵順序的更換，音樂視效，編輯zoe影片長度以及自選背景音樂等。
...
2015年3月隨著[HTC One
M9一同發表](../Page/HTC_One_M9.md "wikilink")，強化了主題功能並增加了主題app「HTC
Theme」讓用戶自訂主題、變更圖示，也增加了自訂導航列的功能，相片集也加入了更豐富的相片編輯功能「雙重曝光、線性效果」等，Motion
Launch 手勢啟動也能夠自訂功能是否啟動。

### Sense 8 (2016)

2016年4月發布，搭載於[HTC 10](../Page/HTC_10.md "wikilink")。強化Motion Launch
手勢啟動功能快速啟動相機，在螢幕關閉時候用手指快速往下滑動兩次，即可啟動相機。新增專屬個性化音效設定、HTC自我風格桌面設計FreeStyle。
Freestyle自我風格桌面，取消桌面應用程式固定擺放位置的框架，不限位置放置，讓應用程式融入桌布成為一體。
...
1.  [HTC Hero 發布：同步上映HTC SENSE
    軟件界面宣告（更新）](http://cn.engadget.com/2009/06/24/htc-hero-htc-sense/)
    ENGADGET 中國版
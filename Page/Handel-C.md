...
In order to facilitate a way to describe parallel behaviour some of the [CSP](https://zh.wikipedia.org/wiki/Communicating_sequential_processes "wikilink") keywords are used, along with the general file structure of [Occam](https://zh.wikipedia.org/wiki/Occam_programming_language "wikilink")。
...
其他的C HDL子集也大約在同一時間被發展出來，像是1994年在[多倫多大學](../Page/多倫多大學.md "wikilink")的Transmogrifier C（現在變為開源碼專案[FpgaC](https://zh.wikipedia.org/wiki/FpgaC "wikilink")），還有在[Los Alamos National Laboratory的Streams](https://zh.wikipedia.org/wiki/Los_Alamos_National_Laboratory "wikilink")-C（現在已經得到[Impulse Accelerated Technologies的認可](https://zh.wikipedia.org/wiki/Impulse_Accelerated_Technologies "wikilink")，並且重命名為[Impulse C](https://zh.wikipedia.org/wiki/Impulse_C "wikilink")）

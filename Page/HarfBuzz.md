...
HarfBuzz最初是由FreeType计划最初的一部分代码发展而来，随后在[Qt](../Page/Qt.md "wikilink")和Pango当中分别开发，后来合并为[MIT许可证授权的通用资源库](https://zh.wikipedia.org/wiki/MIT许可证 "wikilink")，这就是Old HarfBuzz。Old HarfBuzz随着开发路线转向New HarfBuzz而不再开发。\[5\]2013年为在HarfBuzz上的成果赢得[O'Reilly开源大奖](https://zh.wikipedia.org/wiki/O'Reilly开源大奖 "wikilink")。\[6\]

## 用户

多数应用程序并不直接使用HarfBuzz，而是使用接入这个库的[用户界面工具箱](https://zh.wikipedia.org/wiki/用户界面工具箱 "wikilink")。HarfBuzz被用在[GNOME](../Page/GNOME.md "wikilink")、[KDE](../Page/KDE.md "wikilink")、[Chrome OS](../Page/Chrome_OS.md "wikilink")、[Android](../Page/Android.md "wikilink")\[7\]和[Java](../Page/Java.md "wikilink")的界面库中；\[8\]还被[Firefox](../Page/Firefox.md "wikilink")、[LibreOffice和](https://zh.wikipedia.org/wiki/LibreOffice "wikilink")[Inkscape](../Page/Inkscape.md "wikilink")等程序直接使用。\[9\]
...
## 外部链接
  ...
  -
  - [Harfbuzz API设计讨论版](http://lists.freedesktop.org/archives/harfbuzz/2009-August/000359.html)

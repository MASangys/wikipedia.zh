...
Homebrew的作者Max
Howell曾应聘过[Google的职位](../Page/Google.md "wikilink")，在技术没有成功之后，在[Twitter上发帖](../Page/Twitter.md "wikilink")
*Google: 90% of our engineers use the software you wrote (Homebrew), but
you can't invert a binary tree on a whiteboard so f\*\*\*
off.*（Google：我们90%的工程师都在用你的软件（Homebrew），但是你不会在白板上翻转二叉树所以滚出去）
[twitter原文](https://twitter.com/mxcl/status/608682016205344768?lang=en)，在网上引发了关于招聘程序员面试时白板编程意义的讨论。

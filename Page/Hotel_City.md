...
遊戲主題為酒店設計及營運，玩家可用提供的資源自由購買物品或安置[房間來設計自己心目中的理想酒店](https://zh.wikipedia.org/wiki/房間 "wikilink")。用戶亦可聘用工作者為自己的「酒店」工作，亦可探訪Facebook有玩此遊戲的朋友的「酒店」並可從中汲取設計經驗或構思。遊戲更會隨[經驗值升級](https://zh.wikipedia.org/wiki/經驗值 "wikilink")，如經驗值愈高的用戶可購買更多不同款式的物品。

## 爭論

《**Hotel
City**》於2011年9月30日結束營運，令不少玩家抱怨Playfish刪掉此遊戲令他們失去樂趣，此程況在Playfish刪掉旗下遊戲時出現，例如[Restaurant
City](../Page/Restaurant_City.md "wikilink")、[寵物社會](https://zh.wikipedia.org/wiki/寵物社會 "wikilink")、[模擬時光等](https://zh.wikipedia.org/wiki/模擬時光 "wikilink")。\[2\]

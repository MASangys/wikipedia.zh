...
OS等操作系统，是完全基于节点模式设计的产物，其结构、操作方式等和其它的三维软件有很大的差异。Houdini自带的渲染器是Mantra，基于[Reyes渲染架构](../Page/Reyes渲染架构.md "wikilink")，因此也能够快速的渲染[运动模糊](https://zh.wikipedia.org/wiki/运动模糊 "wikilink")、[景深](../Page/景深.md "wikilink")和[置换效果](../Page/位移贴图.md "wikilink")。\[1\]
...
ray](../Page/Mental_Ray.md "wikilink")、[V-Ray](../Page/V-Ray.md "wikilink")和Torque等，可以把场景导出到这些渲染引擎进行渲染。

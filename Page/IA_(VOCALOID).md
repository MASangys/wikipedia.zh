...
#### 系統需求
  ...
  - 系統平台（OS）：[Windows
    XP](../Page/Windows_XP.md "wikilink")（32bit）／[Windows
    Vista](../Page/Windows_Vista.md "wikilink")（32bit）／[Windows
    7](https://zh.wikipedia.org/wiki/Windows_7 "wikilink")（32bit/64bit）／[Windows
    8](https://zh.wikipedia.org/wiki/Windows_8 "wikilink")（32/64bit）／Mac（對已持有Windows版的用戶免費提供）
...
THE PLANETES-，是CeVIO Creative Studio首個非日語聲庫。\[6\]
...
與[初音未來](../Page/初音未來.md "wikilink")（[CRYPTON公司持有版權](https://zh.wikipedia.org/wiki/CRYPTON_FUTURE_MEDIA "wikilink")）等其他VOCALOID角色相比，1st
PLACE對使用IA的聲音、角色形象及名稱（「IA」或「イア」）的限制為寬鬆，只要不是以營利為目的、不違反公序良俗或侵害第三者權益，甚至在一定限制範圍內商用，均毋須獲得官方的許可即可使用\[7\]\[8\]。1st
PLACE亦在其官方網站上提供了一些[自由的素材](http://1stplace.co.jp/vocaloid/commons.html)，供非營利的動畫投稿及Blog上使用。
...
2012年11月29日與[Jin](https://zh.wikipedia.org/wiki/Jin "wikilink")（自然之敵P）在[東京的Zepp](https://zh.wikipedia.org/wiki/東京 "wikilink")
DiverCity出演「VOICE Fes 2012」，應用了3D投影映射（3D Projection Mapping）技術。\[9\]
...
Aquamarine公司开发的IA -ARIA ON THE
PLANETES-立体化手办于2013年3月发售，该手办还原了IA绘师赤坂的「鸟之诗」原作插图造型。\[11\]
...
Visual Tracks
Colorful」之縮寫\[14\]，「IA」和「VT」字样组合起来恰好是“[VITA](../Page/PlayStation_Vita.md "wikilink")”。游戏将收录60首曲目，之后还会对应DLC，已收录以「IA/01
BIRTH」「IA/02 COLOR」为中心的既有曲，IA的其他新曲也有机会收录在内。\[15\]
...
## 外部連結
  ...
  - [IA -ARIA ON THE
    PLANETES-官方網站](http://1stplace.co.jp/software/vocaloid/)

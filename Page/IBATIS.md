...
| status = Active | latest release version = | latest release date = |
...
| programming language = [Java](../Page/Java.md "wikilink"),
[.NET](https://zh.wikipedia.org/wiki/.NET_Framework "wikilink") and
[Ruby](https://zh.wikipedia.org/wiki/Ruby_\(programming_language\) "wikilink")
| genre = [Persistence
Framework](https://zh.wikipedia.org/wiki/Persistence_Framework "wikilink")
| license = [Apache
...
Begin在2001年发起的[开放源代码项目](../Page/开放源代码.md "wikilink")。最初侧重于[密码](https://zh.wikipedia.org/wiki/密码 "wikilink")[软件的开发](../Page/软件.md "wikilink")，现在是一个基于[Java的持久层框架](../Page/Java.md "wikilink")。iBATIS提供的持久层框架包括[SQL](../Page/SQL.md "wikilink")
Maps和Data Access
Objects（[DAO](https://zh.wikipedia.org/wiki/DAO "wikilink")），同时还提供一个利用这个框架开发的JPetStore实例。

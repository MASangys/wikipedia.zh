**IEEE 802.11 (原始标准)**，或称之为**IEEE 802.11-1997**、**IEEE
802.11-1999**，是指[IEEE 802.11](../Page/IEEE_802.11.md "wikilink")
[无线网络](../Page/无线网络.md "wikilink")
最初始的标准。该标准1997年发布并于1999年阐明澄清。该早期版本的大部分协议现在很少被使用。
...
[Lucent](https://zh.wikipedia.org/wiki/Lucent "wikilink"), [Netwave
Technologies等公司](https://zh.wikipedia.org/wiki/Netwave_Technologies "wikilink")。该协议的一大缺点是它提供了太多的选择使得互操作性很难实现。所以它不严密，更像是一个beta标准，给了不同的产品厂商很多灵活性，但缺少厂商之间的操作性。

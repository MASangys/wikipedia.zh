...
目前高效能的[網路交換器皆有建置流量控管機制](../Page/網路交換器.md "wikilink")，當[網路交換器產生擁塞時就會利用PAUSE](../Page/網路交換器.md "wikilink")
frame 通知傳送者暫緩送出封包，以減緩擁塞情況。

## 概述

早期[網路交換器在](../Page/網路交換器.md "wikilink")[半雙工](https://zh.wikipedia.org/wiki/半雙工 "wikilink")(Half
...
在 802.3x下，當[網路交換器產生擁塞時就會利用PAUSE](../Page/網路交換器.md "wikilink") frame

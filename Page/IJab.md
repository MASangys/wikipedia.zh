...
## 功能
  ...
  - 嵌入[浏览器运行](https://zh.wikipedia.org/wiki/浏览器 "wikilink")，无弹出窗口
  - 声音
  - 多人聊天
  - 用户搜索
  - Roster管理
  - [HTTP绑定](https://zh.wikipedia.org/wiki/XMPP#XMPP協議通過HTTP運輸 "wikilink")

## 相关信息

  - [XMPP协议的客户端软件列表](https://zh.wikipedia.org/wiki/XMPP协议的客户端软件列表 "wikilink")

## 外部链接

  - [项目主页](http://code.google.com/p/ijab/)

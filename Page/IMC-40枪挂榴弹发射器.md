**IMC-40**主要被用作同其他单兵武器
（如[突击步枪](../Page/突击步枪.md "wikilink")、[冲锋枪等](../Page/冲锋枪.md "wikilink")，尤其是同为哥伦比亚军事工业公司生产的**[5.56毫米](../Page/5.56×45mm_NATO.md "wikilink")[伽利尔突击步枪AR型和SAR型](https://zh.wikipedia.org/wiki/IMI_Galil突击步枪 "wikilink")**）搭配使用的附件，从而实现单兵能同时拥有发射5.56毫米子弹和所有[40毫米榴弹的能力](https://zh.wikipedia.org/wiki/40毫米榴弹 "wikilink")。

## 设计

IMC-40榴弹发射器作为一款下挂式榴弹发射器，在将其下挂于步枪之下时，不需对榴弹发射器作任何改装，就能通过普通的商用[螺钉等转接零件在](https://zh.wikipedia.org/wiki/螺钉 "wikilink")5分钟之内将榴弹发射器下挂于大多数的突击步枪之下。在材料方面，IMC-40大量使用了高电阻、重量低的航空[铝合金](https://zh.wikipedia.org/wiki/铝合金 "wikilink")。而枪管则是使用高耐用度的、表面经过阳极处理的铝合金，这极大的增强了枪管的使用寿命。尽管IMC-40榴弹发射器在设计时是作为下挂式榴弹发射器使用的，但IMC-40仍可作为独立榴弹发射器使用。
...
## 外部链接
  ...
  - —[哥伦比亚军事工业公司产品目录](https://web.archive.org/web/20150419184649/https://indumil.gov.co/docs/editor/catalogoindumil2010.pdf)
    (15页\~16页有IMC-40榴弹发射器的介绍)
...
[Category:哥伦比亚枪械](https://zh.wikipedia.org/wiki/Category:哥伦比亚枪械 "wikilink")
...
此外，针对iPad使用者日益高涨的生产力需求，苹果专为iPad推出了应用于较大屏幕、具有更强多功能处理能力与延展能力，且媲美桌面级操作系统生产力的全新操作系统：[iPadOS](https://zh.wikipedia.org/wiki/iPadOS "wikilink")。
...
iOS13 操作系统可以切换为黑暗模式（Dark Mode），顾名思义就是把整个操作介面变成暗黑色主色调、降低屏幕亮度，尤其在昏暗环境观看，可以保护双眼，让 OLED 屏幕更耐用，且更省电。

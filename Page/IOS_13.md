...
[Face ID速度提升](../Page/面容_ID.md "wikilink")30％，App体积減少50％，更新体积減小60％，打开速度提升1倍。

### 深色模式

iOS 13 操作系统可以切换为深色模式（Dark Mode），顾名思义就是把整个操作介面变成暗黑色主色调、降低屏幕亮度，尤其在昏暗环境观看，可以保护双眼，让 OLED 屏幕更耐用，且更省电。
...
iOS 13中，苹果地图针对美国境內推出了类似竞争对手[Google Maps的街景地图功能](https://zh.wikipedia.org/wiki/Google_Maps "wikilink")，并预计2019年底开放使用；其他国家將在2020年陆续开放街景功能。此外，地图显示内容也更加细致丰富。针对中国境内使用者，苹果地图还增加了路口导航功能。

### 隐私

iOS 13變更了地理定位資訊的處理方式。當某個應用程式請求存取定位資訊時，使用者可選擇在使用應用程式時允許存取，或僅允許單次存取。當應用程式在背景存取定位資訊時，或要求存取藍芽和Wi-Fi功能時（這兩個功能也可能被用在未經同意的地理位置定位），使用者也會收到類似的詢問訊息。\[4\]\[5\]

根據2019年8月的報導消息指出，自2020年4月開始[VoIP](../Page/VoIP.md "wikilink")的PushKit API將會被限制僅能被用在網路電話上，代表某些應用程式將其用作背景資料收集的「漏洞」將會被修補。\[6\]\[7\]

### 「使用Apple登入」

新推出的單一登入功能「使用Apple登入」（Sign in with Apple），能讓使用者在第三方服務創建帳號時，僅需提供少量的個人資訊。使用者可以使用私人的真實電子郵件地址，或使用臨時電子郵件地址。\[8\]使用者可以針對個別網站產生一次性的臨時電子郵件地址，增加隱私性與匿名性，並減少與單一電子郵件地址關聯的資訊量。所有支援第三方登入方式的應用程式（例如Facebook或Google），都必須支援「使用Apple登入」系統\[9\]\[10\]，而iOS人機介面指引建議開發者將「使用Apple登入」選項放在其他登入方式之上。\[11\]\[12\]
...
### 相機和照片
  ...
  - 在照片编辑页面，各项参数设置的界面更加明了清晰，设置项也更多，例如垂直和水平视角矫正之类的功能被加入编辑器。系统内置滤镜在iOS 13内也支持调整滤镜强度。此外，iPhone首次支持了在“照片”app内对视频进行色调、光效、时长、旋转和剪裁等方面的编辑。

### 邮件

  - 标记电子邮件时時，可以从各种颜色中进行选择。彩色标志在所有Apple设备上可通过iCloud同步到Mail，并且可以随时將其更改或刪除。
  - 除了「回复」，「回复全部」，「转发」和「队列」之外，「回复」选项还增加「标记为未读」，「移至垃圾邮件」，「移至其他信箱」，「标记选项」以及新的「静音」选项。
  - 将所有Apple设备上电子邮件通知静音。
  - 当您输入文字时，键盘上方会出现一个方便的新格式栏，提供全面的格式和附件选项，包括扫描，插入照片或影片，加入附件和插入图纸的功能。
  - 新项目栏增加了全面的文字格式工具，可让您编辑具有专业格式的电子邮件。格式化包括新的字体样式，大小和颜色选择、删除线、对齐、编号和项目符号列表，以及缩进。
  - 支持所有系统字体以及自行安裝的字体。
  - 新的照片选择器占据屏幕的下半部分，可在选择照片时看到的电子邮件。
  - 更新了地址自动填写功能
  - 将在收件人加到到电子邮件地址时，会列出每个发件人下的电子邮件地址选项
...
### 3D Touch与Haptic Touch

[3D觸控於](https://zh.wikipedia.org/wiki/3D觸控 "wikilink") iOS 13 中被蘋果專為 iPhone Xʀ 以及后续 iPhone 11 系列所開發的觸控操作方式Haptic Touch取代。在舊有的仍具備有3D觸控面板設計的機型上（iPhone 6S～iPhone Xs)，3D觸控仍可以触发操作，其有相較於Haptic Touch更快的反應速度。

## 支持设备

由於iOS 13 僅支持2GB RAM以上機型，且iPad系列設備所使用的操作系統被[iPadOS所代替](https://zh.wikipedia.org/wiki/iPadOS "wikilink")。因此iPhone 5S、iPhone 6、iPhone 6 Plus和iPod touch 6均無法升級到iOS 13。這也是蘋果第一次淘汰部分搭載[64位元](../Page/64位元.md "wikilink")處理器的手機。而[iPad mini 4雖然使用了與iPhone](https://zh.wikipedia.org/wiki/iPad_mini_4 "wikilink") 6及iPhone 6 Plus一樣的Apple A8處理器，但由於iPad mini 4搭載了2GB RAM，因此得以升級至[iPadOS](https://zh.wikipedia.org/wiki/iPadOS "wikilink")。
...
<td><p><small>17A5556d</small></p></td>
<td><p>2019年8月8日</p></td>
<td></td>
</tr>
<tr class="even">
<td><p>Public beta 5</p></td>
<td><p>2019年8月9日</p></td>
<td></td>
<td></td>
</tr>
<tr class="odd">
<td><p>Developer beta 7</p></td>
<td><p><small>17A5565b</small></p></td>
...
<td><p>13.1.2</p></td>
<td><p>正式版</p></td>
<td><p><small>17A860/17A861</small></p></td>
...
## 外部鏈接
  ...
  - [官方網站](https://www.apple.com/tw/ios/ios-13-preview/)

...
Interface）原本是一種[Intel架構的企業系統的週邊設備所採用的一種工業標準](../Page/Intel.md "wikilink")。IPMI亦是一個開放的免費標準，使用者無需支付額外的費用即可使用此標準。
...
IPMI
1.5版和之後的版本能透過直接串接、[區域網路](../Page/區域網路.md "wikilink")、或到遠端送出警報，系統管理員能使用IPMI訊息去查詢平台狀態、查看硬體的日誌、或透過相同連線從遠端控制台發出其他要求，這個標準也為系統定義了一個警報機制送出[簡單網路管理協定](../Page/简单网络管理协议.md "wikilink")([SNMP](../Page/简单网络管理协议.md "wikilink"))
平台事件圈套(PET, Platform Event Trap)。

## 頻帶和頻帶外

IPMI實作的通常被稱作 頻帶
管理LAN連線，這個連線應用一個介於BMC和基板[NIC之間的](../Page/网卡.md "wikilink")[SMBUS介面](../Page/系統管理匯流排.md "wikilink")。

這個方案有降低成本的優點，但也限制了頻寬-足夠主控台(Console)的[重定向但不足夠傳訊視訊](../Page/重定向_\(計算機\).md "wikilink")。換句話說，當遠端的電腦關機了，系統管理員能透過IPMI和應用主控台存取。這個對一些重要的功能而言已經足夠，如：確認事件log、存取[BIOS設定執行開啟](../Page/BIOS.md "wikilink")、關閉、開機循環，然而，更進階的功能，如：遠端重安裝作業系統，就需要方法應用一個專用
LAN 連線。
...
一個 [:實地替換單元](../Page/:實地替換單元.md "wikilink")()
擁有可替換設備的詳細清單（如：供應者ID、製造商），一個
感應器資料記錄(SDR) 則記錄了板上個別感應器提供的屬性資料，例如：板上可能包含了感應溫度、風扇速、電流的感應器。
...
## 另請參見
  ...
  - (also known as [Lights out management](../Page/带外管理.md "wikilink")
    (LOM))

  - (MCTP, a low-level protocol used for controlling hardware
    components)

  - ([HP](../Page/Hewlett-Packard.md "wikilink")'s implementation of
    IPMI)

  - [Dell DRAC](../Page/Dell_DRAC.md "wikilink")
    ([Dell](../Page/Dell.md "wikilink")'s implementation of IPMI)
  ...
  - MergePoint Embedded Management Software (OEM IPMI firmware used in
    ...
    [DELL](../Page/DELL.md "wikilink") and
    [Gigabyte](../Page/Gigabyte_Technology.md "wikilink") motherboards)

  - ('s out of band management product and OEM IPMI firmware used in
    e.g. [ASUS](../Page/ASUS.md "wikilink"),
    [Tyan](../Page/Tyan.md "wikilink"),
    [Intel](../Page/Intel.md "wikilink") and
    [Supermicro](../Page/Supermicro.md "wikilink") motherboards)

  - [Intel Active Management
    Technology](../Page/Intel主动管理技术.md "wikilink") (AMT,
    Intel's out-of-band management product, as an alternative to IPMI)
...
## 参见
  ...
  - [Lights out management](../Page/Lights_out_management.md "wikilink")
    (LOM)
  - [Wired for Management](../Page/Wired_for_Management.md "wikilink")
    (WfM)
  - DMTF [Systems Management Architecture for Server
    Hardware](../Page/Systems_Management_Architecture_for_Server_Hardware.md "wikilink")
    (SMASH)
  - DMTF [Alert Standard
    Format](../Page/Alert_Standard_Format.md "wikilink") (ASF)

...
| 100.64.0.0/10                                            | [电信级NAT](https://zh.wikipedia.org/wiki/电信级NAT "wikilink") | RFC 6598 |
| 127.0.0.0/8                                              | [环回](../Page/Localhost.md "wikilink")                     | RFC 5735 |
| 169.254.0.0/16                                           | [链路本地](https://zh.wikipedia.org/wiki/链路本地地址 "wikilink")   | RFC 3927 |
...
隨著[IANA把最後](https://zh.wikipedia.org/wiki/IANA "wikilink")5個地址塊分配給5個RIR，其主地址池在2011年2月3日耗盡。\[5\]
...
<!-- end list -->
  ...
  - 区分服务（Differentiated Services，DS）
    占8bit，最初被定义为[服务类型字段](https://zh.wikipedia.org/wiki/服务类型 "wikilink")，实际上并未使用，但1998年被IETF重定义为区分服务RFC

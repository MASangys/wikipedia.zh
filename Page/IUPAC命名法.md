...
## IUPAC颜色书
  ...
  - 总则（General）
      - [化学命名原理](https://zh.wikipedia.org/wiki/化学 "wikilink")（Principles of Chemical Nomenclature: a Guide to IUPAC Recommendations）
  - 蓝色书（Blue Book）
...
16. *Nomenclature for the C<sub>60</sub>-I<sub>h</sub> and C<sub>70</sub>-D<sub>5h(6)</sub> Fullerenes.* IUPAC Recommendations 2002, *Pure Appl. Chem.*, 2002, 74, 629-695.
...
## 外部連結
  ...
  - Interactive [IUPAC Compendium of Chemical Terminology](http://goldbook.iupac.org/)（interactive "Gold Book"）
  - [IUPAC Nomenclature Books Series](http://old.iupac.org/publications/books/seriestitles/nomenclature.html)（list of all IUPAC nomenclature books, and means of accessing them）
  - [IUPAC Compendium of Chemical Terminology](https://web.archive.org/web/20051212164525/http://www.iupac.org/publications/compendium/index.html)（"*Gold Book*"）
  - [Quantities, Units and Symbols in Physical Chemistry](http://old.iupac.org/publications/books/gbook/index.html)（"*Green Book*"）
  - [IUPAC Nomenclature of Organic Chemistry](http://www.acdlabs.com/iupac/nomenclature/)（"*Blue Book*"）
  - [Nomenclature of Inorganic Chemistry IUPAC Recommendations 2005](http://old.iupac.org/publications/books/author/connelly.html)（"*Red Book*"）
  - [IUPAC Recommendations on Organic & Biochemical Nomenclature, Symbols, Terminology, etc.](http://www.chem.qmul.ac.uk/iupac/)（includes IUBMB Recommendations for biochemistry）
  - [chemicalize.org](http://www.chemicalize.org) A free web site/service that extracts IUPAC names from web pages and annotates a 'chemicalized' version with structure images. Structures from annotated pages can also be searched.
  - [ChemAxon Name \<\> Structure](https://web.archive.org/web/20101124182810/http://www.chemaxon.com/products/name-to-structure/) – IUPAC (& traditional) name to structure and structure to IUPAC name software. As used at [chemicalize.org](http://www.chemicalize.org)
  - [ACD/Name](http://www.acdlabs.com/products/draw_nom/nom/name/) – Generates IUPAC, INDEX (CAS), InChi, Smiles, etc. for drawn structures in 10 languages and translates names to structures. Also available as batch tool and for Pipeline Pilot. Part of [I-Lab 2.0](https://web.archive.org/web/20131103060933/https://ilab.acdlabs.com/iLab2/)

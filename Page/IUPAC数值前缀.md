...
**数值前缀**（numerical multiplier或multiplying affix）是[IUPAC命名法](../Page/IUPAC命名法.md "wikilink")用来表示多少个特定原子或[功能团附加于分子内部的特定位置上](https://zh.wikipedia.org/wiki/功能团 "wikilink")。这些[前缀源自](https://zh.wikipedia.org/wiki/前缀 "wikilink")[拉丁语](../Page/拉丁语.md "wikilink")与[希腊语](https://zh.wikipedia.org/wiki/希腊语 "wikilink")。
...
复合前缀中，数值2表示为*di-*，除了20 (*icosa-*)，200 (*dicta-*)或2000 (*dilia-*)。

## 其它数字前缀种类

IUPAC有机化学命名中还有两种数值前缀。\[1\]

### 复合或复杂特征的数值术语

复合或复杂特征的数值术语 (如同*繁复*) 是在基本数字前缀加上*kis*，除了分别是bis-和tris-的数值2和3以外。
...
<tr class="even">
<td><p>11–9999</p></td>
<td><p><em>在基本数值前缀最后的"a"<br />
用"i"取代，<br />
以及/或者"deka"用"deci"取代。</em> </p></td>
</tr>
</tbody>
</table>
...
语言学家注意到100及以上的表示法并不是正确的希腊语。[古希腊](../Page/古希腊.md "wikilink")时候，*hekaton* = 100，*diakosioi* = 200，*triakosioi* = 300等，*khīlioi* = 1000，*diskhīlioi* = 2000， *triskhīlioi* = 3000等，且13到19是*treiskaideka*等。

## 参见

  - [Oligopeptide](https://zh.wikipedia.org/wiki/Oligopeptide "wikilink") — 少数
  - [Polypeptide](https://zh.wikipedia.org/wiki/Polypeptide "wikilink") — 多数

## 参考文献

[Category:化学命名法](https://zh.wikipedia.org/wiki/Category:化学命名法 "wikilink")

1.  [IUPAC Blue Book](https://zh.wikipedia.org/wiki/IUPAC_Blue_Book "wikilink"), 2013
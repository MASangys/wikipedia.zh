...
成人無記名式如果遺失或被偷竊，無法報失及補發新卡\[6\]。按金是500日圓\[7\]。
...
　1個月、3個月、6個月、端數定期票、學期定期票及後期定期票及年間定期票「Campus Port 365（）」
...
　1枚Ibappi內可購買2種類定期票
  ...
  - 年間定期票及学期定期票
  - 長者專用　全線自由定期票　茨交漫遊Pass

　滿65歳以上長者，能夠隨便乘搭全部巴士全線的定期票

## 系統

### 發行及增值

Ibappi能在各茨城交通的營業所及水戶車站前乘客服務站發售\[8\]。大人無記名式可以在接受Ibappi的巴士上買到\[9\]。售價連按金為2000日圓（即卡內餘額為1500日圓）\[10\]。現金增值能在接受Ibappi的巴士錢箱上、各茨城交通的營業所及水戶車站前乘客服務站進行\[11\]。亦可以申請自動增值功能\[12\]。

### 優惠制度

現正提供用戶優惠（10%）、平日日間優惠（10%）及轉乘優惠（50円）等優惠服務\[13\]。用戶優惠的車費，在茨城交通的官方網站內進行車費查詢後，會以IC車費（「****（Ibappi車費）」）表示\[14\]。

### 提携服務

信用卡「JOYO CARD Plus」為使用Ibappi自動增值功能的用戶提供現金回贈優惠，但已於在2016年5月完結\[15\]。

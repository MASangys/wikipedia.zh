...
[華碩](../Page/華碩.md "wikilink")[Eee PC的简单模式桌面使用IceWM](https://zh.wikipedia.org/wiki/華碩Eee_PC "wikilink")。\[5\]

用于树莓派1、2、3的[openSUSE使用IceWM为默认轻量用户界面](https://zh.wikipedia.org/wiki/openSUSE "wikilink")。\[6\]用于树莓派3的[SUSE Linux Enterprise服务器同样使用IceWM](../Page/SUSE.md "wikilink")。\[7\]

## 截图

Icewmstartmenu.png|IceWM的开始菜单与Windows 95相似 IceWM 1.3.ogv|IceWM 1.3在Debian 7 Linux上运行

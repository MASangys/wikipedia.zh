...
舊版本的毀滅戰士3引擎常被批評缺乏繪製大型戶外場景的功能，而[MegaTexture技術解決了這個問題](https://zh.wikipedia.org/wiki/MegaTexture "wikilink")，透過繪製一個巨型的材質（32,768x32,768像素，新版本的MegaTexture可以支援更大的材質貼圖）覆蓋整個地形，並且儲存該地形的相關物理資料。這些物理資料可以告訴引擎你現在處在什麼環境，例如在石頭上行走和草地上行走的聲音將會有相當大的不同\[3\]。相對於現有使用「套用材質在地形上」的技術，MegaTexture也將讓地圖能夠呈現更精細的景觀。目前唯一使用MegaTexture技術的遊戲是[深入敵後：雷神戰争](https://zh.wikipedia.org/wiki/深入敵後：雷神戰争 "wikilink")。

## 使用id Tech 4引擎的遊戲

  - [毀滅戰士3](https://zh.wikipedia.org/wiki/毀滅戰士3 "wikilink")
      - [毀滅戰士3：邪惡復甦](https://zh.wikipedia.org/wiki/毀滅戰士3：邪惡復甦 "wikilink")（恶魔归来）
  - [雷神之錘4](https://zh.wikipedia.org/wiki/雷神之錘4 "wikilink")
  - [深入敵後：雷神戰争](https://zh.wikipedia.org/wiki/深入敵後：雷神戰争 "wikilink")
...
## 內部連結
  ...
  - [id Tech 3](https://zh.wikipedia.org/wiki/id_Tech_3 "wikilink")

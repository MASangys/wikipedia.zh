> 本文内容由[Istec ISL-200附加型榴彈發射器](https://zh.wikipedia.org/wiki/Istec_ISL-200附加型榴彈發射器)转换而来。
...
順帶一提，在ISL-200系列之中的任何武器均可藉由轉換口徑；在適當的工具和有效的技能以下，即可在5分鐘以內將武器更換為發射不同彈藥類型的[40毫米榴彈](../Page/40毫米榴彈.md "wikilink")、[37毫米信號彈或是](https://zh.wikipedia.org/wiki/37毫米信號彈 "wikilink")[12鉛徑霰彈](https://zh.wikipedia.org/wiki/霰彈 "wikilink")。

### ISL-201

40毫米[下掛式榴弹发射器](https://zh.wikipedia.org/wiki/榴弹发射器#附加型榴弹发射器 "wikilink")。

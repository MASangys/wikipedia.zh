...
的[递归缩写](../Page/递归缩写.md "wikilink")）是一个专业级的[声音服务](../Page/声音服务.md "wikilink")（[守护进程](../Page/守护进程.md "wikilink")），它為声音和[MIDI数据提供实时的](../Page/MIDI.md "wikilink")、[低延时的连接](../Page/低延时.md "wikilink")，有關的程式使用JACK的[API](../Page/API.md "wikilink")。

它是由（他凭着这项工作赢得了2004年的开源奖\[1\]）带领的一个[开源社区开发](../Page/开源.md "wikilink")。自从2002年初以来一直是[Linux下的关键的基础设施和事实上的专业音频软件标准](../Page/Linux.md "wikilink")。这个服务是在[GNU
GPL协议下的](../Page/GNU_GPL.md "wikilink")[开源软件](../Page/开源软件.md "wikilink")，它的库則採用更宽松的[GNU
LGPL协议](../Page/GNU_LGPL.md "wikilink")。

## 实现

JACK
能使用[ALSA](../Page/ALSA.md "wikilink")、[PortAudio](../Page/PortAudio.md "wikilink")、[CoreAudio](../Page/CoreAudio.md "wikilink")、[FFADO和](../Page/FFADO.md "wikilink")[OSS作为硬件层的后端](../Page/OSS.md "wikilink")。此外,
...
[Solaris](../Page/Solaris_\(作業系統\).md "wikilink")、

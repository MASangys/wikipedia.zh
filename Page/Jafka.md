**Jafka**
是一个[开源的](https://zh.wikipedia.org/wiki/开源 "wikilink")、高性能的、跨语言分布式，使用[GitHub](../Page/GitHub.md "wikilink")托管\[1\]。
...
Jafka
遵循[Apache许可证](../Page/Apache许可证.md "wikilink")，同时发布的版本提交到[MAVEN](../Page/MAVEN.md "wikilink")中央仓库\[3\]。

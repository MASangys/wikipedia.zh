...
4.  Jane Doe（Instrumental）
5.  破れた羽根（Instrumental）
6.  錆びたロック（Instrumental）
...
1.  **Jane Doe**
2.  **破れた羽根**
3.  **[右肩](../Page/你就是我.md "wikilink")** \[5:08\]
      -
        （作詞：秋元康、作曲・編曲：[杉山勝彦](https://zh.wikipedia.org/wiki/杉山勝彦 "wikilink")）
4.  Jane Doe（Instrumental）
5.  破れた羽根（Instrumental）
6.  右肩（Instrumental）

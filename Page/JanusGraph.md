...
JanusGraph支持多种储存后端（包括[Apache Cassandra](https://zh.wikipedia.org/wiki/Apache_Cassandra "wikilink")、[Apache HBase](../Page/Apache_HBase.md "wikilink")、[Bigtable](../Page/Bigtable.md "wikilink")、[Berkeley DB](../Page/Berkeley_DB.md "wikilink")\[2\]）。JanusGraph的可扩展性取决于与JanusGraph一起使用的基础技术。例如，通过使用Apache Cassandra作为存储后端，可以将JanusGraph简单地扩展到多个数据中心。

JanusGraph通过与大数据平台（[Apache Spark](../Page/Apache_Spark.md "wikilink")，[Apache Giraph](../Page/Giraph.md "wikilink")，[Apache Hadoop](../Page/Apache_Hadoop.md "wikilink")）集成，支持全局图数据的分析、报告和ETL。\[3\]
...
JanusGraph与Apache TinkerPop\[5\] 图栈（[Gremlin](../Page/Gremlin.md "wikilink")图查询语言，[Gremlin图服务器](https://tinkerpop.apache.org/docs/3.3.3/reference/#gremlin-server)，[Gremlin应用](https://tinkerpop.apache.org/docs/3.3.3/reference/#gremlin-applications)）原生集成。\[6\]
...
## 外部链接
  ...
  - [JanusGraph deployment](https://developer.ibm.com/dwblog/2018/whats-janus-graph-learning-deployment/) / IBM，2018年4月11日
  - [Developing a JanusGraph-backed Service on Google Cloud Platform](https://cloud.google.com/blog/products/gcp/developing-a-janusgraph-backed-service-on-google-cloud-platform) / Google，2018年7月19日
  - [Performance optimization of JanusGraph](https://www.experoinc.com/post/janusgraph-nuts-and-bolts-part-1-write-performance) / Expero，2018年1月23日
  - [Graph Computing with JanusGraph](http://wiki.ldbcouncil.org/download/attachments/91422722/ldbc_tuc_janusgraph.pdf) / IBM，2018年6月8日
  - [Large Scale Graph Analytics with JanusGraph](https://www.slideshare.net/ptgoetz/large-scale-graph-analytics-with-janusgraph) / Hortonworks，2017年6月13日
  - [JanusGraph Concepts](https://console.bluemix.net/docs/services/ComposeForJanusGraph/janusgraph-concepts.html) / IBM，2017年12月12日
  - [Apache Atlas and JanusGraph – Graph-based Meta Data Management](https://developer.ibm.com/articles/apache-atlas-and-janusgraph-graph-based-meta-data-management) / IBM，2018年11月8日

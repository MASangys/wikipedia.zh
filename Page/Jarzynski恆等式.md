...
這裡，*k*是[波茲曼常數](../Page/波茲曼常數.md "wikilink")，*T*為平衡狀態*A*時的系統溫度，也是過程發生时外界的溫度。\(F_A\)和\(F_B\)分别是在条件*A*和*B*下的平衡态自由能。上式右边的横线表示对所有由条件*A*至条件*B*的可能過程之平均。我们假定了初始状态为平衡态。但是由于这些过程不一定是可逆过程，最终状态不一定是平衡态。事实上，\(\exp( -W/kT )\)起的作用就是把所有到达终点*B*时的微观状态重新加权来还原一个平衡态的分布。在任何無限慢的過程中，作用於系統上的功*W*都會是一樣的，所以平均變得無所謂，使Jarzynski恆等式會化為熱力學上的等式\(\Delta F = W\)。但一般而言，*W*還是因著不同的系統初始[微觀態而會有不同](https://zh.wikipedia.org/wiki/微觀態 "wikilink")，儘管其平均仍然能和\(\Delta F\)有[延森不等式](../Page/延森不等式.md "wikilink")的關係，即
...
## 另見
  ...
  - [擾動定理](https://zh.wikipedia.org/wiki/擾動定理 "wikilink") - 提供一個量化於許多非平衡系統內平均熵生成的擾動的公式。
  - [Jarzynski equality on arxiv.org](http://xstructure.inr.ac.ru/x-bin/theme2.py?arxiv=cond-mat&level=1&index1=6091)
  - [Crooks漲落定理](https://zh.wikipedia.org/wiki/Crooks漲落定理 "wikilink")

[Category:统计力学](https://zh.wikipedia.org/wiki/Category:统计力学 "wikilink") [Category:非平衡態熱力學](https://zh.wikipedia.org/wiki/Category:非平衡態熱力學 "wikilink") [Category:方程](https://zh.wikipedia.org/wiki/Category:方程 "wikilink")
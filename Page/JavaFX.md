...
Internet
application（[RIAs](https://zh.wikipedia.org/wiki/RIA "wikilink")）。当前的JavaFX包括JavaFX脚本和JavaFX
Mobile（一种运营于行動裝置的操作系统），今后JavaFX将包括更多的产品。

JavaFX脚本的前身是一个由Chris Oliver开发的一个叫做F3的项目\[1\]。

JavaFX期望能够在桌面应用的开发领域与Adobe公司的AIR、[OpenLaszlo以及](https://zh.wikipedia.org/wiki/OpenLaszlo "wikilink")[微软公司的](../Page/微软.md "wikilink")[Silverlight相竞争](https://zh.wikipedia.org/wiki/Silverlight "wikilink")，它也可应用于Blu-Ray的交互平台[BD-J](../Page/BD-J.md "wikilink")，但目前尚未宣布对Blu-Ray的支援计划。

## 参见

  - [JavaFX脚本](https://zh.wikipedia.org/wiki/JavaFX脚本 "wikilink")
  - [Adobe AIR](../Page/Adobe_AIR.md "wikilink")（前身是Adobe Apollo）
  - [Curl](https://zh.wikipedia.org/wiki/Curl变成语言 "wikilink") 5.0 from
    [Curl Inc.](http://www.curl.com) for off-line RIA\\
  - 支援JavaFX的[Lobo
    Web浏览器](https://zh.wikipedia.org/wiki/Lobo_\(浏览器\) "wikilink")
  - [Microsoft
...
[Category:Mobile_software](https://zh.wikipedia.org/wiki/Category:Mobile_software "wikilink")

...
Java语言中的类、方法、变量、参数和包等都可以被标注。和[Javadoc不同](../Page/Javadoc.md "wikilink")，Java标注可以通过反射获取标注内容。在[编译器生成](../Page/编译器.md "wikilink")[类文件时](../Page/类文件.md "wikilink")，标注可以被嵌入到[字节码中](../Page/字节码.md "wikilink")。[Java虚拟机可以保留标注内容](../Page/Java虚拟机.md "wikilink")，在运行时可以获取到标注内容\[2\]。
当然它也支持自定义Java标注\[3\]
...
标注通常用于软件[框架为用户定义的类和方法提供引用外部资源的情形](../Page/框架.md "wikilink")，如XML配置文件、事务环境等。以下是一个标注过的EJB
3.0的类：

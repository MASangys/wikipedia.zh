...
bytecode的](https://zh.wikipedia.org/wiki/Java_bytecode "wikilink")[虛擬機器](../Page/虛擬機器.md "wikilink")，以[堆疊結構機器來進行實做](https://zh.wikipedia.org/wiki/堆疊結構機器 "wikilink")。最早由[昇陽電腦所研發并实现第一个实现版本](../Page/昇陽電腦.md "wikilink")，是[Java平臺的一部份](../Page/Java平臺.md "wikilink")，能夠執行以[Java語言寫作的](../Page/Java.md "wikilink")[軟體](https://zh.wikipedia.org/wiki/軟體 "wikilink")[程式](https://zh.wikipedia.org/wiki/程式 "wikilink")。

Java虚拟机有自己完善的[硬体架构](https://zh.wikipedia.org/wiki/硬体 "wikilink")，如[处理器](https://zh.wikipedia.org/wiki/处理器 "wikilink")、[堆栈](../Page/堆栈.md "wikilink")、[寄存器等](../Page/寄存器.md "wikilink")，还具有相应的[指令系统](https://zh.wikipedia.org/wiki/指令 "wikilink")。JVM屏蔽了与具体[操作系统平台相关的信息](../Page/操作系统.md "wikilink")，使得Java[程序只需生成在Java虚拟机上运行的目标代码](https://zh.wikipedia.org/wiki/程序 "wikilink")（[字节码](https://zh.wikipedia.org/wiki/字节码 "wikilink")），就可以在多种平台上不加修改地运行。通过对中央处理器（[CPU](https://zh.wikipedia.org/wiki/CPU "wikilink")）所执行的软件實作，实现能执行[编译过的Java程序码](https://zh.wikipedia.org/wiki/编译 "wikilink")（[Applet与应用程式](https://zh.wikipedia.org/wiki/Applet "wikilink")）。
...
以下为实现了相应的JVM编译器的语言及其编译（解释）器，意味着下列语言可以使用基于Java开发的编译器进行编译或解释：
  ...
  - [Pascal](https://zh.wikipedia.org/wiki/Pascal "wikilink")：[Free

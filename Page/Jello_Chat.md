...
## 特色與功能
  ...
  - 通話傳訊：包含傳送文字、語音、相片、影片、短影片、貼圖、GIF、連結等訊息，並可撥打視訊及語音通話。
  - 無痕收回：收回訊息後並不會顯示對方/自己收回訊息的相關提示。
  - 無痕退群：退出群組並不會顯示某人退出群組的相關訊息提示。
  - 語音訊息連播：傳送出的連續語音訊息，點擊第一則，會自動在播放完畢後播放下一則。
  - 悄悄話模式：於訊息欄右滑切換到悄悄話模式後，在對方未點開前顯示為悄悄話訊息，並會在對方點擊後顯示文字內容並開始倒數計時，會於設定秒數後消失。
  - 塗鴉：塗鴉功能分享讓用戶能行在Jello上繪圖，並有空白及其他模板可選擇。傳出後的塗鴉為一張動態貼圖，並在點擊後會照繪圖筆順播放。

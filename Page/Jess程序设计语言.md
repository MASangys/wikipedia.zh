...
Jess提供适合自动化[专家系统的](../Page/专家系统.md "wikilink")[逻辑编程](../Page/逻辑编程.md "wikilink")，它常被称作“专家系统外壳”。近年来，[智能代理系统也在相似的能力上发展起来](../Page/智能代理.md "wikilink")。

与一个程序中有一个只运行一次的循环的[指令式編程语言不同](../Page/指令式編程.md "wikilink")，Jess使用的[宣告式编程通过一个名为](../Page/宣告式编程.md "wikilink")“模式匹配”的过程连续的对一个事实的集合运用一系列规则。规则可以修改事实集合，或者运行任何Java代码。

Jess可以被用来构建使用规则定义形式的知识来推倒结论和推论的[Java
Servlet](../Page/Java_Servlet.md "wikilink")、[EJB](../Page/EJB.md "wikilink")、[Applet和应用程序](../Page/Applet.md "wikilink")。因为不同的规则匹配不同的输入，所以有了一些有效的通用匹配算法。Jess规则引擎使用。
...
## 参见
  ...
  - [JSR-94](../Page/JSR-94.md "wikilink")

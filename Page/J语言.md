...
Hui）（出生于[香港](../Page/香港.md "wikilink")，后前往[加拿大](../Page/加拿大.md "wikilink")）於二十世纪九十年代初發明的一种[程序设计语言](../Page/程序设计语言.md "wikilink")，是[APL语言](../Page/APL语言.md "wikilink")（亦是由艾佛森所創）、、語言的繼承者。

為了避免APL使用特別的字集而遇到的問題，J只需基本的[ASCII字集](../Page/ASCII.md "wikilink")，多用點號和冒號來擴展現有基本字元的意義。

作為一個[陣列編程語言](../Page/陣列編程語言.md "wikilink")，J非常簡潔和強大，在[數學和](../Page/數學.md "wikilink")[统计学程式設計上十分有效](../Page/统计学.md "wikilink")，特別是[矩陣分析的能力](../Page/矩陣.md "wikilink")。

如同原本的FP/FL程式語言，J透過它編程的特色，支援[函數級別編程](../Page/函數級別編程.md "wikilink")。

J並非[馮諾曼程式語言](../Page/馮諾曼程式語言.md "wikilink")，卻能容許程式員使用馮諾曼編程風格。

## 例子

J是極強大的語言，它的程式可以非常簡潔，但以人類的b
常用溝通語言而言通常會變得像密碼。以下是個[快速排序的](../Page/快速排序.md "wikilink")[單行小程kl式](../Page/單行小程kl式.md "wikilink")：
...
| nowrap | `_`負號／*[無限](../Page/無限.md "wikilink")*   | nowrap | `_.`*未定數*                              | nowrap | `_:`無限                                       |
| nowrap |                                          |                                                 |                                                       |
...
| nowrap | `T.`**Taylor近似**                         | nowrap | `u. v.`動詞引數代號                          | nowrap | `u:`[Unicode](../Page/Unicode.md "wikilink") |

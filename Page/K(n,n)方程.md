...
|                                                                                                                                                                                  |                                                                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [K(n,n)_equation_traveling_wave_plot_1.gif](https://zh.wikipedia.org/wiki/File:K\(n,n\)_equation_traveling_wave_plot_1.gif "fig:K(n,n)_equation_traveling_wave_plot_1.gif") | [K(n,n)_equation_traveling_wave_plot_2.gif](https://zh.wikipedia.org/wiki/File:K\(n,n\)_equation_traveling_wave_plot_2.gif "fig:K(n,n)_equation_traveling_wave_plot_2.gif") |
...
1.  Andrei D. Polyanin,Valentin F. Zaitsev, HANDBOOK OF NONLINEAR PARTIAL DIFFERENTIAL EQUATIONS,（《非线性偏微分方程手册》） SECOND EDITION p891 CRC PRESS
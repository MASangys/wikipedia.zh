...
KDELibs包含下列的函式庫和框架：
  ...
  - Interfaces
  - Kate : Kate 編輯器組件，能被嵌入於多種其他應用程序作為預設編輯器元件使用。KDELibs中的 Kate只是一個 KParts
    組件和若干基本外掛程式的封裝，但還不是一個完整可用的程序。
...
## 外部連結
  ...
  - [KDE
    開發](https://web.archive.org/web/20100603061821/http://techbase.kde.org/Development_\(zh_TW\))
  - [KDE
    開發](https://web.archive.org/web/20090825152358/http://techbase.kde.org/Development_\(zh_CN\))

...
[Kde42default.png](https://zh.wikipedia.org/wiki/File:Kde42default.png "fig:Kde42default.png")
**Plasma Desktop**是第一個開發的工作空間，並在 KDE SC 4.2 時成熟。目標是在桌面電腦和筆記型電腦。\[5\]
{{-}}
...
**Plasma Netbook**是第二個工作空間。 它的目標是在小筆電，也可以用平板電腦。第一個穩定版本在 KDE SC 4.4。
{{-}}
...
<File:Plasma-mobile> (Tokamak 4).png|First technology preview of *Plasma
...
## 外部連結
  ...
  - [Plasma
    使用教學](http://userbase.kde.org/Plasma/Introduction_to_Plasma_\(zh_TW\))
  - [Plasma
    使用教學](https://web.archive.org/web/20100706041200/http://userbase.kde.org/Plasma/Introduction_to_Plasma_\(zh_CN\))
  - [Plasma
    開發wiki](https://web.archive.org/web/20120505005558/http://techbase.kde.org/Projects/Plasma_\(zh_TW\))
  - [Plasma
    開發wiki](https://web.archive.org/web/20081204054204/http://techbase.kde.org/Projects/Plasma_%28zh_CN%29)

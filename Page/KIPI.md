...
照片管理程序，如“digiKam”、“KPhotoAlbum”、“GwenView”和“ShowImg”通過使用插件就可以擴展它的功能。插件可以讓用戶使用幾乎任何方式操縱圖像文件。透過編寫一個小插件更容易添加主體應用程序的能力，而不需要修改主體應用程序的核心。許多有價值的插件的[C++源代碼](../Page/C++.md "wikilink")，只有到100-200行左右。
...
## 外掛
  ...
  - **Acquire Images**：提供工具來捕捉新的圖像和保存他們到相簿。
  - **Batch process**
  - **CD archiving**：一個備份相簿的工具。
  - **Calendar**：一種從相簿創建日曆的工具。
  - **Find duplicates**：一種在相簿中查找重複的照片的工具。
  - **Flickr export**：提供用戶上傳照片到Flickr網站。
  - **GPS Sync**
  - **Gallery export**
  - **HTML export**
  - **Ipod export**
...
## 外部連結
  ...
  - [KIPI Plugins official homepage](http://www.kipi-plugins.org/)

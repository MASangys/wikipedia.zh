...
### 個人電腦
  ...
  - **KKBOX
    Windows**－適用於運行[Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")（[Windows
    XP以後版本](../Page/Windows_XP.md "wikilink")）的電腦。
  - **KKBOX Mac OS**－適用於運行[Mac OS X
    10.10或以上的電腦](https://zh.wikipedia.org/wiki/Mac_OS_X_v10.10 "wikilink")。
...
### 行動裝置
  ...
  - **KKBOX Windows Phone**－適用於[Windows
    ...
    Phone 8](../Page/Windows_Phone_8.md "wikilink")、[Windows Phone

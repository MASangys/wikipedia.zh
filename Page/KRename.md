...
## 特性
  ...
  - 可自如地拼写：大写、小写，或首字母大写
  - 可向文件名添加前缀或后缀
  - 可搜索/替换文件名的一部分（支持[正则表达式](../Page/正则表达式.md "wikilink")）
  - 可为文件名添加序号（支持起始、步进、偏移量等功能）
  - 可改变文件的所有者和权限
  - 可改变改变文件的获取和修改的时间
  - 可将重命名后的文件转移至新创建的目录（每个目录的文件及该目录编号的格式可定义）
  - 可提取的 MP3/ogg 文件的 [ID3](../Page/ID3.md "wikilink") 信息
  - 可提取图像文件的 [Exif](../Page/EXIF.md "wikilink") 信息
  - 可向文件名添加目前的日期和时间
  - 可更改文件的扩展名字
  - 可撤消命名

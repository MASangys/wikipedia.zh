...
KV2是帝王谷裏其中一個少數留下古代平面圖的陵墓，其中一幅繪於[紙莎草上的平面草圖最為有名和完整](../Page/紙莎草.md "wikilink")，目前存放於都靈的埃及博物館。\[6\]另一幅則是刻於一塊陶器瓦片上，刻劃了外部門廊的細節，由艾爾頓於陵墓入口的瓦礫中發現。二者均顯示了陵墓已經完工：紙莎草的平面圖示出建成的陵墓比原本的設計簡略，而陶器瓦片則展示出陵墓的門是閂上的。\[7\]

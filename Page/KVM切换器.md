...
「IP KVM」是基于KVM Over
IP的产品概念的中国式的常规称呼，主要的应用概念就是：通过[IP技术](https://zh.wikipedia.org/wiki/IP技术 "wikilink")（[LAN](https://zh.wikipedia.org/wiki/LAN "wikilink")、[WAN](https://zh.wikipedia.org/wiki/WAN "wikilink")）的[通讯技术](https://zh.wikipedia.org/wiki/通讯 "wikilink")，实现对[键盘](https://zh.wikipedia.org/wiki/键盘 "wikilink")、显示图像、[鼠标的远程操作和控制](../Page/鼠标.md "wikilink")。

一般来说，IP
KVM基本等同于目前KVM的基本分类，如[多用户](https://zh.wikipedia.org/wiki/多用户 "wikilink")，普通线缆连接或CAT5线缆连接，但是就其IP
...
## 参见
  ...
  - [Synergy+](https://zh.wikipedia.org/wiki/Synergy+ "wikilink")
    类似用途的软件,需要配备多台显示器

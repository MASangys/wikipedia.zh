...
Keycloak的众多功能包括：
  ...
  -
  - [单点登录](https://zh.wikipedia.org/wiki/单点登录 "wikilink")/登出，在同一Realm中可跨所有应用（Realm是Keycloak中定义的概念）

  - [双重认证](https://zh.wikipedia.org/wiki/双重认证 "wikilink")
...
## 参见
  ...
  - [单点登录](https://zh.wikipedia.org/wiki/单点登录 "wikilink")

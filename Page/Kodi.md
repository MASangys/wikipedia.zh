...
[Mac OS
X](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")、[iOS和](https://zh.wikipedia.org/wiki/iOS "wikilink")[Microsoft
Windows操作系统的原生版](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")。\[17\]
单机版XBMC有 XBMCbuntu。\[18\]\[19\]\[20\]
...
XBMC
的源代码以[GNU通用公共许可协议授权分发](https://zh.wikipedia.org/wiki/GNU通用公共许可协议 "wikilink"),\[37\]
它由免税的非营利组织XBMC基金会赞助, 它由来自全球的自由软件爱好者开发。\[38\]\[39\] XBMC 原始项目不再支持 Xbox,
但是第三方开发者的项目“XBMC4Xbox”仍然对Xbox提供服务。XBMC
流行的一个原因是第三方插件提供了很多盗版内容，虽然也有正版内容提供者的插件。基金会禁止在他们的论坛上讨论第三方插件，因此目前大家主要在[XBMC
HUB](https://web.archive.org/web/20140306170602/http://www.xbmchub.com/blog/)上讨论插件开发。

### 截图

<File:xbmc_911.png>| "Confluence" 皮肤主银幕。
<File:Screenshot000.png>|"PM3.HD" 皮肤主银幕。 |MC360 皮肤

### 硬件要求

Kodi要求[图形处理器支持](https://zh.wikipedia.org/wiki/图形处理器 "wikilink")[3D](../Page/三维计算机图形.md "wikilink")。现代电脑大多带有3D图形处理器，一些机顶盒也有，XBMC的设计也很节约资源。它可以运行在性能较弱的（参照[英特尔Atom](https://zh.wikipedia.org/wiki/英特尔Atom "wikilink")）的[OpenGL
1.3](../Page/OpenGL.md "wikilink")
(支持[GLSL](../Page/GLSL.md "wikilink"))、 [OpenGL ES
2.0](../Page/OpenGL_ES.md "wikilink") 或 [Direct3D (DirectX)
...
32.
33.
34. <http://code.google.com/p/xbmc-addons/> XBMC-Addons on Google Code
    (Addon plugins for XBMC)
...
43. <http://liliputing.com/2013/05/xbmc-running-in-linux-on-a-tv-box-with-an-amlogic-am8726-mx-chip-video.html>

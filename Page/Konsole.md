**Konsole**是一个自由开源的[虚拟终端](../Page/虚拟终端.md "wikilink")，它是[KDE](../Page/KDE.md "wikilink")的一部分。Konsole最初是由Lars
Doelle所攥寫的。
...
[Category:自由终端模拟器](https://zh.wikipedia.org/wiki/Category:自由终端模拟器 "wikilink")

**Krita**是一个[自由和开源的](../Page/自由及开放源代码软件.md "wikilink")[位图图像编辑器](../Page/位图图像编辑器.md "wikilink")。它针对数字绘画和动画创作特化，提供包括低干扰用户界面、OpenGL加速画布、色彩管理、功能强大的笔刷引擎、非破坏性图层和蒙版、图层分组、向量图形支持和可切换界面预设等在内的一系列特色功能，并同时支持[Windows](../Page/Microsoft_Windows.md "wikilink")、[Linux和](../Page/Linux.md "wikilink")[MacOS等平台](../Page/MacOS.md "wikilink")。

## 名字

Krita这个词有来自多种不同文化的内涵。在[瑞典语中krita的含义是蜡笔](../Page/瑞典语.md "wikilink")，rita则是绘画的动词；而在古印度经典[摩诃婆罗多中Krita的含义则是指代完美无瑕的状态](../Page/摩诃婆罗多.md "wikilink")。\[1\]

## 历史

Krita的开发可以一直追溯到1998年。当时[KDE的创始人](../Page/KDE.md "wikilink")[Matthias
Ettrich在Linux](../Page/Matthias_Ettrich.md "wikilink")
Kongress大会上展示了一个为[GIMP编写的](../Page/GIMP.md "wikilink")[Qt界面](../Page/Qt.md "wikilink")。他提出的关于构建一个基于Qt的图像编辑器的想法后来在KImage项目上开始实施，并作为[KOffice套件的一部分由Michael](../Page/KOffice.md "wikilink")
Koch维护。Matthias
Elter则给该项目提出了用[Cobra语言](../Page/CORBA.md "wikilink")，围绕[ImageMagick构建该软件的构想](../Page/ImageMagick.md "wikilink")。然而KImage在市场上已经被注册了商标，为此该项目进行了数次更名，经过KImageShop、Krayon后，终于在2002年选定了Krita作为项目的名称并沿用至今。在2004年到2009年间，Krita是被作为一个和[Photoshop](../Page/Adobe_Photoshop.md "wikilink")、GIMP类似的通用图像处理软件来开发的。\[2\]
...
Studio，面向电影工业和特效工作室。自2014年起他们通过[Kickstarter来为开发](../Page/Kickstarter.md "wikilink")[众筹资金](../Page/众筹.md "wikilink")。
...
Krita使用[OpenGL来为画布进行加速以提高显示质量和速度](../Page/OpenGL.md "wikilink")：
...
Krita有完整的[色彩管理功能](../Page/色彩管理.md "wikilink")：
...
Krita的[吉祥物是电子松鼠Kiki](../Page/吉祥物.md "wikilink")（Kiki the Cyber
Squirrel），她是一位拟人化的机械[松鼠卡通角色](../Page/松鼠.md "wikilink")，设计者是来自中国的钛山（Tyson
Tan）。Krita社区之所以选择了一只松鼠作为吉祥物，是因为在[阿尔巴尼亚语中Krita的意思是松鼠](../Page/阿尔巴尼亚语.md "wikilink")。Kiki的首版设计在2012年在KDE社区论坛上投稿，被印在Krita

**K函数**是[hyper阶乘函数在](../Page/階乘#hyper阶乘.md "wikilink")[复数上的扩展](../Page/复数_\(数学\).md "wikilink")，如同[Γ函数是](../Page/Γ函数.md "wikilink")[阶乘函数在复数上的扩展](../Page/阶乘.md "wikilink")。
K函数的定义为：
...
其中，\(\zeta^\prime(z)\)表示[黎曼ζ函數的](../Page/黎曼ζ函數.md "wikilink")[导函数](../Page/导函数.md "wikilink")，而\(\zeta^\prime(a,z)\)则表示[赫维茨ζ函数的导函数](../Page/赫维茨ζ函数.md "wikilink")，即
...
或者使用[广义多伽玛函数表示为](../Page/广义多伽玛函数.md "wikilink")：\[2\]

\[K(z)=A e^{\psi(-2,z)+\frac{z^2-z}{2}}.\]
其中A表示[格莱舍常数](../Page/格莱舍常数.md "wikilink")（Glaisher
constant）。
...
前几项为：1、4、108、27648、86400000、4031078400000、3319766398771200000……([OEIS中的](../Page/OEIS.md "wikilink")[第A002109号](https://web.archive.org/web/20100114020316/http://www.research.att.com/~njas/sequences/A002109)数列).

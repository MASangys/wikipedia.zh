...
***k*空間**是尋常[空間](https://zh.wikipedia.org/wiki/空間 "wikilink")\(\mathbb{R}^n\)在[傅立葉變換下的對偶空間](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")，主要應用在[磁振造影的成像分析](https://zh.wikipedia.org/wiki/磁振造影 "wikilink")，其他如[磁振造影中的](https://zh.wikipedia.org/wiki/磁振造影 "wikilink")[射頻波形設計](../Page/射頻.md "wikilink")，以及[量子計算中的初始態準備亦用到](https://zh.wikipedia.org/wiki/量子計算 "wikilink")*k*空間的概念。***k***和出現在[波動數學中的](../Page/波.md "wikilink")[波數相應](../Page/波數.md "wikilink")，可說都是「[空間頻率](https://zh.wikipedia.org/wiki/頻率 "wikilink")」的概念。

## 磁振造影成像分析

*本段落涉及[磁振造影中](https://zh.wikipedia.org/wiki/磁振造影 "wikilink")[造影階段](https://zh.wikipedia.org/wiki/造影 "wikilink")，對於資料取得與重建的分析；可稱為「造影k空間」（imaging
k-space）。*
...
*本段落涉及[磁振造影中](https://zh.wikipedia.org/wiki/磁振造影 "wikilink")[激發階段](https://zh.wikipedia.org/wiki/激發 "wikilink")，對於[射頻與](../Page/射頻.md "wikilink")[梯度磁場共同設計的分析](https://zh.wikipedia.org/wiki/梯度磁場 "wikilink")；可稱為「激發k空間」（excitation
k-space）。*

磁振造影在某些場合中，需要對某特定體積進行射頻激發，然而一般的射頻激發方法可能又會遇上[疊影問題](https://zh.wikipedia.org/wiki/疊影 "wikilink")，即激发的区域（Excited
...
此外，這項方法也可用於設計對空間以及對[共振頻率同時做選擇性激發的射頻與梯度磁場](../Page/共振.md "wikilink")。應用場合包括了水影像與脂肪影像的個別取得，或者[磁振頻譜影像](https://zh.wikipedia.org/wiki/磁振頻譜影像 "wikilink")（MRSI）方面的應用。

...
**K线**（）又稱“-{zh-hans:阴阳烛;zh-hk:K線;zh-tw:陰陽燭;}-”、「蠟燭線」，是反映[价格](../Page/价格.md "wikilink")走势的一种图线，其特色在於一個線段內記錄了多項訊息，相當易讀易懂且實用有效，广泛用于[股票](../Page/股票.md "wikilink")、[期貨](https://zh.wikipedia.org/wiki/期貨 "wikilink")、[貴金屬](../Page/貴金屬.md "wikilink")、[数字货币等行情的](https://zh.wikipedia.org/wiki/数字货币 "wikilink")[技术分析](../Page/技术分析.md "wikilink")，称为**K线分析**。

## 由來

据传K线為[日本](../Page/日本.md "wikilink")[江户时代](../Page/江户时代.md "wikilink")的[白米商人](https://zh.wikipedia.org/wiki/白米 "wikilink")[本間宗久所发明](https://zh.wikipedia.org/wiki/本間宗久 "wikilink")，用來記錄每日的米市行情，研析[期貨市場](https://zh.wikipedia.org/wiki/期貨 "wikilink")。日语中K线称为「蠟燭足（）」。

蠟燭線的英文是candlestick chart，日文[片假名](../Page/片假名.md "wikilink")為キャンドル スティック（**K**YANDORU SUTIKKU），故中文也稱之為**K**線。

## 說明

K線可分「陽線」、「陰線」和「中立線」三種，**陽線**代表[收盘价大於](https://zh.wikipedia.org/wiki/收盘价 "wikilink")[开盘价](https://zh.wikipedia.org/wiki/开盘价 "wikilink")，**陰線**代表开盘价大於收盘价，**中立線**則代表开盘价等於收盘价。

最早陽線以[紅色表示](https://zh.wikipedia.org/wiki/紅色 "wikilink")，陰線則以[黑色](../Page/黑色.md "wikilink")表示，但由於[彩色印刷](../Page/彩色印刷.md "wikilink")成本高，所以後來陽線常改以[白色](../Page/白色.md "wikilink")空心方塊表示。在中国大陆、台湾，以及日本和韩国，为了配合傳統習慣，陽線以紅色表示，陰線以[綠色](../Page/綠色.md "wikilink")表示，即是紅升綠跌。至於中立線的顏色則不一而足，難以卒論，但以異於其他兩線為原則。在香港和歐美，習慣則正好相反，陰線以紅色表示，陽線以綠色表示，綠升紅跌。
...
將某段[時間內的各單位時間下的K線綜合起來便可繪出](https://zh.wikipedia.org/wiki/時間 "wikilink")「K線圖」，其橫軸為[時間](https://zh.wikipedia.org/wiki/時間 "wikilink")，縱軸為[價格](https://zh.wikipedia.org/wiki/價格 "wikilink")。

## 美國線

美國線（，**OHLC** chart），以豎立的線條表現股價變化，也可以呈現「開盤價、最高價、最低價、收盤價」，豎線呈現最高價和最低價間的價差間距，左側橫線代表開盤價，右側橫線代表收盤價，繪製上較K線簡單。另有一種美國線僅呈現「最高價、最低價、收盤價」（**HLC**）三項訊息。

## 另見

  - [美國線](https://zh.wikipedia.org/wiki/OHLC_chart "wikilink")

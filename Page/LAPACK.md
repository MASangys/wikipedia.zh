...
binding也是可选的](https://zh.wikipedia.org/wiki/language_binding "wikilink"):
  ...
  - [LACAML](https://web.archive.org/web/20080818035500/http://www.ocaml.info/home/ocaml_sources.html#lacaml)
    for [OCaml](../Page/OCaml.md "wikilink")
...
## 外部链接
  ...
  - [NEW LAPACK++ Homepage (versions 1.9 and
    above)](http://lapackpp.sourceforge.net/) on Sourceforge.net
  - [Sun Performance
    Library](http://developers.sun.com/prodtech/cc/perflib_index.html)
    optimized LAPACK for Solaris OS on SPARC/x86/x64 and Linux
  - [OS Reviews article on
    LAPACK](http://www.osreviews.net/reviews/sci/lapack)
  - [PLAPACK](http://www.cs.utexas.edu/~plapack/)
  - [How to use LAPACK with
    C](http://www.physics.oregonstate.edu/~rubin/nacphy/lapack/cprogp.html)

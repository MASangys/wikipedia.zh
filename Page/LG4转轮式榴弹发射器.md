> 本文内容由[LG4转轮式榴弹发射器](https://zh.wikipedia.org/wiki/LG4转轮式榴弹发射器)转换而来。
...
目前獲多国（包括[美国](../Page/美国.md "wikilink")）採用的[南非](https://zh.wikipedia.org/wiki/南非 "wikilink")[-{米}-尔科姆MGL系列采用火葯燃气控制棘齿](../Page/米尔科姆转轮连发式榴弹发射器.md "wikilink")、卷簧驱动[弹巢转动式机构](https://zh.wikipedia.org/wiki/弹巢 "wikilink")，连可谓改為发射[40毫米無彈殼榴彈的MGL的](https://zh.wikipedia.org/wiki/40毫米無彈殼榴彈 "wikilink")[俄罗斯](../Page/俄罗斯.md "wikilink")[RG-6亦是參考了其而研发的](../Page/RG-6轉輪式榴彈發射器.md "wikilink")。而2006年，[中国兵器工业第208研究所曾研制出一款](https://zh.wikipedia.org/wiki/中国兵器工业第208研究所 "wikilink")[CS/LW1型转轮式防暴榴弹发射器](https://zh.wikipedia.org/wiki/CS/LW1型转轮式防暴榴弹发射器 "wikilink")（前称：38毫米转轮式警用防暴榴弹发射器），但采用的是非自动[霰彈槍常用的](https://zh.wikipedia.org/wiki/霰彈槍 "wikilink")[泵动式原理](https://zh.wikipedia.org/wiki/泵动式 "wikilink")，藉由推拉[前握把以驱动弹巢旋转供弹](../Page/輔助握把.md "wikilink")。

两种操作机构虽然有著毋庸置疑的可靠性，但在使用操作上却都各有缺憾。前者需使卷簧储存著足以让弹巢旋转一周的[勢能](https://zh.wikipedia.org/wiki/勢能 "wikilink")，射击前必须手动预压发条簧，而且弹巢每旋转一次都会撞击棘齿，造成发射器的绕身管轴线翻转以及弹巢定位槽和棘齿变形；后者的前握把要射击时稳固、供弹时顺畅，因而令操作复杂，而紧握前握把的手臂承担着一部分发射器重量，推拉前握把并不轻松，还有採用泵动式意味著受动作幅度大、射频不高而失去了[射速](https://zh.wikipedia.org/wiki/射速 "wikilink")，这难以为习惯南非-{米}-尔科姆MGL操作的广大用户所接受。

面对国际上众多转轮式榴弹发射器已步入成熟的竞争态势，湖南兵器轻武器研究所充分调查、研究目前中国内外各种转轮式榴弹发射器以后，很快确定了突破口，并且[研发出LG](../Page/研究開發.md "wikilink")4，再创转轮式榴弹发射器转动机构先河。
...
LG4的闭锁机构比南非MGL的横摆式闭锁机构或CS/LW1转轮式防暴榴弹发射器的中折式闭锁机构结构要新颖、安全性更高、操作更简捷。

### 其它结构

#### 联动式拋壳机构

除了转动机构为提高LG4战斗射速做出了巨大贡献，联动式拋壳机构也对于拋壳动作有重大協助。打开膛室以后，在后盖板的联动作用下，拋壳器会将弹巢内的空弹壳或剩余弹药预先抽出，只需要简单的倾倒即可将弹巢清空，这样使操作変得非常便捷。
...
LG4的联动式击发机已经在LG1、LG2型枪挂式榴弹发射器以上成熟的应用，其最显著的优点是可以避免发射器携行或跌落时的意外发火。
...
[前握把位置藉由导轨调節](../Page/輔助握把.md "wikilink")，扩大了功能的扩展空间；加上采用了[模块化设计](https://zh.wikipedia.org/wiki/模块化 "wikilink")，无需工具即可分解结合各组件，对于勤务维护非常有利。

### 弹药

LG4可以发射中国內外的各种[40×46毫米系列低速榴彈](../Page/40毫米榴彈.md "wikilink")，包括LG系列的杀伤弹、破甲杀伤弹、训练弹、催泪弹、标识弹等，可以直射和曲射。其中，杀伤弹杀伤威力大，最大可靠作用角达60。配用低速杀伤弹时，可用于杀伤暴露及隐蔽的有生目标。而破甲杀伤弹时，垂直穿深可达80毫米，可毁伤轻型装甲目标。两种弹药均比中国国外同类型弹药更先进，赋予了武器系统杀伤400米内集群有生目标、毁伤400米内的轻装甲目标等作战用途。配用弹葯改为催泪弹、爆震弹等[非致命性彈藥时](../Page/非致命性武器.md "wikilink")，则可用于控制和驱散聚众闹事的人群。
...
<!-- end list -->
  ...
  -   - 2011年第09期號：[中国LG4型40毫米转轮榴弹发射器](http://qkzz.net/article/facd8da1-9c6a-4835-a9d4-40d44f701b6d.htm)
      - 2016年第03期號：[LG4型40毫米转轮榴弹发射器](http://mall.cnki.net/magazine/Article/BQZS201603001.htm)

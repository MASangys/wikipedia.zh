...
Pay跨境支付，在韓國也將配合Line所屬的[Naver集團旗下Naver](https://zh.wikipedia.org/wiki/Naver "wikilink")
Pay共同提供跨境支付結算，[微信使用者](../Page/微信.md "wikilink")，也可透過掃描Line
Pay支付條碼使用微信支付。\[1\]

## 使用技術

LINE Pay使用[二維碼](../Page/二維碼.md "wikilink")(QR Code)或條碼(Bar
Code)傳輸帳戶訊息，以便將資金轉移至指定通路商或個人。 LINE
Pay要求在手機上設定指紋或6位數密碼鎖定。
用戶可以通過自銀行帳戶儲值金額至LINE
Pay一卡通或拍攝信用卡、簽帳卡照片、手動輸入信用卡、簽帳卡訊息以設定支付資金來源。
...
儲存於LINE Points的點數可用來折抵消費金額，1點相當於新台幣1元。於支付介面勾選Line Points即可於掃描支付時折抵消費金額。

#### LINE Points獲取方式

用中國信託LINE Pay信用卡或簽帳卡在實體店面刷卡，即可獲得LINE Points 1%的回饋。 目前2019/4/1\~5/31
大台北商圈有LINE Pay商家5%優惠，目前商圈推廣有內湖商圈、公館商圈、北投商圈、中山商圈，只要用LINE
Pay掃描店家的熊大立牌QR code都可以賺取點數唷 2019/6/30號以前，使用LINE Pay
一卡通帳戶付款，單筆50元的消費，也可以獲得10點LINE Points
更多合作店家資訊，都可以從LINE 錢包裡面的 LINE Pay ----\>合作通路
可以搜尋，也可以選擇附近，用地圖去看有哪些店是可以使用LINE Pay的店家唷
...
透過一些不定期的賺點活動，即可獲得LINE
Points點數。例如於指定線上或線下通路消費、瀏覽指定廣告或網頁、下載指定app、達成指定手遊任務等。
賺點活動可在LINE裡面的LINE錢包裡面的LINE Points功能中查詢。

#### 可使用LINE Points折抵消費金額的通路

請參見[LINE
Pay合作通路](https://event-web.line.me/ectw/article/%E2%9C%94%EF%B8%8F+LINE+Pay+%E5%90%88%E4%BD%9C%E9%80%9A%E8%B7%AF-XN9Orm)
...
儲值於LINE Pay一卡通內的金額，除可用於支付店家的消費金額外，另可通過轉帳功能即時轉帳給LINE好友。轉帳資金將會存入到收款好友的LINE
Pay一卡通帳戶中。 除主動轉帳外，另可向好友提出轉帳邀請，對方於收到轉帳邀請時，將可直接在確認金額後支付提出轉帳邀請人所要求支付的金額。
若需多人分擔一筆款項，可使用分擔付款功能，於輸入總金額與勾選需支付的好友後，即會向受勾選的好友提出每人需支付金額的轉帳邀請。
轉帳不需支付手續費。

### 搭乘[高雄捷運](../Page/高雄捷運.md "wikilink")

[高雄捷運支援使用LINE](../Page/高雄捷運.md "wikilink") Pay一卡通支付乘車票價，透過開啟LINE
Pay一卡通的二維碼畫面，掃描票閘的二維碼掃描器，即可付費進出站。於2018年1月1日至2018年12月31日間，透過LINE
Pay一卡通搭乘高雄捷運，可獲得回饋乘車金額1%的LINE Points點數。

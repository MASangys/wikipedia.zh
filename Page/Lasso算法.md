...
regression，也叫[吉洪诺夫正则化](https://zh.wikipedia.org/wiki/吉洪诺夫正则化 "wikilink")）和最佳子集选择的关系，Lasso系数[估计值](https://zh.wikipedia.org/wiki/估计值 "wikilink")(estimate)和[软阈值](https://zh.wikipedia.org/wiki/软阈值 "wikilink")（soft

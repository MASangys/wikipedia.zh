...
Leafpad的功能包括[字符编码](../Page/字符编码.md "wikilink")选项，自动字符编码检测，无限撤销/重做功能\[5\]，及拖放功能\[6\]。

与其它编辑器，如[Gedit](../Page/Gedit.md "wikilink")或[Kate](../Page/Kate.md "wikilink")相比，Leafpad[内存占用较小](https://zh.wikipedia.org/wiki/内存占用 "wikilink")\[7\]\[8\]。

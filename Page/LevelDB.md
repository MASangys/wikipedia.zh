...
## 特徵
  ...
  - 高性能 \[3\]
  - 簡單的體系結構：只支持API调用，不支持[SQL語言](../Page/SQL.md "wikilink")
...
2013年[Facebook基於LevelDB開發出RocksDB](../Page/Facebook.md "wikilink")，特別針對伺服器負載而優化。\[6\]
...
## 外部連結
  ...
  - [LevelDB
    開放原始碼計劃主頁](https://archive.is/20130426121503/http://leveldb.googlecode.com/)
...
2.  [LevelDB: A Fast Persistent Key-Value
    Store](http://google-opensource.blogspot.com/2011/07/leveldb-fast-persistent-key-value-store.html)
3.  [LevelDB
...
5.  [Source Checkout -
    LevelDB](http://code.google.com/p/leveldb/source/checkout)

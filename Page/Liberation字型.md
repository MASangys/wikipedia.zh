...
Windows與其](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")[辦公室套裝軟體上最常被使用的字型](../Page/Microsoft_Office.md "wikilink")，這套字型是為了要做為上述這些字型的[自由取代而生](../Page/自由及开放源代码软件.md "wikilink")\[1\]。
...
New的比較](https://zh.wikipedia.org/wiki/Courier#Courier_New "wikilink")

## Unicode覆蓋範圍

三種字型均支援IBM／Microsoft的[代码页](../Page/代码页.md "wikilink")437、737、775、850、852、855、857、860、861、863、865、866、869、1250、1251、1252、1253、1254、1257、麥金塔字元集、以及[Windows
OEM字元集](https://zh.wikipedia.org/wiki/代碼頁437 "wikilink")，這僅包含了拉丁文、希臘文、以及西里爾文字，遺漏了許多的書寫系統。因為它獨特的授權條款，使其難以延伸到其他的書寫系統\[2\]。之後因為Croscore這個同等設計字型取代了其他舊的字型，覆蓋Unicode的覆蓋範圍才由此變為可能。
...
截至2018年12月，Liberation字型2.00.0及以上版本由Chrome
OS字型複刻而來，使用[SIL開源字型授權](https://zh.wikipedia.org/wiki/SIL開源字型授權 "wikilink")，所有字型皆在GitHub開發。\[7\]
...
OS字型取代\[20\]——又被稱為[Croscore字型](../Page/Croscore字型.md "wikilink")：Arimo（無襯線體）、Cousine（等寬字型）、及Tinos（襯線體）——是同樣設計的較新版本，但直接由Ascender公司以[SIL開源字型授權提供](https://zh.wikipedia.org/wiki/SIL開源字型授權 "wikilink")。
...
## 參見
  ...
  -
  - [Linux
    Libertine](../Page/Linux_Libertine.md "wikilink")，另外一個支援OpenType特性的自由襯線字型
...
## 外部連結
  ...
  - [Liberation Sans
    Narrow字型檔](https://github.com/liberationfonts/liberation-sans-narrow/releases)
...
9.  [Bugzilla entries for the revised Liberation fonts included in
    Fedora 9](https://bugzilla.redhat.com/buglist.cgi?product=Fedora&version=rawhide&component=liberation-fonts),
    Red Hat Bugzilla – Bug List

10. [Bugzilla screenshot of the revised Liberation Mono font with dotted
    zero](https://bugzilla.redhat.com/attachment.cgi?id=292587), Red Hat
    Bugzilla - Bug \#252149 (Image)

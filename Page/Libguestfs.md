...
libguestfs同时也是可与C和[C++](../Page/C++.md "wikilink")管理程序关联，并为[Perl](../Page/Perl.md "wikilink")、[Python](../Page/Python.md "wikilink")、[Ruby](../Page/Ruby.md "wikilink")、[Java](../Page/Java.md "wikilink")、[OCaml](../Page/OCaml.md "wikilink")、[PHP](../Page/PHP.md "wikilink")、[Haskell](../Page/Haskell.md "wikilink")、[Erlang](../Page/Erlang.md "wikilink")、[Lua](../Page/Lua.md "wikilink")、[Go](../Page/Go.md "wikilink")lang 和[C\#相关联的](../Page/C♯.md "wikilink")[应用程序接口](../Page/应用程序接口.md "wikilink")。此接口可被壳层脚本调用或在命令行中直接运行。使用[FUSE](../Page/FUSE.md "wikilink")模块的情况下，客户机文件系统可通过使用`guestmount`命令挂载到宿主机上。\[3\]

[Linux内核](../Page/Linux内核.md "wikilink")的[基于内核的虚拟机](../Page/基于内核的虚拟机.md "wikilink")实现了libguestfs\[4\]。

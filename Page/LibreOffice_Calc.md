**LibreOffice Calc**（又稱**Calc**）
是[LibreOffice生產力軟體的項目之一](https://zh.wikipedia.org/wiki/LibreOffice "wikilink")。是與[Microsoft
Excel功能相當的試算表軟體](../Page/Microsoft_Excel.md "wikilink")，並可以開啟或儲存為[Microsoft
Excel的檔案格式](../Page/Microsoft_Excel.md "wikilink")，也可存為[.pdf格式](https://zh.wikipedia.org/wiki/PDF "wikilink")。

**LibreOffice試算表**通常會預設以[OpenDocument
...
與其他LibreOffice檔案一樣，「LibreOffice試算表」可跨平台運行。包含[Mac OS
X](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink"), [Microsoft
Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink"),
[Linux和](../Page/Linux.md "wikilink")[FreeBSD等](../Page/FreeBSD.md "wikilink")[作業系統](https://zh.wikipedia.org/wiki/作業系統 "wikilink")。

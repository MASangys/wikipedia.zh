...
遊戲操作是直向介面的，畫面中會有4\~5種Tsums從上落下堆積，玩家必須於手機的觸控熒幕上利用手指或觸控筆將相同三個或以上相同的Tsum連接以把它們清除，並在一分鐘的限時裡盡辦法清除最多的Tsums。隨著Tsums被清除，玩家在一次遊戲中清除四個或以上的Tsums以及連續連接次數（combo）越多就會獲得更高的分數。
...
進入遊戲前，有6款道具讓玩家於遊戲中使用以獲得高分數：
  ...
  - （5→4）：此道具可讓通常遊戲中會出現的5款的Tsum減少至4款。

...
Linux核心從1996年開始就包含了二進制blob\[2\]。而清除二進制blob的工作則由[gNewSense在](https://zh.wikipedia.org/wiki/gNewSense "wikilink")2006年開始。2007年，BLAG有了更多的進展，Linux-libre就此誕生\[3\]\[4\]。Linux-libre是由(FSFLA)所開發，[自由软件基金会](../Page/自由软件基金会.md "wikilink")認可\[5\]，作為[自由軟體基金會認可的Linux發行版的一部份](https://zh.wikipedia.org/wiki/自由軟體基金會認可的Linux發行版 "wikilink")。它在2012年3月成為了GNU計畫的其中一個軟體包\[6\]，Alexandre
Oliva是此專案的維護者。
...
發行版的核心是編譯成用來[实时计算](../Page/实时计算.md "wikilink")的，可以讓多媒體剪輯及其他需要低延遲的工作得到更好的性能表現\[21\]。
[Trisquel](../Page/Trisquel.md "wikilink")與[Parabola

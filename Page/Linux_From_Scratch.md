...
:\*CLFS Embedded 一般用于极小系统以及嵌入式系统。为此，它使用[uclibc而不是一般LFS使用的](https://zh.wikipedia.org/wiki/uclibc "wikilink")[glibc](https://zh.wikipedia.org/wiki/glibc "wikilink")。
...
## 外部链接
  ...
  - [LinuxSir LFS论坛，链接已失效](https://web.archive.org/web/20080405084307/http://linuxsir.org/bbs/forum58.html)

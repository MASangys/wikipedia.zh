...
有三种方法来配置log4j：通过[.properties](../Page/.properties.md "wikilink")文件，通过[XML](../Page/XML.md "wikilink")文件，通过Java代码。通过上述任意方法，你可以定义log4j的三个主要组件：Logger、Appender和Layout。通过文件配置log4j，具有无需修改应用即可打开或关闭日志的好处。例如，应用程序可以在日志关闭的情况下运行，直到问题出现后，再日志功能可以简单地通过修改配置文件重新打开。

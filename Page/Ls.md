...
在[Unix和](https://zh.wikipedia.org/wiki/Unix "wikilink")[类Unix操作系统中都有](https://zh.wikipedia.org/wiki/类Unix "wikilink")[当前目录的概念](https://zh.wikipedia.org/wiki/当前目录 "wikilink")，也即程序目前在[目录树中的位置](../Page/目录_\(文件系统\).md "wikilink")。
...
## 参看
  ...
  - [chown](https://zh.wikipedia.org/wiki/chown "wikilink")：改变文件的拥有者。
  - [chgrp](https://zh.wikipedia.org/wiki/chgrp "wikilink")：改变文件的组
  - [du](https://zh.wikipedia.org/wiki/du "wikilink")：查看文件的大小。
  - [用户标识符](https://zh.wikipedia.org/wiki/用户标识符 "wikilink")
  - [组标识符](https://zh.wikipedia.org/wiki/组标识符 "wikilink")

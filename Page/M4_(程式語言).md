**m4**是一个通用的宏处理器，由[布萊恩·柯林漢](../Page/布萊恩·柯林漢.md "wikilink")和[丹尼斯·里奇](../Page/丹尼斯·里奇.md "wikilink")设计。m4是基于Ritchie早先为AP-3小型机开发的[m3](https://zh.wikipedia.org/wiki/m3 "wikilink")[宏处理器扩展的](https://zh.wikipedia.org/wiki/宏处理器 "wikilink")。
...
与大部分早先的宏处理器不同，m4并不面向任何计算机语言或自然语言；但从历史角度来说，它最初是为支持[Fortran](../Page/Fortran.md "wikilink")的方言[Ratfor而开发的](https://zh.wikipedia.org/wiki/Ratfor "wikilink")。此外，m4还是一种图灵完备的编程语言。
...
[GNU](../Page/GNU.md "wikilink")实现了一个m4版本；FreeBSD、NetBSD和OpenBSD也提供一个m4语言的独立实现版本；此外，[OpenSolaris](../Page/OpenSolaris.md "wikilink")的Heirloom项目开发工具中也包含了一个m4语言的自由版本。

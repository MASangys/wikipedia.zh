**MAME**
是一套設計給[個人電腦使用的軟體](https://zh.wikipedia.org/wiki/個人電腦 "wikilink")[應用程式](https://zh.wikipedia.org/wiki/應用程式 "wikilink")，其目標在於盡可能的忠實且精確地[模擬許多](https://zh.wikipedia.org/wiki/模擬器 "wikilink")[街機遊戲](https://zh.wikipedia.org/wiki/街機 "wikilink")，宗旨在於保存遊戲的歷史，並防止古老的遊戲被遺失或遺忘。程式名稱是由全名
...
0.137 版開始提供 [SDL](https://zh.wikipedia.org/wiki/SDL "wikilink") 跨平臺函式庫的
SDLMAME 原始碼（不提供執行檔）；其他非官方的衍生版有加入
[Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")
[圖形使用介面的](https://zh.wikipedia.org/wiki/GUI "wikilink")
MAMEUI，以及
[Unix-like](https://zh.wikipedia.org/wiki/Unix-like "wikilink") 系統的
XMAME、[Mac OS X](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink") 系統的
MacMAME。

根據 MAME 官方網站描述，第一個公眾 MAME 版本 (0.1)
是在1997年2月5日，由義大利[程式設計師](https://zh.wikipedia.org/wiki/程式設計師 "wikilink")
...
MAME
除了正式發行的版本之外，在開發團隊官方網站尚有階段性的發佈中間更新，這是介於現時官方正式版和未來正式版之間的最新更新。中間更新是以[原始碼差異部分的補綴文件形式發佈](https://zh.wikipedia.org/wiki/原始碼 "wikilink")，並未提供可執行的檔案，使用者必須自行編譯成[執行檔才能使用](https://zh.wikipedia.org/wiki/EXE "wikilink")，或是使用同版號的
MAME 衍生版本。
...
MAME
是免費的，其[原始碼也是免費的](https://zh.wikipedia.org/wiki/原始碼 "wikilink")，但在2016年3月更改授權許可前不允許銷售。

### 軟體授權

MAME
是公開原始碼的[免費軟體（Freeware）](../Page/免費軟體.md "wikilink")，雖然使用其軟體及原始碼完全免費，也可以重新分配，但卻不允許銷售，也不允許製成商業產品或是用於商業活動，故不能歸類為標準的[開放原始碼（Open
source）或](https://zh.wikipedia.org/wiki/開放原始碼 "wikilink")[自由軟體（Free
software）](https://zh.wikipedia.org/wiki/自由軟體 "wikilink")，因為在某些授權條例上是有所牴觸的，所有授權規範一切依照官方制定的
[MAME
...
即能以[原始碼或是](https://zh.wikipedia.org/wiki/原始碼 "wikilink")[執行檔的形式再次散佈](https://zh.wikipedia.org/wiki/EXE "wikilink")。但另外修改過的再次散佈版（衍生版本）必須包含完整的對應原始碼（類似
[Copyleft](../Page/Copyleft.md "wikilink")）。參考 [MAME
授權協議](http://www.mamedev.org/legal.html)。

MAME已於2015年5月開始更改其授權許可，至2016年3月止已改爲使用[BSD
license和](https://zh.wikipedia.org/wiki/BSD_license "wikilink")[GNU
GPL
v2+](https://zh.wikipedia.org/wiki/GNU_General_Public_License "wikilink")，成爲真正的[自由軟體](https://zh.wikipedia.org/wiki/自由軟體 "wikilink")。
...
1.  一般的 ROM 集合。將一個遊戲中所包含的全部吸出資料後，以壓縮方式存放於一個內定名稱的
    **[ZIP](https://zh.wikipedia.org/wiki/ZIP_\(文件格式\) "wikilink")**
...
3.  BIOS 的 ROM 集合，這是通用於標準化的街機系統（例如
    [NeoGeo](https://zh.wikipedia.org/wiki/NEOGEO "wikilink")），主要用於啟動硬體，然後交由遊戲軟體接管系統。

### ROM 取得管道

1.  如果擁有實際的街機遊戲基版及
    [EPROM](https://zh.wikipedia.org/wiki/EPROM "wikilink") 吸出工具，可自行讀出這些
    ROM 檔案。
2.  部分像是 [Capcom](https://zh.wikipedia.org/wiki/Capcom "wikilink") 及
    [Atari](https://zh.wikipedia.org/wiki/Atari "wikilink")
    公司提供自家已淘汰的老舊街機遊戲 ROM 販賣服務，採個別販售或是包含於其他產品中。
...
### 官方網站
  ...
  - [MAME 開發團隊官方網站](http://www.mamedev.org) - 提供
    [Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")
    [命令列版本和中間更新](https://zh.wikipedia.org/wiki/命令列 "wikilink")
  - [SDLMAME 官方原始碼](http://mamedev.org/release.html) - 官方提供的 SDLMAME
    原始碼，採用 [SDL](https://zh.wikipedia.org/wiki/SDL "wikilink")
    跨平臺多媒體函式庫
...
### 衍生版本
  ...
  - [MAMEUI 官方網站](http://www.mameui.info/) -
    [Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")
    [圖形使用介面的官方授權改版](https://zh.wikipedia.org/wiki/GUI "wikilink")
  - [MAME Plus\!](https://zh.wikipedia.org/wiki/MAME_Plus! "wikilink") -
    Windows 圖形使用介面的多國語言版本
  - [XMAME](http://freshmeat.net/projects/xmame/) -
    [Unix-like](https://zh.wikipedia.org/wiki/Unix-like "wikilink") 版本
  - [MacMAME](http://www.macmame.org/) - [Mac
    OS](https://zh.wikipedia.org/wiki/Mac_OS "wikilink")（[麥金塔](../Page/麥金塔.md "wikilink")）版本

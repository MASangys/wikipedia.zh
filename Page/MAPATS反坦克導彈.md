...
MAPATS是一款半自動武器系統，生產商定位它可被用以擊破各種類型的目標（[装甲车](../Page/装甲车.md "wikilink")、工程和防禦結構）。能夠進行全天候操作，而直到導彈撞擊目標以前，射手必須將其持續指向目標。\[2\]\[3\]1984年，MAPATS首度亮相，而它並無拖尾，導彈與系統以無線化的系統相互作用；因此，它與線導式反坦克导弹不同之處，在於可從水面以上對海上目標或從海上對陸地目標進行射擊。其發射器的仰角可達＋30[°](https://zh.wikipedia.org/wiki/度_\(角\) "wikilink")，必要時也可利用時以打擊空中目標。\[4\]從外部看，MAPATS的外觀與拖式二型（TOW-2）反坦克導彈非常相似。
...
[MAPATS_operators.png](https://zh.wikipedia.org/wiki/File:MAPATS_operators.png "fig:MAPATS_operators.png")

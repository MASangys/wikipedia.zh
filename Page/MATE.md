**MATE**，为一[桌面环境](../Page/桌面环境.md "wikilink")，由已經停止官方维护的
[GNOME](../Page/GNOME.md "wikilink") 2 源代码衍生而来。MATE
得名于南美植物[巴拉圭冬青](../Page/巴拉圭冬青.md "wikilink")（yerba
mate）\[1\]。由于 GNOME 3 在界面上的激进变动，导致诸多批评，因而许多人决定创建一个 GNOME 的衍生桌面环境，维持
GNOME 2 的传统风格。更名是為了避免與 GNOME 3 的組成元件產生衝突。
...
Linux](../Page/Arch_Linux.md "wikilink") 的部份使用者發起的\[3\]\[4\]。
...
Caja 加入了復原／取消復原\[5\] 以及比較檔案取代前後的不同的新功能\[6\] 。MATE 1.6
移除了一些過時的函式庫\[7\]。MATE 1.18 已全部移植至GTK3+。\[8\]

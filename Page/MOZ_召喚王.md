...
每個卡組有5張召喚師卡和50張召喚卡，共55張。對戰時，每回合雙方用一張召喚師，根據召喚師的速度各自先後召喚出3隻召喚獸和召喚出一張Help
卡，然後比較各自的總力量值來定輸贏。勝方可得到場上卡的數目的積分點，當積分點有50的一方便勝出遊戲。如果3隻召喚獸和Help
卡都是面向上和有一些規律，就完成了一個組合，較強的組合為勝，並可將取得的積分點數倍化。但在尼奧斯篇中，增加了兩款新卡，分別是F卡及占星術卡。而每個卡組可以放置0-5張F卡或5張（不能多於或少於5張）占星術卡。而兩款卡不能同時放入卡組。
...
<!-- end list -->
  ...
  - 「無效」卡：
      - 除了一些不能還原的效果外，這種SP 卡可以將對手所有特殊效果無效化。它在無效對方Help 卡的同時，就是將那Help
        卡反牌，即破壞了組合。
...
要完成組合，自己必須有3隻面向上的召喚獸和一張面向上的Help
卡，而且召喚獸的特性有以下的條件就完成。完成了組合可將該回合的積分點乘以一些倍數。以下的組合由弱至強來排列。
...
<!-- end list -->
  ...
  - 群雄組合：
      - 只有召喚師「奇拉拉」才可以直接完成此組合，或必須使用Help
        卡「群雄之魂」才可。達到以上條件的話，全部召喚獸的種族都是「[男](../Page/男性.md "wikilink")」就完成。（群雄組合與龍組合強度一樣。）
...
## 其他事項
  ...
  - [日本在推出此召喚王卡牌遊戲後](../Page/日本.md "wikilink")，就推出了《》，玩法和召喚王差不多，但模式卻不同了，不能互相混合對戰。

> 本文内容由[MOZ 召喚王米多羅篇遊戲卡列表](https://zh.wikipedia.org/wiki/MOZ_召喚王米多羅篇遊戲卡列表)转换而来。


**`MOZ``   ``召喚王米多羅篇`**`是`[`MOZ``   ``召喚王`](../Page/MOZ_召喚王.md "wikilink")` 遊戲卡的第四個篇章。在總共的5個篇章中，米多羅篇比較著重召喚師和召喚獸的屬性之間的關係。包含此篇章遊戲卡的擴張包有：炎之章、水之章和雷之章。`

...
此另一廣泛的MP4播放器影片格式，MTV（與[電視無關](../Page/音樂電視網.md "wikilink")），為一系列以512位元組組成在[MP3播放時顯示的無壓縮影像](../Page/MP3.md "wikilink")。\[7\]運作時，音訊會通過晶片的解碼器，同時顯示器的記憶體指示器會被調整成下一張圖而形成影片。雖然此方法會消耗大量的記憶體，但並不需要任何額外硬體設備供解碼。因此，運作解碼檔案時可以減少使用MP4播放器的空間。

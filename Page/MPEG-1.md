**MPEG-1**是[MPEG组织制定的第一个](../Page/MPEG.md "wikilink")[视频和](../Page/视频.md "wikilink")[音频有损压缩标准](https://zh.wikipedia.org/wiki/音频 "wikilink")，也是最早推出及应用在市场上的MPEG技术，其原来主要-{zh-hans:目标;zh-hant:目標}-是在[CD光盘上记录影像](../Page/CD.md "wikilink")，后来被广泛应用在[VCD光盘](../Page/VCD.md "wikilink")。[视频压缩算法于](https://zh.wikipedia.org/wiki/视频压缩 "wikilink")1990年定义完成。1992年底，MPEG-1正式被批准成为国际标准。

## MPEG-1概述

MPEG-1是为[CD](../Page/CD.md "wikilink")[光盘介质定制的视频和音频压缩格式](https://zh.wikipedia.org/wiki/光盘 "wikilink")。一张70分钟的CD光盘传输速率大约在1.4Mbps。而MPEG-1采用了块方式的[运动补偿](../Page/运动补偿.md "wikilink")、[离散余弦变换](../Page/离散余弦变换.md "wikilink")（[DCT](https://zh.wikipedia.org/wiki/DCT "wikilink")）、量化等技术，并为1.2Mbps传输速率进行了优化。MPEG-1随后被[Video
CD采用作为核心技术](https://zh.wikipedia.org/wiki/Video_CD "wikilink")。VCD的解析度只有约352×240，并使用固定的比特率（1.15Mbps），因此在播放快速动作的视频时，由于数据量不足，令压缩时[宏区块无法全面调整](https://zh.wikipedia.org/wiki/宏区块 "wikilink")，结果使视频画面出现模糊的方块。因此MPEG-1的输出质量大约和传统录像机[VCR相当](https://zh.wikipedia.org/wiki/video_cassette_recorder "wikilink")，这也许是[Video
CD在发达国家未获成功的原因](https://zh.wikipedia.org/wiki/Video_CD "wikilink")。MPEG-1音频分三代，其中最著名的第三代协议被称为MPEG-1
Layer
...
MPEG-1可以按照分层的概念来理解，一个MPEG-1视频序列，包含多个[GOP](https://zh.wikipedia.org/wiki/GOP "wikilink")，每个[GOP包含多个](https://zh.wikipedia.org/wiki/GOP "wikilink")[帧](../Page/帧.md "wikilink")，每个[帧包含多个](../Page/帧.md "wikilink")[slice](https://zh.wikipedia.org/wiki/slice "wikilink")。
...
[影格是MPEG](https://zh.wikipedia.org/wiki/影格 "wikilink")-1的一个重要基本元素，一个[影格就是一个完整的显示图像](https://zh.wikipedia.org/wiki/影格 "wikilink")。影格的种类有四种：
  ...
  - P-圖像／影格（預測編碼圖像，predictive coded
    picture）包含來自先前的I或P-畫格的差異資訊。编码时使用[运动补偿和](../Page/运动补偿.md "wikilink")[运动估计](https://zh.wikipedia.org/wiki/运动估计 "wikilink")，採用[前向估计](https://zh.wikipedia.org/wiki/前向估计 "wikilink")，参考之前的I-帧或者P-帧去預測該P格。
  - B-圖像／影格（前後預測編碼圖像，bidirectionally predictive coded
    pictures）包含來自先前和／或之後的I或P-畫格的差異資訊。编码也使用[运动补偿和](../Page/运动补偿.md "wikilink")[运动估计](https://zh.wikipedia.org/wiki/运动估计 "wikilink")，預估採用[前向估计](https://zh.wikipedia.org/wiki/前向估计 "wikilink")、[后向估计或是](https://zh.wikipedia.org/wiki/后向估计 "wikilink")[双向估计](https://zh.wikipedia.org/wiki/双向估计 "wikilink")，主要参考前面的或者后面的I格或者P格。

...
MacPaint是由蘋果工程師[比爾·阿特金森負責編寫的](https://zh.wikipedia.org/wiki/比爾·阿特金森 "wikilink")。\[6\]最初的MacPaint是由5,804行[Pascal](../Page/Pascal_\(程式語言\).md "wikilink")[原始碼所組成的](https://zh.wikipedia.org/wiki/原始碼 "wikilink")，外加2,738行[68000](https://zh.wikipedia.org/wiki/摩托羅拉_68000 "wikilink")[組合語言作增強之用](https://zh.wikipedia.org/wiki/組合語言 "wikilink")。\[7\]另外一位原麥金塔開發團隊成員[蘇珊·卡雷負責設計MacPaint的](https://zh.wikipedia.org/wiki/蘇珊·卡雷 "wikilink")[用戶介面](https://zh.wikipedia.org/wiki/用戶介面 "wikilink")。卡雷同時在MacPaint正式發行前擔任測試員。\[8\]

當用戶在屏幕上拉動圖像的時候會產生閃爍的現象。故此MacPaint用上兩組[數據緩衝器](https://zh.wikipedia.org/wiki/緩衝器 "wikilink")，以防止這一情況出現。\[9\]其中一組緩衝器儲存了文件中的現有[像素](../Page/像素.md "wikilink")，而另外一組則儲存了文件之前的像素。\[10\]第二組緩衝器也提供了MacPaint復原功能的基礎。在1983年4月，軟件的名稱由MacSketch正式改為MacPaint。\[11\]最初的MacPaint被設計成單文件介面。調色板和文件視窗的位置和大小是固定的，這和當時其他主流麥金塔軟件有很大的分別，因為其他軟件的視窗位置和大小是可以讓用家自行調整的。

除此之外，MacPaint最初並沒有[縮放功能](https://zh.wikipedia.org/wiki/縮放 "wikilink")，取而代之的是一個叫FatBits的特殊放大功能。FatBits用一個可按的白邊長方形來顯示每個像素，這種編輯模式最後成了日後[繪圖軟件所參考的標準](https://zh.wikipedia.org/wiki/繪圖軟件 "wikilink")。\[12\]MacPrint有一個叫「Goodies」的功能表，在該功能表下可以找到FatBits工具。這個功能表在之前釋出的版本是叫「Aids」（援助，輔助之意），但在1983年夏天的時候，鑑於公眾開始對[愛滋病](https://zh.wikipedia.org/wiki/愛滋病 "wikilink")（AIDS）有一定的認識的原故，就重新把功能表命名為「Goodies」。\[13\]
...
MacPaint的1.3版本的[原始碼已經向公眾釋出](https://zh.wikipedia.org/wiki/原始碼 "wikilink")，MacPaint和QuickDraw的原始碼都可經電腦歷史博物館的網址下載。\[25\]
...
| 版本  | 發行日期          | 發行資訊                       |
| --- | ------------- | -------------------------- |
| 1.0 | 1984年1月24日    | 初次發放，與System 1.0一併發放\[30\] |
| 1.3 | 1984年5月\[31\] | 與System 1.1一併發放\[32\]      |
| 1.4 | 1984年4月       | 與麥金塔512K一併發放               |
| 1.5 | 1985年4月       | 與System 2.0一併發放            |
| 2.0 | 1988年1月\[33\] | 最後的發放版本                    |
|     |               |                            |
...
## 外部連結
  ...
  - [MacPaint的演化](http://www.folklore.org/StoryView.py?story=MacPaint_Evolution.txt)
  - [復古麥金塔博物館](https://web.archive.org/web/20111211120155/http://www.d4.dion.ne.jp/~motohiko/macpaint.htm)

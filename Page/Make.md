...
目前虽有众多依赖关系检查工具，但是make是应用最广泛的一个。这要归功于它被包含在[Unix系统中](https://zh.wikipedia.org/wiki/Unix "wikilink")。\[1\][斯圖亞特·費爾德曼在](https://zh.wikipedia.org/wiki/斯圖亞特·費爾德曼 "wikilink")1977年在[贝尔实验室里制作了这个软件](../Page/贝尔实验室.md "wikilink")。\[2\]\[3\]\[4\]2003年，斯圖亞特·費爾德曼因发明了这样一个重要的工具而接受了[美国计算机协会](https://zh.wikipedia.org/wiki/美国计算机协会 "wikilink")（ACM）颁发的软件系统奖。\[5\]
...
廣泛應用於[微軟的](https://zh.wikipedia.org/wiki/微軟 "wikilink")[Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")，[微軟的nmake是](https://zh.wikipedia.org/wiki/微軟 "wikilink")
Visual Studio
随附的命令行工具，不要與來自[AT\&T和](../Page/AT&T.md "wikilink")[貝爾實驗室的Unix系統nmake混淆](https://zh.wikipedia.org/wiki/貝爾實驗室 "wikilink")。

**Mama**是一种[面向对象的](../Page/面向对象.md "wikilink")[编程语言](../Page/编程语言.md "wikilink")，是为了帮助年轻学生通过使用自己[母语的语言元素接触编程而设计的](../Page/母语.md "wikilink")。Mama编程语言适用于几种语言，并带有[LTR和](../Page/LTR.md "wikilink")[RTL语言指导支持](../Page/RTL.md "wikilink")。

新的Mama变种构建在[美國](../Page/美國.md "wikilink")[卡耐基梅隆大学的](../Page/卡耐基梅隆大学.md "wikilink")[Alice开发环境上](../Page/Alice_\(software\).md "wikilink")，支持3D舞台对象的脚本编程。这个新的Mama变种是为帮助年轻学生通过构建3D动画和游戏接触编程而设计的。

## 历史

Mama的开始版本 - 1.0, 1.1和1.2 -
提供简单的[整合的开发环境](../Page/整合的开发环境.md "wikilink")（IDE），其包含对标准元素的支持，例如带有[语法高亮的文本标记](../Page/语法高亮.md "wikilink")，编译器，调试器，输出窗口等。从1.5版本开始，Mama就整合了开源的Alice
IDE以支持拖放编程和3D动画。Mama通过Java实现。

当前版本1.5.4，有[英语和](../Page/英语.md "wikilink")[希伯来语两个版本](../Page/希伯来语.md "wikilink")，并且可以在[Microsoft窗口中运行](../Page/Microsoft.md "wikilink").

## 设计

产业编程语言为产品代码而设计的，因此引入了额外的复杂度。Mama仅仅是为教授编程概念，提供简单快捷的开发方法而设计的。语法错误会让刚开接触编程的学生感到很沮丧
-
Mama借助[3D模型在Alice上的变种中使用拖放模式创建](../Page/3D_computer_graphics.md "wikilink")[计算机动画](../Page/计算机动画.md "wikilink")。

Mama语言是一种简单的[面向对象的语言](../Page/object-oriented_programming.md "wikilink")，而Alice
IDE是[基于对象的](../Page/基于对象的.md "wikilink")。这就意味着，在使用Mama语言编写文本脚本时支持所有面向对象的元素（[继承](../Page/继承.md "wikilink")，[多形态](../Page/多形态.md "wikilink")，[原生编程](../Page/原生编程.md "wikilink")，[观察者模式风格的事件处理](../Page/观察者模式.md "wikilink")），使用拖放模式创建对象和方法是基于对象的
...
## 参见
  ...
  - [教育编程语言](../Page/教育编程语言.md "wikilink")
  - [可视化编程语言](../Page/可视化编程语言.md "wikilink")
  - [高级别的编程语言](../Page/高级别的编程语言.md "wikilink")

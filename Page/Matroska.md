...
1.  '''MKV '''（Matroska Video
    File）：[視訊檔](https://zh.wikipedia.org/wiki/視訊 "wikilink")，可以包含[音訊和](https://zh.wikipedia.org/wiki/音訊 "wikilink")[字幕](../Page/字幕.md "wikilink")；
2.  '''MKA '''（Matroska Audio
    File）：單一的音訊檔，可以有多條及多種類型的[音軌](https://zh.wikipedia.org/wiki/音軌 "wikilink")；
...
该项目发起于2002年12月6日\[1\]，[派生自](https://zh.wikipedia.org/wiki/复刻_\(软件工程\) "wikilink")[多媒體封裝格式](https://zh.wikipedia.org/wiki/多媒體封裝格式 "wikilink")（）。在此之前，MCF
的主开发者 Lasse Kärkkäinen 曾与 Steve Lhomme
就使用[可扩展二进制元语言](https://zh.wikipedia.org/wiki/可扩展二进制元语言 "wikilink")（）还是自己的二进制格式发生过争吵，Steve
...
采用 [EBML](https://zh.wikipedia.org/wiki/多媒體封裝格式 "wikilink") 使得 Matroska
的格式未来可以继续扩充。Matroska 团队曾在
[Doom9.org](https://zh.wikipedia.org/wiki/Doom9.org "wikilink")
等论坛上表达过他们的一些长远目标（以下「目标」并不代表现有特性）：\[6\]
  ...
  - 开发一系列[函数库](https://zh.wikipedia.org/wiki/库_\(计算机\) "wikilink")，以便别的开发者可以在他们的应用程序里添加
    Matroska 支持
...
Matroska最大的特點就是能容納多種不同類型的影像編碼、音頻編碼及字幕流，並且它能把非常高密的[RealMedia及](https://zh.wikipedia.org/wiki/RealMedia "wikilink")[QuickTime檔案也容納在内](../Page/QuickTime.md "wikilink")，同時將它們的音頻和影像重新組織起來，從而達到一個更好和鮮明的效果。
...
現時播放Matroska這類格式並不需要專用的播放器，基本上任何播放器都可以播放MKV檔。在[微軟](https://zh.wikipedia.org/wiki/微軟 "wikilink")[作業系統下](https://zh.wikipedia.org/wiki/作業系統 "wikilink")，一般解碼方法，是通過[DirectShow分流器](../Page/DirectShow.md "wikilink")*（DirectShow
Filters）*，「直接地」把[視訊流及](https://zh.wikipedia.org/wiki/視訊流 "wikilink")／或[音訊流以](https://zh.wikipedia.org/wiki/音訊流 "wikilink")[DirectX輸出至](../Page/DirectX.md "wikilink")[硬件的](../Page/硬件.md "wikilink")[驅動程序](https://zh.wikipedia.org/wiki/驅動程序 "wikilink")。

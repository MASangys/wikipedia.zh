...
<!-- end list -->
  ...
  - 完整的[ICC颜色管理](../Page/ICC色彩特性文件.md "wikilink")
...
<!-- end list -->
  ...
  - [字幕支持](../Page/字幕格式.md "wikilink")

<!-- end list -->

  - 支持电视信号的回放与录制（当装有支持的电视卡时）
...
<!-- end list -->
  ...
  - 继承Gabest的Guliverkli MPC Project的全部特色
...
## 外部連結
  ...
  - [MPC-HC官方网站](http://mpc-hc.org/)
  - [MPC-HC(clsid2版)](https://github.com/clsid2/mpc-hc/releases)

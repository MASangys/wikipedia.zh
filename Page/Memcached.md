**memcached**是一套[分布式的高速缓存系統](https://zh.wikipedia.org/wiki/分布式 "wikilink")，由[LiveJournal的Brad](https://zh.wikipedia.org/wiki/LiveJournal "wikilink")
Fitzpatrick开发，但目前被許多网站使用。這是一套[開放原始碼](https://zh.wikipedia.org/wiki/開放原始碼 "wikilink")[軟體](https://zh.wikipedia.org/wiki/軟體 "wikilink")，以[BSD
license授權釋出](https://zh.wikipedia.org/wiki/BSD_license "wikilink")。
...
coherency的問題](https://zh.wikipedia.org/wiki/Cache_coherency "wikilink")。其中一種解決的方法是在更新資料庫時，同時更新memcached內的資訊：

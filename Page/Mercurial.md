**Mercurial**是[跨平台的](https://zh.wikipedia.org/wiki/跨平台 "wikilink")[分布式版本控制软件](https://zh.wikipedia.org/wiki/分布式版本控制 "wikilink")，主要由[Python](../Page/Python.md "wikilink")语言实现，但也包含用[C语言实现的二进制比较工具](https://zh.wikipedia.org/wiki/C语言 "wikilink")。Mercurial一开始的主要运行平台是[Linux](../Page/Linux.md "wikilink")，现在Mercurial已经移植到[Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")、[Mac
OS
...
Mackal。其[源代码](../Page/源代码.md "wikilink")采用[GNU通用公共许可证](../Page/GNU通用公共许可证.md "wikilink")第二版为授权，确保了Mercurial是一个[自由软件](../Page/自由软件.md "wikilink")。
...
2005年时BitKeeper已经被用于[Linux内核](../Page/Linux内核.md "wikilink")的项目版本控制。Mackall决定为Linux内核开发写一个分布式的版本控制软件来替代BitKeeper。在该项目启动数天前，[Linus
...
## 相关软件
  ...
  - Mercurial[图形用户界面](../Page/图形用户界面.md "wikilink")有：*Hgk*（Tcl／Tk）。该程序作为Mercurial的插件而开发，现在被直接包含于正式版本中。界面可以通过命令命令'hg
  ...
  - 转换插件可以将[CVS](../Page/協作版本系統.md "wikilink")、[GIT](https://zh.wikipedia.org/wiki/GIT "wikilink")[Darcs](https://zh.wikipedia.org/wiki/Darcs "wikilink")、[GIT](../Page/Git.md "wikilink")、[GNU
    Arch](https://zh.wikipedia.org/wiki/GNU_Arch "wikilink")、[Monotone](../Page/Monotone.md "wikilink")、[Perforce](https://zh.wikipedia.org/wiki/Perforce "wikilink")、[Bazaar和](https://zh.wikipedia.org/wiki/Bazaar "wikilink")[Subversion](../Page/Subversion.md "wikilink")的版本库转换为Mercurial的版本库。

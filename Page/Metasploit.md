...
Express的所有功能和闭环弱点验证，模拟[钓鱼式攻击等](../Page/钓鱼式攻击.md "wikilink")[社会工程学功能](https://zh.wikipedia.org/wiki/社会工程学 "wikilink")，[网络应用程序测试](../Page/网络应用程序.md "wikilink")，攻击自动化，和其他Express版所没有的功能。

...
testing）及[入侵检测系统](../Page/入侵检测系统.md "wikilink")签名开发。
...
3.  选择并配置一个[有效负载](https://zh.wikipedia.org/wiki/有效负载 "wikilink")
    (payload,
    在成功进入后在目标系统上执行的代码；例如，一个远端[壳层或一个](https://zh.wikipedia.org/wiki/壳层 "wikilink")[VNC](../Page/VNC.md "wikilink")服务器）；
...
Express的所有功能和闭环弱点验证，模拟[钓鱼式攻击](../Page/钓鱼式攻击.md "wikilink")等[社会工程学](../Page/社会工程学.md "wikilink")功能，[网络应用程序](../Page/网络应用程序.md "wikilink")测试，攻击自动化，和其他Express版所没有的功能。

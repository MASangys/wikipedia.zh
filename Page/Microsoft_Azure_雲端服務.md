> 本文内容由[Microsoft Azure 雲端服務](https://zh.wikipedia.org/wiki/Microsoft_Azure_雲端服務)转换而来。
...
| --- | ----------------------------------------------------------------------------------------- | --------------------------------- |
| 4.x | [Windows Server 2012 R2](https://zh.wikipedia.org/wiki/Windows_Server_2012_R2 "wikilink") | 4.29 (.NET Framework 4.5.2)       |

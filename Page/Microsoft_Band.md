...
它內建的[應用程式稱為](https://zh.wikipedia.org/wiki/應用程式 "wikilink")「磁貼」（Tiles），例如有[體能鍛煉](../Page/體能鍛煉.md "wikilink")、紫外线、警鈴與定時器、來電、[簡訊](../Page/簡訊.md "wikilink")、[日曆](https://zh.wikipedia.org/wiki/日曆 "wikilink")、[Facebook](../Page/Facebook.md "wikilink")、[氣象等](https://zh.wikipedia.org/wiki/氣象 "wikilink")\[6\]；如果搭配使用Windows Phone 8.1的裝置，還能啟用[Cortana](https://zh.wikipedia.org/wiki/Microsoft_Cortana "wikilink")（某些功能仍然必須使用手機才能執行）\[7\] 。

用戶可從手機查看來自通知中心磁貼（Notifications Center Tile）的最新通告消息，這個功能也是促銷微軟的軟體和授權許可給開發者和[代工商的途徑之一](https://zh.wikipedia.org/wiki/OEM "wikilink")。 \[8\]

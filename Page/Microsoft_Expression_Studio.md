...
Web是[Microsoft
FrontPage的後繼者](../Page/Microsoft_FrontPage.md "wikilink")，但其功能明顯與FrontPage不同，如使用自己的渲染引擎而不是[Internet
Explorer的](../Page/Internet_Explorer.md "wikilink")
...
## 參見
  ...
  - [Creature House
    Expression](../Page/Creature_House_Expression.md "wikilink")，Expression
    Design的前身
...
### 微軟-{zh:鏈接;zh-hans:链接;zh-hant:鏈接;zh-tw:連結}-
  ...
  - [Microsoft
    Expression](https://web.archive.org/web/20070331045015/http://www.microsoft.com/expression/)
    - 官方網頁
  - [Microsoft Expression團隊網誌](http://blogs.msdn.com/expression/) -
    新聞、示範、教學
  - [Q\&A: Microsoft Unveils Next Generation of Web Authoring and Design
    Tools](https://web.archive.org/web/20070514174713/http://www.microsoft.com/presspass/features/2006/feb06/02-15Designer.mspx)
    - 微軟新聞稿

### 教程與消息

  - [Microsoft Expression
    Tutorials](https://archive.is/20130102130200/http://www.expression-tutorials.com/)
    - 有用的教程
  - [What is
    Expression?](http://by-expression.com/)：Expression開發者的網誌與RSS饋送
  - [NetFXGuide.com上的Microsoft
    Expression頁面](https://web.archive.org/web/20061126063042/http://www.netfxguide.com/guide/expression.aspx)
  - [Microsoft Expression written and flash tutorials.
    Expression網上論譠與幫助](http://www.expression-web-designer-help.com./)

[Category:多媒體製作](https://zh.wikipedia.org/wiki/Category:多媒體製作 "wikilink")

...
MapPoint 意欲為商業用戶，因為它包括先進的功能，譬如與[微軟Office整合](../Page/Microsoft_Office.md "wikilink")，並且從[微軟Excel在一張被創造的地圖上顯示趨向和資料](../Page/Microsoft_Excel.md "wikilink")。

MapPoint技術用在：

  - 終端用戶軟體：
      - MapPoint（為[北美和](https://zh.wikipedia.org/wiki/北美 "wikilink")[西歐商業用戶](https://zh.wikipedia.org/wiki/西歐 "wikilink")）
      - AutoRoute（為[西歐家庭和商業用戶](https://zh.wikipedia.org/wiki/西歐 "wikilink")），2007版為最後一個版本。
      - [微軟Streets and Trips](https://zh.wikipedia.org/wiki/微軟Streets_and_Trips "wikilink")（為北美一般家庭用戶。和MapPoint相比較，少了商業分析的功能。）
...
## 外部連結
  ...
  - [Microsoft MapPoint Review](http://www.laptopgpsworld.com/2736-review-microsoft-mappoint)

...
3.x版本及更高版本的Microsoft Messenger for
Mac使用新的[Aqua圖像介面](../Page/Aqua_\(GUI\).md "wikilink")。而2.x版本和更低版本的圖像介面與Windows
Messenger 4.0相似。5.0版本使用brushed metal為主題。
...
## 外部連結
  ...
  - [Microsoft Messenger for
    Mac](http://www.microsoft.com/mac/products/messenger/default.mspx)
  - [Review of Microsoft Messenger 6

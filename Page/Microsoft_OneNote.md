...
OneNote软件的界面是带有[标签的三环活页夹的电子版本](https://zh.wikipedia.org/wiki/标签 "wikilink")，可用于直接记录笔记，但也可用于收集[打印的](https://zh.wikipedia.org/wiki/打印 "wikilink")“页面”，或由其他应用程序发送过来的页面。页面可以在活页夹内部移动，同时可通过[电子墨水技术添加注释](https://zh.wikipedia.org/wiki/电子墨水技术 "wikilink")，处理文字，或绘图，并且其中还可内嵌[多媒体影音或](../Page/视频.md "wikilink")[Web链接](https://zh.wikipedia.org/wiki/超链接 "wikilink")。作为容器以及收集自不同来源的信息仓库，OneNote笔记本非常适合用于整理来自某个课程或研究项目的大量信息。

OneNote的重要创新之一是内建的搜索功能，以及可索引的[图形和](https://zh.wikipedia.org/wiki/图形 "wikilink")[音频仓库](https://zh.wikipedia.org/wiki/音频 "wikilink")。图像文件（例如屏幕截图、扫描的嵌入式文档，或照片）中可以搜索内嵌的文本内容，电子墨水注释也可作为文字进行搜索。音频内容也可以通过[关键字进行语义搜索](https://zh.wikipedia.org/wiki/关键字 "wikilink")，同时还可以在录制的同时播放笔记中记录的内容。

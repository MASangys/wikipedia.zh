...
L.P的HALO Desktop Imager开发而来。

老版本的Microsoft Photo Editor，包括Office
2000中内建的该工具，还可在保存文件时擦除来自数码相机的JPEG文件中的[元数据](../Page/元数据.md "wikilink")，同时，Office
2000版本中的该工具在保存BMP文件时，无论通过程序的界面设置了怎样的分辨率（DPI），都会将元数据的分辨率设置成0 x 0。
...
**MS Knowledge Base articles**
  ...
  - [在安装Office 2003后如何重装Photo
    Editor](http://support.microsoft.com/?kbid=817095)

<!-- end list -->

  - [MS Photo Editor, Wherefore Art
    Thou?](https://web.archive.org/web/20061016161431/http://pubs.logicalexpressions.com/Pub0009/LPMArticle.asp?ID=298)
...
1.  Microsoft知识库 <http://support.microsoft.com/kb/827740>
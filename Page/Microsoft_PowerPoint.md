...
在Microsoft
PowerPoint，就像其它大部分[簡報軟體一樣](../Page/簡報.md "wikilink")，文字、圖像、影片和其它物體被安置在個別頁或「幻燈片」上。「幻燈片」類似品是個參考物件，相等於幻燈機。隨著PowerPoint和其它簡報軟件的使用，幻燈機日漸淘汰。幻燈片可以打印或（經常）投影于銀幕並可隨演示者命令導覽。介於幻燈片之間的轉換類型可以指定多種方式的動畫，就如同在幻燈片本身上出現一樣。整體簡報設計可由母板來控制；而从整體的結構，至每個幻燈片的文字，可利用缩略圖來編輯。可被儲存和運行的簡報[檔案格式如下](../Page/檔案格式.md "wikilink")：
...
"Death by PowerPoint"这个措辞日渐普及来描述烂演示文稿。 "Death by
PowerPoint"不必然指的是演示文稿本身沉闷，这个问题是出在演示者身上。
...
## 外部链接
  ...
  - [flashgeek](http://www.flashgeek.com/)
    Powerpoint教程與社群，特别是关于使用Powerpoint與Macromedia
    Flash的結合
  - [The PowerPoint
    Page](https://web.archive.org/web/20051217172227/http://www.patricerutledge.com/PowerPointPage.htm)一个完整资源给PowerPoint用户
  - [ppt宝藏](http://www.pptbz.com/) Powerpoint模板资源下载網站
  - [pptok](http://www.pptok.com/) Powerpoint教程與资源下载網站
  - [The home of Awesome Backgrounds for
    PowerPoint](http://www.awesomebackgrounds.com/templates.htm)PowerPoint背景和指导给所有
  - [PPTFLY](http://pptshare.qzone.qq.com/)
    PowerPoint教程與PowerPoint創意作品分享
  - [PowerPoint to Apple
    Devices](http://www.leawo.com/powerpoint-to-ipad/)提供将PowerPoint文件上传并在Apple产品上演示的解决方案
  - [PowerPoint Heaven— The Power to
    Animate](http://pptheaven.mvps.org/)包括展示間、PowerPoint遊戲、動畫模板與爲你的PowerPoint簡報製作動畫的教程）
  - [Free PowerPoint templates and games for
    download](http://www.presentationhelpdesk.com/free-powerpoint-templates.html)
  - [PowerPoint Search
    Engine](https://web.archive.org/web/20100310174042/http://powerpoint-search-engine.com/)Powerpoint幻灯片搜索的资源聚合
  - [PowerPoint
    templates](https://imaginelayout.com/powerpoint-templates/)
    Powerpoint 演示模板

### 討論群

  - [微軟PowerPoint討論群](http://www.microsoft.com/office/community/en-us/default.mspx?dg=microsoft.public.powerpoint&lang=en&cr=US)
  - [微軟Office PowerPoint的Yahoo\!社群 —
    爲PowerPoint使用者提供疑難排解與建議](http://groups.yahoo.com/group/powerpoint/)

### 文章

  - [Edward Tufte: "PowerPoint is
    evil"](http://www.wired.com/wired/archive/11.09/ppt2.html)
  ...
  - [Donald
    Norman：「PowerPoint『不是』問題所在...Tufte完全誤會了要點」](https://web.archive.org/web/20051213224539/http://www.sociablemedia.com/articles_norman.htm)
  - [EServer TC Library:
    Presentations](https://web.archive.org/web/20070609182503/http://tc.eserver.org/dir/Articles/Presentations)
  - [Making a List, Checking It Twice - Interview with Dean Eppler
    (Part 2)](https://archive.is/20130411074812/http://www.marstoday.com/news/viewpr.html?pid=18037)航天員用PowerPoint去取代核對用的清單的紙張
  - [Gaskins:Original Powerpoint Proposal
    加斯金斯當年的Powerpoint產品企劃](http://www.gbuwizards.com/files/gaskins-original-powerpoint-proposal-14-aug-1984.pdf)

[Category:演示文稿软件](https://zh.wikipedia.org/wiki/Category:演示文稿软件 "wikilink")

> 本文内容由[Mk 2手榴彈](https://zh.wikipedia.org/wiki/Mk_2手榴彈)转换而来。
...
Mk 2手榴彈採用[TNT作爆炸填充物](https://zh.wikipedia.org/wiki/TNT "wikilink")，部分型號改用EC無煙火藥。
  ...
  - **Grenade, Hand, Fragmentation, HE, Mk II**：TNT，採用M5爆炸引信。
  - **Grenade, Hand, TNT, Fragmentation, Mk II**：TNT，採用M6A4C爆炸引信。

## 規格

  - **重量**：0.6公斤（1磅5盎司）
  - **爆炸填充物容量**：0.057公斤（2盎司）TNT或EC無煙火藥（約¾盎司）
  - **引信**：根據型號而不同，包括M5、M6爆炸引信、M10系列點燃引信，亦可對應較後期推出的引信

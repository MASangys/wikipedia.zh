...
也有使用到Koltun專利的部分顏色:
  ...
  - <span style="background-color:silver; border:1px solid darkgray;display:inline-block;width:10px;height:10px">

    <div style="position: relative; height: 12px; width: 12px; overflow: hidden; display: inline-block; vertical-align: middle;">

    <div style="position: absolute; height: 256px; width: 384px; top: -4px; left: -136px;">

    <span style="white-space:nowrap">[Silver_Color.png](https://zh.wikipedia.org/wiki/File:Silver_Color.png "fig:Silver_Color.png")</span>
...
## 參見
  ...
  - [分子模型](https://zh.wikipedia.org/wiki/分子模型 "wikilink")

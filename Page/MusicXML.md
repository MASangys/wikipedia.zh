...
Hewlett的[MuseData和David](https://zh.wikipedia.org/wiki/MuseData "wikilink")
...
MusicXML的1.0版由Recordare公司在2004年1月发布。在2005年5月发布1.1版，包含对文件格式支持的改进。在2007年6月发布了2.0版，并且包含了标准的压缩格式。\[6\]所有这些都建立在一系列的[文档类型定义](https://zh.wikipedia.org/wiki/文档类型定义 "wikilink")（DTD）之上。2.0版的[XML
...
截止2017年12月，MusicXML被估计得到了超过230个乐谱程序的支持。\[11\]\[12\]这些程序包括：
  ...
  - 大多数音序程序，包括[Cubase](https://zh.wikipedia.org/wiki/Steinberg_Cubase "wikilink")、[Logic
...
下面是一个C大调，G谱号，4/4拍，包含一个中央C[全音符的例子](https://zh.wikipedia.org/wiki/全音符 "wikilink")。\[15\]

...
Commandert](https://zh.wikipedia.org/wiki/Midnight_Commandert "wikilink")（一款文字介面檔案管理員）。其具有很高的自訂性。支援[ALSA](../Page/ALSA.md "wikilink")，[OSS或](https://zh.wikipedia.org/wiki/OSS "wikilink")[JACK輸出](https://zh.wikipedia.org/wiki/JACK "wikilink")；可自訂的色彩主題及介面；快速鍵；播放清單等。

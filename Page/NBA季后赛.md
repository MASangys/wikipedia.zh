> 本文内容由[NBA季后赛](https://zh.wikipedia.org/wiki/NBA季后赛)转换而来。


**NBA季后赛**（****）是[NBA常規賽後舉行的淘汰賽賽事](https://zh.wikipedia.org/wiki/NBA常規賽 "wikilink")。每個聯盟在常規賽東西區聯盟最佳成績的各8隊（2個聯盟，共16隊）會晉身NBA季后赛。約於4月下旬開始。季後賽球隊的種子排名由晉級季後賽球隊在季前賽的戰績決定。對賽方式如下：擁有較高的種子排名會有許多優勢。由於一號種子將挑戰八號種子，二號對陣七號，依此類推，因此有較高的種子排名意味著將面對排名較低的對手（但並不代表排名低就實力比較弱，NBA曾經有5次是[第8種子淘汰第1種子](../Page/黑八奇迹.md "wikilink")）。

...
就ICAO的格式而言，NOTAM分為六至八段，本文將會順序列出。
  ...
  - 第一段，NOTAM的首行表達了NOTAM的識別，即發出的年月日時間和號碼，如果之前發出過相似的NOTAM，還會以NEW/REPLEACED的字眼標示。
...
<!-- end list -->
  ...
  - 第D行則只會在事件的影響時間不足一天，但是重覆超過一次出現。例如一個機場預定在一天的三個時間內關閉跑道，並連續進行超過一天就要使用NOTAM的D行來表達其時效性。
...
編號：A1234號NOTAM，於2006年發出

NOTAM的目的：代替2006年發出的第1212號NOTAM
...
生效于：05:00 世界協調時 2006年9月5日

生效至：05:00 世界協調時 2007年4月30日

類別：機場、航线及地面助航

描述：因為滑行道B正進行工程，在“F”至“R”出口間的一段關閉。滑行道R在“A”至“B”關閉，滑行的飛機改經新的綠色中線燈和藍色邊緣燈組成的滑行道。

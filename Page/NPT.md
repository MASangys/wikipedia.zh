...
## 法律
  ...
  - ：英國, UK Police term for a group of officers dedicated to policing
    specific neighbourhoods

## 社會組織

  - , a Norwegian government agency responsible for controlling and
    regulating the telecommunication and postal services
...
## 科技
  ...
  - , a racing car developed for Nissan Motors by Nissan Performance
...
<!-- end list -->
  ...
  - [九一一事件陰謀論](../Page/九一一事件陰謀論.md "wikilink")（No-Plane
    Theory），指稱2001年9月11日[九一一事件並無飛機攻擊的一種陰謀論](https://zh.wikipedia.org/wiki/九一一事件 "wikilink")。
  - [等温等压系综](https://zh.wikipedia.org/wiki/等温等压系综 "wikilink")（isothermal–isobaric
    ensemble，又稱NPT系綜）因為其方程式包含粒子數（N）、壓力（P）和溫度（T）。

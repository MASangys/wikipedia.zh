...
**Non return to zero,
inverted**（簡稱：**NRZI**）中文譯為：**翻轉不歸零制**\[1\]，是[二進制](https://zh.wikipedia.org/wiki/二進制 "wikilink")[信號](https://zh.wikipedia.org/wiki/信號 "wikilink")，此信號[對應於實體性](https://zh.wikipedia.org/wiki/對應 "wikilink")[發送](https://zh.wikipedia.org/wiki/發送 "wikilink")（），以此欲於一些發送媒體（介質）。
...
**Return-to-zero,
inverted**（**RZI**）是另一種用于映射传输的編碼法，但受用處並不多。如果二进制信号是0，双电平的RZI信号就有一个[脉冲](https://zh.wikipedia.org/wiki/脉冲 "wikilink")（比[时钟周期短](https://zh.wikipedia.org/wiki/时钟周期 "wikilink")），如果二进制信号是1就不会有脉冲。

## 参见

  - [不归零码](https://zh.wikipedia.org/wiki/不歸零 "wikilink")

## 附註

<references/>

[en:Non-return-to-zero](https://zh.wikipedia.org/wiki/en:Non-return-to-zero "wikilink")

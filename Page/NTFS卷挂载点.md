...
NTFS挂载点可以在NTFS文件系统的[目录上创建](../Page/目录_\(文件系统\).md "wikilink")，提供对一个已挂载卷之[根目录的引用](https://zh.wikipedia.org/wiki/根目录 "wikilink")。任何空目录都可以转化为挂载点。挂载的卷不局限于NTFS文件系统，而是可以为任何[Microsoft Windows支持的文件系统](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")。卷挂载点自[Windows 2000引入的NTFS](../Page/Windows_2000.md "wikilink") 3.0起开始支持。

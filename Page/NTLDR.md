...
解决该问题需要向[光驱内放入一张相应的Windows安装光碟](https://zh.wikipedia.org/wiki/光驱 "wikilink")，开机时先将[BIOS](../Page/BIOS.md "wikilink")设置为从光盘启动，进入系统安装菜单后再选择进入故障恢复台，按屏幕相关说明进入命令行模式，然后将光盘根目录下i386文件夹内的“ntldr”文件和“ntdetect.com”拷贝至系统分区根目录下，重新启动后将BIOS设置回复为硬盘启动即可\[1\]。

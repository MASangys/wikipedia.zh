...
NVIDIA率先將硬体[T\&L整合到顯核中](https://zh.wikipedia.org/wiki/T&L "wikilink")。T\&L原先由[CPU負責](https://zh.wikipedia.org/wiki/CPU "wikilink")，或者由另一个獨立處理機處理（例如一些舊式工作站顯示卡）。較強勁的[3dfx
Voodoo2](https://zh.wikipedia.org/wiki/3dfx "wikilink") 和 [Rendition
Verite顯示核心已整合](https://zh.wikipedia.org/wiki/Rendition_\(company\) "wikilink")*幾何（三角形）建構*，但硬体T\&L仍是一大進步，原因是顯示核心從CPU接管了大量工作。

它的渲染性能比當时的高端顯卡，例如[RIVA
TNT2](https://zh.wikipedia.org/wiki/RIVA_TNT2 "wikilink")，ATI [Rage
128](../Page/Rage_128.md "wikilink")，[3dfx](https://zh.wikipedia.org/wiki/3dfx "wikilink")
Voodoo 3，和[Matrox Millennium G400
MAX強得多了](https://zh.wikipedia.org/wiki/Matrox_G400 "wikilink")。但在1999年很少应用支援T\&L，硬体T\&L根本沒有價值。硬体T\&L只是有益於一些立体第一人稱射擊遊戲，*[Quake
III Arena](https://zh.wikipedia.org/wiki/Quake_III "wikilink")* 和
*[Unreal
Tournament](https://zh.wikipedia.org/wiki/Unreal_Tournament "wikilink")*。3Dfx和其他競爭者認為一个快速CPU可以解決T\&L的問題，而並不需要顯卡硬体支援。當时GeForce
256已經相當昂貴，而在一些非遊戲应用上，效能則相當差，真是名副其實遊戲玩家的顯卡。其後的[GeForce
2充分顯示出硬体T](https://zh.wikipedia.org/wiki/GeForce_2 "wikilink")\&L的重要性。[GeForce
2](https://zh.wikipedia.org/wiki/GeForce_2 "wikilink") MX
比GeForce256相約，而價錢則是後者的一半而已。

GeForce
256顯示核心採用0.22微米製程製造，是256-bit顯示架構，擁有4條像素流水線。每一條有4个像素單元，1个材質單元。三角形生成率是每秒1500萬個，像素生成率則是每秒4亿8000萬個。它擁有2300万个晶体管，數量已超过了[PentiumIII](https://zh.wikipedia.org/wiki/PentiumIII "wikilink")，本应采用[0.18微米製程去解決熱量問題](https://zh.wikipedia.org/wiki/0.18微米製程 "wikilink")，但為了加速上市，唯有採用舊的工藝。但憑著四條像素流水线，效能依然強勁。GeForce
...
SDRAM版本。還有，它沒有記憶體頻寬節省技術（參考ATi的[HyperZ](https://zh.wikipedia.org/wiki/HyperZ "wikilink")）。GeForce
256的記憶體頻寬可謂史上最少，令它達不到应有的性能。縱使[GeForce4](https://zh.wikipedia.org/wiki/GeForce4 "wikilink")
MX（NV17）仍是"NV1x"家族產品，但架構成熟。結果輕量級的GeForce4 MX 440徹底打敗GeForce2 Ultra。

GeForce 256和[GeForce
2都很長壽和普及](https://zh.wikipedia.org/wiki/GeForce_2 "wikilink")，原因是支援硬体T\&L。在1999年和2000年，它的競爭者包括ATI
[Rage 128](../Page/Rage_128.md "wikilink")，[Voodoo
3](https://zh.wikipedia.org/wiki/3Dfx "wikilink")，[Matrox
G400和](../Page/Matrox.md "wikilink")[STM PowerVR3
Kyro](../Page/PowerVR.md "wikilink")。由於它們缺乏对T\&L的支援，產品生命周期並不長。
未來發表的[GeForce
2與](https://zh.wikipedia.org/wiki/GeForce_2 "wikilink")[GeForce
4](https://zh.wikipedia.org/wiki/GeForce_4 "wikilink") MX都是以GeForce
256為基礎的改進產品，支援[DirectX](../Page/DirectX.md "wikilink")
7，亦被2004年的主流[遊戲支援](https://zh.wikipedia.org/wiki/遊戲 "wikilink")。

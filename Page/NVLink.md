> 本文内容由[NVLink](https://zh.wikipedia.org/wiki/NVLink)转换而来。
...
2016年4月5日，輝達發布了基於Pascal架構的GP100晶片以及基於該晶片的Tesla P100運算卡，配備有NVlink。輝達官方認為這款處理器產品適用於資料中心及超級電腦的深度學習當中。\[3\]\[4\]

[美國能源部](../Page/美國能源部.md "wikilink")也與NVIDIA以及[IBM](../Page/IBM.md "wikilink")合作，建造兩組超級電腦「Summit」（用以取代[泰坦](../Page/泰坦_\(超級電腦\).md "wikilink")）以及「Sierra」。\[5\]這兩組超級電腦，其各自的節點互聯也採用NVLink，系統互聯則採用InfiniBand Dual Rail EDR（頻寬23GB/s），\[6\]它們用以將POWER9 CPU與基於Volta架構的GPGPU連接。

一些客制低成本超級工作站/小型電腦的解決方案，像是，也會考慮採用NVLink。現時的Fastra被認為其使用的[SLI多GPU互聯的頻寬](../Page/NVIDIA_SLI.md "wikilink")，已經不敷使用。

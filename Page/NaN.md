**NaN**（**N**ot **a**
**N**umber，非数）是[计算机科学中数值](../Page/计算机科学.md "wikilink")[数据类型的一类值](https://zh.wikipedia.org/wiki/数据类型 "wikilink")，表示未定义或不可表示的值。常在[浮点数运算中使用](../Page/浮点数.md "wikilink")。首次引入NaN的是1985年的[IEEE
...
significant bit of the significand），其取值表示了NaN的类型：X不能全为0，并被称为NaN的payload；
  ...
  - 大多数处理器，包括[Intel与](https://zh.wikipedia.org/wiki/Intel "wikilink")[AMD的](https://zh.wikipedia.org/wiki/AMD "wikilink")[x86系列](https://zh.wikipedia.org/wiki/x86 "wikilink")、[Motorola](https://zh.wikipedia.org/wiki/Motorola "wikilink")
    ...
    [PowerPC系列](../Page/PowerPC.md "wikilink")、[ARM系列](https://zh.wikipedia.org/wiki/ARM架構 "wikilink")、[Sun](../Page/昇陽電腦.md "wikilink")
...
返回NaN的运算有如下三种\[1\]：
  ...
  - [不定式](https://zh.wikipedia.org/wiki/不定式 "wikilink")
      - 下列[除法运算](../Page/除法.md "wikilink")：0/0、[∞](https://zh.wikipedia.org/wiki/∞ "wikilink")/∞、∞/(−∞)、(−∞)/∞、(−∞)/(−∞)
  ...
  - 产生[复数结果的实数运算](../Page/复数_\(数学\).md "wikilink")。例如：
      - 对[负数进行](../Page/负数.md "wikilink")[开偶次方的运算](https://zh.wikipedia.org/wiki/开方 "wikilink")

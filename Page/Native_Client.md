**Google Native Client**（縮寫為****），是一个由[谷歌所發起的](https://zh.wikipedia.org/wiki/谷歌 "wikilink")[開放原始碼計劃](https://zh.wikipedia.org/wiki/開放原始碼 "wikilink")，採用[BSD许可证](../Page/BSD许可证.md "wikilink")。它採用[沙盒技術](https://zh.wikipedia.org/wiki/沙盒_\(計算機安全\) "wikilink")，讓[Intel x86](https://zh.wikipedia.org/wiki/Intel_x86 "wikilink")、[ARM或](https://zh.wikipedia.org/wiki/ARM "wikilink")[MIPS子集的](https://zh.wikipedia.org/wiki/MIPS "wikilink")[機器碼直接在沙盒上運行](https://zh.wikipedia.org/wiki/機器碼 "wikilink")。它能夠從[瀏覽器直接運行程式機器碼](https://zh.wikipedia.org/wiki/瀏覽器 "wikilink")，獨立於使用者的作業系統之外，使[Web應用程式可以用接近於機器碼運作的速度來執行](https://zh.wikipedia.org/wiki/Web應用程式 "wikilink")，同時兼顧安全性。其功能類似於[微軟的](https://zh.wikipedia.org/wiki/微軟 "wikilink") [ActiveX](../Page/ActiveX.md "wikilink")，但是ActiveX只支援視窗系統。

Google將這項功能合併在[Chrome OS之下開發](../Page/Chrome_OS.md "wikilink")。它也可以被用來開發安全的[瀏覽器](https://zh.wikipedia.org/wiki/瀏覽器 "wikilink")[外掛程式](https://zh.wikipedia.org/wiki/外掛 "wikilink")。

2017年5月31日，Google宣布放棄PNaCl轉向[WebAssembly](../Page/WebAssembly.md "wikilink")\[1\]。

## 技術內容

NaCl使用[Newlib作為它的](https://zh.wikipedia.org/wiki/Newlib "wikilink")[C標準函式庫](../Page/C標準函式庫.md "wikilink")，但它也支援[GNU C 函式庫](https://zh.wikipedia.org/wiki/GNU_C_函式庫 "wikilink")。
...
NaCl運用機器碼驗證器（Code Validator）来保證只有安全機器碼能在系統執行。由於x86/x86-64是[複雜指令集](https://zh.wikipedia.org/wiki/複雜指令集 "wikilink")，[指令長度不一](https://zh.wikipedia.org/wiki/指令 "wikilink")，透過[控制流程](../Page/控制流程.md "wikilink")可能隱藏非安全機器碼，從而使驗證十分耗時。NaCl運用固定長度的16或32[位元組的指令束](https://zh.wikipedia.org/wiki/位元組 "wikilink")(Instruction Bundle)，使機器碼驗證器設計簡單（只有約600行[C語言](https://zh.wikipedia.org/wiki/C語言 "wikilink")）和高效率；\[4\] \[5\] 而運用指令束只是失去5%的執行效率。
...
## 外部連結
  ...
  -  - [Google I/O](https://zh.wikipedia.org/wiki/Google_I/O "wikilink") 2009技術專題討論

...
（诸如[Flock](../Page/Flock.md "wikilink")、[SeaMonkey](../Page/SeaMonkey.md "wikilink")等）
...
NoScript会在Firefox中占据一个[工具栏](../Page/工具栏.md "wikilink")图标或是一个[状态栏图标](https://zh.wikipedia.org/wiki/状态栏 "wikilink")，并显示正在浏览的页面上每个站点的内容被阻止或允许的情况，同时也可以修改之前阻止或允许的内容。
...
,
NoScript的白名单默认包含了扩展作者的部分域名，一些[Google](../Page/Google.md "wikilink")的域名（包括一个必要的用于显示[Google
Adsense广告的域名](https://zh.wikipedia.org/wiki/Google_Adsense "wikilink")），[雅虎](../Page/雅虎.md "wikilink")以及[微软](../Page/微软.md "wikilink")，由于这些使用了[AJAX](../Page/AJAX.md "wikilink")的Web邮件服务可能是某些用户唯一熟悉的使用邮件方式，如果不这样做，这些用户就会在安装NoScript之后无意地把他们自己锁住。这个白名单是可以修改的。
\[13\]
...
Plus和用户允许的情况下解析并显示赞助商页面。Palant说NoScript使用了[代码混淆](../Page/代码混淆.md "wikilink")来逃避十六进制代码层面对这个修改的检测。\[15\]\[16\]几乎同时，由于此次事件[Mozilla](../Page/Mozilla.md "wikilink")决定修改社区准则。\[17\]4月30日，NoScript升级到1.9.2.3，把传说中的代码混淆改为了一个用户可见的特性，即NoScript在Adblock
...
Plus的修改时，有人在NoScript支持论坛中指出NoScript官网上有一个[CSS规则不停让](https://zh.wikipedia.org/wiki/CSS "wikilink")[Ghostery](../Page/Ghostery.md "wikilink")这个[Mozilla扩展弹出提示](../Page/Firefox扩展列表.md "wikilink")，表示网页上有奇怪而隐蔽的"bug"。Ghostery也会提示用户Manoe网站上[Google

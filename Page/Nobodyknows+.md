...
乐团所有成员均出身于[东海地方](https://zh.wikipedia.org/wiki/东海地方 "wikilink")，现在居住于[名古屋市](../Page/名古屋市.md "wikilink")。
...
1.  nobody knows（2000）「nobody knows」名义（自主制作）
    ...
    4.
2.  nobody knows2（2001）「nobody knows」名义（自主制作）
...
4.  nobody knows<sup>3</sup> （2003.2.19）「nobody knows」名义
...
5.  ススミダス→（2003.11.19）
    ...
    1.  ススミダス→（プレイステーション2用ソフト「みんなのGOLF4」‘次のコースへ篇’CMソング）
...
1.  @[名古屋](https://zh.wikipedia.org/wiki/名古屋 "wikilink")（2004.7.7）

2.  Do You Know? tour 2004（2005.4.27）

3.  [ja](https://zh.wikipedia.org/wiki/nobodyknows+_tour_2006_"5MC_&_1DJ"_〜く{{lang "wikilink")（2006.11.22）

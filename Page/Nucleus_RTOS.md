...
Technology公司所推出的嵌入式作業系統。Nucleus的好處是程式師不用再撰寫板支持套裝軟體（[BSP](https://zh.wikipedia.org/wiki/BSP "wikilink")）。目前Nucleus
RTOS已支持USB OTG。
...
### 核心
  ...
  - 实时內核
  - [C++和](../Page/C++.md "wikilink")[POSIX接口](https://zh.wikipedia.org/wiki/POSIX "wikilink")
  - 動態下載
...
stack](https://zh.wikipedia.org/wiki/TCP/IP协议族 "wikilink")，[IPv6](../Page/IPv6.md "wikilink")
...
### 檔案系統
  ...
  - [虛擬檔案系統](https://zh.wikipedia.org/wiki/虛擬檔案系統 "wikilink")（Virtual
    file system）[API](https://zh.wikipedia.org/wiki/應用程式介面 "wikilink")
...
[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")（Encryption）、[雜湊](https://zh.wikipedia.org/wiki/雜湊 "wikilink")（hash）和[签名算法](https://zh.wikipedia.org/wiki/签名算法 "wikilink")（signature
algorithms）、[密钥交换协议](https://zh.wikipedia.org/wiki/密钥交换协议 "wikilink")

...
Null
是一特殊指標值（或是一種[对象引用](../Page/:引用型.md "wikilink")）表示這個指標並不指向任何的对象。這樣的指標稱之為
[Null指標](../Page/:指標_\(信息学\).md "wikilink")\[1\]。 有許多實现上是以0 (全位为0)
代表null指標，多數的[CPU以此作為記憶體空間的底](../Page/CPU.md "wikilink")
(雖有些系統會使用有符号位址空間（signed address space），並允許為負值)。
一旦用null來存取其記億體，許多 [作業系統會发生意外事件](../Page/作業系統.md "wikilink")。
一些語言使用其他的命名方式來表示這種指標，如[Pascal](../Page/:Pascal_\(程式語言\).md "wikilink"),
[Ruby](../Page/:Ruby.md "wikilink") 以及 [Lua](../Page/:Lua.md "wikilink")
則使用 `nil`\[2\]，而[Visual Basic](../Page/Visual_Basic.md "wikilink") 使用
...
(SQL)](../Page/Null_\(SQL\).md "wikilink")**。

## Null 字符串

null [字符串](../Page/:字符串.md "wikilink"),
也就是[空字符串](../Page/空字元串.md "wikilink")（empty
string），是一種長度為0的字串 \[3\]。

## Null 设备

  - 虛擬裝置（[device](../Page/硬件.md "wikilink")-like
    entity）並不提供輸入亦不支援輸出。在[UNIX系統中](../Page/Unix.md "wikilink")，會被標示為特別檔（）
    **[`:/dev/null`](../Page/:/dev/null.md "wikilink")**
...
[Unicode標準字元集](../Page/Unicode.md "wikilink"), code value 0
是空字符（null character，NUL）。大多數的程式語言提供語法來表示這樣的字元
(例如：[Pascal](../Page/Pascal_\(程式語言\).md "wikilink") 使用 chr(0) 或
\#0, [C](../Page/C语言.md "wikilink") 以及其他衍生語言 `'\0'`). \[4\]

在一些程式語言，null字符
意指為[字符串的結束](../Page/:字符串.md "wikilink")。這些字串被編成[ASCII字元集有時可視同](../Page/ASCII.md "wikilink")
...
[`nil`](../Page/nil.md "wikilink") 來表示Null變數，這有時會導致混淆。

## Null 脚本 或 Null 子程序

[command script](../Page/脚本语言.md "wikilink") 或 [program
subroutine](../Page/子程序.md "wikilink") 不做任何事, 但回傳個常數值。稱為存根函數或
"[stubroutine](../Page/stubroutine.md "wikilink")", 通常使用於 [program
development](../Page/程序设计.md "wikilink"),
...
[Null函数](../Page/Null函数.md "wikilink")（）（或稱 null操作符）是一種傳回「非資料值」（no data
values）的函數, 故執行後不會有任何狀態的改變。
...
1.  [Brian W. Kernighan](../Page/Brian_W._Kernighan.md "wikilink"),
    [Dennis M. Ritchie](../Page/Dennis_M._Ritchie.md "wikilink"), *[The
    C Programming
    Language](../Page/The_C_Programming_Language.md "wikilink")*, Second
    Edition, Prentice Hall New Jersey, ISBN 0-13-110362-8, p. 102

2.  [Elliot B. Koffman](../Page/Elliot_B._Koffman.md "wikilink"),

...
Nxt的基础设施核心相當复杂。與更為精簡的比特幣相比，Nxt的風險較高，但亦使外部服務更易建設於其區塊鏈上。

Nxt建立了一個[對等網絡交易平台以交易](../Page/對等網路.md "wikilink")[股份和](https://zh.wikipedia.org/wiki/股份 "wikilink")[加密资产](../Page/密碼貨幣.md "wikilink")，由於區塊鏈本質為不可逆的公共帳本，它可以提供該交易平台上所有的交易記錄，而並非只限於Nxt代幣。Nxt允許對指定代幣「著色」，「著色代幣」可以代表物業﹑股票/债券﹑商品甚至概念，它為虛擬的[加密货币與現實世界建立了桥梁](../Page/密碼貨幣.md "wikilink")。

Nxt允許加密文本或纯文本的傳送，包括傳送或永久性儲存多達1000字節，或暫時性儲存42千字節，同戶可以用以建立文件共享服务﹑[分散式应用程序或其他更高級服務](../Page/分散式應用程式.md "wikilink")。

Nxt資產的持有者可以加密证明和外部可验证的方式，就未來決策發展或股東举進行投票。

Nxt所有的插件都不是包含在[沙盒](../Page/沙盒_\(電腦安全\).md "wikilink")，而是允許外部開發人為現在有平台增加新功能或對現有功能進行修訂。

## 参見

  - [Peer-to-peer的计算](../Page/對等網路.md "wikilink")

**OS X
Mavericks**（10.9版本）\[1\]是[蘋果公司為個人電腦和](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")[伺服器](https://zh.wikipedia.org/wiki/伺服器 "wikilink")[作業系統開發的](https://zh.wikipedia.org/wiki/作業系統 "wikilink")[OS
...
OS X
Mavericks是[蘋果公司於](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")2013年6月10日的[全球軟體開發者年會上的主題](https://zh.wikipedia.org/wiki/全球軟體開發者年會 "wikilink")，它是[OS
X 10.8 "Mountain
...
Pro都在這次演講中宣布](../Page/Mac_Pro.md "wikilink")。

## 系统要求

OS X Mavericks是能夠與支援OS X Mountain
Lion所能兼容的[麥金塔電腦](https://zh.wikipedia.org/wiki/麥金塔電腦 "wikilink")，包括2GB的內置存儲、8GB的[硬盤可用空間](https://zh.wikipedia.org/wiki/硬盤 "wikilink")，以及需要支援OS
X 10.6.8 Snow Leopard或更高的版本的系統。
...
兼容的電腦型號如下：
  ...
  - [Mac
    mini](https://zh.wikipedia.org/wiki/Mac_mini "wikilink")（2009年早期或之後的型號）
  - [Mac Pro](../Page/Mac_Pro.md "wikilink")（2008年早期或之後的型號）
  - [Xserve](../Page/Xserve.md "wikilink")（2009年早期的伺服器）

### 新增功能及更新

  - 改良對多個顯示器的支援：主選列和Dock對每個顯示器都能作出支援；[Apple
...
OS X
Mavericks的版本10.9.2之前可能無法驗證[安全套接層或傳輸層安全證書的簽署](https://zh.wikipedia.org/wiki/安全套接層 "wikilink")，用於TLS
1.1或以下，或SSL
3.0及已啓用，這允許[中間人攻擊在這方面採取行動](https://zh.wikipedia.org/wiki/中間人攻擊 "wikilink")\[36\]，此漏洞已被分配為[通用漏洞曝光編號CVE](https://zh.wikipedia.org/wiki/通用漏洞披露 "wikilink")-2014-1266。OS
X 10.9.2的修補程序能堵塞這漏洞。\[37\]。

2014年2月21日，苹果公司发布了一项针对iOS的安全更新。该安全更新解决了Secure
Transport不能验证链接真实性的问题。\[38\]互联网用户在查看开源的相关iOS安全框架代码时，发现引起上述问题的是SSLVerifySignedServerKeyExchange函数中一行多余的“goto
fail;”代码，\[39\]这条代码导致无论对方网站发送的用于验证SSL/TLS连接的密钥是否有效，系统都会继续连接并且不报错。谷歌的安全专家Adam
Langley在个人博客上经过分析指出，\[40\]由于包含问题代码的SecureTransport框架同时应用于iOS和Mavericks系统，Mavericks系统也存在同样的安全漏洞。他还提供了网站（[29](https://www.imperialviolet.org:1266)），用于证明Mavericks系统自带的Safari浏览器由于这个漏洞，会连接没有正确密钥的网站。

由于这个漏洞的严重性，多家媒体对其进行了报道和分析。\[41\]\[42\]但苹果公司并未立即发布安全更新，而只是承诺会“很快”发布。\[43\]

该漏洞影响Mavericks自带的和第三方的使用SecureTransport框架的各类应用，如Safari，Mail.app，Calendar.app，Facetime和App
Store等，\[44\]如果用户和攻击者位于同一无线或有线网络中，就可能受到[中间人攻击](../Page/中间人攻击.md "wikilink")。在苹果公司发布安全补丁之前，用户可采取的保护措施包括避免加入不明来源的无线网络，使用不受该漏洞影响的浏览器，确认住家和公司的无线网络使用WPA2或更强健的加密手段，以及使用VPN等。\[45\]\[46\]
...
2.
3.  [Apple OS X Mavericks
    将于今日开放免费下载！你没看错，是「免费」](http://cn.engadget.com/2013/10/22/apple-os-x-mavericks-available-today-for-free/)
    - [Engadget中国版](http://cn.engadget.com)

4.  \[
    2013年6月10日的[蘋果公司全球軟體開發者年會](https://zh.wikipedia.org/wiki/蘋果公司全球軟體開發者年會 "wikilink")

5.  \[
    2013年6月10日的[蘋果公司全球軟體開發者年會](https://zh.wikipedia.org/wiki/蘋果公司全球軟體開發者年會 "wikilink")

6.  [蘋果公司設於加州總部對OS
    X有一個新的命名方案](http://techcrunch.com/2013/06/10/os-x-mavericks/)

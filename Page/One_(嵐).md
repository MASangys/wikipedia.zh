《**One**》是[嵐的第](../Page/嵐.md "wikilink")7枚專輯，第5枚原創專輯。於2005年8月3日發行。唱片公司為[J
Storm](../Page/J_Storm.md "wikilink")。

## 解說

  - 初回生產限定盤與通常盤的封套不一樣。初回生產限定盤的DVD中收錄了Making。通常盤追加收錄Bonus Track《風向雞》。
  - 首次收錄成員的Solo曲目，亦是首次只收錄了一張單曲的專輯。
...
3.  **ROMANCE** (3:42)
    （作詞：HigherF　作曲：Joey Carbone）
4.  **Lai-Lai-Lai** (3:44)
    （作詞：SPIN　作曲：磯崎健史）
5.  **Days** (3:40)
    （作詞：北川曉　作曲：宮崎步）
6.  **美好的世界**（） (4:12)
    （作詞：大野一成、SPIN　Rap詞：櫻井翔　作曲：松下典由）
      -
        《不知所措的嵐》結尾曲
7.  **[櫻花盛開](../Page/櫻花盛開_\(嵐\).md "wikilink")** (4:19)
    （作詞：相田毅　Rap詞：櫻井翔　作曲：谷本新）
      -
        14th單曲
8.  **Rain** (3:30)

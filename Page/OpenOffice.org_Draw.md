...
繪圖**或**OO.o
繪圖**）是一個向量繪圖軟體，它是[OpenOffice.org辦公軟體套裝的一部份](../Page/OpenOffice.org.md "wikilink")。它的特色在於多樣的「接頭」形狀，可以用在多種不同的線條上，方便建築繪圖，以及[流程圖上](https://zh.wikipedia.org/wiki/流程圖 "wikilink")，與[Microsoft
Visio以及](https://zh.wikipedia.org/wiki/Microsoft_Visio "wikilink")[CorelDRAW等向量繪圖軟體功能類似](../Page/CorelDRAW.md "wikilink")，OpenOffice.org
Draw也有若干[桌上排版](https://zh.wikipedia.org/wiki/桌上排版 "wikilink")（DTP）軟體（如[Microsoft
...
對於[SVG格式的崛起](https://zh.wikipedia.org/wiki/SVG "wikilink")，OpenOffice.org
...
Draw編輯大量來自[開放美工圖庫的SVG圖片](../Page/開放美工圖庫.md "wikilink")，而不是只能編輯[點陣圖](https://zh.wikipedia.org/wiki/點陣圖 "wikilink")、或者只能用其他的SVG編輯器（如[Inkscape](../Page/Inkscape.md "wikilink")）而已。

...
## 外部連結
  ...
  - [Product information
    page](http://www.openoffice.org/product/math.html) from the
    OpenOffice.org website

  - [Official
    FAQ](http://documentation.openoffice.org/faqs/formula/index.html)
    from the OpenOffice.org website

  - Formula Reference and How-to from [the official How-to
    documentation](http://documentation.openoffice.org/HOW_TO/index.html)

  - \- includes lots of examples of how to use OOMath

[Category:開放源碼](https://zh.wikipedia.org/wiki/Category:開放源碼 "wikilink")
[Category:數學軟件](https://zh.wikipedia.org/wiki/Category:數學軟件 "wikilink")
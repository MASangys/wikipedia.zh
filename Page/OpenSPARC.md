...
目前該社群的較知名會員有：Aurora VLSI、Aldec、Synopsys、World 45
Ltd.、SimplyRISC、Time-to-Market公司，及聖克魯茲加州大學（The University of
California at Santa Cruz）。

## 相關參考

  - [SPARC](../Page/SPARC.md "wikilink") -（**S**calable **P**rocessor
    **ARC**hitecture）具擴展延伸性的處理器架構
...
## 相關參見
  ...
  - [OpenSPARC
    Internals](http://www.opensparc.net/publications/books/opensparc-internals.html)
    （[PDF](https://web.archive.org/web/20120510142819/http://www.opensparc.net/offers/OpenSPARC_Internals_Book.pdf)）-
    國際標準書號： ISBN 978-0-557-01974-8
...
<!-- end list -->
  ...
  - [UltraSPARC
    T1的原始程式碼](http://www.opensparc.net/opensparc-t1/download.html)
    - **（英文）**

<!-- end list -->

  - [UltraSPARC
    T1的技術規格](http://www.opensparc.net/opensparc-t1/index.html)
    - **（英文）**

<!-- end list -->

  - [UltraSPARC
    T2的原始程式碼](http://www.opensparc.net/opensparc-t2/downloads.html)
    - **（英文）**

<!-- end list -->

  - [UltraSPARC
    T2的技術規格](http://www.opensparc.net/opensparc-t2/index.html)
    - **（英文）**

[Category:Sun微处理器](https://zh.wikipedia.org/wiki/Category:Sun微处理器 "wikilink")
[Category:電子設計自動化EDA的自由軟體](https://zh.wikipedia.org/wiki/Category:電子設計自動化EDA的自由軟體 "wikilink")

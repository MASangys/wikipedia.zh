**OverlayFS**是一个面向[Linux的](../Page/Linux.md "wikilink")[文件系统服务](../Page/文件系统.md "wikilink")，其实现一个面向其他[文件系统的](../Page/文件系统.md "wikilink")。

它于2014年被合并到[Linux内核的](../Page/Linux内核.md "wikilink")3.18版本。\[1\]\[2\]其4.0版本带来了必要的改进，例如[Docker中所需的](https://zh.wikipedia.org/wiki/Docker_\(軟體\) "wikilink")`overlay2`存储驱动程序。\[3\]
...
## 外部链接
  ...
  - [OverlayFS
    文档](https://git.kernel.org/cgit/linux/kernel/git/torvalds/linux.git/tree/Documentation/filesystems/overlayfs.txt)
...
[Category:联合文件系统](https://zh.wikipedia.org/wiki/Category:联合文件系统 "wikilink")

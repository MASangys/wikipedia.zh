...
PB消音手槍是以[馬卡洛夫手槍作藍本的消音武器](../Page/馬卡洛夫手槍.md "wikilink")，這種武器於1967年投入服役，並列裝[蘇聯軍隊中的偵察小組](https://zh.wikipedia.org/wiki/蘇聯軍隊 "wikilink")、[特種部隊和](../Page/特種部隊.md "wikilink")[克格勃等部門](https://zh.wikipedia.org/wiki/克格勃 "wikilink")。該手槍配有一個一體化，並由兩部分組成的抑制器，必要時使用者可將抑制器拆卸成兩部份，以令手槍能夠方便地。此槍也能夠在沒裝上抑制器的情況下安全地被擊發，這確保了使用者在危急情況下能夠直接開火。在缺乏抑制器的前部零件時此槍的發射聲音與馬卡洛夫手槍相似，而即使在抑制器完整的狀態下此槍也不能夠完全消音。PB手槍有一個特製的，手槍及拆卸後的抑制器可分開收藏在裡面。\[1\]

PB手槍的擊發機構與馬卡洛夫手槍相同，另外由於槍管前部安裝了抑制器，所以槍機十分短小，復位彈簧也被移至握把裡面；PB手槍使用與馬卡洛夫手槍相同的8發[彈匣供彈](../Page/彈匣.md "wikilink")，準星改為固定不能調整。\[2\]

\-{H|zh-hans:总线; zh-hant:滙流排;}-   **PCI-X**是傳統[PCI匯流排](https://zh.wikipedia.org/wiki/PCI "wikilink")（Peripheral Components Interconnect）的升級版，有更高的頻寬。在[PCI Express出現前](../Page/PCI_Express.md "wikilink")，PCI-X多用於[伺服器和](https://zh.wikipedia.org/wiki/伺服器 "wikilink")[工作站](../Page/工作站.md "wikilink")。

PCI-X 是1998年由[IBM](../Page/IBM.md "wikilink")、[惠普](../Page/惠普.md "wikilink")以及康柏（Compaq）等公司制定，採用64位元匯流排寬度，以及133MHz的頻率來傳送資料，有更多的接腳，而且所有的連接裝置會共享所有可用的頻寬，但兩者的協定相當類似\[1\]。PCI-X 2.0還可支援266MHz或533MHz的頻率。

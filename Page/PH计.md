...
在碱性溶液中，探头的输出电压范围为0至0.41V（7×0.059=0.41）。因此，对于pH=10的样品（pH值高于中性溶液3个单位），3×0.059=0.18V，pH计的示数为0.18×17+
7=10。在酸性溶液，探头的输出电压范围从-0.41V到0V。因此，对于pH=4的样品，-3×0.059=-0.18V，pH计示数为-0.18×17+
7=4。
...
## 外部链接
  ...
  - [pH值介绍](https://web.archive.org/web/20060715091909/http://www.omega.com/techref/ph.html)
    – pH值及其测量方法的概览

  - [贝克曼pH计](https://web.archive.org/web/20110928144009/http://acswebcontent.acs.org/landmarks/landmarks/phmeter/phmeter.html)
    – 美国化学学会的国家化学史里程碑

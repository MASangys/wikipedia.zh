...
PLZ-07自行火炮沿用了[PLZ-89自行榴弹炮的基本布局](../Page/PLZ-89自行榴弹炮.md "wikilink")，动力-传动装置前置，全封闭型炮塔通过连接座圈装在[底盘后部](https://zh.wikipedia.org/wiki/底盘 "wikilink")，履带式轻型通用底盘是由[ZBD-04步兵战车底盘改造而来](../Page/ZBD-04步兵战车.md "wikilink")\[2\]，车体前端削尖外形楔形体取消，侧装甲由内倾改为垂直。驾驶员位于车体左前部的驾驶室内，驾驶室内有液压助力式操纵装置、仪表和驾驶员终端显示器，其余炮班成员4人在炮塔与车体相连构成的密闭战斗室里，炮长在右侧前方位置，瞄准手在左侧前方位置，2名装填手（分别是一炮手负责弹丸装填/二炮手负责药筒装填）分坐其后\[3\]，带有数字化火控系统与信息化数据传输设备，炮塔顶部装有卫星定位和通讯数据传输天线。车内带“三防”装置以及灭火抑爆系统。车体尾部开有后门，方便从车外补充弹药。\[4\]

**便携式网络图形**（，**PNG**）是一种[无损压缩的](../Page/无损压缩.md "wikilink")[位图图形格式](../Page/位图.md "wikilink")，支持索引、[灰度](../Page/灰度.md "wikilink")、[RGB三种颜色方案以及](../Page/RGB.md "wikilink")[Alpha通道等特性](../Page/Alpha通道.md "wikilink")。PNG的开发目标是改善并取代[GIF作为适合网络传输的格式而不需专利许可](../Page/GIF.md "wikilink")，所以被广泛应用于[互联网及其他方面上](../Page/互联网.md "wikilink")。
...
## 特性
  ...
  - 支持256色[调色板技术以产生小体积文件](../Page/调色板技术.md "wikilink")
  - 最高支持24位[真彩色图像以及](../Page/真彩色.md "wikilink")8位[灰度图像](../Page/灰度图像.md "wikilink")。
  - 支持[Alpha通道的透明](../Page/Alpha通道.md "wikilink")/半透明特性。
  - 支持图像亮度的[Gamma校准信息](../Page/Gamma校准.md "wikilink")。
  - 支持存储附加文本信息，以保留图像名称、作者、[版权](../Page/版权.md "wikilink")、创作时间、注释等信息。
  - 使用无损压缩。
  - 渐近显示和流式读写，适合在[网络传输中快速显示预览效果后再展示全貌](../Page/网络.md "wikilink")。
  - 使用[CRC防止文件出错](../Page/循环冗余校验.md "wikilink")。
  - 最新的PNG标准允许在一个文件内存储多幅图像。

## 版本及历史

1995年早期，[Unisys公司根据它在GIF格式中使用的](../Page/Unisys.md "wikilink")[LZW](../Page/LZW.md "wikilink")[数据压缩算法的](../Page/数据压缩.md "wikilink")[软件](../Page/软件.md "wikilink")[专利](../Page/专利.md "wikilink")（[美国
...
Network
Graphics图形文件格式被同时创建出来](../Page/MNG.md "wikilink")。1999年8月，Unisys公司进一步中止了对[自由软件和非商用软件开发者的GIF专利免费许可](../Page/自由软件.md "wikilink")，从而使PNG格式获得了更多的关注。

在PNG传播过程中，很多[网络浏览器经过很长时间才开始完全支持PNG格式](../Page/网络浏览器.md "wikilink")；如[Microsoft
Windows預設的](../Page/Microsoft_Windows.md "wikilink")[Internet
...
SP1）需要下載Hotfix \[2\]或由網站提供額外的Script去支援。\[3\]这造成PNG格式并没有得到广泛的认知。
  ...
  - PNG的1.0版本规范于1996年7月1日发布，后来被称为RFC
    2083标准，并在1996年10月1日成为[W3C建议](../Page/W3C.md "wikilink")。
  ...
  - PNG现行版本是国际标准（[ISO](../Page/國際標準化組織.md "wikilink")／[IEC](../Page/国际电工委员会.md "wikilink")
    15948:2003），并在2003年11月10日作为[W3C建议发布](../Page/W3C.md "wikilink")。这个版本与1.2版仅有细微差别。

此外也产生了基于PNG的动画格式：1996年6月提出PNF（Portable Network
Frame）草案，当年8月改名为[MNG](../Page/MNG.md "wikilink")（Multiple-image
Network Graphics）。[1](http://www.libpng.org/pub/mng/)

2004年末，PNG的动画扩展——[APNG](../Page/APNG.md "wikilink")，被提出来。这是一个相对于[MNG更简单的动画实现方案](../Page/MNG.md "wikilink")，不识别APNG格式的PNG解码器至少能够正常回放第一幅普通PNG画面。
...
chunks），PNG允许软件忽略它不认识的附加块。这种基于数据块的设计，允许PNG格式在扩展时仍能保持与旧版本[兼容](../Page/兼容.md "wikilink")。
...
### 与GIF相比
  ...
  - PNG可提供更大颜色深度的支持，包括24位（8位3通道）和48位（16位3通道）真彩色。加入[Alpha通道后可进一步支持每像素](../Page/Alpha通道.md "wikilink")64位的表示。
  - 超过8位色深的PNG图像转换为GIF时，图像质量会由于分色（颜色数减少）而下降。
  - GIF原生支持动态图像，PNG只能通过非标准实现，在PNG的基础上另有发展出支持动画的[APNG和](../Page/APNG.md "wikilink")[MNG格式](../Page/MNG.md "wikilink")，但目前普及度不高。

PNG在[IE6等旧代浏览器上的支持较差](../Page/IE6.md "wikilink")。
...
由于JPEG是有损压缩，会产生迭代失真，在重复压缩和解码的过程中会不断丢失信息使图像质量下降。由于PNG是无损的，保存将要被编辑的图像来说更加合适。虽然PNG压缩照片图像也有效，但有专门针对照片图像设计的无损压缩格式，比如无损[JPEG2000](../Page/JPEG2000.md "wikilink")，[Adobe
...
TIFF使用的最通用的无损压缩算法是LZW。这种算法--GIF中也在使用，直到2003年一直在专利保护之中。有一种TIFF变种使用与PNG相同的压缩算法，但是没有被许多专利程序所-{zh-cn:支持;zh-tw:支援}-。TIFF也提供了一种特殊的无损压缩算法，类似[CCITT](../Page/CCITT.md "wikilink")
...
## 外部链接
  ...
  - [PNG规范第二版](http://www.w3.org/TR/2003/REC-PNG-20031110/)，2003年11月10日[W3C建议](../Page/W3C.md "wikilink")

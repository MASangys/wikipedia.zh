**PPPoE**（），[以太网上的点对点协议](../Page/以太网.md "wikilink")，是将[点对点协议](../Page/点对点协议.md "wikilink")（PPP）封装在[以太网](../Page/以太网.md "wikilink")（Ethernet）框架中的一种网络隧道协议。由于协议中集成PPP协议，所以实现出传统[以太网不能提供的](../Page/以太网.md "wikilink")[身份验证](../Page/身份验证.md "wikilink")、[加密以及](../Page/加密.md "wikilink")[压缩等功能](../Page/数据压缩.md "wikilink")，也可用于[纜線數據機](../Page/纜線數據機.md "wikilink")（cable
modem）和[数位用户线路](../Page/数位用户线路.md "wikilink")（DSL）等以[以太网协议向用户提供](../Page/以太网.md "wikilink")[接入服务的协议体系](../Page/網路存取.md "wikilink")。

本质上，它是一个允许在以太网 [广播域中的两个以太网接口间建立点对点隧道的协议](../Page/广播域.md "wikilink")。

以[Linux系统常用的](../Page/Linux.md "wikilink")[pppd为例](../Page/pppd.md "wikilink")，支持[PPP接口上面的](../Page/点对点协议.md "wikilink")[IP](../Page/IP.md "wikilink")、[IPv6和](../Page/IPv6.md "wikilink")[IPX网络层协议](../Page/IPX.md "wikilink")。
...
Networks和RouterWare所开发的](../Page/Redback_Networks.md "wikilink")。发表于RFC
2516说明中。
...
发现过程包含四个步骤。主机作为客户端，[ISP端的](../Page/ISP.md "wikilink")[访问集中器作为服务器](../Page/访问集中器.md "wikilink")。这四步在下面详述。最后一步第五步是关闭一个现存会话的方法。

### 客户端到服务器：Initiation（PADI）

**PADI**为PPPoE Active Discovery Initiation的缩写。\[1\]
如果一个用户想要使用DSL拨号连入Internet，那么他的计算机必须首先在其ISP的[网络服务提供点](../Page/POP网络服务提供点.md "wikilink")（POP）找到DSL访问集中器（DSL-AC）。在以太网上通讯只能通过[MAC地址](../Page/MAC地址.md "wikilink")。由于计算机不知道DSL-AC的MAC地址，于是就在以太网上[广播一个PADI报文](../Page/廣播_\(網路\).md "wikilink")。这个报文中包含发送者的MAC地址。
...
1.  使用Internet前，需先透過PPPoE進行撥接，而非電腦開機後立即上網。（開機後立即上網，詳見[DHCP](../Page/DHCP.md "wikilink")，有些ISP有提供第1台PC自DHCP取得固定IP）
2.  部分[ISP会對PPPoE的連線用戶採取定時斷線](../Page/ISP.md "wikilink")，以節省營運成本及IP位址的佔用，故對於需長時間掛網的使用者較不利。但也有部份ISP为提供用戶選擇PPPoE可發配非固定IP或固定IP的服务。
3.  目前[Windows
    XP之後的](../Page/Windows_XP.md "wikilink")[Windows](../Page/Windows.md "wikilink")，[Mac
    OS
    X](../Page/Mac_OS_X.md "wikilink")、[Linux等操作系统等皆已內建PPPoE的撥接功能](../Page/Linux.md "wikilink")，更早期的操作系统需另行安裝PPPoE的撥接程式，如Enternet
    300、RAS PPPoE等。

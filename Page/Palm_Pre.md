...
Pre拥有一个3.1英寸、24位色、分辨率为320×480的[触摸屏](https://zh.wikipedia.org/wiki/触摸屏 "wikilink")。触摸屏的操作将会用手指取代原来的Palm
PDA和电话常用的触摸笔。在触摸屏下面有所谓的“手势区域”——一个黑色半透明的额外的触摸区域，带有[LED背光灯](https://zh.wikipedia.org/wiki/LED "wikilink")，允许更多的触摸指令。
...
Palm
Pre拥有8.0 [GB内部](https://zh.wikipedia.org/wiki/GB "wikilink")[闪存](../Page/闪存.md "wikilink")
（用户可用约7.4 GB）。Pre没有配备[闪存卡插槽](https://zh.wikipedia.org/wiki/闪存卡 "wikilink")。\[7\]
...
Palm
Pre是第一个使用[webOS](https://zh.wikipedia.org/wiki/webOS "wikilink")（基於Linux，並用來代替[Palm
OS的](../Page/Palm_OS.md "wikilink")）的Palm设备。

### 界面

webOS的界面是基于“卡片”系统来管理多个[进程的](https://zh.wikipedia.org/wiki/进程 "wikilink")。应用程序可以从“Launcher”（可以显示三页的应用程序）或者快速启动条（横向显示五个图标）

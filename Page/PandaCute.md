...
| 比賽名稱                 | 結果           |
| -------------------- | ------------ |
| YourYouth 女子邀請賽      | **冠軍**\[4\]  |
| 亞洲英雄聯盟女子全明星賽 2017    | 殿軍\[5\]      |
| HKXP 女子邀請賽           | **冠軍**\[6\]  |
|                      |              |
| 全國妹子杯廣州站             | 亞軍\[7\]      |
|                      |              |
| EWG 全國女子大賽           | 小組賽\[8\]     |
|                      |              |
| SHERO 英雄聯盟國際女子邀請賽香港區 | **冠軍**\[9\]  |
|                      |              |
| 2016 英雄聯盟陽光杯 5V5     | **冠軍**\[10\] |
|                      |              |
|                      |              |
|                      |              |
|                      |              |
...
<timeline> ImageSize = width:600 height:175 PlotArea = width:400 height:150 left:75 bottom:20 Alignbars = justify DateFormat = dd/mm/yyyy Period = from:2016 till:2019 TimeAxis = orientation:horizontal format:yyyy
...
`id:album value:black legend:Name`

Legend = orientation:horizontal position:bottom ScaleMajor = unit:year increment:1 start:2016 gridcolor:black PlotData=

`color:blue width:7 textcolor:black align:left anchor:from`
` bar:Deer from:01/10/2016 till:end color:a`
` bar:Momo from:01/10/2016 till:end color:a`

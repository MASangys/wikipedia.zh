**Pathping**是[Windows系统中自带的一个网络诊断工具](https://zh.wikipedia.org/wiki/Windows系统 "wikilink")，用于检测本地至目的地之间[节点的](https://zh.wikipedia.org/wiki/节点 "wikilink")[网络延迟和穩定性](https://zh.wikipedia.org/wiki/网络延迟 "wikilink")。\[1\]

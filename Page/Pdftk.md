**PDFtk**，全稱，是一個在命令行運行的[跨平台工具](https://zh.wikipedia.org/wiki/跨平台 "wikilink")，用作處理[PDF文件](https://zh.wikipedia.org/wiki/PDF "wikilink")。
...
page羅列的部分功能](https://zh.wikipedia.org/wiki/man_page "wikilink")：
  ...
  - 解碼PDF頁面（需要提供密碼）
  - 編碼PDF頁面
  - 打水印[元數據](https://zh.wikipedia.org/wiki/元數據 "wikilink")
  - 可以插入或檢索的PDF文件格式的數據。
  - 連接和打開 PDF附件
  - 從 PDF文件提取到一個簡單的文檔頁面。
  - 修復PDF文件的失敗部分。
...
## 參看
  ...
  - [iText](https://zh.wikipedia.org/wiki/iText "wikilink")

**PerlMonks**（中文翻译：Perl修道士）是一个讨论[Perl编程的](../Page/Perl.md "wikilink")[网络社区](../Page/网络社区.md "wikilink")，里面也涵盖一些与Perl相关的话题，如[网络编程和](../Page/网络应用程序.md "wikilink")[系统管理等](../Page/系统管理员.md "wikilink")。该网站通常被用户戏称为“[僧院](../Page/僧院.md "wikilink")”。\[1\]
PerlMonks这个名字和整个网站的风气，都幽默地反映出[程序员对自己喜爱的](../Page/程序员.md "wikilink")[编程语言有着一种近乎宗教般的热爱](../Page/编程语言.md "wikilink")。网站的用户被称作“修道士”（monk）。
...
运行PerlMonks的软件是一个高度定制的的早期版本。这个软件也被用在[Slashdot等站点上](../Page/Slashdot.md "wikilink")。\[2\]

...
上图的噪声之所以不够真实是因为它的能量在[频谱中平均分布](../Page/频谱.md "wikilink")，即它是[白噪声](https://zh.wikipedia.org/wiki/白噪声 "wikilink")。对白噪声进行[柔化处理后限制了噪声的频谱](https://zh.wikipedia.org/wiki/柔化 "wikilink")，比之前者和自然界中的噪声现象更加接近，但是依然不能令人满意。
...
Perlin噪声对各个点的计算是相互独立的，因此非常适合使用[图形处理器进行计算](https://zh.wikipedia.org/wiki/图形处理器 "wikilink")。[OpenGL在](../Page/OpenGL.md "wikilink")[GLSL中定义了一维至四维的噪声函数noise](../Page/GLSL.md "wikilink")1、noise2、noise3、noise4，在该规范中噪声的性质与上述Perlin提出的性质相同。在[Mesa

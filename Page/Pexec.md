...
这里的集合有四个元素v1、v2、v3、v4，定义了（环境）变量$x可有的值。程序pexec的特征还有：
  ...
  - 使用其他[remote shell替代](../Page/远程外壳.md "wikilink")[ssh](../Page/Secure_Shell.md "wikilink")；
...
[Category:GNU计划软件](https://zh.wikipedia.org/wiki/Category:GNU计划软件 "wikilink") [Category:Unix进程和任务管理相关软件](https://zh.wikipedia.org/wiki/Category:Unix进程和任务管理相关软件 "wikilink")

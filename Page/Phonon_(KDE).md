...
软件能够独立于任何单一的多媒体框架（如[GStreamer或](../Page/GStreamer.md "wikilink")[xine](../Page/xine.md "wikilink")），从而为其提供了在主要版本的生命周期内稳定的多媒体API。通过提供一个简单的
...
Phonon並非只能運行於[Unix系統](../Page/Unix.md "wikilink")，他的後端可以是在其它平台如
[Microsoft Windows](../Page/Microsoft_Windows.md "wikilink") 並提供相同的功能。
...
## 特色
  ...
  - 使用[Solid](../Page/Solid_\(KDE\).md "wikilink")，Phonon將給予用戶更多配件的控制能力如耳機、揚聲器、麥克風。一個例子是，因為你可能只有一個VoIP會話使用您的耳機，但所有其他的聲音通過揚聲器出來。\[4\]
  - 支援 [Unix-like](../Page/Unix-like.md "wikilink")
    系統下的後端GStreamer与VLC。<ref>

</ref>需要注意的是，[xine与](../Page/xine.md "wikilink")[MPlayer的后端在](../Page/MPlayer.md "wikilink")
Linux 中已经过时并不再提供开发。\[5\]

  - 支援 [Windows](../Page/Windows.md "wikilink") 下的後端
    [DirectShow](../Page/DirectShow.md "wikilink")、[VLC和](../Page/VLC_media_player.md "wikilink")[MPlayer](../Page/MPlayer.md "wikilink")。
  - 支援 [Mac OS
    X下的後端](../Page/Mac_OS_X.md "wikilink")[QuickTime](../Page/QuickTime.md "wikilink")。
...
## 外部連結
  ...
  - [PulseAudio](../Page/PulseAudio.md "wikilink") -
    一个[跨平台的](../Page/跨平台.md "wikilink")、可通过网络工作的声音服务
  - [JACK Audio Connection
    Kit](../Page/JACK_Audio_Connection_Kit.md "wikilink") - 一个专业级的声音服务

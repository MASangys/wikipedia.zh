**PRMan**，[皮克斯动画工作室的](https://zh.wikipedia.org/wiki/皮克斯 "wikilink")**PhotoRealistic
RenderMan**软件渲染器，简称为**PRMan**。是用于影视效果制作的三维渲染[软件包](https://zh.wikipedia.org/wiki/软件包 "wikilink")。由于[RenderMan的商标归皮克斯公司拥有](https://zh.wikipedia.org/wiki/RenderMan "wikilink")，人们经常把PRMan等同于RenderMan，实际上RenderMan是一个渲染器规范，皮克斯公司的PRMan是（声称）符合这一规范的一种产品。PRMan
13.0符合RenderMan规范第3.3版。

PRMan使用[RenderMan着色语言进行](https://zh.wikipedia.org/wiki/RenderMan着色语言 "wikilink")[着色器编程](../Page/着色器.md "wikilink")，可灵活的定义材质特性。PRMan渲染器可以渲染高质量的图像。如果使用得当，PRMan可以提供相当快的渲染速度。
...
## PRMan的用法
  ...
  - 使用[文本编辑器编写用于场景描述的](../Page/文本编辑器.md "wikilink")[RIB格式文件](https://zh.wikipedia.org/wiki/RIB "wikilink")，用PRMan渲染。
  - 通过[C语言程序经由RenderMan规范的C语言绑定生成RIB场景描述文件](https://zh.wikipedia.org/wiki/C语言 "wikilink")。
  - [皮克斯的](https://zh.wikipedia.org/wiki/皮克斯 "wikilink")**[RenderMan艺术家工具](https://zh.wikipedia.org/wiki/RenderMan艺术家工具 "wikilink")（RenderMan
    Artist
    Tools，简写为RAT）**产品为PRMan提供了[图形界面包装](https://zh.wikipedia.org/wiki/图形界面 "wikilink")，RAT模块[mtor用于从三维软件](https://zh.wikipedia.org/wiki/mtor "wikilink")[Maya生成PRMan的场景描述文件](../Page/Maya.md "wikilink")。这样，用户就可以在Maya下完成渲染之前的创作后使用PRMan渲染场景。RAT提供[Shader图形化交互创作工具](https://zh.wikipedia.org/wiki/Shader "wikilink")[slim](https://zh.wikipedia.org/wiki/slim "wikilink")、和管理渲染任务的工具[Alfred](https://zh.wikipedia.org/wiki/Alfred "wikilink")。
  - 皮克斯也为小型工作室和个人用户提供使用PRMan的Maya渲染插件[RenderMan for
    Maya](https://zh.wikipedia.org/wiki/RenderMan_for_Maya "wikilink")，用户可以在[Maya环境下以类似Maya内置的](../Page/Maya.md "wikilink")[Maya软件渲染器相似的方式使用PRMan进行渲染](https://zh.wikipedia.org/wiki/Maya软件渲染器 "wikilink")。
  ...
  - 很多支持PRMan的三维图形制作软件可以通过[图形界面定制材质](https://zh.wikipedia.org/wiki/图形界面 "wikilink")，以减少对用户编写[着色器能力的要求和使创作更加便捷](../Page/着色器.md "wikilink")，例如[Maya的](../Page/Maya.md "wikilink")[HyperGraph功能](https://zh.wikipedia.org/wiki/HyperGraph "wikilink")。对于上述方法，用户均可以通过[RenderMan着色语言编写着色器以实现材质的描述](https://zh.wikipedia.org/wiki/RenderMan着色语言 "wikilink")。很多时候，编写自定义着色器是必需的。对于完全使用[RAT的工作流程而言](https://zh.wikipedia.org/wiki/RAT "wikilink")，一般来说需要有开发人员编写[着色器模板](../Page/着色器.md "wikilink")（实际上是TCL\\TK程序），由RAT中的[SLIM进行调用形成材质](https://zh.wikipedia.org/wiki/SLIM "wikilink")，艺术家调节材质中的参数，最终生成材质提供给渲染器使用。
...
## 常见的符合[RenderMan规范的渲染器](../Page/RenderMan规范.md "wikilink")
  ...
  - [Entropy](https://zh.wikipedia.org/wiki/Entropy_\(渲染器\) "wikilink")，被NVIDIA

...
### Windows
  ...
  - 3.0
      ...
      - Build 57.24－2008年9月23日
          - 修正錯誤。
          - 更新數臺相機的RAW支援，包括：Canon 1000D和Powershot A720、Nikon
            D700，以及Olympus E-520。
...
### Linux
  ...
  - 自2006年6月起，Picasa推出第一个[Linux版](../Page/Linux.md "wikilink")，并能在多数linux版本上使用。它通过[Windows
    API模拟出一个Win](../Page/Windows_API.md "wikilink")32的环境，程序还是跟Windows版本没有很大区别，只是比较Windows版本缺少了一些功能。他的後台是[Wine软件](../Page/Wine.md "wikilink")，已经集成进去，因此Linux版本的Picasa不需要调用和修改系统中的Wine软件设置。
  - 2007年11月21日，適用於Linux的Picasa 2.7 (Build 37.3607,0)候選版釋出。\[2\]
  - 2008年4月16日，Google加入適用於Linux的Picasa 2.7 (Build 37.3615,
    0)到他們的Linux儲藏庫。

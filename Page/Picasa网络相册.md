...
Picasa網路相簿使用「未列入目錄的編號」處理私人相簿的網址。相簿允許使用者-{zh:寄出;zh-hans:发送;zh-hant:寄出}-私人相簿網址的電子郵件給想要的人。收件者不需要建立使用者帳號就可以檢視相簿
-
這是經由驗證-{zh:金鑰;zh-hans:密钥;zh-hant:金鑰}-所達成，這需要附上要被顯示相簿的網址。Picasa說明檔案提到，私人相簿除了使用者以外，是搜尋不到的。

**PieTTY**是由台灣程式設計師[林弘德](https://zh.wikipedia.org/wiki/林弘德 "wikilink")（PTT
BBS
id：piaip）以[PuTTY原始碼為基礎](../Page/PuTTY.md "wikilink")，在[Windows上發展的Telnet](https://zh.wikipedia.org/wiki/Windows "wikilink")/SSH安全遠端連線程式，修正與完整支援亞洲語系字元，可切換多種[Unicode字元顯示方式](https://zh.wikipedia.org/wiki/Unicode "wikilink")，提供簡易scp上傳界面，並增加透明視窗、無邊框模式等視覺效果。

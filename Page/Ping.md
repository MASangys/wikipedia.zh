**ping**是一种[電腦](../Page/電腦.md "wikilink")[網路工具](../Page/计算机网络.md "wikilink")，用來測試数据包能否透過[IP协议到達特定](../Page/IP协议.md "wikilink")[主機](../Page/主機.md "wikilink")。ping的運作原理是向目標主機傳出一個[ICMP的请求回显数据包](../Page/ICMP.md "wikilink")，并等待接收回显回應封包。程式會按時間和成功响应的次數估算丢失封包率（丢包率）和[封包往返時間](../Page/來回通訊延遲.md "wikilink")（网络时延，）。

在1983年12月，Mike
Muuss编写了首个這样的程式，用于在IP網路出现問題時方便探查其根源。因為這個程式的運作原理与[潛水艇的主动](../Page/潛水艇.md "wikilink")[声纳相似](../Page/声纳.md "wikilink")，他便用聲納的聲音來為程式取名。David
L. Mills曾提出另一個取名：**P**acket **I**nter**n**et
**G**rouper/**G**opher（後者指[地鼠](../Page/地鼠.md "wikilink")）。

[网络管理员之间也常将ping用作动词](../Page/网络管理员.md "wikilink")，如“ping一下计算机XXX，看它是否开着。”
...
反應時間25[毫秒](../Page/毫秒.md "wikilink")，TTL（Time To Live）值為245
由上來看，到google通過255-245 = 10個路由
...
## 相關條目
  ...
  - [死亡之Ping](../Page/死亡之Ping.md "wikilink")

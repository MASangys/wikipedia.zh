...
Pingus 在图形界面下只有22个冬季主题的教学关卡。可是，还有很多关卡可以从命令行进入，而且有些用了完全不同的图像效果。参数如：

> pingus /usr/share/games/pingus/data/levels/playable/cages.pingus

启动了cages.pingus，在playable目录下。

一个支持选择任何安装关卡的Linux shell脚本能在\[5\]找到。

最新版本0.7.6于2011年12月24日发布。
...
## 外部链接
  ...
  - [项目主页](http://pingus.seul.org/)
  - [105个额外关卡](http://www.xskat.de/pingus/pingus.html)
...
3.
4.  [Unix
    Review](http://www.unixreview.com/documents/s=9900/ur0510d/ur0510d.html)

...
每幅作品的页面都设有-{zh-hans:赞; zh-hant:讚}-\[31\]、问卷调查、标签、添加书签、留言和作品回应等功能让其他用户参与进来。每位用户都拥有一个可以自定义的个人主页、類似[BBS](../Page/BBS.md "wikilink")的留言板、活动公告和展示自己喜欢的作品书签栏。用户可以在对方同意的前提下将双方设为好友，发表的各类信息都可以设定成只有好友可见。pixiv设有作品排行榜，每幅作品得到的总分将影响它们在排行榜上的位置。\[32\]

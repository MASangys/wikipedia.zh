Polipo是一个轻量级的[跨平台](../Page/跨平台.md "wikilink")[代理服务器](../Page/代理服务器.md "wikilink")。可以实现[HTTP和](../Page/HTTP.md "wikilink")[SOCKS代理](../Page/SOCKS.md "wikilink")。为了最小化延迟，Polipo[管线化多个资源请求](../Page/HTTP管線化.md "wikilink")，在同一个[TCP/IP连接上](../Page/传输控制协议.md "wikilink")[多路复用](../Page/时分多路复用.md "wikilink")。\[1\]Polipo具有[HTTP](../Page/HTTP.md "wikilink")
1.1兼容，支持[IPv4](../Page/IPv4.md "wikilink")、[IPv6](../Page/IPv6.md "wikilink")，流量过滤和隐私增强。Polipo是[自由软件](../Page/自由软件.md "wikilink")\[2\]，使用[MIT许可证](../Page/MIT许可证.md "wikilink")。\[3\]
...
Polipo具有一个专用的[命令行界面](../Page/命令行界面.md "wikilink")（CLI）的应用程序，需要使用键盘键入命令，并将参数存储在配置文件中。作为替代，Polipo允许自动化和非交互地运行，例如使用[Shell脚本](../Page/Shell.md "wikilink")。通过[图形用户界面用户可以直观地和Polipo进行](../Page/图形用户界面.md "wikilink")[交互](../Page/人机交互.md "wikilink")
...
快速、轻量、小内存占用的代理服务器使用许多技术：\[9\]
  ...
  - Polipo在一定程度上能代替过滤、增强隐私的代理，例如[Privoxy或者](../Page/Privoxy.md "wikilink")[WWWOFFLE](../Page/WWWOFFLE.md "wikilink")。它能够拦截或重定向请求，检查HTTP请求头和引用信息。\[10\]
  - Polipo同时支持IPv4和IPv6，所以Polipo可作为IPv4和IPv6网络之间的桥梁。
  - Polipo支持[SOCKS 4和SOCKS 5协议](../Page/SOCKS.md "wikilink")。
  - Polipo用作[网页快照](../Page/网页快照.md "wikilink")。

...
Poppler本身是Xpdf-3.0，一个由来自Glyph and Cog, LLC 的 Derek Noonburg 开发的 PDF
阅读器的分支。\[4\]\[5\]

项目名称“Poppler”来自动画《[Futurama](https://zh.wikipedia.org/wiki/Futurama "wikilink")》“The
Problem with Popplers”一集。\[6\]
...
Poppler支持使用[JavaScript](../Page/JavaScript.md "wikilink")，注释和表单的可交互式文档，\[14\]
但还不支持呈现完整的XFA表单。\[15\]

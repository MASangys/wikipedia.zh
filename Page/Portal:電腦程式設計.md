...
{{/box-header|電腦程式設計主题|Portal:電腦程式設計/简介|}}  {{/box-footer|}}
...
{{/box-header|分类|Portal:電腦程式設計/分类|}}  {{/box-footer|}}

{{/box-header|相關主題|Portal:電腦程式設計/相關主題|}}  {{/box-footer|}}

{{/box-header|维基专题|Portal:電腦程式設計/维基专题|}}  {{/box-footer|}}

{{/box-header|维基媒体计划|Portal:電腦程式設計/维基媒体计划|}}  {{/box-footer|}}

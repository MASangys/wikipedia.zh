...
computer**，通常简称**Praat**，是一款[跨平台的多功能](https://zh.wikipedia.org/wiki/跨平台 "wikilink")[语音学专业](../Page/语音学.md "wikilink")[软件](../Page/软件.md "wikilink")，主要用于对[数字化的](../Page/数字化.md "wikilink")[语音](https://zh.wikipedia.org/wiki/语音 "wikilink")[信号进行](https://zh.wikipedia.org/wiki/信号 "wikilink")[分析](https://zh.wikipedia.org/wiki/语音分析 "wikilink")、标注、[处理及](../Page/数字信号处理.md "wikilink")[合成等实验](../Page/语音合成.md "wikilink")，同时生成各种[语图和文字报表](https://zh.wikipedia.org/wiki/语图 "wikilink")。

## 背景概要

### 命名

*Praat*（[国际音标](https://zh.wikipedia.org/wiki/国际音标 "wikilink")
或）在[荷兰语中是](https://zh.wikipedia.org/wiki/荷兰语 "wikilink")**说话**或**交谈**的意思，而*doing
phonetics by
...
作者为以上平台的用户提供已[编译好的](https://zh.wikipedia.org/wiki/编译 "wikilink")[目标文件](../Page/目标代码.md "wikilink")。高级用户还可以在其他[操作系统平台上修改并编译源代码后运行Praat程序](../Page/操作系统.md "wikilink")。
...
对语音信号的分析与标注是Praat的基本功能。在Praat中录音或读取音频文件后，可以按用户要求显示以下多种**语图**：
  ...
  - 音高（即[基频](https://zh.wikipedia.org/wiki/基频 "wikilink")\[4\]）曲线（pitch
    contour）
...
### 缺点
  ...
  - 不能直接访问某些常用音频和图像文件格式，如[WMA格式](https://zh.wikipedia.org/wiki/WMA "wikilink")；对[MP3格式的支持也仅限读取](https://zh.wikipedia.org/wiki/Mp3 "wikilink")（[软件许可证方面的原因](../Page/软件许可证.md "wikilink")）。
  ...
  - 尚未全面支援[Unicode](https://zh.wikipedia.org/wiki/Unicode "wikilink")。档案名称如果包含[汉字](../Page/汉字.md "wikilink")，在Praat对象窗口中会被底线取代。在TextGrid对象中如果输入[汉字](../Page/汉字.md "wikilink")，屏幕上会显示乱码（但所储存文本仍旧正常，只是显示不出来）。标注时所使用的[国际音标字型为](https://zh.wikipedia.org/wiki/国际音标 "wikilink")[SIL
    Doulos
...
### 影响
  ...
  - 尽管还存在一些缺点和不足，毕竟瑕不掩瑜，Praat已成为全世界[实验语音学](https://zh.wikipedia.org/wiki/实验语音学 "wikilink")、[心理语言学](../Page/心理语言学.md "wikilink")、[语言教学](https://zh.wikipedia.org/wiki/语言教学 "wikilink")、[语言调查](https://zh.wikipedia.org/wiki/语言调查 "wikilink")、[自然语言处理等相关领域的高校教师](../Page/自然语言处理.md "wikilink")、学生和其他研究人员普遍选用的专业软件。
  - Praat的普及，终结了从事实验语音学特别是[声学语音学](https://zh.wikipedia.org/wiki/声学语音学 "wikilink")\[9\]研究必须依赖价格昂贵的实验仪器的时代，许多语音学实验室不再使用各种陈旧的[语图仪](https://zh.wikipedia.org/wiki/语图仪 "wikilink")，而仅仅配置有安装了Praat等软件的个人计算机和灵敏的[麦克风作为必备的器材](../Page/麦克风.md "wikilink")。

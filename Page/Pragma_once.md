...
請參考[include防範裡其中一種狀況的範例或其他的使用方法](https://zh.wikipedia.org/wiki/include防範 "wikilink")。如下：
...
| [Comeau C/C++](https://zh.wikipedia.org/wiki/Comeau_C/C++ "wikilink")                   | 支持\[5\]               |
| [C++Builder XE Seattle](https://zh.wikipedia.org/wiki/C++Builder_XE_Seattle "wikilink") | 支持\[6\]               |
| [Digital Mars C++](https://zh.wikipedia.org/wiki/Digital_Mars_C++ "wikilink")           | 支持\[7\]               |
| [GCC](https://zh.wikipedia.org/wiki/GNU_Compiler_Collection "wikilink")                 | 支持\[8\]（3.4版本以后\[9\]） |
| [Intel C++編譯器](../Page/Intel_C++編譯器.md "wikilink")                                      | 支持\[10\]              |
| [Microsoft Visual C++](../Page/Microsoft_Visual_C++.md "wikilink")                      | 支持\[11\]              |
| [Pelles C](https://zh.wikipedia.org/wiki/Pelles_C "wikilink")                           | 支持\[12\]              |
| [IAR C/C++](https://zh.wikipedia.org/wiki/IAR_C/C++ "wikilink")                         | 支持\[13\]              |

...
修改HTTP请求头的字段，如Referrer和[用户代理](../Page/用户代理.md "wikilink")（User
Agent），从而隐藏用户上一个查看的网页和用户正在使用的浏览器。\[7\]
...
[Category:转发代理](https://zh.wikipedia.org/wiki/Category:转发代理 "wikilink")

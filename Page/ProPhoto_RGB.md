...
ProPhoto RGB和其他色彩空間的開發記錄在一篇文章\[2\]中，該文章總結了其現任澳大利亞佳能信息系統研究部高級研究經理的開發人員Geoff Wolfe博士在柯達公司IS＆T / SPIE彩色成像2011年會議的演講。
...
## 觀察環境
  ...
  - 標準[參考白點由CIE標準光源D](https://zh.wikipedia.org/wiki/白点 "wikilink")50的色度（x = 0.3457, y = 0.3585）決定。
...
X'_\\mathrm{ROMM} = I_\\mathrm{MAX} \\cdot \\begin{cases} 0; & X_\\mathrm{ROMM} \< 0.0 \\\\ 16\\cdot X_\\mathrm{ROMM}; & 0.0 \\le X_\\mathrm{ROMM} \< E_t \\\\ X_\\mathrm{ROMM}^{1/1.8}; & E_t \\le X_\\mathrm{ROMM}\<1.0 \\\\ 1; & X_\\mathrm{ROMM} \\ge 1.0 \\end{cases} </math>
...
## 外部連結
  ...
  - [瞭解ProPhoto RGB（英文）](https://luminous-landscape.com/understanding-prophoto-rgb/)
  - [超越Adobe RGB的色彩空間（英文）](http://www.naturephotographers.net/articles1203/mh1203-1.html)

...
PuTTY包括了：
  ...
  - 支援[IPv6連線](../Page/IPv6.md "wikilink")。
  - 可以控制SSH連線時加密協定的種類。
...
## 第三方支援
  ...
  - [PieTTY是以PuTTY為底而發展的衍生版本](../Page/PieTTY.md "wikilink")，主要的改進為使用者介面及在多語環境（尤其是中日韓語系）的強化。
...
[Category:自由終端模擬器](https://zh.wikipedia.org/wiki/Category:自由終端模擬器 "wikilink")
[Category:使用MIT许可证的软件](https://zh.wikipedia.org/wiki/Category:使用MIT许可证的软件 "wikilink")
[Category:自由软件](https://zh.wikipedia.org/wiki/Category:自由软件 "wikilink")

1.
2.  [A.10.3 What does ‘PuTTY’
    mean?](https://www.chiark.greenend.org.uk/~sgtatham/putty/faq.html#faq-meaning)

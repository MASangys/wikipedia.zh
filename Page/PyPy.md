...
Python创建的项目。此外，PyPy比[CPython更灵活](../Page/CPython.md "wikilink")，易于使用和试验，以制定具体的功能在不同情况的实现方法，可以很容易实施。该项目的目标是，让PyPy比[C实现的Python更为容易地适应各个项目和方便裁剪](../Page/C.md "wikilink")。\[1\]
...
## 外部链接
  ...
  - [Python in Python: The PyPy
    ...
    PyPy設計師在[史丹佛大學講課](../Page/史丹佛大學.md "wikilink")（[視頻點播](http://ee380.stanford.edu/cgi-bin/videologger.php?target=110302-ee380-300.asx)）

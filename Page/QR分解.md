**QR分解法**是三種将[矩阵分解的方式之一](../Page/矩阵分解.md "wikilink")。這種方式，把[矩阵分解成一个](../Page/矩阵.md "wikilink")[正交矩阵与一个](../Page/正交矩阵.md "wikilink")[上三角矩阵的积](../Page/上三角矩阵.md "wikilink")。QR分解经常用来解[线性最小二乘法问题](../Page/线性最小二乘法.md "wikilink")。QR分解也是特定[特征值算法即](../Page/特征值算法.md "wikilink")[QR算法的基础](../Page/QR算法.md "wikilink")。
...
[幺正矩阵](../Page/幺正矩阵.md "wikilink")（在*Q*<sup>∗</sup>*Q* =
*I*的意义上）和\(m\)×\(n\)上三角矩阵的乘积。

如果*A*是[非奇异的](../Page/可逆矩阵.md "wikilink")，且限定*R* 的对角线元素为正，则这个因数分解是唯一的。

## QR分解的求法

QR分解的实际计算有很多方法，例如[Givens旋转](../Page/Givens旋转.md "wikilink")、[Householder变换](../Page/Householder变换.md "wikilink")，以及[Gram-Schmidt正交化等等](../Page/Gram-Schmidt正交化.md "wikilink")。每一种方法都有其优点和不足。

### 使用Householder变换

[Householder变换将一个向量关于某个](../Page/Householder变换.md "wikilink")[平面或者](../Page/平面.md "wikilink")[超平面进行反射](../Page/超平面.md "wikilink")。我们可以利用这个操作对\(m \times n ( m \geqq n)\)的矩阵\(A\)进行QR分解。
...
接下来，设\(\mathbf{e}_1\)为单位向量\((1, 0, \cdots, 0)^T\)，||·||为[欧几里的范数](../Page/范数#.E6.AC.A7.E5.87.A0.E9.87.8C.E5.BE.B7.E8.8C.83.E6.95.B0.md "wikilink")，\(I\)为\(m \times m\)单位矩阵，令

**qmake**是一個協助簡化[跨平台進行專案開發的構建過程的工具程式](../Page/跨平台.md "wikilink")，[Qt附帶的工具之一](../Page/Qt.md "wikilink")
...
开发，如自动的包含[moc](../Page/moc.md "wikilink") 和
[uic](../Page/uic.md "wikilink") 的编译规则。

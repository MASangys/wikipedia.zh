...
latest_preview_version = 4.10 Beta 2\[2\] | latest_preview_date =  |
...
最後在2009年3月3日正式發布（連同Qt 4.5），並提供LGPL許可的源代碼。\[7\]
...
您可以使用程式碼編輯器編寫 Qt **C++** 的程式碼或
**[QML](../Page/QML.md "wikilink")**(JavaScript) 描述性程式語言。
...
推薦使用使用版本控制系統來建構專案。Qt Creator 使用版本控制系統的命令列客戶端來訪問您的倉庫。Qt
Creator集成了多数流行的版本控制系统：
...
6.
7.  [Qt 4.5, Qt Creator
    released](http://www.qtsoftware.com/about/news/nokia-releases-new-qt-developer-offerings-to-increase-productivity-and-performance)
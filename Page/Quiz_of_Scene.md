> 本文内容由[Quiz of Scene](https://zh.wikipedia.org/wiki/Quiz_of_Scene)转换而来。
...
## 收視率
  ...
  - 以下紀錄《**Quiz of Scene**》節目收視，收視最低的集數以表示，收視最高的集數以表示，而空格則表示該集的收視沒有相關數據。
...
## 外部連結
  ...
  - [官方網站](http://program.tving.com/xtvn/scenesquiz?rcnt=1)

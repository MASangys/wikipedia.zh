> 本文内容由[Q学习](https://zh.wikipedia.org/wiki/Q学习)转换而来。
...
这是一个由[DeepMind](../Page/DeepMind.md "wikilink")公司开发的利用深度[卷积神经网络](../Page/卷积神经网络.md "wikilink")来进行Q-学习的算法。在使用非线性函数逼近的时候，强化学习经常会有不稳定性或者发散性：这种不稳定性来于当前的观测中有比较强的自相关。DeepMind 通过使用经历回放，也就是每次学习的时候并不直接从最近的经历中学习，而是从之前的经历中随机采样来进行训练。

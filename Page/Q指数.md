[Qexp.gif](https://zh.wikipedia.org/wiki/File:Qexp.gif "fig:Qexp.gif")
**Q指数**是指数函数的Q模拟，定义如下
...
其中, \(E_q(t)\) 是[基本超几何函数的特例](../Page/基本超几何函数.md "wikilink"):
...
<!-- end list -->
  ...
  - Gasper G., and Rahman, M. (2004), *Basic Hypergeometric Series*,
    Cambridge University Press, 2004, ISBN 0521833574

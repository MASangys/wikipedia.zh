**RDFa**是一個[W3C推薦標準](../Page/W3C推薦標準.md "wikilink")。它擴充了[XHTML的幾個屬性](../Page/XHTML.md "wikilink")，網頁製作者可以利用這些屬性在網頁中添加可供机器读取的[後設資料](../Page/後設資料.md "wikilink")。與[RDF資料模型的對應關係使得RDFa可以將RDF的](../Page/RDF.md "wikilink")[三元组嵌入在XHTML文档中](../Page/三元组.md "wikilink")，它也使得符合標準的使用端可以從RDFa文件中提取出這些RDF三元组來。

W3C的「XHTML內的RDF」小組也在討論如何在非XML的HTML下實作RDFa\[1\]。主要的問題是在非XML的HTML裡無法使用[XML名稱空間](../Page/XML名稱空間.md "wikilink")。
...
RDFa一開始是被Mark
Birbeck提出的，那是一份W3C筆記，標題為「XHTML與RDF」\[3\]，這個想法在[W3C的](../Page/W3C.md "wikilink")2004年技術交流會的語意網興趣群組上被提出了\[4\]。那年後來，這個想法被寫入了XHTML
...
這些屬性分別是：
  ...
  - **about** –
    一個URI或是[CURIE](../Page/CURIE.md "wikilink")，用來指出這份後設資料要描述的主語
...
另外RDFa可以增進一個網頁的[網頁親和力](../Page/網頁親和力.md "wikilink")，畢竟[輔助科技軟體可以使用更多的機械可讀資料](../Page/輔助科技.md "wikilink")。\[13\]
...
## 參見
  ...
  - [Microdata (HTML5)](../Page/Microdata_\(HTML5\).md "wikilink") –
    一個在HTML5被提出的功能，增強微格式可用性
  - [eRDF](../Page/eRDF.md "wikilink") – 類似RDFa的一種格式
  - [GRDDL](../Page/GRDDL.md "wikilink") –

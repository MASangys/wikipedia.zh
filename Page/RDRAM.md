...
**RDRAM**）是[Rambus公司設計製造的一種同步](../Page/Rambus.md "wikilink")[DRAM](../Page/Dynamic_Random_Access_Memory.md "wikilink")。

## 實際應用

### 個人電腦

最初支援RDRAM的電腦[主機板是在](../Page/主機板.md "wikilink")1999年登場。這些產品與PC-800
RDRAM相容，以400[MHz頻率工作並具有](../Page/MHz.md "wikilink")1600[MB](../Page/MB.md "wikilink")/s的傳輸速度，使用184針的RIMM插座。

資料在時脈訊號的上升(Positive Edge Trigger，PET)與下降(Negative Edge
Trigger，NET)皆傳輸資料([雙向數據](../Page/雙向數據.md "wikilink"))。由於[銷售需要](../Page/銷售.md "wikilink")，命名方面為時脈頻率的二倍(避免與
DDR
...
除此之外，如果主機板使用[雙通道架構的記憶體子系統](../Page/雙通道.md "wikilink")，則需要將所有記憶體管道同時升級。16位元的模組提供1條記憶體管道，32位元則提供2條。因此，在接受16位元模組的雙管道主機板上，需要成對安裝RIMM。而相容32位元模組的雙管道主機板，則可以逐條安裝RIMM。
...
Rambus的RDRAM最初在1996年的[任天堂](../Page/任天堂.md "wikilink")[電視遊戲主機](../Page/遊戲機.md "wikilink")「[Nintendo
64](../Page/Nintendo_64.md "wikilink")」(N64)上使用。N64使用4[MB](../Page/MB.md "wikilink")
9Bit[匯流排](../Page/匯流排.md "wikilink")，工作於500MHz的RDRAM，提供了500MB/s的傳輸速度。受惠於RDRAM簡單的設計，N64得以確保較大的記憶體傳輸速度。而受惠於RDRAM狹窄的匯流排寬度，主機板的電路設計師得以使用單純的設計方式降低成本。然而，在隨機存取方面的延遲較高的缺點為人所詬病。N64為RDRAM模組使用了一套被動散熱系統用來冷卻[1](https://web.archive.org/web/20090430131325/http://n64.icequake.net/)。

[SONY在](../Page/SONY.md "wikilink")[PlayStation
...
DRAM](../Page/XDR_DRAM.md "wikilink") ，採用256MB，具有8倍於前者的傳輸速度\[1\](與 DDR
比較)，400MHz
...
[Cirrus
Logic公司在](../Page/Cirrus_Logic.md "wikilink")*Laguna*顯示晶片家族中的兩個產品使用RDRA。分別是僅有2D的5462和帶有3D加速的2D晶片5464。

該晶片不僅利用RDRAM的高傳輸速度，更提供了成本方面的優點。此晶片在[CreativeのGraphics](../Page/クリエイティブテクノロジー.md "wikilink")
Blaster MA3xx系列等使用。
...
PC-800
RDRAM工作在45[納秒的等待時間](../Page/納秒.md "wikilink")，這是當時同與之競爭的DRAM技術相比較高的等待時間。RDRAM的記憶體晶片比SDRAM晶片發出更大的熱量，所以所有的RIMM皆需要散熱片。RDRAM每片記憶體晶片皆內建了控制器、與[北橋晶片上配置單一的記憶體控制器的SDRAM相比製造上大幅複雜](../Page/北橋晶片.md "wikilink")。RDRAM由於較高的製造成本和授權費，與PC-133
...
最普通的Rambus記憶體控制器的設計，是將記憶體模組成對安裝做為前提。剩下未使用的記憶體插座必須安裝[CRIMM](../Page/CRIMM.md "wikilink")。追加的CRIMM模組並不會增加記憶體的容量，只是為了不使主機板上的信號發生反射而傳達的相對於終端抵抗的信號。右下角的圖像是CRIMM模組。

伴隨[Intel
840](../Page/Intel晶片組列表#Pentium_II/Pentium_III晶片組.md "wikilink")（[Pentium
III](../Page/Pentium_III.md "wikilink")）、[Intel
850](../Page/Intel晶片組列表#Pentium_4晶片組.md "wikilink")（[Pentium
4](../Page/Pentium_4.md "wikilink")）, [Intel
860](../Page/Intel晶片組列表#Pentium_4晶片組.md "wikilink")（[Pentium 4
Xeon](../Page/Xeon#Xeon_（NetBurst微架構世代）.md "wikilink")）[晶片組的登場](../Page/晶片組.md "wikilink")，[Intel增加了對增至](../Page/Intel.md "wikilink")32位而實現雙倍傳輸速度的雙管道PC-800
RDRAM的支援。隨後，[i850E晶片組導入了PC](../Page/i850E.md "wikilink")-1066
RDRAM，雙管道時的合計傳輸速度擴大到了4200MB/s。2002年，Intel發佈了[E7205](../Page/E7205.md "wikilink")
...
1998年實施的[基準測試中](../Page/基準測試.md "wikilink")，大部分的[應用程式在RDRAM下工作低速](../Page/應用程式.md "wikilink")。RDRAM使用[UMA比SDRAM產品相比僅僅是高速](../Page/統一記憶體架構.md "wikilink")，Intel
...
440BX的基準測試中](../Page/Intel_440BX.md "wikilink")，由於使用Rambus晶片組而獲得性能提高的，除了[工作站用途之外](../Page/工作站.md "wikilink")，與440BX晶片組和PC-133
SDRAM相比，價錢的大幅提高並不正常。[4](http://www.tomshardware.com/1999/12/15/the_rdram_avenger_/)。

後來在2002年，單管道DDR
SDRAM模組和[SiS](../Page/SiS.md "wikilink")648組合時，實際的應用程序性能與雙管道1066MHz
RDRAM和Intel
...
1996年11月，Rambus 與[Intel簽訂了開發與授權協議](../Page/Intel.md "wikilink")。\[3\]
在與DDR
SDRAM比較中認識了RDRAM的優越性後，Intel對於Wintel開發社群發表了自公司[微處理器僅會支援Rambus記憶體介面的聲明](../Page/微處理器.md "wikilink")，\[4\]Intel獲取了Rambus公司以每股10美元100万股股票的購買權。

1998年，Intel為了加速Direct RDRAM的導入，計劃了對[Micron
Technology進行](../Page/Micron_Technology.md "wikilink")5億美元的資本投資。\[5\]作為額外的投資，還有1999年支付給[Samsung的](../Page/Samsung.md "wikilink")1億美元等。

作為移行的戰略，Intel計畫在將來的Intel 82x晶片組上使用[Memory Transfer
Hub](../Page/Intel_820#MTH.md "wikilink") (MTH)以支援PC-133 SDRAM
...
865和](../Page/Intel晶片組列表#Pentium_4晶片組.md "wikilink")[Intel
875晶片組](../Page/Intel晶片組列表#Pentium_4晶片組.md "wikilink")，作為取代Intel
...
(DRDRAM)](../Page/it:DRAM#Direct_Rambus_DRAM_\(DRDRAM\).md "wikilink")

> 本文内容由[REBOOT \(Wonder Girls專輯\)](https://zh.wikipedia.org/wiki/REBOOT_\(Wonder_Girls專輯\))转换而来。
...
| ------------------------------------------------------------------ | ------- |
| 週榜                                                                 | 月榜      |
| 韓國[gaon數位綜合榜](https://zh.wikipedia.org/wiki/Gaon_Chart "wikilink") | 3\[5\]  |
| 韓國gaon音源下載榜                                                        | 3\[6\]  |
| 韓國gaon線上音源榜                                                        | 2\[7\]  |
| 韓國gaon背景音樂服務榜                                                      | 27\[8\] |
| 韓國gaon手機鈴聲榜                                                        | 6\[9\]  |
...
| ------------------------------------------------------------- | ------- |
| 週榜                                                            | 月榜      |
| 韓國[gaon](https://zh.wikipedia.org/wiki/Gaon_Chart "wikilink") | 5\[10\] |
| 美國[告示牌](https://zh.wikipedia.org/wiki/告示牌 "wikilink")         | 2\[11\] |
| \- 表示未統計                                                      |         |

### 韓國音源榜

| 排行榜（2015年）           | 〈I Feel You〉最高名次 | 〈Candle〉最高名次 | 〈Baby Don't Play〉最高名次 |
| -------------------- | ---------------- | ------------ | --------------------- |
| 實時榜                  | 日榜               | 週榜           | 實時榜                   |
| iChart               | 1                | \-           | 1                     |
| Melon                | 1                | 1            | 1                     |

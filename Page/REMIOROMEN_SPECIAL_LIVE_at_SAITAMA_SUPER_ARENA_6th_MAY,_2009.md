...
<!-- end list -->
  ...
  - Remioromen首張2枚組DVD。收錄曲為2009年1月至4月底進行以「風的濃度」專輯為基底的巡迴演唱會。

<!-- end list -->

  - 單曲「[愛情的預感](https://zh.wikipedia.org/wiki/愛情的預感 "wikilink")」同時發售。
      - 與「愛情的預感」的連動特典申請序號封入。集一個序號可以換原創待機畫面Flash，集二個換Remioromen的賀年卡(明信片式)。

<!-- end list -->

  - 這次演唱會首次公開演唱「Starting Over」。

...
**RLC电路**是一种由[电阻](../Page/电阻.md "wikilink")（R）、[电感](../Page/电感.md "wikilink")（L）、[电容](../Page/电容.md "wikilink")（C）组成的[电路结构](../Page/电路.md "wikilink")。[LC电路是其简单的例子](../Page/LC电路.md "wikilink")。RLC电路也被称为二阶电路，电路中的[电压或者](../Page/电压.md "wikilink")[电流是一個二阶](../Page/电流.md "wikilink")[微分方程的解](../Page/微分方程.md "wikilink")，而其係數是由电路结构决定。

若电路元件都视为线性元件时，一个RLC电路可以被视作电子[谐波振荡器](../Page/谐波振荡器.md "wikilink")。

这种电路的[固有频率一般表示为](../Page/固有频率.md "wikilink")：（单位：赫兹Hz）

\[f_c = {1 \over 2 \pi \sqrt{L C}}\]

RLC电路常用來作[带通滤波器或](../Page/带通滤波器.md "wikilink")[带阻滤波器](../Page/带阻滤波器.md "wikilink")，其[Q因子可以由下式得到](../Page/Q因子.md "wikilink")：

\[Q = {f_c \over B_W} = {2 \pi f_c L \over R} = {1 \over \sqrt{R^2 C / L}}\]

RLC电路的组成结构一般有两种：分別是串联型及并联型。

[Tuned_circuit_animation_3.gif](https://zh.wikipedia.org/wiki/File:Tuned_circuit_animation_3.gif "fig:Tuned_circuit_animation_3.gif")（无电阻的RLC电路）的工作。电荷在电容器极板和电感之间来回传递。能量在电容器的[电场](../Page/电场.md "wikilink")
*(E)* 和电感的[磁场](../Page/磁场.md "wikilink") *(B)* 之间来回振荡。
RLC电路工作情况类似，不同之处在于，由于电路中的电阻，随着时间变化振荡电流衰减至零。\]\]
...
在此电路中，三个元件均与电压以串联方式连接。其主要的微分方程可将三个元件的[本构方程代入](../Page/本构方程.md "wikilink")[基尔霍夫电压定律](../Page/基尔霍夫电压定律.md "wikilink")（KVL）获得。由基尔霍夫电压定律：
...
根据不同的阻尼系数\(\zeta\)的值，该微分方程的解法有三种不同的情况，分别为：[欠阻尼](../Page/阻尼#欠阻尼.md "wikilink")（\(\scriptstyle \zeta < 1 \,\)），[过阻尼](../Page/阻尼#过阻尼.md "wikilink")（\(\scriptstyle \zeta > 1 \,\)），以及[临界阻尼](../Page/阻尼#临界阻尼.md "wikilink")（\(\scriptstyle \zeta = 1 \,\)）。该微分方程的[特征方程为](../Page/特征方程.md "wikilink")：
...
*A*<sub>2</sub>由具体问题的[边界条件给出](../Page/边界条件.md "wikilink")。
...
通过[三角恒等式](../Page/三角恒等式#线性组合.md "wikilink")，这两个三角函数可用一个有[相位的](../Page/相位.md "wikilink")[正弦函数表达](../Page/正弦函数.md "wikilink")：\[6\]

\[i(t) = B_3 e^{-\alpha t} \sin (\omega_d t + \varphi) \,\]

欠阻尼响应是一个频率为\(\omega_d \,\)的衰减的振荡。振荡衰减的速率为\(\alpha\)。指数里的\(\alpha\)描述了振荡的[包络函数](../Page/包络函数.md "wikilink")。*B*<sub>1</sub>
...
可以利用[拉普拉斯轉換分析RLC串聯電路的交流暫態及穩態行為](../Page/拉普拉斯轉換.md "wikilink")\[10\]。若上述電壓源產生的波形，在拉普拉斯轉換後為*V*(*s*)（其中*s*為[複頻率](../Page/S平面.md "wikilink")\(s = \sigma + i \omega \,\)），則在拉普拉斯域中應用[基爾霍夫電壓定律](../Page/基爾霍夫電壓定律.md "wikilink")：
...
*Y*(*s*)
的[极点是使得](../Page/极点_\(代数\).md "wikilink")\(Y(s)\rightarrow \infty\)
的*s*，求解二次方程，可得：
...
正弦稳态可通过令\(s = j \omega\)来表示，其中\(j\)为[虚数单位](../Page/虚数单位.md "wikilink")。
...
如图7所示，电阻与电感串联的并联LC电路是有必要考虑到线圈卷线的电阻时经常遇到的一种拓扑结构。并联LC电路经常用于[带通滤波中](../Page/带通滤波器.md "wikilink")，而
...
其中\(Q_L=\frac{\omega'_0L} {R}\)是线圈的[品质因数](../Page/品质因数.md "wikilink")。这可以下式很好地近似\[16\]

> 本文内容由[RNA複製酶](https://zh.wikipedia.org/wiki/RNA複製酶)转换而来。
...
所有的RNA複製酶和不少RNA聚合酶都有一個摺疊結構。這個摺疊結構與三個亞結構域相連。上面三個結構域的形狀和人的右手想像，因而分別被稱爲「四指」（fingers）、「手掌」（palm）、「拇指」（thumb）\[5\]。其中，只有手掌亞結構域有一個由四條反向平行的多肽鏈構成的[β-折疊結構和兩個](https://zh.wikipedia.org/wiki/β-折疊 "wikilink")[α-螺旋結構](https://zh.wikipedia.org/wiki/α-螺旋 "wikilink")，在各類RNA複製酶中高度保守。其中，手掌亞結構域有三個高度保守的基元（A、B，以及C）。基元A（D-x(4,5)-D）和基元C（GDD）在空間上並列。這兩個基元中的天冬氨酸[殘基與鎂離子和錳離子相連](https://zh.wikipedia.org/wiki/殘基 "wikilink")。而B基元中的天冬酰胺殘基則與在脫氧三磷酸核苷中選擇三磷酸核糖核苷的過程有關，上述過程可以確保合成的是RNA而不是DNA\[6\]。RNA複製酶的結構域的組織形式保守\[7\]，其催化中心也是一樣。RNA複製酶的催化中心是由一系列包含保守的氨基酸殘基的基元組成的，即使在同源性不高的編碼序列下也保守。

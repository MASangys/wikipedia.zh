...
可更換式槍管使得RPK-16可在各種戰術任務當中使用：裝有長度為550毫米（21.65英寸）的長槍管的機槍（當它被配置／用作班用自動武器的用途時）可在任何條件以下的一般作戰當中，用作[步兵班](../Page/步兵班.md "wikilink")的支援和壓制武器；而裝上長度為370毫米（14.57英寸）的短槍管時（當它被配置／用作突擊武器的用途時），它可以成為用於[特种行动當中](https://zh.wikipedia.org/wiki/特种行动 "wikilink")，包括在城市條件以下的個人“突擊機槍”——在這種配置以下，RPK-16僅比AK-12機槍重約一公斤。它的設計使它具有可以互換的兩根槍管，並可以很容易地將其拆卸下來，這亦將過去槍管固定不能更換而不能作長時間壓制射擊以及只屬於重槍管自動步槍的影響加以消除。 射手可在數分鐘以內，而且無需使用特殊工具以下自行更換槍管。槍管是以橫向楔形桿與機匣緊固地連接。\[10\]在特種行动時，該機槍可於槍口裝快拆式[抑制器](../Page/抑制器.md "wikilink")。該機槍的槍托不單有著四段伸縮位置，還可向左折疊。可由射手自行週節的表尺式瞄準具可用以協助瞄準有效射程以內的目標。
...
## 使用國
  ...
  -   - [俄羅斯聯邦武裝力量](https://zh.wikipedia.org/wiki/俄羅斯聯邦武裝力量 "wikilink")： 2018年2月，卡拉什尼科夫集團的總幹事阿列克謝·克里沃庫奇宣布，現已與[俄羅斯聯邦國防部簽署了RPK](https://zh.wikipedia.org/wiki/俄羅斯聯邦國防部 "wikilink")-16的持續供貨合約。\[12\]\[13\]
...
## 參考
  ...
  - [斯太爾AUG LMG](https://zh.wikipedia.org/wiki/斯泰爾AUG突擊步槍#衍生型 "wikilink")
  ...
  - [L86A1 LSW](https://zh.wikipedia.org/wiki/SA80突擊步槍#L86_LSW "wikilink")
  ...
  - [FN IAR（FN HAMR）](https://zh.wikipedia.org/wiki/FN_SCAR突擊步槍#FN_IAR "wikilink")

  - [M6A4 IAR](https://zh.wikipedia.org/wiki/LWRC_M6突擊步槍#M6A4 "wikilink")
...
## 外部連結
  ...
  - —[Modern Firearms—Kalashnikov RPK-16 light machine gun](http://world.guns.ru/machine/rus/rpk16-e.html)

  - —[The Firearm Blog.com—Russia Adopts the RPK-16 Light Machine Gun](https://www.thefirearmblog.com/blog/2018/02/06/russia-adopts-the-rpk-16-light-machine-gun/)

  - —[New Russian light machine gun born from iconic Kalashnikov heads for tests](https://www.rt.com/russia/451836-new-russian-machine-gun/)

  - —[Military, Security and Civilian Guns and Equipment—Kalashnikov RPK-16](https://www.militaryfactory.com/smallarms/detail.asp?smallarms_id=1096)

  - —[Новый РПК 16 - ручной пулемет](http://www.armoury-online.ru/articles/add_articles/rpk-16/)

...
作為微軟公司的標準文件，早期外間需要向微軟付款數十美元，才能購買一本薄薄的RTF標準文件。不過随着採用RTF格式標準的軟件愈來愈多，RTF格式也愈來愈普遍，微軟公司就把標準文件公開，放在網上供開發者下載。

RTF 的標準握在微軟公司手裏。最新版本為2008年的 1.9.1 版，包括了 [Office 2007](https://zh.wikipedia.org/wiki/Office_2007 "wikilink") 新增的功能。微軟現已不再對 RTF 規格作更新，Word 2010 或以後版本新增的功能，無法正確儲存到 RTF 格式\[1\]。
...
## 支持软件
  ...
  - [WordPad](../Page/WordPad.md "wikilink")（[Microsoft Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")）/ [文本編輯](https://zh.wikipedia.org/wiki/文字編輯_\(應用程式\) "wikilink")（[Mac OS](https://zh.wikipedia.org/wiki/Mac_OS "wikilink")）
  - [Microsoft Word](../Page/Microsoft_Word.md "wikilink")
  - [Apache OpenOffice](../Page/Apache_OpenOffice.md "wikilink") / [LibreOffice](https://zh.wikipedia.org/wiki/LibreOffice "wikilink")

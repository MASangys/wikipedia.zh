**RTFM**，是一個[英文](https://zh.wikipedia.org/wiki/英文 "wikilink")[縮寫](../Page/縮寫.md "wikilink")，意思是：「去讀那些他媽的手冊」（**R**ead
**T**he **F**ucking
**M**anual），這句話通常用在回覆那些只要查閱文件就可以解決，拿出來提問只是浪費別人時間的問題。而為了避免這個縮寫單詞，因為用了「fuck」（[他媽的](https://zh.wikipedia.org/wiki/他媽的 "wikilink")）這個單詞而攻擊性、火藥味太重，RTFM也被解釋成「去讀那些愚蠢的手冊」（Read
...
在某些加入[大英國協的國家中](https://zh.wikipedia.org/wiki/大英國協 "wikilink")，許多[黑客則傾向使用](../Page/黑客.md "wikilink")**RTBM**，同樣意指「去讀那些天殺的手冊」（**R**ead
**T**he **B**loody
**M**anual），原因是在這些國家中，[bloody](https://zh.wikipedia.org/wiki/wikt:bloody "wikilink")
與 fuck
一字同義，不過在[美國則較少有這種用法](https://zh.wikipedia.org/wiki/美國 "wikilink")。

與這個字類似的黑客用語還包括： **RTFS** ：「去讀該死的原始碼」（Read The Fucking Source） **RTFB**
：「去讀該死的已編譯程式」（Read The Fucking
Binary），常常也以[星際大戰中的台詞](../Page/星際大戰.md "wikilink")「用原力啊，[路克](https://zh.wikipedia.org/wiki/路克·天行者 "wikilink")」（Use
...
的場合，往往是因為程式執行檔案已經過於老舊，而且欠缺文件，唯一能夠瞭解程式的方法就是直接閱讀[機器碼](https://zh.wikipedia.org/wiki/機器碼 "wikilink")，使用太過攻擊性的詞彙，實在不妥。

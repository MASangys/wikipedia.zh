**RabbitMQ**是实现了（AMQP）的开源软件（亦称）。RabbitMQ服务器是用[Erlang语言编写的](../Page/Erlang.md "wikilink")，而群集和故障转移是构建在[開放電信平台框架上的](../Page/開放電信平台.md "wikilink")。所有主要的编程语言均有与代理接口通讯的客户端[函式庫](../Page/函式庫.md "wikilink")。

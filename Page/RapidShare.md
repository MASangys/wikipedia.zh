...
[上傳](https://zh.wikipedia.org/wiki/上傳 "wikilink")[檔案](../Page/檔案.md "wikilink")後，Rapidshare為用戶提供了一個獨特的[下載網址](https://zh.wikipedia.org/wiki/下載 "wikilink")，使任何人都可以下載文件。用戶不可以搜索伺服器的內容以下載文件，所有文件都必須經特定的[網址下載](https://zh.wikipedia.org/wiki/網址 "wikilink")。\[2\]
...
高級用戶只能使用一段時間，以[中歐時間為準](https://zh.wikipedia.org/wiki/中歐時間 "wikilink")。因此，一個在[中歐時間](https://zh.wikipedia.org/wiki/中歐時間 "wikilink")23時59分開設的30天賬戶將在一分鐘後開始運行29天。每個高級帳戶只有每月最多150 GB的上下載量。如果在一個月內有30天，則用戶每一天將可以下載5GB的檔案。用戶可以累積高達25 GB的上下載量，並可以一下子全數使用。\[5\]
...
該軟件比Rapidshare上載器有更多的功能，尤其是排隊上傳和恢復上傳以及下載（只限高級會員，免費用戶無法恢復）。只限[Windows Vista使用](../Page/Windows_Vista.md "wikilink")。
...
## 外部連結
  ...
  - [RapidShare.com](https://web.archive.org/web/20080504015753/http://rapidshare.com/)
  - [RapidShare.de](https://web.archive.org/web/20140110215048/http://rapidshare.de/)

[Category:檔案傳載網站](https://zh.wikipedia.org/wiki/Category:檔案傳載網站 "wikilink")

1.
2.
3.  [RapidShare](http://rapidshare.com/) : Retrieved on April 13 2008.
4.  [RapidShare News](http://rapidshare.com/news.html) : Retrieved 2 March 2010.
5.
6.
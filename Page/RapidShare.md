...
截至2009年5月，高級帳戶的下載限制制定為5 GB。未使用的則自動推遲到下一天，但以限額為25
GB。如果一次用完全部上下載量，用戶在第二天可以再下載5
GB的文件。
...
該軟件比Rapidshare上載器有更多的功能，尤其是排隊上傳和恢復上傳以及下載（只限高級會員，免費用戶無法恢復）。只限[Windows
Vista使用](../Page/Windows_Vista.md "wikilink")。
...
4.  [RapidShare News](http://rapidshare.com/news.html) : Retrieved 2
    March 2010.
5.
6.
...
此專輯共分為三種發行版本，分別為CD+DVD版本、CD版本、PlayButton（徽章播放器）的初回限定版本。

  - CD+DVD+數位音源&影像（編號：AVCY-58580）：此版本設有豪華特別的[Box進行包裝](https://zh.wikipedia.org/wiki/盒子 "wikilink")，並附[QR碼及音樂用](../Page/QR碼.md "wikilink")[PIN碼可用於](https://zh.wikipedia.org/wiki/PIN碼 "wikilink")[智慧型手機收聽音樂及觀看影像](https://zh.wikipedia.org/wiki/智慧型手機 "wikilink")，專輯內容物含一片收錄12首歌曲的CD和一片收錄於日本武道館舉行首場海外Showcase、5部音樂錄影帶及製作花絮錄像的DVD。

<!-- end list -->

  - CD+數位音源（編號：AVCY-58581）：此版本附QR碼及音樂用PIN碼可用於智慧型手機收聽音樂，專輯內容物含一片收錄6首歌曲的CD。

<!-- end list -->

  - 初回限定盤 PlayButton（編號：AVZY-58501）：此版本為徽章播放器，共收錄6首歌曲，以PlayButton
    MP3形式發售。

...
### 重要新功能
  ...
  - 改进磁盘结构可靠性
    ...
    ReFS对所有存储在磁盘上的结构使用[B+树](../Page/B+树.md "wikilink")，包括所有元数据和文件数据。\[10\]\[11\]元数据和文件数据被组成一个类似[关系数据库的数据表](../Page/关系数据库.md "wikilink")。文件大小、[文件夹内的文件数和卷总大小及卷中文件夹数量都采用](../Page/目录_\(文件系统\).md "wikilink")64位数字；因此，ReFS支持最多16[EB的文件大小](../Page/艾字节.md "wikilink")，最多18.4
    × 10<sup>18</sup>个目录和最大1[YB](../Page/尧字节.md "wikilink")（64
    KB[簇的卷](../Page/簇.md "wikilink")），这允许较大的可扩展性，对文件和目录大小没有实际限制（硬件限制仍适用）。空闲空间是由一个分层分配器计算，其中包括三个单独的表，分别保存大、中、小块。
...
:\*
因为ReFS不是为应对故障设计，如果它发生故障，目前没有工具来修复它。第三方工具只能[逆向工程该系统](../Page/逆向工程.md "wikilink")，截至2014年只有寥寥几个工具。\[29\]
...
## 外部链接
  ...
  - [Analysis of detailed differences between NTFS and ReFS in
    Server 2012, and reasons for choosing one or the
    other](http://kx.cloudingenium.com/microsoft/servers/windows-servers/windows-server-2012/windows-server-2012-file-system-resiliency-refs-data-deduplication-ntfs/)
...
5.
6.
7.  Elena Pakhomova of ReclaiMe.com (2012-Aug-08, BEFORE the release of
    Win8\!)
...
18.
19.
20. [Windows Server 2012: Does ReFS replace
    NTFS?](http://blogs.technet.com/b/askpfeplat/archive/2013/01/02/windows-server-2012-does-refs-replace-ntfs-when-should-i-use-it.aspx)
21.
22.
23.
24.
25.
26. Elena Pakhomova of ReclaiMe.com (2012-Aug-08, BEFORE the release of
    Win8\!)
    <http://www.smallnetbuilder.com/nas/nas-features/31836-data-recovery-tales-when-windows-storage-spaces-go-bad>
27. Elena Pakhomova of ReclaiMe.com (2012-Aug-08, BEFORE the release of
    Win8\!)
    <http://www.smallnetbuilder.com/nas/nas-features/31836-data-recovery-tales-when-windows-storage-spaces-go-bad>
28.
29.

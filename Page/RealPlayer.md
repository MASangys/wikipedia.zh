...
RealPlayer除了其基本作為音訊和視訊的播放器以外，亦包括了下列的額外功能：
  ...
  - **視訊下載**：Windows版的第11版容許用戶從[YouTube之類的網站下載視訊](../Page/YouTube.md "wikilink")，並把它在電腦上儲存成為MPEG或MP4格式。Mac版本允许下载，允许存为FLV格式。（只接受[Internet
    Explorer下載](../Page/Internet_Explorer.md "wikilink")）
...
[RealMa-Annoying-Spam-ScreenCapture-20080516.png](https://zh.wikipedia.org/wiki/File:RealMa-Annoying-Spam-ScreenCapture-20080516.png "fig:RealMa-Annoying-Spam-ScreenCapture-20080516.png")
...
RealNetworks
Scheduler（檔案名稱：**realsched.exe**、**Evntsvc.exe**或**TkBellExe**，視乎版本而定）是一個隨同RealPlayer安裝的背景程序。它原來的用途是保持RealPlayer的更新，在電腦連線上網後，能夠適時收到軟件的重要更新。有指，因此過往有些用戶會在網上討論區發問移除有關軟件的辦法。這個檔案對於Windows及RealPlayer來說都並非必需的部份，但會佔用系統記憶約136kB，因此在一般機構的環境下，它的存在需要不大。而透過Windows的系統設定軟件或中等的電腦技術，可從系統中停止有關檔案的運行。
...
對於以前版本的軟體，有兩種商業解決方案：
  ...
  - [Sanyo 3D
    Surround](https://web.archive.org/web/20070312144055/http://www.real.com/accessories/ads/html/s3s.html?lang=en&loc=zz&src=082504_intl_acc)
    插件功能同上，但不會禁用RealPlayer的聲音控制。
...
## 外部連結
  ...
  - [RealPlayer Enterprise
    Download](https://web.archive.org/web/20080608173716/http://forms.real.com/rnforms/products/tools/red/index.html)
  - ["How to get spyware-free RealPlayer through the BBC" - Boing
    Boing](http://www.boingboing.net/2004/02/01/how-to-get-spywarefr.html)
  - Real Alternative 輕量化的RealPlayer
  - [Real Alternative
    Lite](http://www.free-codecs.com/download/Real_Alternative_Lite.htm)
    同Real Alternative，只去掉軟體撥放器
...
1.
2.  [Release
    History](http://www.realnetworks.com/company/press/releases/2006/patent_cts.html)

3.  [RealPlayer - Multiple
    Editions](http://www.realnetworks.com/products/media_players.html)

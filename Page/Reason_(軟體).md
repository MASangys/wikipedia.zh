...
在4.0的版本中，可以使用的模組包括有：
  ...
  - Subtractor：減算合成器
  - Malström:[graintable合成器](https://zh.wikipedia.org/wiki/granular_synthesis "wikilink")
  - NN-19：標準的數位取樣機，可載入預錄的樂器及人聲
  - NN-XT：先進的數位取樣機，特色是可調整預錄樣本或音色其顫音、震盪，以及濾波器的參數
  - Dr Rex：循環播放裝置，將預錄樣本分割成可管理的Bite大小的單元
  - Redrum：鼓機，附有64-step樣式編曲器，可播放預錄的鼓及效果樣本庫
  - Thor：半模組化的[複音合成器](https://zh.wikipedia.org/wiki/複音 "wikilink")。波表、[頻率調變以及向位調製合成](https://zh.wikipedia.org/wiki/頻率調變 "wikilink")，可透過各種濾波器模組去安排。

...
Hat公司發行的一个](https://zh.wikipedia.org/wiki/Red_Hat "wikilink")[Linux发行套件](https://zh.wikipedia.org/wiki/Linux发行套件 "wikilink")。

Red Hat
Linux可算是一個「中年」的Linux發行套件，其1.0版本於1994年11月3日發行。雖然其歷史不及[Slackware般悠久](https://zh.wikipedia.org/wiki/Slackware_Linux "wikilink")，但比起很多的Linux發行套件，Red
Hat的歷史悠久得多。
...
以Red Hat
Linux为基礎派生的Linux發行套件有很多，其中包括以[桌面用戶為目標的](https://zh.wikipedia.org/wiki/桌面 "wikilink")[Mandrake
Linux](https://zh.wikipedia.org/wiki/Mandrake_Linux "wikilink")（原為包含[KDE的Red](../Page/KDE.md "wikilink")
Hat Linux），[Yellow Dog
Linux](../Page/Yellow_Dog_Linux.md "wikilink")（開始時為支援[PowerPC的Red](../Page/PowerPC.md "wikilink")
Hat
Linux）和[ASPLinux](https://zh.wikipedia.org/wiki/ASPLinux "wikilink")（對非拉丁字元有較好支援的Red
Hat Linux）。
...
Core發行版本](https://zh.wikipedia.org/wiki/Fedora_Core "wikilink")。

## 特性

Red Hat
Linux擁有一個圖形化的安裝程序[Anaconda](../Page/Anaconda.md "wikilink")，目的是為了令新手更容易使用。同時，它有一個內建的[防火牆設置工具](https://zh.wikipedia.org/wiki/防火墙_\(计算机\) "wikilink")[Lokkit](https://zh.wikipedia.org/wiki/Lokkit "wikilink")。

由Red Hat Linux
8.0開始，[UTF-8成為了系統預設的字元編碼設定](../Page/UTF-8.md "wikilink")。這對於英語用戶來說無甚影響，但當用到[ISO/IEC
8859-1字元集的較高位置字元時](https://zh.wikipedia.org/wiki/ISO/IEC_8859-1 "wikilink")，編碼方式則完全不同。對於部分[法語或](https://zh.wikipedia.org/wiki/法語 "wikilink")[瑞典語的用户來說](../Page/瑞典語.md "wikilink")，這是一個冒犯性的舉動，這問題可以透過移除"LANG"設定中的".UTF-8"來解決。

8.0版本亦是第一個使用Bluecurve桌面主題的發行版本。

因為可能發生的[版權或](https://zh.wikipedia.org/wiki/版權 "wikilink")[專利權問題](https://zh.wikipedia.org/wiki/專利權 "wikilink")，Red
Hat
...
Vorbis取而代之](https://zh.wikipedia.org/wiki/Ogg_Vorbis "wikilink")，但用戶可以自行安裝[MP3的支持](../Page/MP3.md "wikilink")。Red
...
Linux的國家列表中，將原本的「臺灣」改稱「中國台灣」，並移除[中華民國國旗](https://zh.wikipedia.org/wiki/中華民國國旗 "wikilink")\[1\]，此舉引發臺灣自由軟體界抵制Red
...
*Fedora Core的發行歷史請參見[Fedora
Core條目](https://zh.wikipedia.org/wiki/Fedora_Core "wikilink")*

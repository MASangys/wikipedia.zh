...
`Sitemap`指令被几大搜索引擎支持（包括[Google](../Page/Google.md "wikilink")、[Yahoo](https://zh.wikipedia.org/wiki/Yahoo "wikilink")、[Bing和](../Page/Bing.md "wikilink")[Ask](../Page/Ask.com.md "wikilink")），指定了网站[Sitemaps文件的位置](https://zh.wikipedia.org/wiki/Sitemaps "wikilink")。Sitemaps文件包含了网站页面所在的URL的一个列表。`Sitemap`指令并不受`User-agent`指令的限制，所以它可以放在robots.txt文件中的任意位置。\[4\]

...
接受端將檔案[拷貝打散成固定大小為](https://zh.wikipedia.org/wiki/拷貝 "wikilink")\(S\)的不重疊片段，並對每個片段計算兩個[校验和](https://zh.wikipedia.org/wiki/校验和 "wikilink")：[MD4](https://zh.wikipedia.org/wiki/MD4 "wikilink")[散列函數與一個較弱的](../Page/散列函數.md "wikilink")[輪替校验和](https://zh.wikipedia.org/wiki/輪替校验和 "wikilink")（rolling

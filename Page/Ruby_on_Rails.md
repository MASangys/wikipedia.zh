****（官方简称为Rails，亦被简称为RoR），是一个使用[Ruby语言写的](../Page/Ruby.md "wikilink")[开源](../Page/开源.md "wikilink")[Web應用框架](../Page/Web應用框架.md "wikilink")，它是严格按照[MVC结构开发的](../Page/MVC.md "wikilink")。它努力使自身保持简单，来使实际的应用开发时的代码更少，使用最少的配置。
...
於2004年7月，Rails的創始人[大衛·漢森從](../Page/大衛·漢森.md "wikilink")[37signals公司的項目管理工具Basecamp裡面分離出Ruby](../Page/37signals.md "wikilink")
on Rails，並且以開源方式發佈。

Rails在發佈以後的短短的時間內就迅速獲得很多開發人員歡迎，大衛認為這歸功於Rails設計為opinionated
software。Rails當中有很多規矩從一開始就按照David的意見制定好了，所以在Rails上開發應用程序時，開發人員可以專注於應用程序自身的設計，省卻那些花在瞭解及配置基礎框架上面的時間。這也正是Rails很重要的精神「[約定優於配置](../Page/約定優於配置.md "wikilink")」，開發人員遵照Rails本身的慣例便可以省卻配置組態檔的時間；此外，Rails雖然強調慣例的重要及便利性，但針對不同的需求，Rails也提供修改的空間讓開發人員可以進行自訂的組態。
...
[ActionMailer用来发送和接收](../Page/ActionMailer.md "wikilink")[email](../Page/email.md "wikilink")。

### Web服务：ActionWebService

[ActionWebService来提供](../Page/ActionWebService.md "wikilink")[SOAP和](../Page/SOAP.md "wikilink")[XML-RPC支持](../Page/XML-RPC.md "wikilink")。需要注意的是，Rails趋向使用更加简单明瞭的REST方式web服务而不再提倡SOAP格式的web服务。ActionWebServices在未来的版本裡面会逐步淡出。
...
[AJAX](../Page/AJAX.md "wikilink")（非同步JavaScript與XML）是一種非同步傳輸介面，可以藉由[浏览器使用](../Page/浏览器.md "wikilink")[JavaScript和](../Page/JavaScript.md "wikilink")[XML或其他数据格式来處理傳輸請求](../Page/XML.md "wikilink")，而将[Web服务器作为](../Page/Web服务器.md "wikilink")[后台来处理](../Page/后台.md "wikilink")，这样无须载入额外的[网页](../Page/网页.md "wikilink")。Rails內建有[Prototype套件來實現这个技术](../Page/Prototype_\(框架\).md "wikilink")。Ajax已经和Ruby
...
1.2更加倾向于是用[REST方式的web服务](../Page/REST.md "wikilink")，而ActionWebService在Rails
2.0中作为plugin而不再是rails核心的一部分。

## Web服务器支持

对于开发和测试来说，一个很轻量的[WEBrick網頁服务器已经被包含在了Ruby中](../Page/WEBrick.md "wikilink")，常被用来作为应用服务器。而对于生产应用，常推荐使用带[FastCGI的](../Page/FastCGI.md "wikilink")[Apache或者](../Page/Apache.md "wikilink")[Lighttpd](../Page/Lighttpd.md "wikilink")，但任何支持[CGI或者](../Page/CGI.md "wikilink")[FastCGI的網頁伺服器都可以使用](../Page/FastCGI.md "wikilink")。在Apache上，mod_ruby也可以考虑用来提高性能。

## 數據庫支持

使用Rails的架構開發網絡應用一般都使用數據庫，所以推薦使用一個[關聯式資料庫系統來進行數據存儲](../Page/RDBMS.md "wikilink")，若不能運行一個關聯式資料庫服務器，Rails支持嵌入式數據庫[SQLite](../Page/SQLite.md "wikilink")。Rails還支持關聯式資料庫系統，包括[MySQL](../Page/MySQL.md "wikilink")、[PostgreSQL](../Page/PostgreSQL.md "wikilink")、[IBM
DB2](../Page/IBM_DB2.md "wikilink")、[Oracle和](../Page/Oracle.md "wikilink")[SQL
Server](../Page/SQL_Server.md "wikilink")。

## 系统要求

  - [Ruby语言](../Page/Ruby.md "wikilink")
  - [Web服务器](../Page/Web.md "wikilink")，如[Apache](../Page/Apache.md "wikilink")、[lighttpd等](../Page/lighttpd.md "wikilink")。
  - [FastCGI](../Page/FastCGI.md "wikilink")，或者[Mongrel为了提高效率](../Page/Mongrel.md "wikilink")
  - 数据库和驱动程序

## 集成开发环境

开发用的IDE有：[Eclipse](../Page/Eclipse.md "wikilink")，[MyEclipse](../Page/MyEclipse.md "wikilink")，[NetBeans](../Page/NetBeans.md "wikilink")，[RubyMine](../Page/RubyMine.md "wikilink")，[Aptana](../Page/Aptana.md "wikilink")，[Sublime
...
### [Elixir語言](../Page/Elixir.md "wikilink")
  ...
  - [Phoenix Framework](../Page/Phoenix_\(web_framework\).md "wikilink")

### [Node.js環境](../Page/Node.js.md "wikilink")

  - [Sails.js](../Page/Sails.js.md "wikilink")
...
### 其他
  ...
  - [Fast-track your Web apps with Ruby on
    ...
    Mertz](../Page/David_Mertz.md "wikilink") article at IBM
    [developerWorks](../Page/developerWorks.md "wikilink")）
  - [Ruby on

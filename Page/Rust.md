...
年首次揭露了它的存在\[5\]。也在同一年，其[編譯器原始碼開始由原本的](../Page/編譯器.md "wikilink")
...
(compile time) 錯誤\[16\]。 函數可以使用[泛型化參數](../Page/泛型.md "wikilink")
...
2009年，Graydon Hoare成为[Mozilla雇员](../Page/Mozilla.md "wikilink")\[17\]。

2010年，Rust首次作为Mozilla官方项目出现\[18\]。同年，Rust开始从初始编译（由[OCaml写成](../Page/OCaml.md "wikilink")）转变为自编译\[19\]。

2011年，Rust成功的完成了移植\[20\]。Rust的自编译器采用[LLVM作为其编译后端](../Page/LLVM.md "wikilink")。
...
下面是三个不同版本的阶乘函数，分别以[递归](../Page/递归.md "wikilink")、[循环和](../Page/迭代.md "wikilink")[迭代器的方法写成](../Page/迭代器.md "wikilink")：

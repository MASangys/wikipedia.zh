> 本文内容由[SATA](https://zh.wikipedia.org/wiki/SATA)转换而来。


**串行ATA**（，全称：）是一種[電腦](https://zh.wikipedia.org/wiki/電腦 "wikilink")[匯流排](https://zh.wikipedia.org/wiki/匯流排 "wikilink")，負責[主機板和大容量儲存裝置](https://zh.wikipedia.org/wiki/主機板 "wikilink")（如[硬碟及](https://zh.wikipedia.org/wiki/硬碟 "wikilink")[光碟機](https://zh.wikipedia.org/wiki/光碟機 "wikilink")）之間的數據傳輸，主要用於個人電腦。串行ATA與[串列SCSI](../Page/串列SCSI.md "wikilink")（SAS: Serial Attached SCSI）的兩者排線相容，SATA硬碟可接上SAS介面。

...
实现SAX了的解析器拥有[事件驱动式的API](../Page/事件驱动.md "wikilink")，并像流读取器那样工作。由使用者定义[回调函数](../Page/回调函数.md "wikilink")，解析时，若发生事件的话会被调用。SAX事件包括：
...
SAX解析器在某些方面優於DOM風格解析器。SAX解析器的[記憶體使用量一般遠低於DOM解析器使用量](../Page/主記憶體.md "wikilink")。DOM解析器在任何處理開始之前，必須把整棵樹放在記憶體，所以DOM解析器的記憶體使用量完全根據輸入資料的大小。相對來說，SAX解析器的記憶體內容，是只基於XML檔案的最大深度（XML樹的最大深度）和單一XML項目上XML屬性儲存的最大資料。這兩個總是比整顆解析樹本身還小。
...
某些種類的[XML驗證需要存取整份文件](../Page/XML驗證.md "wikilink")。例如，一個[DTD](../Page/文件類型描述.md "wikilink")
...
### 其他XML處理技術
  ...
  - [文檔對象模型](../Page/文檔對象模型.md "wikilink")

  - [XSL Transformations (XSLT)](../Page/XSLT.md "wikilink")

  -
  - [System Integrated Automation
    parser](../Page/System_Integrated_Automation_parser.md "wikilink")

### 支援SAX的解析器及API

  - [Xerces](../Page/Apache_Xerces.md "wikilink")
  - [MSXML](../Page/MSXML.md "wikilink")
  - [Crimson XML](../Page/Crimson_XML.md "wikilink")
  - [JAXP](../Page/JAXP.md "wikilink") - Java XML解析API
  - [LibXML](../Page/LibXML.md "wikilink")
  - [AVHTML](https://github.com/avplayer/avhtml) - 轻量级C++ HTML Parser

## 參考

  - [David Brownell](../Page/David_Brownell.md "wikilink")：*SAX2*,
    O'Reilly, ISBN 0-596-00237-8
  - [W. Scott Means](../Page/W._Scott_Means.md "wikilink")，[Michael A.
    Bodie](../Page/Michael_A._Bodie.md "wikilink")：*The Book of SAX*, No
    Starch Press, ISBN 1-886411-77-8

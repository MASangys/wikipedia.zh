...
单曲分为「CD+DVD」「只CD」「Bigeast盤」三种版本发行。距离上张单曲发行约两个半个月，是2013年的第3张单曲。附属DVD中收录了《SCREAM》的[MV和MV的拍摄过程](https://zh.wikipedia.org/wiki/MV "wikilink")（只在初回限定盘中收录）。

初回限定版本封入特典是封面大小的卡片（6種中随机封入1种）。「只CD」版本有CD-EXTRA与单曲封面拍摄花絮收录。

主打歌《SCREAM》在“東方神起 LIVE TOUR 2013 〜TIME〜 FINAL in NISSAN STADIUM”巡演中初次披露。
...
1.  《SCREAM》（Video Clip）
2.  《SCREAM》（Video Clip） -Off Shot Movie- （只初回限定盤有收录）

### 只CD

1.  《SCREAM》
2.  《Disvelocity》
3.  《SCREAM 〜the other side mix》 \[3:56\]
4.  《SCREAM》 -Less Vocal-
...
### Bigeast盤
  ...
  - CD与\[CD+DVD\]版同内容。
  - \[CD-EXTRA\]收录有「東方神起 LIVE TOUR 2013 〜TIME〜」的预览映像。

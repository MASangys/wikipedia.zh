...
SETL提供了几个[迭代器，可以在聚合数据结构上生成各种循环](../Page/迭代器.md "wikilink")。
...
根据[吉多·范罗苏姆的说法](../Page/吉多·范罗苏姆.md "wikilink")，“[Python](../Page/Python.md "wikilink")
...
*SET 语言
2*（SETL2）是SETL的一个不向后兼容的后继者，由纽约大学Courant数学科学研究所的柯克斯奈德于二十世纪八十年代后期创建。与其前身一样，它基于有限集的理论和符号，但也受到Ada语言的语法和风格的影响。

*交互式SET语言*（ISETL）是[离散数学中使用的SETL变体](../Page/离散数学.md "wikilink")。
...
## 进一步阅读
  ...
  - Schwartz，Jacob
    T.，“关于编程，关于SETL项目的中期报告”，计算机科学系，Courant数学科学研究所，纽约大学（1973）。
  - Schwartz，Jacob T.，Dewar，RBK，Dubinsky，E。和Schonberg，E。， *Programming
    With Sets：An Introduction to SETL* ，1986。
    [国际标准书号](https://zh.wikipedia.org/wiki/International_Standard_Book_Number "wikilink")
     
    [0-387-96399-5](https://zh.wikipedia.org/wiki/Special:BookSources/0-387-96399-5 "wikilink")
    。

**标准通用标记语言**（，）是现时常用的[超文本格式的最高层次标准](../Page/超文本.md "wikilink")，是可以定义标记语言的[元语言](https://zh.wikipedia.org/wiki/元语言 "wikilink")，甚至可以定义不必采用\<
\>的常规方式。由于它的复杂，因而难以普及。
...
XML的产生就是为了简化它，以便用于更加通用的目的，比如[语义Web](https://zh.wikipedia.org/wiki/语义Web "wikilink")。它已经应用于大量的场合，比较著名的有[XHTML](../Page/XHTML.md "wikilink")、[RSS](../Page/RSS.md "wikilink")、[XML-RPC和](../Page/XML-RPC.md "wikilink")[SOAP](https://zh.wikipedia.org/wiki/SOAP "wikilink")。

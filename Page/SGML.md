...
[HTML](../Page/HTML.md "wikilink")和[XML](../Page/XML.md "wikilink")同样衍生于它：XML可以被认为是它的一个子集，而HTML是它的一个应用。

XML的产生就是为了简化它，以便用于更加通用的目的，比如[语义Web](https://zh.wikipedia.org/wiki/语义Web "wikilink")。它已经应用于大量的场合，比较著名的有[XHTML](../Page/XHTML.md "wikilink")、[RSS](../Page/RSS.md "wikilink")、[XML-RPC](../Page/XML-RPC.md "wikilink")和[SOAP](https://zh.wikipedia.org/wiki/SOAP "wikilink")。

> 本文内容由[SHOWTA. BEST](https://zh.wikipedia.org/wiki/SHOWTA._BEST)转换而来。
...
發售型態分為通常盤（CD ONLY）和初回限定盤（CD+DVD）兩種，初回限定盤中收錄SHOWTA.時期的MV。

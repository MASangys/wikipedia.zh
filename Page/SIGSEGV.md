...
执行了一个无效的内存引用，或发生[段错误时发送给它的](../Page/段错误.md "wikilink")[信号](../Page/信号_\(计算机科学\).md "wikilink")。SIGSEGV的[符号常量在](../Page/C语言预处理器.md "wikilink")[头文件](../Page/头文件.md "wikilink")
...
对于不正确的内存处理（见[段错误](../Page/段错误.md "wikilink")），计算机程序可能抛出SIGSEGV。[操作系统](../Page/操作系统.md "wikilink")
可能使用信号[栈](../Page/堆栈.md "wikilink")
向一个处于自然状态的应用程序通告错误，由此，开发者可以使用它来[调试](../Page/调试.md "wikilink")
程序或处理错误。

在一个程序接收到SIGSEGV时的默认动作是异常终止。这个动作也許會结束[进程](../Page/行程.md "wikilink")
，但是可能生成一个[核心文件](../Page/核心文件.md "wikilink") 以帮助调试，或者执行
一些其他特定于某些平台的动作。例如，使用了[grsecurity补丁的](../Page/grsecurity.md "wikilink")[Linux](../Page/Linux.md "wikilink")
系统可能记录SIGSEGV信号以监视可能的使用[缓存溢出](../Page/缓存溢出.md "wikilink") 的攻击尝试。
...
，它可能检查信号栈并通知[开发者](../Page/软件设计师.md "wikilink")
目前所发生的，以及程序终止的位置。

SIGSEGV通常由[操作系统](../Page/操作系统.md "wikilink")
生成，但是有适当权限的用户可以在需要时使用`kill`[系统调用或](../Page/系统调用.md "wikilink")[kill命令](../Page/kill_\(Unix\).md "wikilink")（一个[用户级程序](../Page/用户级_\(计算机科学\).md "wikilink")，或者一个[shell内建命令](../Page/Unix_shell.md "wikilink")）来向一个进程发送信号。
...
[en:SIGSEGV](../Page/en:SIGSEGV.md "wikilink")

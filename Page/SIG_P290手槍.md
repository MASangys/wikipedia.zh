...
SIG
P290是一款適合個人自衛和[警察等執法機構的](../Page/警察.md "wikilink")的袖珍型手槍，發射[9×19毫米帕拉贝鲁姆](../Page/9×19mm魯格彈.md "wikilink")（9毫米魯格，9毫米北約）手枪子彈。[不鏽鋼套筒表面採用西格](../Page/不鏽鋼.md "wikilink")-紹爾獨有的Nitron塗層[表面處理](https://zh.wikipedia.org/wiki/表面處理 "wikilink")，使其看起來很像黑色。套筒架設在不銹鋼底把以上，而底把位於[聚合物握把部分](../Page/聚合物.md "wikilink")（或外底把）的內部。P290並非模塊化設計，只有一種口徑和底把尺寸。SIG
P290的重量為465克（16.4盎司）。配用彈匣容量為6發和裝有延長底板的8發（延長彈匣）兩種。6發彈匣底部裝有尾指稍息的底板，但原廠也提供無尾指稍息的齊平底板。

SIG
P290具有夜間瞄具。\[1\]\[2\]\[3\]夜間瞄具為附有兩點的缺口式[照門與附有一點的片狀](https://zh.wikipedia.org/wiki/照門 "wikilink")[準星所組成的三點式準星](../Page/照準器.md "wikilink")。西格-紹爾的手槍所裝有的是戰鬥型瞄具。SIG
P290沒有底部附件導軌，但可在防塵蓋的底部安裝專用[雷射瞄準器](https://zh.wikipedia.org/wiki/雷射瞄準器 "wikilink")。隨槍附帶的是其槍套、保險環鎖、彈匣和齊平底板。握把側板可以互換以定制其外觀。SIG
P290為[純雙動操作扳機](https://zh.wikipedia.org/wiki/扳機 "wikilink")（DAO），它可連動擊錘擊發子彈。\[4\]
...
2012年，新型的SIG
P290RS取代了原來的P290型號。主要區別在於純雙動操作扳機（DAO）已經重新設計，具有重新待擊功能（**R**e**s**trike
Capability）。因此，該槍在型號數以後加上RS。如果出現啞火彈，射手現在可以很簡單地再度扣下扳機。而在重新待擊功能重新設計之前，需要射手向後拉動套筒以重置，以試圖擊發首度嘗試時未能點燃的彈藥。
...
## 外部連結
  ...
  - —[SIG-Sauer
    P290](https://web.archive.org/web/20150118080458/http://www.sigsauer.com/CatalogProductList/pistols-p290.aspx)

  - —[Modern firearms—SIG-Sauer P290
    pistol](http://modernfirearms.net/en/handguns/handguns-en/switzerland-semi-automatic-pistols/sig-sauer-p290-eng/)

  - —[D Boy Gun World（槍炮世界）—SIG Sauer
    P290](http://firearmsworld.net/sigsauer/p290/p290.htm)

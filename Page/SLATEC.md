...
| DEPAC                                    | 10   | 否                                                                 | 解 [常微分方程](../Page/常微分方程.md "wikilink")（[龙格－库塔法等](../Page/龙格－库塔法.md "wikilink")）                           |
...
| SLAP                                     | 124  | 是                                                                 | [稀疏](../Page/稀疏矩阵.md "wikilink")[线性代数库](../Page/线性代数.md "wikilink")                                       |
| XERROR                                   | 17   | 否                                                                 | 错误处理                                                                                                      |

## 参考文献

[Category:计算机程序库](https://zh.wikipedia.org/wiki/Category:计算机程序库 "wikilink")
[Category:数值软件](https://zh.wikipedia.org/wiki/Category:数值软件 "wikilink")

1.  <http://www.cisl.ucar.edu/css/software/fishpack/>,
2.  如 <http://www.netlib.org/linpack>
    所说，LINPACK基本已被[LAPACK替代](../Page/LAPACK.md "wikilink")。
在[程序设计](../Page/程序设计.md "wikilink")领域， **SOLID**（**单一功能、开闭原则、里氏替换、接口隔离**以及**依赖反转**）是由[罗伯特·C·马丁在](https://zh.wikipedia.org/wiki/Robert_C._Martin "wikilink")21世纪早期\[1\] 引入的[记忆术](../Page/记忆术.md "wikilink")[首字母缩略字](https://zh.wikipedia.org/wiki/首字母缩略字 "wikilink")\[2\]\[3\]，指代了[面向对象编程和](https://zh.wikipedia.org/wiki/面向对象编程 "wikilink")[面向对象设计](../Page/面向对象设计.md "wikilink")的五个基本原则。当这些原则被一起应用时，它们使得一个[程序员](../Page/程序员.md "wikilink")开发一个容易进行[软件维护和扩展的系统变得更加可能](https://zh.wikipedia.org/wiki/软件维护 "wikilink")。\[4\] SOLID所包含的原则是通过引发编程者进行软件[源代码](../Page/源代码.md "wikilink")的[代码重构](../Page/代码重构.md "wikilink")进行软件的[代码异味](../Page/代码异味.md "wikilink")清扫，从而使得软件清晰可读以及可扩展时可以应用的指南。SOLID被典型的应用在[测试驱动开发](../Page/测试驱动开发.md "wikilink")上，并且是[敏捷开发以及](https://zh.wikipedia.org/wiki/敏捷开发 "wikilink")[自适应软件开发的基本原则的重要组成部分](https://zh.wikipedia.org/wiki/adaptive_programming "wikilink")。\[5\]\[6\]
...
<a href="../Page/依赖注入.md" title="wikilink">依赖注入</a>是该原则的一种实现方式。</p></td>
</tr>
</tbody>
</table>
...
### 基本概念以及相关主题
  ...
  - [面向对象程序设计](../Page/面向对象程序设计.md "wikilink")
      - [继承 (计算机科学)](https://zh.wikipedia.org/wiki/继承_\(计算机科学\) "wikilink")
  - [奥卡姆剃刀](../Page/奥卡姆剃刀.md "wikilink")

### 设计和开发原则

  - [不要重复你自己](https://zh.wikipedia.org/wiki/不要重复你自己 "wikilink")
  - [GRASP (面向对象设计)](https://zh.wikipedia.org/wiki/GRASP_\(面向对象设计\) "wikilink")

...
SPSS 18.0由17個功能模組組成：
  ...
  - Base System基礎程式
  - Advanced Models高等統計模組（GEE/GLM/存活分析）
  - Regression Models進階迴歸模組
  - Custom Tables多變量表格
  - Forecasting時間序列分析
  - Categories類別資料分析/多元尺度方法
  - Conjoint聯合分析
  - Exact Tests精確檢定
  - Missing Value Analysis遺漏值分析
  - Neural Networks類神經網路
  - Decision Trees決策樹
  - Data Preparation資料準備
  - Complex Samples抽樣計畫
  - Direct Marketing直銷行銷模組
  - Bootstrapping拔靴法
  - Data collection Data Entry資料收集
  - Programmability Extension擴充程式碼能力

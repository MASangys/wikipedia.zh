...
SQLAlchemy首次发行于2006年2月，并迅速地在Python社区中最广泛使用的ORM工具之一，不亚于[Django](../Page/Django.md "wikilink")的ORM框架。
...
<!-- end list -->
  ...
  -
  - Rick Copeland, [Essential SQLAlchemy](http://oreilly.com/catalog/9780596516147/), [O'Reilly](https://zh.wikipedia.org/wiki/O'Reilly_Media "wikilink"), 2008, ISBN 0-596-51614-2
...
## 外部链接
  ...
  -
[Category:Python库](https://zh.wikipedia.org/wiki/Category:Python库 "wikilink") [Category:对象关系映射](https://zh.wikipedia.org/wiki/Category:对象关系映射 "wikilink") [Category:使用MIT许可证的软件](https://zh.wikipedia.org/wiki/Category:使用MIT许可证的软件 "wikilink")
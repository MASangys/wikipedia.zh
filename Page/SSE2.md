...
自從GCC
3推出，它能夠自動生成SSE/SSE2純量碼。而SSE/SSE2的[自動向量化也新增在GCC](https://zh.wikipedia.org/wiki/自動向量化 "wikilink")
4。

[Sun Studio Compiler
Suite在使用此](https://zh.wikipedia.org/wiki/Sun_Studio_Compiler_Suite "wikilink")-xvector=simd參數時也能夠產生SSE2指令碼。

## 支援SSE2指令集的處理器

  - [Athlon
    64](https://zh.wikipedia.org/wiki/Athlon_64 "wikilink")、[Sempron
    64](https://zh.wikipedia.org/wiki/Sempron "wikilink")、[Turion
    64等為主的](../Page/Turion_64.md "wikilink")[AMD
    K8架構處理器](../Page/AMD_K8.md "wikilink")
  - [Phenom](https://zh.wikipedia.org/wiki/Phenom "wikilink")、[Phenom
    II](https://zh.wikipedia.org/wiki/Phenom_II "wikilink")、[Athlon
    II等為主的](https://zh.wikipedia.org/wiki/Athlon_II "wikilink")[AMD
    K10](https://zh.wikipedia.org/wiki/AMD_K10 "wikilink")、[AMD
    K10.5架構處理器](https://zh.wikipedia.org/wiki/AMD_K10.5 "wikilink")
  - [Pentium
    4](https://zh.wikipedia.org/wiki/Pentium_4 "wikilink")、[Xeon](https://zh.wikipedia.org/wiki/Xeon "wikilink")、[Celeron](https://zh.wikipedia.org/wiki/Celeron "wikilink")、[Celeron
    D等為主的](https://zh.wikipedia.org/wiki/Celeron_D "wikilink")[Intel](https://zh.wikipedia.org/wiki/Intel "wikilink")[NetBurst架構的處理器](https://zh.wikipedia.org/wiki/NetBurst "wikilink")
  - [Intel Pentium
    M與](https://zh.wikipedia.org/wiki/Intel_Pentium_M "wikilink")[Celeron
    M](https://zh.wikipedia.org/wiki/Celeron_M "wikilink")
  - [Intel
    Core架構的處理器](https://zh.wikipedia.org/wiki/Intel_Core "wikilink")，包括Core
    Duo、Core Solo等
  - [Intel Core
    2架構的處理器](https://zh.wikipedia.org/wiki/Intel_Core_2 "wikilink")，包含Core
    2 Duo、Core 2 Quad、Core 2 Extreme等
  - [Intel Core i3](../Page/Intel_Core_i3.md "wikilink")、[Core
    i5](https://zh.wikipedia.org/wiki/Core_i5 "wikilink")、[Core
    i7等](https://zh.wikipedia.org/wiki/Core_i7 "wikilink")
...
SSE2是[IA-32架構的延伸](https://zh.wikipedia.org/wiki/IA-32 "wikilink")。所以目前所有不支援[IA-32架構的其他架構一概不支援SSE](https://zh.wikipedia.org/wiki/IA-32 "wikilink")2。由於[x86-64架構的處理器是由IA](https://zh.wikipedia.org/wiki/x86-64 "wikilink")-32延伸出來的，所有
x86-64架構的處理器也都支援SSE2指令集。而有些CPU並沒有支援 SSE2，但是有其他的指令集可以提供與SSE2相似的功能。

下列的IA-32架構的處理器是在SSE2發表之後才開發的，但是並不支援SSE2指令集：

  - 比[Athlon64早推出的](https://zh.wikipedia.org/wiki/Athlon64 "wikilink")[AMD處理器](https://zh.wikipedia.org/wiki/AMD "wikilink")，包含了所有使用
    Socket A 插槽的處理器。
  - 比[Pentium

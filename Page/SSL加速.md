...
通常来说，这是一种PCI介面的[擴充卡](https://zh.wikipedia.org/wiki/擴充卡 "wikilink")，其中包括一个或多个處理大量SSL計算的[輔助處理器](../Page/輔助處理器.md "wikilink")。

SSL加速器可以使用现成的CPU，也可以使用[ASIC和](../Page/特殊應用積體電路.md "wikilink")[RISC板卡来完成最艰难的计算工作](../Page/精简指令集.md "wikilink")。
...
现代的[x86](https://zh.wikipedia.org/wiki/x86 "wikilink") CPU支持[AES指令集](../Page/AES指令集.md "wikilink")。

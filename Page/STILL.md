...
单曲分为「CD+DVD」「只CD」「Bigeast盤」三种版本发行。距离上张单曲发行约4个半月。附属DVD中收录了《STILL》的MV与MV的拍摄过程（只在初回限定盘中收录）。

初回限定版本封入特典是封面大小的卡片（6种中随机封入1种）。“只CD”版本有12页豪华手册同捆封入。
...
**DVD**
  ...
  - 《STILL》 -Video Clip-
  - 《STILL》 Off Shot Movie（只初回限定盤有收录）

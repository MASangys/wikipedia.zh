...
STL檔描述原始非結構化由表面[單位](https://zh.wikipedia.org/wiki/單位向量 "wikilink")[法線和由](https://zh.wikipedia.org/wiki/法線 "wikilink")[右手定則](../Page/右手定則.md "wikilink")排序的頂點用三維三角形[笛卡兒座標系](https://zh.wikipedia.org/wiki/笛卡兒座標系 "wikilink")。STL座標必須是[正數](https://zh.wikipedia.org/wiki/正數 "wikilink")，沒有尺度資訊，且[計量單位為任意的](https://zh.wikipedia.org/wiki/計量單位 "wikilink")。\[7\]

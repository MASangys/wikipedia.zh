...
Sabayon的设计目的是给[计算机用户提供一个易于使用的工作空间](https://zh.wikipedia.org/wiki/计算机 "wikilink")，不仅有迷人的界面外观、良好的硬件检测和众多默认安装的最新软件包，还有来自软件仓库的更多软件。Sabayon提供[x86和](../Page/x86.md "wikilink")[AMD64两种架构的发行版](https://zh.wikipedia.org/wiki/AMD64 "wikilink")。

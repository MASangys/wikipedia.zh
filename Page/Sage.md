...
``` python
A = Matrix([[1,2,3],[3,2,1],[1,1,1|1,2,3],[3,2,1],[1,1,1]])
y = vector([0,-4,-1])
A.solve_right(y) # returns (-2, 1, 0)
A.eigenvalues() # returns [5, 0, -1]

B = Matrix([[1,2,3],[3,2,1],[1,2,1|1,2,3],[3,2,1],[1,2,1]])
...
| 3.0       | 2008年4月   |                                                                 |
| 4.0       | 2009年5月   |                                                                 |
| 5.0       | 2012年5月   | [5.0里程碑](http://trac.sagemath.org/sage_trac/milestone/sage-5.0) |
| 6.0       | 2013年12月  |                                                                 |
...
## 参见
  ...
  - [计算机代数系统列表](../Page/计算机代数系统列表.md "wikilink")
...
## 外部链接
  ...
  - [项目主页](http://www.sagemath.org/)
  - [Sage官方文件手册，参考，教程，...](http://www.sagemath.org/doc/index.html)
  - [Sage介绍影片](http://www.sagemath.org/help-video.html)

...
這代取消了心跳感應器，只分別有加速計, 接近度傳感器而電池容量比上代有所提升，可以數據記錄分別有卡路里消耗, 距離, 時間, 速度在手機查閱。


操作有所改變：

  - 單按(播放或暫停音樂)
  - 雙連按(播放下首音樂|接聽來電或結束通話)
  - 三連按(重播上首音樂)
  - 長按(讀出選單或拒絕來電)
  - 雙連長按(播放下一個音樂選單)
  - 向上/向下輕掃(調整音量大/小)
...
<tbody>
<tr class="odd">
<td><p>比上代的 Gear IconX有更好的電池壽命</p>
<p>舒適合身</p>
<p>本地音樂存儲</p></td>
<td><p>不準確的鍛煉記錄</p>
<p>沒有串流音樂整合</p>
<p>某些功能不適用於iOS設備</p></td>
</tr>
</tbody>
</table>
...
整天不能將耳塞放在充電盒裏，因為箱子沒有電源按鈕，而且它一直在充電\[3\]

...
Sharp SX862更支援多種格式如MP3、AAC+、eAAC+、AAC、及M4A 等。
...
Sharp SX862有3.2百萬像素鏡頭，其他功能包括自動對焦、自動曝光操控及補光燈等等。短片攝錄及播放更有VGA 高解像質素。

## 規格表

|         |                                                            |
| ------- | ---------------------------------------------------------- |
| 尺寸      | 110.6 x 50 x 18毫米                                          |
| 重量      | 120克                                                       |
| 通話時間    | 最長可達200分鐘                                                  |
| 備用時間    | 最長可達350小時                                                  |
| 視像通話時間  | 最長可達110分鐘                                                  |
...
| 主屏幕顏色   | 262K                                                       |
| 機身屏幕顏色  | 黑白                                                         |
| 主屏幕解像度  | 854 x 480 解像度                                              |
| 機身屏幕解像度 | 60 x 32 解像度                                                |
| 網絡制式    | HSDPA 3.6Mbps / WCDMA 2100MHz / GSM三頻 900 / 1800 / 1900MHz |
| 內置記憶體   | 50MB                                                       |
| 外置記憶體   | microSD（可支援最高2GB）                                          |

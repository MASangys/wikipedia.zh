...
开发中的 Shoes 4 是一个完全用 Ruby 重写的版本，不再由 C 语言实现。它使用
[JRuby](../Page/JRuby.md "wikilink") + [SWT](../Page/SWT.md "wikilink")
构筑图形界面。
...
[JRuby](../Page/JRuby.md "wikilink") +
[Swing](../Page/Swing_\(Java\).md "wikilink") 的版本等等。

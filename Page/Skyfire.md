...
Skyfire
1.x需要使用[TCP协议的](https://zh.wikipedia.org/wiki/TCP协议 "wikilink")443[端口用于传输网页内容](https://zh.wikipedia.org/wiki/TCP/UDP端口 "wikilink")、[UDP协议用于传输网页上的](../Page/用户数据报协议.md "wikilink")[音频流](https://zh.wikipedia.org/wiki/音频 "wikilink")。因此Skyfire只能在某些[APN上使用](https://zh.wikipedia.org/wiki/APN "wikilink")，如[中国移动运营商](https://zh.wikipedia.org/wiki/中国 "wikilink")[中国移动的CMNET](https://zh.wikipedia.org/wiki/中国移动 "wikilink")、[中国联通的UNINET](https://zh.wikipedia.org/wiki/中国联通 "wikilink")、3GNET。而在[中国移动的CMWAP则不能使用](https://zh.wikipedia.org/wiki/中国移动 "wikilink")。自2010年12月1日起，Skyfire官方已经停止了Skyfire
1.x的服务端中转服务。Skyfire
2.0及以后的版本同样需要使用CMNET或UNINET接入，或者WiFi连接，以正常使用服务器端的[云服务](https://zh.wikipedia.org/wiki/云服务 "wikilink")。Skyfire
3.2-{只}-能在Android 2.x系统中运行。Andriod 1.5/1.6-{只}-能使用旧版的Skyfire 2.3。

## 下载方式

可在官网[get.skyfire.com](https://web.archive.org/web/20090725230258/http://get.skyfire.com/)下载Skyfire的最新版本。或者在[Ovi
...
## 外部链接
  ...
  - [Skyfire
    FAQ](https://web.archive.org/web/20090925080101/http://www.skyfire.com/support/faq/)
  - [Skyfire for
    iPhone](http://itunes.apple.com/us/app/skyfire-web-browser/id384941497?mt=8&ign-mpt=uo%3D4)
  - [Skyfire for
    iPad](http://itunes.apple.com/us/app/skyfire-web-browser-for-ipad/id409153623?mt=8&ign-mpt=uo%3D4)

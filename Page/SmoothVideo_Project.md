...
SVP包括以下三种基本组件：
  ...
  - 基于[MVTools 2.5](http://avisynth.org.ru/mvtools/mvtools2.html)库计算中间帧的脚本。原库进行了改进以使运行速度更快，\[2\]并涵盖了基于[OpenCL](../Page/OpenCL.md "wikilink")[应用程序接口](../Page/应用程序接口.md "wikilink")的[GPU加速版本](https://zh.wikipedia.org/wiki/图形处理器 "wikilink")。因此新版本SVP可以在[兼容的GPU](http://www.svp-team.com/wiki/GPU_Compatibility)上完成接近一半\[3\]的工作；

...
可以使用[npm](https://zh.wikipedia.org/wiki/Node包管理器 "wikilink")（node 软件包）工具来安装。\[2\]
...
[Category:免費軟件](https://zh.wikipedia.org/wiki/Category:免費軟件 "wikilink") [Category:用JavaScript編程的自由軟體](https://zh.wikipedia.org/wiki/Category:用JavaScript編程的自由軟體 "wikilink")

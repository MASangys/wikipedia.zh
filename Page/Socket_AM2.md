...
Socket AM2也是AMD的主流CPU插座之一，另有供Opteron 2000系列以上及Athlon FX-70以上使用的[Socket F](../Page/Socket_F.md "wikilink")，及供行動電腦使用的[Socket S1](https://zh.wikipedia.org/wiki/Socket_S1 "wikilink")。

## 後續

AM3處理器使用新的[記憶體控制器](https://zh.wikipedia.org/wiki/記憶體控制器 "wikilink")，支援DDR2及DDR3；由於AM2處理器只支援DDR2，因此不能用於AM3底板。Socket AM2與[Socket AM3之間有過渡產品](../Page/Socket_AM3.md "wikilink")[Socket AM2+](../Page/Socket_AM2+.md "wikilink")，加入HT3.0支援。

Socket AM3及Socket AM2+處理器可用於Socket AM2底板，只是[系統匯流排](../Page/系統匯流排.md "wikilink")速率會從原HT3.0(5200 MT/s)降至HT1.0(2000MT/s)\[1\]，但非所有主機廠商皆提供[BIOS](../Page/BIOS.md "wikilink")更新。
...
## 外部連結
  ...
  - [AMD：正式全球发布Socket AM2处理器（极速网）](https://web.archive.org/web/20060524175027/http://www.8080.net/html/200605/n231603390.shtml)

**Socket G34**，又稱**LGA
1944**，是[美商超微](../Page/超微半導體.md "wikilink")（AMD）和TE
Connectivity\[1\]設計的中央處理器管腳排列及相應的插座，用於[AMD Opteron
6000系列處理器以及SR](../Page/AMD_Opteron.md "wikilink")5600/SP5100系列晶片組的主機板中。\[2\]除了插座供應商以LGA
1944作爲其零部件名稱以外，坊間也有以插座觸點數來自行命名Socket G34爲**LGA 1974**的説法。\[3\]\[4\]\[5\]

## 技術概況

正如和對手[英特爾常用的可插拔式處理器的插座](../Page/英特爾.md "wikilink")（[行動平台及](../Page/行動平台.md "wikilink")[嵌入式平台除外](../Page/嵌入式系统.md "wikilink")）以及前代的[Socket
F](../Page/Socket_F.md "wikilink")/F+一樣，Socket
G34採用平面網格陣列封裝（LGA），處理器基板上有1,944個觸點，最小間距1.00毫米，而主機板上的處理器插座則有1,974支類似針腳的金屬彈簧片與處理器上的觸點接觸。整個觸點或引腳陣列呈[長方形](../Page/長方形.md "wikilink")，57行×40列。\[6\]\[7\]觸點爲工業鍍[金](../Page/金.md "wikilink")，使用[表面黏著技術以及](../Page/表面黏著技術.md "wikilink")[焊錫球將插座焊接在主機板上](../Page/焊錫.md "wikilink")。\[8\]

採用Socket G34的處理器，均支持四路[HyperTransport
3.0/3.1匯流排](../Page/HyperTransport.md "wikilink")（其中一路用於外部擴展，只有三路用於CPU之間的互聯）和[雙通道/四通道](../Page/多通道記憶體技術.md "wikilink")、可選帶[ECC的](../Page/ECC.md "wikilink")[DDR3-1600](../Page/DDR3_SDRAM.md "wikilink")
UDIMM/RDIMM/LRDIMM內存模塊；[TDP最高達](../Page/TDP.md "wikilink")150W，支援雙路/四路工作方式。\[9\]\[10\]
...
G34平台，相當於形制上將八處理器平台壓縮為四處理器平台規格，而處理器內部的協調運作還是八處理器的操作方式，[作業系統會識別出八個實體處理器](../Page/作業系統.md "wikilink")（節點）。\[13\]而AMD的多處理器平臺均支援[NUMA](../Page/NUMA.md "wikilink")，并且可以在主機板的[BIOS中](../Page/BIOS.md "wikilink")，根據伺服器或工作站的用途手動開啓或關閉。\[14\]

對於純雙處理器工作站/伺服器平台，AMD也推出了同樣是LGA封裝的[Socket
C32對應](../Page/Socket_C32.md "wikilink")，單塊[主機板上安裝的處理器的核心總數](../Page/主機板.md "wikilink")，最多僅為Socket
...
F/[F+的](../Page/Socket_F+.md "wikilink")[Socket
G3和相應的](../Page/Socket_G3.md "wikilink")[記憶體擴充晶片](../Page/記憶體.md "wikilink")[G3MX被完全取消](../Page/Socket_G3_記憶體擴展器.md "wikilink")。\[17\]

最初，AMD雙處理器及四處理器平台[伺服器](../Page/伺服器.md "wikilink")/[工作站用的](../Page/工作站.md "wikilink")[Opteron](../Page/AMD_Opteron.md "wikilink")，包括代號為「Shanghai」4核心處理器、「Istanbul」6核心處理器等45奈米版本K10微架構的處理器，都在Socket
...
採用Socket
G34插座的主機板，到目前為止均採用AMD自家的[SR5600系列晶片組](../Page/AMD_800_芯片组系列.md "wikilink")，而這款晶片組實際上是桌上型電腦平台中，AMD
...
注：[北橋晶片](../Page/北橋.md "wikilink")/[南橋晶片](../Page/南橋.md "wikilink")

### 處理器

2009年推出的45奈米製程、[K10微架構](../Page/AMD_10h.md "wikilink")、核心代號「Magny-Cours」8核心/12核心處理器，以及2011年至2013年間陸續推出的、32奈米製程的[Bulldozer微架構的](../Page/Bulldozer微架構.md "wikilink")「Interlagos」、[Piledriver微架構的](../Page/Piledriver微架構.md "wikilink")「Abu
Dhabi」和「Warsaw」核心代號的伺服器/工作站處理器，均採用了Socket
G34管腳排列，處理器[基板上有](../Page/印刷電路板.md "wikilink")1,944個觸點。\[20\]

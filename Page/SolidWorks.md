...
SolidWorks的是產品設計師和機械工程師使用的軟體，全世界其用戶範圍從個人到大公司，涵蓋非常廣泛的橫截面製造業細分市場。商業銷售是通過間接渠道，其中包括遍及世界各地的交易商和合作夥伴。

## 版本

SolidWorks的CAD軟體，可分3種商業版和3種教育版。

| 版本名称                | 版本号 | 发布日期       |
| ------------------- | --- | ---------- |
| SolidWorks 95       | 1   | 1995年11月   |
| SolidWorks 96       | 2   | 1996       |
| SolidWorks 97       | 3   | 1996       |
| SolidWorks 97Plus   | 4   | 1997       |
| SolidWorks 98       | 5   | 1997       |
| SolidWorks 98Plus   | 6   | 1998       |
| SolidWorks 99       | 7   | 1998       |
| SolidWorks 2000     | 8   | 1999       |
| SolidWorks 2001     | 9   | 2000       |
| SolidWorks 2001Plus | 10  | 2001       |
| SolidWorks 2003     | 11  | 2002       |
| SolidWorks 2004     | 12  | 2003       |
| SolidWorks 2005     | 13  | 2004       |
| SolidWorks 2006     | 14  | 2005       |
| SolidWorks 2007     | 15  | 2006       |
| SolidWorks 2008     | 16  | 2007年7月1日  |
| SolidWorks 2009     | 17  | 2008年1月28日 |
| SolidWorks 2010     | 18  | 2009年12月9日 |
| SolidWorks 2011     | 19  | 2010.06.17 |
| SolidWorks 2012     | 20  | 2011.09    |
| SolidWorks 2013     | 21  | 2012.09    |
| SolidWorks 2014     | 22  | 2013.10.07 |
| SolidWorks 2015     | 23  | 2014.09.09 |
| SolidWorks 2016     | 24  | 2015.10.01 |
| SolidWorks 2017     | 25  | 2016.09.19 |
...
SOLIDWORKS Professional包括SOLIDWORKS的核心產品，另添加幾個-在程序。這些措施包括：

  - Design Checker (設計標準檢查)
  - eDrawings Professional（進階電子工程圖）
  - FeatureWorks（幾何特徵辨識程式）
...
Office Professional add-ins plus the following：
  ...
  - TolAnalyst（GD\&T Tolerance analyse tool，公差分析）
  - CircuitWorks (a bi-directional IDF and PADS file interface)
  - Sustainability (環保綠化指標分析)

### 教育版

  - SolidWorks Student Design Kit

此版本是功能上有限制的SolidWorks教育版本。

  - SolidWorks Education Edition

此版本是一個授權的SolidWorks教育版本。它的用意是教導學生(小學、初中、高中、職業學校、學院和大學)。當要列印時圖紙時有「SolidWorks教育版」的浮水印，。

  - SolidWorks Student Edition

此版本是為學生在課堂以外的地方使用。它包括所有SolidWorks學生版的相同的功能。
...
SolidWorks的開創能力的用戶回滾透過歷史的一部分，以便進行修改、添加額外的功能或改變順序的操作執行。後來基於特徵的實體建模軟件複製這個想法。
...
SolidWorks的合作夥伴與具有黃金夥伴稱號的應用程式都是經由SolidWorks在產品及服務上做其認證，這些產品補足了SolidWorks提供使用者完成機械設計上的問題解決管道（SprutCAM）。

具有黃金夥伴稱號的合作廠商則為軟體公司，這些軟體廠商設計與SolidWorks視窗整合在一起的應用程式。其黃金夥伴所提供的搭配應用程式範圍包括分析（CAE）、電腦輔助製造（CAM）、設計工程製圖、文件管理、以及機構與動力的分析系統等。华东区域的合作伙伴是上海三泽信息技术有限公司

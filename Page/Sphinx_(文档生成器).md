...
reStructuredText是可扩展的，Sphinx通过许多扩展来利用其可扩展性 —
用于从源代码自动生成文档、编写数学符号或突出显示源代码等。
...
Docs项目](https://zh.wikipedia.org/wiki/Read_the_Docs "wikilink")，作为使软件文档维护更容易的努力的一部分。Read
the Docs可以在每次提交之后自动构建和上传Sphinx文档。

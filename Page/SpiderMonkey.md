**SpiderMonkey**是世界上第一款[JavaScript引擎](../Page/JavaScript引擎.md "wikilink")，由前[网景公司的](../Page/网景公司.md "wikilink")[布兰登·艾克設計](../Page/布兰登·艾克.md "wikilink")，後期由[Mozilla基金会維護](../Page/Mozilla基金会.md "wikilink")，以[開放原始碼發佈](../Page/開放原始碼.md "wikilink")。目前為[Mozilla
Firefox](../Page/Mozilla_Firefox.md "wikilink")[網頁瀏覽器所使用的](../Page/網頁瀏覽器.md "wikilink")[JavaScript引擎](../Page/JavaScript.md "wikilink")，並也被嵌入到其他許多環境，例如[GNOME
3桌面](../Page/GNOME.md "wikilink")。

## 歷史

1995年，艾克被招聘到Netscape，目的是让他在瀏覽器中實作[Scheme程式語言](../Page/Scheme.md "wikilink")\[1\]，於是他於10天內開發出JavaScript
\[2\]（當工程管理決定這個程式語言必須長得像[Java時](../Page/Java.md "wikilink")，使用Scheme的想法被放棄\[3\]）。之後艾克必須為這個重大的[技術負債付出代價](../Page/技術負債.md "wikilink")，在1996年秋天，艾克留在家裡兩個禮拜，並且重寫了Mocha程式庫，也是後來大家所知道的SpiderMonkey\[4\]。SpiderMonkey這個名字源自於電影[癟四與大頭蛋横贯美国](../Page/癟四與大頭蛋.md "wikilink")，電影裡的角色Tom
Anderson提到，主要演員就像一對[蜘蛛猴](../Page/蜘蛛猴.md "wikilink")（Spider
...
3.5的SpiderMonkey中的編譯引擎](../Page/Firefox_3.5.md "wikilink")。相比[Firefox
3.0的編譯器](../Page/Firefox_3.0.md "wikilink")，它提供了*高達20到40倍的效能改善*\[7\]。
...
Trees）](http://www.ics.uci.edu/~franz/Site/pubs-pdf/ICS-TR-07-12.pdf)，以生成高度最佳化路徑的[原生碼](../Page/机器语言.md "wikilink")，追蹤樹技術由[爾灣加州大學研究團隊貢獻](../Page/爾灣加州大學.md "wikilink")，[安德里亞斯·加爾是該團隊的负责人](../Page/安德里亞斯·加爾.md "wikilink")\[8\]。
...
JägerMonkey的運作很不同于其他編譯器，傳統的編譯器是藉由建立並將其最佳化，JägerMonkey則是透過重覆線性前進循環SpiderMonkey[字节码](../Page/字节码.md "wikilink")，也就是內部函式表示法。雖然這種方式阻碍重新排序指令的最佳化，但這對JavaScript這個经常改變變數類型而需要重新編譯的語言来说，JägerMonkey有快速編譯的優勢。
...
SpiderMonkey是以[C和](../Page/C语言.md "wikilink")[C++语言編寫](../Page/C++.md "wikilink")，並包含[直譯器](../Page/直譯器.md "wikilink")、IonMonkey[即時編譯和](../Page/即時編譯.md "wikilink")[垃圾回收器](../Page/垃圾回收器.md "wikilink")。
...
representation）的[静态单赋值形式將SpiderMonkey的](../Page/静态单赋值形式.md "wikilink")[字节码轉換為控制流圖](../Page/字节码.md "wikilink")（Control
...
该編譯器可以在[ARM](../Page/ARM架構.md "wikilink")、[X86及](../Page/X86.md "wikilink")[X86-64上快速的將JavaScript函式轉換成](../Page/X86-64.md "wikilink")[原生碼](../Page/机器语言.md "wikilink")。
...
OdinMonkey被用於最佳化JavaScript的子集[asm.js](../Page/asm.js.md "wikilink")，OdinMonkey並非一個JIT編譯器，它依然採用IonMonkey作為編譯器，这於2013年6月25日正式釋出的Firefox
22起採用\[20\]。
...
SpiderMonkey可被嵌入於應用程式中，並为應用程式提供執行JavaScript的能力。不完整名單如下：
  ...
  - [Adobe Acrobat](../Page/Adobe_Acrobat.md "wikilink")、[Adobe
    Reader](../Page/Adobe_Reader.md "wikilink")、Adobe Flash
    Professional、[Adobe
    Dreamweaver](../Page/Adobe_Dreamweaver.md "wikilink")

  - [GNOME桌面環境](../Page/GNOME.md "wikilink")，第3版和​​更高版本

  - [Yahoo\! Widgets](../Page/Yahoo!_Widgets.md "wikilink")

  - UOX 3，*[網路創世紀](../Page/網路創世紀.md "wikilink")*私人伺服器
...
Shell，它是一個互動式開發環境，可讓開發者使用[命令列來執行JavaScript程式](../Page/命令列.md "wikilink")\[22\]。

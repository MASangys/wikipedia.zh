...
有網站指Splashtop據說是運行在主機板上的一塊512MB快閃記憶體上\[5\]。有一個專屬的核心引擎在BIOS啟動時啟動，和載入專門的Linux發行版「虛擬設備環境」(VAE)。當執行VAE時，用戶可以啟動「虛擬設備」(VA)。例如
Skype就是一個VA\[6\]。

## 提供了Splashtop的主板

截至2007年10月為止，Splashtop只是裝了在"[華碩](../Page/華碩.md "wikilink") P5E3 Deluxe /
WiFi AP" 主板上。在這主板上，它被稱為「Express Gate」\[7\]。
...
## 外部連結
  ...
  - [Review on
    Phoronix.com](http://www.phoronix.com/scan.php?page=article&item=869)
  - [Video demonstration on
    YouTube.com](http://www.youtube.com/watch?v=qd_kZhbXkXA)

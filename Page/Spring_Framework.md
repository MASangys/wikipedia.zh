...
平台的一个[开源的全栈](../Page/开放源代码.md "wikilink")（Full-stack）[应用程序框架和](../Page/软件框架.md "wikilink")[控制反转容器实现](../Page/控制反转.md "wikilink")，一般被直接称为
...
Spring框架以 [Apache License 2.0](../Page/Apache_License_2.0.md "wikilink")
...
Framework 获得了 [Jolt 生产力奖](../Page/Jolt_Awards.md "wikilink") 和 [JAX
创新奖](../Page/JAX_创新奖.md "wikilink")。\[1\]\[2\]
...
版本中增加了对 [Java SE](../Page/Java_SE.md "wikilink") 8,
[Groovy](../Page/Groovy.md "wikilink") 2, [Java
EE](../Page/Java_EE.md "wikilink") 7 的一些方面以及
...
<!-- end list -->
  ...
  - 一个可用于 [Java EE](../Page/Java_EE.md "wikilink") 等运行环境的核心
    [Bean](../Page/Enterprise_Java_Beans.md "wikilink")[工厂](../Page/虚拟工厂模式.md "wikilink")。
...
<!-- end list -->
  ...
  - 内建的针对 [JTA](../Page/Java事务API.md "wikilink") 和单个
    [JDBC](../Page/Java_Database_Connectivity.md "wikilink")
    数据源的一般化策略，使Spring的事务支持不要求 [Java
    EE](../Page/Java_EE.md "wikilink") 环境，这与一般的 JTA 或者
    [EJB](../Page/EJB.md "wikilink") CMT 相反。
...
<!-- end list -->
  ...
  - 以资源容器，[DAO](../Page/DAO.md "wikilink") 实现和事务策略等形式与
    [Hibernate](../Page/Hibernate.md "wikilink")，[JDO](../Page/Java_Data_Objects.md "wikilink")
    和 [MyBatis](../Page/MyBatis.md "wikilink") 、[SQL
    Maps](../Page/SQL_Maps.md "wikilink") 集成。利用控制反转机制全面解决了许多典型的
    Hibernate 集成问题。所有这些全部遵从 Spring 通用事务处理和通用数据访问对象异常等级规范。

<!-- end list -->

  - 灵活的基于核心 Spring 功能的 [MVC](../Page/模型-视图-程序控制.md "wikilink")
    [网页应用程序框架](../Page/网页应用程序.md "wikilink")。开发者通过策略接口将拥有对该框架的高度控制，因而该框架将适应于多种呈现（View）技术，例如
    ...
    [Struts](../Page/Struts.md "wikilink")、[WebWork](../Page/WebWork.md "wikilink")
    或 [Tapestry](../Page/Tapestry_\(programming\).md "wikilink")。

<!-- end list -->

  - 提供诸如事务管理等服务的[AOP框架](../Page/面向切面编程.md "wikilink")。
...
### [面向切面编程](../Page/面向切面编程.md "wikilink")
...
<!-- end list -->
  ...
  - [The Spring Reference
    Documentation](http://static.springframework.org/spring/docs/1.1.5/spring-reference.pdf)（[PDF](../Page/Portable_Document_Format.md "wikilink")，1329

...
平台设计的一款软件[复制保护技术的商标](../Page/复制保护.md "wikilink")，它获得了微软合作伙伴等级认证\[1\]
并成为微软解决方案合作伙伴\[2\] 和英特尔软件合作伙伴\[3\]。

它的主要保护方案是使用[字节码封装](../Page/字节码.md "wikilink")[可执行文件和](../Page/可执行文件.md "wikilink")[DLL](../Page/动态链接库.md "wikilink")，并通过其[虚拟机解释这些文件](../Page/虚拟机.md "wikilink")。

尽管商标所有者 Protection Technology 声称 StarForce
很难被[逆向工程所](../Page/逆向工程.md "wikilink")[破解](../Page/破解.md "wikilink")，但是通常使用该保护方案的游戏最终都会遭到破解。制作破解的难度与
StarForce 的版本及游戏开发者在[可执行文件中应用的保护例程次数息息相关](../Page/可执行文件.md "wikilink")。
...
中第一個和最後一個寫入扇區之間的物理角度來工作的。這個硬件特徵在所有轉自[母盤的](../Page/母盤.md "wikilink")
CD
副本中都是唯一的，而以當前的技術，在[刻錄光盤時複製該特徵是很困難的](../Page/刻錄.md "wikilink")。一些程序可以通過截取
CD 驅動器與被保護程序之間的通訊來偽造這個角度，從而使保護措施形同虛設。

因為當前的大多數虛擬光驅軟件都是通過模擬 [SCSI](../Page/小型計算機系統接口.md "wikilink")
驅動器來運作，故而若系統中安裝了
[IDE](../Page/集成設備電路.md "wikilink") 驅動器，StarForce 4.0
之前的版本就會禁止使用 SCSI 光盤驅動器。但是，若系統中沒有安裝 IDE 光盤驅動器，StarForce
就會驗證 SCSI 光盤驅動器中的光盤；它的弱點就是，即使系統中安裝了 IDE
光盤驅動器，但若將其拔下或禁用，就可以通過一個虛擬的
CD 或 [DVD](../Page/DVD-ROM.md "wikilink") 鏡像來運行被保護程序。
...
目前已知的官方 StarForce 产品包括：
  ...
  - StarForce 3.5\[5\]
    增加了对 [64
    位](../Page/64_位.md "wikilink")[系统的支持](../Page/操作系统.md "wikilink")。被
    StarForce 所保护的软件可以通过软件安装文件夹中的一个 `.x64` 文件而被 64 位 Windows
    系统所识别。较早的版本会重新启动系统或直接拒绝在这类系统中运行被保护程序。
  - StarForce FrontLine 4.0\[6\]
    完全支持 [64 位应用程序](../Page/64_位.md "wikilink")。
    完全支持 Windows Vista 32/64 位版本。\[7\]
    第一个通过 [WHQL 测试和](../Page/Windows_硬件设备质量认证测试.md "wikilink")“Microsoft
...
StarForce 所保护的游戏。例如，要在 StarForce 支持 [64 位前将](../Page/64_位.md "wikilink")
64 位支持添加到一个游戏构架中，开发者就需要专门为他们的产品开发一个[补丁](../Page/补丁（计算机）.md "wikilink")。
...
的资料显示，部分已知使用了“专业”级别保护的游戏有[赌命战士](../Page/赌命战士.md "wikilink")、[分裂细胞：混沌法则](../Page/分裂细胞：混沌法则.md "wikilink")、[极速房车赛](../Page/极速房车赛.md "wikilink")、[赛道狂飙：日出和](../Page/赛道狂飙：日出.md "wikilink")[超级战士等](../Page/超级战士.md "wikilink")。它也引用了一个传闻中的保护级别“精英”，目前尚不知有哪款已发布的游戏使用了该级别的技术。\[11\]

## StarForce 3.0 的名声

尽管被 StarForce 3.0
所保护的游戏通常最终都会被[破解](../Page/软件破解.md "wikilink")，而且还有其他方法可以绕过其保护，然而
StarForce 3.0
还是因为极端难以被反向工程而得到了声誉。有些破解会在游戏官方发布后几天内放出，但也有一些游戏在官方发布后几个月或几年才被破解：例如[分裂细胞：混沌法则](../Page/分裂细胞：混沌法则.md "wikilink")，在官方发布后过了422天才被破解。\[12\]
...
如何执行资源密集的过程（例如如何在模拟[虚拟机函数和](../Page/虚拟机.md "wikilink")[操作码的同时实现对光盘等媒体的检测等](../Page/操作码.md "wikilink")）也渐渐为人所知。\[14\]

### 驱动程序安装

StarForce 3.0
会将其自身的[设备驱动程序在被保护产品第一次运行时安装或随被保护产品一起安装至系统](../Page/设备驱动程序.md "wikilink")，而该驱动程序通常并不会随软件一起被卸载（[金刚是个例外](../Page/彼得·杰克逊的金刚（电视游戏）.md "wikilink")），这一点令其饱受批评。尽管
Protection Technology
[提供了删除工具](http://www.onlinesecurity-on.com/protect.phtml?c=55)，但其并未随被保护游戏告知或提供给用户。不过在安装*[科林麦克雷：尘埃](../Page/科林麦克雷：尘埃.md "wikilink")*时，安装程序既会询问用户是否安装该驱动程序，还会提供一份附有如何卸载驱动程序等信息的帮助文件。
...
StarForce 3.0
驱动通常与某些旧版本的[游戏演示版](../Page/游戏演示.md "wikilink")、[免费软件和像](../Page/免费软件.md "wikilink")[赛道狂飙：国家一样的下载版游戏一起安装](../Page/赛道狂飙：国家.md "wikilink")。安装驱动的目的是防止破解者用演示版可执行文件帮助爆破最终版可执行文件（因为这两个文件通常极其相似），它也可以阻止[网游作弊](../Page/使用游戏外挂.md "wikilink")。为回应人们对安装驱动程序之行为的批评，Protection
...
[CDV](../Page/CDV.md "wikilink")、[育碧软件](../Page/育碧软件.md "wikilink")、[Digital
Jesters](../Page/Digital_Jesters.md "wikilink")（现改组为
defunct）、[JoWooD](../Page/JoWooD.md "wikilink")、[Egosoft](../Page/Egosoft.md "wikilink")、[Codemasters](../Page/Codemasters.md "wikilink")、[Eagle
Dynamics](../Page/Eagle_Dynamics.md "wikilink")、[MIdway
Games以及](../Page/MIdway_Games.md "wikilink")[Bohemia Interactive
Studio](../Page/Bohemia_Interactive_Studio.md "wikilink") 将 StarForce
3.0 用于他们的一些产品中。
...
[TAGES](../Page/TAGES.md "wikilink") 复制保护系统，以回应用户的抱怨。\[16\]
...
V](../Page/魔法门之英雄无敌_V.md "wikilink")*和
[GTR2](../Page/GTR2.md "wikilink") 中，StarForce 3.0 被
...
安装于一个可以在公共网络中被发现的受限用户帐户中时，驱动程序的[访问控制列表会被设定为任何用户](../Page/访问控制列表.md "wikilink")（包括没有管理员权限的用户）都可以更改被驱动程序所运行的代码。这样入侵就很容易了：用户可以将该代码修改为指向任意可执行程序，它会在下次重新启动时以完全系统权限运行。可以用安全工具“sercheck2”来检测是否存在这样潜在的不安全驱动程序配置。

### 公司行为

#### Boing Boing

2006年1月30日，著名的[博客提供商](../Page/博客.md "wikilink") [Boing
Boing](../Page/Boing_Boing.md "wikilink")
引用一些与保护系统有关的问题，包括[磁盘驱动器性能退化](../Page/磁盘驱动器.md "wikilink")、[操作系统安全性和稳定性的减弱](../Page/操作系统.md "wikilink")，声称
...
Russinovich](../Page/Mark_Russinovich.md "wikilink") 分析了 StarForce
并发现其“没有什么明显的不稳定”：\[29\]

#### Stardock

2006年3月5日，Protection Technology 的一名雇员帖出了一个指向[银河文明
II](../Page/银河文明_II：死亡领主.md "wikilink") 的未授权下载源的链接，这是 由
[StarDock](../Page/StarDock.md "wikilink")
...
## 请参见
  ...
  - [SafeDisc](../Page/SafeDisc.md "wikilink")
  - [扩展复制保护](../Page/扩展复制保护.md "wikilink") ("XCP")
...
20.
21.
22. 台灣則是在《仙劍奇俠傳四》發行後因為StarForce產生的嚴重問題，最後常使用此防拷程式的[大宇和](../Page/大宇.md "wikilink")[宇峻奧汀也改用SecuROM](../Page/宇峻奧汀.md "wikilink")。
23.
24.
25.
26.

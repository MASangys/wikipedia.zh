...
支持导出光栅图片格式JPEG、BMP和矢量图片格式Windows Metafile、Enhanced Metafile. 无法导出SVG或PNG格式。

## 後繼版本

目前StarUML已經停止開發，原團隊轉型後發行了StarUML2，一個付費的跨平台UML工具。
...
## 外部链接
  ...
  - [StarUML官方站点](http://staruml.io/)
  - [在SourceForge](http://sourceforge.net/projects/staruml/)的项目站点
  - [在SourceForge的下载页](http://sourceforge.net/project/showfiles.php?group_id=152825)
  - [商业支持](https://web.archive.org/web/19990427073802/http://www.plasticsoftware.com/)

[Category:自由UML工具](https://zh.wikipedia.org/wiki/Category:自由UML工具 "wikilink") [Category:Windows软件](https://zh.wikipedia.org/wiki/Category:Windows软件 "wikilink") [Category:SourceForge專案](https://zh.wikipedia.org/wiki/Category:SourceForge專案 "wikilink")
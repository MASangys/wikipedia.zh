...
2018年4月，數間遊戲網站觀察到維爾福在Steam商店頁面上不再提供Steam Machine的販售頁面連結。雖然那些頁面還是可以URL直連進入，但許多先前提供的機型都已不再列出。\[5\]維爾福回應這是因為Steam Machine銷量不好，而且在用戶之間的關注度不大，使他們調整商店的相關頁面。維爾福並表示他們將會繼續把Steam Machine作為開放式遊戲平台推出，而且也會繼續開發相關聯的科技例如SteamOS。\[6\]

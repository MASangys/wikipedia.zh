**`Strcpy`** 是[C語言的函式之一](../Page/C語言.md "wikilink")，來自
[C語言標準函式庫](../Page/C標準函式庫.md "wikilink")，定義於
[string.h](../Page/string.h.md "wikilink")，它可以複製以 null
為結束字元的記憶體區塊到另一個記憶體區塊內。由於[字串在 C
語言不是首要的](../Page/String.h.md "wikilink")[資料型態](../Page/資料型態.md "wikilink")，而是以實作的方式來替代，在記憶體內以連續的[位元組區塊組成](../Page/位元組.md "wikilink")，`strcpy`
可以有效複製兩個配置在記憶體以[指標回傳的字串](../Page/指针_\(信息学\).md "wikilink")（字元指標或是字串指標）。
...
必須注意使用 `strcpy`
函式，因為如果來源字串的長度太長，當複製到目的緩衝區時，它會覆寫到連接目的緩衝區後方的記憶體，導致無法預期的結果。而且程式通常容易會出現[區段錯誤](../Page/記憶體區段錯誤.md "wikilink")（也就是常見的例外現象），但是熟練的駭客會利用[緩衝區溢位來破解進入作業系統](../Page/緩衝區溢位.md "wikilink")（詳見[電腦安全](../Page/電腦安全.md "wikilink")）。
...
來作為結束字元的字串，它也可能出現[讀取例外的現象](../Page/記憶體區段錯誤.md "wikilink")。

### strlcpy

由 [OpenBSD](../Page/OpenBSD.md "wikilink") 的研發人員  和 [Theo de
Raadt](../Page/西奧·德·若特.md "wikilink") 兩人設計
[`strlcpy`](../Page/strlcpy.md "wikilink") 函式，通常視為是 `strncpy`
安全版本。對於一些[作業系統而言](../Page/作業系統.md "wikilink")，這個函式會出現被掌控的問題，但是它已經被
[glibc](../Page/glibc.md "wikilink") 維修人員給特別地刪除，所以在此建議使用
[`memcpy`](../Page/memcpy.md "wikilink") 函式來替代。\[2\]
...
`strcpy`
的不同在於，在它取得額外參數來決定目的緩衝區大小時，會因為發生溢位而出現錯誤，如此一來，就可以預防[緩衝區溢位](../Page/緩衝區溢位.md "wikilink")。由於
`strcpy_s` 對於 C 語言來說是新的函式，所以沒有特別受到廣泛支援。

反對Microsoft人士宣稱，這個函式連同其他Microsoft在其Runtime
Library號稱對安全性所做的強化\[6\]皆為Microsoft試圖把開發人員鎖死在[視窗平台上的手段之一](../Page/Microsoft_Windows.md "wikilink")。\[7\]\[8\]；雖然strcpy_s是屬於ISO/IEC

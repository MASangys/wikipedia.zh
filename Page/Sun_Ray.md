...
Card）讀卡機，且多數機款與[平面顯示器](https://zh.wikipedia.org/wiki/平面顯示器 "wikilink")（Flat
...
| Sun Ray 1g  | 不具顯示功能、強化[解析度](https://zh.wikipedia.org/wiki/解析度 "wikilink")、增加[USB埠](../Page/USB.md "wikilink") | \--                   |
...
1.  \- Thin
    Client也稱為瘦身型、苗條型的用戶端電腦（**瘦身型用戶端**），相對的[個人電腦](https://zh.wikipedia.org/wiki/個人電腦 "wikilink")（Personal

**Swift編程語言，**支持[多编程范式和](https://zh.wikipedia.org/wiki/多编程范式 "wikilink")[編譯式](https://zh.wikipedia.org/wiki/編譯 "wikilink")，用来撰写基于[macOS/OS X](https://zh.wikipedia.org/wiki/OS_X "wikilink")、[iOS](https://zh.wikipedia.org/wiki/iOS "wikilink")、[watchOS和](https://zh.wikipedia.org/wiki/watchOS "wikilink")[tvOS的软件](https://zh.wikipedia.org/wiki/tvOS "wikilink")\[1\]。 苹果公司于2014年在[苹果开发者年会](https://zh.wikipedia.org/wiki/WWDC "wikilink")（WWDC）發布了Swift编程语言。从设计上[苹果公司让Swift与](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")[Objective-C](../Page/Objective-C.md "wikilink")共存在苹果公司的[操作系统上](https://zh.wikipedia.org/wiki/作業系統 "wikilink")\[2\]。

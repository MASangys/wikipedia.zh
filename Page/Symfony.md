**Symfony**是一款基于[MVC架构的](../Page/MVC.md "wikilink")[PHP](../Page/PHP.md "wikilink")[框架](../Page/框架.md "wikilink")。它是一款免费软件，在[MIT
License许可下发行](../Page/MIT_License.md "wikilink")。2005年10月18日，其官方网站symfony-project.com对外开放。2011年Symfony2正式发布，随即启用全新的官方网站symfony.com。\[1\]

## 目标

Symfony致力于减少重复代码的编写，以加速Web应用的开发和维护。它需要以下软件的支持：安装过PHP5的[Unix](../Page/Unix.md "wikilink")，[Mac
OS或](../Page/Mac_OS.md "wikilink")[Microsoft
Windows等操作系统作为WEB应用服务](../Page/Microsoft_Windows.md "wikilink")。Symfony与许多[关系型数据库整合的也非常好](../Page/关系型数据库.md "wikilink")，成本也较小。\[2\]

Symfony致力于在企业背景下创建健壮的应用，同时也给予了开发者强大的配置功能：从文件结构到外部目录，几乎所有的东西都可以自定义。Symfony也捆绑了一些诸如测试、调试、文档生成等额外的工具来满足企业的开发过程。

## 技术

Symfony使用了大量的[设计模式](../Page/设计模式.md "wikilink")，比如[MVC模式](../Page/MVC.md "wikilink")，它分离了业务逻辑层和表示层，降低了耦合性，使程序更易于维护。
Symfony使用了以下一些PHP开源项目的部分功能。

  - [Propel
    (PHP)](../Page/Propel_\(PHP\).md "wikilink")：用作[对象关系映射](../Page/对象关系映射.md "wikilink")（ORM）
  - [Doctrine
    (PHP)](../Page/Doctrine_\(PHP\).md "wikilink")：用作[对象关系映射](../Page/对象关系映射.md "wikilink")（ORM）
  - [Creole](../Page/Creole.md "wikilink")：用作数据库抽象层
  - [Prado](../Page/Prado.md "wikilink")：用作国际化支持
  - [Spyc](../Page/Spyc.md "wikilink")：用作解析[YAML](../Page/YAML.md "wikilink")
  - [Pake](../Page/Pake.md "wikilink")：用作命令行工具
  - [Twig](../Page/Twig.md "wikilink")：用作模板引擎

Symfony也使用了一些开源的[Javascript库](../Page/Javascript.md "wikilink")。

  - [Prototype](../Page/Prototype_javascript.md "wikilink")：用作javascript框架（v
    1.0和1.1）
  - [script.aculo.us](../Page/script.aculo.us.md "wikilink")：用作视觉特效（v
    1.0 and 1.1）
  - [Dynarch.com](../Page/Dynarch.com.md "wikilink")，用作[DHTML日历](../Page/DHTML.md "wikilink")（v
    1.0 and 1.1）
  - [TinyMCE](../Page/TinyMCE.md "wikilink")，用作[富文本编辑器](../Page/富文本.md "wikilink")（v
    1.0）
  - [FCKeditor](../Page/FCKeditor.md "wikilink")，用作[富文本编辑器](../Page/富文本.md "wikilink")
...
Framework作为该项目的名字\[4\]，因此代码中所有的类名前都加上了"sf"前缀，当它决定以[开源形式发布时](../Page/开源.md "wikilink")，便以Symfony作为名称（Symfony的英文缩写也是sf）。\[5\]

## 应用

一款开源的Q\&A服务[Askeet就是使用Symfony开发的](../Page/Askeet.md "wikilink")。[许多其他应用](https://www.webcitation.org/65WVc4PWK?url=http://trac.symfony-project.org/wiki/ApplicationsDevelopedWithSymfony)，包括拥有2000万用户的[Yahoo
...
## 扩展阅读
  ...
  - Potencier, Fabien and Zaninotto, Fran?ois.（2007）. *The Definitive
    Guide to Symfony.* [Apress](../Page/Apress.md "wikilink")。ISBN
    1-59059-786-9.

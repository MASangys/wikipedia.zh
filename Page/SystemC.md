...
通常，系统由[软件](../Page/软件.md "wikilink")部分和[硬件](../Page/硬件.md "wikilink")部分组成，系统的一部分功能由软件实现，而另一部分功能则由硬件实现。早期的系统比较简单，[系统工程师将准备设计的系统划分为软件部分和硬件部分](https://zh.wikipedia.org/wiki/系统工程师 "wikilink")，分别由软件工程师和硬件工程师进行设计、[仿真](../Page/仿真.md "wikilink")、实现和改进，最后再将软件部分和硬件部分结合起来形成系统。[软件工程师使用C和C](https://zh.wikipedia.org/wiki/软件工程师 "wikilink")++等[程序设计语言](https://zh.wikipedia.org/wiki/程序设计语言 "wikilink")，因为这些语言专长于描述串行执行的程序，用来仿真软件部分；而[硬件工程师则使用](https://zh.wikipedia.org/wiki/硬件工程师 "wikilink")[VHDL](../Page/VHDL.md "wikilink")和[Verilog](../Page/Verilog.md "wikilink")等[硬件描述语言](../Page/硬件描述语言.md "wikilink")，因为这些语言专长于描述并行运行的硬件，用来仿真硬件部分。但是，随着电子系统的不断发展，系统结构越来越复杂，系统元件也越来越多，这就要求系统工程师在先期划分软件和硬件时，就对整个系统性能有很好的了解和掌握，以便更好地划分软件和硬件，减小设计中不必要的失误所带来的损失和风险。SystemC也就由此孕育而生，因为它能够满足对软件和硬件协同仿真的需求。

**SystemC**的名称来自“系统”一词的英语**System**和“C/C++语言”中的**C**，以表示它是一种基于C/C++语言的系统设计语言。

许多科学研究团队和[计算机辅助设计](../Page/计算机辅助设计.md "wikilink")软件公司一同为SystemC的发展做出了贡献，1999年成立了[开源SystemC的开发团队](https://zh.wikipedia.org/wiki/开源 "wikilink")“Open SystemC Initiative（OSCI）”。
...
## 相关条目
  ...
  - [C++语言](https://zh.wikipedia.org/wiki/C++语言 "wikilink")
  - [计算机语言](https://zh.wikipedia.org/wiki/计算机语言 "wikilink")
...
## 外部链接
  ...
  - [SystemC.org](https://web.archive.org/web/20081006172519/http://systemc.org/) SystemC的社区

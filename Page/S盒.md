...
不一定等于*m*\[2\]。一个*m*×*n*的S盒可以通过包含2<sup>*m*</sup>条目，每条目*n*比特的[查找表](../Page/查找表.md "wikilink")实现。S盒通常是固定的（例如[DES和](https://zh.wikipedia.org/wiki/DES "wikilink")[AES加密算法](../Page/高级加密标准.md "wikilink")）,

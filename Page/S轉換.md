...
和其他時頻分析工具一樣，透過S轉換，我們可以同時從[時域以及](../Page/時域.md "wikilink")[頻域觀察一個信號的能量分布](../Page/頻域.md "wikilink")。S轉換的特別之處在它既保持與[傅立葉變換的直接關係](../Page/傅立葉變換.md "wikilink")，又可在不同頻率有不同的解析度。此外，S轉換與[小波轉換](../Page/小波轉換.md "wikilink")（wavelet
...
transform），而不如[韋格納分佈](../Page/韋格納分佈.md "wikilink")（Wigner distribution
function）、[科恩克萊斯分佈](../Page/科恩克萊斯分佈.md "wikilink")、[改良式韋格納分佈](../Page/改良式韋格納分佈.md "wikilink")（Modified
...
其中[窗函數為高斯窗函數](../Page/窗函數.md "wikilink")

\[w(t,f) = |f|e^{-\pi t^2f^2}\]

### 另種表示-頻譜表示式

藉著[摺積定理](../Page/摺積定理.md "wikilink")
...
\(|f|e^{-\pi (t-\tau)^2 f^2}\)分別取[傅立葉變換可得](../Page/傅立葉變換.md "wikilink")
...
連續小波轉換可以視為將一個信號對小波做[相關](../Page/相關.md "wikilink")（correlation）：

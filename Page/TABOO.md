...
1.  **TABOO（禁忌）**
      -
        作詞：Kumi Koda、HIRO　作曲：HIRO　編曲：HIRO
2.  **Always**
      -
        作詞：Kumi Koda　作曲：Daisuke“D.I"Imai　編曲：Daisuke“D.I"Imai
3.  '''TABOO -HOUSE NATION Sunset In Ibiza Remix- '''
4.  **TABOO（禁忌） -Instrumental-**
5.  **Always -Instrumental-**

### DVD

1.  **TABOO（禁忌） （MUSIC VIDEO）**
2.  **TABOO（禁忌） （MUSIC VIDEO ANOTHER EDITION）**
3.  **TABOO（禁忌） （PHOTO SLIDE SHOW）**

...
TACACS在RFC
1492中定义，默认使用[TCP或](https://zh.wikipedia.org/wiki/Transmission_Control_Protocol "wikilink")[UDP](https://zh.wikipedia.org/wiki/User_Datagram_Protocol "wikilink")）协议的
49 端口。

...
TCPDF 也是最多人使用的 [PHP](../Page/PHP.md "wikilink") 库之一，因为最流行的一些基于
[PHP](../Page/PHP.md "wikilink") 的
[内容管理系统](../Page/内容管理系统.md "wikilink")
中都带有TCPDF，包括：
[Joomla](https://zh.wikipedia.org/wiki/Joomla "wikilink")\[2\],
[Drupal](../Page/Drupal.md "wikilink")\[3\],
[Moodle](../Page/Moodle.md "wikilink")\[4\],
[phpMyAdmin](https://zh.wikipedia.org/wiki/phpMyAdmin "wikilink")\[5\],
[TCExam](https://zh.wikipedia.org/wiki/TCExam "wikilink")\[6\],
[Xoops](https://zh.wikipedia.org/wiki/Xoops "wikilink")\[7\], [Elxis
CMS](http://elxis.org/)\[8\],
[ImpressCMS](https://zh.wikipedia.org/wiki/ImpressCMS "wikilink")\[9\],
[JELIX Frameweork PHP5](http://jelix.org/)\[10\],
...
2.  [Joomla TCPDF
    API](http://api.joomla.org/com-tecnick-tcpdf/TCPDF.html)
3.  [Drupal Pdfview module relies on
    TCPDF](http://drupal.org/project/pdfview)
4.  [Moodle Index of
    /moodle/lib/tcpdf](http://cvs.moodle.org/moodle/lib/tcpdf/)
5.  [phpMyAdmin docs for
    TCPDF](http://www.phpmyadmin.net/phpdoc/com-tecnick-tcpdf/TCPDF.html)
6.  [TCExam documentation for
    TCPDF](http://www.tecnick.com/pagefiles/tcexam/doc/code/li_com-tecnick-tcpdf.html)

7.  [A module for creating articles in
    Xoops](http://www.xoops.org/modules/news/article.php?storyid=4558)
8.  [Elxis TCPDF
    Module](http://code.elxis.org/20080/nav.html?includes/tcpdf/index.html)
9.  [ImpressCMS 1.1 New
    Features](http://wiki.impresscms.org/index.php?title=ImpressCMS_1.1_New_Features)

10. [JELIX changelog](http://jelix.org/articles/en/changelog/1.0)
11. [TCPDF module for
    SugarCRM](http://www.sugarforge.org/projects/tcpdf)
12. [TCPDF plugin for

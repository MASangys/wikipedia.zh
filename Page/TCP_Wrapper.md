...
## 参见
  ...
  - [IP封锁](https://zh.wikipedia.org/wiki/IP封锁 "wikilink")
...
<references />
  ...
  - Lee Brotzman: [<cite>Wrap a Security Blanket Around Your
    Computer</cite>](http://www.linuxjournal.com/article/2180)
    Linuxjournal article 1997-08-01
...
## 外部链接
  ...
  - [Softpanorama上有关TCP
    Wrappers的信息](http://www.softpanorama.org/Net/Network_security/TCP_wrappers/index.shtml)
  - [tcp
    wrapper指南](http://generationip.com/documentation/mini-howto/116-howto-on-tcp-wrapper)
...
[Category:TCP](https://zh.wikipedia.org/wiki/Category:TCP "wikilink")
[Category:网络软件](https://zh.wikipedia.org/wiki/Category:网络软件 "wikilink")

1.  [*TCP WRAPPER - Network monitoring, access control, and booby
    traps.* by Wietse
    Venema](ftp://ftp.porcupine.org/pub/security/tcp_wrapper.pdf)
2.  [CC/CERT Advisory
    CA-1999-01](http://www.cert.org/advisories/CA-1999-01.html)
3.  [CC/CERT Advisory
    CA-1999-02](http://www.cert.org/advisories/CA-1999-02.html)
4.  [*backdoored tcp wrapper source code*, by Wietse Venema, on
    [Bugtraq](https://zh.wikipedia.org/wiki/Bugtraq "wikilink"), Jan 21,
    1999](http://seclists.org/bugtraq/1999/Jan/0257.html)
5.  [*Announcement: Wietse's FTP site has moved*, by Wietse Venema, on
    [Bugtraq](https://zh.wikipedia.org/wiki/Bugtraq "wikilink"), Jan 21,
    1999](http://seclists.org/bugtraq/1999/Jan/0314.html)
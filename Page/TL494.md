...
TL494于1980年代初由[德州仪器公司设计并推出](../Page/德州仪器.md "wikilink")，推出后立刻得到市场的广泛接受，尤其是在[PC机的](https://zh.wikipedia.org/wiki/PC机 "wikilink")[ATX半桥电源上](https://zh.wikipedia.org/wiki/ATX半桥 "wikilink")。直至今日，仍有相当比例的PC机电源基于TL494芯片。多年来，作为最廉价的双端PWM芯片，TL494在双端拓扑，如[推挽和半桥中应用极多](https://zh.wikipedia.org/wiki/推挽 "wikilink")。由于其较低的[工作频率以及单端的输出端口特性](https://zh.wikipedia.org/wiki/工作频率 "wikilink")，它常配合功率[双极性晶体管](https://zh.wikipedia.org/wiki/双极性晶体管 "wikilink")（BJT）使用，如用于配合功率MOSFET则需外加电路。

TL494已成为一种[工业标准芯片](https://zh.wikipedia.org/wiki/工业标准 "wikilink")，由很多家[集成电路厂商生产](../Page/集成电路.md "wikilink")。它也被命名为其他型号，如飞兆（Fairchild，又称仙童）公司将它的TL494兼容芯片命名为KA7500。
...
TL494内置了基于[带隙原理的](https://zh.wikipedia.org/wiki/带隙原理 "wikilink")[基准源](https://zh.wikipedia.org/wiki/基准源 "wikilink")，基准源的稳定输出电压为5[V](../Page/V.md "wikilink")，条件是[VCC电压在](https://zh.wikipedia.org/wiki/VCC电压 "wikilink")7V以上，[误差在](../Page/误差.md "wikilink")100[mV之内](https://zh.wikipedia.org/wiki/mV "wikilink")。基准源的[输出引脚是第](https://zh.wikipedia.org/wiki/输出引脚 "wikilink")14脚
REF.

''' 锯齿波振荡器 '''

TL494内置了[线性](https://zh.wikipedia.org/wiki/线性 "wikilink")[锯齿波](https://zh.wikipedia.org/wiki/锯齿波 "wikilink")[振荡器](https://zh.wikipedia.org/wiki/振荡器 "wikilink")，产生0.3\~3V的锯齿波。[振荡频率可通过外部的一个](https://zh.wikipedia.org/wiki/振荡频率 "wikilink")[电阻Rt和一个](../Page/电阻.md "wikilink")[电容Ct进行调节](https://zh.wikipedia.org/wiki/电容 "wikilink")，其振荡频率为：f=1/RtCt，其中Rt的单位为[欧姆](https://zh.wikipedia.org/wiki/欧姆 "wikilink")，Ct的单位为[法拉](../Page/法拉.md "wikilink")。锯齿波可以在Ct引脚测量到。

''' [运算放大器](../Page/运算放大器.md "wikilink") '''

TL494集成了两个单电源供电的运算放大器。运算放大器传递[函数为ft](../Page/函数.md "wikilink")(ni,inv)=A(ni-inv)，但不能越出输出[摆幅](https://zh.wikipedia.org/wiki/摆幅 "wikilink")。一般电源电路中，运放接成[闭环运行](https://zh.wikipedia.org/wiki/闭环 "wikilink")。少数特殊情况下使用[开环](https://zh.wikipedia.org/wiki/开环 "wikilink")，由外界输入[信号](https://zh.wikipedia.org/wiki/信号 "wikilink")。
两个运放的输出端分别接一个[二极管](https://zh.wikipedia.org/wiki/二极管 "wikilink")，和COMP引脚以及后级电路（比较器）相连接。这保证了两个运放中较高的输出进入后级电路。
...
Control引脚4设置，它通过一个比较器对脉冲触发器实行[干扰](https://zh.wikipedia.org/wiki/干扰 "wikilink")，限制最大占空比。可设置的每端占空比上限最高为45%，在工作频率高于150KHz时占空比上限是42%左右。（当DTC引脚电平被设为0时）

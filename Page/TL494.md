...
TL494集成了两个单电源供电的运算放大器。运算放大器传递[函数](../Page/函数.md "wikilink")为ft(ni,inv)=A(ni-inv)，但不能越出输出[摆幅](https://zh.wikipedia.org/wiki/摆幅 "wikilink")。一般电源电路中，运放接成[闭环运行](https://zh.wikipedia.org/wiki/闭环 "wikilink")。少数特殊情况下使用[开环](https://zh.wikipedia.org/wiki/开环 "wikilink")，由外界输入[信号](https://zh.wikipedia.org/wiki/信号 "wikilink")。

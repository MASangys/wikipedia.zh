**TR069**是 [CPE](https://zh.wikipedia.org/wiki/CPE "wikilink") 和 ACS 之間溝通的通訊協定。CPE 可以藉著這個協定完成[服務開通](https://zh.wikipedia.org/wiki/服務開通 "wikilink")、功能設定、檔案上傳下載、系統檢測 等等初始化及營運管理的必須動作。

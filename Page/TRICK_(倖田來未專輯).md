...
## 解說
  ...
  - 「TRICK企劃第2彈」包含「CD+2DVD」（「HAPPY TRICK 預購版」）隨機封入共39張的「LUCKY TRICK
    金卡」以及390張的「LUCKY TRICK 銀卡」，「LUCKY TRICK
    金卡」得中選者可得到倖田親筆簽名的「TRICK SPECIAL
    海報」特典，而中選「LUCKY TRICK 銀卡」則可得到「TRICK SPECIAL 海報」特典。
  - DVD2的一夜限定演唱會「KODA KUMI SPECIAL LIVE“Dirty Ballroom”〜one night
    show〜」是以CLUB的想法所構成的，表演與幕後花絮完整收錄於DVD中。
...
1.  **TABOO（禁忌）**
2.  **[TAKE BACK（Sunset In Ibiza
    Remix）](../Page/TAKE_BACK.md "wikilink")**
...
1.  **the Making of 「KODA KUMI SPECIAL LIVED“Dirty Ballroom”〜One Night
    Show〜」**

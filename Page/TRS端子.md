...
[有框](https://zh.wikipedia.org/wiki/File:Phone_Jack_Symbols.svg "fig:有框") 由于 TRS 插口结构多样，在电路图中通常是以代表不同零件的符号依据具体的插口结构组合到一起来表现。以右图为例（插头从右向左插入）：

A：简单的 TS 口，上接 T 下接 S。

B：TRS，上 T 下 R、S 接地。

C：TRS，其中 T 和 R 均是[继电器](../Page/继电器.md "wikilink")结构。当**没有**插头插入时，触点（从上至下编号）2-3、6-7 导通；反之当插入插头时弹簧受力变形，1-2、7-8 分别导通。剩余的 4 接 T、5 接 R、9 接 S。
...
[Category:視聽接口](https://zh.wikipedia.org/wiki/Category:視聽接口 "wikilink") [Category:音訊工程](https://zh.wikipedia.org/wiki/Category:音訊工程 "wikilink")
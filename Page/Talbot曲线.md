...
令\(t=\tan(\theta/3)\)，再應用[棣莫弗公式可得](../Page/棣莫弗公式.md "wikilink")
...
## 參考資料
  ...
  - J. D. Lawrence, *A Catalog of Special Plane Curves*. New York:
    Dover, 1972, pp. 87-90.

## 外部連結

  -
  - ["Tschirnhaus' Cubic" at MacTutor History of Mathematics
    Archive](http://www-groups.dcs.st-and.ac.uk/~history/Curves/Tschirnhaus.html)

  - ["Cubique de Tschirnhausen" at Encyclopédie des Formes Mathématiques
    Remarquables](http://mathcurve.com/courbes2d/tschirnhausen/tschirnhausen.shtml)
    (in French)

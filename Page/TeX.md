**<span class="texhtml" style="font-family: 'CMU Serif', cmr10, LMRoman10-Regular, 'Latin Modern Math', 'Nimbus Roman No9 L', 'Times New Roman', Times, serif;"></span>**（\[1\]，音译“泰赫”，文本模式下写作TeX），是一个由美国计算机教授[高德纳](../Page/高德纳.md "wikilink")（）编写的功能强大的排版软件。它在学术界十分流行，特别是[数学](../Page/数学.md "wikilink")、[物理学和](../Page/物理学.md "wikilink")[计算机科学界](../Page/计算机科学.md "wikilink")。<span class="texhtml" style="font-family: 'CMU Serif', cmr10, LMRoman10-Regular, 'Latin Modern Math', 'Nimbus Roman No9 L', 'Times New Roman', Times, serif;"></span>被普遍认为是一个优秀的排版工具，特别是在处理复杂的数学公式时。利用诸如是<span class="texhtml" style="font-family: 'CMU Serif', cmr10, LMRoman10-Regular, 'Latin Modern Math', 'Nimbus Roman No9 L', 'Times New Roman', Times, serif;">[](../Page/LaTeX.md "wikilink")</span>等终端软件，<span class="texhtml" style="font-family: 'CMU Serif', cmr10, LMRoman10-Regular, 'Latin Modern Math', 'Nimbus Roman No9 L', 'Times New Roman', Times, serif;"></span>就能够排版出精美的文本以幫助人們辨認和尋找。
...
他计划在1978年的[学术休假时完成这项工作](../Page/学术休假.md "wikilink")，但事实上，直到十多年之后的1989年，TeX语言才被「冻结」（可以使用）。1978年夏天，[蓋伊·史提爾二世在高德纳编写其第一版的](../Page/蓋伊·史提爾二世.md "wikilink")程式时，正好在高德纳所工作的[斯坦福大学](../Page/斯坦福大学.md "wikilink")，当他回到[麻省理工学院](../Page/麻省理工学院.md "wikilink")（MIT）时他在下重写了的输出输入系统。的第一版是用写成的，运行于，採用斯坦福大学的[操作系统](../Page/操作系统.md "wikilink")。在之后的版本中，高德纳（Knuth）发明了所谓的“[文学编程](../Page/文学编程.md "wikilink")”（literate
programming），一种从同一源文件自动生成可编译的源代码和高质量的文档的编程方法。这种语言被称为[WEB](../Page/WEB.md "wikilink")，它所生成的源代码是使用[Pascal编程语言](../Page/Pascal编程语言.md "wikilink")。

一个从头开始重写的新版TeX于1982年发布，它被称为TeX82。除了其他修改之外，原本的断字算法被Frank
Liang编写的新算法所取代。TeX82还使用了定点而不是[浮点](../Page/浮点.md "wikilink")，以确保结果在不同的计算机硬件上重现。\[2\]并且在蓋伊·史提爾的大力游说下，TeX82包括一种真正的、[图灵完全的编程语言](../Page/图灵完全.md "wikilink")。\[3\]1989年，高德纳发布了新版本的TeX和[Metafont](../Page/Metafont.md "wikilink")。\[4\]尽管高德纳希望保持程序的稳定性，但他意识到，只能输入128个不同的字符不足以容纳外语；因此TeX
3.0版本的主要变化是能使用[8位元输入](../Page/8位元.md "wikilink")，即在文本中允许输入256个不同的字符。

从第三版开始，之后的升级是在小数点后加入一个新数位，使之越来越接近[圆周率](../Page/圆周率.md "wikilink")「」的值。目前的版本是3.14159265。这显示了已经十分稳定，任何的升级都十分细微。高德纳曾表示“最后一次升级是（于我过世后）将版本数改为『』，那时任何余下的漏洞将被看作程序的功能。”
...
然后在[命令行解释器](../Page/命令行解释器.md "wikilink")（Command line
interpreter）中输入`tex
myfile.tex`，之后便会建立一名为`myfile.dvi`的文件。此文件可用如[Yap之类的检视器检视](../Page/Yap.md "wikilink")。此档于阅读器可见的是“hello”一词。“\\bye”是一个TeX[指令](../Page/指令.md "wikilink")，相等于[档案结束标记](../Page/档案结束标记.md "wikilink")，是不会显示出来的。此DVI文件可在阅读器中直接打印或转换成更普遍的格式，例如[PostScript](../Page/PostScript.md "wikilink")。

另外，使用指令`pdftex
myfile.tex`亦能输出[PDF文件](../Page/PDF.md "wikilink")。当初创造pdf是因为把DVI转成PostScript再转成PDF所产生的字体显示质量很差（但打印则没问题）。这是由于本身支持[点阵字体](../Page/点阵字体.md "wikilink")（Type
3），而此远不及[向量字体](../Page/向量字体.md "wikilink")（Type 1）的显示质量好。
...
[{{Serif是一套以](../Page/LaTeX.md "wikilink")描述的[巨集软件](../Page/巨集.md "wikilink")。有很多预设的模版、样式。它比更为结构化，如包含了供建立[索引](../Page/索引.md "wikilink")、[表格](../Page/表格.md "wikilink")、[列表等的巨集和](../Page/列表.md "wikilink")[公用软件](../Page/公用软件.md "wikilink")。例如：
...
Mathematica](../Page/Acta_Mathematica.md "wikilink")》、和数学期刊《[Indagationes
Mathematicae](../Page/Indagationes_Mathematicae.md "wikilink")》。高德纳通过研究其数学公式的排版，总结出了一套数学公式内部间距的规则，并将其用于。\[7\]排版数学公式时只是提供了一个间距调整引擎，实际的间距大小由数学字体提供。比如默认的[Computer
...
与手动排版相比，计算机排版系统可以自动处理断行问题。大部分排版系统都采用[首次拟合法处理断行](../Page/贪心法.md "wikilink")，即一行一行处理，一行处理完就不管了，因此一旦遇到較長的專有名詞，前面排版正常，後面間距卻非常的寬。的方法是一次处理一个自然段，尝试每一种断行方法，然后选出最优解。两种方法的差异如下：（此演示不考虑断字）
...
Plass的一篇论文指出](../Page/Michael_Plass.md "wikilink")，考虑到图表的放置位置的完美分页算法可能为[NP完全](../Page/NP完全.md "wikilink")。的断行算法后来被[Adobe
...
是非常稳定的程序，高德纳悬赏奖励任何能够在中发现[程序漏洞](../Page/程序錯誤.md "wikilink")（bug）的人。每一个漏洞的奖励金额从2.56美元（16进制的一美元）开始，以后每发现一个bug，都会翻倍，直到目前的327.68美元封顶。然而高德纳从未因此而损失大笔金钱，因为中的漏洞极少，而真正发现漏洞的人在获得支票后往往不愿将其兑现。\[12\]\[13\]
...
有许多衍生出来的文档处理程序就是基于的，主要的有：
  ...
  - ：[美国数学学会](../Page/美国数学学会.md "wikilink")（American Mathematical
    Society）发表的版本。绝大多数的AMS-TeX功能可以利用AMS包在上实现，称为AMS-TeX。

  - [Cont](../Page/ConTeXt.md "wikilink")

  - jadeTeX

  - [{{Serif](../Page/LaTeX.md "wikilink")（Lamport TeX）：流行的文档处理程序

  - [Lua](../Page/LuaTeX.md "wikilink")

  - [Mac](../Page/MacTeX.md "wikilink")

  - [MiK](../Page/MikTeX.md "wikilink")

  - [pdf](../Page/pdfTeX.md "wikilink")

  - [Sync](../Page/SyncTeX.md "wikilink")
...
[TeXmacs是一个所见即所得的科学文档编辑器](../Page/TeXmacs.md "wikilink")，利用字体作为显示字体，具有类似[Emacs的编辑方式](../Page/Emacs.md "wikilink")。它可以导出为文本，[PS](../Page/Adobe_Photoshop.md "wikilink")，[PDF文档](../Page/PDF.md "wikilink")，以及[HTML](../Page/HTML.md "wikilink")，[XML页面](../Page/XML.md "wikilink")。[LyX也是一个类似的工具](../Page/LyX.md "wikilink")。
...
）。音译“泰赫”。在[英语和](../Page/英语.md "wikilink")[法语中实际通常读作](../Page/法语.md "wikilink")，音译“泰克”。这个词来自[希腊文中的](../Page/希腊文.md "wikilink")
 （TEXNH），希腊文意为“艺术”和“制造”，也是英语中
*technical*（技术）的词源。书写时，三个字母都是大写，字母E应当低于其他两个字母。而不支援下标的系统则只能这样书写：“TeX”。

的用户喜欢创造一些和有关的词汇，例如TeXnician（与英语单词technician，技工的发音相近，意为用户），TeXhacker（TeX程序员，TeX黑客）和TeXnique（与英语单词technique，技巧的发音相近，意为的使用技巧）等。另有人發明一詞為TeXpert（TeX高手），但是[高德納本人反對這一名稱](../Page/高德納.md "wikilink")，因為這裡一詞的讀法是錯誤的\[15\]。

## 参见

  - [文档标记语言比较](../Page/文档标记语言比较.md "wikilink")

  - [公式编辑器](../Page/公式编辑器.md "wikilink")

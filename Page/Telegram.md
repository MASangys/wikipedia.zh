...
2017年9月20日下午([UTC+8](https://zh.wikipedia.org/wiki/UTC+8 "wikilink"))，由於位於新加坡（編號為[DC](https://zh.wikipedia.org/wiki/資料中心 "wikilink")5）的
Telegram 伺服器發生了斷電事故，導致亞洲使用者無法使用
Telegram。\[20\]\[21\]\[22\]\[23\]六天後，再次發生同樣的事故。\[24\]Telegram
在其官方 Twitter 帳號發文稱，他們決定將亞洲區的資料中心遷出新加坡更換到新的地點，但需要時間。30日，又因新加坡資料中心斷電導致
Telegram 亞洲區停擺一小時。
...
为了节省服务器资源，若用户长时间不登录Telegram账号，系统会自动予以销毁（即永久删除），用户可以设置多久后自动销毁该账号，时长分别有一个月后、三个月后、半年后和一年后（默认时长为半年后），用户也可[手动销毁账号](https://my.telegram.org/deactivate)。
...
影片、[維基百科的文章](https://zh.wikipedia.org/wiki/維基百科 "wikilink")，等等。
...
[Telegram_UI_(Windows).png](https://zh.wikipedia.org/wiki/File:Telegram_UI_\(Windows\).png "fig:Telegram_UI_(Windows).png")
  ...
  - [Telegram for macOS](https://macos.telegram.org/)：支援
    [macOS](https://zh.wikipedia.org/wiki/macOS "wikilink")，也是官方發行的第一個應用程式。
  - [Telegram
    Desktop](https://desktop.telegram.org/)：由官方發行，可支援多平台桌面環境的應用程式，支援
    [Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")（[綠色軟體](../Page/綠色軟體.md "wikilink")）、[macOS](https://zh.wikipedia.org/wiki/macOS "wikilink")、[GNU](../Page/GNU計劃.md "wikilink")/[Linux](../Page/Linux发行版.md "wikilink")。
...
### Android 裝置
  ...
  - [Telegram
    X](https://play.google.com/store/apps/details?id=org.thunderdog.challegram)：先是由第三方開發，後被併入為官方版\[57\]
  - [Telegreat
    中文版](https://play.google.com/store/apps/details?id=taipei.sean.telegram.messenger.beta&hl=zh-TW)：由
    Telegram 官方版為底的第三方修改版，加入數十種語系檔，支援多種中文語系
...
### 其他行動裝置
  ...
  - [Firefox OS](../Page/Firefox_OS.md "wikilink")：基於
    [Webogram](https://zh.wikipedia.org/wiki/Webogram "wikilink") 的官方客戶端
  ...
  - [Series 40](../Page/Series_40.md "wikilink") &
    [Symbian](https://zh.wikipedia.org/wiki/Symbian "wikilink")：第三方客戶端
...
對於中文用戶，第三方用戶端 [Telegreat](https://telegre.at/) 整理了 [Telegram
客戶端版本比較](https://tlgr.tw/)，可供選擇時參考。
...
## 外部連結
  ...
  - 第三方中文化翻譯
      ...
      - 簡體中文
          - \[//telegram.show 網站\]
          - \[//t.me/zh_CN Telegram頻道\]（需安裝Telegram）
            \[//t.me/Tele_zh_CN Telegram頻道\]（需安裝Telegram）
      - 繁體中文（香港）
...
63. [伊朗封杀即时聊天软件Telegram，俄罗斯此前已封杀](https://www.thepaper.cn/newsDetail_forward_2106355)
    .澎湃新闻.

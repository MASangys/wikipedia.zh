...
淘寶的Tengine從原來的Nginx添加了下列各項內容\[7\]：
  ...
  - 受到[Apache HTTP Server的](../Page/Apache_HTTP_Server.md "wikilink")*modconcat*功能啟導的CONCAT模塊，可组合多个CSS、JavaScript文件的访问请求变成一个请求\[9\]，以減少數據流量及提高壓縮比；
...
## 主要使用者
  ...
  - [Bilibili](../Page/Bilibili.md "wikilink")彈幕網站
...
## 外部連結
  ...
  -
  -
  - [Launchpad](https://zh.wikipedia.org/wiki/Launchpad "wikilink")：[Tengine Web Server](https://launchpad.net/~brightbox/+archive/ubuntu/tengine)

在[计算机领域中](../Page/计算机.md "wikilink")，**`title`**[命令是更改图形版](../Page/命令_\(计算机\).md "wikilink")[终端模拟器窗口标题的命令](../Page/终端模拟器.md "wikilink")，存在于各种[命令行解释器](../Page/命令行界面.md "wikilink")（[殼層](../Page/殼層.md "wikilink")）中，例如[Windows命令提示字元](../Page/命令提示字元.md "wikilink")、[Windows
Embedded](../Page/Windows_Embedded.md "wikilink")
CE的命令处理器壳层\[1\]，以及软件\[2\]。该命令在和中被用于更改当前[驱动器的光盘标题](../Page/碟盤存儲.md "wikilink")。\[3\]

在Windows命令提示符中，它是一个[`cmd.exe`](../Page/命令提示字元.md "wikilink")的[殼層內建指令](../Page/殼層內建指令.md "wikilink")。\[4\]默认的窗口标题定义在[环境变量](../Page/环境变量.md "wikilink")。\[5\]不过，自从[Win32控制台的标题可以在程序的](../Page/Win32控制台.md "wikilink")[快捷方式中定义](../Page/快捷方式.md "wikilink")，该标题通常被设置为“命令提示符”。此命令在[Windows
2000及之后版本中可用](../Page/Windows_2000.md "wikilink")。\[6\]

尽管[OS/2命令壳层与Windows命令提示符密切相关](../Page/OS/2.md "wikilink")，但`title`在`cmd.exe`的OS/2版本中不可用。OS/2壳层窗口的默认标题是“OS/2
窗口”，可以使用[`start`](../Page/start.md "wikilink")命令更改。

在[Mac OS
X的](../Page/OS_X.md "wikilink")[终端中](../Page/终端_\(OS_X\).md "wikilink")，此命令不可用。而为[`echo`](../Page/Echo_\(命令\).md "wikilink")命令使用特殊的[转义序列可以做到同样目的](../Page/转义序列.md "wikilink")。\[7\]

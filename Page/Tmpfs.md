**tmpfs**是[類Unix系統上暫存檔儲存空間的常見名稱](https://zh.wikipedia.org/wiki/類Unix系統 "wikilink")，通常以掛載檔案系統方式實現，並將資料儲存在[揮發性記憶體](../Page/揮發性記憶體.md "wikilink")而非永久儲存裝置中。和[RAM
...
[SunOS](../Page/SunOS.md "wikilink")是[Solaris](../Page/Solaris.md "wikilink")上一世代的作業系統，裡頭實作了tmpfs的部份功能\[1\]最初在SunOS
...
從2005年九月10號之後tmpfs也正式被收錄到[NetBSD](../Page/NetBSD.md "wikilink")的原始碼裡頭\[5\]，同時在4.0之後的版本啟用了這個功能。
[FreeBSD](../Page/FreeBSD.md "wikilink")也已經收錄了NetBSD的這項功能，在7.0之後的版本也跟著啟用。

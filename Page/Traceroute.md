...
由[愛沙尼亞的](https://zh.wikipedia.org/wiki/愛沙尼亞 "wikilink")`kauge.aso.ee`（`195.80.96.219`）到[美國](https://zh.wikipedia.org/wiki/美國 "wikilink")`larousse.wikipedia.org`（`130.94.122.199`）：

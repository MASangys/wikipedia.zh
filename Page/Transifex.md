...
Transifex支持使用[GNU](../Page/GNU.md "wikilink")
[Gettext](../Page/Gettext.md "wikilink")（.po文件）作为翻译的格式的项目。用户不仅能直接提交文件，也能使用web界面翻译。翻译自动地从上游版本控制系统导入。而且不仅能通过电子邮件提交回上游，还能直接提交回版本控制系统。\[1\]
...
## 外部链接
  ...
  - [Transifex.net主页](http://transifex.net)
  - [Transifex.org主页](http://transifex.org) ——开发入口
  - [Transifex blog](http://blog.transifex.com)
  - [Transifex on
    Freenode](http://arquivo.pt/wayback/20141125012630/http://irc.freenode.net/#transifex)
  - [Indifex Site](http://www.indifex.com) -- The company behind
    Transifex
  - [Transifex appliance on
    rBuilder](https://web.archive.org/web/20100317115537/http://www.rpath.org/web/project/transifex/)

[Category:軟體在地化工具](https://zh.wikipedia.org/wiki/Category:軟體在地化工具 "wikilink")

1.  [Transifex | Frequently Asked

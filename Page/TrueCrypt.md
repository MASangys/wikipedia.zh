...
TrueCrypt的支持独立算法有[AES](https://zh.wikipedia.org/wiki/AES "wikilink")、Serpent和[Twofish](https://zh.wikipedia.org/wiki/双鱼算法 "wikilink")。可以采用五种不同级联算法的组合：AES-Twofish、AES-Twofish-Serpent、Serpent-AES、Serpent-Twofish-AES以及Twofish-Serpent。使用TrueCrypt的加密散列函数的有[RIPEMD-160](https://zh.wikipedia.org/wiki/RIPEMD-160 "wikilink")、[SHA-512和](https://zh.wikipedia.org/wiki/SHA-512 "wikilink")[Whirlpool](../Page/Whirlpool.md "wikilink")。

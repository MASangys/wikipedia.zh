...
System，UBIFS）是一种用於[固态硬盘儲存裝置的](../Page/固态硬盘.md "wikilink")[文件系统](../Page/文件系统.md "wikilink")，它與[LogFS相互競爭](../Page/LogFS.md "wikilink")，是[JFFS2的後繼檔案系統之一](https://zh.wikipedia.org/wiki/JFFS2 "wikilink")。其真正開始開發於2007年，並於2008年10月第一次加入穩定版本於[Linux核心](https://zh.wikipedia.org/wiki/Linux核心 "wikilink")2.6.27版。

UBIFS最早在2006年由[IBM與](../Page/IBM.md "wikilink")[Nokia的工程師Thomas](https://zh.wikipedia.org/wiki/Nokia "wikilink")
Gleixner，Artem
...
UBIFS在設計與性能上均較[YAFFS2](../Page/YAFFS.md "wikilink")、[JFFS2更適合大容量的NAND](https://zh.wikipedia.org/wiki/JFFS2 "wikilink")

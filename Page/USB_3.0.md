...
Speed」，是[通用串列匯流排](../Page/通用串列匯流排.md "wikilink")（Universal
Serial
Bus，USB）的第三個主要修訂版本。其主要技術標準有：支援[全雙工](../Page/全雙工.md "wikilink")，並採用發送列表區段來進行數據發包，供電標準為900[mA](../Page/安培.md "wikilink")，且理论上有支援[光纤传输的潜力](../Page/光纤.md "wikilink")，傳輸速度為5Gbit/s。USB
3.0的设计兼容USB 2.0与USB
1.1版本，并採用[三級多層電源管理技術](../Page/三級多層電源管理技術.md "wikilink")，可以為不同設備提供不同的電源管理方案。

USB
3.0採用新的封包[路由傳輸技術](../Page/路由.md "wikilink")，線纜設計8條內部線路，除[VBus和](../Page/VBus.md "wikilink")[GND作為電源提供線外](../Page/接地.md "wikilink")，剩餘3對均為數據傳輸線路其中保留D+與D-兩條兼容USB
2.0的線路，新增[SSRX與](../Page/SSRX.md "wikilink")[SSTX專為新版所設的線路](../Page/SSTX.md "wikilink")，因此USB
3.0比USB 2.0多了數個[觸點](../Page/觸點.md "wikilink")。USB
3.0的Standard-A接口繼續採用與早先版本一樣的尺寸方案，外观以蓝色区分，只是內部觸點有變化，新的觸點將會並排在目前4個觸點的後方。引入展頻時脈技術，降低電磁輻射的逸散。

Intel發表的[xHCI已经可以支持USB](../Page/xHCI.md "wikilink")3.0的接口，且向下兼容USB2.0的接口。
...
3.0引入[展頻時脈](../Page/展頻.md "wikilink")，將原本集中在2.5GHz頻率的能量，USB
3.0以2.5GHz為中心呈現[正弦函數的絕對值分布](../Page/正弦函數.md "wikilink")，降低2.5GHz集中的能量，這樣下次出現能量集中的地方為三次[諧波](../Page/谐波.md "wikilink")7.5GHz（也因這樣所以在USB
3.0線材規範中都有針對7.5GHz制定要求）。\[2\]

然而，2.5GHz的運作頻率與[ISM頻段](../Page/ISM頻段.md "wikilink")（2.412～2.462GHz）靠得太近，加上展頻時脈技術的緣故，原本單一的2.5GHz訊號的能量會延展成從直流到數GHz的頻寬干擾，令USB
3.0在運作時其電磁波訊號的能量會覆蓋ISM頻段的訊號，也無法使用濾波器過濾訊號。因此同一電路板上USB
3.0無法與[藍芽](../Page/藍芽.md "wikilink")、2.4GHz頻段的WLAN在相鄰不遠的情況下一同運作，而USB論壇針對此一現象，也僅能要求製造商將電磁遮蔽做好，從USB插槽、線材、直到外接裝置端都需要做屏蔽接地的動作，盡量壓低輻射出來的電磁波。\[3\]\[4\]而實測表明USB

...
[替代=](https://zh.wikipedia.org/wiki/File:USB_&_Thunderbolt™_Speed_Comparison.jpg "fig:替代=")的速度比較表\]\]
**USB 3.1**（**SuperSpeed+**，官方全名：**SuperSpeed USB 10 Gbps**）是基於[USB
3.0改良推出的](../Page/USB_3.0.md "wikilink")[USB連接介面的最新版本](../Page/USB.md "wikilink")，此技術其中在生活上應用最出名的是[USB
Type-C接口](../Page/USB_Type-C.md "wikilink")。
...
<!-- end list -->
  ...
  - 2014年4月，負責USB介面規範的[USB開發者論壇](../Page/USB開發者論壇.md "wikilink")（USB-IF）公佈USB
    3.1連接介面設計圖，包括Type-A、Type-B以及全新設計的[Type-C](../Page/USB_Type-C.md "wikilink")\[1\]\[2\]\[3\]\[4\]

<!-- end list -->

  - 2015年，USB開發者論壇協會公告：

而USB 3.0更名為USB 3.1 Gen1。
...
3.0為主及設備端廠商也極少願意跟進投入開發對應的USB3.1產品。\[5\]

USB
Type-C還支援[DisplayPort](../Page/DisplayPort.md "wikilink")\[6\]，功能與[Thunderbolt看齊](../Page/Thunderbolt.md "wikilink")。

[Utf8webgrowth.svg](https://zh.wikipedia.org/wiki/File:Utf8webgrowth.svg "fig:Utf8webgrowth.svg") |url=<http://googleblog.blogspot.com/2010/01/unicode-nearing-50-of-web.html> |access-date=2010-12-05}}</ref>，UTF-8在2008年超過了所有其他數據，2012年使用率接近50％。\]\] **UTF-8**（）是一種針對[Unicode的可變長度](https://zh.wikipedia.org/wiki/Unicode "wikilink")[字元編碼](https://zh.wikipedia.org/wiki/字元編碼 "wikilink")，也是一种[前缀码](https://zh.wikipedia.org/wiki/前缀码 "wikilink")。它可以用來表示Unicode標準中的任何字元，且其編碼中的第一個[位元組仍與](https://zh.wikipedia.org/wiki/位元組 "wikilink")[ASCII](../Page/ASCII.md "wikilink")相容，這使得原來處理ASCII字元的[軟體無須或只須做少部份修改](https://zh.wikipedia.org/wiki/軟體 "wikilink")，即可繼續使用。因此，它逐漸成為[電子郵件](https://zh.wikipedia.org/wiki/電子郵件 "wikilink")、[網頁](../Page/網頁.md "wikilink")及其他[儲存或傳送文字優先採用的編碼](../Page/儲存裝置.md "wikilink")。
...
1992年初，為建立良好的[位元組串編碼系統以供多](https://zh.wikipedia.org/wiki/位元組串編碼系統 "wikilink")[位元組字元集使用](https://zh.wikipedia.org/wiki/位元組 "wikilink")，開始了一個正式的研究。[ISO/IEC 10646的初稿中有一個非必須的附錄](../Page/通用字符集.md "wikilink")，名為UTF。當中包含了一個供32[位元](../Page/位元.md "wikilink")的[字元使用的位元組串編碼系統](https://zh.wikipedia.org/wiki/UCS "wikilink")。這個編碼方式的性能並不令人滿意，但它提出了將0-127的範圍保留給ASCII以相容舊系統的概念。

1992年7月，[X/Open委員會XoJIG開始尋求一個較佳的編碼系統](https://zh.wikipedia.org/wiki/X/Open "wikilink")。[Unix系統實驗室](https://zh.wikipedia.org/wiki/Unix系統實驗室 "wikilink")（USL）的Dave Prosser為此提出了一個編碼系統的建議。它具備可更快速實作的特性，並引入一項新的改進。其中，7[位元](../Page/位元.md "wikilink")的[ASCII](../Page/ASCII.md "wikilink")符號只代表原來的意思，所有多位元組序列則會包含第8[位元](../Page/位元.md "wikilink")的符號，也就是所謂的[最高有效位元](https://zh.wikipedia.org/wiki/最高有效位元 "wikilink")。

1992年8月，這個建議由[IBM](../Page/IBM.md "wikilink")[X/Open的代表流傳到一些感興趣的團體](https://zh.wikipedia.org/wiki/X/Open "wikilink")。與此同時，[貝爾實驗室](https://zh.wikipedia.org/wiki/貝爾實驗室 "wikilink")[九號計畫](../Page/貝爾實驗室九號計畫.md "wikilink")[作業系統工作小組的](https://zh.wikipedia.org/wiki/作業系統 "wikilink")[肯·汤普逊](../Page/肯·汤普逊.md "wikilink")對這編碼系統作出重大的修改，讓編碼可以自我同步，使得不必從字串的開首讀取，也能找出字符間的分界。1992年9月2日，[肯·汤普逊](../Page/肯·汤普逊.md "wikilink")和[羅勃·派克](../Page/羅勃·派克.md "wikilink")一起在[美國](https://zh.wikipedia.org/wiki/美國 "wikilink")[新澤西州一架餐車的餐桌墊上描繪出此設計的要點](https://zh.wikipedia.org/wiki/新澤西州 "wikilink")。接下來的日子，Pike及汤普逊將它實現，並將這編碼系統完全應用在[九號計畫當中](../Page/貝爾實驗室九號計畫.md "wikilink")，及後他將有關成果回饋X/Open。
...
[UTF-8_Encoding_Scheme.png](https://zh.wikipedia.org/wiki/File:UTF-8_Encoding_Scheme.png "fig:UTF-8_Encoding_Scheme.png") 目前有好幾份關於UTF-8詳細規格的文件，但這些文件在定義上有些許的不同：

  - RFC 3629 / STD 63（2003），這份文件制定了UTF-8是標準的[網際網路](https://zh.wikipedia.org/wiki/網際網路 "wikilink")[協議元素](https://zh.wikipedia.org/wiki/網路協議 "wikilink")
...
Unicode[字元的](https://zh.wikipedia.org/wiki/UCS "wikilink")[位元](../Page/位元.md "wikilink")被分割為數個部分，並分配到UTF-8的[位元組串中較低的](https://zh.wikipedia.org/wiki/位元組 "wikilink")[位元](../Page/位元.md "wikilink")的位置。在U+0080的以下[字元都使用內含其字元的單](https://zh.wikipedia.org/wiki/UCS "wikilink")[位元組編碼](https://zh.wikipedia.org/wiki/位元組 "wikilink")。這些編碼正好對應7位元的ASCII字符。在其他情況，有可能需要多達4個字元組來表示一個字元。這些多位元組的[最高有效位元會設定成](https://zh.wikipedia.org/wiki/最高有效位元 "wikilink")1，以防止與7位元的ASCII字符混淆，並保持標準的位元組主導字串運作順利。
...
例如，希伯来语字母aleph（א）的Unicode代码是U+05D0，按照以下方法改成UTF-8：
  ...
  - [十六进制](../Page/十六进制.md "wikilink")的0x05D0换算成[二进制就是](https://zh.wikipedia.org/wiki/二进制 "wikilink")101-1101-0000.
  - 这11位数按顺序放入"y"部分和"z"部分：110**10111** 10**010000**.
  - 最后结果就是双字节，用十六进制写起来就是0xD7 0x90，这就是这个字符aleph（א）的UTF-8编码。

所以开始的128个字元（US-ASCII）只需一字节，接下来的1920个字符需要双字节编码，包括带[附加符号](../Page/附加符号.md "wikilink")的[拉丁字母](../Page/拉丁字母.md "wikilink")，[希腊字母](../Page/希腊字母.md "wikilink")，[西里尔字母](../Page/西里尔字母.md "wikilink")，[科普特语](../Page/科普特语.md "wikilink")字母，[亚美尼亚语](../Page/亚美尼亚语.md "wikilink")字母，[希伯来文字母和](https://zh.wikipedia.org/wiki/希伯来文 "wikilink")[阿拉伯字母](../Page/阿拉伯字母.md "wikilink")的字元。[基本多文種平面中其余的字元使用三个字节](https://zh.wikipedia.org/wiki/基本多文種平面 "wikilink")，剩余字符使用四个字节。

根据这种方式可以处理更大数量的字元。原来的规范允许长达6字节的序列，可以覆盖到31位元（[通用字符集](../Page/通用字符集.md "wikilink")原来的极限）。尽管如此，2003年11月UTF-8被RFC 3629重新规范，-{只}-能使用原来Unicode定义的区域，U+0000到U+10FFFF。根据这些规范，以下字节值将无法出现在合法UTF-8序列中：
...
UTF-8的這些特質，保證了一個字符的[字节](../Page/字节.md "wikilink")序列不会包含在另一個字符的[字节](../Page/字节.md "wikilink")序列中。這確保了以位元組為基礎的部份字串比對（sub-string match）方法可以適用於在文字中搜尋字或詞。有些比較舊的可變長度8位元編碼（如[Shift JIS](../Page/Shift_JIS.md "wikilink")）沒有這個特質，故字串比對的算法變得相當複雜。雖然這增加了UTF-8編碼的字串的[信息冗餘](https://zh.wikipedia.org/wiki/信息冗餘 "wikilink")，但是利多於弊。另外，[資料壓縮並非Unicode的目的](https://zh.wikipedia.org/wiki/資料壓縮 "wikilink")，所以不可混為一談。即使在傳送過程中有部份位元組因錯誤或干擾而完全遺失，還是有可能在下一個字符的起點重新同步，令受損範圍受到限制。
...
UTF-8是UNICODE的一種變長度的編碼表達方式{{〈}}一般UNICODE為雙位元組（指UCS2）{{〉}}，它由[肯·汤普逊](../Page/肯·汤普逊.md "wikilink")<small>（）</small>于1992年建立，現在已經標準化為RFC 3629。UTF-8就是以8位为单元对UCS进行编码，而UTF-8不使用大尾序和小尾序的形式，每個使用UTF-8儲存的字符，除了第一個字節外，其餘字節的頭兩個位元都是以"10"開始，使文字處理器能夠較快地找出每個字符的開始位置。
...
更詳細的說，UTF-8編碼具有以下幾點優點：
  ...
  - UTF-8字符串可以由一个简单的算法可靠地识别出来。就是，一个字符串在任何其它编码中表现为合法的UTF-8的可能性很低，并随字符串长度增长而减小。举例说，字元值C0,C1,F5至FF从来没有出现。为了更好的可靠性，可以使用正则表达式来统计非法过长和替代值（可以查看[W3 FAQ: Multilingual Forms](http://www.w3.org/International/questions/qa-forms-utf-8)上的验证UTF-8字符串的正则表达式）。
...
[正则表达式](../Page/正则表达式.md "wikilink")可以进行很多英文高级的模糊检索。例如，\[a-h\]表示a到h间所有字母。

同样GBK编码的中文也可以这样利用[正则表达式](../Page/正则表达式.md "wikilink")，比如在只知道一个字的读音而不知道怎么写的情况下，也可用[正则表达式](../Page/正则表达式.md "wikilink")检索，因为GBK编码是按读音排序的。但是UTF-8不是按读音排序的，所以不利于用正则表达式检索（虽然正则表达式检索並未考慮中文中的多音字，但是由于中文的多音字数量不多，不少多音字还是同音不同调类型的多音字，所以大多数情况下正则表达式检索是可以接受的）。但是，Unicode是按部首排序的，因此在只知道一個字的部首而不知道如何發音的情况下，UTF-8可用[正则表达式](../Page/正则表达式.md "wikilink")检索而GBK不行。
...
在資料庫系統[MySQL](../Page/MySQL.md "wikilink")或[MariaDB](../Page/MariaDB.md "wikilink")中有多种字符集，其中utf8_unicode_ci和utf8_general_ci是最常用的，但是utf8_general_ci对某些语言的支持有一些小问题，如果可以接受，那最好使用utf8_general_ci，因为它速度快。否则，请使用较为精确的utf8_unicode_ci，不过速度会慢一些。

## UTF-8的衍生物

### Windows

雖然不是標準，但許多Windows程序（包括Windows记事本）在UTF-8編碼的檔案的開首加入一段位元組串`EF BB BF`。這是[位元組順序記號](../Page/位元組順序記號.md "wikilink")`U+FEFF`的UTF-8編碼結果。對於沒有預期要處理UTF-8的文字編輯器和瀏覽器會顯示成ISO-8859-1字符串`ï»¿`。

### Posix系统

Posix系统明确不建议使用字节序掩码`EF BB BF`。\[3\]因为很多文本文件期望以 “\#\!”（[Shebang](../Page/Shebang.md "wikilink")）开头指示要运行的程序。Linux系统选择使用Unicode规范形式Normalization Form C（NFC），即优先使用预组装字符（precomposed character）而非组合字符序列（combining character sequence）。

2002年9月发布的[Red Hat Linux 8.0才开始正式把大多数](../Page/Red_Hat_Linux.md "wikilink")[区域设置](../Page/区域设置.md "wikilink")的默认编码设为UTF-8。此前是各种语言的但字节编码为主。2004年9月[SuSE Linux 9.1开始](https://zh.wikipedia.org/wiki/SuSE_Linux "wikilink")，缺省编码迁移为UTF-8。

字符串处理时，使用UTF-8或locale依赖的多字节编码情形，比使用C语言wchar_t的宽字符固定宽度编码，要慢1至2个数量级。\[4\]

### Java

在通常用法下，[Java](../Page/Java.md "wikilink")程序语言在通过和读取和写入串的时候支持标准UTF-8。但是，Java也支持一种非标准的变体UTF-8，供对象的[序列化](../Page/序列化.md "wikilink")，[Java本地界面和在class文件中的嵌入常数時使用的](https://zh.wikipedia.org/wiki/Java本地界面 "wikilink")。

### 變種UTF-8

标准和變種的UTF-8有两个不同点。第一，[空字符](../Page/空字符.md "wikilink")（null character，U+0000）使用雙字节的0xc0 0x80，而不是单字节的0x00。这保证了在已编码字串中没有嵌入空字节。因为[C语言等语言程序中](https://zh.wikipedia.org/wiki/C语言 "wikilink")，单字节空字符是用来标志字串结尾的。当已编码字串放到这样的语言中處理，一个嵌入的空字符将把字串一刀两断。

第二个不同点是[基本多文種平面之外字符的编码的方法](https://zh.wikipedia.org/wiki/基本多文種平面 "wikilink")。在标准UTF-8中，这些字符使用4字节形式编码，而在修正的UTF-8中，这些字符和UTF-16一样首先表示为代理对（surrogate pairs），然后再像[CESU-8那样按照代理对分别编码](https://zh.wikipedia.org/wiki/CESU-8 "wikilink")。这样修正的原因更是微妙。Java中的字符为16位长，因此一些Unicode字符需要两个Java字符来表示。语言的这个性质蓋過了Unicode的增补平面的要求。尽管如此，為了要保持良好的向后兼容、要改變也不容易了。这个修正的编码系統保证了一个已编码字串可以一次编为一个UTF-16码，而不是一次一个Unicode码点。不幸的是，这也意味着UTF-8中需要4字节的字符在變種UTF-8中变成需要6字节。

因为變種UTF-8并**不是**UTF-8，所以用户在交换信息和使用互联网的时候需要特别注意不要误把變種UTF-8當成UTF-8数据。

### Mac OS X

[Mac OS X](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")[操作系统](../Page/操作系统.md "wikilink")使用正式分解万国码（canonically decomposed Unicode），在[文件系统](../Page/文件系统.md "wikilink")中使用UTF-8编码进行文件命名，這做法通常被称为UTF-8-MAC。正式分解万国码中，预组合字符是被禁止使用的，必须以[组合字符取代](https://zh.wikipedia.org/wiki/组合字符 "wikilink")。

这种方法使分类变得非常简单，但是会搞混那些使用预组合字符为标准、组合字符用来显示特殊字符的软件。Mac系统的这种NFD数据是[万国码规范化](https://zh.wikipedia.org/wiki/万国码规范化 "wikilink")（Unicode normalization）的一种格式。而其他系统，包括[Windows和](https://zh.wikipedia.org/wiki/Windows "wikilink")[Linux](../Page/Linux.md "wikilink")，使用万国码规范的NFC形式，也是[W3C标准使用的形式](https://zh.wikipedia.org/wiki/W3C "wikilink")。所以通常NFD数据必须转换成NFC才能被其他平台或者网络使用。

苹果开发者专区有关于此问题的讨论：[Apple Q\&A 1173](http://developer.apple.com/qa/qa2001/qa1173.html)。

## 参考文献

## 由[統一碼聯盟](../Page/統一碼聯盟.md "wikilink")出版的書
...
## 外部連結
  ...
  - [Original UTF-8 paper](https://web.archive.org/web/20050505032430/http://www.cs.bell-labs.com/sys/doc/utf.pdf)
  - UTF-8 test pages by [University Hannover](http://www.unics.uni-hannover.de/nhtcapri/multilingual1.html) and the [World Wide Web Consortium](http://www.w3.org/2001/06/utf-8-test/UTF-8-demo.html)
  - Unix/Linux: [UTF-8和Unicode的常見問題集](http://www.cl.cam.ac.uk/~mgk25/unicode.html)，[Linux Unicode HOWTO](https://web.archive.org/web/20050404103611/http://www.linux.org/docs/ldp/howto/Unicode-HOWTO.html)，[UTF-8 and Gentoo](http://www.gentoo.org/doc/en/utf-8.xml)
  - [The Unicode/UTF-8-character table](http://www.utf8-chartable.de/) displays UTF-8 in a variety of formats（with Unicode and HTML encoding information）
  - [Online Tool](https://web.archive.org/web/20070403222748/http://netzreport.googlepages.com/online_tool_for_url_en_decoding.html) for URL encoding/decoding according to RFC 3986 and RFC 3629（[JavaScript](../Page/JavaScript.md "wikilink")，[GPL](https://zh.wikipedia.org/wiki/GPL "wikilink")）
...
## 参见
  ...
  - [Comparison of email clients\#Features](https://zh.wikipedia.org/wiki/Comparison_of_email_clients#Features "wikilink")
  - [Comparison of Unicode encodings](https://zh.wikipedia.org/wiki/Comparison_of_Unicode_encodings "wikilink")
  - [Character encodings in HTML](https://zh.wikipedia.org/wiki/Character_encodings_in_HTML "wikilink")
  ...
  - [Unicode and e-mail](https://zh.wikipedia.org/wiki/Unicode_and_e-mail "wikilink")
  - [Unicode and HTML](https://zh.wikipedia.org/wiki/Unicode_and_HTML "wikilink")
...
3.  [UTF-8 and Unicode FAQ for Unix/Linux by Markus Kuhn](http://www.cl.cam.ac.uk/~mgk25/unicode.html)

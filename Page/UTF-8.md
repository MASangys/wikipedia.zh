...
**UTF-8**（）是一種針對[Unicode的可變長度](../Page/Unicode.md "wikilink")[字元編碼](../Page/字元編碼.md "wikilink")，也是一种[前缀码](../Page/前缀码.md "wikilink")。它可以用來表示Unicode標準中的任何字元，且其編碼中的第一個[位元組仍與](../Page/位元組.md "wikilink")[ASCII相容](../Page/ASCII.md "wikilink")，這使得原來處理ASCII字元的[軟體無須或只須做少部份修改](../Page/軟體.md "wikilink")，即可繼續使用。因此，它逐漸成為[電子郵件](../Page/電子郵件.md "wikilink")、[網頁及其他](../Page/網頁.md "wikilink")[儲存或傳送文字優先採用的編碼](../Page/儲存裝置.md "wikilink")。

UTF-8使用一至六個[位元組為每個字符編碼](../Page/位元組.md "wikilink")（儘管如此，2003年11月UTF-8被RFC
3629重新規範，只能使用原来Unicode定義的區域，U+0000到U+10FFFF，也就是說最多四個字節）：

1.  128個US-ASCII字符只需一個位元組編碼（Unicode範圍由U+0000至U+007F）。
2.  帶有[附加符号的](../Page/附加符号.md "wikilink")[拉丁文](../Page/拉丁文.md "wikilink")、[希臘文](../Page/希臘文.md "wikilink")、[西里爾字母](../Page/西里爾字母.md "wikilink")、[亞美尼亞語](../Page/亞美尼亞語.md "wikilink")、[希伯來文](../Page/希伯來文.md "wikilink")、[阿拉伯文](../Page/阿拉伯文.md "wikilink")、[敘利亞文及](../Page/敘利亞文.md "wikilink")[它拿字母則需要兩個位元組編碼](../Page/它拿字母.md "wikilink")（Unicode範圍由U+0080至U+07FF）。
3.  其他[基本多文種平面](../Page/基本多文種平面.md "wikilink")（BMP）中的字元（這包含了大部分常用字，如大部分的漢字）使用三個位元組編碼（Unicode範圍由U+0800至U+FFFF）。
4.  其他極少使用的Unicode
    [輔助平面的字元使用四至六位元組編碼](../Page/輔助平面.md "wikilink")（Unicode範圍由U+10000至U+1FFFFF使用四字節，Unicode範圍由U+200000至U+3FFFFFF使用五字節，Unicode範圍由U+4000000至U+7FFFFFFF使用六字節）。

對上述提及的第四種字元而言，UTF-8使用四至六個位元組來編碼似乎太耗費資源了。但UTF-8對所有常用的字元都可以用三個位元組表示，而且它的另一種選擇，[UTF-16編碼](../Page/UTF-16.md "wikilink")，對前述的第四種字符同樣需要四個位元組來編碼，所以要決定UTF-8或UTF-16哪種編碼比較有效率，還要視所使用的字元的分佈範圍而定。不過，如果使用一些傳統的壓縮系統，比如[DEFLATE](../Page/DEFLATE.md "wikilink")，則這些不同編碼系統間的的差異就變得微不足道了。若顧及傳統壓縮算法在壓縮較短文字上的效果不大，可以考慮使用[Unicode標準壓縮格式](../Page/Unicode標準壓縮格式.md "wikilink")（SCSU）。

[網際網路工程工作小組](../Page/網際網路工程工作小組.md "wikilink")（IETF）要求所有[網際網路](../Page/網際網路.md "wikilink")[協議都必須支持UTF](../Page/網路協議.md "wikilink")-8編碼\[1\]。[互聯網郵件聯盟](../Page/互聯網郵件聯盟.md "wikilink")（IMC）建議所有電子郵件軟件都支持UTF-8編碼。\[2\]

## 歷史

1992年初，為建立良好的[位元組串編碼系統以供多](../Page/位元組串編碼系統.md "wikilink")[位元組字元集使用](../Page/位元組.md "wikilink")，開始了一個正式的研究。[ISO/IEC
10646的初稿中有一個非必須的附錄](../Page/通用字符集.md "wikilink")，名為UTF。當中包含了一個供32[位元的](../Page/位元.md "wikilink")[字元使用的位元組串編碼系統](../Page/UCS.md "wikilink")。這個編碼方式的性能並不令人滿意，但它提出了將0-127的範圍保留給ASCII以相容舊系統的概念。

1992年7月，[X/Open委員會XoJIG開始尋求一個較佳的編碼系統](../Page/X/Open.md "wikilink")。[Unix系統實驗室](../Page/Unix系統實驗室.md "wikilink")（USL）的Dave
Prosser為此提出了一個編碼系統的建議。它具備可更快速實作的特性，並引入一項新的改進。其中，7[位元的](../Page/位元.md "wikilink")[ASCII符號只代表原來的意思](../Page/ASCII.md "wikilink")，所有多位元組序列則會包含第8[位元的符號](../Page/位元.md "wikilink")，也就是所謂的[最高有效位元](../Page/最高有效位元.md "wikilink")。

1992年8月，這個建議由[IBM](../Page/IBM.md "wikilink")[X/Open的代表流傳到一些感興趣的團體](../Page/X/Open.md "wikilink")。與此同時，[貝爾實驗室](../Page/貝爾實驗室.md "wikilink")[九號計畫](../Page/貝爾實驗室九號計畫.md "wikilink")[作業系統工作小組的](../Page/作業系統.md "wikilink")[肯·汤普逊對這編碼系統作出重大的修改](../Page/肯·汤普逊.md "wikilink")，讓編碼可以自我同步，使得不必從字串的開首讀取，也能找出字符間的分界。1992年9月2日，[肯·汤普逊和](../Page/肯·汤普逊.md "wikilink")[羅勃·派克一起在](../Page/羅勃·派克.md "wikilink")[美國](../Page/美國.md "wikilink")[新澤西州一架餐車的餐桌墊上描繪出此設計的要點](../Page/新澤西州.md "wikilink")。接下來的日子，Pike及汤普逊將它實現，並將這編碼系統完全應用在[九號計畫當中](../Page/貝爾實驗室九號計畫.md "wikilink")，及後他將有關成果回饋X/Open。

1993年1月25-29日的在[聖地牙哥舉行的](../Page/聖地牙哥.md "wikilink")[USENIX會議首次正式介紹UTF](../Page/USENIX.md "wikilink")-8。

自1996年起，[微軟的](../Page/微軟.md "wikilink")[CAB](../Page/CAB.md "wikilink")（MS
...
目前有好幾份關於UTF-8詳細規格的文件，但這些文件在定義上有些許的不同：
  ...
  - RFC 3629 / STD
    63（2003），這份文件制定了UTF-8是標準的[網際網路](../Page/網際網路.md "wikilink")[協議元素](../Page/網路協議.md "wikilink")
...
Unicode[字元的](../Page/UCS.md "wikilink")[位元被分割為數個部分](../Page/位元.md "wikilink")，並分配到UTF-8的[位元組串中較低的](../Page/位元組.md "wikilink")[位元的位置](../Page/位元.md "wikilink")。在U+0080的以下[字元都使用內含其字元的單](../Page/UCS.md "wikilink")[位元組編碼](../Page/位元組.md "wikilink")。這些編碼正好對應7位元的ASCII字符。在其他情況，有可能需要多達4個字元組來表示一個字元。這些多位元組的[最高有效位元會設定成](../Page/最高有效位元.md "wikilink")1，以防止與7位元的ASCII字符混淆，並保持標準的位元組主導字串運作順利。

<table>
<thead>
<tr class="header">
<th><p>代碼範圍<br />
<a href="../Page/十六進制.md" title="wikilink">十六進制</a></p></th>
<th><p>標量值（scalar value）<br />
<a href="../Page/二進制.md" title="wikilink">二進制</a></p></th>
<th><p>UTF-8<br />
<a href="../Page/二進制.md" title="wikilink">二進制</a>／<a href="../Page/十六進制.md" title="wikilink">十六進制</a></p></th>
<th><p>註釋</p></th>
</tr>
</thead>
<tbody>
...
<td></td>
  ...
  -
    ...
    Unicode在範圍D800-DFFF中不存在任何字元，[基本多文種平面中約定了這個範圍用於UTF](../Page/基本多文種平面.md "wikilink")-16擴展標識[辅助平面](../Page/辅助平面.md "wikilink")（兩個UTF-16表示一個[辅助平面字符](../Page/辅助平面.md "wikilink")）。當然，任何編碼都是可以被轉換到這個範圍，但在unicode中他們並不代表任何合法的值。

例如，希伯来语字母aleph（א）的Unicode代码是U+05D0，按照以下方法改成UTF-8：

  - 它属于U+0080到U+07FF区域，这个表说明它使用双字节，*110*yyyyy *10*zzzzzz.
  - [十六进制的](../Page/十六进制.md "wikilink")0x05D0换算成[二进制就是](../Page/二进制.md "wikilink")101-1101-0000.
  - 这11位数按顺序放入"y"部分和"z"部分：110**10111** 10**010000**.
  - 最后结果就是双字节，用十六进制写起来就是0xD7 0x90，这就是这个字符aleph（א）的UTF-8编码。

所以开始的128个字元（US-ASCII）只需一字节，接下来的1920个字符需要双字节编码，包括带[附加符号的](../Page/附加符号.md "wikilink")[拉丁字母](../Page/拉丁字母.md "wikilink")，[希腊字母](../Page/希腊字母.md "wikilink")，[西里尔字母](../Page/西里尔字母.md "wikilink")，[科普特语字母](../Page/科普特语.md "wikilink")，[亚美尼亚语字母](../Page/亚美尼亚语.md "wikilink")，[希伯来文字母和](../Page/希伯来文.md "wikilink")[阿拉伯字母的字元](../Page/阿拉伯字母.md "wikilink")。[基本多文種平面中其余的字元使用三个字节](../Page/基本多文種平面.md "wikilink")，剩余字符使用四个字节。
...
<thead>
<tr class="header">
<th><p>编码（<a href="../Page/二进制.md" title="wikilink">二进制</a>）</p></th>
...
UTF-8的設計有以下的多字元組序列的特質：
  ...
  - 單位元組字符的[最高有效位元永遠為](../Page/最高有效位元.md "wikilink")0。
  - 多位元組序列中的首個字元組的幾個[最高有效位元決定了序列的長度](../Page/最高有效位元.md "wikilink")。最高有效位為`110`的是2位元組序列，而`1110`的是三位元組序列，如此類推。
...
JIS](../Page/Shift_JIS.md "wikilink")）沒有這個特質，故字串比對的算法變得相當複雜。雖然這增加了UTF-8編碼的字串的[信息冗餘](../Page/信息冗餘.md "wikilink")，但是利多於弊。另外，[資料壓縮並非Unicode的目的](../Page/資料壓縮.md "wikilink")，所以不可混為一談。即使在傳送過程中有部份位元組因錯誤或干擾而完全遺失，還是有可能在下一個字符的起點重新同步，令受損範圍受到限制。
...
但為了與以前的ASCII碼相容（ASCII為一個位元組），因此UTF-8選擇了使用可變長度[字節來儲存Unicode](../Page/字節.md "wikilink")：
...
ASCII字母繼續使用1字節儲存，[重音文字](../Page/重音文字.md "wikilink")、[希臘字母或](../Page/希臘字母.md "wikilink")[西里爾字母等使用](../Page/西里爾字母.md "wikilink")2字節來儲存，而常用的[漢字就要使用](../Page/漢字.md "wikilink")3字節。[辅助平面字元則使用](../Page/辅助平面.md "wikilink")4字節。
...
更詳細的說，UTF-8編碼具有以下幾點優點：
  ...
  - UTF-8和UTF-16都是[可扩展标记语言文档的标准编码](../Page/可扩展标记语言.md "wikilink")。所有其它编码都必须通过显式或文本声明来指定。[1](http://www.w3.org/TR/REC-xml/#charencoding)
  - 任何[面向字节的](../Page/面向字节.md "wikilink")[字符串搜索算法都可以用于UTF](../Page/字符串搜索算法.md "wikilink")-8的数据（-{只}-要输入仅由完整的UTF-8字符组成）。但是，对于包含字符记数的正则表达式或其它结构必须小心。
...
一份写得很差（并且与当前标准的版本不兼容）的UTF-8[解析器可能会接受一些不同的伪UTF](../Page/解析器.md "wikilink")-8表示并将它们转换到相同的Unicode输出上。这为设计用于处理八位表示的校验例程提供了一种遗漏信息的方式。
...
與其他Unicode編碼相比，特別是UTF-16，在UTF-8中ASCII字元佔用的空間-{只}-有一半，可是在一些字元的UTF-8編碼佔用的空間就要多出1/3，特別是中文、日文和韓文（[CJK](../Page/CJK.md "wikilink")）這樣的方塊文字。
...
Linux 9.1开始](../Page/SuSE_Linux.md "wikilink")，缺省编码迁移为UTF-8。

字符串处理时，使用UTF-8或locale依赖的多字节编码情形，比使用C语言wchar_t的宽字符固定宽度编码，要慢1至2个数量级。\[4\]

### Java

在通常用法下，[Java程序语言在通过](../Page/Java.md "wikilink")和读取和写入串的时候支持标准UTF-8。但是，Java也支持一种非标准的变体UTF-8，供对象的[序列化](../Page/序列化.md "wikilink")，[Java本地界面和在class文件中的嵌入常数時使用的](../Page/Java本地界面.md "wikilink")。

### 變種UTF-8

标准和變種的UTF-8有两个不同点。第一，[空字符](../Page/空字符.md "wikilink")（null
character，U+0000）使用雙字节的0xc0
0x80，而不是单字节的0x00。这保证了在已编码字串中没有嵌入空字节。因为[C语言等语言程序中](../Page/C语言.md "wikilink")，单字节空字符是用来标志字串结尾的。当已编码字串放到这样的语言中處理，一个嵌入的空字符将把字串一刀两断。

第二个不同点是[基本多文種平面之外字符的编码的方法](../Page/基本多文種平面.md "wikilink")。在标准UTF-8中，这些字符使用4字节形式编码，而在修正的UTF-8中，这些字符和UTF-16一样首先表示为代理对（surrogate
pairs），然后再像[CESU-8那样按照代理对分别编码](../Page/CESU-8.md "wikilink")。这样修正的原因更是微妙。Java中的字符为16位长，因此一些Unicode字符需要两个Java字符来表示。语言的这个性质蓋過了Unicode的增补平面的要求。尽管如此，為了要保持良好的向后兼容、要改變也不容易了。这个修正的编码系統保证了一个已编码字串可以一次编为一个UTF-16码，而不是一次一个Unicode码点。不幸的是，这也意味着UTF-8中需要4字节的字符在變種UTF-8中变成需要6字节。
...
[Mac OS
X](../Page/Mac_OS_X.md "wikilink")[操作系统使用正式分解万国码](../Page/操作系统.md "wikilink")（canonically
decomposed
Unicode），在[文件系统中使用UTF](../Page/文件系统.md "wikilink")-8编码进行文件命名，這做法通常被称为UTF-8-MAC。正式分解万国码中，预组合字符是被禁止使用的，必须以[组合字符取代](../Page/组合字符.md "wikilink")。

这种方法使分类变得非常简单，但是会搞混那些使用预组合字符为标准、组合字符用来显示特殊字符的软件。Mac系统的这种NFD数据是[万国码规范化](../Page/万国码规范化.md "wikilink")（Unicode
normalization）的一种格式。而其他系统，包括[Windows和](../Page/Windows.md "wikilink")[Linux](../Page/Linux.md "wikilink")，使用万国码规范的NFC形式，也是[W3C标准使用的形式](../Page/W3C.md "wikilink")。所以通常NFD数据必须转换成NFC才能被其他平台或者网络使用。
...
## 外部連結
  ...
  - [Online
    ...
    3629（[JavaScript](../Page/JavaScript.md "wikilink")，[GPL](../Page/GPL.md "wikilink")）
  - [UTF-8測試頁](http://www.slovo.info/testuni.htm)
  - [UTF-8](http://www.utf-8.com/)

## 参见

  - [Alt codes](../Page/Alt_codes.md "wikilink")
  - [ASCII](../Page/ASCII.md "wikilink")
  - [位元組順序記號](../Page/位元組順序記號.md "wikilink")
  - [Comparison of email
    clients\#Features](../Page/Comparison_of_email_clients#Features.md "wikilink")
  - [Comparison of Unicode
    encodings](../Page/Comparison_of_Unicode_encodings.md "wikilink")
  - [Character encodings in
    HTML](../Page/Character_encodings_in_HTML.md "wikilink")
  - [ISO/IEC 8859](../Page/ISO/IEC_8859.md "wikilink")
  - [GB18030](../Page/GB18030.md "wikilink")
  - [UTF-8 in
    URIs](../Page/Percent-encoding#Current_standard.md "wikilink")
  - [Unicode and e-mail](../Page/Unicode_and_e-mail.md "wikilink")
  - [Unicode and HTML](../Page/Unicode_and_HTML.md "wikilink")
  - [Universal Character
    Set](../Page/Universal_Character_Set.md "wikilink")
  - [UTF-16](../Page/UTF-16.md "wikilink")
  - [UTF-9和UTF-18](../Page/UTF-9和UTF-18.md "wikilink")

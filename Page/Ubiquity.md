...
Ubiquity与一般的混搭性质不同，它是一种以用户为中心的混搭，根据用户个人的需求而实现，而目前各种网站使用的混搭，却是以网站本身为中心的。用户想要使用Ubiquity，只需要在Firefox下输入Ubiquity的快捷键[Mac用户默认为](https://zh.wikipedia.org/wiki/Mac "wikilink")`option-space`，[Windows用户默认为](https://zh.wikipedia.org/wiki/Windows "wikilink")`control-space`），即可得到Ubiquity的界面，并在那里输入有关命令，完成工作。Ubiquity用户将不需要再到其他的网站上完成这些任务\[4\]。
...
| `tinyurl`              | 使用[Tinyurl缩短一段](https://zh.wikipedia.org/wiki/Tinyurl "wikilink")[URL](https://zh.wikipedia.org/wiki/URL "wikilink") | 0.1   |
| `translate`            | 使用[Google](../Page/Google.md "wikilink")[翻译一段文本](../Page/Google翻译.md "wikilink")                                     | 0.1   |
| `twitter`              | 使用[twitter说一段话](https://zh.wikipedia.org/wiki/twitter "wikilink")                                                    | 0.1   |

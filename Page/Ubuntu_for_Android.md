...
## 功能
  ...
  - 在Ubuntu桌面运行Android应用程序。\[10\]
  - 直接从桌面接听电话和短信。\[11\]\[12\]

## 系统要求

根据[Canonical公司](https://zh.wikipedia.org/wiki/Canonical公司 "wikilink")，手机要求如下：\[13\]

  - 双核 1 GHz [CPU](https://zh.wikipedia.org/wiki/CPU "wikilink")
  - 视频加速：shared kernel driver with associated
    [X](../Page/X.Org_Server.md "wikilink") driver;
    [OpenGL](../Page/OpenGL.md "wikilink"),
    [ES](../Page/OpenGL_ES.md "wikilink")/[EGL](https://zh.wikipedia.org/wiki/EGL_\(OpenGL\) "wikilink")
  - 存储： 2 GB用于操作系统镜像
  - [HDMI](../Page/HDMI.md "wikilink")： video-out with secondary
    framebuffer device
  - USB主机模式
  - 512 MB RAM

注：大多数智能手机不能同时在单个端口上使用MHL和USB接口。要同时使用这两个功能，需要一个单独的HDMI端口（Motorola
Razr/Razr HD、Xperia S/Acro S、Asus Padfone） 或即将到来的MHL2端口。Samsung Galaxy
S3/S4/Note2上还有一个非标准解决方案。

## 参见

  - [LinuxOnAndroid](https://zh.wikipedia.org/wiki/LinuxOnAndroid "wikilink")
  - [Docking
    station](https://zh.wikipedia.org/wiki/Docking_station "wikilink")
...
[Category:扩展坞](https://zh.wikipedia.org/wiki/Category:扩展坞 "wikilink")

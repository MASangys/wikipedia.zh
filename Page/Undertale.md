...
<!-- end list -->
  ...
  -
    ...
    Retribution，簡稱KR）取消玩家的無敵時間（亦指傷害冷卻時間，一般怪物攻擊玩家時，會使靈魂閃爍，閃爍狀態是無法對靈魂造成傷害，但sans不但可以連續攻擊，且在特殊時段裡，他的攻擊將具有持續性的傷害）
...
<!-- end list -->
  ...
  -
    整個遊戲的最大黑幕。外表為一個擁有白皙皮膚的兒童，性別不明。穿著綠黃相間的橫條紋上衣，頰上有著紅暈，面帶微笑。玩家實際命名的角色，真名只會在屠殺路線中揭示，當中牽涉遊戲系統引導的巧妙之處。

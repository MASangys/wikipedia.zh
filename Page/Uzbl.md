...
Uzbl的[用户界面设计时考虑仅使用](../Page/用户界面.md "wikilink")[键盘快捷键即可进行控制](../Page/快捷键.md "wikilink")，默认的[超链接操作方案和一个](https://zh.wikipedia.org/wiki/超链接 "wikilink")[Firefox浏览器扩展](../Page/Firefox.md "wikilink")[vimperator一致](https://zh.wikipedia.org/wiki/vimperator "wikilink")\[6\]。通过键盘快捷键进入特定的模式，浏览界面的每个[链接会自动标出数字](https://zh.wikipedia.org/wiki/超链接 "wikilink")，按下相应的数字键（0-9）即可访问该链接，或者也可以通过输入相应的文字选中链接。对于熟悉著名[文本编辑器](../Page/文本编辑器.md "wikilink")[Vim的用户来说](../Page/Vim.md "wikilink")，这种方式非常便捷，但其他用户可能需要经历较陡的[学习曲线](https://zh.wikipedia.org/wiki/学习曲线 "wikilink")。
...
Plaetinck开始了Uzbl的开发，很快获得了某个活跃[社区开发者的支持](../Page/网络社区.md "wikilink")\[8\]。代码首次发布于2009年4月21日\[9\]，之后仅仅经过两个月的开发该产品就进入了可用阶段\[10\]。2009年9月21日，Uzbl进入了[Debian操作系统的软件库](../Page/Debian.md "wikilink")\[11\]，2009年10月2日进行了Debian的测试分支。

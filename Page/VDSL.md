...
是VDSL第二代，是目前最快之DSL技術，短距離（350公尺以內）上下行均可達100Mb/s；普通環境應用通常可達下行30Mb/s，上行10Mb/s速度。VDSL2兼具VDSL高速與ADSL家族（ADSL/[ADSL2](https://zh.wikipedia.org/wiki/ADSL2 "wikilink")/[2+](https://zh.wikipedia.org/wiki/ADSL2+ "wikilink")）長距之優點\[1\]。
...
<tr class="odd">
<td><p>VDSL</p></td>
<td><p>ITU G.993.2 Amendment 1</p></td>
...
[ja:デジタル加入者線\#VDSL](https://zh.wikipedia.org/wiki/ja:デジタル加入者線#VDSL "wikilink") [sv:Digital Subscriber Line\#VDSL](https://zh.wikipedia.org/wiki/sv:Digital_Subscriber_Line#VDSL "wikilink")

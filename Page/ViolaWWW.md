...
&lt;/nowiki&gt;</code></pre></td>
  ...
  - 一个简单的[样式表](../Page/样式表.md "wikilink")机制用于指定文档中的样式信息，例如[字体](../Page/字体.md "wikilink")，[颜色](../Page/颜色.md "wikilink")，对齐方式。早在1998年[CSS样式表开发之前已經在Viola中实现了](https://zh.wikipedia.org/wiki/CSS "wikilink")。
...
<span id="cb2-12"><a href="#cb2-12"></a>}</span></code></pre></div></td>
  ...
  - 一个HTML文档可以调用的[脚本语言](../Page/脚本语言.md "wikilink")，让网页文档可以嵌入高度可交互的脚本及小程序，其可以被视为[JavaScript](../Page/JavaScript.md "wikilink")和[嵌入对象的先驱](https://zh.wikipedia.org/wiki/嵌入对象 "wikilink")。
...
<th><p><a href="../Page/JavaScript.md" title="wikilink">JavaScript</a>实现语法</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
[Category:網際網路的歷史](https://zh.wikipedia.org/wiki/Category:網際網路的歷史 "wikilink") [Category:1991年軟體](https://zh.wikipedia.org/wiki/Category:1991年軟體 "wikilink") [Category:1992年軟體](https://zh.wikipedia.org/wiki/Category:1992年軟體 "wikilink")

...
現時 VirusTotal 共有 51 \[4\]個防毒引擎對當案進行偵測。值得注意的是，VirusTotal
上的防毒引擎為指令版本（Command Line
Version），與安裝在電腦上的防毒軟件偵測結果可能有別，因為電腦版防毒軟件可能會根據防火牆、雲端檔案用戶回報、啟發式掃描等其他元件輔助偵測，而指令版本多只根據病毒庫資料作出判斷。

VirusTotal.com曾在[PC
World杂志](https://zh.wikipedia.org/wiki/PC_World杂志 "wikilink")（美国版）的评选中，荣获2007年最优秀的100款产品之一的称号。\[5\]
...
3.
4.
5.  [PC World - The 100 Best Products
    of 2007](http://www.pcworld.com/article/id,131935-page,14/article.html)
**VisIt**是一个[开源型交互式并行](../Page/开源.md "wikilink")[可视化与图形分析工具](../Page/可视化.md "wikilink")，用于查看科学数据。利用VisIt，可以可视化[二维几何模型以及](../Page/二维几何模型.md "wikilink")[三维空间结构化和非结构化网格之中所定义的](../Page/三维空间.md "wikilink")[标量场和](../Page/标量场.md "wikilink")[矢量场](../Page/矢量场.md "wikilink")。在设计上，VisIt不仅旨在处理规模非常庞大，以[太](../Page/万亿.md "wikilink")[字节来计算的](../Page/字节.md "wikilink")[数据集](../Page/数据集.md "wikilink")，同时亦可用于处理千字节范围的小型数据集\[1\]。

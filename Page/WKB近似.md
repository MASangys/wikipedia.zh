在[量子力學裏](../Page/量子力學.md "wikilink")，**WKB近似**是一種半經典計算方法，可以用來解析[薛丁格方程式](../Page/薛丁格方程式.md "wikilink")。[喬治·伽莫夫使用這方法](../Page/喬治·伽莫夫.md "wikilink")，首先正確地解釋了[阿爾法衰變](../Page/阿爾法衰變.md "wikilink")。WKB近似先將量子系統的[波函數](../Page/波函數.md "wikilink")，重新打造為一個[指數函數](../Page/指數函數.md "wikilink")。然後，半經典展開。再假設[波幅或](../Page/波幅.md "wikilink")[相位的變化很慢](../Page/相位.md "wikilink")。通過一番運算，就會得到波函數的近似解。

## 簡略歷史

WKB近似以三位物理學家[格雷戈尔·文策尔](../Page/格雷戈尔·文策尔.md "wikilink")、[汉斯·克喇末和](../Page/汉斯·克喇末.md "wikilink")[萊昂·布里淵姓氏字首命名](../Page/萊昂·布里淵.md "wikilink")。於1926年，他們成功地將這方法發展和應用於量子力學。不過早在1923年，數學家[哈罗德·杰弗里斯就已經發展出二階線性微分方程式的一般的近似法](../Page/哈罗德·杰弗里斯.md "wikilink")。薛丁格方程式也是一個二階微分方程式。可是，薛丁格方程式的出現稍微晚了兩年。三位物理學家各自獨立地在做WKB近似的研究時，似乎並不知道這個更早的研究。所以物理界提到這近似方法時，常常會忽略了杰弗里斯所做的貢獻。這方法在[荷蘭稱為](../Page/荷蘭.md "wikilink")**KWB近似**，在[法國稱為](../Page/法國.md "wikilink")**BWK近似**，只有在[英國稱為](../Page/英國.md "wikilink")**JWKB近似**\[1\]。

## 數學概念

一般而言，WKB近似專門計算一種特殊[微分方程式的近似解](../Page/微分方程式.md "wikilink")。這種特殊微分方程式的最高階導數項目的係數是一個微小參數\(\epsilon\,\!\)。給予一個微分方程式，形式為
...
通常\(y(x)\,\!\)的漸近級數會[發散](../Page/發散.md "wikilink")。當\(n\,\!\)大於某值後，一般項目\(\delta ^n S_n(x)\,\!\)會開始增加。因此WKB近似法造成的最小誤差，約是最後包括項目的數量級。

## 數學例子

設想一個二階齊次[線性微分方程式](../Page/線性微分方程式.md "wikilink")
...
1.  將[波函數重新打造為一個](../Page/波函數.md "wikilink")[指數函數](../Page/指數函數.md "wikilink")，
2.  將這指數函數代入[薛丁格方程式](../Page/薛丁格方程式.md "wikilink")，
3.  展開指數函數的參數為[約化普朗克常數的](../Page/約化普朗克常數.md "wikilink")[冪級數](../Page/冪級數.md "wikilink")，
4.  匹配約化普朗克常數同次冪的項目，會得到一組方程式，
5.  解析這些方程式，就會得到波函數的近似。

一維不含時[薛丁格方程式為](../Page/薛丁格方程式.md "wikilink")

\[- \frac{\hbar^2}{2m} \frac{\mathrm{d}^2}{\mathrm{d}x^2} \psi(x) + V(x) \psi(x) = E \psi(x)\,\!\]；

其中，\(\hbar\,\!\)是[約化普朗克常數](../Page/約化普朗克常數.md "wikilink")，\(m\,\!\)是質量，\(x\,\!\)是坐標，\(V(x)\,\!\)是[位勢](../Page/位勢.md "wikilink")，\(E\,\!\)是能量，\(\psi\,\!\)是波函數。
...
將\(A(x)\,\!\)與\(B(x)\,\!\)展開為\(\hbar\,\!\)的[冪級數](../Page/冪級數.md "wikilink")：
...
這微分方程式稱為[艾里方程式](../Page/艾里方程式.md "wikilink")，其解為著名的[艾里函數](../Page/艾里函數.md "wikilink")：
...
考慮一個[量子諧振子系統](../Page/量子諧振子.md "wikilink")，一個質量為\(m\,\!\)的粒子，運動於諧振位勢\(V(x)=\frac{1}{2}m\omega^2 x^2\,\!\)；其中，\(\omega\,\!\)是角頻率。求算其[本徵能級](../Page/本徵值.md "wikilink")\(E_n\,\!\)？

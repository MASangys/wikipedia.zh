> 本文内容由[WKB近似](https://zh.wikipedia.org/wiki/WKB近似)转换而来。
...
1.  將[波函數重寫為一個](https://zh.wikipedia.org/wiki/波函數 "wikilink")[指數函數](https://zh.wikipedia.org/wiki/指數函數 "wikilink")，
...
假設波函數的形式為另外一個函數\(\phi\,\!\)的指數（函數\(\phi\,\!\)與[作用量](../Page/作用量.md "wikilink")有很密切的關係）：

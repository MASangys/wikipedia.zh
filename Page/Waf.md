**Waf**，一種用於[組建自動化](../Page/組建自動化.md "wikilink")的[工具軟體](https://zh.wikipedia.org/wiki/工具軟體 "wikilink")，被用來自動化編譯程式，以及安裝軟體。它由[Python](../Page/Python.md "wikilink")寫成，主要維護者為湯瑪士·納吉（Thomas
Nagy）。

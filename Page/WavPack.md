...
WavPack允许用户压缩、恢复8、16、24、32位整型以及32位浮点表示的[WAV格式音频文件](../Page/WAV.md "wikilink")，另外它还支持[多声道数据流以及非常高的](https://zh.wikipedia.org/wiki/多声道 "wikilink")[采样率](../Page/采样率.md "wikilink")。与其它无损压缩机制一样，这种算法的压缩比例也随源数据的不同而改变。但对于普通的流行音乐，通常介于30%到70%之间；对于古典音乐以及其它音域较宽的音乐，通常能得到更高的比例。
...
### 概要
  ...
  - 混合／有损模式
  - 硬件支持
  - 支持标签（[ID3v1](../Page/ID3.md "wikilink")、[APEv2标签](https://zh.wikipedia.org/wiki/APEv2_tag "wikilink")）
...
### 软件
  ...
  - [foobar2000](https://zh.wikipedia.org/wiki/foobar2000 "wikilink") -
    Advanced Audio Player（官方插件，w/ ReplayGain & Cuesheets支持）
  - [Windows Media
    Player](https://zh.wikipedia.org/wiki/Windows_Media_Player "wikilink")（带有[CoreWavPack](http://corewavpack.corecodec.org/)
    directshow滤波器）
  ...
  - [KSP Sound
    Player中缺省支持](https://zh.wikipedia.org/wiki/KSP_Sound_Player "wikilink")

### 硬件

  - 运行开放源代码[Rockbox固件的播放器](https://zh.wikipedia.org/wiki/Rockbox "wikilink")，如iriver
...
自从2005年起，WavePack就开始用于[DVD+Audio上的音频压缩取代](https://zh.wikipedia.org/wiki/DVD+Audio "wikilink")[DVD-Audio上昂贵的](../Page/DVD-Audio.md "wikilink")[Meridian
Lossless
...
[dB](https://zh.wikipedia.org/wiki/分貝 "wikilink")，并且当前以及下一个采样在选择两个可用的编码值时都参与衡量，这又将噪声减小1
dB。

由于开发者认为[整数运算受不同芯片的影响较小](../Page/整数.md "wikilink")，而芯片的不同可能带来无损压缩特性的变化，如Pentium
[浮点运算的缺陷就是一个明显的例子](https://zh.wikipedia.org/wiki/浮点 "wikilink")，所以他决定在WavPack算法的数据处理中不使用浮点运算。使用浮点运算的无损压缩工具如果运行在有缺陷的Pentium芯片上可能就会生成不同的结果。即使我们不考虑这些已经存在的缺陷，浮点运算也很复杂，在不同的“正确”实现之间也可能有微小差别，对于这类应用可能会带来麻烦。为了进一步加强WavPack压缩数据的完整性，编码器在生成的数据流后包括有一个32位的错误检测码。

WavPack的源代码非常易于移植到其它平台，它已经可以在几种不同的Unix系统上编译，如[Linux](../Page/Linux.md "wikilink")、[Mac
OS
X](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")、[Solaris](../Page/Solaris.md "wikilink")、[FreeBSD](../Page/FreeBSD.md "wikilink")、[OpenBSD](../Page/OpenBSD.md "wikilink")、康柏[Tru64](https://zh.wikipedia.org/wiki/Tru64 "wikilink")、[HP-UX等等](../Page/HP-UX.md "wikilink")，另外它也可以在[Microsoft
Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")、[DOS](../Page/DOS.md "wikilink")、[Palm
OS以及](../Page/Palm_OS.md "wikilink")[OpenVMS上编译](https://zh.wikipedia.org/wiki/OpenVMS "wikilink")。它可以在许多平台上工作，如[x86](https://zh.wikipedia.org/wiki/x86 "wikilink")、[ARM架构](https://zh.wikipedia.org/wiki/ARM架构 "wikilink")、[PowerPC](../Page/PowerPC.md "wikilink")、[AMD64](https://zh.wikipedia.org/wiki/AMD64 "wikilink")、[IA-64](https://zh.wikipedia.org/wiki/IA-64 "wikilink")、[SPARC](../Page/SPARC.md "wikilink")、[DEC
Alpha](../Page/DEC_Alpha.md "wikilink")、[PA-RISC](https://zh.wikipedia.org/wiki/PA-RISC "wikilink")、[MIPS以及](https://zh.wikipedia.org/wiki/MIPS "wikilink")[Motorola
68k](https://zh.wikipedia.org/wiki/Motorola_68k "wikilink")。

...
Ending's law\[7\]: "Any application that can be compiled to WebAssembly,
will be compiled to WebAssembly eventually."
...
5.  製作大平台
      - 為WebAssembly建置新的[LLVM後端與伴隨的](../Page/LLVM.md "wikilink")[Clang接口](../Page/Clang.md "wikilink")
      - 推動其他WebAssembly的[編譯器與工具](../Page/編譯器.md "wikilink")
      - 啟用更多有用的工具
...
## 外部連結
  ...
  - [WebAssembly Community
    Group](https://www.w3.org/community/webassembly/)
  ...
  - [WebAssembly标准入门 -
    人民邮电](https://github.com/chai2010/awesome-wasm-zh/blob/master/webassembly-primer.md)

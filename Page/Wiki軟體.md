...
作為簡單易用的Wiki引擎，通常會具有以下共通點：
  ...
  - 编辑功能：具有容易书写（并且功能齐全）的格式规则，具备[所見即所得机能](https://zh.wikipedia.org/wiki/所見即所得 "wikilink")，可以分章节编辑，能够方便地参阅以前的版本，并且具有上传文本，插入图像，和书写科学公式的能力。
  ...
  - 个人界面：可设置个人的主页，顶边栏，底边栏，侧边栏；还有[模板](https://zh.wikipedia.org/wiki/網頁模板 "wikilink")。
  - 多国语言：多国语言的支持。
...
共筆型網站百科全书在質素與立場上，會受到筆者及管理員影響，一般資料來源大多依賴[互聯網連結及政府認同的出版社書籍](https://zh.wikipedia.org/wiki/互聯網 "wikilink")。維基百科知名[醜聞有](https://zh.wikipedia.org/wiki/醜聞 "wikilink")：[諾貝爾物理獎的得主一度被维基百科人士拒絕保留有關陳述及專頁](https://zh.wikipedia.org/wiki/諾貝爾獎 "wikilink")\[2\]\[3\]。

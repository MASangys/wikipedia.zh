...
「WinFixer
2005是一個非常有用的可以掃描和修復任何系統、註冊表和硬體錯誤的工具。它可以保證系統穩定持續的運行，釋放被浪費的硬碟空間，修復被損壞的Word、Excel文擋和影片以及圖片檔。」
...
當使用者選擇任何一個選項或嘗試關閉這個訊息方塊（點擊「確定」、「取消」或右上方的交叉），它會觸發一個彈出式視窗而WinFixer便會自行下載及安裝，忽視使用者的意願。因為此訊息方塊關聯於Internet
Explorer應用程式，因此不會出現於Windows工作管理員（Ctrl+Alt+Del）。
...
## 外部連結
  ...
  - [McAfee's Entry on
    WinFixer](http://vil.mcafeesecurity.com/vil/content/v_135733.htm)
  - [Symantec’s Entry on WinFixer and removal
    instructions](https://web.archive.org/web/20060209035533/http://securityresponse.symantec.com/avcenter/venc/data/winfixer.html)
  - [Symantec's entry on ErrorSafe - a sister spyware
    application](https://web.archive.org/web/20060618034938/http://securityresponse.symantec.com/avcenter/venc/data/errorsafe.html)
  - [WinFixer Virus Manual Removal - Vundo
    Variant](http://mc-computing.com/Parasites/WinFixer_parasite.html)
  - [Blog on how to remove
    WinFixer](http://securityticker.blogspot.com/2006/05/easy-fix-for-spyware-and-virus-alert.html)
  - [Help2go's method (covers other baddies that come with winfixer
    too)](http://www.help2go.com/Tutorials/Spyware_Information/www.securityuptodate.net_:_How_to_remove_it_in_3_steps.html)
  - [This Trojan is where many peoples problems start (leads to
    installing winfixer)](http://www.spynomore.com/trojan-zlob.htm)

...
Phone应用，以及[Xbox
One](../Page/Xbox_One.md "wikilink")\[1\]应用程序的开发，作为使用及[C\#](../Page/C♯.md "wikilink")、[VB.NET或](../Page/Visual_Basic_.NET.md "wikilink")[C++](../Page/C++.md "wikilink")（[CX](https://zh.wikipedia.org/wiki/C++/CX "wikilink")）的替代方法。

WinJS始于专用于[通用Windows平台应用的一种技术](../Page/通用Windows平台应用.md "wikilink")，但现已发展为旨在能于任何[网页浏览器中使用](../Page/网页浏览器.md "wikilink")。

2014年4月的[Microsoft
Build开发者会议上宣布](../Page/Build_\(开发者大会\).md "wikilink")，WinJS以[Apache许可证发布为](../Page/Apache许可证.md "wikilink")[自由及开放源代码软件](../Page/自由及开放源代码软件.md "wikilink")，并打算移植到微软以外的平台。一个用于展示该库的网站也已发布。\[2\]其未来的发展重点是维护项目中目前已有内容。没有新功能或功能请求的计划，即没有新功能的发布计划。\[3\]
...
## 特色
  ...
  - UI控件具有对[触摸](../Page/觸控式螢幕.md "wikilink")、[鼠标和](../Page/鼠标.md "wikilink")[键盘的基本支持](https://zh.wikipedia.org/wiki/键盘 "wikilink")。
...
WinJS的首个版本。它随[Windows
8发布](https://zh.wikipedia.org/wiki/Windows_8 "wikilink")。
...
WinJS 3.0于2014年9月发布\[4\]，值得注意的事情有：
  ...
  - 跨浏览器/跨平台支持，包括最流行的桌面和移动浏览器，以及基于HTML的应用程序环境（如[Apache
    Cordova](https://zh.wikipedia.org/wiki/Apache_Cordova "wikilink")）
...
## 参见
  ...
  - [React
    Native](../Page/React.md "wikilink")，适用于[UWP应用程序开发的另一个JavaScript库](../Page/通用Windows平台.md "wikilink")
...
## 外部链接
  ...
  - [Developing Windows Store apps
    (HTML)](http://msdn.microsoft.com/en-us/library/windows/apps/br229565.aspx)

  - [WinJS
    Namespace](http://msdn.microsoft.com/en-us/library/windows/apps/br229773.aspx)

  - [WinJS Playground](http://try.buildwinjs.com)

**WinRAR**是一款用于管理[压缩包文件的](https://zh.wikipedia.org/wiki/压缩软件比较 "wikilink")[共享软件](https://zh.wikipedia.org/wiki/共享软件 "wikilink")。其[算法由作者](../Page/算法.md "wikilink")研发，享有原创[专利](../Page/专利.md "wikilink")。
...
## 功能
  ...
  - 可进行数据修复。
  - WinRAR支持[NTFS系统和](../Page/NTFS.md "wikilink")[Unicode文件名](https://zh.wikipedia.org/wiki/Unicode "wikilink")。
...
## 沿革
  ...
  - 從5.70 beta
    1開始，不再支援ACE格式。因2019年2月，WinRAR裡面處理ACE格式解壓縮的`UNACEV2.DLL`[函式庫被发现存在](../Page/函式庫.md "wikilink")[漏洞](https://zh.wikipedia.org/wiki/漏洞 "wikilink")。由于ACE格式已在2007年11月后停止更新，成為[废弃软件](https://zh.wikipedia.org/wiki/废弃软件 "wikilink")，在無法修補漏洞的情形下只能删去`UNACEV2.DLL`文件，而不再支持
    ACE 存档格式。\[1\]\[2\]

## 非 Windows 系统

RARlab 也发布其它操作系统下的 RAR
软件，比如[GNU/Linux下的](https://zh.wikipedia.org/wiki/GNU/Linux "wikilink")
rarlinux、[Mac OS X下的](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")
rarosx，它们都是在命令行下使用，但可以跟其他图形归档软件配合使用。

## WinRAR 受青睐的原因

由于 ZIP 不支持 Unicode
编码、可能出現亂碼现象，同时也不支持分卷壓縮，[壓縮率稍低](https://zh.wikipedia.org/wiki/壓縮率 "wikilink")，因此發展初期
RAR 更受青睞。\[3\]
...
一段时间之后，上海软众信息科技有限公司（原名“上海比特瑞旺电脑有限公司”）取得了代理权，将简体中文版的翻译工作移交给了这家公司。
现如今，WinRAR
在上海与台湾\]分别由上海软众信息科技有限公司以及淺藍科技有限公司代理，而且通常[繁体中文版会先于](https://zh.wikipedia.org/wiki/繁体中文 "wikilink")[简体中文版发布](https://zh.wikipedia.org/wiki/简体中文 "wikilink")。　

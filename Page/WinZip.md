...
後來，[微軟從](https://zh.wikipedia.org/wiki/微軟 "wikilink")[Windows
Me開始後的作業系統](../Page/Windows_Me.md "wikilink")，包括[Windows
Vista以及](../Page/Windows_Vista.md "wikilink")[Windows
7皆内建開啟壓縮檔的功能](https://zh.wikipedia.org/wiki/Windows_7 "wikilink")，一定程度上減少WinZip的销售量。

2006年5月，[科立爾數位科技收购WinZip](https://zh.wikipedia.org/wiki/科立爾數位科技 "wikilink")
Computing。\[2\]
...
## 功能
  ...
  - 可配置的[Microsoft
    ...
    Shell整合。
  - 128位和256位[AES](https://zh.wikipedia.org/wiki/AES "wikilink")[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")。\[3\]这种加密方式替代了较早版本较不安全的PKZIP
    2.0加密方式。加密的执行使用了[Brian
    Gladman的代码](https://zh.wikipedia.org/wiki/Brian_Gladman "wikilink")，2003年3月27日被FIPS-197认证。\[4\]
  ...
  - 使用[Unicode来确保正确显示Zip内带有国际字符的文件名](https://zh.wikipedia.org/wiki/Unicode "wikilink")。（在版本11.2之前，WinZip不支持带有[Unicode的文件名](https://zh.wikipedia.org/wiki/Unicode "wikilink")。\[5\]
...
Katz和他的PKWare公司在](https://zh.wikipedia.org/wiki/Phil_Katz "wikilink")[MS-DOS上所发明](../Page/MS-DOS.md "wikilink")。\[7\]
...
Henderson发明的[ARC](https://zh.wikipedia.org/wiki/ARC "wikilink")，这可能是PKWARE不能为PKZIP申请专利的原因。\[8\]

WinZip 8.0是最后一个官方支援[Windows 95的版本](../Page/Windows_95.md "wikilink")。

WinZip
9.0支持AES加密ZIP，[BZip2算法压缩的ZIP压缩文件](https://zh.wikipedia.org/wiki/BZip2 "wikilink")（仅仅解压）。

WinZip
10加入了创建／解压[PPMD算法压缩的ZIP压缩文件](https://zh.wikipedia.org/wiki/PPMD "wikilink")。这是最后一个官方支持[Windows
98以及](../Page/Windows_98.md "wikilink")[Windows
ME的版本](https://zh.wikipedia.org/wiki/Windows_ME "wikilink")。WinZip专业版（Pro）在这个版本中被引入，加入了自动操作和任务计划功能。

WinZip
11加入了创建／解压[WavPack压缩的ZIP压缩文件的功能](../Page/WavPack.md "wikilink")。安装程序仍然可以在[Windows
98](../Page/Windows_98.md "wikilink")、[ME上安装](https://zh.wikipedia.org/wiki/Windows_ME "wikilink")，但不被官方支持。WinZip专业版加入了被动FTP支持，FTP传输，e-mail通知，自定义工作选择，完整大小的图片浏览器等新功能。
...
WinZip
11.2可以独立创建[LHA压缩文件](https://zh.wikipedia.org/wiki/LHA "wikilink")。加入Unicode文件名支持。

WinZip
12.0针对照片和图形文件的压缩进行了改进，可以直接将相机内的照片自动打包出来，可以在ZIP里面直接查看照片的缩略图。增加了对[ISO](https://zh.wikipedia.org/wiki/ISO "wikilink")、[IMZ等新格式的支持](https://zh.wikipedia.org/wiki/IMZ "wikilink")。改进了加密算法和用户界面。

WinZip
12.1推出了全新的压缩文件格式[ZIPX](https://zh.wikipedia.org/wiki/ZIPX "wikilink")。并添加了可以对通过WinZip直接发送的电子邮件中的图片大小进行调整这一新功能。

WinZip 14.5開始支援[Windows
7](https://zh.wikipedia.org/wiki/Windows_7 "wikilink")，並將使用介面改為和[Microsoft
Office
2007以及](../Page/Microsoft_Office_2007.md "wikilink")[2010相同的](https://zh.wikipedia.org/wiki/Microsoft_Office_2010 "wikilink")[Ribbon介面](../Page/Ribbon.md "wikilink")。

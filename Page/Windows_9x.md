...
Windows
9x闻名于它在[桌面的使用](https://zh.wikipedia.org/wiki/桌面 "wikilink")；在1998年，Windows占有了操作系统市场份额的82%。\[3\]
...
9x的[内核裡混杂着](../Page/内核.md "wikilink")[16位元和](https://zh.wikipedia.org/wiki/16位元 "wikilink")[32位元的](../Page/32位元.md "wikilink")[程序码](https://zh.wikipedia.org/wiki/程序码 "wikilink")。
...
Windows
2.0现身于1987年12月9日。它使用[真實模式的](../Page/真實模式.md "wikilink")[内存模型](https://zh.wikipedia.org/wiki/内存 "wikilink")，受限于为1兆字节的最大[內存](https://zh.wikipedia.org/wiki/內存 "wikilink")。于此模式下，它可运行在使用[286](https://zh.wikipedia.org/wiki/286 "wikilink")[保护模式的另一个多任务管理器下](https://zh.wikipedia.org/wiki/保护模式 "wikilink")，如[DESKQView](https://zh.wikipedia.org/wiki/DESKQView "wikilink")。

发布于1990年的[Windows
3.0让Windows获得了巨大的商业成功](https://zh.wikipedia.org/wiki/Windows_3.0 "wikilink")。除了给予本机应用程序更好的功能外，由于引用[虚拟内存机制](../Page/虚拟内存.md "wikilink")，Windows也让用户（相对于Windows/386）享有更好的[MS-DOS程序](../Page/MS-DOS.md "wikilink")[多任务处理](https://zh.wikipedia.org/wiki/多任务处理 "wikilink")。

微软开发了[Windows
3.1](https://zh.wikipedia.org/wiki/Windows_3.1 "wikilink")，对Windows
3.0做了些小改进，主要在错误修正及对多媒体的支持上。它也剔除了[实模式支持](https://zh.wikipedia.org/wiki/实模式 "wikilink")，只可在[80286或更高的](https://zh.wikipedia.org/wiki/80286 "wikilink")[处理器上运行](https://zh.wikipedia.org/wiki/处理器 "wikilink")。尔后，微软又发布[Windows
3.11](https://zh.wikipedia.org/wiki/Windows_3.11 "wikilink")，对1992年的Windows
...
Corporation](https://zh.wikipedia.org/wiki/Digital_Equipment_Corporation "wikilink")（后被[康柏收购](../Page/康柏.md "wikilink")，现为[惠普的一部分](../Page/惠普.md "wikilink")）担任VMS的架构师。微软于1988年8月聘请他以开发[OS/2的后继操作系统](https://zh.wikipedia.org/wiki/OS/2 "wikilink")，但他却创建了一个全新的操作系统。
...
[Windows
3.11之后](https://zh.wikipedia.org/wiki/Windows_3.11 "wikilink")，微软开始研发一款以用户为导向的、代号为Chicago的操作系统。Chicago的主要设计目标为支援像是[OS/2和](https://zh.wikipedia.org/wiki/OS/2 "wikilink")[Windows
NT那样的](../Page/Windows_NT.md "wikilink")32位[抢占式多任务处理](https://zh.wikipedia.org/wiki/抢占式多任务处理 "wikilink")，尽管16位[内核将会因向后兼容而被保留](../Page/内核.md "wikilink")。首次推出于Windows
NT中的[Win32](https://zh.wikipedia.org/wiki/Win32 "wikilink")
[API被选定为标准](https://zh.wikipedia.org/wiki/API "wikilink")32位的程序接口，并通过一种被称为“thunking”的技术对Win16兼容。设计全新的[GUI虽然没有在计划之中](https://zh.wikipedia.org/wiki/GUI "wikilink")，但很多Cairo的用户界面元素都被借鉴并用在后来的发布之中（特别是即插即用-Plug
and Play）。
...
微软接着发布五个不同版本的[Windows 95](../Page/Windows_95.md "wikilink")：
  ...
  - Windows 95 B -（OSR2）包含了几个重大的改进、[Internet
    Explorer](../Page/Internet_Explorer.md "wikilink")（IE）3.0和完全的[FAT32文件系统支援](https://zh.wikipedia.org/wiki/FAT32 "wikilink")。
...
第一个[Microsoft
Plus\!附加包是为了Windows](https://zh.wikipedia.org/wiki/Microsoft_Plus! "wikilink")
95而出售的。

### Windows 98

1998年6月25日，微软发布了[Windows
98](../Page/Windows_98.md "wikilink")。它包含了新的硬件驱动，并提供较完善的[FAT32文件系统支援](https://zh.wikipedia.org/wiki/FAT32 "wikilink")，允许硬盘分区大于在[Windows
95可接受的](../Page/Windows_95.md "wikilink")2GB上限。Windows
98对[USB的支援也远优于仅提供基本USB功能的Windows](../Page/USB.md "wikilink")
95的[OEM版本](https://zh.wikipedia.org/wiki/OEM "wikilink")。它还受争议地集成了[Internet
Explorer](../Page/Internet_Explorer.md "wikilink")[浏览器到Windows](https://zh.wikipedia.org/wiki/浏览器 "wikilink")
GUI及Windows Explorer（Windows 资源管理器）中。

1999年，微软发布了Windows 98的第二版，一个过渡性的发布。其值得注意的新特性有[Internet Connection
Sharing和较完善的WDM音频及调制解调器支援](https://zh.wikipedia.org/wiki/Internet_Connection_Sharing "wikilink")。Internet
Connection
Sharing是一种网络地址转换器，允许多个机器在同一个[LAN上共享唯一的互联网连接](https://zh.wikipedia.org/wiki/LAN "wikilink")。Windows
...
98升级版](../Page/Windows_98.md "wikilink")。它也引入了第一版的[系统还原机制](https://zh.wikipedia.org/wiki/系统还原 "wikilink")，使用户能在系统故障的情况下还原系统到之前“已知良好”的状态。[Windows
...
慢慢地，微软结束了对Windows
9x的支持，并先后对终端用户及[OEM厂商停止售卖相关软件](https://zh.wikipedia.org/wiki/OEM "wikilink")。到了2004年的3月，任何Windows
9x系列的软件拷贝已无法在市场上购买到。
...
Studio](https://zh.wikipedia.org/wiki/Visual_Studio "wikilink") 系列最后可将
Windows 98 作为目标平台的版本是 Visual Studio
2008。如今，即使是[开源项目的](https://zh.wikipedia.org/wiki/开源 "wikilink")[Mozilla浏览器](https://zh.wikipedia.org/wiki/Mozilla浏览器 "wikilink")，在不加工修改的情况下，也无法在Windows
9x上运行。\[6\]
...
像大多数操作系统一样，Windows
9x由[内核及](../Page/内核.md "wikilink")[用户空间组成](https://zh.wikipedia.org/wiki/用户空间 "wikilink")。

尽管Windows
9x拥有[内存保护机制](https://zh.wikipedia.org/wiki/内存保护 "wikilink")，但它并没有保护内存的首个兆字节以防止来自[用户空间应用程序的侵害](https://zh.wikipedia.org/wiki/用户空间 "wikilink")。这个内存区含有让操作系统正常运作的关键码。写入这些内存区将可能造成系统崩溃或死机。错误的应用程序可能意外写入此内存区并使操作系统停止运行。这是系统不稳定的原因之一。\[7\]
...
Windows
9x/Me为[GDI及](https://zh.wikipedia.org/wiki/圖形設備接口 "wikilink")[堆资源保留两块](https://zh.wikipedia.org/wiki/堆 "wikilink")64KB的内存。长时间运行多个应用程序，又或运行多个拥有大量GDI元素的应用程序将可能耗尽这些内存。若空闲资源少于10%，Windows将变得不稳定并可能崩溃。
...
9x把用户和配置特定的设定储存在一个大型的、被称为Windows[注册表的信息数据库](../Page/注册表.md "wikilink")。硬件特定的设定也存于注册表中，且很多设备驱动器都使用注册表来加载配置数据。此前的Windows版本使用如[AUTOEXEC.BAT](../Page/AUTOEXEC.BAT.md "wikilink")、[CONFIG.SYS](https://zh.wikipedia.org/wiki/CONFIG.SYS "wikilink")、[WIN.INI](https://zh.wikipedia.org/wiki/WIN.INI "wikilink")、[SYSTEM.INI的文件及其它带有](https://zh.wikipedia.org/wiki/SYSTEM.INI "wikilink").INI后缀的文件来维持配置设定。当Windows日趋复杂并纳入更多的特性时，.INI文件们对当时的FAT文件系统无疑显得笨重至极。对.INI文件的兼容维持直到Windows
XP的出现。
...
Windows
9x本身不支持[NTFS或](../Page/NTFS.md "wikilink")[HPFS](https://zh.wikipedia.org/wiki/HPFS "wikilink")，但第三方解决了问题，允许Windows
9x对NTFS卷进行只读访问。

Windows
95的早期版本不支持[FAT32](https://zh.wikipedia.org/wiki/FAT32 "wikilink")。

同[Windows for Workgroups
3.11一样](https://zh.wikipedia.org/wiki/Windows_for_Workgroups_3.11 "wikilink")，Windows
9x支持[32位文件访问](https://zh.wikipedia.org/wiki/32位文件访问 "wikilink")。不同于Windows
3.x，Windows
9x支持VFAT文件系统，允许文件名字可达最多255个字母以取代[8.3文件命名法](https://zh.wikipedia.org/wiki/8.3文件命名法 "wikilink")。

#### 事件日志及追踪

Windows 9x不支持Windows
NT家族所拥有的[事件日志及追踪或](https://zh.wikipedia.org/wiki/事件日志及追踪 "wikilink")[出错报表机制](https://zh.wikipedia.org/wiki/出错报表 "wikilink")，尽管使用像[Norton
CrashGuard的软件可在Windows](https://zh.wikipedia.org/wiki/Norton_CrashGuard "wikilink")
9x上实现相似的功能。
...
System驱动器来实现对](https://zh.wikipedia.org/wiki/Installable_File_System "wikilink")[NTFS卷的读写](../Page/NTFS.md "wikilink")。FAT系统的安全机制不彰，每个拥有FAT驱动器访问权限的用户都可访问其内的所有文件。不像NTFS，FAT文件系统没有[访问控制列表和文件系统加密机制](https://zh.wikipedia.org/wiki/访问控制列表 "wikilink")。\[8\]

一些与Windows
9x同时期的操作系统（不管是[多用户的或是拥有多个不同访问权限的用户户口](https://zh.wikipedia.org/wiki/多用户 "wikilink")）的重要系统文件（譬如内核映像）在大多数用户户口底下都是不可更动的。相反的，Windows
95及其后的操作系统为多个用户提供简档选项，它们没有访问权限的概念，使它们大致相当于单用户的、单户口的操作系统，意味着所有[进程都可修改所有未打开的文件及引导扇区](https://zh.wikipedia.org/wiki/进程 "wikilink")，或对硬盘进行修改。这使病毒及其它被秘密安装的软件更紧密地与操作系统结合在一起，使用户难以对它们进行侦查及撤消。在Windows
...
Windows
Me引入[系统文件保护机制及](https://zh.wikipedia.org/wiki/系统文件保护 "wikilink")[系统还原来解决此问题](https://zh.wikipedia.org/wiki/系统还原 "wikilink")。

而被Windows
9x从[DOS继承的](../Page/DOS.md "wikilink")[FAT及](../Page/FAT.md "wikilink")[FAT32](https://zh.wikipedia.org/wiki/FAT32 "wikilink")[文件系统则没有文件保护机制](../Page/文件系统.md "wikilink")，也没有类似[NTFS的](../Page/NTFS.md "wikilink")[文件权限机制](https://zh.wikipedia.org/wiki/文件权限 "wikilink")。
...
Windows
9x的[设备驱动程序可以是虚拟设备驱动程序或WDM驱动程序](https://zh.wikipedia.org/wiki/设备驱动程序 "wikilink")（始于Windows
98）。VxD通常都有文件名字后缀.vxd或.386，而WDM兼容驱动程序则使用[扩展名](https://zh.wikipedia.org/wiki/扩展名 "wikilink")[.sys](../Page/.sys.md "wikilink")。32位VxD消息服务器（msgsrv32）乃一程序，能在启动时加载虚拟设备驱动程序（VxD）并尔后处理与驱动程序的通信。消息服务器也可执行一些背景功能，包括加载Windows
...
Me的驱动程序被加载到与内核同样的地址空间，说明驱动程序可能有意或无意地覆写操作系统的关键内存区。这将导致系统崩溃，死机及硬盘损坏。故障的操作系统驱动程序乃操作系统不稳定的其一原因。[单内核或](https://zh.wikipedia.org/wiki/单内核 "wikilink")[混合内核之流](https://zh.wikipedia.org/wiki/混合内核 "wikilink")，如[Linux及](../Page/Linux.md "wikilink")[Windows
...
Windows
9x不支持[超线程](https://zh.wikipedia.org/wiki/超线程 "wikilink")、[数据执行保护](https://zh.wikipedia.org/wiki/数据执行保护 "wikilink")、[对称多处理或](https://zh.wikipedia.org/wiki/对称多处理 "wikilink")[多核处理器](https://zh.wikipedia.org/wiki/多核处理器 "wikilink")。

Windows 9x不支持[SATA](../Page/SATA.md "wikilink")
[AHCI](../Page/AHCI.md "wikilink")（Windows 2000及Windows XP預設也不支援SATA
AHCI，需要安裝驅動程式，較為麻煩），或[USB隨身碟](https://zh.wikipedia.org/wiki/USB隨身碟 "wikilink")（Windows
...
Windows
98是第一款支援[ACPI的Windows](https://zh.wikipedia.org/wiki/ACPI "wikilink")。

### MS-DOS

[Windows 95远远比](../Page/Windows_95.md "wikilink")[Windows
3.1x及其前的作品更加削弱](https://zh.wikipedia.org/wiki/Windows_3.1x "wikilink")[MS-DOS在Windows中的影响](../Page/MS-DOS.md "wikilink")。微软称，MS-DOS在Windows
...
13h](https://zh.wikipedia.org/wiki/int_13h "wikilink")（底层硬盘IO中断）。当一程序发出一int
...
98。但[Windows
2000中的](../Page/Windows_2000.md "wikilink")[恢复控制台](https://zh.wikipedia.org/wiki/恢复控制台 "wikilink")（Recovery
Console）也扮演着类似的角色。
...
不同于加载到[内核空间的Windows](https://zh.wikipedia.org/wiki/内核空间 "wikilink") NT
[GDI](https://zh.wikipedia.org/wiki/圖形設備接口 "wikilink")，身为Win32及Win16子系统的Windows
9x GDI被加载到[用户空间](https://zh.wikipedia.org/wiki/用户空间 "wikilink")。

[Alpha通道或透明特效](https://zh.wikipedia.org/wiki/Alpha通道 "wikilink")，譬如菜单的渐变效果，都不被Windows
9x [GDI支持](https://zh.wikipedia.org/wiki/圖形設備接口 "wikilink")。

[Windows
Explorer乃台式机的默认用户界面](https://zh.wikipedia.org/wiki/Windows_Explorer "wikilink")，尽管出现了各式各样的[Windows
Shell更换软件](https://zh.wikipedia.org/wiki/Windows_Shell "wikilink")。

其它种类的GUI有[LiteStep](https://zh.wikipedia.org/wiki/LiteStep "wikilink"),
[bbLean及](https://zh.wikipedia.org/wiki/bbLean "wikilink")[Program
Manager](https://zh.wikipedia.org/wiki/Program_Manager "wikilink")。GUI让用户更方便地控制个别应用程序的位置与外观，及更好地与Windows系统交互。

...
## 特性
  ...
  - 采用镜像復原安装，速度大大提高，也减少了电脑的负担（與[Windows Vista相似](../Page/Windows_Vista.md "wikilink")）。
  - 安裝模式，有 最小化／典型／全部／自定義 的自行選擇之選項。
  - 安裝组件，有 Additional Driver Support、[Internet Explorer](../Page/Internet_Explorer.md "wikilink")、Language Support、Local Management Support、Windows Help Files、[Windows Media Player](https://zh.wikipedia.org/wiki/Windows_Media_Player "wikilink")、[Windows Messenger](../Page/Windows_Messenger.md "wikilink") 的自行選擇之選項。部份组件比WinXP专业版没有任何减少（如果全选的话），當然遊戲的附件就減去了。
  ...
  - 登錄模式與2003方式相同，需使用 [Ctrl+Alt+Del](../Page/Ctrl+Alt+Del.md "wikilink")。
  - [Windows Vista的痕迹](../Page/Windows_Vista.md "wikilink")（WinFLP里面“有Vista的影子”）。例如采用Windows Vista的[WIM安装方式](https://zh.wikipedia.org/wiki/WIM "wikilink")，以及一些不可捉摸的改进。
  - 部份軟件（如[Microsoft Office XP](https://zh.wikipedia.org/wiki/Microsoft_Office_XP "wikilink")、[Windows Live Messenger](../Page/Windows_Live_Messenger.md "wikilink") 8.x）有兼容問題。

...
Windows Home Server 2011的系统需求：

<div align="center">

|         | 最小配置                                                                                                                 |
| ------- | -------------------------------------------------------------------------------------------------------------------- |
| 处理器     | 1.3 GHz x64 or Itanium 2处理器                                                                                          |
| 記憶體     | 2048 [MB](https://zh.wikipedia.org/wiki/Megabyte "wikilink") [RAM](https://zh.wikipedia.org/wiki/隨機存取記憶體 "wikilink") |
| 显示卡和显示器 | [Super VGA](https://zh.wikipedia.org/wiki/Super_VGA "wikilink")（800×600）                                             |
| 磁盘可用空间  | 最小: 160 [GB或更多](https://zh.wikipedia.org/wiki/gigabyte "wikilink")                                                   |
| 其他设备    | colspan = "2" | [DVD-ROM](https://zh.wikipedia.org/wiki/DVD-ROM "wikilink")，键盘 和 鼠标（或兼容的指针设备），互联网接入（可能需要付费）          |

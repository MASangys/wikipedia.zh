...
Desktop**）是一個的[電子郵件](https://zh.wikipedia.org/wiki/電子郵件 "wikilink")[用戶端](https://zh.wikipedia.org/wiki/用戶端 "wikilink")，屬於微軟[Windows
...
它包含於[Windows
Live程式集內](https://zh.wikipedia.org/wiki/Windows_Live程式集 "wikilink")。

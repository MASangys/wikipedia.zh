...
这个系统是在[Windows 98的基础上开发的](../Page/Windows_98.md "wikilink")，在内核方面没有实质性的进展，但它包括一些相关的小改善。尤其是用户界面方面为之后的[Windows XP提供一些借鉴](../Page/Windows_XP.md "wikilink")。
  ...
  - **[MSN Messenger](https://zh.wikipedia.org/wiki/MSN_Messenger "wikilink")**：作为系统组件提供在线聊天、会议的解决方案。
  - **全新的外观**：Windows Me提供与[Windows 2000一致的界面外观](../Page/Windows_2000.md "wikilink")。
...
Windows Me的[系统还原存在的一个更严重的问题是](https://zh.wikipedia.org/wiki/系统还原 "wikilink")，在还原到2001年9月8日之后创建的检查点时，会报告“还原失败”。这是[系统还原程序中的一个错误](https://zh.wikipedia.org/wiki/系统还原 "wikilink")，[微软](../Page/微软.md "wikilink")已经说明并给予解决方案。\[2\]

## 評價

由於Windows Me推出之後，對於系統當機等問題引發不少的批評。比如一篇由丹·泰南（Dan Tynan）於2006年撰寫並發表在個人電腦世界網（Pc World）的文章《迄今為止最糟的科技產品》（Worst Tech Products of All Time）將Windows Me的“Me”貶為“Mistake Edition（錯誤版本）”，而Windows Me也在文章中“榮獲”殿軍。（見[外部鏈接中的](https://zh.wikipedia.org/wiki/#外部鏈接 "wikilink")“PCWorld網站票選：史上25大科技爛貨（第四名），2006年5月26日。”）\[3\]文章指出：“Windows me在[Windows 2000發布後不久發布](../Page/Windows_2000.md "wikilink")，用戶幾乎隨時都在提交它的錯誤報告：在安裝時，運行時，工作時，安裝新的硬體和軟體時，甚至在报错時（还会出现错误）。”

系統還原同樣存在2001年9月8日之後所建立的檢查點無法還原的錯誤，這會導致2001年9月8日之後所建立的檢查點還原失敗，微軟在2001年3月2日發布了更新修復了這一問題。\[4\]

另外一個比較常見的錯誤在開機和關機時，Windows Me往往會在這個時候[藍屏死機而不是正常地執行開機和關機命令](https://zh.wikipedia.org/wiki/藍屏死機 "wikilink")。\[5\]

與那些負面評價相對的是，拜倫·辛森（Byron Hinson）與朱利安·傑（Julien Jay）在寫給ActiveWin的文章中對Windows Me表示肯定。由於隱藏了[真實模式](../Page/真實模式.md "wikilink")的[MS-DOS](../Page/MS-DOS.md "wikilink")，他們指出，“隱藏[真實模式](../Page/真實模式.md "wikilink")的[MS-DOS](../Page/MS-DOS.md "wikilink")使得Windows Me在穩定性（顯著減少的[藍屏死機就是其現實證明](https://zh.wikipedia.org/wiki/藍屏死機 "wikilink")。）和啟動速度方面都有顯著提升。”\[6\]他們推薦[Windows 9x的用戶將系統升級到Windows](../Page/Windows_9x.md "wikilink") Me，並指出，“如果妳還認為Windows Me不是一款劃時代的作業系統的話，妳可以清楚地看到微軟集中全力使其界面更加友好，穩定並包羅了所有的多媒體選項。這樣的出色的結果配合其強化的性能真的很值得期待。”\[7\]

## 後續

在1999年4月，[微软](../Page/微软.md "wikilink")正式公佈Windows Me成為[Windows 9x系列中最後一個產品](../Page/Windows_9x.md "wikilink")。Windows Me在2006年7月11日起和[Windows 98](../Page/Windows_98.md "wikilink")／[98SE一樣停止重大安全更新](https://zh.wikipedia.org/wiki/Windows_98SE "wikilink")。\[8\]Windows Me的后续产品为[Windows XP](../Page/Windows_XP.md "wikilink")，是微软第一个基于[Windows NT](../Page/Windows_NT.md "wikilink")[内核](../Page/内核.md "wikilink")的家用桌面操作系统，在2001年10月25日上市。

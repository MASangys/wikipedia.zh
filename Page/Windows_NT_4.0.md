**Windows NT
4.0**是[微軟](https://zh.wikipedia.org/wiki/微軟 "wikilink")[Windows
...
95](../Page/Windows_95.md "wikilink")。根據[比爾蓋茲所言](https://zh.wikipedia.org/wiki/比爾蓋茲 "wikilink")，產品名稱中的"NT"為"New
Technology（新技術）"的意思，然而時至今日，該名稱已經沒有其他特殊意義存在。

雖然穩定性高於Windows
95，然而從桌上型電腦的觀點來說，操作界面稍微欠缺了彈性。系統穩定性大部分要歸功於將硬體資源虛擬化，軟體必須藉由系統的[API以使用硬體資源](https://zh.wikipedia.org/wiki/API "wikilink")，而不像[DOS以及Windows](../Page/DOS.md "wikilink")
95（包括稍後的版本）時期直接由軟體進行控制的緣故。但穩定的代價就是利用API進行操作所需要的步驟遠比直接操作硬體資源多，因此造成硬體需求廣泛的程式（如：遊戲）執行上緩慢許多。許多以[Win32](https://zh.wikipedia.org/wiki/Win32 "wikilink")
...
XP的推出之後才消失](../Page/Windows_XP.md "wikilink")，原因包括遊戲用的APIs—諸如[OpenGL以及](../Page/OpenGL.md "wikilink")[DirectX](../Page/DirectX.md "wikilink")—已經成熟到有夠高的運作效率，並且加上硬體本身也有夠高的效能，才能夠以可接受的速度運行[API](https://zh.wikipedia.org/wiki/application_programming_interface "wikilink")。
...
Shell](https://zh.wikipedia.org/wiki/Windows_Shell "wikilink")、[Windows
Explorer](https://zh.wikipedia.org/wiki/Windows_Explorer "wikilink")（被稱為Windows
NT
...
(GDI)整合進系統核心\[1\]以提升[圖形使用者介面](https://zh.wikipedia.org/wiki/圖形使用者介面 "wikilink")（GUI）的效率，使得系統效能跟[Windows
NT
3.51相比有長足的進步](https://zh.wikipedia.org/wiki/Windows_NT_3.51 "wikilink")，不過也使得圖形驅動程式也必須放在核心之中，造成潛在的穩定性問題。
...
pack也被用來增加新的功能。包括新版本的[IIS](https://zh.wikipedia.org/wiki/網際網路資訊管理員 "wikilink")
3.0和4.0，增加[Active Server
Pages](../Page/Active_Server_Pages.md "wikilink")、公鑰以及憑證授權功能、智慧卡（Smart
Card）支援、強化[對稱多處理機](https://zh.wikipedia.org/wiki/對稱多處理機 "wikilink")（**SMP**
**S**ymmetric **M**ulti
**P**rocessor）的彈性，叢集支援、以及[組件對象模型](https://zh.wikipedia.org/wiki/組件對象模型 "wikilink")（COM）支援、以及其他等等。
...
### 伺服器
  ...
  - **Windows NT 4.0終端伺服器**，發行於1998年，允許使用者遠端登入。在[Windows
    2000中](../Page/Windows_2000.md "wikilink")，同樣的功能被稱為**[終端機服務](https://zh.wikipedia.org/wiki/終端機服務 "wikilink")**，而在[Windows
...
Server](https://zh.wikipedia.org/wiki/Microsoft_Small_Business_Server "wikilink")4.0以及4.5套裝軟體中。
...
4.0的作業系統，而不是僅僅修改受影響的的[RPC元件](https://zh.wikipedia.org/wiki/Remote_Procedure_Control，遠端程序控制 "wikilink")，這種規模的系統更新將不能保證原本為了Windows

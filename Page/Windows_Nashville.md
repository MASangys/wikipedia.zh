...
在Nashville的计划取消之后，许多被计划在该版本添加的功能改在较后期版本的Internet Explorer及Windows中出现，特别是许多Internet整合功能，包括资源管理器与网页浏览器的结合，可以在安装[Windows桌面更新](../Page/Windows桌面更新.md "wikilink")后添加到Windows 95以及Windows NT 4.0中，而这个升级包已经包含在Internet Explorer 4.0中（开发代号也是Nashville，在1997年推出）。它可以被单独安装，而它也被整合在Windows 95 OSR 2.5（Windows 95 4.00.950 C）与Windows 98中。
...
## 外部链接
  ...
  - [The Road to Cairo Goes Through Nashville](https://web.archive.org/web/20070227231952/http://www.windowsitpro.com/Windows/Article/ArticleID/2553/2553.html)（June 1996 preview）
  - [Beyond Windows 95](http://www.guidebookgallery.org/articles/beyondwindows95)

[Category:Microsoft_Windows](https://zh.wikipedia.org/wiki/Category:Microsoft_Windows "wikilink")

1.  Memphis是[Windows 98的开发代号](../Page/Windows_98.md "wikilink")。
2.  实际上在Nashville的安装程序中，有一部分确实是显示Windows 96而不是Windows 95。
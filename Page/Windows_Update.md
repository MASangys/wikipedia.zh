...
Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")[操作系统的](../Page/操作系统.md "wikilink")[软件更新服務](https://zh.wikipedia.org/wiki/软件更新 "wikilink")。提供與之前的**Microsoft
...
Server Update
Services更加实用](https://zh.wikipedia.org/wiki/Windows_Server_Update_Services "wikilink")，因为它使通过Windows
...
2和一些针对更新程序主要更改的](https://zh.wikipedia.org/wiki/Windows_XP#Service_Pack_2 "wikilink")
...
正版增值计划](https://zh.wikipedia.org/wiki/Windows_正版增值计划 "wikilink")（）。作为一个升级程序对待，该软件会分析用户的计算机，并测定运行的Windows
...
在[Windows
7中](https://zh.wikipedia.org/wiki/Windows_7 "wikilink")，Windows
...
在[Windows
8中](https://zh.wikipedia.org/wiki/Windows_8 "wikilink")，Windows
Update除了出現在控制台(Control Panel)，另外也出現在Windows新推出的設定(Setting)下。
...
此外使用不需使用浏览器的[AutoPatcher或者](https://zh.wikipedia.org/wiki/AutoPatcher "wikilink")[Bigfix](http://www.bigfix.com)。然而多数的Windows
...
Update的第三方方案WindizUpdate被启用。这个服务支持基于[Mozilla和](../Page/Mozilla.md "wikilink")[Opera的浏览器](https://zh.wikipedia.org/wiki/Opera "wikilink")，不必通过Internet

...
Windows
NT](../Page/Microsoft_Windows_NT.md "wikilink")[操作系统家族中](../Page/操作系统.md "wikilink")[32位版本的](../Page/32位元.md "wikilink")[兼容层](../Page/兼容层.md "wikilink")，目的是扩展以为运行为[Windows
3.x编写的](../Page/Windows_3.x.md "wikilink")[旧式](../Page/遗留代码.md "wikilink")[Win16应用程序提供有限支持](../Page/Win16.md "wikilink")。[64位系统上的](../Page/64位元.md "wikilink")“WOW”通常指在64位Windows上支持32位应用程序的[WOW64](../Page/WoW64.md "wikilink")。

## 背景

许多[16位Windows](../Page/16位元.md "wikilink")（Win16）旧式应用程序可以无需更改运行在较新的[32位Windows版本](../Page/32位元.md "wikilink")。原因是设计者允许应用程序开发者在行业从Windows
3.1x过渡到[Windows
...
操作系统的WOWEXEC子系统会形实替换（）旧的16位API到较新的32位环境，以提供16位[指针](../Page/指標_\(電腦科學\).md "wikilink")、内存模型和[地址空间的支持](../Page/定址空間.md "wikilink")。
...
[7和](../Page/Windows_7.md "wikilink")[8中可用](../Page/Windows_8.md "wikilink")。64位版本的Windows中也有它，但不包括WoW
...
应用程序的兼容性问题，不仅有[长文件名](../Page/长文件名.md "wikilink")、多用户和[最小特权概念的问题](../Page/最小权限原则.md "wikilink")，其他部分也可能导致某些应用程序无法正常运作，例如错误地在[NTFS安全情况下认为对整个文件系统有写入权限](../Page/NTFS.md "wikilink")。

在Windows
95操作系统设计时，一项关键要求就是文件系统要保持对[8.3文件名的向后兼容](../Page/8.3.md "wikilink")，以允许旧款应用程序继续在平台上正常运行。因而Windows
...
在之后的Windows版本中，有相当多的[垫片以拦截和修改旧款应用程序的](../Page/垫片_\(计算机\).md "wikilink")[API调用](../Page/应用程序接口.md "wikilink")。\[6\]这些修复在不断更新，以解决仍在流行的旧款应用程序的问题。\[7\]

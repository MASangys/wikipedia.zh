...
Remoting可以開發SOAP,
HTTP通訊），對於開發人員來說，不同的選擇會有不同的程式設計模型，而且必須要重新學習，讓開發人員在使用时有許多不便。同時，**[服務導向架構](../Page/服務導向架構.md "wikilink")**（Service-Oriented
...
WCF的基本概念是以[合約](../Page/合約.md "wikilink")（Contract）來定義雙方溝通的協定，合約必須要以[介面的方式來呈現](../Page/介面.md "wikilink")，而實際的服務程式碼必須要由這些合約介面衍生並實作。合約分成了四種：
...
由於WCF支援了[HTTP](../Page/HTTP.md "wikilink")，[TCP](../Page/TCP.md "wikilink")，[Named
Pipe](../Page/Named_Pipe.md "wikilink")，[MSMQ](../Page/MSMQ.md "wikilink")，Peer-To-Peer
...
雖然WCF也可以使用[SOAP做通訊格式](../Page/SOAP.md "wikilink")，但它和以往的[ASP.NET](../Page/ASP.NET.md "wikilink")
[XML Web
Services不同](../Page/XML_Web_Services.md "wikilink")，因此有部份技術文章中，會將ASP.NET的XML
Web Services稱為**ASMX Service**。

WCF的服務可以掛載於Console Application，Windows
Application，IIS（ASP.NET）Application，[Windows
Service以及](../Page/Windows_Service.md "wikilink")[Windows Activation
Services中](../Page/Windows_Activation_Services.md "wikilink")，但大多都會掛在Windows
Service。
...
security）兩種。
  ...
  - 傳輸層次安全性：在資料傳輸時期加密，例如[SSL](../Page/SSL.md "wikilink")。
  - 訊息層次安全性：在資料處理時就加密，例如使用[數位簽章](../Page/數位簽章.md "wikilink")，[雜湊或是使用](../Page/雜湊.md "wikilink")[金鑰加密法等](../Page/金鑰.md "wikilink")。

...
## WinPE特點
  ...
  - [Windows Vista](../Page/Windows_Vista.md "wikilink"),[Windows 7](https://zh.wikipedia.org/wiki/Windows_7 "wikilink"),[Windows 8](https://zh.wikipedia.org/wiki/Windows_8 "wikilink"),[Windows 10的安裝程式](../Page/Windows_10.md "wikilink")，亦是基於WinPE。在「Windows 安裝」界面上按下Shift+F10，可開啟「命令提示字元」。

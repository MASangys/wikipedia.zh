...
## 外部链接
  ...
  - [The Wings 3D Official Development
    Forum](http://nendowingsmirai.yuku.com)（The best place to get help
    with Wings 3D）

  - [The Wings 3D user forum at
    Renderosity](http://www.renderosity.com/mod/forumpro/showforum.php?forum_id=12445)（requires
    log in）

  - [The Wings 3D user forum at
    CGTalk](https://web.archive.org/web/20050307221809/http://www.cgtalk.com/forumdisplay.php?s=&forumid=83)（This
    forum has been locked, however it remains a valuable Wings 3D
    resource）

  - [Wings3d.de | The German language Wings 3D
    Community](http://www.wings3d.de/)

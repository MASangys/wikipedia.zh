...
此反例是在[控制理论](../Page/控制理论.md "wikilink")及[信息论](../Page/信息论.md "wikilink")的交集。因為此問題的難度，找最佳控制律的問題也受到[理論計算機科學](../Page/理論計算機科學.md "wikilink")社群的關注。此問題的重要性在2008年在墨西哥Cancun舉行的47屆IEEE決策及控制研討會（CDC）可以看出\[3\]，其中有一整個會議就是瞭解此一反例，而當時距Witsenhausen最早的反例提出已有40年之久。
...
計算機科學文獻也找到了這個分散式問題困難的原因：[赫里斯托斯·帕帕季米特里乌](../Page/赫里斯托斯·帕帕季米特里乌.md "wikilink")及John Tsitsiklis證明此一反例是[NP完全](../Page/NP完全.md "wikilink")\[8\]。

## 試圖求解

有許多方式試圖用數值方式求解。若限制問題的參數（\((k=0.2,\;\sigma_0=5)\)），研究者已經透過[离散化](https://zh.wikipedia.org/wiki/离散化 "wikilink") 以及求解\[9\]。進一步的研究（著名的有[何毓琦](../Page/何毓琦.md "wikilink")的研究\[10\]，Li, Marden and 的研究\[11\]）在相同參數範圍下其成本略有改善。不同參數下的最佳數值解，包括上述所提到的數值解，都是由S.-H. Tseng 和A. Tang在2017年提出的局部搜尋法所得\[12\]。第一個可能近似最佳的控制策略是在2010年提出（Grover, Park, Sahai）\[13\]，其中用[信息论](../Page/信息论.md "wikilink")來了解此反例中的通訊。此反例的最佳解仍然是還沒有答案的開放問題。

...
USB适配器可以应许WSC与其他的游戏主机甚至电脑互相通讯。BANDAI还与日本[NTT
DOCOMO合作](../Page/NTT_DOCOMO.md "wikilink")，使得WSC通过USB适配器可以与手机连接实现上网功能、收发电子邮件、与游戏联动、下载游戏等功能。相比于Wonder
Wave，USB适配器具有速度更快的优点。
...
Wonder Borg其实是一种遥控玩具，含有一只电动甲虫和一个名为Brog
Work的游戏卡适配器。将游戏卡放进WSC（WS也适用）中，便可以给机械甲虫编程，从而使WSC/WS成为一个遥控器，控制甲虫。另外，由于机械甲虫内建感应器，使得甲虫也会对外部的声光产生反应。
...
[Category:萬代遊戲機](https://zh.wikipedia.org/wiki/Category:萬代遊戲機 "wikilink")

...
Windows XP的WordPad增加了多語言文字編輯。它可以開啟Microsoft Word（版本6.0-2003）的檔案，雖然仍然有機會出現格式的錯誤。但是，它不可以儲存[.doc格式的檔案](https://zh.wikipedia.org/wiki/DOC "wikilink")（只支援[.txt或者](https://zh.wikipedia.org/wiki/.txt "wikilink")[.rtf](../Page/RTF.md "wikilink")），與之前的WordPad版本不同。由於安全問題，Windows XP Service Pack 2禁止了WordPad對.wri檔案的支援。在Windows Vista中，亦移除了對Word檔案的支援，原因是格式錯誤顯示的問題還未解決。最後，它新增支援[语音识别](../Page/语音识别.md "wikilink")，以及RichEdit的*[Text Services Framework](https://zh.wikipedia.org/wiki/Text_Services_Framework "wikilink")*（TSF）。對於Word檔案，以至[Open XML的格式錯誤顯示問題](https://zh.wikipedia.org/wiki/Open_XML "wikilink")，微軟發佈了免費的Word Viewer。
...
[Category:Windows组件](https://zh.wikipedia.org/wiki/Category:Windows组件 "wikilink") [Category:文書處理器](https://zh.wikipedia.org/wiki/Category:文書處理器 "wikilink")

1.  [RichEdit versions](http://blogs.msdn.com/murrays/archive/2006/10/14/richedit-versions.aspx)
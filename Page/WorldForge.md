...
几个独立的游戏项目基于WorldForge，所以有了并行开发，养猪业模拟*Acorn*是唯一完善的并发布的游戏，项目也扩展到其他方面（例如，漫画和纸笔游戏）。
...
Cyphesis现在运行这个世界。原意为AI服务器，Indri是原计划中物理构模的部分。但是Indri进展变慢，同时Cyphesis活跃。
...
## 外部链接
  ...
  - [WorldForge主页](http://www.worldforge.org)
  - [Wiki](http://wiki.worldforge.org)

...
起初[Windows Vista的家用入門版与家庭高级版在](../Page/Windows_Vista.md "wikilink")[最终用户许可协议中声明](https://zh.wikipedia.org/wiki/最终用户许可协议 "wikilink")，该系统不能够在一台虚拟机中安装或运行，尽管在技术上并没有障碍使得用户无法这样做。这一条款在2008年1月时被修改了。\[10\]
...
9.  <https://ark.intel.com/content/www/tw/zh/ark/search/featurefilter.html?productType=873&0_ExtendedPageTables=True>

10. [Microsoft relents: Vista consumer virtualization ban lifted](http://arstechnica.com/news.ars/post/20080121-microsoft-relents-vista-virtualization-ban-lifted.html)
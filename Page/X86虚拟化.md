...
**英特尔虚拟化技术**（IVT，Intel Virtualization Technology）是由英特尔开发的一种虚拟化技术，利用IVT可以对在系统上的客操作系统，通过[虚拟机查看器](https://zh.wikipedia.org/wiki/虚拟机查看器 "wikilink")（VMM，Virtual Machine Monitor）来虚拟一套[硬件](../Page/硬件.md "wikilink")设备，以供客操作系统使用。
...
Intel还推出了“直接输入/输出虚拟化”（Virtualization for Directed I/O，VT-d）技术。这项技术提供了一种配置传送给独立虚拟机的[中断与配置](https://zh.wikipedia.org/wiki/中断 "wikilink")[I/O内存单元的方式](https://zh.wikipedia.org/wiki/I/O "wikilink")，以防止虚拟机使用[DMA来终止与真实硬件的隔离](https://zh.wikipedia.org/wiki/DMA "wikilink")。
...
起初[Windows Vista的家用入門版与家庭高级版在](../Page/Windows_Vista.md "wikilink")[最终用户许可协议中声明](https://zh.wikipedia.org/wiki/最终用户许可协议 "wikilink")，该系统不能够在一台虚拟机中安装或运行，尽管在技术上并没有障碍使得用户无法这样做。这一条款在2008年1月时被修改了。\[9\]
...
9.  [Microsoft relents: Vista consumer virtualization ban lifted](http://arstechnica.com/news.ars/post/20080121-microsoft-relents-vista-virtualization-ban-lifted.html)
...
Windows Phone市场允许用户[下载](../Page/下载.md "wikilink")XAP文件到[SD卡](../Page/SD卡.md "wikilink")和手动安装它们。\[3\]

XAP也是XACT音频项目的扩展，可以使用[Microsoft跨平台音频创作工具打开](https://zh.wikipedia.org/wiki/XACT "wikilink")。Silverlight XAP文件不能用音频创作工具打开，并且XACT XAP文件不是压缩文件。

## 内容

XAP文件是一个ZIP压缩包，它通常包含：\[4\]

  - AppManifest.xaml文件
  - 所需的[动态链接库](../Page/动态链接库.md "wikilink")（DLL）

## 参见

  - [APK](../Page/APK.md "wikilink")

  - [Ipa文件](https://zh.wikipedia.org/wiki/Ipa文件 "wikilink")

  - [CAB](../Page/CAB.md "wikilink")或[ZIP格式](../Page/ZIP格式.md "wikilink")，用于旧款PocketPC/Windows Mobile设备

  - [HTML应用程序](../Page/HTML应用程序.md "wikilink")（HTA）
...
1.  <http://www.theverge.com/2014/2/11/5400660/windows-phone-8-1-features-leaked>
2.
3.
4.
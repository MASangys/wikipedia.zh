**可扩展标记语言**（，简称：），是一种[标记语言](../Page/标记语言.md "wikilink")。标记指[计算机所能理解的信息符号](../Page/计算机.md "wikilink")，通过此种标记，[计算机之间可以处理包含各种信息的文章等](../Page/電腦.md "wikilink")。如何定义这些标记，既可以选择国际通用的标记语言，比如[HTML](../Page/HTML.md "wikilink")，也可以使用像XML这样由相关人士自由决定的标记语言，这就是语言的可扩展性。XML是从[标准通用标记语言](../Page/标准通用标记语言.md "wikilink")（SGML）中简化修改出来的。它主要用到的有可扩展标记语言、[可扩展样式语言](../Page/可扩展样式语言.md "wikilink")（XSL）、[XBRL和](../Page/XBRL.md "wikilink")[XPath等](../Page/XPath.md "wikilink")。

## 历史

XML的前身是**SGML**（），是自IBM從1960年代就開始發展的**[GML](../Page/通用标记语言.md "wikilink")**（）標準化後的名稱。
...
1978年，[ANSI將GML加以整理規範](../Page/ANSI.md "wikilink")，發佈成為SGML，1986年起為[ISO所採用](../Page/ISO.md "wikilink")（ISO
...
XML是從1995年開始有其雛形，並向[W3C](../Page/W3C.md "wikilink")（[全球資訊網聯盟](../Page/全球資訊網聯盟.md "wikilink")）提案，而在1998年二月發佈為W3C的標準（XML1.0）。
...
[PDF以及](../Page/Portable_Document_Format.md "wikilink")[Rich Text
Format並使用](../Page/Rich_Text_Format.md "wikilink")[程式語言或](../Page/程式語言.md "wikilink")[XSL](../Page/可擴充套件樣式語言.md "wikilink")。\]\]
...
| 名字   | 字符 | Unicode[码位](../Page/码位.md "wikilink")(十进制) | 标准      | 描述                               |
| ---- | -- | ------------------------------------------ | ------- | -------------------------------- |
| quot | "  | U+0022 (34)                                | XML 1.0 | [双引号](../Page/双引号.md "wikilink") |
| amp  | &  | U+0026 (38)                                | XML 1.0 | [&](../Page/&.md "wikilink")     |
| apos | '  | U+0027 (39)                                | XML 1.0 | [撇号](../Page/撇号.md "wikilink")   |
| lt   | \< | U+003C (60)                                | XML 1.0 | [小于号](../Page/小于号.md "wikilink") |
| gt   | \> | U+003E (62)                                | XML 1.0 | [大于号](../Page/大于号.md "wikilink") |
...
如果属性有多个值，这需要采取XML协议以外的方式来表示，如采用逗号或分号间隔，对于[CSS类或标识符的名字可用空格来分隔](../Page/CSS.md "wikilink")。
...
但是，根元素到底叫<小纸条>还是<小便条>，则是由[文档类型定义](../Page/文档类型定义.md "wikilink")（DTD）或[XML纲要](../Page/XML_Schema.md "wikilink")（XML

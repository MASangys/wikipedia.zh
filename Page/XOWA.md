...
XOWA允许用户从[官方数据库转储或XOWA专门的数据库下载和导入自己的维基百科副本](https://zh.wikipedia.org/wiki/Wikipedia:数据库下载 "wikilink")。该应用程序旨在通过其自己的内部浏览器或本地托管的Web服务器准确地显示维基百科内容，该服务器允许用户使用所选的任何浏览器访问内容。用户还可以在自己的网络上托管内容。\[2\]

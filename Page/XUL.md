...
****（ ）是英文「****」（XML用户界面语言）的[首字母縮寫](https://zh.wikipedia.org/wiki/首字母縮寫 "wikilink")。它是為支持系列的應用程式（如[Mozilla Firefox和](https://zh.wikipedia.org/wiki/Mozilla_Firefox "wikilink")[Mozilla Thunderbird](../Page/Mozilla_Thunderbird.md "wikilink")）而開發的[使用者界面標示語言](https://zh.wikipedia.org/wiki/使用者界面標示語言 "wikilink")。顧名思義，它是一種應用[XML](../Page/XML.md "wikilink")來描述[使用者界面的](https://zh.wikipedia.org/wiki/人机界面 "wikilink")[標示語言](https://zh.wikipedia.org/wiki/標示語言 "wikilink")。XUL被实现为一种[XML](../Page/XML.md "wikilink")的方言。它允许以类似写[网页的方式编写](https://zh.wikipedia.org/wiki/网页 "wikilink")[图形用户界面](../Page/图形用户界面.md "wikilink")。
...
XUL定義了一套豐富的元素。它們大致上可分為以下幾種：
  ...
  - 基層元素: 例如[視窗](../Page/視窗.md "wikilink")、page、[對話框](https://zh.wikipedia.org/wiki/對話框 "wikilink")、[精靈](https://zh.wikipedia.org/wiki/精靈_\(軟件\) "wikilink")
    ...
    其他: 例如overlay（類似[SSI](https://zh.wikipedia.org/wiki/SSI "wikilink")，但在客戶端運作，而且更為強大）、iframe、浏览器、编辑器
...
雖然XUL的設計原意是為了創作Mozilla程式及其擴充套件，但事實上人們也能利用它來編寫基於[HTTP的](https://zh.wikipedia.org/wiki/HTTP "wikilink")[網絡應用程式](https://zh.wikipedia.org/wiki/網絡應用程式 "wikilink")。基本[安全性的原則](https://zh.wikipedia.org/wiki/安全性 "wikilink")，很多需要特權的[XPCOM](../Page/XPCOM.md "wikilink")物件在無特權的XUL文件上都不能使用。唯有使用[數碼簽署的腳本才享有此種特權](https://zh.wikipedia.org/wiki/数字签名 "wikilink")。就算如此，這些文件亦受[網頁瀏覽器的限制](https://zh.wikipedia.org/wiki/網頁瀏覽器 "wikilink")，例如不能載入遠端的XUL、DTD和RDF文件。

## 電影致敬

XUL讀作「zool」有向電影[捉鬼敢死隊](https://zh.wikipedia.org/wiki/捉鬼敢死隊 "wikilink")[致敬](../Page/致敬.md "wikilink")之意。在捉鬼敢死隊中，有一名為「Zuul」的古代[蘇美爾女神在支配住Dana](https://zh.wikipedia.org/wiki/苏美尔人 "wikilink") Barrett的情況下說道：「There is no Dana, only Zuul」\[1\] 。在開發XUL之前，XML通常都是用於記錄資料性文件，而非定義使用者界面。因此設計XUL的編程員們便想到以「There is no data, only XUL」作為標語。而「Keymaster」和「Gatekeeper」都是來自該個情節。另外，Mozilla的JavaScript[除錯器](https://zh.wikipedia.org/wiki/除錯器 "wikilink")——[Venkman](../Page/Venkman.md "wikilink")也是捉鬼敢死隊的其中一個角色。這可以見於XUL的[XML命名空間](https://zh.wikipedia.org/wiki/XML命名空間 "wikilink")\[2\]。而在可以顯示XUL的應用程式上，利用該網頁就可以瀏覽到一個置中的、以大字型顯示的標語。
...
## 外部链接
  ...
  - [XUL Weblog](https://web.archive.org/web/20060207014248/http://xulblog.de/xul/)
  - [Mobile Amazon Browser](https://web.archive.org/web/20070707130622/http://www.faser.net/mab/)
  - [Xul and Xml-related formats](http://www.xul.fr/en-xml-xul.html)

[Category:基於XML的標準](https://zh.wikipedia.org/wiki/Category:基於XML的標準 "wikilink") [Category:Mozilla](https://zh.wikipedia.org/wiki/Category:Mozilla "wikilink")

1.  [Ghostbusters clip](https://www.youtube.com/watch?v=lg7MAacSPNM)
2.  [Mozilla XML Namespace](https://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul)
**xargs**是一条[Unix和](https://zh.wikipedia.org/wiki/Unix "wikilink")[类Unix](https://zh.wikipedia.org/wiki/类Unix "wikilink")[操作系统的常用命令](../Page/操作系统.md "wikilink")。它的作用是将参数列表转换成小块分段传递给其他命令，以避免参数列表过长的问题\[1\]。

...
**Xgl** 是一個[X
server](https://zh.wikipedia.org/wiki/X_Window_System "wikilink")，他藉由[OpenGL技術充分發揮了新一代顯示卡優異的](../Page/OpenGL.md "wikilink")3D立體畫面表現能力；從「架構」的角度來看，XGL透過了[glitz位在](https://zh.wikipedia.org/wiki/glitz "wikilink")[OpenGL的上層](../Page/OpenGL.md "wikilink")。XGL利用了[聚合視窗管理器的幫助](https://zh.wikipedia.org/wiki/compositing_window_manager "wikilink")（像是[Compiz](../Page/Compiz.md "wikilink")
或
[Beryl](https://zh.wikipedia.org/wiki/Beryl_\(window_manager\) "wikilink")）對所有使用X、OpenGL和[XVideo所製作的應用和圖形效果提供了](https://zh.wikipedia.org/wiki/XVideo "wikilink")[硬體加速的支援](https://zh.wikipedia.org/wiki/硬體加速 "wikilink")，所以能表現出包含調整視窗透明度、可旋轉的3D桌面、果凍效果等等令人嘆為觀止的立體特效。這個計畫最初由[David
Reveman發起](https://zh.wikipedia.org/wiki/David_Reveman "wikilink")，並在2006年1月2日的時候第一次釋出（release）。
...
Revenman开发的[Compiz](../Page/Compiz.md "wikilink")，这是第一个使用OpenGL来表现的[复合窗口管理器](https://zh.wikipedia.org/wiki/复合窗口管理器 "wikilink")（compositing
window manager）。\[7\]
...
server上用[GLX開一個OpenGL視窗](https://zh.wikipedia.org/wiki/GLX "wikilink")，xgl再來使用這個OpenGL視窗，這樣的概念類似於[Xnest](https://zh.wikipedia.org/wiki/Xnest "wikilink")。在未來，這種運作模式將只會提供專業的開發者使用，畢竟它存在著一個看似多餘的X
...
3D提供直接的OpenGL渲染到帧缓存或通过](../Page/Mesa_3D.md "wikilink")[DRI到图形硬件](https://zh.wikipedia.org/wiki/Direct_Rendering_Infrastructure "wikilink")。2007年7月时Xegl只能运行在使用[ATi
Radeon
R200显卡的系统上](https://zh.wikipedia.org/wiki/ATi_Radeon_R200 "wikilink")，当前开发已经暂停了。\[10\]
...
對於另一競爭者[微軟公司而言](https://zh.wikipedia.org/wiki/微軟 "wikilink")，他們也在自家的Windows作業系統上提供了相似功能的解決方案：視窗桌面管理器[DWM](../Page/桌面視窗管理員.md "wikilink")。有別於Xgl所採用的OpenGL技術，這套採用微軟自家[DirectX技術的DWM已经在新一代的視窗作業系統](../Page/DirectX.md "wikilink")[Windows
...
Linux和](https://zh.wikipedia.org/wiki/Frugalware "wikilink")[SUSE
Linux Enterprise Desktop
10的一部份](https://zh.wikipedia.org/wiki/SUSE_Linux_Enterprise_Desktop_10 "wikilink")。在[Ubuntu](../Page/Ubuntu.md "wikilink")
6.06 (Dapper)和
[Freespire上](https://zh.wikipedia.org/wiki/Freespire "wikilink")，Xgl更可以以最簡單的二進位程式碼來安裝。在[Gentoo
Linux上面Xgl也可以以](../Page/Gentoo_Linux.md "wikilink") overlayed
package的形式取得。[Arch
Linux的使用者也可以透過PKGBUILD來取得Xgl](../Page/Arch_Linux.md "wikilink")。

[Mandriva Linux
2007內含由官方發行的由Xgl和](../Page/Mandriva_Linux.md "wikilink")[AIGLX搭配](https://zh.wikipedia.org/wiki/AIGLX "wikilink")[Compiz所組成的package](../Page/Compiz.md "wikilink")
...
### 免安裝直接開機使用光碟
  ...
  - [Kororaa Linux](http://kororaa.org) 這套含有 XGL 功能的
    ...
    [GPL](https://zh.wikipedia.org/wiki/GPL "wikilink") 版權規範有所不相容，所以新版的
    Kororaa Linux Live CD
    將不支援這兩家公司的顯示卡，直到有符合[GPL版權宣告的新版驅動程式出現為止](https://zh.wikipedia.org/wiki/GPL "wikilink")。
...
### 桌面貼圖、快照、screencast及範例影片
  ...
  - Novell Open Audio podcast [Xgl with David
    ...
    - [7 April](https://zh.wikipedia.org/wiki/7_April "wikilink")
    2006，discusses the basics and future of Xgl and Compiz

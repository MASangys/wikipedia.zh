...
Grace能创造印刷质量的图形输出。它支持[鼠标](../Page/鼠标.md "wikilink")操作和脚本代码（该程序语言或者通过其它计算机程序语言）。它能对用户定义的任何复杂方程进行[线性和](https://zh.wikipedia.org/wiki/线性 "wikilink")[非线性](https://zh.wikipedia.org/wiki/非线性 "wikilink")[最小二乘法](../Page/最小二乘法.md "wikilink")拟合--不论是否有限制。其他的分析工具包括[快速傅立叶变换](https://zh.wikipedia.org/wiki/快速傅立叶变换 "wikilink")，[积分](../Page/积分.md "wikilink")，[求导](https://zh.wikipedia.org/wiki/求导 "wikilink")，[样条函数](../Page/样条函数.md "wikilink")，[插值](../Page/插值.md "wikilink")和图形平滑处理.

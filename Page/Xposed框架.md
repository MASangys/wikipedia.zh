**Xposed框架**（Xposed
framework）是一套[開放原始碼的](https://zh.wikipedia.org/wiki/開放原始碼 "wikilink")、在[Android高權限模式下運行的框架服务](../Page/Android.md "wikilink")，可以在不修改[APK文件的情况下修改程序的运行](../Page/APK.md "wikilink")（修改系统），基于它可以制作出许多功能强大的模块，且在功能不冲突的情况下同时运作。這套框架需要设备解锁了[Bootloader方可安裝使用](https://zh.wikipedia.org/wiki/Bootloader "wikilink")\[1\]（[root为解锁Bootloader的充分不必要条件](https://zh.wikipedia.org/wiki/root_\(Android\) "wikilink")，而xposed安装仅需通过[TWRP等第三方](../Page/TWRP.md "wikilink")[卡刷安装包而不需要设备拥有完整的root权限](../Page/刷机.md "wikilink")）。
...
2017年10月，Xposed框架開始支持[Android
Nougat](../Page/Android_Nougat.md "wikilink")。\[3\]
...
Xposed框架是以模块扩展方式来实现对系统部分功能的修改，这些模块都依赖于Xposed这个框架。用户可以在一些应用商店或其自带的下载库进行下载安裝。在[中國大陸](https://zh.wikipedia.org/wiki/中國大陸 "wikilink")，還有精简[QQ](https://zh.wikipedia.org/wiki/QQ "wikilink")，个性化[微信界面等用途的模块](../Page/微信.md "wikilink")。\[4\]
...
## 外部链接
  ...
  -
  - [XDA Forums: Xposed
    General](https://forum.xda-developers.com/xposed)

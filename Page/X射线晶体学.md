...
[Lysozyme_crystal1.JPG](https://zh.wikipedia.org/wiki/File:Lysozyme_crystal1.JPG "fig:Lysozyme_crystal1.JPG")下的蛋白质晶体。用于X射线晶体学研究的晶体通常边长小于一个毫米。\]\] 通过X射线衍射分析结构必须首先获得样品的单晶。晶体生长的方法有很多，如气相扩散法、液相扩散法、温度渐变法、真空升华法、对流法等等，而目前应用最广泛的一种晶体生长方法是气相扩散法。气相扩散法又可以分为悬滴法、坐滴法、三明治法、油滴法和微量透析法。其中，悬滴法的使用频率最高。（以上方法都属于化学方法，通常，研究凝聚态物理的用得最多的是区熔法，以多晶材料为基础通过局部施加高温使其部分熔化后再结晶，从而逐渐得到大块的晶体，高分子材料通常不能承受过高温度，所以无法使用这种方法） 结晶时，生成晶体的溶液须先进入成核状态形成晶核，然后进入稳定态使晶体成长，才能获得足够大小的单晶。而合适的晶体生长条件往往极难预测，所以在获得初步的晶体生长条件后，需要对晶体生长条件进行优化，包括调整沉淀剂浓度（如聚乙二醇、盐类等）、[pH值](https://zh.wikipedia.org/wiki/pH "wikilink")、样品浓度、[温度](../Page/温度.md "wikilink")、[离子强度等](https://zh.wikipedia.org/wiki/离子强度 "wikilink")。
...
X射线的来源主要有两种，一种是在常用X射线仪上使用的，通过高能电子流轰击[铜](../Page/铜.md "wikilink")靶（或[鉬靶](https://zh.wikipedia.org/wiki/鉬 "wikilink")），产生多个特征波长的X射线，其中使用的CuKα的波长为1.5418[Å](https://zh.wikipedia.org/wiki/埃格斯特朗_\(单位\) "wikilink")；另一种就是利用[同步辐射](../Page/同步辐射.md "wikilink")所产生的X射线，其波长可以变化。同步辐射X射线可以分为角散同步辐射（ADXD）和能散同步辐射（EDXRD）两种，角散同步辐射的实验原理与通常的X射线衍射仪是一样的，不过波长更低（如0.6199[Å](https://zh.wikipedia.org/wiki/埃格斯特朗_\(单位\) "wikilink")），能量更高；而能散使用白光入射，即入射光具有连续波长，收集的衍射信号是在固定角度进行的，它的分辩率较角散同步辐射低，技术要求也较低。现在中国的[北京同步辐射装置](https://zh.wikipedia.org/wiki/北京同步辐射装置 "wikilink")（BSRF）已经升级成了角散的。 衍射数据（包括衍射点的位置和强度）的记录多采用像板或CCD探测器。

### 數據分析

對記錄到的繞射數據進行分析，可以獲得晶體所屬的[晶系](../Page/晶系.md "wikilink")和對應的[布拉菲晶格](../Page/布拉菲晶格.md "wikilink")以及每個繞射點在[倒晶格上的](https://zh.wikipedia.org/wiki/倒晶格 "wikilink")[密勒指數和對應的強度](https://zh.wikipedia.org/wiki/密勒指數 "wikilink")。
...
同晶置换法：将一个高电子密度的金属原子导入到分子中。结合导入前后和金属原子本身的衍射结果解决相位问题。常用的有[硒](../Page/硒.md "wikilink")、[铼](../Page/铼.md "wikilink")等。
...
虽然人们自很久以来就很喜欢漂亮的晶体，但科学化的研究是等到17世纪才开始的。[约翰内斯·开普勒](../Page/约翰内斯·开普勒.md "wikilink")于1611年发现雪花的对称六角结构是由水分子规则性的排列组成。

[尼古拉斯·斯坦诺](../Page/尼古拉斯·斯坦诺.md "wikilink")于1669年研究晶体的对称性，他指出在同一个晶体上面与面的角度总是一样的。于1784年发现，晶体的结构都能被描述成把相同大小形状的物体重复有规则的排列。与1839年给晶体的每一面各标上整数，[密勒指数到现在还被用于确定晶体方向](https://zh.wikipedia.org/wiki/密勒指数 "wikilink")。

[勒内·茹斯特·阿羽依的研究告诉我们晶体的正确概念](https://zh.wikipedia.org/wiki/勒内·茹斯特·阿羽依 "wikilink")，晶体是由晶体结构在三个方向上重复排列。

[威廉·伦琴](../Page/威廉·伦琴.md "wikilink")于1895年发现[X射线](../Page/X射线.md "wikilink")。物理学家当时不清楚那是什么，怀疑他是[电磁波](../Page/电磁波.md "wikilink")（它的确是）。经许多实验的许多现象说明X射线是电磁波，但X射线同时有粒子的特性（它的确应该有，因为[电磁波](../Page/电磁波.md "wikilink")的载体是[光子](../Page/光子.md "wikilink")——一种粒子）。[威廉·亨利·布拉格](../Page/威廉·亨利·布拉格.md "wikilink")因为这点于1907年认为[X射线](../Page/X射线.md "wikilink")不是[电磁波](../Page/电磁波.md "wikilink")。[马克斯·冯·劳厄](../Page/马克斯·冯·劳厄.md "wikilink")于1912年证实[X射线](../Page/X射线.md "wikilink")确实是[电磁波](../Page/电磁波.md "wikilink")。
...
<!-- end list -->
  ...
  - , [PDF copy of select chapters](http://www.chem.uwec.edu/Chem406_F06/Pages/lecture_notes/lect07/Crystallography_Rhodes.pdf)

...
YCbCr或Y'CbCr有的時候會被寫作：YC<small>B</small>C<small>R</small>或是Y'C<small>B</small>C<small>R</small>，是[色彩空間](../Page/色彩空間.md "wikilink")的一種，通常會用于影片中的影像連續處理，或是數字攝影系統中。Y'和Y是不同的，Y就是所謂的[流明](../Page/流明.md "wikilink")（[luminance](https://zh.wikipedia.org/wiki/luminance "wikilink")），表示光的濃度且為非線性，使用[伽馬修正](https://zh.wikipedia.org/wiki/伽玛校正 "wikilink")（gamma
...
## 外部連結
  ...
  - [YCrCb to RGB
    converter](https://web.archive.org/web/20090111035713/http://www.dvd-replica.com/DVD/colorrgb2.php)
  - [Color Space
    Visualization](https://web.archive.org/web/20081207014820/http://www.couleur.org/index.php?page=transformations#YCbCr)
  - [PC Magazine Encyclopedia:
    YCbCr](http://www.pcmag.com/encyclopedia_term/0,2542,t=YCbCr&i=55147,00.asp)
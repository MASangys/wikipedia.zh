...
，用于改进其[X.25](../Page/X.25.md "wikilink")网络上的文件传输。
...
随着[调制解调器](../Page/调制解调器.md "wikilink")速度的增加，在延迟期间可发送的包数目越来越大，这降低了*[信道效率](../Page/吞吐量.md "wikilink")*
。
...
LeechZmodem是一个恶作剧的ZMODEM变种（在类似的XMODEM和YMODEM衍生品中），它欺骗了[BBS](../Page/BBS.md "wikilink")下载配额。
...
类似的改进允许ZMODEM-90在7bit网络上工作，而早期的协议（除了Kermit之外 ）都要
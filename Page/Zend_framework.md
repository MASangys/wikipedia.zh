...
5.2.3或是更高版本，因为新版本在编译方面有许多重大安全和性能方面的改善和提高。安装PHPUnit3.0或更高版本之后才能以PHP[单元测试方式运行](../Page/单元测试.md "wikilink")，许多组件同样要求PHP扩展。\[13\]
...
所有贡献的代码，在加入到发行版本之前，都必须先通过ZF公司制订的严格的测试标准。所有代码必须符合ZF代码标准，[单元测试达到](../Page/单元测试.md "wikilink")80%以上的的测试覆盖率。\[15\]

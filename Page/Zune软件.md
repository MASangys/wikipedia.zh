...
Zune Marketplace提供查看或使用微軟積分購買音樂、播客、電視節目、電影、音樂、視頻和應用程序的在線商店\[6\]。

Zune Pass提供音樂訂閱服務，只要訂閱處於活動狀態，用戶就可以下載無限量的歌曲\[7\]\[8\]。

Zune Social提供社交功能核心組件，Zune Card在其他網站的頁面嵌入小部件。

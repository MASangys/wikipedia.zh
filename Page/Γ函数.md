...
\[\Gamma(z) = \int_{0}^{\infty} \frac{t^{z-1}}{\mathrm{e}^t} \,{\rm{d}}t\] 此定義可以用[解析開拓原理](https://zh.wikipedia.org/wiki/解析開拓 "wikilink")，拓展到除去[非正整數的整個](https://zh.wikipedia.org/wiki/非正整數 "wikilink")[複數域上](https://zh.wikipedia.org/wiki/複數 "wikilink")。
...
\(\Gamma\)函數还可以通过对\(\mathrm{e}^{-t}\,\)做[泰勒展开](https://zh.wikipedia.org/wiki/泰勒展开 "wikilink")，[解析延拓到整个](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")[复平面](../Page/复平面.md "wikilink")： \(\Gamma(z)=\int_{1}^{\infty}\frac{t^{z-1}}{\mathrm{e}^t}{\rm{d}}t+\sum_{n=0}^{\infty}\frac{(-1)^n}{n!}\frac{1}{n+z}\)

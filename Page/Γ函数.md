...
\[\Gamma(z) = \int_{0}^{\infty} \frac{t^{z-1}}{\mathrm{e}^t} \,{\rm{d}}t\] 此定義可以用[解析延拓原理](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")，拓展到除去[非正整數的整個](https://zh.wikipedia.org/wiki/非正整數 "wikilink")[複數域上](https://zh.wikipedia.org/wiki/複數 "wikilink")。

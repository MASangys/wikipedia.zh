...
在數學中，\(\Gamma \,\)**函数**，也叫做**伽瑪函數**（Gamma函数），是[階乘函數在](../Page/階乘.md "wikilink")[實數與](https://zh.wikipedia.org/wiki/實數 "wikilink")[複數域上的擴展](https://zh.wikipedia.org/wiki/複數 "wikilink")。如果\(n\)為[正整數](https://zh.wikipedia.org/wiki/正整數 "wikilink")，則：
...
此定義可以用[解析開拓原理](https://zh.wikipedia.org/wiki/解析開拓 "wikilink")，拓展到除去[非正整數的整個](https://zh.wikipedia.org/wiki/非正整數 "wikilink")[複數域上](https://zh.wikipedia.org/wiki/複數 "wikilink")。
...
\(\Gamma\)函數还可以通过对\(\mathrm{e}^{-t}\,\)做[泰勒展开](https://zh.wikipedia.org/wiki/泰勒展开 "wikilink")，[解析延拓到整个](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")[复平面](../Page/复平面.md "wikilink")：
...
\(\Gamma\,\)函數可以用[無窮乘積表示](https://zh.wikipedia.org/wiki/無窮乘積 "wikilink")：
...
此式可用來協助計算[t分布機率密度函數](https://zh.wikipedia.org/wiki/t分布 "wikilink")、[卡方分布機率密度函數](https://zh.wikipedia.org/wiki/卡方分布 "wikilink")、[F分布機率密度函數等的累計機率](https://zh.wikipedia.org/wiki/F分布 "wikilink")。
...
其中[e約等於](https://zh.wikipedia.org/wiki/e_\(常數\) "wikilink")。
...
對任何[複數](https://zh.wikipedia.org/wiki/複數 "wikilink")*z*，滿足 *Re(z) \>
0*，有
...
注意到在\(\Gamma\)函數的積分定義中若取\(z \,\)為實部大於零之[複數](https://zh.wikipedia.org/wiki/複數 "wikilink")、則積分存在，而且在右半複平面上定義一個[全純函數](https://zh.wikipedia.org/wiki/全純函數 "wikilink")。利用函數方程
...
Windschitl在2002年提出的方法，其在十進制可獲得有效數-{}-字八位數的精確度\[1\]，已足以填滿[單精度浮點數的二進制有效數](https://zh.wikipedia.org/wiki/單精度浮點數 "wikilink")-{}-字24位：

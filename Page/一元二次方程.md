...
古巴比伦留下的陶片显示，在大约公元前2000年（2000 BC）古巴比伦的数学家就能解一元二次方程了。在大約公元前480年，[中國](../Page/中國.md "wikilink")人已经使用配方法求得了二次方程的正根，但是并没有提出通用的求解方法。公元前300年左右，[欧几里得](../Page/欧几里得.md "wikilink")提出了一种更抽象的几何方法求解二次方程。

...
11世紀[阿拉伯的](../Page/阿拉伯帝国.md "wikilink")[花拉子密](https://zh.wikipedia.org/wiki/花拉子密 "wikilink")
独立地发展了一套公式以求方程的正数解。[亚伯拉罕·巴希亚](https://zh.wikipedia.org/wiki/亚伯拉罕·巴希亚 "wikilink")（亦以[拉丁文名字](https://zh.wikipedia.org/wiki/拉丁文 "wikilink")[萨瓦索达著称](https://zh.wikipedia.org/wiki/萨瓦索达 "wikilink")）在他的著作*Liber
...
把一个一元二次方程变形成一般形式\(ax^2+bx+c=0\)後，如果\(ax^2+bx+c=0\)能够较简便地分解成两个一次[因式的乘积](https://zh.wikipedia.org/wiki/因式 "wikilink")，则一般用[因式分解来解这个一元二次方程](../Page/因式分解.md "wikilink")。
...
[公式解可以由](https://zh.wikipedia.org/wiki/公式解 "wikilink")[配方法得出](../Page/配方法.md "wikilink")。
...
一元二次方程的求根公式在方程的係數为[有理数](../Page/有理数.md "wikilink")、[实数](../Page/实数.md "wikilink")、[复数或是任意](https://zh.wikipedia.org/wiki/复数 "wikilink")[数域中适用](../Page/数域.md "wikilink")。

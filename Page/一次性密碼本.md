...
**一次性密碼本**（**one-time
pad**，[缩写为](https://zh.wikipedia.org/wiki/缩写 "wikilink")**OTP**）是[古典密碼學中的一種](https://zh.wikipedia.org/wiki/古典密碼學 "wikilink")[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")[演算法](https://zh.wikipedia.org/wiki/演算法 "wikilink")。是以隨機的[密钥](https://zh.wikipedia.org/wiki/密钥 "wikilink")（key）組成明文，且只使用一次。
...
## 外部連結
  ...
  - The [FreeS/WAN](https://zh.wikipedia.org/wiki/FreeS/WAN "wikilink")
    [glossary

**一次方程**也被称为[线性](../Page/線性關係.md "wikilink")[方程](../Page/方程.md "wikilink")，因为在[笛卡尔坐标系](../Page/笛卡尔坐标系.md "wikilink")上任何一个一次方程的图形都是一条[直线](../Page/直线.md "wikilink")。组成一次方程的每一[项必须是](../Page/表示式.md "wikilink")[常数或者是一个常数和一个](https://zh.wikipedia.org/wiki/常数 "wikilink")[变量的乘积](https://zh.wikipedia.org/wiki/变量 "wikilink")。且方程中必须包含一个变量，因为如果没有变量只有常数，式子则是[代数式而非](https://zh.wikipedia.org/wiki/代数式 "wikilink")[方程](../Page/方程.md "wikilink")式。

...
model）是一个统计学上常见的。这个模型在[计量经济学的应用中十分重要](../Page/计量经济学.md "wikilink")。不要与[多元线性回归](https://zh.wikipedia.org/wiki/:en:Linear_regression#Simple_and_multiple_linear_regression "wikilink")，[广义线性模型或](../Page/廣義線性模型.md "wikilink")[一般线性方法相混淆](https://zh.wikipedia.org/wiki/:en:Linear_regression#Simple_and_multiple_linear_regression "wikilink")。
...
其中**Y**是一个包含反应变量的[矩阵](../Page/矩阵.md "wikilink")。**X**是一个包含独立自变量的[设计矩阵](https://zh.wikipedia.org/wiki/设计矩阵 "wikilink")。**B**是一个包含多个估计参数的矩阵。**U**
是一个包含[误差和](../Page/误差.md "wikilink")[剩余项的矩阵](https://zh.wikipedia.org/wiki/剩余项 "wikilink")。通常假设误差在测量之间是不相关的，并遵循多元正态分布。如果误差不遵循[多元正态分布](../Page/多元正态分布.md "wikilink")，则可以使用广义线性模型来放宽关于**Y**和**U**的假设。
...
一般线性模型的应用出现在科学实验的多[脑扫描分析中](https://zh.wikipedia.org/wiki/:en:Neuroimaging "wikilink")，其中**Y**包含来自脑扫描仪的数据，**X**包含实验设计变量和混淆值。

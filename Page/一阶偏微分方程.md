...
以下的應用會用到一阶偏微分方程：建構[双曲型偏微分方程的特徵曲面](https://zh.wikipedia.org/wiki/双曲型偏微分方程 "wikilink")、[变分法](../Page/变分法.md "wikilink")、一些幾何問題，以及一些解有用到[特征线法的氣體動力學簡單模型](../Page/特征线法.md "wikilink")。若可以找到一阶偏微分方程的解族，可以透過建立解族的包絡線來找到其他的解。

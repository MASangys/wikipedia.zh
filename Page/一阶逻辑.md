**一阶逻辑**是使用於[数学](../Page/数学.md "wikilink")、[哲学](../Page/哲学.md "wikilink")、[语言学及](../Page/语言学.md "wikilink")[電腦科學中的一种](https://zh.wikipedia.org/wiki/電腦科學 "wikilink")[形式系统](https://zh.wikipedia.org/wiki/形式系统 "wikilink")。

過去一百多年，一階邏輯出現過許多種名稱，包括：**一阶斷言演算**、**低階斷言演算**、**量化理論**或[谓词逻辑](https://zh.wikipedia.org/wiki/谓词逻辑 "wikilink")。一階邏輯和[命題邏輯的不同之處在於](https://zh.wikipedia.org/wiki/命題邏輯 "wikilink")，一階邏輯有使用[量化變數](https://zh.wikipedia.org/wiki/量化_\(數理邏輯\) "wikilink")。一個一階邏輯，若具有由一系列量化變數、一個以上有意義的[斷言字母及包含了有意義的斷言字母的純](https://zh.wikipedia.org/wiki/斷言 "wikilink")[公理所組成的特定](../Page/公理.md "wikilink")[論域](https://zh.wikipedia.org/wiki/論域 "wikilink")，即是一個[一階理論](https://zh.wikipedia.org/wiki/一階理論 "wikilink")。
...
表示若*a*為哲學家，則*a*為學者。符號\(\to\)被用來標記一個[條件敘述](https://zh.wikipedia.org/wiki/實質條件 "wikilink")。箭號的左邊為假設，右邊則為結論。此一公式的真值取決於標記成*a*的元件，及「Phil」和「Schol」的解釋之上。
...
表示不論*a*代表什麼，若*a*為哲學家，則*a*為學者。此處的\(\forall\)（[全稱量化](https://zh.wikipedia.org/wiki/全稱量化 "wikilink")）代表宣稱對「所有」*a*的選擇，括弧內的敘述皆為真的想法。

為了表明，聲稱“如果是一個哲學家然後是一個學者”是假的，一會顯示有一些人是不是一個學者的哲學家。這與存在量詞可以表示反訴 ：
若想證明「若*a*為哲學家，則*a*為學者」此一宣稱是錯的，有些人會證明存在有些不是學者的哲學家。此一反論可以用[存在量化](../Page/存在量化.md "wikilink")\(\exists\)來表示：
...
\[\exists x (\mbox{Person}(x) \land \forall y (\mbox{Time}(y) \rightarrow \mbox{Canfool}(x,y))).\]
...
1.  對每個整數*n* ≥ 0，皆存在一組*n*元**斷言符號**。因為這些斷言符號表示*n*個元素間的[關係](https://zh.wikipedia.org/wiki/關係_\(數學\) "wikilink")，因此也稱為**關係符號**。對每個參數量*n*，皆能有無限多個斷言符號：\#:*P*<sup>*n*</sup><sub>0</sub>,
    *P*<sup>*n*</sup><sub>1</sub>, *P*<sup>*n*</sup><sub>2</sub>,
    *P*<sup>*n*</sup><sub>3</sub>,…
2.  對每個整數*n* ≥ 0，皆存在無限多個*n*元**函數符號**：
      -
        *f<sup>n</sup>*<sub>0</sub>, *f<sup>n</sup>*<sub>1</sub>,
        *f<sup>n</sup>*<sub>2</sub>, *f<sup>n</sup>*<sub>3</sub>,…

在當代的數理邏輯裡，標識會因應用的不同而不同。數學裡的典型標識，在[群裡為](../Page/群.md "wikilink"){1,
×}，或只為{×}；在[有序體裡為](https://zh.wikipedia.org/wiki/有序體 "wikilink"){0,
1, +, ×,
\<}。並沒有限制非邏輯符號的數量，標識可以是[空的](../Page/空集.md "wikilink")、有限、無限，甚至是[不可數的](https://zh.wikipedia.org/wiki/不可數 "wikilink")。例如，在[勒文海姆–斯科倫定理的證明之中即會出現不可數的標識](https://zh.wikipedia.org/wiki/勒文海姆–斯科倫定理 "wikilink")。
...
1.  **斷言符號**。若*P*是一個*n*元斷言符號，且*t*<sub>*1*</sub>, ...,
    *t*<sub>*n*</sub>是項，則*P*(*t*<sub>1</sub>,...,*t*<sub>n</sub>)是公式。
2.  **等式**。若等式符號算是邏輯的一部份，且*t*<sub>*1*</sub>及*t*<sub>2</sub>是項，則*t*<sub>1</sub>
    = *t*<sub>2</sub>是公式。
3.  **否定**。若φ是公式，則\(\neg\)φ是公式。
...
是公式，若*f*是1元函數符號，*P*是1元斷言符號，且*Q*是3元斷言符號。另一方面，\(\forall x\, x \rightarrow\)則不是公式，雖然這也是由詞彙表中的符號組成的字串。
...
定義公式的規則無法定義「若-則-否則」函數ite（c,a,b），其中的*c*是個以公式表示的條件，當c為真時傳回a，為假時傳回b。這是因為斷言和函數都只能接受項當做其參數，但上述函數的第一個參數為公式。某些建構在一階邏輯上的語言，如SMT-LIB
2.0，會增加此一定義。\[2\]
...
3.  **二元聯結詞**。*x*在（φ \(\rightarrow\) ψ）裡是自由的，若且唯若*x*在φ或ψ裡是自由的。*x*在（φ
    \(\rightarrow\) ψ）裡是約束的，若且唯若*x*在φ或ψ裡是約束的。相同的規則也適用於其他的二元聯結詞之上。
4.  **量化**。*x*在\(\forall\)*y*
    φ裡是自由的，若且唯若*x*在φ裡是自由的，且*x*是個和*y*相異的符號。而且，*x*在\(\forall\)*y*
    φ裡是約束的，若且唯若*x*是*y*或*x*在φ裡是約束的。相同的規則也適用於\(\exists\)之上。

舉例來說，在\(\forall\)*x* \(\forall\)*y* (*P*(*x*)\(\rightarrow\)
*Q*(*x*,*f*(*x*),*z*))裡，*x*和*y*是約束變數，*z*是自由變數，而*w*則兩者皆不是，因為它沒有出現在公式之中。

自由和約束也可以用來專指在公式裡特定地方出現的變數。如在\(P(x) \rightarrow \forall x\, Q(x)\)裡，第一個*x*是自由的，而第二個則是約束的。換句話說，*x*在\(P(x)\)裡是自由的，而在\(x\)
in \(\forall x\, Q(x)\)裡則是約束的。
...
有序阿贝尔群的语言有一个常量0，一个一元函数−，一个二元函数 +，和一个二元关系≤。所以
  ...
  - 0, *x*, *y*是**原子项**
  - \+(*x*, *y*), +(*x*, +(*y*, −(*z*))）是**项**，通常写为*x* + *y*, *x* + *y*
    − *z*
  - \=(+(*x*, *y*), 0)，≤（+(*x*, +(*y*, −(*z*))), +(*x*,
    *y*))是**原子公式**，通常写为*x* + *y* = 0, *x* + *y* - *z* ≤
    *x* + *y*
  - (∀*x* ∃*y* ≤（ +(*x*, *y*), *z*))∧(∃*x* =(+(*x*, *y*),
    0))是**公式**，通常写为 (∀*x* ∃*y* *x* + *y* ≤ *z*)∧(∃*x*
    *x* + *y* = 0)
...
若句子φ在一給定解釋*M*下為真，則稱*M*
**滿足**φ，標記為\(M \vDash \phi\)。一個句子稱為**可滿足的**，若存在某个解釋使其為真。
...
**[一階理論](https://zh.wikipedia.org/wiki/一階理論 "wikilink")**是由在一特定一階標識內的一組[公理所組成的](../Page/公理.md "wikilink")。公理所組成的集合通常是有限的或[遞歸可枚舉的](https://zh.wikipedia.org/wiki/遞歸可枚舉集合 "wikilink")，此類的理論稱為是**有效的**。有些作者要求理論也要包括所有由公理導出的邏輯結論。
...
<!-- end list -->
  ...
  -
      ...
      -
        ...
        *x* = *y* →（*P*(...,*x*,...) → *P*（...,*y*,...））对于任何关系*P*（包括 =
        自身）

<!-- end list -->

  - 其次常见的约定是把等号包括为理论的关系之一，并向这个理论的公理增加等式的公理。在实际中这是同前面约定最难分辨的，除了在没有等式概念的不常见情况下。公理是一样的，唯一的区别是把它叫做逻辑公理还是这个理论的公理。
  - 在没有函数和有有限数目个关系的理论中，有可能以关系的方式定义等式，通过定义两个项*s*和*t*是相等的，如果任何关系通过把*s*改变为*t*
    在任何讨论下都没有改变。例如，在带有一个关系∈的集合论中，我们可以定义*s* = *t*为∀*x* (*s* ∈ *x* ↔ *t* ∈
    *x*) ∧ ∀*x*（*x* ∈ *s* ↔ *x* ∈ *t*）的缩写。这个等式定义接着自动的满足了关于等式的公理。
  - 在某些理论中有可能给出特别的等式定义。例如，在带有一个关系 ≤的偏序的理论中，我们可以定义*s* = *t*为*s* ≤ *t* ∧
    *t* ≤ *s*的缩写。
...
可证明性的一个明显问题是它好像非常特别：我们采用了显然随机的公理和推理规则的搜集，不清楚是否意外的漏掉了某个关键的公理或规则。[哥德尔完备性定理确保这实际上不是问题](../Page/哥德尔完备性定理.md "wikilink")：这个定理声称在所有模型中为真的任何陈述在一阶逻辑中都是可证明的。特别是，在一阶逻辑中"可证明性"的任何合理定义都必须等价于上述定义（尽管在不同的可证明性的定义下证明的长度可能有巨大差别）。
...
文法上说斷言演算在现存的命题演算上增加了“斷言-主词结构”和[量词](../Page/量化_\(数理逻辑\).md "wikilink")。主词是给定的个体群组（[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")）的一个成员的名字，而**斷言**是在这个群组上的[关系](../Page/关系_\(数学\).md "wikilink")，一元斷言在哲学中称为[性质](../Page/范畴_\(哲学\).md "wikilink")，在数学中称为[指示函数](../Page/指示函数.md "wikilink")，在[数理逻辑中称为](../Page/数理逻辑.md "wikilink")[布尔值函数](../Page/布尔值函数.md "wikilink")。
...
2.  [有效性的判定问题是半可判定的](https://zh.wikipedia.org/wiki/有效性 "wikilink")。按[哥德尔完备性定理所展示的](../Page/哥德尔完备性定理.md "wikilink")，对于任何**有效的**公式P,
    P是可证明的。
3.  [一元斷言逻辑](https://zh.wikipedia.org/wiki/一元斷言逻辑 "wikilink")（就是说，斷言只有一个参数的斷言逻辑）是可判定的。

## 转换自然语言到一阶逻辑

用自然语言表达的概念必须在一阶逻辑（FOL）可以为为其效力之前必须被转换到FOL，而在这种转换中可能有一些潜在的缺陷。在FOL中，\(p \lor q\)意味着“要么p要么q要么二者”，就是说它是“包容性”的。在英语中，单词“or”有时是包容性的（比如，“加牛奶或糖？”），有时是排斥性的（比如，“喝咖啡或茶？”，通常意味着取其中一个或另一个但非二者）。类似的，英语单词“some”可以意味着“至少一个，可能全部”，有时意味着“不是全部，可能没有”。英语单词“and”有时要按“or”转换（比如，“男人和女人可以申请”）。
\[4\]
...
在数学上，有可能重定义匹配公式算子的新函数的完备集合，但是这是非常笨拙的。\[5\]
斷言if（c,a,b）如果重写为\((c \wedge a) \lor (\neg c \wedge b)\)就可以在FOL中表达，但是如果条件c是复杂的这就是笨拙的。很多人扩展FOL增加特殊情况斷言叫做“if（条件，a,
b）”（这里a和b是公式）和／或函数“ite（条件，a,
b）”（这裡的a和b是项），它们都接受一个公式作为条件，并且等于a如果条件为真，或b如果条件为假。这些扩展使FOL易于用于某些问题，并使某类自动定理证明更容易。\[6\]
其他人进一步扩展FOL使得函数和斷言可以在任何位置接受项和公式二者。

### 类型（种类）

除了在公式（“布尔类型”）和项（“非布尔类型”）之间的区别之外，FOL不包括类型（种类）到自身的概念中。 某些人争辩说缺乏类型是巨大优点
\[7\]，而很多其他人发觉了定义和使用类型（种类）的优点，比如帮助拒绝某些错误或不想要的规定 \[8\]。
...
从[Löwenheim–Skolem定理得出在一阶逻辑中不可能刻画有限性或可数性](https://zh.wikipedia.org/wiki/Löwenheim–Skolem定理 "wikilink")。例如，在一阶逻辑中你不能断言[实数的集合的](../Page/实数.md "wikilink")[上确界性质](https://zh.wikipedia.org/wiki/上确界 "wikilink")，它声称实数的所有有界的、非空集合都有[上确界](https://zh.wikipedia.org/wiki/上确界 "wikilink")；这就需要[二阶逻辑了](https://zh.wikipedia.org/wiki/二阶逻辑 "wikilink")。
...
### 来源
  ...
  - [Jon Barwise](https://zh.wikipedia.org/wiki/Jon_Barwise "wikilink")
    and [John
    Etchemendy](https://zh.wikipedia.org/wiki/John_Etchemendy "wikilink")，2000.
    *Language Proof and Logic*. CSLI (University of Chicago Press) and
    New York: Seven Bridges Press.
  - [David
    Hilbert](https://zh.wikipedia.org/wiki/David_Hilbert "wikilink") and
    [Wilhelm
    Ackermann](https://zh.wikipedia.org/wiki/Wilhelm_Ackermann "wikilink")
    1950. [Principles of Theoretical
    Logic](https://zh.wikipedia.org/wiki/Principles_of_Theoretical_Logic "wikilink")（English
    translation）. Chelsea. The 1928 first German edition was titled
    *Grundzüge der theoretischen Logik*.
  - [Wilfrid
    Hodges](https://zh.wikipedia.org/wiki/Wilfrid_Hodges "wikilink"),
    2001, "Classical Logic I: First Order Logic", in Lou Goble, ed.,
    *The Blackwell Guide to Philosophical Logic*. Blackwell.

## 外部链接

  - *[Stanford Encyclopedia of
    Philosophy](https://zh.wikipedia.org/wiki/Stanford_Encyclopedia_of_Philosophy "wikilink")*："[Classical
    Logic](http://plato.stanford.edu/entries/logic-classical/) -- by
    Stewart Shapiro. Covers syntax, model theory, and metatheory for
    first order logic in the natural deduction style.
  - *[forall x: an introduction to formal
    logic](http://www.fecundity.com/logic/)*, by P.D. Magnus, covers
    formal semantics and proof theory for first-order logic.
  - [Metamath](http://us.metamath.org/index.html)：an ongoing online
    project to reconstruct mathematics as a huge first order theory,
    using first order logic and the [axiomatic set
    theory](https://zh.wikipedia.org/wiki/axiomatic_set_theory "wikilink")
    [ZFC](https://zh.wikipedia.org/wiki/ZFC "wikilink"). *[Principia
    Mathematica](https://zh.wikipedia.org/wiki/Principia_Mathematica "wikilink")*
    modernized and done right.
  - Podnieks, Karl. *[Introduction to mathematical
...
1.
2.  The SMT-LIB Standard: Version 2.0, by Clark Barrett, Aaron Stump,
    and Cesare Tinelli.
3.  For another well-worked example, see [Metamath proof
    explorer](http://us.metamath.org/mpegif/mmset.html)
4.
5.
6.
7.  Leslie Lamport, Lawrence C. Paulson. Should Your Specification
    Language Be Typed? ACM Transactions on Programming Languages and
    Systems. 1998. <http://citeseer.ist.psu.edu/71125.html>
8.  Rushby, John. Subtypes for Specification. 1997. Proceedings of the
    Sixth European Software Engineering Conference (ESEC/FSE 97).
    <http://citeseer.ist.psu.edu/328947.html>
9.
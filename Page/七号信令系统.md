**七号信令系统**（SS7，Signaling System Number
7）是一种被广泛应用在[公共交换电话网](../Page/公共交换电话网.md "wikilink")、[蜂窝通信网络等现代通信网络的](https://zh.wikipedia.org/wiki/蜂窝通信网络 "wikilink")[共路信令系统](https://zh.wikipedia.org/wiki/共路信令 "wikilink")。七号信令系统是[国际电信联盟](../Page/国际电信联盟.md "wikilink")推荐首选的标准[信令系统](https://zh.wikipedia.org/wiki/信令系统 "wikilink")。\[1\]
...
[SS7_software_layers.png](https://zh.wikipedia.org/wiki/File:SS7_software_layers.png "fig:SS7_software_layers.png")
从软件层次区分，七号信令系统可以分成包含三个功能级[消息传递部份](https://zh.wikipedia.org/wiki/消息传递部份 "wikilink")（MTP）和作为第四个功能级的业务分系统。\[8\]

消息传递部份负责信令的正常传输，确保传输的信令不出现错误，为业务分系统提供服务。\[9\]消息传递部份可以细分为三个功能级：数据链路功能级（消息传递部份第一个功能级，MTP
1）、链路控制功能级（消息传递部份第二个功能级，MTP 2）和网络功能级（消息传递部份第三个功能级，MTP
3），\[10\]这三个功能级分别对应了[开放系统互联参考模型的物理层](https://zh.wikipedia.org/wiki/开放系统互联参考模型 "wikilink")、链路层和网络层。\[11\]
...
12.
13.
14. 張明峰，台湾交大資訊工程系，VoIP and
    SS7，http://www.csie.nctu.edu.tw/\~mfchang/VoIP/Sigtran.ppt
**三对角矩阵算法**（），又称为**托马斯算法**（，名称源于英国数学家）是[数值线性代数中的一种算法](../Page/数值线性代数.md "wikilink")，通过简化形式的[高斯消元法求解](https://zh.wikipedia.org/wiki/高斯消元法 "wikilink")[三对角矩阵](https://zh.wikipedia.org/wiki/三对角方程组 "wikilink")。包含*n*个未知数的三对角方程组可以写成

[Cubic_function.png](https://zh.wikipedia.org/wiki/File:Cubic_function.png "fig:Cubic_function.png")
**三次方程**是未知项總次数**最高**为3的[整式](../Page/整式.md "wikilink")[方程](../Page/方程.md "wikilink")，**一元**三次方程一般形式為

\[ax^3 + bx^2 + cx + d = 0\]， 其中\(\ a\), \(\ b\),\(\ c\)和\(\ d\)
...
中國[唐朝数学家](../Page/唐朝.md "wikilink")[王孝通在武德九年](../Page/王孝通.md "wikilink")（626年）前后所著的《[緝古算經](../Page/緝古算經.md "wikilink")》中建立了25个三次多项式方程和提出三次方程实根的数值解法。\[1\]

波斯数学家[欧玛尔·海亚姆](../Page/欧玛尔·海亚姆.md "wikilink")（1048年－1123年）通过用圆锥截面与圆相交的方法構建了三次方程的解法。他说明了怎样用这种几何方法利用三角法表得到数字式的答案。

中国[南宋的数学家](../Page/南宋.md "wikilink")[秦九韶在他](../Page/秦九韶.md "wikilink")1247年编写的《[数书九章](../Page/数书九章.md "wikilink")》一书中提出了[高次方程的数值解法](../Page/高次方程.md "wikilink")[秦九韶算法](../Page/秦九韶算法.md "wikilink")，提出“商常为正，实常为负，从常为正，益常为负”的原则。

在十六世纪早期，意大利数学家[费罗找到了能解一种三次方程的方法](../Page/费罗.md "wikilink")，也就是形如\(x^3 +mx= n \,\)的方程。事实上，如果我们允许\(m \,\),
\(n \,\)是複数，所有的三次方程都能变成这种形式，但在那个时候人们不知道複数。

[尼科洛·塔爾塔利亞被認為是最早得出三次方程式一般解的人](../Page/尼科洛·塔爾塔利亞.md "wikilink")。1553年他在一場數學競賽中解出所有三次方程式的問題。隨後[卡尔丹诺拜訪了](../Page/卡尔丹诺.md "wikilink")[塔爾塔利亞請教三次方程式解法並得到了啟發](../Page/塔爾塔利亞.md "wikilink")。[卡尔丹诺注意到](../Page/卡尔丹诺.md "wikilink")[塔爾塔利亞的方法有时需要他给复数开平方](../Page/塔爾塔利亞.md "wikilink")。他甚至在《数学大典》裡包括了这些[複數的计算](../Page/複數.md "wikilink")，但他并不真正理解它。[拉斐尔·邦贝利](../Page/拉斐尔·邦贝利.md "wikilink")（Rafael
...
当\({\Delta>0}\,\)时，方程有一个实根和两个[共轭複根](../Page/共軛複數.md "wikilink")；
...
在一個**代數封閉**域，所有三次方程都有三個根。複數域就是這樣一個域，這是[代數基本定理的結果](../Page/代數基本定理.md "wikilink")。
...
可以證明實數根數目依賴於輔助方程的[判別式](../Page/判別式.md "wikilink")\(\Delta = \frac{q^2}{4}+\frac{p^3}{27}\)，

  - 若\(\Delta > 0 \,\)，方程有一个实根和两个[共轭複根](../Page/共轭.md "wikilink")；
  - 若\(\Delta = 0 \,\)，方程有三个实根：当\(\frac{q^2}{4}=-\frac{p^3}{27}=0\)时，方程有一个三重实根；当\(\frac{q^2}{4}=-\frac{p^3}{27}\ne 0\)时，方程的三个实根中有两个相等；
  - 若\(\Delta < 0 \,\)，方程有三个不等的实根：\(x_1 = 2\sqrt{Q}\cos \frac{\theta}{3}-\frac{b}{3a} \,,\)
    \(x_{2,3} = 2\sqrt{Q}\cos\frac{\theta \pm 2\pi}{3}-\frac{b}{3a} \,,\)其中\(\theta = \arccos \frac{R}{Q\sqrt{Q}} \,,\)
    \(Q=-\frac{p}{3} \,,\)
    \(R=\frac{q}{2}\)（注意，由於此公式應對於\(x^3 + px = q \,\)的形式，因此這裡的\(q \,\)實際上是前段的\(-q \,\)，應用時務必注意取負號即\(R=-\frac{q}{2}\)）。

注意到实系数三次方程至少有一實根存在，這是因為非[常數多項式在](../Page/常數多項式.md "wikilink")\(+\infty\,\)和\(-\infty\,\)的[極限是](../Page/極限.md "wikilink")[無窮大](../Page/無窮大.md "wikilink")，對奇次多項式這兩個極限異號，又因为多項式是[連續函數](../Page/連續函數.md "wikilink")，所以從[介值定理可知它在某點的值為](../Page/介值定理.md "wikilink")0。
...
我们解出\(U = 2 - 11{\mathrm{i}} \,\)和\(V = 2 + 11{\mathrm{i}} \,\)。取复数立方根不同于实数，有两种方法：几何方法，用到辐角和模（把辐角除以3取模的立方根）；代数方法，分开复数的实部和虚部：
现设\(u = a + b{\mathrm{i}}\,\)。
...
设\(\frac{dy}{dx}=0\)，可得\(\ x\)在\(\ y\)中的[极值](../Page/极值.md "wikilink")（[极大值或](../Page/极大值.md "wikilink")[极小值](../Page/极小值.md "wikilink")）\(\ x_e\)满足：
...
\(f^{\prime \prime}(x_e)<0\)，\(\ x_e\)是\(\ f(x)\)的[极大值点](../Page/极大值点.md "wikilink")；
\(f^{\prime \prime}(x_e)>0\)，\(\ x_e\)是\(\ f(x)\)的[极小值点](../Page/极小值点.md "wikilink")；
...
## 外部链接
  ...
  - [代數學的故事：三次方程的一般解](http://episte.math.ntu.edu.tw/articles/sm/sm_10_04_1/page5.html)，[李白飛](../Page/李白飛.md "wikilink")
  - [三次方程的判別式](http://db.math.ust.hk/resource_sharing/algebra/sc_d3.pdf)，[應用](http://db.math.ust.hk/resource_sharing/algebra/se_d3app.pdf)，Carto
    Wong

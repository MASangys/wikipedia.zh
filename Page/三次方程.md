...
**三次方程**是未知项總次数**最高**为3的[整式](https://zh.wikipedia.org/wiki/整式 "wikilink")[方程](../Page/方程.md "wikilink")，**一元**三次方程一般形式為
...
中國[唐朝数学家](../Page/唐朝.md "wikilink")[王孝通在武德九年](https://zh.wikipedia.org/wiki/王孝通 "wikilink")（626年）前后所著的《[緝古算經](../Page/緝古算經.md "wikilink")》中建立了25个三次多项式方程和提出三次方程实根的数值解法。\[1\]

波斯数学家[欧玛尔·海亚姆](../Page/欧玛尔·海亚姆.md "wikilink")（1048年－1123年）通过用圆锥截面与圆相交的方法構建了三次方程的解法。他说明了怎样用这种几何方法利用三角法表得到数字式的答案。

中国[南宋的数学家](../Page/南宋.md "wikilink")[秦九韶在他](../Page/秦九韶.md "wikilink")1247年编写的《[数书九章](../Page/数书九章.md "wikilink")》一书中提出了[高次方程的数值解法](https://zh.wikipedia.org/wiki/高次方程 "wikilink")[秦九韶算法](../Page/秦九韶算法.md "wikilink")，提出“商常为正，实常为负，从常为正，益常为负”的原则。

在十六世纪早期，意大利数学家[费罗找到了能解一种三次方程的方法](https://zh.wikipedia.org/wiki/费罗 "wikilink")，也就是形如\(x^3 +mx= n \,\)的方程。事实上，如果我们允许\(m \,\),
\(n \,\)是複数，所有的三次方程都能变成这种形式，但在那个时候人们不知道複数。

[尼科洛·塔爾塔利亞被認為是最早得出三次方程式一般解的人](https://zh.wikipedia.org/wiki/尼科洛·塔爾塔利亞 "wikilink")。1553年他在一場數學競賽中解出所有三次方程式的問題。隨後[卡尔丹诺拜訪了](https://zh.wikipedia.org/wiki/卡尔丹诺 "wikilink")[塔爾塔利亞請教三次方程式解法並得到了啟發](https://zh.wikipedia.org/wiki/塔爾塔利亞 "wikilink")。[卡尔丹诺注意到](https://zh.wikipedia.org/wiki/卡尔丹诺 "wikilink")[塔爾塔利亞的方法有时需要他给复数开平方](https://zh.wikipedia.org/wiki/塔爾塔利亞 "wikilink")。他甚至在《数学大典》裡包括了这些[複數的计算](https://zh.wikipedia.org/wiki/複數 "wikilink")，但他并不真正理解它。[拉斐尔·邦贝利](../Page/拉斐尔·邦贝利.md "wikilink")（Rafael
...
注意到实系数三次方程至少有一實根存在，這是因為非[常數多項式在](https://zh.wikipedia.org/wiki/常數多項式 "wikilink")\(+\infty\,\)和\(-\infty\,\)的[極限是](https://zh.wikipedia.org/wiki/極限 "wikilink")[無窮大](https://zh.wikipedia.org/wiki/無窮大 "wikilink")，對奇次多項式這兩個極限異號，又因为多項式是[連續函數](https://zh.wikipedia.org/wiki/連續函數 "wikilink")，所以從[介值定理可知它在某點的值為](../Page/介值定理.md "wikilink")0。

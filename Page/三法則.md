**三法則**（）在[C++](../Page/C++.md "wikilink")裡，它是一個以設計的基本原則而制定的定律。它的要求是，假如[类有明顯](../Page/类_\(计算机科学\).md "wikilink")下列其中一個成員函式，那麼[程序员](../Page/程序员.md "wikilink")必須寫入其他兩個[成員函式到類別內](../Page/方法_\(電腦科學\).md "wikilink")，也就是說下列三個成員函式缺一不可
\[1\]。

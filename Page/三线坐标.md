...
三线坐标和2维[笛卡尔坐标之间存在转换公式](https://zh.wikipedia.org/wiki/笛卡尔坐标 "wikilink")。给定一个参考三角形*ABC*，将顶点*B*的位置表示成一个笛卡尔坐标的有序组，将其代数地写成一个以顶点*C*为起点的[向量](../Page/向量.md "wikilink")<u>*a*</u>。类似地定义顶点*A*为<u>b</u>。然后任何点*P*关于参考三角形*ABC*能定义一个2维笛卡尔坐标系，写成向量<u>*p*</u> = α<u>*a*</u> + β<u>*b*</u>。如果点*P*有三线坐标*x:y:z*，那么变换公式是：

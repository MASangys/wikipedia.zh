**三线性插值**是在三维离散采样数据的[张量积网格上进行](../Page/张量积.md "wikilink")[线性插值的方法](../Page/线性插值.md "wikilink")。这个张量积网格可能在每一[维度上都有任意不重叠的网格点](../Page/维度.md "wikilink")，但并不是三角化的[有限元分析网格](../Page/有限元分析.md "wikilink")。这种方法通过网格上数据点在局部的矩形[棱柱上线性地近似计算点](../Page/棱柱.md "wikilink")
\((x, y, z)\) 的值。

三线性插值经常用于[数值分析](../Page/数值分析.md "wikilink")、[数据分析以及](../Page/数据分析.md "wikilink")[计算机图形学等领域](../Page/计算机图形学.md "wikilink")。
...
顺序插值将会得到同样的结果。这也与张量积的[交换律完全一致](../Page/交换律.md "wikilink")。

## 参见

  - [插值](../Page/插值.md "wikilink")
  - [线性插值](../Page/线性插值.md "wikilink")
  - [双立方插值](../Page/双立方插值.md "wikilink")

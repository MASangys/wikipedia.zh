...
在[概率论与](https://zh.wikipedia.org/wiki/概率论 "wikilink")[统计学中](../Page/统计学.md "wikilink")，**三角形分布**是低限为
...
是两个[連續型均勻分佈的](https://zh.wikipedia.org/wiki/連續型均勻分佈 "wikilink")[随机变量](../Page/随机变量.md "wikilink")。
...
三角形分布经常用于商务[决策](../Page/决策.md "wikilink")，尤其是[计算机模拟领域](../Page/计算机模拟.md "wikilink")。通常，如果对结果的[概率分布所知信息很少](../Page/概率分布.md "wikilink")，例如仅仅知道最大值与最小值，那么可以使用[平均分布模型](https://zh.wikipedia.org/wiki/平均分布 "wikilink")。但是，如果已经知道了最可能出现的结果，那么就可以用三角形分布进行模拟。

### 项目管理

三角形分布以及[Beta分布在](https://zh.wikipedia.org/wiki/Beta分布 "wikilink")[项目管理中大量地用作](../Page/项目管理.md "wikilink")[项目评估与审核技术以及](https://zh.wikipedia.org/wiki/项目评估与审核技术 "wikilink")[关键途径的输入信息](https://zh.wikipedia.org/wiki/关键途径 "wikilink")，以建立在最大值与最小值之间事件发生的概率模型。

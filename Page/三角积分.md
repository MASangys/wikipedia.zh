[SiCi.png](https://zh.wikipedia.org/wiki/File:SiCi.png "fig:SiCi.png")
**三角积分**是含有[三角函数的一种](../Page/三角函数.md "wikilink")[积分](../Page/积分.md "wikilink")。一些简单的含有三角函数的积分，可在[三角函数积分表中找到](../Page/三角函数积分表.md "wikilink")。

## 正弦积分

有两种不同的[正弦积分](../Page/正弦.md "wikilink")：
...
注意到\(\frac{\sin t}{t}\)是[sinc函数](../Page/sinc函数.md "wikilink")，也是第零个[球贝塞尔函数](../Page/贝塞尔函数#球贝塞尔函数.md "wikilink")。

## 余弦积分

有两种不同的[余弦积分](../Page/余弦.md "wikilink")：
...
{\\rm E}_1(z) = \\int_1^\\infty \\frac {\\exp(-zt)} {t} {\\rm d} t
\~\~,\~\~\~\~({\\rm Re}(z) \\ge 0) </math>
称为[指数积分](../Page/指数积分.md "wikilink")，与正弦和余弦积分有以下的关系：

**三进制**是以[3为](../Page/3.md "wikilink")[基数的](https://zh.wikipedia.org/wiki/基数 "wikilink")[进制](https://zh.wikipedia.org/wiki/进制 "wikilink")。和[二进制一样](https://zh.wikipedia.org/wiki/二进制 "wikilink")，三进制的数位，称为三进制位（trit），每个三进制位包含\(\log_2 3\)（约1.58个）二进制位的信息量。通常，三进制中使用0、1、2三个数字。但在[平衡三进制中](https://zh.wikipedia.org/wiki/平衡三进制 "wikilink")，则使用-1（记作T）、0、1来表达。
...
[整数的三进制表示法不如](../Page/整数.md "wikilink")[二进制那样冗长](https://zh.wikipedia.org/wiki/二进制 "wikilink")，但仍然比[十进制要长](../Page/十进制.md "wikilink")。例如，[365在二进制中的写法是](https://zh.wikipedia.org/wiki/365 "wikilink")101101101（9个数字），在三进制中的写法是111112（6个数字）。
...
| 十进制 | 1                 | 3                 | 9                   | 27                    | 81                      | 243                      | 729                         | 2 187                         | 6 561                           | 19 683                            |
...
在三进制中表示三分之一是很方便的，不像在十进制中，需要用无限小数来表示。但是，[二分之一](../Page/二分之一.md "wikilink")、四分之一之类的分数在三进制中都是无穷小数，这是因为[2不是](../Page/2.md "wikilink")3的[因子](https://zh.wikipedia.org/wiki/因子 "wikilink")。
...
早在上世纪50、60年代，一批[莫斯科国立大学的研究员就设计了人类历史上第一批三进制计算机](../Page/莫斯科国立大学.md "wikilink")“”和“”（“”是莫大附近一条流入莫斯科河的小河的名字）。
...
TERNAC
是一部三进制计算机，由纽约州立大学在1973年实现。TERNAC提供整数和浮点数，整数的长度是24个三进制位。浮点数采用科学计数法表示，尾数部分长42个三进制位，指数部分长6个三进制位。

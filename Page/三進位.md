...
[整数](../Page/整数.md "wikilink")的三进制表示法不如[二进制那样冗长](https://zh.wikipedia.org/wiki/二进制 "wikilink")，但仍然比[十进制](../Page/十进制.md "wikilink")要长。例如，[365在二进制中的写法是](https://zh.wikipedia.org/wiki/365 "wikilink")101101101（9个数字），在三进制中的写法是111112（6个数字）。

[Three_utilities_problem.png](https://zh.wikipedia.org/wiki/File:Three_utilities_problem.png "fig:Three_utilities_problem.png") **三間小屋問題**（three cottages problem）也稱為**水、瓦斯及電力問題**（water, gas and electricity）或**Three utilities problem**，是經典的[數學謎題](../Page/數學謎題.md "wikilink")，描述如下：

[LimSup.svg](https://zh.wikipedia.org/wiki/File:LimSup.svg "fig:LimSup.svg") [数学](../Page/数学.md "wikilink")上，[序列](../Page/序列.md "wikilink")的**上极限**和**下极限**可以看为序列的极限上下界。[函数](../Page/函数.md "wikilink")的上极限和下极限可以用类似方式考虑。（参见[函数的极限](https://zh.wikipedia.org/wiki/极限_\(数学\)#函数的极限 "wikilink")）。集合的上极限和下极限分别是这个集合的[极限点](../Page/极限点.md "wikilink")的[上确界和](https://zh.wikipedia.org/wiki/上确界 "wikilink")[下确界](https://zh.wikipedia.org/wiki/下确界 "wikilink")。
...
实数集**R**的[数列](../Page/数列.md "wikilink")对[微积分很重要](https://zh.wikipedia.org/wiki/微积分 "wikilink")。**R**不是完全格，但可以加入正负[无穷](../Page/无穷.md "wikilink")以得到完備[全序集](https://zh.wikipedia.org/wiki/全序集 "wikilink")\([-\infty,+\infty]\)，正是完全格。那么在\([-\infty,+\infty]\)中数列\((x_n)\) [收敛当且仅当](https://zh.wikipedia.org/wiki/极限 "wikilink")\(\liminf x_n = \limsup x_n\)，而这时\(\lim x_n\)等于上面的共同值。（注意当只是考虑**R**时，收敛至\(-\infty\)或\(+\infty\)并不当作收敛，而是視作[極限不存在](https://zh.wikipedia.org/wiki/極限_\(數學\) "wikilink")。）

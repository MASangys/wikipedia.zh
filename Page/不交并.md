...
是不交并[当且仅当对于](../Page/当且仅当.md "wikilink")中任意的两个相异指标和，都有
...
表示一个集合族的不交并，或者*A* +
*B*表示两个集合的不交并。这个记法本意是暗示不交并的[基数是该集合族中所有集合的基数之](https://zh.wikipedia.org/wiki/基数 "wikilink")[和](https://zh.wikipedia.org/wiki/和 "wikilink")。

在另一個定義下，若{*A*<sub>*i*</sub> : *i* ∈ *I*}是一個集合族，不交并定義為

\[\bigsqcup_{i\in I}A_i = \bigcup_{i\in I}\{(x,i) : x \in A_i\}.\]

不交并的元素是[有序對](https://zh.wikipedia.org/wiki/有序對 "wikilink") (*x*, *i*)。此處
*i*標記著 *x* 的來源是哪個 *A*<sub>*i*</sub>。
...
设指标集为[整数集](../Page/整数.md "wikilink")\(\mathbb{Z}\)，定义[集合族](https://zh.wikipedia.org/wiki/集合族 "wikilink")：\(\forall i \in \mathbb{Z}, \; R_i = [i, i+1)\)。则所有的\(R_i\)的并集是不交并，结果是实数集合\(\mathbb{R}\)。
...
在[范畴论的语言中無交并是](../Page/范畴论.md "wikilink")[集合范畴的](../Page/集合范畴.md "wikilink")[上积](https://zh.wikipedia.org/wiki/上积 "wikilink")，因此它满足相应的[泛性质](../Page/泛性质.md "wikilink")。这也意味着不交并是[笛卡尔积的](https://zh.wikipedia.org/wiki/笛卡尔积 "wikilink")[对偶](https://zh.wikipedia.org/wiki/对偶_\(范畴论\) "wikilink")。\[3\]

...
\[[T]_B = \begin{bmatrix} [T|_W]_C & * \\ 0 & * \end{bmatrix}\] 其中左上角块表达了\(W\)中的向量的像还在\(W\)本身中因此是\(W\)的[基向量的](https://zh.wikipedia.org/wiki/基向量 "wikilink")[线性组合这一事实](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。

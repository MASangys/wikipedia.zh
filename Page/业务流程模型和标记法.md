...
Notation**）是一套图形化表示法，用于以[业务流程模型详细说明各种](https://zh.wikipedia.org/wiki/业务流程模型 "wikilink")[业务流程](https://zh.wikipedia.org/wiki/业务流程 "wikilink")。
...
Object Management
Group）维护的关于的行业性标准。它建立在与[UML的](https://zh.wikipedia.org/wiki/UML "wikilink")[活动图非常相似的](https://zh.wikipedia.org/wiki/活动图 "wikilink")[流程图法](../Page/流程图.md "wikilink")（flowcharting）基础上\[2\]，为“业务流程图”（BPD,
Business Process
Diagram）\[3\]中的特定[业务流程提供一套图形化标记法](https://zh.wikipedia.org/wiki/业务流程 "wikilink")。BPMN的目标是，通过提供一套既符合业务人员直观又能表现复杂流程语义的标记法，同时为技术人员和业务人员从事[业务流程管理提供支持](https://zh.wikipedia.org/wiki/业务流程管理 "wikilink")。BPMN规范还提供从标记法的图到执行语言基础构造的映射，尤其是（BPEL）\[4\]。
...
此外，虽然BPMN会显示数据的流（消息）以及活动与数据器物的关联，但它并非[数据流图](https://zh.wikipedia.org/wiki/数据流图 "wikilink")（data
flow diagram）。

...
使用GCJ-02记录下的地点在GCJ-02的地图中会显示在正确的位置，然而换成WGS-84的地图或地点记录就可能造成100－700米不等的偏移。据测量，\[19\]Google.com的地图与真实坐标相差约50－500米，\[20\]而中国区的Google.cn地图则与卫星图无偏差，[雅虎地圖](../Page/雅虎地圖.md "wikilink")显示的街道图也与卫星图偏差不大。MapQuest地图与众包测绘、不受限制的OpenStreetMap重合。

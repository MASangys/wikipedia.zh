**中國剩-{zh-cn:余;zh-tw:餘;}-定理**，又稱**中國餘數定理**，是[数论中的一個关于一元线性](../Page/数论.md "wikilink")[同余方程组的定理](https://zh.wikipedia.org/wiki/同余 "wikilink")，说明了一元线性同余方程组有解的准则以及求解方法。也称为**孫子定理**，古有「[韓信點兵](https://zh.wikipedia.org/wiki/韓信 "wikilink")」、「[孫子定理](https://zh.wikipedia.org/wiki/孫子算經 "wikilink")」、「求一术」（[宋](../Page/宋朝.md "wikilink")[沈括](../Page/沈括.md "wikilink")）、「鬼谷算」（宋[周密](../Page/周密.md "wikilink")）、「隔墻算」（宋
周密）、「剪管術」（宋[杨辉](../Page/杨辉.md "wikilink")）、「[秦王暗點兵](../Page/秦始皇.md "wikilink")」、「物不知數」之名。

## 物不知数

一元线性同余方程组问题最早可见于中國[南北朝时期](https://zh.wikipedia.org/wiki/南北朝 "wikilink")（公元5世纪）的數學著作《[孫子算經](https://zh.wikipedia.org/wiki/孫子算經 "wikilink")》卷下第二十六题，叫做“物不知數”问题，原文如下：

即，一個整數除以三-{zh-cn:余;zh-tw:餘;}-二，除以五-{zh-cn:余;zh-tw:餘;}-三，除以七-{zh-cn:余;zh-tw:餘;}-二，求這個整數。《[孫子算經](https://zh.wikipedia.org/wiki/孫子算經 "wikilink")》中首次提到了同余方程组问题，以及以上具体问题的解法，因此在中文数学文献中也会将中国剩余定理称为孙子定理。

宋朝数学家[秦九韶于](../Page/秦九韶.md "wikilink")1247年《[数书九章](../Page/数书九章.md "wikilink")》卷一、二《大衍类》对“物不知数”问题做出了完整系统的解答。明朝数学家[程大位在](../Page/程大位.md "wikilink")《[算法统宗](https://zh.wikipedia.org/wiki/算法统宗 "wikilink")》中将解法编成易于上口的《孙子歌诀》\[1\]：
...
有解的判定条件，并用[构造法给出了在有解情况下解的具体形式](https://zh.wikipedia.org/wiki/构造法 "wikilink")。

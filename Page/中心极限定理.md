...
**中心极限定理**是[概率论中的一组定理](https://zh.wikipedia.org/wiki/概率论 "wikilink")。中心极限定理说明，在适当的条件下，大量相互独立[随机变量的均值经适当标准化后](../Page/随机变量.md "wikilink")[依分布收敛于](https://zh.wikipedia.org/wiki/依分布收敛 "wikilink")[正态分布](../Page/正态分布.md "wikilink")。这组定理是[数理统计学和误差分析的理论基础](https://zh.wikipedia.org/wiki/数理统计学 "wikilink")，指出了大量随机变量之和近似服从正态分布的条件。
...
棣莫佛－拉普拉斯（de Moivre -
Laplace）定理是中央极限定理的最初版本，讨论了服从[二项分布的随机变量序列](https://zh.wikipedia.org/wiki/二项分布 "wikilink")。它指出，参数为*n*,
...
[林德伯格](https://zh.wikipedia.org/wiki/林德伯格 "wikilink")－[列维](https://zh.wikipedia.org/wiki/列维 "wikilink")（Lindeberg-Levy）定理，是棣莫佛－拉普拉斯定理的扩展，讨论独立同分布随机变量序列的中央极限定理。它表明，独立同分布(iid
...
且具有有限的[数学期望和](https://zh.wikipedia.org/wiki/数学期望 "wikilink")[方差](../Page/方差.md "wikilink")\(E(X_i) = \mu\)，\(D(X_i) = \sigma^2 \neq 0  (i=1,2,\cdots,n)\)。记

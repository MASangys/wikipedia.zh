**中文-{}-化**包含了**[国际化与本地化](../Page/国际化与本地化.md "wikilink")**的概念，指将使用非-{zh:[中文](https://zh.wikipedia.org/wiki/中文 "wikilink");zh-tw:[中文](https://zh.wikipedia.org/wiki/中文 "wikilink");zh-cn:[汉语](../Page/汉语.md "wikilink");}-[语言作为系統界面或](https://zh.wikipedia.org/wiki/语言 "wikilink")-{zh:原始語音;zh-tw:原始語音;zh-cn:原生音频;}-的[计算机软件](https://zh.wikipedia.org/wiki/计算机软件 "wikilink")、[电子游戏](../Page/电子游戏.md "wikilink")（包括[电脑游戏](../Page/电脑游戏.md "wikilink")）、-{zh:影片;zh-tw:影片;zh-cn:视频影像;}-、-{zh:圖片;zh-tw:圖片;zh-cn:平面图像;}-等等，在不改变原本意思的前提下，翻譯並修改成为使用-{zh:[中文](https://zh.wikipedia.org/wiki/中文 "wikilink");zh-tw:[中文](https://zh.wikipedia.org/wiki/中文 "wikilink");zh-cn:[汉语](../Page/汉语.md "wikilink");}-界面或配以字幕的过程。此过程在[中国大陆和](../Page/中国大陆.md "wikilink")[港澳地区常被称为](https://zh.wikipedia.org/wiki/港澳 "wikilink")**汉-{}-化**，而[台湾以及部分中国大陆从事软件文字本地化](https://zh.wikipedia.org/wiki/台湾 "wikilink")（localize）的人士则通常称其为**中-{}-文化**。
...
1.  [源代码中文化](../Page/源代码.md "wikilink")：从软件的源代码起，将其中涉及的[用户界面的部分全部修改为](../Page/用户界面.md "wikilink")[中文](https://zh.wikipedia.org/wiki/中文 "wikilink")，然后将其重新编译为中文软件。这种方式是[开放源代码社区中中文化最常见的方式](../Page/开放源代码.md "wikilink")，另外，部分国外的商业软件公司也通过这种方式来与中国国内的子公司或者代理商合作汉化软件产品。
2.  [资源文件中文化](https://zh.wikipedia.org/wiki/资源文件 "wikilink")：-{zh:現在;zh-tw:現在;zh-cn:当今;}-软件开发的国际化需求越來越受重視，因而發展出以「資源檔案」（resource
    file）來解決不同語言間切換問題的方式。這種方式的運作原理為将所有与语言文字相关的資料抽取出來，存放在額外的文字檔中，和程式原始碼徹底區分開來。每種語言版本都有其專屬的語言檔案，稱為「[語系檔](https://zh.wikipedia.org/wiki/語系檔 "wikilink")」或「[語言套件](https://zh.wikipedia.org/wiki/語言套件 "wikilink")」。當需要切換語言時，只需要替換這個檔案即可。这种汉化方式為根据软件原有的资源文件制作新的中文版资源文件，被认为是汉化工作裡最简单、方便且不破壞、修改原軟體的方法，但必须在待汉化的软件本身就有這個設定的情況下才能使用。
3.  [二进制中文化](https://zh.wikipedia.org/wiki/二进制 "wikilink")：使用-{zh:特定;zh-tw:特定;zh-cn:专门;}-的[编辑软件將](https://zh.wikipedia.org/wiki/编辑软件 "wikilink")[可执行文件中的语言](https://zh.wikipedia.org/wiki/可执行文件 "wikilink")[字符串直接修改為](../Page/字符串.md "wikilink")-{zh:中文;zh-tw:中文;zh-cn:汉字;}-。在没有得到开发商授权的情况下，这是一种争议很大的汉化方式，因为通常[商业软件发行许可证是禁止这种修改行为的](https://zh.wikipedia.org/wiki/商业软件 "wikilink")。但是在很多情况下，也只有通过这种方式才能得到软件的中文版本。
4.  [实时内存中文化](../Page/实时.md "wikilink")：通过修改目标程序内存中数据，或者通过HOOK
    API，使用額外的文件（如-{zh:中文化檔案;zh-tw:中文化檔案;zh-cn:汉化包;}-或中文补丁等），或者经过即时翻译将程序[用户图形界面上的英文显示替换为显示中文](https://zh.wikipedia.org/wiki/用户图形界面 "wikilink")。这种方式不需要修改-{zh:硬碟;zh-tw:硬碟;zh-cn:磁盘;}-裡的文件，适合如[晴窗中文大侠](https://zh.wikipedia.org/wiki/晴窗中文大侠 "wikilink")、[点点通](https://zh.wikipedia.org/wiki/点点通 "wikilink")、[东方快车](https://zh.wikipedia.org/wiki/东方快车_\(软件\) "wikilink")、[金山快译等不便修改文件的](../Page/金山快译.md "wikilink")（面向[最终用户的](https://zh.wikipedia.org/wiki/最终用户 "wikilink")）软件。
...
### 软件汉化主要工具
  ...
  - [Resscope/Exescope](https://zh.wikipedia.org/wiki/Resscope/Exescope "wikilink"):辅助中文化工具，可以用来对PE信息工具的结果做进一步验证，和临时性的修改软件资源，不支持词典翻譯，如果使用这个作为中文化工具，需要汉化的软件推出新版本以后，需要投入较多不必要的重复劳动。
    ...
    [Visual
    Localize](https://zh.wikipedia.org/wiki/Visual_Localize "wikilink"):常用来中文化VC（[Visual
    Studio](https://zh.wikipedia.org/wiki/Visual_Studio "wikilink")）编译的程序，支持自动-{zh:字詞;zh-tw:字詞;zh-cn:词条;}-翻译，相同的内容只需要翻译一次。常用版本是5.21。
    [Multilizer](https://zh.wikipedia.org/wiki/Multilizer "wikilink"):可以中文化VC、[Delphi](../Page/Delphi.md "wikilink")、[Palm](../Page/Palm.md "wikilink")、[Java](../Page/Java.md "wikilink")、[Symbian等各式应用程序](https://zh.wikipedia.org/wiki/Symbian "wikilink")，对Delphi程序的兼容能力较Passolo/Alchemy
    Catalyst等本地化工具强，提供了未知组件映射等功能，对使用了-{zh:面板;zh-tw:面板;zh-cn:皮肤;}-控件[Skin
    componet的程序有不错效果](https://zh.wikipedia.org/wiki/Skin_componet "wikilink")。
    [Language
    Localizer](https://zh.wikipedia.org/wiki/Language_Localizer "wikilink"):早期用来中文化Delphi程序的的工具之一。
    [OmegaT](../Page/OmegaT.md "wikilink"):主要用来本地化自由软件的工具，支持多种源文件格式，例如[gettext](https://zh.wikipedia.org/wiki/gettext "wikilink")
    po。也用于-{zh:文章;zh-tw:文章;zh-cn:文段;}-翻译。

> 本文内容由[中線](https://zh.wikipedia.org/wiki/中線)转换而来。


[Median_rules.jpg](https://zh.wikipedia.org/wiki/File:Median_rules.jpg "fig:Median_rules.jpg") **中線**是[三角形](../Page/三角形.md "wikilink")中从某邊的中點連向對角的[頂點的线段](../Page/頂點_\(幾何\).md "wikilink")。三角形的三条中线总是相交于同一点，这个点称为三角形的[重心](https://zh.wikipedia.org/wiki/几何中心#三角形的中心 "wikilink")。
...
根据定义，\(AD=DB, AF=FC, BE=EC\)，因此\([ADO]=[BDO], [AFO]=[CFO], [BEO]=[CEO], [ABE]=[ACE]\)，其中\([ABC]\)表示三角形*ABC*的[面积](../Page/面积.md "wikilink")。

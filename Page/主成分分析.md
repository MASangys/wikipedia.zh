...
**基本思想：**
  ...
  - 将坐标轴中心移到数据的中心，然后旋转坐标轴，使得数据在C1轴上的上的方差最大，即全部n个数据个体在该方向上的投影最为分散。意味着更多的信息被保留下来。C1成为**第一主成分**。
...
16. {{ cite web | last = The Numerical Algorithms Group | first = | title = NAG Library Routine Document: nag_mv_prin_comp (g03aac) | date = | work = NAG Library Manual, Mark 9 | url = <http://www.nag.co.uk/numeric/CL/nagdoc_cl09/pdf/G03/g03aac.pdf> | accessdate = 2012-02-16 }}
> 本文内容由[乘数-加速原理](https://zh.wikipedia.org/wiki/乘数-加速原理)转换而来。


**加速原理**（）指政府购买增长使计划支出增加，由此使总收入增加。而总收入增加又提高消费，进而使计划支出增加又造成总收入增加。如此往复，最终使总收入以一定的倍数增加。
...
## 參考來源
  ...
  - [乘數-加速原理交互作用](https://web.archive.org/web/20150224113701/http://hsmaterial.moe.edu.tw/schema/econ/14_3_1_1_6.pps)
  ...
  - [乘数-加速原理](http://www.merriam-webster.com/dictionary/acceleration%20principle) - [韦氏词典](../Page/韦氏词典.md "wikilink")

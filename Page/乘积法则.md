**乘积法则**，也称**積定則**、**莱布尼兹法则**，是[数学中关于两个函数的](../Page/数学.md "wikilink")[积的](../Page/乘法.md "wikilink")[導數的一个计算法则](https://zh.wikipedia.org/wiki/導數 "wikilink")。
...
## 例子
  ...
  - 假设我们要求出*f*(*x*) = *x*<sup>2</sup>
    [sin](https://zh.wikipedia.org/wiki/sine "wikilink")(*x*)的导数。利用乘积法则，可得*f*'(*x*)
    = 2*x* sin(*x*) +

...
對應於[中文維基百科條目](https://zh.wikipedia.org/wiki/中文維基百科 "wikilink")《[字體](https://zh.wikipedia.org/wiki/字體 "wikilink")》\]\]
...
<!-- end list -->
  ...
  - 一种语言版本的[操作系统安装了另外一种语言版本的](../Page/操作系统.md "wikilink")[应用程序](../Page/应用程序.md "wikilink")，或者应用程序安装的[补丁的语言版本与应用程序原来安装的语言版本不一致](https://zh.wikipedia.org/wiki/修補程式 "wikilink")。
...
## 可能的解決方法
  ...
  - 轉換編碼。一般可試[Big5](https://zh.wikipedia.org/wiki/Big5 "wikilink")、[GBK](https://zh.wikipedia.org/wiki/GBK "wikilink")、[UTF-8](../Page/UTF-8.md "wikilink")（[Unicode的一種應用方式](https://zh.wikipedia.org/wiki/Unicode "wikilink")，包括世界上主要的文字）三種，如涉及的不是中文，可以再試[JIS](https://zh.wikipedia.org/wiki/JIS "wikilink")（[日文](https://zh.wikipedia.org/wiki/日文 "wikilink")）、[KR](https://zh.wikipedia.org/wiki/KR "wikilink")（[韓文](https://zh.wikipedia.org/wiki/韓文 "wikilink")）及其他文字編碼。徹底的解決方法是雙方使用同一[編碼系統](https://zh.wikipedia.org/wiki/編碼系統 "wikilink")，如UTF-8，只要用戶有對應的字體檔案就可以正確的顯示文字。實際上要統一[編碼系統還要克服各種客觀的困難](https://zh.wikipedia.org/wiki/編碼系統 "wikilink")，現時只有靠軟件（如[Microsoft
  ...
  - 如果本來該顯示出漢字的，卻變成數字，如最欣賞相中拉（最欣賞相中拉）等Unicode代碼，可以把這部分抄出來，獨立存儲成[html檔](https://zh.wikipedia.org/wiki/html "wikilink")，

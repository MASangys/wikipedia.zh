...
在[電腦科學中](../Page/電腦科學.md "wikilink")，**二元樹**（）是每個節點最多只有兩個分支（即不存在分支度大於2的節點）的[樹結構](../Page/樹結構.md "wikilink")。通常分支被稱作“左子樹”或“右子樹”。二元樹的分支具有左右次序，不能随意顛倒。

二元樹的第\(i\)層至多擁有\(2^{i-1}\)個節點；深度為\(k\)的二元樹至多總共有\(2^\begin{align} k \end{align}-1\)個節點（定义根节点所在深度
\(k_0=0\)），而總計擁有節點數符合的，稱為「滿二元樹」；深度為\(k\)有\(n\)個節點的二元樹，當且僅當其中的每一節點，都可以和同樣深度\(k\)的滿二元樹，序號為1到\(n\)的節點一對一對應時，稱為[完全二元樹](../Page/完全二元樹.md "wikilink")。對任何一棵非空的二元樹\(T\)，如果其葉片（終端節點）數為\(n_0\)，分支度為2的節點數為\(n_2\)，則\(n_0 = n_2 + 1\)。

與普通樹不同，普通樹的節點個數至少為1，而二元樹的節點個數可以為0；普通樹節點的最大分支度沒有限制，而二元樹節點的最大分支度為2；普通樹的節點無左、右次序之分，而二元樹的節點有左、右次序之分。

二元樹通常作為資料結構應用，典型用法是對節點定義一個標記函數，將一些值與每個節點相關聯。這樣標記的二元樹就可以實現[二元搜尋樹和](../Page/二元搜尋樹.md "wikilink")[二元堆積](../Page/二元堆積.md "wikilink")，並應用於高效率的搜索和排序。

## [圖論中的定義](../Page/圖論.md "wikilink")

[二元樹是一個連通的無環圖](../Page/二元樹.md "wikilink")，並且每一個頂點的度不大於3。有根[二元樹還要滿足根節點的度不大於](../Page/二元樹.md "wikilink")2。有了根節點之後，每個頂點定義了唯一的父節點，和最多2個子節點。然而，沒有足夠的資訊來區分左節點和右節點。如果不考慮[連通性](../Page/連通性.md "wikilink")，允許圖中有多個[連通分量](../Page/連通分量.md "wikilink")，這樣的結構叫做[森林](../Page/森林.md "wikilink")。

## 二元樹(Binary Tree)的類型

[二元樹是一個有根](../Page/二元樹.md "wikilink")[樹](../Page/樹_\(資料結構\).md "wikilink")，並且每個節點最多有2個子節點。非空的[二叉樹](../Page/二叉樹.md "wikilink")，若樹葉總數為
...
一棵深度為k，且有\(2^\begin{align} k+1 \end{align}-1\)個節點的[二元樹](../Page/二元樹.md "wikilink")，稱為[滿二元樹](../Page/滿二元樹.md "wikilink")（Full
Binary
Tree）。這種樹的特點是每一層上的節點數都是最大節點數。而在一棵[二元樹中](../Page/二元樹.md "wikilink")，除最後一層外，若其餘層都是滿的，並且最後一層或者是滿的，或者是在右邊缺少連續若干節點，則此[二元樹為](../Page/二元樹.md "wikilink")[完全二元樹](../Page/完全二元樹.md "wikilink")（Complete
Binary
Tree）。具有n個節點的[完全二元樹的深度為](../Page/完全二元樹.md "wikilink")\(log_2n+1\)。深度為k的[完全二元樹](../Page/完全二元樹.md "wikilink")，至少有\(2^\begin{align} k-1 \end{align}\)個節點，至多有\(2^\begin{align} k \end{align}-1\)個節點。

[FullBT_CompleteBT.jpg](https://zh.wikipedia.org/wiki/File:FullBT_CompleteBT.jpg "fig:FullBT_CompleteBT.jpg")

|      | [完全二元樹](../Page/完全二元樹.md "wikilink") | [滿二元樹](../Page/滿二元樹.md "wikilink") |
| ---- | ------------------------------------ | ---------------------------------- |
| 總節點k | \(2^{h-1}\)\<= k \<= \(2^h-1\)       | k = \(2^h-1\)                      |
| 樹高h  | h = \(log_2k+1\)                     | h = \(log_2k+1\)                   |

## 存儲[二元樹的方法](../Page/二元樹.md "wikilink")

在[程式設計語言中能用多種方法來構造](../Page/程式設計語言.md "wikilink")[二元樹](../Page/二元樹.md "wikilink")。

### 順序存儲表示

[Binary_tree_in_array.svg](https://zh.wikipedia.org/wiki/File:Binary_tree_in_array.svg "fig:Binary_tree_in_array.svg")\]\]
二元樹可以用[陣列或](../Page/陣列.md "wikilink")[鏈結串列來存儲](../Page/链表.md "wikilink")，若是[滿二元樹就能緊湊排列而不浪費空間](../Page/滿二元樹.md "wikilink")。如果某個節點的索引為<var>i</var>，（假設根節點的索引為0）則在它左子節點的索引會是\(2i + 1\)，以及右子節點會是\(2i + 2\)；而它的父節點（如果有）索引則為*\(\left \lfloor \frac{i-1}{2} \right \rfloor\)*。這種方法更有利於緊湊存儲和更好的[訪問的局部性](../Page/訪問的局部性.md "wikilink")，特別是在[前序遍歷中](../Page/樹的遍歷#遍歷的種類.md "wikilink")。然而，它需要連續的[存儲空間](../Page/存儲空間.md "wikilink")，這樣在存儲高度為*h*的*n*個節點所組成的一般樹時，將浪費很多空間。在最糟糕的情況下，如果深度為h的二元樹其每個節點都只有右孩子，則該存儲結構需要佔用\(2^h-1\)的空間，實際上卻有h個節點，浪費了不少空間，是順序存儲結構的一大缺點。
{{-}}
...
在使用[記錄或](../Page/記錄.md "wikilink")[記憶體位址指標的程式設計語言中](../Page/指標_\(資訊學\).md "wikilink")，二叉樹通常用樹結點結構來存儲。有時也包含指向唯一的父節點的指標。如果一個結點的子結點個數小於2，一些子結點指針可能為空值，或者為特殊的[哨兵結點](../Page/哨兵.md "wikilink")。
...
最後，上面的中序遍歷，每個結點在訪問左子樹和右子樹之間訪問。這在遍歷[二叉搜尋樹時很常用](../Page/二叉搜尋樹.md "wikilink")，因為它能用遞增的順序來遍歷所有的值。
...
以上的[遞迴演算法使用與樹的高度成比例的棧空間](../Page/遞迴.md "wikilink")。如果我們在每個結點中存儲指向父結點的指標，那樣可以使用[反覆運算演算法](../Page/反覆運算.md "wikilink")，只使用常數空間實現所有這些遍歷。然而，指向父結點的指標佔用更多的空間。這只在需要指向父節點的指標或棧空間有限時才使用。例如，
這是一個中序遍歷的反覆運算演算法：
...
在深度優先順序中，我們希望從根結點訪問最遠的結點。和圖的[深度優先搜索不同的是](../Page/深度優先搜索.md "wikilink")，不需記住訪問過的每一個結點，因為樹中不會有環。前序，中序和後序遍歷都是深度優先遍歷的特例。參見[深度優先搜索](../Page/深度優先搜索.md "wikilink")。

### 廣度優先遍歷

和深度優先遍歷不同，廣度優先遍歷會先訪問離根節點最近的節點。參見[廣度優先搜索](../Page/廣度優先搜索.md "wikilink")。

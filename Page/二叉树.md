> 本文内容由[二叉树](https://zh.wikipedia.org/wiki/二叉树)转换而来。
...
一棵深度為k，且有\(2^\begin{align} k+1 \end{align}-1\)個節點的[二元樹](https://zh.wikipedia.org/wiki/二元樹 "wikilink")，稱為[滿二元樹](https://zh.wikipedia.org/wiki/滿二元樹 "wikilink")（Full Binary Tree）。這種樹的特點是每一層上的節點數都是最大節點數。

### 完全二叉树

而在一棵[二元樹中](https://zh.wikipedia.org/wiki/二元樹 "wikilink")，除最後一層外，若其餘層都是滿的，並且最後一層或者是滿的，或者是在右邊缺少連續若干節點，則此[二元樹為](https://zh.wikipedia.org/wiki/二元樹 "wikilink")[完全二元樹](https://zh.wikipedia.org/wiki/完全二元樹 "wikilink")（Complete Binary Tree）。具有n個節點的[完全二元樹的深度為](https://zh.wikipedia.org/wiki/完全二元樹 "wikilink")\(log_2n+1\)。深度為k的[完全二元樹](https://zh.wikipedia.org/wiki/完全二元樹 "wikilink")，至少有\(2^\begin{align} k-1 \end{align}\)個節點，至多有\(2^\begin{align} k \end{align}-1\)個節點。

## 存儲

在[程式設計語言中能用多種方法來構造二元樹](https://zh.wikipedia.org/wiki/程式設計語言 "wikilink")。

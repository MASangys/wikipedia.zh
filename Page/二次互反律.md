在[数论中](../Page/数论.md "wikilink")，特别是在[同余理论里](https://zh.wikipedia.org/wiki/同余 "wikilink")，**二次互反律**（Law
of Quadratic
Reciprocity）是一个用于判别[二次剩余](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")，即二次[同余](https://zh.wikipedia.org/wiki/同余 "wikilink")[方程](../Page/方程.md "wikilink")\(x^2 \equiv p \pmod q\)之[整数解的存在性的定律](../Page/整数.md "wikilink")。二次互反律揭示了方程\(x^2 \equiv p \pmod q\)
可解和
\(x^2 \equiv q \pmod p\)可解的简单关系。运用二次互反律可以将模数较大的二次剩余判别问题转为模数较小的判别问题，并最后归结为较少的几个情况，从而在实际上解决了[二次剩余的判别问题](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")。然而，二次互反律只能提供二次剩余的存在性，对于二次同余方程的具体求解并没有实际帮助。
...
高斯之后[雅可比](../Page/卡爾·雅可比.md "wikilink")、[柯西](https://zh.wikipedia.org/wiki/柯西 "wikilink")、[刘维尔](../Page/约瑟夫·刘维尔.md "wikilink")、[克罗内克](https://zh.wikipedia.org/wiki/克罗内克 "wikilink")、[弗洛贝尼乌斯等也相继给出了新的证明](https://zh.wikipedia.org/wiki/费迪南德·格奥尔格·弗罗贝尼乌斯 "wikilink")。至今，二次互反律已有超过200个不同的的证明。二次互反律可以推广到更高次的情况，如[三次互反律等等](../Page/三次互反律.md "wikilink")。

## 相关术语

一个[整数](../Page/整数.md "wikilink") \(a\)
是[模整数](https://zh.wikipedia.org/wiki/二次剩余 "wikilink") \(n\)
的**[二次剩余](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")**，是指它与某个整数的[平方关于模](../Page/平方.md "wikilink")*n*
[同余](https://zh.wikipedia.org/wiki/同余 "wikilink")。直观来说，是指二次同余方程\(x^2 \equiv a \pmod n\)有整数解。如果这样的整数解不存在，则称
\(a\) 是[模整数](https://zh.wikipedia.org/wiki/同余 "wikilink") \(n\)
...
第一个完整地给出二次互反律的证明的人是德国数学家[高斯](https://zh.wikipedia.org/wiki/高斯 "wikilink")。高斯在1796年给出了二次互反律的第一个证明\[14\]。高斯首先证明了\[15\]
...
> ，我们知道*a*是模*m* + 4*a*、*m* +
> 8*a*、……中所有质数的非剩余，如果这种质数存在的话。但此种质数的存在性直到数十年后才由[狄利克雷证明](https://zh.wikipedia.org/wiki/狄利克雷 "wikilink")。
...
来叙述。其中*a*、*b*是两个非零的[有理数](../Page/有理数.md "wikilink")，*v*则可代表任意非平凡的有理数绝对值（*p*的常用的或[p进的绝对值](https://zh.wikipedia.org/wiki/p进数 "wikilink")）。[希尔伯特符号](../Page/希尔伯特符号.md "wikilink")：\((a,b)_v\)
...
\((a,b)_v\)
的乘积为1（这与[复分析中的留数定理相似](https://zh.wikipedia.org/wiki/复分析 "wikilink")）。

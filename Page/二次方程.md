...
一元二次方程是指只含有一个未知数的二次方程，它的一般形式为：\(ax^2+bx+c=0\,\)，其中
...
若\(\Delta>0\,\)，則該方程有两個不相等的[實数根](https://zh.wikipedia.org/wiki/實数 "wikilink")：
\(x_{1,2} = \frac{-b \pm \sqrt{b^2-4ac}}{2a}\,\)；

若\(\Delta=0\,\)，則該方程有两個相等的實数根： \(x_{1,2} = -\frac{b}{2a}\,\)；

若\(\Delta<0\,\)，則該方程有一對[共軛複數根](https://zh.wikipedia.org/wiki/共軛複數 "wikilink")：
...
\end{align}\]
即为
\(y\,\)的[极值点](../Page/极值.md "wikilink")，该式亦为函数图形（即[抛物线](../Page/抛物线.md "wikilink")）的对称轴方程。
将 \(x=-\frac{b}{2a}\) 代入 \(y\,\)，可得
\[\begin{align}
y&=-\frac{b^2-4ac}{4a^2}
\end{align}\]
即为 \(y\,\) 的极值。

在[统计学中](../Page/统计学.md "wikilink")，**互相关**有时用来表示两个[随机矢量](https://zh.wikipedia.org/wiki/随机矢量 "wikilink")
*X* 和 *Y* 之间的[协方差cov](../Page/协方差.md "wikilink")（*X*, *Y*），以与矢量 *X*
的“协方差”概念相区分，矢量 *X* 的“协方差”是 *X*
的各标量成分之间的[协方差矩阵](../Page/协方差矩阵.md "wikilink")。

在[信号处理领域中](https://zh.wikipedia.org/wiki/信号处理 "wikilink")，**互相关**（有时也称为“[互协方差](../Page/互协方差.md "wikilink")”）是用来表示两个[信号之间相似性的一个度量](https://zh.wikipedia.org/wiki/信号 "wikilink")，通常通过与已知信号比较用于寻找未知信号中的特性。它是两个信号之间相对于[时间的一个函数](../Page/时间.md "wikilink")，有时也称为“滑动[点积](../Page/点积.md "wikilink")”，在[模式识别以及](../Page/模式识别.md "wikilink")[密码分析学领域都有应用](https://zh.wikipedia.org/wiki/密码分析学 "wikilink")。
...
*j* 区域取和，星号表示[复共轭](https://zh.wikipedia.org/wiki/复共轭 "wikilink")。对于连续信号
*f*(*x*) 和 *g*(*x*) 来说，互相关定义为

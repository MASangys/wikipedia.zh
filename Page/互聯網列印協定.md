...
[Win2K3-InternetPrintingService.PNG](https://zh.wikipedia.org/wiki/File:Win2K3-InternetPrintingService.PNG "fig:Win2K3-InternetPrintingService.PNG")上的IPP服務已比過往安全得多。\]\] [Win2K3-InternetPrintingWebScreen.png](https://zh.wikipedia.org/wiki/File:Win2K3-InternetPrintingWebScreen.png "fig:Win2K3-InternetPrintingWebScreen.png") 與其他基於互聯網的協定一樣，IPP可以用於內聯網及互聯網等基於[IP協定的網路上](https://zh.wikipedia.org/wiki/IP協定 "wikilink")。不過，與一般IP協定不同的是：IPP亦同時支援[安全連結](https://zh.wikipedia.org/wiki/安全連結 "wikilink")。所以，用戶可以透過網絡進行[存取控制](https://zh.wikipedia.org/wiki/存取控制 "wikilink")、[認證及](https://zh.wikipedia.org/wiki/認證 "wikilink")[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")，使列印過程更安全。

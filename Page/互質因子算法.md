...
\[2\]，是一種[快速傅立葉變換](../Page/快速傅立葉變換.md "wikilink")（FFT），把*N* =
*N*<sub>1</sub>*N*<sub>2</sub>大小的[離散傅立葉變換重新表示為](../Page/離散傅立葉變換.md "wikilink")*N*<sub>1</sub>
\*
*N*<sub>2</sub>大小的[二維離散傅立葉變換](../Page/离散傅里叶变换.md "wikilink")，其中*N*<sub>1</sub>與*N*<sub>2</sub>需[互質](../Page/互質.md "wikilink")。變成*N*<sub>1</sub>和*N*<sub>2</sub>大小的傅立葉變換後，可以繼續遞迴使用PFA，或用其他[快速傅立葉變換算法來計算](../Page/快速傅立葉變換.md "wikilink")。

較流行的[Cooley-Tukey算法經由mixed](../Page/库利－图基快速傅里叶变换算法.md "wikilink")-radix一般化後，也是把*N*
=
*N*<sub>1</sub>*N*<sub>2</sub>大小的[離散傅立葉變換分割為](../Page/離散傅立葉變換.md "wikilink")*N*<sub>1</sub>和*N*<sub>2</sub>大小的轉換，但和互質因子算法
(PFA)作法並不相同，不應混淆。[Cooley-Tukey算法的](../Page/库利－图基快速傅里叶变换算法.md "wikilink")*N*<sub>1</sub>與*N*<sub>2</sub>不需[互質](../Page/互質.md "wikilink")，可以是任何整數。然而有個缺點是比PFA多出一些乘法，和[單位根](../Page/單位根.md "wikilink")[twiddle
factors相乘](../Page/:en:Twiddle_factor.md "wikilink")。相對的，PFA的缺點則是*N*<sub>1</sub>與*N*<sub>2</sub>需[互質](../Page/互質.md "wikilink")
(例如*N*
...
分解為[互質的](../Page/互質.md "wikilink")[因數](../Page/因數.md "wikilink")，後者則用在重複[質因數上](../Page/質因子.md "wikilink")。
...
[離散傅立葉變換](../Page/離散傅立葉變換.md "wikilink")（DFT）的定義如下:
...
[映射](../Page/映射.md "wikilink") (或*Good's* 映射)，
...
則內部和外部的[總和分別轉換成大小為](../Page/總和.md "wikilink")*N*<sub>2</sub>與*N*<sub>1</sub>的DFT。
...
其中2點DFT的部份因構造單純，皆以交錯的[蝴蝶圖來顯示](../Page/:en:Butterfly_diagram.md "wikilink")。

可以看出即使在這個簡單的例子中，輸入和輸出的index也都經過有點複雜的重新排列。

## 與Cooley-Tukey算法的比較

如首段所述，[Cooley-Tukey算法和互質因子算法](../Page/:en:Cooley-Tukey_FFT_algorithm.md "wikilink")
(PFA)曾被誤認為很類似。兩者皆有各自優點可適用於不同狀況，因此分辨它們的不同是很重要的。在1965年著名的論文中發表的[Cooley-Tukey算法](../Page/Cooley-Tukey算法.md "wikilink")，是在DFT的定義
...
factors](../Page/:en:Twiddle_factor.md "wikilink")
)，但index較為簡單，且適用於任何*N*<sub>1</sub>、*N*<sub>2</sub>。在J.
Cooley稍後發表的關於FFT歷史探討的論文\[4\]中使用*N* = 24點FFT為例，顯示兩種作法在index結構上的不同。

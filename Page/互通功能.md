> 本文内容由[互通功能](https://zh.wikipedia.org/wiki/互通功能)转换而来。


**互通功能**（**Inter-working Function**、簡稱：**IWF**），全名為**以太网多业务互通**（Ethernet multi-service interworking）。是指在[公共交换电话网](../Page/公共交换电话网.md "wikilink")中，通过MPLS PW链接不同介质AC（Attachment Circuit）链路（二层）的功能。例如，用MPLS PW链接ATM AC和Ethernet AC。

在[同調代數中](../Page/同調代數.md "wikilink")，**五引理**是關於[交換圖的一個重要](https://zh.wikipedia.org/wiki/交換圖 "wikilink")[引理](https://zh.wikipedia.org/wiki/引理 "wikilink")。五引理可以被視為兩個相對偶的**四引理**之組合。此結果不只對[阿貝爾範疇成立](../Page/阿貝爾範疇.md "wikilink")，也對[群範疇成立](../Page/群.md "wikilink")。

## 陳述

在任一[阿貝爾範疇](../Page/阿貝爾範疇.md "wikilink")（例如[阿貝爾群或](https://zh.wikipedia.org/wiki/阿貝爾群 "wikilink")[模的範疇](../Page/模.md "wikilink")）或[群範疇中](../Page/群.md "wikilink")，考慮以下的交換圖：
...
為進行圖追蹤，以下假設所論範疇為某個[環上的](https://zh.wikipedia.org/wiki/環 "wikilink")[模範疇](../Page/模.md "wikilink")，因此可以談論對象的元素，並將態射視為模的同態。此時單射、滿射等等性質相應於集合論意義上的性質。根據[Mitchell嵌入定理](https://zh.wikipedia.org/wiki/Mitchell嵌入定理 "wikilink")，可導出一般範疇上的情形。

...
其中，*a*、*b*、*c*、*d*、*e*和*f*为[复数域内的数](https://zh.wikipedia.org/wiki/复数域 "wikilink")，且*a*不为零。例如：
...
後來，和[尼爾斯·阿貝爾證明了一般的五次方程](https://zh.wikipedia.org/wiki/尼爾斯·亨利克·阿貝爾 "wikilink")，不存在統一的根式解（即由方程的係數通過有限次的四則運算及根號組合而成的公式解）\[1\]。認為一般的五次方程沒有公式解存在的看法其实是不正確的。事實上，利用一些[超越函數](../Page/超越函數.md "wikilink")，如[Θ函数或](https://zh.wikipedia.org/wiki/Θ函数 "wikilink")[戴德金η函數即可構造出五次方程的公式解](../Page/戴德金η函數.md "wikilink")。另外，若只需求得數值解，可以利用數值方法（如[牛頓法](https://zh.wikipedia.org/wiki/牛頓法 "wikilink")）得到相當理想的解答。
...
\[X^5+UX+V= 0\,\]
的解有兩個[自變數](https://zh.wikipedia.org/wiki/自變數 "wikilink")
\(U\,\), 和 \(V\,\)。

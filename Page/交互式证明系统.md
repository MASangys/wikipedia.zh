...
**QIP**是将**IP**的**[BPP](https://zh.wikipedia.org/wiki/BPP "wikilink")**检验者换成一个**[BQP](https://zh.wikipedia.org/wiki/BQP "wikilink")**检验者所产生的变体，说更明白些，**BQP**是可以用[量子计算机在多项式时间内解决的问题类别](../Page/量子计算机.md "wikilink")。并且，这一些讯息是用[量子位所表示的](https://zh.wikipedia.org/wiki/量子位 "wikilink")。\[2\]在2009年,
Jain, Ji,

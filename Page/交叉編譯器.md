**交叉编译器**（）是指一个在某个[系统平台下可以产生另一个](../Page/系统平台.md "wikilink")[系统平台的](../Page/系统平台.md "wikilink")-{zh-hans:[可执行文件](https://zh.wikipedia.org/wiki/可执行文件 "wikilink");zh-hant:[執行檔](https://zh.wikipedia.org/wiki/執行檔 "wikilink")}-的[编译器](https://zh.wikipedia.org/wiki/编译器 "wikilink")。交叉编译器在目标[系统平台](../Page/系统平台.md "wikilink")（开发出来的应用程-{zh-hans:序;zh-tw:式}-序所-{zh-hans:运行;zh-tw:執行}-的平台）难以或不容易[编译时非常有用](https://zh.wikipedia.org/wiki/编译 "wikilink")。
...
交叉编译器和[源代码至源代码编译器不同](https://zh.wikipedia.org/wiki/源到源编译器 "wikilink")，交叉编译器用于二进制代码的跨平台软件开发，而源到源编译器是将某种[编程语言的程序](../Page/编程语言.md "wikilink")[源代码作为输入](../Page/源代码.md "wikilink")，生成以另一种编程语言构成的等效源代码的[编译器](https://zh.wikipedia.org/wiki/编译器 "wikilink")，但两者都是[编程工具](https://zh.wikipedia.org/wiki/软件开发工具 "wikilink")。

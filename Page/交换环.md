...
交换环的内部结构通过考虑它的理想来确定，即在与环中任何元素相乘以及加法下封闭的[非空](https://zh.wikipedia.org/wiki/非空 "wikilink")[子集](../Page/子集.md "wikilink") *I*：对所有 *r* 属于 *R*，*i* 与 *j* 属于 *I*，*ri* 与 *i*+*j* 都要求属于 *I*。给定 *R* 的任何子集 *F* = {*f*<sub>*j*</sub>}<sub>*j* ∈ *J*</sub>（这里 *J* 是某个指标集），由 *F* 生成的理想是最小的包含 *F* 的理想。等价地，它有有限[线性组合给出](https://zh.wikipedia.org/wiki/线性组合 "wikilink")

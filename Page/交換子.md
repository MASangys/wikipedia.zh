在[抽象代数中](../Page/抽象代数.md "wikilink")，一个群的**交換子**（commutator）或**换位子**是一个[二元運算子](https://zh.wikipedia.org/wiki/二元運算子 "wikilink")。设*g*及*h*
是 群*G*中的元素，他們的**交換子**是*g*<sup>−1</sup> *h*<sup>−1</sup> *gh*，常記為\[ *g*,
*h* \]。只有当*g*和*h*符合交换律（即gh =
hg）时他们的交换子才是这个[群的](../Page/群.md "wikilink")[单位元](https://zh.wikipedia.org/wiki/单位元 "wikilink")。
...
於1927年，[赫尔曼·外尔](https://zh.wikipedia.org/wiki/赫尔曼·外尔 "wikilink")（Hermann
Weyl）指出了量子算符與[相空間中古典分布之間的對應關係並不成立](../Page/相空間.md "wikilink")。不過他倒是提出了一個機制，稱作[魏爾量子化](https://zh.wikipedia.org/wiki/魏爾量子化 "wikilink")（Weyl
quantization），為了一種稱作[形變量子化](https://zh.wikipedia.org/wiki/形變量子化 "wikilink")（deformation

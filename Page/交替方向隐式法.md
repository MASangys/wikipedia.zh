[数值分析中](https://zh.wikipedia.org/wiki/数值分析 "wikilink")，**交替方向隐式法**（Alternating
direction implicit
method）是[有限差分法的一种](../Page/有限差分法.md "wikilink")，用于求解[抛物线型偏微分方程或](https://zh.wikipedia.org/wiki/抛物线型偏微分方程 "wikilink")[椭圆型偏微分方程](https://zh.wikipedia.org/wiki/椭圆型偏微分方程 "wikilink")\[1\]。特别适用于求解二维及更高维度的[热传导方程与](https://zh.wikipedia.org/wiki/热传导方程 "wikilink")[扩散方程](../Page/扩散方程.md "wikilink")。

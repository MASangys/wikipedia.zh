在[抽象代数中](../Page/抽象代数.md "wikilink")，**交错代数**是乘法不满足[结合性](https://zh.wikipedia.org/wiki/结合性 "wikilink")，仅满足[交错性的](https://zh.wikipedia.org/wiki/交错性 "wikilink")[代数](https://zh.wikipedia.org/wiki/域上的代数 "wikilink")。也就是说，我们有：
...
\[[y,x,x] = 0.\]
两个恒等式在一起，便意味着结合子是完全[斜对称的](https://zh.wikipedia.org/wiki/斜对称 "wikilink")。也就是说：

\[[x_{\sigma(1)}, x_{\sigma(2)}, x_{\sigma(3)}] = \sgn(\sigma)[x_1,x_2,x_3]\]
对于任何[置换σ](https://zh.wikipedia.org/wiki/置换 "wikilink")。于是可以推出：

\[[x,y,x] = 0\]
对于所有的*x*和*y*。这等价于所谓的[柔性恒等式](https://zh.wikipedia.org/wiki/柔性恒等式 "wikilink")：
...
\[y = x^{-1}(xy).\]
这等于是说，对于所有这类的\(x\)和\(y\)，结合子\([x^{-1},x,y]\)都是零。如果\(x\)和\(y\)是可逆的，那么\(xy\)也是可逆的，其乘法逆为\((xy)^{-1} = y^{-1}x^{-1}\)。因此，所有可逆的元素所组成的集合在乘法运算下封闭，并形成了一个[穆方圈](https://zh.wikipedia.org/wiki/穆方圈 "wikilink")。在交错环或代数中，这个单位元素圈与结合环或代数中的[单位元素群是类似的](https://zh.wikipedia.org/wiki/单位元素群 "wikilink")。

## 应用

任何交错的[除环上的](https://zh.wikipedia.org/wiki/除环 "wikilink")[射影平面都是](../Page/射影平面.md "wikilink")[穆方平面](https://zh.wikipedia.org/wiki/穆方平面 "wikilink")。

## 参考文献

  -
[fr:Alternativité](https://zh.wikipedia.org/wiki/fr:Alternativité "wikilink")

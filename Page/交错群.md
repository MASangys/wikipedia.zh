...
群 *A*<sub>*n*</sub> 是[阿贝尔的](../Page/阿贝尔群.md "wikilink")[当且仅当](../Page/当且仅当.md "wikilink") *n* ≤ 3，[单当且仅当](../Page/单群.md "wikilink") *n* = 3 或 *n* ≥ 5。注意 A<sub>3</sub> 事实上是 3 阶单群。A<sub>1</sub> 与 A<sub>2</sub> 是 1 阶群，一般不称为单的，而 A<sub>4</sub> 有一个平凡正规子群从而不单。A<sub>5</sub> 是最小非阿贝尔单群，阶数为 60，也是最小不[可解群](../Page/可解群.md "wikilink")。

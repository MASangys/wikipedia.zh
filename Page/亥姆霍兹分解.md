在[物理学](../Page/物理学.md "wikilink")和[数学](../Page/数学.md "wikilink")中的[向量分析](../Page/向量分析.md "wikilink")中，**亥姆霍兹定理**，\[1\]\[2\] 或称**向量分析基本定理**，\[3\]\[4\]\[5\]\[6\]\[7\]\[8\]\[9\] 指出对于任意足够[光滑](../Page/光滑函数.md "wikilink")、快速衰减的三维[向量场可分解为一个](https://zh.wikipedia.org/wiki/向量场 "wikilink")[无旋向量场和一个](https://zh.wikipedia.org/wiki/无旋向量场 "wikilink")[螺线向量场的和](https://zh.wikipedia.org/wiki/螺线向量场 "wikilink")，这个过程被称作**亥姆霍兹分解**。此定理以物理學家[赫爾曼·馮·亥姆霍茲為名](https://zh.wikipedia.org/wiki/赫爾曼·馮·亥姆霍茲 "wikilink")。<ref>参见：
  ...
  - However, Helmholtz was largely anticipated by George Stokes in his paper: G. G. Stokes (presented: 1849 ; published: 1856) ["On the dynamical theory of diffraction,"](http://books.google.com/books?id=L_NYAAAAYAAJ&pg=PA1#v=onepage&q&f=false) *Transactions of the Cambridge Philosophical Society*, vol. 9, part I, pages 1-62; see pages 9-10.</ref>

这意味着任何矢量场 ，都可以视为两个势场（[純量勢](https://zh.wikipedia.org/wiki/純量勢 "wikilink")  和[向量勢](../Page/向量勢.md "wikilink") ）之和。

## 定理內容

假定  為定義在有界區域  裡的二次連續可微向量場，且  為  的包圍面，則  可被分解成無[旋度](../Page/旋度.md "wikilink")及無[散度](../Page/散度.md "wikilink")兩部份：\[10\]
...
如果  **R**<sup>3</sup>}}，且  在無窮遠處消失的比 \(1/r\) 快，則純量勢及向量勢的第二項為零，也就是說 \[11\]
...
（疑似有错误） 將**F**改寫成[傅利葉轉換的形式](https://zh.wikipedia.org/wiki/傅利葉轉換 "wikilink")：
...
\vec{\mathbf{G}}_\mathbf{A}(\vec{\omega}) = i\, \vec{\omega} \times \left( \vec{\mathbf{G}}(\vec{\omega}) + i G_\Phi(\vec{\omega}) \, \vec{\omega} \right)  \\
 && \\
\Phi(\vec{r}) = \displaystyle \iiint G_\Phi(\vec{\omega}) e^{\displaystyle i \, \vec{\omega} \cdot \vec{r}} d\vec{\omega} & & \vec{\mathbf{A}}(\vec{r}) = \displaystyle \iiint  \vec{\mathbf{G}}_\mathbf{A}(\vec{\omega}) e^{\displaystyle i \, \vec{\omega} \cdot \vec{r}} d\vec{\omega} \end{array}\] 所以
...
### 一般参考文献
  ...
  - [George B. Arfken](https://zh.wikipedia.org/wiki/George_B._Arfken "wikilink") and Hans J. Weber, Mathematical Methods for Physicists, 4th edition, Academic Press: San Diego (1995) pp. 92–93
...
## 外部链接
  ...
  - [Helmholtz theorem](http://mathworld.wolfram.com/HelmholtzsTheorem.html)（[MathWorld](../Page/MathWorld.md "wikilink")）

[Category:向量分析](https://zh.wikipedia.org/wiki/Category:向量分析 "wikilink")

1.  On Helmholtz's Theorem in Finite Regions. By [Jean Bladel](https://zh.wikipedia.org/wiki/Jean_Bladel "wikilink"). Midwestern Universities Research Association, 1958.
2.  Hermann von Helmholtz. Clarendon Press, 1906. By [Leo Koenigsberger](https://zh.wikipedia.org/wiki/Leo_Koenigsberger "wikilink"). p357
3.  An Elementary Course in the Integral Calculus. By [Daniel Alexander Murray](https://zh.wikipedia.org/wiki/Daniel_Alexander_Murray "wikilink"). American Book Company, 1898. p8.
4.  [J. W. Gibbs](https://zh.wikipedia.org/wiki/约西亚·吉布斯 "wikilink") & [Edwin Bidwell Wilson](https://zh.wikipedia.org/wiki/Edwin_Bidwell_Wilson "wikilink") (1901) [Vector Analysis](https://archive.org/stream/117714283#page/236/mode/2up), page 237, link from [Internet Archive](../Page/互联网档案馆.md "wikilink")
5.  Electromagnetic theory, Volume 1. By [Oliver Heaviside](../Page/奧利弗·黑維塞.md "wikilink"). "The Electrician" printing and publishing company, limited, 1893.
6.  Elements of the differential calculus. By [Wesley Stoker Barker Woolhouse](https://zh.wikipedia.org/wiki/Wesley_Stoker_Barker_Woolhouse "wikilink"). Weale, 1854.
7.  An Elementary Treatise on the Integral Calculus: Founded on the Method of Rates Or Fluxions. By [William Woolsey Johnson](https://zh.wikipedia.org/wiki/William_Woolsey_Johnson "wikilink"). John Wiley & Sons, 1881.
    参见：[流数法](../Page/流数法.md "wikilink")。
8.  Vector Calculus: With Applications to Physics. By [James Byrnie Shaw](https://zh.wikipedia.org/wiki/James_Byrnie_Shaw "wikilink"). D. Van Nostrand, 1922. p205.
    参见：[格林公式](../Page/格林公式.md "wikilink")。
9.  A Treatise on the Integral Calculus, Volume 2. By [Joseph Edwards](https://zh.wikipedia.org/wiki/Joseph_Edwards_\(Mathematician\) "wikilink"). Chelsea Publishing Company, 1922.
10.
11. David J. Griffiths, *Introduction to Electrodynamics*, Prentice-Hall, 1999, p. 556.
...
\[\frac{d^2{T}}{d{t}^2} + \omega^2T  =  \left( { d^2 \over dt^2 } + \omega^2 \right) T  =  0,\] 其中 *k* 是分离常数[波數](../Page/波數.md "wikilink")，*ω* 是角频率。注意到现在有了空间变量\(\boldsymbol{x}\)的亥姆霍兹方程和一个二阶时间[常微分方程](../Page/常微分方程.md "wikilink")。时间解是一个[正弦](../Page/正弦.md "wikilink")和[余弦函数的](https://zh.wikipedia.org/wiki/余弦 "wikilink")[线性组合](https://zh.wikipedia.org/wiki/线性组合 "wikilink")，而空间解的形式依赖于具体问题的[边界条件](https://zh.wikipedia.org/wiki/边界条件 "wikilink")。经常可以使用[拉普拉斯变换或者](https://zh.wikipedia.org/wiki/拉普拉斯变换 "wikilink")[傅立叶变换这样的](https://zh.wikipedia.org/wiki/傅立叶变换 "wikilink")[积分变换](../Page/积分变换.md "wikilink")将双曲的偏微分方程转化为亥姆霍兹方程的形式。

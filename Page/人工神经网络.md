...
在神经网络的现代软件实现中，被生物学启发的那种方法已经很大程度上被抛弃了，取而代之的是基于[统计学](../Page/统计学.md "wikilink")和[信号处理的更加实用的方法](https://zh.wikipedia.org/wiki/信号处理 "wikilink")。在一些软件系统中，神经网络或者神经网络的一部分（例如人工神经元）是大型系统中的一个部分。这些系统结合了适应性的和非适应性的元素。虽然这种系统使用的这种更加普遍的方法更适宜解决现实中的问题，但是这和传统的连接主义人工智能已经没有什么关联了。不过它们还有一些共同点：非线性、分布式、并行化，局部性计算以及适应性。从历史的角度讲，神经网络模型的应用标志着二十世纪八十年代后期从高度符号化的人工智能（以用条件规则表达知识的[专家系统](../Page/专家系统.md "wikilink")为代表）向低符号化的机器学习（以用动力系统的参数表达知识为代表）的转变。
...
在2009到2012年之间，Jürgen Schmidhuber在Swiss AI Lab IDSIA的研究小组研发的[递归神经网络](../Page/递归神经网络.md "wikilink")和深前馈神经网络赢得了8项关于模式识别和机器学习的国际比赛。\[8\]\[9\]例如，Alex Graves et al.的双向、多维的LSTM赢得了2009年ICDAR的3项关于连笔字识别的比赛，而且之前并不知道关于将要学习的3种语言的信息。\[10\]\[11\]\[12\]\[13\]
...
1.依學習策略（Algorithm）分類主要有：
  ...
  - [-{zh-hans:监督式学习网络;zh-hant:監督式學習網路}-](https://zh.wikipedia.org/wiki/監督式學習網路 "wikilink")（Supervised Learning Network）為主
  - [-{zh-hans:无监督式学习网络;zh-hant:無監督式學習網路}-](../Page/無監督式學習網路.md "wikilink")（Unsupervised Learning Network）
  - [-{zh-hans:混合式学习网络;zh-hant:混合式學習網路}-](https://zh.wikipedia.org/wiki/混合式學習網路 "wikilink")（Hybrid Learning Network）
  - [-{zh-hans:联想式学习网络;zh-hant:聯想式學習網路}-](https://zh.wikipedia.org/wiki/聯想式學習網路 "wikilink")（Associate Learning Network）
  - [-{zh-hans:最适化学习网络;zh-hant:最適化學習網路}-](https://zh.wikipedia.org/wiki/最適化學習網路 "wikilink")（Optimization Application Network）

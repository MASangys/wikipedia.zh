...
## 应用
  ...
  - 人脸检测可用于生物特征识别，通常做为[人脸识别](../Page/人脸识别.md "wikilink")系统的一部分。人脸检测也可以用于[视频监听](https://zh.wikipedia.org/wiki/视频监听 "wikilink")、[人机交互](../Page/人机交互.md "wikilink")和图像数据库管理。一些最新的[数码相机](../Page/数码相机.md "wikilink")使用人脸检测来[自动对焦](../Page/自动对焦.md "wikilink")。人脸检测也可以在使用了pan-and-scale

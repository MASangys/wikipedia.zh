...
[達爾文認為不同物種都有相似的地方](../Page/查尔斯·达尔文.md "wikilink")。Ekman等人走進一群與世隔絕的原始部落。\[1\]他們發現雖然原始部落的原住民沒接觸過外面的文明世界，但是仍然呈然類似的表情。例如詢問當地的人在這個情況"Your child has died and you are sad"，他們都會與文明社會的人有一樣的傷心表情。[缩略图](https://zh.wikipedia.org/wiki/File:Fusiform_face_area_face_recognition.jpg "fig:缩略图")
...
1.   New York : Routledge, 2017. {{\!}} “First edition published by Routledge 2006”.|isbn=9781315276229|pages=272–298|first=Paula M.|last=Niedenthal|first2=François|last2=Ric}}
2.
3.
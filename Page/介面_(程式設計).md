...
[Liskov代換原則](https://zh.wikipedia.org/wiki/Liskov代換原則 "wikilink")）。
...
尽管介面的定义没有强制的标准，但是一些标准的[COM介面的应用十分广泛](https://zh.wikipedia.org/wiki/COM "wikilink")，例如[IUnknown和IDispatch](https://zh.wikipedia.org/wiki/IUnknown "wikilink")。
...
science)](https://zh.wikipedia.org/wiki/en:Interface_\(computer_science\) "wikilink")
[lt:Interfeisas
(programavimas)](https://zh.wikipedia.org/wiki/lt:Interfeisas_\(programavimas\) "wikilink")
[pl:Interfejs
klasy](https://zh.wikipedia.org/wiki/pl:Interfejs_klasy "wikilink")

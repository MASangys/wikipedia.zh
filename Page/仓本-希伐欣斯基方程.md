[Kuramoto-Sivashinsky_pde_Maple_3d_plot.png](https://zh.wikipedia.org/wiki/File:Kuramoto-Sivashinsky_pde_Maple_3d_plot.png "fig:Kuramoto-Sivashinsky_pde_Maple_3d_plot.png") [Kuramoto-Sivashinsky_pde_Maple_plot.png](https://zh.wikipedia.org/wiki/File:Kuramoto-Sivashinsky_pde_Maple_plot.png "fig:Kuramoto-Sivashinsky_pde_Maple_plot.png") [Kuramoto_Sivashinsky_pde_Maple_animation.gif](https://zh.wikipedia.org/wiki/File:Kuramoto_Sivashinsky_pde_Maple_animation.gif "fig:Kuramoto_Sivashinsky_pde_Maple_animation.gif") **Kuramoto-Sivashinsky 方程**是一个非线性常微分方程\[1\]：
...
[Kuramoto-Sivashinsky_equation_Adomian_solution_sin_plot.gif](https://zh.wikipedia.org/wiki/File:Kuramoto-Sivashinsky_equation_Adomian_solution_sin_plot.gif "fig:Kuramoto-Sivashinsky_equation_Adomian_solution_sin_plot.gif") 利用[阿多米安分解法](../Page/阿多米安分解法.md "wikilink")可求得Kuramoto-Sivashinsky 方程的[柯西问题](../Page/柯西问题.md "wikilink")近似解\[2\]。
...
1.  Graham W. Griffiths William E.Shiesser Traveling Wave Analysis of Partial Differential Equations p185-196 Academy Press

**代数簇**，亦作**代數多樣體**，是[代数几何学上](https://zh.wikipedia.org/wiki/代数几何学 "wikilink")[多项式集合的公共零点解的集合](https://zh.wikipedia.org/wiki/多项式 "wikilink")。代数簇是经典（某种程度上也是现代）[代数几何的中心研究对象](../Page/代数几何.md "wikilink")。

術語**簇**（variety）取自[拉丁语族中詞源](https://zh.wikipedia.org/wiki/拉丁语族 "wikilink")（cognate
of word）的概念，有基於“同源”而“變形”之意。

历史上，[代数基本定理建立了代数和几何之间的一个联系](../Page/代数基本定理.md "wikilink")，它表明在[复数域上的单变量的](https://zh.wikipedia.org/wiki/复数 "wikilink")[多项式由它的根的集合决定](https://zh.wikipedia.org/wiki/多项式 "wikilink")，而根集合是内在的几何对象。在此基础上，[希尔伯特零点定理提供了](../Page/希尔伯特零点定理.md "wikilink")[多项式环的理想和仿射空间子集的基本对应](https://zh.wikipedia.org/wiki/多项式 "wikilink")。利用零点定理和相关结果，我们能够用代数术语捕捉簇的几何概念，也能够用几何来承载[环论中的问题](../Page/环论.md "wikilink")。
...
令 *k*
為[代數封閉域並令](https://zh.wikipedia.org/wiki/代數封閉域 "wikilink")\(\mathbb{A}^n\)為
*k* 上的 *n* 維**仿射空間**。\(f \in k[X_1, \ldots, X_n]\)
藉著代值可以視之為\(\mathbb{A}^n\)上的\(k\)-值函數。對任何子集\(S \subset k[X_1, \ldots, X_n]\)，定義\(S\)的零點為\(\mathbb{A}^n\)裡使\(S\)中所有元素取零值的點：
...
令\(\mathbb{P}^n\)為 \(k\) 上的 n
維**射影空間**。雖然\(k[X_0, \ldots, X_n]\)中的[齊次多項式無法在](https://zh.wikipedia.org/wiki/齊次多項式 "wikilink")[齊次座標上取值](https://zh.wikipedia.org/wiki/齊次座標 "wikilink")（因为齐次坐标系实际上是一个等价类），其零點卻可明確地定義。對任意齊次多項式集合
\(S\)，定義其零點為
...
上述的簇被稱作*塞爾意義下的簇*，因為[讓-皮埃爾·塞爾的奠基之作](../Page/讓-皮埃爾·塞爾.md "wikilink")*Faisceaux
algébriques
cohérents*（代數[凝聚層](../Page/凝聚層.md "wikilink")）探討了這類簇。儘管現在已有更抽象的對象作輔助，它們仍然是代數幾何的踏腳石。

在**數學**上，一個[域](../Page/域_\(數學\).md "wikilink")\(F\)被稱作**代數閉域**，[若且唯若任何係數属于](https://zh.wikipedia.org/wiki/若且唯若 "wikilink")\(F\)且次數大於零的單變數[多項式在](../Page/多項式.md "wikilink")\(F\)裡至少有一個[根](https://zh.wikipedia.org/wiki/根_\(數學\) "wikilink")。
...
同理可證[有理數域非代數閉域](https://zh.wikipedia.org/wiki/有理數 "wikilink")。此外，[有限域也不是代數閉域](../Page/有限域.md "wikilink")，因為若\(a_1, \ldots, a_n\)列出\(F\)的所有元素，則下列多項式在\(F\)中沒有根：

\[(x-a_1)(x-a_2)\cdots(x-a_n)+1\,\]

反之，[複數域則是代數閉域](https://zh.wikipedia.org/wiki/複數 "wikilink")；這是[代數基本定理的內容](https://zh.wikipedia.org/wiki/代數基本定理 "wikilink")。另一個代數閉域之例子是[代數數域](../Page/代數數.md "wikilink")。
...
域*F*是代数闭域，当且仅当对于每一个自然数*n*，任何从*F<sup>n</sup>*到它本身的[线性映射都有某个](../Page/线性映射.md "wikilink")[特征向量](https://zh.wikipedia.org/wiki/特征向量 "wikilink")。

*F<sup>n</sup>*的[自同态具有特征向量](../Page/自同态.md "wikilink")，当且仅当它的[特征多项式具有某个根](https://zh.wikipedia.org/wiki/特征多项式 "wikilink")。因此，如果*F*是代数闭域，每一个*F<sup>n</sup>*的自同态都有特征向量。另一方面，如果每一个*F<sup>n</sup>*的自同态都有特征向量，设*p*(*x*)为*F*\[*x*\]的一个元素。除以它的首项系数，我们便得到了另外一个多项式*q*(*x*)，它有根当且仅当*p*(*x*)有根。但如果*q*(*x*) = *x<sup>n</sup>* + *a*<sub>*n* − 1</sub>*x*<sup>*n* − 1</sup>+ ··· + *a*<sub>0</sub>，那么*q*(*x*)是以下[友矩阵的特征多项式](https://zh.wikipedia.org/wiki/友矩阵 "wikilink")：

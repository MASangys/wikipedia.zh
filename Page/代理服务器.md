...
6.  突破内容过滤机制限制，访问被过滤网站。如[防火長城對中國境內互聯網存取的限制可透過使用代理服务器瀏覽而突破](https://zh.wikipedia.org/wiki/防火長城 "wikilink")。但是每到国庆、两会等敏感时期，防火长城的封锁力度会大大加强，大多数代理服务器和代理软件都会无法连接。（如：[Tor](../Page/Tor.md "wikilink")、[自由门](../Page/自由门.md "wikilink")、[无界浏览等](../Page/无界浏览.md "wikilink")）
...
<!-- end list -->
  ...
  - RTSP代理
    主要用于[Realplayer访问Real](https://zh.wikipedia.org/wiki/Realplayer "wikilink")[流媒体服务器](../Page/流媒体.md "wikilink")，一般有缓存功能。端口一般为554。
...
1.  此处参见[防火长城和](../Page/防火长城.md "wikilink")[破网软件](https://zh.wikipedia.org/wiki/破网软件 "wikilink")

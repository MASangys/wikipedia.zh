...
zh-tw:頁碼;}-**是[字符编码的别名](../Page/字符编码.md "wikilink")，也稱**-{zh-cn:[内码表](https://zh.wikipedia.org/wiki/内码 "wikilink");
zh-tw:[代碼頁](https://zh.wikipedia.org/wiki/代碼 "wikilink");}-**，是特定语言的字符集的一张表。

## 历史

早期，代码页是[IBM称呼计算机的](../Page/IBM.md "wikilink")[BIOS所支持的](../Page/BIOS.md "wikilink")[字符集](https://zh.wikipedia.org/wiki/字符集 "wikilink")[编码](https://zh.wikipedia.org/wiki/编码 "wikilink")。当时通用的操作系统都是[命令行界面](../Page/命令行界面.md "wikilink")，这些操作系统直接使用BIOS提供的字符绘制功能来显示字符（或者是一组嵌入在显卡字符生成器中的字形）。这些BIOS代码页也被称为**OEM代码页**。[图形操作系统使用自己的字符呈现引擎](https://zh.wikipedia.org/wiki/图形界面 "wikilink")（rendering
engine），可以支持多个不同的字符集编码，这类代码页被称作**ANSI代码页**。

早期[IBM和](../Page/IBM.md "wikilink")[微软内部使用数字来标记不同的编码字符集](../Page/微软.md "wikilink")，不同的厂商对同一个字符集编码使用各自不同的名称。例如，[UTF-8在IBM称作代码页](../Page/UTF-8.md "wikilink")1208，在微软称作代码页65001，在[SAP称作代码页](https://zh.wikipedia.org/wiki/SAP "wikilink")4110。

1987年4月，IBM发布了[PC-DOS
3.3](../Page/DOS.md "wikilink")，正式开始使用16比特的无符号整数标识不同的代码页。这时的PC机使用[CGA显示系统的字符界面](https://zh.wikipedia.org/wiki/CGA "wikilink")，绘制不同语言的字符依靠BIOS硬件厂商（在当时就是指制定业界标准的IBM）提供的功能。如果想更换所支持的字符集，就必须换上支持该字符集的ROM芯片。微软作为DOS操作系统的软件厂商，并不拥有绘制这些字符集的知识产权。所以这些字符集的绘制实现，称作OEM代码页。最常见、最具代表性的OEM代码页是"IBM
PC或MS-DOS [代码页437](https://zh.wikipedia.org/wiki/代码页437 "wikilink")"。
...
3.1](https://zh.wikipedia.org/wiki/Windows_3.1 "wikilink")），操作系统具有了字符绘制的功能。微软在Windows操作系统没有转向UTF-16作为内码实现之前（也就是在[Windows
2000之前](../Page/Windows_2000.md "wikilink")），针对不同的使用地区与国家，定义了一系列的支持不同语言字符集的代码页，被称作"Windows（或ANSI）代码页"。代表性的是实现了ISO-8859-1的[代码页1252](https://zh.wikipedia.org/wiki/代码页1252 "wikilink")。

## OEM（IBM PC）代碼頁

  - [437](https://zh.wikipedia.org/wiki/代码页437 "wikilink")—最初的IBM
    PC代碼頁，实现了扩展ASCII字符集
  ...
  - [858](https://zh.wikipedia.org/wiki/代码页858 "wikilink")—带[欧元符号的](../Page/欧元.md "wikilink")「多語言」
  ...
  - [863](https://zh.wikipedia.org/wiki/代码页863 "wikilink")—[法语](../Page/法语.md "wikilink")[加拿大英语](../Page/加拿大.md "wikilink")
...
[代码页819实现了Latin](https://zh.wikipedia.org/wiki/代码页819 "wikilink")-1（ISO/IEC
8859-1），用于IBM AS/400小型机。
...
8859-1](https://zh.wikipedia.org/wiki/ISO_8859-1 "wikilink")。这是Windows代码页被称作ANSI的缘由。
...
## 其他代碼頁
  ...
  - [10000](https://zh.wikipedia.org/wiki/代码页10000 "wikilink")—Macintosh
    Roman encoding（followed by several other Mac character sets）
  - [10007](https://zh.wikipedia.org/wiki/代码页10007 "wikilink")—Macintosh
    Cyrillic encoding
  - [10029](https://zh.wikipedia.org/wiki/代码页10029 "wikilink")—Macintosh
    Central European encoding
  - [1200](https://zh.wikipedia.org/wiki/代码页1200 "wikilink")—UCS-2LE
    [Unicode](https://zh.wikipedia.org/wiki/Unicode "wikilink")
    [小端序](https://zh.wikipedia.org/wiki/字节序#小端序 "wikilink")
  - [1201](https://zh.wikipedia.org/wiki/代码页1201 "wikilink")—UCS-2BE
    [Unicode](https://zh.wikipedia.org/wiki/Unicode "wikilink")
    [大端序](https://zh.wikipedia.org/wiki/字节序#大端序 "wikilink")
  - [65000](https://zh.wikipedia.org/wiki/代码页65000 "wikilink")—[UTF-7](../Page/UTF-7.md "wikilink")
    [Unicode](https://zh.wikipedia.org/wiki/Unicode "wikilink")
  - [65001](https://zh.wikipedia.org/wiki/代码页65001 "wikilink")—[UTF-8](../Page/UTF-8.md "wikilink")
    [Unicode](https://zh.wikipedia.org/wiki/Unicode "wikilink")

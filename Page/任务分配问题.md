**任务分配问题**是在[加权](https://zh.wikipedia.org/wiki/加权 "wikilink")[二分图中寻找最大](../Page/二分图.md "wikilink")（或最小）加权[匹配的问题](https://zh.wikipedia.org/wiki/匹配 "wikilink")。
...
分配问题是[运输问题的特例](https://zh.wikipedia.org/wiki/运输问题 "wikilink")，[运输问题是](https://zh.wikipedia.org/wiki/运输问题 "wikilink")[最少成本流量问题的特例](https://zh.wikipedia.org/wiki/最少成本流量问题 "wikilink")，而它们都是[线性规划的特例](../Page/线性规划.md "wikilink")。因此，[单纯形法可以作为解决这些问题的通法](../Page/单纯形法.md "wikilink")。然而，针对每种特殊情形设计的专门算法可以提高解决问题的效率。如果问题的成本函数包含二次不等式，则称之为二次分配问题。

任务分配問題一般可以在多項式時間內轉化成[最大流量問題](https://zh.wikipedia.org/wiki/最大流量問題 "wikilink")（Maximum
Flow Problem）。

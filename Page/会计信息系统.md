**会计信息系统**
是指以[会计语言为主要表达方式](https://zh.wikipedia.org/wiki/会计 "wikilink")，以会计理论为理论基础，对会计主体内会计信息所进行的收集、加工、传递、反馈等一系列工作所构成的整个信息体系。
...
## 著名的會計信息系統軟件
  ...
  - Macola
  - [Peachtree
    Accounting](https://zh.wikipedia.org/wiki/Peachtree_Accounting "wikilink")
    [1](http://en.wikipedia.org/wiki/Peachtree_Accounting)
    [2](http://www.peachtree.com.hk/products/cproducts.htm)
  - [DacEasy
    Accounting](https://zh.wikipedia.org/wiki/DacEasy_Accounting "wikilink")
  ...
  - [AccPac](https://zh.wikipedia.org/wiki/AccPac "wikilink")
    [5](http://en.wikipedia.org/wiki/Accpac)
  - [Oracle
    Financials](https://zh.wikipedia.org/wiki/Oracle_Financials "wikilink")
    [6](http://en.wikipedia.org/wiki/Oracle_Applications)
  - [QuickBooks](https://zh.wikipedia.org/wiki/QuickBooks "wikilink")
  ...
  - [webERP](https://zh.wikipedia.org/wiki/webERP "wikilink")

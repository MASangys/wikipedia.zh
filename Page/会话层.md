**会话层**，位于[OSI模型的第](../Page/OSI模型.md "wikilink")5层，主要为两个会话层实体进行[会话](https://zh.wikipedia.org/wiki/會話_\(計算機科學\) "wikilink")（Session），而进行的对话连接的管理服务。
...
## 會議層服務
  ...
  - [會話恢復](https://zh.wikipedia.org/wiki/會話恢復 "wikilink")（Session
    restoration）：包括[檢查點](https://zh.wikipedia.org/wiki/檢查點 "wikilink")（checkpointing）和恢復（recovery）
...
1.  为会话实体间建立连接：为给两个对等会话服务用户建立一个会话连接，应该做如下几项工作。
    1.  将会话地址映射为运输地址。
    2.  选择需要的[运输服务质量参数](https://zh.wikipedia.org/wiki/运输服务质量参数 "wikilink")（QoS）。
    3.  对会话参数进行协商。
    4.  识别各个会话连接。
    5.  传送有限的透明用户数据。
...
<div style="-moz-column-count:2; column-count:2;">
  ...
  - iSNS, [Internet Storage Name
    Service](https://zh.wikipedia.org/wiki/ISNS "wikilink")
  - NetBIOS, [Network Basic Input Output
    System](../Page/NetBIOS.md "wikilink")
  - PAP, [Password Authentication
    Protocol](https://zh.wikipedia.org/wiki/Password_Authentication_Protocol "wikilink")
  - PPTP, [Point-to-Point Tunneling
    Protocol](https://zh.wikipedia.org/wiki/PPTP "wikilink")
  - RPC, [遠程過程調用](../Page/遠程過程調用.md "wikilink")
  - RTCP, [實時傳輸控制協議](https://zh.wikipedia.org/wiki/實時傳輸控制協議 "wikilink")
  - SMPP, [Short Message
    Peer-to-Peer](https://zh.wikipedia.org/wiki/SMPP "wikilink")
  - SCP, [Secure Copy
    Protocol](https://zh.wikipedia.org/wiki/Secure_Copy_Protocol "wikilink")
  - ZIP, [Zone Information
    Protocol](https://zh.wikipedia.org/wiki/Zone_Information_Protocol "wikilink")
  - SDP, [Sockets Direct
...
## 參看
  ...
  - [X.225](https://zh.wikipedia.org/wiki/X.225 "wikilink") - [ISO
    8327](https://zh.wikipedia.org/wiki/ISO_8327 "wikilink")

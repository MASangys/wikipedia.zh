...
当一个[振幅为](https://zh.wikipedia.org/wiki/振幅 "wikilink") \(|X| \\)、[角频率为](https://zh.wikipedia.org/wiki/角频率 "wikilink") \(\omega \\) 以及[相位为](https://zh.wikipedia.org/wiki/相位 "wikilink") \(\arg(X) \\) 的[谐波](https://zh.wikipedia.org/wiki/谐波 "wikilink")[信号](https://zh.wikipedia.org/wiki/信号 "wikilink")

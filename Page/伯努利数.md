...
這數列和的公式必定是變數為，次數為次的[多項式](../Page/多項式.md "wikilink")，稱為**[伯努利多項式](../Page/伯努利多項式.md "wikilink")**。伯努利多項式的[係數與伯努利數有密切關係如下](https://zh.wikipedia.org/wiki/係數 "wikilink")：
...
伯努利數最先由[雅各布·伯努利研究](../Page/雅各布·伯努利.md "wikilink")，[棣莫弗以他來命名](https://zh.wikipedia.org/wiki/棣莫弗 "wikilink")。
...
在1842年的[愛達·勒芙蕾絲的](../Page/愛達·勒芙蕾絲.md "wikilink")[分析機筆記的筆記G](../Page/分析機.md "wikilink")，第一次記述了一個讓電腦產生伯努利數的[演算式](https://zh.wikipedia.org/wiki/演算式 "wikilink")。
...
*n*），也就說明它們本質上是這函數在負整數的值。因此，可推測它們有深刻的算術性質，事實也的確如此，這是[庫默爾](https://zh.wikipedia.org/wiki/庫默爾 "wikilink")（Kummer）研究[費馬大定理時發現的](https://zh.wikipedia.org/wiki/費馬大定理 "wikilink")。
...
與整除性也有關連的是[馮·施陶特-克勞森定理](https://zh.wikipedia.org/wiki/馮·施陶特-克勞森定理 "wikilink")（von

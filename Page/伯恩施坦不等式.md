在[概率论中](https://zh.wikipedia.org/wiki/概率论 "wikilink")，**伯恩施坦不等式**（Benstein inequalities）给出了随机变量的和对平均值偏离的概率。在最简单的情况下，设\(X_1,\cdots,X_n\)是独立的[伯努利随机变量](../Page/伯努利試驗.md "wikilink")，取值+1和-1的概率各是1/2，则对任意正数\(\varepsilon\)

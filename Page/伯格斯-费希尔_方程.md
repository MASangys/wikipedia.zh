[Burgers_Fisher_PDE_3d_Maple_plot.png](https://zh.wikipedia.org/wiki/File:Burgers_Fisher_PDE_3d_Maple_plot.png "fig:Burgers_Fisher_PDE_3d_Maple_plot.png") [Burgers_Fisher_pde_Maple_animation.gif](https://zh.wikipedia.org/wiki/File:Burgers_Fisher_pde_Maple_animation.gif "fig:Burgers_Fisher_pde_Maple_animation.gif") [Burgers_Fisher_PDE_Maple_plot.png](https://zh.wikipedia.org/wiki/File:Burgers_Fisher_PDE_Maple_plot.png "fig:Burgers_Fisher_PDE_Maple_plot.png") **伯格斯-費希爾 方程** （Burgers Fisher）非线性偏微分[方程](../Page/方程.md "wikilink")有如下形式：\[1\]
...
[Burgers_Fisher_equation_tanh_Adomian_plot.gif](https://zh.wikipedia.org/wiki/File:Burgers_Fisher_equation_tanh_Adomian_plot.gif "fig:Burgers_Fisher_equation_tanh_Adomian_plot.gif") 利用[阿多米安分解法](../Page/阿多米安分解法.md "wikilink")可求得Burgers-Fisher方程的在[柯西问题](../Page/柯西问题.md "wikilink") u(0)=sin(x) 初始条件下的级数展开近似解：\[2\]

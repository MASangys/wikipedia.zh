**伯格斯-赫胥黎方程**（Burgers-Huxley equation)
是一个模拟物理学、生物学、经济学和生态学等领域非线性波动现象的非线性偏微分方程\[1\]

\(pde1 := u[t]-nu*u[x, x]+a*u*u[x] = b*u*(1-u)*(u-c)\)

其中 u=u(x,t),u\[t\]=\(\frac{\partial u}{\partial t}\) 等等。
...
1.  Inna Shingareva, Carlos Lizárraga-Celaya,Solving Nonlinear Partial
    Differential Equations with Maple p13-25 Springer

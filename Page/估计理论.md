**估计理论**是[统计学和](../Page/统计学.md "wikilink")[信号处理中的一个分支](../Page/信号处理.md "wikilink")，主要是通过测量或经验数据来估计[概率分布](../Page/概率分布.md "wikilink")[参数的数值](../Page/参数.md "wikilink")。这些参数描述了实质情况或实际对象，它们能够回答[估计函数提出的问题](../Page/估计函数.md "wikilink")。
...
在估计理论中，通常假定信息隐藏在包含[雜訊的](../Page/雜訊_\(通訊學\).md "wikilink")[信号中](../Page/信号.md "wikilink")。噪声增加了[不确定性](../Page/不确定性.md "wikilink")，如果没有不确定性，那么也就没有必要估计了。
...
有非常多的领域使用参数估计理论。这些领域包括（当然不局限于以下列出的领域）:
  ...
  - 信号处理
      - [X射線斷層成像](../Page/X射線斷層成像.md "wikilink")
      - [脑电图](../Page/脑电图.md "wikilink")
      - [心电图](../Page/心电图.md "wikilink")
      - [核磁共振](../Page/核磁共振成像.md "wikilink")
      - [医学超声波扫描术](../Page/医学超声波扫描术.md "wikilink")
      - [雷达](../Page/雷达.md "wikilink")、[声纳](../Page/声纳.md "wikilink")、[地震學](../Page/地震學.md "wikilink")——物件的定位
      - 噪声[方差](../Page/方差.md "wikilink")
      - 参数化（例如[周期图和](../Page/周期图.md "wikilink")[相关图谱](../Page/相关图.md "wikilink")）分析
      - 非参数化（例如[MUSIC](../Page/MUSIC.md "wikilink")、[Root-MUSIC和](../Page/Root-MUSIC.md "wikilink")[ESPRIT](../Page/ESPRIT.md "wikilink")）谱分析
      - [维纳滤波](../Page/维纳滤波.md "wikilink")
      - [粒子過濾器](../Page/粒子過濾器.md "wikilink")
  - [临床试验](../Page/临床试验.md "wikilink")
  - [民意调查](../Page/民意调查.md "wikilink")
  - [质量控制](../Page/质量控制.md "wikilink")
  - [通讯](../Page/通讯.md "wikilink")
      - [信道参数](../Page/信道_\(通讯\).md "wikilink")
      - DC增益（请看下边的例子）
  - [控制理论](../Page/控制理论.md "wikilink")
      - [卡尔曼滤波](../Page/卡尔曼滤波.md "wikilink")
      - 随时间改变的[执行器](../Page/执行器.md "wikilink")（英文：）
  - [网络入侵侦查系统](../Page/网络入侵侦查系统.md "wikilink")
...
一般来说，求估计函数需要三步：
  ...
  - 在确定模型之后，需要确定估计器的限制条件。这些限制条件可以通过如[Cramér-Rao不等式这样的方法找到](../Page/Cramér-Rao不等式.md "wikilink")。
...
第一个是从大小为 \(N\)
的[随机矢量中取出的](../Page/随机矢量.md "wikilink")[统计采样](../Page/统计采样.md "wikilink")，将它们放到一个[矢量中](../Page/矢量.md "wikilink")，
...
它需要根据[概率密度函数](../Page/概率密度函数.md "wikilink")（pdf）或者[概率聚集函数](../Page/概率聚集函数.md "wikilink")（:en:[probability
mass function](../Page/probability_mass_function.md "wikilink")）（pmf）建立

  -
    \(p(\mathbf{x} | \mathbf{\theta})\).

参数本身还可能有一个概率分布（[Bayesian
statistics](../Page/Bayesian_statistics.md "wikilink")），需要定义[epistemic
probability](../Page/epistemic_probability.md "wikilink")
...
一个普通的估计器是[最小均方误差](../Page/最小均方误差.md "wikilink")（MMSE）估计器，它利用了参数估计值与实际值之间的误差
...
以下是一些相关的[估计函数以及相关的主题](../Page/估计函数.md "wikilink")

  - [最大似然估計](../Page/最大似然估計.md "wikilink")（Maximum likelihood
    estimation，簡稱MLE）
  - [矩估計](../Page/矩估計.md "wikilink")（Method of moments estimators，簡稱MME）
  - [Cramér-Rao不等式](../Page/Cramér-Rao不等式.md "wikilink")
  - [最小均方差](../Page/最小均方差.md "wikilink")（Minimum mean squared
    error，简称MMSE）
  - [最大后验概率](../Page/最大后验概率.md "wikilink")（Maximum a posteriori
    probability，簡稱MAP）
  - [最小方差非偏估计](../Page/最小方差非偏估计.md "wikilink")（Minimum variance unbiased
    estimator，简称MVUE）
  - [最佳线性非偏估计](../Page/最佳线性非偏估计.md "wikilink")（BLUE）
  - 非偏估计，见[偏差](../Page/偏差.md "wikilink")
...
让我们来看一个接收到的\(N\)个[独立](../Page/statistical_independence.md "wikilink")[采样点的](../Page/采样点.md "wikilink")[离散信号](../Page/离散信号.md "wikilink")\(x[n]\)，它由一个[直流增益](../Page/直流.md "wikilink")\(A\)和*已知*[方差为](../Page/方差.md "wikilink")\(\sigma^2\)
(例如，\(\mathcal{N}(0, \sigma^2)\)）的[叠加白噪声](../Page/叠加白噪声.md "wikilink")\(w[n]\)组成。
...
两个可能的估计器是：
  ...
  - \(\hat{A}_1 = x[0]\)
  - \(\hat{A}_2 = \frac{1}{N} \sum_{n=0}^{N-1} x[n]\)它是[采样平均](../Page/采样平均.md "wikilink")

这两个估计器都有一个[平均值](../Page/平均值.md "wikilink")\(A\)，这可以通过代入每个估计器的[期望得到](../Page/期望.md "wikilink")
...
使用[最大似然估计继续上面的例子](../Page/最大似然估计.md "wikilink")，噪声在一个采样点\(w[n]\)的[概率密度函数](../Page/概率密度函数.md "wikilink")（pdf）是
...
概率密度函数取[自然对数](../Page/自然对数.md "wikilink")
...
为了找到采样平均估计器的[Cramér-Rao下限](../Page/Cramér-Rao下限.md "wikilink")（CRLB），需要找到Fisher
information数
...
采样平均除了是[最大似然估计器之外还是](../Page/最大似然.md "wikilink")[最小变化无偏估计器](../Page/最小变化无偏估计器.md "wikilink")（MVUE）。
...
## 参见
  ...
  - [偏差](../Page/偏差.md "wikilink")
  - [检测理论](../Page/检测理论.md "wikilink")
  - [信息论](../Page/信息论.md "wikilink")
  - [最大似然估计](../Page/最大似然估计.md "wikilink")
  - [矩方法](../Page/矩方法.md "wikilink")
  - [最小均方差](../Page/最小均方差.md "wikilink")（MMSE）

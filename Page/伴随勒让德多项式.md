...
该方程是在[球坐标系下求解](../Page/球坐标系.md "wikilink")[拉普拉斯方程时得到的](../Page/拉普拉斯方程.md "wikilink")，在数学和[理论物理学中有重要的意义](../Page/理论物理学.md "wikilink")。
...
为一般[实数或](../Page/实数.md "wikilink")[复数时方程的解称为](../Page/复数.md "wikilink")**广义勒让德函数**（**generalized
Legendre functions**）。
...
注意当
为[奇数时](../Page/奇数.md "wikilink")，连带勒让德多项式并不是[多项式](../Page/多项式.md "wikilink")。
...
注意  为正整数  时 1- 是[伽玛函数的奇点](../Page/伽玛函数.md "wikilink")，此时等号右边的式子应该理解为当
趋于  时的极限。
...
球谐函数是[球坐标下三维空间](../Page/球坐标.md "wikilink")[拉普拉斯方程的角度部分的解](../Page/拉普拉斯方程.md "wikilink")，构成一组完备的基组，有着重要的意义。
...
式中 d 是[立体角元](../Page/立体角.md "wikilink")。

**伸展树**（）是一种能够自我平衡的[二叉查找树](https://zh.wikipedia.org/wiki/二叉查找树 "wikilink")，它能在均摊\(O(\log n)\)的时间内完成基于伸展（Splay）操作的插入、查找、修改和删除操作。它是由[丹尼尔·斯立特](https://zh.wikipedia.org/wiki/丹尼尔·斯立特 "wikilink")（）和[羅伯特·塔揚在](../Page/羅伯特·塔揚.md "wikilink")1985年发明的\[1\]。

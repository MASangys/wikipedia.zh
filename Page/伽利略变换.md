...
zh-tw:古典力學}-中用以在兩個只以均速相對移動的](https://zh.wikipedia.org/wiki/經典力學 "wikilink")[參考系之間變換的方法](../Page/参考系.md "wikilink")，屬於一種被動態變換。伽利略变换明顯成立的公式在物體以接近[光速運動时](../Page/光速.md "wikilink")、亦或者是电磁过程不会成立，這是[相對論效應造成的](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink")。

[伽利略·伽利萊在解釋均速運動時制定了這一套概念](../Page/伽利略·伽利莱.md "wikilink")。\[1\]他用其解釋[球體滾下](https://zh.wikipedia.org/wiki/球體 "wikilink")[斜面這一力學問題](../Page/斜面.md "wikilink")，並測量出[地球表面](../Page/地球.md "wikilink")[引力](../Page/引力.md "wikilink")[加速度的數值](../Page/加速度.md "wikilink")。

在狭义相对论中，伽利略变换被[庞加莱变换所取代](../Page/龐加萊群.md "wikilink");相反，庞加莱变换的[经典极限](../Page/经典极限.md "wikilink")*c*
→∞中的群收缩产生了伽利略变换。
...
伽利略變換建基於人們加減物體速度的直覺。在其核心，伽利略變換假設時間和空間是[絕對的](https://zh.wikipedia.org/wiki/絕對同時 "wikilink")。

這項假設在[洛伦兹变换中被捨棄](../Page/洛伦兹变换.md "wikilink")，因此就算在[相對論性速度下](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink")，洛伦兹变换也是成立的；而伽利略變換則是洛伦兹变换的低速近似值。
...
利用[線性代數的術語來說](https://zh.wikipedia.org/wiki/線性代數 "wikilink")，這種變換是個[錯切](https://zh.wikipedia.org/wiki/錯切 "wikilink")，是矩陣對向量進行變換的一個過程。當參考系只沿著*x*軸移動時，伽利略變換只作用於兩個分量：
...
這裡我們只考慮[伽利略群的](https://zh.wikipedia.org/wiki/伽利略群 "wikilink")[李代數](../Page/李代數.md "wikilink")。結果能夠輕易延伸到[李群](../Page/李群.md "wikilink")。L的李代數由H、P<sub>i</sub>、C<sub>i</sub>和L<sub>ij</sub>[張成](https://zh.wikipedia.org/wiki/線性生成空間 "wikilink")（[反對稱張量](https://zh.wikipedia.org/wiki/反對稱張量 "wikilink")），並能夠受[交換子的作用](../Page/交換子.md "wikilink")，其中
...
1.  Galileo 1638 *Discorsi e Dimostrazioni Matematiche, intorno á due
    ...
    Elzevir](https://zh.wikipedia.org/wiki/Lowys_Elzevir "wikilink")
    ([Louis
    Elsevier](https://zh.wikipedia.org/wiki/Louis_Elsevier "wikilink")),
    Leiden, or *[Two New
    Sciences](https://zh.wikipedia.org/wiki/Two_New_Sciences "wikilink")*,
    English translation by [Henry
    Crew](https://zh.wikipedia.org/wiki/Henry_Crew "wikilink") and
    [Alfonso de
    Salvio](https://zh.wikipedia.org/wiki/Alfonso_de_Salvio "wikilink")
    1914, reprinted on pages 515-520 of *On the Shoulders of Giants*:
    The Great Works of Physics and Astronomy. [Stephen
    Hawking](https://zh.wikipedia.org/wiki/Stephen_Hawking "wikilink"),
    ed. 2002 ISBN 978-0-7624-1348-5

...
**伽玛分布**是[統計學的一種連續](https://zh.wikipedia.org/wiki/統計學 "wikilink")[機率函數](https://zh.wikipedia.org/wiki/機率函數 "wikilink")。伽玛分佈中的[參數α](https://zh.wikipedia.org/wiki/參數 "wikilink")，稱為形狀參數，β稱為尺度參數。

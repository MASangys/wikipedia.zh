...
伽罗瓦最初使用[置换群](../Page/置换群.md "wikilink")来描述给定的[多项式的](https://zh.wikipedia.org/wiki/多项式 "wikilink")[根与根之间的关系](https://zh.wikipedia.org/wiki/根_\(数学\) "wikilink")。由[戴德金](https://zh.wikipedia.org/wiki/戴德金 "wikilink")（Julius Wilhelm Richard Dedekind）、[利奥波德·克罗内克](../Page/利奥波德·克罗内克.md "wikilink")（Leopold Kronecker）、[埃米爾·阿廷](https://zh.wikipedia.org/wiki/埃米爾·阿廷 "wikilink")（Emil Artin）等人发展起来的现代伽罗瓦理论引入了关于[域扩张](../Page/域扩张.md "wikilink")及其[自同构](../Page/自同构.md "wikilink")的研究。

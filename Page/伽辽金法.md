**伽辽金方法（Galerkin
method）**是由俄罗斯数学家[鲍里斯·格里戈里耶维奇·伽辽金](https://zh.wikipedia.org/wiki/鲍里斯·格里戈里耶维奇·伽辽金 "wikilink")（俄文：Борис
Григорьевич Галёркин 英文：[Boris
Galerkin](https://zh.wikipedia.org/wiki/Boris_Galerkin "wikilink")）发明的一种数值分析方法。应用这种方法可以将求解[微分方程问题](../Page/微分方程.md "wikilink")（通过方程所对应[泛函的](../Page/泛函.md "wikilink")[变分原理](../Page/变分原理.md "wikilink")）简化成为[线性方程组的求解问题](../Page/线性方程组.md "wikilink")。而一个高维（多变量）的线性方程组又可以通过[线性代数方法简化](../Page/线性代数.md "wikilink")，从而达到求解微分方程的目的。
...
\[a(u,v) = a(v,u).\]
虽然伽辽金方法并不要求一定对称，但这一限制使得标准理论的应用变得简单的多。而且，非对称情形的分析可能需要用到[彼得罗夫－伽辽金方法](https://zh.wikipedia.org/wiki/彼得罗夫－伽辽金方法 "wikilink")。
...
根据Lax-Milgram定理（参看[弱形式](https://zh.wikipedia.org/wiki/弱形式 "wikilink")），这两条性质保证了原问题的弱形式的[适定性](https://zh.wikipedia.org/wiki/适定性 "wikilink")。下面章节中的所有[范数都是使得上面的不等式成立的范数](../Page/范数.md "wikilink")（这些范数通常称为能量范数）。
...
因此，读者可以参考[有限元方法的教科书](https://zh.wikipedia.org/wiki/有限元方法 "wikilink")。

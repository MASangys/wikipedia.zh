**位元組順序記號**（，**BOM**）是位於碼點`U+FEFF`的[統一碼字符的名称](https://zh.wikipedia.org/wiki/統一碼 "wikilink")。當以[UTF-16或](https://zh.wikipedia.org/wiki/UTF-16 "wikilink")[UTF-32來將](../Page/UTF-32.md "wikilink")[UCS](https://zh.wikipedia.org/wiki/UCS "wikilink")/統一碼字符所組成的字串編碼時，這個字符被用來標示其[位元組序](https://zh.wikipedia.org/wiki/位元組序 "wikilink")。它常被用來當做標示文件是以[UTF-8](../Page/UTF-8.md "wikilink")、[UTF-16或](https://zh.wikipedia.org/wiki/UTF-16 "wikilink")[UTF-32編碼的記號](../Page/UTF-32.md "wikilink")。
...
標準上允許位元組順序記號的存在，但實際上並不一定需要。UTF-8編碼過的位元組順序記號則被用來標示它是UTF-8的文件。它只用來標示一個UTF-8的檔案，而不用來說明位元組順序。\[1\]許多[視窗程式](https://zh.wikipedia.org/wiki/視窗作業系統 "wikilink")（包含[記事本](../Page/記事本.md "wikilink")）會需要添加位元組順序記號到UTF-8檔案，否則將無法正確解析編碼，而出現亂碼。然而，在[類Unix系統](https://zh.wikipedia.org/wiki/類Unix系統 "wikilink")（大量使用[文本文件](../Page/文本文件.md "wikilink")，用於[檔案格式](../Page/檔案格式.md "wikilink")，用於[行程間通訊](../Page/行程間通訊.md "wikilink")）中，這種做法則不被建議採用。因為它會妨礙到如解譯器腳本開頭的[Shebang等的一些重要的碼的正確處理](../Page/Shebang.md "wikilink")。它亦會影響到無法識別它的程式語言。如[gcc會報告源碼檔開頭有無法識別的字符](https://zh.wikipedia.org/wiki/gcc "wikilink")。而在[PHP中](../Page/PHP.md "wikilink")，如果沒有啟用輸出緩衝（output

...
**置换贴图**是使用[高度图将经过纹理化的表面上实际几何点位置沿着表面法线根据保存在纹理中的数值进行移位的技术](../Page/高度图.md "wikilink")，这是与[凹凸贴图](../Page/凹凸贴图.md "wikilink")、[法线贴图以及](../Page/法线贴图.md "wikilink")[视差贴图不同的技术](../Page/视差贴图.md "wikilink")。

多年以来，置换贴图一直是 [RenderMan](../Page/RenderMan.md "wikilink")
这样的高端渲染系统的一个特性，如
[OpenGL](../Page/OpenGL.md "wikilink") 与
[DirectX](../Page/DirectX.md "wikilink")
这样的[应用程序编程接口则没有这样的特性](../Page/应用程序编程接口.md "wikilink")，其中一个原因就是置换贴图的最初实现为了得到与屏幕上的像素匹配的[微多边形](../Page/微多边形.md "wikilink")（[:en:micropolygon](../Page/:en:micropolygon.md "wikilink")）需要自适应的表面镶嵌。
...
## 参见
  ...
  - [演示效果](../Page/演示效果.md "wikilink")
  - [高度图](../Page/高度图.md "wikilink")

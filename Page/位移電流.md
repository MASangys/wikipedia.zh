在[電磁學裏](https://zh.wikipedia.org/wiki/電磁學 "wikilink")，**位移電流**（）定義為[電位移對於](../Page/電位移.md "wikilink")[時間的變率](https://zh.wikipedia.org/wiki/時間 "wikilink")。位移電流的單位與[電流的單位相同](https://zh.wikipedia.org/wiki/電流 "wikilink")。如同真實的電流，位移電流也有一個伴隨的[磁場](../Page/磁場.md "wikilink")。但是，位移電流並不是移動的[電荷所形成的電流](../Page/電荷.md "wikilink")；而是[電位移對於時間的](../Page/電位移.md "wikilink")[偏導數](https://zh.wikipedia.org/wiki/偏導數 "wikilink")。
...
方程式右手邊的第一個項目，稱為**馬克士威修正項目**。在[自由空間和電介質內](../Page/自由空間.md "wikilink")，這項目都會存在。雖然不涉及任何真實的[電荷運動](../Page/電荷.md "wikilink")，它有一個伴隨的磁場，它的物理行為就好像是真實的[電流](https://zh.wikipedia.org/wiki/電流 "wikilink")。

第二個項目是**電極化電流密度**，與電介質內單獨分子的[極化性有關](../Page/極化性.md "wikilink")。在電介質內，雖然電荷不能自由地運動於電介質，感受到外電場的作用，束縛於[原子內部的束縛電荷可以做微小的運動](../Page/原子.md "wikilink")。因此，正值和負值的束縛電荷會產生小距離的分離，造成[電極化](../Page/電極化.md "wikilink")，這變化可以用[電極化強度](https://zh.wikipedia.org/wiki/電極化強度 "wikilink")\(\mathbf{P}\)來代表。電極化強度對於時間的偏導數就是電極化電流密度。
...
應用[向量微積分裏的一個](https://zh.wikipedia.org/wiki/向量微積分 "wikilink")[恆等式](https://zh.wikipedia.org/wiki/恆等式 "wikilink")，[旋度的散度必定等於零](../Page/旋度.md "wikilink")。所以，
...
在[靜磁學內](../Page/靜磁學.md "wikilink")，這是正確的。但是，出了靜磁學範圍，假若電荷密度\(\rho\)含時間，這就不一定正確了。思考[電荷守恆定律的方程式](https://zh.wikipedia.org/wiki/電荷守恆定律 "wikilink")：
...
經典電磁定律，知名為[馬克士威方程組](../Page/馬克士威方程組.md "wikilink")，可以描述電磁波的物理行為。在[自由空間裏](../Page/自由空間.md "wikilink")，源項目等於零（源[電荷等於零](../Page/電荷.md "wikilink")，源[電流等於零](https://zh.wikipedia.org/wiki/電流 "wikilink")）。除了沒有任何事發生的解答以外（電場和磁場都等於零），方程式仍舊允許不簡單的解答，電場和磁場隨著時間和位置變化\[5\]。採用[國際單位制](https://zh.wikipedia.org/wiki/國際單位制 "wikilink")，處於自由空間狀況的馬克士威方程組表達為
...
將公式 (7)和 (8)代回公式
(6)，可以得到電場的[波動方程式](https://zh.wikipedia.org/wiki/波動方程式 "wikilink")：
...
馬克士威又給予這些渦胞一種[彈性性質](https://zh.wikipedia.org/wiki/彈性 "wikilink")。假設施加某種外力於圓粒，則這些圓粒會轉而施加切力於渦胞，使得渦胞變形。這代表了一種[靜電狀態](https://zh.wikipedia.org/wiki/靜電 "wikilink")。假設外力與時間有關，則渦胞的變形也會與時間有關，因而形成了[電流](https://zh.wikipedia.org/wiki/電流 "wikilink")。這樣，馬克士威可以比擬出[電位移和](../Page/電位移.md "wikilink")**位移電流**。不但是在[介質內](https://zh.wikipedia.org/wiki/介質 "wikilink")，甚至在[真空](https://zh.wikipedia.org/wiki/真空 "wikilink")（馬克士威認為沒有完全的真空，[乙太瀰漫於整個宇宙](https://zh.wikipedia.org/wiki/乙太 "wikilink")），只要有磁力線，就有渦胞，位移電流就可以存在。因此，馬克士威將[安培定律加以延伸](../Page/安培定律.md "wikilink")，增加了一個有關於位移電流的項目，稱為「馬克士威修正項目」。聰明睿智的馬克士威很快地聯想到，既然彈性物質會以[波動形式傳播能量於空間](https://zh.wikipedia.org/wiki/波動 "wikilink")，那麼，這彈性模型所比擬的電磁場應該也會以波動形式傳播能量於空間。不但如此，電磁波還會產生[反射](https://zh.wikipedia.org/wiki/反射 "wikilink")，[折射等等波動行為](../Page/折射.md "wikilink")。馬克士威計算出[電磁波的傳播速度](https://zh.wikipedia.org/wiki/電磁波 "wikilink")，發覺這數值非常接近於，先前從[天文學得到的](../Page/天文學.md "wikilink")，[光波傳播於](../Page/光.md "wikilink")[行星際空間](https://zh.wikipedia.org/wiki/行星際空間 "wikilink")()的速度。因此，馬克士威斷定光波就是一種電磁波\[8\]。

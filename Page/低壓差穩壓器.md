...
[VREG-SO23-X-V33D-AD_(16237026677).jpg](https://zh.wikipedia.org/wiki/File:VREG-SO23-X-V33D-AD_\(16237026677\).jpg "fig:VREG-SO23-X-V33D-AD_(16237026677).jpg") 低壓差穩壓器樣重要的參數有壓降電壓、壓差(Dropout voltage)、靜態耗電電流、靜態電流(quiescent current)、負載調節( Load Regulation )，線性調節(Line Regulation)，最大輸出電流，速度，瞬態響應(Transient response)…等。個別低壓差穩壓器會標明[電源抑制比](../Page/電源電壓抑制比.md "wikilink")(PSRR)，輸出噪聲(Output noise)。

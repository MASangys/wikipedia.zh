[数学中](../Page/数学.md "wikilink")，**体积形式**提供了[函数在不同](../Page/函数.md "wikilink")[坐标系](https://zh.wikipedia.org/wiki/坐标系 "wikilink")（比如[球坐标和](https://zh.wikipedia.org/wiki/球坐标 "wikilink")[圆柱坐标](https://zh.wikipedia.org/wiki/圆柱坐标 "wikilink")）下对[体积](../Page/体积.md "wikilink")[积分的一种工具](../Page/积分.md "wikilink")。更一般地，一个体积元是[流形上一个](../Page/流形.md "wikilink")[测度](../Page/测度.md "wikilink")。

在一个[定向](https://zh.wikipedia.org/wiki/可定向 "wikilink")*n*-维流形上，**体积元**典型地由**体积形式**生成，所谓体积元是一个处处非零的*n*-阶[微分形式](../Page/微分形式.md "wikilink")。一个流形具有体积形式[当且仅当它是可定向的](../Page/当且仅当.md "wikilink")，而可定向流形有无穷多个体积形式（[细节见下](https://zh.wikipedia.org/wiki/#体积形式不变性 "wikilink")）。

有一个推广的**伪体积形式**概念，对无论可否定向的流形都存在。

许多类型的流形有典范的（伪）体积形式，因为它们有额外的结构保证可选取一个更好的体积形式。在复情形，一个带有[全纯体积形式的](https://zh.wikipedia.org/wiki/全纯 "wikilink")[凯勒流形是](../Page/凯勒流形.md "wikilink")[卡拉比-丘流形](https://zh.wikipedia.org/wiki/卡拉比-丘流形 "wikilink")。
...
对不可定向流形，一个体积“伪”形式，也称为“奇”或“扭曲”的体积形式，可以定义为[定向丛的一个处处非](https://zh.wikipedia.org/wiki/定向丛 "wikilink")0截面；这个定义同样适用于定向流形。在这种看法下，（非扭曲的）微分形式就是“偶”
...
[同伦等价](https://zh.wikipedia.org/wiki/同伦等价 "wikilink")（事实上是形变收缩），任何流形都有伪体积形式。类似地，定向丛总是平凡的，所以任何流形都有一个伪体积形式。
...
这里流形为*n*-维，\(|g|\)是流形上[度量张量行列式的绝对值](../Page/度量张量.md "wikilink")，\(dx^i\)为组成流形[余切丛一组基的](../Page/余切丛.md "wikilink")[1形式](https://zh.wikipedia.org/wiki/1形式 "wikilink")。
...
给出，这里\(\wedge\)是[楔积](https://zh.wikipedia.org/wiki/楔积 "wikilink")。对一个正则曲面，这个行列式不为0；等价地，雅可比矩阵的秩为2。
...
反过来，[Jürgen
K.Moser](https://zh.wikipedia.org/wiki/Jürgen_K.Moser "wikilink")（[Jürgen
Moser](https://zh.wikipedia.org/wiki/:en:Jürgen_Moser "wikilink")）\[1\]的一个定理指出，对于连通紧流形上两个体积相等的体积形式\(\omega_1\)和\(\omega_2\)，存在一个流形的微分自同胚将\(\omega_1\)拉回到\(\omega_2\)，事实上存在由的[流形成](../Page/流_\(数学\).md "wikilink")[同痕](https://zh.wikipedia.org/wiki/同痕 "wikilink")。
...
<references />
  ...
  - [Michael
    Spivak](https://zh.wikipedia.org/wiki/Michael_Spivak "wikilink"),
    *Calculus on Manifolds*, (1965) W.A. Benjamin, Inc. Reading,
    Massachusetts ISBN 0-8053-9021-9（提供了一个微分几何的现代理念的初等介绍，只需要一般的微积分背景。）

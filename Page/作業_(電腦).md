在計算機科學中，**作業**（），又譯為**工作**、**任務**，是在[記憶體中的一組](https://zh.wikipedia.org/wiki/記憶體 "wikilink")[程式指令](https://zh.wikipedia.org/wiki/程式 "wikilink")。它包括了一段虛擬[定址空間分頁](https://zh.wikipedia.org/wiki/定址空間 "wikilink")，與[作業系統資源](https://zh.wikipedia.org/wiki/作業系統 "wikilink")，提供[執行緒運行的空間](https://zh.wikipedia.org/wiki/執行緒 "wikilink")。有時候，它與[行程](../Page/行程.md "wikilink")被認為是同義的；但也有人認為，在即時系統（Real-time）中運行的[行程](../Page/行程.md "wikilink")才被稱為作業。

...
1.  「キミアトラクション (Kimiatorakushon)」Video Clip & Making
...
1.  　"Kimiato"裝飾貼紙 ("キミアト"デコレーションステッカー)
...
1.  「キミアトラクション (Kimiatorakushon)」Video Clip（Dance Ver.） & Making
...
1.  　"Kimiato"美甲貼紙 ("キミアト"ネイルデコレーションシール)
...
5.  キミアトラクション（Oringinla Karaoke）
6.  Shall We?（Oringinla Karaoke）
7.  NEW AGE（Oringinla Karaoke）
8.  Ignition（Oringinla Karaoke）

※ **封入特典**:僅限首壓板

1.  　"Kimiato"標誌貼紙 ("キミアト"ロゴステッカー)

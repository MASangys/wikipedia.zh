...
（[OEIS:A001608](https://zh.wikipedia.org/wiki/OEIS:A001608 "wikilink")）
...
此數列早於1878年就被[愛德華·盧卡斯研究](https://zh.wikipedia.org/wiki/愛德華·盧卡斯 "wikilink")（*American
Journal of Mathematics*, vol 1, page 230ff）。1899年R.
Perrin（*L'Intermediaire Des Mathematiciens*）又再研究。對此數列較詳盡的研究是Dan
Shanks及Bill Adams在1982年發表的論文（*Mathematics of Computation*, vol 39, n.
159）。
...
和[巴都萬數列一樣](../Page/巴都萬數列.md "wikilink")，佩蘭數列的一般形式也和方程\(x^3-x-1=0\)的三個根有關：實根\(p\)（即[銀數](https://zh.wikipedia.org/wiki/銀數 "wikilink")）和兩個複數根\(q\)、\(r\)。

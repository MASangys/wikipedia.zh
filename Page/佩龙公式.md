在[数学或更具体地](../Page/数学.md "wikilink")，其分支[解析数论中](../Page/解析数论.md "wikilink")，**佩龙公式**源自[奥斯卡·佩龙](https://zh.wikipedia.org/wiki/奥斯卡·佩龙 "wikilink")，是利用逆[Mellin
变换来计算](https://zh.wikipedia.org/wiki/Mellin_变换 "wikilink")[算术函数的和](https://zh.wikipedia.org/wiki/算术函数 "wikilink")。

## 定理陈述

令 \(\{a(n)\}\)
为一[算术函数](https://zh.wikipedia.org/wiki/算术函数 "wikilink")，并令

\[g(s)=\sum_{n=1}^{\infty} \frac{a(n)}{n^{s}}\]

为其对应的[狄利克雷级数](../Page/狄利克雷级数.md "wikilink")。假设这狄利克雷级数对 \(\Re(s)>\sigma\)
[一致收敛](https://zh.wikipedia.org/wiki/一致收敛 "wikilink")，那么佩龙公式为：
...
用[阿贝尔求和公式可以得到一个简单的证明梗概](https://zh.wikipedia.org/wiki/阿贝尔求和公式 "wikilink")：
...
和 \(\chi(n)\)
是[狄利克雷特征](https://zh.wikipedia.org/wiki/狄利克雷特征 "wikilink").

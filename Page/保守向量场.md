...
=
0，任何正合形式都是闭合的，因此任何保守向量场都是无旋的。定义域是[单连通的](https://zh.wikipedia.org/wiki/单连通 "wikilink")，当且仅当它的第一个[同调群为零](https://zh.wikipedia.org/wiki/同调群 "wikilink")，或第一个[上同调群为零](https://zh.wikipedia.org/wiki/上同调群 "wikilink")。第一个[德拉姆上同调](../Page/德拉姆上同调.md "wikilink")群\(H_{\mathrm{dR}}^{1}\)是零，当且仅当所有闭合1-形式都是恰当的。

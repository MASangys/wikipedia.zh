如果一个[向量场是某个](https://zh.wikipedia.org/wiki/向量场 "wikilink")[标量势的梯度](https://zh.wikipedia.org/wiki/标量势 "wikilink")，那么便称为**保守向量场**。有两个密切相关的概念：**路径无关**和**无旋向量场**。任何一个保守向量场的[旋度都是零](../Page/旋度.md "wikilink")（因此是无旋的），也具有路径无关的性质。
...
这是[复合函数求导法则和](https://zh.wikipedia.org/wiki/复合函数求导法则 "wikilink")[微积分基本定理的结果](../Page/微积分基本定理.md "wikilink")。
...
更加抽象地，保守向量场是[恰当1-形式](https://zh.wikipedia.org/wiki/恰当形式 "wikilink")。也就是说，它是一个1-形式，等于某个0-形式（标量场）\(\phi\)的[外导数](https://zh.wikipedia.org/wiki/外导数 "wikilink")。一个无旋向量场是[闭合1-形式](https://zh.wikipedia.org/wiki/闭形式 "wikilink")。由于*d*<sup>2</sup>
=
0，任何正合形式都是闭合的，因此任何保守向量场都是无旋的。定义域是[单连通的](https://zh.wikipedia.org/wiki/单连通 "wikilink")，当且仅当它的第一个[同调群为零](https://zh.wikipedia.org/wiki/同调群 "wikilink")，或第一个[上同调群为零](https://zh.wikipedia.org/wiki/上同调群 "wikilink")。第一个[德拉姆上同调群](../Page/德拉姆上同调.md "wikilink")\(H_{\mathrm{dR}}^{1}\)是零，当且仅当所有闭合1-形式都是恰当的。

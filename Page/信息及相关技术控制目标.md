> 本文内容由[信息及相关技术控制目标](https://zh.wikipedia.org/wiki/信息及相关技术控制目标)转换而来。


****（全称为：），中文译为：**信息及相关技术控制目标**。它是一系列关于管理最佳实践（框架）的集合，并由（）和治理委员会于1992年创建。为管理人员、审计人员和用户提供了一套通用的测量、显示和处理的方法以及最佳的实践，帮助其通过在公司中使用信息技术和适当的IT治理与控制，使公司的利益最大化。
...
[Category:資訊科學](https://zh.wikipedia.org/wiki/Category:資訊科學 "wikilink") [Category:隐私](https://zh.wikipedia.org/wiki/Category:隐私 "wikilink")

1.  <https://www.arabianindustry.com/technology/news/2018/nov/15/isaca-releases-cobit-2019-6002724/>
...
Library，一般情况下使用其缩写**ITIL**，也譯為「**資訊技術基礎建設館**」\[1\]）是用来管理[信息技术的](../Page/信息技术.md "wikilink")[架构设计](https://zh.wikipedia.org/wiki/架构 "wikilink")，研发和操作的一整套概念和思想。
...
Library*都是[英国](https://zh.wikipedia.org/wiki/英国 "wikilink")[政府商務辦公室](../Page/政府商務辦公室_\(英國\).md "wikilink")
(OGC)的[注册商标](https://zh.wikipedia.org/wiki/注册商标 "wikilink")。藉由为不同的IT组织量身定制一些复杂的清单，任务，流程，ITIL为许多重要的IT时间准则给出了详尽的解释。
...
以下作些许的说明: Service Delivery是属于战略性的思考，偏管理规范或协议，共分五大流程，分别是：
  ...
  - [服务水平管理](https://zh.wikipedia.org/wiki/服务水平管理 "wikilink")（Service
    Level Managemnet）
  - [财务管理](https://zh.wikipedia.org/wiki/财务管理 "wikilink")（Financial
    Management）
  - [可用性管理](https://zh.wikipedia.org/wiki/可用性管理 "wikilink")（Availability
    Management）
  - [能力管理](https://zh.wikipedia.org/wiki/能力管理 "wikilink")（Capacity
    Management）
  - [持续性管理](https://zh.wikipedia.org/wiki/持续性管理 "wikilink")（Continuity
    Management）

Service Support是属于操作面规范，亦分五大流程，分别是

  - [事故管理](https://zh.wikipedia.org/wiki/事故管理_\(信息技术服务管理\) "wikilink")（Incident
    management）
  - [问题管理](https://zh.wikipedia.org/wiki/问题管理 "wikilink")（Problem
    management）
  - [配置管理](https://zh.wikipedia.org/wiki/配置管理 "wikilink")（Configuration
    Management）
  - [变更管理](https://zh.wikipedia.org/wiki/变更管理 "wikilink")（Change
    Management）
  - [发布管理](https://zh.wikipedia.org/wiki/发布管理 "wikilink")（Release
    Management）
...
Service Management
Forum（[itSMF](https://zh.wikipedia.org/wiki/IT_Service_Management_Forum "wikilink")）International和如下两家考试机构组成：[EXIN](http://www.exin-exams.com/)（总部设在荷兰），[ISEB](http://www.bcs.org/BCS/Products/Qualifications/ISEB/)（总部设在英国）.
...
20000认证](https://zh.wikipedia.org/wiki/ISO/IEC_20000 "wikilink")。

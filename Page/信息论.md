...
信息熵与物理学中的[热力学熵有着紧密的联系](../Page/热力学熵.md "wikilink"):

\[S(X)=k_BH(X)\]

其中S(X)為熱力學熵，H(X)為信息熵，\(k_B\)為[波茲曼常數](../Page/波茲曼常數.md "wikilink")。
事實上這個關係也就是廣義的[波茲曼熵公式](../Page/波茲曼熵公式.md "wikilink")，或是在[正則系綜內的熱力學熵表示式](../Page/正則系綜.md "wikilink")。如此可知，[玻尔兹曼与](../Page/玻尔兹曼.md "wikilink")[吉布斯在统计物理学中对熵的工作](../Page/吉布斯.md "wikilink")，啟發了信息論的熵。

信息熵是[信源編碼定理中](../Page/信源編碼定理.md "wikilink")，壓縮率的下限。當我們用少於信息熵的資訊量做編碼，那麼我們一定有資訊的損失。夏農在[大數定律和](../Page/大數定律.md "wikilink")的基础上定義了和典型-{序列}-。典型集是典型-{序列}-的集合。因為一个独立同分布的\(X\)-{序列}-属于由\(X\)定义的典型集的機率大約為1，所以只需要将屬於典型集的无记忆\(X\)信源-{序列}-编为唯一可译碼，其他-{序列}-隨意編碼，就可以達到幾乎無損失的壓縮。
...
[聯合熵](../Page/聯合熵.md "wikilink")（）由熵的定義出發，由[聯合分布](../Page/聯合分布.md "wikilink")，我們有:

\[H(X,Y)=\sum_{x\in\mathcal{X}}\sum_{y\in\mathcal{Y}}^{}p(x,y)\log(\frac{1}{p(x,y)})\]

[條件熵](../Page/條件熵.md "wikilink")（），顧名思義，從條件機率p(y|x)做定義:

\[H(Y|X)=\sum_{x\in\mathcal{X}}\sum_{y\in\mathcal{Y}}^{}p(x,y)\log(\frac{1}{p(y|x)})\]

因為由[貝氏定理](../Page/貝氏定理.md "wikilink")，我們有\(p(x,y)=p(y|x)p(x)\)，帶入聯合熵的定義，可以分離出條件熵，於是得到聯合熵與條件熵的關係式:
...
[Category:形式科學](https://zh.wikipedia.org/wiki/Category:形式科學 "wikilink")

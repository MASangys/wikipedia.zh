**修饰模式**，是[面向对象编程领域中](../Page/面向对象编程.md "wikilink")，一种动态地往一个类中添加新的行为的[设计模式](../Page/软件设计模式.md "wikilink")。就功能而言，修饰模式相比生成[子类更为灵活](../Page/子类.md "wikilink")，这样可以给某个对象而不是整个类添加一些功能。\[1\]
...
I/O
Streams的实现](../Page/Java_Platform,_Standard_Edition#java.io.md "wikilink")。

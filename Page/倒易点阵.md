...
**倒易点阵**（），又称**倒（易）晶格**、**倒（易）格子**，是物理学中描述空间[波函数的](../Page/波函数.md "wikilink")[傅立叶变换后的周期性的一种方法](https://zh.wikipedia.org/wiki/傅立叶变换 "wikilink")。相对于正晶格所描述的实空间周期性，倒晶格描述的是[动量空间](https://zh.wikipedia.org/wiki/动量空间 "wikilink")，亦可认为是k空间的周期性。根据位置和动量所满足的[庞特里亚金对偶性](https://zh.wikipedia.org/wiki/庞特里亚金对偶性 "wikilink")，[布拉菲晶格的倒晶格仍然是一种](../Page/布拉菲晶格.md "wikilink")[布拉菲晶格](../Page/布拉菲晶格.md "wikilink")，而倒晶格的倒晶格就会变回原始晶格（正晶格）。
...
對三維晶格而言，我們定義[素晶胞的基矢](https://zh.wikipedia.org/wiki/素晶胞 "wikilink")
...
其中hkl为[密勒指数](https://zh.wikipedia.org/wiki/密勒指数 "wikilink")，向量**G**的[模长与正晶格的晶面间距有以下关系](https://zh.wikipedia.org/wiki/模长 "wikilink")
...
这个形式也和[劳厄方程式相符](https://zh.wikipedia.org/wiki/劳厄方程式 "wikilink")。
...
## 外部連結
  ...
  - <http://newton.umsl.edu/run//nano/known.html> -
    [Jmol](https://zh.wikipedia.org/wiki/Jmol "wikilink")-based electron
    diffraction simulator lets you explore the intersection between
    reciprocal lattice and Ewald sphere during tilt.

...
倒頻譜被定義在1963的論文（Bogert等）。定義如下：
  ...
  - 數學上：信號的倒頻譜 = [IFT](https://zh.wikipedia.org/wiki/逆傅里叶变换 "wikilink")
    ( [log](https://zh.wikipedia.org/wiki/对数 "wikilink") ( |
    [FT](../Page/傅里叶变换.md "wikilink") (信号) | ) + j2πm )（m為實數）
  - 演算法：信号 -\> 傅立叶变换 -\> 取[绝对值](../Page/绝对值.md "wikilink") -\>
    取[对数](https://zh.wikipedia.org/wiki/对数 "wikilink") -\> 相位展开
    -\> 逆傅立叶变换 -\> 倒频谱
...
## 應用
  ...
  - 倒頻譜可以被視為在不同頻帶上變化速率的資訊，倒頻譜一開始被發明在[地震或](../Page/地震.md "wikilink")[炸彈產生的地震回音](https://zh.wikipedia.org/wiki/炸彈 "wikilink")，現今也被使用在分析[雷達訊號](https://zh.wikipedia.org/wiki/雷達 "wikilink")，以及[訊號處理等問題](https://zh.wikipedia.org/wiki/訊號處理 "wikilink")。
  ...
  - 語音大致上是由音高、[聲帶](https://zh.wikipedia.org/wiki/聲帶 "wikilink")[脈衝](https://zh.wikipedia.org/wiki/脈衝 "wikilink")、聲門波形所組成，我們可以利用倒頻譜將這三種元素在倒頻域上分開，以利於做[語音訊號的分析](../Page/語音.md "wikilink")。
...
先對信號做[Z轉換](https://zh.wikipedia.org/wiki/Z轉換 "wikilink"), 並整理一下係數,
讓他變成下面的形式
...
根據[Z轉換所得到的系數](https://zh.wikipedia.org/wiki/Z轉換 "wikilink"),
我們可以利用泰勒展開得到Z的反轉換
...
2.對於FIR([有限脈衝響應](https://zh.wikipedia.org/wiki/有限脈衝響應 "wikilink"))的情況,
\(c_k=0, d_k=0\)
...
分別對於x\[n\]的四種不同的狀況做延伸
1.對於x\[n\]是因果(causal)和[最小相位](https://zh.wikipedia.org/wiki/最小相位 "wikilink")(minimum
phase) i.e. \(x[n]=\widehat {x}\left[ n\right]=0, n<0\)
...
2.  梅爾頻率倒頻譜是針對訊號的[能量取](../Page/能量.md "wikilink")[對數](https://zh.wikipedia.org/wiki/對數 "wikilink")，而倒頻譜是針對訊號原始在頻譜上的值取[對數](https://zh.wikipedia.org/wiki/對數 "wikilink")。
...
1.  B. P. Bogert, M. J. R. Healy, and [J. W.
    Tukey](https://zh.wikipedia.org/wiki/J._W._Tukey "wikilink"): "The
    quefrency analysis of [time
    series](https://zh.wikipedia.org/wiki/time_series "wikilink") for
    echoes: cepstrum,
    pseudo-[autocovariance](https://zh.wikipedia.org/wiki/autocovariance "wikilink"),

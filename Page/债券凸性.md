**债券凸性**（）在[金融学中是指](https://zh.wikipedia.org/wiki/金融学 "wikilink")[债券价格与](../Page/债券.md "wikilink")[利率间](../Page/利率.md "wikilink")[非线性关系的一种量度](https://zh.wikipedia.org/wiki/非线性 "wikilink")，表示为债券价格对利率的二阶[导数](../Page/导数.md "wikilink")，即价格－利率曲线的弯曲程度。与其相关的一个概念为[债券存續期間](https://zh.wikipedia.org/wiki/债券存續期間 "wikilink")，表示为价格对利率的一阶导数，即价格－利率曲线的斜率。

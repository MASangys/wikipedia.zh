在[计算机科学](../Page/计算机科学.md "wikilink")中，**值**（）是一无法进一步[求值的](https://zh.wikipedia.org/wiki/eval "wikilink")[表达式](https://zh.wikipedia.org/wiki/表达式 "wikilink")。例如，表达式“1
+
...
(電腦科學)](https://zh.wikipedia.org/wiki/赋值_\(電腦科學\) "wikilink")（即位于[赋值运算符左侧](https://zh.wikipedia.org/wiki/赋值运算符 "wikilink")）的对象，但由于“const”被加入到语言中，这类对象现在被称作“可更改的左值”。C++中，左值和右值是表达式的分类，一个表达式必然是左值或右值之一。[C++11](../Page/C++11.md "wikilink")把上述左值性(lvalueness)扩充为更复杂的值类别(value

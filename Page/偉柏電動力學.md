...
[韋伯](https://zh.wikipedia.org/wiki/韋伯 "wikilink")(1804 - 1891)發現兩帶電質點間的作用力與其相對速度與距離有關，是最早提出力的作用與速度有關的科學家，這個理論能有效的解釋靜電學中電磁吸引、感應電流等現象。若有一組帶電粒子 與 ，分別座落於 與 上，其速度分別為 與 ，則帶電質點2對1的韋伯力(Weber’s force)其值可表示成 \(F_{21}=q_1 q_2\frac{1}{r^2}(1-\frac{{\dot{r}}^2-2\dot{r}\ddot{r}}{c^2})\)
...
因此Lagrangian可以寫成\(L=T-U\) \(L=\frac{1}{2}m\dot{r}+\frac{1}{2}mr^2{\dot{\theta}}^2-\frac{q_1 q_2}{r}(1+\frac{{\dot{r}}^2}{c^2})\)
...
從上式我們可以知到r方向的作用力即為[韦伯力](https://zh.wikipedia.org/wiki/韦伯力 "wikilink")，另外，注意到θ方向是沒有作用力的，即兩個帶電質點間沒有扭力(torque)作用，因此韦伯电动力学中的作用力是在兩個質點連心線上，遵守牛頓第三運動定律的strong form，此結果和麦克斯韦尔-洛伦兹电动力学中的[洛伦兹力](../Page/洛伦兹力.md "wikilink")有很大的不同，接下來的部分將會對兩種不同形式的電動力學做討論。

...
**偏微分方程**（，[缩写作](https://zh.wikipedia.org/wiki/缩写 "wikilink")****）指含有未知[函数及其](../Page/函数.md "wikilink")[偏导数的](../Page/偏导数.md "wikilink")[方程](../Page/方程.md "wikilink")。描述自变量、未知函數及其偏导數之間的關係。符合這個關係的函数是方程的解。
...
適用於所有物質或[電荷的](../Page/電荷.md "wikilink")[重力場或](https://zh.wikipedia.org/wiki/重力場 "wikilink")[靜電場](https://zh.wikipedia.org/wiki/靜電場 "wikilink")。
...
1.  \(B^2 - AC \, < 0\) 且 (A,B,C)≠(0,0,0):
    [椭圆方程](https://zh.wikipedia.org/wiki/椭圆型偏微分方程 "wikilink")；
2.  \(B^2 - AC = 0\,\) 或 (A,B,C)=(0,0,0):
    [抛物线方程](https://zh.wikipedia.org/wiki/抛物偏微分方程 "wikilink")；
...
利用积分法，将偏微分方程变换为可分离的偏微分方程，方便求解。一般为[傅里叶变换分析](../Page/傅里叶变换.md "wikilink")。
...
在众多求解偏微分方程的数值方法中，三种应用最广的方法为[有限元法](https://zh.wikipedia.org/wiki/有限元法 "wikilink")（Finite
Element Method, FEM）、有限体积法（Finite Volume Method, FVM）和有限差分法（Finite
Difference Method,
FDM）。其中，有限元法占主要地位，尤其是它的高效高阶版本—。其它版本的有限元法还有：[广义有限元法](https://zh.wikipedia.org/wiki/广义有限元法 "wikilink")（Generalized

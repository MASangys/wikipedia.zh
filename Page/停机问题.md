**停机问题**（）是[逻辑数学中](../Page/数理逻辑.md "wikilink")[可计算性理论的一个问题](../Page/可计算性理论.md "wikilink")。通俗地说，停机问题就是判断任意一个[程序是否能在有限的时间之内结束运行的问题](https://zh.wikipedia.org/wiki/程序 "wikilink")。该问题等价于如下的判定问题：是否存在一个程序P，对于任意输入的程序w，能够判断w会在有限时间内结束或者死循环。

[艾伦·图灵在](../Page/艾伦·图灵.md "wikilink")1936年用[對角論證法证明了](../Page/對角論證法.md "wikilink")，不存在解决停机问题的通用算法。这个证明的关键在于对计算机和程序的数学定义，这被称为[图灵机](../Page/图灵机.md "wikilink")。停机问题在图灵机上是[不可判定问题](https://zh.wikipedia.org/wiki/不可判定的 "wikilink")。这是最早提出的[决定性问题之一](https://zh.wikipedia.org/wiki/决定性问题 "wikilink")。

用数学语言描述，则其本质问题为:
给定一个[图灵机](../Page/图灵机.md "wikilink")**T**，和一个任意语言[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")**S**，是否**T**会最终停机于每一个\(s \in S\)。其意义相同于可确定语言。显然任意有限
**S**
是[可判定性的](https://zh.wikipedia.org/wiki/可判定性 "wikilink")，可数的（countable）**S**
也是可停机的。

停机问题包含了[自我指涉](https://zh.wikipedia.org/wiki/自我指涉 "wikilink")，本质是[一阶逻辑的](../Page/一阶逻辑.md "wikilink")[不完备性](https://zh.wikipedia.org/wiki/不完备性 "wikilink")，类似的命题有[理发师悖论](../Page/理发师悖论.md "wikilink")、[全能悖论等](https://zh.wikipedia.org/wiki/全能悖论 "wikilink")。

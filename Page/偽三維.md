...
**Parallax mapping** (also called **offset mapping** or **virtual displacement mapping**) is an enhancement of the bump mapping and normal mapping techniques implemented by displacing the texture coordinates at a point on the rendered polygon by a function of the view angle in tangent space (the angle relative to the surface normal) and the value of the [height map](https://zh.wikipedia.org/wiki/height_map "wikilink") at that point. At steeper view-angles, the texture coordinates are displaced more, giving the illusion of depth due to [parallax](https://zh.wikipedia.org/wiki/parallax "wikilink") effects as the view changes.

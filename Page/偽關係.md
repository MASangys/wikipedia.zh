...
第三種情況就會發生偽關係。如果在統計上控制住C變數，A和B就不再相關。

## 迴歸現象與偽關係

當[迴歸分析中B隨A變化時](../Page/迴歸分析.md "wikilink")，實際因果關係可能如下：
...
兩者之間未必有因果關係。事實上，它們都和數据觀測之前9個月的天氣相關\[1\]。
  ...
  - 例三
    [跨性別科學家](../Page/跨性別.md "wikilink")[本·巴雷斯死於胰臟癌](https://zh.wikipedia.org/wiki/本·巴雷斯 "wikilink")，這搞不好是因為他為了[變性而長期施打男性賀爾蒙所致](../Page/變性.md "wikilink")。

**傅里叶变换**（、）是一种線性[积分变换](../Page/积分变换.md "wikilink")，用于信号在[时域](../Page/时域.md "wikilink")（或空域）和[频域之间的变换](../Page/频域.md "wikilink")，在[物理学和](../Page/物理学.md "wikilink")[工程学中有许多应用](../Page/工程学.md "wikilink")。因其基本思想首先由[法国学者](../Page/法国.md "wikilink")[约瑟夫·傅里叶系统地提出](../Page/约瑟夫·傅里叶.md "wikilink")，所以以其名字来命名以示纪念。实际上傅里叶变换就像化学分析，确定物质的基本成分；信号来自自然界，也可对其进行分析，确定其基本成分。\[1\]

经傅里叶变换生成的函数 \(\hat f\) 称作原函数 \(f\)
的傅里叶变换、亦称**[频谱](../Page/频谱.md "wikilink")**。在許多情況下，傅里叶变换是可逆的，即可通过
\(\hat f\) 得到其原函数 \(f\)。通常情况下，\(f\) 是[实数函数](../Page/实数.md "wikilink")，而
\(\hat f\)
则是[复数函数](../Page/复数.md "wikilink")，用一个复数来表示[振幅和](../Page/振幅.md "wikilink")[相位](../Page/相位.md "wikilink")。

“傅里叶变换”一词既指变换操作本身（将函数 \(f\) 进行傅里叶变换），又指该操作所生成的复数函数（\(\hat f\) 是 \(f\)
的傅里叶变换）。
...
自变量*x*表示*时间*（以秒为单位），变换变量*ξ*表示[频率](../Page/频率.md "wikilink")（以[赫兹为单位](../Page/赫兹.md "wikilink")）。在适当条件下，\(\hat f\)可由**逆变换**（inverse
Fourier transform）由下式确定\(f\)：

\[f(x) = \int_{-\infty}^\infty \hat f(\xi)\ e^{2 \pi i \xi x}\,d\xi\]，*x*为任意实数。

[傅里叶逆定理提出](../Page/傅里叶逆定理.md "wikilink")\(f\)可由\(\hat f\)确定，[傅里叶在其](../Page/约瑟夫·傅里叶.md "wikilink")1822年出版的著作《热分析理论》（）中首次引入这个定理。虽然现在标准下的证明直到很久以后才出现。\(f\)和\(\hat{f}\)常常被称为*傅里叶积分对*
或*傅里叶变换对*。
...
傅里叶变换源自对[傅里叶级数的研究](../Page/傅里叶级数.md "wikilink")。在对傅里叶级数的研究中，复杂的[周期函数可以用一系列简单的](../Page/周期函数.md "wikilink")[正弦](../Page/正弦.md "wikilink")、[余弦波之和表示](../Page/余弦.md "wikilink")。傅里叶变换是对傅里叶级数的扩展，由它表示的函数的周期趋近于无穷。
...
傅里叶变换在[醫學](../Page/醫學.md "wikilink")、[数据科学](../Page/数据科学.md "wikilink")、[物理学](../Page/物理学.md "wikilink")、[声学](../Page/声学.md "wikilink")、[光学](../Page/光学.md "wikilink")、[结构动力学](../Page/结构动力学.md "wikilink")、[量子力學](../Page/量子力學.md "wikilink")、[数论](../Page/数论.md "wikilink")、[组合数学](../Page/组合数学.md "wikilink")、[概率论](../Page/概率论.md "wikilink")、[统计学](../Page/统计学.md "wikilink")、[訊号处理](../Page/信号处理.md "wikilink")、[密码学](../Page/密码学.md "wikilink")、[海洋学](../Page/海洋学.md "wikilink")、[通讯](../Page/通讯.md "wikilink")、[金融等领域都有着广泛的应用](../Page/金融.md "wikilink")。例如在訊号处理中，傅里叶变换的典型用途是将訊号分解成[振幅分量和](../Page/振幅.md "wikilink")[频率分量](../Page/频率.md "wikilink")。

## 基本性质

### 线性性质

两函数之和的傅里叶变换等于各自变换之和。数学描述是：若函数\(f \left( x\right )\)和\(g \left(x \right)\)的傅里叶变换\(\mathcal{F}[f]\)和\(\mathcal{F}[g]\)都存在，\(\alpha\)和\(\beta\)为任意常系数，则\(\mathcal{F}[\alpha f+\beta g]=\alpha\mathcal{F}[f]+\beta\mathcal{F}[g]\)；傅里叶变换算符\(\mathcal{F}\)可经[归一化成为](../Page/归一化.md "wikilink")[幺正算符](../Page/幺正算符.md "wikilink")。

### 平移性质

若函数\(f \left( x\right )\)存在傅里叶变换，则对任意[实数](../Page/实数.md "wikilink")\(\omega_{0}\)，函数\(f(x) e^{i \omega_{0} x}\)也存在傅里叶变换，且有\(\mathcal{F}[f(x)e^{i \omega_{0} x}]=F(\omega - \omega _0 )\)。式中花体\(\mathcal{F}\)是傅里叶变换的作用[算子](../Page/算子.md "wikilink")，平体\(F\)表示变换的结果（复函数），\(e\)为[自然对数的底](../Page/自然对数.md "wikilink")，\(i\)为[虚数单位](../Page/虚数.md "wikilink")\(\sqrt{-1}\)。

### [微分关系](../Page/微分.md "wikilink")

若函数\(f \left( x\right )\)当\(|x|\rightarrow\infty\)时的[极限为](../Page/函數極限.md "wikilink")0，而其导函数\(f'(x)\)的傅里叶变换存在，则有\(\mathcal{F}[f'(x)]= i \omega \mathcal{F}[f(x)]\)，即导函数的傅里叶变换等于原函数的傅里叶变换乘以因子\(i\omega\)。更一般地，若\(f(\pm\infty)=f'(\pm\infty)=\ldots=f^{(k-1)}(\pm\infty)=0\)，且\(\mathcal{F}[f^{(k)}(x)]\)存在，则\(\mathcal{F}[f^{(k)}(x)]=( i \omega)^{k} \mathcal{F}[f]\)，即*k*阶[导数的傅里叶变换等于原函数的傅里叶变换乘以因子](../Page/导数.md "wikilink")\(( i \omega)^{k}\)。

### [卷积特性](../Page/卷积.md "wikilink")

若函数\(f \left( x\right )\)及\(g \left( x\right )\)都在\((-\infty,+\infty)\)上[绝对可积](../Page/绝对可积.md "wikilink")，则卷积函数\(f*g=\int_{-\infty}^{+\infty} f(x-\xi)g(\xi)d\xi\)（或者\(f*g=\int_{-\infty}^{+\infty} f(\xi)g(x-\xi)d\xi\)）的傅里叶变换存在，且\(\mathcal{F}[f*g]=\mathcal{F}[f]\cdot\mathcal{F}[g]\)。卷积性质的逆形式为\(\mathcal{F}^{-1}[F(\omega)*G(\omega)]=2\pi\mathcal{F}^{-1}[F(\omega)]\cdot\mathcal{F}^{-1}[G(\omega)]\)，即两个函数卷积的傅里叶逆变换等于它们各自的傅里叶逆变换的乘积乘以\(2\pi\)。

### [帕塞瓦尔定理](../Page/帕塞瓦尔定理.md "wikilink")

若函数\(f \left( x\right )\)[可积且平方可积](../Page/可积.md "wikilink")，则\(\int_{-\infty}^{+\infty} f^2 (x)dx = \frac{1}{2\pi}\int_{-\infty}^{+\infty} |F(\omega)|^{2}d\omega\)。其中\(F \left( \omega \right)\)是\(f \left( x \right)\)的傅里叶变换。

更一般化而言，若函数\(f \left( x\right )\)和\(g \left( x\right )\)皆為[平方可積函數](../Page/平方可積函數.md "wikilink")，则\(\int_{-\infty}^{+\infty} f(x)g^{*}(x) dx = \frac{1}{2\pi}\int_{-\infty}^{+\infty} F(\omega)G^{*}(\omega)d\omega\)。其中\(F \left( \omega \right)\)和\(G \left( \omega \right)\)分别是\(f \left( x \right)\)和\(g \left( x \right)\)的傅里叶变换,
\(*\)代表[複共軛](../Page/複共軛.md "wikilink")。

## 傅里叶变换的不同变种

傅里叶变换也可以写成[角频率形式](../Page/角频率.md "wikilink")：
2*πξ*}}其单位是[弧度每秒](../Page/弧度.md "wikilink")。
...
若不按照本文中使用的，而像这样定义傅里叶变换，那它将不再是*L*<sup>2</sup>(**R**<sup>*n*</sup>)上的一个酉变换
...
[傅里叶分析最初是研究](../Page/傅里叶分析.md "wikilink")[周期性现象](../Page/週期.md "wikilink")，即傅里叶级数的，后来通过傅里叶变换将其推广到了非周期性现象。理解这种推广过程的一种方式是将非周期性现象视为周期性现象的一个特例，即其[周期为无限长](../Page/周期.md "wikilink")。
...
为了在科学计算和[数字信号处理等领域使用计算机进行傅里叶变换](../Page/数字信号处理.md "wikilink")，必须将函数*x*<sub>*n*</sub>定义在*离散*点而非连续域内，且须满足[有限性或](../Page/有限性.md "wikilink")[周期性条件](../Page/周期性.md "wikilink")。这种情况下，使用离散傅里叶变换，将函数*x*<sub>*n*</sub>表示为下面的求和形式：

\[x_n = \sum_{k=0}^{N-1} X_k e^{-i\frac{2\pi}{N} kn} \qquad n = 0,\dots,N-1\]

其中\(X_k\)是傅里叶振幅。直接使用这个公式计算的[计算复杂度为](../Page/计算复杂度.md "wikilink")\(\mathcal{O}(n^2)\)，而[快速傅里叶变换](../Page/快速傅里叶变换.md "wikilink")（FFT）可以将复杂度改进为\(\mathcal{O}(n \log n)\)。计算复杂度的降低以及数字电路计算能力的发展使得DFT成为在信号处理领域十分实用且重要的方法。

### 在阿贝尔群上的统一描述

以上各种傅里叶变换可以被更统一的表述成任意[局部紧致的](../Page/紧性.md "wikilink")[阿贝尔群上的傅里叶变换](../Page/阿贝尔群.md "wikilink")。这一问题属于[调和分析的范畴](../Page/调和分析.md "wikilink")。在调和分析中，一个变换从一个群变换到它的[对偶群](../Page/对偶群.md "wikilink")（dual
group）。此外，将傅里叶变换与卷积相联系的卷积定理在调和分析中也有类似的结论。傅里叶变换的广义理论基础参见[龐特里亞金對偶性](../Page/龐特里亞金對偶性.md "wikilink")（Pontryagin
duality）中的介绍。

### 时频分析变换

[小波变换](../Page/小波变换.md "wikilink")，[chirplet轉換和](../Page/chirplet轉換.md "wikilink")[分数傅里叶变换试图得到时间信号的频率信息](../Page/分数傅里叶变换.md "wikilink")。同时解析频率和时间的能力在数学上受[不确定性原理的限制](../Page/不确定性原理.md "wikilink")。
...
下面的表记录了一些封闭形式的傅立叶变换。对于函数*f*(*x*),
*g*(*x*)和*h*(*x*)，它们的傅立叶变换分别表示为\(\hat{f}\),
\(\hat{g}\)
和\(\hat{h}\)。只包含了三种最常见的形式。注意条目105给出了一个函数的傅里叶变换与其原函数，这可以看作是傅里叶变换及其逆变换的关系。
...
<td><p>埃尔米特对称。<span class="math inline">$\displaystyle \overline{z}\,$</span>表示<a href="../Page/复共轭.md" title="wikilink">复共轭</a>。</p></td>
</tr>
<tr class="even">
<td><p>111</p></td>
<td><p>当<span class="math inline"><em>f</em>(<em>x</em>)</span>是实<a href="../Page/偶函数.md" title="wikilink">偶函数</a></p></td>
<td><p><span class="math inline"><em>f̂</em>(<em>ω</em>)</span>, <span class="math inline"><em>f̂</em>(<em>ξ</em>)</span>和<span class="math inline"><em>f̂</em>(<em>ν</em>) </span>都是实<a href="../Page/偶函数.md" title="wikilink">偶函数</a>。</p></td>
<td></td>
<td></td>
<td></td>
</tr>
<tr class="odd">
<td><p>112</p></td>
<td><p>当<span class="math inline"><em>f</em>(<em>x</em>)</span>是实<a href="../Page/奇函数.md" title="wikilink">奇函数</a></p></td>
<td><p><span class="math inline"><em>f̂</em>(<em>ω</em>)</span>, <span class="math inline"><em>f̂</em>(<em>ξ</em>)</span>和<span class="math inline"><em>f̂</em>(<em>ν</em>)</span>都是<a href="../Page/虚数.md" title="wikilink">虚</a><a href="../Page/奇函数.md" title="wikilink">奇函数</a>。</p></td>
<td></td>
<td></td>
<td></td>
</tr>
...
<td><p><a href="../Page/复共轭.md" title="wikilink">复共轭</a>，110的一般化</p></td>
</tr>
</tbody>
</table>
...
<td><p><a href="../Page/矩形脉冲.md" title="wikilink">矩形脉冲和归一化的</a><a href="../Page/sinc函数.md" title="wikilink">sinc函数</a></p></td>
</tr>
<tr class="odd">
<td><p>11</p></td>
...
<td><p>变换10的频域对应。矩形函数是理想的低通滤波器，<a href="../Page/sinc函数.md" title="wikilink">sinc函数是这类滤波器对</a><a href="../Page/反因果系统.md" title="wikilink">反因果冲击的响应</a>。</p></td>
</tr>
<tr class="even">
<td><p>12</p></td>
...
<td><p><em>tri</em>是<a href="../Page/三角形函数.md" title="wikilink">三角形函数</a></p></td>
</tr>
<tr class="odd">
<td><p>13</p></td>
...
<td><p><a href="../Page/光学.md" title="wikilink">光学领域应用较多</a></p></td>
</tr>
<tr class="even">
<td><p>16</p></td>
...
<td><p><span class="math inline"><em>δ</em>(<em>ω</em>)</span>代表<a href="../Page/狄拉克δ函数.md" title="wikilink">狄拉克δ函数分布</a>.这个变换展示了狄拉克δ函数的重要性：该函数是常函数的傅立叶变换</p></td>
</tr>
<tr class="odd">
<td><p>24</p></td>
...
<td><p>——有助于解释或理解从连续到<a href="../Page/离散时间.md" title="wikilink">离散时间的转变</a>.</p></td>
</tr>
</tbody>
</table>
...
*400：*
变量*ξ<sub>x</sub>*、*ξ<sub>y</sub>*、*ω<sub>x</sub>*、*ω<sub>y</sub>*、*ν<sub>x</sub>*和*ν<sub>y</sub>*为实数。
对整个平面积分。

*401：* 这两个函数都是高斯分布，而且可能不具有单位体积。

*402：* 此圆有单位半径，如果把circ（t）认作阶梯函数u(1-t);
Airy分布用J<sub>1</sub>（1阶[第一类贝塞尔函数](../Page/贝塞尔函数#第一类贝塞尔函数.md "wikilink")）表达。
...
## 外部連結
  ...
  - [Brad G. Osgood : The Fourier Transform and its Applications (video
    lectures)](http://academicearth.org/courses/the-fourier-transform-and-its-applications)

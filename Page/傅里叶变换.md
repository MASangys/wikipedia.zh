...
经傅里叶变换生成的函数 \(\hat f\) 称作原函数 \(f\) 的傅里叶变换、亦称**[频谱](../Page/频谱.md "wikilink")**。在許多情況下，傅里叶变换是可逆的，即可通过 \(\hat f\) 得到其原函数 \(f\)。通常情况下，\(f\) 是[实数](../Page/实数.md "wikilink")函数，而 \(\hat f\) 则是[复数函数](https://zh.wikipedia.org/wiki/复数 "wikilink")，用一个复数来表示[振幅和](https://zh.wikipedia.org/wiki/振幅 "wikilink")[相位](https://zh.wikipedia.org/wiki/相位 "wikilink")。

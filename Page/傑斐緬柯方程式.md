在[電磁學裏](../Page/電磁學.md "wikilink")，給予含時[電荷密度分佈和](../Page/電荷密度.md "wikilink")[電流密度分佈](../Page/電流密度.md "wikilink")，可以使用**傑斐緬柯方程式**（Jefimenko
equation）來計算[電場和](../Page/電場.md "wikilink")[磁場](../Page/磁場.md "wikilink")。這方程式因其發現者物理學家而命名\[1\]。傑斐緬柯方程式是[馬克士威方程組對於這些電荷密度分佈和電流密度分佈的解答](../Page/馬克士威方程組.md "wikilink")\[2\]\[3\]。
...
在[真空內](../Page/真空.md "wikilink")，電場\(\mathbf{E}\)和磁場\(\mathbf{B}\)可以用傑斐緬柯方程式表達為：
...
其中，\(\mathbf{r}\)是場位置，\(\mathbf{r}'\)是源位置，\(t\)是現在[時間](../Page/時間.md "wikilink")，\(t_r\)是[推遲時間](../Page/推遲時間.md "wikilink")，\(\epsilon_0\)是[電常數](../Page/電常數.md "wikilink")，\(\mu_0\)是[磁常數](../Page/磁常數.md "wikilink")，\(\rho\)是[電荷密度](../Page/電荷密度.md "wikilink")，\(\dot{\rho}\ \stackrel{def}{=}\ \frac{\partial\rho}{\partial t}\)定義為電荷密度對於時間的[偏導數](../Page/偏導數.md "wikilink")，\(\mathbf{J}\)是[電流密度](../Page/電流密度.md "wikilink")，\(\dot{\mathbf{J}}\ \stackrel{def}{=}\ \frac{\partial\mathbf{J}}{\partial t}\)定義為電流密度對於時間的[偏導數](../Page/偏導數.md "wikilink")，\(\mathcal{V}'\)是體積分的空間，\(d^3\mathbf{r}'\)是微小體元素。
...
推遲時間\(t_r\)定義為現在時間\(t\)減去[光波傳播的時間](../Page/光波.md "wikilink")：
...
對於任意介質，將前面所述電場和磁場的方程式加以延伸\[4\]，可以從電荷密度\(\rho\)、電流密度\(\mathbf{J}\)、[電極化強度](../Page/電極化強度.md "wikilink")\(\mathbf{P}\)、[磁化强度](../Page/磁化强度.md "wikilink")\(\mathbf{M}\)，計算出電場\(\mathbf{E}\)、[電位移](../Page/電位移.md "wikilink")\(\mathbf{D}\)、[磁感應強度](../Page/磁感應強度.md "wikilink")\(\mathbf{B}\)、[磁場強度](../Page/磁場強度.md "wikilink")\(\mathbf{H}\)。

...
泰老民族按照地区和文化的不同，有各自的称呼，可以划分为30多个群体，主要的是：</br>
Shan（[掸族](../Page/掸族.md "wikilink")/Tai Long傣龙）（Tai Yai
傣亚/花腰傣、Tai Nüa 傣那/花腰傣）；</br> Khamti、Tai Laing、Tai Phake、Tai
Aiton、Khamyang、Ahom、Turung（以上为7支为印度和印缅边境）</br>
Laos（老族，老族又有6个支系老龙、老允、老康等等）、Lao
Isan（泰国伊桑地区老族）、Nyaw（泰国伊桑地区）、Phu Thai（普泰，泰国伊桑地区和老挝中部）</br> Tai
Dam（黑傣）、Tai
Dón（[白泰](https://zh.wikipedia.org/wiki/白泰 "wikilink")）、Tai
Daeng（[红泰](https://zh.wikipedia.org/wiki/红泰 "wikilink")）、Phuan（傣Phuan）、Thai
Song（松）</br> Tai
Yuan（[傣沅](https://zh.wikipedia.org/wiki/傣沅 "wikilink")）、Tai
Lü（[傣泐](https://zh.wikipedia.org/wiki/傣泐 "wikilink")）、Khun（）</br>
Siamese（暹罗泰族）、Southern Thai（泰国南部泰族）、Khorat（克拉泰族）</br>

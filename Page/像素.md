...
256色或者更少的色彩的影像经常以[块或](https://zh.wikipedia.org/wiki/块 "wikilink")[平面](../Page/平面.md "wikilink")格式存储于顯示記憶體中，其中顯示記憶體的每个像素是到一个称为[调色板的颜色代碼的索引值](https://zh.wikipedia.org/wiki/调色板 "wikilink")。这些模式因而有时被称为*索引*模式。虽然每次只有256色，但是这256种可以选自一个通常是16-{zh-hans:兆; zh-hant:百萬;}-色的调色板，所以可以有多種組合。改变调色板中的色彩值可以得到一种动画效果，[Windows 95和](../Page/Windows_95.md "wikilink")[Windows 98的标志可能是这类动画最著名的例子了](../Page/Windows_98.md "wikilink")。

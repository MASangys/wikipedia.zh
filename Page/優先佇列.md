...
有一些特殊的[堆为优先队列的实现提供了额外的性能](https://zh.wikipedia.org/wiki/堆_\(数据结构\) "wikilink")：[二叉堆](../Page/二叉堆.md "wikilink")的插入与提取操作的时间复杂度为*O*(log
*n*)，并可以常量时间复杂度的peek操作。[二项堆](../Page/二项堆.md "wikilink")提供了几种额外操作。[斐波那契堆](../Page/斐波那契堆.md "wikilink")的插入、提取、修改元素优先级等操作具有[分摊常量时间复杂度](../Page/平摊分析.md "wikilink")，\[1\]，但删除操作的时间复杂度为*O*(log

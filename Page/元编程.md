...
另一个很常用的元编程例子是[lex和](https://zh.wikipedia.org/wiki/lex "wikilink")[yacc](https://zh.wikipedia.org/wiki/yacc "wikilink")，这两个工具用来生成[词法分析](../Page/词法分析.md "wikilink")器和[语法分析器](https://zh.wikipedia.org/wiki/语法分析 "wikilink")。Yacc通常用作编译器的编译器，生成能够将高级语言转换为机器语言的工具。

[自产生程式是一种源代码等于输出的特殊的元程序](https://zh.wikipedia.org/wiki/自产生程式 "wikilink")。[面向语言的程序设计](../Page/面向语言的程序设计.md "wikilink")是一种强烈关注元编程的编程风格，通过[领域特定语言来实现](https://zh.wikipedia.org/wiki/领域特定语言 "wikilink")。

## 宏用于产生式编程

[IBM
System/360及其衍生物拥有强大的汇编宏工具](https://zh.wikipedia.org/wiki/System/360 "wikilink")，通常用于生成完整的程序或者程序片段（比如针对不同操作系统）。[CICS](https://zh.wikipedia.org/wiki/CICS "wikilink")[事务处理](../Page/事务处理.md "wikilink")系统也提供了汇编宏，可以生成用于预处理阶段的COBOL语句。

...
2.  **[並網逆變器](https://zh.wikipedia.org/wiki/並網逆變器 "wikilink")**（Grid-tie inverters）：逆變器的輸出電壓可以回送到商用交流電源，因此輸出[弦波需要和電源的](https://zh.wikipedia.org/wiki/弦波 "wikilink")[相位](https://zh.wikipedia.org/wiki/相位 "wikilink")、[頻率及](https://zh.wikipedia.org/wiki/頻率 "wikilink")[電壓](../Page/電壓.md "wikilink")相同。並網逆變器會有安全設計，若未連接到電源，會自動關閉輸出。若電網電源跳電，並網逆變器沒有備存供電的機能。

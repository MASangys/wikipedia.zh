...
若一正整數的[質因數](../Page/質因數.md "wikilink")均不大於<var>B</var>，此整數即為<var>B</var>-光滑數。例如1620的因數分解為2<sup>2</sup>
...
有些[快速傅里叶变换](../Page/快速傅里叶变换.md "wikilink")演算法中會用到光滑數，例如[库利－图基快速傅里叶变换算法](../Page/库利－图基快速傅里叶变换算法.md "wikilink")會將問題一直分解為較小的問題，其大小為原問題大小的因數，若原問題大小是*B*原問題大小，原問題可以分解為許多很小的問題，此情形有有快速的演算法，若大小是較大的質數，就要應用像是[Chirp-Z

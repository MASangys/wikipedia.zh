**光滑數**（），或译**脆数**\[1\]，是一個可以[因數分解為小](https://zh.wikipedia.org/wiki/因數分解 "wikilink")[質數乘積的](https://zh.wikipedia.org/wiki/質數 "wikilink")[正整數](https://zh.wikipedia.org/wiki/正整數 "wikilink")。光滑數一詞是是[伦纳德·阿德曼所提出](../Page/伦纳德·阿德曼.md "wikilink")\[2\]。光滑數在以因數分解為基礎的[密码学中扮演重要角色](../Page/密码学.md "wikilink")。
...
numbers）。7-光滑數有時會稱為「謙虛數」或「高合成數」\[3\]，不過後者會和以因數個數來定義的[高合成數混淆](https://zh.wikipedia.org/wiki/高合成數 "wikilink")。
...
5-光滑數〈或稱為[正規數](../Page/正规数_\(整数\).md "wikilink")〉在[巴比倫數學中有重要的角色](https://zh.wikipedia.org/wiki/巴比倫數學 "wikilink")\[4\]，在[音樂理論中也很重要](https://zh.wikipedia.org/wiki/音樂理論 "wikilink")\[5\]。有一個[函數程式語言的問題就是要產生正規數](https://zh.wikipedia.org/wiki/函數程式語言 "wikilink")\[6\]。

> 本文内容由[克劳森函数](https://zh.wikipedia.org/wiki/克劳森函数)转换而来。


[Clausen_function.png](https://zh.wikipedia.org/wiki/File:Clausen_function.png "fig:Clausen_function.png") **克劳森函数**是[丹麦](https://zh.wikipedia.org/wiki/丹麦 "wikilink")[数学家](../Page/数学家.md "wikilink")最先研究的[特殊函数](https://zh.wikipedia.org/wiki/特殊函数 "wikilink")，定义如下：

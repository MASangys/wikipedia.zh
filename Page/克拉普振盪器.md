**克拉普振盪器**是一種由[電晶體](https://zh.wikipedia.org/wiki/電晶體 "wikilink")（或[真空管](../Page/真空管.md "wikilink")）與一組正[反馈電路組成的](../Page/反馈.md "wikilink")[振盪器](https://zh.wikipedia.org/wiki/振盪器 "wikilink")。

它由在1948年发表。\[1\] 根据Vačkář的文献，\[2\]
此类振荡器是几个发明者自主开发的，其中由[Gouriet开发的那个振荡器从](https://zh.wikipedia.org/wiki/Geoffrey_G._Gouriet "wikilink")1938年就一直在[BBC工作](https://zh.wikipedia.org/wiki/BBC "wikilink")。

[Clapp_oscillator.png](https://zh.wikipedia.org/wiki/File:Clapp_oscillator.png "fig:Clapp_oscillator.png")
根據下圖可知此電路使用1個[電感與](https://zh.wikipedia.org/wiki/電感 "wikilink")3個[電容](../Page/電容.md "wikilink")，其中的2個電容（C1及C2）用來分壓以決定施於電晶體輸入端的回授電壓。克拉普振盪器是以[Colpitts振盪器為基礎](../Page/Colpitts振盪器.md "wikilink")，在原本的電感前多串聯1個電容。下圖中使用[場效電晶體的振壓器電路的振盪頻率](https://zh.wikipedia.org/wiki/場效電晶體 "wikilink")（單位為赫茲）是：
...
在設計使用1個可變電容調整頻率的[變頻振盪器](https://zh.wikipedia.org/wiki/變頻振盪器 "wikilink")（Variable
Frequency
...
1.  J. K. Clapp, "An inductance-capacitance oscillator of unusual
    frequency stability", [Proc.
    IRE](https://zh.wikipedia.org/wiki/Proc._IRE "wikilink"), vol. 367,
    pp. 356-358, Mar. 1948.

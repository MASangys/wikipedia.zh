...
The definition of Kleene star is found in virtually every textbook on automata theory. A standard reference is the following:
  ...
  - [John Hopcroft](https://zh.wikipedia.org/wiki/:en:John_Hopcroft "wikilink") and [Jeffrey D. Ullman](https://zh.wikipedia.org/wiki/:en:Jeffrey_Ullman "wikilink"). Introduction to Automata Theory Languages and Computation. 1st edition. Addison-Wesley Publishing Company, 1979.

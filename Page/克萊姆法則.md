**克萊姆法則**（），又稱為**克拉瑪公式**，是一個[線性代數中的](../Page/線性代數.md "wikilink")[定理](../Page/定理.md "wikilink")，用[行列式來計算出線性等式組中的所有解](../Page/行列式.md "wikilink")。這個定理因[加百列·克萊姆](../Page/加布里爾·克拉默.md "wikilink")（1704年
- 1752年）的卓越使用而命名。在計算上，並非最有效率之法，所以在很多條等式的情況中沒有廣泛應用。不過，這定理在理論性方面十分有用。

## 基本方程

一個線性方程組可以用[矩陣与](../Page/矩陣.md "wikilink")[向量的方程來表示](../Page/向量.md "wikilink")：
...
其中的\(A\)是一个\(n \times n\)的[方塊矩陣](../Page/方塊矩陣.md "wikilink")，而向量
\(x=( x_1, x_2, \cdots x_n )^T\)
是一个长度为**n**的[列向量](../Page/列向量.md "wikilink")。\(c=( c_1, c_2, \cdots c_n )^T\)
也一样。

克莱姆法则说明：如果\(A\)是一个[可逆矩陣](../Page/可逆矩陣.md "wikilink")（ \(\det{A} \neq 0\)
），那么方程(1)有解 \(x=( x_1, x_2, \cdots x_n )^T\)，其中
...
考虑\(\Delta_i\)的值，利用[行列式的](../Page/行列式.md "wikilink")[線性和交替性質](../Page/線性.md "wikilink")，有
...
用3×3[矩陣的情況亦差不多](../Page/矩陣.md "wikilink")。
...
**克萊姆法則**在解決[微分幾何的问题时十分有用](../Page/微分幾何.md "wikilink")。
...
用兩個[雅可比矩陣來表示的方程](../Page/雅可比矩陣.md "wikilink")：
...
**克萊姆法則**可以用來證明一些線性代數中的定理，當中的定理對[環理論十分有用](../Page/環理論.md "wikilink")。

### 線性規劃上的應用

**克萊姆法則**可以用來證明一個[線性規劃問題有一個基本](../Page/線性規劃.md "wikilink")[整數的解](../Page/整數.md "wikilink")。這樣使得線性規劃的問題更容易被解決。

## 外部链接

  - [Online calculator to solve a system of ecuations using the Cramer's
    Rule](https://web.archive.org/web/20170421111458/http://www.algebrasolver.totalh.com/)

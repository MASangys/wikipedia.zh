**克萊姆法則**（），又稱為**克拉瑪公式**，是一個[線性代數中的](https://zh.wikipedia.org/wiki/線性代數 "wikilink")[定理](../Page/定理.md "wikilink")，用[行列式來計算出線性等式組中的所有解](../Page/行列式.md "wikilink")。這個定理因[加百列·克萊姆](https://zh.wikipedia.org/wiki/加布里爾·克拉默 "wikilink")（1704年
- 1752年）的卓越使用而命名。在計算上，並非最有效率之法，所以在很多條等式的情況中沒有廣泛應用。不過，這定理在理論性方面十分有用。

## 基本方程

一個線性方程組可以用[矩陣与](https://zh.wikipedia.org/wiki/矩陣 "wikilink")[向量的方程來表示](../Page/向量.md "wikilink")：
...
其中的\(A\)是一个\(n \times n\)的[方塊矩陣](https://zh.wikipedia.org/wiki/方塊矩陣 "wikilink")，而向量
\(x=( x_1, x_2, \cdots x_n )^T\)
是一个长度为**n**的[列向量](https://zh.wikipedia.org/wiki/列向量 "wikilink")。\(c=( c_1, c_2, \cdots c_n )^T\)
也一样。

克莱姆法则说明：如果\(A\)是一个[可逆矩陣](https://zh.wikipedia.org/wiki/可逆矩陣 "wikilink")（
...
考虑\(\Delta_i\)的值，利用[行列式的](../Page/行列式.md "wikilink")[線性和交替性質](https://zh.wikipedia.org/wiki/線性 "wikilink")，有

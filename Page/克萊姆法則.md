**克萊姆法則**（），又稱為**克拉瑪公式**，是一個[線性代數中的](https://zh.wikipedia.org/wiki/線性代數 "wikilink")[定理](../Page/定理.md "wikilink")，用[行列式](../Page/行列式.md "wikilink")來計算出線性等式組中的所有解。這個定理因[加百列·克萊姆](https://zh.wikipedia.org/wiki/加布里爾·克拉默 "wikilink")（1704年 - 1752年）的卓越使用而命名。在計算上，並非最有效率之法，所以在很多條等式的情況中沒有廣泛應用。不過，這定理在理論性方面十分有用。
...
[Category:線性代數](https://zh.wikipedia.org/wiki/Category:線性代數 "wikilink") [Category:代数定理](https://zh.wikipedia.org/wiki/Category:代数定理 "wikilink")
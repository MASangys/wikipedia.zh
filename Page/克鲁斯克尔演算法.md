**Kruskal演算法**是一種用來尋找[最小生成樹的演算法](../Page/最小生成樹.md "wikilink")，由Joseph
Kruskal在1956年發表。用來解決同樣問題的還有[Prim演算法和](../Page/Prim演算法.md "wikilink")等。三種演算法都是[贪心算法的應用](../Page/贪心法.md "wikilink")。和Boruvka演算法不同的地方是，Kruskal演算法在圖中存在相同權值的邊時也有效。

[Difference_Between_Halfwidth_and_Fullwidth.png](https://zh.wikipedia.org/wiki/File:Difference_Between_Halfwidth_and_Fullwidth.png "fig:Difference_Between_Halfwidth_and_Fullwidth.png")

**全角**和**半角**，是[计算机中](https://zh.wikipedia.org/wiki/计算机 "wikilink")，[中](https://zh.wikipedia.org/wiki/中文 "wikilink")、[日](https://zh.wikipedia.org/wiki/日語 "wikilink")、[韩文的](https://zh.wikipedia.org/wiki/韩文 "wikilink")[CJKV字符的显示格式](https://zh.wikipedia.org/wiki/CJKV "wikilink")。

传统上，[英语或](../Page/英语.md "wikilink")[拉丁字母语言使用的](../Page/拉丁字母.md "wikilink")[电脑系统](https://zh.wikipedia.org/wiki/电脑 "wikilink")，每一个[字母或](../Page/字母.md "wikilink")[符号](../Page/符号.md "wikilink")，都是使用一[字节的空间](../Page/字节.md "wikilink")（一[字节由](../Page/字节.md "wikilink")8[位元組成](../Page/位元.md "wikilink")，共256个编码空间）来储存；而[汉语](../Page/汉语.md "wikilink")、[日语及](../Page/日语.md "wikilink")[韩语文字](https://zh.wikipedia.org/wiki/韩语 "wikilink")，由于数量大大超过256个，故惯常使用两字节来储存一个字符。在使用[等宽字体](../Page/等宽字体.md "wikilink")（如[DOS](../Page/DOS.md "wikilink")、部分文字编辑器等）的环境下，中日韩文字此时占据两倍于西文字符的显示宽度。所以，中、日、韩等文字称为全形字符，相比起来，拉丁字母或数字就称为半形字符。有时为了使[字体看起来齐整](../Page/字体.md "wikilink")，英文字母、数字及其他符号也由原来只占一个字空间，改为占用两个字的空间显示、使用两个字节储存的格式。

[JIS X
0201编码表把日语的](../Page/JIS_X_0201.md "wikilink")[片假名放进一字节的空间](../Page/片假名.md "wikilink")，故又称为“[半角片假名](https://zh.wikipedia.org/wiki/半角片假名 "wikilink")”。
...
[OpenType有](../Page/OpenType.md "wikilink")`fwid`、`halt`、`hwid`和`vhal`功能标签来提供字符的全角或半角形式。
...
## 外部链接
  ...
  - [East Asian Width](http://www.unicode.org/reports/tr11/tr11-31.html)

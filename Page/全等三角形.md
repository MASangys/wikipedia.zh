...
下列五種方法均可驗證全等三角形：
  ...
  - **RHS**（Right
    angle-Hypotenuse-Side，直角、斜邊、邊，又称**HL**（斜边、直角边）；斜股性質）：在一对[直角三角形](../Page/直角三角形.md "wikilink")中，斜邊及另一條直角邊相等。
...
此时两角夹一边已知，通过三角形内角和得到第三角后用[正弦定理](../Page/正弦定理.md "wikilink")计算剩下两边。
...
[勾股定理](../Page/勾股定理.md "wikilink")或是直接連兩边的頂端解出剩下一边，即变成
SSS或SAS。

[Probability_venn_event.svg](https://zh.wikipedia.org/wiki/File:Probability_venn_event.svg "fig:Probability_venn_event.svg") [数学](../Page/数学.md "wikilink")上，特别是在[集合论](../Page/集合论.md "wikilink")和[数学基础](../Page/数学基础.md "wikilink")的应用中，**全类**（若是集合，则为**全集**）大约是这样一个类，它（在某种程度上）包含了所有的研究对象和[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")。

...
从物理意义上讲，第一项\(\left(\frac{1}{r}\right)^{12}\)可认为是对应于两体在近距离时以互相排斥为主的作用，第二项\(\left(\frac{1}{r}\right)^{6}\)对应两体在远距离以互相吸引（例如通过[范德瓦耳斯力](https://zh.wikipedia.org/wiki/范德瓦耳斯力 "wikilink")）为主的作用，而此六次方項也的確可以使用以電子-原子核的電偶極矩[微擾展開得到](https://zh.wikipedia.org/wiki/微擾理論 "wikilink")。但讀者尤須記住，兰纳-琼斯势本身只是一个近似公式。

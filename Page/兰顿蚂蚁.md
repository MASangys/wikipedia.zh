...
**兰顿蚂蚁**（英語：Langton's
ant）是[细胞自动机的例子](https://zh.wikipedia.org/wiki/细胞自动机 "wikilink")。它由[克里斯托夫·兰顿在](https://zh.wikipedia.org/wiki/克里斯托夫·兰顿 "wikilink")1986年提出，它由黑白格子和一只“蚂蚁”构成\[1\]，是一个二维[图灵机](../Page/图灵机.md "wikilink")。兰顿蚂蚁拥有非常简单的逻辑和复杂的表现。在2000年兰顿蚂蚁的[图灵完备性被证明](https://zh.wikipedia.org/wiki/图灵完备性 "wikilink")。兰顿蚂蚁的想法后来被推广，比如使用多种颜色。

## 规则

[LangtonsAntAnimated.gif](https://zh.wikipedia.org/wiki/File:LangtonsAntAnimated.gif "fig:LangtonsAntAnimated.gif")
...
Image:LangtonsAnt-nColor_RRLLLRLLLRRR_32734.png|RRLLLRLLLRRR:
生成一个移动并生长的实心三角形. Image:CA3061-81k7.png|L2NNL1L2L1:
六边形循环生长. Image:CA174906.png|L1L2NUL2L1R2: 六边形螺旋生长. Image:CA50338
animation.gif|R1R2NUR2R1L2: 动画.

在[数值线性代数中](../Page/数值线性代数.md "wikilink")，[共轭梯度法是一种求解](../Page/共轭梯度法.md "wikilink")[对称](../Page/对称矩阵.md "wikilink")[正定](../Page/正定矩阵.md "wikilink")[线性方程组](../Page/线性方程组.md "wikilink")

\[\boldsymbol{Ax}=\boldsymbol{b}\]

的[迭代方法](../Page/迭代方法.md "wikilink")。共轭梯度法可以从不同的角度推导而得，包括作为求解[最优化问题的](../Page/最优化.md "wikilink")[共轭方向法的特例](../Page/共轭方向法.md "wikilink")，以及作为求解[特征值问题的](../Page/特征值.md "wikilink")[Arnoldi](../Page/Arnoldi迭代.md "wikilink")/[Lanczos迭代的变种](../Page/Lanczos迭代.md "wikilink")。
...
逐步建立[Krylov子空间](../Page/Krylov子空间.md "wikilink")
...
[上Hessenberg矩阵](../Page/Hessenberg矩阵.md "wikilink")\(\boldsymbol{H}_i=\boldsymbol{V}_i^\mathrm{T}\boldsymbol{AV}_i\)变成对阵三对角矩阵。于是它可以被更明确地表示为
...
由于\(\boldsymbol{A}\)对称正定，\(\boldsymbol{H}_i\)同样也对称正定。因此，\(\boldsymbol{H}_i\)可以通过不[选主元的](../Page/选主元.md "wikilink")[LU分解分解为](../Page/LU分解.md "wikilink")

...
其中\((\cdot)_{i,j}\)表示矩阵i行j列上的元素，\(\overline{(\cdot)}\)表示[标量的](../Page/标量.md "wikilink")[复共轭](https://zh.wikipedia.org/wiki/复共轭 "wikilink")。

这一定义也可以写作：

\[A^* = (\overline{A})^\mathrm{T} = \overline{A^\mathrm{T}}\]
其中\(A^\mathrm{T} \,\!\)是矩阵A的[转置](https://zh.wikipedia.org/wiki/轉置矩陣 "wikilink")，\(\overline{A}\,\!\)表示对矩阵A中的元素取复共轭。
...
## 性质
  ...
  - (*A*<sup>\*</sup>)<sup>\*</sup> = *A*
  - 若*A*为[方阵](https://zh.wikipedia.org/wiki/方阵 "wikilink")，则[det](../Page/行列式.md "wikilink")(*A*<sup>\*</sup>)
    = (det
    A)<sup>\*</sup>，且[tr](https://zh.wikipedia.org/wiki/矩阵的迹 "wikilink")(*A*<sup>\*</sup>)
    = (tr A)<sup>\*</sup>
  - *A*是[可逆矩阵](https://zh.wikipedia.org/wiki/可逆矩阵 "wikilink")，[当且仅当](../Page/当且仅当.md "wikilink")*A*<sup>\*</sup>可逆，且有(*A*<sup>\*</sup>)<sup>−1</sup>
    = (*A*<sup>−1</sup>)<sup>\*</sup>.
  - *A*<sup>\*</sup>的[特征值是](https://zh.wikipedia.org/wiki/特征值 "wikilink")*A*的特征值的复共轭。
  - \<*Ax*,*y*\> = \<*x*,
    *A*<sup>\*</sup>*y*\>，其中*A*为*m*行*n*列的矩阵，复向量*x*为n维列向量，复向量*y*为m维列向量，\<·,·\>为复数的[内积](https://zh.wikipedia.org/wiki/内积 "wikilink")。

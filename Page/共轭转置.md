...
其中\((\cdot)_{i,j}\)表示矩阵i行j列上的元素，\(\overline{(\cdot)}\)表示[标量](../Page/标量.md "wikilink")的[复共轭](https://zh.wikipedia.org/wiki/复共轭 "wikilink")。
...
元素为\(a_{ij}\)的方块矩阵*A*称为：
  ...
  - [埃尔米特矩阵](../Page/埃尔米特矩阵.md "wikilink")或自伴矩阵，如果*A* =
    *A*<sup>\*</sup>，也就是说，\(a_{ij}=a_{ji}^*\) ；
  - [斜埃尔米特矩阵](../Page/斜埃尔米特矩阵.md "wikilink")或反埃尔米特矩阵，如果*A* =
    −*A*<sup>\*</sup>，也就是说，\(a_{ij}=-a_{ji}^{*}\) ；

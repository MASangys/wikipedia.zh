...
的相互相关最大的线性组合。\[1\]T·R·Knapp指出“几乎所有常见的[参数测试的意义可视为特殊情况的典型相关分析](https://zh.wikipedia.org/wiki/参数测试 "wikilink")，这是研究两组变量之间关系的一般步骤。”\[2\]
这个方法在1936年由[哈罗德·霍特林首次引入](https://zh.wikipedia.org/wiki/哈罗德·霍特林 "wikilink")。\[3\]

## 定义

给定两个带[有限](https://zh.wikipedia.org/wiki/有限 "wikilink")[矩的随机变量的](https://zh.wikipedia.org/wiki/矩 "wikilink")[列向量](https://zh.wikipedia.org/wiki/列向量 "wikilink")
\(X = (x_1, \dots, x_n)'\) 和
...
(见[Rayleigh
quotient](https://zh.wikipedia.org/wiki/Rayleigh_quotient "wikilink"))
最大特征值对应的[特征向量](https://zh.wikipedia.org/wiki/特征向量 "wikilink")，那么就可以得到相关的最大值。随后的典型变量对可以通过减少[特征值的量级来得到](https://zh.wikipedia.org/wiki/特征值 "wikilink")。正交性保证了相关矩阵的对称性。
...
以下是它在一些语言中的函数 \[5\]
  ...
  - [SAS](https://zh.wikipedia.org/wiki/SAS_language "wikilink") as
    [proc
...
个[自由度的](https://zh.wikipedia.org/wiki/自由度 "wikilink")[卡方分布](https://zh.wikipedia.org/wiki/卡方分布 "wikilink")。\[6\]
...
## 参见
  ...
  - [Generalized Canonical
    Correlation](https://zh.wikipedia.org/wiki/Generalized_Canonical_Correlation "wikilink")
  - [Multilinear subspace
    learning](https://zh.wikipedia.org/wiki/Multilinear_subspace_learning "wikilink")
  - [RV
    coefficient](https://zh.wikipedia.org/wiki/RV_coefficient "wikilink")
  - [Principal
    angles](https://zh.wikipedia.org/wiki/Principal_angles "wikilink")
  - [主成分分析](../Page/主成分分析.md "wikilink")
  - [Regularized canonical correlation
    analysis](https://zh.wikipedia.org/wiki/Regularized_canonical_correlation_analysis "wikilink")
  - [奇异值分解](../Page/奇异值分解.md "wikilink")
  - [Partial least squares
    regression](https://zh.wikipedia.org/wiki/Partial_least_squares_regression "wikilink")

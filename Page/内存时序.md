...
现代[DIMM包括一个](../Page/DIMM.md "wikilink")[串行存在检测](../Page/串行存在检测.md "wikilink")（SPD）ROM芯片，其中包含为自动配置推荐的内存时序。[PC上的](../Page/个人电脑.md "wikilink")[BIOS可能允许用户调整时序以提高性能](../Page/BIOS.md "wikilink")（存在降低稳定性的风险），或在某些情况下增加稳定性（如使用建议的时序）。

...
在[計算機科學中](https://zh.wikipedia.org/wiki/計算機科學 "wikilink")，**内核**（）又稱**-{zh-cn:核心;
zh-tw:內核;
zh-hk:核心;}-**，是一個電腦[程式](https://zh.wikipedia.org/wiki/程式 "wikilink")，用來管理[軟體發出的資料](https://zh.wikipedia.org/wiki/軟體 "wikilink")[I/O](https://zh.wikipedia.org/wiki/I/O "wikilink")（輸入與輸出）要求，將這些要求轉譯為資料處理的指令，交由[中央處理器](https://zh.wikipedia.org/wiki/中央處理器 "wikilink")（CPU）及[電腦中其他](https://zh.wikipedia.org/wiki/電腦 "wikilink")[電子元件進行處理](../Page/電子元件.md "wikilink")，是現代[操作系统中最基本的部分](../Page/操作系统.md "wikilink")。它是为众多[应用程序提供对](../Page/应用程序.md "wikilink")[计算机](https://zh.wikipedia.org/wiki/计算机 "wikilink")[硬件的安全访问的一部分](../Page/硬件.md "wikilink")[软件](../Page/软件.md "wikilink")，这种访问是有限的，并由内核决定一个[程序在什么时候对某部分硬件操作多长时间](https://zh.wikipedia.org/wiki/程序 "wikilink")。直接对硬件操作是非常复杂的。所以内核通常提供一种[硬件抽象的方法](https://zh.wikipedia.org/wiki/硬件抽象 "wikilink")，来完成这些操作。通过[进程间通信机制及](https://zh.wikipedia.org/wiki/进程间通信 "wikilink")[系统调用](https://zh.wikipedia.org/wiki/系统调用 "wikilink")，应用进程可间接控制所需的硬件资源（特别是处理器及IO设备）。

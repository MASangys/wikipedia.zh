...
[CPU中的](https://zh.wikipedia.org/wiki/CPU "wikilink")“[熔毁](https://zh.wikipedia.org/wiki/熔毁_\(安全漏洞\) "wikilink")”硬件安全缺陷。\[1\]\[2\]
...
x86处理器的[熔毁漏洞被公布](https://zh.wikipedia.org/wiki/熔毁_\(安全漏洞\) "wikilink")。KAISER补丁改为修复此问题，并更名为KPTI，因为新型攻击很类似，尽管更为严重。
...
## 参见
  ...
  - [熔毁 (安全漏洞)](https://zh.wikipedia.org/wiki/熔毁_\(安全漏洞\) "wikilink")

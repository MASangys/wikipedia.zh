**内积空间**是[数学中的](../Page/数学.md "wikilink")[线性代数裡的基本概念](../Page/线性代数.md "wikilink")，是增添了一个额外的结构的[向量空间](../Page/向量空间.md "wikilink")。这个额外的结构叫做**[内积](https://zh.wikipedia.org/wiki/内积 "wikilink")**或[标量积](https://zh.wikipedia.org/wiki/标量积 "wikilink")。内积将一对[向量与一个标量连接起来](../Page/向量.md "wikilink")，允许我们严格地谈论[向量的](../Page/向量.md "wikilink")“[夹角](https://zh.wikipedia.org/wiki/角 "wikilink")”和“[长度](../Page/长度.md "wikilink")”，并进一步谈论向量的[正交性](../Page/正交.md "wikilink")。内积空间由[欧几里得空间抽象而来](../Page/欧几里得空间.md "wikilink")（内积是点积的抽象），这是[泛函分析讨论的课题](../Page/泛函分析.md "wikilink")。
...
下文中的[标量](../Page/标量.md "wikilink")[域](https://zh.wikipedia.org/wiki/域 "wikilink")\(F\)是指[实数域](../Page/实数.md "wikilink")\(\mathbb{R}\)或[复数域](https://zh.wikipedia.org/wiki/複數 "wikilink")\(\mathbb{C}\)。
...
这里假定左侧的[无穷级数是](https://zh.wikipedia.org/wiki/无穷级数 "wikilink")[收敛的](https://zh.wikipedia.org/wiki/收敛 "wikilink")。这时候空间\(V\)的完备性保证了等式的右侧向量级数也有意义，因为容易证明部分和序列\(S_k = \sum_{i=1}^k x_i\)是收敛的[柯西序列](../Page/柯西序列.md "wikilink")。
...
如果这些向量的范数都是1（\(\forall i , \; \; \; \| e_i \| = 1.\)），就称\(\mathfrak{B}\)是一组标准正交基。给定任意一组基，都可以通过[格拉姆－施密特正交化方法得到一组标准正交基](https://zh.wikipedia.org/wiki/格拉姆－施密特正交化 "wikilink")。

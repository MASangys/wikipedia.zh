...
下面的C語言片段即含有一個system
call的包裝函式。其組語語法為[GNU汇编器使用的](https://zh.wikipedia.org/wiki/GNU汇编器 "wikilink")[AT\&T組語語法](https://zh.wikipedia.org/wiki/AT&T組語語法 "wikilink")。一般這類程式都會使用[巨集實作](../Page/巨集.md "wikilink")，不過為了清楚展示觀念，在此列出了完整的程式碼。

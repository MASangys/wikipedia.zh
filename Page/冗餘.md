...
在許多[生命攸關系統](../Page/生命攸關系統.md "wikilink")（像是[飛機中的](https://zh.wikipedia.org/wiki/飛機 "wikilink")[Fly-by-wire及液壓系統](../Page/电传操纵系统.md "wikilink")）中，控制系統的一些元件會特別配置三組\[1\]，一般稱為[三重模塊冗餘](../Page/三重模塊冗餘.md "wikilink")（TMR）。若其中一個有問題，其他二個正常，則會依類似投票的機制，以二個正常的模塊為準。在三重模塊冗餘的系統中，至少要有二個模塊有問題才可能造成系統失效。因為模塊的失效率其實很低，而且模塊的失效是互相獨立的，因此二個模塊都失效的機率相當的低，會低於比其他的風險因素（例如[人为错误](https://zh.wikipedia.org/wiki/人为错误 "wikilink")）。冗餘也可以稱為是「多數決系統」\[2\]或「投票式邏輯」\[3\]。

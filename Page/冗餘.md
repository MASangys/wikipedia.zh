...
[工程学](../Page/工程学.md "wikilink")中的**冗餘**是指[系統](../Page/系統.md "wikilink")為了提昇其[可靠度](https://zh.wikipedia.org/wiki/可靠度 "wikilink")，刻意配置重複的零件或是機能。冗餘一般是為了備用，或是[失效安全](../Page/失效安全.md "wikilink")的考量，也有可能是了提昇系統性能，像是[卫星导航系统](../Page/卫星导航系统.md "wikilink")接收器，或是多[线程](../Page/线程.md "wikilink")電腦處理。

在[數學裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，**冪等**有兩種主要的定義。
  ...
  - 某[一元運算為](https://zh.wikipedia.org/wiki/一元運算 "wikilink")**冪等**的時，其作用在任一元素兩次後會和其作用一次的結果相同。例如，[高斯符號便是冪等的](../Page/高斯符號.md "wikilink")。
  - [一元運算的定義是](https://zh.wikipedia.org/wiki/一元運算 "wikilink")[二元運算定義的特例](https://zh.wikipedia.org/wiki/二元運算 "wikilink")（詳情請見下面）。
...
特別的是，任一[單位元都是冪等的](../Page/單位元.md "wikilink")。若*S*的所有元素都是冪等的話，則其二元運算\*被稱做是冪等的。例如，[聯集和](https://zh.wikipedia.org/wiki/聯集 "wikilink")[交集的運算便都是冪等的](../Page/交集.md "wikilink")。

### 一元運算

設*f*為一由*X*映射至*X*的[一元運算](https://zh.wikipedia.org/wiki/一元運算 "wikilink")，則*f*為冪等的，當對於所有在*X*內的*x*，

  -
    *f*(*f*(*x*)) = *f*(*x*).

特別的是，[恆等函數一定是冪等的](https://zh.wikipedia.org/wiki/恆等函數 "wikilink")，且任一[常數函數也都是冪等的](../Page/常數函數.md "wikilink")。

注意當考慮一由*X*至*X*的所有函數所組成的集合*S*時，*f*在一元運算下為冪等的若且唯若在二元運算下，*f*相對於其[複合運算](https://zh.wikipedia.org/wiki/複合函數 "wikilink")(標記為*o*)會是冪等的。這可以寫成*f* o *f*
= *f*。
...
定義上，[環的冪等元素為一相對於環乘法為冪等的元素](https://zh.wikipedia.org/wiki/環 "wikilink")。可以定義一於環冪等上的[偏序](https://zh.wikipedia.org/wiki/偏序 "wikilink")：若*e*和*f*為冪等的，當*ef*
...
0)。這表示了[整環及](https://zh.wikipedia.org/wiki/整環 "wikilink")[除環都不會存在此種冪等元素](https://zh.wikipedia.org/wiki/除環 "wikilink")。[局部環也沒有此種冪等元素](../Page/局部環.md "wikilink")，但理由有點不同。唯一包含於一環的[雅各布森根內的冪等元素只有](../Page/雅各布森根.md "wikilink")0。[共四元數環內會有一冪等元素組成的](https://zh.wikipedia.org/wiki/共四元數 "wikilink")[懸鏈曲面](../Page/懸鏈曲面.md "wikilink")。
...
在[線性代數裡](https://zh.wikipedia.org/wiki/線性代數 "wikilink")，[投射是冪等的](https://zh.wikipedia.org/wiki/投射 "wikilink")。亦即，每一將向量投射至一子空間V（不需正交）上的[線性算子](https://zh.wikipedia.org/wiki/線性算子 "wikilink")，都是冪等的。

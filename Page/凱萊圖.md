...
**凱萊圖**（Cayley
graph）也叫做**凱萊著色圖**是編碼[離散群](../Page/離散群.md "wikilink")的[圖](https://zh.wikipedia.org/wiki/圖 "wikilink")。它的定義是[凱萊定理](../Page/凱萊定理.md "wikilink")（以[阿瑟·凱萊](../Page/阿瑟·凱萊.md "wikilink")命名）所暗含的，并使用這個群的特定的通常有限的[生成元集合](../Page/群的生成集合.md "wikilink")。它是組合群論與[幾何群論的中心工具](https://zh.wikipedia.org/wiki/幾何群論 "wikilink")。
...
<!-- end list -->
  ...
  - 類似的，如果*G* =
    **Z**<sub>*n*</sub>是*n*階[循環群](../Page/循環群.md "wikilink")而*S*由兩個元素構成，*G*的標準生成元和它的逆元，則凱萊圖是[環圖](https://zh.wikipedia.org/wiki/循環圖 "wikilink")*C*<sub>*n*</sub>。
...
[Dih_4_Cayley_Graph;_generators_a,_b;_prefix.svg](https://zh.wikipedia.org/wiki/File:Dih_4_Cayley_Graph;_generators_a,_b;_prefix.svg "fig:Dih_4_Cayley_Graph;_generators_a,_b;_prefix.svg")
  ...
  - [二面體群](../Page/二面體群.md "wikilink")*D*<sub>4</sub>在兩個生成元*a*和*b*上的凱萊圖列于右側。紅色箭頭表示左乘元素*a*。因此元素*b*是[自我逆轉的](../Page/凱萊表.md "wikilink")，表示左乘元素*b*藍色線是無方向的。因此這個圖是混合的：它有8個頂點，8個有向邊，4個邊。群*D*<sub>4</sub>的[凱萊表](../Page/凱萊表.md "wikilink")可以從[群展示得出](../Page/群的展示.md "wikilink")：
...
<!-- end list -->
  ...
  - 在對應於集合*S* = {*a*, *b*, *a*<sup>−1</sup>, *b*<sup>−1</sup>}的兩個生成元*a*,
    *b*上的[自由群](../Page/自由群.md "wikilink")的凱萊圖列出在文章開頭，這里的*e*表示[單位元](../Page/單位元.md "wikilink")。沿著邊向右走表示右乘*a*，而沿著變向上走表示乘以*b*。因為自由群沒有[關係](../Page/群的展示.md "wikilink")，它的凱萊圖中沒有[環](https://zh.wikipedia.org/wiki/環_\(圖論\) "wikilink")。這個凱萊圖是證明[巴拿赫-塔斯基悖论的關鍵因素](https://zh.wikipedia.org/wiki/巴拿赫-塔斯基悖论 "wikilink")。

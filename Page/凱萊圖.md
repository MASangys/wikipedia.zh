...
**凱萊圖**（Cayley
graph）也叫做**凱萊著色圖**是編碼[離散群的](../Page/離散群.md "wikilink")[圖](https://zh.wikipedia.org/wiki/圖 "wikilink")。它的定義是[凱萊定理](../Page/凱萊定理.md "wikilink")（以[阿瑟·凱萊命名](../Page/阿瑟·凱萊.md "wikilink")）所暗含的，并使用這個群的特定的通常有限的[生成元集合](../Page/群的生成集合.md "wikilink")。它是組合群論與[幾何群論的中心工具](https://zh.wikipedia.org/wiki/幾何群論 "wikilink")。
...
<!-- end list -->
  ...
  - 類似的，如果*G* =
    **Z**<sub>*n*</sub>是*n*階[循環群而](../Page/循環群.md "wikilink")*S*由兩個元素構成，*G*的標準生成元和它的逆元，則凱萊圖是[環圖](https://zh.wikipedia.org/wiki/循環圖 "wikilink")*C*<sub>*n*</sub>。

<!-- end list -->

  - 群的[直積的凱萊圖是對應的凱萊圖的](https://zh.wikipedia.org/wiki/直積 "wikilink")[笛卡爾積](https://zh.wikipedia.org/wiki/圖的笛卡爾積 "wikilink")。因此帶有四個元素（±1,
    ±1）組成的生成集的阿貝爾群**Z**<sup>2</sup>的凱萊圖是在平面**R**<sup>2</sup>上無窮[網格](https://zh.wikipedia.org/wiki/網格圖 "wikilink")，而帶有類似的生成集的直積**Z**<sub>*n*</sub>×**Z**<sub>*m*</sub>的凱萊圖是在[環面上](https://zh.wikipedia.org/wiki/環面 "wikilink")*n*乘*m*有限網格。
...
<!-- end list -->
  ...
  - 在對應於集合*S* = {*a*, *b*, *a*<sup>−1</sup>, *b*<sup>−1</sup>}的兩個生成元*a*,
    *b*上的[自由群的凱萊圖列出在文章開頭](../Page/自由群.md "wikilink")，這里的*e*表示[單位元](../Page/單位元.md "wikilink")。沿著邊向右走表示右乘*a*，而沿著變向上走表示乘以*b*。因為自由群沒有[關係](../Page/群的展示.md "wikilink")，它的凱萊圖中沒有[環](https://zh.wikipedia.org/wiki/環_\(圖論\) "wikilink")。這個凱萊圖是證明[巴拿赫-塔斯基悖论的關鍵因素](https://zh.wikipedia.org/wiki/巴拿赫-塔斯基悖论 "wikilink")。
...
<!-- end list -->
  ...
  - 凱萊圖\(\Gamma(G,S)\)本質上依賴於生成元的集合\(S\)的選擇方式。例如，如果生成集合\(S\)有\(k\)個元素，則凱萊圖的每個頂點都有\(k\)個進入和\(k\)個外出的有向邊。在有\(r\)個元素的對稱生成集合\(S\)的情況下，凱萊圖是\(r\)度的[正則圖](https://zh.wikipedia.org/wiki/正則圖 "wikilink")。
...
<!-- end list -->
  ...
  - 如果\(f: G'\to G\)是[滿射](https://zh.wikipedia.org/wiki/滿射 "wikilink")[群同態并且](../Page/群同態.md "wikilink")\(G'\)的生成集合\(S'\)的元素的像是不同的，則它引發一個圖的覆蓋
...
<!-- end list -->
  ...
  -
    ...
    特別是，如果群\(G\)有\(k\)個生成元，都有不是2的階，并且這些生成元和它們的逆元構成集合\(S\)，則凱萊圖\(\Gamma(G,S)\)由對應於在相同生成集合的[自由群的](../Page/自由群.md "wikilink")\(2k\)度無限正則[樹所覆蓋](https://zh.wikipedia.org/wiki/樹_\(圖論\) "wikilink")。

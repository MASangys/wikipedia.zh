[Cayley_graph_of_F2.svg](https://zh.wikipedia.org/wiki/File:Cayley_graph_of_F2.svg "fig:Cayley_graph_of_F2.svg")的凱萊圖\]\] **凱萊圖**（Cayley graph）也叫做**凱萊著色圖**是編碼[離散群](../Page/離散群.md "wikilink")的[圖](https://zh.wikipedia.org/wiki/圖 "wikilink")。它的定義是[凱萊定理](../Page/凱萊定理.md "wikilink")（以[阿瑟·凱萊](../Page/阿瑟·凱萊.md "wikilink")命名）所暗含的，并使用這個群的特定的通常有限的[生成元集合](../Page/群的生成集合.md "wikilink")。它是組合群論與[幾何群論的中心工具](https://zh.wikipedia.org/wiki/幾何群論 "wikilink")。

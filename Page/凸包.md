...
在一个[实数](../Page/实数.md "wikilink")[向量空間](https://zh.wikipedia.org/wiki/向量空間 "wikilink")\(V\)中，对于给定集合\(X\)，所有包含X的[凸集的](../Page/凸集.md "wikilink")[交集](../Page/交集.md "wikilink")\(S\)被称为\(X\)的**凸包**。

\[S := \bigcap_{X \subseteq K \subseteq V \atop K\ \mathrm{is\ convex}} K.\]

\(X\)的凸包可以用\(X\)内所有点\((x_1, \ldots, x_n)\)的[线性组合来构造](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。

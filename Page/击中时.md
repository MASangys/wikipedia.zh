...
**击中时**也称为**命中时**、**首中时**，是[数学](../Page/数学.md "wikilink")中[随机过程](../Page/随机过程.md "wikilink")研究里出现的一个概念，表示一个随机过程首次接触到[状态空间](../Page/状态空间.md "wikilink")的某个[子集](../Page/子集.md "wikilink")的时间。在特定的例子中，也会被称为**离时**（**脱离时间**）或**回时**（**首次回归时间**）。

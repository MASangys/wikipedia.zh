在[计算机科学](../Page/计算机科学.md "wikilink")中，**库**（）是用于开发[软件](../Page/软件.md "wikilink")的[子程序](../Page/子程序.md "wikilink")集合。库和[可执行文件的区别是](https://zh.wikipedia.org/wiki/可执行文件 "wikilink")，库不是独立[程序](https://zh.wikipedia.org/wiki/程序 "wikilink")，他们是向其他程序提供服务的代码。

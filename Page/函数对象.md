**函数对象**（function object）{{\#tag:ref|In C++, a **functionoid** is an object that has one major method, and a **functor** is a special case of a functionoid.\[1\] They are similar to a function object, *but not the same*.|name=a|group=note}}是一个程序设计的对象允许被当作普通函数来调用。
...
[Python](../Page/Python.md "wikilink")程序设计中，函数是作为头等对象（first-class object），可以如同普通的字符串、数值、list等对象那样操作。这使得大部分编写函数对象都是不必须的。
...
## 外部链接
  ...
  - [Function Objects (STL) by Gabriel\&Andreas Fleseriu\&Masur on February 22nd, 2006](http://www.codeguru.com/cpp/cpp/cpp_mfc/stl/article.php/c11449/Function-Objects-STL.htm)
  - [Description from the Portland Pattern Repository](http://c2.com/cgi/wiki?FunctorObject)
  - [C++ Advanced Design Issues - Asynchronous C++](http://www.two-sdg.demon.co.uk/curbralan/papers/AsynchronousC++.pdf) by [Kevlin Henney](https://zh.wikipedia.org/wiki/Kevlin_Henney "wikilink")
  - [The Function Pointer Tutorials](http://www.newty.de/fpt/index.html) by Lars Haendel (2000/2001)
  - Article "[Generalized Function Pointers](https://web.archive.org/web/20050218045631/http://www.cuj.com/documents/s=8464/cujcexp0308sutter/)" by [Herb Sutter](https://zh.wikipedia.org/wiki/Herb_Sutter "wikilink")
  - [Generic Algorithms for Java](http://jga.sourceforge.net/)
  - [PHP Functors - Function Objects in PHP](https://web.archive.org/web/20100330073950/http://www.amcgowan.ca/blog/computer-science/php-functors-function-objects-in-php/)
  - [What the heck is a functionoid, and why would I use one?](https://web.archive.org/web/20130727001627/http://www.parashift.com/c++-faq-lite/pointers-to-members.html#faq-33.10) (C++ FAQ)

[Category:面向对象的程序设计](https://zh.wikipedia.org/wiki/Category:面向对象的程序设计 "wikilink") [Category:控制流程](https://zh.wikipedia.org/wiki/Category:控制流程 "wikilink")

1.  [33.15: What's the difference between a functionoid and a functor?](http://www.parashift.com/c++-faq-lite/pointers-to-members.html#faq-33.15)
2.  [Accumulator Generator](http://www.paulgraham.com/accgen.html)
3.  [Python reference manual - Function definitions](http://docs.python.org/3/reference/compound_stmts.html#function-definitions)
**函数重载**（），是[Ada](../Page/Ada.md "wikilink")、[C++](../Page/C++.md "wikilink")、[C\#](../Page/C♯.md "wikilink")、D和[Java等](../Page/Java.md "wikilink")[编程语言中具有的一项特性](../Page/编程语言.md "wikilink")，这项特性允许创建数项名称相同但输入输出类型或个数不同的[子程序](../Page/子程序.md "wikilink")，它可以简单地称为一个单独功能可以执行多项任务的能力。
...
## 外部链接
  ...
  - Bertrand Meyer: Overloading vs Object Technology, in Journal of
    Object-Oriented Programming (JOOP), vol. 14, no. 4, October-November
    2001, available
    [online](http://se.ethz.ch/~meyer/publications/joop/overloading.pdf)

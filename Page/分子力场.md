...
不同的分子力场会选取不同的函数形式来描述上述能量与体系构型之间的关系。到目前，不同的科研团队设计了很多适用于不同体系的力场函数，根据他们选择的函数和力场参数，可以分为以下几类
  ...
  - 第二代力场
    ...
    <!-- end list -->
      ...
      - [COMPASS力场由MSI公司开发的力场](https://zh.wikipedia.org/wiki/COMPASS力场 "wikilink")，擅长进行[高分子体系的计算](../Page/高分子.md "wikilink")

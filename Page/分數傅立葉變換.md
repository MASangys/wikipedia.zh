在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，**分數傅立葉變換**（Fractional
Fourier
transform，縮寫：FRFT）指的就是[傅立葉變換](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")（Fourier
Transform）的廣義化。近幾年來，分數傅立葉變換除了在[信號處理領域有相當廣泛的應用](https://zh.wikipedia.org/wiki/信號處理 "wikilink")，其也在數學上被單獨地研究，而定義出如分數迴旋積分（Fractional
Convolution）、分數相關（Fractional Correlation）等許多相關的數學運算。

分數傅立葉變換的物理意義即做傅立葉變換 \(a\) 次，其中 \(a\)
不一定要為整數；而做了分數傅立葉變換之後，信號或輸入函數便會出現在介於[時域與](https://zh.wikipedia.org/wiki/時域 "wikilink")[頻域之間的分數域](../Page/頻域.md "wikilink")（Fractional
Domain）。
...
對信號 \(x(t)\)
做一次[傅立葉變換的結果為](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")\(\mathcal{F}(x)\)
，做兩次[傅立葉變換的結果為](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")\(\mathcal{F}(\mathcal{F}(x))\)
，表示成\(\mathcal{F}^2=\mathcal{F}(\mathcal{F}(x))\) ，而當做了 \(a\)
次的[傅立葉變換可以寫成一般式](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")
...
\(n=1\)時相當於做一次[傅立葉變換](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")，如果在[時頻分析](../Page/時頻分析.md "wikilink")(Time-Frequency
Analysis)圖上，則是對訊號**順時針轉90度**

\(n=2\)時相當於做兩次[傅立葉變換](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")，如果在[時頻分析](../Page/時頻分析.md "wikilink")(Time-Frequency
Analysis)圖上，則是對訊號**順時針轉180度**,\(\mathcal{F}^2[x(t)]=x(-t)\)

\(n=3\)時相當於做兩次[傅立葉變換](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")，如果在[時頻分析](../Page/時頻分析.md "wikilink")(Time-Frequency
Analysis)圖上，則是對訊號**順時針轉270度**

\(n=4\)時相當於做兩次[傅立葉變換](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")，如果在[時頻分析](../Page/時頻分析.md "wikilink")(Time-Frequency
...
的時頻分布([維格納分布](https://zh.wikipedia.org/wiki/維格納分布 "wikilink"),[加伯轉換](../Page/加伯轉換.md "wikilink"))順時針旋轉角度
\(\phi\)，用數學式子表示如下:
...
假設 \(H(f)\)
為一個[低通濾波器](https://zh.wikipedia.org/wiki/低通濾波器 "wikilink")(Low-pass
Filter)

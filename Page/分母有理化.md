**分母有理化**，简称**有理化**，指的是将该原为[无理数的分母化为](https://zh.wikipedia.org/wiki/无理数 "wikilink")[有理数的过程](../Page/有理数.md "wikilink")，也就是将分母中的[根号化去](https://zh.wikipedia.org/wiki/根号 "wikilink")。

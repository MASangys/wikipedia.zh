...
最近Intel和AMD的CPU都提供了能使[hypervisor控制Ring](https://zh.wikipedia.org/wiki/hypervisor "wikilink") 0的硬件访问的[x86虚拟化指令集](https://zh.wikipedia.org/wiki/x86虚拟化 "wikilink")。虽然他们互不兼容，但是他们都创建了一个叫Ring -1的新Ring，所以客户机操作系统可以直接运行在Ring 0上而不影响其他客户机或者宿主系统。\[9\]
...
## 参见
  ...
  - [System Management Mode](https://zh.wikipedia.org/wiki/System_Management_Mode "wikilink") (SMM)

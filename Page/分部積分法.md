**分部積分法**是一種[積分的技巧](https://zh.wikipedia.org/wiki/積分 "wikilink")。它是由[微分的](../Page/微分.md "wikilink")[乘法定則和](https://zh.wikipedia.org/wiki/乘法定則 "wikilink")[微積分基本定理推導而來的](https://zh.wikipedia.org/wiki/微積分基本定理 "wikilink")。其基本思路是将不易求得结果的积分形式，转化为等价的但易于求出结果的积分形式。
...
對上述等式兩邊求[不定積分](https://zh.wikipedia.org/wiki/不定積分 "wikilink")，得
...
由以上等式我们可以推导出分部积分法在[区间](https://zh.wikipedia.org/wiki/区间 "wikilink")\([a,A]\\)的[定积分形式](https://zh.wikipedia.org/wiki/定积分 "wikilink")
...
注意，上面的原式中含有*g*的導數；在使用這個規則時必須先找到[不定積分](https://zh.wikipedia.org/wiki/不定積分 "wikilink")*g*，並且積分\(\int gf' {\rm{d }}x\)必須是可積的。
...
用分部积分法时选择哪个函数为*u*哪个为*dv*很要紧，**ILATE约法**给出一个简单的选择*u*的方法：
  ...
  -
    **I**: [反三角函数](../Page/反三角函数.md "wikilink")：arctan *x*, arcsec *x*,
    etc.
    **L**: [对数函数](https://zh.wikipedia.org/wiki/对数函数 "wikilink")：ln *x*,
    \(\log_2(x)\), etc.
    **A**:
    [代数函数](https://zh.wikipedia.org/wiki/代数函数 "wikilink")：\(x^2\),
    \(3x^{50}\), etc.
    **T**: [三角函数](../Page/三角函数.md "wikilink")：sin *x*, tan *x*, etc.
    **E**: [指数函数](../Page/指数函数.md "wikilink")：\(e^x\), \(13^x\), etc.

*u*确定后，另一个函数自然是*dv*.
ILATE这个[口诀代表优先选择的顺序](https://zh.wikipedia.org/wiki/口诀 "wikilink")。.其中的道理是求列在后面的函数的积分比列在前面的更容易。

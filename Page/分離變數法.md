[數學上](https://zh.wikipedia.org/wiki/數學 "wikilink")，**分離變數法**是一種解析[常微分方程或](../Page/常微分方程.md "wikilink")[偏微分方程的方法](../Page/偏微分方程.md "wikilink")。使用這方法，可以藉[代數來將方程式重新編排](https://zh.wikipedia.org/wiki/代數 "wikilink")，讓方程式的一部分只含有一個變數，而剩餘部分則跟此變數無關。這樣，隔離出的兩個部分的值，都分別等於常數，而兩個部分的值的[代數和等於零](https://zh.wikipedia.org/wiki/代數和 "wikilink")。
...
有些不喜歡用[萊布尼茨標記](https://zh.wikipedia.org/wiki/萊布尼茨標記 "wikilink") ()
的數學家，或許會選擇將公式 (1) 寫為
...
(II)的解析裏會有更詳細的解釋](https://zh.wikipedia.org/wiki/#實例_\(II\) "wikilink")，
...
\(y(x) = 1\)
是否也是常微分方程式的解答（在這個例子裏，它們都是解答）。參閱[奇異解](https://zh.wikipedia.org/wiki/奇異解 "wikilink")
() 。
...
時常，對於每一個自變量 \(x_i\)
，都會伴隨著一個**分離常數**。如果，這個方法成功，則稱這偏微分方程為[可分偏微分方程](https://zh.wikipedia.org/wiki/可分偏微分方程 "wikilink")
()。
...
是相位常數。這些常數可以由[邊界條件求得](https://zh.wikipedia.org/wiki/邊界條件 "wikilink")。

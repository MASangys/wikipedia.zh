...
## 页面调度
  ...
  - 當系統查看[分頁表](../Page/分頁表.md "wikilink")時認為某些資料可能需要用到，而先將資料傳到記憶體上的行為，就叫做「**先行分頁**」，
    當記憶體夠大的話通常會採取這種方式。\[7\]
...
`WINDOWS`
資料夾中。此檔案的大小決定分頁檔的大小（可以在[控制面板](../Page/控制面板.md "wikilink")中調整），如果使用者移動或刪除這個檔案會在下次開機時出現[蓝屏死机](../Page/蓝屏死机.md "wikilink")。

...
<!-- end list -->
  ...
  - 最基本的切换（软切换）是当一个通话中的手机从当前小区（称为**源小区**）和当前使用的信道转移到另一个可用的小区(称为**目的小区**）和信道（源小区和目的小区可以是不同的[小区](https://zh.wikipedia.org/wiki/小区 "wikilink")，也可以是同一小区的不同[扇区](https://zh.wikipedia.org/wiki/扇区 "wikilink")）。这个切换过程可称之为**小区间切换**；另一个特别的例子是源和目的小区是同一个，甚至同一个扇区，但转移仅仅是在使用的信道间进行，这种切换称之为**小区内切换**。

## 切换类型

加上以上提到的**小区间切换**和**小区内切换**两个类别
，还有**[硬切换](https://zh.wikipedia.org/wiki/硬切换 "wikilink")**和**[软切换](https://zh.wikipedia.org/wiki/软切换 "wikilink")**之分：

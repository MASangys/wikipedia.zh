在[概率論中](../Page/概率論.md "wikilink")，**切比雪夫不等式**（）顯示了[隨機變量的](../Page/隨機變量.md "wikilink")「幾乎所有」值都會「接近」[平均](../Page/平均.md "wikilink")。在20世纪30年代至40年代刊行的书中，其被称为比奈梅不等式（）或比奈梅-切比雪夫不等式（）。切比雪夫不等式，对任何分布形状的数据都适用。可表示为：对于任意\(b>0\)，有：
...
這個不等式以數量化這方式來描述，究竟「幾乎所有」是多少，「接近」又有多接近：
  ...
  - 與平均相差2個[標準差以上的值](../Page/標準差.md "wikilink")，數目不多於1/4
...
設(*X*,Σ,μ)為一[測度空間](../Page/測度空間.md "wikilink")，*f*為定義在*X*上的[廣義實值](../Page/廣義實數集.md "wikilink")[可測函數](../Page/可測函數.md "wikilink")。對於任意[實數](../Page/實數.md "wikilink")*t*
\> 0，
...
設\(X\)為隨機變量，[期望值為](../Page/期望值.md "wikilink")\(\mu\)，[标准差為](../Page/标准差.md "wikilink")\(\sigma\)。對於任何實數k\>0，
...
定義\(~A_t := \{x \in X \mid f(x) \geq t\}\)，設\(1_{A_t}\)為集\(~A_t\)的[指標函數](../Page/指標函數.md "wikilink")，有
...
又可從[馬爾可夫不等式直接證明](../Page/馬爾可夫不等式.md "wikilink")：馬氏不等式說明對任意隨機變量*Y*和正數*a*有\(\Pr(|Y|>a) \le \operatorname{E}(|Y|)/a\)。取\(Y=(X-\mu)^2\)及\(a=(k \sigma)^2\)。
...
## 參見
  ...
  - [弱大數定律](../Page/弱大數定律.md "wikilink")
  - [大數定律](../Page/大數定律.md "wikilink")

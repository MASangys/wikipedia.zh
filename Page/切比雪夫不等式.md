...
設(*X*,Σ,μ)為一[測度空間](https://zh.wikipedia.org/wiki/測度空間 "wikilink")，*f*為定義在*X*上的[廣義實值](https://zh.wikipedia.org/wiki/廣義實數集 "wikilink")[可測函數](https://zh.wikipedia.org/wiki/可測函數 "wikilink")。對於任意[實數](https://zh.wikipedia.org/wiki/實數 "wikilink")*t*
\> 0，
...
設\(X\)為隨機變量，[期望值為](../Page/期望值.md "wikilink")\(\mu\)，[标准差為](https://zh.wikipedia.org/wiki/标准差 "wikilink")\(\sigma\)。對於任何實數k\>0，
...
定義\(~A_t := \{x \in X \mid f(x) \geq t\}\)，設\(1_{A_t}\)為集\(~A_t\)的[指標函數](https://zh.wikipedia.org/wiki/指標函數 "wikilink")，有

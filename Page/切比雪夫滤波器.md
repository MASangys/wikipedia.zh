...
**切比雪夫滤波器**（又译**柴比雪夫滤波器，**）是在通带或阻带上[频率响应幅度等波纹波动的](../Page/频率响应.md "wikilink")[滤波器](../Page/滤波器.md "wikilink")。在通带波动的为“I型切比雪夫滤波器”，在阻带波动的为“II型切比雪夫滤波器”。切比雪夫滤波器在过渡带比[巴特沃斯滤波器的衰减快](../Page/巴特沃斯滤波器.md "wikilink")，但频率响应的幅频特性不如后者平坦。切比雪夫滤波器和理想滤波器的频率响应曲线之间的误差最小，但是在通频带内存在幅度波动。
...
其中：
  ...
  - 而\(|H(\omega_0)| = \frac{1}{\sqrt{1+\epsilon^2}}\)
    是滤波器在[截止频率](../Page/截止频率.md "wikilink")\(\omega_0\)的放大率
    (*注意*:
    常用的以幅度下降3[分贝的频率点作为截止频率的定义不适用于切比雪夫滤波器](../Page/分贝.md "wikilink")\!)
...
参数 ε 与 [阻频带的](../Page/阻频带.md "wikilink")
[衰减度](../Page/衰减度.md "wikilink") γ 有如下关系：
...
## 使用范围
  ...
  - 如果需要快速衰减而允许[通频带存在少许幅度波动](../Page/通频带.md "wikilink")，可用第一类切比雪夫滤波器；如果需要快速衰减而不允许[通频带存在幅度波动](../Page/通频带.md "wikilink")，可用第二类切比雪夫滤波器。

## 与其他滤波器的比较

下图比较四种同阶低通滤波器：（左上）[巴特沃斯滤波器](../Page/巴特沃斯滤波器.md "wikilink")、（右上）I型切比雪夫滤波器、（左下）II型切比雪夫滤波器（右下）[椭圆函数滤波器](../Page/椭圆函数滤波器.md "wikilink")。
...
但不如[椭圆函数滤波器](../Page/椭圆函数滤波器.md "wikilink")，然而后者幅度波动较大。

## 参考

  - [贝塞耳滤波器](../Page/贝塞耳滤波器.md "wikilink")
  - [巴特沃斯滤波器](../Page/巴特沃斯滤波器.md "wikilink")
  - [梳状滤波器](../Page/梳状滤波器.md "wikilink")
  - [椭圆函数滤波器](../Page/椭圆函数滤波器.md "wikilink")

[數學上的](../Page/數學.md "wikilink")**切比雪夫總和不等式**或**切比雪夫不等式**以[切比雪夫命名](../Page/切比雪夫.md "wikilink")，可用以比較兩組數積的和及兩組數的線性和的積的大小：
...
它是由[排序不等式而來](../Page/排序不等式.md "wikilink")。

## 证明

设\(a_1 \geq a_2 \geq \cdots \geq a_n\)且\(b_1 \geq b_2 \geq \cdots \geq b_n\)，由[排序不等式可知](../Page/排序不等式.md "wikilink")，最大的和为顺序和：
...
将这\(n\)个[不等式分边相加](../Page/不等式.md "wikilink")，同时对右边进行[因式分解](../Page/因式分解.md "wikilink")，便得到：

\[n (a_1 b_1 + \cdots + a_n b_n) \geq (a_1 + \cdots + a_n) (b_1 + \cdots + b_n)\]

两边都除以\(n^2\)，就得到切比雪夫不等式的第一个[不等号](../Page/不等号.md "wikilink")：
...
若\(f\)和\(g\)是[区间](../Page/区间.md "wikilink")\([0, 1]\)上的可积的[实函数](../Page/实函数.md "wikilink")，并且两者都是[递增或两者都是递减的](../Page/递增.md "wikilink")，则：

...
Cesàro）發明，是計算[無窮級數和的方式](https://zh.wikipedia.org/wiki/無窮級數 "wikilink")。若一[級數](https://zh.wikipedia.org/wiki/級數 "wikilink")[收斂至α](https://zh.wikipedia.org/wiki/收斂 "wikilink")，則其切薩羅和存在，其值為
α，而[發散級數也可以用切薩羅求和的方式](https://zh.wikipedia.org/wiki/發散級數 "wikilink")，計算出切薩羅和。

## 定義

令 {*a*<sub>n</sub>} 為一
[數列](https://zh.wikipedia.org/wiki/數列 "wikilink")，且令

\[s_k = a_1 + \cdots + a_k\] 為數列前 *k*
項的[部份和](https://zh.wikipedia.org/wiki/部份和 "wikilink")：
...
當*n*趨近於[無限大](https://zh.wikipedia.org/wiki/無限大 "wikilink")，切薩羅和為如下極限：
...
\[A_n^{-1}=a_n; A_n^\alpha=\sum_{k=0}^n A_k^{\alpha-1}\] (上面的指数不表示指数)且定義
*E*<sub>*n*</sub><sup>α</sup> 為數列 1 , 0 , 0 , 0 , 0· · · 的

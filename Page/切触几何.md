...
切触几何和辛几何一样在[物理学](../Page/物理学.md "wikilink")中有广泛的应用，例如，[几何光学](../Page/几何光学.md "wikilink")、[经典力学](../Page/经典力学.md "wikilink")、[热力学](../Page/热力学.md "wikilink")、[几何量子化](https://zh.wikipedia.org/wiki/几何量子化 "wikilink")、[可積系統](https://zh.wikipedia.org/wiki/可積系統 "wikilink")\[1\]、以及诸如[控制论这样的应用数学](https://zh.wikipedia.org/wiki/控制论 "wikilink")。它也可以用于证明有趣的事情，例如‘你总是可以[平泊你的汽车](https://zh.wikipedia.org/wiki/平泊 "wikilink")，只要空间足够大’。 切触几何有很多[低维拓扑中的应用](https://zh.wikipedia.org/wiki/低维拓扑 "wikilink")；一个这种相关性的表现就是每个[三维流形都有一个切触结构](https://zh.wikipedia.org/wiki/三维流形 "wikilink")。

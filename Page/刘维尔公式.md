**刘维尔公式**（Liouville's
Formula）是一个关于[多重积分和](https://zh.wikipedia.org/wiki/多重积分 "wikilink")[欧拉积分](https://zh.wikipedia.org/wiki/欧拉积分 "wikilink")（\(\Gamma\)函数）的公式，其形式如下：
...
1.  Б.П.吉米多维奇. 《吉米多维奇数学分析习题集题解》. 济南: 山东科学技术出版社. 2014. ISBN
    978-7-5331-5895-8.

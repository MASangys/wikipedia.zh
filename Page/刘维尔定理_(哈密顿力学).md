...
在[物理学](../Page/物理学.md "wikilink")中，**刘维尔定理**（）是经典[统计力学](../Page/统计力学.md "wikilink")与[哈密顿力学](../Page/哈密顿力学.md "wikilink")中的关键定理。该定理断言[相空间的分布函数沿着系统的轨迹是常数](https://zh.wikipedia.org/wiki/相空间 "wikilink")——即给定一个系统点，在相空间游历过程中，该点邻近的系统点的密度关于时间是常数。
...
刘维尔方程描述了相空间[分布函数](https://zh.wikipedia.org/wiki/分布函数 "wikilink")（尽管数学中准确术语是[测度](../Page/测度.md "wikilink")，物理学家一般称为分布）的时间演变。考虑一个[动力系统](../Page/动力系统.md "wikilink")具有[正则坐标](https://zh.wikipedia.org/wiki/正则坐标 "wikilink")
...
\((\dot p , \dot q)\)
的[散度](../Page/散度.md "wikilink")为零（由哈密顿方程得出），由连续性方程得出密度
\(d \rho/dt\) 的等于零的定理。
...
\(\mathbf{F}\) 下在[欧几里得空间](../Page/欧几里得空间.md "wikilink")运动，具有坐标
...
在经典[统计力学](../Page/统计力学.md "wikilink")中，粒子数 \(N\)
非常大（譬如：对一个实验室规模系统为[阿伏伽德罗常数](../Page/阿伏伽德罗常数.md "wikilink")数量级）。令
...
在[遍历论与](https://zh.wikipedia.org/wiki/遍历论 "wikilink")[动力系统](../Page/动力系统.md "wikilink")中，由目前给出的物理考虑启发，有相应的结果也称为刘维尔定理。在[哈密顿力学](../Page/哈密顿力学.md "wikilink")中，相空间是一个自然赋有一个光滑[测度](../Page/测度.md "wikilink")的[光滑流形](https://zh.wikipedia.org/wiki/光滑流形 "wikilink")（局部这个测度是
...
在[辛几何](../Page/辛几何.md "wikilink")方面，此定理断言辛结构（[2-形式](https://zh.wikipedia.org/wiki/2-形式 "wikilink")，由
\(\Delta p_i\) 与 \(\Delta q_i\) 的楔积之和组成）的 d
次幂在其哈密顿演化下的[李导数](../Page/李导数.md "wikilink")为零。辛结构的
d 次幂就是相空间中上面所说的测度。

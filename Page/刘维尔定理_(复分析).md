**刘维尔定理**是[数学中](../Page/数学.md "wikilink")[复分析的一个定理](https://zh.wikipedia.org/wiki/复分析 "wikilink")，由十九世纪法国数学家[约瑟夫·刘维尔最先证明](../Page/约瑟夫·刘维尔.md "wikilink")。刘维尔定理对[整函数](../Page/整函数.md "wikilink")（即在整个[复数](https://zh.wikipedia.org/wiki/复数 "wikilink")[域](../Page/数域.md "wikilink")\(\mathbb{C}\)上都是[全纯函数](../Page/全纯函数.md "wikilink")）的[值域进行了刻画](../Page/值域.md "wikilink")。它表明，任何[有界的](../Page/有界函数.md "wikilink")[整函数都一定是常数](../Page/整函数.md "wikilink")。

比刘维尔定理更进一步的是[皮卡定理](../Page/皮卡定理.md "wikilink")。後者说明，只要存在两个相异的复数，它们都**不属于**一个整函数的值域，则这个整函数是常数函数。

## 简介

整函数是指从复数域\(\mathbb{C}\)射到复数域，并且在整个复数域上都是[全纯函数的函数](../Page/全纯函数.md "wikilink")。全纯也称为复可微，是复函数的重要性质。某个函数\]\(f : \; \; \mathbb{C} \rightarrow \mathbb{C}\)在某点\(z_0\)全纯，指在点\(z_0\)以及其[邻域上有定义](../Page/邻域.md "wikilink")，并且以下[极限](https://zh.wikipedia.org/wiki/极限 "wikilink")：
...
\leq \frac{M}{r^k},\]
在以上的估计中，[积分路径为](https://zh.wikipedia.org/wiki/路径积分 "wikilink")\(C_r\)，其中半径\(r\)的选择是任意的。当\(r\)趋于无穷大时，\(\frac{M}{r^k}\)趋于0.
因此，让\(r\)趋于[无穷大](https://zh.wikipedia.org/wiki/无穷大 "wikilink")，便可以推出：对所有的*k*
...
其中\(M\)是一个常数系数。考虑\(f\)的[导函数](https://zh.wikipedia.org/wiki/导函数 "wikilink")。根据[柯西积分公式](https://zh.wikipedia.org/wiki/柯西积分公式 "wikilink")，

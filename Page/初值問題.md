...
若ƒ在一個包括*t*<sub>0</sub>及*y*<sub>0</sub>的區間內連續，且對變數*y*滿足[利普希茨連續的條件](../Page/利普希茨連續.md "wikilink")．則[皮卡-林德勒夫定理可保證在一個包括](https://zh.wikipedia.org/wiki/皮卡-林德勒夫定理 "wikilink")*t*<sub>0</sub>的區間有唯一解。

此定理的證明需將問題變成等價的[積分方程](https://zh.wikipedia.org/wiki/積分方程 "wikilink")，積分可視為將一個函數映射為另一個函數的運算子，因此其解為運算子的[不動點](https://zh.wikipedia.org/wiki/不動點 "wikilink")，再利用[巴拿赫不动点定理證明有一個唯一的不動點](../Page/巴拿赫不动点定理.md "wikilink")．即為初值問題的解。

較早期證明皮卡-林德勒夫定理的方式是建構一個函數的數列，最終會收斂到積分方程的解，也就是初值問題的解。這種建構法稱為「皮卡法」或是「連續近似法」，是巴拿赫不动点定理的一個特例。

日本數學家找到一個初值問題有唯一解的[充分必要條件](https://zh.wikipedia.org/wiki/充分必要條件 "wikilink")，其條件是要證實系統的[李亞普諾夫函數存在](../Page/李亞普諾夫函數.md "wikilink")\[1\]。
...
[el:Αρχική
τιμή](https://zh.wikipedia.org/wiki/el:Αρχική_τιμή "wikilink")
[it:Problema ai valori
iniziali](https://zh.wikipedia.org/wiki/it:Problema_ai_valori_iniziali "wikilink")
[sv:Begynnelsevärdesproblem](https://zh.wikipedia.org/wiki/sv:Begynnelsevärdesproblem "wikilink")

在[一般拓扑学与数学的相关领域中](https://zh.wikipedia.org/wiki/一般拓扑学 "wikilink")，给定集合\(X\)与\(X\)上的一族函数，其**初拓扑**（the
initial
topology）是使得这一族函数[连续的](https://zh.wikipedia.org/wiki/连续函数#拓扑空间之间的连续函数 "wikilink")[最粗糙拓扑](https://zh.wikipedia.org/wiki/拓撲比較 "wikilink")。
...
均為[连续的](https://zh.wikipedia.org/wiki/连续函数#拓扑空间之间的连续函数 "wikilink")[最粗糙拓扑](https://zh.wikipedia.org/wiki/拓撲比較 "wikilink")。
...
## 实例
  ...
  - [子空间拓扑是在子空間上](https://zh.wikipedia.org/wiki/子空间拓扑 "wikilink")，关于[包含映射的初拓扑](../Page/包含映射.md "wikilink")。

  - [積拓撲是关于一族](https://zh.wikipedia.org/wiki/積拓撲 "wikilink")[投影映射的初拓扑](https://zh.wikipedia.org/wiki/投影映射 "wikilink")。

  - 的是关于映射至其[对偶空间的](../Page/对偶空间.md "wikilink")[连续线性算子的初拓扑](https://zh.wikipedia.org/wiki/连续线性算子 "wikilink")。
...
从这个定理可以得到，如果\(X\)上有一族连续映射从闭集分离点，那么关于这族映射就存在一个初拓扑。反之是不成立的，因为初拓扑是由\(f^{-1}(U)\)为子基生成的拓扑，在这个定理中要求the
cylinder sets是集合\(X\)的一个基。

...
\(f\)的[值域是](../Page/值域.md "wikilink")\(Y\)的一個[子集](../Page/子集.md "wikilink")，若\(f\)是一個[滿射函數](https://zh.wikipedia.org/wiki/滿射 "wikilink")（），則\(f\)的對應域和值域相等，反之則代表有\(y \in Y\)不存在於\(f\)的值域中，使得方程式\(f(x)=y\)無解。
...
3.  因為\(f\)的對應域不等於\(h\)的定義域，[合成函數](https://zh.wikipedia.org/wiki/合成函數 "wikilink")
...
\(T\)也可以被表達成一個的實數[矩陣](https://zh.wikipedia.org/wiki/矩陣 "wikilink")，代表一個從定義域\(\mathbb{R}^2\)到對應域\(\mathbb{R}^2\)的對應方式。
假設

**前馈控制**（feed-forward control），是一个术语，描述[控制系统中的一个元素或路径](https://zh.wikipedia.org/wiki/控制系统 "wikilink")，它将控制信号从外部环境的來源传递到另一个外部环境中的负载。这通常是来自外部操作者的命令信号。

仅具有前馈行为的控制系统对其控制信号以预先定义的方式作出响应，而不对负载的响应方式作出响应；它与同样具有[反馈](../Page/反馈.md "wikilink")的系统形成对比，反馈系统根据输出如何影响负载，以及负载本身如何不可预测地变化来调整输出；负载被认为属于系统的外部环境。
...
[计算机科学](../Page/计算机科学.md "wikilink")的[感知机网络是个前馈系统](https://zh.wikipedia.org/wiki/感知机 "wikilink")，因为每层神经元的输出只传给下一层，而不能传给上一层神经元，因此没有[反馈](https://zh.wikipedia.org/wiki/反馈环 "wikilink")。

## 模型

前馈控制系統（機器、程序或是生物體）的數學模型可以用[控制工程](../Page/控制工程.md "wikilink")的方式產生，也可以用控制系統自身學習而得到\[8\]。隨著[微处理器](../Page/微处理器.md "wikilink")運算速度的提昇，具有學習及調整數學模型能力的控制系統也就越來越接近實務應用。現代前馈控制的原理是因為微处理器的發明才有了實務發展的空間\[9\]\[10\]。

前馈控制需要將數學模型整合到控制演算法中，依照目前已知的系統狀態來決定控制動作。以重量輕、有可撓性的[機械手臂](../Page/機械手臂.md "wikilink")而言，可能是在手臂有載重時加以補償，沒有載重時則不補償。目標的關節角度會以根據數學模型，載重造成系統的擾動，以及在理想位置下手臂的變形量調整。若是一系統決定命令，再由另一個系統執行命令，這不一定符合上述前馈控制的定義。只有系統有方式可以偵測擾動，或是有輸入信號，再將輸入信號送到數學模型中，以此來調整控制命令，這才稱為是真正的前馈控制\[11\]\[12\]\[13\]。

### 開迴路系統

在[系统科学](../Page/系统科学.md "wikilink")中，**開迴路系統**（open system）是指沒有[反馈](../Page/反馈.md "wikilink")可以控制其輸出的系統。相反的，可以用回授迴路來控制系統運動。開迴路系統中，系統的輸出不會回授到系統，供控制或是運作使用。
...
## 参见
  ...
  - [史密斯預測器](../Page/史密斯預測器.md "wikilink")
...
[Category:控制理论](https://zh.wikipedia.org/wiki/Category:控制理论 "wikilink") [Category:人工神经网络](https://zh.wikipedia.org/wiki/Category:人工神经网络 "wikilink") [Category:自動化](https://zh.wikipedia.org/wiki/Category:自動化 "wikilink")
...
7.  Alberts, T.E., Sangveraphunsiri, V. and Book, Wayne J., Optimal Control of a Flexible Manipulator Arm: Volume I, Dynamic Modeling, MHRC Technical Report, MHRC-TR-85-06, Georgia Inst, of Technology, 1985.

8.

9.  Oosting, K.W., Simulation of Control Strategies for a Two Degree-of-Freedom Lightweight Flexible Robotic Arm, Thesis, Georgia Institute of Technology, Dept. of Mechanical Engineering, 1987.

10. Alberts, T.E., Sangveraphunsiri, V. and Book, Wayne J., Optimal Control of a Flexible Manipulator Arm: Volume I, Dynamic Modeling, MHRC Technical Report, MHRC-TR-85-06, Georgia Inst, of Technology, 1985.

11. Greene, P. H. (1969): "Seeking mathematical models of skilled actions". In: H. C. Muffley/D. Bootzin (Eds.), Biomechanics, Plenum, pp. 149–180

12. Book, W.J., Modeling, Design and Control of Flexible Manipulator Arms, PhD. Thesis, MIT, Dept. of Mech. Eng., April 1974.

13. Maizza-Neto, 0., Modal Analysis and Control of Flexible Manipulator Arms, PhD. Thesis-, MIT, Dept. of Mech. Eng., September 1974.

14. "Feedback Feedforward control". Psychology Encyclopedia. Retrieved 24 February 2013.

15. MacKay, D. M. (1966): "Cerebral organization and the conscious control of action". In: J. C. Eccles (Ed.), Brain and conscious experience, Springer, pp. 422–440

16. Greene, P. H. (1969): "Seeking mathematical models of skilled actions". In: H. C. Muffley/D. Bootzin (Eds.), Biomechanics, Plenum, pp. 149–180
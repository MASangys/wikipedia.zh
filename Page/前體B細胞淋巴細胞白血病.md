...
它包括以下的子類型：\[1\]
  ...
  - t(1;19)-E2A/PBX1
  - t(12;21)-ETV/ CBFα
  - [t(17;19)-E2A-HLF](http://atlasgeneticsoncology.org/Anomalies/t1719ID1078.html)

## 分子機制

一個有趣的模型"前體B細胞急性淋巴性白血病"(B-cell
ALL)顯示了單一基因的功能異常，即PAX5，它能夠改變"B細胞表型"(phenotype
of B cell)至"前體細胞"(precursor cell)。\[2\]\[3\]
...
## 外部連結
  ...
  - [Precursor B-lymphoblastic
    leukemia](http://www.cancer.gov/dictionary?CdrID=524192) entry in
    the public domain NCI Dictionary of Cancer Terms

[Category:Lymphocytic_leukemia](https://zh.wikipedia.org/wiki/Category:Lymphocytic_leukemia "wikilink")

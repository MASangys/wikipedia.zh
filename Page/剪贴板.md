...
最早的剪贴板实现是数据存储为纯文本，没有例如[字体](../Page/字体.md "wikilink")、样式和颜色等元信息。之后的实现支持了多种数据类型，允许存储复杂的[数据结构](../Page/数据结构.md "wikilink")。有样式的文本有[RTF、](../Page/RTF.md "wikilink")[HTML等](../Page/HTML.md "wikilink")，还有各类[位图](../Page/位图.md "wikilink")、[矢量图](../Page/矢量图形.md "wikilink")，以及[电子表格](https://zh.wikipedia.org/wiki/电子表格 "wikilink")、数据库条目等等。
...
有些现代的用户图形界面提供一个，支持多次剪切和粘贴。在这种模式下，剪贴板被当作一个[堆栈或者说](../Page/堆栈.md "wikilink")[剪贴簿](https://zh.wikipedia.org/wiki/剪贴簿 "wikilink")，新的剪切和粘贴被放在最近操作的顶部。标准的粘贴操作继续使用最近一次操作记录，而特制的界面可提供对其他记录的访问。这些管理器通常还提供一个窗口，显示最近的操作记录，允许用户选择更早的副本，然后编辑它们、更改它们的格式、搜索它们，以及其他高级功能。
...
在以前版本的[Microsoft
Windows操作系统中](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")，剪贴板的内容可以随时使用“剪贴板查看器”查看（一个搭载于Windows
...
在[Macintosh操作系统](https://zh.wikipedia.org/wiki/Mac_OS "wikilink")，使用[Finder的](../Page/Finder.md "wikilink")“编辑”-“显示剪贴板”菜单可以查看剪贴板的内容。
...
各个选择的使用和处理未被标准化。不过大多数现代的工具包和桌面环境（如[GNOME和](../Page/GNOME.md "wikilink")[KDE](../Page/KDE.md "wikilink")）遵循被广泛接受的约定，在[freedesktop.org标准中有其概述](https://zh.wikipedia.org/wiki/freedesktop.org "wikilink")。\[3\]一种名为CLIPBOARD的“选择”使用传统的剪贴板语义，并使用与Windows相同的快捷键。另一种名为PRIMARY的“选择”使用X11特有的机制。高亮的数据会立即被复制，而单击鼠标中键时会粘贴数据。这通常与CLIPBOARD的“选择”分别存储，不会改变其内容。

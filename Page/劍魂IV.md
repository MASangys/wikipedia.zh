...
Gauge）與[星際大戰角色獨有的](../Page/星際大戰.md "wikilink")「[原力計量表](../Page/原力.md "wikilink")」（Force
Gauge），是本遊戲中的新特色。

#### 靈魂計量表

「靈魂計量表」是以有色的[寶石顯示](../Page/寶石.md "wikilink")，其顏色會因為攻防狀態而有改變，一般初始狀態為綠色（裝有特定技能時則為藍色且閃白顯示），當防禦到一定程度，或者在特定模式中，以魂量發動特定技能時，魂量就會下降，甚至變成紅色且量表外框會持續閃紅，直到一方陷入「靈魂衝擊（Soul
Crash）」的防禦崩潰狀態後，發動者將在一瞬間，以無視敵方生命值的「必殺終結技」結束該局\[6\]，而Namco的這項設計，進而鼓勵玩家由消極防守，轉為積極攻擊\[7\]。

#### 原力

[原力是](../Page/原力.md "wikilink")[星際大戰角色](../Page/星際大戰.md "wikilink")（[達斯·維達](../Page/達斯·維達.md "wikilink")、[尤達](../Page/尤達.md "wikilink")、秘密學徒）\[8\]獨有的，某些招式必須配合原力才能使用，且會隨招式的破壞力，有不同程度的耗損，計量表則會在未使用原力時逐漸恢復。當原力耗盡時，玩家會在瞬間失去控制\[9\]，對手會有一定機會趁隙攻擊。

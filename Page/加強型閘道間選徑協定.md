...
EIGRP有以下四个基本组件：
  ...
  - 协议相关模块（Protocol-dependent modules PDMs ）：协议相关模块的引进，使得EIGRP可以支持不同的网络层协议，如[IPX](https://zh.wikipedia.org/wiki/IPX "wikilink")、[AppleTalk](https://zh.wikipedia.org/wiki/AppleTalk "wikilink")、[IPv6](../Page/IPv6.md "wikilink")，而不仅仅是IPv4协议。

> 本文内容由[加汀納符號表](https://zh.wikipedia.org/wiki/加汀納符號表)转换而来。
...
“兩位女神”的表意字符，女神[瓦吉特](../Page/瓦吉特.md "wikilink")作為眼鏡蛇而[奈赫貝特作為白色禿鷹](https://zh.wikipedia.org/wiki/奈赫貝特 "wikilink")。 這二者分別是上下埃及獨立王國的守護神，當兩個王國統一後，這二者後來被寫成[直立形式的眼鏡蛇](https://zh.wikipedia.org/wiki/:en:_uraeus "wikilink")，被認為是在這兩個埃及和法老的保護人。 這種表意字符只發布列在“鳥類名錄”為G16，卻被忽略發布列在神表列和爬行動物表列的名錄。 加汀納採取了其他的縮寫和人格形式的分類，也有專為書寫在[莎草紙的](https://zh.wikipedia.org/wiki/莎草紙 "wikilink")《[死者之書](https://zh.wikipedia.org/wiki/死者之書 "wikilink")》所用的象形符號建立了完整子集合。

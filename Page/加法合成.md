...
从[傅里叶分析的角度上来看](../Page/傅里叶分析.md "wikilink")，乐器的音色均可被分解为一系列和谐或不和谐的[分音](../Page/泛音列.md "wikilink")。加法合成利用了这一点，使用具有不同[频率与](https://zh.wikipedia.org/wiki/频率 "wikilink")[振幅的正弦波重现这些分音](https://zh.wikipedia.org/wiki/振幅 "wikilink")。各分音的响度可以用开始-衰减-保持-释放（英语：ADSR）或动态控制。
...
对单个音符来说，它含有的分音中最低的频率被称为[基本频率](https://zh.wikipedia.org/wiki/基本频率 "wikilink")。简单起见，即使常见乐器演奏出的单个音符中还包含许多其他频率，音符也往往被定义为其基频（例如“[中央C是](https://zh.wikipedia.org/wiki/中央C "wikilink")261.6[赫兹](../Page/赫兹.md "wikilink")”）\[3\]。基频以外的频率叫做[泛音或者](../Page/泛音.md "wikilink")[谐波](https://zh.wikipedia.org/wiki/谐波 "wikilink")\[4\]。换言之，基频定义音符的音调，而泛音定义音符的音色。人类之所以能区分钢琴和小提琴的声音，就是因为它们演奏出的同一音符的泛音不同。即使是同种乐器，不同的乐器个体间也会存在细微的音色差异。
...
[Category:声音合成类型](https://zh.wikipedia.org/wiki/Category:声音合成类型 "wikilink")

...
除了AMD提出的AMD Fusion專案之外，還有[IBM](../Page/IBM.md "wikilink")和[Sony等公司共同開發的](https://zh.wikipedia.org/wiki/Sony "wikilink")[Cell處理器](https://zh.wikipedia.org/wiki/Cell "wikilink")（一個PPE核心+8個SPE核心）、[Intel自](https://zh.wikipedia.org/wiki/Intel "wikilink")[Intel Westmere微架構及以後的一些內建](https://zh.wikipedia.org/wiki/Intel_Westmere "wikilink")[Intel HD Graphics顯示核心的微處理器](../Page/Intel_HD_Graphics.md "wikilink")、[NVIDIA的](https://zh.wikipedia.org/wiki/NVIDIA "wikilink")“[Project Denver](../Page/Project_Denver.md "wikilink")”等新形態的微處理器，甚至超微自家的AMD Radeon HD 8000系列顯示核心（或將內建ARM架構的通用控制單元）和英特爾已取消的獨立顯示核心專案Larrabee，這些與以往形態不同，以「通用處理器核心」+「流處理單元」的處理器，廣義上也可以認為是「加速處理單元」。\[7\]

[Trebuchet.jpg](https://zh.wikipedia.org/wiki/File:Trebuchet.jpg "fig:Trebuchet.jpg")，利用平衡重鎚的[重-{}-力势能](../Page/重力勢能.md "wikilink")，將石頭拋向敵城。\]\]
[JiangNanTianChi.JPG](https://zh.wikipedia.org/wiki/File:JiangNanTianChi.JPG "fig:JiangNanTianChi.JPG")將電力用位能的形式儲存\]\]
**势能**（），亦稱**-{zh-tw:勢能;
zh-hk:勢能;zh-cn:位能}-**，是储存于一[物理系统内的一种](../Page/物理.md "wikilink")[能量](../Page/能量.md "wikilink")，是一个用来描述物体在保守力场中[做功能力大小的](../Page/做功.md "wikilink")[物理量](../Page/物理量.md "wikilink")。[保守力作](../Page/保守力.md "wikilink")[功与路径无关](../Page/功.md "wikilink")，故可定义一个仅与位置有关的[函数](../Page/函数.md "wikilink")，使得保守力沿任意路径所做的功，可表达为这两点函数值的差，这个函数便是势能。

从物理意义上来说，势能表示了物体在特定位置上所储存的能量，描述了作功能力的大小。在适当的情况下，势能可以转化为诸如[动能](../Page/动能.md "wikilink")、[内能等其他能量](../Page/内能.md "wikilink")。

## 势能

### 势能的保守力定义

如果分别作用于两个质点上的[作用力与反作用力作功与具体路径无关](../Page/牛顿运动第三定律.md "wikilink")，只取决于相互作用质点初末位置，那么这样的一对力就叫作**保守力**。不满足这个条件的则称为**非保守力**。可以证明保守场的几个等价条件\[1\]，于是我们得到保守力的性质有：

1.  保守力沿给定两点间作功与路径无关；
2.  保守力沿任意环路作功为零；
3.  保守力可以表示为一个标量函数的（负）[梯度](../Page/梯度.md "wikilink")；

推广到多质点体系和连续分布物体，如果一封闭系统中任意两个质点之间的作用力都是保守力，则称该系统为保守体系。保守体系的**位形**，即在保守体系中各质点的相对位置发生变化时，其间的相互作用力作功，作功之和只与各质点相对位置有关。将保守体系在保守力作用下的这种与相对位置相联系的作功的能力定义为一个函数，称为该保守体系的**势-{}-能函数**或**位-{}-能函数**，简称**势-{}-能**或**位-{}-能**\[2\]。这样，**体系从一种位形变为另一种位形时对外界所作的功等于后者与前者的势能之差**，从而赋予了势能函数以直观的[物理意义](../Page/#势能物理意义.md "wikilink")。

除此之外，我们还可以将势能的定义从现在的基础上拓展。比如[热学中气体分子间的相互作用势能](../Page/热学.md "wikilink")，它是大量分子势能的和，实际不是用相对位置（位形）来描述的，而是用[体积](../Page/体积.md "wikilink")、[温度](../Page/温度.md "wikilink")、[压强等热学参量](../Page/压强.md "wikilink")。又如，在一些特定的约束条件下，某些平时是非保守力的力也成为了保守力\[3\]，或者几种力的合力恰巧成为了一个保守力。

### 广义势能

对于一个理想、完整体系，有[拉格朗日方程](../Page/拉格朗日方程.md "wikilink")
...
广义势能最主要的应用在于带电粒子在[电磁场中的运动上](../Page/电磁场.md "wikilink")。带有[电荷q](../Page/电荷.md "wikilink")，以速度v移動的粒子在[电场](../Page/电场.md "wikilink")**E**和[磁场](../Page/磁场.md "wikilink")**B**中受到[洛伦兹力](../Page/洛伦兹力.md "wikilink")

\[\boldsymbol{F} = q (\boldsymbol{E} + \boldsymbol{v} \times \boldsymbol{B})\]

再辅以[麦克斯韦方程组](../Page/麦克斯韦方程组.md "wikilink")，定义[電势](../Page/電势.md "wikilink")*φ*与[矢势](../Page/矢势.md "wikilink")***A***，可以得到一个满足上述条件的函数\[5\]
...
势能为[能量的一种](../Page/能量.md "wikilink")，具有能量量纲，在[国际单位制下的单位是](../Page/国际单位制.md "wikilink")[焦耳](../Page/焦耳.md "wikilink")（J），另外在涉及到[粒子物理时常用到](../Page/粒子物理.md "wikilink")[电子伏特](../Page/电子伏特.md "wikilink")（eV），高斯单位制下为[尔格](../Page/尔格.md "wikilink")（erg）。势能一般使用“*E<sub>p</sub>*”\[6\]表示，也常使用“*W*”\[7\]“*U*”和“*V*”\[8\]。

势能是一个[标量函数](../Page/标量函数.md "wikilink")，当一个物体与多个物体共有势能或共有多种势能时，这个物体所具有的总势能为所有势能的代数和。

由定义可知，势能取决于两个或多个物体的相对位形，是两个或多个物体所**共有**的。然而，在两物体A、B组成的保守体系中，如果我们以其中一个物体A作为参考系，则势能仅取决于另一物体B的相对位置。这时，在不引起混淆的情况下，我们常把“A、B具有的势能”称作是“B的势能”。比如，在电场中的[电荷具有静电势能](../Page/电荷.md "wikilink")，或者是在一个天体附近的另一个天体具有引力势能。除此之外，有时候保守体系中只存在一个物体，势能来自于物体内部各部分间的相对位移，这时候我们也说，势能是这个物体所具有的。比如，[弹簧](../Page/弹簧.md "wikilink")，或者是具有体分布电荷的绝缘体球。
...
外力的功与非保守内力的功之和等于质点系机械能的增量，这就是质点系的[功能原理](../Page/功能原理.md "wikilink")。用数学方式表达出来为
...
再假设一个粒子，初始时在AB间。若它机械能为0，那么它可以在AB间运动，其最大动能为E<sub>k
max</sub>=E<sub>p1</sub>。当其机械能不断增大，达到E<sub>p2</sub>时，它将可以翻越势垒，到达B右方空间（当然，其在A左方的空间也会延伸）。[Balance.png](https://zh.wikipedia.org/wiki/File:Balance.png "fig:Balance.png")
...
在物理中有时会提到势，请不要与势能相混淆。势通常表述为势能与一个物理量的比值，如[电势](../Page/电势.md "wikilink")（一个粒子静电势能与其电荷量的比值），[引力势](../Page/引力势.md "wikilink")（一个物体[引力势能与其质量的比值](../Page/引力势能.md "wikilink")）。一个确定保守力场中，一个物体的势能与该物体有关，但势的分布与该物体无关\[13\]。
...
[PotentialEnergy_Gravitational2.png](https://zh.wikipedia.org/wiki/File:PotentialEnergy_Gravitational2.png "fig:PotentialEnergy_Gravitational2.png")
重-{}-力势能是[引-{}-力势能在一种特殊情况下的简化形式](../Page/引力势能.md "wikilink")。可以证明\[14\]，对一球对称分布物体在其外一质点产生的-{引}-力，上面两质点间的作用力公式仍适用，其中*m*<sub>0</sub>为该物体总质量，***r***<sub>0</sub>为其球心位矢。当
{{\!}}***r-r***<sub>0</sub>{{\!}}
在不太大范围内变动时，对作用力公式取零级近似，作用力不变，则引-{}-力退化为重-{}-力。\[15\]由此可见，重-{}-力的近似要求很严格。然而由于在日常生活中这个条件很容易满足，而且极简便，符合人们的日常生活经验，故仍有研究价值，单列一项。
...
在地球上g的值约为9.8
ms<sup>-2</sup>，在不同地区稍有不同。这个值已经包括了和[地球自转所需的](../Page/地球自转.md "wikilink")[向心力造成的差别](../Page/向心力.md "wikilink")。一般计算中g可近似的取作标准重力加速度，即g=g<sub>n</sub>=9.80665
ms<sup>-2</sup> \[18\]。
...
弹簧、钢片、金属丝等满足胡克定律的物体，在弹性限度内[应力与](../Page/应力.md "wikilink")[应变成正比](../Page/应变.md "wikilink")。下面以弹簧为例。在弹性限度内，弹簧弹力与长度变化量的关系为
...
在[靜電學裏](../Page/靜電學.md "wikilink")，根据[库伦定律](../Page/库伦定律.md "wikilink")，对于两静止点电荷*q*、*q*<sub>0</sub>，点电荷*q*受到的静电力为

\[\boldsymbol{F}(\boldsymbol{r})=\frac{q q_0}{4\pi \epsilon_0} \cfrac{\boldsymbol{r} - \boldsymbol{r_0}}{|\boldsymbol{r} - \boldsymbol{r_0}|^3}\]

其中*ε*<sub>0</sub>是[电常数](../Page/电常数.md "wikilink")，*r*<sub>0</sub>、*r*分别为两点电荷的位置矢量。静电场中的点电荷会具有电势能。对于两个点电荷，定义无穷远处为势能零点，则点电荷*q*在*r*处的的电势能为
...
[PotentialEnergy_Intermolecular.png](https://zh.wikipedia.org/wiki/File:PotentialEnergy_Intermolecular.png "fig:PotentialEnergy_Intermolecular.png")
[分子力实际上来源于多个方面](../Page/凡得瓦力.md "wikilink")，精确的计算与各分子内部结构有很大关系，会变得十分复杂。对于无极性分子，两分子间作用力可近似用以下半经验公式表示：\[20\]
...
对[兰纳-琼斯势在排斥力部分简化](../Page/兰纳-琼斯势.md "wikilink")，成为[苏则朗势](../Page/苏则朗势.md "wikilink")（Sutherland
potential），即
...
其中E、d为常数，因分子而异。满足苏则朗势的气体称为范德瓦尔斯气体，分子力又称作范德瓦尔斯力，满足[范德瓦尔斯方程](../Page/范德瓦尔斯方程.md "wikilink")\[22\]。[PotentialEnergy_Rigid_Sphere.png](https://zh.wikipedia.org/wiki/File:PotentialEnergy_Rigid_Sphere.png "fig:PotentialEnergy_Rigid_Sphere.png")

对苏则朗势在引力部分再次简化，成为[刚球势](../Page/球對稱位勢#球對稱的三維無限深方形位勢阱.md "wikilink")，即
...
## 参见条目
  ...
  - [拉格朗日方程](../Page/拉格朗日方程.md "wikilink")
...
13. 准确地说，当该物体对周围环境影响足够小时。比如电场中一个电量很小的点电荷（被称作试探电荷），当电量较大时会严重影响到周围物体上的电荷分布从而影响到势分布。关于试探电荷见[电场\#电场强度或贾起民](../Page/电场#电场强度.md "wikilink")，郑永令，陈暨耀．《电磁学（第二版）》，P13。

14. 赵凯华，罗蔚茵．《力学（第二版）》，P337。

15. 实际对于重-{}-力的定义略稍复杂，参见[万有引力\#两者的微妙差别](../Page/万有引力#两者的微妙差别.md "wikilink")。

16. 对于计入离心力的重-{}-力定义，重-{}-力还与物体所处经纬度有关。参见[万有引力\#两者的微妙差别](../Page/万有引力#两者的微妙差别.md "wikilink")。另外，由于地球实际分布非完全球对称及地球实际略椭，也导致重-{}-力在各地有微小差异。

17. 由于离心力的原因，在一般情况下“铅直向下”方向并不指向地心，然而重-{}-力方向仍然是与铅直向下方向完全一致的。

18.

19. 使用拉格朗日方程时也可以使用广义势能*U*=*q*(*φ*+***v***·***A***)描述，见[\#广义势能](../Page/#广义势能.md "wikilink")

[Trebuchet.jpg](https://zh.wikipedia.org/wiki/File:Trebuchet.jpg "fig:Trebuchet.jpg")，利用平衡重鎚的[重-{}-力势能](https://zh.wikipedia.org/wiki/重力勢能 "wikilink")，將石頭拋向敵城。\]\]
[JiangNanTianChi.JPG](https://zh.wikipedia.org/wiki/File:JiangNanTianChi.JPG "fig:JiangNanTianChi.JPG")將電力用位能的形式儲存\]\]
**势能**（），亦稱**-{zh-tw:勢能;
zh-hk:勢能;zh-cn:位能}-**，是储存于一[物理系统内的一种](https://zh.wikipedia.org/wiki/物理 "wikilink")[能量](../Page/能量.md "wikilink")，是一个用来描述物体在保守力场中[做功能力大小的](https://zh.wikipedia.org/wiki/做功 "wikilink")[物理量](../Page/物理量.md "wikilink")。[保守力作](../Page/保守力.md "wikilink")[功与路径无关](../Page/功.md "wikilink")，故可定义一个仅与位置有关的[函数](../Page/函数.md "wikilink")，使得保守力沿任意路径所做的功，可表达为这两点函数值的差，这个函数便是势能。
...
除此之外，我们还可以将势能的定义从现在的基础上拓展。比如[热学中气体分子间的相互作用势能](https://zh.wikipedia.org/wiki/热学 "wikilink")，它是大量分子势能的和，实际不是用相对位置（位形）来描述的，而是用[体积](../Page/体积.md "wikilink")、[温度](../Page/温度.md "wikilink")、[压强等热学参量](../Page/压强.md "wikilink")。又如，在一些特定的约束条件下，某些平时是非保守力的力也成为了保守力\[3\]，或者几种力的合力恰巧成为了一个保守力。
...
广义势能最主要的应用在于带电粒子在[电磁场中的运动上](../Page/电磁场.md "wikilink")。带有[电荷q](https://zh.wikipedia.org/wiki/电荷 "wikilink")，以速度v移動的粒子在[电场](https://zh.wikipedia.org/wiki/电场 "wikilink")**E**和[磁场](https://zh.wikipedia.org/wiki/磁场 "wikilink")**B**中受到[洛伦兹力](../Page/洛伦兹力.md "wikilink")
...
势能为[能量的一种](../Page/能量.md "wikilink")，具有能量量纲，在[国际单位制下的单位是](../Page/国际单位制.md "wikilink")[焦耳](../Page/焦耳.md "wikilink")（J），另外在涉及到[粒子物理时常用到](https://zh.wikipedia.org/wiki/粒子物理 "wikilink")[电子伏特](https://zh.wikipedia.org/wiki/电子伏特 "wikilink")（eV），高斯单位制下为[尔格](https://zh.wikipedia.org/wiki/尔格 "wikilink")（erg）。势能一般使用“*E<sub>p</sub>*”\[6\]表示，也常使用“*W*”\[7\]“*U*”和“*V*”\[8\]。
...
在物理中有时会提到势，请不要与势能相混淆。势通常表述为势能与一个物理量的比值，如[电势](https://zh.wikipedia.org/wiki/电势 "wikilink")（一个粒子静电势能与其电荷量的比值），[引力势](https://zh.wikipedia.org/wiki/引力势 "wikilink")（一个物体[引力势能与其质量的比值](../Page/引力势能.md "wikilink")）。一个确定保守力场中，一个物体的势能与该物体有关，但势的分布与该物体无关\[13\]。
...
在[靜電學裏](../Page/靜電學.md "wikilink")，根据[库伦定律](https://zh.wikipedia.org/wiki/库伦定律 "wikilink")，对于两静止点电荷*q*、*q*<sub>0</sub>，点电荷*q*受到的静电力为
...
[分子力实际上来源于多个方面](https://zh.wikipedia.org/wiki/凡得瓦力 "wikilink")，精确的计算与各分子内部结构有很大关系，会变得十分复杂。对于无极性分子，两分子间作用力可近似用以下半经验公式表示：\[20\]
...
对[兰纳-琼斯势在排斥力部分简化](../Page/兰纳-琼斯势.md "wikilink")，成为[苏则朗势](https://zh.wikipedia.org/wiki/苏则朗势 "wikilink")（Sutherland
potential），即

[Lerch_transsendent.gif](https://zh.wikipedia.org/wiki/File:Lerch_transsendent.gif "fig:Lerch_transsendent.gif")
[Lerch_complex_plot.gif](https://zh.wikipedia.org/wiki/File:Lerch_complex_plot.gif "fig:Lerch_complex_plot.gif")
**勒奇函数**是一种特殊函数，定义如下

...
某些實體數據只將作業系統鎖住，直到受害者付清贖金後才將電腦解鎖。實體數據可能以數種手段來達成恐嚇，包括將[Windows的](https://zh.wikipedia.org/wiki/Windows "wikilink")[使用者介面](https://zh.wikipedia.org/wiki/使用者介面 "wikilink")（Windows Shell）綁定為病毒程式，\[11\] 或甚至修改磁碟的[主啟動磁區](https://zh.wikipedia.org/wiki/主啟動磁區 "wikilink")、硬碟分割表等。 \[12\] 最嚴重的一種實體數據將受害者的檔案[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")，以多種加密方法讓受害者無法使用檔案，唯一的方法通常就是向該病毒的作者繳納贖金，換取加密金鑰，以解開加密檔案。\[13\]\[14\]\[15\]
...
## 延伸閱讀
  ...
  - <cite class="citation web" contenteditable="false">["Exploit Kits and CryptoWall 3.0"](http://www.rackspace.com/blog/exploit-kits-and-cryptowall-3-0/). The Rackspace Blog\! </cite><cite class="citation web" contenteditable="false">& NewsRoom.</cite><span class="Z3988" title="ctx_ver=Z39.88-2004&rfr_id=info%3Asid%2Fen.wikipedia.org%3ARansomware&rft.aufirst=Duncan&rft.aulast=Brad&rft.btitle=Exploit+Kits+and+CryptoWall+3.0&rft.date=2015-03-02&rft.genre=unknown&rft_id=http%3A%2F%2Fwww.rackspace.com%2Fblog%2Fexploit-kits-and-cryptowall-3-0%2F&rft.pub=The+Rackspace+Blog%21+%26+NewsRoom&rft_val_fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook" contenteditable="false"> </span>

...
上述方程及其解函数因[法国](https://zh.wikipedia.org/wiki/法国 "wikilink")[数学家](../Page/数学家.md "wikilink")[阿德里安-马里·勒让德而得名](../Page/阿德里安-马里·勒让德.md "wikilink")。勒让德方程是[物理学和其他技术领域常常遇到的一类](../Page/物理学.md "wikilink")[常微分方程](../Page/常微分方程.md "wikilink")。当试图在[球坐标中求解三维](https://zh.wikipedia.org/wiki/球坐标 "wikilink")[拉普拉斯方程](../Page/拉普拉斯方程.md "wikilink")（或相关的其他[偏微分方程](../Page/偏微分方程.md "wikilink")）时，问题便会归结为勒让德方程的求解。
...
值变化方程的解相应变化，构成一组由[正交多项式组成的](https://zh.wikipedia.org/wiki/正交多项式 "wikilink")[多项式序列](https://zh.wikipedia.org/wiki/多项式序列 "wikilink")，这组多项式称为**勒让德多项式**（Legendre
polynomials）。

勒让德多项式P<sub>*n*</sub>(*x*)是*n*
阶多项式，可用[罗德里格公式表示为](https://zh.wikipedia.org/wiki/罗德里格公式 "wikilink")：
...
关于[L<sup>2</sup>内积满足](../Page/Lp空间.md "wikilink")[正交性](https://zh.wikipedia.org/wiki/正交性 "wikilink")，即：

\[\int_{-1}^{1} P_m(x) P_n(x)\,dx = {2 \over {2n + 1}} \delta_{mn}\]

其中 δ<sub>*mn*</sub>
为[克罗内克δ记号](https://zh.wikipedia.org/wiki/克罗内克δ "wikilink")，当*m*
= *n* 时为1，否则为0。 事实上，推导勒让德多项式的另一种方法便是关于前述内积空间对多项式{1, *x*,
*x*<sup>2</sup>,
...
在求解三维空间中的球对称问题，譬如计算[点电荷在空间中激发的](https://zh.wikipedia.org/wiki/点电荷 "wikilink")[电势时](https://zh.wikipedia.org/wiki/电势 "wikilink")，常常要用到勒让德多项式作如下形式的[级数展开](../Page/级数.md "wikilink")：
...
当阶数*k*
为[偶数时](https://zh.wikipedia.org/wiki/偶数 "wikilink")，\(P_k(x)\)为[偶函数](https://zh.wikipedia.org/wiki/偶函数 "wikilink")；当阶数*k*
为[奇数时](https://zh.wikipedia.org/wiki/奇数 "wikilink")，\(P_k(x)\)为[奇函数](https://zh.wikipedia.org/wiki/奇函数 "wikilink")，即：
...
分数阶勒让德多项式通过将分数阶微分（定义参见[分数微积分理论](../Page/分数微积分.md "wikilink")）和通过[Γ函数定义的非整数](../Page/Γ函数.md "wikilink")[阶乘代入](https://zh.wikipedia.org/wiki/阶乘 "wikilink")[罗德里格公式中来定义](https://zh.wikipedia.org/wiki/罗德里格公式 "wikilink")。

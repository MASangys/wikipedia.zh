在[数学分析](../Page/数学分析.md "wikilink")和[测度论中](https://zh.wikipedia.org/wiki/测度论 "wikilink")，**[勒贝格控制收敛定理](https://zh.wikipedia.org/wiki/勒贝格 "wikilink")**提供了[积分](../Page/积分.md "wikilink")运算和[极限运算可以交换运算顺序的一个](https://zh.wikipedia.org/wiki/极限 "wikilink")[充分条件](https://zh.wikipedia.org/wiki/充分条件 "wikilink")。在分析[逐点收敛的](https://zh.wikipedia.org/wiki/逐点收敛 "wikilink")[函数](../Page/函数.md "wikilink")[数列](../Page/数列.md "wikilink")的[勒贝格积分时](https://zh.wikipedia.org/wiki/勒贝格积分 "wikilink")，积分号和逐点收敛的极限号并不总是可以交换的。控制收敛定理说明了，如果[逐点收敛的](https://zh.wikipedia.org/wiki/逐点收敛 "wikilink")[函数](../Page/函数.md "wikilink")列的每一项都能被同一个[勒贝格可积的函数](https://zh.wikipedia.org/wiki/勒贝格积分 "wikilink")“**控制**”（即对[变量的任何取值](https://zh.wikipedia.org/wiki/变量 "wikilink")，函数的[绝对值](../Page/绝对值.md "wikilink")都小于另一个函数），那么[函数](../Page/函数.md "wikilink")列的极限函数的勒贝格积分等于函数列中每个函数的勒贝格积分的极限。勒贝格控制收敛定理显示出勒贝格积分相比于[黎曼积分](../Page/黎曼积分.md "wikilink")的优越性，在数学分析和实变函数论中有很大的应用。
...
勒贝格控制收敛定理是更广泛的[法图-勒贝格定理](https://zh.wikipedia.org/wiki/法图-勒贝格定理 "wikilink")（）的特例。以下是一个引用[法图引理](../Page/法图引理.md "wikilink")的证明。

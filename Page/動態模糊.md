...
預先運算生成的電腦圖像中，如[電腦合成影像的電影](../Page/電腦合成影像.md "wikilink")，可以繪出逼真的動態模糊，因為渲染器（renderer）有更多時間來繪製每個畫面。時間上避免失真需依照許多瞬間時間的組合來製造畫面。
...
,\(psf(x)\)為已知的[點擴散函數PSF](../Page/點擴散函數.md "wikilink")(Point

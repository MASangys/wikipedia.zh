在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，**動量算符**（）是一種[算符](https://zh.wikipedia.org/wiki/算符_\(物理学\) "wikilink")，可以用來計算一個或多個粒子的[動量](https://zh.wikipedia.org/wiki/動量 "wikilink")。對於一個不帶[電荷](../Page/電荷.md "wikilink")、沒有[自旋的粒子](../Page/自旋.md "wikilink")，作用於[波函數](https://zh.wikipedia.org/wiki/波函數 "wikilink")
\(\psi(x)\,\!\) 的動量算符可以寫為

\[\hat{p}=\frac{\hbar}{i}\frac{\partial}{\partial x}\,\!\] ；

其中，\(\hat{p}\,\!\) 是動量算符，\(\hbar\,\!\)
是[約化普朗克常數](https://zh.wikipedia.org/wiki/約化普朗克常數 "wikilink")，\(i\,\!\)
是[虛數單位](../Page/虛數單位.md "wikilink")，\(x\,\!\) 是位置。

給予一個粒子的波函數 \(\psi(x)\,\!\)
，這粒子的動量[期望值為](https://zh.wikipedia.org/wiki/期望值_\(量子力学\) "wikilink")
...
對於一個非[相對論性的](https://zh.wikipedia.org/wiki/相對論 "wikilink")[自由粒子](../Page/自由粒子.md "wikilink")，位勢
\(V(x)=0\,\!\)
，[不含時薛丁格方程式表達為](https://zh.wikipedia.org/wiki/不含時薛丁格方程式 "wikilink")
...
是粒子的[質量](https://zh.wikipedia.org/wiki/質量 "wikilink")，\(\psi(x)\,\!\)
是粒子的[波函數](https://zh.wikipedia.org/wiki/波函數 "wikilink")，\(x\,\!\)
是粒子的位置，\(E\,\!\) 是粒子的[能量](../Page/能量.md "wikilink")。
...
自由粒子具有明確的動量 \(p\,\!\)
，給予一個[系綜許多相同的自由粒子系統](https://zh.wikipedia.org/wiki/系綜 "wikilink")。每一個自由粒子系統的量子態都一樣。標記粒子的動量算符為
\(\hat{p}\,\!\) 。假若，對於這系綜內，每一個自由粒子系統的動量所作的測量，都得到同樣的測量值 \(p\,\!\)
，那麼，不確定性 \(\sigma_{p}=0\,\!\)
，這自由粒子的量子態是[確定態](https://zh.wikipedia.org/wiki/可觀察量#確定態 "wikilink")，是
\(\hat{p}\,\!\)
的[本徵態](https://zh.wikipedia.org/wiki/本徵態 "wikilink")，在[位置空間](https://zh.wikipedia.org/wiki/位置空間 "wikilink")()裏，[本徵函數為](../Page/本徵函數.md "wikilink")
\(\psi_k\,\!\) ，[本徵值為](https://zh.wikipedia.org/wiki/本徵值 "wikilink")
\(p\,\!\) ：

\[\hat{p}\psi_k(x)=p\psi_k(x)\,\!\] 。

換句話說，在位置空間裏，動量算符的[本徵函數必須是自由粒子的波函數](../Page/本徵函數.md "wikilink")
\(\psi_k(x)\,\!\) \[1\]。
...
其中，\(\Psi(x,\,t)\,\!\)
是[波函數](https://zh.wikipedia.org/wiki/波函數 "wikilink")。
...
\[\langle p\rangle=m \int_{ - \infty}^{\infty}\ \left( \frac{\partial \Psi^*}{\partial t}x\Psi
+\Psi^*x\frac{\partial \Psi}{\partial t} \right) dx\,\!\]
...
\[\int_{ - \infty}^{\infty}\ \frac{\partial^2 \Psi^*}{\partial x^2}x\Psi\ dx= - \int_{ - \infty}^{\infty}\ \frac{\partial \Psi^*}{\partial x}\Psi\ dx - \int_{ - \infty}^{\infty}\ \frac{\partial \Psi^*}{\partial x}x\frac{\partial \Psi}{\partial x}\ dx \,\!\]
，<span style="position:absolute;right:15%">(2)</span>

\[\int_{ - \infty}^{\infty}\ \Psi^* x\frac{\partial^2 \Psi}{\partial x^2}\ dx= - \int_{ - \infty}^{\infty}\ \Psi^*\frac{\partial \Psi}{\partial x}\ dx - \int_{ - \infty}^{\infty}\ \frac{\partial \Psi^*}{\partial x}x\frac{\partial \Psi}{\partial x}\ dx \,\!\]
。<span style="position:absolute;right:15%">(3)</span>

方程式 (2) 與 (3)
的減差（使用[分部積分法](../Page/分部積分法.md "wikilink")，并利用当x趋于无穷大时波函数\(\Psi\,\!\)趋于零的特性）
...
對於任意波函數 \(\Psi\,\!\) ，這方程式都成立。因此，可以認定動量算符 \(\hat{p}\,\!\) 為
...
根據[伴隨算符的定義](https://zh.wikipedia.org/wiki/伴隨算符 "wikilink")，假設
\(\hat{O}^{\dagger}\,\!\) 是 \(\hat{O}\,\!\) 的伴隨算符，則
\(\langle \psi|\hat{O}|\psi\rangle^*=\langle\psi |\hat{O}^{\dagger}|\psi\rangle\,\!\)
。因此，

\[\hat{O}=\hat{O}^{\dagger}\,\!\] 。

這正是[厄米算符的定義](https://zh.wikipedia.org/wiki/厄米算符 "wikilink")。所以，表示可觀察量的算符
\(\hat{O}\,\!\) ，都是厄米算符。

動量是一個可觀察量，動量算符應該也是厄米算符：選擇位置空間，量子態 \(|\psi\rangle\,\!\) 的波函數為
\(\psi(x)\,\!\) ，
...
對於任意量子態 \(|\psi\rangle\,\!\) ，\(\hat{p}=\hat{p}^{\dagger}\,\!\)
。所以，動量算符確實是一個厄米算符。

## 本徵值與本徵函數

假設，動量算符 \(\hat{p}\,\!\)
的[本徵值為](https://zh.wikipedia.org/wiki/本徵值 "wikilink")
\(p\,\!\) 的[本徵函數是](../Page/本徵函數.md "wikilink") \(f_p(x)\,\!\) ：
...
假設 \(f_p(x)\,\!\) 的定義域是一個有限空間，從 \(x= - L\,\!\) 到 \(x=L\,\!\) ，那麼，可以將
\(f_p(x)\,\!\) [歸一化](https://zh.wikipedia.org/wiki/歸一化 "wikilink")：

\[\int_{ - L}^{L}\ f_p^*(x)f_p(x)\ dx=|f_0|^2 \int_{ - L}^{L}\ dx=|f_0|^2 2L=1\,\!\]
。

\(f_0\,\!\) 的值是 \(1/\sqrt{2L}\,\!\) 。動量算符的本徵函數歸一化為
\(f_p(x)=\frac{1}{\sqrt{2L}} e^{ipx/\hbar}\,\!\) 。

假設 \(f_p(x)\,\!\) 的定義域是無窮大空間，則 \(f_p(x)\,\!\)
不是一個[平方可積函數](../Page/平方可積函數.md "wikilink")：

\[\int_{ - \infty}^{\infty}\ f_p^*(x)f_p(x)\ dx=|f_0|^2 \int_{ - \infty}^{\infty}\ dx=\infty\,\!\]
。

動量算符的本徵函數不存在於[希爾伯特空間內](https://zh.wikipedia.org/wiki/希爾伯特空間 "wikilink")，不能直接地積分
\(|f_p(x)|^2\,\!\) 於無窮大空間，來使 \(f_p(x)\,\!\) 歸一化。
...
其中，\(\delta(p1-p2)\,\!\)
是[狄拉克δ函數](https://zh.wikipedia.org/wiki/狄拉克δ函數 "wikilink")。

這性質不是普通的[正交歸一性](https://zh.wikipedia.org/wiki/正交歸一性 "wikilink")。稱這性質為**狄拉克正交歸一性**。因為這性質，動量算符的本徵函數是**完備**的。也就是說，任意波函數
\(\psi(x)\,\!\) 都可以表達為本徵函數的線性組合：
...
所以，\([\hat{x},\ \hat{p}]=i\hbar\,\!\)
。這關係稱為位置算符與動量算符的[正則對易關係](https://zh.wikipedia.org/wiki/正則對易關係 "wikilink")。由於兩者的正則對易關係不等於
0
，位置與動量彼此是[不相容可觀察量](https://zh.wikipedia.org/wiki/可觀察量#不相容可觀察量 "wikilink")。\(\hat{x}\,\!\)
與 \(\hat{p}\,\!\) 絕對不會有共同的基底量子態。一般而言，\(\hat{x}\,\!\) 的本徵態與
\(\hat{p}\,\!\) 的本徵態不同。
...
由於 \(x\,\!\) 與 \(p\,\!\)
是兩個不相容可觀察量，\(\left|\frac{\langle[\hat{x},\ \hat{p}]\rangle}{2i}\right| =\hbar/2\,\!\)
。所以，\(x\,\!\) 的不確定性與 \(p\,\!\) 的不確定性的乘積 \(\Delta x\ \Delta p \,\!\)
，必定大於或等於 \(\hbar/2\,\!\) 。

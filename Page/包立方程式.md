**包立方程式**或稱**薛丁格-包立方程式**，為描述帶有[自旋1/2的粒子在與](https://zh.wikipedia.org/wiki/自旋1/2 "wikilink")[電磁場交互作用下的修正方程式](https://zh.wikipedia.org/wiki/電磁場 "wikilink")（自旋1/2粒子例如[電子](https://zh.wikipedia.org/wiki/電子 "wikilink")）。在此之前，用以描述粒子行為的[薛丁格方程式則未考慮到粒子](https://zh.wikipedia.org/wiki/薛丁格方程式 "wikilink")[自旋的性質](../Page/自旋.md "wikilink")。其為[狄拉克方程式在](../Page/狄拉克方程式.md "wikilink")[非相對論極限下的特例](https://zh.wikipedia.org/wiki/相對論 "wikilink")，應用在粒子速度慢到相對論效應可以忽略的場合。

包立方程式是由[沃爾夫岡·包立於](https://zh.wikipedia.org/wiki/沃爾夫岡·包立 "wikilink")1927年所建構。

## 方程式

一自旋粒子具有[質量](https://zh.wikipedia.org/wiki/質量 "wikilink")*m*、[電荷](../Page/電荷.md "wikilink")*q*，於外加電磁場中運動；外加電磁場可以[純量勢](../Page/電勢.md "wikilink")*ϕ*、[向量勢](https://zh.wikipedia.org/wiki/磁向量勢 "wikilink")**A**
= (*A<sub>x</sub>*, *A<sub>y</sub>*,
*A<sub>z</sub>*)來描述。包立方程式可描述外加[電磁場與自旋交互作用的影響](https://zh.wikipedia.org/wiki/電磁場 "wikilink")：
...
這表示系統是有額外但[簡併的的自由度](https://zh.wikipedia.org/wiki/簡併 "wikilink")。
...
equation），右半部[斯特恩-革拉赫項](https://zh.wikipedia.org/wiki/斯特恩-革拉赫實驗 "wikilink")（上式Stern-Gerlach
term）。如此可解釋帶有一個[價電子的原子何以得到得到自旋取向](https://zh.wikipedia.org/wiki/價電子 "wikilink")，例如流過不均勻磁場的[銀原子](../Page/銀.md "wikilink")。相似地，比如在[反常塞曼效應](https://zh.wikipedia.org/wiki/塞曼效應 "wikilink")，這一項造成磁場中的譜線（對應到能階）分裂。

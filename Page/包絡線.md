...
**包絡線**（Envelope）是[幾何學裡的概念](https://zh.wikipedia.org/wiki/幾何學 "wikilink")，代表一條[曲線與某個](https://zh.wikipedia.org/wiki/曲線 "wikilink")[曲線族中的每條線都有至少一點](https://zh.wikipedia.org/wiki/曲線族 "wikilink")[相切](https://zh.wikipedia.org/wiki/相切 "wikilink")。（[曲線族即一些曲線的](https://zh.wikipedia.org/wiki/曲線族 "wikilink")[無窮集](https://zh.wikipedia.org/wiki/無限集合 "wikilink")，它們有一些特定的關係。）
...
若曲線族以[隱函數形式](https://zh.wikipedia.org/wiki/隱函數 "wikilink")
\(F(x,y,s)=0\) 表示，其包絡線的隱方程，便是以下面兩個方程消去\(s\)得出。

[Diffeq.png](https://zh.wikipedia.org/wiki/File:Diffeq.png "fig:Diffeq.png")
[EnvelopeAnim.gif](https://zh.wikipedia.org/wiki/File:EnvelopeAnim.gif "fig:EnvelopeAnim.gif")
**包絡線**（Envelope）是[幾何學裡的概念](../Page/幾何學.md "wikilink")，代表一條[曲線與某個](../Page/曲線.md "wikilink")[曲線族中的每條線都有至少一點](../Page/曲線族.md "wikilink")[相切](../Page/相切.md "wikilink")。（[曲線族即一些曲線的](../Page/曲線族.md "wikilink")[無窮集](../Page/無限集合.md "wikilink")，它們有一些特定的關係。）
...
若曲線族以[隱函數形式](../Page/隱函數.md "wikilink") \(F(x,y,s)=0\)
表示，其包絡線的隱方程，便是以下面兩個方程消去\(s\)得出。

  -
    \(\begin{cases} F(x,y,s)=0\\ \frac{\partial F(x,y,s)}{\partial s} =0\end{cases}\)

**繡曲線**是包絡線的例子。直線族\((A-s) x + s y = (A-s)(s)\)（其中\(A\)是常數，\(s\)是直線族的變數）的包絡線為[拋物線](../Page/拋物線.md "wikilink")。[1](http://www.cut-the-knot.org/Curriculum/Geometry/ParabolaEnvelope.shtml)
...
在E的切向量為\(< \frac{dx}{ds}, \frac{dy}{ds}  >\)。因為\(x\)是\(s\)和\(t\)的函數，而此處\(t=h(s)\)，[局部求導有](../Page/局部求導.md "wikilink")：
...
類似地得
\(\frac{dy}{ds} = \frac{\partial y}{\partial h} h'(s) + \frac{\partial y}{\partial s}\)。
...
## 參見
  ...
  - [克萊羅方程](../Page/克萊羅方程.md "wikilink")

## 外部連結

  - [Special Plane Curves:
    Envelope](http://xahlee.org/SpecialPlaneCurves_dir/Envelope_dir/envelope.html)
  - [Envelopes of Lines and
    Circles](http://jwilson.coe.uga.edu/Texts.Folder/Envel/envelopes.html)

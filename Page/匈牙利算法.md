**匈牙利算法**是一种在[多项式时间内求解](../Page/时间复杂度.md "wikilink")[任务分配问题](../Page/任务分配问题.md "wikilink")的[组合优化](https://zh.wikipedia.org/wiki/组合优化 "wikilink")[算法](../Page/算法.md "wikilink")，并推动了后来的[原始对偶方法](https://zh.wikipedia.org/wiki/原始对偶方法 "wikilink")。美国数学家于1955年提出该算法。此算法之所以被称作匈牙利算法，是因为算法很大一部分是基于以前[匈牙利](../Page/匈牙利.md "wikilink")数学家Dénes Kőnig和Jenő Egerváry的工作之上创建起来的。\[1\]\[2\]

**化学混合流爆炸方程**是一组模拟化学混合流爆炸波的二元非线性偏微分方程：\[1\]

\(v(x, t)_x-v(x, t)*(1/2)*u(x, t)/\beta+\gamma*\kappa = 0\)

\(u(x, t)_t+u(x, t)*u(x, t)_x-\alpha*v(x, t)_x-\beta*u(x, t)_x = 0\)
...
1.  阎振亚著 《复杂非线性波的构造性理论及其应用》 第111页 科学出版社 2007年
在计算机编程中，**匿名函数**（）是指一类无需定义[标识符](https://zh.wikipedia.org/wiki/标识符 "wikilink")（函数名）的[函数或](../Page/函数.md "wikilink")[子程序](../Page/子程序.md "wikilink")，普遍存在于多种编程语言中。
...
<td></td>
<td><p>在有<a href="../Page/clang.md" title="wikilink">clang和llvm的compiler</a>-rt程序库的环境下支援</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p><a href="https://zh.wikipedia.org/wiki/Rust" title="wikilink">Rust</a></p></td>
<td></td>
...
<tr class="odd">
<td><p><a href="https://zh.wikipedia.org/wiki/Visual_Prolog" title="wikilink">Visual Prolog</a> v 7.2</p></td>
<td></td>
<td></td>
</tr>
<tr class="even">
...
lambda函数的数据类型是[函数对象](https://zh.wikipedia.org/wiki/函数对象 "wikilink")，保存时必须用`std::function`模板类型或`auto`关键字。
例如：
...
[C++14增加了广义捕获](https://zh.wikipedia.org/wiki/C++14 "wikilink")(Generalized
...
C++14还允许lambda函数的形参使用`auto`关键字作为其类型，这实质上是函数对象的`operator()`成员作为模板函数；并且允许[可变参数模板](https://zh.wikipedia.org/wiki/可变参数模板 "wikilink")。

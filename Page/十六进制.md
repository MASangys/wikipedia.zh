...
例如[十进制數](../Page/十进制.md "wikilink")57，在[二进制寫作](https://zh.wikipedia.org/wiki/二进制 "wikilink")111001，在16进制寫作39。

在历史上，[中国曾经在重量单位上使用过](https://zh.wikipedia.org/wiki/中国 "wikilink")16进制，比如，规定16[两为一](../Page/两.md "wikilink")[斤](../Page/斤.md "wikilink")。
...
不同[電腦系統](https://zh.wikipedia.org/wiki/電腦 "wikilink")、[編程語言對於](https://zh.wikipedia.org/wiki/編程語言 "wikilink")16進制數值有不同的表示方式：
  ...
  - [C語言](https://zh.wikipedia.org/wiki/C語言 "wikilink")、C++、[Shell](../Page/Bash.md "wikilink")、[Python](../Page/Python.md "wikilink")、[Java語言及其他相近的語言使用字首](../Page/Java.md "wikilink")「0x」，例如「0x5A3」。开头的「0」令[解析器更易辨认数](https://zh.wikipedia.org/wiki/解析器 "wikilink")，而「x」則代表十六进制（就如「O」代表[八进制](https://zh.wikipedia.org/wiki/八进制 "wikilink")）。在「0x」中的「x」可以[大寫或](../Page/大寫字母.md "wikilink")[小寫](https://zh.wikipedia.org/wiki/小寫字母 "wikilink")。对于字符量C语言中则以x+两位十六进制数的方式表示，如xFF。
      - C++11引进了十六进制浮点型[字面常量](../Page/字面常量_\(C语言\).md "wikilink")。例如：`0x1.2p10`表示
        （1+2/16）×2<sup>10</sup>=1152<sub>10</sub>。实际上，[Visual
        C++一直以来使用的C](https://zh.wikipedia.org/wiki/Visual_C++ "wikilink")/C++语言标准库函数printf，`%a`作为类型说明符来格式化输出浮点型值即为上述格式。例如：`printf("%a",1152.0);`
      - C/C++在表示字符型字面常量时，可以用：
  ...
  - 在[VB](https://zh.wikipedia.org/wiki/VB "wikilink")、MSX BASIC、Quick
  ...
  - 其他匯編器（[AT\&T](../Page/AT&T.md "wikilink")、[Motorola](https://zh.wikipedia.org/wiki/Motorola "wikilink")、6502），[Pascal](https://zh.wikipedia.org/wiki/Pascal_\(编程语言\) "wikilink")，[Delphi和某些BASIC的版本使用字首](../Page/Delphi.md "wikilink")「$」，例如「$5A3」
  - 亦有用`X'5A3'`這類表示方式的，如于[PL/I](https://zh.wikipedia.org/wiki/PL/I "wikilink")，[COBOL及](../Page/COBOL.md "wikilink")[JCL中](https://zh.wikipedia.org/wiki/JCL "wikilink")。这亦是[IBM装载早期操作系统的](../Page/IBM.md "wikilink")[大型机与](https://zh.wikipedia.org/wiki/大型机 "wikilink")[小型机上最常用的数据格式](https://zh.wikipedia.org/wiki/小型机 "wikilink")。
...
在[網頁設計上十六進制是很常用的](https://zh.wikipedia.org/wiki/網頁設計 "wikilink")。[HTML和](../Page/HTML.md "wikilink")[CSS使用十六進制的表示法來表示網頁上的特定顏色](https://zh.wikipedia.org/wiki/Cascading_Style_Sheets "wikilink")。使用
...
[网页颜色模式](https://zh.wikipedia.org/wiki/网页颜色模式 "wikilink").

在[URL的特殊字元亦是用](https://zh.wikipedia.org/wiki/URL "wikilink")[ASCII中的十六进位](../Page/ASCII.md "wikilink")，每字節都有百份比符號（%）在前，例如：
...
用例（[类UNIX系统中](https://zh.wikipedia.org/wiki/类UNIX "wikilink")）：

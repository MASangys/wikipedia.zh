...
在使用这个公式时，必须确保 <span class="texhtml">*h*</span> 不超过1（<span class="texhtml">*d*</span> 只当h的值在0到1间才有意义）。 <span class="texhtml">*h*</span> 仅在球面上两点连线过球心时才为1，当测量精度有限时，会产生较大的计算误差。 <span class="texhtml">*d*</span> 如果大到接近圆周的一半长度<span class="texhtml">π*R*</span> 时（这个情况并不常见），一个小错误通常是一个大问题在。虽然还有其他的[大圆距离](../Page/大圆距离.md "wikilink")公式，能够避免这个问题。上述公式有时候用[反正切](../Page/反正切.md "wikilink")函数表达，但是h接近1时这个问题仍然存在。

但是仍有对策来避免上述问题。类似的公式可以使用余弦函数表达（有时亦称为球面余弦定理，但是并非平面[余弦定理](https://zh.wikipedia.org/wiki/余弦定理 "wikilink")）而不是半正矢，但如果这两点十分靠近（例如在地球上的一公里外）你可能得到的结果为 <span class="texhtml">cos(<span class="sfrac nowrap" style="display:inline-block; vertical-align:-0.5em;  text-align:center;"><span style="display:block; line-height:1em; padding:0 0.1em;">*d*</span><span style="display:none;">/</span><span style="display:block; line-height:1em; padding:0 0.1em; border-top:1px solid;">*R*</span></span>)</span> =0.99999999，导致一系列的误差。而由于半正矢式使用正弦函数，避免了这一问题。所以两个公式应该互补使用。

因为[地球](../Page/地球.md "wikilink")是一个不完美的球体，故当其应用于地球时，无论哪一个公式只是做一个近似测算，"[地球半径](../Page/地球半径.md "wikilink")" <span class="texhtml">*R*</span> 在极点地区是6356.752 公里，在赤道地区为6378.137 公里。另外，半径曲率在极点处(≈6399.594 公里)比在赤道处(≈6335.439 公里)大1%，所以半正矢公式或者球面余弦定理是不能保证0.5%以内的误差。更准确的方法，应该是使用考虑地球[离心率的Vincenty的公式或其他有关地理距离的论文所给出方法](https://zh.wikipedia.org/wiki/离心率 "wikilink")。

## 半正矢定理

[右](https://zh.wikipedia.org/wiki/File:Law-of-haversines.svg "fig:右") 给出一个单位球，一个在表面的球面三角形 三个过三点(u,v,w)的大圆所围出来的区域。如图这个球面三角形的三边分别是 <span class="texhtml">*a*</span>（<span class="texhtml">**u**</span> 至 <span class="texhtml">**v**</span>），<span class="texhtml">*b*</span>（<span class="texhtml">**u**</span> 到 <span class="texhtml">**w**</span>）和 <span class="texhtml">*c*</span>（<span class="texhtml">**v**</span> 至 <span class="texhtml">**w**</span>）并且角C对边c那么有如下关系
...
由于这是一个单位球，弧长 <span class="texhtml">*a*</span>、 <span class="texhtml">*b*</span> 和 <span class="texhtml">*c*</span> 与两端点同球心构成的圆心角（[弧度制](https://zh.wikipedia.org/wiki/弧度 "wikilink")）相等。

为了从该定理中得到半正矢公式。只要一个认为特<span class="texhtml">**u**</span>是[北极](../Page/北极点.md "wikilink")，而<span class="texhtml">**v**</span>和<span class="texhtml">**w**</span>两点，其距离 <span class="texhtml">*d*</span> 是要计算的。在这种情况下， <span class="texhtml">*a*</span> 和 <span class="texhtml">*b*</span> 是 <span class="texhtml"><span class="sfrac nowrap" style="display:inline-block; vertical-align:-0.5em;  text-align:center;"><span style="display:block; line-height:1em; padding:0 0.1em;">π</span><span style="display:none;">/</span><span style="display:block; line-height:1em; padding:0 0.1em; border-top:1px solid;">2</span></span> − *φ*<sub>1,2</sub></span> (即，90° − 纬度), <span class="texhtml">*C*</span> 是 <span class="texhtml">Δ*λ*</span> 和 <span class="texhtml">*c*</span> 是求的 <span class="texhtml"><span class="sfrac nowrap" style="display:inline-block; vertical-align:-0.5em;  text-align:center;"><span style="display:block; line-height:1em; padding:0 0.1em;">*d*</span><span style="display:none;">/</span><span style="display:block; line-height:1em; padding:0 0.1em; border-top:1px solid;">*R*</span></span></span>. 结合 <span class="texhtml">sin(<span class="sfrac nowrap" style="display:inline-block; vertical-align:-0.5em;  text-align:center;"><span style="display:block; line-height:1em; padding:0 0.1em;">π</span><span style="display:none;">/</span><span style="display:block; line-height:1em; padding:0 0.1em; border-top:1px solid;">2</span></span> − *φ*) = cos(*φ*)</span>，半正矢公式即可推导得出。

或者可以从球面余弦定理中得出

\[\cos(c)=\cos(a)\cos(b)+\sin(a)\sin(b)\cos(C)\]\(\)

当 <span class="texhtml">*c*</span> 很小时，这个公式精度不高。所以我们可以用<span class="texhtml">cos(*θ* ) = 1 − 2 hav(*θ* )</span> 来替换 ，并引用[三角恒等式](https://zh.wikipedia.org/wiki/三角恒等式 "wikilink")<span class="texhtml">cos(*a* − *b* ) = cos(*a* )cos(*b* ) + sin(*a* )sin(*b* )</span>，半正矢定理就能推出。

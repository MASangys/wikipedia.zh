近年来，**协变经典场论**又引起了研究者的兴趣。动力学在这里用[有限维空间的在](../Page/向量空间.md "wikilink")[时空中的给定时间点上的](../Page/时空.md "wikilink")[场来表述](https://zh.wikipedia.org/wiki/场 "wikilink")。[射流丛现在被认为是这种表述的正确定义域](https://zh.wikipedia.org/wiki/射流丛 "wikilink")。
...
其中\(\sigma \in \bar{\Gamma}(\pi)\)，并定义于[开集](../Page/开集.md "wikilink")\(\sigma(\mathcal{M})\,\)，而\(j^{1}\sigma\,\)代表其第一[射流延长](https://zh.wikipedia.org/wiki/射流丛 "wikilink")(jet
prolongation)。
...
其中\(\beta^{\alpha} = \beta^{\alpha}(x,u)\,\)。采用[切触形式](https://zh.wikipedia.org/wiki/射流丛 "wikilink")

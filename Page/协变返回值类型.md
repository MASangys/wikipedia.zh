在[面向对象程序设计中](../Page/面向对象程序设计.md "wikilink")，实例函数的**协变返回值类型**指的是子类中的成员函数的返回值类型不必严格等同与该函数所重写的父类中的函数的返回值类型，而可以是更
...
但是协变类型不能兼容于泛型，如使用到[智能指针或](../Page/智能指针.md "wikilink")[泛型容器的场合](https://zh.wikipedia.org/wiki/C++標準程式庫#.E5.AE.B9.E5.99.A8 "wikilink")，即如下的程序是不合法的：

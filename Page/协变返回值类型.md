在[面向对象程序设计](../Page/面向对象程序设计.md "wikilink")中，实例函数的**协变返回值类型**指的是子类中的成员函数的返回值类型不必严格等同与该函数所重写的父类中的函数的返回值类型，而可以是更
"狭窄" 的类型。在 [C++](../Page/C++.md "wikilink") 程序设计中。这是一种常见的编程范式，如下面的例子：
...
## 外部链接
  ...
  - [Covariant Return Types in
    C++](http://www.lwithers.me.uk/articles/covariant.html)

...
它是個不[連續函數](../Page/連續.md "wikilink")，其「微分」是[狄拉克δ函數](../Page/狄拉克δ函數.md "wikilink")。它是一個[幾乎必然是零的](../Page/幾乎必然.md "wikilink")[隨機變數的](../Page/隨機變數.md "wikilink")[累積分布函數](../Page/累積分布函數.md "wikilink")。

事實上，\(x = 0\)的值在函數應用上並不重要，可以任意取。

這個函數由[奥利弗·黑維塞提出](../Page/奥利弗·黑維塞.md "wikilink")。

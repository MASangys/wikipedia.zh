**单向链表**（又名单链表、线性链表）是[链表的一种](../Page/链表.md "wikilink")，其特点是链表的链接方向是单向的，对链表的访问要通过从头部开始，依序往下讀取。
...
[<File:Link>
zh.png](https://zh.wikipedia.org/wiki/File:Link_zh.png "fig:File:Link zh.png")

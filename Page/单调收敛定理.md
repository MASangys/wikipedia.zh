...
*a*<sub>*k*+1</sub>），则这个序列具有极限（如果我们把正无穷大和负无穷大也算作极限的话）。这个极限是[有限的](https://zh.wikipedia.org/wiki/有限 "wikilink")，当且仅当序列是[有界的](https://zh.wikipedia.org/wiki/有界 "wikilink")。
...
Lebesgue](https://zh.wikipedia.org/wiki/it:Passaggio_al_limite_sotto_segno_di_integrale#Integrale_di_Lebesgue "wikilink")

...
theorem）表明[解析函数有一个用实部表示的上界](../Page/解析函数.md "wikilink")。它是[最大模原理的一个应用](../Page/最大模原理.md "wikilink")，以[埃米尔·博雷尔与](../Page/埃米尔·博雷尔.md "wikilink")[康斯坦丁·卡拉西奥多里命名](../Page/康斯坦丁·卡拉西奥多里.md "wikilink")。

在[复分析中](../Page/複分析.md "wikilink")，**博雷尔-卡拉西奥多里定理**（Borel-Carathéodory
theorem）表明[解析函数](../Page/解析函数.md "wikilink")有一个用实部表示的上界。它是[最大模原理](../Page/最大模原理.md "wikilink")的一个应用，以[埃米尔·博雷尔](../Page/埃米尔·博雷尔.md "wikilink")与[康斯坦丁·卡拉西奥多里](../Page/康斯坦丁·卡拉西奥多里.md "wikilink")命名。
...
## 参考资料
  ...
  - Lang, Serge (1999). *Complex Analysis* (4th ed.). New York:
    Springer-Verlag, Inc. ISBN 0-387-98592-1.
  - Titchmarsh, E. C. (1938). *The theory of functions.* Oxford
    University Press.

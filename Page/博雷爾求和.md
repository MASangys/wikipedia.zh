在數學上，**博雷爾求和**（）是一種[发散级数的](../Page/发散级数.md "wikilink")[求和方法](../Page/发散级数.md "wikilink")。這種求和法是由提出的，在處理發散的[渐近展开時尤其有用](../Page/渐近展开.md "wikilink")。博雷爾和有時也會以其他形式出現，它的一般推廣是[米塔-列夫勒和](https://zh.wikipedia.org/wiki/米塔-列夫勒和 "wikilink")。

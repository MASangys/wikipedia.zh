[Ile_de_ré.JPG](https://zh.wikipedia.org/wiki/File:Ile_de_ré.JPG "fig:Ile_de_ré.JPG")岸[雷岛](https://zh.wikipedia.org/wiki/雷岛 "wikilink")（RHE）鲸鱼灯塔拍摄的照片，显示浅海上田字形的椭圆余弦波列。这种浅水中的[孤波](../Page/孤波.md "wikilink")可以由卡东穆夫-彼得韦亚斯维利方程模拟。\]\] **卡东穆塞夫-彼得韦亚斯维利方程**(Kadomtsev-Petviashvili equation)，简称KP方程，是1970年苏联物理学家波里斯·卡东穆塞夫 和弗拉基米尔-彼得韦亚斯维利创立以模拟非线性波动的非线性偏微分方程\[1\]：

> 本文内容由[卡咯提的-昆达利尼函数](https://zh.wikipedia.org/wiki/卡咯提的-昆达利尼函数)转换而来。


[Carotid_Fractal.png](https://zh.wikipedia.org/wiki/File:Carotid_Fractal.png "fig:Carotid_Fractal.png") **卡咯提的-昆达利尼函数**（Carotid-Kundalili Function）定义如下\[1\]
...
## 外部链接
  ...
  - [Carotid-Kundalini function](http://smallsats.org/2014/01/03/carotid-kundalini-function/)

...
不等式約束問題的必要和充分條件初見於[卡羅需](https://zh.wikipedia.org/wiki/卡羅需 "wikilink")（William Karush）的博士論文\[1\]，之後在一份由W.库恩（Harold W. Kuhn）及[塔克](https://zh.wikipedia.org/wiki/塔克 "wikilink")（Albert W. Tucker）撰寫的研討生論文\[2\]出現後受到重視。

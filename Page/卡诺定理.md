...
设ABC为[三角形](../Page/三角形.md "wikilink")，O为其[外心](../Page/外心.md "wikilink")。则O到ABC各边的距离之和为

  -
    OO<sub>*A*</sub> + OO<sub>*B*</sub> + OO<sub>*C*</sub> = *R* + *r*，

其中r为[内切圆半径](../Page/内切圆.md "wikilink")，R为[外接圆半径](../Page/外接圆.md "wikilink")。这个定理叫做**卡诺定理**（），以[拉扎尔·卡诺為名](../Page/拉扎尔·卡诺.md "wikilink")。

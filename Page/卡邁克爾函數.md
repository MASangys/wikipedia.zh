...
当n为1、2、4、奇[质数的次幂](https://zh.wikipedia.org/wiki/质数 "wikilink")、奇质数的次幂的两倍时为[欧拉函数](../Page/欧拉函数.md "wikilink")，当n为2,4以外的2的次幂时为它的一半。
\(\lambda(n) =
\begin{cases}
...
[分类:同余](https://zh.wikipedia.org/wiki/分类:同余 "wikilink")
[分类:函数](https://zh.wikipedia.org/wiki/分类:函数 "wikilink")

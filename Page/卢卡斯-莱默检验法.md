[数学中](../Page/数学.md "wikilink")，**卢卡斯-莱默检验法**（）是检验[梅森数的](https://zh.wikipedia.org/wiki/梅森数 "wikilink")[素性检验](https://zh.wikipedia.org/wiki/素性检验 "wikilink")，是由[爱德华·卢卡斯于](https://zh.wikipedia.org/wiki/爱德华·卢卡斯 "wikilink")1878年完善，随后于1930年代将其改进。
...
[37634](https://zh.wikipedia.org/wiki/37634 "wikilink"), ...
...
我们注意到\({\langle}s_i{\rangle}\)是一个具有闭式解的[递推关系](https://zh.wikipedia.org/wiki/递推关系 "wikilink")。定义\(\omega = 2 + \sqrt{3}\)及\(\bar{\omega} = 2 - \sqrt{3}\)；我们可以用[数学归纳法来验证对于所有](../Page/数学归纳法.md "wikilink")*i*，都有\(s_i = \omega^{2^i} + \bar{\omega}^{2^i}\)：
...
Ödseth的证明\[3\]。首先，注意到3是模 *M*<sub>*p*</sub>的[二次非剩余](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")，这是因为对于奇数*p* \> 1，2<sup> *p*</sup> − 1只取得值7
mod

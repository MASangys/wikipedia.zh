**卢曼-缅绍夫定理**（）是[复分析中的一条定理](https://zh.wikipedia.org/wiki/复分析 "wikilink")。该定理指出，定义在[复平面上某个区域内的](../Page/复平面.md "wikilink")[连续函数是](../Page/连续函数.md "wikilink")[解析函数](../Page/解析函数.md "wikilink")，当且仅当其视作\(\R^2 \to \R^2\)的映射时，四个[偏导数处处存在且满足](../Page/偏导数.md "wikilink")[柯西-黎曼方程](https://zh.wikipedia.org/wiki/柯西-黎曼方程 "wikilink")。该定理由卢曼于1923年提出，于1931年由缅绍夫证明。\[1\]\[2\]

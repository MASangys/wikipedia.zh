**卷积定理**指出，函数[卷积的](../Page/卷积.md "wikilink")[傅里叶变换是函数傅里叶变换的乘积](../Page/傅里叶变换.md "wikilink")。即一个域中的卷积对应于另一个域中的乘积，例如[时域中的卷积对应于](../Page/时域.md "wikilink")[频域中的乘积](../Page/频率.md "wikilink")。
...
注意以上的写法只对特定形式定义的变换正确，变换可能由其它方式[正规化](../Page/正规化.md "wikilink")，使得上面的关系式中出现其它的[常数因子](../Page/常数因子.md "wikilink")。

这一定理对[拉普拉斯变换](../Page/拉普拉斯变换.md "wikilink")、[双边拉普拉斯变换](../Page/双边拉普拉斯变换.md "wikilink")、[Z变换](../Page/Z变换.md "wikilink")、[梅林变换和](../Page/梅林变换.md "wikilink")[Hartley变换](../Page/Hartley变换.md "wikilink")（参见[Mellin
inversion
theorem](../Page/:en:Mellin_inversion_theorem.md "wikilink")）等各种傅里叶变换的变体同样成立。在[调和分析中还可以推广到在局部紧致的](../Page/调和分析.md "wikilink")[阿贝尔群上定义的傅里叶变换](../Page/阿贝尔群.md "wikilink")。
...
其中*x*和*ν*之间的*点*表示**R**<sup>*n*</sup>上的[内积](../Page/内积.md "wikilink")。

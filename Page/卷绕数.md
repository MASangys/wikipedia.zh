...
[平面上的闭](../Page/平面.md "wikilink")[曲线关于某个点的](../Page/曲线.md "wikilink")**卷绕数**，是一个整数，它表示了曲线绕过该点的总次数。卷绕数与曲线的[定向有关](https://zh.wikipedia.org/wiki/定向 "wikilink")，如果曲线依顺时针方向绕过某个点，则卷绕数是负数。

卷绕数在[代数拓扑中是基本的概念](../Page/代数拓扑.md "wikilink")，在[向量分析](../Page/向量分析.md "wikilink")、[复分析](https://zh.wikipedia.org/wiki/复分析 "wikilink")、[几何拓扑](https://zh.wikipedia.org/wiki/几何拓扑 "wikilink")、[微分几何和](../Page/微分几何.md "wikilink")[物理学中也扮演了重要的角色](../Page/物理学.md "wikilink")。
...
这是[柯西积分公式的一个特例](https://zh.wikipedia.org/wiki/柯西积分公式 "wikilink")。卷绕数在复分析中扮演了一个十分重要的角色（例如在[留数定理的表述中](../Page/留数定理.md "wikilink")）。

## 回转数

我们也可以考虑曲线关于它本身的卷绕数（又称为回转数
），也就是曲线的切向量旋转的次数。在右面的图中，曲线的回转数是4（或−4），那个小的回路也计算在内。这只对可微且光滑的曲线才有定义。参见：[回转切线定理](https://zh.wikipedia.org/wiki/回转切线定理 "wikilink")。

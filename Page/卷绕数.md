...
[平面](../Page/平面.md "wikilink")上的闭[曲线](../Page/曲线.md "wikilink")关于某个点的**卷绕数**，是一个整数，它表示了曲线绕过该点的总次数。卷绕数与曲线的[定向有关](https://zh.wikipedia.org/wiki/定向 "wikilink")，如果曲线依顺时针方向绕过某个点，则卷绕数是负数。

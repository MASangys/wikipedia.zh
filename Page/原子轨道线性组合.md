**原子轨域线性组合**（，或者简写为LCAO），是[量子化学](../Page/量子化学.md "wikilink")中用于求解[分子轨域的一种方法](https://zh.wikipedia.org/wiki/分子轨域 "wikilink")，这种方法是通过对[原子轨域进行线性叠加来构造](https://zh.wikipedia.org/wiki/原子轨域 "wikilink")[分子轨域](https://zh.wikipedia.org/wiki/分子轨域 "wikilink")。因为它属于分子轨域方法的一种，所以又称原子轨域线性组合的[分子轨域方法](https://zh.wikipedia.org/wiki/分子轨域 "wikilink")，或者叫LCAO-MO。它于1929年由Sir

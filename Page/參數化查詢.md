...
statement）是指在設計與資料庫連結並存取資料時，在需要填入數值或資料的地方，使用[參數](https://zh.wikipedia.org/wiki/參數 "wikilink")（parameter）來給值，這個方法目前已被視為最有效可預防[SQL注入攻击的攻擊手法的防禦方式](https://zh.wikipedia.org/wiki/SQL注入攻击 "wikilink")。
...
[Microsoft SQL
Server的參數格式是以](https://zh.wikipedia.org/wiki/Microsoft_SQL_Server "wikilink")"@"字元加上參數名稱而成，SQL
Server亦支援匿名參數"?"。
...
[PDO用於](https://zh.wikipedia.org/wiki/PDO "wikilink")[PHP之內](../Page/PHP.md "wikilink")。在使用[PDO驱动时](https://zh.wikipedia.org/wiki/PDO "wikilink")，参数查询的使用方法一般为：
...
[JDBC](https://zh.wikipedia.org/wiki/JDBC "wikilink") 用於
[Java](../Page/Java.md "wikilink") 之內。

...
\(x = a \cos(t), y = a \sin(t)\)，表示了[平面上半徑為](../Page/平面.md "wikilink")\(a\)、以原點為圓心的[圓](https://zh.wikipedia.org/wiki/圓 "wikilink")。在三維，加入\(z=bt\)，便是[螺旋的圖形](https://zh.wikipedia.org/wiki/螺旋 "wikilink")。這些式子可以表示成：

\[r(t) = (x(t), y(t), z(t)) = (a \cos(t), a \sin(t), b t)\,\]

如果有一個[粒子](https://zh.wikipedia.org/wiki/粒子 "wikilink")，沿這個螺旋的路徑而行，直接[微分上面的式子便會得到粒子的速度](../Page/微分.md "wikilink")：

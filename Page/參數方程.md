...
\(x = a \cos(t), y = a \sin(t)\)，表示了[平面](../Page/平面.md "wikilink")上半徑為\(a\)、以原點為圓心的[圓](https://zh.wikipedia.org/wiki/圓 "wikilink")。在三維，加入\(z=bt\)，便是[螺旋的圖形](https://zh.wikipedia.org/wiki/螺旋 "wikilink")。這些式子可以表示成：

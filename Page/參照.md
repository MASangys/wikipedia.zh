在[電腦科學中](https://zh.wikipedia.org/wiki/電腦科學 "wikilink")，**參照**（）是指一個可以讓程式間接存取於[電腦記憶體或其他](../Page/電腦記憶體.md "wikilink")[儲存裝置中一特定資料的](../Page/儲存裝置.md "wikilink")[值](https://zh.wikipedia.org/wiki/值_\(電腦科學\) "wikilink")，該數據可以為[變數或](https://zh.wikipedia.org/wiki/變數_\(程序設計\) "wikilink")[記錄](https://zh.wikipedia.org/wiki/記錄_\(電腦科學\) "wikilink")。
...
參照的概念和其他如[關聯鍵或](../Page/关系键.md "wikilink")[識別字之類用來識別特定資料項目的值不同](https://zh.wikipedia.org/wiki/標識符 "wikilink")，後者只能透過[資料庫表中的](https://zh.wikipedia.org/wiki/資料庫表 "wikilink")[尋找運算](../Page/查找表.md "wikilink")，來存取資料。

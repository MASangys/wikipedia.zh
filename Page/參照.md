在[電腦科學中](https://zh.wikipedia.org/wiki/電腦科學 "wikilink")，**參照**（）是指一個可以讓程式間接存取於[電腦記憶體或其他](../Page/電腦記憶體.md "wikilink")[儲存裝置中一特定資料的](../Page/儲存裝置.md "wikilink")[值](../Page/值_\(電腦科學\).md "wikilink")，該數據可以為[變數或](https://zh.wikipedia.org/wiki/變數_\(程序設計\) "wikilink")[記錄](https://zh.wikipedia.org/wiki/記錄_\(電腦科學\) "wikilink")。
...
最早的不透明參照為[LISP的](../Page/LISP.md "wikilink")[CONS函式](../Page/列表構造函數.md "wikilink")，此一函式只是一個包含兩個參照至其他Lisp物件的[記錄](https://zh.wikipedia.org/wiki/物件複合 "wikilink")，其他Lisp物件也可能包括其他的cons函式。此一簡單的結構最常被用來建構單向[連結串列](https://zh.wikipedia.org/wiki/連結串列 "wikilink")，但也可用來建構簡單的[二元樹](https://zh.wikipedia.org/wiki/二元樹 "wikilink")，以及一種被稱為「點狀串列」的結構，該結構最終會終止於一個值上，而非空參照。

在[数值分析这个](https://zh.wikipedia.org/wiki/数值分析 "wikilink")[数学分支中](../Page/数学.md "wikilink")，**双三次插值**（）是[二维空间中最常用的](https://zh.wikipedia.org/wiki/二维 "wikilink")[插值方法](../Page/插值.md "wikilink")。在这种方法中，[函数](../Page/函数.md "wikilink")
*f* 在点 (*x*, *y*)
的值可以通过[矩形](../Page/矩形.md "wikilink")[网格中最近的十六个采样点的](https://zh.wikipedia.org/wiki/网格 "wikilink")[加权平均得到](https://zh.wikipedia.org/wiki/加权平均 "wikilink")，在这里需要使用两个[多项式插值](../Page/多项式插值.md "wikilink")[三次函数](https://zh.wikipedia.org/wiki/三次函数 "wikilink")，每个方向使用一个。
...
## 参见
  ...
  - [Lanczos
    resampling](https://zh.wikipedia.org/wiki/Lanczos_resampling "wikilink")

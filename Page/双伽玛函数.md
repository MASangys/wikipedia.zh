...
当|*z*|\<1时收敛。在这里，\(\zeta(n)\)是[黎曼ζ函数](https://zh.wikipedia.org/wiki/黎曼ζ函数 "wikilink")。这个级数可以很容易从[赫尔维茨ζ函数的泰勒级数推导出](../Page/赫尔维茨ζ函数.md "wikilink")。
...
## 参考文献
  ...
  -
[km:អនុគមន៍
ឌីហ្គាំម៉ា](https://zh.wikipedia.org/wiki/km:អនុគមន៍_ឌីហ្គាំម៉ា "wikilink")

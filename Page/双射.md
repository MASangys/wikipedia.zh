...
[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，一個由[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")\(X\)[映射至集合](https://zh.wikipedia.org/wiki/映射 "wikilink")\(Y\)的[函數](https://zh.wikipedia.org/wiki/函數 "wikilink")，若對每一在\(Y\)內的\(y\)，存在唯一一個在\(X\)內的\(x\)与其对应，則此函數為**對射函數**。
...
雙射函數在許多數學領域扮演著很基本的角色，如在[同構的定義](https://zh.wikipedia.org/wiki/同構 "wikilink")（以及如[同胚和](../Page/同胚.md "wikilink")[微分同構等相關概念](https://zh.wikipedia.org/wiki/微分同構 "wikilink")）、[置換群](https://zh.wikipedia.org/wiki/置換群 "wikilink")、[投影映射及許多其他概念的基本上](https://zh.wikipedia.org/wiki/投影映射 "wikilink")。
...
## 例子與反例
  ...
  - [指數函數](https://zh.wikipedia.org/wiki/指數函數 "wikilink")\(g : \R \rightarrow\R\)，其形式為\(g(x) = e^{x}\)，不是雙射的：因為不存在一\(\R\)內的\(x\)使得\(g(x) = -1\)，故\(g\)非為雙射。但若其[陪域改成正實數](../Page/到达域.md "wikilink")\(\R^{+} = (0,+\infty )\)，則\(g\)便是雙射的了；其反函數為[自然對數函數](../Page/自然對數.md "wikilink")\(\ln\)。
  - 函數\(h\) :

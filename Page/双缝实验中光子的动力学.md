**双缝实验中光子的动力学**描述了在[双缝实验中](https://zh.wikipedia.org/wiki/双缝实验 "wikilink")，经典[电磁波和其](https://zh.wikipedia.org/wiki/电磁波 "wikilink")[量子化的对应物](../Page/量子化.md "wikilink")——[光子之间的关系](../Page/光子.md "wikilink")。表面上，只要将经典场解释为光子的几率幅，光子的动力学似乎就能用经典的[麦克斯韦方程组完全描述](https://zh.wikipedia.org/wiki/麦克斯韦方程组 "wikilink")。然而，这种解释充满疏漏，并最终会导致矛盾的结论。也就是说，我们不能将[电磁场看作是光子的](../Page/电磁场.md "wikilink")[波函数](../Page/波函数.md "wikilink")。主要原因在於，电磁场是物理实在的并且是[可观测的](https://zh.wikipedia.org/wiki/可观测量 "wikilink")；而从原理上说（即不管使用什么仪器），满足[薛定谔方程的波函数都不是可观测量](../Page/薛定谔方程.md "wikilink")。从而，电磁场是一种物理实在的可观测场，而不仅仅代表了对振幅取模平方所对应的在某处找到光子的[几率](https://zh.wikipedia.org/wiki/几率 "wikilink")。而光子的波函数是否可定义，仍然是一个悬而未决的问题\[1\]。
...
10<sup>8</sup>米/秒，也就是光在[自由空间中的速度](https://zh.wikipedia.org/wiki/自由空间 "wikilink")。

磁场和电场之间的联系由[麦克斯韦修正的](https://zh.wikipedia.org/wiki/麦克斯韦 "wikilink")[安培定律给出](../Page/安培定律.md "wikilink")：
...
是x-y平面的[琼斯矢量](https://zh.wikipedia.org/wiki/琼斯运算 "wikilink")。这里这个矢量的记法是借用了[量子力学中的](../Page/量子力学.md "wikilink")[狄拉克符号](../Page/狄拉克符号.md "wikilink")。之所以用狄拉克符号来标注琼斯矢量是希望将其理解为量子力学中的[态矢量](https://zh.wikipedia.org/wiki/态矢量 "wikilink")。
...
通过[普朗克的能量量子化假设和](https://zh.wikipedia.org/wiki/普朗克 "wikilink")[爱因斯坦对](https://zh.wikipedia.org/wiki/爱因斯坦 "wikilink")[光电效应实验的解释](../Page/光电效应.md "wikilink")，爱因斯坦提出了电磁波的能量是由不可再分的能量子组成的，这种不可再分的能量子称为光子。
...
从对应原理还可以得到光子的动量，其动量密度对应着经典的[玻印亭矢量除以光速的平方](https://zh.wikipedia.org/wiki/玻印亭矢量 "wikilink")，即
...
光子处於某一[偏振态的几率取决于用麦克斯韦方程组描述的经典场](../Page/偏振.md "wikilink")；类似地，一个单光子的[福柯态所对应的几率密度和其对应电磁场的能量密度的期望值有关](https://zh.wikipedia.org/wiki/福柯态 "wikilink")。一般而言，量子力学中几率幅的叠加法则和经典的几率叠加看上去非常相似\[5\]：

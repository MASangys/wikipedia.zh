**双缝实验中光子的动力学**描述了在[双缝实验中](../Page/双缝实验.md "wikilink")，经典[电磁波和其](../Page/电磁波.md "wikilink")[量子化的对应物](../Page/量子化.md "wikilink")——[光子之间的关系](../Page/光子.md "wikilink")。表面上，只要将经典场解释为光子的几率幅，光子的动力学似乎就能用经典的[麦克斯韦方程组完全描述](../Page/麦克斯韦方程组.md "wikilink")。然而，这种解释充满疏漏，并最终会导致矛盾的结论。也就是说，我们不能将[电磁场看作是光子的](../Page/电磁场.md "wikilink")[波函数](../Page/波函数.md "wikilink")。主要原因在於，电磁场是物理实在的并且是[可观测的](../Page/可观测量.md "wikilink")；而从原理上说（即不管使用什么仪器），满足[薛定谔方程的波函数都不是可观测量](../Page/薛定谔方程.md "wikilink")。从而，电磁场是一种物理实在的可观测场，而不仅仅代表了对振幅取模平方所对应的在某处找到光子的[几率](../Page/几率.md "wikilink")。而光子的波函数是否可定义，仍然是一个悬而未决的问题\[1\]。
...
其中\(c\,\)是真空或介质中的光速。对於真空，c = 2.998 x
10<sup>8</sup>米/秒，也就是光在[自由空间中的速度](../Page/自由空间.md "wikilink")。

磁场和电场之间的联系由[麦克斯韦修正的](../Page/麦克斯韦.md "wikilink")[安培定律给出](../Page/安培定律.md "wikilink")：
...
沿z方向传播的电磁波可由一个平面正弦波来给出（在[厘米-克-秒制和](../Page/厘米-克-秒制.md "wikilink")[国际单位制下](../Page/国际单位制.md "wikilink")）：
...
以上为磁矢量，其中\(k\,\)是[波数](../Page/波数.md "wikilink")。

  -
    \(\omega_{ }^{ } = c k\)

是波的[角频率](../Page/角频率.md "wikilink")。矢量正上方的标记分别表示x、y和z方向的[单位矢量](../Page/单位矢量.md "wikilink")。

[Light-wave.svg](https://zh.wikipedia.org/wiki/File:Light-wave.svg "fig:Light-wave.svg")

其中的参数包括[振幅](../Page/振幅.md "wikilink")
...
是x-y平面的[琼斯矢量](../Page/琼斯运算.md "wikilink")。这里这个矢量的记法是借用了[量子力学中的](../Page/量子力学.md "wikilink")[狄拉克符号](../Page/狄拉克符号.md "wikilink")。之所以用狄拉克符号来标注琼斯矢量是希望将其理解为量子力学中的[态矢量](../Page/态矢量.md "wikilink")。
...
其中\(r\,\)是从波源出发的距离，而\(r_0\,\)是对应电场强度
\(\mathbf{E} ( \mathbf{r_0} , t )\)的从波源出发的距离。
...
[Double_Slit_Experiment.svg](https://zh.wikipedia.org/wiki/File:Double_Slit_Experiment.svg "fig:Double_Slit_Experiment.svg")
...
以上的处理方法都是经典的。不过，这种方法可以被推广成[量子力学的方法](../Page/量子力学.md "wikilink")，只需要将其中一个经典量重新解释为量子力学量。这个量就是上面用狄拉克符号写成的琼斯矢量\(\mid \phi \rangle\)：将其从原本双缝实验中的经典描述改为用於描述光子量子态的态矢量。

### 光子的能量和动量

通过[普朗克的能量量子化假设和](../Page/普朗克.md "wikilink")[爱因斯坦对](../Page/爱因斯坦.md "wikilink")[光电效应实验的解释](../Page/光电效应.md "wikilink")，爱因斯坦提出了电磁波的能量是由不可再分的能量子组成的，这种不可再分的能量子称为光子。

#### 能量

由[普朗克的能量量子化假设](../Page/普朗克公式.md "wikilink")，光子的能量正比于电磁波的角频率：
...
将几率的概念应用到解释光子的行为时，有两种方法可以考虑：一种是用几率计算处在某个特定态上的可能的光子数量，另一种是用几率计算单个光子处在某个特定态上的可能性。前一种方法的结果会违反能量守恒；后一种方法虽然不直观但确实是可行的。[狄拉克在双缝实验中对这一点进行了解释](../Page/狄拉克.md "wikilink")\[4\]：

#### 几率幅

光子处於某一[偏振态的几率取决于用麦克斯韦方程组描述的经典场](../Page/偏振.md "wikilink")；类似地，一个单光子的[福柯态所对应的几率密度和其对应电磁场的能量密度的期望值有关](../Page/福柯态.md "wikilink")。一般而言，量子力学中几率幅的叠加法则和经典的几率叠加看上去非常相似\[5\]：
...
## 参见
  ...
  - [薛定谔方程的理论和实验验证](../Page/薛定谔方程的理论和实验验证.md "wikilink")
  - [施特恩-格拉赫实验](../Page/施特恩-格拉赫实验.md "wikilink")
  - [波粒二象性](../Page/波粒二象性.md "wikilink")
  - [光子的偏振](../Page/光子的偏振.md "wikilink")

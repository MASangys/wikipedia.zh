...
在[数学中](../Page/数学.md "wikilink")，**反三角函数**是[三角函数的](../Page/三角函数.md "wikilink")[反函数](https://zh.wikipedia.org/wiki/反函数 "wikilink")。
...
\(\mathrm{acos}\),
\(\mathrm{atan}\)。很多编程语言提供两自变量[atan2函数](https://zh.wikipedia.org/wiki/atan2 "wikilink")，它计算给定\(y\)和\(x\)的\(\frac{y}{x}\)的反正切，但是值域为\([-\pi, \pi]\)。
...
| [反正割](https://zh.wikipedia.org/wiki/反正割 "wikilink") | \(y=\arcsec x\) | \(x=\sec y\) | \((-\infty,-1]\cup[1,+\infty)\) | \([0,\frac{\pi}{2})\cup(\frac{\pi}{2},\pi]\) |
...
\end{align}\]
当\(x\)等于1时，在有极限的域上的积分是[瑕积分](https://zh.wikipedia.org/wiki/瑕积分 "wikilink")，但仍是良好定义的。

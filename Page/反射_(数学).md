...
在[数学中](../Page/数学.md "wikilink")，**反射**是把一个物体变换成它的[镜像的](https://zh.wikipedia.org/wiki/镜像 "wikilink")[映射](../Page/函数.md "wikilink")。要反射一个平面图形，需要“镜子”是一条直线（反射轴），对于三维空间中的反射就要使用[平面作为镜子](../Page/平面.md "wikilink")。反射有时被认为是[圆反演的特殊情情况](https://zh.wikipedia.org/wiki/反演 "wikilink")，参考圆有无限半径。

在几何上说，要找到一个点的反射，可从这个点向反射轴画一条[垂线](https://zh.wikipedia.org/wiki/垂线 "wikilink")。并在另一边延续相同的距离。要找到一个图形的反射，需要反射这个图形的每个点。

两次反射回到原来的地方。反射保持在点之间的距离。反射不移动在镜子上的点，镜子的维数比发生反射的空间的维数要小1。这些观察允许我们形式化反射的定义：反射是[欧几里得空间的](../Page/欧几里得空间.md "wikilink")[对合](https://zh.wikipedia.org/wiki/对合 "wikilink")[等距同构](../Page/等距同构.md "wikilink")，它的[不动点集合是](../Page/不动点.md "wikilink")[余维数为](https://zh.wikipedia.org/wiki/余维数 "wikilink")1的[仿射子空间](../Page/仿射空间.md "wikilink")。
...
给定在[欧几里得空间](../Page/欧几里得空间.md "wikilink")**R**<sup>*n*</sup>中的一个向量*a*，在通过原点的[正交于](../Page/正交.md "wikilink")*a*的[超平面中的反射的公式是](https://zh.wikipedia.org/wiki/超平面 "wikilink")
...
这里的δ<sub>*ij*</sub>是[克罗内克δ](https://zh.wikipedia.org/wiki/克罗内克δ "wikilink")。

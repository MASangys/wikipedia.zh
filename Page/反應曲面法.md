...
一般來說，執行反應曲面法大致分為兩階段:
  ...
  - 第一階段稱為[反應曲面設計](https://zh.wikipedia.org/wiki/#反應曲面設計 "wikilink")(response
    surface design)
  - 第二階段稱為[反應曲面最佳化](https://zh.wikipedia.org/wiki/#反應曲面最佳化 "wikilink")(response
...
[媒體存取控制](https://zh.wikipedia.org/wiki/媒體存取控制 "wikilink") (Medium
access control, MAC) 協定和隨意隨選距離向量 (Ad hoc On demand
...
將三個因子分別設定成二個水準(利用 [ns-2](https://zh.wikipedia.org/wiki/ns-2 "wikilink")
模擬器中 AODV 軟體分配的預設值)

...
利用[自然對數可將定義推廣到整個複數集](../Page/自然對數.md "wikilink")：

\[\arcsin x = -{\mathrm{i}}\ln \left({\mathrm{i}}x + \sqrt{1 - x^2}\right) \,\]
[ArcSinComplex.png](https://zh.wikipedia.org/wiki/File:ArcSinComplex.png "fig:ArcSinComplex.png")

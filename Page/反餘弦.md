**反餘弦**（arccosine, \(\arccos\),
\(\cos^{-1}\)）是一種[反三角函數](https://zh.wikipedia.org/wiki/反三角函數 "wikilink")，也是高等數學中的一種[基本特殊函數](https://zh.wikipedia.org/wiki/Category:基本特殊函数 "wikilink")。在[三角學中](https://zh.wikipedia.org/wiki/三角學 "wikilink")，反餘弦被定義為一個角度，也就是[餘弦值的](../Page/餘弦.md "wikilink")[反函數](../Page/反函數.md "wikilink")，然而餘弦函數是[雙射且](https://zh.wikipedia.org/wiki/雙射 "wikilink")[不可逆的而不是一個](https://zh.wikipedia.org/wiki/不可逆 "wikilink")[對射](https://zh.wikipedia.org/wiki/對射 "wikilink")[函數](https://zh.wikipedia.org/wiki/函數 "wikilink")（即多個值可能只得到一個值，例如1和所有同界角），故無法有[反函數](../Page/反函數.md "wikilink")，但我們可以限制其定義域，因此，反餘弦是[單射和](https://zh.wikipedia.org/wiki/單射 "wikilink")[滿射也是](https://zh.wikipedia.org/wiki/滿射 "wikilink")[可逆的](https://zh.wikipedia.org/wiki/可逆 "wikilink")，另外，我們也需要限制值域，且限制值域時，不能和[反正弦定義相同的區間](../Page/反正弦.md "wikilink")，因為這樣會變成一對多，而不構成函數，所以我們將**反餘弦**函數的值域定義在
，\(\left[0, \pi\right]\)。另外，在原始的定義中，若輸入值不在區間\([-1,1]\)，是沒有意義的，但是三角函數擴充到複數之後，若輸入值不在區間\([-1,1]\)，將傳回[複數](https://zh.wikipedia.org/wiki/複數_\(數學\) "wikilink")。
...
這個動作使反餘弦被推廣到[複數](https://zh.wikipedia.org/wiki/複數 "wikilink")。
[ArccosComplex.png](https://zh.wikipedia.org/wiki/File:ArccosComplex.png "fig:ArccosComplex.png")
...
\end{align}\]
由於先前描述的對稱關係\(\arccos x=\pi-\arccos\left(-x\right)\)，可由上式計算\(| x |\)接近1時的反餘弦值。

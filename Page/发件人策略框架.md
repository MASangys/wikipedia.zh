**发件人策略框架**（；簡稱**SPF**； RFC
4408）是一套[电子邮件認證機制](../Page/电子邮件.md "wikilink")，可以確認電子郵件確實是由網域授權的郵件伺服器寄出，防止有人偽冒身份[網路釣魚或寄出](../Page/網路釣魚.md "wikilink")[垃圾電郵](../Page/垃圾電郵.md "wikilink")。SPF允许管理员设定一个[DNS](../Page/域名系统.md "wikilink")
[TXT记录或](../Page/域名服務器記錄類型列表.md "wikilink")[SPF记录设定发送邮件服务器的IP范围](../Page/域名服務器記錄類型列表.md "wikilink")，如有任何郵件並非從上述指明授權的IP地址寄出，則很可能該郵件並非確實由真正的寄件者寄出（郵件上聲稱的「寄件者」為假冒）。\[1\]
...
[SMTP協定本身沒有機制鑑別寄件人的真正身份](../Page/SMTP.md "wikilink")，電子郵件的「寄件者」一欄可以填上任何名字，於是偽冒他人身份來網路釣魚或寄出垃圾郵件便相當容易，而真正來源卻不易追查。

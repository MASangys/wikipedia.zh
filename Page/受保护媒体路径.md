...
此外，视频和音频数据在经过[PCI Express](../Page/PCI_Express.md "wikilink")[总线](../Page/总线.md "wikilink")时，将会使用PVP-UAB（受保护视频路径-用户可访问总线）[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")，以避免其在运行中被[显卡中断和复制](../Page/显示卡.md "wikilink")。这补充了PVP输出保护管理。

...
选取[高斯函数](../Page/高斯函数.md "wikilink")作为试探波函数\(\psi \left( x \right) =Ae^{-bx^2}\)，其中\(b\)为常数，由波函数的归一化\(\int_{-\infty}^{+\infty}{\psi \left( x \right) dx}=1\)
，可得\(A=\left( \frac{2b}{\pi} \right) ^{\frac{1}{2}}\)，

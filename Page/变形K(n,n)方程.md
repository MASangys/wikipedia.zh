''' 变形K(n,n)方程 '''(Modified K(n,n) equation)是一个非线性偏微分方程：\[1\]

\(u_{t}+a*(u^{n+1})_{x}+(u*(u^n)_{xx})_{x}=0\)

## 解析解

\[u(x,t)=( \frac{2*c}{a}*sin((1/2)*\sqrt{a}*(x-c*t+b))^2))^{1/n}\]

\[u(x,t)=( \frac{2*c}{a}*sinh((1/2)*\sqrt{-a}*(x-c*t+b))^2))^{1/n}\]

\[u(x,t)=( \frac{2*c}{a}*cosh((1/2)*\sqrt{-a}*(x-c*t+b))^2))^{1/n}\]

## 行波图

|                                                                                                                                                                                                              |                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Modified_K(n,n)_equation_traveling_wave_plot_1.gif](https://zh.wikipedia.org/wiki/File:Modified_K\(n,n\)_equation_traveling_wave_plot_1.gif "fig:Modified_K(n,n)_equation_traveling_wave_plot_1.gif") | [Modified_K(n,n)_equation_traveling_wave_plot_2.gif](https://zh.wikipedia.org/wiki/File:Modified_K\(n,n\)_equation_traveling_wave_plot_2.gif "fig:Modified_K(n,n)_equation_traveling_wave_plot_2.gif") |
...
1.  Andrei D. Polyanin,Valentin F. Zaitsev, HANDBOOK OF NONLINEAR PARTIAL DIFFERENTIAL EQUATIONS,（《非线性偏微分方程手册》） SECOND EDITION p892 CRC PRESS
[系統工程中的](https://zh.wikipedia.org/wiki/系統工程 "wikilink")**變更管理**流程，是一種對[系統變更的請求](../Page/系統.md "wikilink")、決定可達性、計畫、實施、和評估的過程，主要目的係以一系列相互關聯的因子，來支援變更的處理和可追溯性\[1\]。
...
[元建模技術常用於有關變更管理流程的描述](../Page/元建模.md "wikilink")，圖一為描繪在本節中所解釋的[過程數據圖](https://zh.wikipedia.org/wiki/過程數據圖 "wikilink")。
...
change〉。這些活動由四個不同的[角色所執行](https://zh.wikipedia.org/wiki/社會角色 "wikilink")，詳列於表一。這些活動(或其下屬活動)也詳列於表二。
...
|             | 建立計畫       | 為了[實施變更而建立一個變更計畫](https://zh.wikipedia.org/wiki/實施 "wikilink")，一些流程說明〈例如：Mäkäräinen, 2000〉闡明可能「保留」變更，並以[批式方式處理這些變更](https://zh.wikipedia.org/wiki/批式生產 "wikilink")，這個活動可被視為一個好做法。 |
...
在這裡所處理的變更管理的另一個典型範圍，就是[製造業領域](https://zh.wikipedia.org/wiki/製造業 "wikilink")。以一輛汽車的設計和生產為例，如果在長距離駕駛後發現車輛安全氣囊自動填充空氣，這毫無疑問會導致顧客投訴（或者在測試階段所期望的問題提報）。反過來，這些會產生一個變更請求（見右圖二），這可能會證明變更是合理的。
儘管如此，還是要做一個最簡單的成本和效益分析，然後才能批准變更請求。在分析對汽車設計和生產時程的影響之後，就可創建實施變更的計劃。依據這個計劃，這個變更實際上是可以實現的。隨後在這個新版汽車被公開發布之前，有望得到徹底的測試。

## 在工業廠房

由於復雜流程對於即使是小變更也非常敏感，所以對工業設施和流程的變更的適當管理，被認為是安全的關鍵。[美國職業安全與衛生管理局](https://zh.wikipedia.org/wiki/美國職業安全與衛生管理局 "wikilink")（OSHA）制定了指導如何進行變更和記錄的相關規定。主要的需求是由一個多學科小組對一個提案的變更進行徹底審查，以確保盡可能多的觀點被用來最大限度地減少發生危害的機會。在這種情況下，變更管理被稱為「變更的管理」（MOC），它只是[流程安全管理許多要素之一](https://zh.wikipedia.org/wiki/流程安全管理 "wikilink")，第
1910.119(l).1節。
...
## 参见
  ...
  - [工程變更通知](https://zh.wikipedia.org/wiki/工程變更通知 "wikilink")、[工程變更命令](https://zh.wikipedia.org/wiki/工程改變命令 "wikilink")、[變更請求](https://zh.wikipedia.org/wiki/變更請求 "wikilink")
  ...
  - [發佈管理](https://zh.wikipedia.org/wiki/發佈管理 "wikilink")

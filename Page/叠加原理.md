...
在[数学](../Page/数学.md "wikilink")中，这个性质更常被叫做**[可加性](https://zh.wikipedia.org/wiki/线性 "wikilink")**。在绝大多数实际情形中，*F*
...
例如，在[傅里叶分析](../Page/傅里叶分析.md "wikilink")中，刺激写成无穷多个[正弦波的叠加](https://zh.wikipedia.org/wiki/正弦波 "wikilink")。由于叠加原理，每个这样的正弦波可单独分析，各自的反应可计算出来。（反应自己也是一个正弦波，与刺激的频率相同，但一般有不同的[振幅与](https://zh.wikipedia.org/wiki/振幅 "wikilink")[相位](https://zh.wikipedia.org/wiki/相位 "wikilink")。）根据叠加原理，原来的刺激的反应是所有单独的正弦波反应之总和（或积分）。
...
\[G(y)=z\]
例如，在[狄利克雷边界条件下](../Page/狄利克雷问题.md "wikilink")[拉普拉斯方程](../Page/拉普拉斯方程.md "wikilink")的中，*F*

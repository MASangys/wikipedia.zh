在[程序设计中](../Page/程序设计.md "wikilink")，**句柄**（**handle**）是[Windows操作系统用来标识被应用程序所建立或使用的对象的整数](https://zh.wikipedia.org/wiki/Windows操作系统 "wikilink")。其本质相当于带有引用计数的[智能指针](../Page/智能指针.md "wikilink")。当一个[应用程序要引用其他系统](../Page/应用程序.md "wikilink")（如[数据库](../Page/数据库.md "wikilink")、[操作系统](../Page/操作系统.md "wikilink")）所管理的[内存块或](https://zh.wikipedia.org/wiki/内存 "wikilink")[对象时](https://zh.wikipedia.org/wiki/对象_\(计算机科学\) "wikilink")，可以使用句柄。
...
在上世纪80年代的操作系统（如[Mac
OS](https://zh.wikipedia.org/wiki/Mac_OS "wikilink")\[1\]和[Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")）的[内存管理中](https://zh.wikipedia.org/wiki/内存管理 "wikilink")，句柄被广泛应用。[Unix系统的](https://zh.wikipedia.org/wiki/Unix "wikilink")[文件描述符基本上也属于句柄](../Page/文件描述符.md "wikilink")。和其它[桌面环境一样](../Page/桌面环境.md "wikilink")，[Windows
...
如今，[内存容量的增大和](https://zh.wikipedia.org/wiki/内存 "wikilink")[虚拟内存算法使得更简单的](../Page/虚拟内存.md "wikilink")[指针愈加受到青睐](https://zh.wikipedia.org/wiki/指针_\(信息学\) "wikilink")，而指向另一指针的那类句柄受到冷淡。尽管如此，许多[操作系统仍然把指向私有](../Page/操作系统.md "wikilink")[对象的指针以及](https://zh.wikipedia.org/wiki/对象_\(计算机科学\) "wikilink")[进程传递给](https://zh.wikipedia.org/wiki/进程 "wikilink")[客户端的内部](https://zh.wikipedia.org/wiki/客户端 "wikilink")[数组下标称为句柄](../Page/数组.md "wikilink")。

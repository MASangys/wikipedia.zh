...
在上世纪80年代的操作系统（如[Mac
OS](https://zh.wikipedia.org/wiki/Mac_OS "wikilink")\[1\]和[Windows](https://zh.wikipedia.org/wiki/Windows "wikilink")）的[内存管理中](https://zh.wikipedia.org/wiki/内存管理 "wikilink")，句柄被广泛应用。[Unix系统的](https://zh.wikipedia.org/wiki/Unix "wikilink")[文件描述符](../Page/文件描述符.md "wikilink")基本上也属于句柄。和其它[桌面环境](../Page/桌面环境.md "wikilink")一样，[Windows
API大量使用句柄来标识系统中的](../Page/Windows_API.md "wikilink")[对象](https://zh.wikipedia.org/wiki/对象_\(计算机科学\) "wikilink")，并建立操作系统与[用户空间之间的通信渠道](https://zh.wikipedia.org/wiki/用户空间 "wikilink")。例如，桌面上的一个窗体由一个`HWND`类型的句柄来标识。
...
康奈尔大学副教授所著的《Compiler Construction for Digital Computer》. John Wiley and
Sons, New York, 1971, 491 pages, ISBN 0-471-32776-X，给出如下定义：

` (2.3.10) DEFINITION. A handle of any sentential form is a leftmost simple phrase.`

在该书的中译本：
D.格里斯著,[仲萃豪等译](https://zh.wikipedia.org/wiki/仲萃豪 "wikilink")：《数字计算机的编译程序构造》，[科学出版社](https://zh.wikipedia.org/wiki/科学出版社 "wikilink"),
1976年版，给出了如下翻译：
...
1.  {{ citation | last = Hertzfeld | first = Andy | author-link = Andy
    Hertzfeld | title = The Original Macintosh: Hungarian | date =
    January 1982 | url =
    <http://www.folklore.org/StoryView.py?project=Macintosh&story=Hungarian.txt>
    | accessdate = 2010-05-10 }}
2.  [Ruediger Asche: "Give Me a Handle, and I'll Show You an Object", in
    MSDN](https://msdn.microsoft.com/en-us/library/ms810501.aspx)
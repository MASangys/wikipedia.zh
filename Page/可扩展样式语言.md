...
## 外部链接
  ...
  - [The Extensible Stylesheet Language Family
    ...
    [W3C中关于XSL的条目](https://zh.wikipedia.org/wiki/World_Wide_Web_Consortium "wikilink")
  - [Antenna
    House公司中的条目](https://zh.wikipedia.org/wiki/Antenna_House "wikilink")
...
## 参见
  ...
  - [Style Sheet](https://zh.wikipedia.org/wiki/Style_Sheet "wikilink")
      ...
      - [Document Style Semantics and Specification
        Language（DSSSL）](https://zh.wikipedia.org/wiki/DSSSL "wikilink")
      - [Cascading Style
        Sheets（CSS）](https://zh.wikipedia.org/wiki/CSS "wikilink")

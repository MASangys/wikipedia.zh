**可扩展消息与存在协议**（，缩写：**XMPP**；前稱**Jabber**\[1\]）是一种以[XML](../Page/XML.md "wikilink")為基礎的開放式[即時通訊](../Page/即時通訊.md "wikilink")協定，是經由網際網路工程工作小組（[IETF](https://zh.wikipedia.org/wiki/IETF "wikilink")）通過的[網際網路標準](https://zh.wikipedia.org/wiki/網際網路 "wikilink")。XMPP因为被[Google Talk应用而被广大网民所接触](../Page/Google_Talk.md "wikilink")。

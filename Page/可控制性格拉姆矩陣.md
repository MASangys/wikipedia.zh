...
Gramian）是用來判斷線性[動態系統是否](https://zh.wikipedia.org/wiki/動態系統 "wikilink")[可控制的](../Page/可控制性.md "wikilink")[格拉姆矩阵](../Page/格拉姆矩阵.md "wikilink")。
...
\(\boldsymbol{B}\)若穩定（所有的特徵值實部均為負），可控制性格拉姆矩阵也是以下[李亞普諾夫方程的唯一解](../Page/李亞普諾夫方程.md "wikilink")
...
可控制性格拉姆矩陣是以下[李亞普諾夫方程的解](../Page/李亞普諾夫方程.md "wikilink")
...
可控制性系統的其他特性在\[1\]中，以及[可控制性中都有描述](../Page/可控制性.md "wikilink")。

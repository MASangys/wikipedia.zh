[控制理论中](../Page/控制理论.md "wikilink")，**可控制性格拉姆矩阵**（Controllability
Gramian）是用來判斷線性[動態系統是否](https://zh.wikipedia.org/wiki/動態系統 "wikilink")[可控制的](https://zh.wikipedia.org/wiki/可控制性 "wikilink")[格拉姆矩阵](../Page/格拉姆矩阵.md "wikilink")。
...
\(\boldsymbol{B}\)若穩定（所有的特徵值實部均為負），可控制性格拉姆矩阵也是以下[李亞普諾夫方程的唯一解](https://zh.wikipedia.org/wiki/李亞普諾夫方程 "wikilink")
...
可控制性格拉姆矩陣是以下[李亞普諾夫方程的解](https://zh.wikipedia.org/wiki/李亞普諾夫方程 "wikilink")
...
可控制性系統的其他特性在\[1\]中，以及[可控制性中都有描述](https://zh.wikipedia.org/wiki/可控制性 "wikilink")。
...
其中矩陣\(\boldsymbol{A}\),
\(\boldsymbol{B}\)和\(\boldsymbol{C}\)的元素會隨時間而變化。其可控制性格拉姆矩陣為\(n\times n\)矩陣，定義如下：
...
## 相關條目
  ...
  - [可控制性](https://zh.wikipedia.org/wiki/可控制性 "wikilink")
  - [可观测性格拉姆矩阵](https://zh.wikipedia.org/wiki/可观测性格拉姆矩阵 "wikilink")
  - [格拉姆矩阵](../Page/格拉姆矩阵.md "wikilink")
  - [最小能量控制](https://zh.wikipedia.org/wiki/最小能量控制 "wikilink")

## 參考資料

## 外部連結

  - [Mathematica function to compute the controllability
    Gramian](http://reference.wolfram.com/mathematica/ref/ControllabilityGramian.html)

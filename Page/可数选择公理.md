...
\(\text{ZF}+\text{AC}_\omega\)足够证明可数多可数集合的并集是可数的。它还足够证明所有[无限集合都是](https://zh.wikipedia.org/wiki/无限集合 "wikilink")[戴德金无限的](https://zh.wikipedia.org/wiki/戴德金无限集合 "wikilink")（等价的说：有可数无限的真子集）。\(\text{AC}_\omega\)对于开发[数学分析特别有用](../Page/数学分析.md "wikilink")，这里的很多结果依赖于[实数的可数集合有选择函数](../Page/实数.md "wikilink")（考虑为[有理数的](../Page/有理数.md "wikilink")[柯西序列的集合](../Page/柯西序列.md "wikilink")）。

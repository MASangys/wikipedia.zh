...
**可移植性可执行文件**（[英语](../Page/英语.md "wikilink")：Portable Executable，缩写为PE）是一种用于[可执行文件](https://zh.wikipedia.org/wiki/可执行文件 "wikilink")、[目标文件和](https://zh.wikipedia.org/wiki/目标文件 "wikilink")[动态链接库](../Page/动态链接库.md "wikilink")的[文件格式](https://zh.wikipedia.org/wiki/文件格式 "wikilink")，主要使用在32位和64位的[Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")[操作系统](../Page/操作系统.md "wikilink")上。“可移植的”是指该文件格式的通用性，可用于许多种不同的操作系统和体系结构中。PE文件格式封装了Windows操作系统加载可执行程序代码时所必需的一些信息。这些信息包括[动态链接库](https://zh.wikipedia.org/wiki/库_\(计算机\)#动态链接 "wikilink")、[API导入和导出表](https://zh.wikipedia.org/wiki/Application_programming_interface "wikilink")、资源管理数据和[线程局部存储数据](https://zh.wikipedia.org/wiki/thread-local_storage "wikilink")。在[Windows NT操作系统中](../Page/Windows_NT.md "wikilink")，PE文件格式主要用于[EXE文件](https://zh.wikipedia.org/wiki/EXE "wikilink")、[DLL文件](../Page/动态链接库.md "wikilink")、[.sys](../Page/.sys.md "wikilink")（驱动程序）和其他文件类型。[可扩展固件接口（EFI）技术规范书中说明PE格式是EFI环境中的标准可执行文件格式](https://zh.wikipedia.org/wiki/可扩展固件接口 "wikilink")。开头为[DOS头部](https://zh.wikipedia.org/wiki/DOS头部 "wikilink")。
...
PE文件格式的主要竞争对手是[可执行与可链接格式（ELF）](https://zh.wikipedia.org/wiki/可执行与可链接格式 "wikilink")（使用于[Linux](../Page/Linux.md "wikilink")和大多数[Unix版本中](https://zh.wikipedia.org/wiki/Unix "wikilink")）和[Mach-O](../Page/Mach-O.md "wikilink")（使用于[Mac OS X中](https://zh.wikipedia.org/wiki/Mac_OS_X "wikilink")）。

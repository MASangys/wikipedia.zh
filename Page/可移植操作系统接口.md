**可移植作業系統接口**（，縮寫為**POSIX**）是[IEEE为要在各种](https://zh.wikipedia.org/wiki/IEEE "wikilink")[UNIX](../Page/UNIX.md "wikilink")[操作系统上运行软件](../Page/操作系统.md "wikilink")，而定义[API的一系列互相关联的标准的总称](https://zh.wikipedia.org/wiki/API "wikilink")，其正式称呼为IEEE
Std
1003，而国际标准名称为[ISO](https://zh.wikipedia.org/wiki/ISO "wikilink")/[IEC](https://zh.wikipedia.org/wiki/IEC "wikilink")

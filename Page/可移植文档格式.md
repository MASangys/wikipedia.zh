**可移植文档格式**（，缩写：**PDF**）是一種用獨立於[應用程式](https://zh.wikipedia.org/wiki/應用程式 "wikilink")、[硬體](https://zh.wikipedia.org/wiki/硬體 "wikilink")、[作業系統的方式呈現](https://zh.wikipedia.org/wiki/作業系統 "wikilink")[文檔的](https://zh.wikipedia.org/wiki/文檔 "wikilink")[檔案格式](../Page/檔案格式.md "wikilink")。\[1\]每個PDF文件包含固定布局的平面文檔的完整描述，包括文本、字形、圖形及其他需要顯示的資訊。 1991年，[Adobe Systems共同創始人約翰](https://zh.wikipedia.org/wiki/Adobe_Systems "wikilink")·沃諾克提出的名為“Camelot”的系統\[2\]演變成PDF。

## 歷史

PDF檔案格式是在1990年代初開發，用於分享包括文本格式和内置影像的文檔，能跨平台操作，即使電腦平台完全不同，收件者亦無需适配相關或合用的[應用軟體接口](https://zh.wikipedia.org/wiki/應用軟體 "wikilink")\[3\]。當時與PDF一起競逐跨平台檔案格式的，還包括 [DjVu](../Page/DjVu.md "wikilink")（仍在開發中）、、Common Ground Digital Paper、Farallon Replica 及 [Adobe](https://zh.wikipedia.org/wiki/Adobe系統 "wikilink") 自己本身的 [PostScript](../Page/PostScript.md "wikilink")（.ps）格式。在[萬維網及](https://zh.wikipedia.org/wiki/萬維網 "wikilink")[HTML](../Page/HTML.md "wikilink")文本尚未興起的當時，PDF在[桌面出版](../Page/桌面出版.md "wikilink")[工作流技术](../Page/工作流技术.md "wikilink")當中很受歡迎。PDF最早是Adobe所控制的，直到2008年7月1日才被官方以[开放标准发行](https://zh.wikipedia.org/wiki/开放标准 "wikilink")，并由[国际标准化组织以](https://zh.wikipedia.org/wiki/国际标准化组织 "wikilink") ISO 32000-1:2008 发布。\[4\]\[5\] 此後，標準的控制權便移轉到了產業專家志願者所組的ISO委员会底下。2008年，Adobe在 ISO 32000-1 發佈了公共专利许可，對於製做、使用、銷售及發佈PDF相容的應用所需的專利，皆赋予[买断式授权](https://zh.wikipedia.org/wiki/买断式授权 "wikilink")。\[6\]
...
PDF可能会被[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")，以致查看或编辑内容时会要求输入密码。PDF参考书同时定义40位和128位加密，都运用[RC4](../Page/RC4.md "wikilink")和[MD5](../Page/MD5.md "wikilink")的复杂系统。PDF参考书还定义第三方可以制定他们自己的PDF加密系统的方式。
...
71. [PCmag.com blogs](http://blogs.pcmag.com/securitywatch/2010/03/malicious_pdfs_execute_code_wi.php)

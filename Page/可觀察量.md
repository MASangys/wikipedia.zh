...
在[物理學裏](https://zh.wikipedia.org/wiki/物理學 "wikilink")，特別是在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，處於某種狀態的物理系統，它所具有的一些性質，可以經過一序列的[物理運作過程而得知](../Page/算符.md "wikilink")。這些可以得知的性質，稱為**可觀察量**（）。例如，物理運作可能涉及到施加[電磁場於物理系統](https://zh.wikipedia.org/wiki/電磁場 "wikilink")，然後使用實驗儀器測量某[物理量的數值](../Page/物理量.md "wikilink")。在[經典力學的系統裏](https://zh.wikipedia.org/wiki/經典力學 "wikilink")，任何可以用實驗測量獲得的可觀察量，都可以用定義於物理系統狀態的[實函數來表示](https://zh.wikipedia.org/wiki/實函數 "wikilink")。在量子力學裏，物理系統的狀態稱為[量子態](../Page/量子態.md "wikilink")，其與可觀察量的關係更加微妙，必須使用[線性代數來解釋](https://zh.wikipedia.org/wiki/線性代數 "wikilink")。根據[量子力學的數學表述](../Page/量子力學的數學表述.md "wikilink")，量子態可以用存在於[希爾伯特空間的](https://zh.wikipedia.org/wiki/希爾伯特空間 "wikilink")[態向量來代表](../Page/態向量.md "wikilink")，量子態的可觀察量可以用[厄米算符來代表](https://zh.wikipedia.org/wiki/厄米算符 "wikilink")。

[Stern-Gerlach_experiment_zh.png](https://zh.wikipedia.org/wiki/File:Stern-Gerlach_experiment_zh.png "fig:Stern-Gerlach_experiment_zh.png")儀器，可以將入射的銀原子束，分裂成兩道銀原子束，一道銀原子束的\(S_z\)為上旋，另一道銀原子束的\(S_z\)為下旋。在這裏，\(S_z\)是可觀察量。\]\]
在[物理學裏](../Page/物理學.md "wikilink")，特別是在[量子力學裏](../Page/量子力學.md "wikilink")，處於某種狀態的物理系統，它所具有的一些性質，可以經過一序列的[物理運作過程而得知](../Page/算符.md "wikilink")。這些可以得知的性質，稱為**可觀察量**（）。例如，物理運作可能涉及到施加[電磁場於物理系統](../Page/電磁場.md "wikilink")，然後使用實驗儀器測量某[物理量的數值](../Page/物理量.md "wikilink")。在[經典力學的系統裏](../Page/經典力學.md "wikilink")，任何可以用實驗測量獲得的可觀察量，都可以用定義於物理系統狀態的[實函數來表示](../Page/實函數.md "wikilink")。在量子力學裏，物理系統的狀態稱為[量子態](../Page/量子態.md "wikilink")，其與可觀察量的關係更加微妙，必須使用[線性代數來解釋](../Page/線性代數.md "wikilink")。根據[量子力學的數學表述](../Page/量子力學的數學表述.md "wikilink")，量子態可以用存在於[希爾伯特空間的](../Page/希爾伯特空間.md "wikilink")[態向量來代表](../Page/態向量.md "wikilink")，量子態的可觀察量可以用[厄米算符來代表](../Page/厄米算符.md "wikilink")。

## 數學表述

### 本徵態

假設，物理量\(O\)是某量子系統的可觀察量，其對應的量子算符\(\hat{O}\)，可能有很多不同的本徵值\(O_i\)與對應的本徵態\(|e_i\rang\)，這些本徵態\(|e_i\rang,\quad i=1,\ 2,\ 3,\ \cdots,n\)，形成了具有[正交歸一性的](../Page/正交歸一性.md "wikilink")[基底](../Page/基底.md "wikilink")：\[1\]
...
根據[統計詮釋](../Page/統計詮釋.md "wikilink")，對應於可觀察量的量子算符可能有很多本徵值，測量結果只能是其中一個本徵值，而且，每一個本徵值出現的機會呈機率性。測量這個動作會將量子系統的量子態改變為對應於本徵值的本徵態，並且，在之後短暫片刻內，量子系統的量子態仍舊是這本徵態。\[3\]
...
這正是[厄米算符的定義](../Page/厄米算符.md "wikilink")。所以，表現可觀察量的算符，都是厄米算符。\[4\]

## 不相容可觀察量

假若兩種可觀察量的[對易算符不等於](../Page/對易算符.md "wikilink")0，則稱這兩種可觀察量為「不相容可觀察量」：\[5\]

\[[\hat{A},\hat{B}]\ne 0\]；

其中，\(\hat{A}\)、\(\hat{B}\)分別是可觀察量\(A\)、\(B\)的算符。

這兩種算符\(\hat{A}\)與\(\hat{B}\)絕對不會有共同的基底。一般而言，\(\hat{A}\)的本徵態與\(\hat{B}\)的本徵態不同假設量子系統的量子態為\(|\psi\rang\)。對於算符\(\hat{A}\)，所有本徵值為\(a_i\)的本徵態\(|\alpha_i\rang,\quad i=1,\ 2,\ 3,\ \cdots,n\)，形成一個基底。量子態\(|\psi\rang\)可以表示為這組基底本徵態的[線性組合](../Page/線性組合.md "wikilink")：
...
對於算符\(\hat{B}\)，所有本徵值為\(b_i\)的本徵態\(|\beta_i\rang,\quad i=1,\ 2,\ 3,\ \cdots,n\)，形成了另外一個基底。量子態\(|\psi\rang\)可以表示為這組基底本徵態的[線性組合](../Page/線性組合.md "wikilink")：
...
對於量子系統的可觀察量\(A\)做測量，可能得到的結果是各種本徵態\(|\alpha_i\rang\)的本徵值\(a_i\)，獲得這些不同結果的機會具有機率性，可以表達為[機率分佈](../Page/機率分佈.md "wikilink")，結果為\(a_i\)的機率是\(|c_i|^2\)。
...
為了具體計算位置與動量的[期望值](../Page/期望值_\(量子力學\).md "wikilink")，可以將量子態表現於位置空間，以位置空間的[波函數來表示](../Page/波函數.md "wikilink")，使用對應的代數算符。
...
在三維空間裏，[角動量算符的x](../Page/角動量算符.md "wikilink")-分量\(\hat{L}_x\)是厄米算符。因為

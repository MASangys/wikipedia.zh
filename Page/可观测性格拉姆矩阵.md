[控制理論中](https://zh.wikipedia.org/wiki/控制理論 "wikilink")，**可观测性格拉姆矩阵**（Observability
Gramian）是用來判斷線性[動態系統是否](https://zh.wikipedia.org/wiki/動態系統 "wikilink")[可觀測的](../Page/可觀測性.md "wikilink")[格拉姆矩阵](../Page/格拉姆矩阵.md "wikilink")。
...
\(\boldsymbol{A}\)若穩定（所有的特徵值實部均為負），可观测性格拉姆矩阵也是以下[李亞普諾夫方程的唯一解](https://zh.wikipedia.org/wiki/李亞普諾夫方程 "wikilink")
...
## 外部連結
  ...
  - [Mathematica function to compute the observability
    Gramian](http://reference.wolfram.com/mathematica/ref/ObservabilityGramian.html)

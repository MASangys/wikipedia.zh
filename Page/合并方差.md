**合并方差**（）在[统计学中是指当多个总体均值不同时估算总体](../Page/统计学.md "wikilink")[方差的方法](../Page/方差.md "wikilink")。其假设每个总体都有着相同的方差。在此假设之下，合并样本方差相比单个的样本方差能更精确地估算总体方差。合并方差的平方根则称为**合并标准差**（）。
...
\[s^2_i\] =
\(\frac{1}{n_i-1} \sum_{j=1}^{n_i} \left(y_j - \overline{y_j} \right)^2\).

...
homo，意為與符號含義表示相同）是某些编程语言的特殊屬性，它意味着一个程序的结构与其[句法是相似的](../Page/句法.md "wikilink")，因此易于通过阅读程序来推测程序的内在涵义。如果一门编程语言具备了同像性，说明该语言的文本表示（通常指源代码）與其[抽象語法樹](https://zh.wikipedia.org/wiki/抽象語法樹 "wikilink")（AST）具有相同的結構（即，AST
...
依照[道格拉斯·麥克羅伊的提議](../Page/道格拉斯·麥克羅伊.md "wikilink")，依據Peirce，C.S.McIlroy

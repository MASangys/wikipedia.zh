[抽象代数](../Page/抽象代数.md "wikilink")中，**同态**是两个[代数结构](../Page/代数结构.md "wikilink")（例如[群](../Page/群.md "wikilink")、环、或者[向量空间](../Page/向量空间.md "wikilink")）之间的保持结构不变的[映射](https://zh.wikipedia.org/wiki/映射 "wikilink")。英文的同态(*homomorphism*)来自[希腊语](https://zh.wikipedia.org/wiki/希腊语 "wikilink"):*
(homos)*表示"相同"而* (morphe)*表示"形态"。注意相似的词根*
(homoios)*表示"相似"出现在另一个数学概念[同胚](../Page/同胚.md "wikilink")的英文(homeomorphism)中。
...
在 *Y* 中的像必然[同构](../Page/同构.md "wikilink")于
*X*/\~。这就是所谓的[同构基本定理](../Page/同构基本定理.md "wikilink")之一。注意到在有些情况下（比如说在[群](../Page/群.md "wikilink")结构或环结构时），仅仅一个[等价类](../Page/等价类.md "wikilink")
*K* 就可以决定商集的结构，因此这时我们可以将它记作 *X*/*K*（一般读作 *X*
[模](https://zh.wikipedia.org/wiki/同余 "wikilink") *K* ）。在这种情况下，一般将
*K*，而不是 \~，称作 *f*
的核（参见[正规子群](../Page/正规子群.md "wikilink")和[理想](../Page/理想_\(环论\).md "wikilink")）。
...
同态也被用于[形式语言](../Page/形式语言.md "wikilink")的研究中。\[1\]给定字母表\(\Sigma_1\)和\(\Sigma_2\)，函数*h*
: \(\Sigma_1^*\) →

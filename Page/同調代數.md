...
同調代數的發展與[範疇論的出現密不可分](https://zh.wikipedia.org/wiki/範疇論 "wikilink")。大致說來，同調代數是（上）同調函子及其代數結構的研究。「同調」與「上同調」是一對對偶的概念，它們滿足的[範疇論性質相反](https://zh.wikipedia.org/wiki/範疇論 "wikilink")（即：箭頭反向）。數學很大一部分的內在構造可藉[鏈複形理解](https://zh.wikipedia.org/wiki/鏈複形 "wikilink")，其性質則以同調與上同調的面貌展現，同調代數能萃取這些鏈複形蘊含的資訊，並表之為[拓撲空間](https://zh.wikipedia.org/wiki/拓撲空間 "wikilink")、[層](https://zh.wikipedia.org/wiki/層_\(數學\) "wikilink")、[群](../Page/群.md "wikilink")、[環](https://zh.wikipedia.org/wiki/環 "wikilink")、[李代數與](../Page/李代數.md "wikilink")[C\*-代數等等](https://zh.wikipedia.org/wiki/C*-代數 "wikilink")「具體」對象的（上）同調不變量。[譜序列是計算這些量的有力工具](../Page/譜序列.md "wikilink")。

同調代數肇始即在代數拓撲中扮演要角。其影響日漸擴大，目前已遍及[交換代數](../Page/交換代數.md "wikilink")、[代數幾何](https://zh.wikipedia.org/wiki/代數幾何 "wikilink")、[代數數論](../Page/代數數論.md "wikilink")、[表示理論](https://zh.wikipedia.org/wiki/表示理論 "wikilink")、[算子代數](https://zh.wikipedia.org/wiki/算子代數 "wikilink")、[偏微分方程與](../Page/偏微分方程.md "wikilink")[非交換幾何](https://zh.wikipedia.org/wiki/非交換幾何 "wikilink")。[K-理論是一門獨立的學科](https://zh.wikipedia.org/wiki/K-理論 "wikilink")，它也採用同調代數的辦法。

## 主要對象：鏈複形

同調代數領域的基本對象是一個**鏈複形**\((A_\bullet, d_\bullet)\)。這是一個由[交換群](https://zh.wikipedia.org/wiki/交換群 "wikilink")、[模或更廣義地說是由一個](../Page/模.md "wikilink")[阿貝爾範疇的對象組成的序列](../Page/阿貝爾範疇.md "wikilink")*A*<sub>0</sub>,
*A*<sub>1</sub>,
*A*<sub>2</sub>……。它們通過一系列[同態](https://zh.wikipedia.org/wiki/同態 "wikilink")*d*<sub>*n*</sub>
...
<!-- end list -->
  ...
  - 對鏈映射可以定義[同倫的概念](https://zh.wikipedia.org/wiki/鏈同倫 "wikilink")，這是拓撲學的[同倫在代數框架下的翻譯](../Page/同倫.md "wikilink")。同倫的鏈映射在同調群上誘導出相同的映射。
  - 在同調群上誘導出同構的鏈映射稱作**擬同構**。

鏈複形概念的一個對偶版本是*上鏈複形*。一個**上鏈複形**\((A^\bullet, d^\bullet)\)是個序列*A*<sup>0</sup>,
*A*<sup>1</sup>,
*A*<sup>2</sup>……。它們由一系列[同態](https://zh.wikipedia.org/wiki/同態 "wikilink")*d*<sup>*n*</sup>
:
...
同調代數的根源之一在[代數拓撲](https://zh.wikipedia.org/wiki/代數拓撲 "wikilink")，而後者的歷史則可上溯至十九世紀中。早在[黎曼關於](https://zh.wikipedia.org/wiki/黎曼 "wikilink")[阿貝爾簇的工作中](https://zh.wikipedia.org/wiki/阿貝爾簇 "wikilink")，就已考慮過[黎曼曲面上的閉曲線是否為一塊區域的邊界的問題](../Page/黎曼曲面.md "wikilink")；根據[斯托克斯定理](../Page/斯托克斯定理.md "wikilink")，[閉形式在這類閉曲線上的積分恆為零](../Page/微分形式.md "wikilink")，而這類曲線的多寡顯然牽涉到曲面的拓撲性狀。黎曼依此定義了「連通數」——用現代的語言表述即是\(1 + \dim H_1(X; \mathbb{Z}/2\mathbb{Z})\)，此量關係到黎曼曲面的[虧格](https://zh.wikipedia.org/wiki/虧格 "wikilink")，直觀地理解便是曲面上有幾個「洞」。

[龐加萊在](https://zh.wikipedia.org/wiki/龐加萊 "wikilink")1895年的經典論文*Analysis
Situs*及其後續工作真正奠定了代數拓撲學的基礎。他考慮的對象是後來所謂的[單純複形](https://zh.wikipedia.org/wiki/單純複形 "wikilink")，這類空間在[同胚的意義下可剖分為](../Page/同胚.md "wikilink")[多面體](https://zh.wikipedia.org/wiki/多面體 "wikilink")，它包含了[微分拓撲中處理的大多數有限維空間](https://zh.wikipedia.org/wiki/微分拓撲 "wikilink")。龐加萊考慮一個單純複形\(X\)中各種維度的[單純形](https://zh.wikipedia.org/wiki/單純形 "wikilink")（零維的點、一維的線、二維的三角形、三維的四面體等等）的整係數線性組合，稱之為**鏈**，它們構成一系列的[阿貝爾群](https://zh.wikipedia.org/wiki/阿貝爾群 "wikilink")\(C_0(X), C_1(X), C_2(X), \ldots\)，其中下標代表維度。龐加萊還定義了一個**邊界映射**\(\partial_i: C_i(X) \rightarrow C_{i-1}(X)\)，它在單純形上的作用是將\(i\)維單純形的\((i-1)\)維邊界取適當正負號後作線性組合；彼此差個邊界的鏈在拓撲上稱作**同調的**，這也是同調代數的詞源。龐加萊證明\(\partial_{i-1} \circ \partial_i = 0\)，於是我們有以下[鏈複形](https://zh.wikipedia.org/wiki/鏈複形 "wikilink")
...
定義\(X\)的[貝蒂數與](../Page/貝蒂數.md "wikilink")[歐拉示性數](https://zh.wikipedia.org/wiki/歐拉示性數 "wikilink")：
...
這兩個量都與空間\(X\)的剖分方式無關，僅決定於空間的[倫型](../Page/同倫.md "wikilink")。起初龐加萊只考慮數值不變量；在1925年，[埃米·诺特於一份只有](../Page/埃米·诺特.md "wikilink")14行的報告中指出：根本的不變量是[阿貝爾群](https://zh.wikipedia.org/wiki/阿貝爾群 "wikilink")\(H^i(X) = \mathrm{Ker}(\partial_i)/\mathrm{Im}\partial_{i+1}\)，而不僅僅是它派生的非負整數\(b_i = \dim H^i(X) \otimes \mathbb{Q}\)；群結構能給出更細的拓撲資訊，而空間的[連續映射能導出同調群的同態](https://zh.wikipedia.org/wiki/連續映射 "wikilink")。代數拓撲的風貌從此遂澈底改變。

循此脈絡，L.
Mayer在1929年定義了抽象的[鏈複形及其](https://zh.wikipedia.org/wiki/鏈複形 "wikilink")[同調群](https://zh.wikipedia.org/wiki/同調群 "wikilink")。同調理論自此有了純[代數的框架](https://zh.wikipedia.org/wiki/抽象代數 "wikilink")。
...
此後拓撲學仍不斷為同調代數注入動力，例子包括了：
  ...
  - [非球空間的上同調群](https://zh.wikipedia.org/wiki/非球空間 "wikilink")：它們可由基本群的[群上同調算出](../Page/群上同調.md "wikilink")，這也是一種[Ext函子](../Page/Ext函子.md "wikilink")。
  - [李群的上同調群](../Page/李群.md "wikilink")：由其[李代數決定](../Page/李代數.md "wikilink")，由此催生了[李代數上同調理論](https://zh.wikipedia.org/wiki/李代數上同調 "wikilink")。

### 希爾伯特與合衝模

同調代數的另一條線索可以追溯到十九世紀的顯學[不變量理論與](../Page/不變量理論.md "wikilink")[大衛·希爾伯特](https://zh.wikipedia.org/wiki/大衛·希爾伯特 "wikilink")。希爾伯特為了研究不變量本身、不變量間的關係、以及關係間的關係……，而考慮[自由分解的問題](https://zh.wikipedia.org/wiki/自由分解 "wikilink")：設\(A\)為[諾特環](../Page/諾特環.md "wikilink")，\(M\)為有限生成的\(A\)-模，
...
當\(A\)是[局部環時](../Page/局部環.md "wikilink")，極小分解的長度稱作\(M\)的[投射維度](https://zh.wikipedia.org/wiki/投射維度 "wikilink")，它相當於使下式成立的最小整數\(n\)：
...
[昂利·嘉當與](https://zh.wikipedia.org/wiki/昂利·嘉當 "wikilink")[塞缪尔·艾伦伯格在](../Page/塞缪尔·艾伦伯格.md "wikilink")1956年出版的著作*Homological
Algebra*標示了同調代數的成熟。書中的概念與工具影響之深廣，成為各領域數學家們不可須臾離的生活資料。以下舉出數點例子：
  ...
  - 將[Tor函子與](../Page/Tor函子.md "wikilink")[Ext函子分別定義為](../Page/Ext函子.md "wikilink")\(M \otimes_R -\)與\(\mathrm{Hom}_R(-, M)\)的右導函子與左導函子，並探討了[同調維度](https://zh.wikipedia.org/wiki/同調維度 "wikilink")。
  - 介紹了譜序列，並用以計算Tor與Ext。
...
[亞歷山大·格羅滕迪克在](https://zh.wikipedia.org/wiki/亞歷山大·格羅滕迪克 "wikilink")1955年左右對[韋伊猜想發生興趣](https://zh.wikipedia.org/wiki/韋伊猜想 "wikilink")，而真正勾動他的是此猜想的[上同調表述](https://zh.wikipedia.org/wiki/韋伊上同調 "wikilink")；格羅滕迪克為此開始研習同調代數，當時嘉當-艾倫伯格的書尚未出版。嘉當與艾倫伯格僅考慮[模構成的範疇](../Page/模.md "wikilink")。格羅滕迪克在1956年一封給塞爾的信中寫道：
...
homologique*\[5\]中開花結果。原本區區數頁的簡單定義變為102頁的[範疇論論證](https://zh.wikipedia.org/wiki/範疇論 "wikilink")，謠傳他因此花了兩年才找到地方刊登；但後續發展證明他的努力與收穫是相稱的。論文提出的重要觀念如下：
...
格羅滕迪克在1961年左右面臨一個技術瓶頸：為了為任意概形上的[凝聚層建立對偶定理](../Page/凝聚層.md "wikilink")，必須為同調代數發展新工具。這個任務由他的學生[讓-路易·韋迪耶](https://zh.wikipedia.org/wiki/讓-路易·韋迪耶 "wikilink")（）完成了。
...
就[模型範疇的觀點](https://zh.wikipedia.org/wiki/模型範疇 "wikilink")，同調代數可被視為同倫理論的一支。這是Daniel
Quillen將模型範疇理論稱作[同倫代數的原因](https://zh.wikipedia.org/wiki/同倫代數 "wikilink")
。

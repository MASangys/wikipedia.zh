...
直觉上，同调是取一个[等价关系](../Page/等价关系.md "wikilink")，如果[链](https://zh.wikipedia.org/wiki/链_\(代数拓扑\) "wikilink") *C* - *D* 是一个高一维链的边界，则链 *C* 与 *D* 是同调的。最简单的例子是在[图论](../Page/图论.md "wikilink")中，有 *C* 和 *D* 两组顶点集，考虑到从 *P*到 *Q* 的有向边 *E* 的边缘是 *Q*-*P*。从 *D* 到 *C* 的一些边的集合，每一个与前一个相连，是一个同调。

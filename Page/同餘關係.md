...
元型例子是[模算术](https://zh.wikipedia.org/wiki/模算术 "wikilink")：对于一个正[整数](../Page/整数.md "wikilink")*n*，两个整数*a*和*b*被称为**同餘模*n***，如果*a* − *b*整除于*n*（还有一个等价的条件是它们除以*n*得出同样的餘数）。
...
想法是推广到[泛代数中](https://zh.wikipedia.org/wiki/泛代数 "wikilink")：代数*A*上的同餘关系是[直积](../Page/直积.md "wikilink")*A*×*A*的[子集](../Page/子集.md "wikilink")，它既是在*A*上的[等价关系又是](../Page/等价关系.md "wikilink")*A*×*A*的[子代数](https://zh.wikipedia.org/wiki/子代数 "wikilink")。

[同态的](../Page/同态.md "wikilink")[核总是同餘](../Page/核_\(代数\).md "wikilink")。实际上，所有同餘引起自核。对于给定在*A*上的同餘\~，[等价类的集合](../Page/等价类.md "wikilink")*A*/\~可以自然的方式给出自代数的结构[商代数](https://zh.wikipedia.org/wiki/商代数 "wikilink")。映射所有*A*的元素到它的等价类的函数是同态，这个同态的核是\~。

在一个代数上的所有同餘关系的[格是](../Page/格_\(数学\).md "wikilink")[代数格](https://zh.wikipedia.org/wiki/代数格 "wikilink")。

## 群的同餘、正规子群和理想

在[群的特殊情况下](../Page/群.md "wikilink")，同餘关系可以用基本术语描述为：如果*G*是群（带有[单位元](https://zh.wikipedia.org/wiki/单位元 "wikilink")*e*）并且\~是在*G*上的[二元关系](../Page/二元关系.md "wikilink")，则\~是同餘只要：

1.  给定*G*的[任何元素](https://zh.wikipedia.org/wiki/全称量词 "wikilink")*a*，*a*
    \~ *a*（**[自反关系](../Page/自反关系.md "wikilink")**）。
2.  给定*G*任何的元素*a*和*b*，[如果](https://zh.wikipedia.org/wiki/实质蕴涵 "wikilink")*a*
    \~ *b*，则*b* \~
    *a*（**[对称关系](https://zh.wikipedia.org/wiki/对称关系 "wikilink")**）。
3.  给定*G*的任何元素*a*,*b*和*c*，如果*a* \~ *b*
    [并且](https://zh.wikipedia.org/wiki/逻辑合取 "wikilink")*b* \~
    *c*，则*a* \~
    *c*（**[传递关系](https://zh.wikipedia.org/wiki/传递关系 "wikilink")**）。
...
类似的技巧允许谈论环中的核为[理想来替代同餘关系](../Page/理想_\(环论\).md "wikilink")，在[模理论中为](../Page/模.md "wikilink")[子模来替代同餘关系](https://zh.wikipedia.org/wiki/子模 "wikilink")。

这个技巧不适用于[幺半群](../Page/幺半群.md "wikilink")，所以同餘关系的研究在幺半群理论扮演更中心的角色。

## 参见

  - [合同](https://zh.wikipedia.org/wiki/合同_\(數學\) "wikilink")

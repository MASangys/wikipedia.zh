...
在[UNIX与](../Page/UNIX.md "wikilink")[类UNIX系统中](../Page/类UNIX系统.md "wikilink")，后台进程的[进程组ID](https://zh.wikipedia.org/wiki/进程组 "wikilink")（即**PGID**，可用[ps命令获得](https://zh.wikipedia.org/wiki/Ps_\(Unix\) "wikilink")）与控制终端进程组ID（即**TPGID**）不同，因而也可以此辨识后台进程。后台进程无法接收从键盘传送的[信号](https://zh.wikipedia.org/wiki/信号_\(计算机科学\) "wikilink")（如Ctrl-C）\[4\]，但从更专业的定义来说，程序是否能收到用户的中断信号并非后台进程的判别标准。
...
现今许多新型[智能手机与](../Page/智能手机.md "wikilink")[PDA的操作系统都可以运行后台进程](https://zh.wikipedia.org/wiki/PDA "wikilink")，但[移动设备操作系统上的后台程序所能完成的任务与能分配到的资源也因](../Page/移动设备.md "wikilink")[硬件性能差异而常有所限制](../Page/硬件.md "wikilink")，如[Android上后台进程的](../Page/Android.md "wikilink")[CPU使用率就限定于](https://zh.wikipedia.org/wiki/CPU "wikilink")5%～10%的范围内\[10\]，而[iOS上的](../Page/iOS.md "wikilink")在后台运行时也只能完成指定范围内的任务\[11\]；除此以外，在iOS和Android上，系统也会在后台进程占用的[系统存储空间过多时将其杀死](https://zh.wikipedia.org/wiki/内存 "wikilink")\[12\]\[13\]。

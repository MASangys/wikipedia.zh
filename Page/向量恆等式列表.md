...
這條目陳列一些常用的[向量代數的](../Page/向量代數.md "wikilink")[恆等式](../Page/恆等式.md "wikilink")。
...
<!-- end list -->
  ...
  -
      ...
      -
        ...
        的每個分量取[拉普拉斯算子](../Page/拉普拉斯算子.md "wikilink")，卽[向量值函数的拉普拉斯算子](../Page/拉普拉斯算子#向量值函数的拉普拉斯算子.md "wikilink")。
...
[en:List of vector
identities](../Page/en:List_of_vector_identities.md "wikilink")

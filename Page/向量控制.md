...
[达姆施塔特工业大学](../Page/达姆施塔特工业大学.md "wikilink")的K.
Hasse及[西門子公司的F](https://zh.wikipedia.org/wiki/西門子公司 "wikilink").
Blaschke分別在1968年及1970年代初期提出向量控制的概念。Hasse提出的是間接向量控制，Blaschke提出的是直接向量控制\[5\]\[6\]。[布伦瑞克工业大学](../Page/布伦瑞克工业大学.md "wikilink")的維爾納·萊昂哈德（Leonhard
...
向量控制可以用有[編碼器回授轉速的閉迴路磁場導向控制來實現](https://zh.wikipedia.org/wiki/旋轉編碼器 "wikilink")，也可以用無（速度）感測器（sensorless）的[開迴路控制器](../Page/開迴路控制器.md "wikilink")來實現。無感測器向量控制和閉迴路控制器的最大差異是可以輸出額定轉矩的最小速度。閉迴路向量控制可以在馬達靜止時輸出額定轉矩，而無感測器向量控制一般有其最小速度的限制，例如0.8Hz\[25\]。

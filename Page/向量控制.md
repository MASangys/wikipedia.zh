...
Blaschke分別在1968年及1970年代初期提出向量控制的概念。Hasse提出的是間接向量控制，Blaschke提出的是直接向量控制\[5\]\[6\]。[布伦瑞克工业大学的維爾納](https://zh.wikipedia.org/wiki/布伦瑞克工业大学 "wikilink")·萊昂哈德（Leonhard
...
向量控制可以用有[編碼器回授轉速的閉迴路磁場導向控制來實現](https://zh.wikipedia.org/wiki/旋轉編碼器 "wikilink")，也可以用無（速度）感測器（sensorless）的[開迴路控制器來實現](https://zh.wikipedia.org/wiki/開迴路控制器 "wikilink")。無感測器向量控制和閉迴路控制器的最大差異是可以輸出額定轉矩的最小速度。閉迴路向量控制可以在馬達靜止時輸出額定轉矩，而無感測器向量控制一般有其最小速度的限制，例如0.8Hz\[25\]。
...
## 向量控制的特點
  ...
  - 藉由調整控制的[目標值](https://zh.wikipedia.org/wiki/目標值 "wikilink")，轉矩及磁通可以快速變化，一般可以在5-10毫秒內完成。
...
## 相關條目
  ...
  - [控制工程](https://zh.wikipedia.org/wiki/控制工程 "wikilink")
  ...
  - [鲁棒控制](https://zh.wikipedia.org/wiki/鲁棒控制 "wikilink")

  - [根軌跡圖](https://zh.wikipedia.org/wiki/根軌跡圖 "wikilink")
  ...
  - [滑動模式控制](https://zh.wikipedia.org/wiki/滑動模式控制 "wikilink")
  ...
  - [暫態響應](https://zh.wikipedia.org/wiki/暫態響應 "wikilink")

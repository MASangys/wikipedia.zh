**向量自迴歸模型**（，简称**VAR模型**）是一种常用的计量经济模型，由[计量经济学家和](../Page/计量经济学.md "wikilink")[宏观经济学家](../Page/宏观经济学.md "wikilink")[克里斯托弗·西姆斯](../Page/克里斯托弗·西姆斯.md "wikilink")（）提出。它擴充了只能使用一個變量的[自迴歸模型](../Page/自迴歸模型.md "wikilink")（簡稱：AR模型），使容納大於1個變量，因此經常用在多變量[時間序列模型的分析上](https://zh.wikipedia.org/wiki/時間序列_\(經濟學\) "wikilink")。
...
3.  \(\mathrm{E}(e_{t}e_{t-k}') = 0\,\)
    （对于所有不为0的*k*都满足）—误差项不存在[自相关](https://zh.wikipedia.org/wiki/自相关 "wikilink")
...
其中*I*是[单位矩阵](https://zh.wikipedia.org/wiki/单位矩阵 "wikilink")。

...
在[物理學裏](https://zh.wikipedia.org/wiki/物理學 "wikilink")，**哈密頓-雅可比方程**
（Hamilton-Jacobi equation，HJE）
是[經典力學的一種表述](https://zh.wikipedia.org/wiki/經典力學 "wikilink")。哈密顿-雅可比方程、[牛頓力學](https://zh.wikipedia.org/wiki/牛頓力學 "wikilink")、[拉格朗日力學](https://zh.wikipedia.org/wiki/拉格朗日力學 "wikilink")、[哈密頓力學](https://zh.wikipedia.org/wiki/哈密頓力學 "wikilink")，這幾個表述是互相全等的。而哈密顿-雅可比方程在辨明[守恆的](https://zh.wikipedia.org/wiki/守恆定律 "wikilink")[物理量方面](../Page/物理量.md "wikilink")，特別有用處。有時候，雖然物理問題的本身無法完全解析，哈密顿-雅可比方程仍舊能夠正確的辨明守恆的物理量。

HJE
是[经典哈密顿量一个](../Page/哈密顿力学.md "wikilink")[正则变换](https://zh.wikipedia.org/wiki/正则变换 "wikilink")，经过该变换得到的结果是一个一阶非线性[偏微分方程](../Page/偏微分方程.md "wikilink")，方程式之解描述了系统的行为。与[哈密顿运动方程的不同之处在于](https://zh.wikipedia.org/wiki/哈密顿方程 "wikilink")
HJE 是一个偏微分方程，每个变量对应于一个坐标，而哈密顿方程是一个一阶线性方程组，每两个方程对应于一个坐标。HJE
可以漂亮地解析一些重要问题，例如[开普勒问题](https://zh.wikipedia.org/wiki/开普勒问题 "wikilink")。

HJE
是唯一能夠將粒子運動表達為[波動的一種力學表述](https://zh.wikipedia.org/wiki/波動 "wikilink")。因此，HJE
滿足了一個長久以來理論物理的研究目標（早至 18
世紀，[約翰·白努利和他的學生](../Page/約翰·白努利.md "wikilink")[皮埃爾·莫佩爾蒂的年代](../Page/皮埃爾·莫佩爾蒂.md "wikilink")）；那就是，尋找[波傳播與粒子運動的相似之處](https://zh.wikipedia.org/wiki/波傳播 "wikilink")。力學系統的[波動方程式與](https://zh.wikipedia.org/wiki/波動方程式 "wikilink")[薛丁格方程式很相似](https://zh.wikipedia.org/wiki/薛丁格方程式 "wikilink")；但並不相同。稍後會有詳細說明。HJE
被認為是從經典力學進入[量子力學最近的門階](https://zh.wikipedia.org/wiki/量子力學 "wikilink")。
...
其中，\(\mathcal{H}\)
是[哈密頓量](https://zh.wikipedia.org/wiki/哈密頓量 "wikilink")，未知函數
...
哈密頓-雅可比方程是一個一階非线性[偏微分方程式](https://zh.wikipedia.org/wiki/偏微分方程式 "wikilink")；其中，函數
...
與拉格朗日力學的[拉格朗日方程比較](https://zh.wikipedia.org/wiki/拉格朗日方程 "wikilink")，哈密頓力學裏使用[共軛動量而非](https://zh.wikipedia.org/wiki/共軛動量 "wikilink")[廣義速度](../Page/廣義速度.md "wikilink")。並且，[哈密頓方程乃是一組](https://zh.wikipedia.org/wiki/哈密頓方程 "wikilink")
\(2N\) 個一階微分方程式，用來表示 \(N\) 個廣義坐標和 \(N\)
個廣義動量隨時間的演變，而[拉格朗日方程則是一組](https://zh.wikipedia.org/wiki/拉格朗日方程 "wikilink")
\(N\) 個二階微分方程式，用來表示 \(N\) 個廣義坐標隨時間的演變。

因為 HJE 等價於一個最小積分問題（像[哈密頓原理](../Page/哈密頓原理.md "wikilink")）， HJE
可以用於許多關於[變分法的問題](https://zh.wikipedia.org/wiki/變分法 "wikilink")。更推廣地，在數學與物理的其它分支，像[動力系統](https://zh.wikipedia.org/wiki/動力系統 "wikilink")、[辛幾何](https://zh.wikipedia.org/wiki/辛幾何 "wikilink")、[量子混沌理論](https://zh.wikipedia.org/wiki/混沌理論 "wikilink")，都可以用
HJE 來解析問題。例如，HJE
可以用來找尋[黎曼流形的](../Page/黎曼流形.md "wikilink")[測地線](https://zh.wikipedia.org/wiki/測地線 "wikilink")，這是[黎曼幾何一個很重要的變分法問題](https://zh.wikipedia.org/wiki/黎曼幾何 "wikilink")。

## 導引

在[哈密頓力學裏](https://zh.wikipedia.org/wiki/哈密頓力學 "wikilink")，[正則變換將一組](../Page/正則變換.md "wikilink")[正則坐標](https://zh.wikipedia.org/wiki/正則坐標 "wikilink")
...
假若，使用[第二型生成函數](https://zh.wikipedia.org/wiki/正則變換生成函數#第二型生成函數 "wikilink")
...
哈密頓主函數 \(S\)
的可分性，相關於哈密頓量和廣義坐標的選擇。假若，一個物理系統符合[施特克爾條件](https://zh.wikipedia.org/wiki/施特克爾條件 "wikilink")
() ，則哈密頓主函數 \(S\) 可以完全分離。以下為用幾種正交座標來完全分離 HJE 的例子。

### 球坐標系

採用[球坐標](https://zh.wikipedia.org/wiki/球坐標 "wikilink")
\((r,\ \theta,\ \phi)\) ，假設一個物理系統的哈密頓量為
...
為[位勢函數](https://zh.wikipedia.org/wiki/位勢 "wikilink")，不含時間。
...
假若，[位勢函數](https://zh.wikipedia.org/wiki/位勢 "wikilink")
\(U(r,\ \theta,\ \phi)\) 的形式可以進一步設定為
...
想像 \(\sigma_0\)
為一個[相位曲面](https://zh.wikipedia.org/wiki/相位 "wikilink")。既然粒子具有[波粒二象性](../Page/波粒二象性.md "wikilink")，試著給予粒子一個相位與
\(S\) 成比例的[波函數](https://zh.wikipedia.org/wiki/波函數 "wikilink")：
...
\(\Psi(\mathbf{r},\,t)\)
的[波動方程式為](https://zh.wikipedia.org/wiki/波動方程式 "wikilink")
...
由於這取極限的動作，在[希爾伯特空間裏對於態向量的描述改變為在](https://zh.wikipedia.org/wiki/希爾伯特空間 "wikilink")[相空間裏對於粒子位置與動量的描述](../Page/相空間.md "wikilink")。薛丁格方程屬於[線性方程](https://zh.wikipedia.org/wiki/線性方程 "wikilink")，假若\(\chi_1\)、\(\chi_2\)皆是薛丁格方程的解答，則它們的[線性疊加](https://zh.wikipedia.org/wiki/疊加原理 "wikilink")\(c_1\chi_1+c_2\chi_2\)必定也是解答，其中\(c_1\)、\(c_2\)皆是複係數。哈密頓-雅可比方程屬於[非線性方程](https://zh.wikipedia.org/wiki/線性方程 "wikilink")，假若\(f_1\)、\(f_2\)皆是哈密頓-雅可比方程的解答，則它們的線性疊加\(c_1f_1+c_2f_2\)必定不是解答。這意味著，在量子力學可以觀察得到的[量子疊加現象](https://zh.wikipedia.org/wiki/量子疊加 "wikilink")，無法出現在經典力學。但是，簡單地推論，經典力學應是量子力學的極限案例，為什麼量子疊加現象無法出現於經典力學裏？這不僅僅是個理論問題，在實驗室裏，時常可以觀察到微觀粒子呈現出量子疊加現象，為什麼無法觀察到宏觀物體呈現出同樣的現象\[6\]？更詳盡內容，請參閱條目[量子退相干](../Page/量子退相干.md "wikilink")。
...
其中，\(g^{ik}\)
是[度規張量](https://zh.wikipedia.org/wiki/度規張量 "wikilink")[逆變](https://zh.wikipedia.org/wiki/逆變 "wikilink")

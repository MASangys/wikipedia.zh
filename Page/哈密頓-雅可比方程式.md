...
想像 \(\sigma_0\) 為一個[相位曲面](https://zh.wikipedia.org/wiki/相位 "wikilink")。既然粒子具有[波粒二象性](../Page/波粒二象性.md "wikilink")，試著給予粒子一個相位與 \(S\) 成比例的[波函數](https://zh.wikipedia.org/wiki/波函數 "wikilink")：

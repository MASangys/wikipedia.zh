...
一般而言，HJB方程不會有一個傳統[光滑函数的解](../Page/光滑函数.md "wikilink")。為了這些情形發展了許多廣義解的表示方式，包括[皮埃爾-路易·利翁及](../Page/皮埃爾-路易·利翁.md "wikilink")的[粘性解](../Page/粘性解.md "wikilink")，Andrei
Izmailovich
Subbotin的[極小化極大演算法等](https://zh.wikipedia.org/wiki/極小化極大演算法 "wikilink")。

## 延伸到隨機問題

上述的作法主要是應用贝尔曼的最优化原理，以及在時間上由最終時間倒推求解，針對[隨機控制問題也可以用類似的作法求最佳解](../Page/隨機控制.md "wikilink")。考慮以下的問題

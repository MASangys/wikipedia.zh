[Hamiltonian_path.svg](https://zh.wikipedia.org/wiki/File:Hamiltonian_path.svg "fig:Hamiltonian_path.svg") **哈密顿图**是一個[無向圖](https://zh.wikipedia.org/wiki/無向圖 "wikilink")，由[哈密顿爵士提出](https://zh.wikipedia.org/wiki/哈密顿 "wikilink")，由指定的起点前往指定的终点，途中经过所有其他节点且只经过一次。在[图论](../Page/图论.md "wikilink")中是指含有哈密顿回路的图，闭合的哈密顿路径称作**哈密顿回路**（**Hamiltonian cycle**），含有图中所有顶点的路径称作**哈密顿路径**（，或）。

...
定理的最一般的表述需要一些准备。给定标量[體](https://zh.wikipedia.org/wiki/體_\(數學\) "wikilink")\(\mathbb{K}\)（[实数](../Page/实数.md "wikilink")域或[复数域](https://zh.wikipedia.org/wiki/复数 "wikilink")）上的一个[向量空间](../Page/向量空间.md "wikilink")**\(V\)**，一个[函数](../Page/函数.md "wikilink")\(\mathcal{N}:V\rightarrow\mathbb{R}\)称为*[次线性](https://zh.wikipedia.org/wiki/次线性函数 "wikilink")*的，如果：

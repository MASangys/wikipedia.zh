**哈斯圖**（[英語Hasse](https://zh.wikipedia.org/wiki/英語 "wikilink") , [德語](https://zh.wikipedia.org/wiki/德語 "wikilink"): ）、在[數學分支](https://zh.wikipedia.org/wiki/數學 "wikilink")[序理論中](https://zh.wikipedia.org/wiki/序理論 "wikilink")，是用來表示有限[偏序集的一種數學圖表](https://zh.wikipedia.org/wiki/偏序關係 "wikilink")，它是一種圖形形式的對偏序集的[傳遞簡約](https://zh.wikipedia.org/wiki/傳遞簡約 "wikilink")。具體的說，對於偏序集合（S, ≤），把S的每個元素表示為平面上的[頂點](https://zh.wikipedia.org/wiki/頂點 "wikilink")，並繪製從x到y向上的[線段或弧線](https://zh.wikipedia.org/wiki/線段 "wikilink")，只要y [覆蓋x](https://zh.wikipedia.org/wiki/覆蓋關係 "wikilink")（就是說，只要x \< y並且沒有z使得x \< z \< y）。這些弧線可以相互交叉但不能觸及任何非其端點的頂點。帶有標註的頂點的這種圖唯一確定這個集合的偏序。

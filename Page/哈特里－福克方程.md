**哈特里－福克**方程（），又称为**HF方程**，是一个应用[变分法计算](../Page/变分法.md "wikilink")[波函数的](../Page/波函数.md "wikilink")[方程式](https://zh.wikipedia.org/wiki/方程式 "wikilink")，是[量子物理](https://zh.wikipedia.org/wiki/量子物理 "wikilink")、[凝聚態物理學](https://zh.wikipedia.org/wiki/凝聚態物理學 "wikilink")、[量子化学中最重要的方程之一](../Page/量子化学.md "wikilink")。HF方程形式上是单电子[本征方程](https://zh.wikipedia.org/wiki/本征值方程 "wikilink")，求得的本征态是单电子波函数，即[分子轨道](../Page/分子轨道.md "wikilink")。以HF方程为核心的数值计算方法称为“哈特里－福克方法”（）。
...
1927年，[物理学家](../Page/物理学家.md "wikilink")[瓦尔特·海特勒和](https://zh.wikipedia.org/wiki/瓦尔特·海特勒 "wikilink")[弗里茨·伦敦完成了](https://zh.wikipedia.org/wiki/弗里茨·伦敦 "wikilink")[氢气](https://zh.wikipedia.org/wiki/氢气 "wikilink")[分子的](../Page/分子.md "wikilink")[量子力学计算之后](../Page/量子力学.md "wikilink")，开启了[量子化学的时代](../Page/量子化学.md "wikilink")。从此，人们便开始尝试使用量子力学理论来解释化学物质结构和化学现象。
...
1930年，哈特里的学生和分别提出了考虑[泡利原理的自洽场迭代方程和单行列式型多电子体系波函数](https://zh.wikipedia.org/wiki/泡利原理 "wikilink")，这就是今天的**哈特里-福克方程**。但是由于计算上的困难，HF方程诞生后整整沉寂了二十年，在1950年，量子化学家想到将分子轨道用原子轨道的线性组合来近似展开，而得到了结构的[罗特汉方程](../Page/罗特汉方程.md "wikilink")。
...
哈特里－福克方程源于对多电子体系电子波函数的变分法处理。在[玻恩-奥本海默近似条件下](https://zh.wikipedia.org/wiki/玻恩-奥本海默近似 "wikilink")，一个多电子体系的[电子运动与](../Page/电子.md "wikilink")[能量可以与](../Page/能量.md "wikilink")[原子核的运动和能量相互分离](../Page/原子核.md "wikilink")，这样利用电子[哈密顿算符和多电子波函数便可以计算体系的电子能量](../Page/哈密顿算符.md "wikilink")。其能量的表达式为:

...
There are suggested amendments to the proof, presented by C. A. Anderson,\[2\] but argued to be refutable by C. A. Anderson and Michael Gettings.\[3\] Sobel's proof of modal collapse has been questioned by Koons,\[4\] but a counter-defence by Sobel has been given.
...
There are many more criticisms, most focusing on the philosophically interesting question of whether these axioms *must* be rejected to avoid odd conclusions. The broader criticism is that even if the axioms cannot be shown to be false, that does not mean that they are true. Hilbert's famous [remark](https://zh.wikipedia.org/wiki/Synthetic_geometry#Logical_synthesis "wikilink") about interchangeability of the primitives' names applies to those in Gödel's ontological axioms (*"positive", "god-like", "essence"*) as well as to those in Hilbert's geometry axioms (*"point", "line", "plane"*). According to Fuhrmann (2005) it remains to show that the dazzling notion prescribed by traditions and often believed to be essentially mysterious satisfies Gödel's axioms. This is not a mathematical, but merely a theological task.\[7\] It is this task which decides which religion's god has been proven to exist.
...
1.
2.  C. A. Anderson. Some emendations of Gödel's ontological argument. Faith and Philosophy, 7:291–303, 1990.
3.  Gόdel's Ontological Proof Revisited | C. Anthony Anderson and Michael Gettings, Gödel's Ontological Proof Revisited
4.  Koons, Robert C. "Sobel on Gödel’s ontological proof." (2005)
5.  Oppy, Graham. "Gödelian ontological arguments." Analysis 56.4 (1996): 226–230.
6.  Gettings, Michael. "Gödel's ontological argument: a reply to Oppy." Analysis 59.264 (1999): 309–313.
7.
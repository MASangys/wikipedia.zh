...
其中\(u\)是一個[可逆元素](https://zh.wikipedia.org/wiki/可逆元素 "wikilink")，\(p_1, \cdots ,p_n\)是[不可約元素](../Page/不可約元素.md "wikilink")，\(n\)是非負整數。並且如果存在\(x\)的另一種表示法此表法\(x = v q_1 q_2 \cdots q_m\)（\(v\)是[可逆元素](https://zh.wikipedia.org/wiki/可逆元素 "wikilink")，\(q_1, \cdots ,q_m\)是[不可約元素](../Page/不可約元素.md "wikilink")），則\(m=n\)，且存在一個下標的重排\(\sigma \in S_n\)與[可逆元素](https://zh.wikipedia.org/wiki/可逆元素 "wikilink")\(w_1, \cdots ,w_n\)使得\(q_i = w_i p_{\sigma(i)}\)
（\(i=1,\cdots,n\)），換句話說，存在\(\sigma \in S_n\)使得\(q_i\)和\(p_{\sigma(i)}\)相伴。

## 例子

  - [主理想整环](https://zh.wikipedia.org/wiki/主理想整环 "wikilink")，特別是[歐幾里得整环](https://zh.wikipedia.org/wiki/歐幾里得整环 "wikilink")。由此可知[整數](https://zh.wikipedia.org/wiki/整數 "wikilink")、[高斯整數與](../Page/高斯整數.md "wikilink")[艾森斯坦整數環都是唯一分解整环](https://zh.wikipedia.org/wiki/艾森斯坦整數 "wikilink")。
  ...
  - [複流形](https://zh.wikipedia.org/wiki/複流形 "wikilink")（例如\(\mathbb{C}\)）上一點的[局部環是唯一分解整环](../Page/局部環.md "wikilink")。
...
## 等價條件
  ...
  - 一個[諾特](../Page/諾特環.md "wikilink")[整環是唯一分解整环若且唯若每個](https://zh.wikipedia.org/wiki/整環 "wikilink")[高度為一的](https://zh.wikipedia.org/wiki/高度_\(環論\) "wikilink")[素理想都是主理想](../Page/素理想.md "wikilink")（即：由單個元素生成）。

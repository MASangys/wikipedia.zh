> 本文内容由[唯舞獨尊Online](https://zh.wikipedia.org/wiki/唯舞獨尊Online)转换而来。
...
由於譜面流動的方式和[RF完全相同](https://zh.wikipedia.org/wiki/#RF類型 "wikilink")（由上而下流動），且啟動爆氣逆轉模式時，譜面會加速流動，因此可以將此類型視為RF的簡化版本。
...
即模仿「[押忍！战斗！应援团](https://zh.wikipedia.org/wiki/押忍！战斗！应援团 "wikilink")」及其PC模拟游戏[OSU\!的玩法](https://zh.wikipedia.org/wiki/OSU! "wikilink")。
...
即模仿「[Cytus](https://zh.wikipedia.org/wiki/Cytus "wikilink")」的玩法，但改用上下左右鍵點擊音符。

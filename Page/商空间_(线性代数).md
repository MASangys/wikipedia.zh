在[线性代数](../Page/线性代数.md "wikilink")中，一个[向量空间](../Page/向量空间.md "wikilink")*V*被一个[子空间](../Page/线性子空间.md "wikilink")*N*的**商**是将*N*“坍塌”为零得到的向量空间。所得的空间称为**商空间**（），记作*V*/*N*（读作
*V*模*N*）。
...
**R**<sup>*m*</sup>显然地[同构](../Page/同构.md "wikilink")于**R**<sup>*n*−*m*</sup>。

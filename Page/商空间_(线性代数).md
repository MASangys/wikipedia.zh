...
正式地，此构造如下。设*V*是[域](https://zh.wikipedia.org/wiki/域 "wikilink")*K*上的一个[向量空间](../Page/向量空间.md "wikilink")，且*N*是*V*的一个[子空间](../Page/线性子空间.md "wikilink")。我们定义在*V*上定义一个[等价类](../Page/等价关系.md "wikilink")\~，如果*x* − *y* ∈ *N*则令*x* \~ *y*。即如果其中一个加上*N*中一个元素得到另一个，则*x*与*y*相关。*x*的所在等价类通常记作

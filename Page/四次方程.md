...
**四次方程**，是[未知数最高次数不超过四次的](https://zh.wikipedia.org/wiki/未知数 "wikilink")[多项式方程](https://zh.wikipedia.org/wiki/多项式 "wikilink")。一个典型的一元四次方程的通式为：
...
自然，人们为了找到这些根做了许多努力。就像其它[多项式](https://zh.wikipedia.org/wiki/多项式 "wikilink")，有时可能对一个四次方程分解出因式；但更多的时候这样的工作是极困难的，尤其是当根是无理数或复数时。因此找到一个通式解法或运算法则（就像[二次方程那样](../Page/二次方程.md "wikilink")，

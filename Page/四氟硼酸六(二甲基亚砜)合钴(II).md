...
将\[Co(H<sub>2</sub>O)<sub>6</sub>\](BF<sub>4</sub>)<sub>2</sub>溶解在热的[DMSO中](https://zh.wikipedia.org/wiki/二甲基亚砜 "wikilink")，真空蒸发溶剂，析出晶体，晶体过滤后用[丙酮](../Page/丙酮.md "wikilink")洗涤，用[五氧化二磷](../Page/五氧化二磷.md "wikilink")干燥，得到纯净的\[Co(DMSO)<sub>6</sub>\](BF<sub>4</sub>)<sub>2</sub>。\[3\]

  -
    \[Co(H<sub>2</sub>O)<sub>6</sub>\](BF<sub>4</sub>)<sub>2</sub> + 6 DMSO → \[Co(DMSO)<sub>6</sub>\](BF<sub>4</sub>)<sub>2</sub> + 6 H<sub>2</sub>O

将氟硼酸钴的水合物溶解在丙酮中，加入DMSO，发生略微的放热反应，也能得到产物。\[4\]另一种方法则是利用钴在DMSO存在下在[氟硼酸](../Page/氟硼酸.md "wikilink")中发生电化学氧化反应来制备。\[5\]

...
在[閔考斯基時空內的任何一點](../Page/閔考斯基時空.md "wikilink")，都可以用四維向量（一組[標準基底的四個坐標](https://zh.wikipedia.org/wiki/閔考斯基時空#標準基底 "wikilink")）
\({x}^{\mu}=({x}^0,\, {x}^1,\, {x}^2,\, {x}^3)\) 來表示；其中，上標
\(\mu=0,\,1,\,2,\,3\)
標記[時空的維數次序](https://zh.wikipedia.org/wiki/時空 "wikilink")。稱這四維向量為「坐標四維向量」，又稱「四維坐標」，定義為

\[{x}^{\mu}\ \stackrel{def}{=}\ (ct,\, x,\, y,\, z)\] ；

其中，\(c\) 是[光速](../Page/光速.md "wikilink")，\(t\) 是時間，\((x,\, y,\, z)\)
是位置的三維[直角坐標](https://zh.wikipedia.org/wiki/直角坐標系 "wikilink")。

為了確使每一個坐標的單位都是長度單位，定義 \({x}^0\ \stackrel{def}{=}\ ct\) 。

「四維位移」定義為兩個事件之間的矢量差。在[時空圖裏](https://zh.wikipedia.org/wiki/時空圖 "wikilink")，四維位移可以用從第一個事件指到第二個事件的箭矢來表示。當矢量的尾部是坐標系的[原點時](https://zh.wikipedia.org/wiki/原點 "wikilink")，位移就是位置。四維位移
\(\Delta {x}^{\mu}\) 表示為
...
帶有上標的四維向量 \({U}^{\mu}\)
稱為[反變矢量](https://zh.wikipedia.org/wiki/反變 "wikilink")，其分量標記為

\[{U}^{\mu}=\ ({U}^0,\, {U}^1,\, {U}^2,\, {U}^3)\] 。

假若，標號是下標，則稱四維向量 \({U}_{\mu}\)
為[協變矢量](https://zh.wikipedia.org/wiki/協變 "wikilink")。其分量標記為
...
這物體的運動可以用一條[世界線](https://zh.wikipedia.org/wiki/世界線 "wikilink")
\(x(\tau)\)
...
的[內積](https://zh.wikipedia.org/wiki/內積 "wikilink")，稱為**閔考斯基內積**，以方程式表示為：
...
一個[靜止質量為](https://zh.wikipedia.org/wiki/靜止質量 "wikilink") \(m\) 的粒子的四維動量
\(P^\mu\) 定義為
...
\(\mathbf{f}\)
對於這粒子所做的微小[機械功](https://zh.wikipedia.org/wiki/機械功 "wikilink")
\(\mathrm{d}W\) 為

\[\mathrm{d}W= \mathbf{f} \cdot \mathrm{d}\mathbf{x}\] 。

因此，這粒子的[動能的改變](https://zh.wikipedia.org/wiki/動能 "wikilink")
\(\mathrm{d}K\) 為
...
這公式的右手邊第二個項目就是[靜止能量](https://zh.wikipedia.org/wiki/靜止能量 "wikilink")
\(E_0\ \stackrel{def}{=}\ m c^2\) 。動能 \(K\) 加上靜止能量 \(E_0\)
等於[總能量](https://zh.wikipedia.org/wiki/總能量 "wikilink") \(E\) ：
...
在[電磁學裏](https://zh.wikipedia.org/wiki/電磁學 "wikilink")，四維電流密度 \(J^{\mu}\)
是一個四維向量，定義為

\[J^{\mu}\ \stackrel{def}{=}\ ( \rho c,\, \mathbf{j})\] ；

其中，\(\rho\) 是[電荷密度](../Page/電荷密度.md "wikilink")，\(\mathbf{j}\)
是三維[電流密度](https://zh.wikipedia.org/wiki/電流密度 "wikilink")。
...
與[矢量勢](https://zh.wikipedia.org/wiki/矢量勢 "wikilink")
\(\mathbf{A}\) 共同形成的，定義為
...
其中，\(\mu_0\)
是[磁常數](https://zh.wikipedia.org/wiki/磁常數 "wikilink")，\(\Box=\partial^2=\partial_\alpha\partial^\alpha=\left( \frac{1}{c^2}\ \frac{\partial^2}{\partial t^2} - \nabla^2 \right)\)
是[達朗貝爾算符](https://zh.wikipedia.org/wiki/達朗貝爾算符 "wikilink")，又稱為[四維拉普拉斯算符](https://zh.wikipedia.org/wiki/拉普拉斯算符 "wikilink")。
...
一個近[單色光的](https://zh.wikipedia.org/wiki/單色光 "wikilink")[波包的波動性質可以用](../Page/波包.md "wikilink")[四維波矢量](https://zh.wikipedia.org/wiki/四維波矢量 "wikilink")
\({K}^\alpha\) 來描述：
...
其中，\(\mathbf{k}\)
是三維[波矢量](https://zh.wikipedia.org/wiki/波矢量 "wikilink")。

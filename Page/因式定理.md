在代數，**因式定理**(*factor theorem*)是關於一個[多項式](../Page/多項式.md "wikilink")的因式和[零點的定理](https://zh.wikipedia.org/wiki/零點 "wikilink")。這是一個[餘式定理](../Page/餘式定理.md "wikilink")的特殊情形\[1\]。
...
3.  利用[長除法](../Page/長除法.md "wikilink")計算多項式\(g(x) = \frac{f(x)}{x-a}\)。

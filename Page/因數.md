...
之间存在的[整除关系](../Page/整除.md "wikilink")，即 \(b\) 可以被
\(a\) [整除](../Page/整除.md "wikilink")。这里我们称 \(b\) 是 \(a\) 的**倍数**，\(a\) 是
\(b\) 的**因数**、**约数**或**因子**.
...
的[倍数](../Page/倍数.md "wikilink")， \(a\) 是 \(b\)
的[约数](../Page/约数.md "wikilink")。这种关系记作 \(a|b\),读作“\(a\)
[整除](../Page/整除.md "wikilink") \(b\)”.
...
<!-- end list -->
  ...
  - 若 \(b=qd+c\), 那么 \(d|b\) 的[充要条件是](../Page/充要条件.md "wikilink")
    \(d|c\)
...
### 整数的[唯一分解定理](../Page/唯一分解定理.md "wikilink")

任何一个[正整数都有且仅有一种方式写出它所有](../Page/正整数.md "wikilink")[素数因子的](../Page/素数.md "wikilink")[乘积表达式](../Page/乘积表达式.md "wikilink")。这个过程称为[质因数分解](../Page/质因数分解.md "wikilink")
...
[自然数](../Page/自然数.md "wikilink")的正因数和，以[因数函数](../Page/因数函数.md "wikilink")
\(\sigma (N)\) 表示。由质因数分解而得。
...
再由[等比级数求和公式可知](../Page/等比级数.md "wikilink")，上式亦可写成：
...
## 其他
  ...
  - 所有*n*的正因數都是n的[質因數的](../Page/質因子.md "wikilink")[積的一些](../Page/積.md "wikilink")[冪](../Page/冪.md "wikilink")。這是[算術基本定理的結果](../Page/算術基本定理.md "wikilink")。

<!-- end list -->

  - 1是所有整數的正因數，-1是所有整數的負因數，因為\(x=1x=-1\times(-x)\)

由上式同樣可證明，一個整數及其[相反數必然為自身的因數](../Page/相反數.md "wikilink")，叫做明顯因數。
...
<!-- end list -->
  ...
  - 質數\(p\)只有2個正因數：1, \(p\)。\(p\)
    的[平方數只有三個正因數](../Page/平方數.md "wikilink")：1,
    \(p\), \(p^2\)。
...
## 相關條目
  ...
  - 因數判別法可參照[整除規則](../Page/整除規則.md "wikilink")。
  - [質數](../Page/質數.md "wikilink")
  - [同余](../Page/同余.md "wikilink")
  - [質因數](../Page/質因子.md "wikilink")
  - [公倍數](../Page/公倍數.md "wikilink")、[最小公倍數](../Page/最小公倍數.md "wikilink")
  - [公因數](../Page/公因數.md "wikilink")、[最大公因數](../Page/最大公因數.md "wikilink")

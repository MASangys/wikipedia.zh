}} 在[數學的分支](https://zh.wikipedia.org/wiki/數學 "wikilink")[图论](../Page/图论.md "wikilink")中，**图**（）用于表示物件與物件之間的關係，是[圖論的基本研究對象](https://zh.wikipedia.org/wiki/圖論 "wikilink")。一张圖由一些小圓點（稱為**頂點**或**結點**）和連結這些圓點的直線或曲線（稱為**[邊](https://zh.wikipedia.org/wiki/邊 "wikilink")**）組成。[西尔维斯特在](https://zh.wikipedia.org/wiki/詹姆斯·约瑟夫·西尔维斯特 "wikilink")1878年首次提出“图”这一名词。

...
在[數學的分支](https://zh.wikipedia.org/wiki/數學 "wikilink")[图论中](../Page/图论.md "wikilink")，**图**（）用于表示物件與物件之間的關係，是[圖論的基本研究對象](https://zh.wikipedia.org/wiki/圖論 "wikilink")。一张圖由一些小圓點（稱為**頂點**或**結點**）和連結這些圓點的直線或曲線（稱為**[邊](https://zh.wikipedia.org/wiki/邊 "wikilink")**）組成。[西尔维斯特在](https://zh.wikipedia.org/wiki/詹姆斯·约瑟夫·西尔维斯特 "wikilink")1878年首次提出“图”这一名词。
...
[6n-graph2.svg](https://zh.wikipedia.org/wiki/File:6n-graph2.svg "fig:6n-graph2.svg")
  ...
  - **[鄰接矩陣](https://zh.wikipedia.org/wiki/鄰接矩陣 "wikilink")**（Adjacency
    matrix）
  ...
  - **[距離矩陣](https://zh.wikipedia.org/wiki/距離矩陣 "wikilink")**（Distance
    matrix）
...
## 圖的重要類型
  ...
  - [完全图](https://zh.wikipedia.org/wiki/完全图 "wikilink")：每一对不同顶点间都有边相连的的图，记作\(K_n\)。

在[计算机视觉领域](../Page/计算机视觉.md "wikilink")，**图像分割**（Segmentation）指的是将[数字图像细分为多个图像子区域](../Page/数字图像.md "wikilink")（像素的[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")）（也被称作超像素）的过程。图像分割的目的是简化或改变图像的表示形式，使得图像更容易理解和分析。\[1\]图像分割通常用于定位图像中的物体和[边界](../Page/边界.md "wikilink")（[线](https://zh.wikipedia.org/wiki/线 "wikilink")，[曲线等](../Page/曲线.md "wikilink")）。更精确的，图像分割是对图像中的每个[像素加](../Page/像素.md "wikilink")[标签的一个过程](https://zh.wikipedia.org/wiki/标签 "wikilink")，这一过程使得具有相同标签的像素具有某种共同视觉特性。
...
图像分割在实际中的应用包括：
  ...
  - [Brake light
    detection](https://zh.wikipedia.org/wiki/Brake_light_detection "wikilink")
...
[K-均值算法是一种将](https://zh.wikipedia.org/wiki/K-均值算法 "wikilink")[图像分割成K个聚类的](../Page/聚类分析.md "wikilink")[迭代技术](../Page/迭代.md "wikilink")。基本[算法如下](../Page/算法.md "wikilink")：
...
## 请参阅
  ...
  - [Pulse-coupled
    networks](https://zh.wikipedia.org/wiki/Pulse-coupled_networks "wikilink")
  - [Range image
    segmentation](https://zh.wikipedia.org/wiki/Range_image_segmentation "wikilink")

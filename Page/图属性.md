...
invariant，**又称**图不变量）**是[图的一种性质](../Page/图_\(数学\).md "wikilink")，它只取决于其抽象结构，而不取决于图的表示形式如特定的[图标号或](../Page/图标号.md "wikilink")[图绘制形式](https://zh.wikipedia.org/wiki/图绘制 "wikilink")。\[1\]

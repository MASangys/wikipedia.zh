在[图论](../Page/图论.md "wikilink")的[数学](../Page/数学.md "wikilink")学科中，**图标号**（）是对图的[边](../Page/边.md "wikilink")和/或[顶点的编号](../Page/顶点_\(图论\).md "wikilink")（传统上用[整数](../Page/整数.md "wikilink")表示）进行赋值\[1\]。

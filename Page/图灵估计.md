Good-Turing平滑法可处理N元语法中数据矩阵的稀疏问题，主要思想将非零N元语法的概率均匀分给一些低概率语法，以修改[最大似然估计与真实](../Page/最大似然估计.md "wikilink")[概率之间的偏离](../Page/概率.md "wikilink")。是使用的比较多的一种[平滑算法](../Page/平滑算法.md "wikilink")。
...
Good-Turing平滑法由古德於1953年提出，而这种算法的思想则来自[图灵](../Page/图灵.md "wikilink")，算法证明参见：Church
et al.（1990）

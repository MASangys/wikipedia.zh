**圓判據**（circle criterion）是[非線性控制](../Page/非線性控制.md "wikilink")及中，針對非線性時變系統的[稳定性判据](https://zh.wikipedia.org/wiki/稳定性判据 "wikilink")。可以視為是針對[线性时不变系统](../Page/线性时不变系统理论.md "wikilink")（LTI）的[奈奎斯特稳定判据](../Page/奈奎斯特稳定判据.md "wikilink")之擴展版本。

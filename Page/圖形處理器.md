...
隨著[OpenGL](../Page/OpenGL.md "wikilink") API和DirectX類似功能的出現，圖形處理器新增可編程[着色的能力](https://zh.wikipedia.org/wiki/像素着色引擎 "wikilink")。現在，每個像素可以經由獨立的小程序處理，當中可以包含額外的圖像紋理輸入，而每個幾何頂點同樣可以在投影到屏幕上之前被獨立的小程序處理。[NVIDIA是首家能生產支援可編程著色晶片的公司](https://zh.wikipedia.org/wiki/NVIDIA "wikilink")，即[GeForce 3](https://zh.wikipedia.org/wiki/GeForce_3 "wikilink")（代號為NV20）。2002年10月，ATI發表了[Radeon 9700](https://zh.wikipedia.org/wiki/Radeon_9700 "wikilink")（代號為[R300](https://zh.wikipedia.org/wiki/Radeon_R300 "wikilink")）。它是世界上首個Direct3D 9.0加速器，而像素和頂點著色引擎可以執行循環和長時間的浮點運算，就如中央處理器般靈活，和達到更快的圖像陣列運算。像素著色通常被用於[凸凹紋理映射](https://zh.wikipedia.org/wiki/凸凹紋理映射 "wikilink")，使物件透過增加紋理令它們看起來更明亮、陰暗、粗糙、或是偏圓及被擠壓。\[4\]
...
不過從2009年開始，整合GPU已經從主機板移至處理器了，如Intel從[Westmere架構開始整合Intel](../Page/Westmere微架构.md "wikilink") HD Graphics GPU到CPU至今。不過Core極致版並沒有集成繪圖晶片。集成至處理器的好處是由於繪圖及處理器晶片工藝為相同（Westmere除外，CPU為32[nm而GPU為](https://zh.wikipedia.org/wiki/納米 "wikilink")45nm），可以減低熱功耗。隨著內顯技術的成熟，目前的內顯已經足夠應付基本3D的需求，不過仍然依賴主機板本身的記憶體。

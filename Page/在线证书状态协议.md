**在线证书状态协议**（，缩写：**OCSP**）是一个用于获取[X.509](../Page/X.509.md "wikilink")[数字证书撤销状态的](https://zh.wikipedia.org/wiki/数字证书 "wikilink")[网际协议](../Page/网际协议.md "wikilink")，\[1\]在中定义，作为[证书吊销列表](https://zh.wikipedia.org/wiki/证书吊销列表 "wikilink")（CRL）的替代品解决了在[公开密钥基础建设](../Page/公開金鑰認證.md "wikilink")（PKI）中使用证书吊销列表而带来的多个问题。\[2\]协议数据传输过程中使用[ASN.1编码](../Page/ASN.1.md "wikilink")，并通常建立在[HTTP协议上](../Page/超文本传输协议.md "wikilink")，此消息类型分为“请求消息”和“响应消息”，因此致OCSP[服务器被称为](../Page/服务器.md "wikilink")“OCSP响应端”。

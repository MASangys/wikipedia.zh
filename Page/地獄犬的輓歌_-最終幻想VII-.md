...
《地獄犬的輓歌 -最終幻想VII-》是第三人稱射擊遊戲，主角文森特在遊戲會使用許多種鎗，根據狀況來活用不同的武器。鎗類大致可分為3
種，首先是可以快速行動以攻擊中距離敵人的手鎗，其次是對付近距離敵人相當有效的機關鎗，再者是可以在神不知鬼不覺得狀態下攻擊遠方敵人的來福鎗。
...
**威斯**（Weiss）聲優：[中田譲治](../Page/中田譲治.md "wikilink")
  ...
  -
    ...
    被寶條奪取了身體, 後來被弟弟尼洛用黑暗使寶條的控制減弱, 當弟弟求威斯和他一起, 不要再分開的時候,
    滿足了他的願望。
...
**尼洛**（Nero）聲優：[置鮎龍太郎](../Page/置鮎龍太郎.md "wikilink")
  ...
  -
    ...
    Sable）」。根據(只在日本發行)的地獄犬輓歌網上遊戲, 和哥哥威斯般, 被 Restrictors
    長期用帶電的鎖鏈鎖在柱上,
    玩家能看到他痛苦中叫了聲哥哥。他也是在Deepground裡進行的G計劃的實驗品(因此有傑尼西斯的細胞),
    但哥哥的實驗是用純粹的魔晄(為了使他能成為奧米加的容器), 尼洛則是用停滯的 Lifestream (負能量),
    因此尼洛成了黑暗的容器, 一出生時他的黑暗就把他的母親吞噬掉。

**阿祖爾**（Azul）聲優：[玄田哲章](../Page/玄田哲章.md "wikilink")

  -
    Tsviet (Deepground裡最強的幾位戰士, 有傑尼西斯的細胞) 成員之一。稱號「蒼藍的阿祖爾（Azul the
    Cerulean）」。

**羅瑟**（Rosso）聲優：[田中敦子](../Page/田中敦子.md "wikilink")

  -
    Tsviet (Deepground裡最強的幾位戰士, 有傑尼西斯的細胞) 成員之一。稱號「朱紅的羅瑟（Rosso the
    Crimson）」。

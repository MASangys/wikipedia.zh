...
在[量子力學裏](../Page/量子力學.md "wikilink")，**埃倫費斯特定理**（）表明，[量子算符的](../Page/算符.md "wikilink")[期望值對於](../Page/期望值_\(量子力学\).md "wikilink")[時間的導數](../Page/時間.md "wikilink")，跟這量子算符與[哈密頓算符的](../Page/哈密頓算符.md "wikilink")[對易算符](../Page/對易算符.md "wikilink")，兩者之間的關係，以方程式表達為\[1\]
...
是[哈密頓算符](../Page/哈密頓算符.md "wikilink")，\(t\)
是時間，\(\hbar\) 是[約化普朗克常數](../Page/約化普朗克常數.md "wikilink")。

埃倫費斯特定理是因物理學家[保羅·埃倫費斯特命名](../Page/保羅·埃倫費斯特.md "wikilink")。在量子力學的[海森堡繪景裏](../Page/海森堡繪景.md "wikilink")，埃倫費斯特定理非常顯而易見；取[海森堡方程式的期望值](../Page/海森堡繪景#數學細節.md "wikilink")，就可以得到埃倫費斯特定理。埃倫費斯特定理與[哈密頓力學的](../Page/哈密頓力學.md "wikilink")[劉維定理密切相關](../Page/刘维尔定理_\(哈密顿力学\).md "wikilink")；劉維定理使用的[泊松括號](../Page/泊松括號.md "wikilink")，對應於埃倫費斯特定理的[對易算符](../Page/對易算符.md "wikilink")。實際上，從根據經驗法則，將對易算符換為泊松括號乘以
...
[薛丁格方程表明哈密頓算符](../Page/薛丁格方程.md "wikilink") \(H\) 與時間 \(t\) 的關係為
...
因為哈密頓算符是[厄米算符](../Page/厄米算符.md "wikilink")，\(H^*=H\) 。所以，
...
使用埃倫費斯特定理，可以簡易地證明，假若一個物理系統的哈密頓量[顯性地不含時間](../Page/顯性_\(物理\).md "wikilink")，則這系統是[保守系統](../Page/保守系統.md "wikilink")。
...
試想一個[質量為](../Page/質量.md "wikilink") \(m\)
的粒子，移動於一維空間．其[哈密頓量是](../Page/哈密頓量.md "wikilink")

\[H(x,\ p,\ t) = \frac{p^2}{2m} + V(x,\ t)\] ;

其中，\(x\) 為位置，\(p\) 是[動量](../Page/動量.md "wikilink")，\(V\)
...
取「經典極限」，[量子力學的](../Page/量子力學.md "wikilink")[定律約化為](../Page/定律.md "wikilink")[經典力學的定律](../Page/經典力學.md "wikilink")。這結果也時常被稱為**埃倫費斯特定理**。這經典極限是什麼呢？標記
\(V\,'(x)\) 為 \(\frac{\partial V(x)}{\partial x}\) 。設定
\(\langle x\rangle=x_0\) 。[泰勒展開](../Page/泰勒級數.md "wikilink") \(V\,'(x)\)
於 \(x_0\) ：

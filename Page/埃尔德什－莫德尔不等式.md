[Erdos-Mordell.PNG](https://zh.wikipedia.org/wiki/File:Erdos-Mordell.PNG "fig:Erdos-Mordell.PNG") 在[几何学](../Page/几何学.md "wikilink")中，**埃尔德什-莫德尔不等式**是一个二十世纪初期发现的不等式。埃尔德什-莫德尔不等式说明了：对于任何[三角形](../Page/三角形.md "wikilink")ABC和其内部的一点O，点O到三角形三条边的[距离](../Page/距离.md "wikilink")之和总是小于或等于点O到三角形的三个顶点的距离之和的一半。

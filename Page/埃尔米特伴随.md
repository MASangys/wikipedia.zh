[数学上](../Page/数学.md "wikilink")，特别是[泛函分析中](../Page/泛函分析.md "wikilink")，[希尔伯特空间中的每个](../Page/希尔伯特空间.md "wikilink")[线性算子有一个相应的](https://zh.wikipedia.org/wiki/线性算子 "wikilink")**伴随算子**（）。[算子的伴随将](../Page/算子.md "wikilink")[方块矩阵](../Page/方块矩阵.md "wikilink")[共轭转置推广到](../Page/共轭转置.md "wikilink")（可能）无穷维情形。如果我们将希尔伯特空间上的算子视为“广义复数”，则一个算子的伴随起着一个复数的[共轭的作用](https://zh.wikipedia.org/wiki/复数共轭 "wikilink")。

一个算子*A*的伴随常常也称为**埃尔米特伴随**（，以[夏尔·埃尔米特命名](https://zh.wikipedia.org/wiki/夏尔·埃尔米特 "wikilink")），记作*A*<sup>\*</sup>或*A*<sup>†</sup>（后者尤其用于[狄拉克符号记法](../Page/狄拉克符号.md "wikilink")）。
...
在某种意义下，这种算子起着[实数](../Page/实数.md "wikilink")（等于他们的复共轭）的作用。他们在[量子力学中作为实值](../Page/量子力学.md "wikilink")[可观测量的模型](https://zh.wikipedia.org/wiki/可观测量 "wikilink")。更多细节参见[自伴算子一文](../Page/自伴算子.md "wikilink")。

## 无界算子的伴随

许多重要的算子不是连续的或只定义在希尔伯特的一个[子空间上](https://zh.wikipedia.org/wiki/子空间 "wikilink")。在这种情形，我们仍然能定义伴随，在[自伴算子一文有解释](../Page/自伴算子.md "wikilink")。

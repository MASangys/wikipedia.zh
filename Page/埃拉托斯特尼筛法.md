...
zh-hk:愛氏篩}-**，也称**素数筛**。这是一種簡單且历史悠久的[筛法](https://zh.wikipedia.org/wiki/筛法 "wikilink")，用來找出一定範圍內所有的[質數](https://zh.wikipedia.org/wiki/質數 "wikilink")。
...
1.  [Nicomachus](https://zh.wikipedia.org/wiki/尼科馬庫斯 "wikilink"),
    *Introduction to Arithmetic*, I, 13.

本**網域名稱系統記錄類型列表**提供[網域名稱系統](../Page/DNS.md "wikilink")（DNS）記錄類型（數據庫記錄）的概覽，而這些記錄都是存儲在網域名稱系統（DNS）的區域文件（zone
files）。

網域名稱系統實現將[域名和](../Page/域名.md "wikilink")[IP
位址相互對映的一個](../Page/IP_位址.md "wikilink")[分散式數據庫](../Page/分散式數據庫.md "wikilink")，能夠使人更方便的存取[互聯網](../Page/互聯網.md "wikilink")。在這些[域名伺服器](../Page/域名伺服器.md "wikilink")，不同的記錄類型有著不同的用途。
...
<td><p>傳回一個32位元的IPv4地址，最常用於映射<a href="../Page/主機名稱.md" title="wikilink">主機名稱到</a><a href="../Page/IP地址.md" title="wikilink">IP地址</a>，但也用於（RFC 1101）等。</p></td>
</tr>
<tr class="even">
<td><div id="AAAA">
</div>
...
<td><p>18</p></td>
<td><p>RFC 1183</p></td>
<td><p><a href="../Page/AFS檔案系統.md" title="wikilink">AFS檔案系統</a></p></td>
<td><p>（Andrew File System）資料庫核心的位置，於域名以外的 AFS 客戶端常用來聯繫 AFS 核心。這個記錄的子類型是被過時的的 <a href="../Page/DCE/DFS.md" title="wikilink">DCE/DFS</a>（DCE Distributed File System）所使用。</p></td>
</tr>
<tr class="even">
<td><div id="APL">
</div>
...
<td><p>RFC 6844</p></td>
<td><p>权威认证授权</p></td>
<td><p>DNS认证机构授权，限制主机/域的可接受的CA</p></td>
</tr>
<tr class="even">
<td><p>CDNSKEY</p></td>
<td><p>60</p></td>
...
<td><p>RFC 4398</p></td>
<td><p>憑證記錄</p></td>
<td><p>儲存 <a href="../Page/PKIX.md" title="wikilink">PKIX</a>、、<a href="../Page/Pretty_Good_Privacy.md" title="wikilink">PGP等</a>。</p></td>
</tr>
<tr class="odd">
<td><div id="CNAME">
</div></td>
...
<td><p>RFC 1035</p></td>
<td><p>規範名稱記錄</p></td>
<td><p>一個主機名字的別名：<a href="../Page/DNS.md" title="wikilink">網域名稱系統將會繼續嘗試查找新的名字</a>。</p></td>
</tr>
<tr class="even">
<td><div id="DHCID">
</div>
...
<td><p>49</p></td>
<td><p>RFC 4701</p></td>
<td><p><a href="../Page/DHCP.md" title="wikilink">DHCP</a>（動態主機設定協定）識別碼</p></td>
<td><p>用於將 FQDN 選項結合至 <a href="../Page/DHCP.md" title="wikilink">DHCP</a>。</p></td>
</tr>
<tr class="odd">
<td><div id="DLV">
</div>
...
<td><p>32769</p></td>
<td><p>RFC 4431</p></td>
<td><p><a href="../Page/DNSSEC.md" title="wikilink">DNSSEC</a>（域名系統安全擴展）來源驗證記錄</p></td>
...
<td><p>RFC 4025</p></td>
<td><p>IPSEC 密鑰</p></td>
<td><p>與 <a href="../Page/IPSEC.md" title="wikilink">IPSEC</a> 同時使用的密鑰記錄。</p></td>
</tr>
<tr class="odd">
<td><div id="KEY">
</div>
...
<tr class="even">
<td><p><a href="../Page/LOC記錄.md" title="wikilink">LOC記錄</a>（LOC record）</p></td>
<td><p>29</p></td>
<td><p>RFC 1876</p></td>
<td><p>位置記錄</p></td>
...
<tr class="odd">
<td><p><a href="../Page/MX記錄.md" title="wikilink">MX記錄</a>（MX record）</p></td>
<td><p>15</p></td>
<td><p>RFC 1035</p></td>
<td><p>電郵交互記錄</p></td>
<td><p>引導域名到該域名的<a href="../Page/郵件傳輸代理.md" title="wikilink">郵件傳輸代理</a>（MTA, Message Transfer Agents）列表。</p></td>
</tr>
<tr class="even">
<td><p><a href="../Page/NAPTR記錄.md" title="wikilink">NAPTR記錄</a>（NAPTR record）</p></td>
<td><p>35</p></td>
<td><p>RFC 3403</p></td>
<td><p>命名管理指標</p></td>
<td><p>允許基於正則表達式的域名重寫使其能夠作為 <a href="../Page/URI.md" title="wikilink">URI</a>、進一步域名查找等。</p></td>
</tr>
<tr class="odd">
<td><div id="NS">
</div>
...
<td><p>RFC 1035</p></td>
<td><p>名稱伺服器記錄</p></td>
<td><p>委託<a href="../Page/DNS區域.md" title="wikilink">DNS區域</a>（DNS zone）使用已提供的權威域名伺服器。</p></td>
</tr>
<tr class="even">
<td><div id="NSEC">
</div>
...
<td><p>RFC 1035</p></td>
<td><p>指標記錄</p></td>
<td><p>引導至一個<a href="../Page/規範名稱.md" title="wikilink">規範名稱</a>（Canonical Name）。與 CNAME 記錄不同，DNS「不會」進行處理程序，只會傳回名稱。最常用來執行，其他用途包括引作 。</p></td>
</tr>
<tr class="odd">
<td><div id="RRSIG">
</div>
...
<tr class="odd">
<td><p><a href="../Page/Sender_Policy_Framework.md" title="wikilink">SPF</a></p></td>
<td><p>99</p></td>
<td><p>RFC 4408</p></td>
<td><p>SPF 記錄</p></td>
...
<tr class="even">
<td><p><a href="../Page/SRV記錄.md" title="wikilink">SRV記錄</a>（SRV record）</p></td>
<td><p>33</p></td>
<td><p>RFC 2782</p></td>
<td><p>服務定位器</p></td>
...
<td><p>DNS 系統用來發佈 <a href="../Page/SSH.md" title="wikilink">SSH</a> 公共密鑰指紋的資源記錄，以用作輔助驗證伺服器的真實性。</p></td>
</tr>
<tr class="even">
<td><div id="TA">
</div>
...
<p><a href="../Page/TKEY記錄.md" title="wikilink">TKEY記錄</a>（TKEY record）</p></td>
<td><p>249</p></td>
<td><p>RFC 2930</p></td>
<td><p>秘密密鑰記錄</p></td>
<td><p>為<a href="../Page/TSIG.md" title="wikilink">TSIG提供密鑰材料的其中一類方法</a>，that is 在公共密鑰下加密的 accompanying KEY RR。[10]</p></td>
</tr>
<tr class="even">
<td><div id="TSIG">
</div>
...
<td><p>RFC 1035</p></td>
<td><p>文本記錄</p></td>
<td><p>最初是為任意可讀的文本 DNS 記錄。自1990年起，些記錄更經常地帶有機讀數據，以 RFC 1464 指定：<a href="../Page/机会性加密.md" title="wikilink">机会性加密</a>（opportunistic encryption）、<a href="../Page/Sender_Policy_Framework.md" title="wikilink">Sender Policy Framework</a>（雖然這個臨時使用的 TXT 記錄在 SPF 記錄推出後不被推薦）、DomainKeys、DNS-SD等。</p></td>
</tr>
<tr class="even">
<td><p>URI</p></td>
<td><p>256</p></td>
...
的記錄可見，一些記錄類型由於一些原因而被限制其使用、一些被標示為明顯過時的、有些是為了隱藏的服務、有些是為了舊版本的服務、有的有特別記錄指出它們是「不正確的」。
  ...
  - 為了發佈郵件列表訂戶的 DNS 記錄：MB(7)、MG(8)、MR(9)、MINFO(14)、MAILB (253)。 在 RFC
    883 標明的意圖是為了讓 MB 代替 [SMTP](../Page/SMTP.md "wikilink") VRFY 指令、MG 代替

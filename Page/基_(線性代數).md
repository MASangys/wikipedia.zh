[Basis_graph.svg](https://zh.wikipedia.org/wiki/File:Basis_graph.svg "fig:Basis_graph.svg")  在[线性代数](../Page/线性代数.md "wikilink")中，**基**(basis)（也称为**基底**）是描述、刻画[向量空间](../Page/向量空间.md "wikilink")的基本工具。向量空间的基是它的一个特殊的[子集](../Page/子集.md "wikilink")，基的元素称为**基向量**。向量空间中任意一个元素，都可以唯一地表示成基向量的[线性组合](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。如果基中元素个数[有限](https://zh.wikipedia.org/wiki/有限 "wikilink")，就称向量空间为有限维向量空间，将元素的个数称作向量空间的**维数**。

**基于内核的虚拟机**（，縮寫為）是一种用於[Linux內核中的虛擬化基礎设施](https://zh.wikipedia.org/wiki/Linux內核 "wikilink")，可將Linux內核轉化為一個[虚拟机监视器](../Page/Hypervisor.md "wikilink")。KVM于2007年2月5日被導入Linux 2.6.20核心中，以[可載入核心模組的方式被移植到](https://zh.wikipedia.org/wiki/可載入核心模組 "wikilink")[FreeBSD](../Page/FreeBSD.md "wikilink")及[illumos上](https://zh.wikipedia.org/wiki/illumos "wikilink")。\[1\]KVM需要支持特性的处理器。\[2\]KVM也被移植至[FreeBSD](../Page/FreeBSD.md "wikilink")\[3\]与[illumos](../Page/Illumos.md "wikilink")\[4\]上以载入内核模块。
...
诸多客户操作系统支持KVM，包括Linux的诸多发行版、BSD、[Solaris](../Page/Solaris.md "wikilink")、[Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")、[Haiku](../Page/Haiku.md "wikilink")、[ReactOS](https://zh.wikipedia.org/wiki/ReactOS "wikilink")、[Plan 9](../Page/貝爾實驗室九號計畫.md "wikilink")、\[8\]和[OS X](../Page/MacOS.md "wikilink")。\[9\]除此之外，还支持Android 2.2、GNU/Hurd\[10\]（Debian K16）、[Minix](https://zh.wikipedia.org/wiki/MINIX_3 "wikilink") 3.1.2a、Solaris 10 U3和Darwin 8.0.1，而其他操作系统或新版操作系统都支持KVM，仅仅存在一些限制而已。\[11\]

support for certain devices is available for 使用Linux、OpenBSD、\[12\]FreeBSD、\[13\] NetBSD,\[14\]Plan 9、\[15\]和带有**VirtIO** API\[16\]的Windows客户机上支持对部分设备的。这项特性支持半虚拟化网卡、半虚拟化磁盘I/O控制器、\[17\]用于调整客户端内存使用的气球设备（Balloon device）和使用或[VMWare驱动程序的VGA图形接口](https://zh.wikipedia.org/wiki/VMWare "wikilink")。
...
KVM内部使用作为对16位x86 [BIOS](../Page/BIOS.md "wikilink")的开源模拟。\[19\]
...
阿维·齐维迪（Avi Kivity）在一家名为的[初创企业](../Page/初创企业.md "wikilink")开始了KVM的研发工作\[21\]，随后此公司于2008年被[紅帽公司](../Page/紅帽公司.md "wikilink")收购。\[22\]
...
| 分类                                                              | 设备                                                                                                                                                        |
| --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [显示卡](../Page/显示卡.md "wikilink")                                | Cirrus CLGD 5446 PCI VGA卡、具有[Bochs](../Page/Bochs.md "wikilink")与[VESA拓展的虚拟VGA卡](https://zh.wikipedia.org/wiki/VESA "wikilink")\[25\]或使用作为虚拟3D CPU。\[26\] |
...
25. [wiki.qemu.org – QEMU Emulator User Documentation](http://wiki.qemu.org/download/qemu-doc.html), read 2010-05-06

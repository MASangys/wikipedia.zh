...
在实际中，大部分有趣的情形是具有负[曲率](../Page/曲率.md "wikilink")的曲面，由群\(PSL(2,\mathbb{R})\)中一个离散格作用在[上半平面](../Page/上半平面.md "wikilink")实现。这样的格称为[富克斯群](https://zh.wikipedia.org/wiki/富克斯群 "wikilink")（[Fuchsian
...
或者，不可定向曲面能由两种形式给出，亏格*n* [克莱因瓶](../Page/克莱因瓶.md "wikilink")与亏格*n*
...
一个（双曲）[紧](../Page/紧空间.md "wikilink")[黎曼曲面](../Page/黎曼曲面.md "wikilink")的基本多边形有许多重要的性质，将曲面与它的[富克斯模型](https://zh.wikipedia.org/wiki/富克斯模型 "wikilink")（[Fuchsian
model](https://zh.wikipedia.org/wiki/:en:Fuchsian_model "wikilink")）联系起来。即一个双曲紧黎曼曲面可以[上半平面](../Page/上半平面.md "wikilink")做为[万有覆叠](https://zh.wikipedia.org/wiki/万有覆叠 "wikilink")，从而可以表示为一个[商](../Page/商空间.md "wikilink")[流形](../Page/流形.md "wikilink")**H**/Γ，这里
Γ是一个[非阿贝尔群同构于曲面的](https://zh.wikipedia.org/wiki/非阿贝尔群 "wikilink")[甲板变换群](https://zh.wikipedia.org/wiki/万有覆叠 "wikilink")（）。商空间的[陪集](../Page/陪集.md "wikilink")有标准多边形做为代表元素。在下面，注意所有黎曼曲面都是可定向的。

### 度量基本多边形

给定[上半平面](../Page/上半平面.md "wikilink")**H**中一点\(z_0\)，以及PSL(2,**R**)一个离散[子群](../Page/子群.md "wikilink")Γ
...
度量基本多边形与标准多边形通常有不同的边数。比如，[环面](../Page/环面.md "wikilink")的标准基本多边形是一个[基本平行四边形](https://zh.wikipedia.org/wiki/基本平行四边形 "wikilink")（[fundamental
...
标准基本多边形的面积是\(4\pi(n-1)\)，这里*n*是黎曼曲面的亏格（等价于4*n*是多边形的边数）。由于标准多边形是**H**/Γ的一个代表，黎曼曲面的整个面积等于标准多边形的面积。这个面积公式由[高斯-博内定理](../Page/高斯-博内定理.md "wikilink")得出，在某种意义下[黎曼-赫尔维茨公式](https://zh.wikipedia.org/wiki/黎曼-赫尔维茨公式 "wikilink")（[Riemann-Hurwitz

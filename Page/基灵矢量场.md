**基灵矢量场**，**基灵矢量**或**基灵矢量场**（），以[德国数学家](../Page/德国.md "wikilink")[威尔海姆·基灵命名](https://zh.wikipedia.org/wiki/威尔海姆·基灵 "wikilink")，是定义在[黎曼流形或](../Page/黎曼流形.md "wikilink")[伪黎曼流形上的一组](../Page/伪黎曼流形.md "wikilink")[矢量场](https://zh.wikipedia.org/wiki/矢量场 "wikilink")，[流形的](../Page/流形.md "wikilink")[度规在这组矢量的方向上能够保持不变](https://zh.wikipedia.org/wiki/度规 "wikilink")。基灵矢量是[等距同构的无穷小生成元](../Page/等距同构.md "wikilink")，即由基灵矢量场生成的[流包含有一种](../Page/流_\(数学\).md "wikilink")[对称性](../Page/对称性_\(物理学\).md "wikilink")，也就是说流形在基灵矢量场的方向上进行平移不会改变其上点与点之间的距离。一个简单的例子是一个圆周上具有相同长度并且指向顺时针方向的矢量场即是一个基灵矢量场，因为将圆周上的点沿这些方向平移等同于顺时针转动这个圆周而不改变彼此间的距离。
...
对某个纯量\(\lambda\,\)，一个单参数[共形映射族的导数是共形基灵场](../Page/共形映射.md "wikilink")。另一种推广是共形基灵张量场，是一个对称[张量场](https://zh.wikipedia.org/wiki/张量 "wikilink")*T*，使得\(\nabla T \,\)的对称化中与迹无关的部分为零。

## 广义时空几何中的对称性和守恒律

对称性|诺特定理}}
在广义相对论中，基灵矢量与时空的对称性紧密联系。简单说来，当一个时空流形在特定变换下具有几何不变性时，我们称这种时空流形具有[对称性](../Page/对称性_\(物理学\).md "wikilink")；也就是说度规在这种变换下是保持形式不变的。一个[张量场可能会具有多种不同的对称性](../Page/张量场.md "wikilink")，例如[闵可夫斯基时空的平直度规在平移变换](https://zh.wikipedia.org/wiki/闵可夫斯基时空 "wikilink")（包含四种基本对称操作）及[洛伦兹变换](../Page/洛伦兹变换.md "wikilink")（包含六种基本对称操作）下保持不变，即对于[闵可夫斯基度规](https://zh.wikipedia.org/wiki/闵可夫斯基度规 "wikilink")
...
对[类时的](https://zh.wikipedia.org/wiki/类时 "wikilink")[测地线而言](../Page/测地线.md "wikilink")，[测地线方程可以写成](https://zh.wikipedia.org/wiki/测地线方程 "wikilink")[动量的形式](../Page/动量.md "wikilink")，即对于粒子的四维动量\(p^{\mu} = mU^{\mu}\,\)，测地线方程为

...
**基爾霍夫積分定理**（）表明，假設點P在閉合曲面\(\mathbb{S}\)之外，只考慮[單色波](https://zh.wikipedia.org/wiki/單色光 "wikilink")，則位於點P的波擾\(\psi(\mathbf{r})\)，可以以位於閉合曲面\(\mathbb{S}\)的所有波擾與其[梯度表達為](../Page/梯度.md "wikilink")\[1\]\[2\]
...
基爾霍夫積分定理是因德國物理學者[古斯塔夫·基爾霍夫而命名](../Page/古斯塔夫·基爾霍夫.md "wikilink")。這定理廣泛地應用於[光學領域](https://zh.wikipedia.org/wiki/光學 "wikilink")。對於很多案例，這定理的方程式可以近似成一種更簡單的形式，稱為[基爾霍夫衍射公式](../Page/基爾霍夫衍射公式.md "wikilink")。[惠更斯－菲涅耳原理的](../Page/惠更斯－菲涅耳原理.md "wikilink")[傾斜因子專門依方向的不同而調整由點波源所產生的次波朝著不同方向傳播的波幅](https://zh.wikipedia.org/wiki/惠更斯－菲涅耳原理#數學表述 "wikilink")。從基爾霍夫衍射公式，可以推導出傾斜因子的確切形式。
...
設定\(k=\omega/c\)，注意到[推遲時間](https://zh.wikipedia.org/wiki/推遲時間 "wikilink")\(t_r=t-R/c\)出現在[相位因子裏](../Page/相位因子.md "wikilink")，必須將光波傳播的時間納入計算。更換積分次序，公式變為

...
其中，\(i_k\) 是第 \(k\) 個進入或離開這節點的[電流](https://zh.wikipedia.org/wiki/電流 "wikilink")，\(I_k\) 是其[振幅](https://zh.wikipedia.org/wiki/振幅 "wikilink")，\(\theta_k\) 是其[相位](https://zh.wikipedia.org/wiki/相位 "wikilink")，\(\omega\) 是角頻率，\(t\) 是時間。

...
基站子系统（Base Station Subsystem，简称：BSS）是传统的[蜂窝电话网络的一个组成部分](../Page/蜂窝网络.md "wikilink")，负责处理一个[移动电话](../Page/移动电话.md "wikilink")和[网络交换子系统](../Page/网络交换子系统.md "wikilink")之间的通信流量和信令。BSS负责通过[空中接口](https://zh.wikipedia.org/wiki/空中介面 "wikilink")（Air_interface）进行通话[信道](../Page/信道.md "wikilink")（channel）的转码、向移动电话分配无线电[信道](../Page/信道.md "wikilink")、[寻呼](https://zh.wikipedia.org/wiki/寻呼机 "wikilink")（paging）、[传输](https://zh.wikipedia.org/wiki/传输 "wikilink")（transmission）以及其它和无线电网络相关的任务。

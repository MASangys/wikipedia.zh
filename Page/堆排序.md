...
若以升序排序說明，把[陣列轉換成](https://zh.wikipedia.org/wiki/陣列 "wikilink")[最大堆積](https://zh.wikipedia.org/wiki/最大—最小堆 "wikilink")(Max-Heap
Heap)，這是一種滿足最大堆積性質(Max-Heap
Property)的[二元樹](https://zh.wikipedia.org/wiki/二元樹 "wikilink")：對於除了根之外的每個节点i,
A\[parent(i)\] ≥ A\[i\]。
...
堆排序的平均[时间复杂度为](../Page/时间复杂度.md "wikilink")\(\Omicron(n \log n)\)，[空间复杂度为](https://zh.wikipedia.org/wiki/空间复杂度 "wikilink")\(\Theta(1)\)。
...
sort](https://zh.wikipedia.org/wiki/no:Sorteringsalgoritme#Heap_sort "wikilink")

**复制省略**或者译作“省略不必要的复制”（copy elision），是[C++](../Page/C++.md "wikilink")语言标准中定义的编译优化技术。

当一个[class类型的](../Page/类_\(计算机科学\).md "wikilink")的临时对象用于初始化同类型的对象\[1\][ISO](https://zh.wikipedia.org/wiki/ISO "wikilink")/[IEC](https://zh.wikipedia.org/wiki/IEC "wikilink") (2003). *[ISO/IEC 14882:2003(E): Programming Languages - C++](https://zh.wikipedia.org/wiki/ISO/IEC_14882 "wikilink") §12.8 Copying class objects \[class.copy\]* para. 15</ref>时，复制初始化通常优化为直接初始化；但在语义上仍然需要[复制构造函数是可访问的](https://zh.wikipedia.org/wiki/复制构造函数 "wikilink")。\[2\] 例如：
...
1.
2.  {{ cite book | first1 = Herb | last1 = Sutter | authorlink1 = Herb Sutter | year = 2001 | title = More Exceptional C++ | publisher = Addison-Wesley }}
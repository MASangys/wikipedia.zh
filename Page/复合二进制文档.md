**复合二进制文档**（CFBF），簡称**复合文档**，\[1\]英文全名 **Composite Document File V2
Document**\[2\]，是微软开发、用於实现[COM结构化存储的文件格式](../Page/COM结构化存储.md "wikilink")，用于把多个对象内容存放在同一个硬盘文件。\[3\]\[4\]\[5\]

Microsoft已经开放了这个文件格式。广泛用于[Microsoft
Word与](../Page/Microsoft_Word.md "wikilink")[Microsoft
Access](../Page/Microsoft_Access.md "wikilink")。也是的基础。\[6\]
...
4.
5.
6.  [AMW Association (formerly AAF
    Association)](http://www.aafassociation.org)
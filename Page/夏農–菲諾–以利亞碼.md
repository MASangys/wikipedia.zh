在[消息理論中](../Page/消息理論.md "wikilink")，**夏農–菲諾–以利亞碼**是[算術編碼的先導](../Page/算術編碼.md "wikilink")，其機率被用於決定碼字。
  ...
  -
    ...
    \[\bar F(A) = \frac 12 p(A) = \frac 12 \cdot \frac 13 = 0.1666...\]
      -
        ...
        L(A) = \(\left\lceil \log_2 \frac 1 \frac 1 3 \right\rceil + 1\)
        = **3**
        code(A) 為 001
  ...
  -
    ...
    \[\bar F(B) = p(A) + \frac 12 p(B) = \frac 13 + \frac 12 \cdot \frac 14 = 0.4583333...\]
      -
        ...
        L(B) = \(\left\lceil \log_2 \frac 1 \frac 1 4 \right\rceil + 1\)
        = **3**
        code(B) 為 011
  ...
  -
    ...
    \[\bar F(C) = p(A) + p(B) + \frac 12 p(C) = \frac 13 + \frac 14 + \frac 12 \cdot \frac 16 = 0.66666...\]
      -
        ...
        L(C) = \(\left\lceil \log_2 \frac 1 \frac 1 6 \right\rceil + 1\)
        = **4**
        code(C) 為 1010
...
<!-- end list -->
  ...
  -
    ...
    \[\bar F(D) = p(A) + p(B) + p(C) + \frac 12 p(D) = \frac 13 + \frac 14 + \frac 16 + \frac 12 \cdot \frac 14 = 0.875\]
      -
        在二進位中， Z(D) = 0.**111**
        L(D) = \(\left\lceil \log_2 \frac 1 \frac 1 4 \right\rceil + 1\)
        = **3**
        code(D) 為 111
...
令 bcode(x) 為二進位表示法最左側加入小數點而成之小數。舉例而言， code(C)=1010 ，則 bcode(C) = 0.1010
。 對所有 x ，如果沒有任何 y 存在使得
...
此碼之平均長度為
\(LC(X) = \sum_{x \epsilon X}p(x)L(x) = \sum_{x \epsilon X}p(x)(\left\lceil \log_2 \frac {1}{p(x)} \right\rceil + 1)\)
。
...
T. M. Cover and Joy A. Thomas (2006). Elements of information theory
(2nd ed.). John Wiley and Sons. pp. 127–128.

...
滿足以下條件：
  ...
  - [空集](../Page/空集.md "wikilink")有[零外測度](https://zh.wikipedia.org/wiki/零测度集 "wikilink")：
...
这样我们可以定义[可测性](https://zh.wikipedia.org/wiki/可测集 "wikilink")：称\(X\) 的子集\(E\)是 \(\varphi\)-可测的，当且仅当对\(X\)的任意子集\(A\)，

\[\varphi(A) = \varphi(A \cap E) + \varphi(A \cap  E^c).\]

全体 \(\varphi\)-可测的子集构成了一个[\(\sigma\)-代数](../Page/Σ-代数.md "wikilink") ，\(\varphi\)限制在全体可测集上是可数可加的[完备测度](https://zh.wikipedia.org/wiki/完备测度 "wikilink")。这个方法是Carathéodory构造出来的，是构造[勒贝格测度](../Page/勒贝格测度.md "wikilink")和[积分](../Page/积分.md "wikilink")理论的重要方法。

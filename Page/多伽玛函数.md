\(\boldsymbol{m}\)阶多伽玛函数'''是[伽玛函数的第](../Page/伽玛函数.md "wikilink")\((\boldsymbol{m+1})\)个[对数导数](../Page/对数导数.md "wikilink")。
...
是[双伽玛函数](../Page/双伽玛函数.md "wikilink")，\(\Gamma(\zeta)\!\)是伽玛函数。函数\(\psi^{(1)}(\zeta)\!\)有时称为[三伽玛函数](../Page/三伽玛函数.md "wikilink")。
...
当Re *z* \>0和*m* \> 0时成立。对于*m* =
0，参见[双伽玛函数的定义](../Page/双伽玛函数.md "wikilink")。

## 递推关系

多伽玛函数具有以下的[递推关系](../Page/递推关系.md "wikilink")：

\[\psi^{(m)}(z+1)= \psi^{(m)}(z) + (-1)^m\; m!\; z^{-(m+1)}.\]

## 乘法定理

[乘法定理给出](../Page/乘法定理.md "wikilink")：
...
对*m* \>
0和任何不等于负数的复数*z*都成立。还可以用[赫尔维茨ζ函数来表示](../Page/赫尔维茨ζ函数.md "wikilink")：
...
当|*z*| \<
1时收敛。在这里，ζ是[黎曼ζ函数](../Page/黎曼ζ函数.md "wikilink")。这个级数可以很容易从赫尔维茨ζ函数的泰勒级数推出。这个级数也可以用来推导出一些[有理ζ级数](../Page/有理ζ级数.md "wikilink")。
...
## 参考文献
  ...
  - Milton Abramowitz and Irene A. Stegun, *[Handbook of Mathematical
    ...
    (1964) Dover Publications, New York. ISBN 978-0-486-61272-0 .
    参见第[§6.4](http://www.math.sfu.ca/~cbm/aands/page_260.htm)节。

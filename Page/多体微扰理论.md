...
在多体微扰理论下，基态零级能量就是构成基态[斯莱特行列式的各分子轨道轨道能的代数和](../Page/斯莱特行列式.md "wikilink")，零级波函数就是基态[斯莱特行列式波函数](../Page/斯莱特行列式.md "wikilink")。可以看出，多体微扰理论的零级能量精度甚至不如[Hartree-Fock方程所得的能量](https://zh.wikipedia.org/wiki/Hartree-Fock方程 "wikilink")。

...
1985 年，和在论文中引入了术语「蕴含多态」（）来为子类型和[继承 (计算机科学)建模](https://zh.wikipedia.org/wiki/继承_\(计算机科学\) "wikilink")。\[4\]。不过子类型和继承本身在 1967 年就已经在 [Simula](../Page/Simula.md "wikilink") 有对应的实现。

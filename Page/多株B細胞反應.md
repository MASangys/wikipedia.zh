...
抗原通常是一種巨大而構造複雜的物質，而單一抗體只能和抗原的特定微小部位結合。因此，免疫系統通常由多種不同的B細胞製造出大量不同的抗體，對同一個抗原執行免疫反應。細胞株（）是指一群由單一母細胞所產生的細胞，故名為「多株」（）\[3\]\[4\]\[5\]。在多株反應中製造的抗體稱為[多株抗體](https://zh.wikipedia.org/wiki/多株抗體 "wikilink")。異質的多株抗體和[單株抗體不同](https://zh.wikipedia.org/wiki/單株抗體 "wikilink")；後者彼此間構造完全相同，只針對同一個抗原決定位產生反應，較具有專一性。

在[物理學裏](https://zh.wikipedia.org/wiki/物理學 "wikilink")，**多極展開**方法廣泛應用於涉及於[質量分佈產生的](https://zh.wikipedia.org/wiki/質量 "wikilink")[重力場](https://zh.wikipedia.org/wiki/重力場 "wikilink")、[電荷](../Page/電荷.md "wikilink")分佈產生的[電勢](../Page/電勢.md "wikilink")或[電場](../Page/電場.md "wikilink")、[電流分佈產生的](https://zh.wikipedia.org/wiki/電流 "wikilink")[磁向量勢和](https://zh.wikipedia.org/wiki/磁向量勢 "wikilink")[磁場](../Page/磁場.md "wikilink")、[電磁波的傳播等等問題](https://zh.wikipedia.org/wiki/電磁波 "wikilink")。使用多極展開，重力場或電勢等等，都可以表達為單極項、偶極項、四極項、八極項等等的疊加。一個典型範例是，從[原子核](../Page/原子核.md "wikilink")的[外部多極矩與](https://zh.wikipedia.org/wiki/球多極矩#點電荷案例 "wikilink")[電子](https://zh.wikipedia.org/wiki/電子 "wikilink")[軌域的](https://zh.wikipedia.org/wiki/軌域 "wikilink")[內部多極矩之間的交互作用能量](https://zh.wikipedia.org/wiki/球多極矩#點電荷案例 "wikilink")，計算求得[原子](../Page/原子.md "wikilink")的原子核外多極矩。由於從原子核的外多極矩可以給出原子核內部的電荷分佈，物理學者可以研究原子核的形狀。

做理論運算時，在允許誤差範圍內，時常可以只取多極展開的最低階的幾個非零項目，忽略其它項目，因為它們的數值超小。

## 電勢的多極展開式

[Source_and_Destination02.jpg](https://zh.wikipedia.org/wiki/File:Source_and_Destination02.jpg "fig:Source_and_Destination02.jpg") 在靜電學裏，設定電荷密度分佈 \(\rho(\mathbf{r}')\) ，則其產生的電勢 \(\Phi(\mathbf{r})\) 為
...
假設體積區域 \(\mathbb{V'}\) 是在以原點為圓心、半徑為 \(R\) 的圓球內部，則在圓球以外，電勢 \(\Phi(\mathbf{r})\) 可以多極展開。文獻裏常見到兩種電勢的多極展開方法。一種展開為[直角坐標](https://zh.wikipedia.org/wiki/直角坐標 "wikilink") \((x,y,z)\) 的[泰勒級數](https://zh.wikipedia.org/wiki/泰勒級數 "wikilink")，稱為「笛卡兒多極展開」（）；另一種是用距離[倒數的](https://zh.wikipedia.org/wiki/倒數 "wikilink")[冪](../Page/冪.md "wikilink")和[球諧函數展開](https://zh.wikipedia.org/wiki/球諧函數 "wikilink")，是以[球坐標表示](https://zh.wikipedia.org/wiki/球坐標 "wikilink")，稱為「球多極展開」（）。

### 笛卡兒多極展開

任意函數 \(f(\mathbf{r}')\) 在[原點](https://zh.wikipedia.org/wiki/原點 "wikilink") \(\mathbf{r}'=\mathbf{O}\) 的[泰勒級數為](https://zh.wikipedia.org/wiki/泰勒級數 "wikilink")
...
設定 \(f(\mathbf{r}')=\frac{1}{|\mathbf{r} - \mathbf{r}'|}\) ，則 \(f(\mathbf{r}')\) 對於 \(\mathbf{r}'\) 的偏微分為
...
其中，\(\delta_{\alpha\beta}\) 是[克罗内克记号](https://zh.wikipedia.org/wiki/克罗内克记号 "wikilink")。

所以 \(\frac{1}{|\mathbf{r} - \mathbf{r}'|}\) 在原點 \(\mathbf{r}'=\mathbf{O}\) 的泰勒級數為
...
總[電荷](../Page/電荷.md "wikilink")（電單極矩） \(q\) 、[電偶極矩](https://zh.wikipedia.org/wiki/電偶極矩 "wikilink") \(\mathbf{p}\) 、[電四極矩](https://zh.wikipedia.org/wiki/電四極矩 "wikilink")（） \(Q_{\alpha\beta}\) 分別以方程式定義為\[1\]
...
場位置與源位置之間距離的[倒數](https://zh.wikipedia.org/wiki/倒數 "wikilink")，\(\frac{1}{|\mathbf{r} - \mathbf{r}'|}\) ，可以用[球諧函數](https://zh.wikipedia.org/wiki/球諧函數 "wikilink") \(Y_{\ell m}\) 展開為\[2\]
...
其中，\(\mathbf{r}\) 與 \(\mathbf{r}'\) 的[球坐標分別為](https://zh.wikipedia.org/wiki/球坐標 "wikilink")\((r,\theta,\phi)\) 與 \((r',\theta',\phi')\) 。
...
注意到 \(q_{\ell (-m)}=(-1)^m q^*_{\ell m}\) 。以下列出幾個最低階的球多極矩的表達式，以及與笛卡兒多極矩之間的關係\[3\]：
...
對於多極展開式的每一階 \(\ell\) ，笛卡兒多極展開會得到 \((\ell+1)(\ell+2)/2\) 個笛卡兒多極矩，而球多極展開會得到 \(2\ell+1\) 個球多極矩。這是因為兩種展開各自具有不同的旋轉變換屬性。笛卡兒多極矩是[可約的](https://zh.wikipedia.org/wiki/可約的 "wikilink")（）；而球多極矩則是不可約的，這種分解能夠得到[旋轉群](../Page/旋轉群.md "wikilink")的[不可約表示](https://zh.wikipedia.org/wiki/不可約表示 "wikilink")。

在多極展開式裏，不等於零的最低階多極矩，其數值與原點的選擇無關。例如，對於在 \(\mathbb{V'}\) 內部、位置為 \(\mathbf{r}'_0\) 的單獨點電荷，電荷密度可以寫為 \(\rho(\mathbf{r}')=q\delta(\mathbf{r}'-\mathbf{r}'_0)\) 。這單獨點電荷的電單極矩為 \(\int_{\mathbb{V'}}q\delta(\mathbf{r}'-\mathbf{r}'_0)\ \mathrm{d}^3\mathbf{r}' =q\) ，與原點位置無關。

對於在 \(\mathbb{V'}\) 內部、位置分別為 \(\mathbf{r}'_1\) 、\(\mathbf{r}'_2\) 的兩個異電性、同電量的點電荷，電荷密度可以寫為 \(\rho(\mathbf{r}')=q[\delta(\mathbf{r}'-\mathbf{r}'_1)-\delta(\mathbf{r}'-\mathbf{r}'_2)]\) 。這單獨點電荷的電單極矩為 \(\int_{\mathbb{V'}}q[\delta(\mathbf{r}'-\mathbf{r}'_1)-\delta(\mathbf{r}'-\mathbf{r}'_2)]\ \mathrm{d}^3\mathbf{r}' =0\) 。最低階多極矩為電偶極矩 \(\int_{\mathbb{V'}}\mathbf{r}'q[\delta(\mathbf{r}'-\mathbf{r}'_1)-\delta(\mathbf{r}'-\mathbf{r}'_2)]\ \mathrm{d}^3\mathbf{r}' =q(\mathbf{r}'_1-\mathbf{r}'_2)\) 。這電偶極矩與原點位置無關，與兩個點電荷之間的相對位置有關。

## 電能的多極展開式

假設處於外電勢 \(\Phi(\mathbf{r})\) 的電荷密度分佈 \(\rho(\mathbf{r})\) ，則其[電能](https://zh.wikipedia.org/wiki/電能 "wikilink") \(U\) 為

\[U=\int_{\mathbb{V}} \rho(\mathbf{r})\Phi(\mathbf{r})\ \mathrm{d}^3\mathbf{r}\] 。

注意到[外電場](https://zh.wikipedia.org/wiki/外電場 "wikilink") \(\mathbf{E}=-\nabla\Phi\) ，外電勢 \(\Phi(\mathbf{r})\) 在原點 \(\mathbf{O}\) 的泰勒級數為
...
由於外電場的[散度](../Page/散度.md "wikilink")為零 \(\nabla\cdot\mathbf{E}=0\) ，電勢可以寫為
...
從這裏可以看到電能的成分：第一個項目是點電荷處於外電勢的電能、第二個項目是電偶極子處於外電場的電能、第三個項目是電四極子處於具有[梯度](../Page/梯度.md "wikilink")的外電場所涉及的電能。

## 磁向量勢的多極展開式

在[靜磁學](../Page/靜磁學.md "wikilink")裏，設定電流密度分佈 \(\mathbf{J}(\mathbf{r}')\) ，則其產生的磁向量勢 \(\mathbf{A}(\mathbf{r})\) 為
...
將前面推導出的 \(\frac{1}{|\mathbf{r} - \mathbf{r}'|}\) 在原點 \(\mathbf{r}'=\mathbf{O}\) 的泰勒級數帶入磁向量勢方程式，則可得到
...
應用[高斯散度定理](../Page/高斯散度定理.md "wikilink")，由於電流密度分佈 \(\mathbf{J}\) 是局部的，假若積分體積 \(\mathbb{V}'\) 足夠大，則位於包含積分體積的曲面 \(\mathbb{S}'\) 的電流密度分佈為零：

\[\int_{\mathbb{V}'}J_{\alpha}(\mathbf{r}')\, d^3\mathbf{r}'
=\int_{\mathbb{S}'}r'_{\alpha}\mathbf{J}(\mathbf{r}')\cdot\, d\mathbf{S}'=0\] 。

所以，磁單極子項目 \(\int_{\mathbb{V}'}J_{\alpha}(\mathbf{r}')\, d^3\mathbf{r}'\) 等於零。
...
多極展開在[數值模擬領域用途很多](../Page/计算机模拟.md "wikilink")。對於相互作用的粒子組成的物理系統，[快速多極法](https://zh.wikipedia.org/wiki/快速多極法 "wikilink")（）是高效率運算這系統的能量與作用力常使用的一種方法\[4\]。快速多極法就是建構於[格林函數](../Page/格林函數.md "wikilink")的多極展開。這方法的基本點子是分解所有粒子為幾個小群，每一個小群內的粒子正常地互相作用（即通過全部勢能），而小群與小群之間的互相作用則是由其多極矩計算求得。快速多極矩法的效率通常與[伊沃德求和法](https://zh.wikipedia.org/wiki/伊沃德求和法 "wikilink")（）等同，但是假若系統的粒子具有高度群聚性，即高密度漲落，則快速多極矩法比較優等。
...
[Category:位勢論](https://zh.wikipedia.org/wiki/Category:位勢論 "wikilink") [Category:向量分析](https://zh.wikipedia.org/wiki/Category:向量分析 "wikilink")

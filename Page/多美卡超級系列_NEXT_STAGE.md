《**多美卡超級系列 NEXT STAGE**》（）是Takara Tomy於2016年推出的産品系列與網路動畫。
...
## 主題曲
  ...
  - 主題曲「NEXT STAGE」
    主唱：[鶴野剛士](https://zh.wikipedia.org/wiki/鶴野剛士 "wikilink")

## 各話列表

| 話數  | 標題        | 公開日                         |
| --- | --------- | --------------------------- |
| 第1話 | {{nihongo | 出動！ホワイトホープ}}                |
| 第2話 | {{nihongo | 驚愕！シンクロ合体}}                 |
| 第3話 | {{nihongo | 激動！ソニックインターセプター}}           |
| 第4話 | {{nihongo | 特別機動隊！ソニックインターセプターメガマックス！}} |

...
approximation,
MSA）**是最常用來分析[離散小波变换](../Page/離散小波变换.md "wikilink")〈DWT〉或是驗證[快速小波轉換](../Page/快速小波轉換.md "wikilink")〈FWT〉理論的方法。本分析方法在1989年\[1\]及1998年\[2\]由Stephane
Mallat 著作的論文提到。
...
\[\{0\}\dots\subset V_1\subset V_0\subset V_{-1}\subset\dots\subset V_{-n}\subset V_{-(n+1)}\subset\dots\subset L^2(\R)\]
  ...
  - 取樣定理
      -
        取樣定理主要是在重建一個時間長度\(T\)中被取樣過的信號：若信號是有限頻寬，只要[奈奎斯特頻率](../Page/奈奎斯特頻率.md "wikilink")（Nyquist

...
Daubechies）的名字命名的一種[小波函数](https://zh.wikipedia.org/wiki/小波 "wikilink")，當初Ingrid
Daubechies發現了一種具有階層（hierarchy）性質的小波，便將此小波以她的名字命名。多貝西小波主要應用在離散型的[小波轉換](https://zh.wikipedia.org/wiki/小波轉換 "wikilink")，是最常使用到的小波轉換，通常使用在[數位信號分析](https://zh.wikipedia.org/wiki/數位信號分析 "wikilink")、信號壓縮跟雜訊去除。

一般而言的離散小波轉換通常是以[正交小波](https://zh.wikipedia.org/wiki/正交小波 "wikilink")（orthogonal

****（Multiplexing，又稱「**多工**」）是一个[通信和](../Page/通信.md "wikilink")[计算机网络领域的专业](../Page/计算机网络.md "wikilink")[术语](https://zh.wikipedia.org/wiki/术语 "wikilink")，在没有歧义的情况下，“多路复用”也可被称为“复用”。多路复用通常表示在一个[信道上](../Page/信道.md "wikilink")[传输多路](https://zh.wikipedia.org/wiki/传输 "wikilink")[信号或](https://zh.wikipedia.org/wiki/信号 "wikilink")[数据流的过程和技术](https://zh.wikipedia.org/wiki/数据流 "wikilink")。因为多路复用能够将多个低速信道整合到一个高速信道进行传输，从而有效地利用了高速信道。通过使用多路复用，[通信运营商可以避免维护多条线路](https://zh.wikipedia.org/wiki/通信运营商 "wikilink")，从而有效地节约运营成本。\[1\]

## 工作过程

[Mux_color.png](https://zh.wikipedia.org/wiki/File:Mux_color.png "fig:Mux_color.png")
首先，各个低速信道的信号通过[多路复用器](https://zh.wikipedia.org/wiki/多路复用器 "wikilink")（MUX，多工器）组合成一路可以在高速信道传输的信号。在这个信号通过高速信道到达接收端之后，再由[分路器](https://zh.wikipedia.org/wiki/分路器 "wikilink")（DEMUX，解多工器）将高速信道传输的信号转换成多个低速信道的信号，并且转发给对应的低速信道。\[2\]
...
多路复用根据使用的技术可以分为[时分复用](https://zh.wikipedia.org/wiki/时分复用 "wikilink")（TDM）、[频分复用](https://zh.wikipedia.org/wiki/频分复用 "wikilink")（FDM）、（SDM）和[码分复用](https://zh.wikipedia.org/wiki/码分多址 "wikilink")（CDM）。\[4\]
  ...
  - 频分复用的特点是：多路复用器将各个低速信道的信号通过[调制分布到高速信道的各个](https://zh.wikipedia.org/wiki/调制 "wikilink")[频段](https://zh.wikipedia.org/wiki/频段 "wikilink")，然后进行叠加，形成高速信道上传输的信号，在接收端，分路器一般通过[带通滤波器分离各个频段](https://zh.wikipedia.org/wiki/带通滤波器 "wikilink")，然后转发给对应的低速信道。\[6\]在[光通信领域](https://zh.wikipedia.org/wiki/光通信 "wikilink")，根据[光波](https://zh.wikipedia.org/wiki/光波 "wikilink")[波长的不同进行多路复用的技术被称为](../Page/波长.md "wikilink")[波分复用](https://zh.wikipedia.org/wiki/波分复用 "wikilink")（WDM）。\[7\]
...
## 参见
  ...
  - [频分复用](https://zh.wikipedia.org/wiki/频分复用 "wikilink")
    [正交频分复用](https://zh.wikipedia.org/wiki/正交频分复用 "wikilink")

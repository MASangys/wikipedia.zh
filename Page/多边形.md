[Assorted_polygons.svg](https://zh.wikipedia.org/wiki/File:Assorted_polygons.svg "fig:Assorted_polygons.svg") **多邊形**是[平面](../Page/平面.md "wikilink")的封閉[圖形](https://zh.wikipedia.org/wiki/幾何形狀 "wikilink")、由有限[線段](https://zh.wikipedia.org/wiki/線段 "wikilink")（大于2）組成，且首尾連接起來劃出的形狀。

[右](https://zh.wikipedia.org/wiki/File:Multi-pseudograph.svg "fig:右") 在[数学](../Page/数学.md "wikilink")中，更具体地为在[图论](../Page/图论.md "wikilink")中， **多重图**（**multigraph**）或**伪图（pseudograph）**是一个允许有[多重边](../Page/重边.md "wikilink")（也称平行边）的[图](../Page/图_\(数学\).md "wikilink")。\[1\]多重边即两个[顶点之间可能存在多条](../Page/顶点_\(图论\).md "wikilink")[边](../Page/图论术语.md "wikilink")。

[多重边有两种不同的类型](https://zh.wikipedia.org/wiki/多重边 "wikilink"):

  - [边](../Page/边.md "wikilink")没有[身份](https://zh.wikipedia.org/wiki/身份 "wikilink"):边的身份仅由其两端[节点定义](https://zh.wikipedia.org/wiki/节点 "wikilink")。这种情况下，术语“多重边”表示同一条边在两个节点间多次出现。
...
正式定义：带标记的有向多重图G是将顶点和有向边进行标记的多重图。 其严格定义为八元组合 \(G=(\Sigma_V, \Sigma_A, V, A, s, t, \ell_V, \ell_A)\)，其中

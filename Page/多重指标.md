**多重指標**是數學中一種方便的表示法，它將指標中的單個整數推廣為多個整數，它可以簡化多元[微積分](https://zh.wikipedia.org/wiki/微積分 "wikilink")、[偏微分方程與](../Page/偏微分方程.md "wikilink")[分佈理論中的計算](https://zh.wikipedia.org/wiki/分佈_\(數學\) "wikilink")，也便於操作[冪級數](https://zh.wikipedia.org/wiki/冪級數 "wikilink")。
...
其中的最後一項（餘項）有多種表法，例如[柯西的積分表法](https://zh.wikipedia.org/wiki/柯西 "wikilink")：

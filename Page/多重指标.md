**多重指標**是數學中一種方便的表示法，它將指標中的單個整數推廣為多個整數，它可以簡化多元[微積分](../Page/微積分.md "wikilink")、[偏微分方程與](../Page/偏微分方程.md "wikilink")[分佈理論中的計算](../Page/分佈_\(數學\).md "wikilink")，也便於操作[冪級數](../Page/冪級數.md "wikilink")。

## 定義與運算

一個\(n\)-維**多重指標**是一個由[整數構成的](../Page/整數.md "wikilink")[向量](../Page/向量.md "wikilink")
...
**分部積分**：對有界定義域\(\Omega \subset \mathbb{R}^n\)上的緊[支集](../Page/支撐集.md "wikilink")[光滑函數](../Page/光滑函數.md "wikilink")，我們有

\[\int_{\Omega}{}{u(D^{\alpha}v)}\,dx = (-1)^{|\alpha|}\int_{\Omega}^{}{(D^{\alpha}u)v\,dx}\]

此公式用以定義[分佈與](../Page/分佈_\(數學\).md "wikilink")[弱導數](../Page/弱導數.md "wikilink")。

## 文獻

  - Saint Raymond, Xavier (1991). *Elementary Introduction to the Theory
    of Pseudodifferential Operators*. Chap 1.1 . CRC Press. ISBN
    0-8493-7158-9

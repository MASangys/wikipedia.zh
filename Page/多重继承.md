...
多重繼承可以導致某些令人混淆的情況，所以關於它的好處與風險之間孰輕孰重常常受人爭論。[Java使用了一個折衷的辦法](../Page/Java.md "wikilink")：允許一個類別繼承自多於一個父[介面](https://zh.wikipedia.org/wiki/介面 "wikilink")（可以指定某一個類別，它繼承了所有父類別的類型，並必須擁有所有父類別介面的外部可見方法的具體實現，並允許編譯器強制以上要求），但只可以從一個父類別繼承實現（方法與數據）。微軟的[.NET編程語言](https://zh.wikipedia.org/wiki/.NET_Framework "wikilink")，例如[C\#和](https://zh.wikipedia.org/wiki/C_Sharp "wikilink")[Visual
Basic .NET也使用了這種介面的做法](../Page/Visual_Basic_.NET.md "wikilink")。
...
各種編程語言有不同的方式處理上述問題。例如[Eiffel容許子類型透過重新命名](../Page/Eiffel.md "wikilink")，或提前為他們確定選擇規則，來**適應**（）它繼承得來的功能。允許物件從多個介面繼承，但僅允許一個實現繼承。[REALbasic與它相似](../Page/REALbasic.md "wikilink")，並增加了一個不需使用繼承來「擴展」一個類別的功能。[Perl使用一種有序列表式的繼承機制](../Page/Perl.md "wikilink")：搜尋方法時，它會先搜尋當前類別的方法，然後使用深度優先搜索來順序尋找各個繼承類別及其父類別。[CLOS允許程式設計者完全控制方法的組合](https://zh.wikipedia.org/wiki/CLOS "wikilink")。如果這還不足夠，[元对象协议給程式設計者一種手段去](https://zh.wikipedia.org/wiki/元对象协议 "wikilink")**修改**繼承，[方法調度](https://zh.wikipedia.org/wiki/方法調度 "wikilink")，[類別特例化](https://zh.wikipedia.org/wiki/類別特例化 "wikilink")，及其它內部的機制，而不影響系統的穩定性。

## C++与多继承

[C++支援多重繼承](../Page/C++.md "wikilink")，允許對現實世界進行更直接的建模，[Borland
C++的](../Page/Borland_C++.md "wikilink")[OWL](https://zh.wikipedia.org/wiki/OWL "wikilink")
Framework大量使用多重繼承來描述視窗的關係。微軟的[MFC僅使用單一繼承描述視窗](https://zh.wikipedia.org/wiki/MFC "wikilink")，[ATL使用多重繼承實現](https://zh.wikipedia.org/wiki/ATL "wikilink")[COM](https://zh.wikipedia.org/wiki/COM "wikilink")/[ActiveX](../Page/ActiveX.md "wikilink")，[WTL則使用多重繼承實現視窗](https://zh.wikipedia.org/wiki/WTL "wikilink")。
...
## 外部链接
  ...
  - Article by Jonathan Lurie of Builder.Com on instances in .NET
    languages:
    <https://web.archive.org/web/20060112044813/http://builder.com.com/5100-6373-5030734.html>

...
**多项式**（Polynomial）是[代数学中的基础概念](https://zh.wikipedia.org/wiki/代数学 "wikilink")，是由称为**未知数**的[变量和称为](https://zh.wikipedia.org/wiki/变量 "wikilink")**系数**的[常数通过有限次](https://zh.wikipedia.org/wiki/常数 "wikilink")[加减法](../Page/加法.md "wikilink")、[乘法以及](../Page/乘法.md "wikilink")[自然数幂次的](../Page/自然数.md "wikilink")[乘方运算得到的代数表达式](https://zh.wikipedia.org/wiki/乘方 "wikilink")。多项式是[整式的一种](https://zh.wikipedia.org/wiki/整式 "wikilink")。未知数只有一个的多项式称为一元多项式；例如\(x^2-3x+4\)就是一个一元多项式。未知数不止一个的多项式称为多元多项式，例如\(x^3+2xyz^2-yz+1\)就是一個三元多项式。

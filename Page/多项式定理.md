**多项式定理**为[二项式定理的推广](../Page/二项式定理.md "wikilink")。\(t=2\) 时为二项式定理。
...
由[隔板法可知该多项式展开共有](https://zh.wikipedia.org/wiki/隔板法 "wikilink")
\(\frac{(n+t-1)!}{n!(t-1)!}\) 项。
...
[分类:代数定理](https://zh.wikipedia.org/wiki/分类:代数定理 "wikilink")
[分类:组合数学](https://zh.wikipedia.org/wiki/分类:组合数学 "wikilink")
[分类:阶乘与二项式主题](https://zh.wikipedia.org/wiki/分类:阶乘与二项式主题 "wikilink")

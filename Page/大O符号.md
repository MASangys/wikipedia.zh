...
进一步看，如果我们与任一其他级的表达式比较，\(n^2\)项的[系数也是无关紧要的](https://zh.wikipedia.org/wiki/系数 "wikilink")。例如：一个包含\(n^3\)或\(n^2\)项的表达式，即使\(T(n)=1,000,000\cdot n^2\)，假定\(U(n)=n^3\)，一旦\(n\)增长到大于1,000,000，后者就会一直超越前者（\(T(1,000,000)=1,000,000^3=U(1,000,000)\)）。
...
大O也可以用来描述数学函数估计中的误差项。例如\(e^x\)的[泰勒展开](https://zh.wikipedia.org/wiki/泰勒展开 "wikilink")：
...
給定兩個定義在[實數某子集上的關於](https://zh.wikipedia.org/wiki/實數 "wikilink")\(x\)的函數\(f(x)\)和\(g(x)\)，當\(x\)趨近於無窮大時，[當且僅當存在正常數](https://zh.wikipedia.org/wiki/當且僅當 "wikilink")\(M\)，使得對於所有足夠大（[sufficiently_large](https://en.wikipedia.org/wiki/List_of_mathematical_jargon#sufficiently_large)）的\(x\)，都有\(f(x)\)的絕對值小於等於\(M\)乘以\(g(x)\)的絕對值，那麼我們就可以說，當\(x \to \infty\)時，

\[f(x)=\Omicron(g(x))\]

也就是說，假如[當且僅當存在正實數](https://zh.wikipedia.org/wiki/當且僅當 "wikilink")\(M\)和實數\(x\)<sub>0</sub>，使得對於所有的\(x \ge x_0\)，均有：\(|f(x)| \le \ M |g(x)|\)成立，我們就可以認爲，\(f(x)=\Omicron(g(x))\)。

在很多情況下，我們會省略“當\(x\)趨近於無限大時”這個前提，而簡寫爲：

\[f(x)=\Omicron(g(x))\]

此概念也可以用於描述函數\(f\)在接近實數\(a\)時的行爲，通常\(a = 0\)。當我們說，當\(x \to a\)時，有\(f(x)=\Omicron(g(x))\)，也就相當於稱，[當且僅當存在正實數](https://zh.wikipedia.org/wiki/當且僅當 "wikilink")\(M\)和實數\(\delta\)，使得對於所有的\(0 \le |x - a| \le \delta\)，均有\(|f(x)| \le \ M |g(x)|\)成立。

如果當\(x\)和\(a\)足夠接近（[sufficiently_close](https://en.wikipedia.org/wiki/List_of_mathematical_jargon#sufficiently_large)）時，\(g(x)\)的值仍不爲0，這兩種定義就可以統一用[上極限來表示](https://zh.wikipedia.org/wiki/上極限 "wikilink")：
...
| 符号                                             | 名称                                                                                          |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------- |
| \(\Omicron(1)\!\)                              | [常数](https://zh.wikipedia.org/wiki/常数 "wikilink")（阶，下同）                                     |
| \(\Omicron(\log n)\!\)                         | [对数](https://zh.wikipedia.org/wiki/对数 "wikilink")                                           |
| \(\Omicron[(\log n)^c]\!\)                     | [多对数](https://zh.wikipedia.org/wiki/多对数 "wikilink")                                         |
| \(\Omicron(n)\!\)                              | [线性](https://zh.wikipedia.org/wiki/线性 "wikilink")，次线性                                       |
| \(\Omicron(n\log^*n)\!\)                       | \(\log^*n\)為[迭代对数](https://zh.wikipedia.org/wiki/迭代对数 "wikilink")                           |
| \(\Omicron(n \log n)\!\)                       | [线性对数](https://zh.wikipedia.org/wiki/线性对数 "wikilink")，或对数线性、拟线性、超线性                         |
| \(\Omicron( n^2)\!\)                           | [平方](../Page/平方.md "wikilink")                                                              |
| \(\Omicron(n^c), \operatorname{Integer}(c>1)\) | [多项式](https://zh.wikipedia.org/wiki/多项式 "wikilink")，有时叫作“代数”（阶）                             |
| \(\Omicron(c^n)\!\)                            | [指数](https://zh.wikipedia.org/wiki/指数 "wikilink")，有时叫作“[几何](../Page/等比数列.md "wikilink")”（阶） |
| \(\Omicron(n!)\!\)                             | [阶乘](https://zh.wikipedia.org/wiki/阶乘 "wikilink")，有时叫做“组合”（阶）                               |
...
大O符号经常被误用：有的作者可能会使用大O符号表达[大Θ符号的含义](https://zh.wikipedia.org/wiki/大Θ符号 "wikilink")。因此在看到大O符号时应首先确定其是否为误用。

## 参看

  - [O](../Page/O.md "wikilink")（拉丁字母）
  - [大Ω符号](https://zh.wikipedia.org/wiki/大Ω符号 "wikilink")
  - [大Θ符号](https://zh.wikipedia.org/wiki/大Θ符号 "wikilink")

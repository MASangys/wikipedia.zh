...
## 外部链接
  ...
  - [Brief Description on LSO in Linux](http://kb.pert.geant.net/PERTKB/LargeSendOffloadLSO)
  - [Case Studies of Performance issues with LSO and Traffic Shaping (Linux)](http://kb.pert.geant.net/PERTKB/PerformanceCaseStudies)

...
大炮的第一個目標可能是存储避開網路審查工具的網站，像是線上原始碼存储網站[GitHub](../Page/GitHub.md "wikilink")，以及監控中國防火長城封鎖現況的[GreatFire網站](https://zh.wikipedia.org/wiki/GreatFire "wikilink")。
...
3.  第三輪，DDoS攻擊[GitHub
    Pages](https://zh.wikipedia.org/wiki/GitHub_Pages "wikilink")；
4.  第四輪，[SYN

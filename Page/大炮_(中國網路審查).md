...
根據命名大炮的加拿大學者表示，大炮將從中國以外的連線流量導到特定的目標網站，導致目標網站網路服務不穩。雖然大炮跟[防火長城一起](https://zh.wikipedia.org/wiki/防火長城 "wikilink")，但大炮是分開的攻擊系統，擁有不同的設計和功用。\[4\]除了發起分散式阻斷服務攻擊以外，大炮還能監控[網路流量](https://zh.wikipedia.org/wiki/網路流量 "wikilink")，以及採用類似[美國國安局的](https://zh.wikipedia.org/wiki/美國國安局 "wikilink")[量子注入系統](https://zh.wikipedia.org/wiki/量子注入系統 "wikilink")（Quantum
insert
system），對目標散佈[惡意程式](https://zh.wikipedia.org/wiki/惡意程式 "wikilink")。\[5\]\[6\]

## 大炮發起的攻擊

大炮的第一個目標可能是存储避開網路審查工具的網站，像是線上原始碼存储網站[GitHub](../Page/GitHub.md "wikilink")，以及監控中國防火長城封鎖現況的[GreatFire網站](../Page/GreatFire.md "wikilink")。
\[7\]多次技术报告显示，发动对GitHub和GreatFire的攻击的方式是通过向[百度注入恶意的](../Page/百度.md "wikilink")[JavaScript](../Page/JavaScript.md "wikilink")（简称JS）代码以使从中国大陆以外访问百度网站及广告的流量转换为DDoS攻击发送至目标。\[8\]

### 针对Github

2015年3月26日至31日的對[GitHub發起的](../Page/GitHub.md "wikilink")[旁觀者攻擊](https://zh.wikipedia.org/wiki/旁觀者攻擊 "wikilink")（），被认为是大炮的第一次重要应用。

第三方研究者指出，此次攻击采用了HTTP劫持，[百度的](../Page/百度.md "wikilink")[JS脚本文件被](../Page/JavaScript.md "wikilink")[中间人植入了攻击GitHub的代码](../Page/中间人攻击.md "wikilink")，其功能是每隔2秒加载一次[GreatFire或](https://zh.wikipedia.org/wiki/Greatfire.org "wikilink")[纽约时报中文网的帳號主頁](../Page/纽约时报.md "wikilink")。\[9\]百度已否认自身产品存在安全问题。\[10\]。这次攻击导致GitHub在全球范围内的访问速度下降。\[11\]外界普遍相信這是中國政府所為，但中国政府予以否认。\[12\]
\[13\]
3月28日（[UTC+8](https://zh.wikipedia.org/wiki/UTC+8 "wikilink")）起，GitHub在中国大陆十分不稳定，多数情况下无法访问。\[14\]截止29日，攻击者共使用了四種DDoS攻擊技術：
...
4.  第四輪，[SYN
    flood](../Page/SYN_flood.md "wikilink")，利用[TCP缺陷发送大批伪造的TCP連線請求](../Page/传输控制协议.md "wikilink")，耗盡GitHub的資源。\[15\]

根據系統狀態訊息頁面的顯示，已於3月31日停止了網路攻擊，該日凌晨0:09（UTC）已經穩定。GitHub在其Twitter與微博予以了證實。至此，此網路攻擊共持續了五天。

### 其他

2015年4月26日，大炮對開放原始碼網站wpkg.org與旅遊網站ptraveler.com發動了攻擊，凡是用中國IP瀏覽嵌入了Facebook
Connect按鈕脚本的網站，皆會被重新導向至這兩個網站。\[16\]\[17\]

2017年8月16日，大炮被发现攻击曾经邀请中国海外流亡富豪[郭文贵做访谈的异议新闻站点](../Page/郭文贵.md "wikilink")[明镜网](https://zh.wikipedia.org/wiki/明镜新闻集团 "wikilink")，大炮通过对百度站长统计的脚本代码注入攻击明镜网的代码。
\[18\]\[19\]\[20\]\[21\]
...
为了防止数据在网络中无限循环，名为[存活时间](https://zh.wikipedia.org/wiki/存活时间 "wikilink")（Time
to
live，TTL）的机制限定了数据包的寿命。从数据包发出开始，每经过一个路由，TTL就减去1，当TTL=0时数据包将会被丢弃。大多数系统发送数据包时都是从TTL=64开始，如果该数据包抵达时TTL=24，那么计算机和发送者之间经过了40跳（64-24=40）。在对GitHub发动的DDoS攻击中，攻击者劫持了[百度的JS文件](../Page/百度.md "wikilink")。如图所示，百度[服务器所发送数据包的TTL](../Page/服务器.md "wikilink")=64，第一次抵达用户[浏览器时TTL](https://zh.wikipedia.org/wiki/浏览器 "wikilink")=42，经过了22跳，用户发回的请求包的TTL值也是64，但接下来的响应包的TTL值却突然变成了227，显然有中间人设备注入了伪造包。一位研究人员用定制[Traceroute工具测试发现](../Page/Traceroute.md "wikilink")，注入设备位于第11跳和第12跳之间，通过查询第12跳设备的IP地址，作者发现它位于中国联通骨干网，因此得出了中国政府与此有关的结论。
\[22\]

## Google對JS劫持攻擊的分析

2015年4月24日，Google安全團隊在其部落格撰文稱，Javascript劫持攻击的执行分为多個阶段，最早发生在2015年3月3日，最后一次是在4月7日。Google指出，共有8個百度網域遭到劫持，被注入不同大小的Javascript代码。Google认为，全面启用HTTPS加密将能防御這类攻击。\[23\]\[24\]
...
## 參見
  ...
  - [禁止网络盗版法案](../Page/禁止网络盗版法案.md "wikilink")（SOPA，美國的提出审查盗版网站的法案）
...
## 外部連結
  ...
  - [紐約時報中文網](https://zh.wikipedia.org/wiki/紐約時報 "wikilink")：[中国启用“网-{}-络大炮”
    加强境外互联-{}-网审查](http://cn.nytimes.com/china/20150413/c13hack)

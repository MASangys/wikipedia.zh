...
在[右手定則](../Page/右手定則.md "wikilink")的直角赤道座標（此處\(X\)軸是[春分點的方向](https://zh.wikipedia.org/wiki/春分點 "wikilink")， \(Y\)軸是向東旋轉90° ，這個[平面](../Page/平面.md "wikilink")就是[天球赤道](../Page/天球赤道.md "wikilink")，而\(Z\)軸指向[天球北極](../Page/天極.md "wikilink")\[6\] ），[天文單位](../Page/天文單位.md "wikilink")的表示如下：
...
## 外部連結
  ...
  - [Solar Position Algorithm](http://rredc.nrel.gov/solar/codesandalgorithms/spa/), at National Renewable Energy Laboratory's [Renewable Resource Data Center](http://www.nrel.gov/rredc/) website.
  - [Sun Position Calculator](https://web.archive.org/web/20141204231754/http://pveducation.org/pvcdrom/properties-of-sunlight/sun-position-calculator), at [pveducation.org](http://www.pveducation.org/pvcdrom). An interactive calculator showing the Sun's path in the sky.

**夾擠定理**，又稱**夹逼定理**、**三明治定理**，是有關[函數](../Page/函數.md "wikilink")[極限的](../Page/極限.md "wikilink")[定理](../Page/定理.md "wikilink")。它指出若有兩個函數在某點的極限相同，且有第三個函數的值在這兩個函數之間，则第三個函數在該點的極限也相同。
...
\(g(x)\)和\(h(x)\)分別稱為\(f(x)\)的[下界和](../Page/下界.md "wikilink")[上界](../Page/上界.md "wikilink")。
...
對於實數值，[正弦函數的](../Page/正弦.md "wikilink")[絕對值不大於](../Page/絕對值.md "wikilink")1，因此\(f(x)\)的絕對值也不大於\(x^2\)。設\(g(x) = -x^2\),
\(h(x) = x^2\)：
...
（注：這個問題不可以用[洛必達法則解決](../Page/洛必達法則.md "wikilink")。）
...
[高斯函數的](../Page/高斯函數.md "wikilink")[積分的應用包括](../Page/積分.md "wikilink")[連續傅立葉變換和正交化](../Page/連續傅立葉變換.md "wikilink")。

...
{| class="wikitable" style="float: right; text-align: center; margin: 1em;" |- \! rowspan="2" | 7位数据
（1的个数） \! colspan="2" | 带有校验位的字节 |- \! 偶核對位元 \! 奇核對位元 |- | 0000000（0） | 0000000**0** | 0000000**1** |- | 1010001（3） | 1010001**1** | 1010001**0** |- | 1101001（4） | 1101001**0** | 1101001**1** |- | 1111111（7） | 1111111**1** | 1111111**0** |} **奇偶校验位**（）或**校验比特**（）是一个表示给定位数的二进制数中1的个数是[奇数还是](https://zh.wikipedia.org/wiki/奇数 "wikilink")[偶数的](https://zh.wikipedia.org/wiki/偶数 "wikilink")[二进制数](https://zh.wikipedia.org/wiki/二进制 "wikilink")。奇偶校验位是最简单的[错误检测码](https://zh.wikipedia.org/wiki/错误检测与校正 "wikilink")。

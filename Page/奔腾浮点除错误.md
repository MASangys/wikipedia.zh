...
**Pentium FDIV
bug**（奔腾浮点除错误）是[英特爾公司的舊版本](https://zh.wikipedia.org/wiki/英特爾 "wikilink")[Pentium](https://zh.wikipedia.org/wiki/Pentium "wikilink")[浮点运算器的一個](https://zh.wikipedia.org/wiki/浮点运算器 "wikilink")[錯誤](../Page/程序错误.md "wikilink")。错误起源于奔腾系列的FDIV（浮点除）指令。

## 發現

1994年10月，美國[弗吉尼亞州Lynchburg](https://zh.wikipedia.org/wiki/弗吉尼亞州 "wikilink")
College數學系教授Thomas
Nicely發現用[電腦處理](https://zh.wikipedia.org/wiki/電腦 "wikilink")[長除法時一直出錯](../Page/長除法.md "wikilink")。他用一個數字去除以824,633,702,441時，答案一直是錯誤的。事後發現原因是英特爾為了加速運算，將整個[乘法表燒錄在處理器上面](https://zh.wikipedia.org/wiki/乘法表 "wikilink")，但是2048個乘法數字中，有5個輸入錯誤。這些錯誤其實不容易顯現，在運算過程中，它會自動修復錯誤，只有幾個二進位的數字組，才會造成完全錯誤的結果。
...
## 外部連結
  ...
  - [A Tale of Two
    ...
    [Cleve Moler](https://zh.wikipedia.org/wiki/Cleve_Moler "wikilink")
    of [The
    MathWorks](https://zh.wikipedia.org/wiki/The_MathWorks "wikilink")

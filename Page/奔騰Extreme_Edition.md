...
Extreme Edition 840。
這個系列必須使用[英特爾的i](https://zh.wikipedia.org/wiki/英特爾 "wikilink")955X或i975X及[NVIDIA的](https://zh.wikipedia.org/wiki/NVIDIA "wikilink")[NForce
4 SLI Intel
Edition晶片組](https://zh.wikipedia.org/wiki/NForce_4_SLI_Intel_Edition "wikilink")，使用i945系列晶片組的話會關閉超執行緒功能。

### Presler

它是第二代Pentium Extreme Edition的核心，跟Pentium 9XX系列一樣，但開啟了超執行緒技術，使用1066MHz
[FSB](https://zh.wikipedia.org/wiki/FSB "wikilink")，以及解除了倍頻鎖。這個系列有兩枚處理器，分別是955及965。Presler必須搭配英特爾的i975X晶片組或NVIDIA的nForce4系列。

## 後繼者


英特爾將以使用[Intel
Core微處理器架構的](https://zh.wikipedia.org/wiki/Intel_Core微處理器架構 "wikilink")[Intel
Core 2
Extreme取代Pentium](https://zh.wikipedia.org/wiki/Intel_Core_2#Conroe_XE_\(Core_2_Extreme\) "wikilink")
Extreme Edition。
...
XE](https://zh.wikipedia.org/wiki/en:Pentium_D#Smithfield_XE "wikilink")

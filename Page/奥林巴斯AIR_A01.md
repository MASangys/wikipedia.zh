...
奥林巴斯为Air产品提供了相关APP\[6\]：

| 名称              | 主要功能                |
| --------------- | ------------------- |
| OA.Central      | 基础连接教学、基本使用         |
| OA.Viewer       | 照片回放                |
| OA.Clips        | 视频相关拍摄与回放           |
| OA.ModeDial     | 模式选择，可以设定参数         |
| OA.PhotoStory   | 以PhotoStory拼图方式构建拍摄 |
| OA.ColorCreator | 色彩创意模式              |
| OA.ArtFilter    | 滤镜模式                |
| OA.Genius       | 智能/傻瓜拍摄模式           |

OPC相关app

而一部分beta程序，和面向开发者的项目，则在OPC平台和SDK中提供\[7\]。

### 固件更新

奥林巴斯提供了针对Air A01的固件更新\[8\]：

<table>
<caption>Air A01固件版本</caption>
<thead>
<tr class="header">
<th><p>版本号</p></th>
<th><p>时间</p></th>
...
<td><p>* 兼容<a href="../Page/Android.md" title="wikilink">Android 7.0</a><br />
* 提升操作稳定性</p></td>
</tr>
</tbody>
</table>
...
<!-- end list -->
  ...
  - **可更换镜头分离式相机**
      - [索尼ILCE-QX1](../Page/索尼ILCE-QX1.md "wikilink")
...
<!-- end list -->
  ...
  - **OLYMPUS AIRの進化を探れ！** - DC Watch Impress
      - [第1回：“オープンプラットフォーム”で未来のカメラを模索](http://dc.watch.impress.co.jp/docs/review/olympusair/743161.html)
      - [第2回：“リア充”っぽい写真を撮ってみる（※ただし1人で）](http://dc.watch.impress.co.jp/docs/review/olympusair/743405.html)
      - [第3回：レゴでカメラボディを作ってみた](http://dc.watch.impress.co.jp/docs/review/olympusair/743926.html)

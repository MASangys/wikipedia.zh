...
correlation的形式](https://zh.wikipedia.org/wiki/circular_correlation "wikilink")。

Step
3：為了要符合[迴旋摺積的定義](https://zh.wikipedia.org/wiki/迴旋摺積 "wikilink")(矩陣的對角線的項數相同)，故必須再將第二列與第四列交換，第二行與第四行交換，矩陣如下：

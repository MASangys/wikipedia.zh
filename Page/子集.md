...
**子集**，為某個[集合中一部分的集合](https://zh.wikipedia.org/wiki/集合 "wikilink")，故亦稱**部分集合**。
...
所有集合*\(B\)*都是其本身的子集。
不[等于](https://zh.wikipedia.org/wiki/等于 "wikilink")*\(B\)*的*\(B\)*的子集称为**真子集**。
...
[ISO 80000-2](https://zh.wikipedia.org/wiki/ISO_80000-2 "wikilink")

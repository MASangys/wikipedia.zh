**字体光栅化**是将文字从一个[向量表示](../Page/向量.md "wikilink")（比如一个[TrueType](../Page/TrueType.md "wikilink")[字体](../Page/字体.md "wikilink")）转化到光栅或者[位图表示的过程](../Page/位图.md "wikilink")。在这个过程中往往涉及一些[抗锯齿技术来使得屏幕上的字体更加平滑易读](https://zh.wikipedia.org/wiki/抗锯齿 "wikilink")。这也经常会涉及“[字体微调](https://zh.wikipedia.org/wiki/字体微调 "wikilink")”技术。
...
[Subpixel-rendering-RGB.png](https://zh.wikipedia.org/wiki/File:Subpixel-rendering-RGB.png "fig:Subpixel-rendering-RGB.png")

## 目前使用的光栅化系统

[Microsoft
Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink") 自
[Windows XP](../Page/Windows_XP.md "wikilink") 开始支持
[ClearType](../Page/ClearType.md "wikilink") 渲染。
[PDF](https://zh.wikipedia.org/wiki/PDF "wikilink") 通常使用 [Adobe
CoolType](https://zh.wikipedia.org/wiki/CoolType "wikilink") 渲染。

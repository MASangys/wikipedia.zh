...
关于孪生素数有著名的[孪生素数猜想](../Page/孪生素数猜想.md "wikilink")，即是否存在无穷多对孪生素数。这是[数论中未解决的一个重要问题](../Page/数论.md "wikilink")。是孪生素数猜想的一个增强形式，猜测孪生素数的分布与[素数定理中描述的素数分布规律相类似](https://zh.wikipedia.org/wiki/素数定理 "wikilink")。
...
以下列出了最小的35对孪生素数（[1000以內的孪生素数](../Page/1000.md "wikilink")）（及)：

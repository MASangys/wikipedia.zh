...
\(R\)-模對一[理想](https://zh.wikipedia.org/wiki/理想_\(環論\) "wikilink")
\(I \subset R\)
的完備性。由於完備環有較容易處理的性質，**完備化**是研究[交換環的基本工具](https://zh.wikipedia.org/wiki/交換環 "wikilink")。
...
對於一個交換環 \(R\) 及其理想
\(I\)（通常取為[極大理想](https://zh.wikipedia.org/wiki/極大理想 "wikilink")），可以藉著取
\(I^n \; (n  \in \N)\) 為零元素的開鄰域，賦予 \(R\)
相應的拓撲結構，使之成為對加法的[拓撲群](https://zh.wikipedia.org/wiki/拓撲群 "wikilink")。這種拓撲稱為
**\(I\)-進拓撲**。
...
模 \(M\) 對 \(I \subset R\)
的**完備化**定義為[射影極限](https://zh.wikipedia.org/wiki/極限_\(範疇論\) "wikilink")：

  -
    \(\hat{M} := \varprojlim_n M/I^n M\)

正如其名，\(\hat{M}\) 對其
\(I\)-進拓撲是[完備的](https://zh.wikipedia.org/wiki/完備性 "wikilink")。對於固定的
...
## 例子
  ...
  - [p進整數是](https://zh.wikipedia.org/wiki/p進數 "wikilink") \(\Z\) 對
    \(p\Z\) 的完備化。

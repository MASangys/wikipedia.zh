...
fusion**）是一项旨在提高[x86](https://zh.wikipedia.org/wiki/x86 "wikilink")[处理器性能的技术](https://zh.wikipedia.org/wiki/处理器 "wikilink")。支持宏融合的处理器可令多条（通常为两条）x86[指令融合为一条执行](https://zh.wikipedia.org/wiki/指令 "wikilink")，从而提高了处理器的吞吐率。
...
目前，[英特尔基于](../Page/英特尔.md "wikilink")[Core](https://zh.wikipedia.org/wiki/Intel_Core微处理器架构 "wikilink")、[Nehalem和](https://zh.wikipedia.org/wiki/Nehalem "wikilink")[Sandy
Bridge微架构的处理器和](https://zh.wikipedia.org/wiki/Sandy_Bridge "wikilink")[威盛凌珑处理器](../Page/VIA_Nano.md "wikilink")\[3\]均支持宏融合，而[超微](https://zh.wikipedia.org/wiki/超微 "wikilink")(AMD)的处理器尚不支持这项技术。
...
*以下限制仅适于用Core微架构的处理器*
  ...
  - 宏融合只支持[32位程序](https://zh.wikipedia.org/wiki/32位 "wikilink")，包括在[64位](https://zh.wikipedia.org/wiki/64位 "wikilink")[操作系统下运行的](../Page/操作系统.md "wikilink")32位程序。这也是某些程序的32位版本较其64位版本运行更快的原因之一。

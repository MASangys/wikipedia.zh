**定理**（）是經過受[邏輯限制的](https://zh.wikipedia.org/wiki/邏輯 "wikilink")[證明為真的](../Page/證明.md "wikilink")[陈述](https://zh.wikipedia.org/wiki/陈述 "wikilink")。一般來說，在數學中，只有重要或有趣的陳述才叫定理。證明定理是[數學的中心活動](https://zh.wikipedia.org/wiki/數學 "wikilink")。一个定理陈述一个给定类的所有（全称）元素一种不变的关系，这些元素可以是无穷多，它们在任何时刻都无区别地成立，而没有一个例外。（例如：某些\(a\)是\(x\)，某些\(a\)是\(y\)，就不能算是定理）。
...
7.  [假說](https://zh.wikipedia.org/wiki/假说 "wikilink")－根據已知的[科學事實和科學](../Page/科学.md "wikilink")[原理](../Page/原理.md "wikilink")，對所研究的[自然現象及其](../Page/自然.md "wikilink")[規律性提出的推測和說明](https://zh.wikipedia.org/wiki/规律 "wikilink")。

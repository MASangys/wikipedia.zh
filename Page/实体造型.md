...
**实体造型**（）是用於數學和電腦建模的三維實體上的一組連貫原則，它和[幾何模型以及](https://zh.wikipedia.org/wiki/幾何模型 "wikilink")[计算机图形的差別主要在於它對物理尺度保真度的強調](../Page/计算机图形.md "wikilink")。\[1\]幾何模型和實體模型一同構成[電腦輔助設計的根基](https://zh.wikipedia.org/wiki/電腦輔助設計 "wikilink")，一般可以協助物理實體的創造、交換、視覺化、製作動畫、檢查和註解。

实体造型的主要應用領域是[计算机辅助设计](../Page/计算机辅助设计.md "wikilink")、[工程分析](https://zh.wikipedia.org/wiki/工程分析 "wikilink")、[计算机图形学](../Page/计算机图形学.md "wikilink")、[动画](../Page/动画.md "wikilink")、快速原型（rapid
prototyping）、医疗测试和科学研究的[可视化](https://zh.wikipedia.org/wiki/可视化 "wikilink")（visualization）。
...
<!-- end list -->
  ...
  - **边界表示(Boundary representation)**
      ...
      - 也成为'曲面造型surfacing'。
      - 和各种制造技术类似；[射出成型](https://zh.wikipedia.org/wiki/射出成型 "wikilink")(Injection
        moulding)、[铸造](https://zh.wikipedia.org/wiki/铸造 "wikilink")(casting)、锻造(forging)、[热塑加工](https://zh.wikipedia.org/wiki/热塑加工 "wikilink")(thermoforming)等等。
...
三维CAD的一场革命始于1989年，当时第一个参数化造型系统[T-FLEX在PC上发布了](https://zh.wikipedia.org/wiki/T-FLEX "wikilink")。[Pro/ENGINEER也于同年发行](../Page/Creo_Parametric.md "wikilink")。现在大部分实体造型系统都是参数化的。
...
计算机产生的人物的动画是参数化造型的一个例子。[恰恰·賓克斯](https://zh.wikipedia.org/wiki/恰恰·賓克斯 "wikilink")(Jar
Jar
Binks，星战人物)用一组定位关键肢体位置的参数描述。模型从这些位置开始建造。对每一[帧进行参数修改和模型重建就得到了](../Page/帧.md "wikilink")[动画](../Page/动画.md "wikilink")。

## 医用实体造型

现代[计算机断层摄影](https://zh.wikipedia.org/wiki/CT "wikilink")(俗称CT)和[核磁共振扫描仪可以为体内特征构造实体模型](../Page/核磁共振.md "wikilink")

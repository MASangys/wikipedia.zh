...
[国际电信联盟ITU](../Page/国际电信联盟.md "wikilink")-T也发布了自己的RTP文档，作为H.225.0，但是后来当IETF发布了关于它的稳定的标准RFC后就被取消了。它作为[因特网标准在RFC](https://zh.wikipedia.org/wiki/因特网 "wikilink")
3550（该文档的旧版本是RFC 1889）有详细说明。RFC 3551（STD 65，旧版本是RFC
1890）详细描述了使用最小控制的音频和视频会议。

RTP协议详细说明了在[互联网上传递音频和视频的标准数据包格式](../Page/互联网.md "wikilink")。它一开始被设计为一个[多播协议](../Page/多播.md "wikilink")，但后来被用在很多[单播应用中](https://zh.wikipedia.org/wiki/单播 "wikilink")。RTP协议常用于[流媒体系统](../Page/流媒体.md "wikilink")（配合RTSP协议），视频会议和[一键通](https://zh.wikipedia.org/wiki/一键通 "wikilink")（）系统（配合H.323或SIP），使它成为[IP电话产业的技术基础](https://zh.wikipedia.org/wiki/IP电话 "wikilink")。RTP协议和RTP控制协议[RTCP一起使用](https://zh.wikipedia.org/wiki/RTCP "wikilink")，而且它是建立在[UDP协议上的](https://zh.wikipedia.org/wiki/UDP协议 "wikilink")。
...
## 参见
  ...
  - [Real time control
    protocol](https://zh.wikipedia.org/wiki/RTCP "wikilink")（RTCP）
  - [Real Time Streaming Protocol
    (RTSP)](https://zh.wikipedia.org/wiki/RTSP "wikilink")
  - [Secure Real-time Transport
    Protocol](https://zh.wikipedia.org/wiki/Secure_Real-time_Transport_Protocol "wikilink")
  - [Stream Control Transmission
    Protocol](https://zh.wikipedia.org/wiki/Stream_Control_Transmission_Protocol "wikilink")
  - [ZRTP](https://zh.wikipedia.org/wiki/ZRTP "wikilink")
  - [Real time
    communications](https://zh.wikipedia.org/wiki/Real_time_communications "wikilink")

...
在[命题演算](https://zh.wikipedia.org/wiki/命题演算 "wikilink")，或在[数学的逻辑演算中](../Page/数学.md "wikilink")，**实质条件**、**實質蘊涵**(容易和語意蘊涵\(\vDash\)搞混，建議不要用蘊涵這兩字)或**蕴涵算子**是一种[二元的](../Page/二元关系.md "wikilink")[真值泛函的](https://zh.wikipedia.org/wiki/真值泛函 "wikilink")[逻辑运算符](../Page/逻辑运算符.md "wikilink")，它有着如下形式
...
<!-- end list -->
  ...
  - \(\rightarrow\)和\(\models\)而二者都是[單調的](https://zh.wikipedia.org/wiki/單調函數 "wikilink")；就是說如果\(\Gamma\models\psi\)則\(\Delta\cup\Gamma\models\psi\)，并且如果\(\phi\rightarrow\psi\)則\((\phi\land\alpha)\rightarrow\psi\)對於任何α,
    Δ。（用[結構規則的術語說](https://zh.wikipedia.org/wiki/結構規則 "wikilink")，這叫做弱化。）
...
[邏輯等價於](https://zh.wikipedia.org/wiki/邏輯等價 "wikilink")\((A \land B) \rightarrow C\)；這個性質有時叫做[柯里化](../Page/柯里化.md "wikilink")。由於這些性質，對→符號採用[右結合約定是合適的](https://zh.wikipedia.org/wiki/右結合 "wikilink")。
...
这些有爭議的真值推理陳述句出现，是因为自然口语的人經常易受诱惑，而把**实质条件**和[直陈条件或其他条件陈述如](https://zh.wikipedia.org/wiki/直陈条件 "wikilink")[反事实条件](../Page/反事实条件.md "wikilink")，混淆在一起了。通过不把条件陈述读做“如果”和“则/那么”可以减轻这种诱惑。最常见的方式是把
...
<!-- end list -->
  ...
  - [Quine,
    W.V.](https://zh.wikipedia.org/wiki/W.V._Quine "wikilink")（1982）,
    *Methods of Logic*, (1st ed. 1950), (2nd ed. 1959), (3rd ed. 1972),
    4th edition, Harvard University Press, Cambridge, MA.

<!-- end list -->

  - [Stalnaker,
    Robert](https://zh.wikipedia.org/wiki/Robert_Stalnaker "wikilink").
    'Indicative Conditionals'.
    *[Philosophia](https://zh.wikipedia.org/wiki/Philosophia "wikilink")*
    **5**（1975）: 269–286.

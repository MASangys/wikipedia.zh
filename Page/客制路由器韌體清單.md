...
<!-- end list -->
  ...
  - – 早期專注於效能和功能提升的韌體專案，盡量與的原廠韌體保持相近但提供傳輸功率控制、連接埠觸發器、腳本、telnet等功能
      ...
      - [Tomato](https://zh.wikipedia.org/wiki/Tomato "wikilink") –
        HyperWRT的繼任者，另外新增了進階[QoS](https://zh.wikipedia.org/wiki/QoS "wikilink")、[Ajax和](https://zh.wikipedia.org/wiki/Ajax "wikilink")[SVG圖形畫統計報表顯示](https://zh.wikipedia.org/wiki/SVG "wikilink")
          - Tomato by Shibby\[12\]

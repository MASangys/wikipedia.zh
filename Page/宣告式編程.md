**宣告式編程**（）是一種[编程范式](https://zh.wikipedia.org/wiki/編程典範 "wikilink")，与[指令式編程相對立](../Page/指令式編程.md "wikilink")。它描述目標的性質，讓電腦明白目標，而非流程。声明式编程不用告诉电脑问题领域，从而避免随之而来的副作用。而指令式编程则需要用算法来明确的指出每一步该怎么做。

宣告式编程通常被看做是[形式逻辑的理论](https://zh.wikipedia.org/wiki/形式逻辑 "wikilink")，把计算看做推导。宣告式编程因大幅简化了[并行计算的编写难度](../Page/并行计算.md "wikilink")，自2009起备受关注。
...
宣告式編程語言通常用作解決[人工智能和](../Page/人工智能.md "wikilink")[約束滿足問題](https://zh.wikipedia.org/wiki/約束补偿問題 "wikilink")。
...
[函数式编程](../Page/函数式编程.md "wikilink")，特别是[纯函数式编程](https://zh.wikipedia.org/wiki/纯函数式编程 "wikilink")，尝试最小化状态带来的副作用，因此被认为是宣告式的。大多数函数式编程语言，例如[Scheme](../Page/Scheme.md "wikilink")、[Clojure](https://zh.wikipedia.org/wiki/Clojure "wikilink")、[Haskell](../Page/Haskell.md "wikilink")、[OCaml](../Page/OCaml.md "wikilink")、[Standard
ML和](https://zh.wikipedia.org/wiki/Standard_ML "wikilink")[Unlambda](https://zh.wikipedia.org/wiki/Unlambda "wikilink")，允许副作用的存在。

### 逻辑式编程

[逻辑式编程语言如](https://zh.wikipedia.org/wiki/逻辑式编程 "wikilink")[Prolog声明关系并且对关系进行提问](../Page/Prolog.md "wikilink")。同函数式编程一样，许多逻辑编程语言允许副作用的存在。

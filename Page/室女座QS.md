...
2009年宣布以凌日法量測該聯星系統兩顆恆星的凌日時間變化發現一個環繞室女座QS聯星系統的[太陽系外行星](../Page/太陽系外行星.md "wikilink")\[3\]。該行星的質量是木星的6.4倍，並以距離聯星系4.2天文單位的橢圓軌道公轉。

之後的觀測發現凌日的時間變化並不符合預測的行星模式。雖然觀測到的凌日時間變化可能是由第三個天體引起，最符合的軌道模型是一個最小質量0.05倍太陽質量的天體（約木星質量的50倍）在高離心率的週期14年軌道上運行\[4\]。

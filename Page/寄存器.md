...
暫存器是[記憶體階層中的最頂端](https://zh.wikipedia.org/wiki/記憶體階層 "wikilink")，也是系統操作資料的最快速途徑。暫存器通常都是以他們可以保存的[位元數量來估量](../Page/位元.md "wikilink")，舉例來說，一個[8位元暫存器或](../Page/8位元.md "wikilink")[32位元暫存器](../Page/32位元.md "wikilink")。暫存器現在都以[暫存器陣列的方式來實作](https://zh.wikipedia.org/wiki/暫存器陣列 "wikilink")，但是他們也可能使用單獨的[正反器](https://zh.wikipedia.org/wiki/正反器 "wikilink")、高速的[核心記憶體](https://zh.wikipedia.org/wiki/核心記憶體 "wikilink")、[薄膜記憶體以及在數種機器上的其他方式來實作出來](https://zh.wikipedia.org/wiki/薄膜記憶體 "wikilink")。
...
<!-- end list -->
  ...
  - **[指令寄存器](https://zh.wikipedia.org/wiki/指令寄存器 "wikilink")** -
    儲存現在正在被執行的指令
  - **** - 是在程式執行時用來更改操作数位址之用。

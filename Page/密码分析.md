**密碼分析**（，來源於[希臘語](https://zh.wikipedia.org/wiki/希臘語 "wikilink")，即「隱藏」，以及，即「解開」），是研究在不知道通常解密所需要的秘密信息的情況下對已[加密的信息進行解密的一門學問](https://zh.wikipedia.org/wiki/加密 "wikilink")。一般情況下，要成功解密需要尋找到一個秘密的[鑰匙](https://zh.wikipedia.org/wiki/鑰匙 "wikilink")，俗稱**破解密碼**（破密）。

從廣義的角度看，密碼分析這個詞語有時也泛指繞開某個[密碼學](../Page/密碼.md "wikilink")[算法或](../Page/算法.md "wikilink")[密碼協議的嘗試](https://zh.wikipedia.org/wiki/密碼協議 "wikilink")，而不僅僅是針對[加密算法](https://zh.wikipedia.org/wiki/加密 "wikilink")。但是，密碼分析通常不包括並非主要針對密碼算法或協議的攻擊。儘管這些攻擊方式是[計算機安全領域裡的重要考慮因素](https://zh.wikipedia.org/wiki/計算機安全 "wikilink")，而且通常比傳統的密碼分析更加有效。

雖然密碼分析的目標在[密碼學的歷史上從未改變](https://zh.wikipedia.org/wiki/密碼學 "wikilink")，但是實際使用的方法和技巧則隨著密碼學變得越來越復雜而日新月異。密碼學算法和協議從古代只利用紙筆等工具，發展到[第二次世界大戰時的](https://zh.wikipedia.org/wiki/第二次世界大戰 "wikilink")[恩尼格瑪密碼機](https://zh.wikipedia.org/wiki/恩尼格瑪密碼機 "wikilink")（又稱「謎」，[德語](https://zh.wikipedia.org/wiki/德語 "wikilink")：），直到目前的基於[電子計算機的方案](../Page/電子計算機.md "wikilink")。而密碼分析也隨之改變了。無限制地成功破解密碼已經不再可能。事實上，只有很少的攻擊是實際可行的。在上個世紀70年代中期，[公鑰密碼學作為一個新興的密碼學分支發展起來了](https://zh.wikipedia.org/wiki/公鑰密碼學 "wikilink")。而用來破解這些公鑰系統的方法則和以往完全不同，通常需要解決精心構造出來的[純數學問題](https://zh.wikipedia.org/wiki/純數學 "wikilink")。其中最著名的就是大數的[質因數分解](https://zh.wikipedia.org/wiki/整數分解 "wikilink")。

## 密碼分析的歷史

密碼分析和[密碼學是](https://zh.wikipedia.org/wiki/密碼學 "wikilink")[共同演化的](../Page/共同演化.md "wikilink")。這從[密碼學史中可以看得很明顯](https://zh.wikipedia.org/wiki/密碼學史 "wikilink")。總是有新的[密碼機被設計出來並取代已經被破解的設計](https://zh.wikipedia.org/wiki/密碼機 "wikilink")，同時也總是有新的密碼分析方法被發明出來以破解那些改進了的方案。事實上，密碼和密碼分析是同一枚硬幣的正反兩面：為了創建安全的密碼，就必須考慮到可能的密碼分析。

### 經典密碼分析

儘管「密碼分析」這個詞是晚近出現的（1920年由確立），但破解[密碼和](../Page/密碼.md "wikilink")[密碼機的方法卻由來已久](https://zh.wikipedia.org/wiki/密碼機 "wikilink")。世界上最早的破解密碼方法的文字記錄可以追溯到九世紀[阿拉伯](https://zh.wikipedia.org/wiki/阿拉伯 "wikilink")[通才](https://zh.wikipedia.org/wiki/文藝復興人 "wikilink")所著《破解密碼信息》（A
Manuscript on Deciphering Cryptographic
Messages），這篇文章論述了一個[頻率分析的方法](https://zh.wikipedia.org/wiki/頻率分析 "wikilink")。

[頻率分析是破解經典密碼的一個基本方法](https://zh.wikipedia.org/wiki/頻率分析 "wikilink")。在[自然語言裡](https://zh.wikipedia.org/wiki/自然語言 "wikilink")，字母表裡的有些字母比其它的字母出現得更頻繁。例如，在[英語裡](https://zh.wikipedia.org/wiki/英語 "wikilink")，字母[E很有可能是在任何文字樣本裡出現頻率都最高的字母](../Page/E.md "wikilink")。同樣的，TH這兩個字母連起來是最有可能出現的字母對。頻率分析法假設密碼沒有隱藏這樣的統計信息。例如，在簡單的[替換密碼中](https://zh.wikipedia.org/wiki/替換密碼 "wikilink")，每個字母只是簡單地被替換成另一個字母，那麼在密文中出現頻率最高的字母就最有可能是E。
...
卡恩對於密碼分析所作的論斷也許還為時過早。不安全的密碼並沒有絕跡，美國國家情報機構的密碼分析方法也沒有公開過。在[學術界](https://zh.wikipedia.org/wiki/學術界 "wikilink")，新的密碼在不斷地被設計出來，也經常地被破解。1984年，
[分組密碼被一種](https://zh.wikipedia.org/wiki/分組密碼 "wikilink")[唯密文攻擊破解](https://zh.wikipedia.org/wiki/唯密文攻擊 "wikilink")。1998年，原本提出來要取代[DES標准加密算法的分組密碼](https://zh.wikipedia.org/wiki/DES "wikilink")
，也因為被學術界發現了很多類似而且實際可行的攻擊而消亡。在[工業界](https://zh.wikipedia.org/wiki/工業界 "wikilink")，很多密碼也被發現有漏洞。例如，在手機中使用的，以及算法，用一般的計算工具可以在幾小時，幾分鐘內，甚至是實時地被破解。2001年，用來保護無線[Wi-Fi網絡的](../Page/Wi-Fi.md "wikilink")[有線等效加密協議](../Page/有線等效加密.md "wikilink")（或稱**無線加密協議**，即WEP）也可以用[相關鑰匙攻擊來破解](https://zh.wikipedia.org/wiki/相關鑰匙攻擊 "wikilink")。

### 密碼分析的後果

無疑，成功的密碼分析影響了歷史的進程。能夠看懂別人本以為是秘密的想法或計劃，這種能力可以成為決定性的優勢。在戰爭期間尤其如此。例如，在[第一次世界大戰中](https://zh.wikipedia.org/wiki/第一次世界大戰 "wikilink")，成功地破解[齊默爾曼電報是促使](https://zh.wikipedia.org/wiki/齊默爾曼電報 "wikilink")[美國參戰的直接原因](https://zh.wikipedia.org/wiki/美國 "wikilink")。在[第二次世界大戰中](https://zh.wikipedia.org/wiki/第二次世界大戰 "wikilink")，對[德國密碼的成功破解](https://zh.wikipedia.org/wiki/德國 "wikilink")，包括[恩尼格瑪密碼機](https://zh.wikipedia.org/wiki/恩尼格瑪密碼機 "wikilink")（Enigma）和[洛侖茲密碼機](https://zh.wikipedia.org/wiki/洛侖茲密碼機 "wikilink")（Lorenz
Cipher），其後果從使歐洲戰場早幾個月結束，到對整個戰爭起決定性作用，各種說法都有（參見）。[美國也從對](https://zh.wikipedia.org/wiki/美國 "wikilink")[日本的](../Page/日本.md "wikilink")密碼的密碼分析中受益（參見）。

一些國家的政府很早就已經意識到了密碼分析對於情報收集的重要性，不管是對於軍事還是外交都一樣。這些國家還建立了專門破解密碼的機構，如英國[政府通訊總部](https://zh.wikipedia.org/wiki/政府通訊總部 "wikilink")（GCHQ），以及[美國國家安全局](https://zh.wikipedia.org/wiki/美國國家安全局 "wikilink")（NSA）。這些機構在當今都非常活躍。2004年，有報道說美國成功破解了[伊朗的密碼](https://zh.wikipedia.org/wiki/伊朗 "wikilink")。但這是純粹的密碼分析還是有其它因素，目前還不清楚
[2](http://news.bbc.co.uk/1/hi/technology/3804895.stm)。

## 攻擊類型

不同的密碼分析攻擊有不同的效力，對於實際的[密碼系統的威脅也不盡相同](https://zh.wikipedia.org/wiki/密碼系統 "wikilink")。有的時候，對於某個密碼系統的攻擊只是停留在理論上，對於任何實際的密碼系統可能並不適用。這就是所謂的「證書式弱點」（certificational
weakness）。現代密碼分析的學術研究結果大部分都屬於這一類。從根本上說，某種攻擊方式在實際中的有效性取決於它對於以下幾個問題給出的答案：
...
另外，我們通常用[攻擊模式來描述攻擊者可以獲得關於系統信息的方式](https://zh.wikipedia.org/wiki/攻擊模式 "wikilink")。[攻擊模式包括以下幾種](https://zh.wikipedia.org/wiki/攻擊模式 "wikilink")：
  ...
  - [相關鑰匙攻擊](https://zh.wikipedia.org/wiki/相關鑰匙攻擊 "wikilink")：與選擇明文（或密文）攻擊類似。不同的是，攻擊者可以得到被兩個不同的[鑰匙所加密](https://zh.wikipedia.org/wiki/鑰匙 "wikilink")（或解密）得到的密文（或明文）。攻擊者不知道這兩個鑰匙的數值，但知道這兩個鑰匙之間的關係，比如兩個鑰匙之間相差一個-{zh-hans:比特;
    zh-hant:位元;}-。
...
對於密碼分析的結果來說，其有用的程度也各有不同。密碼學家於1998年將對於[分組密碼的攻擊按照獲得的秘密信息的不同分為以下幾類](https://zh.wikipedia.org/wiki/分組密碼 "wikilink")：
  ...
  - 實例（局部）演繹 --
    攻擊者獲得了一些攻擊之前並不知道的[明文](https://zh.wikipedia.org/wiki/明文 "wikilink")（或[密文](https://zh.wikipedia.org/wiki/密文 "wikilink")）。
  - 信息演繹 --
    攻擊者獲得了一些以前不知道的關於[明文或](https://zh.wikipedia.org/wiki/明文 "wikilink")[密文的](https://zh.wikipedia.org/wiki/密文 "wikilink")[香農信息](https://zh.wikipedia.org/wiki/信息論 "wikilink")。
  - 分辨算法 --
    攻擊者能夠區別加密算法和隨機[排列](https://zh.wikipedia.org/wiki/排列 "wikilink")。

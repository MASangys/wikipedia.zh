...
從廣義的角度看，密碼分析這個詞語有時也泛指繞開某個[密碼](../Page/密碼.md "wikilink")學[算法](../Page/算法.md "wikilink")或[密碼協議的嘗試](https://zh.wikipedia.org/wiki/密碼協議 "wikilink")，而不僅僅是針對[加密算法](https://zh.wikipedia.org/wiki/加密 "wikilink")。但是，密碼分析通常不包括並非主要針對密碼算法或協議的攻擊。儘管這些攻擊方式是[計算機安全領域裡的重要考慮因素](https://zh.wikipedia.org/wiki/計算機安全 "wikilink")，而且通常比傳統的密碼分析更加有效。

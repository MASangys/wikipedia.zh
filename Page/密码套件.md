**密码套件**（**Cipher suite**）是[傳輸層安全](https://zh.wikipedia.org/wiki/傳輸層安全協議 "wikilink")（TLS）/安全套接字层（SSL）[网络协议中的一个概念](../Page/网络传输协议.md "wikilink")。在TLS 1.3之前，密码套件的名称是以协商安全设置时使用的[身份验证](https://zh.wikipedia.org/wiki/身份验证 "wikilink")、[加密](https://zh.wikipedia.org/wiki/加密 "wikilink")、[訊息鑑別碼](https://zh.wikipedia.org/wiki/訊息鑑別碼 "wikilink")（MAC）和[密钥交换](../Page/密钥交换.md "wikilink")[算法](../Page/算法.md "wikilink")组成。TLS 1.3中的密码套件格式已经修改。在目前的TLS 1.3草案文档中，密码套件仅用于协商加密和[HMAC算法](../Page/金鑰雜湊訊息鑑別碼.md "wikilink")。\[1\]

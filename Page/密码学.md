...
加解密的具体運作由两部分决定：一个是[算法](../Page/算法.md "wikilink")，另一个是[密钥](https://zh.wikipedia.org/wiki/密钥 "wikilink")。[密钥是一個用於加解密算法的秘密參數](https://zh.wikipedia.org/wiki/密钥 "wikilink")，通常只有通訊者擁有。歷史上，[密钥通常未經](https://zh.wikipedia.org/wiki/密钥 "wikilink")[認證或](https://zh.wikipedia.org/wiki/認證 "wikilink")[完整性測試而被直接使用在](https://zh.wikipedia.org/wiki/完整性 "wikilink")[加解密上](https://zh.wikipedia.org/wiki/密码机 "wikilink")。
...
即每4位取一个字母。其他字母是干扰的。但次传说并未得到证实，因为故事发生的地点在希腊和波斯，但密文却是英文。
...
NIST）制定[數位加密標準](https://zh.wikipedia.org/wiki/數位加密標準 "wikilink")（[DES](https://zh.wikipedia.org/wiki/DES "wikilink")），[惠特菲爾德·迪菲和](../Page/惠特菲爾德·迪菲.md "wikilink")提出的開創性論文，以及公開釋出[RSA](../Page/RSA加密演算法.md "wikilink")。從那個時期開始，密碼學成為通訊、電腦網路、電腦安全等上的重要工具。許多現代的密碼技術的基礎依賴於特定基算問題的困難度，例如[因數分解問題或是](https://zh.wikipedia.org/wiki/因數分解 "wikilink")[離散對數問題](https://zh.wikipedia.org/wiki/離散對數 "wikilink")。許多密碼技術可被證明為只要特定的計算問題無法被有效的解出，那就安全。除了一個著名的例外：[一次性密碼本](../Page/一次性密碼本.md "wikilink")（，OTP），這類證明是偶然的而非決定性的，但是是目前可用的最好的方式。

> 本文内容由[密钥交换](https://zh.wikipedia.org/wiki/密钥交换)转换而来。


**密钥交换**（，也称key establishment）是[密码学](../Page/密码学.md "wikilink")中两方交换[密钥](../Page/密钥.md "wikilink")以允许使用某种[加密](../Page/加密.md "wikilink")[算法](../Page/算法.md "wikilink")的过程。
...
### 拓展阅读
  ...
  - [The possibility of Non-Secret digital encryption](https://web.archive.org/web/20141030210530/https://cryptocellar.web.cern.ch/cryptocellar/cesg/possnse.pdf) J. H. Ellis, January 1970.

  - [Non-Secret Encryption Using a Finite Field](https://web.archive.org/web/20101116234929/http://www.cesg.gov.uk/publications/media/secenc.pdf) MJ Williamson, January 21, 1974.

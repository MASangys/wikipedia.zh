**富比尼定理**（）是[数学分析中有关重积分的一个定理](../Page/数学分析.md "wikilink")，由数学家[圭多·富比尼在](../Page/圭多·富比尼.md "wikilink")1907年提出。富比尼定理给出了使用[逐次积分的方法计算](https://zh.wikipedia.org/wiki/逐次积分 "wikilink")[双重积分的条件](https://zh.wikipedia.org/wiki/双重积分 "wikilink")。在这些条件下，不仅能够用逐次积分计算双重积分，而且交换逐次积分的顺序时，积分结果不变。**Tonelli定理**由数学家

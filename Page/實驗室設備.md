**實驗室設備**是指在[實驗室裡工作人士用的各種各樣的](https://zh.wikipedia.org/wiki/實驗室 "wikilink")[工具和](../Page/工具.md "wikilink")[設備](https://zh.wikipedia.org/wiki/設備 "wikilink")。實驗室設備一般是用作進行實驗或作為測量，和收集資料。**實驗室設備**依實驗室的種類不同，而有不同的設備。

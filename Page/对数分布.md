在[概率论与](https://zh.wikipedia.org/wiki/概率论 "wikilink")[统计学中](../Page/统计学.md "wikilink")，**对数分布**是一种离散[概率分布形式](../Page/概率分布.md "wikilink")，它也称为**对数级数分布**。
...
这样就可以直接导出呈Log(*p*)分布的[随机变量在](../Page/随机变量.md "wikilink")\(k \ge 1\)且\(0<p<1\)时的[概率集聚函数](https://zh.wikipedia.org/wiki/概率集聚函数 "wikilink")：
...
## 参见
  ...
  - [泊松分布](https://zh.wikipedia.org/wiki/泊松分布 "wikilink")（also derived
    from a Maclaurin series）

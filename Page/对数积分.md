**对数积分**\(\operatorname{li}(x)\)是一个[特殊函数](../Page/特殊函数.md "wikilink")。它出现在[物理学的问题中](../Page/物理学.md "wikilink")，在[数论中也有重要性](../Page/数论.md "wikilink")，主要出現在與[質數定理與](../Page/質數定理.md "wikilink")[黎曼猜想的相關理論之中](../Page/黎曼猜想.md "wikilink")。
...
在这里，ln表示[自然对数](../Page/自然对数.md "wikilink")。函数1/ln (*t*)在*t* =
1处有一个[奇点](../Page/奇点.md "wikilink")，当*x* \>
...
...。这个数称为[Ramanujan-Soldner常数](../Page/Ramanujan-Soldner常数.md "wikilink")。

\[\operatorname{li}(2) = -(\Gamma\left(0,-\ln 2\right) + i\,\pi) \sim 1.04516 37801 17492 78484 45888 89194 613136 522615 578151\]

其中\(\Gamma\left(a,x\right)\)是[不完全伽玛函数](../Page/不完全伽玛函数.md "wikilink")。
...
...是[欧拉-马歇罗尼常数](../Page/欧拉-马歇罗尼常数.md "wikilink")。一个收敛得更快的级数，是：
...
其中\(\mathcal{O}\)是[大O符号](../Page/大O符号.md "wikilink")。完整的[渐近展开式为](../Page/渐近展开式.md "wikilink")：

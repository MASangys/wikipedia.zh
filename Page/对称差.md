...
[数学上](../Page/数学.md "wikilink")，两个[集合的](https://zh.wikipedia.org/wiki/集合 "wikilink")**对称差**是只属于其中一个集合，而不属于另一个集合的元素组成的集合。
[集合论中的这个运算相当于](../Page/集合论.md "wikilink")[布尔逻辑中的](../Page/布尔逻辑.md "wikilink")[异或运算](https://zh.wikipedia.org/wiki/异或 "wikilink")。

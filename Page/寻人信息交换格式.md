**寻人信息交换格式**（People Finder Interchange
Format，**PFIF**）是一种广泛使用的开放数据标准，该标准可用于登记失踪人员或流离失所人员的信息。PFIF被设计为可以在政府机构，救援组织，以及其他幸存者登记处之间实现信息共享，以帮助人们在灾难发生后找到和联系他们的家人和朋友。
...
下列网站和软件项目使用PFIF：
  ...
  - [Google寻人工具](https://zh.wikipedia.org/wiki/Google寻人工具 "wikilink")
  - [Sahana
    Eden](https://zh.wikipedia.org/wiki/Sahana_FOSS_Disaster_Management_System "wikilink")
  - [National Library of Medicine People
    Locator](https://web.archive.org/web/20160311005819/https://pl.nlm.nih.gov/index.php)
  - [Ushahidi](https://zh.wikipedia.org/wiki/Ushahidi#Ushahidi "wikilink")
  - [PFIF .NET Library](http://code.google.com/p/pfifnet/)
  - [XML::PFIF Perl module](http://erislabs.net/ianb/projects/pfif/)

[Cat:XML](https://zh.wikipedia.org/wiki/Cat:XML "wikilink")
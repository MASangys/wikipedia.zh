...
**對數平均**是一個二個非負[數字的](../Page/數字.md "wikilink")[數學函數](https://zh.wikipedia.org/wiki/數學函數 "wikilink")，等於兩者的[差除以其](https://zh.wikipedia.org/wiki/差 "wikilink")[對數的差](https://zh.wikipedia.org/wiki/對數 "wikilink")。其符號為：
...
因為指數函數為[單調函數](https://zh.wikipedia.org/wiki/單調函數 "wikilink")，長度為1區間的的積分會在\(x\)和\(y\)之間。積分算子的[齐次性轉移到平均算子](../Page/齐次函数.md "wikilink")，因此\(L(c\cdot x, c\cdot y) = c\cdot L(x,y)\).

## 推廣

### 微分的均值定理

對數平均可推廣到\(n+1\)變數，考慮對數n階[導數的](https://zh.wikipedia.org/wiki/導數 "wikilink")。

**對數平均溫差**（logarithmic mean temperature
difference）簡稱為**LMTD**，是在[传热流體系統](../Page/传热.md "wikilink")（例如[熱交換器中](../Page/熱交換器.md "wikilink")）用來分析溫度推動力的工具。對數平均溫差是在雙管換熱器中冷端及熱端[溫度差的](../Page/溫度.md "wikilink")[對數平均](../Page/對數平均.md "wikilink")。對數平均溫差越大，表示传热量越大。在分析固定流速及流體熱力學性質的熱交換器時，就會出現對數平均溫差。
...
其中
  ...
  -
    ...
    *U*為[传热系数](../Page/传热系数.md "wikilink")（單位 J/
    [K](../Page/克爾文.md "wikilink") m<sup>2</sup>）
    *Ar*為熱交換面積
...
若熱交換器是並流（熱蒸氣及冷蒸氣平行，都從某一側進，從另一側出）或是[逆流](../Page/逆流熱交換.md "wikilink")（熱蒸氣及冷蒸氣平行，但各由一側進，從另一側出），以上的式子都會成立。

若是交叉流（cross-flow）熱交換器，也就是熱交換器中有[散熱片](../Page/散熱片.md "wikilink")，上面的溫度接近定值，其熱交換量和LMTD也會有類似的關係，不過會出現修正係數。若是結構比較複雜的熱交換器（例如），也會有修正係數。

## 推導

假設熱傳導是在沿著*z*軸上，從*A*點到*B*點的熱交換器上進行，熱傳導是在二種流體之間交換能量，分別標示為*1*和*2*，沿著*z*軸的熱量分別是T<sub>1</sub>(z)和
T<sub>2</sub>(z)。
...
流體釋放的熱會依[傅立葉定律產生溫度梯度](../Page/傅立葉定律.md "wikilink")：
...
## 假設及限制
  ...
  - 假設二流體溫度的變化率和其溫差成正比，這對固定[比熱的流體有效](../Page/比熱.md "wikilink")，流體的溫度變化若在一個較小的範圍，此假設成立，不過若比熱有變化，用計算對數平均溫差計算的熱交換量就不準了。
  - LMTD不適用在[冷凝器及](../Page/冷凝器.md "wikilink")中，其中包括了相變化及其[潛熱](../Page/潛熱.md "wikilink")，因此假設無效。

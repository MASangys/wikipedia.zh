...
difference）簡稱為**LMTD**，是在[传热流體系統](https://zh.wikipedia.org/wiki/传热 "wikilink")（例如[熱交換器中](https://zh.wikipedia.org/wiki/熱交換器 "wikilink")）用來分析溫度推動力的工具。對數平均溫差是在雙管換熱器中冷端及熱端[溫度差的](https://zh.wikipedia.org/wiki/溫度 "wikilink")[對數平均](../Page/對數平均.md "wikilink")。對數平均溫差越大，表示传热量越大。在分析固定流速及流體熱力學性質的熱交換器時，就會出現對數平均溫差。
...
其中
  ...
  -
    ...
    *U*為[传热系数](https://zh.wikipedia.org/wiki/传热系数 "wikilink")（單位 J/
    [K](https://zh.wikipedia.org/wiki/克爾文 "wikilink") m<sup>2</sup>）
    *Ar*為熱交換面積

**對角矩陣**（）是一個[主對角線之外的元素皆為](https://zh.wikipedia.org/wiki/主對角線 "wikilink")0的[矩陣](https://zh.wikipedia.org/wiki/矩陣 "wikilink")。對角線上的元素可以為0或其他值。因此n行n列的矩陣\(\mathbf{D}\)
...
## 性质
  ...
  - 一對角矩陣 \(\text{diag}\left (a_1, \dots, a_n \right )\)
    的[特徵值為](https://zh.wikipedia.org/wiki/特徵值 "wikilink")
    \(a_1, \dots, a_n\)，其[特徵向量為](https://zh.wikipedia.org/wiki/特徵向量 "wikilink")[單位向量](https://zh.wikipedia.org/wiki/單位向量 "wikilink")

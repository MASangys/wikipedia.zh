...
## 软件
  ...
  - SIP客户端：
      ...
      - [OpenWengo](http://www.openwengo.com/)一个开源的SIP客户端，运行在Windows和Linux上。Mac OS X和PocketPC版本稍后推出。

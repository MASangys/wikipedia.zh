...
Kangas发明了*bookmarklet*这个词\[1\]，之后他在[Netscape的JavaScript指南中的某些内容上产生了自己的创意](https://zh.wikipedia.org/wiki/Netscape "wikilink")\[2\]。最早的一个词语是**favelet**在2001年9月6日被[坦塔克·塞里克所使用](https://zh.wikipedia.org/wiki/坦塔克·塞里克 "wikilink")。而在Netscape发明[JavaScript的](../Page/JavaScript.md "wikilink")[布蘭登·艾克这样说明小书签的来历](../Page/布蘭登·艾克.md "wikilink")：
...
小书签的存储与使用和普通书签一致。如同它们的名字，小书签是一种十分易用的工具。例如：
  ...
  - 快速调用[搜索引擎搜索当前页面选中的文字](https://zh.wikipedia.org/wiki/搜索引擎 "wikilink")
...
3.  [Mozilla
    ...
    [Safari](../Page/Safari.md "wikilink"),和[Chrome上运行且不支持IE](https://zh.wikipedia.org/wiki/Chrome "wikilink").原始来源：[Alex

...
另一個小波轉換在生醫領域的應用則是應用在[腦電圖上](https://zh.wikipedia.org/wiki/腦波分析 "wikilink")，早期腦電圖訊號分析技術，普遍以傅利葉轉換為主，近年來，小波轉換技術逐漸被採用，其特性在對於未知訊號的頻率分佈，在時間軸上可以得到很好的解析度，適合應用於腦波的不穩定訊號分析處理。再配合類神經網路非線性分辨能力，可有效分辨α波、β波。

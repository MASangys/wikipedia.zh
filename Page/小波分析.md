...
小波理論和幾個其他課題相關。所有小波變換可以視為[時域頻域表示的形式](https://zh.wikipedia.org/wiki/時域頻域表示 "wikilink")，所以和[調和分析](../Page/調和分析.md "wikilink")相關。所有實際有用的「離散小波變換」使用包含[有限脈衝響應濾波器的濾波器段](https://zh.wikipedia.org/wiki/有限脈衝響應 "wikilink")（filter band）。構成CWT的小波受[海森堡的](https://zh.wikipedia.org/wiki/海森堡 "wikilink")[測不準原理制約](https://zh.wikipedia.org/wiki/測不準原理 "wikilink")，或者說，離散小波基可以在[測不準原理的其他形式的情境中考慮](https://zh.wikipedia.org/wiki/不確定性原理 "wikilink")。

...
尤達條件式將表達式的常量部份放在條件語句的左側。這個風格的名稱源於[星際大戰絕地大師](../Page/星際大戰.md "wikilink")[尤達的角色](../Page/尤達.md "wikilink")，他以非標準語法講英語。
...
大約是[賓主動語序](../Page/賓主動語序.md "wikilink")（例如，“當九百歲你活到，看起來很好你將不”）。
...
藉由定義賦值表達式不會被評估就沒有任何值，在這種情況是不可能發生這類錯誤的。許多編譯器會對如`if (myNumber
= 42)`的源碼發出警示訊息（例如，GCC`-Wall`選項會警告括號語句中的賦值為真），讓程序員發現可能的錯誤點。

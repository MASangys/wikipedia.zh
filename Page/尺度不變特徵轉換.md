...
**SIFT**)是一種[机器視覺的演算法用來偵測與描述影像中的局部性特徵](https://zh.wikipedia.org/wiki/机器視覺 "wikilink")，它在空間尺度中尋找極值點，並提取出其位置、尺度、旋轉不變數，此演算法由
[David
Lowe](https://zh.wikipedia.org/wiki/David_Lowe_\(computer_scientist\) "wikilink")
在1999年所發表，2004年完善總結。 \[1\] 後續的論文中也有許多基於 SIFT 改進的論文，例如
[SURF](https://zh.wikipedia.org/wiki/加速穩健特徵 "wikilink") 將 SIFT
...
此演算法有其專利，專利擁有者為
[英屬哥倫比亞大學](https://zh.wikipedia.org/wiki/英屬哥倫比亞大學 "wikilink")。\[2\]
...
detection)的一種變形，也就是使用[拉普拉斯運算元來求出各個倍率及空間中的最大值](https://zh.wikipedia.org/wiki/拉普拉斯運算元 "wikilink")。高斯差可近似為拉普拉斯運算元運算後的結果，因建立[高斯金字塔的過程是一種尺寸正規化拉普拉斯運算的近似](../Page/高斯金字塔.md "wikilink")。

...
的許多過程近似，達到加速的效果；PCA-SIFT利用[主成分分析](../Page/主成分分析.md "wikilink")降低描述子的維度，減少記憶體的使用並加快配對速度。
...
detection)的一種變形，也就是使用[拉普拉斯運算元來求出各個倍率及空間中的最大值](https://zh.wikipedia.org/wiki/拉普拉斯運算元 "wikilink")。高斯差可近似為拉普拉斯運算元運算後的結果，因建立[高斯金字塔](../Page/高斯金字塔.md "wikilink")的過程是一種尺寸正規化拉普拉斯運算的近似。

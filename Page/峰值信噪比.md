...
位线性[脉冲编码调制表示](https://zh.wikipedia.org/wiki/脉冲编码调制 "wikilink")，那么
*MAX<sub>I</sub>* 就是

\[2^B-1\].

对于每点有[RGB三个值的](https://zh.wikipedia.org/wiki/RGB "wikilink")[彩色图像来说峰值信噪比的定义类似](https://zh.wikipedia.org/wiki/彩色图像 "wikilink")，只是均方误差是所有方差之和除以图像尺寸再除以
3。

...
以往[PLC會利用開放式或專有的通訊協定和從站通訊](../Page/可编程逻辑控制器.md "wikilink")，這類的通訊協定包括[Modbus](../Page/Modbus.md "wikilink")、[Sinec H1](https://zh.wikipedia.org/wiki/Sinec_H1 "wikilink")、[Profibus](https://zh.wikipedia.org/wiki/Profibus "wikilink")、[CANopen](../Page/CANopen.md "wikilink")、[DeviceNet](../Page/DeviceNet.md "wikilink")或[FOUNDATION Fieldbus](https://zh.wikipedia.org/wiki/FOUNDATION_Fieldbus "wikilink")。不過越來越多的使用者開始改用乙太網為其[数据链路层](../Page/数据链路层.md "wikilink")的通訊協定，而[應用層仍使用上述的通訊協定](https://zh.wikipedia.org/wiki/應用層 "wikilink")。

...
**工業乙太網**是指在[工業環境的](https://zh.wikipedia.org/wiki/工業 "wikilink")[自動化控制及程序控制中應用](https://zh.wikipedia.org/wiki/自動化控制 "wikilink")[乙太網的相關元件及技術](https://zh.wikipedia.org/wiki/以太網 "wikilink")。工業乙太網會採用[TCP/IP協定](https://zh.wikipedia.org/wiki/TCP/IP "wikilink")，和[IEEE
802.3標準相容](https://zh.wikipedia.org/wiki/IEEE_802.3 "wikilink")，但在[應用層會加入各自特有的協定](https://zh.wikipedia.org/wiki/應用層 "wikilink")\[1\]。
...
以往[PLC會利用開放式或專有的通訊協定和從站通訊](../Page/可编程逻辑控制器.md "wikilink")，這類的通訊協定包括[Modbus](../Page/Modbus.md "wikilink")、[Sinec
H1](https://zh.wikipedia.org/wiki/Sinec_H1 "wikilink")、[Profibus](https://zh.wikipedia.org/wiki/Profibus "wikilink")、[CANopen](../Page/CANopen.md "wikilink")、[DeviceNet或](../Page/DeviceNet.md "wikilink")[FOUNDATION
Fieldbus](https://zh.wikipedia.org/wiki/FOUNDATION_Fieldbus "wikilink")。不過越來越多的使用者開始改用乙太網為其[数据链路层的通訊協定](../Page/数据链路层.md "wikilink")，而[應用層仍使用上述的通訊協定](https://zh.wikipedia.org/wiki/應用層 "wikilink")。
...
相較於以[RS-232或](https://zh.wikipedia.org/wiki/RS-232 "wikilink")[RS-485為基礎的工業網路](https://zh.wikipedia.org/wiki/RS-485 "wikilink")，工業乙太網有以下的優點：
  ...
  - 提昇傳輸速率，RS-232的速率為9.6
    kbit/秒，若是[吉比特以太网](../Page/吉比特以太网.md "wikilink")，使用[CAT-5e](../Page/CAT-5.md "wikilink")、[CAT-6的網路線或](../Page/CAT-6.md "wikilink")[光纖為傳輸介質](https://zh.wikipedia.org/wiki/光纖 "wikilink")，傳輸速率可以到1Gbit/秒。
  - 傳輸距離可以拉長。
...
以下是應用工業乙太網時的缺點：
  ...
  - 需將既有的系統轉換為另一個新的通訊協定。
  - 及時控制使用像[TCP協議時](../Page/传输控制协议.md "wikilink")，有許多不便之處（有些應用因此使用[UDP或其他](../Page/用户数据报协议.md "wikilink")[数据链路层的協定](../Page/数据链路层.md "wikilink")）

...
在[上下文無關文法內裡的說法](https://zh.wikipedia.org/wiki/上下文無關文法 "wikilink")，若一個非終端符號（non-terminal）`r`有任何直接的文法規則或者透過多個文法規則，推導出的句型（sentential
...
這規則的*[遞歸下降分析器](https://zh.wikipedia.org/wiki/遞歸下降分析器 "wikilink")*(recursive
...
[遞歸下降分析器進行](https://zh.wikipedia.org/wiki/遞歸下降分析器 "wikilink")[語法分析](../Page/語法分析器.md "wikilink")，除非將文法轉變為[weakly
equivalent](https://zh.wikipedia.org/wiki/Weak_equivalence "wikilink")
的右遞歸形式
(相對的，在[LALR分析器裡面則比較偏好左遞歸](https://zh.wikipedia.org/wiki/LALR "wikilink")，因為比起右遞歸來說會使用比較少的[堆疊](https://zh.wikipedia.org/wiki/堆疊 "wikilink"))；然而，比較複雜的由上而下(top-down)語法分析器裡面可以藉由使用縮減(by
use of
curtailment)來實做一般的[上下文無關文法](https://zh.wikipedia.org/wiki/上下文無關文法 "wikilink")。
...
如果使用[YACC](https://zh.wikipedia.org/wiki/YACC "wikilink")
或者[Bison](https://zh.wikipedia.org/wiki/GNU_bison "wikilink")，他們有所謂*算符宣告*(operator
declarations)， %left, %right and
%nonassoc，這一些算符可以告訴[語法分析器產生程式](https://zh.wikipedia.org/wiki/語法分析器產生程式 "wikilink")(parser
generator)應該遵從哪一種結合。
...
1.  \[<http://www.cs.may.ie/~jpower/Courses/parsing/parsing.pdf#search='indirect%20left%20recursion>'
    ...
    Ireland.[JPR02](https://zh.wikipedia.org/wiki/JPR02 "wikilink")
2.
3.
4.
5.
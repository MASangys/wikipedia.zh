**差分**，又名**差分[函數](../Page/函數.md "wikilink")**或**差分[運算](../Page/運算.md "wikilink")**，是数学中的一个概念。它将原函数
\(\ f(x)\) [映射到](../Page/映射.md "wikilink")
\(\ f(x+a)-f(x+b)\)。差分運算，相應於微分運算，是[微积分中重要的一个概念](../Page/微积分.md "wikilink")。
...
在微积分学中的有限差分（finite
differences），前向差分通常是[微分在](../Page/微分.md "wikilink")[离散的函数中的等效运算](../Page/离散.md "wikilink")。[差分方程的解法也与](../Page/差分方程.md "wikilink")[微分方程的解法相似](../Page/微分方程.md "wikilink")。当\(\ f(x)\)是[多项式时](../Page/多项式.md "wikilink")，前向差分为Delta算子（称\(\Delta\)为差分[算子](../Page/算子.md "wikilink")\[2\]），一种[线性算子](../Page/线性算子.md "wikilink")。前向差分会将多项式阶数降低
1。
...
其中，\(\ {n \choose i}\)为[二项式系数](../Page/二项式系数.md "wikilink")。

特别的，有

\[\ \Delta^2 [f](x) = f(x+2) - 2f(x+1) + f(x)\]

前向差分有时候也称作[数列的](../Page/数列.md "wikilink")[二项式变换](../Page/二项式变换.md "wikilink")

## 差分的性质

对比[解析函数中的](../Page/解析函数.md "wikilink")[微分的属性](../Page/微分.md "wikilink")，差分的性质有：

  - 如果C为[常数](../Page/常数.md "wikilink")，则有

\[\Delta C=0\]

  - [线性](../Page/线性.md "wikilink")：如果 \(\ a\) 和 \(\ b\) 为常数，则有
...
**牛頓插值公式**也叫做**[牛頓級數](../Page/牛頓多項式.md "wikilink")**，由“牛頓前向[差分方程](../Page/差分方程.md "wikilink")”的項組成，得名於[伊薩克·牛頓爵士](../Page/伊薩克·牛頓.md "wikilink")，最早发表为他在1687年出版的《[自然哲學的數學原理](../Page/自然哲學的數學原理.md "wikilink")》中第三編“宇宙體系”的引理五\[3\]，此前[詹姆斯·格雷果里於](../Page/詹姆斯·格雷果里.md "wikilink")1670年和牛頓於1676年已經分別獨立得出這個成果。一般稱其為連續[泰勒展開的離散對應](../Page/泰勒級數.md "wikilink")。
...
\\end{align} </math>
這成立於任何[多項式函數和大多數但非全部](../Page/多項式.md "wikilink")[解析函數](../Page/解析函數.md "wikilink")。這裡的表達式

\[{x \choose k} = \frac{(x)_k}{k!} \quad\quad (x)_k=x(x-1)(x-2)\cdots(x-k+1)\]
是[二項式係數](../Page/二項式係數.md "wikilink")，其中的(x)<sub>k</sub>是“[下降階乘冪](../Page/下降階乘冪.md "wikilink")”，[空積](../Page/空積.md "wikilink")(*x*)<sub>0</sub>被定義為1。這裡的Δ<sup>k</sup>\[f\](x)是“前向差分”的特定情況，即間距h=1。

### 實例

為了展示牛頓的這個公式是如何使用的，舉例[數列](../Page/數列.md "wikilink") 1, 4,
...
## 参见
  ...
  - [牛顿级数表](../Page/牛顿级数表.md "wikilink")
  - [泰勒级数](../Page/泰勒级数.md "wikilink")
  - [时标微积分](../Page/时标微积分.md "wikilink")
  - [分部求和法](../Page/分部求和法.md "wikilink")

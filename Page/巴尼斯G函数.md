**巴尼斯G函数**是[超级阶乘函数在](../Page/階乘#超級階乘.md "wikilink")[复数上的扩展](../Page/复数_\(数学\).md "wikilink")。它与[Γ函数](../Page/Γ函数.md "wikilink")、[K函数以及](../Page/K函数.md "wikilink")[格莱舍常数](../Page/格莱舍常数.md "wikilink")（Glaisher
constant）有关。以[数学家](../Page/数学家.md "wikilink")[欧尼斯特·巴尼斯](../Page/欧尼斯特·巴尼斯.md "wikilink")（Ernest
William Barnes）的名字命名。\[1\]

巴尼斯G函数可以通用[魏尔施特拉斯分解定理的形式定义为](../Page/魏尔施特拉斯分解定理.md "wikilink")：
...
巴尼斯G函数满足[差分方程](../Page/差分方程.md "wikilink")
...
其中\(\zeta^\prime\)表示[黎曼ζ函数的](../Page/黎曼ζ函数.md "wikilink")[导函数](../Page/导函数.md "wikilink")，\(A\)则表示为格莱舍常数。

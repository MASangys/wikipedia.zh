**巴特沃斯滤波器**是一种的[频率响应](../Page/频率响应.md "wikilink")曲线很平坦的。它也被称作**最大平坦滤波器**。这种滤波器最先由[英国](https://zh.wikipedia.org/wiki/英国 "wikilink")[工程师](../Page/工程师.md "wikilink")、[物理学家](../Page/物理学家.md "wikilink")在1930年发表的论文《滤波器放大器理论研究》中提出的。\[1\]

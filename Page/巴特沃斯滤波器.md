**巴特沃斯滤波器**是一种的[频率响应曲线很平坦的](../Page/频率响应.md "wikilink")。它也被称作**最大平坦滤波器**。这种滤波器最先由[英国](../Page/英国.md "wikilink")[工程师](../Page/工程师.md "wikilink")、[物理学家](../Page/物理学家.md "wikilink")在1930年发表的论文《滤波器放大器理论研究》中提出的。\[1\]
...
在对数[波特图上](../Page/波特图.md "wikilink")，从某一边界角频率开始，振幅随着角频率的增加而线性减少至负无穷。

一阶巴特沃斯滤波器的衰减率为每[倍频](../Page/純八度.md "wikilink")6 dB，每十倍频20
dB（所有一阶低通滤波器具有相同的归一化频率响应）。二阶巴特沃斯滤波器的衰减率为每倍频12
dB、 三阶巴特沃斯滤波器的衰减率为每倍频18 dB、如此类推。巴特沃斯滤波器的振幅是 ω
...
我们希望能够（通过[拉普拉斯变换](../Page/拉普拉斯变换.md "wikilink")）确定传递函数 *H(s)*，其中
\(s=\sigma+j\omega\)。根据
\(\left|H(s)\right|^2 = H(s)\overline{H(s)}\)，及拉普拉斯变换在虚轴
\(s=j\omega\) 上的性质 \(H(-j\omega) = \overline{H(j\omega)}\)，若选取 H(s) 满足：
...
上述表达式的 *n*
个[极点等距离地分布在](../Page/极点.md "wikilink")[半径为](../Page/半径.md "wikilink")
...
其中：
  ...
  - *G* 表示滤波器的放大率，
  - *H* 表示 [傳遞函數](../Page/傳遞函數.md "wikilink")，
  - *j* 是 [虚数单位](../Page/虚数单位.md "wikilink")，
  - *n* 表示滤波器的级数，
  - ω 是信号的 [角频率](../Page/角频率.md "wikilink")，以弧度/秒 为单位，
...
**k**阶巴特沃斯滤波器的[考尔第一型电子线路图如下](../Page/考尔第一型.md "wikilink"): 其中：

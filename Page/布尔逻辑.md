**布尔逻辑**（）得名于[乔治·布尔](../Page/乔治·布尔.md "wikilink")，他是[爱尔兰](../Page/爱尔兰.md "wikilink")[科克的皇后学院的英国数学家](https://zh.wikipedia.org/wiki/科克 "wikilink")，他在[十九世纪中叶首次定义了逻辑的代数系统](https://zh.wikipedia.org/wiki/十九世纪 "wikilink")。现在，布尔逻辑在电子学、计算机硬件和软件中有很多应用。在1937年，[克劳德·艾尔伍德·香农展示了布尔逻辑如何在](https://zh.wikipedia.org/wiki/克劳德·艾尔伍德·香农 "wikilink")[电子学中使用](../Page/电子学.md "wikilink")。
...
[德·摩根定律](https://zh.wikipedia.org/wiki/德·摩根定律 "wikilink") |-
|\(\lnot \lnot a = a\) | |
...
+表示或，\(\cdot\)表示与（因为在某些方面这些运算类似于在其他[代数结构中的加法和乘法](../Page/代数结构.md "wikilink")，并且这种记号使熟悉普通代数的人易于得到[积之和范式](https://zh.wikipedia.org/wiki/积之和范式 "wikilink")）。非也表示为在要否定的表达式顶上的一个横线。
...
布尔逻辑还在[电子工程中的电路设计中使用](../Page/电子工程.md "wikilink")；这里的0和1表示在[数字电路中某一个](../Page/数字电路.md "wikilink")[位的不同状态](https://zh.wikipedia.org/wiki/位 "wikilink")，典型的是高和低[电压](https://zh.wikipedia.org/wiki/电压 "wikilink")。使用包含变量的表达式描述电路，并且对于这些变量的所有的值两个这种表达式是等价的，当且仅当对应的电路有相同的输入-输入行为。进一步的说，每种可能的输入-输出行为都被建模为适合的布尔表达式。
...
[en:Boolean
logic](https://zh.wikipedia.org/wiki/en:Boolean_logic "wikilink")

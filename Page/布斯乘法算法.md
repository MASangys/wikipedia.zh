**布斯乘法算法**（）是[计算机中一种利用数的](https://zh.wikipedia.org/wiki/计算机 "wikilink")[2的补码形式来计算乘法的算法](https://zh.wikipedia.org/wiki/二补数 "wikilink")。该算法由[安德鲁·唐纳德·布思于](https://zh.wikipedia.org/wiki/安德鲁·唐纳德·布思 "wikilink")1950年发明，当时他在[伦敦大学](https://zh.wikipedia.org/wiki/伦敦大学 "wikilink")[柏贝克学院做](https://zh.wikipedia.org/wiki/柏贝克学院 "wikilink")[晶体学研究](../Page/晶体学.md "wikilink")。布斯曾使用过一种[台式计算器](../Page/计算器.md "wikilink")，由于用这种计算器来做移位计算比加法快，他发明了该算法来加快计算速度。布斯算法在[计算机体系结构学科中备受关注](https://zh.wikipedia.org/wiki/计算机体系结构 "wikilink")。

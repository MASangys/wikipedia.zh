...
[量子力學中](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，以[自旋物理與](../Page/自旋.md "wikilink")[核磁共振專家](../Page/核磁共振.md "wikilink")[费利克斯·布洛赫](../Page/费利克斯·布洛赫.md "wikilink")（Felix
...
對量子位元這樣的二階量子系統而言，其存在的可能狀態\(|\psi \rangle\)（採用[狄拉克標記的](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")[右矢表示](https://zh.wikipedia.org/wiki/右矢 "wikilink")）可以由兩個互相[正交的](../Page/正交.md "wikilink")[基底以](https://zh.wikipedia.org/wiki/基底 "wikilink")[複數](https://zh.wikipedia.org/wiki/複數 "wikilink")[線性疊加所構成](https://zh.wikipedia.org/wiki/態疊加原理 "wikilink")，這兩個基底可以選用\(|0 \rangle\)和\(|1 \rangle\)為代表。在物理實作上，\(|0 \rangle\)和\(|1 \rangle\)代表了做[投影式量子測量所會得到的唯二結果](../Page/量子測量.md "wikilink")。
...
**布洛赫球**（Bloch
ball）是**布洛赫球面**的擴充，[混合態](https://zh.wikipedia.org/wiki/混合態 "wikilink")（mixed
state）會出現在球內（離球心距離\<1的點）而不是球面上。\[2\]\[3\]並可從此推論出球心該點所代表的量子狀態是**最大混合態**（maximally
mixed
state），用[密度矩陣形式及](../Page/密度矩陣.md "wikilink")[狄拉克標記表示即](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")（另見「[量子位元](../Page/量子位元.md "wikilink")」）：
...
可以看到这是兩個彼此正交的[純態以恰好一半一半的比例構成](../Page/純態.md "wikilink")[混合態](https://zh.wikipedia.org/wiki/混合態 "wikilink")。

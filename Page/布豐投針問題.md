...
18世紀，[布豐提出以下問題](https://zh.wikipedia.org/wiki/布豐 "wikilink")：設我們有一個以[平行且等距木紋舖成的地板](../Page/平行.md "wikilink")（如右圖），現在隨意拋一支長度比木紋之間距離小的[針](../Page/針.md "wikilink")，求針和其中一條木紋相交的概率。這就是**布豐投針問題**（又译“蒲丰投針問題”）。

使用[積分幾何能找到此題的解](../Page/微分几何.md "wikilink")，並得出一個求[π的](https://zh.wikipedia.org/wiki/圓周率 "wikilink")[蒙特·卡羅方法](https://zh.wikipedia.org/wiki/蒙特·卡羅方法 "wikilink")。

## 解法

設針的長度是\(\ell\)，平行線之間的距離為\(t\)，\(x\)為針的中心和最近的平行線的距離，\(\theta\)為針和線之間的[銳角](https://zh.wikipedia.org/wiki/銳角 "wikilink")。

\(x \in [0,t/2]\)且[均匀分布](https://zh.wikipedia.org/wiki/均匀分布 "wikilink")，其[機率密度函數為](../Page/機率密度函數.md "wikilink")\(\frac{2}{t}\)。

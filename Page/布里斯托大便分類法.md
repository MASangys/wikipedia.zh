...
Scale）是一種為了[醫學上的需求而設計的分類法](https://zh.wikipedia.org/wiki/醫學 "wikilink")，它將人類的[大便分為七類](https://zh.wikipedia.org/wiki/大便 "wikilink")。設計者為[-{布里斯托}-大學](https://zh.wikipedia.org/wiki/布里斯托大學 "wikilink")（University
of Bristol）的希頓（Heaton）和路易斯（Lewis），首篇於1997年發表在《北歐腸胃病學雜誌》（Scandinavian
Journal of
Gastroenterology）上。因為大便的形狀和其待在[大腸內的時間有關](https://zh.wikipedia.org/wiki/大腸 "wikilink")，所以可以用它來判斷食物經過大腸所需的時間。
...
第一型和第二型表示有[便秘](../Page/便秘.md "wikilink")；第三型和第四型是理想的便形，尤其第四型是最容易[排便的形狀](https://zh.wikipedia.org/wiki/排便 "wikilink")；第五至第七型則有[腹瀉的可能](../Page/腹瀉.md "wikilink")。

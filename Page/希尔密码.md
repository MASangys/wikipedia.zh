**希爾密碼**是運用基本[矩陣論原理的](https://zh.wikipedia.org/wiki/矩陣論 "wikilink")[替換密碼](https://zh.wikipedia.org/wiki/替換密碼 "wikilink")，由Lester
S. Hill在1929年發明。

每個字母當作26進制數字：A=0, B=1, C=2...
一串字母當成n維向量，跟一個n×n的矩陣相乘，再將得出的結果[模26](../Page/同餘.md "wikilink")。

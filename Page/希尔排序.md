[Shell_sorting_algorithm_color_bars.svg](https://zh.wikipedia.org/wiki/File:Shell_sorting_algorithm_color_bars.svg "fig:Shell_sorting_algorithm_color_bars.svg") **希爾排序**，也稱**遞減增量排序算法**，是[插入排序](../Page/插入排序.md "wikilink")的一種更高效的改進版本。希爾排序是非穩定排序算法。

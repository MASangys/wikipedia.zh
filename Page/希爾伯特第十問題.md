...
這裡[德文的方法](https://zh.wikipedia.org/wiki/德文 "wikilink")（），就是[英文所謂的](https://zh.wikipedia.org/wiki/英文 "wikilink")[演算法](https://zh.wikipedia.org/wiki/演算法 "wikilink")（）。對於演算法的概念我們是不陌生的，例如遠在[古希臘時代](https://zh.wikipedia.org/wiki/古希臘 "wikilink")，人們就知道可以使用[輾轉相除法](https://zh.wikipedia.org/wiki/輾轉相除法 "wikilink")，求兩個自然數的[最大公約數](https://zh.wikipedia.org/wiki/最大公約數 "wikilink")。還有，任給一個自然數，也存在著一個方法，在有限步驟內，可以判定這個數是不是[質數](https://zh.wikipedia.org/wiki/質數 "wikilink")。

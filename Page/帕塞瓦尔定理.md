...
Parseval在](https://zh.wikipedia.org/wiki/:en:Marc-Antoine_Parseval "wikilink")1799年所得到的一个有关[级数的定理](../Page/级数.md "wikilink")，该定理随后被应用于[傅里叶级数](../Page/傅里叶级数.md "wikilink")。它也被称为**瑞利能量定理**或**瑞利恒等式**，以物理学家[瑞利命名](https://zh.wikipedia.org/wiki/约翰·斯特拉特，第三代瑞利男爵 "wikilink")。

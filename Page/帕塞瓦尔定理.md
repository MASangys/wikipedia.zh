在[数学中](../Page/数学.md "wikilink")，**帕塞瓦尔定理**（或称**帕塞瓦尔等式**），经常指“[傅里叶转换是](https://zh.wikipedia.org/wiki/傅里叶转换 "wikilink")[幺正算符](../Page/幺正算符.md "wikilink")”这一结论；简而言之，就是说函数平方的和（或积分）等于其傅里叶转换式平方之和（或者积分）。这个定理产生于[Marc-Antoine
Parseval在](https://zh.wikipedia.org/wiki/:en:Marc-Antoine_Parseval "wikilink")1799年所得到的一个有关[级数的定理](../Page/级数.md "wikilink")，该定理随后被应用于[傅里叶级数](../Page/傅里叶级数.md "wikilink")。它也被称为**瑞利能量定理**或**瑞利恒等式**，以物理学家[约翰·斯特拉特，第三代瑞利男爵命名](https://zh.wikipedia.org/wiki/约翰·斯特拉特，第三代瑞利男爵 "wikilink")。
...
的[连续傅立叶变换](https://zh.wikipedia.org/wiki/连续傅立叶变换 "wikilink")（以归一化酉形式），而*f*代表*x*的频率分量（非[角频率](https://zh.wikipedia.org/wiki/角频率 "wikilink")）
...
此外，对于[离散傅立叶变换](https://zh.wikipedia.org/wiki/离散傅立叶变换 "wikilink")
(DFT)，表达式变换为：
...
## 参见
  ...
  - [Plancherel's
    theorem](https://zh.wikipedia.org/wiki/:en:Plancherel's_theorem "wikilink")
  - [Parseval–Gutzmer
    formula](https://zh.wikipedia.org/wiki/:en:Parseval–Gutzmer_formula "wikilink")

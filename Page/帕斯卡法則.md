**帕斯卡法則**是[組合數學上的一個關於](https://zh.wikipedia.org/wiki/組合數學 "wikilink")[二項式係數的](../Page/二項式係數.md "wikilink")[恆等式](https://zh.wikipedia.org/wiki/恆等式 "wikilink")。它說明對於正[整數](https://zh.wikipedia.org/wiki/整數 "wikilink")\(n\),\(k\)（\(k \le n\)），
...
[ru:Закон
Паскаля](https://zh.wikipedia.org/wiki/ru:Закон_Паскаля "wikilink")

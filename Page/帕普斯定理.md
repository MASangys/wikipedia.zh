[Pappus.png](https://zh.wikipedia.org/wiki/File:Pappus.png "fig:Pappus.png")
设U，V，W，X，Y和Z为[平面上](../Page/平面.md "wikilink")6条[直线](../Page/直线.md "wikilink")。如果：
...
\[\gamma = -(\alpha + \beta)\] 因此，如果\(\alpha\) = 0且\(\beta\) =
0，则\(\gamma\) = 0。

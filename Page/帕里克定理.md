在[理論計算機科學中](../Page/理論計算機科學.md "wikilink")，**帕里克定理**指出，对于[上下文无关语言](../Page/上下文无关语言.md "wikilink")，如果只关心其中每个[终止符号出现的次数](../Page/上下文无关文法.md "wikilink")，而不考虑它们的顺序，那么存在[正则语言与其对应](../Page/正则语言.md "wikilink")\[1\]。这个定理可用于确定具有给定数量终止符号的字符串是否能为上下文无关语法接受\[2\]。1961年[罗希特·帕里克第一次证明了它](https://zh.wikipedia.org/wiki/Rohit_Jivanlal_Parikh "wikilink")\[3\]，论文于1966年再次发表\[4\]。
...
帕里克定理表明，有些上下文无关语言可能只有[歧义语法](https://zh.wikipedia.org/wiki/歧义语法 "wikilink")。这样的语言称为*[固有歧义语言](https://zh.wikipedia.org/wiki/固有歧义语言 "wikilink")*。从[形式文法的角度看](../Page/形式文法.md "wikilink")，这意味着某些有歧义的[上下文无关文法无法转换为明确的上下文无关文法](../Page/上下文无关文法.md "wikilink")。

...
[信号处理中的](../Page/信号处理.md "wikilink")**带阻滤波器**（或）是指能通过大多数[频率分量](../Page/频率.md "wikilink")、但将某些范围的频率分量[衰减到极低水平的](../Page/衰减.md "wikilink")[滤波器](../Page/電子濾波器.md "wikilink")，与[带通滤波器的概念相对](../Page/带通滤波器.md "wikilink")。其中**点阻滤波器**（notch
filter）是一种特殊的带阻滤波器，它的阻带范围极小，有着很高的[Q因子](../Page/Q因子.md "wikilink")。

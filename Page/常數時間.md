在[計算複雜度理論中](https://zh.wikipedia.org/wiki/計算複雜度理論 "wikilink")，**常數時間**是一种[时间复杂度](../Page/时间复杂度.md "wikilink")，它表示某个[算法求出解答的时间在固定范围内](../Page/算法.md "wikilink")，而不依照問題輸入資料大小变化。

[Exp_series.gif](https://zh.wikipedia.org/wiki/File:Exp_series.gif "fig:Exp_series.gif")，红色曲线是指数函数的[麦克劳林展开的前](../Page/麦克劳林级数.md "wikilink")*n*+1项和的曲线\]\]
在[数学中](../Page/数学.md "wikilink")，**幂级数（power
series）**是一类形式简单而应用广泛的[函数级数](../Page/级数#函数项级数.md "wikilink")，变量可以是一个或多个（见“[多元幂级数](../Page/#多元幂级数.md "wikilink")”一节）。单变量的幂级数形式为：

\[f(x) = \sum_{n=0}^\infty a_n \left( x-c \right)^n\]

\[= a_0 + a_1 (x-c)^1 + a_2 (x-c)^2 + a_3 (x-c)^3 + \cdots\]
其中的*c*和\(a_0 ,a_1 ,a_2 \cdots a_n \cdots\)是[常数](../Page/常数.md "wikilink")。\(a_0 ,a_1 ,a_2 \cdots a_n \cdots\)称为幂级数的系数。幂级数中的每一项都是一个[幂函数](../Page/幂函数.md "wikilink")，幂次为非负整数。幂级数的形式很像[多项式](../Page/多项式.md "wikilink")，在很多方面有类似的性质，可以被看成是“无穷次的多项式”。
...
幂级数是分析学研究的重点之一，然而在[组合数学中](../Page/组合数学.md "wikilink")，幂级数也占有一席之地。作为[母函数](../Page/母函数.md "wikilink")，由幂级数概念发展出来的[形式幂级数是许多](../Page/形式幂级数.md "wikilink")[组合恒等式的来源](../Page/组合恒等式.md "wikilink")\[1\]。在电力工程学中，幂级数则被称为[Z-变换](../Page/Z-变换.md "wikilink")。[实数的小数记法也可以被看做幂级数的一种](../Page/实数.md "wikilink")，只不过这里的*x*被固定为\(\frac{1}{10}\)。在[p-进数中则可以见到](../Page/p-进数.md "wikilink")*x*被固定为\(10\)的幂级数。

## 例子

[多项式可以看做系数从某一项开始全是零的幂级数](../Page/多项式.md "wikilink")，例如多项式\(f(x) = x^2 + 2x + 3\)可以写成标准形式的幂级数：
...
幂级数里不包括负的幂次。例如\(1 + x^{-1} + x^{-2} + \cdots\)就不是幂级数（它是一个[洛朗级数](../Page/洛朗级数.md "wikilink")）。同样的，幂次为[分数的级数也不是幂级数](../Page/分数.md "wikilink")。系数\(a_n\)必须是和*x*无关，比如\(\sin(x) x + \sin(2x) x^2 + \sin(3x) x^3 + \cdots \,\)就不是一个幂级数。

## 敛散性

作为[级数的一种](../Page/级数.md "wikilink")，幂级数的敛散性也是研究幂级数的重点之一。对同一个幂级数，当变量*x*在[复数中变化时](../Page/复数.md "wikilink")，幂级数可能收敛，也可能发散。作为判断的依据，有：

  -
    **阿贝尔引理**：给定一个幂级数\(\sum_{n=0}^\infty a_n x^n\)，如果对实数\(r_0>0\)，数列\(( |a_n| r_0^n)_{n \ge 0}\)
    [有界](../Page/有界.md "wikilink")，那么对任意复数\(|x| < r_0\)，\(\sum_{n=0}^\infty a_n x^n\)绝对收敛。
...
[有界](../Page/有界.md "wikilink")，存在正实数*M*使得对任意的*n*，总有\(0 \le |a_n| r_0^n \le M\)。所以：
...
根据[达朗贝尔审敛法](../Page/达朗贝尔判别法.md "wikilink")，[收敛半径](../Page/收敛半径.md "wikilink")\(R\)满足：如果幂级数\(\sum a_n x^n\)满足\(\lim_{n \to \infty} |{a_{n+1} \over a_n}| = \rho\)，则：
...
根据[根值审敛法](../Page/根值审敛法.md "wikilink")，则有[柯西-阿达马公式](../Page/柯西-阿达马公式.md "wikilink")：
...
对一个收敛半径为*R*的幂级数\(\sum_{n=0}^\infty a_n x^n\)，可以证明，幂级数在收敛圆盘上[一致收敛](../Page/一致收敛.md "wikilink")。这个性质称为**内闭一致收敛**。因此，考虑幂级数函数
...
可以证明，幂级数函数*f*在收敛区间上[无穷次可导](../Page/光滑.md "wikilink")，并且[可积](../Page/积分.md "wikilink")。此外，由于幂级数函数*f*在收敛圆盘内一致收敛，可以进行逐项求导和积分，而且其导函数和积分函数都是在收敛区间上[连续的幂级数函数](../Page/连续.md "wikilink")。它们的收敛半径等于\(\sum_{n=0}^\infty a_n x^n\)的收敛半径*R*。具体形式为：
...
即是在这点的[泰勒展开的第](../Page/泰勒展开.md "wikilink")*n*项的值。这时展开得到的幂级数称为函数*f*在*c*点的[泰勒级数](../Page/泰勒级数.md "wikilink")。
...
函数可以展开成幂级数的[充要条件是其泰勒展开的余项趋于零](../Page/充要条件.md "wikilink")：
\(R_n(x)= f(x) -\sum_{n=0}^{n} {f^{(n)}(c)\over{n!}} (x-c)^n  \rightarrow 0\)，

一个更常用到的[充分条件是](../Page/充分条件.md "wikilink")：
...
以下是一些常见函数的幂级数展开。运用这些展开可以得到一些重要的[恒等式](../Page/恒等式.md "wikilink")。
...
局部上由收敛幂级数给出的函数叫做**解析函数**。解析函数可分成实解析函数与複解析函数。所有的幂级数函数在其收敛圆盘内都是解析函数，并且在所有点上都可展。根据*零点孤立原理*，解析函数的[零点必然是](../Page/零点.md "wikilink")[孤立点](../Page/孤立点.md "wikilink")。在[复分析中](../Page/复分析.md "wikilink")，所有的[全纯函数](../Page/全纯函数.md "wikilink")（即複可微函数）都是无穷可微函数，并是复解析函数，这在[实分析中则不然](../Page/实分析.md "wikilink")。

## 形式幂级数

在[抽象代数中](../Page/抽象代数.md "wikilink")，幂级数研究的重点是其作为一个[半环的代数性质](../Page/半环.md "wikilink")。幂级数的系数域是实数或复数或其它的域不再重要，敛散性也不再讨论。这样抽离出的代数概念被称为**形式幂级数**。形式幂级数在[组合代数有重要用处](../Page/组合代数.md "wikilink")，例如作为母函数而运用在许多组合恒等式的推导中。
...
## 参见
  ...
  - [零点孤立原理](../Page/零点孤立原理.md "wikilink")

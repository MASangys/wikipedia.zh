**平均数不等式**，或称**平均值不等式**、**均值不等式**，是[数学上的一组](../Page/数学.md "wikilink")[不等式](../Page/不等式.md "wikilink")，也是[基本不等式的推广](../Page/基本不等式.md "wikilink")。它是说：
...
关于均值不等式的证明方法有很多，[数学归纳法](../Page/数学归纳法.md "wikilink")（第一数学归纳法或反向归纳法）、[拉格朗日乘数法](../Page/拉格朗日乘数.md "wikilink")、[琴生不等式法](../Page/琴生不等式.md "wikilink")、[排序不等式法](../Page/排序不等式.md "wikilink")、[柯西不等式法等等](../Page/柯西不等式.md "wikilink")，都可以证明均值不等式，在这里简要介绍数学归纳法证明n维形式的均值不等式的方法：

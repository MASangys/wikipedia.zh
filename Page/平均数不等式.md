...
关于均值不等式的证明方法有很多，[数学归纳法](../Page/数学归纳法.md "wikilink")（第一数学归纳法或反向归纳法）、[拉格朗日乘数](../Page/拉格朗日乘数.md "wikilink")法、[琴生不等式法](https://zh.wikipedia.org/wiki/琴生不等式 "wikilink")、[排序不等式法](https://zh.wikipedia.org/wiki/排序不等式 "wikilink")、[柯西不等式法等等](https://zh.wikipedia.org/wiki/柯西不等式 "wikilink")，都可以证明均值不等式，在这里简要介绍数学归纳法证明n维形式的均值不等式的方法：

**平坦擬譜法**（flat pseudospectral method）是由和[Fahroo提出](../Page/Fariba_Fahroo.md "wikilink")[Ross–Fahroo擬譜法](../Page/Ross–Fahroo擬譜法.md "wikilink")中的一部份\[1\] \[2\]。此方法結合了[微分平坦性](../Page/平坦性.md "wikilink")\[3\] \[4\]以及的概念，在所謂的平坦空間中產生輸出。

**平方差公式**是數學公式的一種，它屬於[乘法公式](../Page/乘法公式.md "wikilink")、[因式分解及](../Page/因式分解.md "wikilink")[恆等式](https://zh.wikipedia.org/wiki/恆等式 "wikilink")，目前被普遍使用。平方差指一個[平方數或](https://zh.wikipedia.org/wiki/平方數 "wikilink")[正方形](../Page/正方形.md "wikilink")，減去另一個[平方數或正方形得來的](https://zh.wikipedia.org/wiki/平方數 "wikilink")[乘法公式](../Page/乘法公式.md "wikilink")：
...
平方差可利用[因式分解及](../Page/因式分解.md "wikilink")[分配律來驗證](https://zh.wikipedia.org/wiki/乘法分配律 "wikilink")：
...
平方差可透過一個普通的平面圖表驗證出來。右圖中，是正方形\(a^2\)減去正方形\(b^2\)，那即是\(a^2 - b^2\)。透過平方差，計算出陰影部分的[面積就是](https://zh.wikipedia.org/wiki/面積 "wikilink")\((a+b)(a-b)\)。

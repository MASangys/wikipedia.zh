...
[Oscillatory_integrand_and_slow_varying_phase.png](https://zh.wikipedia.org/wiki/File:Oscillatory_integrand_and_slow_varying_phase.png "fig:Oscillatory_integrand_and_slow_varying_phase.png")
[Contribution_of_statinary_phase_region.png](https://zh.wikipedia.org/wiki/File:Contribution_of_statinary_phase_region.png "fig:Contribution_of_statinary_phase_region.png")
\(F(v,x)=\int_{0}^{\pi} cos(v*h(t) dt\)
...
[Category:定积分](https://zh.wikipedia.org/wiki/Category:定积分 "wikilink")

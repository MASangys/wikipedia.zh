...
在[几何中](https://zh.wikipedia.org/wiki/几何 "wikilink")，**平行移动**（或译**平行输运**，英文： 或 ）是将[流形](../Page/流形.md "wikilink")上的几何数据沿着光滑[曲线](../Page/曲线.md "wikilink")移动的一种方法。如果流形的[切丛](../Page/切丛.md "wikilink")上装备有一个[仿射联络](https://zh.wikipedia.org/wiki/仿射联络 "wikilink")（一个[共变导数或](https://zh.wikipedia.org/wiki/共变导数 "wikilink")[联络](../Page/联络_\(向量丛\).md "wikilink")），那么联络保证我们可以将流形上的向量沿着曲线移动使得它们关于这个联络保持“平行”。其他[联络](../Page/联络.md "wikilink")概念也装备了它们自己的平行移动系统。比如，一个向量场上的[科斯居尔联络也允许类似于共变导数一样将向量平行移动](https://zh.wikipedia.org/wiki/科斯居尔联络 "wikilink")。[埃雷斯曼或](../Page/埃雷斯曼联络.md "wikilink")[嘉当联络](../Page/嘉当联络.md "wikilink")提供了从流形到[主丛](../Page/主丛.md "wikilink")全空间的“提升曲线”。这种曲线提升方式有时被认为是[参考标架的平行移动](https://zh.wikipedia.org/wiki/参考标架 "wikilink")。
...
设 *M* 是一个光滑流形，则 *M* 的切丛上一个联络称为[仿射联络](https://zh.wikipedia.org/wiki/仿射联络 "wikilink")，确定了一类曲线称为（仿射）[测地线](../Page/测地线.md "wikilink")。一条光滑曲线 γ: *I* → *M* 是一条**仿射测地线**如果 \(\dot\gamma\) 是沿着 \(\gamma\) 的平行移动，即

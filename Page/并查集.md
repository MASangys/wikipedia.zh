...
set）。其他的重要方法，MakeSet，用于建立单元素集合。有了这些方法，许多经典的[划分问题可以被解决](https://zh.wikipedia.org/wiki/划分问题 "wikilink")。
...
**并查集森林**是一种将每一个集合以[樹表示的数据结构](../Page/树_\(数据结构\).md "wikilink")，其中每一个节点保存着到它的父节点的[引用](../Page/引用.md "wikilink")（见[意大利面条堆栈](https://zh.wikipedia.org/wiki/意大利面条堆栈 "wikilink")）。这个数据结构最早由[Bernard
A.
Galler和](https://zh.wikipedia.org/wiki/Bernard_A._Galler "wikilink")[Michael
J.
Fischer于](https://zh.wikipedia.org/wiki/Michael_J._Fischer "wikilink")1964年提出，\[1\]但是经过了数年才完成了精确的分析。
...
\(n = f(x) = A (x, x)\) 的反函数，\(A\)
是急速增加的[阿克曼函数](https://zh.wikipedia.org/wiki/阿克曼函数 "wikilink")。因为

...
**并网逆变器**（grid-tie inverter，簡稱**GTI**）是一種特殊的[逆變器](../Page/逆變器.md "wikilink")，除了可以將[直流電](../Page/直流電.md "wikilink")轉換給[交流電](../Page/交流電.md "wikilink")外，其輸出的交流電可以和和市電的[頻率及](https://zh.wikipedia.org/wiki/頻率 "wikilink")[相位同步](https://zh.wikipedia.org/wiki/相位 "wikilink")，因此輸出的交流電可以回到市電。并网逆变器常用在一些直流電壓源（如[太陽能板或是小型](https://zh.wikipedia.org/wiki/太陽能板 "wikilink")[風力發電機](https://zh.wikipedia.org/wiki/風力發電機 "wikilink")）和電網連接的應用中\[1\]。
...
## 外部連結
  ...
  - [Grid-Tie Wind Inverters Versus Solar Inverters](http://www.dtims.com/whitepapers/gale_versus_solar.pdf) - describes in detail the differences between existing grid tied inverters.

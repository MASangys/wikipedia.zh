...
现在，绝大多数商业化的CPU实现都能够提供某种形式的向量处理的指令，用来处理多个（向量化的）数据集，也就是所谓的SIMD（单一指令、多重数据）。常见的例子有 [VIS](https://zh.wikipedia.org/wiki/VIS "wikilink"), [MMX](../Page/MMX.md "wikilink"), [SSE](../Page/SSE.md "wikilink"), [AltiVec](https://zh.wikipedia.org/wiki/AltiVec "wikilink") 和 [AVX](https://zh.wikipedia.org/wiki/AVX "wikilink")。向量处理技术也能在游戏主机硬件和图形加速硬件上看到。在2000年，[IBM](../Page/IBM.md "wikilink")，[东芝](../Page/东芝.md "wikilink")和[索尼](../Page/索尼.md "wikilink")合作开发了[Cell处理器](../Page/Cell_\(微處理器\).md "wikilink")，集成了一个标量处理器和八个向量处理器，应用在索尼的[PlayStation 3游戏机和其他一些产品中](../Page/PlayStation_3.md "wikilink")。

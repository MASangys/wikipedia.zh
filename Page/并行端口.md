...
Terminal)**，是计算机上数据以[并行方式传递的](https://zh.wikipedia.org/wiki/并行 "wikilink")[端口](https://zh.wikipedia.org/wiki/端口 "wikilink")，也就是说至少应该有两条[连接线用于传递数据](https://zh.wikipedia.org/wiki/连接线 "wikilink")。与只使用一根线传递数据（这里没有包括用于[接地](../Page/接地.md "wikilink")、控制等的连接线）的[串行端口相比](../Page/串行端口.md "wikilink")，并口在相同的[数据传送速率下](https://zh.wikipedia.org/wiki/数据传送速率 "wikilink")，并口可以更快地传输数据。所以在21世纪之前，在需要较大传输速度的地方，例如[打印机](../Page/打印机.md "wikilink")，并口得到广泛使用。但是随着速度迅速提高，并口上导线之间数据[同步成为一个很难处理的难题](https://zh.wikipedia.org/wiki/同步 "wikilink")，导致并口在速度竞赛中逐渐被淘汰。目前[USB等改进的串口逐渐代替了并口](../Page/USB.md "wikilink")。
...
| <small>埠號</small> | <small>[中斷號](../Page/中斷.md "wikilink")</small> | <small>起始[I/O地址](https://zh.wikipedia.org/wiki/I/O "wikilink")</small> | <small>終止[I/O地址](https://zh.wikipedia.org/wiki/I/O "wikilink")</small> | <small>Notes</small>                                                                          |
| ----------------- | ---------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |

**广义仓本-希伐欣斯基方程**(Generalized Kuramoto-Sivashinsky equation)是一个非线性偏微分方程：\[1\]

\(u_{t}+u^k*u_{x}+\alpha*u_{xx}+\beta*u_{xxx}+\gamma*u_{xxxx}=0\)

## 解析解

\[u1 = ((3*(k+1))*(2*k+3)*\beta^3/(8*(k+3)^2*\gamma^2))^(1/k)*\exp(-\beta*z/((2*(k+3))*\gamma))*cosh(k*\beta*z/((2*(k+3))*\gamma))^(-3/k)\]

\[u2 = ((k+1)*(2*k+3)*\beta^3/(72*(k+3)^2*\gamma^2))^(1/k)*(tanh(k*\beta*z1/((6*(k+3))*\gamma))-1)^(3/k)\]

## 行波图

|                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generalized_Kuramoto-Sivanshinsky_equation_traveling_wave_plot_1.gif](https://zh.wikipedia.org/wiki/File:Generalized_Kuramoto-Sivanshinsky_equation_traveling_wave_plot_1.gif "fig:Generalized_Kuramoto-Sivanshinsky_equation_traveling_wave_plot_1.gif") | [Generalized_Kuramoto-Sivanshinsky_equation_traveling_wave_plot_2.gif](https://zh.wikipedia.org/wiki/File:Generalized_Kuramoto-Sivanshinsky_equation_traveling_wave_plot_2.gif "fig:Generalized_Kuramoto-Sivanshinsky_equation_traveling_wave_plot_2.gif") |
...
1.  Andrei D. Polyanin,Valentin F. Zaitsev, HANDBOOK OF NONLINEAR PARTIAL DIFFERENTIAL EQUATIONS, SECOND EDITION p983 CRC PRESS
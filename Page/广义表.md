**广义表**（）是一种非线性的[数据结构](../Page/数据结构.md "wikilink")。但如果广义表的每个元素都是原子，它就变成了[线性表](../Page/线性表.md "wikilink")。广义表广泛地用于[人工智能等领域的](../Page/人工智能.md "wikilink")[LISP语言](../Page/LISP.md "wikilink")。

...
function**），有时也称**超几何函数**，是一个用[幂级数](../Page/幂级数.md "wikilink")定义的函数，其中幂级数的系数由若干个[升阶乘的积和商给出](https://zh.wikipedia.org/wiki/阶乘幂#上升阶乘幂 "wikilink")。下文中用“超几何函数”一词代指广义超几何函数，而用“[高斯超几何函数](../Page/超几何函数.md "wikilink")”一词代指
=2, =1 时的广义超几何函数。
...
当超几何函数截断为多项式时，显然[收敛半径](../Page/收敛半径.md "wikilink")是[无穷大](https://zh.wikipedia.org/wiki/无穷大 "wikilink")。

除去这种特殊情况之外，用[比值审敛法](../Page/比值审敛法.md "wikilink")可知，当 \<+1 时，收敛半径为无穷大，当
...
functions），与[贝塞尔函数](../Page/贝塞尔函数.md "wikilink")有密切关联。

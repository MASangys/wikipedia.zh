...
[SPI_three_slaves.svg](https://zh.wikipedia.org/wiki/File:SPI_three_slaves.svg "fig:SPI_three_slaves.svg") **串行外设接口**（Serial Peripheral Interface Bus，SPI），是一种用于短程通信的[同步](https://zh.wikipedia.org/wiki/同步電路 "wikilink")[串行通信](../Page/串行通信.md "wikilink")接口规范，主要应用于[单片机系统中](https://zh.wikipedia.org/wiki/单片机系统 "wikilink")。类似[I²C](../Page/I²C.md "wikilink")。 这种接口首先被[Motorola](https://zh.wikipedia.org/wiki/Motorola "wikilink")（摩托罗拉）公司开发，然后发展成了一种行业规范。典型应用包含[SD卡](../Page/SD卡.md "wikilink")和[液晶显示器](../Page/液晶显示器.md "wikilink")。

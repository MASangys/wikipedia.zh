[缩略图](https://zh.wikipedia.org/wiki/File:UndirectedDegrees_\(Loop\).svg "fig:缩略图") 在[图论](../Page/图论.md "wikilink")中，一个[顶点在](https://zh.wikipedia.org/wiki/顶点 "wikilink")[图中的](../Page/图_\(数学\).md "wikilink")**度** (**degree**)为与这个顶点相连接的[边](../Page/边.md "wikilink")的数目。在[多重图](../Page/多重图.md "wikilink")中，[自环](../Page/自环.md "wikilink")被计数两次。\[1\] 顶点 \(v\) 的度记作\(\deg(v)\)或\(\deg v\)。图*G*的**最大度**记作Δ(*G*)，**最小度**记作δ(*G*)，分别为图中所有顶点度的最大值和最小值。 在右边的[多重图](../Page/多重图.md "wikilink")中，最大度为5，最小度为0。 在[正则图中](https://zh.wikipedia.org/wiki/正则图 "wikilink")，所有度都是相同的，因为我们可以直接说该图的度是多少。 [完全图是正则图中的一种特殊情况](../Page/完全圖.md "wikilink")，其任意两个点均相连，若顶点数为p，则该图的度为p-1。
...
## 全局属性
  ...
  - 如果图中每个顶点的度均为*k，*那么这个图被称作[k-正则图](https://zh.wikipedia.org/wiki/正則圖 "wikilink")，可称该图的度为*k*。类似地，在[二分图](../Page/二分图.md "wikilink")中，在同一侧顶点的度相同的图被称作[双正则图](https://zh.wikipedia.org/wiki/双正则图 "wikilink")。

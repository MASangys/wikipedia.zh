在[黎曼幾何裡面](https://zh.wikipedia.org/wiki/黎曼幾何 "wikilink")，**度量張量**（英語：Metric
...
\(\textstyle ds^2=\sum_{ij}g_{ij}dx^i dx^j\)，也可以用[矩陣](https://zh.wikipedia.org/wiki/矩陣 "wikilink")
\((g_{ij})\) 表示，記作為*G*或*g*。而 \(g_{ij}\)
記號傳統地表示度量張量的[協變分量](https://zh.wikipedia.org/wiki/協變導數 "wikilink")（亦為「矩陣元素」）。

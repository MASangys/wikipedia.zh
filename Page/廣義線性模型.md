在[統計學上](https://zh.wikipedia.org/wiki/統計學 "wikilink")， **廣義線性模型**
...
[John
Nelder與](https://zh.wikipedia.org/wiki/:en:John_Nelder "wikilink")[Peter
McCullagh在](https://zh.wikipedia.org/wiki/:en:Peter_McCullagh "wikilink")1989年出版，被視為廣義線性模式的代表性文獻中提綱挈領地說明了廣義線性模式的原理、計算(如[最大概似估計量](../Page/最大似然估计.md "wikilink"))及其實務應用。

## 概說

广义线性模型（generalized linear model,
GLM)是简单最小二乘回归（OLS）的扩展,在廣義線性模式中，假設每個資料的觀測值\(\mathbf Y\)來自某個[指數族分佈](https://zh.wikipedia.org/wiki/指數族 "wikilink")。
...
[殆最大概似估計量](https://zh.wikipedia.org/wiki/:en:quasi-maximum_likelihood "wikilink"),
...
[指數族](https://zh.wikipedia.org/wiki/指數族 "wikilink")[隨機變數意指其具參數](https://zh.wikipedia.org/wiki/隨機變數 "wikilink")*θ*與*τ*的[機率密度函數](../Page/機率密度函數.md "wikilink"),
...
*θ*與該隨機變數的期望值有關。若*a*為[恆等函數](https://zh.wikipedia.org/wiki/恆等函數 "wikilink")，則稱該分佈屬於
[正則型式](https://zh.wikipedia.org/wiki/正則型式 "wikilink")。
...
"[Η](https://zh.wikipedia.org/wiki/Η "wikilink")")通常用來表示線性預測子。它與資料的[期望值的鏈結函數值有關](../Page/期望值.md "wikilink")(故稱"預測子")。
...
為***β***的[充份統計量此一條件](https://zh.wikipedia.org/wiki/充份統計量 "wikilink")。這在*θ*與線性預測子的鏈結函數值相等時方成立。下面列出若干指數族分佈的典则鏈結函數及其反函數(有時稱為均值函數)：
...
這個例子具有廣義線性模式罕有的[最大概似估計量的](https://zh.wikipedia.org/wiki/最大概似估計量 "wikilink")[解析解](https://zh.wikipedia.org/wiki/解析解 "wikilink")

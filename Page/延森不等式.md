...
Jensen）命名。它給出[積分的](https://zh.wikipedia.org/wiki/積分 "wikilink")[凸函數值和凸函數的積分值間的關係](https://zh.wikipedia.org/wiki/凸函數 "wikilink")。延森不等式有以下推论：过一个[凸函数上任意两点所作](../Page/凸函数.md "wikilink")[割线一定在这两点间的函数图象的上方](https://zh.wikipedia.org/wiki/割线 "wikilink")，即：

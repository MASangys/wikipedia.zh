**琴生不等式（Jensen's
inequality）**以[丹麥](https://zh.wikipedia.org/wiki/丹麥 "wikilink")[數學家](https://zh.wikipedia.org/wiki/數學家 "wikilink")[約翰·延森](https://zh.wikipedia.org/wiki/約翰·延森 "wikilink")（Johan
Jensen）命名。它給出[積分的](https://zh.wikipedia.org/wiki/積分 "wikilink")[凸函數值和凸函數的積分值間的關係](https://zh.wikipedia.org/wiki/凸函數 "wikilink")。延森不等式有以下推论：过一个[凸函数上任意两点所作](../Page/凸函数.md "wikilink")[割线一定在这两点间的函数图象的下方](https://zh.wikipedia.org/wiki/割线 "wikilink")，即：
...
兩邊取[自然指數就得出熟悉的](https://zh.wikipedia.org/wiki/自然指數 "wikilink")[-{zh-cn:均值不等式;
zh-hant:平均數不等式}-](https://zh.wikipedia.org/wiki/平均數不等式 "wikilink")：
...
其中方括號表示[期望值](../Page/期望值.md "wikilink")，是以[隨機變數](https://zh.wikipedia.org/wiki/隨機變數 "wikilink")*X*的某個[概率分佈算出](https://zh.wikipedia.org/wiki/概率分佈 "wikilink")。這個情形的證明很簡單（參見Chandler,

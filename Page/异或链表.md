...
普通[双向链表](../Page/双向链表.md "wikilink")的每个结点有三个域 ，分别存储着前一个结点的地址、后一个点的地址，以及数据
...
[Category:数据结构](https://zh.wikipedia.org/wiki/Category:数据结构 "wikilink") [Category:二进制算术](https://zh.wikipedia.org/wiki/Category:二进制算术 "wikilink")
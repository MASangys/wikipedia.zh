...
给定[域](https://zh.wikipedia.org/wiki/域 "wikilink")\(F\)上一个有限[向量空间](../Page/向量空间.md "wikilink")集合\(\left \{ V_1,...,V_n \right \}\)，我们可以考虑他们的[张量积](https://zh.wikipedia.org/wiki/张量积#向量空间的张量积 "wikilink")
...
在旧教材中这个变换规律经常作为一个张量的定义。形式上，这意味这那个张量作为所有坐标变换组成的[群](../Page/群.md "wikilink")的一个特定[表示](https://zh.wikipedia.org/wiki/群表示 "wikilink")。

在[数学中](../Page/数学.md "wikilink")，一个[向量空间](../Page/向量空间.md "wikilink")\(V\)的**张量代数**（），记作\(T(V)\)，是*\(V\)*上的（任意阶）[张量的](https://zh.wikipedia.org/wiki/张量 "wikilink")[代数](https://zh.wikipedia.org/wiki/域上的代数 "wikilink")，其乘法为[张量积](../Page/张量积.md "wikilink")。张量代数[左伴随于从代数到向量空间的](https://zh.wikipedia.org/wiki/伴随函子 "wikilink")[遗忘函子](https://zh.wikipedia.org/wiki/遗忘函子 "wikilink")，在这种意义下它是*\(V\)*上的[自由代数](https://zh.wikipedia.org/wiki/自由代数 "wikilink")；在相应的[泛性质的意义下](../Page/泛性质.md "wikilink")，它是包含*\(V\)*的“最一般的代数”（见下）。

张量代数也具有[余代数结构](https://zh.wikipedia.org/wiki/余代数 "wikilink")。

**注**：本文中所有代数都假设是[有单位的且](../Page/有单位的.md "wikilink")[结合](https://zh.wikipedia.org/wiki/结合代数 "wikilink")。
...
此构造可径直推广到任意[交换环上的](../Page/交换环.md "wikilink")[模](../Page/模.md "wikilink")\(M\)上。如果\(R\)是一个[非交换环](https://zh.wikipedia.org/wiki/非交换环 "wikilink")，我们仍然可以对任意\(R\)-\(R\)

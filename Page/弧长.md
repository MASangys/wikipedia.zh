...
[曲线](../Page/曲线.md "wikilink")的**弧长**也称曲线的长度，是曲线的特征之一。不是所有的曲线都能定义长度，能够定义长度的曲线称为**可求长曲线**。最早研究的曲线弧长是圆弧的长度。为了计算[圆周的长度](https://zh.wikipedia.org/wiki/圆周 "wikilink")，数学家发明了用直[线段](../Page/线段.md "wikilink")近似的方法，并应用到其他的曲线上。[微积分出现后](https://zh.wikipedia.org/wiki/微积分 "wikilink")，数学家开始用积分的方式计算曲线的弧长，得出了许多特殊曲线的弧长的精确表达式。
...
也就是说，曲线的弧长是所有从曲线中选取有限个点连起来的折线长度的[最小上界](../Page/最小上界.md "wikilink")。广义的曲线弧长也包括这个最小上界不存在的情况，这时候定义曲线的弧长是无穷大。曲线的弧长有限的时候，称之为可求长曲线，否之称为不可求长曲线。以上的定义不要求函数\(f\)可微，度量空间也没有定义[微分](../Page/微分.md "wikilink")的结构。

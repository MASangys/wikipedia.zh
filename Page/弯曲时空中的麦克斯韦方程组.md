...
in curved
spacetime）制约着弯曲[时空](../Page/时空.md "wikilink")（其间的[度规可能不是](https://zh.wikipedia.org/wiki/度规 "wikilink")[闵可夫斯基性的](https://zh.wikipedia.org/wiki/闵可夫斯基时空 "wikilink")）中的[电磁场的动力学](../Page/电磁场.md "wikilink")。它们可以被认为是真空中的[麦克斯韦方程组在](https://zh.wikipedia.org/wiki/麦克斯韦方程组 "wikilink")[广义相对论框架中的扩展](https://zh.wikipedia.org/wiki/广义相对论 "wikilink")，而真空中的麦克斯韦方程组只是一般化的麦克斯韦方程组在局部平直时空中的特殊形式。但由于在广义相对论中电磁场本身的存在也会引起时空的弯曲，因此真空中的麦克斯韦方程组应被理解为一种出于方便的近似形式。
...
这一关系包含了[法拉第电磁感应定律和](../Page/法拉第电磁感应定律.md "wikilink")[磁场的高斯定理](https://zh.wikipedia.org/wiki/磁场的高斯定理 "wikilink")，因此也叫做法拉第-高斯方程。具体而言，
...
注意这个方程是电磁理论中唯一有度规（即引力）存在的方程。并且这一方程具有[尺度不变性](https://zh.wikipedia.org/wiki/尺度不变性 "wikilink")，即将度规乘以一个常数不会改变方程的形式。也就是说，引力只能通过改变全局坐标中的[光速来影响相应的电磁场](../Page/光速.md "wikilink")，由于光在引力场中会发生偏折，其效应等同于质量的引力场增加了周围时空的[折射率](../Page/折射率.md "wikilink")，从而影响了对应的位移电场和附屬磁场。
...
在考虑麦克斯韦方程组本身与背景时空无关时，时空度规在广义相对论中被认为是受电磁场影响的动态变化的变量，这导致了电磁波方程和麦克斯韦方程组是非线性的。这一点可以从[爱因斯坦场方程中的曲率张量依赖于](../Page/爱因斯坦场方程.md "wikilink")[应力-能量张量看出](https://zh.wikipedia.org/wiki/应力-能量张量 "wikilink")。
...
是[爱因斯坦张量](https://zh.wikipedia.org/wiki/爱因斯坦张量 "wikilink")，\(G\,\)是[万有引力常数](../Page/万有引力常数.md "wikilink")，\(R\,\)
（[标量曲率](https://zh.wikipedia.org/wiki/标量曲率 "wikilink")）是里奇张量的迹。应力-能量张量来源于粒子的[应力和能量](https://zh.wikipedia.org/wiki/应力 "wikilink")，但同时也来源于电磁场，这造就了非线性。

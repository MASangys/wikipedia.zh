...
**归并排序**（，或），是建立在归并操作上的一种有效的[排序算法](../Page/排序算法.md "wikilink")，[效率為](../Page/時間複雜度.md "wikilink")\(O(n\log n)\)（[大O符号](../Page/大O符号.md "wikilink")）。1945年由[约翰·冯·诺伊曼首次提出](../Page/约翰·冯·诺伊曼.md "wikilink")。该算法是采用[分治法](../Page/分治法.md "wikilink")（Divide
and Conquer）的一个非常典型的应用，且各层分治递归可以同时进行。
...
1.  将序列每相邻两个数字进行[归并操作](../Page/#归并操作.md "wikilink")，形成\(ceil(n/2)\)个序列，排序后每个序列包含两/一个元素
...
*比较操作*的次数介于\((n\log n)/2\)和\(n\log n - n + 1\)。
*赋值操作*的次数是\((2n\log n)\)。归并算法的空间复杂度为：\(\Theta(n)\)

## 参考文献

## 外部連結

  - [Dictionary of Algorithms and Data Structures: Merge
    sort](http://www.nist.gov/dads/HTML/mergesort.html)
  - [Merge sort Algorithm with example
    program](https://www.interviewbit.com/tutorial/merge-sort-algorithm/)
  - [Merge Sort Algorithm
    Simulation](https://web.archive.org/web/20000412204316/http://www.geocities.com/SiliconValley/Program/2864/File/Merge1/mergesort.html)
  - [Mergesort For Linked
    Lists](http://www.chiark.greenend.org.uk/~sgtatham/algorithms/listsort.html)
  - [Mergesort in Java, Python, Perl, C,
    Ruby](https://web.archive.org/web/20140407075718/http://talkera.org.cp-in-1.webhostbox.net/wp/?p=95)

[no:Sorteringsalgoritme\#Flettesortering](../Page/no:Sorteringsalgoritme#Flettesortering.md "wikilink")

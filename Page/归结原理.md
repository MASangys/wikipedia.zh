**归结**（resolution）原理，在[数理逻辑和](../Page/数理逻辑.md "wikilink")[自动定理证明中](https://zh.wikipedia.org/wiki/自动定理证明 "wikilink")（[GOFAI涉及的主题](https://zh.wikipedia.org/wiki/GOFAI "wikilink")），是对于[命题逻辑和](../Page/命题逻辑.md "wikilink")[一阶逻辑中的句子的](../Page/一阶逻辑.md "wikilink")[推理规则](../Page/推理规则.md "wikilink")，它导致了一种[反证法的](https://zh.wikipedia.org/wiki/反证法 "wikilink")[定理](../Page/定理.md "wikilink")[证明技术](https://zh.wikipedia.org/wiki/证明 "wikilink")。
...
-
子句是[文字的析取式](https://zh.wikipedia.org/wiki/文字_\(数理逻辑\) "wikilink")，并生成带有除了互补的文字的所有文字的一个新子句。形式上，这里的\(a_i\)和\(b_j\)是互补的文字：
...
当外加上完备的[搜索算法的时候](https://zh.wikipedia.org/wiki/搜索算法 "wikilink")，归结规则生成一个可靠的和完备的算法来决定命题公式的*可满足性*，并且经过扩展，决定句子在一组公理下的有效性。

这种归结技术使用[反证法](https://zh.wikipedia.org/wiki/反证法 "wikilink")，并基于在命题逻辑中的任何句子都能转换成等价的[合取范式句子的事实](../Page/合取范式.md "wikilink")。步骤如下：
...
要使用归结技术重造推理，首先子句们必须转换成[合取范式](../Page/合取范式.md "wikilink")。在这种形式下，所有的[量化都成为隐含的](https://zh.wikipedia.org/wiki/量化 "wikilink")：在变量（X,
Y...）上的[全称量词理所当然的被省略了](https://zh.wikipedia.org/wiki/全称量词 "wikilink")，而[存在量化的变量被替换成](../Page/存在量化.md "wikilink")[Skolem函数](https://zh.wikipedia.org/wiki/Skolem函数 "wikilink")。
...
form](https://zh.wikipedia.org/wiki/clausal_normal_form "wikilink"), are
presented in:

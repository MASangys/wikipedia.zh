...
**循环小数**，是從[小數部分的某一位起](https://zh.wikipedia.org/wiki/小數 "wikilink")，一個數字或幾個數字，依次不斷地重複出現的小數。可分为[有限循环小数和](https://zh.wikipedia.org/wiki/有限小数 "wikilink")[无限循环小数](https://zh.wikipedia.org/wiki/无限小数 "wikilink")。

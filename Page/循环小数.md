[Seventh_perspective.png](https://zh.wikipedia.org/wiki/File:Seventh_perspective.png "fig:Seventh_perspective.png")
**循环小数**，是從[小數部分的某一位起](../Page/小數.md "wikilink")，一個數字或幾個數字，依次不斷地重複出現的小數。可分为[有限循环小数和](../Page/有限小数.md "wikilink")[无限循环小数](../Page/无限小数.md "wikilink")。

## 定義

循環小數即為[有理數的](../Page/有理數.md "wikilink")[小數表示形式](../Page/小數.md "wikilink")，例：
      ...
      -
        ...
        3.承接以上兩點，當除数a可以質因數標準分解式表示成\((2^m\times 5^n)\times (P1^{S1}\times P2^{S2}\times\)⋯\(\times Pn^{Sn})\)時，會有max(m,n)個不循環位數，和\(E\)個循環節位數。
          -
              ...
              -
                其中，\(P1^{S1}\),
                \(P2^{S2}\),⋯,\(Pn^{Sn}\)分別各有個循環節位數，存在一個最小公倍數\(E=[\)\(]\)。
                例：\(\frac{11}{2^2\times3^2\times5^3\times7\times17}\)的循環節個數？
                答：前三位不循環（2 和 5 的最高次方為 3），循環節個數是
                48（因為\(3^2\)的循環節位數為1，7的循環節位數為6，17的循環節位數為16，\[1,6,16\]=48）\[2\]

## 化為[分數的方法](../Page/分數.md "wikilink")

1.  先看有幾位「非[循環節位數](../Page/循環節.md "wikilink")（\({\color{blue}n\,\!}\)）」和「循環節位數（\({\color{red}m\,\!}\)）」，算出後，將\({\begin{matrix} \underbrace{ 999 \cdots 9 } \\ {\color{red}m\,\!} \end{matrix} \begin{matrix} \underbrace{ 000 \cdots 0 } \\ {\color{blue}n\,\!} \end{matrix}}\)擺於「**[分母](../Page/分母.md "wikilink")**」。
...
利用[短除法可以将分数](../Page/短除法.md "wikilink")([有理数](../Page/有理数.md "wikilink")，\(\mathbb{Q}\))转化为循环小数。
...
### 与[進位制系統密切相关](../Page/進位制.md "wikilink")
...
## 參見
  ...
  - [Midy定理](../Page/Midy定理.md "wikilink")

...
## 参阅
  ...
  - [RC4](../Page/RC4.md "wikilink") - 一种[流密码](../Page/流密码.md "wikilink")，如同TEA一般, 旨在被设计后易于执行。
...
## 外部链接
  ...
  - [JavaScript implementation of XXTEA with Base64](http://www.farfarfar.com/scripts/encrypt/)

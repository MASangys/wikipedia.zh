[量子力學的](../Page/量子力學.md "wikilink")**微擾理論**（perturbation
theory）引用一些[數學的](../Page/數學.md "wikilink")[微扰理论的近似方法於量子力學](../Page/微扰理论.md "wikilink")。當遇到比較複雜的量子系統時，這些方法試著將複雜的量子系統簡單化或理想化，變成為有精確解的量子系統，再應用理想化的量子系統的精確解，來解析複雜的量子系統。微扰理论从可以获得精确解或易于得到近似解的相对简单体系出发，在這簡單系統的[哈密頓量](../Page/哈密頓量.md "wikilink")(Hamiltonian)裏，加上一個很弱的微擾，變成了較複雜系統的哈密頓量。假若這微擾不是很大，複雜系統的許多物理性質（例如，[能級](../Page/能級.md "wikilink")，[量子態](../Page/量子態.md "wikilink")）可以表達為簡單系統的物理性質加上一些修正。這樣，從研究比較簡單的量子系統所得到的知識，可以進而研究比較複雜的量子系統。

微擾理論可以分為兩類，**不含時微擾理論**(Time-independent perturbation
theory)與**含時微擾理論**(Time-dependent perturbation
theory)。在不含時微擾理論中，哈密顿量的微扰项不显含時間；而含時微擾理論的微擾哈密頓量含時間，詳見[含時微擾理論](../Page/含時微擾理論.md "wikilink")。本篇文章只講述不含時微擾理論。此後凡提到微擾理論，皆指不含時微擾理論。

## 微擾理論應用

微擾理論是量子力學的一個重要的工具。因為，物理學家發覺，甚至對於中等複雜度的哈密頓量，也很難找到其[薛定谔方程](../Page/薛定谔方程.md "wikilink")（Schrödinger
Equation)
的精確解。物理學家所知道的就只有幾個量子模型有精確解，像[氫原子](../Page/氫原子.md "wikilink")、[量子諧振子](../Page/量子諧振子.md "wikilink")、與[盒中粒子](../Page/盒中粒子.md "wikilink")。這些量子模型都太過理想化，無法適當地描述大多數的量子系統。應用微擾理論，可以將這些理想的量子模型的精確解，用來生成一系列更複雜的量子系統的解答。例如，通過添加一個微擾的[電位於氫原子的哈密頓量](../Page/電位.md "wikilink")，可以計算在[電場的作用下](../Page/電場.md "wikilink")，氫原子[譜線產生的微小偏移](../Page/譜線.md "wikilink")（參閱[斯塔克效應](../Page/斯塔克效應.md "wikilink")(Stark's
effect)）。又如，在哈密顿量中引入磁场的微扰，即可以解释**塞曼效应**（Zeeman's effect)。

應用微擾理論而得到的解答並不是精確解，但是，這方法可以計算出相當準確的解答。假若使展開的參數\(\lambda\)變得非常的小，得到的解答會很準確。通常，解答是用有限數目的項目的\(\lambda\)的[冪級數來表達](../Page/冪級數.md "wikilink")。

## 歷史

[埃爾溫·薛定谔在創立了奠定基石的](../Page/埃爾溫·薛定谔.md "wikilink")[量子波力學理論後](../Page/薛定谔方程式.md "wikilink")，經過短短一段時間，於
1926年，他又在另一篇論文裏，發表了微擾理論\[1\]。在這篇論文裏，薛定谔提到[約翰·斯特拉特，第三代瑞利男爵先前的研究](../Page/約翰·斯特拉特，第三代瑞利男爵.md "wikilink")\[2\]。瑞利勳爵曾經在弦的[諧振動的微擾研究](../Page/振動.md "wikilink")，得到突破性的結果。現今，微擾理論時常又被稱為**瑞利-薛定谔微擾理論**。

## 一階修正

設想一個不含時間的零微擾哈密頓量\(H_0\)，有已知的[本徵值能級](../Page/本徵值.md "wikilink")\(E_n^{(0)}\)和已知的[本徵態](../Page/本徵態.md "wikilink")\(|n^{(0)}\rang\)。它們的關係可以用[不含時薛丁格方程式表達為](../Page/不含時薛丁格方程式.md "wikilink")

\[H_0 |n^{(0)}\rang = E_n^{(0)} |n^{(0)}\rang \quad,\quad n = 1, 2, 3, \cdots\]。

為了簡易起見，假設[能級是](../Page/能級.md "wikilink")[離散的](../Page/離散量.md "wikilink")。上標\((0)\)標記所有零微擾系統的[物理量與](../Page/物理量.md "wikilink")[量子態](../Page/量子態.md "wikilink")。

現在添加一個微擾於哈密頓量。讓微擾\(V\)代表一個很微弱的物理擾動，像外場產生的[位能](../Page/位能.md "wikilink")。設定\(\lambda\)為一個[無因次的參數](../Page/無因次.md "wikilink")。它的值可以從\(0\)變化到\(1\)。含微擾哈密頓量\(H\)表達為
...
在這裏，主要目標是用零微擾能級和零微擾量子態表達出\(E_n\)和\(|n\rang\)。假若微擾足夠的微弱，則可以將它們寫為\(\lambda\)的[冪級數](../Page/冪級數.md "wikilink")：
...
將\(\langle n^{(0)}|\) [內積於這方程式](../Page/內積.md "wikilink")：

\[\langle n^{(0)}|H_0 |n^{(1)}\rang + \langle n^{(0)}|V |n^{(0)}\rang = \langle n^{(0)}|E_n^{(0)} |n^{(1)}\rang + \langle n^{(0)}|E_n^{(1)} |n^{(0)}\rang\]。

這方程式的左手邊第一個項目與右手邊第一個項目相抵去（回憶零微擾哈密頓量是[厄米算符](../Page/厄米算符.md "wikilink")）。這導致一階能級修正：
...
現在計算能量本徵態的一階修正\(|n^{(1)}\rangle\)。請先注意到，由於所有的零微擾本徵態\(|k^{(0)}\rangle\)形成了一個[正交基](../Page/正交基.md "wikilink")，\(|n^{(0)}\rangle\)可以表達為

\[|n^{(0)}\rangle=\sum_{k} |k^{(0)}\rangle\langle k^{(0)}|n^{(0)}\rangle\]。

所以，[單位算符可以寫為所有](../Page/單位算符.md "wikilink")[密度矩陣的總合](../Page/密度矩陣.md "wikilink")：
...
由於所有的\(|n^{(0)}\rangle\)形成了一個[正交基](../Page/正交基.md "wikilink")，\(|n^{(1)}\rangle\)可以表達為
...
原本的零微擾能量本徵態滿足[歸一性](../Page/歸一性.md "wikilink")：
...
假設兩個以上的能量本徵態是[簡併的](../Page/簡併.md "wikilink")，也就是說，它們的能量本徵值相同，則其一階能量修正不是良好定義的（），因為沒有唯一方法來確定一個零微擾本徵態正交基。一階本徵態修正的計算也會遇到嚴峻的問題，因為假若本徵態\(|n^{(0)}\rangle\)與本徵態\(|k^{(0)}\rangle\)是簡併的，則公式(3)的分數內的分母\(E_n^{(0)} - E_k^{(0)}=0\)，這造成公式(4)無解。

對於某個能級\(E_n^{(0)}\)，將其所有簡併的量子態生成的[子空間標記為](../Page/子空間.md "wikilink")\(D\)。藉著選擇生成本徵態的不同的線性組合，可以為\(D\)構造一個不同的正交基。含微擾系統的量子態可以表達為
...
這是一個[本徵值問題](../Page/本徵值.md "wikilink")，等價於[對角化以下](../Page/特徵向量.md "wikilink")[矩陣](../Page/矩陣.md "wikilink")：
...
通常，簡併能量的分裂\(\epsilon_n\)可以在實驗中被測量出來。雖然，與簡併量子態的能級本身相比，分裂值可能很小，但這對了解諸如[精細結構](../Page/精細結構.md "wikilink")、[核磁共振等物理現象](../Page/核磁共振.md "wikilink")，仍然是非常重要的。
...
近簡併量子態也應該使用前面講述的方法來解析，因為，在近簡併量子態的子空間內，能級的相差很可能是微擾的量級。[近自由電子模型是一個標準案例](../Page/近自由電子近似.md "wikilink")，即便是對於很小的微擾，正確的近簡併計算也能給出[能隙](../Page/能隙.md "wikilink")。
...
[ko:건드림이론](../Page/ko:건드림이론.md "wikilink")
...
1.  E. Schrödinger, Annalen der Physik, Vierte Folge, Band 80, p. 437
    (1926)
2.  J. W. S. Rayleigh, *Theory of Sound*, 2nd edition Vol. I, pp
    115-118, Macmillan, London (1894)
3.  L. D. Landau, E. M. Lifschitz, \`\`Quantum Mechanics:
    Non-relativistic Theory"'', 3rd ed.
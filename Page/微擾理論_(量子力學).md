...
Equation)
的精確解。物理學家所知道的就只有幾個量子模型有精確解，像[氫原子](../Page/氫原子.md "wikilink")、[量子諧振子](../Page/量子諧振子.md "wikilink")、與[盒中粒子](https://zh.wikipedia.org/wiki/盒中粒子 "wikilink")。這些量子模型都太過理想化，無法適當地描述大多數的量子系統。應用微擾理論，可以將這些理想的量子模型的精確解，用來生成一系列更複雜的量子系統的解答。例如，通過添加一個微擾的[電位於氫原子的哈密頓量](https://zh.wikipedia.org/wiki/電位 "wikilink")，可以計算在[電場](../Page/電場.md "wikilink")的作用下，氫原子[譜線](../Page/譜線.md "wikilink")產生的微小偏移（參閱[斯塔克效應](https://zh.wikipedia.org/wiki/斯塔克效應 "wikilink")(Stark's
...
1926年，他又在另一篇論文裏，發表了微擾理論\[1\]。在這篇論文裏，薛定谔提到[約翰·斯特拉特，第三代瑞利男爵](../Page/約翰·斯特拉特，第三代瑞利男爵.md "wikilink")先前的研究\[2\]。瑞利勳爵曾經在弦的[諧振動的微擾研究](https://zh.wikipedia.org/wiki/振動 "wikilink")，得到突破性的結果。現今，微擾理論時常又被稱為**瑞利-薛定谔微擾理論**。

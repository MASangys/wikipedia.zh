...
[网页上的允许的微格式数据包括事件](https://zh.wikipedia.org/wiki/网页 "wikilink")、人物、地点等，它可以被其他的[软件检测到](../Page/软件.md "wikilink")，并提取出相应的信息，以及对信息进行[索引](https://zh.wikipedia.org/wiki/索引 "wikilink")、[搜索](https://zh.wikipedia.org/wiki/搜索 "wikilink")、[跨平台的参考](https://zh.wikipedia.org/wiki/跨平台 "wikilink")，把这些信息以其他形式重复使用或组合。
...
这样机器就可以正确地理解这些数字的含义，可以对他进行索引，在[地图上看他的位置](../Page/地图.md "wikilink")，把它导出到[GPS设备](https://zh.wikipedia.org/wiki/GPS "wikilink")，以及其他的用途。

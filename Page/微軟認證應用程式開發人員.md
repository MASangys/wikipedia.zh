[MCAD_logo.png](https://zh.wikipedia.org/wiki/File:MCAD_logo.png "fig:MCAD_logo.png")
**微軟認證應用程式開發人員**（MCAD）為微軟在.NET Framework
1.0-1.1時期，為了與[MCSD工作項目有所區分](https://zh.wikipedia.org/wiki/Microsoft_Certified_Solution_Developer "wikilink")，並且不是所有人都具有系統分析能力的情況下，所加入的認證資格，持有此認證表示具有應用Microsoft
[.NET
Framework技術發展應用程式的能力](https://zh.wikipedia.org/wiki/.NET_Framework "wikilink")，應用程式不一定要Windows與Web都精通，但一定要會XML
Web Service和伺服器端的開發，這些需求也反應到了考科之上。

> 本文内容由[微軟認證資料庫管理員](https://zh.wikipedia.org/wiki/微軟認證資料庫管理員)转换而来。


[MCDBA_logo.png](https://zh.wikipedia.org/wiki/File:MCDBA_logo.png "fig:MCDBA_logo.png") **微軟認證資料庫管理員**（MCDBA）為微軟針對SQL Server資料庫所推出的獨立認證，特別針對[資料庫管理員所設計](https://zh.wikipedia.org/wiki/資料庫管理員 "wikilink")，持有此認證的專業人員，可被視為具有管理SQL Server以及設計資料庫應用的專業能力與知識。MCDBA最早是自SQL Server 7.0開始推出，歷經SQL Server 2000時期，兩個時期的認證要求差不多，都是要求通過四科考試，包含資料庫系統管理，資料庫設計，伺服器作業系統管理以及選考科目。

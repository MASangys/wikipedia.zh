[MCDBA_logo.png](https://zh.wikipedia.org/wiki/File:MCDBA_logo.png "fig:MCDBA_logo.png")
**微軟認證資料庫管理員**（MCDBA）為微軟針對SQL
Server資料庫所推出的獨立認證，特別針對[資料庫管理員所設計](https://zh.wikipedia.org/wiki/資料庫管理員 "wikilink")，持有此認證的專業人員，可被視為具有管理SQL
Server以及設計資料庫應用的專業能力與知識。MCDBA最早是自SQL Server 7.0開始推出，歷經SQL Server
2000時期，兩個時期的認證要求差不多，都是要求通過四科考試，包含資料庫系統管理，資料庫設計，伺服器作業系統管理以及選考科目。

本認證已隨著Exam 70-228與Exam 70-229於2009年3月31日停考後正式走入歷史，但已發出的認證為永久有效。

## MCDBA on SQL Server 7.0

MCDBA on SQL Server 7.0是第一代的MCDBA認證，配合SQL Server
7.0所需要的執行環境，以及程式發展的需求所設計，當時的作業環境為Windows
2000，並且在SQL Server 7.0中首次支援資料倉儲的建置，但在當時並不是主要的需求，因此將資料倉儲的考試放置在選考科目中。
...
在SQL Server 2000時代，由於作業環境橫跨了Windows 2000和Windows Server
2003，因此MCDBA的考試也納入兩個環境，在SQL Server 2000的考試配置的差異和SQL
Server 7.0時期差不多，都需要通過系統管理與資料庫設計兩科考試。

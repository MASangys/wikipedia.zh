**微软安全开发周期**是[微软公司提出的](https://zh.wikipedia.org/wiki/微软公司 "wikilink")[软件开发过程](../Page/软件开发过程.md "wikilink")，以降低[计算机软件维护成本](https://zh.wikipedia.org/wiki/计算机软件 "wikilink")，提高软件可靠性，提高与[程序错误](../Page/程序错误.md "wikilink")相关的[计算机安全](../Page/计算机安全.md "wikilink")。该方法基于[螺旋模型](../Page/螺旋模型.md "wikilink")。\[1\]\[2\]\[3\]
...
## 外部链接
  ...
  -
  - [MSDN的Microsoft Security Development Lifecycle (SDL) – version 5.2](https://msdn.microsoft.com/en-us/library/windows/desktop/cc307748.aspx)
...
2.
3.
4.  \[<https://msdn.microsoft.com/en-us/library/jj161081(v=vs.140>).aspx Visual Studio 2015 Compile Options：/sdl (Enable Additional Security Checks)\]
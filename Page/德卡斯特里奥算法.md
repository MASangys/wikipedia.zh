[数学子领域](../Page/数学.md "wikilink")[数值分析中的](https://zh.wikipedia.org/wiki/数值分析 "wikilink")**德卡斯特里奥算法**（），以发明者保尔·德·卡斯特里奥命名，是计算[伯恩斯坦形式的多项式或](https://zh.wikipedia.org/wiki/伯恩斯坦形式 "wikilink")[貝茲曲線的](../Page/貝茲曲線.md "wikilink")[递归方法](../Page/递归.md "wikilink")。
...
在计算带*n*+1个控制点**P**<sub>*i*</sub>的三维空间中的*n*次[贝塞尔曲線](https://zh.wikipedia.org/wiki/贝塞尔曲線 "wikilink")
(Bézier curve) 时

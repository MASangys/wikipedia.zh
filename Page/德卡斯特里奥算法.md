[数学子领域](../Page/数学.md "wikilink")[数值分析中的](../Page/数值分析.md "wikilink")**德卡斯特里奥算法**（），以发明者保尔·德·卡斯特里奥命名，是计算[伯恩斯坦形式的多项式或](../Page/伯恩斯坦形式.md "wikilink")[貝茲曲線的](../Page/貝茲曲線.md "wikilink")[递归方法](../Page/递归.md "wikilink")。

虽然对于大部分的体系结构，该算法和直接方法相比较慢，但它在数值上更为[稳定](../Page/數值穩定性.md "wikilink")。
...
曲线在*t*<sub>0</sub>点上可以用[遞迴關係式运算](../Page/遞迴關係式.md "wikilink")
...
在计算带*n*+1个控制点**P**<sub>*i*</sub>的三维空间中的*n*次[贝塞尔曲線](../Page/贝塞尔曲線.md "wikilink")
(Bézier curve) 时
...
## 参考
  ...
  - Farin, Gerald & Hansford, Dianne (2000). *The Essentials of CAGD*.
    Natic, MA: A K Peters, Ltd. ISBN 1-56881-123-3

## 参看

  - [Horner法](../Page/Horner法.md "wikilink")：计算[单项式形式多项式](../Page/单项式形式.md "wikilink")
  - [Clenshaw算法](../Page/Clenshaw算法.md "wikilink")：计算[切比雪夫形式多项式](../Page/切比雪夫形式.md "wikilink")

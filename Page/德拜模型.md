...
在[热力学](../Page/热力学.md "wikilink")和[固体物理学](../Page/固体物理学.md "wikilink")中，**德拜模型**（英語：**Debye
model**）是由[彼得·德拜](../Page/彼得·德拜.md "wikilink")在1912年提出的方法\[1\]，用于估算[声子](../Page/声子.md "wikilink")对固体的[比热](https://zh.wikipedia.org/wiki/比热 "wikilink")（热容）的贡献。德拜模型把[原子](../Page/原子.md "wikilink")[晶格的](https://zh.wikipedia.org/wiki/晶格 "wikilink")[振动](https://zh.wikipedia.org/wiki/振动 "wikilink")（熱）当作盒中的[聲子处理](https://zh.wikipedia.org/wiki/聲子 "wikilink")，而与此不同的[爱因斯坦模型](../Page/爱因斯坦模型.md "wikilink")则将固体作为许多单独的、不相互作用的[量子谐振子处理](https://zh.wikipedia.org/wiki/量子谐振子 "wikilink")。德拜模型正确地预言了低温时固体的热容：与\(T^3\)成正比（德拜\(T^3\)定律）。与[爱因斯坦模型](../Page/爱因斯坦模型.md "wikilink")一样，它在高温时也与[杜隆-珀蒂定律](../Page/杜隆-珀蒂定律.md "wikilink")相符合。但由于模型的简单假设，它在中间的温度不太准确。

...
在[热力学和](../Page/热力学.md "wikilink")[固体物理学中](../Page/固体物理学.md "wikilink")，**德拜模型**（英語：**Debye
model**）是由[彼得·德拜在](../Page/彼得·德拜.md "wikilink")1912年提出的方法\[1\]，用于估算[声子对固体的](../Page/声子.md "wikilink")[比热](../Page/比热.md "wikilink")（热容）的贡献。德拜模型把[原子](../Page/原子.md "wikilink")[晶格的](../Page/晶格.md "wikilink")[振动](../Page/振动.md "wikilink")（熱）当作盒中的[聲子处理](../Page/聲子.md "wikilink")，而与此不同的[爱因斯坦模型则将固体作为许多单独的](../Page/爱因斯坦模型.md "wikilink")、不相互作用的[量子谐振子处理](../Page/量子谐振子.md "wikilink")。德拜模型正确地预言了低温时固体的热容：与\(T^3\)成正比（德拜\(T^3\)定律）。与[爱因斯坦模型一样](../Page/爱因斯坦模型.md "wikilink")，它在高温时也与[杜隆-珀蒂定律相符合](../Page/杜隆-珀蒂定律.md "wikilink")。但由于模型的简单假设，它在中间的温度不太准确。

## 推导

德拜模型是[普朗克黑体辐射定律的固体版本](../Page/普朗克黑体辐射定律.md "wikilink")，后者把[电磁辐射视为](../Page/电磁辐射.md "wikilink")[盒中的光子气体](../Page/盒中气体.md "wikilink")，而德拜模型把原子的振动视为盒中的[声子](../Page/声子.md "wikilink")（盒子就是这块固体）。它们大部分的计算步骤都是相同的，因为[声子气和光子气都是有线性色散关系的](../Page/声子.md "wikilink")[玻色气体](../Page/玻色气体.md "wikilink")。

考虑一个边长为\(L\)的立方体。从[盒中粒子一文可知](../Page/盒中粒子.md "wikilink")，盒中的（沿某一边长方向传播的）声波由于共振效应，其波长只能为：
...
对于缓慢变化的、表现良好的函数，求和可以用积分来代替（又称为[托马斯-费米近似](../Page/托马斯-费米近似.md "wikilink")）：

\[U \approx\int_0^{\sqrt[3]{N}}\int_0^{\sqrt[3]{N}}\int_0^{\sqrt[3]{N}} E(n)\,\bar{N}\left(E(n)\right)\,dn_x\, dn_y\, dn_z\,.\]

至此，我们还没有提到\(\bar{N}(E)\)：能量为\(E\,\)的声子的数目。声子服从[玻色-爱因斯坦统计](../Page/玻色-爱因斯坦统计.md "wikilink")。它们的分布由著名的玻色-爱因斯坦公式给出：

\[\langle N\rangle_{BE} = {1\over e^{E/kT}-1}\,.\]

由于一个声子有三个可能的偏振态（一个[纵向](../Page/纵波.md "wikilink")、两个[横向](../Page/横波.md "wikilink")，大致携带相同的能量），需把以上公式乘以3：
...
这比光子的情况容易得多，因为（在半经典式的处理中）光子的频率（也即这个三重积分）是无上界的。但如上面图所示，这一点对于[声子不成立](../Page/声子.md "wikilink")。为了近似计算这个三重积分，德拜使用了[球坐标系](../Page/球坐标系.md "wikilink")：
...
实际上，德拜用不同且更简单的方法推出了这个公式。利用[连续介质的](../Page/连续介质力学.md "wikilink")[固体力学](../Page/固体力学.md "wikilink")，他发现频率小于某个特定值的振动状态的数目趋近于：

\[n \sim {1 \over 3} \nu^3 V F\,,\]

其中\(V\)是体积，\(F\)是一个从[弹性系数和密度计算出的因子](../Page/弹性_\(物理学\).md "wikilink")。把这与温度T的量子谐振子的期望能量（已经由爱因斯坦在他的模型中使用）结合，便给出能量：
...
这就是[杜隆-珀蒂定律](../Page/杜隆-珀蒂定律.md "wikilink")，它是相当准确的，虽然它没有考虑非谐性，这造成了热容进一步上升。如果固体是[导体或](../Page/导体.md "wikilink")[半导体](../Page/半导体.md "wikilink")，那么它的总热容还可能含有电子的不可忽略的贡献。

## 参见

  - [玻色气体](../Page/玻色气体.md "wikilink")
  - [盒中气体](../Page/盒中气体.md "wikilink")

...
德摩根定律在[数理逻辑的定理推演中](../Page/数理逻辑.md "wikilink")，在[计算机的逻辑设计中以及](https://zh.wikipedia.org/wiki/计算机 "wikilink")[数学的](../Page/数学.md "wikilink")[集合运算中都起着重要的作用](https://zh.wikipedia.org/wiki/集合运算 "wikilink")\[2\]。他的发现影响了[乔治·布尔从事的逻辑问题代数解法的研究](../Page/乔治·布尔.md "wikilink")，这巩固了德摩根作为该规律的发现者的地位，尽管[亚里士多德也曾注意到类似现象](../Page/亚里士多德.md "wikilink")、且这也为古希腊与中世纪的逻辑学家熟知（引自Bocheński《形式逻辑历史》）。
...
在经典命题逻辑的外延中，此二元性依然有效（即对于任意的逻辑运算符，我们都能找他它的对偶），由于存在于调节否定关系的恒等式中，人们总会引入作为一个算符的德摩根对偶的另一个算符。这导致了基于传统逻辑的逻辑学的一个重要性质，即[否定范式的存在性](https://zh.wikipedia.org/wiki/否定范式 "wikilink")：任何公式等价于另外一个公式，其中否定仅出现在作用于公式中非逻辑的原子时。否定常型的存在推进了许多应用，例如在[数位电路设计中该性质用于操纵](https://zh.wikipedia.org/wiki/数位电路 "wikilink")[逻辑閘](https://zh.wikipedia.org/wiki/逻辑閘 "wikilink")，以及在形式逻辑中该性质是寻找一个公式的[合取范式和](../Page/合取范式.md "wikilink")[析取范式的必要条件](https://zh.wikipedia.org/wiki/析取范式 "wikilink")；电脑程式設計師们则用它们将一个类似于"*如果...那么...否则...*"这样的复杂语句转变为其对等形式（例如：`if(...){...}
else{...}`）；它们也同样经常用于初等[概率论中的计算](https://zh.wikipedia.org/wiki/概率论 "wikilink")。
...
从而，量词的二元性可进一步延伸到[模态逻辑中的](../Page/模态逻辑.md "wikilink")[方块和](https://zh.wikipedia.org/wiki/方块 "wikilink")[菱形算符](../Page/菱形.md "wikilink")：

\[\Box p \equiv \neg \Diamond \neg p\]

\[\Diamond p \equiv \neg \Box \neg p\]

在其用于可能性和必然性的[真势模态的应用中](https://zh.wikipedia.org/wiki/真势模态 "wikilink")，[亚里士多德注意到该情况](../Page/亚里士多德.md "wikilink")，以及在[正规模态逻辑的情况中](../Page/正规模态逻辑.md "wikilink")，这些模态算符对量化的关系可借助按[关系语义设置模型来理解](../Page/关系语义.md "wikilink")。

...
\[2\]
由[保罗·德鲁德](../Page/保罗·德鲁德.md "wikilink")提出，以解释[电子](../Page/电子.md "wikilink")在物质（特别是金属）中的输运性质。这个模型是[分子运动论](../Page/分子运动论.md "wikilink")的一个应用，假设了电子在固体中的微观表现可以用经典的方法处理，很像一个[彈珠台](../Page/彈珠台.md "wikilink")，其中电子不断在较重的、相对固定的正离子之间来回反弹。

...
[电传导的](../Page/电传导.md "wikilink")**德鲁德模型**在1900年\[1\] \[2\]
由[保罗·德鲁德提出](../Page/保罗·德鲁德.md "wikilink")，以解释[电子在物质](../Page/电子.md "wikilink")（特别是金属）中的输运性质。这个模型是[分子运动论的一个应用](../Page/分子运动论.md "wikilink")，假设了电子在固体中的微观表现可以用经典的方法处理，很像一个[彈珠台](../Page/彈珠台.md "wikilink")，其中电子不断在较重的、相对固定的正离子之间来回反弹。

德鲁德模型的两个最重要的结果是电子的运动方程：

\[\frac{d}{dt}\mathbf{p}(t) = q\mathbf{E} - \frac{\mathbf{p}(t)}{\tau},\]
以及[电流密度](../Page/电流密度.md "wikilink")\(J\)与[电场](../Page/电场.md "wikilink")\(E\)之间的线性关系：

\[\mathbf{J} = \left( \frac{n q^2 \tau}{m} \right) \mathbf{E}.\]
在这里，\(t\)代表时间，\(p\)、\(q\)、\(n\)、\(m\)和\(\tau\)分别代表电子的动量、电荷、数密度、质量，以及与离子碰撞之间的平均自由时间。后一个表达式尤其重要，因为它用半定量的术语解释了为什么[欧姆定律](../Page/欧姆定律.md "wikilink")，电磁学中最普遍存在的一个关系，应该是正确的。\[3\]
\[4\] \[5\]
...
其中\(\langle\mathbf{p}\rangle\)表示[平均动量](../Page/平均.md "wikilink")，m表示有效质量，q表示电子的电荷。这是一个非齐次微分方程，它的通解为：
...
于是可以证明，物质满足[欧姆定律](../Page/欧姆定律.md "wikilink")，其[直流电电导率为](../Page/直流电.md "wikilink")\(\, \sigma_0\)：
...
这个简单、经典的德鲁德模型提供了[金属中的直流电和交流电传导](../Page/金属.md "wikilink")、[霍尔效应](../Page/霍尔效应.md "wikilink")，以及[热传导的非常好的解释](../Page/热传导.md "wikilink")。这个模型也解释了1853年发现的[魏德曼-弗朗茨定律](../Page/維德曼–夫蘭茲定理.md "wikilink")。然而，它大大高估了金属的电子热容。实际上，金属和绝缘体在常温下的热容大致上相等。虽然模型可以应用于正电荷（空穴）载流子，像霍尔效应所验证的那样，它并不预言它们的存在。

德鲁德在最初的论文中犯了一个概念性的错误，他估计电导率仅有实际值的一半。\[8\]

## 参见

  - [自由电子模型](../Page/自由电子模型.md "wikilink")
  - [阿诺·索末菲](../Page/阿诺·索末菲.md "wikilink")
  - [经典和量子传导](../Page/经典和量子传导.md "wikilink")
  - [电导率](../Page/电导率.md "wikilink")

...
[电传导的](https://zh.wikipedia.org/wiki/电传导 "wikilink")**德鲁德模型**在1900年\[1\]
\[2\]
...
以及[电流密度](../Page/电流密度.md "wikilink")\(J\)与[电场](https://zh.wikipedia.org/wiki/电场 "wikilink")\(E\)之间的线性关系：
...
这个简单、经典的德鲁德模型提供了[金属中的直流电和交流电传导](../Page/金属.md "wikilink")、[霍尔效应](https://zh.wikipedia.org/wiki/霍尔效应 "wikilink")，以及[热传导的非常好的解释](../Page/热传导.md "wikilink")。这个模型也解释了1853年发现的[魏德曼-弗朗茨定律](https://zh.wikipedia.org/wiki/維德曼–夫蘭茲定理 "wikilink")。然而，它大大高估了金属的电子热容。实际上，金属和绝缘体在常温下的热容大致上相等。虽然模型可以应用于正电荷（空穴）载流子，像霍尔效应所验证的那样，它并不预言它们的存在。

...
2012年2月，传输层安全（TLS）和[数据报传输层安全](https://zh.wikipedia.org/wiki/数据报传输层安全 "wikilink")（DTLS）协议的心跳扩展成为了标准，是为\[11\]。它提供了一种无需每次都重新协商连接，就能测试和保持安全通信链路的方式。2011年，RFC的作者之一，当时[杜伊斯堡-埃森大学](../Page/杜伊斯堡-埃森大学.md "wikilink")的博士生罗宾·赛格尔曼（Robin
...
Technica](../Page/Ars_Technica.md "wikilink")\[31\]和[布鲁斯·施奈尔](https://zh.wikipedia.org/wiki/布鲁斯·施奈尔 "wikilink")\[32\]均认为心脏出血漏洞是“灾难性的”。[福布斯](../Page/福布斯.md "wikilink")网络安全专栏作家写道：
...
2014年4月8日，[GitHub](../Page/GitHub.md "wikilink")上有一项对访问量最大的网站的分析，发现受影响的网站包括[雅虎](../Page/雅虎.md "wikilink")、[Imgur](../Page/Imgur.md "wikilink")、[Stack
...
Bundle及](../Page/Humble_Bundle.md "wikilink")[流亡黯道](../Page/流亡黯道.md "wikilink")在内的游戏受到影响，随后得到修复\[116\]。
...
存在缺陷的应用软件包括：
  ...
  - 若干[VMware](../Page/VMware.md "wikilink")产品，包括 5.5、[VMware
...
塔林理工大学的简思·格特鲁（Jens
Getreu）在他的文章中提到，如果OpenSSL使用保证内存安全的[Rust](../Page/Rust.md "wikilink")语言开发，那么心脏出血漏洞本来是可以避免的\[182\]。百度则使用Rust语言实现了MesaLink
TLS项目；MesaLink提供和OpenSSL兼容的API，从而可以在cURL等项目中替换OpenSSL\[183\]。

[西奥·德·若特](https://zh.wikipedia.org/wiki/西奥·德·若特 "wikilink")，[OpenBSD](../Page/OpenBSD.md "wikilink")和[OpenSSH](../Page/OpenSSH.md "wikilink")项目的创始人和领导者，就同一方面批评OpenSSL的开发人员编写自己的内存管理程序，如他所说的那样，这就绕过了OpenBSD
[C标准函数库对漏洞的防范](https://zh.wikipedia.org/wiki/C标准函数库 "wikilink")，他说“OpenSSL是由一个不负责任的团队开发的。”\[184\]\[185\]继心脏出血漏洞披露之后，OpenBSD项目的成员从OpenSSL[复刻出了](https://zh.wikipedia.org/wiki/复刻_\(软件工程\) "wikilink")[LibreSSL](../Page/LibreSSL.md "wikilink")\[186\]。
...
此漏洞后，谷歌成立了[Project
Zero寻找零日漏洞](../Page/Project_Zero_\(Google\).md "wikilink")，来帮助保护网络和社会。\[205\]

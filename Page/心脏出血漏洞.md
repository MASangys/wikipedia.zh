...
2014年4月8日，[GitHub上有一项对访问量最大的网站的分析](../Page/GitHub.md "wikilink")，发现受影响的网站包括[雅虎](../Page/雅虎.md "wikilink")、[Imgur](../Page/Imgur.md "wikilink")、[Stack
...
已经发布了[Snort规则](../Page/Snort.md "wikilink")，以检测心脏出血攻击流量和可能的心脏出血响应流量\[174\]。开源数据包分析软件，如[Wireshark及](../Page/Wireshark.md "wikilink")[tcpdump](https://zh.wikipedia.org/wiki/tcpdump "wikilink")，使用特定的BPF数据包过滤器，将其作用于捕获并存储的数据包和实时流量上，可以识别出心脏出血包\[175\]。

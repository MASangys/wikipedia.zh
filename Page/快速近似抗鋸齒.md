**快速近似抗锯齿**（，），由[nVIDIA員工Timothy](https://zh.wikipedia.org/wiki/nVIDIA "wikilink")
Lottes開發的一種[反鋸齒算法](../Page/反鋸齒.md "wikilink")。\[1\]
...
## 好處
  ...
  - 只需較低的運算效能，只平滑化呈鋸齒狀的邊緣。\[2\]即根據顯示屏的[像素去處理鋸齒](../Page/像素.md "wikilink")，而非像傳統的AA去分析3D模型本身。\[3\]

[数学](../Page/数学.md "wikilink")上，**态射**（morphism）是两个[数学结构之间保持结构的一种](https://zh.wikipedia.org/wiki/数学结构 "wikilink")[过程抽象](https://zh.wikipedia.org/wiki/过程抽象 "wikilink")。

最常见的这种过程的例子是在某种意义上保持结构的[函数](../Page/函数.md "wikilink")或[映射](https://zh.wikipedia.org/wiki/映射 "wikilink")。例如，在[集合论](../Page/集合论.md "wikilink")中，态射就是函数；在[群论](../Page/群论.md "wikilink")中，它们是[群同态](https://zh.wikipedia.org/wiki/群同态 "wikilink")；而在[拓扑学](../Page/拓扑学.md "wikilink")中，它们是[连续函数](../Page/连续函数.md "wikilink")；在[泛代数](https://zh.wikipedia.org/wiki/泛代数 "wikilink")（universal algebra）的范围，态射通常就是[同态](../Page/同态.md "wikilink")。

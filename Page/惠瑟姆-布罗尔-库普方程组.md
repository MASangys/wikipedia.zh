...
Whitman-Broer-Kaup 方程有cot、coth、tan、coth等函数展开行波解：
  ...
  -
    p\[2\] :=
    -1.0833333333333333333+7.6564210202379311500\*cot(-15.1+1.2\*x+1.3\*t)
    p\[3\] :=
    -1.0833333333333333333+7.6564210202379311500\*coth(-15.1+1.2\*x+1.3\*t)
    p\[4\] :=
    -1.0833333333333333333-7.6564210202379311500\*tan(-15.1+1.2\*x+1.3\*t)
    q\[5\] :=
    10.475595709785310629-10.475595709785310629\*tanh(-15.1+1.2\*x+1.3\*t)^2

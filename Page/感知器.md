...
1943年，心理学家[沃伦·麦卡洛克和数理逻辑学家](../Page/沃伦·麦卡洛克.md "wikilink")[沃尔特·皮茨在合作的](https://zh.wikipedia.org/wiki/沃尔特·皮茨 "wikilink")《A
logical calculus of the ideas immanent in nervous
activity》\[1\]论文中提出并给出了[人工神经网络的概念及人工](../Page/人工神经网络.md "wikilink")[神经元的数学模型](https://zh.wikipedia.org/wiki/神经元 "wikilink")，从而开创了人工神经网络研究的时代。1949年，心理学家[唐纳德·赫布在](../Page/唐纳德·赫布.md "wikilink")《The
Organization of
...
虽然最初被认为有着良好的发展潜能，但感知机最终被证明不能处理诸多的[模式识别问题](../Page/模式识别.md "wikilink")。1969年，[马文·明斯基和](../Page/马文·闵斯基.md "wikilink")[西摩·帕尔特在](https://zh.wikipedia.org/wiki/西摩·帕尔特 "wikilink")《Perceptrons》书中，仔细分析了以感知机为代表的单层神经网络系统的功能及局限，证明感知机不能解决简单的[异或](https://zh.wikipedia.org/wiki/异或 "wikilink")（XOR）等[线性不可分问题](https://zh.wikipedia.org/wiki/线性不可分 "wikilink")，但和[马文·明斯基和](../Page/马文·闵斯基.md "wikilink")[西摩·帕尔特等人在当时已经了解到多层神经网络能够解决线性不可分的问题](https://zh.wikipedia.org/wiki/西摩·帕尔特 "wikilink")。

由于等人没能够及时推广感知机学习算法到多层神经网络上，又由于《Perceptrons》在研究领域中的巨大影响，及人们对书中论点的误解，造成了人工神经领域发展的长年停滞及低潮，直到人们认识到[多层感知机没有单层感知机固有的缺陷及](https://zh.wikipedia.org/wiki/多层感知机 "wikilink")[反向传播算法在](../Page/反向传播算法.md "wikilink")80年代的提出，才有所恢复。1987年，书中的错误得到了校正，并更名再版为《Perceptrons
- Expanded Edition》。
...
设一训练集为\(D = \{(\mathbf{p}_1, \; t_1), \;\dots\;, (\mathbf{p}_m, \; t_m)\}\)，其中\(\mathbf{p}_i\)表示输入，而\({t}_i\)是对应的目标输出。由于符号函数的[不连续性](https://zh.wikipedia.org/wiki/不连续性 "wikilink")，如果采用标准的[均方误差](../Page/均方误差.md "wikilink")，所得[误差函数必然是不连续的](../Page/误差函数.md "wikilink")，因而基于[梯度的学习算法也就不能被使用](../Page/梯度.md "wikilink")。为此，Rosenblatt提出了感知机准则函数：

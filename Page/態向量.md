在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，一個量子系統的[量子態可以抽象地用](../Page/量子態.md "wikilink")**態向量**來表示。態向量存在於[內積空間](https://zh.wikipedia.org/wiki/內積空間 "wikilink")。定義內積空間為增添了一個額外的[內積結構的](https://zh.wikipedia.org/wiki/內積 "wikilink")[向量空間](https://zh.wikipedia.org/wiki/向量空間 "wikilink")。態向量滿足向量空間所有的[公理](../Page/公理.md "wikilink")。態向量是一種特殊的向量，它也允許[內積的運算](https://zh.wikipedia.org/wiki/內積 "wikilink")。態向量的範度是1，是一個[單位向量](https://zh.wikipedia.org/wiki/單位向量 "wikilink")。標記量子態\(\psi\,\!\)的態向量為\(|\psi\rangle\,\!\)。
...
定義\(|\alpha\rangle\,\!\)內積\(|\alpha\rangle\,\!\)的[平方根為](../Page/平方根.md "wikilink")\(|\alpha\rangle\,\!\)的[範數](https://zh.wikipedia.org/wiki/範數 "wikilink")，標記為\(|\alpha|\,\!\)。由於態向量滿足[歸一性](https://zh.wikipedia.org/wiki/歸一性 "wikilink")，態向量的範數必定等於1：

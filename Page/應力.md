...
stress），如圖1所示的\(\sigma_{11}\,\)、\(\sigma_{22}\,\)、\(\sigma_{33}\,\)，都是正向應力；假設受力表面與施力方向互相平行，則稱此應力分量為**[剪應力](https://zh.wikipedia.org/wiki/剪應力 "wikilink")**（shear
...
tensor）的[二阶张量](https://zh.wikipedia.org/wiki/二阶张量 "wikilink")（详见[并矢张量或者](https://zh.wikipedia.org/wiki/并矢张量 "wikilink")[张量积](../Page/张量积.md "wikilink")）。概略地说，**应力**描述了[连续介质内部之间通过力](https://zh.wikipedia.org/wiki/连续介质 "wikilink")（而且是通过近距离接触[作用力](https://zh.wikipedia.org/wiki/作用力 "wikilink")）进行[相互作用的强度](https://zh.wikipedia.org/wiki/相互作用 "wikilink")。具体说，如果我们把连续介质用一张假想的光滑[曲面把它一分为二](../Page/曲面.md "wikilink")，那么被分开的这两部分就会透过这张曲面相互施加作用力。很显然，即使在保持连续介质的物理状态不变的前提下，这种作用力也会因为假想曲面的不同而不同，所以，必须用一个不依赖于假想曲面的[物理量来描述连续介质内部的相互作用的状态](../Page/物理量.md "wikilink")。对于连续介质来说，担当此任的就是应力张量，简称为应力。

在这裡，我们所说的**连续介质**同[物理学中的](../Page/物理学.md "wikilink")[质点](https://zh.wikipedia.org/wiki/质点 "wikilink")、[刚体](../Page/刚体.md "wikilink")、[点电荷等类似](https://zh.wikipedia.org/wiki/点电荷 "wikilink")，都是一种[模型](https://zh.wikipedia.org/wiki/模型 "wikilink")，它假定[物质没有](../Page/物质.md "wikilink")[微观结构](https://zh.wikipedia.org/wiki/微观 "wikilink")，而只是[连续地分布在一个给定的三维](https://zh.wikipedia.org/wiki/连续 "wikilink")[区域中](https://zh.wikipedia.org/wiki/区域 "wikilink")－－有些情况下也会假定它连续分佈在一个光滑曲面上，甚至一条光滑[曲线上](../Page/曲线.md "wikilink")，不过我们这里暂不考虑这种二维分佈和一维分佈的连续介质。刚体就是连续介质的一种特殊情形。[流体和](https://zh.wikipedia.org/wiki/流体 "wikilink")[弹性体也是连续介质的特殊情形](../Page/弹性体.md "wikilink")。

设\(d\mathbf{S}\,\)是假想曲面\(\mathcal{S}\,\)的一个微小面积元素向量，其方向是垂直於假想曲面，朝著假想曲面的外側指去的方向，\(d\mathbf{F}\,\)是施加於假想曲面\(d\mathbf{S}\,\)的作用力，設定\(d\mathbf{F}\,\)的正值方向是朝著假想曲面的外側指去的方向。则，作为一个物理模型，\(d\mathbf{F}\,\)对\(d\mathbf{S}\,\)有线性依赖关系，也就是说，从\(d\mathbf{S}\,\)到\(d\mathbf{F}\,\)的映射是一个[线性映射](../Page/线性映射.md "wikilink")。这个线性映射可以通过二阶张量\(\boldsymbol{\sigma}\,\)（在[电动力学和](https://zh.wikipedia.org/wiki/电动力学 "wikilink")[相对论中常常用](../Page/相对论.md "wikilink")\(\mathbf{T}\,\)来表示）和
\(d\mathbf{S}\,\)的[张量缩并](https://zh.wikipedia.org/wiki/张量缩并 "wikilink")（）得到：
...
[等值曲面的單位面積的作用力](https://zh.wikipedia.org/wiki/等值曲面 "wikilink")。
...
在[牛顿力学中](https://zh.wikipedia.org/wiki/牛顿力学 "wikilink")，应力张量的对称性是[角动量定理的一个推论](https://zh.wikipedia.org/wiki/角动量定理 "wikilink")。

## 压强和剪应力

可以把应力张量分解为**[压强](../Page/压强.md "wikilink")**（pressure）\(p\,\)和**[剪应力](https://zh.wikipedia.org/wiki/剪应力 "wikilink")**（shear
stress）\(\boldsymbol{\tau}\,\)两部分。为此，我们先给出二阶张量的**[迹](https://zh.wikipedia.org/wiki/迹 "wikilink")**（trace）以及单位张量的定义。
...
在[电动力学中](https://zh.wikipedia.org/wiki/电动力学 "wikilink")，[电磁场的](../Page/电磁场.md "wikilink")[馬克士威應力張量在](../Page/馬克士威應力張量.md "wikilink")[国际单位制中的表达式为](../Page/国际单位制.md "wikilink")
...
这就是[统计力学中常常遇到的](../Page/统计力学.md "wikilink")[光压](https://zh.wikipedia.org/wiki/光压 "wikilink")。

## 應力的種類

  - [地应力](https://zh.wikipedia.org/wiki/地应力 "wikilink")：由于岩石发生形变而引起的介质内部单位面积上的作用力。

...
以\(x_0\in N\)為初值,
步長\(\gamma=1\)的牛頓法是**[二次收斂](../Page/收斂速度.md "wikilink")**的.
...
[Cholesky分解同](../Page/Cholesky分解.md "wikilink")[共軛梯度法只有在](https://zh.wikipedia.org/wiki/共軛梯度法 "wikilink")\(\mathbf{H}f(x)\)是[正定矩陣時才適用](https://zh.wikipedia.org/wiki/正定矩陣 "wikilink").
...
此時則要使用其他方法,
例如[Cholesky分解的\(\mathbf{LDL}^\mathbf{T}\)變形或](../Page/Cholesky分解.md "wikilink")[共軛梯度法等的方法](https://zh.wikipedia.org/wiki/共軛梯度法 "wikilink"),
來疊代得出\(x_{n+1}\).

此外,
為規避求[Hessian矩陣的繁瑣](https://zh.wikipedia.org/wiki/Hessian矩陣 "wikilink"),
也存在多種[擬牛頓法](../Page/擬牛頓法.md "wikilink"),

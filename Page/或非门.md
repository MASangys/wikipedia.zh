...
**或非门**（）是数字逻辑中实现[逻辑或非的](../Page/逻辑或非.md "wikilink")[逻辑门](https://zh.wikipedia.org/wiki/逻辑门 "wikilink")，功能见右侧[真值表](../Page/真值表.md "wikilink")。若输入均为低电平（0），则输出为高电平（1）；若输入中至少有一个为高电平（1），则输出为低电平（0）。或非是[逻辑或加](../Page/逻辑或.md "wikilink")[逻辑非得到的结果](https://zh.wikipedia.org/wiki/逻辑非 "wikilink")。或非是一种具有[函数完备性的运算](https://zh.wikipedia.org/wiki/函数完备性 "wikilink")，因此其他任何逻辑函数都能用或非门实现。相比之下，[逻辑或运算器是一种单调的运算器](../Page/逻辑或.md "wikilink")，其只能将低电平变为高电平，但不能将高电平变为低电平。
...
上图展示了使用NMOS线路的2输入或非门的构造。如果输入都是高电平，对应的NMOS就会接通，输出会被拉到低电平；反之输出会通过[上拉电阻被拉到高电平](../Page/上拉电阻.md "wikilink")。下图展示了使用[CMOS技术的](https://zh.wikipedia.org/wiki/CMOS "wikilink")2输入或非门。输出端的[二极管和](https://zh.wikipedia.org/wiki/二极管 "wikilink")[电阻用来保护CMOS元件](../Page/电阻.md "wikilink")，以防其受到[静电放电](https://zh.wikipedia.org/wiki/静电放电 "wikilink")（ESD）的损害，从而在电路的逻辑功能中发挥不了作用。
...
[eu:EZ-EDO ate
logikoa](https://zh.wikipedia.org/wiki/eu:EZ-EDO_ate_logikoa "wikilink")
[ro:NOR logic](https://zh.wikipedia.org/wiki/ro:NOR_logic "wikilink")

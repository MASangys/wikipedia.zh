...
上图展示了使用NMOS线路的2输入或非门的构造。如果输入都是高电平，对应的NMOS就会接通，输出会被拉到低电平；反之输出会通过[上拉电阻](../Page/上拉电阻.md "wikilink")被拉到高电平。下图展示了使用[CMOS技术的](https://zh.wikipedia.org/wiki/CMOS "wikilink")2输入或非门。输出端的[二极管和](https://zh.wikipedia.org/wiki/二极管 "wikilink")[电阻](../Page/电阻.md "wikilink")用来保护CMOS元件，以防其受到[静电放电](https://zh.wikipedia.org/wiki/静电放电 "wikilink")（ESD）的损害，从而在电路的逻辑功能中发挥不了作用。 [Cmosunbuff.png](https://zh.wikipedia.org/wiki/File:Cmosunbuff.png "fig:Cmosunbuff.png")

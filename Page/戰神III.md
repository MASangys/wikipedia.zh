...
<!-- end list -->
  ...
  -
    曾將克雷多斯推上戰神之位，但為保護宙斯遭其誤殺。後來卻讓克雷多斯尋找奧林匹斯的火焰（Flame of
    Olympus，宙斯力量的泉源）以擊敗宙斯。在战神2把克雷多斯的力量取走。
...
<!-- end list -->
  ...
  -
    以冥界之神的身分，而令眾人懼怕的哈帝斯。於"戰神III"阻擋於克雷多斯逃離冥府，最後被克雷多斯以其雙勾爪勾出魂魄而死。死後無數靈魂從其體內逸出，其軀體被冥河（River
    of Synx）內的亡魂拖走。
...
<!-- end list -->
  ...
  -
    許珀里翁之子，太陽神。在遊戲中鎮守奧林匹亞城（City of
    Olympia），被泰坦打傷，最後被克雷多斯無情的扭斷頭部致死。他死後太陽隕落，大地陷入黑暗之中。
...
<!-- end list -->
  ...
  -
    已亡之哈帝斯之妻，在本作只出現其軀體，在[战神：奥林匹斯之链中意圖破壞世界而被克雷多斯殺死](../Page/战神：奥林匹斯之链.md "wikilink")。
...
<!-- end list -->
  ...
  -
    由於克雷多斯掉入冥河，使得原先使用的雅典娜神劍（Blades of
    Athena）遭到冥界的死靈啃蝕、破壞，無法繼續使用，而雅典娜為了重新取得克雷多斯的信任，而給予克雷多斯這兩把雙刃，也是克雷多斯在戰神系列作中所擁有的第三把鎖鏈雙刃，攻擊方式和雅典娜神劍相去無幾，只有部份差別。
    戰神系列的代表性武器就是鎖鏈雙刃，攻擊方式相當有彈性，能直接在近距離砍殺、撕裂敵人，或拋出連接著鎖鏈的雙刃，以強大的離心力切下敵人的肢體和首級。
    能使出魔法:「Army of
    Sparta」（斯巴達軍隊）召喚已逝的斯巴達大軍，擺出著名的斯巴達方陣，以眾多盾牌保護克雷多斯並以長槍使出全方位攻擊，升級到後期甚至會降下箭雨。
...
<!-- end list -->
  ...
  -
    ...
    魔法技能為「Divine
    Reckoning」（神之決戰），使用時克雷多斯會將奧林匹斯神劍插入大地，招喚出從天而降的渦流，席捲周圍的敵人。
...
<!-- end list -->
  ...
  -
    曾經協助宙斯嬴得聖戰，集天地神氣而成的神劍。幾經轉手於克雷多斯和宙斯之間，最後回到克雷多斯手中。本作中並不能直接使用奥林匹斯神劍，只能發動Rage
    fo Sparta（斯巴達之怒），進入無敵模式，一定時間內使用奥林匹斯神劍。
...
Collection）裡所附加DEMO下載小卡）、2010年2月25日（PSN免費下載）釋出\[2\]
試玩版中出現了兩種武器，分別是雅典娜神劍和尼米恩拳套。實際遊戲場景畫面細節提升了許多，將敵人開腸剖肚等分屍之細節也描繪的更加仔細且更血腥。

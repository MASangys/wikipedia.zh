**戴德金η函數**（Dedekind eta
function）是定義在上半平面的[全純函數](https://zh.wikipedia.org/wiki/全純函數 "wikilink")，這是權1/2的[模形式之一例](../Page/模形式.md "wikilink")。
...
此處的根號是方根函數在右半平面的[解析延拓](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")
...
其中的[自守因子](https://zh.wikipedia.org/wiki/自守因子 "wikilink")\(\epsilon\)定為
...
operator）理論闡釋了模形式與數論的關鍵聯繫，同時也聯繫了模形式與[表示理論](https://zh.wikipedia.org/wiki/表示理論 "wikilink")。

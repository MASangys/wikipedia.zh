...
1.  在AB兩端[開路](https://zh.wikipedia.org/wiki/開路 "wikilink")（在沒有任何外電流輸出，亦即當AB點之間的阻抗無限大）的狀況下計算輸出電壓

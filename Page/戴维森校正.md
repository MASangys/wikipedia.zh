**戴维森校正**是一种在[组态相互作用方法](../Page/组态相互作用方法.md "wikilink")中经常使用的简单校正方法，是[计算化学](../Page/计算化学.md "wikilink")中[后哈特里–福克方法的几种能量校正方法之一](https://zh.wikipedia.org/wiki/后哈特里–福克方法 "wikilink")，由
...
另外由于戴维森校正是一种[微扰理论方法](https://zh.wikipedia.org/wiki/微扰理论 "wikilink")，其结果只有在系数\(a_0^2\)接近1的情况下才有意义。因此当用于参考态的[哈特里–福克方法与CISD给出的](https://zh.wikipedia.org/wiki/哈特里–福克方法 "wikilink")[电子态不相近时](../Page/电子排布.md "wikilink")，该校正无效。这使得戴维森校正无法用于[激发态](../Page/激发态.md "wikilink")能量的计算。

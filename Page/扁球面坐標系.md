[Oblate_spheroidal_coordinates_half_hyperboloid.png](https://zh.wikipedia.org/wiki/File:Oblate_spheroidal_coordinates_half_hyperboloid.png "fig:Oblate_spheroidal_coordinates_half_hyperboloid.png")。紅色扁球面的\(\mu=1\)。藍色半雙曲面的\(\nu=45^{\circ}\)。黃色半平面的\(\phi= - 60^{\circ}\)（黃色半平面與xz-半平面之間的[二面角角度是](../Page/二面角.md "wikilink")\(- 60^{\circ}\)）。z-軸是垂直的，以白色表示。x-軸以綠色表示。三個坐標曲面相交於點P（以黑色的圓球表示），[直角坐標大約為](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")\((1.09,\ - 1.89,\ 1.66)\)。\]\]
[OblateSpheroidCoord.png](https://zh.wikipedia.org/wiki/File:OblateSpheroidCoord.png "fig:OblateSpheroidCoord.png")

**扁球面坐標系**（）是一種三維[正交坐標系](https://zh.wikipedia.org/wiki/正交坐標系 "wikilink")。設定二維[橢圓坐標系包含於xz](../Page/橢圓坐標系.md "wikilink")-平面；兩個焦點\(F_{1}\)與\(F_{2}\)的[直角坐標分別為](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")\(( - a,\ 0,\ 0)\)與\((a,\ 0,\ 0)\)。將橢圓坐標系繞著z-軸旋轉，則可以得到扁球面坐標系。（假若，繞著y-軸旋轉，則可以得到[長球面坐標系](../Page/長球面坐標系.md "wikilink")。）橢圓坐標系的兩個焦點，變為一個半徑為\(a\)的圓圈，包含於三維空間的xy-平面。稱這圓圈為**焦圓**，又稱為**參考圓**。扁球面坐標系可以被視為[橢球坐標系的極限案例](../Page/橢球坐標系.md "wikilink")，其兩個最大的半軸的長度相同。

當邊界條件涉及[扁球面或](https://zh.wikipedia.org/wiki/扁球面 "wikilink")[旋轉雙曲面時](../Page/雙曲面.md "wikilink")，扁球面坐標時常可以用來解析[偏微分方程式](https://zh.wikipedia.org/wiki/偏微分方程式 "wikilink")。例如，關於[佩蘭摩擦因子](https://zh.wikipedia.org/wiki/佩蘭摩擦因子 "wikilink")（）的計算，扁球面坐標扮演了極重要的角色。[讓·佩蘭因此而榮獲](https://zh.wikipedia.org/wiki/讓·佩蘭 "wikilink")1926年[諾貝爾物理獎](https://zh.wikipedia.org/wiki/諾貝爾物理獎 "wikilink")。佩蘭摩擦因子決定了[分子的](../Page/分子.md "wikilink")[旋轉擴散](https://zh.wikipedia.org/wiki/旋轉擴散 "wikilink")（）。這程序又影響了許多科技，像[蛋白質](https://zh.wikipedia.org/wiki/蛋白質 "wikilink")[核磁共振](../Page/核磁共振.md "wikilink")[光譜學](https://zh.wikipedia.org/wiki/光譜學 "wikilink")（），的可行性。應用這程序，我們可以推論分子的[流體動力體積與形狀](../Page/流體動力學.md "wikilink")。扁球面坐標也時常用來解析[電磁學](https://zh.wikipedia.org/wiki/電磁學 "wikilink")（例如，扁球形帶電的分子的[電容率](https://zh.wikipedia.org/wiki/電容率 "wikilink")），[聲學](https://zh.wikipedia.org/wiki/聲學 "wikilink")（例如，聲音通過圓孔時產生的散射），[流體動力學](../Page/流體動力學.md "wikilink")（水通過消防水帶的噴口），[擴散理論](https://zh.wikipedia.org/wiki/擴散 "wikilink")（紅熱的錢幣在水裏的冷卻），等等方面的問題。
...
如同[球坐標解答的形式為](https://zh.wikipedia.org/wiki/球坐標 "wikilink")[球諧函數](https://zh.wikipedia.org/wiki/球諧函數 "wikilink")，[拉普拉斯方程可以用分離變數法來求解](../Page/拉普拉斯方程.md "wikilink")，得到形式為扁球**諧函數**的答案。假若，邊界條件涉及扁球面，我們可以優先選擇這方法來解析。

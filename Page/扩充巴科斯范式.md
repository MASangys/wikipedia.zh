在[计算机科学中](../Page/计算机科学.md "wikilink")，**扩充巴科斯-瑙尔范式**（ABNF）是一种基于[巴科斯-瑙尔范式](https://zh.wikipedia.org/wiki/巴科斯-瑙尔范式 "wikilink")（BNF）的[元语言](https://zh.wikipedia.org/wiki/元语言 "wikilink")，但它有自己的语法和派生规则。ABNF的原动原则是描述一种作为双向[通信协议的语言的](https://zh.wikipedia.org/wiki/通信协议 "wikilink")[形式系统](https://zh.wikipedia.org/wiki/形式系统 "wikilink")。它是由[*第68号互联网标准*](http://www.rfc-editor.org/std/std68.txt)（"STD
68"，大小写样式按照原文）定义的，也就是RFC
5234，经常用于[互联网工程任务组](../Page/互联网工程任务组.md "wikilink")（[IETF](https://zh.wikipedia.org/wiki/IETF "wikilink")）通信协议的定义语言。\[1\]\[2\]

在[组合数论中](https://zh.wikipedia.org/wiki/组合数论 "wikilink")，**扩展图**（）是一种具有强[连通性质的](../Page/连通图.md "wikilink")[疏松图](https://zh.wikipedia.org/wiki/疏松图 "wikilink")，具体而言，看可用边、顶点或图谱扩展性（）三种方式定义。扩展图的构造问题引导了多个数学分支上的研究，它还在[计算复杂性理论](https://zh.wikipedia.org/wiki/计算复杂性理论 "wikilink")、[计算机网络](../Page/计算机网络.md "wikilink")设计和[编码理论](../Page/编码理论.md "wikilink")上有诸多应用\[1\]。

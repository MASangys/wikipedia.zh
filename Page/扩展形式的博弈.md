[博弈论](../Page/博弈论.md "wikilink")中，与[正則形式相应](https://zh.wikipedia.org/wiki/正則形式的博弈 "wikilink")，**扩展形式**（Extensive-form game）通过[树来描述博弈](../Page/树_\(图论\).md "wikilink")。每个[节点](../Page/顶点_\(图论\).md "wikilink")（称作**决策节点**）表示博弈进行中的每一个可能的状态。博弈从唯一的**初始节点**开始，通过由参与者决定的路径到达**终端节点**，此时[博弈结束](https://zh.wikipedia.org/wiki/结果_\(博弈论\) "wikilink")，参与者得到相应的收益。每个非终端节点只属于一个参与者；参与者在该节点选择其可能的行动，每个可能的行动通过[边从该节点到达另一个节点](https://zh.wikipedia.org/wiki/边_\(图论\) "wikilink")。

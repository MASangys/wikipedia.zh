...
Abstractions*）是一個有關[程式的定律](https://zh.wikipedia.org/wiki/程式 "wikilink")。最早是由Joel
Spolsky在其[部落格中提出](https://zh.wikipedia.org/wiki/部落格 "wikilink")，其定義為「所有非不證自明的抽象概念，都有某種程度的疏漏」（原文：*All
...
另外也可以從[物件導向語言來看](https://zh.wikipedia.org/wiki/物件導向語言 "wikilink")([C++或是](../Page/C++.md "wikilink")[JAVA](https://zh.wikipedia.org/wiki/JAVA "wikilink"))，何為抽象漏洞定律就是抽象介面與實體化執行的分離。

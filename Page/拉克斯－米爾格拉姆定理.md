**拉克斯－米爾格拉姆定理**是[數學](https://zh.wikipedia.org/wiki/數學 "wikilink")[泛函分析的定理](../Page/泛函分析.md "wikilink")，以[彼得·拉克斯和](https://zh.wikipedia.org/wiki/彼得·拉克斯 "wikilink")[阿瑟·米爾格拉姆命名](https://zh.wikipedia.org/wiki/阿瑟·米爾格拉姆 "wikilink")。这定理可用來藉[弱形式求解](https://zh.wikipedia.org/wiki/弱形式 "wikilink")[偏微分方程](../Page/偏微分方程.md "wikilink")，因此主要用作[有限元法的理論基礎](https://zh.wikipedia.org/wiki/有限元法 "wikilink")。
...
而且如果\(a\)是[對稱的](../Page/對稱.md "wikilink")，那麼\(u\)是\(\mathcal{H}\)中唯一的元素，使得以下[泛函取](../Page/泛函.md "wikilink")[最小值](https://zh.wikipedia.org/wiki/最小值 "wikilink")\(J:\mathcal{H}\rightarrow\R\)，\(J(v) = \tfrac{1}{2}a(v,v)-Lv\)對所有\(v\in\mathcal{H}\)，即：
...
是一個\(\mathcal{H}\)上連續[線性自同態](https://zh.wikipedia.org/wiki/線性自同態 "wikilink")。由此可把\((1)\)表示成如下等價形式：
...
[en:Lax-Milgram
theorem](https://zh.wikipedia.org/wiki/en:Lax-Milgram_theorem "wikilink")

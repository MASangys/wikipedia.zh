> 本文内容由[拉卡多项式](https://zh.wikipedia.org/wiki/拉卡多项式)转换而来。


[Racah_polynomials.gif](https://zh.wikipedia.org/wiki/File:Racah_polynomials.gif "fig:Racah_polynomials.gif") **拉卡多项式**(Racah polynomials)是数学中以Guilio Racah命名的正交多项式，由下列[广义超几何函数](../Page/广义超几何函数.md "wikilink")定义\[1\]

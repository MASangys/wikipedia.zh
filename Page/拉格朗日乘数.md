...
在[数学中的](../Page/数学.md "wikilink")[最优化问题中](../Page/最优化.md "wikilink")，**拉格朗日乘数法**（以数学家[约瑟夫·拉格朗日命名](../Page/约瑟夫·拉格朗日.md "wikilink")）是一种寻找多元[函数在其](../Page/函数.md "wikilink")[变量受到一个或多个条件的约束时的](https://zh.wikipedia.org/wiki/自变量 "wikilink")[极值的方法](../Page/极值.md "wikilink")。这种方法可以将一个有*n*个变量与*k*个约束条件的最优化问题转换为一个解有*n*
+
*k*个变量的[方程组的解的问题](../Page/方程.md "wikilink")。这种方法中引入了一个或一组新的[未知数](https://zh.wikipedia.org/wiki/未知数 "wikilink")，即**拉格朗日乘数**，又称**拉格朗日乘子**，或**拉氏乘子**，它们是在转换后的方程，即约束方程中作为[梯度](../Page/梯度.md "wikilink")（gradient）的[线性组合中各个向量的系数](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。
...
拉格朗日乘数法所得的极点会包含原问题的所有极值点，但并不保证每个极值点都是原问题的极值点。拉格朗日乘数法的正确性的证明牵涉到[偏微分](https://zh.wikipedia.org/wiki/偏微分 "wikilink")，[全微分或](../Page/全微分.md "wikilink")[链法](https://zh.wikipedia.org/wiki/链法 "wikilink")。
...
约束最优化在[经济学占有很重要的地位](../Page/经济学.md "wikilink")。例如一个[消费者的选择问题可以被视为一个求](../Page/消费者.md "wikilink")[效用方程在](../Page/效用.md "wikilink")[预算约束下的最大值问题](https://zh.wikipedia.org/wiki/预算约束 "wikilink")。拉格朗日乘数在经济学中被解释为[影子价格](https://zh.wikipedia.org/wiki/影子价格 "wikilink")，设定在某种约束下，在这里即收入的[边际效用](https://zh.wikipedia.org/wiki/边际效用 "wikilink")。

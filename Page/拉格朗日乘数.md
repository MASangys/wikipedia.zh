...
在[数学](../Page/数学.md "wikilink")中的[最优化](../Page/最优化.md "wikilink")问题中，**拉格朗日乘数法**（以数学家[约瑟夫·拉格朗日](../Page/约瑟夫·拉格朗日.md "wikilink")命名）是一种寻找多元[函数](../Page/函数.md "wikilink")在其[变量受到一个或多个条件的约束时的](https://zh.wikipedia.org/wiki/自变量 "wikilink")[极值](../Page/极值.md "wikilink")的方法。这种方法可以将一个有*n*个变量与*k*个约束条件的最优化问题转换为一个解有*n* + *k*个变量的[方程](../Page/方程.md "wikilink")组的解的问题。这种方法中引入了一个或一组新的[未知数](https://zh.wikipedia.org/wiki/未知数 "wikilink")，即**拉格朗日乘数**，又称**拉格朗日乘子**，或**拉氏乘子**，它们是在转换后的方程，即约束方程中作为[梯度](../Page/梯度.md "wikilink")（gradient）的[线性组合中各个向量的系数](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。

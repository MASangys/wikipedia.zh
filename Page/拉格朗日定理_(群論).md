**拉格朗日定理**是[群論的定理](https://zh.wikipedia.org/wiki/群論 "wikilink")，利用[陪集證明了](../Page/陪集.md "wikilink")[子群的階一定是有限](../Page/子群.md "wikilink")[群的階的因數值](../Page/群.md "wikilink")。

## 定理

叙述：设H是有限[群G的子群](../Page/群.md "wikilink")，则H的[阶整除G的阶](../Page/階_\(群論\).md "wikilink")。
...
拉格朗日定理说明，如果[商群](../Page/商群.md "wikilink")*G* /
*H*存在，那么它的阶等于H对G的指数\[G:H\]。
...
*d*的子群。最简单的例子是4次交替群*A*<sub>4</sub>，它的阶是12，但对于12的因数6，*A*<sub>4</sub>没有6阶的子群。对于这样的子群的存在性，[柯西定理和](https://zh.wikipedia.org/wiki/柯西定理_\(群论\) "wikilink")[西洛定理给出了一个部分的回答](https://zh.wikipedia.org/wiki/西洛定理 "wikilink")。

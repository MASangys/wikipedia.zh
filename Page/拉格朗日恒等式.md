...
应用于任意两个[实数](../Page/实数.md "wikilink")或[复数集合](../Page/复数_\(数学\).md "wikilink")（或者更一般地，一个[交换环](../Page/交换环.md "wikilink")的元素）{*a*<sub>1</sub>,
*a*<sub>2</sub>, . . ., *a<sub>n</sub>*} and {*b*<sub>1</sub>,
*b*<sub>2</sub>, . . .,
*b<sub>n</sub>*}。这个恒等式是[婆罗摩笈多－斐波那契恒等式](../Page/婆罗摩笈多－斐波那契恒等式.md "wikilink")的推广，同时也是[Binet–Cauchy恒等式的特殊形式](https://zh.wikipedia.org/wiki/Binet–Cauchy恒等式 "wikilink")。

在代数中，以[约瑟夫·拉格朗日命名的](../Page/约瑟夫·拉格朗日.md "wikilink")**拉格朗日恒等式**是：\[1\]\[2\]
...
应用于任意两个[实数或](../Page/实数.md "wikilink")[复数集合](../Page/复数_\(数学\).md "wikilink")（或者更一般地，一个[交换环的元素](../Page/交换环.md "wikilink")）{*a*<sub>1</sub>,
*a*<sub>2</sub>, . . ., *a<sub>n</sub>*} and {*b*<sub>1</sub>,
*b*<sub>2</sub>, . . .,
*b<sub>n</sub>*}。这个恒等式是[婆罗摩笈多－斐波那契恒等式的推广](../Page/婆罗摩笈多－斐波那契恒等式.md "wikilink")，同时也是[Binet–Cauchy恒等式的特殊形式](https://zh.wikipedia.org/wiki/Binet–Cauchy恒等式 "wikilink")。

用一个更为简洁的向量形式表示，Lagrange恒等式就是：\[3\]

\[\| \mathbf a \|^2 \ \| \mathbf b \|^2 - (\mathbf {a \cdot b } )^2 = \sum_{1 \le i < j \le n} \left(a_ib_j-a_jb_i \right)^2 \ ,\]

其中**a**和**b**是由实数构成的*n*维向量。向复数的引申需要将[点积理解为](../Page/点积.md "wikilink")[内积或者Hermitian点积](https://zh.wikipedia.org/wiki/内积 "wikilink")。准确的说，对于复数，Lagrange恒等式可以写成以下形式：\[4\]

...
**拉格朗日方程式**（），因數學物理學家[约瑟夫·拉格朗日而命名](../Page/约瑟夫·拉格朗日.md "wikilink")，是[分析力學的重要方程式](../Page/分析力學.md "wikilink")，可以用來描述物體的運動，特別適用於理論物理的研究。拉格朗日方程式的功能相等於[牛頓力學中的](../Page/牛頓力學.md "wikilink")[牛頓第二定律](../Page/牛頓第二定律.md "wikilink")。
...
在[分析力學裏](../Page/分析力學.md "wikilink")，有三種方法可以導引出拉格朗日方程式。最原始的方法是使用達朗貝爾原理導引出拉格朗日方程式（參閱[達朗貝爾原理](../Page/達朗貝爾原理#拉格朗日方程式.md "wikilink")）；更進階層面，可以從哈密頓原理推導出拉格朗日方程式（參閱[哈密頓原理](../Page/哈密頓原理#拉格朗日方程式導引.md "wikilink")）；最簡明地，可以借用數學[變分法的](../Page/變分法.md "wikilink")[歐拉-拉格朗日方程式來推導](../Page/歐拉-拉格朗日方程式.md "wikilink")：
...
其中，\(x\,\!\)是[自變數](../Page/自變數.md "wikilink")（）。

若\(\mathbf{y}(x)\in(C^1[a,\ b])^N\,\!\)使[泛函](../Page/泛函.md "wikilink")\(J(\mathbf{y})=\int_a^bf(\mathbf{y},\ \dot{\mathbf{y}},\ x)dx\,\!\)取得局部[平穩值](../Page/平穩值.md "wikilink")，則在區間\((a,\ b)\,\!\)內，歐拉-拉格朗日方程式成立：
...
\[\frac{d}{dt}\frac{\partial \mathcal{L}}{\partial \dot\mathbf{q}} - \frac{\partial \mathcal{L}}{\partial \mathbf{q}} = \mathbf{0}\,\!\]。
  ...
  - 拉格朗日量是[動能減去](../Page/動能.md "wikilink")[位勢](../Page/位勢.md "wikilink")，而位勢必須是[廣義位勢](../Page/廣義位勢.md "wikilink")。所以，這系統必須是單演系統。

## 半完整系統

  -
    主項目：參閱[半完整系統](../Page/非完整系統#半完整系統.md "wikilink")

一個不是完整系統的物理系統是[非完整系統](../Page/非完整系統.md "wikilink")，不能用上述形式論來分析。假若，一個非完整系統的[約束可以以方程式表示為](../Page/約束.md "wikilink")
...
思考一個粒子從靜止狀態自由地下落。由於[重力](../Page/重力.md "wikilink")\(F=mg\,\!\)作用於此粒子，應用[牛頓第二定律](../Page/牛頓第二定律.md "wikilink")，可以得到運動方程式
...
## 相關條目
  ...
  - [牛頓力學](../Page/牛頓力學.md "wikilink")
  - [變分法](../Page/變分法.md "wikilink")

## 參考文獻

[en:Lagrangian equation](../Page/en:Lagrangian_equation.md "wikilink")

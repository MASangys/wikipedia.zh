...
在按照下式定义的内积构成的[内积空间](../Page/内积空间.md "wikilink")中，拉盖尔多项式是[正交多项式](https://zh.wikipedia.org/wiki/正交多项式 "wikilink")。
...
## 广义拉盖尔多项式的性质与应用
  ...
  - 拉盖尔函数可以由[合流超几何函数](../Page/合流超几何函数.md "wikilink")和Kummer变换得到：
...
随意选定参量t，[贝塞尔函数](../Page/贝塞尔函数.md "wikilink")可以表示为：
...
[Γ函数](../Page/Γ函数.md "wikilink")可以展开为：

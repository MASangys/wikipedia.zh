...
## 广义拉盖尔多项式的性质与应用
  ...
  - 拉盖尔函数可以由[合流超几何函数和Kummer变换得到](https://zh.wikipedia.org/wiki/合流超几何函数 "wikilink")：
...
拉盖尔多项式可以用[超几何函数来定义](../Page/超几何函数.md "wikilink")，具体地说，是用[合流超几何函数定义](https://zh.wikipedia.org/wiki/合流超几何函数 "wikilink")：

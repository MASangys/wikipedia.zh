...
實際上，拋物線坐標可以應用在許多物理問題。例如，[斯塔克效應](https://zh.wikipedia.org/wiki/斯塔克效應 "wikilink")（），物體邊緣的[位勢論](https://zh.wikipedia.org/wiki/位勢論 "wikilink")，以及[拉普拉斯-龍格-冷次向量的](../Page/拉普拉斯-龍格-冷次向量.md "wikilink")[保守性](../Page/保守力.md "wikilink")。
...
+y-軸）[拋物線](https://zh.wikipedia.org/wiki/拋物線 "wikilink")：
...
其它微分算子，像 \(\nabla \cdot \mathbf{F}\) ， \(\nabla \times \mathbf{F}\)
，都可以用 \((\sigma,\ \tau)\)
坐標表示，只要將標度因子代入在[正交坐標系條目內的一般公式](https://zh.wikipedia.org/wiki/正交坐標系 "wikilink")。
...
將二維的拋物線坐標系繞著[拋物線的對稱軸旋轉](https://zh.wikipedia.org/wiki/拋物線 "wikilink")，則可以得到三維的拋物線坐標系，又稱為**旋轉拋物線坐標系**。將對稱軸與
...
其它微分算子，像 \(\nabla \cdot \mathbf{F}\) ， \(\nabla \times \mathbf{F}\)
，都可以用 \((\sigma,\ \tau,\ \phi)\)
坐標表示，只要將標度因子代入在[正交坐標系](https://zh.wikipedia.org/wiki/正交坐標系 "wikilink")
條目內的一般公式。

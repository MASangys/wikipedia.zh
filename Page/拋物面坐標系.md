**拋物面坐標系**（）是一種三維[正交坐標系](../Page/正交坐標系.md "wikilink")，是二維[拋物線坐標系的推廣](../Page/拋物線坐標系.md "wikilink")。與大多數的三維[正交坐標系的生成方法不同](../Page/正交坐標系.md "wikilink")，拋物面坐標系不是由任何二維正交坐標系延伸或旋轉生成的。
...
從[直角坐標](../Page/直角坐標.md "wikilink") \((x,\ y,\ z)\) 變換至拋物面坐標
\(( \lambda,\ \mu,\ \nu )\) ：
...
\(\lambda\)-坐標曲面是[橢圓拋物面](../Page/橢圓拋物面.md "wikilink") () ：

\[\frac{x^{2}}{\lambda - A}+\frac{y^{2}}{\lambda - B}=2z+\lambda\] 。

\(\mu\)-坐標曲面是[雙曲拋物面](../Page/雙曲拋物面.md "wikilink") ：

...
**拓扑空间**是一种[数学结构](https://zh.wikipedia.org/wiki/数学结构 "wikilink")，可以在上頭形式化地定義出如[收敛](https://zh.wikipedia.org/wiki/收敛 "wikilink")、[连通](../Page/连通空间.md "wikilink")、[连续等概念](https://zh.wikipedia.org/wiki/连续 "wikilink")。拓扑空间在现代[数学的各个分支都有应用](../Page/数学.md "wikilink")，是一个居于中心地位的、统一性的概念。拓扑空间有独立研究的价值，研究拓扑空间的数学分支称为[拓扑学](../Page/拓扑学.md "wikilink")。
...
给定拓扑空间(X,τ)，A是X的子集，有以下概念（继续使用上面的符号）：
  ...
  - 聚点，导集
    X中的点x称为A的**聚点**，当且仅当x ∈ c(A -
    {x})（或者等价地，x的任意邻域至少包含x以外的A的一个点）。A的所有聚点组成的集合称为A的**导集**。
  - 孤立点
...
**网**的目的在推广序列及极限，网的收性称作**Moore-Smith收敛**。其关键在於以[有向集合代替自然数集](../Page/有向集合.md "wikilink")\(\mathbb{N}\)。
...
## 拓扑空间的例子
  ...
  - [实数集](../Page/实数.md "wikilink")**R**构成一个拓扑空间：全体开[区间构成其上的一组拓扑基](https://zh.wikipedia.org/wiki/区间 "wikilink")，其上的拓扑就由这组基来生成。这意味着实数集**R**上的开集是一组开区间的并（开区间的数量可以是无穷多个，但进一步可以证明，所有的开集可以表示为可数个互不相交的开区间的并）。从许多方面来说，实数集都是最基本的拓扑空间，并且它也指导着我们获得对拓扑空间的许多直观理解；但是也存在许多“奇怪”的拓扑空间，它们有悖于我们从实数集获得的直观理解。
  - 更一般的，n维[欧几里得空间](../Page/欧几里得空间.md "wikilink")**R**<sup>*n*</sup>构成一个拓扑空间，其上的开集就由开球来生成。
  - 任何[度量空间都可构成一个拓扑空间](../Page/度量空间.md "wikilink")，如果其上的开集由开球来生成。这中情况包括了许多非常有用的无穷维空间，如[泛函分析领域中的](../Page/泛函分析.md "wikilink")[Banach空间和](https://zh.wikipedia.org/wiki/Banach空间 "wikilink")[希尔伯特空间](../Page/希尔伯特空间.md "wikilink")。
  - 任何[局部域都自然地拥有一个拓扑](../Page/局部域.md "wikilink")，并且这个拓扑可以扩张成为这个域上的[向量空间](../Page/向量空间.md "wikilink")。
  - 除了由全体开区间生成的拓扑之外，实数集还可以赋予另外一种拓扑—[下限拓扑](../Page/下限拓扑.md "wikilink")（lower
    limit topology）。这种拓扑的开集由下列点集构成—空集、全集和由全体半开区间\[*a*,
    *b*)生成的集合。这种拓扑严格地细于上面定义的欧几里得拓扑；在这种拓扑空间中，一个点列收敛于一点，当且仅当，该点列在欧几里得拓扑中也收敛于这个点。这样我们就给出了一个集合拥有不同拓扑的示例。
  - [流形都是一个拓扑空间](../Page/流形.md "wikilink")。
  - 每一个[单形都是一个拓扑空间](https://zh.wikipedia.org/wiki/单形 "wikilink")。单形是一种在[计算几何学中非常有用的](https://zh.wikipedia.org/wiki/计算几何学 "wikilink")[凸集](../Page/凸集.md "wikilink")。在0、1、2和3维空间中，相应的单形分别是[点](../Page/点.md "wikilink")、[线段](../Page/线段.md "wikilink")、[三角形和](../Page/三角形.md "wikilink")[四面体](https://zh.wikipedia.org/wiki/四面体 "wikilink")。
  - 每一个[单纯复形都是一个拓扑空间](../Page/单纯复形.md "wikilink")。一个单纯复形由许多单形构成。许多几何体都可以通过单纯复形—来建立模型，参见[多胞形](https://zh.wikipedia.org/wiki/多胞形 "wikilink")（Polytope）。
  - [扎里斯基拓扑是一种纯粹由代数来定义的的拓扑](../Page/扎里斯基拓扑.md "wikilink")，这种拓扑建立在某个环的[交換环谱之上或者某个](https://zh.wikipedia.org/wiki/交換环谱 "wikilink")[代数簇之上](../Page/代数簇.md "wikilink")。对**R**<sup>*n*</sup>或者**C**<sup>*n*</sup>来说，相应扎里斯基拓扑定义的闭集，就是由全体[多项式方程的解集合构成](https://zh.wikipedia.org/wiki/多项式 "wikilink")。
  - [线性图是一种能推广](https://zh.wikipedia.org/wiki/线性图 "wikilink")[图的许多几何性质的拓扑空间](https://zh.wikipedia.org/wiki/图 "wikilink")。
  - [泛函分析中的许多](../Page/泛函分析.md "wikilink")[算子集合可以获得一种特殊的拓扑](../Page/算子.md "wikilink")，在这种拓扑空间中某一类函数序列收敛于零函数。
  ...
  - **有限补拓扑**。设X是一个[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")。X的所有有限[子集的](../Page/子集.md "wikilink")[补集加上](../Page/补集.md "wikilink")[空集](../Page/空集.md "wikilink")，构成X上的一个拓扑。相应的拓扑空间称为**有限补空间**。有限补空间是这个集合上最小的[T<sub>1</sub>拓扑](../Page/T1空间.md "wikilink")。
  - **可数补拓扑**。设X是一个[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")。X的所有[可数子集的](https://zh.wikipedia.org/wiki/可数子集 "wikilink")[补集加上](../Page/补集.md "wikilink")[空集](../Page/空集.md "wikilink")，构成X上的一个拓扑。相应的拓扑空间称为**可数补空间**。
  - 如果Γ是一个[序数](../Page/序数.md "wikilink")，则集合\[0,
    Γ\]是一个拓扑空间，该拓扑可以由区间(*a*,
    *b*\]生成，此处*a*和*b*是Γ的元素。
...
## 拓扑空间的构造
  ...
  - [商拓扑可以被如下地定义出来](https://zh.wikipedia.org/wiki/商拓扑 "wikilink")：若*X*是一个拓扑空间，*Y*是一个集合，如果*f*
    : *X*  → 
    *Y*是一个[满射](../Page/满射.md "wikilink")，那么*Y*获得一个拓扑；该拓扑的开集可如此定义，一个集合是开的，当且仅当它的[逆像也是开的](https://zh.wikipedia.org/wiki/逆像 "wikilink")。可以利用*f*自然投影确定下*X*上的[等价类](../Page/等价类.md "wikilink")，从而给出拓扑空间*X*上的一个[等价关系](../Page/等价关系.md "wikilink")。
...
### 连通性
  ...
  - 道路连通
    X称为**[道路连通的](https://zh.wikipedia.org/wiki/道路连通 "wikilink")**，当且仅当其任意两点*x*和*y*，存在从*x*到*y*的道路*p*，也即，存在一个连续映射*p*: \[0,1\] → *X*，满足*p*（0）=
    *x* 且*p*（1）= *y*。道路连通的空间总是连通的。
  - 局部道路连通
...
可度量性意味着可赋予空间一个度量，使之给出该空间的拓扑。目前已有许多版本的度量化定理，其中最著名的是**Urysohn度量化定理**：一个第二可数的正则豪斯多夫空间可被度量化。由此可导出任何第二可数的[流形皆可度量化](../Page/流形.md "wikilink")。
...
同样地，可定义[拓扑向量空间为一个赋有拓扑结构的向量空间](https://zh.wikipedia.org/wiki/拓扑向量空间 "wikilink")，使得加法与纯量乘法是连续映射，这是[泛函分析的主题](../Page/泛函分析.md "wikilink")；我们可以类似地定义[拓扑环](https://zh.wikipedia.org/wiki/拓扑环 "wikilink")、拓扑域等等。

结合拓扑与代数结构，往往可以引出相当丰富而实用的理论，例如微分几何探究的[主齐性空间](../Page/主齐性空间.md "wikilink")。在[代数数论及](https://zh.wikipedia.org/wiki/代数数论 "wikilink")[代数几何中](../Page/代数几何.md "wikilink")，人们也常定义适当的拓扑结构以简化理论，并得到较简明的陈述；如数论中的[局部域](../Page/局部域.md "wikilink")（一种拓扑域），[伽罗瓦理论中考虑的Krull拓扑](https://zh.wikipedia.org/wiki/伽罗瓦理论 "wikilink")（一种特别的拓扑群），以及定义[形式概形所不可少的I](https://zh.wikipedia.org/wiki/形式概形 "wikilink")-进拓扑（一种拓扑环）等等。
...
## 参考书目
  ...
  - John L. Kelley, General Topology (GTM 27). Springer-Verlag. ISBN
    0387901256.
  - James R. Munkres, Topology (second edition). Prentice Hall; ISBN
    0131816292.

<!-- end list -->

  - 点集拓扑学初步 / [江泽涵](../Page/江泽涵.md "wikilink")-{著}-. -
  ...
  - 点集拓扑学原理 / 鲍姆-{著}-;蒲思立译. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [人民教育出版社](../Page/人民教育出版社.md "wikilink"), 1981年6月。
  - 一般拓扑学 / 李普舒茨-{著}-;陈昌平等译. -
    [上海](https://zh.wikipedia.org/wiki/上海 "wikilink"):
    [华东师大出版社](https://zh.wikipedia.org/wiki/华东师大出版社 "wikilink"),
    1982年1月。
  - 一般拓扑学 / 凯莱-{著}-;吴丛，吴让泉译. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [科学出版社](https://zh.wikipedia.org/wiki/科学出版社 "wikilink"),
    1982年5月。
  - 拓扑学引论 / 本特·门德尔森-{著}-;陈明蔚译. -
    [南宁](https://zh.wikipedia.org/wiki/南宁 "wikilink"):
    [广西人民出版社](https://zh.wikipedia.org/wiki/广西人民出版社 "wikilink"),
    1983年1月。
  - 基础拓扑学 / 阿姆斯特朗-{著}-;孙以丰译. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [北京大学出版社](../Page/北京大学出版社.md "wikilink"), 1983年1月。
  - 点集拓扑学 / 方嘉琳编-{著}-. -
    [沈阳](https://zh.wikipedia.org/wiki/沈阳 "wikilink"):
    [辽宁人民出版社](../Page/辽宁人民出版社.md "wikilink"), 1983年4月。
  - 拓扑学的基础和方法 / 野口宏-{著}-;郭卫中，王家彦译. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [科学出版社](https://zh.wikipedia.org/wiki/科学出版社 "wikilink"),
    1986年3月。
  - 拓扑学初步 / [苏步青](../Page/苏步青.md "wikilink")-{著}-. -
    [上海](https://zh.wikipedia.org/wiki/上海 "wikilink"):
    [复旦大学出版社](https://zh.wikipedia.org/wiki/复旦大学出版社 "wikilink"),
    1986年4月。
  - 拓扑学基础教程 / 曼克勒斯-{著}-;罗嵩龄等译. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [科学出版社](https://zh.wikipedia.org/wiki/科学出版社 "wikilink"),
    1987年8月。
  - 基础拓扑学 / 何伯和，廖公夫-{著}-. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [高等教育出版社](../Page/高等教育出版社.md "wikilink"), 1991年1月。
  - 一般拓扑学专题选讲 / 蒋继光-{著}-. -
    [成都](https://zh.wikipedia.org/wiki/成都 "wikilink"):
    [四川教育出版社](https://zh.wikipedia.org/wiki/四川教育出版社 "wikilink"),
    1991年3月。
  - 拓扑学导论 / 鲍里索维奇等-{著}-;盛立人等译. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [高等教育出版社](../Page/高等教育出版社.md "wikilink"), 1992年9月。
  - 基础拓扑学讲义 / 尤承业编-{著}-. -
    [北京](https://zh.wikipedia.org/wiki/北京 "wikilink"):
    [北京大学出版社](../Page/北京大学出版社.md "wikilink"), 1997年. ISBN
    7-301-03103-3.

**拟阵**是一个[数学结构](https://zh.wikipedia.org/wiki/数学结构 "wikilink")，是对（[线性](https://zh.wikipedia.org/wiki/线性 "wikilink")）独立的概括与归纳。常用于[排列组合和](https://zh.wikipedia.org/wiki/排列组合 "wikilink")[图论](../Page/图论.md "wikilink")等方面。

...
*X* 的[偏离系数是](https://zh.wikipedia.org/wiki/偏离系数 "wikilink")： **V**\[X\]
= 1
...
给定[独立同分布样本](https://zh.wikipedia.org/wiki/独立同分布 "wikilink")*x* =
(*x*<sub>1</sub>, ..., *x*<sub>*n*</sub>)，λ的似然函数（Likelihood function）是：
...
似然函数[对数的](https://zh.wikipedia.org/wiki/对数 "wikilink")[导数是](../Page/导数.md "wikilink")：

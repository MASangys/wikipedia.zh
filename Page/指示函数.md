...
如上一例子所示，指示函数是[组合数学一个有用记法](../Page/组合数学.md "wikilink")。这记法也用在其他地方，例如在[概率论](https://zh.wikipedia.org/wiki/概率论 "wikilink")：若*X*是[概率空间](https://zh.wikipedia.org/wiki/概率空间 "wikilink")，有概率测度*P*，*A*是[可测集](../Page/测度.md "wikilink")，那么*1<sub>A</sub>*就是[随机变量](../Page/随机变量.md "wikilink")，其[期望值等于](../Page/期望值.md "wikilink")*A*的概率。

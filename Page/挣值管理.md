**實獲值管理**是[專案管理的一种方法](https://zh.wikipedia.org/wiki/專案管理 "wikilink")，主要用于[專案](https://zh.wikipedia.org/wiki/專案 "wikilink")[成本和](../Page/成本.md "wikilink")[进度的监控](https://zh.wikipedia.org/wiki/进度 "wikilink")
...
## 背景概念
  ...
  - 项目主进度计划(PMS):
    关于哪些[任务将完成以及由谁完成的](https://zh.wikipedia.org/wiki/任务 "wikilink")[甘特图](https://zh.wikipedia.org/wiki/甘特图 "wikilink")。

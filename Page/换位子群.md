在[抽象代数中](../Page/抽象代数.md "wikilink")，一个[群的](../Page/群.md "wikilink")**换位子群**或**导群**，是指由这个群的所有[交换子所生成的](https://zh.wikipedia.org/wiki/交换子 "wikilink")[子群](../Page/子群.md "wikilink")，记作\[*G*,*G*\]、*G′*或*G*<sup>(1)</sup>
。每个群都对应着一个确定的交换子群。在一个群*G*的所有正规子群中，交换子群*G′*是使得*G*对它的[商群为](../Page/商群.md "wikilink")[交换群的最小子群](https://zh.wikipedia.org/wiki/交换群 "wikilink")。在某种意义上，交换子群提供了群*G*的可交换程度。因为从交换子的定义：
\([x,y]=xyx^{-1}y^{-1}\)，如果x与y交换，那么\[x,y\]=e。一个群内可交换的元素越多，交换子就越少，交换子群也就越小。可交换群的交换子群为[平凡群](https://zh.wikipedia.org/wiki/平凡群 "wikilink"){e}。

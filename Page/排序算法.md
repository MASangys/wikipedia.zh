...
### 穩定的排序
  ...
  - [侏儒排序](https://zh.wikipedia.org/wiki/侏儒排序 "wikilink")（gnome sort）—
    \(O(n^2)\)
...
### 不穩定的排序
  ...
  - [Clover排序算法](https://zh.wikipedia.org/wiki/Clover排序算法 "wikilink")（Clover
...
### 不實用的排序
  ...
  - [珠排序](../Page/珠排序.md "wikilink")（bead sort）— \(O(n)\) 或
    \(O(\sqrt{n})\),但需要特別的硬體
  - [煎餅排序](https://zh.wikipedia.org/wiki/煎餅排序 "wikilink")—\(O(n)\),但需要特別的硬體

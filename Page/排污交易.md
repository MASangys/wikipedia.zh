> 本文内容由[排污交易](https://zh.wikipedia.org/wiki/排污交易)转换而来。


**排污交易**是一種以「獎勵」形式的經濟誘因，鼓勵私人企業致力減排的，控制污染經濟工具和政府行政門徑；以達致減少排放[污染物目標](https://zh.wikipedia.org/wiki/污染物 "wikilink")。 \[1\] 仍發展中的減低排放[溫室氣體的](https://zh.wikipedia.org/wiki/溫室氣體 "wikilink")，可令參與公司及人士產生可交易的。 [京都議定書內](https://zh.wikipedia.org/wiki/京都議定書 "wikilink")[清潔發展機制(CDM)可提供這方面的排放指標規定](https://zh.wikipedia.org/wiki/清潔發展機制 "wikilink")。在不影响科技与经济发展的同时, 排污交易可以有弹性的减少污染排放量。\[2\]

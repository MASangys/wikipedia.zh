> 本文内容由[排版引擎比较 \(HTML\)](https://zh.wikipedia.org/wiki/排版引擎比较_\(HTML\))转换而来。
...
<td></td>
<td><p>{{#tag:ref|<q>在Gecko 1.8之前不支持嵌套使用。[1]|group=注}}</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<td><p>{{#tag:ref|对图像来说，该对象会被添加一个框架。不支持其它内容类型且作为一个ActiveX包装，该元素不会被正确实现。版本7之前不支持嵌套对象回退机制。[2]|group=注}}</p></td>
<td><p>rowspan="2" </p></td>
<td><p>rowspan="2" </p></td>
<td><p>rowspan="2" </p></td>
<td><p>rowspan="2" </p></td>
...
<td><p>{{#tag:ref|在Internet Explorer 8.0（trident 4.0）之前和早期的兼容模式下，innerText属性会代替值属性提交。[3]|group=注}}</p></td>
<td><p>rowspan="4" </p></td>
<td><p>rowspan="4" </p></td>
<td><p>rowspan="4" </p></td>
<td><p>rowspan="3" </p></td>
...
<tbody>
<tr class="odd">
<td><p><code>&lt;link rel="style" … /&gt;</code></p></td>
<td></td>
<td><p>rowspan="2" </p></td>
<td><p>rowspan="2" </p></td>
<td><p>rowspan="2" </p></td>
...
<td><p>{{#tag:ref|Internet Explorer 9（Trident 5.0)与更早的版本<code></p>
<style>
<p></code>元素受到限制。[4][5]|group=注}}</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
用于嵌入客户端脚本（[JavaScript](../Page/JavaScript.md "wikilink")）的元素。
...
## 外部链接
  ...
  - [webref.info的HTML参考](http://webref.info/?ID=1)

  - [使用DOCTYPE声明激活正确的排版模式](http://hsivonen.iki.fi/doctype/)

  - [文档类型和它们各自的排版模式](http://gutfeldt.ch/matthias/articles/doctypeswitch/table.html)

  - [HTML支持历史](http://www.blooberry.com/indexdot/html/supportkey/a.htm)

  - [网页浏览器HTML支持](http://www.webdevout.net/browser_support_html.php)

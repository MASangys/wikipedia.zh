...
接触力学是[机械工程的基本领域](../Page/机械工程.md "wikilink")，它为技术系统的安全和能量的有效设计提供了必要的信息。接触力学的原理应用于很多领域，例如机车轮-轨接触、联接装置、[刹车系统](https://zh.wikipedia.org/wiki/刹车 "wikilink")、疲劳、衬套、球轴承、[内燃机](../Page/内燃机.md "wikilink")、机械连接、密封垫片、金属加工、金属成型、超声波电焊、电接触等等。该领域目前面临的挑战包括接触应力分析、耦合数、润滑油影响和摩擦磨损上的材料设计。接触力学的应用更可以扩展到微粒子和[纳米技术领域](../Page/纳米技术.md "wikilink")。

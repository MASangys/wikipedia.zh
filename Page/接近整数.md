...
皮索特-维贡伊拉卡文数是指[代數數](../Page/代數數.md "wikilink")本身大於1，而且其[極小多項式](../Page/極小多項式.md "wikilink")中另一根的絕對值小於1。像[黃金比例本身大於](https://zh.wikipedia.org/wiki/黃金比例 "wikilink")1，\(\phi\)的最小多項式為 \(x^2 - x - 1=0\)
...
而\(\phi^n + \overline{\phi}^n\)可以用\(\phi \overline{\phi}\) 及\(\phi+\overline{\phi}\)來表示，由於二根之和及二根之積均為整數，計算所得的結果也是一個正整數，假設為一正整數K，則\(\phi^n\)可以用下式表示
...
\[e^{\pi\sqrt{163}}=12^3(231^2-1)^3+744-7.499\cdots\times 10^{-13}\,\] 其中：\(21=3\times7,231=3\times7\times11,744=24\times 31\,\) 由於[艾森斯坦級數](../Page/艾森斯坦級數.md "wikilink")的關係，使得上式中出現平方項。常數\(e^{\pi\sqrt{163}}\,\)有時會稱為[拉馬努金常數](https://zh.wikipedia.org/wiki/拉馬努金常數 "wikilink")。
...
\[e^{5\pi}=6635623.999341134233\cdots\,\] [格尔丰德常数](https://zh.wikipedia.org/wiki/格尔丰德常数 "wikilink")（\(e^{\pi}\,\)）接近\(\pi+20\,\)，至2011年為止還沒找到出現此特性的原因\[2\]，因此只能視為一。另一個有關格尔丰德常数的常數也是接近整數 \(\frac{e^\pi-\pi-1}{6\pi}=1.00793356\cdots\,\)
...
\[{}_{ \ln K_0-\ln\ln K_0\approx 1.0000744}\] ，其中\(K_0\)是[辛钦常数](../Page/辛钦常数.md "wikilink")
...
## 外部連結
  ...
  - [J.S. Markovitch Coincidence, data compression, and Mach's concept of economy of thought](http://cogprints.org/3667/1/APRI-PH-2004-12b.pdf)
...
2.  Eric Weisstein, ["Almost Integer"](http://mathworld.wolfram.com/AlmostInteger.html) at MathWorld
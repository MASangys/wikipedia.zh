**控制流程**（也稱為**流程控制**）是[電腦運算領域的用語](../Page/電腦運算.md "wikilink")，意指在[程式執行時](../Page/程式.md "wikilink")，個別的指令（或是[陳述](../Page/陳述_\(程式\).md "wikilink")、[子程序](../Page/子程序.md "wikilink")）執行或[求值的順序](../Page/求值.md "wikilink")
。不論是在[宣告式程式語言或是](../Page/宣告式編程.md "wikilink")[函數程式語言中](../Page/函數程式語言.md "wikilink")，都有類似的概念。

在宣告式的[程式語言中](../Page/程式語言.md "wikilink")，**流程控制指令**是指會改變程式執行順序的指令，可能是執行不同位置的指令，或是在二段（或多段）程式中選擇一個執行。
...
不同的程式語言所提供的流程控制指令也會隨之不同，但一般可以分為以下四種：
  ...
  - 執行位在不同位置的一段指令，但完成後會繼續執行原來要執行的指令，包括[子程序](../Page/子程序.md "wikilink")、[协程](../Page/协程.md "wikilink")（coroutine）及[计算续体](../Page/计算续体.md "wikilink")（continuation）。
  - 停止程式，不執行任何指令（無條件的終止）。

[中斷以及](../Page/中斷.md "wikilink")[Unix系統中的](../Page/Unix.md "wikilink")[信号等較低階的機制也可以造成類似子程序的效果](../Page/信号_\(计算机科学\).md "wikilink")，不過通常這類機制會用來回應外部的事件或是輸入。[程序自修改因為其對程式碼的影響](../Page/程序自修改.md "wikilink")，也會影響控制流程，但多半不會有明顯的流程控制指令。

在[机器语言或](../Page/机器语言.md "wikilink")[汇编语言中](../Page/汇编语言.md "wikilink")，流程控制是藉由修改[程式計數器數值來達到](../Page/程式計數器.md "wikilink")。一些[中央處理器只支援條件](../Page/中央處理器.md "wikilink")[分支](../Page/分支_\(計算機科學\).md "wikilink")（branch）或是無條件分支（有時會稱為jump）。
...
有一些程式語言（像[Fortran及](../Page/Fortran.md "wikilink")[BASIC等](../Page/BASIC.md "wikilink")）利用[行號作為標記](../Page/行號_\(程式語言\).md "wikilink")。行號是標示在每一行程式最前面的[自然數](../Page/自然數.md "wikilink")，不一定要是連續的數字，在不受流程控制指令影響的情形下，程式會從最小的行號依序執行，而流程控制指令需指定對應的行號。以下是一個BASIC的例子:
...
在像是[C及](../Page/C语言.md "wikilink")[Ada等程式語言中](../Page/Ada.md "wikilink")，標記是一個[標識符](../Page/標識符.md "wikilink")，一般出現在一行的最前面，後面會加一個[冒號作為識別](../Page/冒號.md "wikilink")，以下是C語言的例子：
...
[Algol
60語言同時支持整數](../Page/Algol_60.md "wikilink")（類似行號）及標識符的標記（二者後面都要加上冒號），不過其他Algol語言幾乎都不支援整數的標記。

### Goto

goto
指令（來自英文[go和](../Page/wiktionary:go.md "wikilink")[to的組合](../Page/wiktionary:to.md "wikilink")）是無條件流程控制指令中最基本的型式。一般在程式中會用以下的方式出現（指令大小寫可能會依程式語言而不同）
...
goto
指令是許多的计算机科学家[視為有害的指令](../Page/視為有害.md "wikilink")，像荷兰计算机科学家[艾茲格·迪科斯徹](../Page/艾茲格·迪科斯徹.md "wikilink")（Edsger
Wybe Dijkstra）就提出了[goto有害論](../Page/goto有害論.md "wikilink")\[1\]。
...
如今子程序也常用來使得程式更加的結構化，例如可以將一些特殊的演算法或特殊的資料存取方式放在子程序中，和其他代碼隔離。子程序也是程式[模組的一種](../Page/模組_\(程式設計\).md "wikilink")，若許多程式設計師共同開發一個程式，子程序也有助於其工作的分割及分工。
...
若一程式語言支援控制結構，控制結構開始時多半都會有特定的關鍵字，以標明是使用哪一種控制結構。但只有部份程式語言在控制結構結束時會有特定的關鍵字表示結束，因此可以依控制結構結束時是否有特定關鍵字來將程式語言分為二類。
  ...
  - 沒有特定關鍵字的語言：[Algol
    60](../Page/Algol_60.md "wikilink")、[C](../Page/C语言.md "wikilink")、[C++](../Page/C++.md "wikilink")、[Haskell](../Page/Haskell.md "wikilink")、[Java](../Page/Java.md "wikilink")、[Pascal](../Page/Pascal_\(程式語言\).md "wikilink")、[Perl](../Page/Perl.md "wikilink")、[PHP](../Page/PHP.md "wikilink")、[PL/I](../Page/PL/I.md "wikilink")、[Python](../Page/Python.md "wikilink")、[Windows
    PowerShell](../Page/Windows_PowerShell.md "wikilink")。這類語言需要有關鍵字可以將group程式指令together：
      ...
      - PL/1：`DO` ... `END`
      - Python：利用的層次，詳細內容請參考[Off-side規則](../Page/Off-side規則.md "wikilink")
      - Haskell：可以利用縮排或大括號，兩者可以混用
  - 有特定關鍵字的語言：[Ada](../Page/Ada.md "wikilink")、[Algol
    68](../Page/Algol_68.md "wikilink")、
    [Modula-2](../Page/Modula-2.md "wikilink")、[Fortran
...
[條件判斷是依指定變數或運算式的結果](../Page/條件判斷.md "wikilink")，決定後續執行的程序，最常用的是if-else指令，可以根據指定條件是否成立，決定後續的程序。也可以組合多個if-else指令，進行較複雜的條件判斷。
...
在一些[函數程式語言](../Page/函數程式語言.md "wikilink")（例如[Haskell和](../Page/Haskell.md "wikilink")[Scheme](../Page/Scheme.md "wikilink")）中會使用[递归或](../Page/递归_\(计算机科学\).md "wikilink")[不动点组合子來達到迴圈的效果](../Page/不动点组合子.md "wikilink")，其中[尾部递归是一種特別的递归](../Page/尾部递归.md "wikilink")，很容易轉換為迭代。

## 結構化的非區部控制流程

有些程式語言 會提供非區部的控制流程（non-local control
flow），會允許流程跳出目前的程式碼，進入一段事先指定的程式碼。常用的結構化非區部控制流程可分為[條件處理](../Page/异常处理.md "wikilink")、[异常处理及](../Page/异常处理.md "wikilink")[延續性](../Page/延續性.md "wikilink")（Continuation）三種。

### 條件處理

[PL/I程式語言中有](../Page/PL/I.md "wikilink")22種標準的條件（如 ZERODIVIDE
SUBSCRIPTRANGE ENDFILE），可以在程式中設定，當特定條件成立時需進行的指令，程式設計者也可以定義自己的條件，並在程式中使用。
...
程式需要分配空間給子程序用到的區域變數，而且在子程序結束時需釋出這些變數用到的空間。許多程式語言利用[調用堆疊來存放這些變數](../Page/調用堆疊.md "wikilink")，可以簡單快速的分配及釋出空間。也有一些程式語言使用[動態記憶體分配來儲存變數](../Page/動態記憶體分配.md "wikilink")，可以較靈活的分配變數，但分配及釋出空間較不方便。這二個架構下延續性的處理方式也會不同，各有其優點及缺點。
...
## 相關條目
  ...
  - [分支 (計算機科學)](../Page/分支_\(計算機科學\).md "wikilink")

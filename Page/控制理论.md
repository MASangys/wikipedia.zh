...
像[機器人學及](https://zh.wikipedia.org/wiki/機器人學 "wikilink")[航天產業中的程序一般都有高度非線性的動態](../Page/航天.md "wikilink")，在控制理論中有時可以用線性化的方式轉換為線性系統，再依線性系統的方式控制。但有時需要用一些可以配合非線性系統使用的理論，例如[回授線性化](https://zh.wikipedia.org/wiki/回授線性化 "wikilink")、、[滑動模式控制等](../Page/滑動模式控制.md "wikilink")。轨迹线性化控制一般利用[李亞普諾夫穩定性的基礎](https://zh.wikipedia.org/wiki/李亞普諾夫穩定性 "wikilink")。[微分幾何用做為一數學工具](https://zh.wikipedia.org/wiki/微分幾何 "wikilink")，將許多廣為人知的線性控制概念擴展到非線性控制中，但其中又有其微妙之處，因此變成一個更有挑戰性的問題。

...
許多領域的[控制工程](../Page/控制工程.md "wikilink")使用的控制器要比[PID控制器](../Page/PID控制器.md "wikilink")複雜，例如[电传操纵飛機控制系統](https://zh.wikipedia.org/wiki/电传操纵系统 "wikilink")、化工廠、煉油廠等。[模型預測控制](../Page/模型預測控制.md "wikilink")系統是由特殊的電腦輔助設計軟體以及受控系統的經驗數學模型來進行設計。

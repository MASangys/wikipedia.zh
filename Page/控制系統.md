...
**控制系統**（control
system）是指用[控制迴路管理及控制另一個設備或是系統的系統](../Page/控制迴路.md "wikilink")。控制系統可以小到家中用[自動調溫器實現的溫度控制器](../Page/自動調溫器.md "wikilink")，也可以大到控制製程或是機器的大型。
...
在線性[反馈系統中](../Page/反馈.md "wikilink")，會由[传感器](../Page/传感器.md "wikilink")、控制演算法、[致動器形成](https://zh.wikipedia.org/wiki/致動器 "wikilink")[控制迴路](../Page/控制迴路.md "wikilink")，設法將過程變數控制在[目標值](../Page/目標值.md "wikilink")（SP）附近。日常的例子像是車輛的[巡航定速](../Page/巡航定速.md "wikilink")，外界的影響（例如上下坡）會影響速度，駕駛有能力將車輛維持在固定速度左右。理想的控制器會以最佳方式（最小延遲或是過衝）控制汽車的引擎輸出，將實際速度控制在理想速度。

控制系統只要包括一些感測器的機能，就可以試著利用回授來適應外來條件的變化，就算是回授控制系統。相反的，[開迴路控制器不會使用回授信號](../Page/開迴路控制器.md "wikilink")，只會依事先預定的方式動作。
...
許多領域的[控制工程使用的控制器要比](../Page/控制工程.md "wikilink")[PID控制器複雜](../Page/PID控制器.md "wikilink")，例如[电传操纵飛機控制系統](https://zh.wikipedia.org/wiki/电传操纵系统 "wikilink")、化工廠、煉油廠等。[模型預測控制系統是由特殊的電腦輔助設計軟體以及受控系統的經驗數學模型來進行設計](../Page/模型預測控制.md "wikilink")。

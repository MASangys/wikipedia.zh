**控制重構**（Control
reconfiguration）也稱為**控制重組態**，是[控制理論領域中](https://zh.wikipedia.org/wiki/控制理論 "wikilink")[动力系统的](../Page/动力系统.md "wikilink")[容錯控制](https://zh.wikipedia.org/wiki/容錯 "wikilink")\[1\]，在有故障時調整控制架構。作法在發生嚴重[故障](https://zh.wikipedia.org/wiki/故障 "wikilink")（例如[致動器或是](https://zh.wikipedia.org/wiki/致動器 "wikilink")[感測器不運作](https://zh.wikipedia.org/wiki/感測器 "wikilink")），影響[控制迴路時](../Page/控制迴路.md "wikilink")，系統可以重新調整其控制組態，以避免系統層的。控制重構不但包括架構的重新調整，也包括控制器參數為了配合新的架構而作的參數調整。控制重構是回授控制系統增加的重要機能之一\[2\]。

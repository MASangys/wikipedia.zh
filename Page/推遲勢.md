在[電磁學裏](https://zh.wikipedia.org/wiki/電磁學 "wikilink")，**推遲勢**指的是，響應含時[電荷分佈或含時](../Page/電荷.md "wikilink")[電流分佈](https://zh.wikipedia.org/wiki/電流 "wikilink")，而產生的推遲[純量勢或推遲](https://zh.wikipedia.org/wiki/純量勢 "wikilink")[向量勢](../Page/向量勢.md "wikilink")。對於這程序，由於「前因」與「後果」之間必然的推遲關係，訊號以[光速從源位置傳播到場位置](../Page/光速.md "wikilink")，需要有限時間。在某源位置的電流或電荷分佈，必須經過一段時間之後，才能夠將其影響傳播到場位置，產生對應的電磁作用。這一段時間的長久跟源位置與場位置之間距離的遠近有關。
...
對於靜態的電荷分佈和電流分佈，[電勢](../Page/電勢.md "wikilink")\(\Phi(\mathbf{r})\)和[磁向量勢](https://zh.wikipedia.org/wiki/磁向量勢 "wikilink")\(\mathbf{A}(\mathbf{r})\)分別定義為
...
在[電動力學裏](https://zh.wikipedia.org/wiki/電動力學 "wikilink")，這兩個方程式必須加以延伸，才能正確地響應含時[電流分佈或含時](https://zh.wikipedia.org/wiki/電流 "wikilink")[電荷分佈](../Page/電荷.md "wikilink")。定義[推遲時間](https://zh.wikipedia.org/wiki/推遲時間 "wikilink")\(t_r\)為檢驗時間\(t\)減去[電磁波傳播的時間](https://zh.wikipedia.org/wiki/電磁波 "wikilink")：

**提升方法**（Boosting），是一种可以用来减小[監督式學習中](../Page/監督式學習.md "wikilink")[偏差的](https://zh.wikipedia.org/wiki/偏差 "wikilink")[机器学习算法](../Page/机器学习.md "wikilink")。面對的问题是邁可·肯斯（Michael

[Insertion-sort-example-300px.gif](https://zh.wikipedia.org/wiki/File:Insertion-sort-example-300px.gif "fig:Insertion-sort-example-300px.gif")
**插入排序**（）是一种简单直观的[排序算法](../Page/排序算法.md "wikilink")。它的工作原理是通过构建有序序列，对于未排序数据，在已排序序列中从后向前扫描，找到相应位置并插入。**插入排序**在实现上，通常采用in-place排序（即只需用到\(O(1)\)的额外空间的排序），因而在从后向前扫描过程中，需要反复把已排序元素逐步向后挪位，为最新元素提供插入空间。

## 記載

最早擁有排序概念的機器出現在1901至1904年間由[Hollerith發明出使用基數排序法的分類機](https://zh.wikipedia.org/wiki/統計學家列表 "wikilink")，此機器系統包括打孔，制表等功能，1908年分類機第一次應用於人口普查，並且在兩年內完成了所有的普查數據和歸檔。
[Hollerith在](https://zh.wikipedia.org/wiki/統計學家列表 "wikilink")1896年創立的分類機公司的前身，為[電腦製表記錄公司（CTR）](../Page/IBM.md "wikilink")。他在電腦製表記錄公司曾擔任顧問工程師，直到1921年退休，而電腦製表記錄公司在1924年正式改名為[IBM](../Page/IBM.md "wikilink")。
...
如果*比较操作*的代价比*交换操作*大的话，可以采用[二分查找法来减少](https://zh.wikipedia.org/wiki/二分查找法 "wikilink")*比较操作*的数目。该算法可以认为是**插入排序**的一个变种，称为[二分查找插入排序](https://zh.wikipedia.org/wiki/二分查找插入排序 "wikilink")。
...
## 延伸閱讀
  ...
  - \[97严\]
    [严蔚敏](https://zh.wikipedia.org/wiki/严蔚敏 "wikilink")，[吴伟民](https://zh.wikipedia.org/wiki/吴伟民 "wikilink")，《数据结构C语言版》，[清华大学出版社](../Page/清华大学出版社.md "wikilink")，1997年4月
  - \[99殷\]
    [殷人昆](https://zh.wikipedia.org/wiki/殷人昆 "wikilink")，[陶永雷](https://zh.wikipedia.org/wiki/陶永雷 "wikilink")，[谢若阳](https://zh.wikipedia.org/wiki/谢若阳 "wikilink")，[盛绪华](https://zh.wikipedia.org/wiki/盛绪华 "wikilink")，《数据结构（用面向对象方法与C++描述）》，[清华大学出版社](../Page/清华大学出版社.md "wikilink")，1999年7月

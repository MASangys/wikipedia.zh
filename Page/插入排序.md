...
最早擁有排序概念的機器出現在1901至1904年間由[Hollerith發明出使用基數排序法的分類機](https://zh.wikipedia.org/wiki/統計學家列表 "wikilink")，此機器系統包括打孔，制表等功能，1908年分類機第一次應用於人口普查，並且在兩年內完成了所有的普查數據和歸檔。 [Hollerith在](https://zh.wikipedia.org/wiki/統計學家列表 "wikilink")1896年創立的分類機公司的前身，為[電腦製表記錄公司（CTR）](../Page/IBM.md "wikilink")。他在電腦製表記錄公司曾擔任顧問工程師，直到1921年退休，而電腦製表記錄公司在1924年正式改名為[IBM](../Page/IBM.md "wikilink")。

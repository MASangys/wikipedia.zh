**換行**（），在[計算機領域中是一種加在](https://zh.wikipedia.org/wiki/計算機 "wikilink")[文字](../Page/文字.md "wikilink")最後位置的特殊字元，在換行字元的下一個字元將會出現在下一[行](https://zh.wikipedia.org/wiki/行 "wikilink")，實際上換行字元根據不同的[硬體平台或](https://zh.wikipedia.org/wiki/硬體 "wikilink")[作業系統平台會有不同的](https://zh.wikipedia.org/wiki/作業系統 "wikilink")[編碼方式](https://zh.wikipedia.org/wiki/編碼 "wikilink")。

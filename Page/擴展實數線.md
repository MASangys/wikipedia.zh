...
对任意[实数](../Page/实数.md "wikilink")\(a\)，定义\(-\infty \le a \le +\infty\)，扩展的实数轴就成了一个[全序集](https://zh.wikipedia.org/wiki/全序集 "wikilink")。这种集合有种非常好的性质，就是其所有[子集都有](../Page/子集.md "wikilink")[上确界和](https://zh.wikipedia.org/wiki/上确界 "wikilink")[下确界](https://zh.wikipedia.org/wiki/下确界 "wikilink")：这是一个[完备格](https://zh.wikipedia.org/wiki/完备格 "wikilink")。全序关系在\(\overline\R\)上引入了[拓扑](../Page/拓扑学.md "wikilink")。在这个拓扑中，集合\(U\)是\(+\infty\)的[邻域](../Page/邻域.md "wikilink")，当且仅当它包含集合\(\left\{ x : x > a \right\}\)，这里\(a\)是某个实数。\(-\infty\)的邻域类似。\(\overline\R\)是个[紧致的](https://zh.wikipedia.org/wiki/紧致 "wikilink")[豪斯多夫空间](../Page/豪斯多夫空间.md "wikilink")，与单位[区间](https://zh.wikipedia.org/wiki/区间 "wikilink")\(\left[ 0, 1 \right]\)[同胚](../Page/同胚.md "wikilink")。

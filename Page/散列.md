**雜湊**（）是電腦科学中一種对資料的处理方法，通过某种特定的函数/算法（称为**雜湊函数**/算法）将要检索的项与用来检索的索引（称为**雜湊**，或者**雜湊值**）关联起来，生成一种便于搜索的資料結構（称为**雜湊表**）。旧译**哈-{}-希**（误以为是人名而采用了音译）。它也常用作一种資訊安全的實作方法，由一串資料中經過[雜湊演算法](https://zh.wikipedia.org/wiki/雜湊演算法 "wikilink")（Hashing
...
| **[RadioGatún](https://zh.wikipedia.org/wiki/RadioGatún "wikilink")**                       | Arbitrarily long    | 58 words | 3 words | 否    | 1-64 | 否    |
| **[RIPEMD](https://zh.wikipedia.org/wiki/RIPEMD "wikilink")**                               | 128                 | 128      | 512     | 64   | 32   | 是    |
| **[RIPEMD-128/256](https://zh.wikipedia.org/wiki/RIPEMD "wikilink")**                       | 128/256             | 128/256  | 512     | 64   | 32   | 否    |
| **[RIPEMD-160/320](https://zh.wikipedia.org/wiki/RIPEMD "wikilink")**                       | 160/320             | 160/320  | 512     | 64   | 32   | 否    |

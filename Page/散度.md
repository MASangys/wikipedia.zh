**散度**或稱**發散度**，是[向量分析中的一个](../Page/向量分析.md "wikilink")[向量](https://zh.wikipedia.org/wiki/向量场 "wikilink")[算子](../Page/算子.md "wikilink")，将[向量空间上的一个](../Page/向量空间.md "wikilink")[向量场](https://zh.wikipedia.org/wiki/向量场 "wikilink")（矢量场）对应到一个[标量场上](https://zh.wikipedia.org/wiki/标量场 "wikilink")。散度描述的是向量场里一个点是汇聚点还是发源点，形象地说，就是这包含这一点的一个微小体元中的向量是“向外”居多还是“向内”居多。举例来说，考虑空间中的静[电场](https://zh.wikipedia.org/wiki/电场 "wikilink")，其空间里的[电场强度是一个矢量场](https://zh.wikipedia.org/wiki/电场强度 "wikilink")。[正电荷附近](https://zh.wikipedia.org/wiki/电 "wikilink")，[电场线](https://zh.wikipedia.org/wiki/电场线 "wikilink")“向外”发射，所以正电荷处的散度为正值，电荷越大，散度越大。负电荷附近，电场线“向内”，所以负电荷处的散度为负值，电荷越大，散度越小。[向量函數的散度為一個](https://zh.wikipedia.org/wiki/向量函數 "wikilink")[純量](https://zh.wikipedia.org/wiki/純量 "wikilink")，而二阶[张量的散度是](https://zh.wikipedia.org/wiki/张量 "wikilink")[向量函数](https://zh.wikipedia.org/wiki/向量函数 "wikilink")。
...
其中\(\mathrm{d}S\)是积分的面积元，**n**是Σ在点(x,y,z)处的单位[法向量](https://zh.wikipedia.org/wiki/法向量 "wikilink")。如果曲面是封闭的，例如球面，那么通常约定法向量是从裡朝外的，所以这时候的通量是描述曲面上的场向量朝外的程度。
...
散度等于零的区域称为无源场或管形场。[流体力学中](../Page/流体力学.md "wikilink")，散度为零的流体称为[不可压缩](../Page/不可壓縮流.md "wikilink")[流体](https://zh.wikipedia.org/wiki/流体 "wikilink")，也就是说此流体中不会有一部分凭空消失或突然产生，每个微小时间间隔中流入一个微小体元的流体总量都等于在此时间间隔内流出此体元的流体总量。
...
作为向量分析的基础概念，散度同样源自对[四元数上的微积分研究](https://zh.wikipedia.org/wiki/四元数 "wikilink")。[哈密顿在介绍四元数的运算时](../Page/威廉·哈密頓.md "wikilink")，将一个四元数\(q = A+B\boldsymbol{i}+C\boldsymbol{j}+D\boldsymbol{k}\)中的\(A\)称为“标量部分”（scalar

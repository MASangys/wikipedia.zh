...
\(\nabla\!\cdot(\mathbf{V}(x,y))=\frac{\partial\ {\mathbf{V}_x(x,y)}}{\partial{x}}+\frac{\partial\ {\mathbf{V}_y(x,y)}}{\partial{y}}\)](https://zh.wikipedia.org/wiki/File:Divergence_\(captions\).svg "wikilink")

**散度**或稱**發散度**，是[向量分析中的一个](../Page/向量分析.md "wikilink")[向量](https://zh.wikipedia.org/wiki/向量场 "wikilink")[算子](../Page/算子.md "wikilink")，将[向量空间上的一个](../Page/向量空间.md "wikilink")[向量场](https://zh.wikipedia.org/wiki/向量场 "wikilink")（矢量场）对应到一个[标量场上](https://zh.wikipedia.org/wiki/标量场 "wikilink")。散度描述的是向量场里一个点是汇聚点还是发源点，形象地说，就是这包含这一点的一个微小体元中的向量是“向外”居多还是“向内”居多。
...
具有一阶连续[偏导数](../Page/偏导数.md "wikilink")，那么向量场 \(\mathbf{A}\) 的散度就是：
...
\[\mathbf A = A_r(\rho, \varphi, z) \boldsymbol{e}_{\rho} +  A_{\varphi}(\rho, \varphi, z)\boldsymbol{e}_{\varphi} + A_z(\rho, \varphi, z) \boldsymbol{e}_{z}\]，
向量场**A**的散度就是：

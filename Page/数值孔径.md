...
数值孔径的概念在[摄影](../Page/摄影.md "wikilink")中用得较少，取而代之的是透镜的[焦比](../Page/焦比.md "wikilink")这一概念。焦比一般写作
 或
\(N\)，其定义为透镜的[焦距](../Page/焦距.md "wikilink")与[入瞳直径之比](https://zh.wikipedia.org/wiki/入瞳 "wikilink")：
...
一般而言，上述近似在数值孔径较小的时候才成立，但一系列分析表明，对于经过良好校正的光学系统（如相机镜头）而言，这一近似即便是对较大的数值孔径也成立。对此[鲁道夫·京斯莱克](../Page/鲁道夫·京斯莱克.md "wikilink")做出了如下解释，“认为\[\(D/2f\) \]等于
\(\tan \theta\)，而非
\(\sin \theta\)，这是一个普遍性的错误想法……如果主平面在实际中真的是平面，那这当然没错；但关于[阿贝正弦条件的完备理论表明](https://zh.wikipedia.org/wiki/阿贝正弦条件 "wikilink")，当透镜已经针对[彗形像差](../Page/彗形像差.md "wikilink")和[球面像差](../Page/球面像差.md "wikilink")进行过校正（所有好的摄影机镜头都应当做到这一点），这时透镜的第二主平面就不再是平面，而成为了以焦点为圆心，以焦距为半径的圆的一部分……”\[3\]从这种意义上来说，传统的[薄透镜定义和焦比的图示就显得有些误导性了](https://zh.wikipedia.org/wiki/薄透镜 "wikilink")，用数值孔径来定义反倒更有意义一些。
...
的光纤核心层中时，由[斯涅尔定律](../Page/斯涅尔定律.md "wikilink")可知

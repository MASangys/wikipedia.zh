...
数位滤波器的另外一种形式是[状态空间](../Page/状态空间.md "wikilink")模型。状态空间滤波器的一个典型例子是[Rudolf Kalman在](https://zh.wikipedia.org/wiki/Rudolf_Kalman "wikilink")1960年提出的[卡尔曼滤波器](https://zh.wikipedia.org/wiki/卡尔曼滤波器 "wikilink")。

...
[二階邏輯](../Page/二階邏輯.md "wikilink")可捕捉數學歸納法這概念，表達成如下邏輯式：
...
若用[一階邏輯將數學歸納法](https://zh.wikipedia.org/wiki/一階邏輯 "wikilink")[公設化](https://zh.wikipedia.org/wiki/公設 "wikilink")，則須採用[公設模式](https://zh.wikipedia.org/wiki/公理模式 "wikilink")，替每一個可能存在的述詞設下針對其的獨立公設。舉例而言，我們僅允許三個一階述詞存在，分別名為 P<sub>1</sub>、P<sub>2</sub>、P<sub>3</sub> ，則原先以二階邏輯描述的公設可改寫為：
...
一階[ZFC集合論不允許述詞被遍歷](https://zh.wikipedia.org/wiki/ZFC "wikilink")， 但我們可以藉由遍歷集合，繞過一階邏輯之限制，描述歸納法：
...
皮亞諾公理視數學歸納法不證自明，設作公設，而於ZFC集合論，數學歸納法可从[良序定理](https://zh.wikipedia.org/wiki/良序定理 "wikilink")（well-ordering principle）推导出来。\[4\]

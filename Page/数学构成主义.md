在[数学哲学中](https://zh.wikipedia.org/wiki/数学哲学 "wikilink")，**构成主义**或**构造主义**认为要证明一个数学对象存在就必须把它构造出来。如果假设一个对象不存在，并从该假设推导出一个矛盾，对于构成主义者来说，不足以证明该对象存在。见[构造性证明](https://zh.wikipedia.org/wiki/构造性证明 "wikilink")。
...
在经典[实分析中](https://zh.wikipedia.org/wiki/实分析 "wikilink")，[实数构造的方法之一是把它作为](https://zh.wikipedia.org/wiki/实数构造 "wikilink")[有理数的](../Page/有理数.md "wikilink")[柯西列对](https://zh.wikipedia.org/wiki/柯西列 "wikilink")。这个构造在构造主义数学中不成立，因为序列是无穷的。
...
这些观点[希尔伯特在](https://zh.wikipedia.org/wiki/希尔伯特 "wikilink")1928年曾有强烈表示．他在《数学基础》（）写道：“把排中律从数学家那里拿走，就像把望远镜从天文学家那里拿走，或是从拳击手那里把拳头拿走一样”\[1\]
（[排中律在](https://zh.wikipedia.org/wiki/排中律 "wikilink")[构造性逻辑中不成立](https://zh.wikipedia.org/wiki/构造性逻辑 "wikilink")）。
...
## 对构成主义有贡献的数学家
  ...
  - [克罗内克](https://zh.wikipedia.org/wiki/克罗内克 "wikilink")（Leopold
    Kronecker）
  - [L.E.J.
    Brouwer](https://zh.wikipedia.org/wiki/L.E.J._Brouwer "wikilink")
  - [Paul
    Lorenzen](https://zh.wikipedia.org/wiki/Paul_Lorenzen "wikilink")
  - [Errett
    Bishop](https://zh.wikipedia.org/wiki/Errett_Bishop "wikilink")

在[数学哲学中](https://zh.wikipedia.org/wiki/数学哲学 "wikilink")，**构成主义**或**构造主义**认为要证明一个数学对象存在就必须把它构造出来。如果假设一个对象不存在，并从该假设推导出一个矛盾，对于构成主义者来说，不足以证明该对象存在。见[构造性证明](../Page/构造性证明.md "wikilink")。

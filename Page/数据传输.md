...
数据传输可以是从数据源始发的数字信息，例如一台计算机或一个键盘。也可以是将一个模拟信号如电话或视频信号[数字化至一个比特流](https://zh.wikipedia.org/wiki/数字化 "wikilink")，例如使用[脉冲编码调制](https://zh.wikipedia.org/wiki/脉冲编码调制 "wikilink")（PCM）或更进一步的[数据压缩](../Page/数据压缩.md "wikilink")（[数模转换与](https://zh.wikipedia.org/wiki/数模转换 "wikilink")[数据压缩](../Page/数据压缩.md "wikilink")）方案。这种信源的编解码是通过[编解码器设备所进行的](../Page/编解码器.md "wikilink")。

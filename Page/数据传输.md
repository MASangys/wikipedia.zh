...
数字传输或数据传输以前一直属于[电信](../Page/电信.md "wikilink")和[电气工程的范畴](https://zh.wikipedia.org/wiki/电气工程 "wikilink")。数据传输的基本原则也可以包涵在[数据通信](../Page/数据通信.md "wikilink")之中的[计算机科学](../Page/计算机科学.md "wikilink")
/

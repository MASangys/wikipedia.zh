**數據擁塞控制協議**（，縮寫為
DCCP）是由（[網際網路工程工作小組](https://zh.wikipedia.org/wiki/IETF "wikilink")[IETF](https://zh.wikipedia.org/wiki/IETF "wikilink")）提出一個針對[传输层中](../Page/传输层.md "wikilink")[UDP的新传输的](../Page/用户数据报协议.md "wikilink")[協議而發展出來](https://zh.wikipedia.org/wiki/協議\(電子計算機\) "wikilink")，用来传输实时业务。它是一个可以进行[拥塞控制的非可靠传输协议](https://zh.wikipedia.org/wiki/拥塞控制的非可靠传输协议 "wikilink")，并同时提供多种拥塞控制机制，在通信开始时由用户进行协商选择。除预留和自定义方式外，目前DCCP定义了两种拥塞控制机制：[TCP－Like和](https://zh.wikipedia.org/wiki/TCP－Like "wikilink")[TFRC](https://zh.wikipedia.org/wiki/友善式傳輸層協定壅塞控制 "wikilink")。[TCP－Like类似](https://zh.wikipedia.org/wiki/TCP－Like "wikilink")[TCP的](../Page/传输控制协议.md "wikilink")[AIMD机制](https://zh.wikipedia.org/wiki/AIMD "wikilink")，而[TFRC是](https://zh.wikipedia.org/wiki/友善式傳輸層協定壅塞控制 "wikilink")[TCP友好的速率控制机制](../Page/传输控制协议.md "wikilink")。
...
有确认的不可靠数据报流。使用[Data和](../Page/Data.md "wikilink")[DataAck两种数据流的数据传输](https://zh.wikipedia.org/wiki/DataAck "wikilink")，[Data是纯数据](../Page/Data.md "wikilink")，[DataAck可以既有数据又有确认信息](https://zh.wikipedia.org/wiki/DataAck "wikilink")。
...
尽管DCCP当前仍有很多问题，例如，协议应该同时支持[IPv4和](../Page/IPv4.md "wikilink")[IPv6](../Page/IPv6.md "wikilink")；在安全性方面，有关DCCP是否可以在传输安全管理协议上取代UDP还需探讨；DCCP和[RTP](https://zh.wikipedia.org/wiki/RTP "wikilink")（[实时传输协议](../Page/实时传输协议.md "wikilink")）的关系也还须进一步研究，但DCCP协议草案的提出为希望使用一种协议同时提供多种传输服务的应用展现了一种新的服务模式，对未来网络中传输协议的研究及对多媒体应用的支持提供了一个新的切入点。

...
多數的資料挖掘研究都關注於發現大量的資料集中，一個高度詳細的模式。在《大忙人的資料挖掘》一書中， [西弗吉尼亞大學](../Page/西弗吉尼亞大學.md "wikilink")和[不列顛哥倫比亞大學](../Page/不列顛哥倫比亞大學.md "wikilink")研究者討論了一個交替模式，用來發現一個資料集當中兩個元素的最小區別，它的目標是發現一個更簡單的模式來描述相關數據。\[17\]
...
14. K.A. Taipale (December 15, 2003). "*Data Mining and Domestic Security: Connecting the Dots to Make Sense of Data*". *Colum. Sci. & Tech. L. Rev.* 5 (2). SSRN 546782 / OCLC 45263753 .

15. Chip Pitts (March 15, 2007). "*The End of Illegal Domestic Spying? Don't Count on It*". Wash. Spec.

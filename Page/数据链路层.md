...
## 常見数据链路层的设备
  ...
  - [交换机是本层设备](https://zh.wikipedia.org/wiki/网络交换机 "wikilink")。而[集线器是物理层设备](https://zh.wikipedia.org/wiki/集线器 "wikilink")，不是[数据链路层设备](https://zh.wikipedia.org/wiki/数据链路 "wikilink")。
...
Sicherungsschicht](https://zh.wikipedia.org/wiki/de:OSI-Modell#Schicht_2_–_Sicherungsschicht "wikilink")

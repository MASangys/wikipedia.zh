...
**整塊性核心**（），也譯為**集成式核心**、**單體式核心**，一種[作業系統核心架構](../Page/内核.md "wikilink")，此架構的特性是整個核心程式是一個單一二進位執行檔，在[核心空間以監管者模式](https://zh.wikipedia.org/wiki/核心空間 "wikilink")（Supervisor
Mode）來執行。相對於其他類型的作業系統架構，如[微核心架構或](https://zh.wikipedia.org/wiki/微核心 "wikilink")[混核心架構等](https://zh.wikipedia.org/wiki/混核心 "wikilink")，這些核心會定義出一個高階的虛擬介面，由該介面來涵蓋描述整個電腦硬體，這些描述會集合成一組硬體描述用詞，有時還會附加一些[系統调用](https://zh.wikipedia.org/wiki/系統调用 "wikilink")，如此可以用一個或多個模組來實現各種作業系統服務，如[行程管理](../Page/行程.md "wikilink")、共時（Concurrency）控制、[記憶體管理等](../Page/記憶體管理.md "wikilink")。

## 概論

整塊性核心被視作為運行在單一位址空間的單一的行程，核心提供的所有服務，都以特權模式，在這個大型的核心位址空間中運作，這個位址空間被稱為[核心空間](https://zh.wikipedia.org/wiki/核心空間 "wikilink")（kernel
space）。它通常是以單一靜態[二進位檔案的方式被儲存在](https://zh.wikipedia.org/wiki/二進位檔案 "wikilink")[磁碟](https://zh.wikipedia.org/wiki/磁碟 "wikilink")，或是[快取記憶體上](https://zh.wikipedia.org/wiki/快取記憶體 "wikilink")，在開機之後被載入記憶體中的核心空間，開始運作。
...
現在多數採行整塊性架構設計的作業系統，如[OpenVMS](https://zh.wikipedia.org/wiki/OpenVMS "wikilink")、[Linux](../Page/Linux.md "wikilink")、[FreeBSD](../Page/FreeBSD.md "wikilink")、以及[Solaris等](../Page/Solaris.md "wikilink")，都已經能在運作執行階段中，以動態方式來載入（Load）、卸載（Unload）可執行的[模組](https://zh.wikipedia.org/wiki/可載入核心模組 "wikilink")，不過這些模組是屬於二進位程式碼的層次，或稱映像層次，而非核心架構的層次。即使整塊性核心進行模組化轉化，也不會與微核心或混核心架構的核心產生區分上的混淆，因為微核心、混核心的模組是屬於系統架構的層次。

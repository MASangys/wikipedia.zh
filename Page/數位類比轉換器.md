...
典型的数字模拟转换器将抽象数转换为具体的脉冲序列，然后利用[插值法输出近似连续的量](../Page/插值.md "wikilink")。其他的转换方法（例如基于[ΔΣ调变的方法](https://zh.wikipedia.org/wiki/ΔΣ调变 "wikilink")）则产生[脉冲密度调制](../Page/脉冲密度调制.md "wikilink")（）\[1\]进而产生平滑的连续信号。

...
[數學哲學就關注](https://zh.wikipedia.org/wiki/數學哲學 "wikilink")[語言和邏輯在數學證明中的角色](../Page/語言.md "wikilink")，和[作為語言的數學](https://zh.wikipedia.org/wiki/數學語言 "wikilink")。
...
[反证法是一种古老的证明方法](https://zh.wikipedia.org/wiki/反证法 "wikilink")，其思想为：欲證明某命題是假命題，则反过来假設該命題為真。在这种情况下，若能通过正确有效的推理導致逻辑上的[矛盾](../Page/矛盾.md "wikilink")（如导出该命题自身为假，于是陷入命题既真且假的矛盾），則能證明原来的命題為假。\[8\][無矛盾律和](https://zh.wikipedia.org/wiki/無矛盾律 "wikilink")[排中律是反證法的邏輯基礎](../Page/排中律.md "wikilink")。反证法的好处是在反过来假设该命题为真的同时，等于多了一个已知条件，这样对题目的证明常有帮助\[9\]。

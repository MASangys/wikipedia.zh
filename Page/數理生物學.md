**數理生物學**（），又稱**數學生物學**（）或**生物数学**（）是一个[跨学科的领域](https://zh.wikipedia.org/wiki/跨学科 "wikilink")，其主要目标是利用[数学的技巧和工具为自然界](../Page/数学.md "wikilink")，特别是[生物学中的过程](../Page/生物学.md "wikilink")[建模并进行分析](https://zh.wikipedia.org/wiki/建模 "wikilink")。生物数学在生物学的理论和实践中都有广泛的应用。
...
<!-- end list -->
  ...
  - 数学理论，特别是[混沌理论的发展](../Page/混沌.md "wikilink")，使人们对[复杂性系统的认识更加深刻](https://zh.wikipedia.org/wiki/复杂性系统 "wikilink")，从而提供了研究生物学中[非线性动力过程的工具和方法](https://zh.wikipedia.org/wiki/非线性 "wikilink")。
...
<!-- end list -->
  ...
  - 基于人类与动物研究中的复杂性，人们对*[In
    silico](https://zh.wikipedia.org/wiki/In_silico "wikilink")*的兴趣与日俱增。
...
在[微演化中](https://zh.wikipedia.org/wiki/微演化 "wikilink")，最主要的數學應用是[族群遺傳學](https://zh.wikipedia.org/wiki/族群遺傳學 "wikilink")，計算的是有限數量的基因頻率如何受[天擇](https://zh.wikipedia.org/wiki/天擇 "wikilink")、[性擇](https://zh.wikipedia.org/wiki/性擇 "wikilink")、[突變](https://zh.wikipedia.org/wiki/突變 "wikilink")、[漂變](https://zh.wikipedia.org/wiki/漂變 "wikilink")、[遷徒等演化力量影響](https://zh.wikipedia.org/wiki/遷徒 "wikilink")；可以由觀察到的基因頻率回推演化力量，或是由演化力量預測未來的基因頻率。當有大量基因座，而且個基因座對性狀的影響都很小時，可以用[計量遺傳學](https://zh.wikipedia.org/wiki/計量遺傳學 "wikilink")（Quantitative
genetics）描述性狀的分佈如何演化；通常假設性狀是常態分佈，計算基平均值和方差，[羅納德·費雪為](https://zh.wikipedia.org/wiki/羅納德·費雪 "wikilink")[統計學打下的基礎即是由此建立](https://zh.wikipedia.org/wiki/統計學 "wikilink")。由[John
Maynard
Smith引进的](https://zh.wikipedia.org/wiki/:en:John_Maynard_Smith "wikilink")[进化博弈理论是另一個重要的數理應用](https://zh.wikipedia.org/wiki/进化博弈理论 "wikilink")。

在[巨演化中](https://zh.wikipedia.org/wiki/巨演化 "wikilink")，[系統分類學大量使用數學](https://zh.wikipedia.org/wiki/系統分類學 "wikilink")。該領域比較生物間性狀的異同（包括基因組成）後，用[最大簡約法或](../Page/最大簡約法.md "wikilink")[最大似然估計等數學理論來重建演化歷史](https://zh.wikipedia.org/wiki/最大似然估計 "wikilink")。

在生態學中，族群動態學（Population
dynamics）描述生物族群大小的變化。[馬爾薩斯的](https://zh.wikipedia.org/wiki/馬爾薩斯 "wikilink")《[人口論](../Page/人口論.md "wikilink")》提出指數成長的人口模型，可以說是最早的族群動態學理論。[Lottak-Volterra方程解釋天敵和獵物的族群波動關係](https://zh.wikipedia.org/wiki/洛特卡－沃尔泰拉方程 "wikilink")，也早在19世纪就被广泛地研究。与人口动力学密切相关的另一领域是[数学流行病学](../Page/流行病学.md "wikilink")，其主要研究内容为传染病在易感人群中的传播。目前已经有多个病毒传播模型在公共健康政策的决策中产生了重要影响。[群集生態學以及](https://zh.wikipedia.org/wiki/群集生態學 "wikilink")[生物地理學也大量使用數學](https://zh.wikipedia.org/wiki/生物地理學 "wikilink")，包括[羅伯特·麥克阿瑟和](https://zh.wikipedia.org/wiki/羅伯特·麥克阿瑟 "wikilink")[艾德華·威爾森提出的的島嶼模型](../Page/艾德華·威爾森.md "wikilink")，以及[生態學中性理論](https://zh.wikipedia.org/wiki/生態學中性理論 "wikilink")，計算環境因子影響如何影響物種遷徒、滅絕、以及種化的頻率，從而解釋一個地區的物種多樣性。
...
随即动力系统用来描述一个从给定的初态到某个终态随机的[映射](https://zh.wikipedia.org/wiki/映射 "wikilink")，将相空间视为一个[随机变量及相应的](../Page/随机变量.md "wikilink")[随机分布](https://zh.wikipedia.org/wiki/随机分布 "wikilink")。
...
## 扩展阅读
  ...
  - S. Schnell, R. Grima, P. K. Maini, *[Multiscale Modeling in
    Biology](https://web.archive.org/web/20090326215301/http://eprints.maths.ox.ac.uk/567/01/224.pdf)*,
    American Scientist, Vol 95, pages 134-142, March-April 2007.

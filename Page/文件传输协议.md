...
原始规范由 Abhay Bhushan 编写，并于1971年4月16日作为 RFC114 发布。直到1980年，FTP 才在TCP/ IP的前身NCP上运行。该协议先被TCP / IP版本，[RFC](https://zh.wikipedia.org/wiki/Request_for_Comments "wikilink") [765](https://zh.wikipedia.org/wiki/rfc:765 "wikilink")（1980年6月）取代，后来又被[RFC 959](https://zh.wikipedia.org/wiki/rfc:959 "wikilink")（1985年10月）所取代，这也是当前规范。RFC 959提出了若干标准修改，例如[RFC 1579](https://zh.wikipedia.org/wiki/rfc:1579 "wikilink")（1994年2月）使 FTP 能够穿越 [NAT](https://zh.wikipedia.org/wiki/NAT "wikilink") 与 [防火墙](../Page/防火墙.md "wikilink")（被动模式），[RFC 2228](https://zh.wikipedia.org/wiki/rfc:2228 "wikilink")（1997年6月）提出安全扩展，[RFC 2428](https://zh.wikipedia.org/wiki/rfc:2428 "wikilink")（1998年9月）增加了对[IPv6](../Page/IPv6.md "wikilink")的支持，并定义了一种新型的被动模式。      

...
Bush的论文《就像我们可能会想的……》\[1\]第一次提出了设计自动的，在大规模的存储数据中进行查找的机器的构想。这被认为是现在信息检索技术的开山之作。进入50年代后，研究者们开始为逐步的实现这些设想而努力。在50年代中期，在利用[电脑对文本数据进行检索的研究上](https://zh.wikipedia.org/wiki/电脑 "wikilink")，研究者取得了一些成果。其中最有代表性的是Luhn在[IBM](../Page/IBM.md "wikilink")公司的工作\[2\]，他提出了利用词对文档构建索引并利用检索与文档中词的匹配程度进行检索

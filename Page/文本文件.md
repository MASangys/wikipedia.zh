...
[ASCII](../Page/ASCII.md "wikilink")标准使得只含有ASCII字符的文本文件可以在[Unix](https://zh.wikipedia.org/wiki/Unix "wikilink")、[Macintosh](https://zh.wikipedia.org/wiki/Macintosh "wikilink")、[Microsoft
Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")、[DOS](../Page/DOS.md "wikilink")和其它[操作系统](../Page/操作系统.md "wikilink")之间自由交互，而其它格式的文件是很难做到这一点的。但是，在这些操作系统中，[换行符并不相同](https://zh.wikipedia.org/wiki/换行 "wikilink")，处理非ASCII字符的方式也不一致。

**文档分类**是[图书馆学](../Page/图书馆学.md "wikilink")， [信息学和](https://zh.wikipedia.org/wiki/信息学 "wikilink")[计算机科学](../Page/计算机科学.md "wikilink")中的一个问题。其任务是将一个[文档分配到一个或者多个](https://zh.wikipedia.org/wiki/文档 "wikilink")[类别中](https://zh.wikipedia.org/wiki/类别 "wikilink")。它可以是通过人工分类完成的，也可以是通过计算机算法实现的。多数通过人工的文档分类问题一直属于图书馆学的领域，而通过算法实现的文档分类问题则多属于信息学和计算机科学的领域。这些问题之间是有相同的部分的，所以有一些对文档分类的跨学科研究。
...
文档自动分类的任务可以分为三类：**监督式学习**的文档分类，这需要人工反馈数据的一些外在机制。**非监督式学习**的文档分类（也被称作[文档聚类](https://zh.wikipedia.org/wiki/文档聚类 "wikilink")），这类任务完全不依靠外在人工机制。和**半监督式学习**的文档分类，是前两类的结合，\[3\] 它其中有一部分的文档是由人工标注的，这有一些相关方面的具有许可证的软件。\[4\]\[5\]\[6\]\[7\]\[8\]
...
自动的文档分类工具如下：
  ...
  - [自然语言处理](../Page/自然语言处理.md "wikilink")的方法
...
分类工具被应用于如下：
  ...
  - [可读性](../Page/可读性.md "wikilink")评价, 自动评价一个纯文本的可读性程度，或者找到可读性适合于某一特定群体的文本，这属于的体系。
...
doi: 10.1109/SECON.2017.7925400, URL: <http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7925400&isnumber=7925258></ref> \[11\]
...
## 参阅
  ...
  - [监督式学习](https://zh.wikipedia.org/wiki/监督式学习 "wikilink"), [非监督式学习](https://zh.wikipedia.org/wiki/非监督式学习 "wikilink")
...
## 外部链接
  ...
  - [Introduction to document classification](https://web.archive.org/web/20070613200617/http://isp.imm.dtu.dk/thor/projects/multimedia/textmining/node11.html)
...
[Category:資訊科學](https://zh.wikipedia.org/wiki/Category:資訊科學 "wikilink") [Category:自然语言处理](https://zh.wikipedia.org/wiki/Category:自然语言处理 "wikilink") [Category:知识表示](https://zh.wikipedia.org/wiki/Category:知识表示 "wikilink") [Category:数据挖掘](https://zh.wikipedia.org/wiki/Category:数据挖掘 "wikilink") [Category:机器学习](https://zh.wikipedia.org/wiki/Category:机器学习 "wikilink")
...
4.
5.  [Interactive Automatic Document Classification Prototype](https://seer.lcc.ufmg.br/index.php/jidm/article/download/43/41An)
6.  [Document Classification - Artsyl](https://archive.is/20141208063727/http://www.artsyltech.com/da_classification.htmlAutomatic)
7.  [ABBYY FineReader Engine 11 for Windows](http://www.abbyy.com/ocr_sdk_windows/what_is_new/classification/)

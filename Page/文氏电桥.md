...
**文氏电桥**（）是利用[電阻與](https://zh.wikipedia.org/wiki/電阻 "wikilink")[電容作為迴授的一种电桥型](../Page/電容.md "wikilink")[振盪器](https://zh.wikipedia.org/wiki/振盪器 "wikilink")，工作[頻率可達約幾MHz左右](https://zh.wikipedia.org/wiki/頻率 "wikilink")。將輸出接至一電阻（\(R_3\)）與電容（\(C_1\)）串聯之電抗（\(X_s\)）串接一電阻（\(R_4\)）與電容（\(C_2\)）並聯之電抗（\(X_p\)），再將\(X_p\)之電壓回授至輸入端，此方式稱為韋恩橋式震盪器或韋恩橋式震盪電路。

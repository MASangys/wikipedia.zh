...
**文泉驿**是一个开源汉字字体项目，由旅美学者房骞骞（FangQ）于2004年10月创建，集中力量解决GNU/Linux高质量中文字体匮乏的状况。目前，文泉驿已经开发并发布了第一个完整覆盖GB18030汉字（包含27000多个汉字）的多规格点阵汉字字库，第一个覆盖GBK字符集的开源矢量字库（[文泉驿正黑](https://zh.wikipedia.org/wiki/文泉驿正黑 "wikilink")），并提供了目前包含字符数目最多的开源字体——[GNU
...
Linux](../Page/Magic_Linux.md "wikilink")、[CDLinux使用文泉驿作为默认中文字体](https://zh.wikipedia.org/wiki/CDLinux "wikilink")，[Debian](../Page/Debian.md "wikilink")、[Gentoo](https://zh.wikipedia.org/wiki/Gentoo "wikilink")、[Mandriva](../Page/Mandriva.md "wikilink")、[ArchLinux](https://zh.wikipedia.org/wiki/ArchLinux "wikilink")、[Frugalware则提供了官方源支持](https://zh.wikipedia.org/wiki/Frugalware "wikilink")，而FreeBSD则在其ports中有提供。文泉驿的网站（除了论坛）采用[Wiki搭建](../Page/Wiki.md "wikilink")。
...
## 发展历程
  ...
  - 2005年1月6日，发布**炎黄—Unifont (yhunifont)**16X16
    pt[点阵字体](https://zh.wikipedia.org/wiki/点阵字体 "wikilink")。
  ...
  - 2005年12月20日，[Magic Linux](../Page/Magic_Linux.md "wikilink") 2.0
    RC2首次采用文泉驿[点阵字体作为](https://zh.wikipedia.org/wiki/点阵字体 "wikilink")9pt\~12pt屏幕显示字体，Magic
    Linux是第一个在官方发布版中使用文泉驿[点阵字体的](https://zh.wikipedia.org/wiki/点阵字体 "wikilink")[Linux发行版](../Page/Linux发行版.md "wikilink")。
  - 2006年2月9日，CJK
    Basic拥有[开源图片的](https://zh.wikipedia.org/wiki/开源 "wikilink")19816个[汉字的笔画分析全部完成](../Page/汉字.md "wikilink")。
...
H-Source（香港，[常用字字形表](../Page/常用字字形表.md "wikilink")、[香港字形參考指引](http://glyph.iso10646hk.net/chinese/hkcharacters.jsp)），並不符合台灣和香港對繁體字的慣用寫法。詳見[中日韓越統一表意文字](https://zh.wikipedia.org/wiki/中日韓越統一表意文字 "wikilink")。

**斐波那契堆**（**Fibonacci
heap**）是[计算机科学中](../Page/计算机科学.md "wikilink")[树的集合](../Page/树_\(数据结构\).md "wikilink")。它比[二项堆具有更好的](../Page/二项堆.md "wikilink")[平摊分析性能](../Page/平摊分析.md "wikilink")，可用于实现合并[优先队列](https://zh.wikipedia.org/wiki/优先队列 "wikilink")。不涉及删除元素的操作有O(1)的平摊时间。
Extract-Min和Delete的数目和其它相比，较小时效率更佳。稠密图每次decrease
key只要O(1)的平摊时间，和二项堆的O(lg n)相比是巨大的改进。

斐波纳契堆于1984年由[Michael L.
Fredman与](https://zh.wikipedia.org/wiki/Michael_Fredman "wikilink")[Robert
E.
Tarjan提出](https://zh.wikipedia.org/wiki/罗伯特·塔扬 "wikilink")，1987年公开发表。\[1\]名字来源于运行时分析使用的[斐波那契数](https://zh.wikipedia.org/wiki/斐波那契数 "wikilink")。

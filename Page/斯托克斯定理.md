...
定理可以简单的推广到[分段光滑的子流形的](https://zh.wikipedia.org/wiki/分段光滑 "wikilink")[线性组合上](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。斯托克斯定理表明相差一个[恰当形式的闭形式在相差一个](https://zh.wikipedia.org/wiki/恰当形式 "wikilink")[边界](../Page/边界.md "wikilink")的链上的积分相同。这就是[同调群和](https://zh.wikipedia.org/wiki/同调群 "wikilink")[德拉姆上同调](../Page/德拉姆上同调.md "wikilink")可以配对的基础。

在數學中，****用於解決各種[數學分析和](https://zh.wikipedia.org/wiki/數學分析 "wikilink")[組合數學問題](https://zh.wikipedia.org/wiki/組合數學 "wikilink")，斯特林數是兩組不同的數，均是18世紀由
引入並以其命名，以****和****的稱呼區分。此外，有時候也將****稱爲第三類斯特林數\[1\]。

## 第一類斯特林數

### 定義

****可以定義爲對應[遞降階乘展開式的各項係數](../Page/遞進階乘與遞降階乘.md "wikilink")，即
...
****是由在1954年發現的\[7\]\[8\]，可以用[遞進階乘和遞降階乘定義爲](../Page/遞進階乘與遞降階乘.md "wikilink")
...
比較等式兩邊係數，得
  ...
  -
    <math display='block'>\\begin{cases}{L(3,0)=0} \\\\
    {L(3,1)-L(3,2)+2L(3,3)=2} \\\\
...
以上定義的拉赫數是無符號拉赫數（英語： signed Lah numbers），有符號拉赫數（英語：signed Lah
numbers）的定義如下：
...
7.
8.  [John Riordan, *Introduction to Combinatorial
    Analysis*](https://books.google.com/books?id=zWgIPlds29UC),
    Princeton University Press (1958, reissue 1980)  (reprinted again in
    2002 by Dover Publications).
9.
10.
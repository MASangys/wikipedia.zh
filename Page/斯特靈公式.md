...
**斯特靈公式**是一條用來取n[階乘](../Page/階乘.md "wikilink")[近似值的](https://zh.wikipedia.org/wiki/近似值 "wikilink")[數學](https://zh.wikipedia.org/wiki/數學 "wikilink")[公式](https://zh.wikipedia.org/wiki/公式 "wikilink")。一般來說，當n很大的時候，n階乘的計算量十分大，所以斯特靈公式十分好用，而且，即使在n很小的時候，斯特靈公式的取值已經十分準確。
...
证明了公式中\(c=\sqrt{2\pi}\)，約為。更加精确的形式是[雅克·比内发现的](https://zh.wikipedia.org/wiki/雅克·比内 "wikilink")。
...
可以通过把斯特灵公式整理，并注意到它的幂级数与[双曲正弦函数的](https://zh.wikipedia.org/wiki/双曲正弦 "wikilink")[泰勒级数展开式的相似性来得出](../Page/泰勒级数.md "wikilink")。当*z*的实数部分大于8时，这个近似值精确到小数点后8位。2002年，Robert

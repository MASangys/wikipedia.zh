[Stirling's_Approximation.svg](https://zh.wikipedia.org/wiki/File:Stirling's_Approximation.svg "fig:Stirling's_Approximation.svg")

**斯特靈公式**是一條用來取n[階乘](../Page/階乘.md "wikilink")[近似值的](../Page/近似值.md "wikilink")[數學](../Page/數學.md "wikilink")[公式](../Page/公式.md "wikilink")。一般來說，當n很大的時候，n階乘的計算量十分大，所以斯特靈公式十分好用，而且，即使在n很小的時候，斯特靈公式的取值已經十分準確。
...
这个公式是[亚伯拉罕·棣莫弗首先发现的](../Page/亚伯拉罕·棣莫弗.md "wikilink")，形式为：

\[\displaystyle n! \approx c  n^{n+\frac{1}{2}} e^{-n}\]，其中c為常數。
证明了公式中\(c=\sqrt{2\pi}\)，約為。更加精确的形式是[雅克·比内发现的](../Page/雅克·比内.md "wikilink")。

## 推导

这个公式，以及误差的估计，可以推导如下。首先不直接估计*n*\!，而是考虑它的[自然对数](../Page/自然对数.md "wikilink")：

\[\ln (n!) = \ln 1 + \ln 2 + \cdots + \ln n.\] 即:

\[\ln (n!) - \frac{\ln n}{2} = \ln 1 + \ln 2 + \cdots + \ln n - \frac{\ln n}{2}.\]

这个方程的右面是积分\(\int_1^n \ln(x)\,dx = n \ln n - n + 1\)的近似值（利用[梯形法则](../Page/梯形法则.md "wikilink")），而它的误差由[欧拉-麦克劳林公式给出](../Page/欧拉-麦克劳林公式.md "wikilink")：
...
将上述表达式代入[沃利斯乘积公式](../Page/沃利斯乘积.md "wikilink")，并令*n*趋于无穷，便可以得出*e*<sup>*y*</sup>（\(e^y = \sqrt{2 \pi}\)）。因此，我们便得出斯特灵公式：

\[n! = \sqrt{2 \pi n}~{\left( \frac{n}{e} \right)}^n \left[ 1 + O \left( \frac{1}{n} \right) \right]\]

这个公式也可以反复使用[分部积分法来得出](../Page/分部积分法.md "wikilink")，首项可以通过[最速下降法得到](../Page/最速下降法.md "wikilink")。把以下的和
...
当\(n \to \infty\)时，截断级数的误差等于第一个省略掉的项。这是[渐近展开式的一个例子](../Page/渐近展开式.md "wikilink")。它不是一个[收敛级数](../Page/收敛级数.md "wikilink")；对于任何特殊值*n*，级数的准确性只在取有限个项时达到最大，如果再取更多的项，则准确性将变得越来越差。
...
然而，[伽玛函数与阶乘不一样](../Page/伽玛函数.md "wikilink")，它对于所有复数都有定义。尽管如此，斯特灵公式仍然适用。如果\(\Re(z) > 0\)，那么：
...
一种方法是利用含有[上升阶乘幂的级数](../Page/阶乘幂.md "wikilink")。如果\(z^{\overline n} = z(z+1) \cdots (z+n-1)\)，那么：
...
可以通过把斯特灵公式整理，并注意到它的幂级数与[双曲正弦函数的](../Page/双曲正弦.md "wikilink")[泰勒级数展开式的相似性来得出](../Page/泰勒级数.md "wikilink")。当*z*的实数部分大于8时，这个近似值精确到小数点后8位。2002年，Robert
H. Windschitl建议计算器用这个公式来计算伽玛函数。
...
## 参考文献
  ...
  - Paris, R. B., and Kaminsky, D., *Asymptotics and the Mellin-Barnes
    Integrals*, Cambridge University Press, 2001

  - Whittaker, E. T., and Watson, G. N., *A Course in Modern Analysis*,
    fourth edition, Cambridge University Press, 1963. ISBN 0-521-58807-3

  - Toth, V. T. *Programmable Calculators: Calculators and the Gamma
    Function*. <http://www.rskey.org/gamma.htm>, modified 2006

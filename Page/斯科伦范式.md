[一阶逻辑的](../Page/一阶逻辑.md "wikilink")[公式是](../Page/公式.md "wikilink")**Skolem
范式**的，如果它的[前束范式只有全称量词](../Page/前束范式.md "wikilink")。一个公式可以被**Skolem
化**，就是说消除它的存在量词并生成最初的公式的[等价可满足的公式](../Page/等价可满足.md "wikilink")。Skolem
化是如下([二阶的](../Page/二阶逻辑.md "wikilink"))等价的应用

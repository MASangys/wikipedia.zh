> 本文内容由[斯科伦范式](https://zh.wikipedia.org/wiki/斯科伦范式)转换而来。


[一阶逻辑](../Page/一阶逻辑.md "wikilink")的[公式是](https://zh.wikipedia.org/wiki/公式 "wikilink")**Skolem 范式**的，如果它的[前束范式](../Page/前束范式.md "wikilink")只有全称量词。一个公式可以被**Skolem 化**，就是说消除它的存在量词并生成最初的公式的[等价可满足的公式](https://zh.wikipedia.org/wiki/等价可满足 "wikilink")。Skolem 化是如下([二阶的](https://zh.wikipedia.org/wiki/二阶逻辑 "wikilink"))等价的应用
...
[Category:模型论](https://zh.wikipedia.org/wiki/Category:模型论 "wikilink") [Category:数学公式](https://zh.wikipedia.org/wiki/Category:数学公式 "wikilink")
[Scorers_Gi_function.png](https://zh.wikipedia.org/wiki/File:Scorers_Gi_function.png "fig:Scorers_Gi_function.png")
[Scorers_Hi_function.png](https://zh.wikipedia.org/wiki/File:Scorers_Hi_function.png "fig:Scorers_Hi_function.png")
...
也可以通过[艾里函数定义](../Page/艾里函数.md "wikilink")：
...
<references/>
  ...
  -
  - f(x)e^{i\\phi(x)}dx</math> and the tabulation of the function
    \({\rm Gi} (z)=\frac{1}{\pi}\int^\infty_0{\rm sin}\left(uz+\frac 13 u^3\right)du\)
    | doi=10.1093/qjmam/3.1.107 | mr=0037604 |id=| year=1950 |
    journal=The Quarterly Journal of Mechanics and Applied Mathematics |
    issn=0033-5614 | volume=3 | pages=107–112}}

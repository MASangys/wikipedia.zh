...
在[数学中](../Page/数学.md "wikilink")，若一個數\(b\)為[数](../Page/数.md "wikilink")\(a\)的**\(n\)次方根**，則\(b^n=a\)。当提及[实数](../Page/实数.md "wikilink")\(a\)的\(n\)次方根的时候，假定想要的是这个数的**主\(n\)次方根**，那么它就可以用[根号](https://zh.wikipedia.org/wiki/根号 "wikilink")（\(\sqrt{\color{white} x}\)）表示成\(\sqrt[n]{a}\)。例如：1024的主10次方根为2，就可以记作\(\sqrt[10]{1024}=2\)。當\(n=2\)時，則\(n\)可以省略。定义实数\(a\)的主\(n\)次方根为\(a\)的\(n\)次方根，且具有与\(a\)相同的正负号的唯一实数\(b\)。如果\(n\)是[偶数](https://zh.wikipedia.org/wiki/偶数 "wikilink")，那么[负数将没有主](../Page/负数.md "wikilink")\(n\)次方根。习惯上，将2次方根叫做[平方根](../Page/平方根.md "wikilink")，将3次方根叫做[立方根](../Page/立方根.md "wikilink")。

## 符号史

最早的根号“√”源于字母「L」的变形（出自拉丁语latus的首字母，表示“边长”），没有[线括号](https://zh.wikipedia.org/wiki/线括号 "wikilink")（即[被开方数上的横线](https://zh.wikipedia.org/wiki/被开方数 "wikilink")），后来数学家[笛卡尔给其加上线括号](https://zh.wikipedia.org/wiki/笛卡尔 "wikilink")，但与前面的方根符号是分开的，因此在复杂的式子显得很乱。直至18世纪中叶，数学家卢贝将前面的方根符号与线括号一笔写成，并将[根指数写在](https://zh.wikipedia.org/wiki/根指数 "wikilink")[根号的左上角](https://zh.wikipedia.org/wiki/根号 "wikilink")，以表示高次方根（当根指数为2时，省略不写。）。从而，形成了我们现在所熟悉的[开方](https://zh.wikipedia.org/wiki/开方 "wikilink")[运算符号](https://zh.wikipedia.org/wiki/运算 "wikilink")\(\sqrt{\color{white} x}\)。
...
对于所有的[非零](https://zh.wikipedia.org/wiki/零向量 "wikilink")[复数](https://zh.wikipedia.org/wiki/复数 "wikilink")*a*，有*n*个不同的复数*b*使得*b*<sup>*n*</sup>
=
*a*，所以符号\(\sqrt[n]{a}\)不能无歧义的使用（通常這樣寫是取*n*個值當中[主幅角最小的](https://zh.wikipedia.org/wiki/主幅角 "wikilink")）。*n*次[单位根是特别重要的](../Page/单位根.md "wikilink")。
...
若要做[加法或](../Page/加法.md "wikilink")[减法](https://zh.wikipedia.org/wiki/减法 "wikilink")，应当注意下列概念是重要的。

\[\sqrt[3]{a^5} = \sqrt[3]{aaaaa} = \sqrt[3]{a^3a^2} = a\sqrt[3]{a^2}\]

若已可以简化根式[表达式](https://zh.wikipedia.org/wiki/表达式 "wikilink")，则加法和减法简单的是[群的](../Page/群.md "wikilink")“同类项”问题。
...
曾经[猜想](../Page/猜想.md "wikilink")[多项式的所有根可以用根号和基本运算来表达](https://zh.wikipedia.org/wiki/多项式 "wikilink")；但是[阿贝尔-鲁菲尼定理断言了这不是普遍为真的](../Page/阿贝尔-鲁菲尼定理.md "wikilink")。例如，方程

[Nuvola_mimetypes_kformula_kfo.png](https://zh.wikipedia.org/wiki/File:Nuvola_mimetypes_kformula_kfo.png "fig:Nuvola_mimetypes_kformula_kfo.png") 在[数学](../Page/数学.md "wikilink")中，若一個數\(b\)為[数](../Page/数.md "wikilink")\(a\)的**\(n\)次方根**，則\(b^n=a\)。当提及[实数](../Page/实数.md "wikilink")\(a\)的\(n\)次方根的时候，假定想要的是这个数的**主\(n\)次方根**，那么它就可以用**[根号](../Page/根号.md "wikilink")**（\(\sqrt{\color{white} x}\)）表示成\(\sqrt[n]{a}\)。例如：1024的主10次方根为2，就可以记作\(\sqrt[10]{1024}=2\)。當\(n=2\)時，則\(n\)可以省略。定义实数\(a\)的主\(n\)次方根为\(a\)的\(n\)次方根，且具有与\(a\)相同的正负号的唯一实数\(b\)。如果\(n\)是[偶数](https://zh.wikipedia.org/wiki/偶数 "wikilink")，那么該數則是[虛數](https://zh.wikipedia.org/wiki/虛數 "wikilink")。习惯上，将2次方根叫做[平方根](../Page/平方根.md "wikilink")，将3次方根叫做[立方根](../Page/立方根.md "wikilink")。

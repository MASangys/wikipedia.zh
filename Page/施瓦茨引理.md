...
lemma）是[複分析中关于定义在单位开圆盘的](../Page/複分析.md "wikilink")[全纯函数的一个结果](../Page/全纯函数.md "wikilink")，以[赫尔曼·阿曼杜斯·施瓦茨命名](https://zh.wikipedia.org/wiki/赫尔曼·阿曼杜斯·施瓦茨 "wikilink")。这引理不及其他结果有名（例如[黎曼映射定理](../Page/黎曼映射定理.md "wikilink")，其证明有用到这引理），但却是能显示全纯函数的刚性的一个简单结果。对于[实函数则没有类似的结果](https://zh.wikipedia.org/wiki/实分析 "wikilink")。
...
关于[上半平面](https://zh.wikipedia.org/wiki/上半平面 "wikilink")\(\mathbb{H}\)有一个相似的命题：

...
**旋转**在[几何和](https://zh.wikipedia.org/wiki/几何 "wikilink")[线性代数中是描述](../Page/线性代数.md "wikilink")[刚体围绕一个固定点的运动的在平面或空间中的](../Page/刚体.md "wikilink")[变换](https://zh.wikipedia.org/wiki/变换 "wikilink")。旋转不同于没有固定点的[平移](../Page/平移.md "wikilink")，和翻转变换的形体的[反射](../Page/反射_\(数学\).md "wikilink")。旋转和上面提及的变换是[等距的](https://zh.wikipedia.org/wiki/等距 "wikilink")，它们保留在任何两点之间的距离在变换之后不变。
...
\[z = x + iy \,\]
是这样一个复数。它的实部是[横坐标而虚部是](https://zh.wikipedia.org/wiki/横坐标 "wikilink")[纵坐标](https://zh.wikipedia.org/wiki/纵坐标 "wikilink")。
...
[fr:Rotation\#En
mathématiques](https://zh.wikipedia.org/wiki/fr:Rotation#En_mathématiques "wikilink")

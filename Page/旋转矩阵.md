...
在三维空间中，旋转可以通过三个[欧拉角](../Page/欧拉角.md "wikilink") \((\alpha,\beta,\gamma)\) 来定义。有一些可能的欧拉角定义，每个都可以依据 roll, pitch 和 yaw 的复合来表达。依据 "z-x-y" 欧拉角，在右手[笛卡尔坐标中的主动旋转矩阵可表达为](https://zh.wikipedia.org/wiki/笛卡尔坐标 "wikilink"):

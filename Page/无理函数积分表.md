...
\== 包括 *r* = √<span style="text-decoration:overline">*a*<sup>2</sup> +
*x*<sup>2</sup></span>的积分==
...
\== 包括 *s* = √<span style="text-decoration:overline">*x*<sup>2</sup> -
*a*<sup>2</sup></span>的积分== 假設 \((x^2>a^2)\), \((x^2<a^2)\)請看下一節:
...
=\frac{1}{2}\ln\left(\frac{x+s}{x-s}\right)\),
里\(\cosh^{-1}\left|\frac{x}{a}\right|\)取正值.
...
0}^{n-m-1}\\frac{1}{2(m+i)+1}{n-m-1 \\choose
i}\\frac{x^{2(m+i)+1}}{s^{2(m+i)+1}}\\qquad\\mbox{(}n\>m\\ge0\\mbox{)}</math>
...
\== 包括 *t* = √<span style="text-decoration:overline">*a*<sup>2</sup> -
*x*<sup>2</sup></span>的积分==
...
\== 包括√<span style="text-decoration:overline">R</span> =
√<span style="text-decoration:overline">*ax*<sup>2</sup> + *bx* +
*c*</span>的积分==
...
<!-- end list -->
  ...
  -
    <math>\\int\\frac{dx}{\\sqrt{(ax^2+bx+c)^{2n+1}}} =
    \\frac{4ax+2b}{(2n-1)(4ac-b^2)R^{(2n-1)/2}}+\\frac{8a(n-1)}{(2n-1)(4ac-b^2)}
...
\== 包括 √<span style="text-decoration:overline">R</span> =
√<span style="text-decoration:overline">*ax* + *b*</span>的积分==
...
\\left(x^{n}\\sqrt{ax + b} - bn\\int\\frac{x^{n-1}}{\\sqrt{ax +
b}}\\right)</math>

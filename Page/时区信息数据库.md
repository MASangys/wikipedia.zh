...
时区信息数据库用来处理时区和进行时区转换，已经应用于很多的计算机系统中，包括：
  ...
  - 一些其他的[Unix操作系统](../Page/Unix.md "wikilink")，包括[Tru64和](https://zh.wikipedia.org/wiki/Tru64 "wikilink")[UNICOS](https://zh.wikipedia.org/wiki/UNICOS "wikilink")/mp（还有[IRIX](../Page/IRIX.md "wikilink")，维护而不发行）；

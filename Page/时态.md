**时**或**时态**（Tempus、），是一种[语法范畴](../Page/语法范畴.md "wikilink")，在[语法裡是表示行为发生的时间和说话时的关系](../Page/语法.md "wikilink")。一般分为[過去时](https://zh.wikipedia.org/wiki/過去时 "wikilink")、[現在时](https://zh.wikipedia.org/wiki/現在时 "wikilink")、[将来时](https://zh.wikipedia.org/wiki/将来时 "wikilink")，通常也有與表示動作進行或終止的進行式和完成式等體貌一起相連用的情況。

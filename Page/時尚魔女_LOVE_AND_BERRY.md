...
接下來就像[音樂遊戲](../Page/音樂遊戲.md "wikilink")一樣能和CPU對戰並且隨著歌曲的節奏，透過按的時機是否準確來評分（如果一直沒準確按中的話，畫面會出現「失敗」的字）。最終的由時尚指數和舞蹈的總合分數高最高的一方獲勝。
...
<!-- end list -->
  ...
  -
    漫画版由溝口涼子和小室栄子所畫。角色設定和遊戲版不同、比較偏向[少女漫画](../Page/少女漫画.md "wikilink")風。

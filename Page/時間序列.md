...
时间序列是[计量经济学](../Page/计量经济学.md "wikilink")所研究的三大数据形态（另两大为横截面数据和面板数据）之一，在[總體经济学](https://zh.wikipedia.org/wiki/總體经济学 "wikilink")、[国际经济学](../Page/国际经济学.md "wikilink")、[金融学](https://zh.wikipedia.org/wiki/金融学 "wikilink")、[金融工程学等学科中有广泛应用](https://zh.wikipedia.org/wiki/金融工程学 "wikilink")。
...
**ARCH模型**（，自回歸條件異變異數模型）能准确地模拟时间序列变量的波动性的变化，它在[金融工程学的](https://zh.wikipedia.org/wiki/金融工程学 "wikilink")[实证研究中也应用广泛](../Page/觀察研究.md "wikilink")，使人们能更加准确地把握[风险](../Page/风险.md "wikilink")（波动性），尤其是应用在[风险价值](https://zh.wikipedia.org/wiki/风险价值 "wikilink")（Value at Risk）理论中，在[华尔街](../Page/华尔街.md "wikilink")是尽人皆知的工具。

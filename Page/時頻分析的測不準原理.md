...
另外對一個訊號的[相位](https://zh.wikipedia.org/wiki/相位 "wikilink") \(\phi(t)\)
作[微分](../Page/微分.md "wikilink")，我們可以得到該訊號的瞬時頻率
\(\omega\)。現在我們定義一個訊號的[共變異數](https://zh.wikipedia.org/wiki/共變異數 "wikilink")
...
我們得到了測不準原理的形式，接下來的問題是:甚麼樣的訊號能得到乘積的最小值1/2?我們在推導過程中可以發現，在柯西-施瓦茨不等式當中的兩個[函數成正比時等號會成立](https://zh.wikipedia.org/wiki/函數 "wikilink")，我們取
...
上式就是[高斯函數](https://zh.wikipedia.org/wiki/高斯函數 "wikilink")，高斯函數的時間寬度與頻寬的乘積能達到最小，高斯函數也作為[加伯轉換的](../Page/加伯轉換.md "wikilink")[窗函數](https://zh.wikipedia.org/wiki/窗函數 "wikilink")，在[時頻分析中具有重要的地位](../Page/時頻分析.md "wikilink")。

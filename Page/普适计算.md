...
**普适计算**（（）、），又称**普存计算**、**普及计算**、**遍佈式計算**、**泛在计算**，是一個强调和环境融为一体的计算概念，而[计算机本身则从人们的视线裡消失](https://zh.wikipedia.org/wiki/计算机 "wikilink")。在普适计算的模式下，人们能够在任何时间、任何地点、以任何方式进行信息的获取与处理。

普适计算是一个涉及研究范围很广的课题，包括[分布式计算](../Page/分布式计算.md "wikilink")、[移动计算](https://zh.wikipedia.org/wiki/移动计算 "wikilink")、[人机交互](../Page/人机交互.md "wikilink")、[人工智能](../Page/人工智能.md "wikilink")、[嵌入式系统](../Page/嵌入式系统.md "wikilink")、[感知网络以及](https://zh.wikipedia.org/wiki/感知网络 "wikilink")[信息融合等多方面技术的融合](https://zh.wikipedia.org/wiki/信息融合 "wikilink")。普适计算在教育中的应用项目：（1）清华大学smart
...
### 历史
  ...
  - 1988年，[Mark
    Weiser提出了普适计算的思想](https://zh.wikipedia.org/wiki/马克·维瑟 "wikilink")，并预测计算模式会发展为普适计算。（另一说为1991年）
  ...
  - 2002年，[IEEE](https://zh.wikipedia.org/wiki/IEEE "wikilink")
    Pervasive Computing期刊创刊。
...
[淡江大學資訊工程系施國琛教授](https://zh.wikipedia.org/wiki/淡江大學 "wikilink")（現中央大學資工系教授）所領導的Mine
Lab。 所進行的Hard SCORM項目，允許通過手機、PDA，數字電視以及添加紙訪問基於2004版SCORM標準的課程資源。

### MIT的OXYGEN项目

[麻省理工學院OXYGEN项目](https://zh.wikipedia.org/wiki/麻省理工學院 "wikilink")
麻省理工學院的OXYGEN项目在电子白板的功能方面有了新的突破。

## 外部參考文獻鏈接

An introduction to the field appropriate for general audiences is [Adam
Greenfield](https://zh.wikipedia.org/wiki/Adam_Greenfield "wikilink")'s
book *Everyware: The Dawning Age of Ubiquitous Computing* (ISBN
0-321-38401-6). Greenfield describes the interaction paradigm of
ubiquitous computing as "information processing dissolving in behavior".
...
Conferences in the field include:
  ...
  - [IEEE GlobeCom Workshop on Service Discovery and Composition in
    ...
    Environments](https://web.archive.org/web/20090531002455/http://www.comsoc.org/confs/globecom/2007/cfwpapers.html)
    (SUPE)
...
computing:
  ...
  - [Pervasive Computing
    (IEEE)](https://web.archive.org/web/20050812003939/http://www.computer.org/portal/site/pervasive//)
...
[Mark Weiser](https://zh.wikipedia.org/wiki/Mark_Weiser "wikilink")'s
original material dating from his tenure at Xerox PARC:
...
Other links:
  ...
  - [Yesterday’s tomorrows: notes on ubiquitous computing’s dominant
    ...
    by [Genevieve
    Bell](https://zh.wikipedia.org/wiki/Genevieve_Bell "wikilink") &
    Paul Dourish.

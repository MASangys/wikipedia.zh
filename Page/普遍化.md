**普遍化**是[谓词演算的一个](../Page/谓词演算.md "wikilink")[推理规则](../Page/推理规则.md "wikilink")，它声称：
...
\[\vdash P(7)\], "7 是素数"，可以通过[肯定前件推出](../Page/肯定前件.md "wikilink")

\[\vdash \forall x P(x)\],
"所有自然数都是素数"，这是个[矛盾](../Page/矛盾.md "wikilink")，所以[反证法得出这个公式是错的](../Page/反证法.md "wikilink")。
...
十字转门符号 \(\vdash\)
不是合式公式的一部分：严格的说它既不属于[命题演算也不属于](../Page/命题演算.md "wikilink")[谓词演算](../Page/谓词演算.md "wikilink")，而可以被认为是一个"元符号"。所以，最终

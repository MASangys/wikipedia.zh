...
可以證明[前馈控制](../Page/前馈控制.md "wikilink")網路配合非線性、連續且可微的激活函數可以有的能力。[循环神经网络也已用在系統識別中](https://zh.wikipedia.org/wiki/循环神经网络 "wikilink")。假設一組輸入-輸出資料對，系統識別可以在資料對中形成映射，這些網路的目的是要找到系統的動態特性。

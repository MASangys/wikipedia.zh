...
曲线没有内蕴的曲率，只有外在的曲率（即只有把曲线嵌入到具体的空间中才能定义曲率）。相比之下，曲面可以有不依赖于嵌入的内蕴曲率。高斯曲率，以[高斯命名](https://zh.wikipedia.org/wiki/高斯 "wikilink")，等于主曲率的乘积\(k_1k_2\)*。*它的量纲为长度<sup>-2</sup>，对于[球面](../Page/球面.md "wikilink")、[椭球](../Page/椭球.md "wikilink")、双叶双曲面的一叶、[椭圆抛物面为正](../Page/抛物面.md "wikilink")，对于[伪球面](../Page/偽球面.md "wikilink")、

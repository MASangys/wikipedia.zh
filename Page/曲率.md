...
曲线的曲率通常是标量，但也可以定义[曲率向量](https://zh.wikipedia.org/wiki/曲率向量 "wikilink")。对于更复杂的对象（例如曲面，或者一般的n维空间），曲率要用更复杂的[线性代数来描述](../Page/线性代数.md "wikilink")，例如一般的[黎曼曲率张量](../Page/黎曼曲率張量.md "wikilink")。
...
当曲线位于三维空间中的二维曲面上时，可以定义[法曲率](https://zh.wikipedia.org/wiki/法曲率 "wikilink")、[测地曲率和](../Page/测地曲率.md "wikilink")[测地挠率](https://zh.wikipedia.org/wiki/测地挠率 "wikilink")。设曲面上的曲线在某一点处的切向量为\(\boldsymbol{\tau}\)，曲面在这一点处的法向量为\(\boldsymbol{n}\)。则曲线的法曲率就是曲线在\(\boldsymbol{\tau}\)和\(\boldsymbol{n}\)张成的平面上的投影曲线的曲率；测地曲率就是曲线在曲面的切平面上的投影的曲率。

## 三维空间中的曲面曲率

对于嵌入在[欧几里得空间](../Page/欧几里得空间.md "wikilink")**R**<sup>3</sup>中的二维曲面，有两种曲率存在：**[高斯曲率](../Page/高斯曲率.md "wikilink")**和**[平均曲率](../Page/平均曲率.md "wikilink")**。为计算在曲面给定点的曲率，考虑曲面和由在该点的[法向量和某一](https://zh.wikipedia.org/wiki/法向量 "wikilink")[切向量所确定的平面的交集](https://zh.wikipedia.org/wiki/切向量 "wikilink")。这个交集是一个平面曲线，所以有一个曲率；如果选择其它切向量，这个曲率会改变，并且有两个极值-最大和最小曲率，称为**[主曲率](../Page/主曲率.md "wikilink")**
*k*<sub>1</sub>
和*k*<sub>2</sub>，极值方向称为**主方向**。这里我们采用在曲线向和曲面选定法向的相同方向绕转的时候把曲率置为[正数](https://zh.wikipedia.org/wiki/正数 "wikilink")，否则为负的约定。

### 高斯曲率

曲线没有内蕴的曲率，只有外在的曲率（即只有把曲线嵌入到具体的空间中才能定义曲率）。相比之下，曲面可以有不依赖于嵌入的内蕴曲率。高斯曲率，以[高斯命名](https://zh.wikipedia.org/wiki/高斯 "wikilink")，等于主曲率的乘积\(k_1k_2\)*。*它的量纲为长度<sup>-2</sup>，对于[球面](../Page/球面.md "wikilink")、[椭球](../Page/椭球.md "wikilink")、双叶双曲面的一叶、[椭圆抛物面为正](../Page/抛物面.md "wikilink")，对于[伪球面](https://zh.wikipedia.org/wiki/偽球面 "wikilink")、
单叶[双曲面](https://zh.wikipedia.org/wiki/双曲面 "wikilink")、[双曲抛物面为负](../Page/抛物面.md "wikilink")，对[平面](../Page/平面.md "wikilink")、[圆柱面为](https://zh.wikipedia.org/wiki/圆柱面 "wikilink")0。它决定了曲面是局部[凸](https://zh.wikipedia.org/wiki/凸 "wikilink")（正的时候）还是局部鞍形（负的时候）。

上面给出的高斯曲率的定义是外在的，因为它用了曲面在
**R**<sup>3</sup>中的嵌入，法向量，外部平面等等。但是高斯曲率实际上是曲面的内在属性，也就是它不依赖于曲面的特定[嵌入](https://zh.wikipedia.org/wiki/嵌入 "wikilink")；直观的讲，这意味着活在曲面上的蚂蚁可以确定高斯曲率。例如，生活在球面上的蚂蚁能够测量三角形的内角和，发现它大于180度，表明这个曲面是正曲率的。而生活在圆柱面上的蚂蚁则不会发现对[欧氏几何的任何背离](../Page/欧几里得几何.md "wikilink")。
...
**[平均曲率](../Page/平均曲率.md "wikilink")**等于主曲率的算术平均数(*k*<sub>1</sub>+*k*<sub>2</sub>)/2。量纲为长度<sup>-1</sup>。平均曲率和曲面面积的第一变分密切相关。特别的，像肥皂膜这样的[极小曲面平均曲率为](../Page/极小曲面.md "wikilink")0，而[肥皂泡平均曲率为常数](../Page/肥皂泡.md "wikilink")。不像高斯曲率，平均曲率依赖于嵌入，例如，[圆柱和平面是局部](https://zh.wikipedia.org/wiki/圆柱 "wikilink")[等距的](https://zh.wikipedia.org/wiki/等距 "wikilink")，但是平面的平均曲率为0，而圆柱的非零。

[微分几何中](../Page/微分几何.md "wikilink")，**曲率形式**（）描述了[主丛上的](../Page/主丛.md "wikilink")[联络的](../Page/联络形式.md "wikilink")[曲率](../Page/曲率.md "wikilink")。它可以看作是[黎曼几何中的](../Page/黎曼几何.md "wikilink")[曲率张量的替代或是推广](https://zh.wikipedia.org/wiki/曲率张量 "wikilink")。

## 定义

令 *G* 为一个[李群](../Page/李群.md "wikilink")，记 *G*
的[李代数为](https://zh.wikipedia.org/wiki/李代数 "wikilink") \(g\)。设
\(E\to B\) 为一个[主 *G*-丛](../Page/主丛.md "wikilink")。令 \(\omega\) 表示 *E*
...
这里 \(d\)
表示标准[外导数](https://zh.wikipedia.org/wiki/外导数 "wikilink")，\([*,*]\)
是[李括号](https://zh.wikipedia.org/wiki/李括号 "wikilink")，而 *D*
...
若 \(E\to B\)
是一个[纤维丛](../Page/纤维丛.md "wikilink")，其[结构群为](https://zh.wikipedia.org/wiki/结构群 "wikilink")
*G*，我们可以在[相伴的主](https://zh.wikipedia.org/wiki/相伴丛 "wikilink")
*G*-丛上重复同样的定义。
...
其中 \(\wedge\) 是[楔积](https://zh.wikipedia.org/wiki/楔积 "wikilink")。更准确地讲，若
\(\omega^i_j\) 和 \(\Omega^i_j\) 分别代表 \(\omega\) 和 \(\Omega\) 的分量（所以每个
\(\omega^i_j\) 是一个通常的 1-形式而每个 \(\Omega^i_j\) 是一个普通的2-形式），则
...
是[曲率张量的一种替换表述](https://zh.wikipedia.org/wiki/曲率张量 "wikilink")，也就是在曲率张量的标准表示中，我们有
...
如果 \(\theta\) 是标架丛上的典范向量值 1-形式，联络形式 ω
的[挠率](https://zh.wikipedia.org/wiki/挠率形式 "wikilink") \(\Theta\)
是由结构方程定义的向量值 2-形式：
...
## 参看
  ...
  - [陈-西蒙斯形式](https://zh.wikipedia.org/wiki/陈-西蒙斯形式 "wikilink")（Chern-Simons
    form）

...
从古代开始，许多[具体曲线已经用综合方法深入研究](https://zh.wikipedia.org/wiki/曲线列表 "wikilink")。[微分几何](../Page/微分几何.md "wikilink")采取另外一种方式：把曲线表示为[参数形式](https://zh.wikipedia.org/wiki/参数方程 "wikilink")，将它们的几何性质和各种量，比如[曲率](../Page/曲率.md "wikilink")和[弧长](../Page/弧长.md "wikilink")，用[向量分析](../Page/向量分析.md "wikilink")表示为[导数](../Page/导数.md "wikilink")和[积分](../Page/积分.md "wikilink")。分析曲线最重要的工具之一为
**Frenet
...
\(\gamma\) 的参数，\(\gamma(I)\) 称为曲线的**像**。将参数曲线 \(\gamma\) 和它的像
\(\gamma(I)\) 区别开来是非常重要的，因为一个给定的\({\mathbb R}^n\)的子集可以是许多不同的参数曲线的像。
...
标架和广义曲率](https://zh.wikipedia.org/wiki/#Frenet_标架 "wikilink")）在重新参数化下不变从而满足[等价类](../Page/等价类.md "wikilink")性质。这个等价类称为
...
γ(*t*) 局部性质的*n* 个[正交](../Page/正交.md "wikilink")向量 *e*<sub>*i*</sub>(*t*)
...
γ(*t*) 的各阶导数使用[格拉姆-施密特正交化](../Page/格拉姆-施密特正交化.md "wikilink")算法得到的：
...
的瞬時速度用一個[向量](../Page/向量.md "wikilink")表示，稱為曲線在
*P* 的**切向量**。

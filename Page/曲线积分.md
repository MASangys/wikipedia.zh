在[数学](../Page/数学.md "wikilink")中，**曲线积分**或**路徑積分**是[积分](../Page/积分.md "wikilink")的一种。[积分函数的取值沿的不是](https://zh.wikipedia.org/wiki/积分函数 "wikilink")[区间](https://zh.wikipedia.org/wiki/区间 "wikilink")，而是特定的[曲线](../Page/曲线.md "wikilink")，称为**积分路径** 。曲线积分有很多种类，当积分路径为闭合曲线时，称为**环路积分**或**围道积分**。

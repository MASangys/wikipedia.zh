[数学上](../Page/数学.md "wikilink")，**曲面积分**（面积分）是在[曲面上的](../Page/曲面.md "wikilink")[定积分](https://zh.wikipedia.org/wiki/定积分 "wikilink")（曲面可以是[空间中的弯曲](https://zh.wikipedia.org/wiki/空间 "wikilink")[子集](../Page/子集.md "wikilink")）；它可以视为和[线积分相似的](https://zh.wikipedia.org/wiki/线积分 "wikilink")[双重积分](https://zh.wikipedia.org/wiki/双重积分 "wikilink")。给定一个曲面，可以在上面对[标量场](https://zh.wikipedia.org/wiki/标量场 "wikilink")（也就是實数值的[函数](../Page/函数.md "wikilink")）进行积分，也可以对[向量场](https://zh.wikipedia.org/wiki/向量场 "wikilink")（也就是[向量值的函数](../Page/向量.md "wikilink")）积分。

面积分在[物理中有大量应用](https://zh.wikipedia.org/wiki/物理 "wikilink")，特别是在[电磁学的](../Page/电磁学.md "wikilink")[經典物理學中](../Page/經典物理學.md "wikilink")。
...
要找到面积分的直接公式，首先需要[参数化曲面](https://zh.wikipedia.org/wiki/坐标系 "wikilink")*S*，也即在*S*上建立坐标系，就像[球面上的](../Page/球面.md "wikilink")[经纬度](../Page/经纬度.md "wikilink")。令参数化为**x**(*s*,
*t*)，其中(*s*,
*t*)在某个[平面上的区域](https://zh.wikipedia.org/wiki/笛卡尔坐标系#二维坐标系 "wikilink")*T*中变化。则
\(f\) 在曲面 \(S\) 的面积分为
...
為參數的曲面其面积的標準公式。很容易认出第二行中的向量是曲面的[法向量](https://zh.wikipedia.org/wiki/法向量 "wikilink")。
...
面积分中很多有用的结果可以用[微分几何和](../Page/微分几何.md "wikilink")[向量微积分导出](https://zh.wikipedia.org/wiki/向量微积分 "wikilink")，例如[散度定理及其推广](https://zh.wikipedia.org/wiki/散度定理 "wikilink")[斯托克斯定理](../Page/斯托克斯定理.md "wikilink")。

...
不同的参数 \(c\)
可能使[序列的](../Page/序列.md "wikilink")[绝对值逐漸發散到无限大](../Page/绝对值.md "wikilink")，也可能[收斂在有限的區域内](https://zh.wikipedia.org/wiki/收斂 "wikilink")。
...
fractal](https://zh.wikipedia.org/wiki/Ultra_fractal "wikilink")，内部已经有了比较成熟的例子。下面的程序是一段[伪代码](../Page/伪代码.md "wikilink")，表达了曼德博集合的计算思路。

...
**曼德博集合**（Mandelbrot
set，或译為**曼德布洛特复数集合**）是一种在[复平面上组成](../Page/复平面.md "wikilink")[分形的点的集合](../Page/分形.md "wikilink")，以數學家[本華·曼德博的名字命名](../Page/本華·曼德博.md "wikilink")。曼德博集合與[朱利亚集合有些相似的地方](../Page/朱利亚集合.md "wikilink")，例如使用相同的复二次多项式來进行[迭代](../Page/迭代.md "wikilink")。
...
每次迭代的值依序如以下[序列所示](../Page/序列.md "wikilink")：

\((0, f_c(0), f_c(f_c(0)), f_c(f_c(f_c(0))), \ldots)\)

不同的参数 \(c\)
可能使[序列的](../Page/序列.md "wikilink")[绝对值逐漸發散到无限大](../Page/绝对值.md "wikilink")，也可能[收斂在有限的區域内](../Page/收斂.md "wikilink")。

曼德博集合 \(M\) 就是使[序列不延伸至无限大的所有复数](../Page/序列.md "wikilink") \(c\)
的[集合](../Page/集合_\(数学\).md "wikilink")。
...
由數學歸納法可得知
\(2<|{z_1}|<|{z_2}|<...<|{z_n}|<|z_{n+1}|<|z_{n+2}| \,\)，可看出隨著迭代次數增加
\(|z_n| \,\) 逐漸遞增並發散。

假如\(|z_n| \,\)不发散，则收敛于某个常数\(a>|c|>2\),

由\(|z_{n+1}|\ge |z_{n}|^2-|c|\) 再取极限得 \(a\ge a^2-|c|\) 即
\(a^2-a\leq |c|\)。
...
由數學歸納法可得知 \(2<|{z_n}|<|z_{n+1}|<|z_{n+2}|<... \,\)，可看出隨著迭代次數增加
\(|z_n| \,\) 逐漸遞增並發散。
...
曼德博集合一般用[计算机程序计算](../Page/计算机程序.md "wikilink")。对于大多数的分形软件，例如[Ultra
fractal](../Page/Ultra_fractal.md "wikilink")，内部已经有了比较成熟的例子。下面的程序是一段[伪代码](../Page/伪代码.md "wikilink")，表达了曼德博集合的计算思路。
...
1.  直接利用循环终止时的Repeats
2.  综合利用z和Repeats
3.  [Orbit Traps](../Page/Orbit_Traps.md "wikilink")

### [Mathematica代码](../Page/Mathematica.md "wikilink")
...
[Fractal-zoom-1-15-rupture.ogg](https://zh.wikipedia.org/wiki/File:Fractal-zoom-1-15-rupture.ogg "fig:Fractal-zoom-1-15-rupture.ogg")
[Mandelbrot_sequence_new.gif](https://zh.wikipedia.org/wiki/File:Mandelbrot_sequence_new.gif "fig:Mandelbrot_sequence_new.gif")
...
1.  [Mrob.com pixel
    counting](http://www.mrob.com/pub/muency/pixelcounting.html)

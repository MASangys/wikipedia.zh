在[统计学](../Page/统计学.md "wikilink")中，**最大似然估计**（，缩写为MLE），也称**最大概似估计**，是用来[估计一个](https://zh.wikipedia.org/wiki/估计函数 "wikilink")[概率模型](../Page/概率模型.md "wikilink")的参数的一种方法。
...
其中\(0\leq p \leq 1\). 我们可以使用[微分法来求](https://zh.wikipedia.org/wiki/微分法 "wikilink")[最值](https://zh.wikipedia.org/wiki/最值 "wikilink")。方程两边同时对\(p\)取[微分](../Page/微分.md "wikilink")，并使其为零。

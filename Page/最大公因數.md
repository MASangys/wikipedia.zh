...
求兩個整數最大公因數主要的方法：
  ...
  - [輾轉相除法](https://zh.wikipedia.org/wiki/輾轉相除法 "wikilink")：兩數相除，取餘數重複進行相除，直到餘數為\(0\)時，前一個除數即為最大公因數。
...
在[直角坐標中](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")，兩頂點為\((0, 0), (a, b)\)的線段會通過\(\gcd(a, b)+1\)個[格子點](https://zh.wikipedia.org/wiki/格子點 "wikilink")。
...
可以通过[質因數分解来计算最大公因数](https://zh.wikipedia.org/wiki/質因數分解 "wikilink")。例如计算\(\gcd(18, 84)\)，可以先进行质因数分解
\(18 = 2 \times 3^2\) 和
...
以下使用[輾轉相除法實現](https://zh.wikipedia.org/wiki/輾轉相除法 "wikilink")。

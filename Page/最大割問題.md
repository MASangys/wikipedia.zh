[右](https://zh.wikipedia.org/wiki/File:Max-cut.svg "fig:右") 最大割問題（）是 [NP完备](https://zh.wikipedia.org/wiki/NP完备 "wikilink") 问题。給定一張[圖](https://zh.wikipedia.org/wiki/cmn:图_\(数学\) "wikilink")，求一種分割方法，將所有[頂點](https://zh.wikipedia.org/wiki/頂點 "wikilink")（）分割成两群，同时使得被切斷的邊（）數量最大。

在[计算机科学](../Page/计算机科学.md "wikilink")中，最大子数列问题的目标是在数列的一维方向找到一个连续的子数列，使该子数列的和最大。例如，对一个数列
−2, 1, −3, 4, −1, 2, 1, −5, 4，其连续子数列中和最大的是 4, −1, 2, 1, 其和为6。

该问题最初由[布朗大学](../Page/布朗大学.md "wikilink")的[Ulf
Grenander教授于](https://zh.wikipedia.org/wiki/Ulf_Grenander "wikilink")1977年提出，当初他为了展示数字图像中一个简单的[最大似然估计](../Page/最大似然估计.md "wikilink")模型。不久之后[卡内基梅隆大学的](https://zh.wikipedia.org/wiki/卡内基梅隆大学 "wikilink")[Jay

...
在[重力作用且忽略](https://zh.wikipedia.org/wiki/万有引力 "wikilink")[摩擦力的情況下](../Page/摩擦力.md "wikilink")，一個[質點在一點](../Page/質點.md "wikilink")*A*以[速率為零開始](../Page/速率.md "wikilink")，沿某條[曲線](https://zh.wikipedia.org/wiki/曲線 "wikilink")，去到一點不高於*A*的*B*，怎樣的曲線能令所需的時間最短呢？這就是**最速降線問題**，又稱**最短時間問題**、**最速落徑問題**。在部分歐洲語言中，這個問題稱為**Brachistochrone**，即[希臘語中的](https://zh.wikipedia.org/wiki/希臘語 "wikilink")「最短」（brochistos）和「[時間](https://zh.wikipedia.org/wiki/時間 "wikilink")」（chronos）。這條線段就是[擺線](https://zh.wikipedia.org/wiki/擺線 "wikilink")，可以用[變分學证明](https://zh.wikipedia.org/wiki/變分學 "wikilink")。
...
通过假设光在[光速v在满足](../Page/光速.md "wikilink")\[v=\sqrt{2gy}\]的[介质中运动形成的轨迹来导出最速降线](https://zh.wikipedia.org/wiki/介质 "wikilink")。

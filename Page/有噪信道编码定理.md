...
根据香农1948年的陈述，本定理描述了在不同级别的噪音干扰和数据损坏情况下，[错误监测和纠正可能达到的最高效率](https://zh.wikipedia.org/wiki/错误监测和纠正 "wikilink")。定理没有指出*如何*构造错误监测的模型，只是告诉大家*有可能*达到的最佳效果。香农定理可以广泛应用在通信和[数据存储领域](https://zh.wikipedia.org/wiki/数据存储 "wikilink")。本定理是现代[信息论的基础理论](../Page/信息论.md "wikilink")。香农只是提出了证明的大概提纲。1954年，[艾米尔·范斯坦第一个提出了严密的论证](https://zh.wikipedia.org/wiki/艾米尔·范斯坦 "wikilink")。
...
简单的流程如"重复发送数据3遍，用一个投票系统在数据不一样的时候选择3个里面相同的那两个的值"是低效的错误纠正的方式，不能保证数据块能完全没有错误地传送。先进一些的技术如[里德-所罗门码编码技术和更现代一些的](../Page/里德-所罗门码.md "wikilink")[Turbo码](https://zh.wikipedia.org/wiki/Turbo码 "wikilink")、[LDPC码等编码技术更逼近香农限制](https://zh.wikipedia.org/wiki/LDPC码 "wikilink")，但是计算复杂度很高。
...
下面这个可实现性的证明是使用[渐近等同分割特性](https://zh.wikipedia.org/wiki/渐近等同分割特性 "wikilink")（[Asymptotic
equipartition
property](https://zh.wikipedia.org/wiki/:en:Asymptotic_equipartition_property "wikilink")
- AEP）方法。另一种信息论常用证明方法是错误列举法（[Error
Exponent](https://zh.wikipedia.org/wiki/:en:Error_Exponent "wikilink")）。
...
### 来源
  ...
  - [克劳德·艾尔伍德·香农](https://zh.wikipedia.org/wiki/克劳德·艾尔伍德·香农 "wikilink")：《[通信的数学理论](http://cm.bell-labs.com/cm/ms/what/shannonday/paper.html)》Urbana,

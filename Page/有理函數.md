**有理函數**是可以表示為以下形式的[函數](../Page/函數.md "wikilink")：
...
## 漸近線
  ...
  - 不失一般性可假設分子、分母[互質](../Page/互質.md "wikilink")。若存在\(r>0\)，使得\((px+q)^r\)是分母\(Q(x)\)的因子，則有理函數存在垂直[漸近線](../Page/漸近線.md "wikilink")\(x=-q/p\)。
  - 若\(m<n\)，有水平漸近線\(y=0\)。
...
有理函數的[泰勒級數的係數滿足一個](../Page/泰勒級數.md "wikilink")[線性遞歸關係](../Page/線性遞歸關係.md "wikilink")。反之，若一個泰勒級數的係數滿足一個線性遞歸關係，它對應的函數是有理函數。

## 部分分式

**[部分分式](../Page/部分分式.md "wikilink")**，又稱**部分分數**、**分項分式**，是將有理數式分拆成數個有理數式的技巧。
...
## 應用
  ...
  - [Padé迫近法](../Page/Padé迫近法.md "wikilink")
  - [插值](../Page/插值.md "wikilink")

## 參考

  - [:en:Partial
    fraction](../Page/:en:Partial_fraction.md "wikilink")，[:de:Rationale
    Funktion](../Page/:de:Rationale_Funktion.md "wikilink")
  - [Ostrogradsky's

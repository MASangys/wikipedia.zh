...
FIR）滤波器是數位滤波器的一种，简称**FIR數位滤波器**。这类滤波器对于[脉冲输入信号的响应最终趋向于](../Page/脉冲.md "wikilink")0，因此是有限的，而得名。它是相对于[无限冲激响应](../Page/无限冲激响应.md "wikilink")（IIR）滤波器而言。由于无限冲激响应滤波器中存在反馈回路，因此对于脉冲输入信号的响应是无限延续的。
...
如果输入信号为[脉冲信号](../Page/脉冲.md "wikilink")\(\delta(n)\)，
...
有限冲激响应滤波器的[传递函数可由其冲激响应的](../Page/传递函数.md "wikilink")[z变换获得](../Page/z变换.md "wikilink")：

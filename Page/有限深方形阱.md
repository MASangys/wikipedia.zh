...
在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，**有限深方形阱**，又稱為**有限深位勢阱**，是[無限深方形阱的延伸](../Page/無限深方形阱.md "wikilink")。有限深方形阱是一個阱內位勢為0，阱外[位勢為有限值的位勢阱](https://zh.wikipedia.org/wiki/位勢 "wikilink")。關於一個或多個[粒子](https://zh.wikipedia.org/wiki/粒子 "wikilink")，在這種位勢作用中的量子行為的問題，稱為**有限深位勢阱問題**。與無限深方形阱問題不同的是，在阱外找到粒子的[機率大於](https://zh.wikipedia.org/wiki/機率 "wikilink")0。

在[經典力學裏](https://zh.wikipedia.org/wiki/經典力學 "wikilink")，假若，粒子的[能量小於阱壁的位勢](../Page/能量.md "wikilink")，則粒子只能移動於阱內，無法存在於阱外。截然不同地，在量子力學裏，雖然粒子的能量小於阱壁的位勢，在阱外找到粒子的機率大於0。
...
假若，粒子的能量小於位勢：\(E < V_0 \,\!\)，則這粒子束縛於位勢阱內．稱這粒子的[量子態為](../Page/量子態.md "wikilink")[束縛態](https://zh.wikipedia.org/wiki/束縛態 "wikilink")（）。設定
...
[薛丁格方程的解答必須具有](https://zh.wikipedia.org/wiki/薛丁格方程 "wikilink")[連續性與](https://zh.wikipedia.org/wiki/連續函數 "wikilink")[連續可微性](https://zh.wikipedia.org/wiki/光滑函數 "wikilink")。這些要求是前面導引出的[微分方程的邊界條件](../Page/微分方程.md "wikilink")。

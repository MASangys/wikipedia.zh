...
优化一个FSM意味着找到带有极小数目个状态的进行同样功能的机器。一种可能是使用[真值表](../Page/真值表.md "wikilink")或[Moore简约过程](https://zh.wikipedia.org/wiki/Moore简约过程 "wikilink")。另一种可能是[无环FSA的自底向上算法](http://www.cs.jhu.edu/~hajic/courses/cs226/alg.html)。

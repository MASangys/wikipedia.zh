...
## 实现
  ...
  - [PocoCapsule SCA组装容器（C++）](https://web.archive.org/web/20071119030902/http://www.pocomatic.com/docs/whitepapers/webservices/#sca-as-a-dsm) 该GPL开源实现基于[控制反转](../Page/控制反转.md "wikilink")（IoC）及[领域特定建模](https://zh.wikipedia.org/wiki/领域特定建模 "wikilink")（DSM），并附带丰富的[应用实例](http://www.pocomatic.com/docs/cpp-examples/#webservices)（包括SCA著名的BigBank）
...
## 外部链接
  ...
  - [PocoCapsule SCA组装容器（C++）](https://web.archive.org/web/20071119030902/http://www.pocomatic.com/docs/whitepapers/webservices/#sca-as-a-dsm) 该GPL开源实现基于[控制反转](../Page/控制反转.md "wikilink")（IoC）及[领域特定建模](https://zh.wikipedia.org/wiki/领域特定建模 "wikilink")（DSM），并附丰富的[应用实例](http://www.pocomatic.com/docs/cpp-examples/#webservices)（包括SCA著名的BigBank）

...
设(*X*, Σ, *μ*)为[测度空间](../Page/测度.md "wikilink")，并设*f* : *X* → **R**为定义在*X*上的实函数，它并不一定是[可测的](../Page/可测函数.md "wikilink")。实数*a*称为*f*的*[上确界](https://zh.wikipedia.org/wiki/上确界 "wikilink")*，如果对于*X*内的所有*x*，都有*f*(*x*) ≤ *a*，也就是说，集合

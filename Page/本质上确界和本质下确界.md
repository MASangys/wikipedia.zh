**本质上确界**和**本质下确界**的概念与[上确界和](../Page/上确界.md "wikilink")[下确界有关](../Page/下确界.md "wikilink")，但前者与[测度论的关联性更大](../Page/测度论.md "wikilink")，其中通常要涉及不是处处都成立的命题（也就是对[集合中](../Page/集合.md "wikilink")*所有*元素都成立的命题），而是*[几乎处处](../Page/几乎处处.md "wikilink")*，也就是说，除了在[测度为零的集合以外](../Page/零测集.md "wikilink")。

设(*X*, Σ, *μ*)为[测度空间](../Page/测度.md "wikilink")，并设*f* : *X* → **R**为定义在*X*上的实函数，它并不一定是[可测的](../Page/可测函数.md "wikilink")。实数*a*称为*f*的*[上确界](../Page/上确界.md "wikilink")*，如果对于*X*内的所有*x*，都有*f*(*x*) ≤ *a*，也就是说，集合
...
在实数轴上，考虑[勒贝格测度和它对应的σ代数Σ](../Page/勒贝格测度.md "wikilink")。用以下公式定义*f*：
...
\[f(x)= \begin{cases} x^3, & \mbox{if }  x\in \mathbb Q  \\
 ...
 \end{cases}\]
其中**Q**表示[有理数](../Page/有理数.md "wikilink")。这个函数既没有上界也没有下界，所以上确界和下确界分别是∞和−∞。但是，从勒贝格测度的角度来看，有理数集合的测度为零；因此，真正有关的是在这个集合的补集发生的事情，其中函数由arctan
*x*给出。于是，函数的本质上确界是π/2，本质下确界是−*π*/2。

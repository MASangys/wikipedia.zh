...
并仍然是[文本分类的一种热门](https://zh.wikipedia.org/wiki/文档分类 "wikilink")（基准）方法，文本分类是以[词频为特征判断文件所属类别或其他](https://zh.wikipedia.org/wiki/词袋 "wikilink")（如[垃圾邮件](../Page/反垃圾邮件技术.md "wikilink")、合法性、体育或政治等等）的问题。通过适当的预处理，它可以与这个领域更先进的方法（包括[支持向量机](../Page/支持向量机.md "wikilink")）相竞争。\[2\]
...
(这种对数似然比的技术在统计中是一种常用的技术。在这种两个独立的分类情况下（如这个垃圾邮件的例子），把对数似然比转化为[S曲线的形式](https://zh.wikipedia.org/wiki/S函数 "wikilink"))。
...
## 参见
  ...
  - [提升方法](https://zh.wikipedia.org/wiki/提升方法 "wikilink")

**机会性加密**或**伺机加密**（，简称**OE**\[1\]；有时也称**非认证加密**、**随机加密**\[2\]）是一种[网络](../Page/计算机网络.md "wikilink")[通信](../Page/通信.md "wikilink")[加密机制](https://zh.wikipedia.org/wiki/加密 "wikilink")，即当建立通信连接时，首先尝试请求加密，如果对方也支持加密连接，连接则开始加密，期间不进行身份验证；如果加密请求尝试失败，则回退到[明文通信机制](https://zh.wikipedia.org/wiki/明文 "wikilink")。这种加密不须双方进行事先配置，能够抵抗被动的流量窃听\[3\]，但无法防御[中间人攻击等主动攻击](../Page/中间人攻击.md "wikilink")。因此，它不能替代完整的加密方案。使用机会性加密时，用户也不会看到任何连接安全的提示。

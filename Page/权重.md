...
设有独立观测值
\(L_{1},L_{2},\ldots,L_{n}\)，它们的[標準差及权分别为](../Page/標準差.md "wikilink")\(m_{1},m_{2},\ldots,m_{n}\)和\(p_{1},p_{2},\ldots,p_{n}\)。令观测值[函数为](../Page/函数.md "wikilink")：

\(z=f(L_{1},L_{2}\ldots L_{n})\)

由[误差传播及定权公式](../Page/误差传播.md "wikilink")，得

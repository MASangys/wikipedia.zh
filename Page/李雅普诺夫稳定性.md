...
對於有輸入的系統，需量化輸入對系統穩定性的影響。在[線性系統](../Page/線性系統.md "wikilink")中會用[BIBO穩定性來作分析的工具](https://zh.wikipedia.org/wiki/BIBO穩定性 "wikilink")，在[非線性系統](../Page/非線性系統.md "wikilink")中則會使用[輸入-狀態穩定性](https://zh.wikipedia.org/wiki/輸入-狀態穩定性 "wikilink")。

...
JSP中的許多內容和有關\[5\]\[6\]，不過後者專注在輸出流的結構。JSP和Warnier/Orr圖都將程式及資料由序列、迭代及選擇三個結構來表示，基本上創立了[正则表达式](../Page/正则表达式.md "wikilink")的[語法分析器](../Page/語法分析器.md "wikilink")程式，可同時符合程式輸入及輸出的資料流。

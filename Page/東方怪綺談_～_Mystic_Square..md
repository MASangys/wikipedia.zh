...
幻想乡发生了异常，大量恶魔从山上涌出，[博丽灵梦和她的同伴决定一探究竟这次异常的源头](https://zh.wikipedia.org/wiki/博丽灵梦 "wikilink")……
...
<span id="神綺"></span>**，Shinki**
  ...
  -
    ...
    **主題曲**：
      - （『怪綺談』）
    魔界的創造主，即是魔界之神，魔界的一切皆是由她創造的。對於在魔界肆意破壞的人，會予以罪罰性的攻擊。『怪綺談』作中，戰鬥時會生出三對翅膀，並會隨著體力減少由白色轉為紫色。長髮的一大節被紮起捲往一側的頭髮（[呆毛](https://zh.wikipedia.org/wiki/呆毛 "wikilink")）是其特徵。作为本次异变的原因是因为其批准了魔界的恶魔去人间旅行而做成。
...
| FINAL STAGE | 神戦 〜 Dream Battle       | （无）        | 神绮  |
...
6.  ****（译名：冒險的孩子們\[10\]） - 第3关卡BGM
7.  ****（译名：雕塑的心靈 ） - 第3关卡头目（爱丽丝）BGM1
8.  ****（译名：Maple Wise ） - 第4关卡BGM
9.  ****（译名： 禁斷之魔法　～Forbidden Magic） - 第4关卡头目前半段BGM
10. ****（译名：鮮紅的少女　～緋之死 ） - 第4关卡头目（雪）后半段BGM
11. ****（译名：背叛的少女　～猶大之吻 ） - 第4关卡头目（舞）后半段BGM
12. ****（译名：最後的審判 ） - 第5关卡BGM
13. ****（译名：悲苦的人形　～ Doll of Misery ） - 第5关卡头目（梦子）BGM
14. ****（译名：世界末日　～ World's End ） -第6关卡BGM
15. ****（译名：神話幻想　～永遠的存在 ） - 第6关卡头目（神绮）BGM
16. ****（译名：愛麗絲夢遊仙境 ） - Extra关卡BGM
17. ****（译名：愛麗絲的魔法書 ） - Extra关卡头目（爱丽丝）BGM2
18. ****（译名：神社 ） - 不完美结局BGM
19. ****（译名：Endless ） - 完美结局BGM1
20. ****（译名：久遠的樂園 ） - 完美结局BGM2
21. ****（译名：神秘的夢 ） - 制作人员名单BGM
...
8.
9.
10. 依照19世紀出版的 Alice In Wonderland 當時的翻譯，「Romantic」應該被翻譯為「因為冒險而感到興奮」」
...
博丽神社遭遇到破坏了，而巫女[博丽灵梦是绝不会饶恕敌人的](https://zh.wikipedia.org/wiki/博丽灵梦 "wikilink")。她通过了特殊管道来到了另一个世界，就为了寻找并惩罚做出这些事情的妖怪。虽然她无法直接给予敌人伤害，但她可以使用一个强大的武器——博丽阴阳玉。有了它，灵梦就可以对抗所有跟她对立的敌人——假设她可以控制它……
...
<!-- end list -->
  ...
  - 魅魔（<span id="魅魔"></span>**，Mima**）
    ...
    雾雨魔理沙曾叫其为「（魅魔大人）」而且非常仰慕其，所以怀疑其为雾雨魔理沙的师傅。

<!-- end list -->

  - 菊理（<span id="菊理"></span>**Kikuri**）
...
7.  ****（译名：天使传说） - 第十关BGM
8.  ''' '''（译名：东方魔法师）- 魔界路线第11～14关BGM
9.  ****（译名：破邪之小太刀） - 地狱路线第11～14关BGM
10. ****（译名：魔镜） - 第十关BGM
11. ****（译名：影之传说） - 魔界路线第16～19关BGM
12. ****（译名：来吧，直到倒地死去的那一刻） - 魔界路线最终关曲1
13. ****（译名：一起死吧） - 魔界路线最终关曲2
14. ****（译名：星幽剑师） - 地獄最终关曲
15. ****（译名：鸢尾） - 通关曲

...
本作中新加入的「動物靈系統」，自機的性能會根據憑依的動物靈不同而變化。
...
在遊戲中，擊破特定敵人或在一般狀態下中彈會出現各種動物靈道具，擁有和[東方星蓮船中的飛碟道具類似的移動軌跡與變色規律](https://zh.wikipedia.org/wiki/東方星蓮船 "wikilink")。動物靈道具分為「動物靈」和「道具魚靈」兩種。當角色中彈時會產生2個與自機配置相一致的固定顏色的基本靈。 收集5個動物靈道具后會進入“咆哮模式”，當5個動物靈中有三個相同的動物靈，則會觸發具有額外效果的“暴走咆哮模式”。

  - 野狼靈 - 集中射擊大幅度增強。
  - 水獺靈 - 出現將敵機子彈轉換為得分道具（綠）的屏障。
  - 大鷲靈 - 擴散射擊大幅度增強。

在“咆哮模式”下拾取動物靈，可以增加持續時間，如果拾取的是道具魚靈，則會立即獲得對應的道具。“咆哮模式”期間中彈不會失去殘機，而是立即解除“咆哮模式”，而在不中彈的情況下結束“咆哮模式”，持有的道具魚靈所對應的道具將返還，並隨機生成2個新的動物靈。

...
柯尼希定理相当于[赫尔婚姻定理和Dilworth定理](https://zh.wikipedia.org/wiki/赫尔婚姻定理 "wikilink")。既然二分图匹配就是[最大流的特烈](https://zh.wikipedia.org/wiki/最大流问题 "wikilink")，这定理也是[最大流量分割理的特烈](https://zh.wikipedia.org/wiki/最大流最小割定理 "wikilink")。

在[微積分中](https://zh.wikipedia.org/wiki/微積分 "wikilink")，**柯西主值**是為某類原來[發散的](https://zh.wikipedia.org/wiki/發散 "wikilink")[反常積分指派特定數值的方式](../Page/反常積分.md "wikilink")，為紀念數學家[柯西而得此名](https://zh.wikipedia.org/wiki/柯西 "wikilink")。
...
在計算積分的柯西主值時，使用[換元積分法可能會導致歧義](https://zh.wikipedia.org/wiki/換元積分法 "wikilink")。例如在計算
...
value)。但這和[多值函數的主值是沒有關係的](https://zh.wikipedia.org/wiki/多值函數 "wikilink")。

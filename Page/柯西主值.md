在[微積分中](../Page/微積分.md "wikilink")，**柯西主值**是為某類原來[發散的](../Page/發散.md "wikilink")[反常積分指派特定數值的方式](../Page/反常積分.md "wikilink")，為紀念數學家[柯西而得此名](../Page/柯西.md "wikilink")。

## 第一類反常積分

第一類反常積分，稱為無窮積分，指積分區間的上限或下限為[無窮的積分](../Page/無窮.md "wikilink")。
...
上式中兩個極限皆[收斂](../Page/收斂.md "wikilink")，這反常積分才定義為收斂。若任意其一[發散](../Page/發散.md "wikilink")，則此積分發散。在這裡，兩個極限須分別處理，即兩者的收斂速度可能不同。但在柯西主值的理解下，可假設兩個極限的收斂速度相同，即：
...
第二類反常積分，稱為瑕積分，指被積函數在積分區間中含有[不連續點的積分](../Page/不連續點.md "wikilink")。
...
同樣地，上式中兩個極限皆[收斂](../Page/收斂.md "wikilink")，這反常積分才定義為收斂。若任意其一[發散](../Page/發散.md "wikilink")，則此積分發散。在這裡，兩個極限的收斂速度可能不同。但在柯西主值的理解下，可假設兩個極限的收斂速度相同，即：
...
在計算積分的柯西主值時，使用[換元積分法可能會導致歧義](../Page/換元積分法.md "wikilink")。例如在計算
\(\mathrm{PV} \int_{-2}^1\frac{10+4x}{x^3(5+x)^3}\,dx\) 時，
...
有些作者會把柯西主值直接叫作「主值」(principal
value)。但這和[多值函數的主值是沒有關係的](../Page/多值函數.md "wikilink")。
...
## 參考文獻
  ...
  - Dave Rusin's webpage. *Cauchy Principal Value.* The Department of
    Mathematics, the University of Texas.
    <http://www.math.utexas.edu/users/rusin/408D-12b/CPV.pdf>.

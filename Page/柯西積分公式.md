**柯西积分公式**是[数学中](../Page/数学.md "wikilink")[复分析的一个重要结论](../Page/複分析.md "wikilink")，以十九世纪法国数学家[奥古斯丁·路易·柯西命名](https://zh.wikipedia.org/wiki/奥古斯丁·路易·柯西 "wikilink")。柯西积分公式说明了任何一个闭合区域上的[全纯函数在区域](../Page/全纯函数.md "wikilink")[内部的值完全取决于它在区域边界上的值](../Page/内部.md "wikilink")，并且给出了区域内每一点的任意阶[导数的积分计算方式](../Page/导数.md "wikilink")。柯西积分公式是复分析中全纯函数“微分等同于积分”特性的表现。而在[实分析中这样的结果是完全不可能达到的](https://zh.wikipedia.org/wiki/实分析 "wikilink")。
...
对上式等号右侧的积分进行*n*次[分部积分变换就可得到对](https://zh.wikipedia.org/wiki/分部积分法 "wikilink")*n*阶导数的柯西积分公式：

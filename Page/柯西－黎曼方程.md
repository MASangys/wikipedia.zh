[复分析中的](https://zh.wikipedia.org/wiki/复分析 "wikilink")**柯西-黎曼微分方程**（）是提供了[可微函数在](../Page/可微函数.md "wikilink")[开集中為](../Page/开集.md "wikilink")[全纯函数的](https://zh.wikipedia.org/wiki/全纯 "wikilink")[充要条件的两个](https://zh.wikipedia.org/wiki/充要条件 "wikilink")[偏微分方程](../Page/偏微分方程.md "wikilink")，以[柯西和](https://zh.wikipedia.org/wiki/柯西 "wikilink")[黎曼得名](https://zh.wikipedia.org/wiki/黎曼 "wikilink")。这个方程组最初出现在[达朗贝尔的著作中](https://zh.wikipedia.org/wiki/达朗贝尔 "wikilink")。后来[欧拉将此方程组和解析函数联系起来](https://zh.wikipedia.org/wiki/欧拉 "wikilink")。
...
+ i*y*) = *u*(*x*,*y*) +
i*v*(*x*,*y*)。假设*u*和*v*在[开集](../Page/开集.md "wikilink")**C**上[连续可微](https://zh.wikipedia.org/wiki/连续可微 "wikilink")，则当且仅当*u*和*v*的偏微分满足柯西-黎曼方程组(1a)和(1b)，*f*=*u*+i*v*是[全纯的](https://zh.wikipedia.org/wiki/全纯 "wikilink")
...
反过来，如果*f*:**C** →
**C**作为映射到**R**<sup>2</sup>上的函数可微，则*f*[複可微当且仅当柯西](https://zh.wikipedia.org/wiki/複數_\(數學\) "wikilink")-黎曼方程成立。
...
分别根据[格林定理和](https://zh.wikipedia.org/wiki/格林定理 "wikilink")[散度定理](https://zh.wikipedia.org/wiki/散度定理 "wikilink")，这样的场是[保守的](../Page/保守向量场.md "wikilink")，而且没有源，在整个开域上净流量为零。（这两点在[柯西积分定理中作为实部和虚部结合起来](../Page/柯西积分定理.md "wikilink")。）在[流体力学中](../Page/流体力学.md "wikilink")，这样的一个场是一个[势流](https://zh.wikipedia.org/wiki/势流 "wikilink")。在[静磁学中](https://zh.wikipedia.org/wiki/静磁学 "wikilink")，这样的向量场是在不含电流的平面区域中的静[磁场的模型](https://zh.wikipedia.org/wiki/磁场 "wikilink")。在[静电学中](https://zh.wikipedia.org/wiki/静电学 "wikilink")，它们提供了不包含电荷的平面区域的电场模型。
...
对于任何坐标(*n*(*x*,*y*),
*s*(*x*,*y*))，如果它们满足\(\scriptstyle (\nabla n, \nabla s)\)[正交并且](../Page/正交.md "wikilink")[正定向](https://zh.wikipedia.org/wiki/定向\(数学\) "wikilink")。因此，特别的有，在极坐标*z*=*re*<sup>iθ</sup>下，方程组有如下形式
...
**R**<sup>2</sup>[可微](https://zh.wikipedia.org/wiki/Fréchet导数 "wikilink")。则**柯西积分定理**（柯西－古尔萨定理）断言*f*在开[複域Ω上解析当且仅当它在该域上满足柯西](https://zh.wikipedia.org/wiki/複數_\(數學\) "wikilink")-黎曼方程。特别是，*f*不需假定为连续可微。

柯西－古尔萨定理的假设可以大幅减弱；*f*不需可微，只要*f*=*u*+i*v*在Ω上连续且*f*关于*x*和*y*的[偏导数在Ω中存在即可](../Page/偏导数.md "wikilink")，这个结果称为[Looman–Menchoff定理](https://zh.wikipedia.org/wiki/Looman–Menchoff定理 "wikilink")。

...
标准模板库係由[Alexander Stepanov創造於](https://zh.wikipedia.org/wiki/Alexander_Stepanov "wikilink")1979年前後，這也正是[比雅尼·斯特勞斯特魯普創造](https://zh.wikipedia.org/wiki/比雅尼·斯特勞斯特魯普 "wikilink")[C++](../Page/C++.md "wikilink")的年代。

雖然David R. Musser於1971年開始即在計算機幾何領域發展並倡導某些泛型程序設計觀念，但早期並沒有任何程式語言支援泛型程序設計。 Alex和Musser曾於1987開發出一套相關的Ada library.

...
## 树的种类
  ...
  - 有序树：树中任意节点的子节点之间有顺序关系，这种树称为有序树；
      - [二叉树](../Page/二叉树.md "wikilink")：每个节点最多含有两个子树的树称为二叉树；
          ...
          - [排序二叉树](https://zh.wikipedia.org/wiki/排序二叉树 "wikilink")([二叉查找树](https://zh.wikipedia.org/wiki/二叉查找树 "wikilink")（英语：Binary
...
## 外部链接
  ...
  - [树-数据结构(Python)](https://web.archive.org/web/20181002180935/https://eindex.me/tree-in-python/)by
    EINDEX

...
Framework**，缩写**KMDF**）是[微軟公司推出的](../Page/微軟公司.md "wikilink")[Windows](../Page/Windows.md "wikilink")[驅動程式基礎](../Page/驅動程式.md "wikilink")（[Windows
Driver
Foundation](../Page/Windows_Driver_Foundation.md "wikilink")）之一，建構[Windows
...
KMDF係以物件為基底建立於WDM架構之上。不同的功能有不同的物件，KMDF在實作上包含了：
  ...
  - 即插即用和电源管理
  - I/O队列
  - [直接内存访问](../Page/直接内存访问.md "wikilink")（DMA）
  - [Windows Management
    Instrumentation](../Page/Windows_Management_Instrumentation.md "wikilink")（WMI）
  - 同步

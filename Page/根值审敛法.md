**根值审敛法**是判别正项[级数敛散性的一种方法](../Page/级数.md "wikilink")，又叫做**[柯西判别法](https://zh.wikipedia.org/wiki/柯西 "wikilink")**。方法是分析第\(n\)项的绝对值的\(n\)次方的[上极限与](https://zh.wikipedia.org/wiki/上极限 "wikilink")1的大小关系。
...
Cauchy'ego](https://zh.wikipedia.org/wiki/pl:Kryteria_zbieżności_szeregów#Kryterium_Cauchy'ego "wikilink")

在[线性代数中](../Page/线性代数.md "wikilink")，如果[内积空间上的一组向量能够组成一个](../Page/内积空间.md "wikilink")[子空间](https://zh.wikipedia.org/wiki/子空间 "wikilink")，那么这一组向量就称为这个子空间的一个基。**Gram－Schmidt正交化**提供了一种方法，能够通过这一子空间上的一个基得-{出}-子空间的一个[正交基](https://zh.wikipedia.org/wiki/正交基 "wikilink")，并可进一步求出对应的[标准正交基](../Page/标准正交基.md "wikilink")。

这种正交化方法以和命名，然而比他们更早的[拉普拉斯](https://zh.wikipedia.org/wiki/拉普拉斯 "wikilink")（Laplace）和[柯西](https://zh.wikipedia.org/wiki/柯西 "wikilink")（Cauchy）已经发现了这一方法。在[李群分解中](https://zh.wikipedia.org/wiki/李群分解 "wikilink")，这种方法被推广为[岩泽分解](../Page/岩泽分解.md "wikilink")（Iwasawa
decomposition）。

在[数值计算中](https://zh.wikipedia.org/wiki/数值计算 "wikilink")，Gram－Schmidt正交化是[数值不稳定的](../Page/数值稳定性.md "wikilink")，计算中累积的舍入误差会使最终结果的正交性变得很差。因此在实际应用中通常使用[豪斯霍尔德变换或](../Page/豪斯霍尔德变换.md "wikilink")[Givens旋转进行正交化](https://zh.wikipedia.org/wiki/Givens旋转 "wikilink")。

## 记法

  - \(\boldsymbol{V}^n\)：[维数为](https://zh.wikipedia.org/wiki/维数 "wikilink")*n*
    的内积空间
...
考察如下[欧几里得空间](../Page/欧几里得空间.md "wikilink")**R**<sup>*n*</sup>中向量的[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")，欧氏空间上内积的定义为\<***a***,
***b***\> = ***b***<sup>''T''</sup>***a***：

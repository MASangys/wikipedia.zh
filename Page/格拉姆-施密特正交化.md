...
## 外部链接
  ...
  -
  - [Harvey Mudd College Math Tutorial on the Gram-Schmidt algorithm](http://www.math.hmc.edu/calculus/tutorials/gramschmidt/gramschmidt.pdf)

  - [Earliest known uses of some of the words of mathematics: G](http://jeff560.tripod.com/g.html)

  - Demos: [Gram Schmidt process in plane](http://www.bigsigma.com/en/demo/gram-schmidt-plane) and [Gram Schmidt process in space](http://www.bigsigma.com/en/demo/gram-schmidt-space)

在[数学中](../Page/数学.md "wikilink")，**格朗沃尔引理**或**格朗沃尔不等式**说明了对于满足一定的[微分方程或](../Page/微分方程.md "wikilink")[积分方程的函数](../Page/积分方程.md "wikilink")，有相应的关于此微分方程或积分方程的[不等式](../Page/不等式.md "wikilink")。格朗沃尔不等式有两种形式，分别是积分形式和微分形式。积分形式下的不等式可以有几种不同的写法。

格朗沃尔不等式常常被用来估计[常微分方程的解的取值范围](../Page/常微分方程.md "wikilink")。比如，它可以用来证明[初值问题的解的](../Page/初值问题.md "wikilink")[唯一性](../Page/唯一性.md "wikilink")（见[柯西-利普希茨定理](../Page/柯西-利普希茨定理.md "wikilink")）。

格朗沃尔不等式的名称来自[多玛·哈肯·格朗沃尔](../Page/多玛·哈肯·格朗沃尔.md "wikilink")。格朗沃尔是一位[瑞典的](../Page/瑞典.md "wikilink")[数学家](../Page/数学家.md "wikilink")，后来移居[美国](../Page/美国.md "wikilink")。

格朗沃尔不等式的微分形式首先由格朗沃尔在1919年证明\[1\]。而积分形式则是由[理查德·贝尔曼](../Page/理查德·贝尔曼.md "wikilink")（）在1943年证明\[2\]。

## 微分形式

设 *I*
是一个[实数](../Page/实数.md "wikilink")[区间](../Page/区间.md "wikilink")，记为：\[*a*, ∞)
...
则运用复合函数求导法则中的[乘積法則](../Page/乘積法則.md "wikilink")、[链式法则](../Page/链式法则.md "wikilink")、[指数函数的求导法则以及](../Page/指数函数.md "wikilink")[微积分基本定理](../Page/微积分基本定理.md "wikilink")，可以得到：
...
1.  T. H. Gronwall: Note on the derivative with respect to a parameter
    ...
    Math](../Page/Annals_of_Mathematics.md "wikilink") 20 (1919),
    292–296.

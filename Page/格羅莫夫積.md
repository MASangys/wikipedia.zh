...
格羅莫夫積可用以定義[格羅莫夫雙曲空間及其理想邊界](../Page/格羅莫夫雙曲空間.md "wikilink")。
...
\[0 \leq (y, z)_{x} \leq \min \big\{ d(y, x), d(z, x) \big\}\]
  ...
  - 格羅莫夫積是[利普希茨連續的](../Page/利普希茨連續.md "wikilink")：
...
1.  Mikhail Gromov, *Hyperbolic groups.* Essays in group theory,
    75--263, Math. Sci. Res. Inst. Publ., 8, Springer, New York, 1987.
2.  É. Ghys and P. de la Harpe (éd.), *Sur les groupes hyperboliques

**格蘭傑因果關係檢驗**（）是一種[假設檢定的統計方法](../Page/假設檢定.md "wikilink")，檢驗一組[時間序列](../Page/時間序列.md "wikilink")\(x\)是否為另一組時間序列\(y\)的原因。它的基礎是[迴歸分析當中的](../Page/迴歸分析.md "wikilink")[自迴歸模型](https://zh.wikipedia.org/wiki/自迴歸模型 "wikilink")。迴歸分析通常只能得出*不同*
...
1\.
令\(x\)和\(y\)為[廣義平穩序列](https://zh.wikipedia.org/wiki/平穩過程#廣義平穩（弱平穩） "wikilink")。如要檢測\(x\)非\(y\)的格蘭傑原因之[零假設](https://zh.wikipedia.org/wiki/零假設 "wikilink")，首先引入\(y\)的滯後值建立\(y\)的[自迴歸模型](https://zh.wikipedia.org/wiki/自迴歸模型 "wikilink")（AR
model on \(y\)）：
...
## 相關條目
  ...
  - [自迴歸模型](https://zh.wikipedia.org/wiki/自迴歸模型 "wikilink")（AR model）

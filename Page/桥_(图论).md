[Graph_cut_edges.svg](https://zh.wikipedia.org/wiki/File:Graph_cut_edges.svg "fig:Graph_cut_edges.svg") [Undirected.svg](https://zh.wikipedia.org/wiki/File:Undirected.svg "fig:Undirected.svg") 在[圖論中](../Page/图论.md "wikilink")，一條邊被稱為「**橋**」代表這條邊一旦被刪除，這張圖的連通塊數量會增加。\[1\] 等價地說，一條邊是一座橋若且唯若這條邊不在任何[環上](https://zh.wikipedia.org/wiki/環_\(圖論\) "wikilink")。一張圖可以有零或多座橋。

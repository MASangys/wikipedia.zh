**梁友栋—柏世奇算法**（以[梁友栋和](../Page/梁友栋.md "wikilink")的名字命名）是[计算机图形学中的一个](../Page/计算机图形学.md "wikilink")[线段裁剪算法](https://zh.wikipedia.org/wiki/线段裁剪算法 "wikilink")。梁友栋—柏世奇算法使用直线的参数方程和不等式组来描述线段和裁剪窗口的交集。求解出的交集将被用于获知线的哪些部分是应当绘制在屏幕上的。这一算法比[科恩－苏泽兰算法](../Page/科恩－苏泽兰算法.md "wikilink")（）要更加高效，梁友栋—柏世奇算法的基本思想是：在计算线段与裁剪窗交集之前做尽可能多的判断。

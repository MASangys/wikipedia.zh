...
Coefficients，MFCCs**)就是組成梅爾頻率倒譜的係數。它衍生自音訊片段的[倒頻譜](../Page/倒頻譜.md "wikilink")(cepstrum)。倒譜和梅爾頻率倒譜的區別在於，梅爾頻率倒譜的頻帶劃分是在[梅爾刻度上等距劃分的](https://zh.wikipedia.org/wiki/梅爾刻度 "wikilink")，它比用於正常的對數[倒頻譜](../Page/倒頻譜.md "wikilink")中的線性間隔的頻帶更能近似人類的聽覺系統。

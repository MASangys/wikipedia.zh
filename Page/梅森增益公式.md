...
。上式的分數形成[有理函數的](../Page/有理函數.md "wikilink")[子環](../Page/子環.md "wikilink")
\(R(1+\langle L_i\rangle)^{-1}\)。上述的觀察可以延伸到非交換性的情形\[3\]，不過梅森增益公式會被[里格尔公式](../Page/里格尔公式.md "wikilink")（Riegle's
rule）所取代。

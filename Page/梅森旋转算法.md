**梅森旋转演算法**（**Mersenne
twister**）是一个[伪随机数发生算法](https://zh.wikipedia.org/wiki/伪随机数发生算法 "wikilink")。由[松本真和](https://zh.wikipedia.org/wiki/松本真 "wikilink")[西村拓士](https://zh.wikipedia.org/wiki/西村拓士 "wikilink")\[1\]在1997年开发，基于有限[二进制](https://zh.wikipedia.org/wiki/二进制 "wikilink")[字段上的](https://zh.wikipedia.org/wiki/字段 "wikilink")[矩阵线性递归](https://zh.wikipedia.org/wiki/矩阵线性递归 "wikilink")\(F_{2}\)。可以快速产生高质量的伪随机数，修正了古典随机数发生算法的很多缺陷。
...
Twister会在\([0,2^k-1]\)的区间之间生成[离散型均匀分布的随机数](https://zh.wikipedia.org/wiki/离散型均匀分布 "wikilink")。

## 应用

梅森旋转算法是[R](../Page/R.md "wikilink")、[Python](../Page/Python.md "wikilink")、[Ruby](../Page/Ruby.md "wikilink")、[IDL](https://zh.wikipedia.org/wiki/IDL "wikilink")、[Free
Pascal](../Page/Free_Pascal.md "wikilink")、[PHP](../Page/PHP.md "wikilink")、[Maple](../Page/Maple.md "wikilink")、[Matlab](https://zh.wikipedia.org/wiki/Matlab "wikilink")、[GNU多重精度运算库和GSL的默认伪随机数产生器](../Page/GNU多重精度运算库.md "wikilink")。从C++11开始，C++也可以使用这种算法。在Boost
...
为了性能，这个算法付出了巨大的空间成本（当时而言）：需要 2.5
[KiB](https://zh.wikipedia.org/wiki/KiB "wikilink")
的[缓存空间](https://zh.wikipedia.org/wiki/memory_hierarchy "wikilink")。2011年，[松本真和](https://zh.wikipedia.org/wiki/松本真 "wikilink")[西村拓士针对这一问题提出了一个更小的版本](https://zh.wikipedia.org/wiki/西村拓士 "wikilink")，仅占127
...
`     `**`for`**` i `**`from`**` 1 `**`to`**` 623 { `*`//``
 ``走訪剩下的每個元素`*
`         MT[i] := `**`last``   ``32``   ``bits``
 ``of`**`(1812433253 * (MT[i-1] `**[`xor`](https://zh.wikipedia.org/wiki/位操作#按位异或\(XOR\) "wikilink")**` (`**`right``
...
`     y := y `**`xor`**` (`**`left``   ``shift``   ``by``   ``7``
 ``bits`**`(y) `**[`and`](https://zh.wikipedia.org/wiki/位操作#按位与\(AND\) "wikilink")**` (2636928640)) `*`//``
...
### 实现
  ...
  - [Implementation of the Mersenne Twister in
    ...
    Toolkit](https://zh.wikipedia.org/wiki/Mobile_Robot_Programming_Toolkit "wikilink")
  ...
  - [High-speed Implementation of Mersenne
    ...
    [Linoleum](https://zh.wikipedia.org/wiki/Linoleum_programming_language "wikilink")
    (a cross-platform
    [Assembler](https://zh.wikipedia.org/wiki/Assembly_language "wikilink")),
    by Herbert Glarner
  ...
  - It also is implemented in
    [gLib](https://zh.wikipedia.org/wiki/gLib "wikilink") and the
    standard libraries of at least [PHP](../Page/PHP.md "wikilink"),
    [Python](../Page/Python.md "wikilink") and
    [Ruby](https://zh.wikipedia.org/wiki/Ruby_programming_language "wikilink").

[Meixner-Pollaczek_2.gif](https://zh.wikipedia.org/wiki/File:Meixner-Pollaczek_2.gif "fig:Meixner-Pollaczek_2.gif")
[Meixner-Pollaczek_3.gif](https://zh.wikipedia.org/wiki/File:Meixner-Pollaczek_3.gif "fig:Meixner-Pollaczek_3.gif")
**梅西纳-珀拉泽克多项式**是一个以[超几何函数定义的正交多项式](../Page/超几何函数.md "wikilink")
...
\(\lim_{t \to \infty}\frac{ S_{n}((x-t)^2;\lambda+it,\lambda-it,tcos\phi         }{ t^{n}N! }=\frac{ P_{n}^{(\lambda)}(x;\phi  }{(sin\phi)^n    }\)
  ...
  - [连续哈恩多项式](https://zh.wikipedia.org/wiki/连续哈恩多项式 "wikilink")→梅西纳-珀拉泽克多项式

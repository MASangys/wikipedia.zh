[trapezoidal_rule_illustration.png](https://zh.wikipedia.org/wiki/File:trapezoidal_rule_illustration.png "fig:trapezoidal_rule_illustration.png")[函數](../Page/函數.md "wikilink")（紅色）會作用估算[函數](../Page/函數.md "wikilink")\(f(x)\)
（藍色）。\]\]

**梯形公式**是[數學中](../Page/數學.md "wikilink")[数值积分的基础公式之一](../Page/数值积分.md "wikilink")：\(\int_{a}^{b} f(x)\, dx \approx (b-a)\frac{f(a) + f(b)}{2}.\)

## 公式由来

由[积分中值定理可得](../Page/积分中值定理.md "wikilink")

\(\exists \xi \in [a,b]  \int\limits_{a}^{b} f(x) dx = (b-a)f(\xi)\)，

但由于ξ其值一般难于确定，故难以准确算出f(ξ)的值。

如果用两端点f(a)与f(b)的[算术平均值估算f](../Page/算术平均值.md "wikilink")(ξ)，有
...
[Trapezoidal_rule_illustration_small.svg](https://zh.wikipedia.org/wiki/File:Trapezoidal_rule_illustration_small.svg "fig:Trapezoidal_rule_illustration_small.svg")
為了計算出更加準確的[定積分](../Page/定積分.md "wikilink")，可以把[積分的區間](../Page/積分.md "wikilink")\([a, b]\)分成\(N\)份，當中\(N\)趨向[無限](../Page/無限.md "wikilink")，分割出的每一個區間長度必定要是一樣的，然後就可以應用梯形公式：
...
給予\(x_1,\ldots,x_N\)以及\(y_1,\ldots,y_N\)，[定積分就可以估算成](../Page/定积分.md "wikilink")
...
如果[被積函數是一個](../Page/被積函數.md "wikilink")[凸函數](../Page/凸函數.md "wikilink")（亦即有一個正值[二階導數](../Page/二階導數.md "wikilink")），那麼誤差會是一個負數，也代表梯形公式的估算值高估了真實數字。這可以利用一個幾何圖形代去表達：梯形不但覆蓋曲線下的面積更超越其範圍。同樣地，如果被積函數是一個[凹函數](../Page/凹函數.md "wikilink")，梯形公式就會低估其真實數字因為曲線下部份面積沒有被計算在內。如果被積函數中有[拐點](../Page/拐點.md "wikilink")。它的錯誤是比較難去估計。

一般而言有數種方法可以去分析誤差，例如是：[傅利葉級數](../Page/傅利葉級數.md "wikilink")。

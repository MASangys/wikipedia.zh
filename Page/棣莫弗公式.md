[3rd_roots_of_unity.svg](https://zh.wikipedia.org/wiki/File:3rd_roots_of_unity.svg "fig:3rd_roots_of_unity.svg")**棣莫弗公式**是一個關於[複數和](../Page/複數.md "wikilink")[三角函數的公式](../Page/三角函数.md "wikilink")，命名自[法國數學家](../Page/法國.md "wikilink")[亞伯拉罕·棣美弗](../Page/亞伯拉罕·棣莫弗.md "wikilink")（，1667年－1754年）。其內容為對任意複數和[整數](../Page/整数.md "wikilink")，下列性質成立：

[Ellipse_Properties.svg](https://zh.wikipedia.org/wiki/File:Ellipse_Properties.svg "fig:Ellipse_Properties.svg") 在[数学](../Page/数学.md "wikilink")中，**椭圆**是平面上到两个固定点的距离之和为[常数的点之轨迹](https://zh.wikipedia.org/wiki/常数 "wikilink")。

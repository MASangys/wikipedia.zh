在[积分学中](../Page/积分学.md "wikilink")，**椭圆积分**最初出现于[椭圆的](../Page/椭圆.md "wikilink")[弧长有关的问题中](../Page/弧长.md "wikilink")。[Guilio
Fagnano和](../Page/Guilio_Fagnano.md "wikilink")[欧拉是最早的研究者](../Page/欧拉.md "wikilink")。现代数学将**椭圆积分**定义为可以表达为如下形式的任何[函数](../Page/函数.md "wikilink")
\(f \,\)的积分

\[f(x) = \int_{c}^{x} R[t,\sqrt[]{P(t)} ]\ dt \,\!\]

其中\(R \,\)是其两个参数的[有理函数](../Page/有理函数.md "wikilink")，\(P \,\)是一个无重根的\(3 \,\)或\(4 \,\)阶[多项式](../Page/多项式.md "wikilink")，而\(c \,\)是一个常数。
...
除下面给出的形式之外，椭圆积分也可以表达为[勒让德形式和](../Page/勒让德形式.md "wikilink")[Carlson对称形式](../Page/Carlson对称形式.md "wikilink")。通过对[施瓦茨-克里斯托费尔映射的研究可以加深对椭圆积分理论的理解](../Page/施瓦茨-克里斯托费尔映射.md "wikilink")。历史上，[椭圆函数是作为椭圆积分的逆函数被发现的](../Page/椭圆函数.md "wikilink")，特别是这一个：\(F [ \textrm{sn} \left(z;k \right);k] = z\,\)其中\(\textrm{sn} \,\)是[雅可比椭圆函数之一](../Page/雅可比椭圆函数.md "wikilink")。

## 记法

椭圆积分通常表述为不同变量的函数。这些变量完全等价（它们给出同样的椭圆积分），但是它们看起来很不相同。很多文献使用单一一种标准命名规则。在定义积分之前，先来检视一下这些变量的命名常规：

  - \(\alpha\) **[模角](../Page/模角.md "wikilink")**;
  - \(k=\sin \alpha\) **[椭圆模](../Page/椭圆模.md "wikilink")**;
...
上述三种常规完全互相确定。规定其中一个和规定另外一个一样。椭圆积分也依赖于另一个变量，可以有如下几种不同的设定方法：
  ...
  - \(u\,\)，其中\(x =  \textrm{sn} \; u \,\)而\(\textrm{sn} \,\)是[雅可比椭圆函数之一](../Page/雅可比椭圆函数.md "wikilink")
...
后者有时称为**δ幅度**并写作\(\Delta(\phi)=\textrm{dn}\; u\,\!\)。有时文献也称之为补参数，补模或者补模角。这些在[四分周期中有进一步的定义](../Page/四分周期.md "wikilink")。
...
与此等价，用[雅可比的形式](../Page/雅可比.md "wikilink")，可以设
...
and Stegun](../Page/Abramowitz_and_Stegun.md "wikilink")。
...
和上面的不同对应的是，如果从[Mathematica语言翻译代码到](../Page/Mathematica.md "wikilink")[Maple语言](../Page/Maple.md "wikilink")，必须将EllipticK函数的参数用它的[平方根代替](../Page/平方根.md "wikilink")。反过来，如果从Maple翻到Mathematica，则参数应该用它的[平方代替](../Page/平方.md "wikilink")。Maple中的EllipticK(\(x\))几乎和Mathematica中的EllipticK\[\(x^2\)\]相等；至少当\(0<x<1\,\)时是相等的。

注意

\[F(x;k) = u \,\!\]
其中\(u\,\)如上文所定义：由此可见，[雅可比椭圆函数是椭圆积分的逆](../Page/雅可比椭圆函数.md "wikilink")。
...
其中\(n!! \,\)表示[双阶乘](../Page/双阶乘.md "wikilink")。利用高斯的[超几何函数](../Page/超几何函数.md "wikilink")，第一类完全椭圆积分可以表达为

\[K(k) = \frac{\pi}{2} \,_2F_1 \left( \frac{1}{2} , \frac{1}{2}; 1; k^2\right).\,\!\]

第一类完全椭圆积分有时称为[四分周期](../Page/四分周期.md "wikilink")。它可以利用[算术几何平均值來快速计算](../Page/算术-几何平均数.md "wikilink")。
...
用[高斯超几何函数表示的话](../Page/超几何级数.md "wikilink")，第二类完全椭圆积分可以写作
...
## 参考
  ...
  - Milton Abramowitz and Irene A. Stegun, *[Handbook of Mathematical
    ...
    chapter 17)*.
  - [Harris Hancock](../Page/Harris_Hancock.md "wikilink") *[Lectures on
    the theory of Elliptic
    functions](http://www.archive.org/details/lecturestheorell00hancrich)*
    (New York, J. Wiley & sons, 1910)
  - [Alfred George
    Greenhill](../Page/Alfred_George_Greenhill.md "wikilink") *[The
    applications of elliptic

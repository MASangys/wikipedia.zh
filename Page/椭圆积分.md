在[积分学中](https://zh.wikipedia.org/wiki/积分学 "wikilink")，**椭圆积分**最初出现于[椭圆](../Page/椭圆.md "wikilink")的[弧长](../Page/弧长.md "wikilink")有关的问题中。[Guilio
...
但是，还有许多不同的用于椭圆积分的记法。取值为椭圆积分的函数没有（象[平方根](../Page/平方根.md "wikilink")，[正弦](../Page/正弦.md "wikilink")和[误差函数](../Page/误差函数.md "wikilink")那样的）标准和唯一的名字。甚至关于该领域的文献也常常采用不同的记法。Gradstein,

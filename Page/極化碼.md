**極化碼**（）是一種[前向錯誤更正編碼方式](../Page/前向錯誤更正.md "wikilink")，用於訊號傳輸。
...
在解碼側，極化後的信道可用簡單的逐次干擾抵消解碼的方法，以較低的複雜度獲得與最大自然解碼相近的性能。\[2\]
...
[華為](https://zh.wikipedia.org/wiki/華為 "wikilink")2016宣布4月份率先完成中國[IMT-2020](https://zh.wikipedia.org/wiki/IMT-2020 "wikilink")（[5G](../Page/5G.md "wikilink")）推進組第一階段的空口關鍵技術驗證測試，在5G信道編碼領域全部使用極化碼，2016年11月17日国际无线标准化机构3GPP第87次会议在美国拉斯维加斯召开，中国华为主推PolarCode（极化码）方案，美国[高通主推](../Page/高通.md "wikilink")[低密度奇偶檢查碼](../Page/低密度奇偶檢查碼.md "wikilink")（LDPC）方案，法国主推Turbo2.0方案，最終控制信道採用極化碼，數據信道採用LDPC。\[4\]

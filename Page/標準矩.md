在[機率論和](https://zh.wikipedia.org/wiki/機率論 "wikilink")[統計學中](https://zh.wikipedia.org/wiki/統計學 "wikilink")，一個[機率分布的](https://zh.wikipedia.org/wiki/機率分布 "wikilink")**標準矩**是經過[標準化後的](../Page/标准化_\(统计学\).md "wikilink")[中心矩](../Page/中心矩.md "wikilink")（通常是較高階的中心矩）。標準化通常是將其除以[標準差的過程](../Page/標準差.md "wikilink")，這樣做可以使得標準矩對縮放和[離散程度皆能保持一致](https://zh.wikipedia.org/wiki/離散程度 "wikilink")，
在比較不同機率分布的形狀時更為方便。\[1\]

## 定義

設<span>*X*</span>為一[隨機變量](https://zh.wikipedia.org/wiki/隨機變量 "wikilink")，其[機率密度函數為](../Page/機率密度函數.md "wikilink")*f*、平均值為 \(\mu = \mathrm{E}[X]\)

...
local data = mw.loadData( 'Module:Ancient Egypt era/data' ) local lang =
...
`               '`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")` `[`dynasty`](https://zh.wikipedia.org/wiki/List_of_ancient_Egyptian_dynasties "wikilink")`, %d',`

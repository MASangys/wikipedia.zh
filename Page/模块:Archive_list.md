> 本文内容由[模块:Archive list](https://zh.wikipedia.org/wiki/模块:Archive_list)转换而来。
...
`           return '未有存檔（`[`建立`](https://zh.wikipedia.org/wiki/'_.._glargs.prefix_.._'1 "wikilink")`）'`
`       end`
`   end`
...
`           '`[`%s%d`](https://zh.wikipedia.org/wiki/%s%d "wikilink")`',`

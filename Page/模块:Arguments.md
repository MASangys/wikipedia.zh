...
`   --`[`--``   ``Set``   ``up``   ``the``   ``args,``   ``metaArgs``   ``and``   ``nilArgs``   ``tables.``   ``args``   ``will``   ``be``   ``the``   ``one``   ``--``   ``accessed``   ``from``   ``functions,``   ``and``   ``metaArgs``   ``will``   ``hold``   ``the``   ``actual``   ``arguments.``   ``Nil``   ``--``   ``arguments``   ``are``   ``memoized``   ``in``   ``nilArgs,``   ``and``   ``the``   ``metatable``   ``connects``   ``all``   ``of``   ``them``   ``--``   ``together.``   ``--`](https://zh.wikipedia.org/wiki/--_Set_up_the_args,_metaArgs_and_nilArgs_tables._args_will_be_the_one_--_accessed_from_functions,_and_metaArgs_will_hold_the_actual_arguments._Nil_--_arguments_are_memoized_in_nilArgs,_and_the_metatable_connects_all_of_them_--_together._-- "wikilink")
`   local args, metaArgs, nilArgs, metatable = {}, {}, {}, {}`
`   setmetatable(args, metatable)`

`   local function mergeArgs(iterator, tables)`
`       --`[`--``   ``Accepts``   ``multiple``   ``tables``   ``as``   ``input``   ``and``   ``merges``   ``their``   ``keys``   ``and``   ``values``   ``--``   ``into``   ``one``   ``table``   ``using``   ``the``   ``specified``   ``iterator.``   ``If``   ``a``   ``value``   ``is``   ``already``   ``--``   ``present``   ``it``   ``is``   ``not``   ``overwritten;``   ``tables``   ``listed``   ``earlier``   ``have``   ``precedence.``   ``--``   ``We``   ``are``   ``also``   ``memoizing``   ``nil``   ``values,``   ``but``   ``those``   ``values``   ``can``   ``be``   ``--``   ``overwritten.``   ``--`](https://zh.wikipedia.org/wiki/--_Accepts_multiple_tables_as_input_and_merges_their_keys_and_values_--_into_one_table_using_the_specified_iterator._If_a_value_is_already_--_present_it_is_not_overwritten;_tables_listed_earlier_have_precedence._--_We_are_also_memoizing_nil_values,_but_those_values_can_be_--_overwritten._-- "wikilink")

...
`       return string.format('`[`%s`](https://zh.wikipedia.org/wiki/Category:%s "wikilink")`', categoryName(args, class, importance), pageNumber)`
`   end`
`   `
...
', ret, pageNumberWithLink(args, class, importance))
...
', ret, pageNumberWithLink(args, class, 'ALL'))
...
', ret, args\['custom_score'\] or table.concat(summaryTable, '，'))
...
', ret, math.ceil(totalScore / pages \* 100) / 100)
...
\-{zh-hans:质量;zh-hant:質量;zh-tw:品質;}-
...
', builder, pageNumberWithLink(args, 'ALL', importance))
...
<td colspan="%s" style="text-align: center;">

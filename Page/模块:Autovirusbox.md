...
`           name = '`<span class="error">`ERROR: parameter(s) specifying taxon are incorrect; see `[`documentation`](https://zh.wikipedia.org/wiki/Template:Virusbox/doc#Usage "wikilink")</span>`'`
`       else`
`           name = targetTaxon`
...
`   if species ~= '' then`
`       if infraTaxon ~= '' then`
`           species = "`*[`"..species.."`](https://zh.wikipedia.org/wiki/"..species.." "wikilink")*`"`
`       else`
`           species = "`***`"..species.."`***`"`
`       end`
`   end`
...
[Category:Virusboxes_with_incorrect_parameters_that_specify_taxon](https://zh.wikipedia.org/wiki/Category:Virusboxes_with_incorrect_parameters_that_specify_taxon "wikilink")
> 本文内容由[模块:Bar](https://zh.wikipedia.org/wiki/模块:Bar)转换而来。
...
<table style="width:' .. width .. ';' .. (barCSS or '') .. '" cellspacing="0">
...
<td title="%s" style="width:%s; height:1em; padding:0; background:%s;" data-value="%s">

</td>

', series.title, width, series.color, series.value)

...
end --火星區 local function marsquad(lat, lon)
...
end --水星區 local function mercuryquad(lat, lon)
...
end --金星區 local function venusquad(lat, lon)
...
[Category:'_.._res_.._'方格](https://zh.wikipedia.org/wiki/Category:'_.._res_.._'方格 "wikilink")
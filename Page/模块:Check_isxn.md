...
\--[--------------------------\< IS _ V A L I D _ I S X N \>----------------------------------------------------- ISBN-10 and ISSN validator code calculates checksum across all isbn/issn digits including the check digit. ISBN-13 is checked in check_isbn(). If the number is valid the result will be 0. Before calling this function, issbn/issn must be checked for length and stripped of dashes, spaces and other non-isxn characters.](https://zh.wikipedia.org/wiki/--------------------------\<_IS_V_A_L_I_D_I_S_X_N_\>-----------------------------------------------------_ISBN-10_and_ISSN_validator_code_calculates_checksum_across_all_isbn/issn_digits_including_the_check_digit._ISBN-13_is_checked_in_check_isbn\(\)._If_the_number_is_valid_the_result_will_be_0._Before_calling_this_function,_issbn/issn_must_be_checked_for_length_and_stripped_of_dashes,_spaces_and_other_non-isxn_characters. "wikilink")
...
\--[--------------------------\< C H E C K _ I S B N \>------------------------------------------------------------ Determines whether an ISBN string is valid](https://zh.wikipedia.org/wiki/--------------------------\<_C_H_E_C_K_I_S_B_N_\>------------------------------------------------------------_Determines_whether_an_ISBN_string_is_valid "wikilink")
...
\--[--------------------------\< C H E C K _ I S M N \>------------------------------------------------------------ Determines whether an ISMN string is valid. Similar to isbn-13, ismn is 13 digits begining 979-0-... and uses the same check digit calculations. See http://www.ismn-international.org/download/Web_ISMN_Users_Manual_2008-6.pdf section 2, pages 9–12.](https://zh.wikipedia.org/wiki/--------------------------\<_C_H_E_C_K_I_S_M_N_\>------------------------------------------------------------_Determines_whether_an_ISMN_string_is_valid._Similar_to_isbn-13,_ismn_is_13_digits_begining_979-0-..._and_uses_the_same_check_digit_calculations._See_http://www.ismn-international.org/download/Web_ISMN_Users_Manual_2008-6.pdf_section_2,_pages_9–12. "wikilink")

...
`       return string.format( '`[`%dx%dpx`](https://zh.wikipedia.org/wiki/File:Chess_%s%st45.svg "fig:%dx%dpx")`', piece, color, size, size, alt, alt )`
`   end`

`   function letters_row( rev, num_lt, num_rt )`
`       local td = '`

<td style="padding: 0; vertical-align: inherit;height:18px;width:' .. size .. 'px;">
...
`   if ( numbers_lt ) then b = b .. '`

<td style="padding: 0; vertical-align: inherit; width:18px;height:' .. size .. 'px">
...
`   b = b .. string.format( '`[`%dx%dpx`](https://zh.wikipedia.org/wiki/File:Chessboard480.svg "fig:%dx%dpx")`', 8 * size, 8 * size )`
`   for trow = 1,8 do`
...
<div style="position:absolute;z-index:3;top:%dpx;left:%dpx;width:' .. size .. 'px;height:' .. size .. 'px;">
...
`   if ( numbers_rt ) then b = b .. '`

<td style="width:18px;height:' .. size ..'px;padding:0">
...
<td style="padding: 0; vertical-align: inherit;height:' .. size .. 'px">
...
<div class="thumb ' .. align .. '" style="clear:' .. clear .. '; text-align:center;">

'

`   return '`

<div class="' .. align .. '" style="clear:' .. clear .. '; text-align:center;">

...
`       text = "`[`doi`](https://zh.wikipedia.org/wiki/Digital_object_identifier "wikilink")`:" .. id;`
`       cat = cat .. ""`
...
`       cat = cat .. "" .. '`<span class="error">` Bad DOI (expected "10." prefix) in code number`</span>`'`
`   end`
...
`   return hideinprint("`[`ISSN`](https://zh.wikipedia.org/wiki/International_Standard_Serial_Number "wikilink")` [`<http://www.worldcat.org/search?fq=x0:jrnl&q=n2>`:" .. Name .. " " .. Name .. "]")`
...
\-- This is used by template . function z.r(frame)
...
\-- This is used by template . function z.reflabel(frame)
...
\-- This is used by templates  and . function z.reflist(frame)
...
\-- This is used by template . function z.refbegin(frame)
...
\-- This is used by template . function z.refend(frame)
...
\-- This is used by template . function z.efn(frame)

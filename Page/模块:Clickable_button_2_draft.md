> 本文内容由[模块:Clickable button 2 draft](https://zh.wikipedia.org/wiki/模块:Clickable_button_2_draft)转换而来。
...
`   else`
`       link = string.format('`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`', data.link, display)`
`   end`
...
[Category:Pages_using_old_style_ui-button-color](https://zh.wikipedia.org/wiki/Category:Pages_using_old_style_ui-button-color "wikilink")
...
end local function color2lum( origc )
...
end local function get_colors(team, unknown)
...
`   local results = {'Problems in `[`Module:College``
 ``color/data`](https://zh.wikipedia.org/wiki/Module:College_color/data "wikilink")`:'}`

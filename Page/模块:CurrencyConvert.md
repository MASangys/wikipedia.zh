...
\--[--------------------------\< M A K E _ S H O R T _ F O R M _ N A M E \>------------------------------------- Assembles value and symbol according to the order specified in the properties table for this currency code](https://zh.wikipedia.org/wiki/--------------------------\<_M_A_K_E_S_H_O_R_T_F_O_R_M_N_A_M_E_\>-------------------------------------_Assembles_value_and_symbol_according_to_the_order_specified_in_the_properties_table_for_this_currency_code "wikilink")
...
\--[--------------------------\< M A K E _ N A M E \>---------------------------------------------------------- Make a wikilink from the currency's article title and its plural (if provided). If linked is false, returns only the article title (unlinked)](https://zh.wikipedia.org/wiki/--------------------------\<_M_A_K_E_N_A_M_E_\>----------------------------------------------------------_Make_a_wikilink_from_the_currency's_article_title_and_its_plural_\(if_provided\)._If_linked_is_false,_returns_only_the_article_title_\(unlinked\) "wikilink")
...
\--[--------------------------\< M A K E _ L O N G _ F O R M _ N A M E \>--------------------------------------- assembles a long-form currency name from amount and name from the properties tables; plural for all values not equal to 1](https://zh.wikipedia.org/wiki/--------------------------\<_M_A_K_E_L_O_N_G_F_O_R_M_N_A_M_E_\>---------------------------------------_assembles_a_long-form_currency_name_from_amount_and_name_from_the_properties_tables;_plural_for_all_values_not_equal_to_1 "wikilink")
...
\--[--------------------------\< R E N D E R _ C U R R E N C Y \>------------------------------------------------ Renders currency amount with symbol or long-form name. Also, entry point for other modules. Assumes that parameters have been vetted; amount is a number, code is upper case string, long_form is boolean; all are required.](https://zh.wikipedia.org/wiki/--------------------------\<_R_E_N_D_E_R_C_U_R_R_E_N_C_Y_\>------------------------------------------------_Renders_currency_amount_with_symbol_or_long-form_name._Also,_entry_point_for_other_modules._Assumes_that_parameters_have_been_vetted;_amount_is_a_number,_code_is_upper_case_string,_long_form_is_boolean;_all_are_required. "wikilink")
...
\--[--------------------------\< C O N V E R T _ S T R I N G _ T O _ N U M E R I C \>------------------------------------------------ Converts quantified number/string combinations to a number e.g. 1 thousand to 1000.](https://zh.wikipedia.org/wiki/--------------------------\<_C_O_N_V_E_R_T_S_T_R_I_N_G_T_O_N_U_M_E_R_I_C_\>------------------------------------------------_Converts_quantified_number/string_combinations_to_a_number_e.g._1_thousand_to_1000. "wikilink")
...
\-- amount = lang:parseFormattedNumber(args\[1\]); -- if args\[1\] can't be converted to a number then error (this just strips grouping characters) -- if args\[1\]:find ('\[^%d%.\]') or not amount then -- non-digit characters or more than one decimal point (because lag:parse... is broken) -- return '<span style="font-size:inherit" class="error"> – invalid amount ([help](https://zh.wikipedia.org/wiki/Template:CurrencyConvert/doc#Error_messages "wikilink"))</span>'; -- end

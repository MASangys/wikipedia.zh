...
`   return string.format('`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`', table.concat(ret, '|'))`
...
`       -- things like `[`Example.png`](https://zh.wikipedia.org/wiki/File:Example.png "fig:Example.png")`.`
`       if v == '_BLANK' then`
`           v = ''`
`       end`
`       args[k] = v`

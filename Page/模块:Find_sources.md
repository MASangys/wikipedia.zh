...
`   if not linkCfg then`
`       error(string.format(`
`           "invalid link code '%s'; no link config found at `[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`",`
`           code,`
`           LINK_ROOT .. code`
`       ))`
`   end`
...
`       error(string.format(`
`           "invalid template name '%s'; no template config found at `[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`",`
...
`           formatString = formatString .. '`[`%s:%s`](https://zh.wikipedia.org/wiki/%s:%s "wikilink")`'`
`       end`

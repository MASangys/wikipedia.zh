> 本文内容由[模块:Fun](https://zh.wikipedia.org/wiki/模块:Fun)转换而来。
...
local _checkCache = {} local function _check(funcName, expectType)
...
\-- Fancy stuff local function capture(...)
...
\-- shared metatable local mt = { __call = callMethod }

\-- Create callable table. function p.memoize(func)

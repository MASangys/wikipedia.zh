...
\-- Module:Hatnote-inline -- -- -- -- This module produces hatnote-style
links and links to related articles, -- -- but inside a <span>, instead
of the
...
local mHatnote = require('Module:Hatnote') local mArguments =
require('Module:Arguments') local yesno = require('Module:Yesno') local
p = {}

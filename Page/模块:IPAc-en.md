...
`           '`[`Speakerlink-new.svg`](https://zh.wikipedia.org/wiki/File:Speakerlink-new.svg "fig:Speakerlink-new.svg")`',`
`           getFilepath(file)`
`       ))`
`       :tag('sup')`
`           :tag('span')`
...
`               :css('padding', '0 .1em')`
`               :addClass('IPA')`
`               :wikitext(string.format('`[`i`](https://zh.wikipedia.org/wiki/:File:%s "wikilink")`', file))`
`   return tostring(span)`
...
`           :wikitext(string.format(`
`               '`[`%s`](https://zh.wikipedia.org/wiki/Help:英語國際音標 "wikilink")`',`
`               table.concat(words)`
`           ))`

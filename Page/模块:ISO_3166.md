\-- to enable us to replicate the current functioning of Country
extract, we need to deal with: -- 2 {{<name>}} DONE\! -- 3
[<name>](https://zh.wikipedia.org/wiki/\<name\> "wikilink") DONE\! -- 4
[<junk>](https://zh.wikipedia.org/wiki/\<name\> "wikilink") DONE\! -- 5
[gif](https://zh.wikipedia.org/wiki/image:flag_of_\<country\>.[svg "wikilink")
DONE\!

local p = {} local getArgs = require("Module:Arguments").getArgs local
data = mw.loadData("Module:ISO 3166/data/National")

\--[----------F I N D N A M
E----------](https://zh.wikipedia.org/wiki/----------F_I_N_D_N_A_M_E---------- "wikilink")--
...
\--[----------I S O N A M
E----------](https://zh.wikipedia.org/wiki/----------I_S_O_N_A_M_E---------- "wikilink")--
...
\--[----------S T R I
P----------](https://zh.wikipedia.org/wiki/----------S_T_R_I_P---------- "wikilink")--
-- Removes junk from the input
...
\--[----------P . C A L L S T R I P
---------](https://zh.wikipedia.org/wiki/----------P_._C_A_L_L_S_T_R_I_P_--------- "wikilink")--
-- Calls P.strip but using Module:Arguments
...
\--[----------P . L U A C O D
E---------](https://zh.wikipedia.org/wiki/----------P_._L_U_A_C_O_D_E--------- "wikilink")--
...
\--[----------P . C O D
E---------](https://zh.wikipedia.org/wiki/----------P_._C_O_D_E--------- "wikilink")--
-- Calls P.Luacode but using Module:Arguments
...
\--[----------P . N U M E R I
C---------](https://zh.wikipedia.org/wiki/----------P_._N_U_M_E_R_I_C--------- "wikilink")--
-- Calls P.Luacode but using Module:Arguments and setting it to output a
numeric value
...
\--[----------P . L U A N A M
E---------](https://zh.wikipedia.org/wiki/----------P_._L_U_A_N_A_M_E--------- "wikilink")--
-- Makes the ISO/common name of a country
...
\--[----------P . N A M
E---------](https://zh.wikipedia.org/wiki/----------P_._N_A_M_E--------- "wikilink")--
-- Calls P.Luaname but using Module:Arguments
...
\--[----------P . G E O C O O R D I N S E R
T---------](https://zh.wikipedia.org/wiki/----------P_._G_E_O_C_O_O_R_D_I_N_S_E_R_T--------- "wikilink")--
-- Wrapper for Module:Coordinates.coordinsert function
p.geocoordinsert(frame)
...
[Category:使用未识别行政区名称的页面](https://zh.wikipedia.org/wiki/Category:使用未识别行政区名称的页面 "wikilink")
[Category:使用未识别国名的页面](https://zh.wikipedia.org/wiki/Category:使用未识别国名的页面 "wikilink")
[Category:使用未识别国名的页面](https://zh.wikipedia.org/wiki/Category:使用未识别国名的页面 "wikilink")
[Category:使用未识别国名的页面](https://zh.wikipedia.org/wiki/Category:使用未识别国名的页面 "wikilink")
[Category:使用未识别国名的页面](https://zh.wikipedia.org/wiki/Category:使用未识别国名的页面 "wikilink")

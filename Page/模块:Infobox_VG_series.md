> 本文内容由[模块:Infobox VG series](https://zh.wikipedia.org/wiki/模块:Infobox_VG_series)转换而来。
...
`               list['data'..i] = args['latest release version'] .. '`
`' .. args['latest release date']`
`               break`
`           end`
`       end`
`   end`
...
`               list['data'..i] = args['first release version'] .. '`
`' .. args['first release date']`
`               break`
`           end`
`       end`
`   end`

...
`local hs_link = "`[`檢視/編輯``
 ``人類`](https://zh.wikipedia.org/wiki/d:"..Qid.." "wikilink")`" -- localization required!`
`local mm_link = ""`
`local link_no_hs`
`local link_no_mm`
...
`   link_no_hs = 2`
`   mm_link = "`[`檢視/編輯``
 ``小鼠`](https://zh.wikipedia.org/wiki/d:"..Qid_mm.." "wikilink")`" -- localization required!`
`end`
...
`                       out[#out + 1] = "`[`"``   ``..``   ``label``
 ``..``
 ``"`](https://zh.wikipedia.org/wiki/:d:Q"_.._v.mainsnak.datavalue.value_.._" "wikilink")`"`
`                   end`
`               end`
...
`                   out[#out + 1] = "`[`"``   ``..``   ``datav``
 ``..``
 ``"`](https://zh.wikipedia.org/wiki/:d:"_.._id_.._" "wikilink")`"`
`               end`

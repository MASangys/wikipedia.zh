...
`           return string.format("`[`%spx`](https://zh.wikipedia.org/wiki/File:%s "fig:%spx")`", shield, size)`
`       else`
`           args.shielderr = true`
...
\-- Links/abbreviations local function link(args)
...
`           return abbr`
`       else`
`           return mw.ustring.format("`<span class=\"nowrap\">[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")</span>`", link, abbr)`
`       end`
`   end`
...
`       local page = mw.title.getCurrentTitle().prefixedText -- Get transcluding page's title`
`       actualLink = string.format("`<span class=\"error\">`Invalid type: %s`</span>`", args.type, page)`
`   end`
`   local isTo = args.to`
`   local prefix`
`   if num == 1 then`
...
`               insert(secondRun, format("`[`%spx`](https://zh.wikipedia.org/wiki/File:No_image_wide.svg "fig:%spx")`", width))`
...
`               insert(secondRun, format("`[`%spx`](https://zh.wikipedia.org/wiki/File:No_image_wide.svg "fig:%spx")`", pixels))`
`           end`
`       else`
`           local widthCode = parser(v, 'width') or 'square'`
`           if widthCode == 'square' then`
`               insert(secondRun, format("`[`%s`](https://zh.wikipedia.org/wiki/File:%s "fig:%s")`", bannerFile))`
`           elseif widthCode == 'expand' then`
`               local route = v.route`
`               if #route >= 3 then`
`                   insert(secondRun, format("`[`No_image.svg`](https://zh.wikipedia.org/wiki/File:No_image.svg "fig:No_image.svg")[`%s`](https://zh.wikipedia.org/wiki/File:%s "fig:%s")[`No_image.svg`](https://zh.wikipedia.org/wiki/File:No_image.svg "fig:No_image.svg")`", bannerFile))`
`               else`
`                   insert(secondRun, format("`[`%s`](https://zh.wikipedia.org/wiki/File:%s "fig:%s")`", bannerFile))`
`               end`
`           elseif widthCode == 'wide' then`
...
`               end`
`           elseif widthCode == 'US1926' then`
`               insert(secondRun, format("`[`%s`](https://zh.wikipedia.org/wiki/File:%s "fig:%s")[`No_image.svg`](https://zh.wikipedia.org/wiki/File:No_image.svg "fig:No_image.svg")`", bannerFile))`

...
`       row:wikitext("1.000英里＝1.609公里；1.000公里＝0.621英里`
`")`
`   end`
`   `
...
`       row:wikitext(string.format("", pagename))`
`   end`
`   `
...
[Category:Jctbtm_temporary_tracking_category](https://zh.wikipedia.org/wiki/Category:Jctbtm_temporary_tracking_category "wikilink")
...
`   ['cmd'] = '⌘ Cmd',`
`   ['`[`cmd`](https://zh.wikipedia.org/wiki/command_key "wikilink")`'] = '⌘ `[`Cmd`](../Page/Command键.md "wikilink")`',`
`   ['command'] = '⌘ Command',`
`   ['`[`command`](https://zh.wikipedia.org/wiki/command_key "wikilink")`'] = '⌘ `[`Command`](../Page/Command键.md "wikilink")`',`
`   ['opt'] = '⌥ Opt',`

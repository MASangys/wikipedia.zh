...
`   -- raw is the string without the Wikiformatting so that it correctly analyses the string that is `[`Italie`](https://zh.wikipedia.org/wiki/:fr:Italie "wikilink")` -> 'italie'`

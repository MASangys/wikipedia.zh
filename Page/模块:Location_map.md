...
`       '%s`[`%spx`](https://zh.wikipedia.org/wiki/File:%s "fig:%spx")`',`
`       retval,`
`       image,`
`       width,`
...
[File:'_.._getContainerImage(args,_map)_.._'](https://zh.wikipedia.org/wiki/:File:'_.._getContainerImage\(args,_map\)_.._' "wikilink")
...
`           '`[`%dx%dpx`](https://zh.wikipedia.org/wiki/File:%s "fig:%dx%dpx")`',`
`           mark,`
`           marksize,`
`           marksize,`
`           label,`

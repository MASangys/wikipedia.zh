...
`                   talkText = format('%s`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`.', talkText, talk, talkTitle.prefixedText)`
`               else`
`                   talkText = format('%s`[`討論頁`](https://zh.wikipedia.org/wiki/%s#%s "wikilink")`.', talkText, talkTitle.prefixedText, talk)`
`               end`
`               self.talk = talkText`
`           end`
`       end`
...
`           self.imageLeft = format('`[`%s`](https://zh.wikipedia.org/wiki/File:%s "fig:%s")`', self.typeImage or 'Imbox notice.png', imageSize)`
`       end`
`   end`
...
`               :addClass('error')`
`               :wikitext(format(`
`                   '模板%s`[`%s`](https://zh.wikipedia.org/wiki/Template:%s "wikilink")`%s被錯誤地替代。',`

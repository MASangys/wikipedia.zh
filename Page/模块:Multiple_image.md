...
image](https://zh.wikipedia.org/wiki/template:multiple_image "wikilink")
local p = {}
...
`   imagediv:wikitext('`[`file:'``   ``..``   ``image``   ``..``
 ...
 ``thumbtimestr``   ``..``
 ``'`](https://zh.wikipedia.org/wiki/file:'_.._image_.._widthstr_.._linkstr_.._altstr_.._thumbtimestr_.._' "wikilink")`')`

...
`   return '`[`讨论`](https://zh.wikipedia.org/wiki/'_.._tostring\(p.talkPageTitle\)_.._' "wikilink")`'`
...
`   return '`[`相关`](https://zh.wikipedia.org/wiki/Special:RelatedChanges/'_.._p.fullText_.._' "wikilink")`'`
...
<table class="wikitable plainlinks sortable">
...
[Category:有错误的PageLinks嵌入](https://zh.wikipedia.org/wiki/Category:有错误的PageLinks嵌入 "wikilink")
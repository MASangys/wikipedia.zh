...
p.getUsers = function ( text, sort, unique )
...
p.getSections = function( text, header_level )
...
p.formatSectionLink = function( root, text )
...
p.formatDateDiff = function( date_diff )
...
p.getExcerpt = function( text, length )

...
<div class="transborder" style="position:absolute;width:'..radius..'px;line-height:0px;'..lr..':'..lrv..'px;top:'..tv..'px;border-width:'..bw1..'px '..bw2..'px '..bw3..'px '..bw4..'px;border-'..bd..'color:'..color..';">
...
['..(radius\*2)..'px](https://zh.wikipedia.org/wiki/File:Circle_frame.svg "fig:'..(radius*2)..'px")<Module:Plotter internal imgmap insertion token>
...
`           output = output .. `[<span style="position:absolute;left:]] .. plotx .. [[px;_top:|px; top:]] .. ploty .. [[px;">`|px;">`](https://zh.wikipedia.org/wiki/\<span_style="position:absolute;left: "wikilink")` .. icon .. "`</span>`"`
`           lastx = plotx`
`           lasty = ploty`
`       end`
`       index = 3`
...
`                 output = output .. `[<span style="position:absolute;left:]] .. lastx+linefix+math.floor(delx*(plotparm/plotdist)) .. [[px;_top:|px; top:]] .. lasty+linefix+math.floor(dely*(plotparm/plotdist)) .. [[px;">`|px;">`](https://zh.wikipedia.org/wiki/\<span_style="position:absolute;left: "wikilink")` .. lineicon .. "`</span>`"`

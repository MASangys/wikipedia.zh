...
`                   :tag( 'span' )`
`                       :css( 'margin', '0 0.5em' )`
`                       :wikitext( string.format( '`[`%s`](https://zh.wikipedia.org/wiki/File:%s "fig:%s")`', getImageName{ portal } ) )`
`                       :done()`
`                   :wikitext( string.format( '`[`%s主题`](https://zh.wikipedia.org/wiki/Portal:%s "wikilink")`', portal, portal ) )`
`   end`
`   `
`   nav`
`       :node( list )`

> 本文内容由[模块:RFX report](https://zh.wikipedia.org/wiki/模块:RFX_report)转换而来。
...
`       '\n|-\n|%s `[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`%s%s%s %s',`
...
`       '\n|-\n! colspan="9" style="text-align: center;" | `[`申请成为管理人员`](https://zh.wikipedia.org/wiki/Wikipedia:申请成为管理人员 "wikilink")<span class="plainlinks" style="float: right;"><small>`[%s 刷新]`</small></span>`',`
`       purgeLink`
`   )`
`   local rows = makeReportRows() or ''`
`   if rows == '' then`
`       rows = '\n|-\n| colspan="10" | 当前没有提名。请参阅`[`最近的管理人员任免记录`](https://zh.wikipedia.org/wiki/Wikipedia:管理人員任免記錄 "wikilink")`。'`
`   end`
...
`       return string.format('`[`%d`](https://zh.wikipedia.org/wiki/%s#支持 "wikilink")`%s`[`%d`](https://zh.wikipedia.org/wiki/%s#反對 "wikilink")`%s`[`%d`](https://zh.wikipedia.org/wiki/%s#中立 "wikilink")`',`

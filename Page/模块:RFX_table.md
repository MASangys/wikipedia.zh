...
`       '\n|-\n|%s `[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`%s%s%s\n| style="text-align: center;%s" | %s%s',`
...
`       '\n|-\n! colspan="10" style="text-align: center;" | Requests for `[`adminship`](https://zh.wikipedia.org/wiki/Wikipedia:Requests_for_adminship "wikilink")` and `[`bureaucratship`](https://zh.wikipedia.org/wiki/Wikipedia:Requests_for_bureaucratship "wikilink")<span class="plainlinks" style="float: right;"><small>`[%s update]`</small></span>`',`
`       purgeLink`
`   )`
`   local rows = makeReportRows( args ) or ''`
`   if rows == '' then`
`       rows = '\n|-\n| colspan="10" | No current discussions. `<small>`Recent RfAs: (`[`successful`](https://zh.wikipedia.org/wiki/Wikipedia:Successful_requests_for_adminship "wikilink")`, `[`unsuccessful`](https://zh.wikipedia.org/wiki/Wikipedia:Unsuccessful_adminship_candidacies_\(Chronological\) "wikilink")`) Recent RfBs: (`[`successful`](https://zh.wikipedia.org/wiki/Wikipedia:Successful_bureaucratship_candidacies "wikilink")`, `[`unsuccessful`](https://zh.wikipedia.org/wiki/Wikipedia:Unsuccessful_bureaucratship_candidacies "wikilink")`)`</small>`'`
`   end`

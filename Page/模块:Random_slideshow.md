...
<div class="' .. containerClassName .. '" style="max-width:' .. normaliseCssMeasurement(maxWidth) .. '; margin:-4em auto;">

{{\#tag:gallery|' .. galleryContent .. '|mode=slideshow}}
...
`   local creditLine = ( credit and '`

<span style="font-size:88%">' .. credit .. '</span>
...
`   local gallery = mw.ustring.match(wikitext, '<gallery.->%s*(.-)%s*`

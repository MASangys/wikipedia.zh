...
} local rfx = {} local corrections = require('Module:Rfx/correction')
...
`   --- See `[`special:permalink/45633636`](https://zh.wikipedia.org/wiki/special:permalink/45633636 "wikilink")`.`
...
`       end`
`       -- === `[`Nickname`](https://zh.wikipedia.org/wiki/User:Example "wikilink")` ===`
`       data.user = umatch(introText, '===%s*%[%[[_%s]*[uU]ser[_%s]*:[_%s]*([^\n]-)|[^\n]-%]%]%s*===') or`
`       -- === `[`Nickname`](https://zh.wikipedia.org/wiki/U:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*[uU][_%s]*:[_%s]*([^\n]-)|[^\n]-%]%]%s*===') or`
`       -- === `[`Nickname`](https://zh.wikipedia.org/wiki/用户:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*用户[_%s]*:[_%s]*([^\n]-)|[^\n]-%]%]%s*===') or`
`       -- === `[`Nickname`](https://zh.wikipedia.org/wiki/用戶:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*用戶[_%s]*:[_%s]*([^\n]-)|[^\n]-%]%]%s*===') or`
`       -- === `[`User:Example`](https://zh.wikipedia.org/wiki/User:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*[uU]ser[_%s]*:[_%s]*([^\n]-)%]%]%s*===') or`
`       -- === `[`U:Example`](https://zh.wikipedia.org/wiki/U:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*[uU][_%s]*:[_%s]*([^\n]-)%]%]%s*===') or`
`       -- === `[`用户:Example`](https://zh.wikipedia.org/wiki/用户:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*用户[_%s]*:[_%s]*([^\n]-)%]%]%s*===') or`
`       -- === `[`用戶:Example`](https://zh.wikipedia.org/wiki/用戶:Example "wikilink")` ===`
`       umatch(introText, '===%s*%[%[[_%s]*用戶[_%s]*:[_%s]*([^\n]-)%]%]%s*===') or`
`       -- === User:Example ===`

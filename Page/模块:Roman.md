> 本文内容由[模块:Roman](https://zh.wikipedia.org/wiki/模块:Roman)转换而来。
...
\-- This function implements the  template. local function overline(s)
...
`   --for `[`模块:PeriodicTable`](../Page/模块:PeriodicTable.md "wikilink")

...
<div style="display:inline-block; text-align: ##BLOCK_ALIGN##; vertical-align:middle;">
...
`           '`[`东环南路`](../Page/东环南路站.md "wikilink")` - `[<span style="color:gray">`邱隘东`</span>](../Page/邱隘东站.md "wikilink")` - `[<span style="color:gray">`宝幢`</span>](../Page/宝幢站_\(地铁\).md "wikilink")` - `[`邬隘`](../Page/邬隘站_\(地铁\).md "wikilink")`'`
`       },`
`       {`
...
`           '`<span class="nowrap">`（`[`高桥西方向`](https://zh.wikipedia.org/wiki/高桥西站_\(宁波\) "wikilink")`）`[`东环南路`](../Page/东环南路站.md "wikilink")</span>` - `[`霞浦`](https://zh.wikipedia.org/wiki/霞浦站_\(宁波\) "wikilink")` - `[`右边`](https://zh.wikipedia.org/wiki/左边站 "wikilink")` - 原来的东西'`
`       },`
`   }`

...
\-- Identical to p.msg() above, but used from other lua modules function
p.format(dataset, key, params, lang)
...
\-- Given a dataset name, convert it to a title with the 'commons:data:'
prefix link = function(dataset)

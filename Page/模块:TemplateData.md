...
`           r = string.format( "%s`[Category:%s](https://zh.wikipedia.org/wiki/Category:%s "wikilink")`",`
`                              r,`
`                              Config.strange )`
`       end`
`   else`
...
`       code:addClass( "error" )`
`       Fault( string.format( "Bad ID params.%s", access ) )`
`       legal = false`
...
`       end -- for k, v`
`       if lapsus then`
`           s = string.format( "params.%s.aliases", access )`
...
`                   if show == "0" then`
`                       dd:wikitext("<span style=\"color: #610; font-weight: bold;\">False`</span>` (0)")`
`                   elseif show == "1" then`
`                       dd:wikitext("<span style=\"color: #050; font-weight: bold;\">True`</span>` (1)")`
`                   else`
`                       dd:wikitext( show )`
`                   end`
`               else`
...
`                :wikitext( "INVALID" )`
`           s = string.format( "params.%s.type", access )`
`           Fault(  getLocalizedText( "invalid-value" ):gsub( "$1", s )  )`
`           legal = false`
`       end`
`   else`

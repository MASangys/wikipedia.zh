...
ago](../Page/Template:Time_ago.md "wikilink") local numberSpell =
require('Module:NumberSpell')._main local yesno =
require('Module:Yesno')

local p = {}

\-- Table to convert entered text values to numeric values. timeText = {

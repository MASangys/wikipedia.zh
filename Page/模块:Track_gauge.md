...
`   local ft = tgEntry.ft`
`   if ft then`
`       local ftlink = addUnitlink and measurementToLink ~= 'imp' and '`[`ft`](https://zh.wikipedia.org/wiki/Foot_\(unit\) "wikilink")`' or 'ft'`
...
`       local incheslink = addUnitlink and measurementToLink ~= 'imp' and '`[`in`](https://zh.wikipedia.org/wiki/inch "wikilink")`' or 'in'`
...
`       return mw.ustring.format('`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`', tgEntry.pagename, gaugeSize)`
`   else`
`       return gaugeSize`
`   end`
...
`   local gaugeSize`
`   if m then`
`       local mUnit = addUnitlink and measurementToLink ~= 'met' and '`[`m`](https://zh.wikipedia.org/wiki/metre "wikilink")`' or 'm'`
...
`       end`
`       local mmUnit = addUnitlink and measurementToLink ~= 'met' and '`[`mm`](https://zh.wikipedia.org/wiki/millimetre "wikilink")`' or 'mm'`
...
`       -- switched off per `[`Wikipedia:Categories_for_discussion/Log/2016_December_6#Category:Articles_that_mention_a_specific_track_gauge`](https://zh.wikipedia.org/wiki/Wikipedia:Categories_for_discussion/Log/2016_December_6#Category:Articles_that_mention_a_specific_track_gauge "wikilink")
`       -- 2016-12-19`

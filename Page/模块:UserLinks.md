...
`   -- at `[`Module:UserLinks/extra`](https://zh.wikipedia.org/wiki/Module:UserLinks/extra "wikilink")`.`
`   --]=]`
...
`   -- functions from `[`Module:UserLinks/extra`](https://zh.wikipedia.org/wiki/Module:UserLinks/extra "wikilink")` if necessary.`

`   -- Lazily initialise the extraLinkFunctions table. We only want to load`
`   -- `[`Module:UserLinks/extra`](https://zh.wikipedia.org/wiki/Module:UserLinks/extra "wikilink")` as necessary, so it has a low transclusion`
`   -- count.`
...
`   -- `[`Module:InterwikiTable`](https://zh.wikipedia.org/wiki/Module:InterwikiTable "wikilink")`. The data is loaded as necessary and memoized`
...
`   -- `[`Module:InterwikiTable`](https://zh.wikipedia.org/wiki/Module:InterwikiTable "wikilink")`. If it is present, returns the code and the`
...
`   -- The main function. This is the one called from `[`Template:User-multi`](https://zh.wikipedia.org/wiki/Template:User-multi "wikilink")`,`
`   -- via p.main.`

...
`                   sandboxLink = string.format('​（`[`沙盒`](https://zh.wikipedia.org/wiki/:%s "wikilink")`）', tsSandboxTitle.prefixedText)`
`               end`
`           end`
`           tStylesLinks[i] = string.format('`[`:%s`](https://zh.wikipedia.org/wiki/:%s "wikilink")`%s', ts, sandboxLink or '')`
`       end`
...
`           '使用以下`[`模板样式`](https://zh.wikipedia.org/wiki/Wikipedia:模板样式 "wikilink")`：\n' .. tStylesList`
`   end`
`   boxArgs.type = 'notice'`
`   boxArgs.small = true`
`   boxArgs.image = '`[`Farm-Fresh_css_add.svg`](https://zh.wikipedia.org/wiki/File:Farm-Fresh_css_add.svg "fig:Farm-Fresh_css_add.svg")`'`

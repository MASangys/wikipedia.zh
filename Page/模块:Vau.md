...
<strong class="error" style="background:#fff; margin:0 ' .. (#tostring(mw.title.getCurrentTitle()) * 0.6 + 11.8) .. 'em;">[<span style="color:#c00;">Template:Vau</span>发生了调用错误](https://zh.wikipedia.org/wiki/Template:Vau "wikilink")</strong>
...
`       else`
`           -- 阅读`
`           return '`<span class="vau-error">`' .. noref .. '`</span>`', ''`
`       end`
`   else`
...
[Category:模板参数错误的页面/Template:Vau](https://zh.wikipedia.org/wiki/Category:模板参数错误的页面/Template:Vau "wikilink")
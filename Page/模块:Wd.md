...
\-- allows for recursive calls function Config.new()
...
\-- level 1 hook function State:getProperty(claim)
...
\-- level 1 hook function State:getQualifiers(claim, param)
...
\-- level 2 hook function State:getQualifier(snak)
...
\-- level 1 hook function State:getReferences(claim)
...
\-- level 2 hook function State:getReference(statement)
...
\-- level 1 hook function State:getAlias(object)
...
\-- level 1 hook function State:getBadge(value)

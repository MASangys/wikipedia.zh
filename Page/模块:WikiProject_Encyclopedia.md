...
\-- 取得百科全書的書名 function z.get_book(frame)
...
\-- 取得百科全書的章節名 function z.get_chapter(frame)
...
\-- 根據百科全書連結和標題產生說明文字 function z.get_ref_desc(frame)
...
\-- 根據百科全書連結產生分類。 function z.get_ref_cat(frame)

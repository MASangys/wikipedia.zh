> 本文内容由[模块:WikiProject sidebar](https://zh.wikipedia.org/wiki/模块:WikiProject_sidebar)转换而来。
...
`           :wikitext('`[`Replacement_filing_cabinet.svg`](https://zh.wikipedia.org/wiki/File:Replacement_filing_cabinet.svg "fig:Replacement_filing_cabinet.svg")
[`存档`](https://zh.wikipedia.org/wiki/Wikipedia:存档 "wikilink")`')`
`               `
...
`   header:tag('td')`
`       :css('width' ,'48px')`
`       :wikitext('`[`'_.._args.icon_.._'`](https://zh.wikipedia.org/wiki/File:'_.._args.icon_.._' "fig:'_.._args.icon_.._'")`')  `
`   header:tag('td')`
...
`       :wikitext(' 编辑]')`
`   bottom:tag('li'):wikitext('`[`变动`](https://zh.wikipedia.org/wiki/Special:RecentChangesLinked/Wikipedia:'_.._args.link_.._' "wikilink")`')`
`   `
`   return ret`

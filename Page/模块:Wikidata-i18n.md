> 本文内容由[模块:Wikidata-i18n](https://zh.wikipedia.org/wiki/模块:Wikidata-i18n)转换而来。
...
[Category:在Wikidata模块中使用了Dump函数](https://zh.wikipedia.org/wiki/Category:在Wikidata模块中使用了Dump函数 "wikilink")
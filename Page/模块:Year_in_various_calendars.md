...
`   if display then`
`       self.link = string.format( '`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`', link, display )`
`   else`
`       self.link = string.format( '`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`', link )`
`   end`
...
`   -- Set the caption.`
`   box:setCaption( box.caption .. '年在多个`[`历法中的表示`](../Page/纪年.md "wikilink")`' )`
...
`       gregorian.yearLink = string.format( '`[`%s`](https://zh.wikipedia.org/wiki/%s "wikilink")`', gregcal, yearText )`
`   else`
...
`               `[`%s`
<span style="font-family: serif;">*`%s`*</span>](https://zh.wikipedia.org/wiki/%s\<br_/\>\<span_style="font-family:_serif;"\>''%s''\</span\> "wikilink")`,`
...
`       armenian:setYear( string.format( '%s`
`ԹՎ %s', armenianYear, numToArmenian( armenianYear ) ) )`
...
`       { '子', '`[`子`](https://zh.wikipedia.org/wiki/子_\(地支\) "wikilink")`' },           -- 1`
`       { '丑', '`[`丑`](https://zh.wikipedia.org/wiki/丑_\(地支\) "wikilink")`' },             -- 2`
`       { '寅', '`[`寅`](https://zh.wikipedia.org/wiki/寅 "wikilink")`' },       -- 3`
`       { '卯', '`[`卯`](https://zh.wikipedia.org/wiki/卯 "wikilink")`' },     -- 4`
`       { '辰', '`[`辰`](https://zh.wikipedia.org/wiki/辰 "wikilink")`' },     -- 5`
`       { '巳', '`[`巳`](https://zh.wikipedia.org/wiki/巳 "wikilink")`' },       -- 6`
`       { '午', '`[`午`](https://zh.wikipedia.org/wiki/午 "wikilink")`' },       -- 7`
`       { '未', '`[`未`](https://zh.wikipedia.org/wiki/未 "wikilink")`' },         -- 8`
`       { '申', '`[`申`](https://zh.wikipedia.org/wiki/申_\(地支\) "wikilink")`' },     -- 9`
`       { '酉', '`[`酉`](https://zh.wikipedia.org/wiki/酉 "wikilink")`' },   -- 10`
`       { '戌', '`[`戌`](https://zh.wikipedia.org/wiki/戌 "wikilink")`' },           -- 11`
`       { '亥', '`[`亥`](https://zh.wikipedia.org/wiki/亥 "wikilink")`' }            -- 12`
`   }`
...
`           [=`[`%s%s年`](https://zh.wikipedia.org/wiki/[干支 "wikilink")` `<small>`(%s %s)`</small>
`%s / %s`
`    — 至 —`
`%s%s年 `<small>`(%s %s)`</small>
`%s / %s]=],`
`           heavenlyTable1[ 1 ],`
`           earthlyTable1[ 1 ],`
`           heavenlyTable1[ 2 ],`
...
`   local hindu = calendarGroup:new{ heading = '`[`印度曆`](https://zh.wikipedia.org/wiki/印度曆 "wikilink")`' }`
...
`       minguo:setYear( string.format( '`[`民國`](https://zh.wikipedia.org/wiki/中华民国 "wikilink")`%d年', minguoYear ) )`
`   elseif year > 1911 then`
`       local minguoYear = year - 1911`
`       minguo:setYear( string.format( '`[`民國`](https://zh.wikipedia.org/wiki/中华民国_\(大陆时期\) "wikilink")`%d年', minguoYear ) )`
`   else`
...
`           addtext = string.format( '`[`AG`](https://zh.wikipedia.org/wiki/塞琉古纪年 "wikilink")`') -- 英文 Anno Graecorum`
...
`           [=[%s`[`%s年`](https://zh.wikipedia.org/wiki/生肖 "wikilink")
`%s / %s / %s`
`    — 至 —`
`%s%s年`
`%s / %s / %s]=],`
...
`       if year == 2039 then`
`           -- Y2K38 bug`
`           return "`[`-2117492897`](../Page/2038年问题.md "wikilink")`"`
`       end`

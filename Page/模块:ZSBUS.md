> 本文内容由[模块:ZSBUS](https://zh.wikipedia.org/wiki/模块:ZSBUS)转换而来。


\-- 声明模块本体 local p = {} -- 导入数据 local c = mw.loadData('Module:ZSBUS/color') local function _loadSystemData(loc)

`   local state`
`   if loc == nil or loc == "" or loc == "中山" then`
...
`   if d[no] == nil then`
`       a = `[`width="1%"`](https://zh.wikipedia.org/wiki/ "wikilink")`..no..`[](https://zh.wikipedia.org/wiki/''' "wikilink")`..'`[`Module:ZSBUS中未包含这条`](https://zh.wikipedia.org/wiki/Module:ZSBUS "wikilink")[`"..loc.."的线路`](https://zh.wikipedia.org/wiki/'..loc.."巴士路线列表 "wikilink")`）''"`
...
`       if d[no].frequency == "" or d[no].frequency == nil then`
`           freq = "（暂时未知）"`
`       else`
`           freq = d[no].frequency`
`       end`
...
](https://zh.wikipedia.org/wiki/\<br_/\> "wikilink")`..t2..`[](https://zh.wikipedia.org/wiki/ "wikilink")`..freq`
`           else`
...
`   local bb = frame.args`
`   local loc = bb.loc`
`   if loc == "" or loc == nil then loc = "中山" end`
`   local time = bb.time`
...
`   local d = _loadSystemData(loc)`
`   if d[no] == nil then`
`       a = `[`align=center`](https://zh.wikipedia.org/wiki/ "wikilink")`..no..`[](https://zh.wikipedia.org/wiki/''' "wikilink")`..'`[`Module:ZSBUS中未包含这条`](https://zh.wikipedia.org/wiki/Module:ZSBUS "wikilink")[`"..loc.."的线路`](https://zh.wikipedia.org/wiki/'..loc.."巴士路线列表 "wikilink")`）''"`
`   elseif d[no].note == "已停办" or d[no].note == "已停辦" then`
...
`       if style == "noco" then                                 -- 不显示公司栏（noco）`
`           t = '!rowspan="2" colspan="2" width="14%"|`[`编号`](https://zh.wikipedia.org/wiki/'..loc..'巴士路线列表 "wikilink")`!!colspan="3"|起讫点'..'!!rowspan="2" width="8%"|发车间隔!!rowspan="2" width="8%"|全程票价!!rowspan="2" width="20%"|备注\n|-style="background:#EAECF0" height=0\n!width="24%"|发车时间!! !!width="24%"|发车时间'`
`       elseif style == "nofa" then                             -- 不显示票价栏（nofa）`
`           t = '!rowspan="2" colspan="2" width="14%"|`[`编号`](https://zh.wikipedia.org/wiki/'..loc..'巴士路线列表 "wikilink")`!!colspan="3"|起讫点'..'!!rowspan="2" width="8%"|发车间隔!!rowspan="2" width="8%"|运营商!!rowspan="2" width="20%"|备注\n|-style="background:#EAECF0" height=0\n!width="24%"|发车时间!! !!width="24%"|发车时间'`
`       elseif style == "nocofa" then                           -- 不显示公司和票价栏（nocofa）`
`           t = '!colspan="2" rowspan="2" width="15%"|`[`编号`](https://zh.wikipedia.org/wiki/'..loc..'巴士路线列表 "wikilink")`!!colspan="3"|起讫点'..'!!rowspan="2" width="11%"|发车间隔!!rowspan="2" width="20%"|备注\n|-style="background:#EAECF0" height=0\n!width="26%"|发车时间!! !!width="26%"|发车时间'`
`       else                                                    -- 显示公司和票价栏（默认）`
`           t = '!colspan="2" rowspan="2" width="12%"|`[`编号`](https://zh.wikipedia.org/wiki/'..loc..'巴士路线列表 "wikilink")`!!colspan="3"|起讫点'..'!!rowspan="2" width="8%"|发车间隔!!rowspan="2" width="8%"|全程票价!!rowspan="2" width="8%"|运营商!!rowspan="2" width="18%"|备注\n|-style="background:#EAECF0" height=0\n!width="22%"|发车时间!! !!width="22%"|发车时间'`
`       end`
`   else                                                        -- 不显示时间`
`       if style == "noco" then                                 -- 不显示公司栏（noco）`

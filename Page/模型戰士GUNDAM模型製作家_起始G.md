...
與以往的「[GUNDAM系列](https://zh.wikipedia.org/wiki/高達系列作品 "wikilink")」動畫不同，是以將GUNDAM系列作品中的兵器立體化的塑膠模型產品，通稱「GUNPLA」的系列為主題的作品\[1\]。
...
## 主題歌
  ...
  - 『my Proud,my Play！』
    主唱：[KAmiYU](https://zh.wikipedia.org/wiki/KAmiYU "wikilink")（[神谷浩史](../Page/神谷浩史.md "wikilink")、[入野自由](../Page/入野自由.md "wikilink")）
    作詞：[畑亞貴](../Page/畑亞貴.md "wikilink")、作曲：[黑須克彥](https://zh.wikipedia.org/wiki/黑須克彥 "wikilink")、編曲：[增田武史](https://zh.wikipedia.org/wiki/增田武史 "wikilink")

## 登場人物

  -
    本作的主角。以與起始鋼彈的邂逅為契機，成為了製作模型的「鋼彈模型製作家」。之後遇見了強大的對手並逐漸成長。(使用模型：初始高達，初始高達30)
  -
    晴的朋友，是位個性活潑的女孩。同樣也對GUNDAM模型有興趣。(使用模型：熊霸)
  -
    晴的朋友，是個喜歡GUNDAM模型的少年。會對晴提供製作GUNDAM模型的建議。經常光顧可以進行GUNDAM模型大戰的模型店。(使用模型：白式，沙煞比\[白色塗裝\])
  -
    是位偶像的鋼彈模型製作家。小晴的對手。(使用模型：超級特裝渣古F2000)
  -
    神秘的鋼彈模型製作家。(使用模型：永恆高達)
  -
    晴們經常光顧的模型店的店長。

在数学上，**模形式**（Modular
form）是一种解析函数，这种函数的只接受来自[复数平面内](https://zh.wikipedia.org/wiki/复数平面 "wikilink")[上半平面中的值](https://zh.wikipedia.org/wiki/上半平面 "wikilink")，并且这种函数在一個在的[群运算之下](../Page/群作用.md "wikilink")，会变成某种类型的函数方程，并且通过函数计算出的值也会呈现出某个增长趋势。模形式理論屬於[数论的範疇](../Page/数论.md "wikilink")。模形式也出現在其他領域，例如[代數拓撲和](https://zh.wikipedia.org/wiki/代數拓撲 "wikilink")[弦理論](../Page/弦理論.md "wikilink")。
...
例如，可以去掉全純條件：是[上半平面的](https://zh.wikipedia.org/wiki/上半平面 "wikilink")[拉普拉斯算子的特徵函數](../Page/拉普拉斯算子.md "wikilink")，但並非全純函數。

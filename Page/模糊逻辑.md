...
模糊逻辑尽管被广泛接受却是有争议的：它被某些[控制工程师出于有效性和其他原因](https://zh.wikipedia.org/wiki/控制论 "wikilink")，和一些坚持[概率论是](https://zh.wikipedia.org/wiki/概率论 "wikilink")[不确定性的唯一严格描述的](https://zh.wikipedia.org/wiki/不确定性 "wikilink")[统计学](../Page/统计学.md "wikilink")家所拒绝。批評者認為它不是[普通集合论的超集](https://zh.wikipedia.org/wiki/普通集合论 "wikilink")，因为成员函数是依据[常规集合而定义的](https://zh.wikipedia.org/wiki/常规集合 "wikilink")。
...
[Category:模糊邏輯](https://zh.wikipedia.org/wiki/Category:模糊邏輯 "wikilink") [Category:人工智能](https://zh.wikipedia.org/wiki/Category:人工智能 "wikilink") [Category:计算机逻辑](https://zh.wikipedia.org/wiki/Category:计算机逻辑 "wikilink")
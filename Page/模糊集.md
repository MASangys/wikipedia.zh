**模糊集**是[模糊数学上的一个基本概念](../Page/模糊数学.md "wikilink")，是[数学上普通](../Page/数学.md "wikilink")[集合的扩展](https://zh.wikipedia.org/wiki/集合 "wikilink")。
...
参见[集合代数和](../Page/集合代数.md "wikilink")[布尔代数](../Page/布尔代数.md "wikilink")。

主要[算子的性质对比表如下](../Page/算子.md "wikilink")（`.`表示不满足，`-`表示未验证）：
...
可以使用一般的[度量理论来描述模糊集之间的距离](../Page/度量.md "wikilink")。在这个意义上，我们需要在模糊幂集\(F(U)\)上建立一个度量，此外，我们还可能需要将此度量标准化，也即映射到\([0,1]\)区间上。例如可以这样来标准化
Minkowski 距离：
:

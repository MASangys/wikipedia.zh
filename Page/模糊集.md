**模糊集**是[模糊数学上的一个基本概念](../Page/模糊数学.md "wikilink")，是[数学上普通](../Page/数学.md "wikilink")[集合的扩展](../Page/集合.md "wikilink")。
...
模糊集可以记为\(A\)。映射（函数）\(\mu_A(\cdot)\)或简记为\(A(\cdot)\)叫做模糊集\(A\)的[隶属函数](../Page/隶属函数.md "wikilink")。
...
和傳統的[集合一樣](../Page/集合.md "wikilink")，**模糊集**也有它的元素，但可以談論每個元素屬於該模糊集的**程度**，其從低至高一般用
0 到 1
之間的數來表示。模糊集理論是由[盧菲特·澤德](../Page/盧菲特·澤德.md "wikilink")（1965）所引進的，是經典[集合論的一種推廣](../Page/集合論.md "wikilink")\[2\]。在經典的集合論中，所謂的[二分條件規定每個元素只能](../Page/二值原理.md "wikilink")**屬於**或**不屬於**某個集合（因此模糊集不是集合）；可以說，每個元素對每個集合的**歸屬性**（membership）都只能是
0 或 1。而每模糊集則擁有一個[歸屬函數](../Page/歸屬函數.md "wikilink")（membership
function），其值允許取[閉區間](../Page/閉區間.md "wikilink")\([0,1]\)（[單位區間](../Page/單位區間.md "wikilink")）中的任何實數，用來表示元素對該集的歸屬程度。比如設某模糊集\(A\)的歸屬函數為\(m\)
...
## 參見
  ...
  - [粗糙集](../Page/粗糙集.md "wikilink")

## 參考文獻

[de:Fuzzylogik\#Unscharfe
Mengen](../Page/de:Fuzzylogik#Unscharfe_Mengen.md "wikilink")

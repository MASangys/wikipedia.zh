...
有关概念在[数论](../Page/数论.md "wikilink")中的应用请参阅[模算數](../Page/模算數.md "wikilink")。
...
一些取模操作，经过分解和展开可以等同于其他数学运算。这在[密码学](../Page/密码学.md "wikilink")的证明中十分有用，例如：[迪菲-赫爾曼密鑰交換](../Page/迪菲-赫爾曼密鑰交換.md "wikilink")。
  ...
  - 恒等式：
      ...
      - 如果  是一个[质数](https://zh.wikipedia.org/wiki/质数 "wikilink")，且不为
        的[因数](https://zh.wikipedia.org/wiki/因数 "wikilink")，此时由[费马小定理](../Page/费马小定理.md "wikilink")有：
        *a* mod *p*}}
  - 逆运算：
      - 0}}.
...
## 參見
  ...
  - 和 —— “模数（Modulo）”这个词的许多用法，都是 1801
    年[卡爾·弗里德里希·高斯](../Page/卡爾·弗里德里希·高斯.md "wikilink")引入[模算數](../Page/模算數.md "wikilink")时产生的。

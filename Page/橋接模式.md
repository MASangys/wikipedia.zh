...
橋接模式是[軟件設計模式中最複雜的模式之一](https://zh.wikipedia.org/wiki/軟件設計模式 "wikilink")，它把事物對象和其具體行爲、具體特徵分離開來，使它们可以各自独立的变化。事物對象僅是一個抽象的概念。如“圓形”、“三角形”歸于抽象的“形狀”之下，而“畫圓”、“畫三角”歸于實現行爲的“畫圖”類之下，然後由“形狀”調用“畫圖”。

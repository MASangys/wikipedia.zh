> 本文内容由[機動戰士GUNDAM 00 登場機體列表](https://zh.wikipedia.org/wiki/機動戰士GUNDAM_00_登場機體列表)转换而来。
...
<!-- end list -->
  ...
  -
    粒子束軍刀（Beam Saber）
    [粒子束槍](https://zh.wikipedia.org/wiki/射束 "wikilink")（Beam Gun）
...
<!-- end list -->
  ...
  -
    ...
    「Artemie」之名取自於希臘神話的「[阿耳忒彌斯](https://zh.wikipedia.org/wiki/阿耳忒彌斯 "wikilink")（月之女神）」。
...
<!-- end list -->
  ...
  - 設計者：柳瀨敬之
  - 命名：九天使階級中排第五的[德天使](https://zh.wikipedia.org/wiki/德天使 "wikilink")（Virtues）
...
<!-- end list -->
  ...
  -
    ...
    全身裝甲均裝有GN[導彈箱](https://zh.wikipedia.org/wiki/導彈 "wikilink")（可撘載76枚GN導彈），繫於左右腰後之GN浮游盾型位元除可作盾牌使用外也可收納GN步槍Bit，其可以拆開成GN浮游手槍位元（槍管下方裝有接近戰用的刀刃），兩者均可作全方位或手持武器使用。
    此機體是以萊爾·狄蘭迪的戰鬥數據所製作的專用GUNDAM，除了頭上狙擊用鏡頭，腳部和肩部均裝上隱藏鏡頭，可透過全方位螢幕畫面瞄準單一或多重目標；所以駕駛艙內廢除了步槍型的狙擊瞄準器，操縱杆亦換成了手槍形。
    『Zabanya』為[伊斯蘭教之](https://zh.wikipedia.org/wiki/伊斯蘭教 "wikilink")《[可蘭經](https://zh.wikipedia.org/wiki/可蘭經 "wikilink")》中管理地獄的天使，有『狂亂的突擊者』之意思，港釋GUNDAM沙巴尼亞。
...
<!-- end list -->
  ...
  -
    ...
    「Euclides」為[歐幾里得英語拼法](https://zh.wikipedia.org/wiki/歐幾里得 "wikilink")。
...
<!-- end list -->
  ...
  -
    第一季天上人GUNDAM專用運輸艦，最多可裝備4座GUNDAM用格納庫。不過除防禦用之GN力場外並不裝備有任何重型武裝，在後期裝備強襲裝載運輸機（Assault Container）才擁有武裝，最多可裝備4台（取代4座GUNDAM用格納庫），能與艦體分離直接作出攻擊。
    艦橋偽裝在彈射器的倉蓋上方，以天上人戰術預報士[皇·李·諾瑞加為中心進行任務](https://zh.wikipedia.org/wiki/皇·李·諾瑞加 "wikilink")。和艦艇運作無關的Gundam Meister並沒有席位，但可使用收納在牆壁中的預備座椅。
    格納庫位於以艦艇為中心公轉的構造上，轉至位於艦橋上方的格納庫能把GUNDAM直接送到艦內再以彈射器出擊。各GUNDAM也可從格納庫直接出擊、歸艦，也考慮到打開倉蓋，把GUNDAM用作托勒密的武裝這樣的機能。
    艦內設有量子終端機，是一個以腦量子波直接訪問VEDA的空間，非腦量子波的使用者是無法到達這個地方。
    本艦擁有使用GN粒子的推進系統，在同規模的輸送艦中擁有難以想像的高速，但沒有搭載獨立的GN-Drive（5台太陽爐的其中1台分配到天使部隊），各GUNDAM的太陽爐必須定時為托勒密補充GN粒子，否則只能靠本艦的GN電容行動。
    本艦成員在戰鬥時會關閉一般的電力供應，切換到低能源消耗的狀態下作戰。
    本艦在第一季第24話被一台[GNX-603T 厄運式擊毀主艦橋](https://zh.wikipedia.org/wiki/GNX-603T_厄運式 "wikilink")，使得當時在架橋內的里希特及克莉絲壯烈犧牲。
...
<!-- end list -->
  ...
  -
    ...
    新型的GN粒子推進系統（GN Propellant System）擁有非常高的速度及推進力，使本艦能直接進出大氣層及於深海中自由航行。
    擁有為長時間持續作戰的火器管制裝置，在物資充足的情況下，彈藥是近乎是無限的。
    彈射器增加至3個，位於艦橋兩側及下方。
    第一第二格納庫裝載GUNDAM，第三格納庫裝載一般機體及支援機，3個格納庫均可互相移動機體。
    於地球上能使用光學迷彩避過敵方衛星探測。
    汲取了4年前的教訓，艦橋增至兩個，在主艦橋被破壞時把控制權移交到副艦橋，這樣能夠令托勒密能繼續航行。此外，副艦橋也是砲手伊安使用武裝的地方。
    設有獨立的Trans-AM系統，能短時間啟動。在第二季第9話，藉由各GUNDAM的Trans-AM系統直接提升本艦推進力及GN力場強度，進行大氣層超高速脫離（受地球引力情況且以Trans-AM的極限時間下計算，速度至少達到83km/s，遠超第三宇宙速度），並無效敵人所有攻擊。
    不過如GN粒子殘量不足則無法開啟GN力場，，如沒有GN-Drive而只依賴艦上儲存之粒子則只有極短Trans-AM有效時間。
...
<!-- end list -->
  ...
  -
    電影中登場天人戰鬥母艦，是托勒密號Ⅱ型的強化型。
    因為物質缺乏而放棄開發新型艦的念頭，為托勒密號的推進系統進行改造，在推進器左右額外裝上GN電容推進器(GN Booster)，為推進器帶來更強大的推進力及長時間啟動Trans-AM進行遠距離宇域航行，更可以在艦外使用電纜為MS進行粒子補充，GN粒子殘量耗盡後可直接從尾部分離。
    天人重新奪回VEDA的掌控權，並完全掌握VEDA所有功能後（在第一季，沒有得到VEDA的許可，天上人是不能隨意行動），在電影中的天人均能掌握地球、新政府及聯邦軍的動向，以及分佈在世界各地的變革體之情報，這也是因為得到了VEDA強大的支援，而放棄開發新型艦，一邊進行著規格外的武力介入。
    本艦於ELS之戰中被侵蝕，尚未知道是否與ELS同化。
...
<!-- end list -->
  ...
  - ;SVMS-01X 聯合旗幟式特裝型Ⅱ（Union Flag Custom Ⅱ）
    ...
    :沒有任何遠戰用武裝，擬似太陽爐輸出之能量僅使用在GN粒子束軍刀（該GN光束軍刀是從[座天使GUNDAM一型奪取的](https://zh.wikipedia.org/wiki/GNW-001_座天使GUNDAM一型 "wikilink")）及非戰鬥時的飛行上，尚未能完全取代傳統能源。
...
### MS
  ...
  - ;MSJ-06Ⅱ-SP 鐵人式桃子（Tieren Taozi）
    ...
    \*簡介：
    :人革聯超兵－索瑪·皮利斯的專用機，塗裝為[粉紅色](https://zh.wikipedia.org/wiki/粉紅色 "wikilink")，可於太空與陸上的使用的兩用機(而不須換裝)。
    :二肩可動裝甲部與小腿部裝置大型推力偏向推進器，全身各處也裝置了較小型的推進器，擁有高於一般鐵人的機動性。
    :頭部裝備兩台監視器，初登場時由於有測試的性質，仍然使用頭帶式顯示器。
    :不過由於不能阻隔駕駛員索瑪和高達使者阿雷路亞的[腦量子波](https://zh.wikipedia.org/wiki/腦量子波 "wikilink")，在安全的建議下，於第一季第9話起裝上全方位投影系統及新型（阻隔腦量子波）駕駛員用太空服。
...
<!-- end list -->
  ...
  -
    ...
    本體內部，有著足以運送兩架可變MS或是一輛氣墊戰車的空間。此外，本體中央部左右的突起處，是電力接收用天線，能夠直接接受發電衛星以[微波形式發出的電力補給](https://zh.wikipedia.org/wiki/微波 "wikilink")。
...
<!-- end list -->
  ...
  - ;GNX-704T/AC 先驅式近距離戰鬥型「前鋒」（-{Ahead}- Close Combat Type(Sakigake)）
    ...
    \*簡介：
    :先驅式之特化型試作機之一，屬近戰用機體。
    :外觀與武裝參考古代[日本武士](https://zh.wikipedia.org/wiki/日本武士 "wikilink")，為喜愛近戰用的武士道先生（葛拉漢·耶卡）所專用的先驅式。
    :頭部後方伸出之電纜可供應能量予追加裝備。
    :「Sakigake」來自日本漢字「先驅」。
    \*設計者：寺岡賢司
...
<!-- end list -->
  ...
  - ;GNX-704T/SP 先驅式腦量子波對應型「野苺」（-{Ahead}- Quantum Brainwave Type(Smultron)）
    ...
    :以對應可使用[腦量子波的駕駛員為前提](https://zh.wikipedia.org/wiki/腦量子波 "wikilink")，機體之操作及裝備均可由腦量子波控制。
...
<!-- end list -->
  ...
  - 設計者：[福地仁](https://zh.wikipedia.org/wiki/福地仁 "wikilink")
...
<!-- end list -->
  ...
  -
    ...
    搭載有4個擬似太陽爐，能使用Trans-AM及搭載12台MS。
...
<!-- end list -->
  ...
  -
    ...
    艦體中央的大型空間能收納加迪拉薩等大型MA，或最大22架MS
...
<!-- end list -->
  ...
  -
    劇場版結尾2364年時剎那.F.塞耶所駕駛的MS，與ELS融合的產物，也象徵了互相理解的機體。
    從外觀上沒有任何武裝配備。GN盾牌與六枚GN劍型Bit變成了背後翅膀。
    裝甲均以漸變色呈獻，翅膀的前尖端部分則是透明狀，整體輪廓都是保持Gundam樣式，但看上去更像是生物一樣似的。
...
<!-- end list -->
  ...
  -
    托勒密上所撘載的小型機械人。
    有由[哈囉駕駛或](https://zh.wikipedia.org/wiki/哈囉 "wikilink")[無人駕駛兩種模式](https://zh.wikipedia.org/wiki/無人駕駛 "wikilink")。
    用來協助維修托勒密及整備四部鋼彈。

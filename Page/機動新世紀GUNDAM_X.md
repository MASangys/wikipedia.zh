> 本文内容由[機動新世紀GUNDAM X](https://zh.wikipedia.org/wiki/機動新世紀GUNDAM_X)转换而来。
...
通稱GX，舊地球聯邦軍所開發的決戰用規格MS，最大的特徵為背部搭載必須藉由新人類腦波進行感應認證且月亮可見的天候下才可開啟的衛星加農砲，透過接收無月面發射的微波能源，能發揮出遠超戰艦火炮等級、甚至是與衛星兵器匹敵的強大破壞力。

此外，GX本身尚搭載了能透過新人類的腦波對無人MS子機進行遠端操作、進行集團作戰的閃光系統。

  - 型號：GX-9900
  - 駕駛員：傑米爾·尼特（大戰時期）／ 卡洛德·朗（早期）
  - 全高：17.1公尺
  - 重量：7.5公噸
  - 裝甲：月球鈦合金（Lunar Titanium Alloy）
  - 武裝：

<!-- end list -->

  -
    衛星加農砲（Satellite Cannon）x1
    破壞來福槍（Buster Rifle）x1
    大型光束劍（Large Beam Sword）x1
    火神砲（Vulcan）x4
    盾牌（Shield）x1
...
<!-- end list -->
  ...
  - ;GUNDAMX 分頻砲裝備型（Gundam X Divider）

GX戰損後利用自由號所存放的各式零件重新改裝成的型態，主武裝改成盾牌內裝擴散光束砲與輔助噴射器的分頻砲盾及光束機關槍，背部受損的衛星砲組件摘除後改為大出力噴射器。

雖然失去了衛星加農砲的強大破壞力，但作為MS本身的性能卻獲得顯著的提升。

:\*駕駛員：卡洛德·朗（早期）／傑米爾·尼特（後期）
...
:\*武裝：
  ...
  -
      ...
      -
        分頻砲盾（Divider）x1
        光束機關槍（Beam Machine Gun）x1
        光束劍（Beam Sword）x2
        火神砲（Vulcan）x4

**空霸GUNDAM（Gundam Air Master）**

舊聯邦軍開發的鋼彈型MS之一，最大的特徵在於搭載了變形結構，能夠透過變形來強化機動力。
...
<!-- end list -->
  ...
  - ;爆烈空霸GUNDAM（Gundam Air Master Burst）

::在艾斯塔爾德防衛戰中，空霸鋼彈遇上了機動性更勝一籌的新聯邦空戰MA加迪爾，雖然最後以險勝收場，機體卻也被打得殘破不堪，之後透過艾斯塔爾德國軍的協助將空霸鋼彈大幅改造，除了機動性提升以外，也讓火力得到強化，機身的紅色塗裝也一併改成藍色。
...
:\*武裝：
  ...
  -
      ...
      -
        破壞來福槍（Buster Rifle）x2
        光束加農砲（Beam Cannon）x6；MA形態用
        火神砲（Vulcan）x2

**斑豹GUNDAM（Gundam Leopard）**

同樣是舊聯邦軍開發的鋼彈型MS之一，全身上下裝備著以飛彈和機砲為首的大量火器，具備相當優異的遠距離壓制火力。
...
<!-- end list -->
  ...
  -
    光束格林機槍（Beam Gatling）x1
    榴彈發射器（Grenade Launcher）x6
    格林機槍（Gatling）x2
    黃蜂飛彈（Hornet Missile）x2
    飛彈（Missile）x11
    光束短刀（Beam Knife）x1
    加農砲（Cannon）x2
    火神砲（Vulcan）x2
...
<!-- end list -->
  ...
  - ;毀滅斑豹GUNDAM（Gundam Leopard Destroy）

::自由號離開艾斯塔爾德時，遭遇了新聯邦軍的大型試作MS阻攔，最後是由斑豹鋼彈捨身以零距離的全彈齊射為所有人打出破口，但斑豹鋼彈也因此遭到重創。之後由技師基德藉此機會將之大幅改裝，獲得了比之前要更充沛的火力，塗裝則是從青綠色改成紅色。
...
:\*武裝：
  ...
  -
      ...
      -
        雙光束左輪砲（Twin Beam Cylinder）x1
        格林機槍（Gatling）x2
        黃蜂飛彈（Hornet Missile）x2
        飛彈（Missile）x11
        發射器（Launcher）x4
        光束短刀（Beam Knife）x1
        光束加農砲（Beam Cannon）x2
        頭部光束砲（Head Beam Cannon）x2
...
<!-- end list -->
  ...
  -
    雙管衛星加農砲（Twin Satellite Cannon）x1
    破壞來福槍（Buster Rifle）x1
    高出力光束劍（Hyper Beam Sword）x2
    飛彈發射器（Launcher）x2
    火神砲（Vulcan）x2
    防護盾（Defence Plate）x1
...
<!-- end list -->
  ...
  -
    擴散式光束加農砲（Scattering Beam Cannon）x2
    追蹤導彈（Homing Missile）x20
    火神砲（Vulcan）x2

**華沙哥GUNDAM（Gundam Virsago）**
...
<!-- end list -->
  ...
  - ;華沙哥GUNDAM CB（Gundam Virsago Chest Breake）
...
<!-- end list -->
  ...
  -
    三重米加音速砲（Triple Megasonic Gun）x1
    光束軍刀（Beam Saber）x1
    突擊勾爪（Stirke Claw）x2
    光束加農砲（Beam Cannon）x2

**阿斯特龍GUNDAM（Gundam Ashtaron）**
...
<!-- end list -->
  ...
  -
    原子剪刀（Atomic Scissors）x2
    光束加農砲（Beam Cannon）x2
    光束加農砲（Beam Cannon）x4；MA型態用
    光束軍刀（Beam Saber）x1
...
<!-- end list -->
  ...
  - ;阿斯特龍GUNDAM HC（Gundam Ashtaron Hermitcrab）
...
<!-- end list -->
  ...
  -
    原子剪刀（Atomic Scissors）x2
    光束加農砲（Beam Cannon）x2
    機關砲（Machine Cannon）x4；MA型態用
    光束軍刀（Beam Saber）x1
    衛星發射器（Satellite Launcher）x1；MA型態用
  ...
  -
    收錄曲目：
      -
        ...
        ⒊Dreams(Original Karaoke)
        ⒋Don't stop loving you(Original Karaoke)
  ...
  -
    收錄曲目：
      -
        ⒈Resolution
        ⒉I don't wanna cry
        ⒊Resolution(Original Karaoke)
        ⒋I don't wanna cry(Original Karaoke)
...
<!-- end list -->
  ...
  -
    收錄曲目：
      -
        ⒈Human Touch
        ⒉Human Touch(Instrumental Version)
        ⒊Human Touch(Off Vocal Version)
  ...
  -
    收錄曲目：
      -
        ⒈Human Touch
        ⒉今すぐいくよ
        ⒊Human Touch(Original Karaoke)
        ⒋今すぐいくよ（Original Karaoke)
  ...
  -
    收錄曲目：
      -
        ⒈銀色Horizon
        ⒉オレンジ色の花
        ⒊銀色Horizon(off vocal version)

## 音樂集

**機動新世紀ガンダムX　SIDE.1 / (1996年7月24日發售)**
...
<!-- end list -->
  ...
  -
    ⒈プレリュード\~第7次宇宙戦争（M-1 レコード?ヴァージョン）
    ⒉DREAMS（ロマンティック?モード）
    ⒊A.W.0015（サブタイトルA,M-17,M-5前半）
    ⒋少年（M-7,M-5後半）
    ⒌追撃（M-6,M-18)
    ⒍始動（M-12)
    ⒎月と少女（M-14)
...
**機動新世紀ガンダムX　SIDE.2 / (1996年10月23日發售)**
...
<!-- end list -->
  ...
  -
    ⒈夢を失くした时代にて…（M-26)
    ⒉DREAMS(T.V.サイズ?ヴァージョン）（ロマンティック?モード）
    ⒊標的はフリーデン（サブタイトルB,M-25)
    ⒋「あの子，许さない！」（M-38,M-43)
    ⒌POWER by YOU(高木渉)
    ⒍ティファとカリス（M-23)
    ⒎「仆がニュータイプだ」（M-22後半，M-44)
    ⒏ニュータイプという恐怖（M-36)
    ⒐「何も考えずに走れ！」（M-39)
    ⒑復活のガロード（M-42,M-45 リズム?ヴァージョン）
    ⒒モーニングは2人で…（M-32,M-21)
    ⒓優しい未來へ…（かないみか）
    ⒔「あなた自身が確かめて」（M-37,M-20)
    ⒕迫り来る巨大な力（予告C，予告A,M-15)
    ⒖「…また逢えたわね」（M-41)
    ⒗駆け抜けるGX(M-48,M-45)
    ⒘ニューウェポン?ディバイダー（M-46,M-50)
    ⒙「わたしも人间だから」（M-29)
    ⒚HUMAN TOUCH(TVサイズ?ヴァージョン）（ウォーレン?ウィービー）

**機動新世紀ガンダムX　SIDE.3 / (1997年1月22日發售)**
...
<!-- end list -->
  ...
  -
    ⒈「どうして俺を知っている！?」（M57cho入り）
    ⒉Resulution(TVサイズ?ヴァーション）（ロマンティック?モード）
    ⒊悪夢，再び…（サブタイトルC,M51)
    ⒋深い闇の中で（M60,M61)
    ⒌HUMAN TOUCH(TVサイズ?ヴァーション）（re-kiss)
    ⒍Fifteen Children(M54,M62,M56)
    ⒎growth（高木渉）
    ⒏银色Horizon（中瀬聡美）
    ⒐重力のない世界（M55，予告B)
    ⒑「月が見えた！」（M52）
    ...
    ⒓虹の色が変わる（かないみか）
    ⒔D.O.M.E.(M59)
    ⒕咆哮する宇宙（M63フルサイズcho入り）
    ⒖そして，月へ…（M58）
    ⒗銀色Horizon(TVサイズ?ヴァージョン）（中瀬聡美）
    ⒘Resolution（ロマンティック?モード）

...
在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，從機率守恆可以得到「機率連續性方程式」。設定一個量子系統的波函數為
...
是質量，\(\Psi^*\) 是 \(\Psi\)
是[共軛複數](https://zh.wikipedia.org/wiki/共軛複數 "wikilink")，\(\mbox{Im}()\)
是取括弧內項目的複值。
...
內的機率。第二個[曲面積分是機率流出](https://zh.wikipedia.org/wiki/曲面積分 "wikilink")
...
假設 \(\Psi\)
的[含時薛丁格方程式為](https://zh.wikipedia.org/wiki/含時薛丁格方程式 "wikilink")
...
其中，\(A\)
是[振幅常數](https://zh.wikipedia.org/wiki/振幅 "wikilink")，\(\mathbf{k}\)
是[波數](../Page/波數.md "wikilink")，\(\mathbf{r}\) 是位置，\(\omega\)
是[角頻率](https://zh.wikipedia.org/wiki/角頻率 "wikilink")，\(t\) 是時間。
...
這只是振幅的平方乘以粒子的速度
\(\mathbf{v} = \frac{\mathbf{p}}{m} = \frac{\hbar\mathbf{k}}{m}\) 。

請注意，雖然這平面波是[定態](../Page/定態.md "wikilink")，在每一個的地點，\(\frac{d|\Psi|^2}{dt} = 0\)
，但是機率流仍舊不等於 \(0\) 。因此可以推論，雖然機率密度不顯性地跟時間有關，粒子仍可能移動於空間中。

### 盒中粒子

[Infinite_potential_well.svg](https://zh.wikipedia.org/wiki/File:Infinite_potential_well.svg "fig:Infinite_potential_well.svg")
思考一維[盒中粒子問題](https://zh.wikipedia.org/wiki/盒中粒子 "wikilink")，能級為 \(E_n\)
的[本徵波函數](https://zh.wikipedia.org/wiki/本徵態 "wikilink") \(\Psi_n\) 是

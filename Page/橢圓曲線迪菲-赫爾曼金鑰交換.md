**橢圓曲線迪菲-赫爾曼金鑰交換**（，縮寫為），是一種匿名的[密鑰合意協議](https://zh.wikipedia.org/wiki/密鑰合意協議 "wikilink")（Key-agreement
protocol），這是[迪菲－赫尔曼密钥交换的變種](https://zh.wikipedia.org/wiki/迪菲－赫尔曼密钥交换 "wikilink")，採用[橢圓曲線密码学來加強性能与安全性](../Page/椭圆曲线密码学.md "wikilink")。在這個協定下，雙方利用由[橢圓曲線密码学建立的公鑰與私鑰對](../Page/椭圆曲线密码学.md "wikilink")，在一個不安全的通道中，建立起安全的共有加密資料。\[1\]\[2\]\[3\]

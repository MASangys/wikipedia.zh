...
**橢球坐標系**（）是一種三維[正交坐標系](../Page/正交坐標系.md "wikilink")，是[橢圓坐標系的推廣](../Page/橢圓坐標系.md "wikilink")。與大多數的三維[正交坐標系的生成方法不同](../Page/正交坐標系.md "wikilink")，橢球坐標系不是由任何二維正交坐標系延伸或旋轉生成的。

## 基本公式

橢球坐標 \((\lambda,\ \mu,\ \nu)\) 以[直角坐標](../Page/直角坐標.md "wikilink")
\((x,\ y,\ z)\) 定義為：
...
\(\mu\)-坐標曲面是[單葉雙曲面](../Page/單葉雙曲面.md "wikilink") () ：

\[\frac{x^{2}}{a^{2} + \mu} +  \frac{y^{2}}{b^{2} + \mu} + \frac{z^{2}}{c^{2} + \mu} = 1\]
。

\(\nu\)-坐標曲面是[双葉雙曲面](../Page/双葉雙曲面.md "wikilink") () ：
...
，都可以用橢球坐標表達，只需要將標度因子代入[正交坐標條目內對應的一般公式](../Page/正交坐標系.md "wikilink")。

**文件名稱**是一註明電腦上每一[檔案的特別字串](https://zh.wikipedia.org/wiki/计算机文件 "wikilink")。在不同的作業系統中，對檔案名稱在長度及可允許使用的字元上可能作出限制。檔案中的「[通用资源标志符
...
在很多的系統中，包括DOS及UNIX，是可以句點(.)方式，將檔案名稱分成兩個部份，包括可含有一個或多個字元的[副檔名](../Page/文件扩展名.md "wikilink")。這兩個部份包括：
  ...
  - 檔案的**扩展名**
    (通常是指出與指定格式有關聯的[文件格式或](https://zh.wikipedia.org/wiki/文件格式 "wikilink")[MIME類型](https://zh.wikipedia.org/wiki/MIME "wikilink"))

在同一個目錄中，檔案名稱必須是要唯一的。但是，兩個檔案在不同的目錄中，其名稱是可以相同的。在某些的作業系統中，比如UNIX及Macintosh作業系統中，可以容許一個檔案可以多於一個名字，這稱作*替身*或[硬連結](https://zh.wikipedia.org/wiki/硬連結 "wikilink")
(請同時參閱：[inode](https://zh.wikipedia.org/wiki/inode "wikilink"))。
...
例如，[DOS的](../Page/DOS.md "wikilink")[裝置檔案](https://zh.wikipedia.org/wiki/裝置檔案 "wikilink")：
...
([UNIX](../Page/UNIX.md "wikilink")/[UNIX-LIKE](https://zh.wikipedia.org/wiki/UNIX-LIKE "wikilink"))
...
[pl:Ścieżka
dostępu](https://zh.wikipedia.org/wiki/pl:Ścieżka_dostępu "wikilink")

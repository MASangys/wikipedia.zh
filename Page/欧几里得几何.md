...
欧几里得几何有时就指二维[平面上的几何](../Page/平面_\(数学\).md "wikilink")，即**平面几何**，本文主要描述平面几何。三维空间的欧几里得几何通常叫做[立体几何](https://zh.wikipedia.org/wiki/立体几何 "wikilink")，高维的情形请参看[欧几里得空间](../Page/欧几里得空间.md "wikilink")。

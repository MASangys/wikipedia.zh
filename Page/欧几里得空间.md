...
**欧几里得几何**是在约公元前300年，由[古希腊](../Page/古希腊.md "wikilink")[数学家](../Page/数学家.md "wikilink")[欧几里得建立的](../Page/欧几里得.md "wikilink")[角和](https://zh.wikipedia.org/wiki/角 "wikilink")[空间中](https://zh.wikipedia.org/wiki/空間_\(數學\) "wikilink")[距离之间联系的法则](../Page/距离.md "wikilink")。欧几里得首先开发了处理平面上[二维物体的](https://zh.wikipedia.org/wiki/二维 "wikilink")“平面几何”，他接着分析[三维物体的](https://zh.wikipedia.org/wiki/三維空間 "wikilink")“立体几何”，所有欧几里得的[公理被编排到](../Page/公理.md "wikilink")[幾何原本](https://zh.wikipedia.org/wiki/幾何原本 "wikilink")。

这些数学空间可以被扩展来应用于任何有限维度，而这种空间叫做 **n维欧几里得空间**（甚至简称 **\(n\) 维空间**）或**有限维实内积空间**。

这些数学空间还可被扩展到任意维的情形，称为**实[内积空间](../Page/内积空间.md "wikilink")**（不一定完备），
[希尔伯特空间在](../Page/希尔伯特空间.md "wikilink")[高等代数教科书中也被称为欧几里得空间](https://zh.wikipedia.org/wiki/抽象代數 "wikilink")。
为了开发更高维的欧几里得空间，空间的性质必须非常仔细的表达并被扩展到任意维度。
尽管结果的数学非常抽象，它却呈现了我们熟悉的欧几里得空间的根本本质，根本性质是它的平面性。
另外也存在其他種類的空间，例如球面[非欧几里得空间](https://zh.wikipedia.org/wiki/非欧几里得空间 "wikilink")，[相对论所描述的](../Page/相对论.md "wikilink")[四维](https://zh.wikipedia.org/wiki/四维 "wikilink")[时空在](../Page/时空.md "wikilink")[重力出现的时候也不是欧几里得空间](https://zh.wikipedia.org/wiki/重力 "wikilink")。
...
为了使这些在数学上精确，必须明确定义距离、角、平移和旋转的概念。标准方式是定义欧几里得平面为装备了[内积的二维](https://zh.wikipedia.org/wiki/内积 "wikilink")[实数的](../Page/实数.md "wikilink")[向量空间](../Page/向量空间.md "wikilink")。有着:
...
zh-tw:體;}-](https://zh.wikipedia.org/wiki/實數#公理的方法 "wikilink")。對任意一個正整數n，實數的[n元組的全體構成了](../Page/多元组.md "wikilink")\(\mathbb{R}\)上的一個n維[向量空間](https://zh.wikipedia.org/wiki/向量空間 "wikilink")，用\(\mathbb{R}^n\)來表示。有時稱之為**實數坐標空間**。
...
這個距離函數稱為[歐幾里得度量](https://zh.wikipedia.org/wiki/歐幾里得度量 "wikilink")，它可以看作[勾股定理一種形式](../Page/勾股定理.md "wikilink")。

這裡的\(\mathbb{R}^n\)僅指實數向量空間，而加入了如上定義的歐幾里得結構後才稱為**歐氏空間**；有些作者會用符號\(\mathbb{E}^n\)來標記之。歐氏結構使\(\mathbb{E}^n\)具有這些空間結構：[內積空間](https://zh.wikipedia.org/wiki/內積空間 "wikilink")、[希爾伯特空間](https://zh.wikipedia.org/wiki/希爾伯特空間 "wikilink")、[賦範向量空間以及](../Page/賦範向量空間.md "wikilink")[度量空間](https://zh.wikipedia.org/wiki/度量空間 "wikilink")。
...
关于\(\mathbb{R}^n\)上拓扑的一个并不浅显易懂的重要结论是，[鲁伊兹·布劳威尔的](../Page/鲁伊兹·布劳威尔.md "wikilink")[区域不变性](https://zh.wikipedia.org/wiki/区域不变性 "wikilink")。任意\(\mathbb{R}^n\)的子集（以及其[子拓扑](https://zh.wikipedia.org/wiki/子拓扑 "wikilink")）与另外一个\(\mathbb{R}^n\)的子集[同胚的话](../Page/同胚.md "wikilink")，那么这个子集自己是[开的](../Page/开集.md "wikilink")。这个结果的一个直接的结论就是\(\mathbb{R}^m\)与\(\mathbb{R}^n\)不[同胚](../Page/同胚.md "wikilink")，当\(m\neq n\)。
...
\(n\)维欧氏空间是[n维流形的典型例子](https://zh.wikipedia.org/wiki/n维流形 "wikilink")，事实上也就是[光滑流形](https://zh.wikipedia.org/wiki/光滑流形 "wikilink")。对于\(n\neq 4\)，任意与\(\mathbb{R}^n\)[同胚的可微n维流形](../Page/同胚.md "wikilink")，也是[微分同胚的](../Page/微分同胚.md "wikilink")。值得惊奇的结果是，1982年[西蒙·唐纳森证明了对于](../Page/西蒙·唐纳森.md "wikilink")\(n= 4\)的情况不成立；其反例被称为是[怪**R**<sup>4</sup>](https://zh.wikipedia.org/wiki/怪R4 "wikilink")。

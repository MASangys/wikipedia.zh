...
**欧拉-麦克劳林求和公式**在1735年由[莱昂哈德·欧拉与](https://zh.wikipedia.org/wiki/莱昂哈德·欧拉 "wikilink")[科林·麦克劳林分别独立发现](../Page/科林·麦克劳林.md "wikilink")，该公式提供了一个联系积分与求和的方法，由此可以导出一些渐进展开式。
...
欧拉-麦克劳林求和公式的精确度通常不一定随着的增加而增加，相反地，如果相当大，则积分项也会很大。右图是在计算[调和级数的前](../Page/调和级数.md "wikilink")100项时用[Mathematica算出不同的](https://zh.wikipedia.org/wiki/Mathematica "wikilink")对应的积分项的[绝对值](../Page/绝对值.md "wikilink")：

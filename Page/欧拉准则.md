在[数论中](../Page/数论.md "wikilink")，[二次剩余的](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")**歐拉判別法**（又稱**歐拉準則**）是用来判定给定的[整数是否是一个](../Page/整数.md "wikilink")[质数的](https://zh.wikipedia.org/wiki/质数 "wikilink")[二次剩余](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")。
...
运用同余性质和[勒让德符号可以加快检验速度](../Page/勒让德符号.md "wikilink")。继续算下去，可以得到：
  ...
  -
    ...
    -1（也就是说17是模这些质数的[二次非剩余](https://zh.wikipedia.org/wiki/二次剩余 "wikilink")）。
...
欧拉准则与[高斯引理以及](../Page/高斯引理.md "wikilink")[二次互反律有关](../Page/二次互反律.md "wikilink")，并且在定义[欧拉-雅可比伪素数](https://zh.wikipedia.org/wiki/欧拉-雅可比伪素数 "wikilink")（见[伪素数](https://zh.wikipedia.org/wiki/伪素数 "wikilink")）时会用到。

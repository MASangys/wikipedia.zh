在[物理学上](../Page/物理学.md "wikilink")，**欧拉方程**统治[刚体的转动](../Page/刚体.md "wikilink")。我们可以选取相对于惯量的主轴坐标为体坐标轴系。这使得计算得以简化，因为我们现在可以将[角动量的变化分成分别描述](../Page/角动量.md "wikilink")\(\mathbf{L}\)的大小变化和方向变化的部分，并进一步将惯量对角化。

这些方程是:

\[\left(\frac{d\mathbf{L}}{dt}\right)_\mathrm{relative}+\mathbf{\omega}\times\mathbf{L}=\frac{d\mathbf{L}}{dt}=\mathbf{N}\]

其中\(\mathbf{L}\)是[角动量在体坐标系中的表达](../Page/角动量.md "wikilink")，\(\left(\frac{d\mathbf{L}}{dt}\right)_\mathrm{relative}\)是物体[角动量相对于体坐标系的变化](../Page/角动量.md "wikilink")，
\(\mathbf{\omega}\)是在体坐标系中的角速度，而\(\mathbf{N}\)是外力矩。
...
方程左边为0时，还是有非平凡解：无力矩[进动](../Page/进动.md "wikilink")。
...
## 參閱
  ...
  - [Poinsot构造](../Page/Poinsot构造.md "wikilink")

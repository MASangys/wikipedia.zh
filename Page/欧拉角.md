...
[萊昂哈德·歐拉用](../Page/萊昂哈德·歐拉.md "wikilink")**歐拉角**來描述[剛體在](https://zh.wikipedia.org/wiki/剛體 "wikilink")[三維](../Page/維度.md "wikilink")[歐幾里得空間的](https://zh.wikipedia.org/wiki/歐幾里得空間 "wikilink")[取向](https://zh.wikipedia.org/wiki/取向 "wikilink")。對於任何參考系，一個剛體的取向，是依照順序，從這[參考系](https://zh.wikipedia.org/wiki/參考系 "wikilink")，做三個歐拉角的[旋轉而設定的](https://zh.wikipedia.org/wiki/旋轉 "wikilink")。所以，剛體的取向可以用三個基本旋轉矩陣來決定。換句話說，任何關於剛體旋轉的[旋轉矩陣是由三個基本旋轉矩陣](https://zh.wikipedia.org/wiki/旋轉矩陣 "wikilink")[複合而成的](https://zh.wikipedia.org/wiki/複合函數 "wikilink")。
...
歐拉角在[SO(3)上](../Page/旋轉群.md "wikilink")，形成了一個[坐標卡](https://zh.wikipedia.org/wiki/坐標卡 "wikilink")
()；SO(3)是在三維空間裏的旋轉的[特殊正交群](https://zh.wikipedia.org/wiki/特殊正交群 "wikilink")。這坐標卡是平滑的，除了一個[極坐標式的](https://zh.wikipedia.org/wiki/極坐標 "wikilink")[奇點在](https://zh.wikipedia.org/wiki/奇點 "wikilink")\(\beta=0\)　。
...
在剛體的問題上,
xyz坐標系是**全域坐標系**，XYZ坐標系是**局域坐標系**。全域坐標系是不動的；而局域坐標系牢嵌於剛體內。關於[動能的演算](https://zh.wikipedia.org/wiki/動能 "wikilink")，通常用局域坐標系比較簡易；因為，[慣性張量不隨時間而改變](https://zh.wikipedia.org/wiki/轉動慣量#慣性張量 "wikilink")。如果將慣性張量（有九個分量，其中六個是獨立的）[對角線化](https://zh.wikipedia.org/wiki/可對角化矩陣 "wikilink")，那麼，會得到一組主軸，以及一個[轉動慣量](../Page/轉動慣量.md "wikilink")（只有三個分量）。

**欧姆接触**是[半导体设备上具有线性并且对称的](../Page/半导体.md "wikilink")[电流-电压特性曲线](https://zh.wikipedia.org/wiki/电流-电压特性曲线 "wikilink")（I-V
curve）的区域。如果电流-电压特性曲线不是线性的，这种接触便叫做[肖特基接触](../Page/肖特基二极管.md "wikilink")。典型的欧姆接触是[溅镀或者](https://zh.wikipedia.org/wiki/溅射 "wikilink")[蒸镀的金属片](../Page/蒸发.md "wikilink")，这些金属片通过[光刻製程布局](../Page/光刻.md "wikilink")。低电阻，稳定接触的欧姆接触是影响[集成电路性能和稳定性的关键因素](../Page/集成电路.md "wikilink")。它们的制备和描绘是电路制造的主要工作。
...
level）**材料则会变得具有少量负电荷。最终得到的静电势称为**内建场**记为\(V_{bi}\)。这种**接触电势**将会在任何两种固体间出现并且是诸如[二极管](https://zh.wikipedia.org/wiki/二极管 "wikilink")[整流现象和](https://zh.wikipedia.org/wiki/整流 "wikilink")[温差电效应等的潜在原因](https://zh.wikipedia.org/wiki/温差电效应 "wikilink")。内建场是导致半导体连接处**能带弯曲**的原因。明显的能带弯曲在金属中不会出现因为他们很短的[屏蔽长度意味着任何电场只在接触面间无限小距离内存在](https://zh.wikipedia.org/wiki/电场屏蔽 "wikilink")。
...
affinity），定义为真空能级和[导带](https://zh.wikipedia.org/wiki/导带 "wikilink")（CB）能级的差。对于p型半导体，\(\phi_B = E_g/e - (\phi_M - \chi_S)\)其中\(E_g\)是[禁带宽度](https://zh.wikipedia.org/wiki/禁带宽度 "wikilink")，e是[基本電荷](https://zh.wikipedia.org/wiki/基本電荷 "wikilink")。当穿越势垒的激发是热力学的，这一过程称为[热发射](https://zh.wikipedia.org/wiki/热发射 "wikilink")。真实的接触中一个同等重要的过程既即为[量子力学](../Page/量子力学.md "wikilink")[隧穿](https://zh.wikipedia.org/wiki/隧道效应 "wikilink")。[WKB近似描述了最简单的包括势垒穿透几率与势垒高度和厚度的乘积指数相关的隧穿图像](../Page/WKB近似.md "wikilink")。对于电接触的情形，**耗尽区宽度**决定了厚度，其和内建场穿透入半导体内部长度同量级。耗尽层宽度\(W\)可以通过解[泊松方程以及考虑半导体内存在的](../Page/泊松方程.md "wikilink")[掺杂来计算](https://zh.wikipedia.org/wiki/掺杂 "wikilink"):
...
对于0 \< x \<
W，\(\rho = e N_{dopant}\)是完全**耗尽**的半导体中离子化的施主和受主净电荷密度\(N_{dopant}\)以及\(e\)是[电荷](https://zh.wikipedia.org/wiki/原电荷 "wikilink")。\(\rho\)和\(V_{bi}\)对于n型半导体取正号而对于p型半导体取负号，n型的正曲率\(V''(x)\)和p型的负曲率如图所示。
...
隨著集成電路製備過程的發展，遠更複雜的接觸電阻測量被使用，最流行的方法即為[傳輸線測量）](https://zh.wikipedia.org/wiki/傳輸線模型 "wikilink")（transmission
line
measurement）。傳輸線測量的基本思路是描繪類似接觸之間同寬不同長度的條狀電阻值。結果曲線的斜率是塊狀薄膜[電阻率](https://zh.wikipedia.org/wiki/電阻率 "wikilink")（resistivity）的函數而截距即為接觸電阻（resistance）。
...
现代对硅的欧姆接触比如二硅化钛钨通常是CVD制作的[硅化物](https://zh.wikipedia.org/wiki/硅化物 "wikilink")。接触通常通过沉积过渡金属然后[退火形成硅化物来制造且形成的硅化物通常为非化学计算的](../Page/退火.md "wikilink")。硅化物接触也可通过直接溅射复合或者离子移植过渡金属来沉积并退火。[铝是另一种可同时用于n型和p型半导体重要的硅接触金属](../Page/铝.md "wikilink")，但並非所有n型硅和鋁都可以形成歐姆接觸，一般而言，n+型硅和鋁較能形成良好的歐姆接觸，與n型或n-型硅則形成schottky接觸，而一般n型硅，摻雜濃度在10<sup>16</sup>cm<sup>-3</sup>左右，先鍍Ti接觸硅再鍍上Ag形成歐姆接觸。连同使用其它的反应金属，铝接触通过消耗天然氧化物中的[氧来形成](../Page/氧.md "wikilink")。硅化物很大程度上取代了铝（Al）部分因为高折射材料不太倾向于扩散到不希望的地带，特别是在随后的高温处理过程中。
...
所以一层靠近它表面的砷化镓层能促进欧姆行为。总之相比之下，[III-V和](https://zh.wikipedia.org/wiki/III-V "wikilink")[II-VI半导体欧姆接触技术比硅欧姆接触技术发展较缓](https://zh.wikipedia.org/wiki/II-VI "wikilink")。

| 材料                                                                                                 | 接触材料                                                                                                                                                                                                                                                                        |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [硅](../Page/硅.md "wikilink")（Si）                                                                   | [铝](../Page/铝.md "wikilink")（Al），铝-硅，硅化钛（TiSi<sub>2</sub>），[氮化钛](https://zh.wikipedia.org/wiki/氮化钛 "wikilink")（TiN），[钨](../Page/钨.md "wikilink")，硅化钼（MoSi<sub>2</sub>），硅化铂（PtSi），硅化钴（CoSi<sub>2</sub>），硅化钨（WSi<sub>2</sub>）                                                 |

在[數學裏](../Page/數學.md "wikilink")，一個**正交座標系**定義為一組**正交座標**\(\mathbf{q}=(q_1,\ q_2,\ q_3,\ \dots\ q_n)\)，其[座標曲面都以直角相交](../Page/座標曲面.md "wikilink")。**座標曲面**定義為座標\(q_i\)的[等值曲面](../Page/等值曲面.md "wikilink")，或等值超曲面。例如，三維[直角座標](../Page/直角座標系.md "wikilink")\((x,\ y,\ z)\)是一種正交座標，它的\(x\)為常數，\(y\)為常數，\(z\)為常數的座標曲面，都是互相以直角相交的平面，都互相垂直。

正交座標時常用來解析一些出現於[量子力學](../Page/量子力學.md "wikilink")、[流體動力學](../Page/流體動力學.md "wikilink")、[電動力學](../Page/電動力學.md "wikilink")、[熱力學等等的](../Page/熱力學.md "wikilink")[偏微分方程](../Page/偏微分方程.md "wikilink")。舉例而言，選擇一個恰當的的正交座標來解析[氫離子](../Page/氫離子.md "wikilink")\(H_2\,^-\)的[波函數或消防水管的噴水](../Page/波函數.md "wikilink")，也許會比用直角座標方便的多。這主要是因為恰當的正交座標能夠與一個問題的[對稱性相配合](../Page/對稱性.md "wikilink")，從而促使應用[分離變數法來成功的解析關於這問題的方程式](../Page/分離變數法.md "wikilink")。分離變數法是一種數學技巧，專門用來將一個複雜的\(n\)維問題變為\(n\)個一維問題。很多問題都可以簡化為[拉普拉斯方程或](../Page/拉普拉斯方程.md "wikilink")[亥姆霍茲方程](../Page/亥姆霍茲方程.md "wikilink")，這些方程式可以用很多種正交座標來分離。

在數學裏，存在有各種各樣無限多的正交座標系。應用二維[直角座標系](../Page/直角座標系.md "wikilink")\((x,\ y)\)的[共形映射方法](../Page/共形映射.md "wikilink")，可以簡易的生成這些正交座標系。一個複數\(z=x+iy\)的任何[全純函數](../Page/全純函數.md "wikilink")\(w=f(z)\)，其複值的導數，如果不等於零，則會造成一個[共形映射](../Page/共形映射.md "wikilink")。如果答案可以表達為\(w=u+iv\)，則\(u\)與\(v\)的等值曲線以直角相交，就好似原本的\(x\)與\(y\)的等值曲線以直角相交

三維與更高維的正交座標系可以由一個二維正交座標系生成，只要將二維正交座標往一個新的座標軸投射（形成類似[圓柱座標系的座標系](../Page/圓柱座標系.md "wikilink")），或者將二維正交座標繞著其對稱軸旋轉。可是，也有一些三維正交座標系，例如[橢球座標系](../Page/橢球座標系.md "wikilink")，則不能夠用上述方法得到。

## 向量與積分

[Conformal_map.svg](https://zh.wikipedia.org/wiki/File:Conformal_map.svg "fig:Conformal_map.svg")作用于矩形网格。注意，弯曲的网格的正交性被保留。\]\]
正交坐標的[度規張量絕對沒有非對角項目](../Page/度規張量.md "wikilink")。換句話說，無窮小距離的平方\(ds^2\)，可以寫為無窮小坐標位移的平方和：
...
在正交坐標系裏，[內積的公式仍舊不變](../Page/內積.md "wikilink")：
...
| [标量场的](../Page/标量场.md "wikilink")[拉普拉斯算子](../Page/拉普拉斯算子.md "wikilink") | \(\nabla^{2} \Phi = \frac{1}{h_{1} h_{2} h_{3}}
\left[
...
一個函數\(\phi\)的梯度朝某個方向\(\hat{\mathbf{n}}\)的分量，等於[方向導數](../Page/方向導數.md "wikilink")

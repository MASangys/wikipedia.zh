...
[正交矩阵在](../Page/正交矩阵.md "wikilink")[矩阵乘法下构成的](https://zh.wikipedia.org/wiki/矩阵乘法 "wikilink")[群](../Page/群.md "wikilink")。它是[一般线性群GL](../Page/一般线性群.md "wikilink")(*n*,*F*)的子群，由
...
更一般地，*F*上一个非奇异[二次型的正交群是保持二次型不变的矩阵构成的群](../Page/二次型.md "wikilink")。[嘉当-迪奥多内定理描述了这个正交群的结构](https://zh.wikipedia.org/wiki/嘉当-迪奥多内定理 "wikilink")。
...
=
−1，从而O(*n*,*F*)和SO(*n*,*F*)相等；其他情形SO(*n*,*F*)在O(*n*,*F*)中的[指数是](https://zh.wikipedia.org/wiki/子群的指数 "wikilink")2。特征2且偶数维时，很多作者用另一种定义，定义SO(*n*,*F*)为迪克森不变量的[核](https://zh.wikipedia.org/wiki/核 "wikilink")，这样它在O(*n*,*F*)中总有指数2。
...
[维实](https://zh.wikipedia.org/wiki/维数 "wikilink")[紧](https://zh.wikipedia.org/wiki/紧 "wikilink")[李群](../Page/李群.md "wikilink")。O(*n*,**R**)有两个[连通分支](../Page/连通空间.md "wikilink")，SO(*n*,**R**)是[单位分支](https://zh.wikipedia.org/wiki/单位分支 "wikilink")，即包含[单位矩阵的连通分支](https://zh.wikipedia.org/wiki/单位矩阵 "wikilink")。

实正交群和特殊正交群有如下的解释：

O(*n*,**R**)是*E*(*n*)的子群，*E*(*n*)是**R**<sup>*n*</sup>的[等距群](https://zh.wikipedia.org/wiki/等距 "wikilink")；O(*n*,**R**)由其中保持[原点不动等距组成](https://zh.wikipedia.org/wiki/原点 "wikilink")。它是以原点为中心的[球面](../Page/球面.md "wikilink")
(*n* =
3)、[超球面和所有球面对称的对象的](https://zh.wikipedia.org/wiki/超球面 "wikilink")[對稱群](https://zh.wikipedia.org/wiki/空间对称群 "wikilink")。
...
{ *I*, −*I*
}是O(*n*,**R**)的[正规子群并是](../Page/正规子群.md "wikilink")[特征子群](https://zh.wikipedia.org/wiki/特征子群 "wikilink")；如果*n*是偶数，对SO(*n*,**R**)也对。如果*n*是奇数，O(*n*,**R**)是SO(*n*,**R**)和{
*I*, −*I*
}的[直积](../Page/直积.md "wikilink")。*k*重[旋转](../Page/旋转.md "wikilink")[循环群](https://zh.wikipedia.org/wiki/循环群 "wikilink")*C<sub>k</sub>*对任何正整数*k*都是O(2,**R**)和SO(2,**R**)的正规子群。
...
[圆的](../Page/圆.md "wikilink")[對稱群是O](https://zh.wikipedia.org/wiki/空间对称群 "wikilink")(2,**R**)，也称为[Dih](https://zh.wikipedia.org/wiki/二面体群 "wikilink")(S<sup>1</sup>)，这里S<sup>1</sup>是模长1複数的乘法群。

SO(2,**R**)
(作为李群)同构于圆S<sup>1</sup>（[圆群](https://zh.wikipedia.org/wiki/圆群 "wikilink")）。这个同构将複数exp(φ*i*)
...
2，SO(*n*,**R**)的[基本群是](../Page/基本群.md "wikilink")[2阶循环](https://zh.wikipedia.org/wiki/循环群 "wikilink")，而[自旋群Spin](https://zh.wikipedia.org/wiki/自旋群 "wikilink")(*n*)是其[万有覆叠](https://zh.wikipedia.org/wiki/万有覆叠 "wikilink")。对*n*
=
2基本群是[无限循环而万有覆叠对应于](https://zh.wikipedia.org/wiki/无限循环 "wikilink")[实数轴](https://zh.wikipedia.org/wiki/实数轴 "wikilink")（旋量群Spin(2)是惟一的2重覆叠）

李群O(*n*,**R**)和SO(*n*,**R**的[李代数由](https://zh.wikipedia.org/wiki/李代数 "wikilink")[斜对称实](https://zh.wikipedia.org/wiki/斜对称 "wikilink")*n*×*n*矩阵组成，[李括号由](https://zh.wikipedia.org/wiki/李括号 "wikilink")[交换子给出](https://zh.wikipedia.org/wiki/交换子 "wikilink")。这个李代数经常记为
o(*n*,**R**)或so(*n*,**R**)。
...
SO(*n*,**C**)的[基本群是](../Page/基本群.md "wikilink")2阶[循环群](https://zh.wikipedia.org/wiki/循环群 "wikilink")，而SO(2,**C**)的基本群是无穷循环群。
...
的[正向极限](https://zh.wikipedia.org/wiki/正向极限 "wikilink")（因为包含都是闭包含，从而是[上纤维化](https://zh.wikipedia.org/wiki/上纤维化 "wikilink")，也能理解成[并](../Page/并集.md "wikilink")）。
...
可以理解为：正交群\(O(n+1)\)
[传递地作用于单位球面](https://zh.wikipedia.org/wiki/传递作用 "wikilink")\(S^n\)上，一点（看作一个单位向量）的[稳定子群是其正交补的正交群](https://zh.wikipedia.org/wiki/稳定子群 "wikilink")，这是第一维的正交群。映射\(O(n) \to O(n+1)\)是自然包含。

从而包含\(O(n) \to O(n+1)\)是[*(n-1)*
-连通的](https://zh.wikipedia.org/wiki/n-连通 "wikilink")，故同伦群稳定，对\(n > k + 1\)有\(\pi_k(O) = \pi_k(O(n))\)，所以稳定空间的同伦群等于非稳定空间的低维同伦群。

通过[博特周期性定理](https://zh.wikipedia.org/wiki/博特周期性 "wikilink")，\(\Omega^8 O \simeq O\)，从而*O*的同伦群以8为周期，即
...
通过[cluching
construction](https://zh.wikipedia.org/wiki/:en:cluching_construction "wikilink")，稳定空间*O*的同伦群和稳定球面上的向量丛等价（同构的意义下），提高一个维数：\(\pi_k O = \pi_{k+1} BO\)。
...
迪克森不变量也能对所有维数的[克利福德群和](https://zh.wikipedia.org/wiki/克利福德群 "wikilink")[Pin群类似地定义](../Page/Pin群.md "wikilink")。

## 特征2域上正交群

特征2域上的正交群常常有不同的表現。這一節列出一些不同：

  - 任何域上的任何正交群都是由反射生成，惟一的例外是兩個元素的域上的[维特指标為](https://zh.wikipedia.org/wiki/维特指标 "wikilink")2的4維向量空間。注意特征2域上的反射定義稍不同。特征2域，垂直于一個向量*u*的反射將*v*映為*v*+B(*v*,*u*)/Q(*u*)·*u*，這里*B*是一個雙線性形式，*Q*是和正交矩陣相連的二次形式。而通常的[豪斯霍尔德变换是將](../Page/豪斯霍尔德变换.md "wikilink")*v*映到*v*-2·B(*v*,*u*)/Q(*u*)·*u*，當奇特征和零特征時與比較兩者不同。
...
[代数群的](https://zh.wikipedia.org/wiki/代数群 "wikilink")[伽罗瓦上同调理论](https://zh.wikipedia.org/wiki/伽罗瓦上同调 "wikilink")，引入了一些更深入的观点。它们有解释的价值，特别是二次型理论的联系；
...
这里μ<sub>2</sub>是[单位根的代数群](https://zh.wikipedia.org/wiki/单位根的群概形 "wikilink")；在一个特征非2的域上，粗略地看，和作用平凡的两元素群相同。

从*H*<sup>0</sup>（就是取值于*F*中点的群*O*<sub>V</sub>(*F*)）到*H*<sup>1</sup>(μ<sub>2</sub>)的[连接同态本质上是spinor模](https://zh.wikipedia.org/wiki/连接同态 "wikilink")，因为

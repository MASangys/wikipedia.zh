...
3.  任意[实数都可以](../Page/实数.md "wikilink")\(\tan \frac{\alpha }{2}\)的[形式表達](https://zh.wikipedia.org/wiki/形式 "wikilink")，可用[正切函数](https://zh.wikipedia.org/wiki/正切函数 "wikilink")[换元](https://zh.wikipedia.org/wiki/换元 "wikilink")。
4.  在某些[积分中](../Page/积分.md "wikilink")，可以将含有[三角函数的积分变为](../Page/三角函数.md "wikilink")[有理](https://zh.wikipedia.org/wiki/有理數 "wikilink")[分式的积分](https://zh.wikipedia.org/wiki/分式 "wikilink")。
...
[相似关係](https://zh.wikipedia.org/wiki/相似 "wikilink")，\(\frac{t}{\sin \phi} = \frac{1}{1+ \cos \phi}\)，可得出
...
此公式亦可以对[双曲函数起到类似的作用](../Page/双曲函数.md "wikilink")，由[双曲线右支上的一](../Page/双曲线.md "wikilink")[点](../Page/点.md "wikilink")(cosh *θ*, sinh *θ*)给出。从(−1, 0)到*y*[轴给出了如下](https://zh.wikipedia.org/wiki/轴 "wikilink")[等式](https://zh.wikipedia.org/wiki/等式 "wikilink")：

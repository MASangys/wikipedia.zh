...
game）是描述博弈的一种方式。与[延展形式不同](../Page/扩展形式的博弈.md "wikilink")，正则形式不用图形来描述博弈，而是用[矩阵来陈述博弈](../Page/矩阵.md "wikilink")。与延展形式的表述方式相比，这种方式在识别出[严格优势策略和](https://zh.wikipedia.org/wiki/严格优势策略 "wikilink")[纳什均衡上更有用](../Page/纳什均衡.md "wikilink")，但会丢失某些信息。博弈的正则形式的表述方式包括如下部分：每个参与者所有显然的和可能的[策略](https://zh.wikipedia.org/wiki/策略\(博弈论\) "wikilink")，以及和与其相对应的收益。

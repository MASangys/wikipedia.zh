在[哈密頓力學裏](../Page/哈密頓力學.md "wikilink")，**正則變換**（canonical
transformation）是一種[正則坐標的改變](../Page/正則坐標.md "wikilink")，\((\mathbf{q},\ \mathbf{p}) \rightarrow (\mathbf{Q},\ \mathbf{P})\)，而同時維持[哈密頓方程的形式](../Page/哈密頓方程.md "wikilink")，雖然[哈密頓量可能會改變](../Page/哈密頓量.md "wikilink")。正則變換是[哈密頓-亞可比方程式與](../Page/哈密頓-亞可比方程式.md "wikilink")[刘维尔定理的基礎](../Page/刘维尔定理_\(哈密顿力学\).md "wikilink")。

## 定義

**點變換**（）將[廣義坐標](../Page/廣義坐標.md "wikilink")\(\mathbf{q}=(q_1,\ q_2,\ \dots,\ q_N)\)變換成廣義坐標\(\mathbf{Q}=(Q_1,\ Q_2,\ \dots,\ Q_N)\)，點變換方程式的形式為

\[q_i=q_i(Q_1,\ Q_2,\ \dots,\ Q_N,\ t)\ ,\qquad\qquad\qquad\qquad i=1,\ 2,\ 3,\ \dots ,\ N\]；

其中，\(t\)是[時間](../Page/時間.md "wikilink")。

在[哈密頓力學裏](../Page/哈密頓力學.md "wikilink")，由於廣義坐標與[廣義動量](../Page/廣義動量.md "wikilink")\(\mathbf{p}=(p_1,\ p_2,\ \dots,\ p_N)\)同樣地都是[自變量](../Page/自變量.md "wikilink")（），點變換的定義可以加以延伸，使變換方程式成為
...
為了分辨這兩種不同的點變換，稱前一種點變換為**[位形空間點變換](../Page/位形空間.md "wikilink")**，而後一種為**[相空間點變換](../Page/相空間.md "wikilink")**。

在[哈密頓力學裏](../Page/哈密頓力學.md "wikilink")，正則變換將一組正則坐標\((\mathbf{q},\ \mathbf{p})\)變換為一組新的正則坐標\((\mathbf{Q},\ \mathbf{P})\)，而同時維持哈密頓方程式的形式（稱為**形式不變性**）。原本的哈密頓方程式為
...
則可以設定另外一組變數與哈密頓量： \(\mathbf{Q}=\alpha \mathbf{Q}'\)、
\(\mathbf{P}=\beta \mathbf{P}'\)、
\(\mathcal{K}=\alpha\beta\mathcal{K}\,'\)、
\(G=\alpha\beta G\,'\)；其中，\(\alpha,\ \beta\)是用來刪除\(\sigma\)的常數，\(\sigma=\frac{1}{\alpha\beta}\)。經過一番運算，可以得到
...
第一型生成函數\(G_{1}\)只跟舊[廣義坐標](../Page/廣義坐標.md "wikilink")、新廣義坐標有關，

\[G=G_{1}(\mathbf{q},\ \mathbf{Q},\ t)\]。

代入方程式（1）。展開生成函數對於時間的[全導數](../Page/全導數.md "wikilink")，
...
正則變換必須滿足哈密頓方程式不變；哈密頓方程式為正則變換的一個不變式。另外，正則變換也有幾個重要的[不變量](../Page/不變量.md "wikilink")。

### 辛條件

[辛標記提供了一種既簡單](../Page/辛標記.md "wikilink")，又有效率的標記方法來展示方程式及數學運算。設定一個\(2N\times 1\)的豎[矩陣](../Page/矩陣.md "wikilink")\(\boldsymbol{\xi}\)
:
...
這裏，\(\mathbf{M}\)是[亞可比矩陣](../Page/雅可比矩陣.md "wikilink")，\(M_{ij}=\frac{\partial \Xi_i}{\partial \xi_j}\)。
...
假若限制正則變換為設限正則變換，也就是說，[顯性地不含時間](../Page/顯性.md "wikilink")，解答會簡單許多。假若正則變換顯性地含時間，則仍舊能得到與下述同樣的答案\[1\]，這是一個很好的偏導數習題。現在，限制這正則變換為設限正則變換，則簡化後的方程式為
...
在[相空间裏](../Page/相空间.md "wikilink")，兩個函數\(f(\mathbf{q},\ \mathbf{p}),\ g(\mathbf{q},\ \mathbf{p})\)關於[正則坐標](../Page/正則坐標.md "wikilink")\(\mathbf{q},\ \mathbf{p}\)的**帕松括號**定義為
...
定義**基本帕松括號**\(\big[\boldsymbol{\xi},\ \boldsymbol{\xi}\big]\)為一個[方矩陣](../Page/方矩陣.md "wikilink")，其中，元素\(ij\)的值是\(\big[\xi_i,\ \xi_j\big]\)。那麼，
...
思考兩個函数\(f,\ g\)對於[正則坐標](../Page/正則坐標.md "wikilink")\(\boldsymbol{\xi}\)的泊松括號
...
## 參閱
  ...
  - [正則變換列表](../Page/正則變換列表.md "wikilink")
  - [正則座標](../Page/正則座標.md "wikilink")
  - [帕松括號](../Page/泊松括號.md "wikilink")
  - [辛矩陣](../Page/辛矩陣.md "wikilink")
  - [辛拓撲](../Page/辛拓撲.md "wikilink")
  - [辛群](../Page/辛群.md "wikilink")

## 參考文獻

  - Landau LD and Lifshitz EM (1976) *Mechanics*, 3rd. ed., Pergamon
    Press. ISBN 0-08-021022-8 (hardcover) and ISBN 0-08-029141-4
    (softcover).

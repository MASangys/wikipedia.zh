在[哈密頓力學裏](https://zh.wikipedia.org/wiki/哈密頓力學 "wikilink")，**正則變換**（canonical
...
為了分辨這兩種不同的點變換，稱前一種點變換為**[位形空間點變換](https://zh.wikipedia.org/wiki/位形空間 "wikilink")**，而後一種為**[相空間點變換](../Page/相空間.md "wikilink")**。
...
[辛標記提供了一種既簡單](../Page/辛標記.md "wikilink")，又有效率的標記方法來展示方程式及數學運算。設定一個\(2N\times 1\)的豎[矩陣](https://zh.wikipedia.org/wiki/矩陣 "wikilink")\(\boldsymbol{\xi}\)
:

在[數學裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，尤其是在[群論](https://zh.wikipedia.org/wiki/群論 "wikilink")、[環與](https://zh.wikipedia.org/wiki/環_\(代數\) "wikilink")[模理論](../Page/模.md "wikilink")、[同調代數及](../Page/同調代數.md "wikilink")[微分幾何等數學領域中](https://zh.wikipedia.org/wiki/微分幾何 "wikilink")，**正合序列**（或釋作**正合列**或**恰當序列**）是指一個由對象及其間的[態射所組成的](https://zh.wikipedia.org/wiki/態射 "wikilink")[序列](../Page/序列.md "wikilink")，該序列中的每一個態射的[像都恰好是其下一個態射的](https://zh.wikipedia.org/wiki/像_\(數學\) "wikilink")[核](https://zh.wikipedia.org/wiki/核_\(代數\) "wikilink")。正合序列可以為有限序列或無限序列。

正合序列於[同調代數中居於核心地位](../Page/同調代數.md "wikilink")，其中特別重要的一類是**短正合序列**。

## 定義

在[群論裡](https://zh.wikipedia.org/wiki/群論 "wikilink")，一個由[群及](../Page/群.md "wikilink")[群同態所組成的序列](../Page/群同態.md "wikilink")

\[G_0\;\xrightarrow{f_1}\; G_1 \;\xrightarrow{f_2}\; G_2 \;\xrightarrow{f_3}\; \cdots \;\xrightarrow{f_n}\; G_n\]
稱之為**正合序列**，若且唯若該序列中的每一個同態的[像均等於其下一個同態的](https://zh.wikipedia.org/wiki/像_\(數學\) "wikilink")[核](https://zh.wikipedia.org/wiki/核_\(代數\) "wikilink")：
...
下面會舉出一些相對簡單的例子來幫助理解上述定義。這些例子均以[-{zh:當然;zh-hans:平凡;zh-hk:當然;zh-tw:當然}-群作為開頭或結束](https://zh.wikipedia.org/wiki/當然群 "wikilink")，一般會將此一當然群標記為0（表示加法運算，一般用於序列內的群為阿貝爾群時），或標記為1（表示乘法運算）。
  ...
  - 序列0 → *A* → *B* 為正合序列，若且唯若從*A* 至*B*
    的映射，其核為{0}，亦即若且唯若該映射為[單射](https://zh.wikipedia.org/wiki/單射 "wikilink")。
  - 在對偶時，序列*B* → *C* → 0 為正合序列，若且唯若從*B* 至*C*
    的映射，其像為整個*C*，亦即若且唯若該映射為[滿射](https://zh.wikipedia.org/wiki/滿射 "wikilink")。
  - 因此，序列0 → *X* → *Y* → 0 為正合序列，若且唯若從*X* 至*Y*
    的映射同時為單射及滿射（即為[雙射](https://zh.wikipedia.org/wiki/雙射 "wikilink")），並因此在大多數狀況下，該映射為從*X*
    至*Y* 的[同構](https://zh.wikipedia.org/wiki/同構 "wikilink")。
...
如上所述，對任何一個短正合序列，*f*
一定為[單射](https://zh.wikipedia.org/wiki/單射 "wikilink")，且*g*
一定為[滿射](https://zh.wikipedia.org/wiki/滿射 "wikilink")，且*f* 的像會等於*g*
的核。因此，可導出一[同構](https://zh.wikipedia.org/wiki/同構 "wikilink")
...
對上鏈複形的上同調亦同，此時連接同態的方向是\(H^n(C''^\bullet) \to H^{n+1}(C'^\bullet)\)。這類序列稱作**長正合序列**，它是[同調代數最重要的技術之一](../Page/同調代數.md "wikilink")。在[代數拓撲中](https://zh.wikipedia.org/wiki/代數拓撲 "wikilink")，長正合序列與相對同調群和Mayer-Vietoris序列相關。[導函子也可以導出相應的長正合序列](https://zh.wikipedia.org/wiki/導函子 "wikilink")。

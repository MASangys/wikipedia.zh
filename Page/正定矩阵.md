在[线性代数裡](../Page/线性代数.md "wikilink")，**正定矩阵**是[埃尔米特矩阵的一种](../Page/埃尔米特矩阵.md "wikilink")，有时会简称为**正定阵**。在[线性代数中](../Page/线性代数.md "wikilink")，正定矩阵的性质類似[复数中的](https://zh.wikipedia.org/wiki/复数 "wikilink")[正](https://zh.wikipedia.org/wiki/正数 "wikilink")[实数](../Page/实数.md "wikilink")。与正定矩阵相对应的[线性算子是](https://zh.wikipedia.org/wiki/线性算子 "wikilink")[对称](https://zh.wikipedia.org/wiki/对称矩阵 "wikilink")[正定双线性形式](../Page/确定双线性形式.md "wikilink")（複域中则对应[埃尔米特](../Page/埃尔米特矩阵.md "wikilink")[正定双线性形式](../Page/确定双线性形式.md "wikilink")）。

## 定义

一个的实[对称矩阵](https://zh.wikipedia.org/wiki/对称矩阵 "wikilink")**\(M\)**是**正定**的，[当且仅当对于所有的非零实系数](../Page/当且仅当.md "wikilink")[向量](../Page/向量.md "wikilink")，都有。其中*z*<sup>T</sup>表示*z*的[转置](https://zh.wikipedia.org/wiki/转置 "wikilink")。

对于[复数的情况](https://zh.wikipedia.org/wiki/复数 "wikilink")，定义则为：一个的[埃尔米特矩阵](../Page/埃尔米特矩阵.md "wikilink")(或厄米矩阵)**\(M\)**是正定的当且仅当对于每个非零的複向量*z*，都有*z*<sup>\*</sup>**\(M\)***z*
\>
...
<td><p><strong><span class="math inline"><em>M</em></span></strong>的所有<a href="https://zh.wikipedia.org/wiki/子式和余子式#应用" title="wikilink">顺序主子式</a>，也就是<a href="https://zh.wikipedia.org/wiki/顺序主子阵" title="wikilink">顺序主子阵的</a><a href="../Page/行列式.md" title="wikilink">行列式都是正的</a>（）。明确来说，就是考察下列矩阵的行列式：</p>
<ul>
...
<p><br /><span class="math display"><em>M</em> = <em>L</em><em>L</em><sup>*</sup></span><br />. 其中<span class="math inline"><em>L</em><sup>*</sup></span>是<span class="math inline"><em>L</em></span>的<a href="../Page/共轭转置.md" title="wikilink">共轭转置</a>。 T这一分解被称为<a href="https://zh.wikipedia.org/wiki/Cholesky分解" title="wikilink">Cholesky分解</a>。</p></td>
</tr>
</tbody>
</table>
...
由以上的第二个等价条件，可以得到[二次型形式下正定矩阵的等价条件](../Page/二次型.md "wikilink")：用\(\mathbb{K}\)代表\(\mathbb{C}\)或\(\mathbb{R}\)，设\(\mathbb{V}\)是\(\mathbb{K}\)上的一个[向量空间](../Page/向量空间.md "wikilink")。一个[埃尔米特型](https://zh.wikipedia.org/wiki/埃尔米特型 "wikilink")：

\[B : V \times V \rightarrow K\]

是一个[双线性映射](../Page/双线性映射.md "wikilink")，使得*B*（*x*, *y*）总是*B*（*y*,
*x*）的[共轭](https://zh.wikipedia.org/wiki/共轭 "wikilink")。这样的一个映射*B*是**正定**的当且仅当对\(\mathbb{V}\)中所有的非零向量*x*，都有*B*(*x*,
*x*) \> 0。
...
可以看出，上一节中正定阵的等价性质1只需略作相应改动，就可以变为判别负定矩阵、半正定矩阵和半负定矩阵的准则。注意当**M**是半正定时，相应的[Gram矩阵不必由线性无关的向量组成](https://zh.wikipedia.org/wiki/Gram矩阵 "wikilink")。对任意矩阵\(A\)，*A*<sup>\*</sup>*A*必然是半正定的，并有rank(\(A\))
=
rank（*A*<sup>\*</sup>*A*，两者的[秩相等](https://zh.wikipedia.org/wiki/矩阵的秩 "wikilink")）。反过来，任意的半正定矩阵都可以写作**M**
=
*A*<sup>\*</sup>*A*，这就是[Cholesky分解](https://zh.wikipedia.org/wiki/Cholesky分解 "wikilink")。
...
Matrizen](https://zh.wikipedia.org/wiki/de:Definitheit#Definitheit_von_Matrizen "wikilink")

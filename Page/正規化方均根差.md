**正規化方均根差**（Normalized root mean square error）是將[方均根差化正規化後所得的統計數值](https://zh.wikipedia.org/wiki/方均根差 "wikilink")，其正規化的方法有很多種。 例如:在[信號處理中](https://zh.wikipedia.org/wiki/信號處理 "wikilink")，我們會以其訊號強度來正規化方均差。
...
此數值常被用來作為測量訊號之間[結構相似度](../Page/結構相似性.md "wikilink")(Structural Similarity)的評估工具。

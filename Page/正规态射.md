...
對於[集合範疇](https://zh.wikipedia.org/wiki/集合範疇 "wikilink")、[群範疇以及一個](../Page/群.md "wikilink")[環上的](https://zh.wikipedia.org/wiki/環 "wikilink")[模範疇](../Page/模.md "wikilink")，嚴格性並不成問題。一旦引入額外結構，狀況將大大地複雜化：例如取\(\mathcal{C}\)為[拓撲向量空間範疇](../Page/拓撲向量空間.md "wikilink")，\(\mathcal{C}\)中存在所有有限的積與上積。\(\mathcal{C}\)中的態射\(f: X \to Y\)即[連續線性映射](https://zh.wikipedia.org/wiki/連續線性算子 "wikilink")，其像\(\mathrm{Im}(f)\)是空間\(f(X)\)配與\(Y\)的子空間拓撲，上像\(\mathrm{Coim}(f)\)則是\(f(X)\)配與\(f: X \to f(X)\)的[商拓撲](https://zh.wikipedia.org/wiki/商拓撲 "wikilink")；後者一般較前者為細。

...
步進等級具體指的是刻製像是中央處理器、[圖形處理器](../Page/圖形處理器.md "wikilink")等積體電路的一個或一組光刻掩模的工藝的版本，即標識一系列積體電路設計或光刻掩模版本資訊，會隨著這一系列處理器製造工藝或電路或新增特性的改進而改變。“Stepping
level”一詞中“Stepping”來自於[光刻機](https://zh.wikipedia.org/wiki/光刻機 "wikilink")（“Stepper”），光刻機在作業過程中需要將[晶圓](../Page/晶圓.md "wikilink")上的光致抗蝕劑（感光性樹脂，俗稱“光刻膠”）暴露於紫外光照中。\[3\]\[4\]\[5\]
...
對於一般的使用者，就中央處理器來說，新步進的製品會比上一步進的擁有更好的能效比，更低的發熱量、更低的預設電壓、或者比上一步進的製品擁有更好的[超頻](../Page/超頻.md "wikilink")效能，甚至會有指令集的更新。舉個例子，如超微[Phenom

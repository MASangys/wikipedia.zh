在[量子力學裏](../Page/量子力學.md "wikilink")，表達[粒子的](../Page/粒子.md "wikilink")[量子態的](../Page/量子態.md "wikilink")[波函數必須滿足](../Page/波函數.md "wikilink")**歸一條件**（**歸一化**，），也就是說，在空間內，找到粒子的[機率必須等於](../Page/機率.md "wikilink")
\(1\) 。這性質稱為**歸一性**。用[數學公式表達](../Page/數學.md "wikilink")，
...
一般而言，波函數 \(\psi\)
是一個[複函數](../Page/複數.md "wikilink")。可是，\(\psi^* \psi =  \mid \psi  \mid ^2\)
是一個[實函數](../Page/實數.md "wikilink")，大於或等於 \(0\) ，稱為「機率密度函數」。所以，在區域
\([x,\ x+\Delta x]\) 內，找到粒子的機率 \(\Delta P\) 是
...
假若，從解析[薛丁格方程而得到的波函數](../Page/薛丁格方程.md "wikilink") \(\psi\) ，其機率 \(P\)
是有限的，但不等於 \(1\) ，則可以將波函數 \(\psi\) 乘以一個常數，使機率 \(P\) 等於 \(1\)
。或者，假若波函數內，已經有一個任意常數，可以設定這任意常數的值，使機率 \(P\) 等於 \(1\)。
...
是[角頻率](../Page/角頻率.md "wikilink")，\(A\) 是任意常數。
...
其中，\(\hbar\) 是[約化普朗克常數](../Page/約化普朗克常數.md "wikilink")，\(V(x)\)
是[位勢](../Page/位勢.md "wikilink")，\(E\)
...
薛丁格方程的形式不變。對於歸一化，薛丁格方程是個[不變式](../Page/不變量.md "wikilink")，因為薛丁格方程是個[線性微分方程式](../Page/線性微分方程式.md "wikilink")。
...
## 參閱
  ...
  - [正則變換](../Page/正則變換#不變量.md "wikilink")
  - [么正性](../Page/么正性.md "wikilink")
...
function](../Page/en:Normalizable_wave_function.md "wikilink")

...
这里指的是[进程死锁](https://zh.wikipedia.org/wiki/进程 "wikilink")，是个計算機技术名词。它是[操作系统](../Page/操作系统.md "wikilink")或软件运行的一种状态：在多工系統下，当一个或多个进程等待系统资源，而资源又被进程本身或其他进程占用时，就形成了死锁。有个变种叫[活锁](https://zh.wikipedia.org/wiki/活锁 "wikilink")。

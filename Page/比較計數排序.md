**比較计数排序（Comparison Counting Sort）**\[1\]是一种稳定的[线性时间](https://zh.wikipedia.org/wiki/线性时间 "wikilink")[排序算法](../Page/排序算法.md "wikilink")，此種演算法時間複雜度雖然是平方時間，但它是擁有較強抗干擾能力和穩固性的排序演算法\[2\]。

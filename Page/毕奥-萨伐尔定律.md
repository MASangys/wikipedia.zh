...
Law}-）以方程式描述，[電流在其周圍所產生的](https://zh.wikipedia.org/wiki/電流 "wikilink")[磁場](../Page/磁場.md "wikilink")。採用[靜磁近似](../Page/靜磁學.md "wikilink")，當電流緩慢地隨時間而改變時（例如當[載流導線緩慢地移動時](https://zh.wikipedia.org/wiki/載流導線 "wikilink")），這定律成立，磁場與電流的大小、方向、距離有關\[1\]。必歐-沙伐定律是以法國物理學者[让-巴蒂斯特·毕奥與](../Page/让-巴蒂斯特·毕奥.md "wikilink")[菲利克斯·沙伐命名](../Page/菲利克斯·沙伐.md "wikilink")。

必歐-沙伐定律表明，假設源位置為\(\mathbf{r}'\)的微小線元素\(\mathrm{d}\boldsymbol{\ell}'\)有[電流](https://zh.wikipedia.org/wiki/電流 "wikilink")\(I\)，則\(\mathrm{d}\boldsymbol{\ell}'\)作用於場位置\(\mathbf{r}\)的[磁場為](../Page/磁場.md "wikilink")
...
在[空氣動力學中](https://zh.wikipedia.org/wiki/空氣動力學 "wikilink")，以[渦度對應電流](https://zh.wikipedia.org/wiki/渦度 "wikilink")、速度對應磁場強度，便可應用必歐-沙伐定律以計算[渦線](https://zh.wikipedia.org/wiki/渦線 "wikilink")
()導出的速度。
...
應用這方程式，必須先選出磁場的場位置。固定這場位置，積分於源電流的路徑，就可以計算出在場位置的磁場。請注意，這定律的應用，隱性地依賴著磁場的[疊加原理成立](https://zh.wikipedia.org/wiki/疊加原理 "wikilink")；也就是說，每一個微小線段的電流所產生的磁場，其向量的疊加和給出總磁場。對於[電場和磁場](../Page/電場.md "wikilink")，疊加原理成立，因為它們是一組[線性微分方程式的解答](https://zh.wikipedia.org/wiki/線性微分方程式 "wikilink")。更明確地說，它們是[馬克士威方程組的解答](../Page/馬克士威方程組.md "wikilink")。
...
必歐-沙伐定律是靜磁學的基本定律，在靜磁學的地位，類同於[庫侖定律之於](https://zh.wikipedia.org/wiki/庫侖定律 "wikilink")[靜電學](../Page/靜電學.md "wikilink")。必歐-沙伐定律和[安培定律的關係](../Page/安培定律.md "wikilink")，則如庫侖定律之於[高斯定律](../Page/高斯定律.md "wikilink")。

假若無法採用靜磁近似，例如當電流隨著時間變化太快，或當導線快速地移動時，就不能使用必歐-沙伐定律，必須改用[傑斐緬柯方程式](../Page/傑斐緬柯方程式.md "wikilink")。

### 等速運動的點電荷所產生的電場和磁場

由於[點電荷的運動不能形成電流](https://zh.wikipedia.org/wiki/點電荷 "wikilink")，所以，必須使用[推遲勢的方法來計算其電場和磁場](../Page/推遲勢.md "wikilink")。假設一個點電荷\(q\)以等速度\(\mathbf{v}\)移動，在時間\(t\)的位置為\(\mathbf{w}=\mathbf{v}t\)。那麼，麦克斯韦方程組給出此點電荷所產生的電場和磁場：

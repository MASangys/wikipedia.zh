...
Law}-）以方程式描述，[電流在其周圍所產生的](https://zh.wikipedia.org/wiki/電流 "wikilink")[磁場](../Page/磁場.md "wikilink")。採用[靜磁近似](../Page/靜磁學.md "wikilink")，當電流緩慢地隨時間而改變時（例如當[載流導線緩慢地移動時](https://zh.wikipedia.org/wiki/載流導線 "wikilink")），這定律成立，磁場與電流的大小、方向、距離有關\[1\]。必歐-沙伐定律是以法國物理學者[讓-巴蒂斯特·必歐與](../Page/让-巴蒂斯特·毕奥.md "wikilink")[菲利克斯·沙伐命名](../Page/菲利克斯·沙伐.md "wikilink")。
...
應用這方程式，必須先選出磁場的場位置。固定這場位置，積分於源電流的路徑，就可以計算出在場位置的磁場。請注意，這定律的應用，隱性地依賴著磁場的[疊加原理成立](https://zh.wikipedia.org/wiki/疊加原理 "wikilink")；也就是說，每一個微小線段的電流所產生的磁場，其向量的疊加和給出了總磁場。對於[電場和磁場](../Page/電場.md "wikilink")，疊加原理成立，因為它們是一組[線性微分方程式的解答](https://zh.wikipedia.org/wiki/線性微分方程式 "wikilink")。更明確地說，它們是[馬克士威方程組的解答](../Page/馬克士威方程組.md "wikilink")。

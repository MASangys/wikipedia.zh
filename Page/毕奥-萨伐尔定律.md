[Jbiot.jpg](https://zh.wikipedia.org/wiki/File:Jbiot.jpg "fig:Jbiot.jpg")\]\]
在[靜磁學裏](../Page/靜磁學.md "wikilink")，**必歐-沙伐定律**（-{Biot-Savart
Law}-）以方程式描述，[電流在其周圍所產生的](../Page/電流.md "wikilink")[磁場](../Page/磁場.md "wikilink")。採用[靜磁近似](../Page/靜磁學.md "wikilink")，當電流緩慢地隨時間而改變時（例如當[載流導線緩慢地移動時](../Page/載流導線.md "wikilink")），這定律成立，磁場與電流的大小、方向、距離有關\[1\]。必歐-沙伐定律是以法國物理學者[讓-巴蒂斯特·必歐與](../Page/让-巴蒂斯特·毕奥.md "wikilink")[菲利克斯·沙伐命名](../Page/菲利克斯·沙伐.md "wikilink")。

必歐-沙伐定律表明，假設源位置為\(\mathbf{r}'\)的微小線元素\(\mathrm{d}\boldsymbol{\ell}'\)有[電流](../Page/電流.md "wikilink")\(I\)，則\(\mathrm{d}\boldsymbol{\ell}'\)作用於場位置\(\mathbf{r}\)的[磁場為](../Page/磁場.md "wikilink")

\[\mathrm{d}\mathbf{B} =\frac{\mu_0 I }{4\pi} \mathrm{d}\boldsymbol{\ell}' \times \frac{\mathbf{r} - \mathbf{r}'}{|\mathbf{r} - \mathbf{r}'|^3}\]；

其中，\(\mathrm{d}\mathbf{B}\)是微小磁場（這篇文章簡稱磁通量密度為磁場），\(\mu_0\)是[磁常數](../Page/磁常數.md "wikilink")。

已知[電流密度](../Page/電流密度.md "wikilink")\(\mathbf{J}(\mathbf{r}')\)，則有：
...
在[空氣動力學中](../Page/空氣動力學.md "wikilink")，以[渦度對應電流](../Page/渦度.md "wikilink")、速度對應磁場強度，便可應用必歐-沙伐定律以計算[渦線](../Page/渦線.md "wikilink")
()導出的速度。

## 概念

必歐-沙伐定律適用於計算一個穩定電流所產生的磁場。這電流是連續流過一條導線的電荷，電流量不隨時間而改變，電荷不會在任意位置累積或消失。採用[國際單位制](../Page/國際單位制.md "wikilink")，用方程式表示，
...
應用這方程式，必須先選出磁場的場位置。固定這場位置，積分於源電流的路徑，就可以計算出在場位置的磁場。請注意，這定律的應用，隱性地依賴著磁場的[疊加原理成立](../Page/疊加原理.md "wikilink")；也就是說，每一個微小線段的電流所產生的磁場，其向量的疊加和給出了總磁場。對於[電場和磁場](../Page/電場.md "wikilink")，疊加原理成立，因為它們是一組[線性微分方程式的解答](../Page/線性微分方程式.md "wikilink")。更明確地說，它們是[馬克士威方程組的解答](../Page/馬克士威方程組.md "wikilink")。

當電流可以近似為流過無窮細狹導線，上述這方程式是正確的。但假若導線是寬厚的，則可用積分於導線體積或包含導線體積\(\mathbb{V}'\)的方程式：

\[\mathbf{B}(\mathbf{r}) =\frac{\mu_0}{4\pi} \int_{\mathbb{V}'} \mathbf{J}(\mathbf{r}') \times \frac{\mathbf{r} - \mathbf{r}'}{|\mathbf{r} - \mathbf{r}'|^3} \mathrm{d}^3{r}'\]；

其中，\(\mathbf{J}\)是[電流密度](../Page/電流密度.md "wikilink")，\(\mathrm{d}^3 r'\)是微小體積元素。

必歐-沙伐定律是靜磁學的基本定律，在靜磁學的地位，類同於[庫侖定律之於](../Page/庫侖定律.md "wikilink")[靜電學](../Page/靜電學.md "wikilink")。必歐-沙伐定律和[安培定律的關係](../Page/安培定律.md "wikilink")，則如庫侖定律之於[高斯定律](../Page/高斯定律.md "wikilink")。

假若無法採用靜磁近似，例如當電流隨著時間變化太快，或當導線快速地移動時，就不能使用必歐-沙伐定律，必須改用[傑斐緬柯方程式](../Page/傑斐緬柯方程式.md "wikilink")。

### 等速運動的點電荷所產生的電場和磁場

由於[點電荷的運動不能形成電流](../Page/點電荷.md "wikilink")，所以，必須使用[推遲勢的方法來計算其電場和磁場](../Page/推遲勢.md "wikilink")。假設一個點電荷\(q\)以等速度\(\mathbf{v}\)移動，在時間\(t\)的位置為\(\mathbf{w}=\mathbf{v}t\)。那麼，麦克斯韦方程組給出此點電荷所產生的電場和磁場：
...
這方程式最先由[奧利弗·黑維塞於](../Page/奧利弗·黑維塞.md "wikilink")1888年推導出來，稱為**必歐-沙伐點電荷定律**\[2\]。

## 安培定律和高斯磁定律的導引

這裏，我們要從必歐-沙伐定律推導出[安培定律和](../Page/安培定律.md "wikilink")[高斯磁定律](../Page/高斯磁定律.md "wikilink")
()\[3\]\[4\]。若想查閱此證明，請點選「顯示」。
...
\!證明必歐-沙伐定律所計算出來的磁場，永遠滿足[高斯磁定律](../Page/高斯磁定律.md "wikilink")： |-
|首先，列出必歐-沙伐定律，
...
應用一個[向量恆等式](../Page/向量恆等式.md "wikilink")，

\[\frac{\mathbf{r} - \mathbf{r}'}{|\mathbf{r} - \mathbf{r}'|^3} = - \nabla\left(\frac{1}{|\mathbf{r} - \mathbf{r}'|}\right)\]，

將這恆等式帶入必歐-沙伐方程式。由於[梯度只作用於無單撇號的坐標](../Page/梯度.md "wikilink")，可以將梯度移到積分外：
...
\!證明必歐-沙伐定律所計算出來的磁場，永遠滿足[安培定律](../Page/安培定律.md "wikilink")： |-
|首先，列出必歐-沙伐定律：

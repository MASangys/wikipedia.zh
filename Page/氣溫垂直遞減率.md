**氣溫垂直遞減率**（）、**垂直遞減率**或**氣溫直減率**，是[氣溫隨者](../Page/氣溫.md "wikilink")[高度上升而遞減的幅度](../Page/高度.md "wikilink")。國際民航組織（ICAO）的數據指出，在[對流層中](../Page/對流層.md "wikilink")，乾[空氣平均每上升](../Page/空氣.md "wikilink")100公尺，氣溫就下降約0.98度。若空氣中含有水氣，因為[水汽凝結時會釋放](../Page/水汽.md "wikilink")[潛熱](../Page/潛熱.md "wikilink")，平均每上升100公尺，氣溫下降約0.649度。
...
註：因為比熱比或濕度常數等皆會使用\(\gamma\)為符號，為了避免混淆，有時會用\(\Gamma\) 或
\(\alpha\)代表氣溫垂直遞減率。
...
因為是絕熱過程：
[Emagram.GIF](https://zh.wikipedia.org/wiki/File:Emagram.GIF "fig:Emagram.GIF")
\(P dV = -V dP / \gamma\)
...
1.  [Adiabatic Lapse Rate,](http://goldbook.iupac.org/A00144.html)
    [IUPAC](../Page/IUPAC.md "wikilink")<span> Goldbook</span>
2.  Danielson, Levin, and Abrams, *Meteorology*, McGraw Hill, 2003
3.  Landau and Lifshitz, *Fluid Mechanics*, Pergamon, 1979
4.  Kittel and Kroemer, *Thermal Physics*, Freeman, 1980; [chapter 6,
    problem 11](http://books.google.com/books?id=c0R79nyOoNMC&lpg=PP1&dq=Kittel%20and%20Kroemer%2C%20Thermal%20Physics%2C&pg=PA179#v=onepage&q&f=false)

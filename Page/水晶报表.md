...
Crystal Reports可以存取的数据源包括有：
  ...
  - 储存在[資料庫系统內的数据](../Page/数据库.md "wikilink")，例如：[PostgreSQL](../Page/PostgreSQL.md "wikilink")、[Sybase](https://zh.wikipedia.org/wiki/Adaptive_Server_Enterprise "wikilink")、[IBM
    ...
    Server](https://zh.wikipedia.org/wiki/Microsoft_SQL_Server "wikilink")、[MySQL](../Page/MySQL.md "wikilink")、[Interbase及](https://zh.wikipedia.org/wiki/Interbase "wikilink")[Oracle等](https://zh.wikipedia.org/wiki/Oracle_database "wikilink")。\[3\]
...
1.  [Short history and resources for Crystal Reports Software Developer
    Kits
    (SDK)](https://blogs.sap.com/2010/03/29/short-history-and-resources-for-crystal-reports-software-developer-kits-sdk/)
2.
3.
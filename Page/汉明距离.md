...
**[汉明重量](../Page/汉明重量.md "wikilink")**是字符串相对于同样长度的零字符串的汉明距离，也就是说，它是字符串中非零的元素个数：对于[二进制](https://zh.wikipedia.org/wiki/二进制 "wikilink")[字符串来说](../Page/字符串.md "wikilink")，就是1的个数，所以11101的汉明重量是4。
...
[异或](https://zh.wikipedia.org/wiki/异或 "wikilink")*b*以后所得二进制字符串中“1”的个数。另外二进制字符串的汉明距离也等于*n*维[超正方体两个顶点之间的](https://zh.wikipedia.org/wiki/超正方体 "wikilink")[曼哈顿距离](https://zh.wikipedia.org/wiki/曼哈顿距离 "wikilink")，其中*n*是两个字串的长度。
...
[理查德·衛斯里·漢明](../Page/理查德·衛斯里·漢明.md "wikilink")，误差检测与[纠错码](https://zh.wikipedia.org/wiki/纠错码 "wikilink")（Error-detecting
and [error-correcting
codes](https://zh.wikipedia.org/wiki/error-correcting_code "wikilink")）,

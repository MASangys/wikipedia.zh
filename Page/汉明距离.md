...
对于二进制字符串*a*与*b*来说，它等于*a* [异或](https://zh.wikipedia.org/wiki/异或 "wikilink")*b*以后所得二进制字符串中“1”的个数。另外二进制字符串的汉明距离也等于*n*维[超正方体两个顶点之间的](https://zh.wikipedia.org/wiki/超正方体 "wikilink")[曼哈顿距离](https://zh.wikipedia.org/wiki/曼哈顿距离 "wikilink")，其中*n*是两个字串的长度。

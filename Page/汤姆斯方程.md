**汤姆斯方程**（Thomas equation）是一个非线性偏微分方程\[1\]。

\(\frac{\partial^2 u}{\partial  x\partial t}+\alpha*\frac{\partial u}{\partial t}
+\beta*\frac{\partial u}{\partial  x}+\gamma*\frac{\partial u}{\partial  x}*\frac{\partial u}{\partial  t}=0\)
...
1.  阎振亚著 《复杂非线性波的构造性理论及其应用》第80页 科学出版社 2007年
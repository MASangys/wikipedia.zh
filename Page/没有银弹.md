...
程式語言Ada是1980年代的一個通用型高階語言。事實上，Ada不只是反映了在[語言概念上的演進](../Page/語言.md "wikilink")，同時也具體實現了一些助長現代[設計與模組化概念的特徵](../Page/設計.md "wikilink")；也許，Ada的理念才是比Ada語言本身更先進的地方，這理念就是：[模組化](https://zh.wikipedia.org/wiki/模組化 "wikilink")（modularity）、[抽象資料型別](../Page/抽象資料型別.md "wikilink")（abstract
data

**泊松分布**（，）又稱**-{zh-cn:帕松; zh-tw:泊松; zh-hk:帕松;}-分布**、**普阿松分布**、**布瓦松分佈**、**布阿松分佈**、**波以松分佈**、**卜氏分配**、**帕松小數法則**（Poisson law of small numbers），是一種[統計與](https://zh.wikipedia.org/wiki/統計 "wikilink")[概率](../Page/概率.md "wikilink")學裡常見到的[離散機率分佈](https://zh.wikipedia.org/wiki/机率分布 "wikilink")，由[法國](https://zh.wikipedia.org/wiki/法國 "wikilink")[數學家](https://zh.wikipedia.org/wiki/數學家 "wikilink")[西莫恩·德尼·泊松](https://zh.wikipedia.org/wiki/西莫恩·丹尼·泊松 "wikilink")（Siméon-Denis Poisson）在1838年時發表。

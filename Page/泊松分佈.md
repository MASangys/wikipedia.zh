...
law of small
numbers），是一種[統計與](https://zh.wikipedia.org/wiki/統計 "wikilink")[概率學裡常見到的](../Page/概率.md "wikilink")[離散機率分佈](https://zh.wikipedia.org/wiki/机率分布 "wikilink")，由[法國](https://zh.wikipedia.org/wiki/法國 "wikilink")[數學家](https://zh.wikipedia.org/wiki/數學家 "wikilink")[西莫恩·德尼·泊松](https://zh.wikipedia.org/wiki/西莫恩·丹尼·泊松 "wikilink")（Siméon-Denis
Poisson）在1838年時發表。

泊松分布适合于描述单位时间内随机事件发生的次数的概率分布。如某一服务设施在一定时间内受到的服务请求的次数，[电话](../Page/电话.md "wikilink")[交换机接到呼叫的次数](https://zh.wikipedia.org/wiki/交换机 "wikilink")、汽车站台的候客人数、机器出现的故障数、[自然灾害发生的次数](../Page/自然灾害.md "wikilink")、DNA序列的变异数、放射性原子核的衰变数、[雷射的光子數分布等等](https://zh.wikipedia.org/wiki/雷射 "wikilink")。
...
1、服从泊松分布的[随机变量](../Page/随机变量.md "wikilink")，其[数学期望与](../Page/期望值.md "wikilink")[方差相等](../Page/方差.md "wikilink")，同为参数\(\lambda\)
: \(E(X) = V(X)= \lambda\)

2、兩個獨立且服从泊松分布的[随机变量](../Page/随机变量.md "wikilink")，其和仍然服从泊松分布。更精確地說，若
\(X \sim  Poisson(\lambda_1)\)且
\(Y \sim Poisson(\lambda_2)\)，則\(X+Y \sim Poisson(\lambda_1+\lambda_2)\)。
...
在[二项分布的](https://zh.wikipedia.org/wiki/二项分布 "wikilink")[伯努利试验中](https://zh.wikipedia.org/wiki/伯努利试验 "wikilink")，如果试验次数n很大，二项分布的概率p很小，且乘积λ=''

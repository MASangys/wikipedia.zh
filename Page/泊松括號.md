在[數學及](https://zh.wikipedia.org/wiki/數學 "wikilink")[经典力學中](https://zh.wikipedia.org/wiki/经典力學 "wikilink")，**泊松括號**是[哈密顿力學中重要的運算](https://zh.wikipedia.org/wiki/哈密顿力學 "wikilink")，在哈密頓表述的[動力系統中時間演化的定義起着中心角色](https://zh.wikipedia.org/wiki/動力系統 "wikilink")。在更一般的情形，泊松括号用来定义一个[泊松代数](../Page/泊松代数.md "wikilink")，而[泊松流形是一个特例](../Page/泊松流形.md "wikilink")。它们都是以[西莫恩·德尼·泊松命名的](../Page/西莫恩·德尼·泊松.md "wikilink")。
...
設*M*是一個[辛流形](../Page/辛流形.md "wikilink")，即[流形上帶有一個](../Page/流形.md "wikilink")[辛形式](https://zh.wikipedia.org/wiki/辛形式 "wikilink")（[闭的非退化](../Page/闭形式和恰当形式.md "wikilink")[2-形式](../Page/微分形式.md "wikilink")）：\(\omega\)，这就是说\(d\omega = 0\)且当其视一个映射\(\omega: \xi \in \mathrm{vect}[M] \rightarrow i_\xi \omega \in \Lambda^1[M]\)，\(\omega\)有逆映射\(\tilde{\omega}: \Lambda^1[M] \rightarrow \mathrm{vect}[M]\)。
这里\(d\)是流形*M*上内蕴的[外导数运算](https://zh.wikipedia.org/wiki/外导数 "wikilink")，而\(i_\xi \theta\)是[内乘或](../Page/内乘.md "wikilink")[缩并运算](https://zh.wikipedia.org/wiki/张量缩并 "wikilink")，在1-形式\(\theta\)这等价于\(\theta(\xi)\)。
...
\(\omega\)-恰当（或**余恰当**）。已知\(d\omega = 0\)，上面的表达式蕴含着两个余闭向量场总是一个余恰当向量场，因为当*v*和*w*都余闭时，表达式中惟一非零项是\(d(i_v i_w \omega)\)。又因为外导数满足\(d \circ d = 0\)，所有余恰当向量场是余闭的；所以李括号对余闭向量场空间与其子空间余恰当向量场都是封闭。用[抽象代数的话来说](../Page/抽象代数.md "wikilink")，余闭向量场组成了*M*上光滑向量场[李代数的一个](https://zh.wikipedia.org/wiki/李代数 "wikilink")[子代数](https://zh.wikipedia.org/wiki/子代数 "wikilink")，而余恰当向量场组成这个子代数的一个[代数理想](https://zh.wikipedia.org/wiki/代数理想 "wikilink")。

假设存在逆映射\(\tilde{\omega}\)，*M*上每个光滑实值函数*f*可以与一个余恰当向量场相伴\(\tilde{\omega}(df)\)（两个函数与同一个向量场相伴当且仅当它们的差是*d*的核，即在*M*的任何连通分支上是常数）。这样我们定义\((M, \omega)\)上的**泊松括号**，为[可微](https://zh.wikipedia.org/wiki/可微 "wikilink")[函数上一个](../Page/函数.md "wikilink")[双线性运算](../Page/双线性映射.md "wikilink")，在泊松括号下\(C^\infty\)（光滑）函数组成一个[代数](../Page/代数.md "wikilink")。它由下式给出：
...
**泊松括號**是[反交换的](https://zh.wikipedia.org/wiki/反交換律 "wikilink")，也滿足[雅可比恒等式](https://zh.wikipedia.org/wiki/雅可比恒等式 "wikilink")。这使得[辛流形上的](../Page/辛流形.md "wikilink")[光滑函数空间成为無限維的](../Page/光滑函数.md "wikilink")[李代數](../Page/李代數.md "wikilink")，以泊松括號为[李括號](../Page/李代數.md "wikilink")。相应的[李群是辛流形的](../Page/李群.md "wikilink")[辛同胚群](../Page/辛同胚.md "wikilink")（也稱為[正則變換](../Page/正則變換.md "wikilink")）。

给定一个可微[切丛上的](../Page/切丛.md "wikilink")[向量场](https://zh.wikipedia.org/wiki/向量场 "wikilink")*X*，令\(P_X\)为其[共轭动量](https://zh.wikipedia.org/wiki/共轭动量 "wikilink")。这个从场到共轭动量的映射为从泊松括號到[李括號的](https://zh.wikipedia.org/wiki/李括號 "wikilink")[李代數反同态](../Page/李代數.md "wikilink")：
...
## 另见
  ...
  - [Peierls
    bracket](https://zh.wikipedia.org/wiki/Peierls_bracket "wikilink")

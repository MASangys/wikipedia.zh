...
意为“测量规范”或“标准”\[1\]），但这些术语在使用时并不严格区分。这一干涉仪的特性为，当入射光的频率满足其共振条件时，其透射频谱会出现很高的峰值，对应着很高的透射率。法布里－佩罗干涉仪这一名称来自法国物理学家[夏尔·法布里和](../Page/夏尔·法布里.md "wikilink")[阿尔弗雷德·佩罗](https://zh.wikipedia.org/wiki/阿尔弗雷德·佩罗 "wikilink")\[2\]。

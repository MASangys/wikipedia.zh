...
如果曲面在某点没有切平面，那么在该点就没有法线。例如，[圆锥](../Page/圆锥.md "wikilink")的顶点以及底面的边线处都没有法线，但是圆锥的法线是[几乎处处存在的](https://zh.wikipedia.org/wiki/几乎处处 "wikilink")。通常一个满足[Lipschitz连续的曲面可以认为法线几乎处处存在](https://zh.wikipedia.org/wiki/Lipschitz连续 "wikilink")。

...
来求出点\(y\)处的泛函导数(这是整个泛函变分的关键点，就像[偏导数](../Page/偏导数.md "wikilink")是[梯度](../Page/梯度.md "wikilink")的一个分量):
...
通过更仔细地定义[函数空间](../Page/拓撲向量空間.md "wikilink")，泛函导数的定义可以更准确、正式。例如，当函数空间是一个[巴拿赫空间](../Page/巴拿赫空间.md "wikilink")时,
泛函导数就是著名的[Fréchet导数](https://zh.wikipedia.org/wiki/Fréchet导数 "wikilink"),
而这在更一般的[局部凸空间上使用](https://zh.wikipedia.org/wiki/局部凸空间 "wikilink")[加托導數](../Page/加托導數.md "wikilink")。注意，著名的[希尔伯特空间](../Page/希尔伯特空间.md "wikilink")是[巴拿赫空间](../Page/巴拿赫空间.md "wikilink")的特例。更正式的处理允许将普通[微积分和](https://zh.wikipedia.org/wiki/微积分 "wikilink")[数学分析](../Page/数学分析.md "wikilink")的定理推广为[泛函分析](../Page/泛函分析.md "wikilink")中对应的定理，以及大量的新定理。
...
為標量對向量的導數。<ref group="Note">在三維[笛卡尔坐标系](../Page/笛卡尔坐标系.md "wikilink")中，
...
\end{align}\]</ref>
第三行則用到了[散度的積法則](https://zh.wikipedia.org/wiki/散度#性质 "wikilink")。第四行由[高斯散度定理](../Page/高斯散度定理.md "wikilink")及邊界上
0}} 的條件得到。由於
可以是任意的函數，由[變分法基本引理](../Page/變分法基本引理.md "wikilink")可知，所求泛函導數為

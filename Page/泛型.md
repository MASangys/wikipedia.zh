...
2.  在程序編碼中一些包含參數的[-{zh-hans:类; zh-hant:類別;}-](../Page/类_\(计算机科学\).md "wikilink")。其參數可以代表-{zh-hans:类; zh-hant:類別;}-或-{zh-hans:对象; zh-hant:物件;}-等等。（現在人們大多把這稱作[模板](https://zh.wikipedia.org/wiki/模板 "wikilink")）

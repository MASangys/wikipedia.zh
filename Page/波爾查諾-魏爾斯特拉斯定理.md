**波爾查諾-魏爾施特拉斯定理**（）是[数学中](../Page/数学.md "wikilink")，尤其是[拓扑学与](../Page/拓扑学.md "wikilink")[實分析中](https://zh.wikipedia.org/wiki/實分析 "wikilink")，用以刻劃
\(\mathbb{R}^n\)中的[緊集的基本定理](https://zh.wikipedia.org/wiki/緊集 "wikilink")，得名於數學家[伯納德·波爾查諾與](../Page/伯納德·波爾查諾.md "wikilink")[卡爾·魏爾施特拉斯](https://zh.wikipedia.org/wiki/卡爾·魏爾施特拉斯 "wikilink")。波尔查诺-魏尔斯特拉斯定理说明，有限维[实](../Page/实数.md "wikilink")[向量空间](../Page/向量空间.md "wikilink")\(\mathbb{R}^n\)中的一個[子集](../Page/子集.md "wikilink")\(E\)是[序列緊緻](https://zh.wikipedia.org/wiki/紧集 "wikilink")（每個序列都有收斂子序列）当且仅当\(E\)是[有界](https://zh.wikipedia.org/wiki/有界 "wikilink")[閉集](https://zh.wikipedia.org/wiki/閉集 "wikilink")。

## 历史

这个定理最早由[伯纳德·波尔查诺证明](https://zh.wikipedia.org/wiki/伯纳德·波尔查诺 "wikilink")，當他在證明[介值定理時](../Page/介值定理.md "wikilink")，附帶證明了這個定理，但是他的证明已经散佚。[卡尔·魏尔施特拉斯独自发现并证明了这个定理](../Page/卡尔·魏尔施特拉斯.md "wikilink")。波尔查诺-魏尔施特拉斯定理是[实分析中的基本定理](https://zh.wikipedia.org/wiki/实分析 "wikilink")。
...
## 基础概念
  ...
  - 有界闭集：\(\mathbb{R}^n\)中的有界闭集概念建立在给定的[拓扑和](https://zh.wikipedia.org/wiki/拓扑 "wikilink")[度量上的](../Page/度量.md "wikilink")。由于在有限维向量空间中所有度量等价，所以可以将\(\mathbb{R}^n\)视为装备了[欧几里德度量的](https://zh.wikipedia.org/wiki/欧几里德度量 "wikilink")[度量空间](../Page/度量空间.md "wikilink")（并且可以定义相应的[范数](../Page/范数.md "wikilink")）。\(\mathbb{R}^n\)的子集\(E\)有界，当且仅当所有\(E\)中元素\(x\)的[范数小于一个给定常数](../Page/范数.md "wikilink")\(K\)。注意这时对应的拓扑是欧几里德范数诱导的自然拓扑。

**波向量**是[波的](../Page/波.md "wikilink")[向量表示方法](../Page/向量.md "wikilink")。波向量是一个向量，其大小表示[波数](https://zh.wikipedia.org/wiki/波数 "wikilink")（\(k=|{\mathbf k}| = 2\pi/\lambda\)），其方向表示[波传播的方向](https://zh.wikipedia.org/wiki/波传播 "wikilink")。

波向量在[狭义相对论背景下可定义为](../Page/狭义相对论.md "wikilink")[四维矢量](https://zh.wikipedia.org/wiki/四维矢量 "wikilink")。

## 定义

[Wave_new_sine.svg](https://zh.wikipedia.org/wiki/File:Wave_new_sine.svg "fig:Wave_new_sine.svg")波长*λ*可以通过测量[相位相同的任意相邻两点间的距离得到](https://zh.wikipedia.org/wiki/相位 "wikilink")，这两点可以是相邻的波峰、波谷或是如图所示的。\]\]

在[计算机语言中](https://zh.wikipedia.org/wiki/计算机语言 "wikilink")，**注释**是[计算机语言的一个重要组成部分](https://zh.wikipedia.org/wiki/计算机语言 "wikilink")，用于在[源代码中解释代码的功用](../Page/源代码.md "wikilink")，可以增强程序的可读性，可维护性，或者用于在源代码中处理不需运行的代码段，来调试程序的功能执行。

注释在随源代码进入[预处理器或](../Page/预处理器.md "wikilink")[编译器处理后会被移除](https://zh.wikipedia.org/wiki/编译器 "wikilink")，不会在[目标代码中保留其相关信息](../Page/目标代码.md "wikilink")。
...
一些开发工具通过注释来生成文档。
如[java程序通过](https://zh.wikipedia.org/wiki/java "wikilink")[javadoc](https://zh.wikipedia.org/wiki/javadoc "wikilink"),
[c](https://zh.wikipedia.org/wiki/c "wikilink")/[c++等通过](https://zh.wikipedia.org/wiki/c++ "wikilink")[doxygen生成文档](https://zh.wikipedia.org/wiki/doxygen "wikilink")。
...
<tr class="even">
<td><p>%</p></td>
<td><p>TeX, Prolog, MATLAB[1], Erlang, <a href="https://zh.wikipedia.org/wiki/S-Lang" title="wikilink">S-Lang</a>、<a href="https://zh.wikipedia.org/wiki/Visual_Prolog" title="wikilink">Visual Prolog</a></p>
</references/></td>
</tr>
<tr class="odd">
<td><p>{}</p></td>
...
| /\* \*/                                                        | ActionScript, AutoHotkey, C, C++, Objective-C, Swift, C\#, [Go](../Page/Go.md "wikilink"), Java, JavaScript, PHP, PL/I, SQL, [Visual Prolog](https://zh.wikipedia.org/wiki/Visual_Prolog "wikilink"), CSS |

...
[Zernike_Polynomial_J.gif](https://zh.wikipedia.org/wiki/File:Zernike_Polynomial_J.gif "fig:Zernike_Polynomial_J.gif")
**泽尔尼克多项式**是一个以1953年获[诺贝尔物理学奖荷兰](../Page/诺贝尔物理学奖.md "wikilink")[物理学家](../Page/物理学家.md "wikilink")[弗里茨·泽尔尼克命名的正交多项式](../Page/弗里茨·泽尔尼克.md "wikilink")，分为奇、偶两类
...
其中 \(\epsilon_m\) 称为Neumann因子，其数值为 *2* 如果满足 \(m=0\) ，数值为 *1*，如果
\(m\neq 0\).

**洋蔥路由**（）為一種在[電腦網路上匿名溝通的技術](https://zh.wikipedia.org/wiki/電腦網路 "wikilink")。在洋蔥路由的網路中，[訊息一層一層的加密包裝成像](https://zh.wikipedia.org/wiki/訊息 "wikilink")[洋蔥一樣的](../Page/洋蔥.md "wikilink")[封包](https://zh.wikipedia.org/wiki/封包 "wikilink")，並經由一系列被稱作洋蔥[路由器的網路節點傳送](../Page/路由器.md "wikilink")，每經過一個洋蔥路由器會將封包的最外層解密，直至目的地時將最後一層解密，目的地因而能獲得原始訊息。而因為透過這一系列的加密包裝，每一個網路節點（包含目的地）都只能知道上一個節點的位置，但無法知道整個傳送路徑以及原傳送者的位址。\[1\]

## 發明與實作

1990年代中期，[美國海軍研究實驗室的研究員保羅](../Page/美國海軍研究實驗室.md "wikilink")‧西維爾森（）、和大衛‧戈爾德施拉格（）為了保護[美國線上情報系統而開發了洋蔥路由](../Page/美國情報體系.md "wikilink")\[2\]\[3\]\[4\]。其後[國防高等研究計劃署接手該計畫繼續開發](../Page/國防高等研究計劃署.md "wikilink")，並在1998年獲得海軍的[專利](https://zh.wikipedia.org/wiki/專利 "wikilink")\[5\]\[6\]\[7\]。2002年電腦科學家羅傑‧丁高戴恩（）和尼克‧馬修森（）加入了西維爾森的計畫，並開始開發[Tor](../Page/Tor.md "wikilink")；Tor為「洋蔥路由專案」（）的[頭字語](https://zh.wikipedia.org/wiki/頭字語 "wikilink")，該專案後來成為規模最大的洋蔥路由實作並廣為人知。之後美國海軍研究實驗室將Tor以[自由軟體授權的方式公開了原始碼](https://zh.wikipedia.org/wiki/自由軟體 "wikilink")\[8\]\[9\]\[10\]，丁高戴恩、馬修森以及其他五位成員在2006年成立了名為「」的[非營利組織](https://zh.wikipedia.org/wiki/501\(c\)条款#501\(c\)\(3\) "wikilink")，並獲得包含[電子前哨基金會在內的幾個組織的](https://zh.wikipedia.org/wiki/電子前哨基金會 "wikilink")。\[11\]\[12\]
...
[大蒜路由是洋蔥路由的一種變體](https://zh.wikipedia.org/wiki/大蒜路由 "wikilink")，其結合了[I2P網路並將多份訊息加密打包在一起](../Page/I2P.md "wikilink")，使其更難被攻擊者以流量分析的方式破解。\[21\]

### 出口節點漏洞

雖然訊息在洋蔥路由網路中被層層加密，但是在出口節點時，該節點會把最後一層解密並將原始訊息傳給接收者；因此若出口節點遭到攻擊或是受控制，則原始的訊息將會被截取\[22\]。[瑞典研究員丹](../Page/瑞典.md "wikilink")‧伊格史塔德（）曾用此方式獲得了超過100封寄給外國[大使館的](https://zh.wikipedia.org/wiki/大使館 "wikilink")[電子郵件密碼](https://zh.wikipedia.org/wiki/電子郵件 "wikilink")\[23\]。出口節點漏洞的原理與未加密[無線網路很類似](https://zh.wikipedia.org/wiki/無線網路 "wikilink")，後者為使用者將未加密的資料在無線網路上傳送時可能中途被其他人截走；這兩種問題都可以透過[端對端加密連線如](https://zh.wikipedia.org/wiki/端對端加密 "wikilink")[SSL](https://zh.wikipedia.org/wiki/SSL "wikilink")、[HTTPS等方式解決](https://zh.wikipedia.org/wiki/HTTPS "wikilink")。\[24\]

**洛伦兹-亥维赛单位制**（或称**亥维赛-洛伦兹单位制**）是一种衍生自[厘米-克-秒制的单位系统](../Page/厘米-克-秒制.md "wikilink")，主要用于电磁学领域。其得名于荷兰物理学家[亨德里克·洛伦兹与英国数学家](../Page/亨德里克·洛伦兹.md "wikilink")[奥利弗·亥维赛](../Page/奥利弗·亥维赛.md "wikilink")。与同是衍生自厘米-克-秒制的[高斯单位制类似](../Page/高斯单位制.md "wikilink")，在使用这种单位制时，[电常数](../Page/电常数.md "wikilink")及[磁常数](../Page/磁常数.md "wikilink")并不在方程中出现，而是整合于相关的单位中。相对于[国际单位制](../Page/国际单位制.md "wikilink")，洛伦兹-亥维赛单位制可以视作调整[麦克斯韦方程组](../Page/麦克斯韦方程组.md "wikilink")，归一与，转而在麦克斯韦方程组中使用[光速](../Page/光速.md "wikilink")的结果。\[1\]\[2\]

与国际单位制类似，洛伦兹-亥维赛单位制是有理化的，即在方程中不会出现系数。这一点与同是衍生自CGS制的高斯单位制不同。\[3\]\[4\]正是由于这一单位制是有理化的，其会特别符合[量子场论的需求](../Page/量子场论.md "wikilink")：在该理论所涉及的拉格朗日量中不会出现系数。\[5\]同时，[电荷](../Page/电荷.md "wikilink")、[电磁场依据洛伦兹](../Page/电磁场.md "wikilink")-亥维赛单位制所得到的定义也会由于系数而发生改变。洛伦兹-亥维赛单位制在[弦论这样计算所涉及的空间维度大于三的情形中特别适用](../Page/弦论.md "wikilink")，并且还常用于[狭义相对论计算](../Page/狭义相对论.md "wikilink")。

## 量纲

与高斯单位制类似，洛伦兹-亥维赛单位制采用“长度-质量-时间”[量纲系统](../Page/量纲.md "wikilink")，即其中所有的电磁单位都是导出单位，大小取决于长度、质量以及时间所采用的单位大小。电荷的单位是通过[库伦定律推导的](../Page/库伦定律.md "wikilink")：当采用高斯单位制时，其形式为；而当采用洛伦兹-亥维赛单位制时，其单位则变为。与之对应的单位转换关系为：。因此，洛伦兹-亥维赛单位制下的单位电荷会比高斯单位制中的大倍。
...
常数则通过联系电学单位与磁學单位。当采用高斯单位制或洛伦兹-亥维赛单位制时，由[电磁波方程](../Page/电磁波方程.md "wikilink")，被设为。但在国际单位制中，，则上式化为。因而在许多教科书中，电荷与电流间的关系为而不是。

## 有源麦克斯韦方程组

当采用洛伦兹-亥维赛单位制时，[自由空间中有源麦克斯韦方程组的形式为](../Page/自由空间.md "wikilink")：
...
其中为真空中[光速](../Page/光速.md "wikilink")，为[电场强度](../Page/电场强度.md "wikilink")，为[磁场强度](../Page/磁场强度.md "wikilink")，为[电荷密度而](../Page/电荷密度.md "wikilink")则为[电流密度](../Page/电流密度.md "wikilink")。

[洛伦兹力方程为](../Page/洛伦兹力.md "wikilink")：
...
在这里，我们将列举微观与宏观微分形式的麦克斯韦方程组在三种单位制下的不同形式。积分形式的麦克斯韦方程组可以通过[斯托克斯定理由微分形式得到](../Page/斯托克斯定理.md "wikilink")。
...
<tbody>
<tr class="odd">
<td><p><a href="../Page/高斯定理.md" title="wikilink">高斯定理</a><br />
（宏观）</p></td>
...
<tr class="even">
<td><p><a href="../Page/法拉第感应定律.md" title="wikilink">法拉第感应定律</a></p></td>
...
<tr class="odd">
<td><p><a href="../Page/安培定律#原本定律的延伸：馬克士威-安培方程式.md" title="wikilink">麦克斯韦-安培定律</a><br />
（宏观）</p></td>
...
<tr class="odd">
<td><p>静止点电荷的<a href="../Page/电场强度.md" title="wikilink">电场强度</a></p></td>
...
下面所列的为电介质中几种电场性质。为简单起见，这里仅列举均一、线性、各向同性且无色散介质中的情况，即令[电容率为一个常数](../Page/电容率.md "wikilink")。
...
其中
  ...
  - **E**与**D**分别为[电场强度与](../Page/电场强度.md "wikilink")[电位移](../Page/电位移.md "wikilink")；
  - **P**为[电极化强度](../Page/电极化强度.md "wikilink")；
...
下面所列的为磁介质中几种磁场性质。为简单起见，这里仅列举均一、线性、各向同性且无色散介质中的情况，即令[磁导率为一个常数](../Page/磁导率.md "wikilink")。
...
其中
  ...
  - **B**与**H**分别为[磁感应强度与](../Page/磁感应强度.md "wikilink")[磁场强度](../Page/磁场强度.md "wikilink")；
  - **M**为[磁化强度](../Page/磁化强度.md "wikilink")；
...
<tr class="odd">
<td><p>电场强度<br />
（<a href="../Page/静电场.md" title="wikilink">静电场</a>）</p></td>
...
<tr class="even">
<td><p><a href="../Page/电导率.md" title="wikilink">电导率</a>，<a href="../Page/电导.md" title="wikilink">电导</a>，<a href="../Page/电容.md" title="wikilink">电容</a></p></td>
...
当采用国际单位制时，设定即可得到[自然单位制所对应的形式的方程](../Page/自然单位制.md "wikilink")，其与采用洛伦兹-亥维赛单位制时的方程形式类似。形式转换并不涉及系数。

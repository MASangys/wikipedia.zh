...
oscillator）的长期行为对应的[分形结构](../Page/分形.md "wikilink")，以[爱德华·诺顿·洛伦茨的姓氏命名](https://zh.wikipedia.org/wiki/爱德华·诺顿·洛伦茨 "wikilink")。洛伦茨振子是能产生[混沌流的三维动力系统](../Page/混沌理论.md "wikilink")，是一種[吸引子](https://zh.wikipedia.org/wiki/吸引子 "wikilink")，以其双纽线形状而著称。映射展示出[动力系统](../Page/动力系统.md "wikilink")（三维-{}-系统的三个变量）的状态是如何以一种复杂且不重复的模式，随时间的推移而演变的。
...
Tucker）证明出在一组确定的参数下，系统会表现出混沌行为，显示出人们今天所知的[奇异吸引子](https://zh.wikipedia.org/wiki/奇异吸引子 "wikilink")。这样的奇异吸引子是[豪斯多夫维数在](../Page/豪斯多夫维数.md "wikilink")2与3之间的[分形](../Page/分形.md "wikilink")。[彼得·格拉斯伯格](https://zh.wikipedia.org/wiki/彼得·格拉斯伯格 "wikilink")（Peter
...
\(\sigma\)称为**[普兰特尔数](https://zh.wikipedia.org/wiki/普兰特尔数 "wikilink")**
，\(\rho\)称为**[瑞利数](https://zh.wikipedia.org/wiki/瑞利数 "wikilink")**。所有的\(\sigma\)，\(\rho\)，\(\beta\)
\> 0，但通常\(\sigma\) = 10，\(\beta\) =
...
=
28时表现出混沌特性，但\(\rho\)为其他值时会显示出具纽结的周期轨道。例如，当\(\rho = 99.96\)时，图像变为一个*T*(3,2)[环面纽结](https://zh.wikipedia.org/wiki/环面纽结 "wikilink")。
...
> > | ρ值较小时，系统是稳定的，并能演变为两个定点[吸引子中的一个](https://zh.wikipedia.org/wiki/吸引子 "wikilink")；当ρ大於24.74时，定点变成了[排斥子](https://zh.wikipedia.org/wiki/排斥子 "wikilink")，会以非常复杂的方式排斥轨迹，演变时自身从不交叉。 |
...
## 外部链接
  ...
  - [洛伦茨吸引子](http://demonstrations.wolfram.com/LorenzAttractor/)，作者为[Wolfram
    Demonstrations
    Project的Rob](https://zh.wikipedia.org/wiki/Wolfram_Demonstrations_Project "wikilink")
    Morris
  ...
  - [用於绘出洛伦茨吸引子或处理类似情况的源代码](http://www.mizuno.org/c/la/index.shtml)，使用[ANSI
    C及](../Page/ANSI_C.md "wikilink")[gnuplot实现](https://zh.wikipedia.org/wiki/gnuplot "wikilink")

  - 《[同步混沌与私人通信](http://video.google.com/videoplay?docid=2875296564158834562&q=strogatz&ei=xr9OSJ_SOpeG2wKB3Iy2DA&hl=en)》，由MIT[林肯实验室的Steven](https://zh.wikipedia.org/wiki/林肯实验室 "wikilink")

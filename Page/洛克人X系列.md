...
21XX年，凱恩博士發現謎之機器人－艾克斯（X）。以其設計構想為基礎，開發出能夠自我思考的高精密度機器人－「思考型機器人」。

雖然思考型機器人迅速地普及並被人類活用，不過其中也產生一種會傷害人類，被稱為「非正規」的思考型機器人。

在這事態下，取締非正規為目的，以優秀思考型機器人組織成的「非正規獵人」結成，問題暫時解決。

然而，隨著「非正規獵人」領袖，同時也是最強的思考型機器人，西格瑪的非正規化，世界即將面臨存亡的危機。

非正規品獵人艾克斯，以及特A級獵人傑洛，為了阻止西克瑪挺身而出。\[1\]
...
<!-- end list -->
  ...
  - [傑洛](../Page/傑洛.md "wikilink")(ゼロ，Zero)
    登場作品：全
...
<!-- end list -->
  ...
  - 艾莉雅(エイリア，Alia)
    ...
    小說版《洛克人X》中曾以背景人物的身分登場\[3\]

<!-- end list -->

  - 席格納斯(シグナス，Signas)
    登場作品：『X5\~X8』
    聲優：[鈴置洋孝](../Page/鈴置洋孝.md "wikilink")(X6～X7)、[岩鶴恆義](https://zh.wikipedia.org/wiki/岩鶴恆義 "wikilink")(X8)
...
<!-- end list -->
  ...
  - 威利博士(Dr.ワイリー，Dr.Wily)
    登場作品：『X4』
    聲優：[青野武](../Page/青野武.md "wikilink")
    21世紀的機械人工學權威之一，傑洛的製作者。過去曾數度嘗試征服世界，都被[洛克人阻止](https://zh.wikipedia.org/wiki/洛克人 "wikilink")。約100年前辭世，但似乎也如萊特博士一般將自己化為資料般的形式存活。雖並未於『X5』中直接登場，但西克瑪屢次提到自己與一個「對傑洛有強烈執著的人」合作，意圖令傑洛覺醒以破壞艾克斯。在『X2』登場的卡斯以及『X6』的艾索克疑似是他的化身。
    小說版中沒有直接被提及，但是凱恩博士的回憶中提及100年前「有位邪惡的科學家企圖征服世界的計劃」導致100年前的歷史遭到篡改，甚至有一部分真相至今仍被掩埋\[10\]

## 組織

  - 非正規品獵人（イレギュラーハンター，Irregular Hunter）\[11\]
    ...
    :;戰鬥部隊
      -
        到目前為止，確定至少有0\~17共18個部隊存在。18個部隊中，現在已經確認的部隊成員如下。其中除了艾克斯、傑洛、西克瑪以外，下列有記載其名字的獵人均已遭判定為非正規品並處分完畢（名字後標示其登場作品）。
          -
            **第0特殊部隊（忍者部隊）**
            隊長：不明→[傑洛](../Page/傑洛.md "wikilink")／副隊長：爆炸黃蜂(X3)／成員：電磁蜈蚣(X2)、電網蜘蛛(X4)
            ...
            **第13極地部隊**
            隊長：不明／副隊長：不明／成員：冰凍企鵝(X1)
            **第14格鬥戰鬥部隊**
            隊長：炎龍騎兵(X4)
            **第17精銳部隊**
            隊長：西克瑪（X1前）→[傑洛](../Page/傑洛.md "wikilink")（X1時）→[艾克斯](https://zh.wikipedia.org/wiki/洛克人X "wikilink")（X1後～X6、X7後）
            成員：[傑洛](../Page/傑洛.md "wikilink")（X2之後成為第零部隊隊長）、霸法、閃電山魈(X1)、剪刀鍬形蟲(X1)、烈火朱鹿(X2)、重力甲蟲(X3)、馬克(X3)、塔布魯(X4)
...
<!-- end list -->
  ...
  - 惡夢戰警（ナイトメアポリス，Nightmare Police）(X3)
...
9.  原因就是元祖系列中威利博士的征服世界計劃，因此包括洛克人的存在都從歷史上被掩蓋掉，更連帶的導致研發機器人的技術在接下來的100年間都呈現衰退狀態
10. 此設定也解釋了為什麼開發機器人的技術從《元祖》到《X》花了一百年都沒有進步
11.
12. 小說版中，第一台思考型機器人則是原創角色「阿爾法」，同樣是凱恩博士製作。以艾克斯為原型製作的阿爾法被描述為愛好和平，與艾克斯相處有如兄弟般的思考型機器人，兩人和凱恩博士就如同沒有血緣關係的家人。但是，阿爾法也成為了第一個非正規品，被艾克斯親手破壞。
13. 『Irregular Hunter X』收錄的OVA「THE DAY OF Σ」。
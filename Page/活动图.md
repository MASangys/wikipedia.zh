**活动图**（）是[工作流的图形化表示](https://zh.wikipedia.org/wiki/工作流 "wikilink")。\[1\]活动图的主要由活动和动作构成，也可以支持分支选择、迭代、并行。在 [UML](https://zh.wikipedia.org/wiki/UML "wikilink") 中，活动图主要用于为计算性和组织性过程（即工作流）建模，相关活动之间的数据流也在其覆盖范围之内。\[2\]\[3\]
...
[Category:图表](https://zh.wikipedia.org/wiki/Category:图表 "wikilink") [Category:统一建模语言图表](https://zh.wikipedia.org/wiki/Category:统一建模语言图表 "wikilink")

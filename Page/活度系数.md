...
这里的\(\mu_{i}^{\ominus}\)代表组分i在[标准状态](../Page/标准状态.md "wikilink")下的化学势。而在真实溶液中，组分i-组分i间的作用力和组分i-其他组分间的作用力并不相等，导致了组分i并不满足拉乌尔定律，其化学势也不满足以上关系，即偏离了理想溶液的行为，为此[吉尔伯特·牛顿·路易斯引入了活性和活性系数的概念](https://zh.wikipedia.org/wiki/吉尔伯特·牛顿·路易斯 "wikilink")。
定义：

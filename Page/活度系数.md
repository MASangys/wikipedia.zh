**活性係數**（****），又称**活性因子**（****），是[热力学中的一个系数](../Page/热力学.md "wikilink")，反映的是真实溶液中某组分i的行为偏离[理想溶液的程度](https://zh.wikipedia.org/wiki/理想溶液 "wikilink")\[1\]，量纲为1。引入活性系数后，适用于理想溶液的各种关系可以相应修正为适用于真实溶液。类似的，[逸度系数是表示真实气体混合物中某组分和理想行为的偏离的系数](../Page/逸度.md "wikilink")。
...
这里的\(\mu_{i}^{\ominus}\)代表组分i在[标准状态下的化学势](../Page/标准状态.md "wikilink")。而在真实溶液中，组分i-组分i间的作用力和组分i-其他组分间的作用力并不相等，导致了组分i并不满足拉乌尔定律，其化学势也不满足以上关系，即偏离了理想溶液的行为，为此[吉尔伯特·牛顿·路易斯引入了活性和活性系数的概念](https://zh.wikipedia.org/wiki/吉尔伯特·牛顿·路易斯 "wikilink")。
定义：

\[a_{x,i} =\gamma_{x,i} x_i\]
这里的\(a_{x,i}\)是组分i以摩尔分数所表示的[活性](https://zh.wikipedia.org/wiki/活性 "wikilink")，\(\gamma_{x,i}\)则是组分i用摩尔分数所表示的活性系数。引入活性和活性系数后，拉伍爾定律可以修正为：
...
真实溶液的浓度越稀，溶剂的活性系数就越接近1，活性和摩尔分数近乎相等，其行为越接近理想溶液。浓度越高，活性系数越偏离1，真实溶液的行为偏差理想溶液就越大，比如对于浓度较高的电解质溶液，其活性就无法用摩尔分数取代，这一点在[电化学和](../Page/电化学.md "wikilink")[土壤化学中十分常见](https://zh.wikipedia.org/wiki/土壤化学 "wikilink")\[2\]。

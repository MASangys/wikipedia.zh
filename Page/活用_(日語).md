...
由于活用语尾在四段中发生活用，因此名为**四段活用**。相当于现代日语（現代假名遣\[14\]）中的**[五段活用](../Page/活用_\(日語\)#五段活用.md "wikilink")**。
...
由于活用语尾在中发生活用，因此名为**下一段活用**\[15\]。只有“蹴（け）る”一個詞。现代日语中「蹴（け）る」同化合并入**[五段活用](../Page/活用_\(日語\)#五段活用.md "wikilink")**。
...
由于活用语尾在两段中发生活用，因此名为**下二段活用**\[16\]。现代日语中同化合并入**[下一段活用](../Page/活用_\(日語\)#上一段、下一段活用.md "wikilink")**。

**流固耦合**, 就是[流體與](https://zh.wikipedia.org/wiki/流體 "wikilink")[固體之間的交互作用](https://zh.wikipedia.org/wiki/固體 "wikilink")。流固耦合的英文為Fluid-Structure Interaction 或是Fluid-Solid Interaction。流固耦合可簡單分為單向及雙向耦合，单向耦合忽略了结构变形对于流场空间的改变，因此计算更为简化。流固耦合双向耦合包括两种求解方法，一般称之为迭代耦合（弱耦合）和直接耦合（强耦合）两种计算方法。相關的計算軟體有GDS Studio、ADINA、ANSYS、ESI-CFD 以及COMSOL等。

## 商業程式

  - [ESI CFD-ACE+](https://web.archive.org/web/20140517033443/http://esi-cfd.com/)
  - [Abaqus Multiphysics Coupling](https://zh.wikipedia.org/wiki/Abaqus_Multiphysics_Coupling "wikilink")
  - [AcuSolve FSI applications](https://zh.wikipedia.org/wiki/AcuSolve_FSI_applications "wikilink")
  - [GDS Studio](http://thingo.com.cn)
  - [ADINA FSI homepage](https://web.archive.org/web/20180804053728/http://adina.com.cn/)
  - [Ansys' FSI homepage](https://zh.wikipedia.org/wiki/Ansys'_FSI_homepage "wikilink")
  - [CoLyX - FSI and mesh-morphing from EVEN - Evolutionary Engineering AG](https://zh.wikipedia.org/wiki/CoLyX_-_FSI_and_mesh-morphing_from_EVEN_-_Evolutionary_Engineering_AG "wikilink")
  - [COMSOL FSI homepage](https://zh.wikipedia.org/wiki/COMSOL_FSI_homepage "wikilink")
  - [MpCCI homepage](https://zh.wikipedia.org/wiki/MpCCI_homepage "wikilink")
  - [MSC Software MD Nastran](https://zh.wikipedia.org/wiki/MSC_Software_MD_Nastran "wikilink")
  - [MSC Software Dytran](https://zh.wikipedia.org/wiki/MSC_Software_Dytran "wikilink")
  - [FINE/Oofelie FSI: Fully integrated and strongly coupled for better convergence](https://zh.wikipedia.org/wiki/FINE/Oofelie_FSI:_Fully_integrated_and_strongly_coupled_for_better_convergence "wikilink")
  - [LS-DYNA Home Page](https://zh.wikipedia.org/wiki/LS-DYNA_Home_Page "wikilink")
...
[Category:流體力學](https://zh.wikipedia.org/wiki/Category:流體力學 "wikilink") [Category:流體動力學](https://zh.wikipedia.org/wiki/Category:流體動力學 "wikilink") [Category:結構力學](https://zh.wikipedia.org/wiki/Category:結構力學 "wikilink") [Category:結構動力學](https://zh.wikipedia.org/wiki/Category:結構動力學 "wikilink")
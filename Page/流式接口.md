...
Fowler于](https://zh.wikipedia.org/wiki/Martin_Fowler "wikilink")2005年提出。
...
[C++的](../Page/C++.md "wikilink")[iostream流式调用就是一个典型的例子](https://zh.wikipedia.org/wiki/iostream "wikilink")。Smalltalk在1970年代就实现了。
...
C\#在[LINQ中大量使用](https://zh.wikipedia.org/wiki/LINQ "wikilink") *standard
query operators*与[扩展方法](https://zh.wikipedia.org/wiki/扩展方法 "wikilink")。
...
[gradual
typing](https://zh.wikipedia.org/wiki/gradual_typing "wikilink") makes

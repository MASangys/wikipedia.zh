...
## 外部链接
  ...
  - [Thomas Dreibholz's SCTP Project
    Page](https://web.archive.org/web/20131126184525/http://www.iem.uni-due.de/~dreibh/sctp/)
  ...
  - [SCTP
    通訊協定簡介](http://applezulab.netdpi.net/network/sctp_introduction)

  - [TCP 與 SCTP
    協定轉換機制](http://applezulab.netdpi.net/network/tcp-sctp-translator)

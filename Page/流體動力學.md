...
流體動力學有很大的應用，比如在預測[天氣](https://zh.wikipedia.org/wiki/天氣 "wikilink")，計算[飛機所受的](https://zh.wikipedia.org/wiki/飛機 "wikilink")[力和](../Page/力.md "wikilink")[力矩](../Page/力矩.md "wikilink")，輸油管線中[石油的](../Page/石油.md "wikilink")[流率等方面上](https://zh.wikipedia.org/wiki/流率 "wikilink")。其中的的一些[原理甚至運用在](../Page/原理.md "wikilink")[交通工程](https://zh.wikipedia.org/wiki/交通工程 "wikilink")，因交通運輸本身可被視為一連續流體运动。

## 流體動力學方程式

流體動力學的基本公理為[守恆律](https://zh.wikipedia.org/wiki/守恆律 "wikilink")，特別是[質量守恆](https://zh.wikipedia.org/wiki/質量守恆 "wikilink")、[動量守恆](https://zh.wikipedia.org/wiki/動量守恆 "wikilink")（也稱作[牛頓第二與第三定律](https://zh.wikipedia.org/wiki/牛頓運動定律 "wikilink")）以及[能量守恆](https://zh.wikipedia.org/wiki/能量守恆 "wikilink")。這些守恆律以[古典力學為基礎](https://zh.wikipedia.org/wiki/古典力學 "wikilink")，並且在[量子力學及](https://zh.wikipedia.org/wiki/量子力學 "wikilink")[廣義相對論中有所修改](../Page/廣義相對論.md "wikilink")。它們可用[雷諾傳輸定理](../Page/雷諾傳輸定理.md "wikilink")（Reynolds
...
若流體足夠緻密，可以成為一連續體，並且不含有離子化的組成，速度相對於[光速是很慢的](../Page/光速.md "wikilink")，則[牛頓流體的動量方程式為](https://zh.wikipedia.org/wiki/牛頓流體 "wikilink")「[納維-斯托克斯方程式](https://zh.wikipedia.org/wiki/納維-斯托克斯方程式 "wikilink")」。其為[非線性](https://zh.wikipedia.org/wiki/非線性 "wikilink")[微分方程式](https://zh.wikipedia.org/wiki/微分方程式 "wikilink")，描述流體的流所帶有的[應力是與](../Page/應力.md "wikilink")[速度及](../Page/速度.md "wikilink")[壓力呈線性相依](https://zh.wikipedia.org/wiki/壓力 "wikilink")。未簡化的納維-斯托克斯方程式並沒有一般[閉形式解](https://zh.wikipedia.org/wiki/閉形式解 "wikilink")，所以只能用在[計算流體力學](https://zh.wikipedia.org/wiki/計算流體力學 "wikilink")，要不然就需要進行簡化。方程式可以通過很多方法來簡化，以容易求解。其中一些方法允許適合的流體力學問題能得到閉形式解。
...
其中 \(p\)為[壓力](https://zh.wikipedia.org/wiki/壓力 "wikilink")，
\(\rho\)為[密度](../Page/密度.md "wikilink")，
\(R_u\)為[氣體常數](../Page/氣體常數.md "wikilink")，
\(M\)為[分子量](../Page/分子量.md "wikilink")，以及
\(T\)為[溫度](https://zh.wikipedia.org/wiki/溫度 "wikilink")。
...
因此，計算管壁對流體的淨力，需要使用黏性方程式。如同[達朗白謬論的說明](https://zh.wikipedia.org/wiki/達朗白謬論 "wikilink")，物體在非黏性流裡，不會感受到力。[歐拉方程是描述非黏性流的標準方程式](../Page/欧拉方程_\(流体动力学\).md "wikilink")。在這種情況，一個常使用的模型，使用歐拉方程描述遠離邊界的流體，在接觸的[邊界](https://zh.wikipedia.org/wiki/邊界 "wikilink")，使用[邊界層方程式](../Page/邊界層.md "wikilink")。
...
亂流遵守[納維-斯托克斯方程式](https://zh.wikipedia.org/wiki/納維-斯托克斯方程式 "wikilink")。[數值直解法](https://zh.wikipedia.org/wiki/數值直解法 "wikilink")（Direct
numerical
...
\>3 m）以72 km/h（20
m/s）的速度移動，此情況都遠遠在DNS能夠模擬的範圍之外（雷諾數為4百萬）。像是[空中巴士A300或](https://zh.wikipedia.org/wiki/空中巴士A300 "wikilink")[波音747這類的飛行工具](../Page/波音747.md "wikilink")，機翼上的雷諾數超過4千萬（以翼弦為標準）。為了能夠處理這些生活上實際的問題，需要建立紊流模型。雷諾平均納維-斯托克斯方程式（Reynolds-averaged
Navier-Stokes
equations）結合了紊流的效果，提供了一個紊流的模型，將額外的動量傳遞表示由[雷諾應力所造成](https://zh.wikipedia.org/wiki/雷諾應力 "wikilink")；然而，亂流也會增加熱傳與質傳速度。[大渦數值模擬計算](https://zh.wikipedia.org/wiki/大渦數值模擬計算 "wikilink")（Large
eddy
simulation，LES）也是一個模擬方法，外觀與[分離渦流模型](https://zh.wikipedia.org/wiki/分離渦流模型 "wikilink")（detached
...
### 數學方程式與觀念
  ...
  - [曼寧公式](https://zh.wikipedia.org/wiki/曼寧公式 "wikilink")
...
### 流類型
  ...
  - [斯托克斯流](https://zh.wikipedia.org/wiki/斯托克斯流 "wikilink")

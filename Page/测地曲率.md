...
式中，k为曲线在P点的曲率，\(k_{n}\)为曲线在P点的[法曲率](../Page/法曲率.md "wikilink")。

## 二維曲面常用的測地曲率公式

今有一[緊緻定向的二維曲面S](../Page/緊空間.md "wikilink")，其[線元素可用](../Page/線元素.md "wikilink")[曲面的](../Page/曲面.md "wikilink")[第一基本形式的係數表示為](../Page/第一基本形式.md "wikilink")：\(ds^2 = Edu^2+2Fdudv+Gdv^2 \,\)，則其[度量張量可表成下列關係式](../Page/度量張量.md "wikilink")：
...
令\(C\)為曲面S上的一正則曲線，在此曲線上以其弧長\(s\)為參數，則曲線\(C\)的參數方程式為\(C: r(s)=(u(s),v(s))\)，則它在P點的測地曲率\(k_g\)可表為下列**克氏符號**（全稱[克里斯多福符號](../Page/克里斯多福符號.md "wikilink")，[Christoffel
symbols](../Page/Christoffel_symbols.md "wikilink")）相關的表示式\[1\] \[2\]
\[3\]：

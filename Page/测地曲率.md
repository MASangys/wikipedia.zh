...
今有一[緊緻定向的二維曲面S](https://zh.wikipedia.org/wiki/緊空間 "wikilink")，其[線元素可用](https://zh.wikipedia.org/wiki/線元素 "wikilink")[曲面的](../Page/曲面.md "wikilink")[第一基本形式的係數表示為](../Page/第一基本形式.md "wikilink")：\(ds^2 = Edu^2+2Fdudv+Gdv^2 \,\)，則其[度量張量可表成下列關係式](https://zh.wikipedia.org/wiki/度量張量 "wikilink")：
...
令\(C\)為曲面S上的一正則曲線，在此曲線上以其弧長\(s\)為參數，則曲線\(C\)的參數方程式為\(C: r(s)=(u(s),v(s))\)，則它在P點的測地曲率\(k_g\)可表為下列**克氏符號**（全稱[克里斯多福符號](https://zh.wikipedia.org/wiki/克里斯多福符號 "wikilink")，[Christoffel
symbols](https://zh.wikipedia.org/wiki/Christoffel_symbols "wikilink")）相關的表示式\[1\]
\[2\] \[3\]：
...
上述用克式符號表示測地曲率的一般公式即是所謂的**Beltrami**公式(Beltrami's formula for geodesic
curvature.)\[4\]。這裡所用的**克氏符號**  在有些書籍還會沿用舊式的
符號注記。由於**克式符號**屬曲面的內蘊性質，而上述**測地曲率**一般公式只和**克式符號**與[曲面](../Page/曲面.md "wikilink")[第一基本形式有關](../Page/第一基本形式.md "wikilink")，因此，**測地曲率**必然是屬曲面的**內蘊幾何**量\[5\]。
...
令\(C\)為曲面S上的一正則曲線，在此曲線上以其弧長\(s\)為參數，則曲線\(C\)的參數方程式為\(C: r(s)=(u(s),v(s))\)，今其參數化是採[正交座標系](../Page/正交座標系.md "wikilink")，換言之，[第一基本形式的係數](../Page/第一基本形式.md "wikilink")\(F=0\)，又令曲線\(C\)在P點與\(u\)座標線的夾角為\(\theta\)，則它在P點的測地曲率\(k_g\)可表為下列與\(\theta (s)\)夾角相關的**Liouville**公式\[6\]
\[7\] \[8\]：
...
1.
2.  [【推導過程見MIT線上開放課程 §10.2.1. Parametric
    surfaces】](http://web.mit.edu/hyperbook/Patrikalakis-Maekawa-Cho/mathe.html)
3.
4.
5.
6.
7.
8.
9.  Sigurd Angenent. [A note and two problems on Liouville's
    formula.](http://www.math.wisc.edu/~angenent/561/liouvillesummary.pdf)
    這是介紹測地曲率之Liouville公式更加精簡形式的文件。
...
[数学上](../Page/数学.md "wikilink")，**测度**（）是一个[函数](../Page/函数.md "wikilink")，它对一个给定[集合的某些](https://zh.wikipedia.org/wiki/集合_\(數學\) "wikilink")[子集指定一个数](../Page/子集.md "wikilink")，这个数可以比作大小、[体积](../Page/体积.md "wikilink")、[概率等等](../Page/概率.md "wikilink")。传统的[积分是在](../Page/积分.md "wikilink")[区间上进行的](https://zh.wikipedia.org/wiki/区间 "wikilink")，后来人们希望把积分推广到任意的集合上，就发展出测度的概念，它在[数学分析和](../Page/数学分析.md "wikilink")[概率论有重要的地位](https://zh.wikipedia.org/wiki/概率论 "wikilink")。

**测度论**是[实分析的一个分支](https://zh.wikipedia.org/wiki/实分析 "wikilink")，研究对象有[σ代数](https://zh.wikipedia.org/wiki/σ代数 "wikilink")、测度、[可测函数和](../Page/可测函数.md "wikilink")[积分](../Page/积分.md "wikilink")，其重要性在[概率论和](https://zh.wikipedia.org/wiki/概率论 "wikilink")[统计学中都有所体现](../Page/统计学.md "wikilink")。

## 定义

正式的定義為，一个测度\(\mu\\)（详细的说法是**可列可加的正测度**）是个函数。设\(\mathcal{A}\) 的元素是
\(X\\)的子集合，而且是一個[\(\sigma\)-代數](https://zh.wikipedia.org/wiki/σ代数 "wikilink")，\(\mu\\)在\(\mathcal{A}\)上定义，于\([0,\infty]\)中取值，并且满足以下性质：
...
测度\(\mu\\)的[单调性](https://zh.wikipedia.org/wiki/单调性 "wikilink")：
...
如果还满足并且对于所有的\(n\\)，\(E_n\\)⊆\(E_{n+1}\\)，则如下[极限式成立](https://zh.wikipedia.org/wiki/扩充实数线#极限 "wikilink")：

\[\mu\left(\bigcup_{i=1}^\infty E_i\right) = \lim_{i\to\infty}  \mu(E_i).\]

### 可数个[可测集的交集的测度](https://zh.wikipedia.org/wiki/可测集 "wikilink")

若\(E_1,E_2,\cdots\)为可测集，并且对于所有的\(n\\)，\(E_{n+1}\\)⊆\(E_n\\)，则\(E_n\\)的[交集是可测的](../Page/交集.md "wikilink")。进一步说，如果至少一个\(E_n\\)的测度[有限](https://zh.wikipedia.org/wiki/扩充实数线#定义 "wikilink")，则有极限：
...
下列是一些测度的例子（顺序与重要性无关）。
  ...
  - **Circular
    angle测度**是[旋转不变的](https://zh.wikipedia.org/wiki/旋转（数学） "wikilink")。
...
## 相关条目
  ...
  - [几乎处处](https://zh.wikipedia.org/wiki/几乎处处 "wikilink")（Almost
    everywhere）
...
## 参考文献
  ...
  - Shilov, G. E., and Gurevich, B. L., 1978. *Integral, Measure, and
    ...
    integral](https://zh.wikipedia.org/wiki/Daniell_integral "wikilink").

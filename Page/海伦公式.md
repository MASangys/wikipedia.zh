...
formula**或**Hero's
formula**），又譯-{zh-cn:**希罗-{}-公式**\[1\]、**希-{}-伦公式**、**海龙-{}-公式**;zh-hk:**希-{}-倫公式**、**海龍-{}-公式**，**海龍-{}-公式**;zh-tw:**希羅-{}-公式**\[2\]、**希-{}-倫公式**、**海倫-{}-公式**、**海隆-{}-公式**}-，亦称“海伦-秦九韶公式”。此公式是[亞歷山大港的希羅發現的](https://zh.wikipedia.org/wiki/亞歷山大港的希羅 "wikilink")，並可在其於公元60年的《Metrica》中找到其證明，利用[三角形的三條邊長來求取三角形面積](../Page/三角形.md "wikilink")。亦有認為早於[阿基米德已經懂得這條公式](../Page/阿基米德.md "wikilink")，而由於《Metrica》是一部古代數學知識的結集，该公式的發現時期很有可能先於希羅的著作。\[3\]

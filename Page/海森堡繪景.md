...
**海森堡繪景**（Heisenberg
picture）是[量子力學的一種表述](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，因物理學者[维尔纳·海森堡而命名](../Page/维尔纳·海森堡.md "wikilink")。在海森堡繪景裏，對應於[可觀察量的](../Page/可觀察量.md "wikilink")[算符會隨著時間流易而演化](../Page/算符.md "wikilink")，而描述量子系統的[態向量則與時間無關](../Page/態向量.md "wikilink")。使用海森堡繪景，可以很容易地觀察到量子系統與經典系統之間的動力學關係。\[1\]

海森堡繪景與[薛丁格繪景](../Page/薛丁格繪景.md "wikilink")、[狄拉克繪景不同](https://zh.wikipedia.org/wiki/狄拉克繪景 "wikilink")。在薛丁格繪景裏，描述量子系統的[態向量隨著時間流易而演化](../Page/態向量.md "wikilink")，而像[位置](https://zh.wikipedia.org/wiki/位置 "wikilink")、[動量一類的對應於可觀察量的算符則不會隨著時間流易而演化](https://zh.wikipedia.org/wiki/動量 "wikilink")。在狄拉克繪景裏，態向量與對應於可觀察量的算符都會隨著時間流易而演化。

...
**海森堡繪景**（Heisenberg
picture）是[量子力學的一種表述](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，因物理學者[维尔纳·海森堡](../Page/维尔纳·海森堡.md "wikilink")而命名。在海森堡繪景裏，對應於[可觀察量](../Page/可觀察量.md "wikilink")的[算符](../Page/算符.md "wikilink")會隨著時間流易而演化，而描述量子系統的[態向量](../Page/態向量.md "wikilink")則與時間無關。使用海森堡繪景，可以很容易地觀察到量子系統與經典系統之間的動力學關係。\[1\]

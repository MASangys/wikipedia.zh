**涡量**，也称为**涡度**，是一个[流體力學的概念](https://zh.wikipedia.org/wiki/流體力學 "wikilink")，用以描述[流體的旋轉情況](https://zh.wikipedia.org/wiki/流體 "wikilink")。[數學上](https://zh.wikipedia.org/wiki/數學 "wikilink")，渦度\(\zeta\)是描述[速度](../Page/速度.md "wikilink")場

**涡量**，也称为**涡度**，是一个[流體力學的概念](https://zh.wikipedia.org/wiki/流體力學 "wikilink")，用以描述[流體的旋轉情況](https://zh.wikipedia.org/wiki/流體 "wikilink")。[數學上](https://zh.wikipedia.org/wiki/數學 "wikilink")，渦度\(\zeta\)是描述[速度場](../Page/速度.md "wikilink")
\(\vec{v}\)的[旋度](../Page/旋度.md "wikilink")，是一個[向量場](https://zh.wikipedia.org/wiki/向量場 "wikilink")。
...
對於二維流體而言，其渦度向量垂直於流體平面。而若有一流體繞著一個軸心[剛體旋動的話](https://zh.wikipedia.org/wiki/剛體 "wikilink")，則其渦度值為[角速度之兩倍](../Page/角速度.md "wikilink")；故對這樣的流體而言，若渦度值為零的話則必為非旋轉流體。但是，非旋轉流體仍然可以具有非零值的角速度，如一繞著軸心繞轉時、其切線速度剛好正比於流體與軸心距離之倒數的流體，其渦度為零。
...
普遍而言，對[黏度低](https://zh.wikipedia.org/wiki/黏度 "wikilink")（[雷諾數較高](https://zh.wikipedia.org/wiki/雷諾數 "wikilink")）的流體來說，渦度是個相當有用的物理量。在這些情況下，無論速度場有多複雜，除了一小部分空間外、渦度場均可較準地近似為零。這個近似法對二維無黏性的流體而言是正確的，皆因這樣的流體之流線場可以透過[複分析而解得](../Page/複分析.md "wikilink")。
...
與渦度相關的物理量有[渦旋曲線](https://zh.wikipedia.org/wiki/渦旋曲線 "wikilink")，這些曲線的每一點均[相切於該點的渦度](https://zh.wikipedia.org/wiki/相切 "wikilink")；而渦旋管則是由通過一[封閉曲線上每一點的渦旋曲線所組成的封閉面](https://zh.wikipedia.org/wiki/封閉 "wikilink")。\[3\]渦旋管的強度就是通過該面的渦度量積分；由於渦度之[散度為零](../Page/散度.md "wikilink")，故渦旋管強度在管上各處相等。根據[赫爾姆霍茨定理](https://zh.wikipedia.org/wiki/赫爾姆霍茨定理 "wikilink")，無黏性流體之渦旋管強度亦不隨著時間而改變（黏度會令流體出現摩擦損耗因而隨時間改變）。

另外，就三維流體而言，延長渦旋曲線可導致流體總渦度增加，亦即所謂的[渦旋伸展](https://zh.wikipedia.org/wiki/渦旋伸展 "wikilink")。在浴缸去水口出現的渦旋、以致[龍捲風的形成等都是實際例子](../Page/龍捲風.md "wikilink")。

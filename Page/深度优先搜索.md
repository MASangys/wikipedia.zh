...
深度优先搜索是图论中的经典算法，利用深度优先搜索算法可以产生目标图的相应[拓扑排序表](../Page/拓扑.md "wikilink")，利用拓扑排序表可以方便的解决很多相关的[图论问题](../Page/图论.md "wikilink")，如最大路径问题等等。

因发明“深度优先搜索算法”，[約翰·霍普克洛夫特与](../Page/約翰·霍普克洛夫特.md "wikilink")[罗伯特·塔扬在](../Page/罗伯特·塔扬.md "wikilink")[1986年共同获得计算机领域的最高奖](../Page/1986年.md "wikilink")：[图灵奖](../Page/图灵奖.md "wikilink")。\[1\]
...
定义一个结构体来表达一個二元樹的[节点的结构](../Page/节点.md "wikilink")：
...
那么我们在搜索一个树的时候，从一个[节点开始](../Page/节点.md "wikilink")，能首先获取的是它的两个子节点。例如：

A是第一个访问的，然后顺序是B和D、然后是E。然后再是C、F、G。那么我们怎么来保证这个顺序呢？

这里就应该用[堆栈的结构](../Page/堆栈.md "wikilink")，因为堆栈是一个先进后出的顺序。通过使用[C++的](../Page/C++.md "wikilink")[STL](../Page/STL.md "wikilink")，下面的程序能帮助理解：

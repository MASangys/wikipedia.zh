...
具有深度封包檢測的裝置可以看到[OSI模型](../Page/OSI模型.md "wikilink")的第2層及第3層之後。在某些情况下，深度封包檢測可用來看透OSI模型的第2層至第7層。這包括了整個標頭、資料協議架構及訊息的負載。深度封包檢測功能在裝置採取其他行動時，依據OSI模型第3層之後的資訊被引用。深度封包檢測可以依據包含由封包資料部分摘取出之資訊的特徵資料庫，識別並分類訊務，從而允許比僅依據標頭資訊分類有更精確的控制。在許多情況下，終端可使用[加密及模糊處理技術來規避深度封包檢測](https://zh.wikipedia.org/wiki/加密 "wikilink")。
...
中國政府使用深度封包檢測來監控及審查網路訊務及那些政府聲稱有害於中國民眾與國家利益的內容。這些內容包括色情、宗教訊息及政治異議等\[25\]。在中國的網路裡，[ISP業者使用深度封包檢測查看是否有敏感的關鍵字通過其網路](https://zh.wikipedia.org/wiki/ISP "wikilink")。若有，則其連線將會被切斷。在中國境內的人們時常會在訪問內容含有[臺灣](../Page/臺灣.md "wikilink")與[西藏獨立](https://zh.wikipedia.org/wiki/西藏 "wikilink")、[法輪功](https://zh.wikipedia.org/wiki/法輪功 "wikilink")、[達賴喇嘛](https://zh.wikipedia.org/wiki/達賴喇嘛 "wikilink")、[天安門事件等網站時](../Page/六四事件.md "wikilink")，會連不上去。反對共產黨統治的政治團體及各種反共產黨的行動\[26\]都已被登錄入深度封包檢測中的關鍵字。中國亦阻擋流入或流出該國的網路電話訊務。[Skype](../Page/Skype.md "wikilink")的語音訊務雖不受影響，但其簡訊仍會受到深度封包檢測監控，如內容含有如髒話之類的敏感字眼，不通知通訊的任何一方，直接不予傳送。中國亦封鎖YouTube.com等視訊多媒體網站，以及許多攝影與部落格網站\[27\]。
...
在諾基亞賣出其系統的十年前，[Secure Computing Corp.](https://zh.wikipedia.org/wiki/Secure_Computing_Corp. "wikilink") 曾與伊朗有過交易，賣給該國可用來封鎖網際網路之設備\[28\]。

有人對[華爾街日報這篇由](https://zh.wikipedia.org/wiki/華爾街日報 "wikilink")[華盛頓獨立分析師暨](https://zh.wikipedia.org/wiki/華盛頓特區 "wikilink")[卡托研究所](../Page/卡托研究所.md "wikilink")兼職學者David Isenberg所寫的報導之可信性提出質疑，並特別指出，Roome拒絕承認報導中的言論出自於他，且Isenberg在華爾街日報一篇較早之前所寫的報導中亦曾被提出類似的質疑\[29\]。諾基亞通信並發出下述否認聲明：諾基亞通信「沒有提供過任何具深度封包檢測、網路審查或網際網路過濾等能力之設備給伊朗\[30\]。」紐約時報同一時期的報導寫道，諾基亞通信的業務已被「（2009年）4月一連串的新聞報導（包括[華盛頓時報](https://zh.wikipedia.org/wiki/華盛頓時報 "wikilink")）」，以及這個國家對網際網路與其他媒體審查之檢視所掩埋，但沒有提到深度封包檢測\[31\]。

據規避網際網路審查之開發商[Alkasir的Walid](https://zh.wikipedia.org/wiki/Alkasir "wikilink") Al-Saqaf所述，伊朗於2012年2月使用深度封包檢測，讓整個國家的網際網路速率幾乎陷入停頓。這簡單地排除掉了[Tor](../Page/Tor.md "wikilink")與Alkasir等工具的使用\[32\]。

### 新加坡

新加坡據說設置了深度封包檢測，以監控網際網路訊務\[33\]。

### 馬來西亞

由[國民陣線](../Page/國民陣線.md "wikilink")領導的[馬來西亞政府據傳於](https://zh.wikipedia.org/wiki/馬來西亞 "wikilink")2013年5月5日舉辦之第13屆大選期間使用深度封包檢測監控其政治對手。

在此例中，深度封包檢測被用來封鎖及/或妨礙特定網站，如[Facebook](../Page/Facebook.md "wikilink")帳戶、[部落格與新聞](https://zh.wikipedia.org/wiki/部落格 "wikilink")[入口網站](https://zh.wikipedia.org/wiki/入口網站 "wikilink")\[34\] \[35\]。

## 深度封包檢測與網路中立性

關注[隱私或](https://zh.wikipedia.org/wiki/隱私 "wikilink")[網路中立性的人或組織發覺檢測網際網路內容層之行為極具攻擊性](https://zh.wikipedia.org/wiki/網路中立性 "wikilink")\[36\]，並表示，「網路曾是建立在封包的開放存取與無差別待遇之上！\[37\]」同時，網路中立性規則的批評者則稱之為「尋找問題中的答案」（a solution in search of a problem），並表示網路中立性規則會減少升級網路及推動[次世代網路服務之誘因](https://zh.wikipedia.org/wiki/次世代網路 "wikilink")\[38\]。

封包檢測被許多人認為會破壞網際網路的基礎設備，亦被認為違反美國憲法\[39\]。
...
[nDPI](http://www.ntop.org/products/ndpi/)（OpenDPI\[40\]的一分支）\[41\]\[42\]是用來檢測非[模糊](https://zh.wikipedia.org/wiki/模糊 "wikilink")[協議的](https://zh.wikipedia.org/wiki/網路傳輸協定 "wikilink")[開源版本](https://zh.wikipedia.org/wiki/開源 "wikilink")。PACE則包含了模糊與加密協議，與[Skype](../Page/Skype.md "wikilink")或加密[BitTorrent所使用的協議相關](https://zh.wikipedia.org/wiki/BitTorrent "wikilink")\[43\]。OpenDPI已不再維護，取而代之的是nDPI\[44\]，現仍積極維護與擴充包含[Skype](../Page/Skype.md "wikilink")、[Webex](../Page/Webex.md "wikilink")、[Citrix與其他軟體在內的新協議](https://zh.wikipedia.org/wiki/Citrix "wikilink")。

L7-Filter是用於Linux的Netfilter識別應用層之封包的分類器\[45\]。L7-Filter可分類[Kazza](https://zh.wikipedia.org/wiki/Kazza "wikilink")、[HTTP](https://zh.wikipedia.org/wiki/HTTP "wikilink")、[Jabber](https://zh.wikipedia.org/wiki/Jabber "wikilink")、[Citrix](https://zh.wikipedia.org/wiki/Citrix "wikilink")、[BitTorrent](https://zh.wikipedia.org/wiki/BitTorrent "wikilink")、[FTP](https://zh.wikipedia.org/wiki/FTP "wikilink")、[Gnucleus](https://zh.wikipedia.org/wiki/Gnucleus "wikilink")、eDonkey2000與其他軟體。L7-Filter亦可分類串流、電子郵件、P2P、[網路電話](https://zh.wikipedia.org/wiki/網路電話 "wikilink")、協議及遊戲等應用。

Hippie（高性能協議識別引擎）是一項開源計畫，被開發作為Linux的核心模組\[46\]。Hippie為Josh Ballard所開發。Hippie支援深度封包檢測與防火牆功能\[47\]。

SPID（統計協議識別）計畫透過識別應用程式的訊務，進行網路流量的[統計分析](https://zh.wikipedia.org/wiki/統計分析 "wikilink")\[48\]。SPID演算法可透過分析pcap檔的流量（封包大小等）與負載統計（位元值等），檢測應用層協議（第7層）。SPID只是個概念驗證程式，目前支援大約15個應用及協議，如[eDonkey混淆訊務](https://zh.wikipedia.org/wiki/eDonkey "wikilink")、[Skype](../Page/Skype.md "wikilink")的UDP與TCP、[BitTorrent](https://zh.wikipedia.org/wiki/BitTorrent "wikilink")、[IMAP](https://zh.wikipedia.org/wiki/IMAP "wikilink")、[IRC](../Page/IRC.md "wikilink")、[MSN](../Page/MSN.md "wikilink")等。

Tstat（TCP統計與分析工具）提供流量圖像的概觀，並給出許多應用與協議的細節與統計\[49\]。

Libprotoident引入輕度封包檢測（LPI），只檢查每個方向之負載的頭4個位元組。這可減輕對隱私的疑慮，降低為分類而需儲存封包紀錄的硬碟空間。Libprotoident支援200個不同的協議，且其分類使用負載模式匹配、負載大小、埠號與IP匹配等混合而成的方法\[50\]。

法國公司Amesys設計並出售給[格達費一套侵入型與大規模網際網路監控系統](https://zh.wikipedia.org/wiki/格達費 "wikilink")，被稱為Eagle\[51\]。

### 比較

各種使用了深度封包檢測的網路流量分類器（PACE、OpenDPI、L7-filter的4種設定、NDPI、Libprotoident及Cisco NBAR）的整體比較，可見《流量分類常見DPI工具的獨立比較》（Independent Comparison of Popular DPI Tools for Traffic Classification）一文\[52\]。

## 硬體

在[禁止網路盜版法案與](https://zh.wikipedia.org/wiki/禁止網路盜版法案 "wikilink")[保護智慧財產權法案被否決之後](https://zh.wikipedia.org/wiki/保護智慧財產權法案 "wikilink")，深度封包檢測得到了更多的重視。許多現行的深度封包檢測方法既慢又昂貴，特別是對於高頻寬的應用。更有效的深度封包檢測方法被開發出來。專用路由器現在已可以執行深度封包檢測；具備程式字典的路由器將能協助識別內網與網際網路訊務之目的。Cisco Systems已開發出具有深度封包檢測功能的第二代路由器，稱之為CISCO ISR G2\[53\]。
...
28. ["Iran's Web Spying Aided By Western Technology"](http://online.wsj.com/article/SB124562668777335653.html) by Christopher Rhoads in New York and Loretta Chao in Beijing, *The Wall Street Journal*, June 22, 2009. Retrieved 6/22/09.

29. ["Questions about WSJ story on Net Management in Iran"](http://www.isen.com/blog/2009/06/questions-about-wsj-story-on-net.html) by David S. Isenberg, isen.blog, June 23, 2009. Retrieved 6/22/09.

30. ["Provision of Lawful Intercept capability in Iran"](http://www.nokiasiemensnetworks.com/global/Press/Press+releases/news-archive/Provision+of+Lawful+Intercept+capability+in+Iran.htm) Company press release. June 22, 2009. Retrieved 6/22/09.

31. ["Web Pries Lid of Iranian Censorship"](http://www.nytimes.com/2009/06/23/world/middleeast/23censor.html?_r=1&hp) by Brian Stelter and Brad Stone, *The New York Times*, June 22, 2009. Retrieved 6/23/09.

32. [Feb. 14, 2012 "Breaking and Bending Censorship with Walid Al-Saqaf"](http://www.arsehsevom.net/2012/02/breaking-and-bending-censorship-with-walid-al-saqaf/) , an Interview with [Arseh Sevom](http://www.arsehsevom.net/). Last viewed Feb. 23, 2102.
...
40. [Opendpi](http://www.opendpi.org/)

41.

42.

43. [Deep packet inspection engine goes open source](http://arstechnica.com/open-source/news/2009/09/deep-packet-inspection-engine-goes-open-source.ars)

44. [nDPI](http://www.ntop.org/products/ndpi/)

45. [L7-Filter home page](http://l7-filter.sourceforge.net/)

46. [Hippie Project download page on SourceForge](http://hippie.cvs.sourceforge.net/viewvc/hippie/)

47. [Hippie reference page](http://www.linux112.com/hippie-p313520.html)

48. [SPID project on SourceForge](http://sourceforge.net/projects/spid/)

49. [Tstat project home](http://tstat.tlc.polito.it/index.shtml)

50. [Libprotoident project home](http://research.wand.net.nz/software/libprotoident.php)

51. *[Spy-Gear Business to Be Sold - Amesys to Sell Business That Provided Surveillance Technology Used by Gadhafi](http://www.wallstreetjournal.de/article/SB10001424052970203961204577269391401776590.html)*, the Wall Street Journal, German edition, friday, march the 9th of 2012.

52.

53. Application Visibility and Control. (n.d.). In Cisco Systems. Retrieved from <http://www.cisco.com/en/US/prod/routers/application_visibility_control.html>.
当[曲线上一点](../Page/曲线.md "wikilink")\(M\)沿曲线无限远离[原点时](https://zh.wikipedia.org/wiki/原点 "wikilink")，如果\(M\)到一条[直线的](../Page/直线.md "wikilink")[距离](../Page/距离.md "wikilink")[无限](https://zh.wikipedia.org/wiki/无限 "wikilink")[趋近于零](https://zh.wikipedia.org/wiki/極限 "wikilink")，那么这条直线称为这条曲线的**渐近线**。數學上的定義則是：若函數\(y=f \left(x \right)\)的圖形[收斂](https://zh.wikipedia.org/wiki/收斂 "wikilink")，則漸近線為\(y=\lim_{x \to \infty} f \left(x \right)\)，

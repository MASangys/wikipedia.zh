当[曲线上一点](../Page/曲线.md "wikilink")\(M\)沿曲线无限远离[原点时](../Page/原点.md "wikilink")，如果\(M\)到一条[直线的](../Page/直线.md "wikilink")[距离](../Page/距离.md "wikilink")[无限](../Page/无限.md "wikilink")[趋近于零](../Page/極限.md "wikilink")，那么这条直线称为这条曲线的**渐近线**。數學上的定義則是：若函數\(y=f \left(x \right)\)的圖形[收斂](../Page/收斂.md "wikilink")，則漸近線為\(y=\lim_{x \to \infty} f \left(x \right)\)，
...
若[极限](../Page/极限.md "wikilink")\(\lim_{x \to \infty} \frac{f(x)}{x}=a\)存在，且极限\(\lim_{x \to + \infty} \left[f \left (x \right) -ax \right]=b\)也存在，那么曲线\(y=f \left(x \right)\)具有渐近线\(y=ax+b\)。

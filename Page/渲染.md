[Glasses_800_edit.png](https://zh.wikipedia.org/wiki/File:Glasses_800_edit.png "fig:Glasses_800_edit.png") 3.6所创建的一幅[图像](https://zh.wikipedia.org/wiki/图像 "wikilink")。图中突出表现了玻璃器皿以及液体等的质感\]\] **渲染**（，或称为**绘制**）在[電腦繪圖中](https://zh.wikipedia.org/wiki/電腦繪圖 "wikilink")，是指以[软件](../Page/软件.md "wikilink")由[模型生成](https://zh.wikipedia.org/wiki/三維模型 "wikilink")[图像的过程](https://zh.wikipedia.org/wiki/图像 "wikilink")。模型是用语言或者数据结构进行严格定义的三维物体或虚拟场景的描述，它包括几何、视点、[纹理](https://zh.wikipedia.org/wiki/纹理 "wikilink")、[照明和](https://zh.wikipedia.org/wiki/照明 "wikilink")[阴影等信息](https://zh.wikipedia.org/wiki/阴影 "wikilink")。图像是[数字图像](../Page/数字图像.md "wikilink")或者[位图](../Page/位图.md "wikilink")[图像](https://zh.wikipedia.org/wiki/图像 "wikilink")。彩現用于描述：计算视频编辑软件中的效果，以生成最终视频的输出过程。

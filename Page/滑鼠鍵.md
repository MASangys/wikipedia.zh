...
現今的滑鼠鍵大多是根據[X
Window系統在](../Page/X_Window系統.md "wikilink")1984年製定、以數字鍵操作的標準。\[2\]\[3\]
...
[X Window
System的MouseKeysAccel決定了游標的加速度](https://zh.wikipedia.org/wiki/X_Window_System "wikilink")。\[5\]按下方向鍵的一瞬間，游標會移動一段距離，取決於*action_delta*。過了*mk_delay*後，假如按鍵未放開，游標會加速移動，直到過了前*mk_time_to_max*後，游標就會以*mk_max_speed*勻速移動。
...
| \-1000    | 勻速移動                                          |
| 0         | 勻加速運動，速度直線上升                                  |
| 1000      | 勻[加加速度運動](../Page/加加速度.md "wikilink")，加速度直線上升 |

## 啟用

在使用[X Window
System的](https://zh.wikipedia.org/wiki/X_Window_System "wikilink")[Xorg和](../Page/X.Org_Server.md "wikilink")[XFree86等](../Page/XFree86.md "wikilink")[類Unix系統](https://zh.wikipedia.org/wiki/類Unix系統 "wikilink")，如[Linux](../Page/Linux.md "wikilink")、[BSD和](../Page/BSD.md "wikilink")[AIX](https://zh.wikipedia.org/wiki/AIX "wikilink")，啟用和停用滑鼠鍵的快速鍵的非官方標準是++\[6\]，有時沒有加速度的滑鼠鍵可以透過+啟用，這取決於[視窗管理員](https://zh.wikipedia.org/wiki/視窗管理員 "wikilink")，而且都可在設定檔修改。在Xorg下，setxkbmap可用來啟用滑鼠鍵。\[7\]
...
在[macOS上可在](https://zh.wikipedia.org/wiki/macOS "wikilink")「系統偏好設定」→「輔助使用」→「滑鼠與觸控式軌跡板」啟用滑鼠鍵，也可以按下快速鍵++，或快速按下Touch
Bar上的Touch ID 三次。\[8\]
...
4.  [GNOME Documentation Library, Configuring a Keyboard-Based
    Mouse](http://library.gnome.org/users/gnome-access-guide/stable/dtconfig-mousekeys.html.en)

...
其中\(\, a\)是圓的半徑，\(\, t\)為參數
  ...
  - 在 [極坐標系中](https://zh.wikipedia.org/wiki/極坐標系 "wikilink")，
    \(\, r,\theta\) 一個圓的漸開線的參數方程可以寫成：
...
[歐拉建議使用圓的漸開線作為](https://zh.wikipedia.org/wiki/歐拉 "wikilink")[齒輪的形狀](https://zh.wikipedia.org/wiki/齒輪 "wikilink"),
這個設計普遍存在於目前使用，稱為[漸開線齒輪](https://zh.wikipedia.org/wiki/漸開線齒輪 "wikilink")。

### 懸鏈線的漸開線

一個[懸鏈線的漸開線](https://zh.wikipedia.org/wiki/懸鏈線 "wikilink")
會通過此懸鏈線的[頂點](https://zh.wikipedia.org/wiki/頂點 "wikilink")
，形成[曳物線](https://zh.wikipedia.org/wiki/曳物線 "wikilink")。
在[笛卡兒坐標系中](https://zh.wikipedia.org/wiki/笛卡兒坐標系 "wikilink")，一個懸鏈線的漸開線的參數方程可以寫成：

\(x=t-\mathrm{tanh}(t)\,\)
\(y=\mathrm{sech}(t)\,\)
其中*t*
是參數，而[sech是雙曲正割函數](https://zh.wikipedia.org/wiki/sech "wikilink")(1/cosh(x))
...
*一個* [擺線的漸開線是另一個與它](https://zh.wikipedia.org/wiki/擺線 "wikilink")
[全等的擺線](https://zh.wikipedia.org/wiki/全等 "wikilink")
在[笛卡兒坐標系中](https://zh.wikipedia.org/wiki/笛卡兒坐標系 "wikilink")，一個擺線的漸開線的參數方程可以寫成：

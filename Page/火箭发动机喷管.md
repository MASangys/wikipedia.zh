...
渐缩渐阔喷管最初是由现代火箭之父[罗伯特·戈达德](../Page/罗伯特·戈达德.md "wikilink")发明并用于早期火箭。后来，几乎所有火箭发动机都采用这种理念，包括[沃尔特·蒂尔](https://zh.wikipedia.org/wiki/沃尔特·蒂尔 "wikilink")（Walter Thiel）为德国制造的[V2火箭](https://zh.wikipedia.org/wiki/V2火箭 "wikilink")。

...
**火箭发动机喷管**是用于[火箭发动机的一种](../Page/火箭发动机.md "wikilink")（通常是[渐缩渐阔喷管](https://zh.wikipedia.org/wiki/渐缩渐阔喷管 "wikilink")）[推力喷管](https://zh.wikipedia.org/wiki/推力喷管 "wikilink")。它用于膨胀并加速由燃烧室燃烧推进产生的燃气，使之达到[超高音速](https://zh.wikipedia.org/wiki/超高音速 "wikilink")。

## 历史

渐缩渐阔喷管最初是由现代火箭之父[罗伯特·戈达德发明并用于早期火箭](../Page/罗伯特·戈达德.md "wikilink")。后来，几乎所有火箭发动机都采用这种理念，包括[沃尔特·蒂尔](https://zh.wikipedia.org/wiki/沃尔特·蒂尔 "wikilink")（Walter
Thiel）为德国制造的[V2火箭](https://zh.wikipedia.org/wiki/V2火箭 "wikilink")。
...
废气出口速度**V<sub>e</sub>**根据火箭发动机推进剂不同有所变化，以下是一些典型出口速度：
  ...
  - 1.7 to 2.9 km/s (3800 to 6500 mi/h)
    液体[单组元推进剂](https://zh.wikipedia.org/wiki/单组元推进剂 "wikilink")
  - 2.9 to 4.5 km/s (6500 to 10100 mi/h)
    液体[双元推进剂](https://zh.wikipedia.org/wiki/双元推进剂 "wikilink")
  - 2.1 to 3.2 km/s (4700 to 7200 mi/h)
    [固体推进剂](https://zh.wikipedia.org/wiki/固体推进剂 "wikilink")
...
分离过程在出口压力大约为围压的30--40%时发生，但如果将喷管设计为可以增加边缘压力，则此过程可以延缓至出口压力极低，[SSME采用这种技术](https://zh.wikipedia.org/wiki/SSME "wikilink")。(1-2
psi 对应15 psi围压)

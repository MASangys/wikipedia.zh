...
[C++语言标准尚未支持灵活数组类型](../Page/C++.md "wikilink")。但[Visual
C++](https://zh.wikipedia.org/wiki/Visual_C++ "wikilink")2015支持。
...
1.
2.  <http://www.open-std.org/jtc1/sc22/WG14/www/docs/n1256.pdf> section
    §6.7.2.1, item 16, page 103
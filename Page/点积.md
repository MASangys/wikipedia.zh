在[数学中](../Page/数学.md "wikilink")，**点积**（、）又称**-{zh-hans:数量积;zh-hant:數量積}-**或**标量积**（、），是一种接受两个等长的数字序列（通常是[坐标](https://zh.wikipedia.org/wiki/坐标 "wikilink")[向量](../Page/向量.md "wikilink")）、返回单个数字的[代数](../Page/代数.md "wikilink")[运算](https://zh.wikipedia.org/wiki/运算 "wikilink")。在[欧几里得几何中](../Page/欧几里得几何.md "wikilink")，两个[笛卡尔坐标向量的点积常称为](../Page/笛卡尔坐标系.md "wikilink")**-{zh-hans:内积;zh-hant:內積}-**（、），见[内积空间](../Page/内积空间.md "wikilink")。

从代数角度看，先对两个数字序列中的每组对应元素求[积](https://zh.wikipedia.org/wiki/积 "wikilink")，再对所有积求和，结果即为点积。从几何角度看，点积则是两个[向量的](../Page/向量.md "wikilink")[长度与它们夹角](https://zh.wikipedia.org/wiki/向量#大小 "wikilink")[余弦的积](https://zh.wikipedia.org/wiki/余弦 "wikilink")。这两种定义在笛卡尔坐标系中等价。
...
这裡的Σ是[求和符号](../Page/求和符号.md "wikilink")，而*n*是[向量空間的維數](https://zh.wikipedia.org/wiki/向量空間 "wikilink")。
...
|\(\vec{x}\)|
表示\(\vec{x}\)的[模](https://zh.wikipedia.org/wiki/模长 "wikilink")（长度），\(\theta\)表示两个向量之间的[角度](https://zh.wikipedia.org/wiki/角度 "wikilink")。
...
欧氏空间中向量\(\mathbf A\)在向量\(\mathbf B\)上的[标量投影是指](https://zh.wikipedia.org/wiki/scalar_projection "wikilink")
...
应用[余弦定理](https://zh.wikipedia.org/wiki/余弦定理 "wikilink")。
...
构造以\(\vec{a}\)，\(\vec{b}\)，\(\vec{c}\)为边的三角形，采用[余弦定理](https://zh.wikipedia.org/wiki/余弦定理 "wikilink")，有
...
点积可以用来计算[合力和](https://zh.wikipedia.org/wiki/合力 "wikilink")[功](../Page/功.md "wikilink")。若\(\vec{b}\)为单向量，则点积即为\(\vec{a}\)在方向\(\vec{b}\)的投影，即给出了[力在这个方向上的分解](../Page/力.md "wikilink")。功即是力和[位移的点积](../Page/位移.md "wikilink")。
...
如果\(\vec{b}\)是[单位向量](../Page/单位向量.md "wikilink")，则点积给出\(\vec{a}\)在方向\(\vec{b}\)上投影的大小，如果方向相反则带有负号。分解向量对求向量的和经常是有用的，比如在[力学中计算](../Page/力学.md "wikilink")[合力](https://zh.wikipedia.org/wiki/合力 "wikilink")。
...
[矩阵具有](../Page/矩阵.md "wikilink")[弗罗比尼乌斯内积](https://zh.wikipedia.org/wiki/弗罗比尼乌斯内积 "wikilink")，可以类比于向量的内积。它被定义为两个相同大小的矩阵**A**和**B**的对应元素的内积之和。

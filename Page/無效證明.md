在[數學裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，有著許多明顯[矛盾的虛假](../Page/矛盾.md "wikilink")[證明存在](../Page/證明.md "wikilink")。即使其證明是有缺陷的，其錯誤－通常是經過設計的－卻常是較難抓摸的。這些[謬誤一般都儘止於好奇而已](../Page/謬誤.md "wikilink")，但可以被使用顯示嚴謹在數學中的重要性。
...
這個證明的錯誤點在於第五步，由於\(a - b \,\)等於[零](https://zh.wikipedia.org/wiki/零 "wikilink")，而[除以零是無效的](../Page/除以零.md "wikilink")。
...
1.  在矩形ABCD外作CE=CD。
2.  联结AE。
3.  作BC、AE的[中垂线](https://zh.wikipedia.org/wiki/中垂线 "wikilink")，它们的垂足分别是G、F，两条[直线交于H](../Page/直线.md "wikilink")。
...
\[\int \frac{1}{x} dx\]
利用[分部积分法](https://zh.wikipedia.org/wiki/分部积分法 "wikilink")，可得：

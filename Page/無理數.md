...
非[有理數之](https://zh.wikipedia.org/wiki/有理數 "wikilink")[實數](https://zh.wikipedia.org/wiki/實數 "wikilink")，不能寫作兩整數之比。若將它寫成[小數形式](https://zh.wikipedia.org/wiki/小數 "wikilink")，小數點之後的數字有無限多個，並且不會循環，即无限不循环小数。常見的無理數有大部分的[平方根](../Page/平方根.md "wikilink")、[π和](https://zh.wikipedia.org/wiki/圓周率 "wikilink")[e](https://zh.wikipedia.org/wiki/e_\(数学常数\) "wikilink")（其中後兩者同時為[超越數](../Page/超越數.md "wikilink")）等。無理數的另一特徵是無限的[連分數表達式](https://zh.wikipedia.org/wiki/連分數 "wikilink")。

[傳說中](https://zh.wikipedia.org/wiki/傳說 "wikilink")，无理数最早由[畢達哥拉斯學派弟子](https://zh.wikipedia.org/wiki/畢達哥拉斯 "wikilink")[希伯斯发现](https://zh.wikipedia.org/wiki/希伯斯 "wikilink")。他以幾何方法證明\(\sqrt{2}\)無法用[整数及](../Page/整数.md "wikilink")[分數表示](../Page/分數.md "wikilink")。而畢達哥拉斯深信任意数均可用整数及分数表示，不相信無理數的存在。後來希伯斯触犯学派章程，将无理数透露给外人，因而被扔进海中处死，其罪名竟然等同于“渎神”。另見[第一次數學危機](https://zh.wikipedia.org/wiki/第一次數學危機 "wikilink")。
...
無理數與無理數的[四則運算的結果往往不知道是否無理數](https://zh.wikipedia.org/wiki/四則運算 "wikilink")，只有\(\pi+(-\pi)\)、\(\sqrt{2}+\sqrt{3}\)等除外。

我們亦不知道\(2^e \,\)、\(\pi^e \,\)、\(\pi^\sqrt{2}\)、[欧拉-马歇罗尼常数](https://zh.wikipedia.org/wiki/欧拉-马歇罗尼常数 "wikilink")\(\gamma \,\)或[卡塔兰常数](../Page/卡塔兰常数.md "wikilink")\(G\)是否無理數。

## 無理數集的特性

無理數集是[不可數集](../Page/不可數集.md "wikilink")（因有理數集是[可數集而實數集是不可數集](../Page/可數集.md "wikilink")）。無理數集是個不[完備的](https://zh.wikipedia.org/wiki/完備 "wikilink")[拓撲空間](https://zh.wikipedia.org/wiki/拓撲空間 "wikilink")，它是與所有[正數](https://zh.wikipedia.org/wiki/正數 "wikilink")[數列的集](https://zh.wikipedia.org/wiki/數列 "wikilink")[拓撲同構的](https://zh.wikipedia.org/wiki/拓撲同構 "wikilink")，當中的同構[映射是無理數的](https://zh.wikipedia.org/wiki/映射 "wikilink")[連分數開展](https://zh.wikipedia.org/wiki/連分數 "wikilink")。因而[贝尔纲定理可以應用在無數間的拓撲空間上](../Page/贝尔纲定理.md "wikilink")。
...
## 参见
  ...
  - [3的算术平方根](https://zh.wikipedia.org/wiki/3的算术平方根 "wikilink")
  - [5的算术平方根](https://zh.wikipedia.org/wiki/5的算术平方根 "wikilink")

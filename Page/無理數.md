...
非[有理數之](https://zh.wikipedia.org/wiki/有理數 "wikilink")[實數](https://zh.wikipedia.org/wiki/實數 "wikilink")，不能寫作兩整數之比。若將它寫成[小數形式](https://zh.wikipedia.org/wiki/小數 "wikilink")，小數點之後的數字有無限多個，並且不會循環，即无限不循环小数。常見的無理數有大部分的[平方根](../Page/平方根.md "wikilink")、[π和](../Page/圓周率.md "wikilink")[e](https://zh.wikipedia.org/wiki/e_\(数学常数\) "wikilink")（其中後兩者同時為[超越數](../Page/超越數.md "wikilink")）等。無理數的另一特徵是無限的[連分數表達式](https://zh.wikipedia.org/wiki/連分數 "wikilink")。

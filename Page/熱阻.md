...
**熱阻**（thermal
resistance）是一個和[熱有關的性質](https://zh.wikipedia.org/wiki/熱 "wikilink")，是指在有溫度差的情形下，物體抵抗[传热的能力](https://zh.wikipedia.org/wiki/传热 "wikilink")。[熱導率越好的物體](../Page/熱導率.md "wikilink")，熱阻通常會比較低。
  ...
  - 热绝缘系数（Thermal
    insulance，在[國際標準制下單位為](https://zh.wikipedia.org/wiki/國際標準制 "wikilink")(m<sup>2</sup>K)/W，在[英制下為](https://zh.wikipedia.org/wiki/英制 "wikilink")([ft](https://zh.wikipedia.org/wiki/英尺 "wikilink")<sup>2</sup>·[°F](https://zh.wikipedia.org/wiki/華氏度 "wikilink")·[hr](https://zh.wikipedia.org/wiki/小時 "wikilink"))/[Btu](https://zh.wikipedia.org/wiki/英熱單位 "wikilink")。是一材料單位面積下的熱阻。若是在隔熱的應用上，會用來量測。

## 絕對熱阻

一物體的絕對熱阻是指在單位時間內當有單位熱能量通過物體時，物體兩端的[溫度差](https://zh.wikipedia.org/wiki/溫度 "wikilink")。是[熱導的倒數](https://zh.wikipedia.org/wiki/熱導 "wikilink")。其國際標準制單位為[开尔文每](../Page/开尔文.md "wikilink")[瓦特或等效的](../Page/瓦特.md "wikilink")[摄氏度每瓦特](../Page/摄氏温标.md "wikilink")（因為Δ1
K = Δ1 °C，上述二個單位是相等的）。
...
| 傳導率                                               | [剛度](https://zh.wikipedia.org/wiki/剛度 "wikilink") \(k\) \[N/m\]    |                                                                                 | 熱導\(1/R\) \[W/(K·m)\]                                                                          | 電導 \(1/R\) \[...\]                                                                 |
...
根据[热传导的傅里叶定律](../Page/热传导.md "wikilink")，可以推导以下的式子，只要所有的参数x和k都是定值，下式都会有效。
...
Phillips的研究人員Clemens J. M.
Lasance在2008年提出一份論文，其中提到：「雖然熱傳導（傅立葉定律）和電流的流動（歐姆定律）有類比關係，但熱傳率及電導率的物理特性使得熱傳導和電流的流動在一般情形下有些不同。……雖然兩者的微分方程式類似的，但在實務上，電阻和熱阻有顯著的不同。一個材料若是絕緣體，其電導率會比導體小20個數量級。但一個材料若是隔熱體，其導熱能力只比導熱體小3個數量級，大約只相關於高摻雜矽及低電摻雜矽的電導率比例」\[3\]

## 量測方式

功率元件中連接點（junction）到空氣的熱阻主要會因環溫而有顯著的變化\[4\]。更精確的說法是，連接點到空氣的熱阻並不是邊界條件獨立（Boundary-Condition
Independent，BCI）\[5\]。[JEDEC有一個標準](../Page/JEDEC.md "wikilink")（JESD51-2）可以量測在[自然对流下連接點到空氣的熱阻](https://zh.wikipedia.org/wiki/自然对流 "wikilink")，有另一個標準（JESD51-6）量測在[強制對流下連接點到空氣的熱阻](../Page/強制對流.md "wikilink")。
...
## 相關條目
  ...
  - [接觸熱導](https://zh.wikipedia.org/wiki/接觸熱導 "wikilink")

## 外部連結

  - Guoping Xu (2006), [Thermal Management for Electronic
    Packaging](https://cseweb.ucsd.edu/classes/wi06/cse291-b/slide/let9/thermal.pdf),
    Sun Microsystems
  - <http://www.electronics-cooling.com/2012/09/update-on-jedec-thermal-standards/>
  - The importance of [Soil Thermal
    Resistivity](https://web.archive.org/web/20141202091212/http://tempsand.com.au/services/tempsand-soil-test-soil-thermal-conductivity-resistivity/)
    for power companies
...
1.  Tony Abbey. "Using FEA for Thermal Analysis". Desktop Engineering
    magazine. 2014 June. p. 32.

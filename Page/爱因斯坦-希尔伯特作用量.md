...
其中\(g = \, {1 \over c^2} \, \det \, (g_{\alpha \beta})\)是时空的[洛伦兹度规的](https://zh.wikipedia.org/wiki/洛伦兹度规 "wikilink")[行列式](../Page/行列式.md "wikilink")，\(R\,\)是[里奇标量](https://zh.wikipedia.org/wiki/里奇数量曲率 "wikilink")，\(\kappa = \frac{8 \pi G}{c^4} \,\)是一个普适性常数，拉格朗日量是\({1 \over 2\kappa} R \sqrt{-g}\)，积分范围是时空中的一块区域。对于有物质存在的爱因斯坦方程，在对应的拉格朗日量中还要添加物质本身的拉格朗日量。（注意：这里所谓“拉格朗日量”都是指其标量密度，在[国际单位制中的单位是](../Page/国际单位制.md "wikilink")[焦耳](../Page/焦耳.md "wikilink")/立方米，而不是指其在空间或时空范围内的一个积分。）
...
根据对[行列式进行](../Page/行列式.md "wikilink")[求导的](../Page/导数.md "wikilink")[雅可比公式](https://zh.wikipedia.org/wiki/雅可比公式 "wikilink")

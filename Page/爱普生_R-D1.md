...
R-D1在2004年推出，机身借鉴了福伦达Bessa
R2作为基础\[3\]；作为一款数码旁轴，R-D1却保留了很多旧式旁轴相机的操作元素，例如对于数码传感器没有存在必要的过片扳手，以及可以翻转收起的回放用屏幕；机身上还使用仪表来显示机身参数，该部分由精工进行开发上的技术支持，也成为玩家群中津津乐道的设计特色。

**R-D1**与其后续机型，使用的都是同一片CCD传感器，为来自索尼公司的**ICX413AQ**\[4\]（interline-transfer
CCD），具备1.5倍的[焦距转换率](../Page/焦距转换率.md "wikilink")；这块传感器自2002年推出\[5\]，也在同时代的其他一些数码单反机型，如**宾得\*ist
D**,
**尼康D100**以及[柯尼卡美能達Dynax_5D上广泛使用](../Page/柯尼卡美能達Dynax_5D.md "wikilink")。
...
## 外部链接
  ...
  - [Epson R-D1 Digital Rangefinder
    Camera](http://www.dpreview.com/articles/1924025521/epsonrd1) -
    Dpreview
...
1.  [エプソン、レンジファインダーデジカメ「R-D1xG」を生産終了](http://dc.watch.impress.co.jp/docs/news/20140317_639952.html)
    - DC Watch Impress
2.  [「カメラグランプリ 2005」は「α-7
    DIGITAL」に～特別賞にF6とR-D1](http://dc.watch.impress.co.jp/cda/other/2005/05/20/1571.html)
    - DC Watch Impress
3.  [写真で見る「エプソン
    R-D1」](http://pc.watch.impress.co.jp/docs/2004/0311/epson2.htm) -
    PC Watch Impress
4.  [ＡＰＳサイズのカラーＣＣＤ撮像素子
    一眼レフデジタルスチルカメラ向けに商品化](http://www.sony.co.jp/SonyInfo/News/Press_Archive/200202/02-0220/)
    - sony.co.jp
5.  [Sony ICX413AQ six megapixel
    CCD](http://www.dpreview.com/articles/9510183425/sonyicx413) - DP
    Review
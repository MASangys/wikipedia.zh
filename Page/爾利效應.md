...
若集电区电压升高，以上因素都会使集电区或晶体管的输出电流增大，如下图所示的[BJT输出特性曲线](https://zh.wikipedia.org/wiki/BJT "wikilink")。特性曲线中电压较大时的切线进行反向外推，其延长线与电压轴相交，在电压轴上截得的负截距称为**厄利电压**（Early voltage），记为**V<sub>A</sub>**。  从爾利效應可以看出，如果BJT的基区寬度發生變化，會導致更大的反向偏置電壓在集电极－基極接面，會增加集电极－基極耗尽区寬度，減少基区寬度。總的來說，增加集电极電壓（V<sub>C</sub>），集电极電流（I<sub>C</sub>）也會跟著上升。

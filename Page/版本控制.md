...
**版本控制**（）是维护工程[藍圖的标准作法](https://zh.wikipedia.org/wiki/藍圖 "wikilink")，能追蹤工程藍图從诞生一直到定案的過程。此外，版本控制也是一種[軟體工程技巧](https://zh.wikipedia.org/wiki/軟體工程 "wikilink")，藉此能在軟體開發的過程中，確保由不同人所編輯的同一程式檔案都得到同步。
...
2000年後，、、和[GNU開始用分散式系統](../Page/GNU.md "wikilink")：開發者直接在各自的本地檔案庫工作，並容許多個開發者同時更動同一檔案，而各個檔案庫有另一個[合併各個改變的功能](https://zh.wikipedia.org/wiki/合併 "wikilink")。這個方式讓開發者能不靠網路也能繼續工作，也讓開發者有充分的版本控制能力，而不需經中央權威許可。分散式系統仍然可以有檔案上鎖功能。
...
## 著名的版本控制軟體
  ...
  - [Micorosoft Visual
    SourceSafe](https://zh.wikipedia.org/wiki/Visual_SourceSafe "wikilink")/[Team
    Foundation
    Server](../Page/Team_Foundation_Server.md "wikilink")/[Visual Studio
    Online](https://zh.wikipedia.org/wiki/Visual_Studio_Online "wikilink")

  - [Perforce](https://zh.wikipedia.org/wiki/Perforce "wikilink")

  - [Rational
    ClearCase](https://zh.wikipedia.org/wiki/Rational_ClearCase "wikilink")

  - [RCS](https://zh.wikipedia.org/wiki/RCS "wikilink")（）

  - [Serena
    Dimention](https://zh.wikipedia.org/wiki/Serena_Dimention "wikilink")
  ...
  - [Monotone
    (軟體)](https://zh.wikipedia.org/wiki/Monotone_\(軟體\) "wikilink")
...
## 參看
  ...
  - [Software
    version](https://zh.wikipedia.org/wiki/Software_version "wikilink")
  ...
  - Related information
      ...
      - [neutral
        build](https://zh.wikipedia.org/wiki/neutral_build "wikilink")

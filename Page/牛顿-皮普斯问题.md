...
\[P(N)=1-\sum_{x=0}^{n-1}\binom{6n}{x}\left(\frac{1}{6}\right)^x\left(\frac{5}{6}\right)^{6n-x}\, .\] *n*变大时，P(*N*)会逐渐趋近于极限值1/2.
...
[Category:概率论](https://zh.wikipedia.org/wiki/Category:概率论 "wikilink") [Category:赌博](https://zh.wikipedia.org/wiki/Category:赌博 "wikilink") [Category:骰子游戏](https://zh.wikipedia.org/wiki/Category:骰子游戏 "wikilink")

1.  [Isaac Newton as a Probabilist](http://galton.uchicago.edu/faculty/stigler/pubs/IsaacNewtonProb-final.html) , Stephen Stigler, University of Chicago
2.
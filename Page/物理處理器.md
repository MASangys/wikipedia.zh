...
[PlayStation 2](../Page/PlayStation_2.md "wikilink")（PS2）的VU0可以被視為早期PPU應用的發展，VU0可以取代CPU來做額外的AI和物理運算，但也支援額外的頂點運算，讓他成為一種額外的補助器而不是一個獨立的單元（Unit）。VU0的用途類似於Havok FX和GPU的物理運算。
...
## 外部連結
  ...
  - [PC Perspective: AGEIA PhysX PPU預覽](http://www.pcper.com/article.php?aid=140&type=expert&pid=1)

在[概率论中](https://zh.wikipedia.org/wiki/概率论 "wikilink")，任何[随机变量的](../Page/随机变量.md "wikilink")**特征函数**（缩写：ch.f，复数形式：ch.f's）完全定义了它的[概率分布](../Page/概率分布.md "wikilink")。在[实直线上](../Page/实数.md "wikilink")，它由以下公式给出，其中*X*是任何具有该分布的随机变量：
...
一般地，这是一个[广义积分](https://zh.wikipedia.org/wiki/广义积分 "wikilink")；被积分的函数可能只是条件可积而不是[勒贝格可积的](https://zh.wikipedia.org/wiki/勒贝格积分 "wikilink")，也就是说，它的[绝对值的积分可能是无穷大](../Page/绝对值.md "wikilink")。\[1\]
...
由于[连续定理](https://zh.wikipedia.org/wiki/莱维连续定理 "wikilink")，特征函数被用于[中心极限定理的最常见的证明中](../Page/中心极限定理.md "wikilink")。
...
在这裡，\(\mathrm{Tr}(\cdot)\)是[迹函数](https://zh.wikipedia.org/wiki/矩阵的迹 "wikilink")，\(\ XT\)表示\(T\)与\(X\)的矩阵乘积。由于矩阵*XT*一定有迹，因此矩阵*X*必须与矩阵*T*的[转置的大小相同](https://zh.wikipedia.org/wiki/转置 "wikilink")；因此，如果*X*是*m*

在[图论中](../Page/图论.md "wikilink")，**特征向量中心性**(**eigenvector
...
[谷歌的](https://zh.wikipedia.org/wiki/谷歌 "wikilink")[PageRank和](../Page/PageRank.md "wikilink")[Katz中心性是特征向量中心性的变体](https://zh.wikipedia.org/wiki/Katz中心性 "wikilink")。\[3\]

## 利用邻接矩阵求特征向量中心性

给定一个节点集合为\(|V|\)的图\(G=(V,E)\)，定义其[邻接矩阵为](../Page/邻接矩阵.md "wikilink")\(A = (a_{v,t})\)，当\(v\)与\(t\)相连时\(a_{v,t} = 1\)，否则\(a_{v,t} = 0\)。则节点\(v\)中心性\(x\)的分数其求解公式为：
...
在[神经科学中](../Page/神经科学.md "wikilink")，研究发现一个模型神经网络其神经元的特征向量中心性与神经元的相对激发率有关。\[4\]

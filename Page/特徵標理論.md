在[數學裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，尤其是在[群表示理論裡](https://zh.wikipedia.org/wiki/群表示理論 "wikilink")，一個群表示的**特徵標**（）是指一個將[群的每個元素連結至](../Page/群.md "wikilink")[表示空間這個](https://zh.wikipedia.org/wiki/表示_\(群\) "wikilink")[域內的每個元素之](../Page/域_\(數學\).md "wikilink")[函數](https://zh.wikipedia.org/wiki/函數 "wikilink")。特徵標蘊藏著群的許多重要性質，且因此可以用來做群的研究。

特徵標理論是對[有限簡單群分類的一個有重要的工具](https://zh.wikipedia.org/wiki/有限簡單群分類 "wikilink")。在[范特-湯普遜定理證明接近一半的地方會有一個用到特徵標的複雜計算](https://zh.wikipedia.org/wiki/范特-湯普遜定理 "wikilink")。另外還有一些較簡單但一樣重要的結論需用在特徵標理論，如[伯恩賽德定理及](https://zh.wikipedia.org/wiki/伯恩賽德定理 "wikilink")[理查·布勞爾和](https://zh.wikipedia.org/wiki/理查·布勞爾 "wikilink")[鈴木通夫所證出之定理](https://zh.wikipedia.org/wiki/鈴木通夫 "wikilink")，此定理表示有限[簡單群不會有一個為廣義](https://zh.wikipedia.org/wiki/簡單群 "wikilink")[四元群的](../Page/四元群.md "wikilink")[西洛2-子群](https://zh.wikipedia.org/wiki/西洛定理 "wikilink")。
...
其中\(\mathrm{Tr}\)為矩陣的[跡數](https://zh.wikipedia.org/wiki/跡數 "wikilink")。
...
在[調和分析中](https://zh.wikipedia.org/wiki/調和分析 "wikilink")，通常定義局部緊阿貝爾[拓撲群](https://zh.wikipedia.org/wiki/拓撲群 "wikilink")
\(G\)
的特徵標為[連續](https://zh.wikipedia.org/wiki/連續函數 "wikilink")[群同態](../Page/群同態.md "wikilink")
...
\((\chi \cdot \eta)(g) = \chi(g) \to \eta(g)\)，稱為對偶群。[龐特里雅金對偶性總結了對偶群的一般性質](https://zh.wikipedia.org/wiki/龐特里雅金對偶性 "wikilink")。
...
<!-- end list -->
  ...
  - 若*F*是[代數封閉的且char](https://zh.wikipedia.org/wiki/代数闭域 "wikilink")(*F*)不可以整除*G*的[阶](../Page/階_\(群論\).md "wikilink")|，則*G*的不可約特徵標之數量等於*G*的[共軛類數](https://zh.wikipedia.org/wiki/共軛類 "wikilink")：
    \(|Irr(G)| = |Conj(G)|\)。
...
的特徵標；根據[弗羅貝尼烏斯互反定理](https://zh.wikipedia.org/wiki/弗羅貝尼烏斯互反定理 "wikilink")，對所有
\(G\) 的特徵標 \(\eta\)，恆有下述等式
...
一個群*G*的某些性質可以由其特徵表中推導出來：
  ...
  - *G*是[可換的若且唯若對每個在表上的特徵標](https://zh.wikipedia.org/wiki/阿貝爾群 "wikilink")，χ(1)
    = 1。
  - *G*有一個非當然[正規子群](https://zh.wikipedia.org/wiki/正規子群 "wikilink")(即*G*不是一個[簡單群](https://zh.wikipedia.org/wiki/簡單群 "wikilink"))[若且唯若對於某些表上的非當然特徵標χ和一些於](https://zh.wikipedia.org/wiki/若且唯若 "wikilink")*G*內的非單位元素*g*，會有χ(1)
    = χ(g)。

...
其多項式的根即為矩陣**A**的[特徵值](https://zh.wikipedia.org/wiki/特徵值 "wikilink")，也是傳遞函數的[极点](https://zh.wikipedia.org/wiki/极点_\(代数\) "wikilink")。极点可以用來分析系統是否為[指數穩定](../Page/指數穩定.md "wikilink")、[臨界穩定或者根本不穩定](../Page/臨界穩定.md "wikilink")。[李雅普諾夫穩定性是另一種不需計算特徵值](https://zh.wikipedia.org/wiki/李雅普諾夫穩定性 "wikilink")，也可以判斷穩定性的方式。

在[自动机理论和](https://zh.wikipedia.org/wiki/自动机理论 "wikilink")[时序逻辑中](https://zh.wikipedia.org/wiki/时序逻辑 "wikilink")，**状态转移表**是展示有限[半自动机或](../Page/半自动机.md "wikilink")[有限状态自动机基于当前状态和其他输入](https://zh.wikipedia.org/wiki/自动机 "wikilink")，要移动到什么状态（或在[非确定有限状态自动机情况下那些状态](../Page/非确定有限状态自动机.md "wikilink")）的表格。“状态表”本质上是其中某些输入是当前状态，而输出包含与其他输出在一起的下一个状态的[真值表](../Page/真值表.md "wikilink")。

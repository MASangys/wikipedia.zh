在[自动机理论和](../Page/自动机理论.md "wikilink")[时序逻辑中](../Page/时序逻辑.md "wikilink")，**状态转移表**是展示有限[半自动机或](../Page/半自动机.md "wikilink")[有限状态自动机基于当前状态和其他输入](../Page/自动机.md "wikilink")，要移动到什么状态（或在[非确定有限状态自动机情况下那些状态](../Page/非确定有限状态自动机.md "wikilink")）的表格。“状态表”本质上是其中某些输入是当前状态，而输出包含与其他输出在一起的下一个状态的[真值表](../Page/真值表.md "wikilink")。
...
3.  指定一个状态为[开始状态](../Page/开始状态.md "wikilink")。开始状态在自动机的形式定义中给出。
4.  指定一个或多个状态为[接受状态](../Page/接受状态.md "wikilink")。它也在自动机的形式定义中给出。

## 引用

  - Michael Sipser: *Introduction to the Theory of Computation*. PWS
    Publishing Co., Boston 1997 ISBN 0-534-94728-X

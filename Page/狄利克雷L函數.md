...
在此 \(\chi\)
是一個[狄利克雷特徵](https://zh.wikipedia.org/wiki/狄利克雷特徵 "wikilink")，\(s \in \mathbb{C}\)
的實部大於一。此函數可[解析延拓為整個複平面上的](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")[亞純函數](https://zh.wikipedia.org/wiki/亞純函數 "wikilink")。

[約翰·彼得·狄利克雷證明對所有](https://zh.wikipedia.org/wiki/約翰·彼得·狄利克雷 "wikilink")
\(\chi\) 俱有
\(L(1,\chi) \neq 0\)，並藉此證明[狄利克雷定理](../Page/狄利克雷定理.md "wikilink")。若
\(\chi\) 是主特徵，則 \(L(s,\chi)\) 在 \(s=1\)
有單[極點](https://zh.wikipedia.org/wiki/極點 "wikilink")。
...
不論可能的[西格爾零點](https://zh.wikipedia.org/wiki/西格爾零點 "wikilink")，狄利克雷L函數有與[黎曼ζ函數相似的無零點區域](../Page/黎曼ζ函數.md "wikilink")，包括
\(\{s:\mathrm{Re}(s) \geq 1\}\)。一如黎曼ζ函數，狄利克雷L函數也有相應的[廣義黎曼猜想](https://zh.wikipedia.org/wiki/廣義黎曼猜想 "wikilink")。
...
表[Γ函數](https://zh.wikipedia.org/wiki/Γ函數 "wikilink")，而符號 \(a\)
由下式給出

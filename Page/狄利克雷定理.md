在[數論中](https://zh.wikipedia.org/wiki/數論 "wikilink")，**狄利克雷定理**說明對於任意[互質](../Page/互質.md "wikilink")的正整數\(a,d\)，有無限多個[質數的形式如](https://zh.wikipedia.org/wiki/質數 "wikilink")\(a+nd\)，其中\(n\)為正整數，即在[算術級數](https://zh.wikipedia.org/wiki/算術級數 "wikilink")\(a+d,a+2d,a+3d,...\)中有無限多個質數——有無限個質數模\(d\)[同餘](../Page/同餘.md "wikilink")\(a\)。

在[数学分析中](../Page/数学分析.md "wikilink")，**狄利克雷定理**（或**若尔当—狄利克雷定理**,**狄利克雷条件**）是关于[傅里叶级数](../Page/傅里叶级数.md "wikilink")[逐点收敛的一个结果](https://zh.wikipedia.org/wiki/逐点收敛 "wikilink")。这个定理的最初版本是由[德国](../Page/德国.md "wikilink")[科学家](https://zh.wikipedia.org/wiki/科学家 "wikilink")[狄利克雷在公元](../Page/約翰·彼得·古斯塔夫·勒熱納·狄利克雷.md "wikilink")1829年证明的\[1\]。由于当时还没有出现适合的[积分理论](https://zh.wikipedia.org/wiki/积分理论 "wikilink")，狄利克雷的证明只能适用于足够规则的函数（除了在有限点以外都[单调的函数](../Page/单调函数.md "wikilink")）。

定理的推广版本则是由[法国数学家](https://zh.wikipedia.org/wiki/法国 "wikilink")[卡米尔·若尔当在](../Page/卡米尔·若尔当.md "wikilink")1881年的证明的，适用于所有局部[有界变差函数](../Page/有界变差.md "wikilink")\[2\]。

## 定理的叙述

设 \(f\)
为一个在\(\mathbb{R}\)上的[周期性的](../Page/周期函数.md "wikilink")[局部可积函数](../Page/局部可积函数.md "wikilink")，其周期为\(2\pi\)。给定
\(x_0 \in \mathbb{R}\)，假设有以下条件成立：

1.  函数 \(f\) 在 \(x_0\) 处有[左极限和右极限](../Page/极限_\(数学\).md "wikilink")，分别记为
    \(f(x_0^+)\) 和 \(f(x_0^-)\)。
...
定理成立的一个特例是当函数 \(f\) 在\(x_0\)
处有[左导数和右导数的时候](../Page/导数.md "wikilink")，又或者是当函数是分段\(\mathcal{C}^{1}\)函数（见[光滑函数](../Page/光滑函数.md "wikilink")）的时候。

## 证明

定理的证明是基于以下事实：傅里叶函数可以通过[卷积以及拥有良好性质的](../Page/卷积.md "wikilink")[三角多项式](../Page/三角多项式.md "wikilink")：[狄利克雷核来计算](../Page/狄利克雷核.md "wikilink")。
...
这种写法接近于使用[黎曼-勒贝格定理所需的条件](../Page/黎曼-勒贝格定理.md "wikilink")，唯一需要考虑的地方是函数
\(\frac{f(x-t)}{\sin(t/2)}\) 在**0**附近并不一定可积。但是由于：

\[\tilde{f}(x) = \frac{ f(x^+)+f(x^-)}{2}\]
存在，可以考虑将区间\([ -\pi , 0)\)上的积分用\(u = -t\)换元，这样
\(S_n(f)(x)\) 就变成：
...
1.  [狄利克雷](../Page/約翰·彼得·古斯塔夫·勒熱納·狄利克雷.md "wikilink"), *Sur la
    convergence des séries trigonométriques qui servent à représenter
    une fonction arbitraire entre des limites données*, Journal de
    Crelle 4 (1829) p. 157-169

...
其中 *μ*(*n*)
是[默比乌斯函数](https://zh.wikipedia.org/wiki/默比乌斯函数 "wikilink")。还有很多的狄利克雷级数都可以通过[默比乌斯倒置算法和](https://zh.wikipedia.org/wiki/默比乌斯倒置算法 "wikilink")[狄利克雷卷积得到](https://zh.wikipedia.org/wiki/狄利克雷卷积 "wikilink")。比如对于一个给定的[狄利克雷特征](https://zh.wikipedia.org/wiki/狄利克雷特征 "wikilink")\(\scriptstyle\chi(n)\)，有

\[\frac{1}{L(\chi,s)}=\sum_{n=1}^{\infty} \frac{\mu(n)\chi(n)}{n^s}\]

其中
\(L(\chi,s)\)是一个[狄利克雷L函数](https://zh.wikipedia.org/wiki/狄利克雷L函数 "wikilink")。
...
其中 σ<sub>*a*</sub>(*n*)
是[因数函数](https://zh.wikipedia.org/wiki/因数函数 "wikilink")。
...
是一个关于复变量 *s*
的函数。为了使得函数有意义，需要考虑使得右端的[无穷级数收敛的](https://zh.wikipedia.org/wiki/无穷级数 "wikilink")*s*。

如果*a*<sub>*n*</sub>}<sub>*n* ∈
**N**</sub>是一个[有界数列](https://zh.wikipedia.org/wiki/有界数列 "wikilink")，那么*f*在所有Re(*s*)

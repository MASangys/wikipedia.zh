[量子場論中](https://zh.wikipedia.org/wiki/量子場論 "wikilink")，**狄拉克旋量**（）為一，出現在自由粒子[狄拉克方程式的](../Page/狄拉克方程式.md "wikilink")[平面波解中](../Page/平面波.md "wikilink")：

\[\psi = \omega_\vec{p}\;e^{-ipx} \;\]； 自由粒子的狄拉克方程式為：

\[(i\gamma^\mu\partial_{\mu}-m)\psi=0 \;,\]
其中（採用[自然單位制](https://zh.wikipedia.org/wiki/自然單位制 "wikilink")\(\scriptstyle c \,=\, \hbar \,=\, 1\)）
...
[狄拉克方程式的形式為](../Page/狄拉克方程式.md "wikilink")：
...
此二為4×4矩陣，與[狄拉克矩陣有關](../Page/狄拉克矩陣.md "wikilink")。其中**0**與**I**為2×2矩陣。
...
\end{bmatrix} \,\] 其中*s* = 1或2（[自旋向上或向下](../Page/自旋.md "wikilink")）。

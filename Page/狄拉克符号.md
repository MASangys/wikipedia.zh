**狄拉克符号**或**狄拉克標記**（）是[量子力学中广泛应用于描述](../Page/量子力学.md "wikilink")[量子态的一套标准符号系统](https://zh.wikipedia.org/wiki/量子态 "wikilink")。在这套系统中，每一个[量子态都被描述为](https://zh.wikipedia.org/wiki/量子态 "wikilink")[希尔伯特空间中的](../Page/希尔伯特空间.md "wikilink")[態向量](../Page/態向量.md "wikilink")，定义为**右矢**（**ket**）：\(|\psi\rangle\)；每一个右矢的[共軛轉置定义为其](https://zh.wikipedia.org/wiki/共軛轉置 "wikilink")**左矢**（**bra**）：\(\langle\psi|\)。
...
不同的两个态矢量的[内积则由一个括号来表示](https://zh.wikipedia.org/wiki/内积 "wikilink")：\(\langle\phi|\psi\rangle\)，当狄拉克符号作用于两个基矢时，所得值为：\(\langle e_i|e_j\rangle = \delta_{ij}\)
（\(\delta_{ij}\)为[克罗内克函數](https://zh.wikipedia.org/wiki/克罗内克函數 "wikilink")）
...
## 相關條目
  ...
  - [角動量圖](https://zh.wikipedia.org/wiki/角動量圖 "wikilink")

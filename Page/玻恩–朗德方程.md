**玻恩－朗德方程**（）是由德国化学家[马克斯·玻恩和](../Page/马克斯·玻恩.md "wikilink")[阿尔弗雷德·朗德提出的一个计算](../Page/阿尔弗雷德·朗德.md "wikilink")[离子化合物](https://zh.wikipedia.org/wiki/离子化合物 "wikilink")[晶格能的公式](https://zh.wikipedia.org/wiki/晶格能 "wikilink")。1918年\[1\]，马克斯·玻恩和阿尔弗雷德·朗德提出晶格能的计算公式可由离子晶格的静[电势和推斥型势能概念推导出来](https://zh.wikipedia.org/wiki/电势 "wikilink")\[2\]。
...
其中：
  ...
  - *M* =
    [马德隆常数](https://zh.wikipedia.org/wiki/马德隆常数 "wikilink")，取决于晶体中的几何排列；
  - *z*<sup>+</sup> = 阳离子电荷数；
  - *z*<sup>−</sup> = 阴离子电荷数；
  - *e* = [元电荷](https://zh.wikipedia.org/wiki/元电荷 "wikilink")，大约1.6022
    [C](../Page/库仑.md "wikilink")；
  - *ε*<sub>0</sub> = [真空电容率](../Page/真空电容率.md "wikilink")；
      -
        4π*ε*<sub>0</sub> = 1.112 C<sup>2</sup>/(J·m)
  - *r*<sub>0</sub> = 最近离子的距离
  - *n* =
    玻恩指数，通常在5到12之间，可由实验测定[压缩性或理论计算得出](https://zh.wikipedia.org/wiki/压缩性 "wikilink")\[3\]。
...
\[n\] =
玻恩指数，通常在5到12之间，表示某种晶体的[压缩性](https://zh.wikipedia.org/wiki/压缩性 "wikilink")
...
将这个能量对\(r\)[微分即可得到用平衡距离](../Page/微分.md "wikilink")\(r_0\)表示未知常数\(B\)的关系式：

**現場總線**（fieldbus）是許多工業用[通訊協定的總稱](https://zh.wikipedia.org/wiki/通訊協定 "wikilink")，一般用在即時分散式控制系統，IEC
...
一個複雜的[自動化系統](https://zh.wikipedia.org/wiki/自動化 "wikilink")（例如組裝生產線）會需要一個有組織的控制系統階層才能運作。在此階層的頂端一般是人機界面（Human
Machine Interface,
...
S50.02，但國際標準的發展花了一段很長的時間。1999年時[國際電工協會](https://zh.wikipedia.org/wiki/國際電工協會 "wikilink")（IEC）的SC65C/WG6標準委員會開會，設法解決在IEC現場總線標準草案上的差異及歧見，會議的結果形成了第二版的IEC
...
這種形式的「標準」一開始是為了[歐洲共同市場所訂定](https://zh.wikipedia.org/wiki/歐洲共同市場 "wikilink")，不著重其共通性，達成了消除各國家之間貿易限制的其主要目的。在第二版標準完成後，形成了一個的委員會SC65C/MT-9來修正IEC
61158標準中彼此不一致的格式及內容。上述標準的修正已進行的相關完善。

## IEC 61158的現狀

在2008年[國際電工委員會提出新的現場總線標準IEC](https://zh.wikipedia.org/wiki/國際電工委員會 "wikilink")
61158，將現場總線相關的標準分為15個通信行规族（Communication Profile Families, CPF）\[1\]：

  - CPF01：（FOUNDATION Fieldbus）。
  - CPF02：[通用工业协定](https://zh.wikipedia.org/wiki/通用工业协定 "wikilink")（Common
    Industrial Protocol，簡稱CIP）。
  ...
  - CPF10：[TCnet](https://zh.wikipedia.org/wiki/TCnet "wikilink")（全名為time-critical
    information and control
    network，由日本[東芝推動的通訊協定](https://zh.wikipedia.org/wiki/東芝 "wikilink")）。
  - CPF11：[EtherCAT](../Page/EtherCAT.md "wikilink")。
  - CPF12：。
  - CPF13：[EPA](https://zh.wikipedia.org/wiki/EPA_\(現場總線\) "wikilink")（全名為Ethernet
    for Plant Automation，中國提出的即時工业以太网通訊協定\[3\]）。

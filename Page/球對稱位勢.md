**球對稱位勢**乃是一種只與徑向距離有關的[位勢](../Page/位勢.md "wikilink")。許多描述宇宙交互作用的基本位勢，像[重力勢](../Page/萬有引力.md "wikilink")、[電勢](../Page/電勢.md "wikilink")，都是球對稱位勢。這條目只講述，在[量子力學裏](../Page/量子力學.md "wikilink")，運動於球對稱位勢中的[粒子的量子行為](../Page/粒子.md "wikilink")。這量子行為，可以用[薛丁格方程式表達為](../Page/薛丁格方程式.md "wikilink")

\[- \frac{\hbar^2}{2\mu}\nabla^2\psi + V(r)\psi=E\psi\]；

其中，\(\hbar\)是[普朗克常數](../Page/普朗克常數.md "wikilink")，\(\mu\)是粒子的[質量](../Page/質量.md "wikilink")，\(\psi\)是粒子的[波函數](../Page/波函數.md "wikilink")，\(V\)是[位勢](../Page/位勢.md "wikilink")，\(r\)是徑向距離，\(E\)是[能量](../Page/能量.md "wikilink")。

由於球對稱位勢\(V(r)\)只與徑向距離有關，與天頂角\(\theta\)、方位角\(\phi\)無關，為了便利分析，可以採用[球坐標](../Page/球坐標.md "wikilink")\((r,\ \theta,\ \phi)\)來表達這問題的薛丁格方程式。然後，使用[分離變數法](../Page/分離變數法.md "wikilink")，可以將[薛丁格方程式分為兩部分](../Page/薛丁格方程式.md "wikilink")，徑向部分與角部分。
...
其中，\(R(r)\)，\(\Theta(\theta)\)，\(\Phi(\phi)\)，都是函數。\(\Theta(\theta)\)與\(\Phi(\phi)\)時常會合併為一個函數，稱為[球諧函數](../Page/球諧函數.md "wikilink")，\(Y_{lm}(\theta,\ \phi)=\Theta(\theta)\Phi(\phi)\)。這樣，本徵函數\(\psi\)的形式變為：
...
其中，非負整數\(l\)是[角動量的](../Page/角動量.md "wikilink")**角量子數**。\(m\)（滿足\(- l\le m\le l\)）是角動量對於z-軸的（量子化的）[投影](../Page/投影.md "wikilink")。不同的\(l\)與\(m\)給予不同的球諧函數解答\(Y_{lm}\)：

\[Y_{lm}(\theta,\ \phi) =(i)^{m+|m|} \sqrt{{(2l+1)\over 4\pi}{(l - |m|)!\over(l+|m|)!}}  \, P_{lm} (\cos{\theta}) \, e^{im\phi}\]；

其中，\(i\)是[虛數單位](../Page/虛數單位.md "wikilink")，\(P_{lm}(\cos{\theta})\)是[伴隨勒讓德多項式](../Page/伴隨勒讓德多項式.md "wikilink")，用方程式定義為

\[P_{lm}(x) = (1 - x^2)^{|m|/2}\ \frac{d^{|m|}}{dx^{|m|}}P_l(x)\]；

而\(P_l(x)\)是\(l\)階[勒讓德多項式](../Page/勒讓德多項式.md "wikilink")，可用[羅德里格公式表示為](../Page/羅德里格公式.md "wikilink")
...
這正是函數為\(u(r)\)，有效位勢為\(V_{\mathrm{eff}}\)的薛丁格方程式。徑向距離\(r\)的定義域是從\(0\)到\(\infty\)。新加入有效位勢的項目，稱為[離心位勢](../Page/離心力.md "wikilink")。
...
1.  \(V(r)=0\)：原方程變為[亥姆霍兹方程](../Page/亥姆霍兹方程.md "wikilink")\((\nabla^2 + \frac{2\mu E}{\hbar^2})A = 0\)，使用球諧函數為[正交歸一基](../Page/正交歸一性.md "wikilink")，解析眞空狀況實例。這實例可以做為別的實例的基礎。
2.  當\(r<r_0\)時，\(V(r)=0\)；否則，\(V(r)=\infty\)：這實例比第一個實例複雜一點，可以描述三維的圓球形盒子中的粒子的量子行為。
3.  \(V(r)\propto r^2\)：研討三維[均向性](../Page/均向性.md "wikilink")[諧振子的實例](../Page/諧振子.md "wikilink")。在量子力學裏，是少數幾個存在簡單的[解析解的量子模型](../Page/解析解.md "wikilink")。
4.  \(V(r)\propto 1/r\)：關於[類氫原子的](../Page/類氫原子.md "wikilink")[束縛態的實例](../Page/束縛態.md "wikilink")，也有簡單的解析解。

### 真空狀況實例

思考\(V(r)=0\)的狀況，設定\(k\ \stackrel{\mathrm{def}}{=}\ \sqrt{2\mu E\over\hbar^2}\)，在設定[無因次的變數](../Page/無因次.md "wikilink")

\[\rho\ \stackrel{\mathrm{def}}{=}\ kr\]。

代入方程式(2)，定義\(J(\rho)\ \stackrel{\mathrm{def}}{=}\  \sqrt{\rho} R(r)\)，就會得到[貝塞爾方程式](../Page/貝塞爾函數.md "wikilink")，一個二階常[微分方程式](../Page/微分方程式.md "wikilink")：

\[\rho^2{d^2J\over d\rho^2}+\rho{dJ\over d\rho}+\left[\rho^2-\left(l+\frac{1}{2}\right)^2\right]J=0\]。

貝塞爾方程式的解答是[第一類貝塞爾函數](../Page/貝塞爾函數#第一類貝塞爾函數.md "wikilink")\(J_{l+1/2}(\rho)\)；而\(R(r)\)是第一類[球貝塞爾函數](../Page/貝塞爾函數#球貝塞爾函數.md "wikilink")
（真空解的[邊界條件要求原點的函數值有限](../Page/邊界條件.md "wikilink")，因此在原點趨於無窮的第二類球貝塞爾函數項的係數必須為零）：

\[R(r) = j_l(kr) \ \stackrel{\mathrm{def}}{=}\   \sqrt{\pi/(2kr)} J_{l+1/2}(kr)\]。<span style="position:absolute;right:15%">(4)</span>

在眞空裏，一個粒子的薛丁格方程（即自由空間中的[齊次](../Page/线性方程组#齐次线性方程组.md "wikilink")[亥姆霍兹方程](../Page/亥姆霍兹方程.md "wikilink")）的解，以球坐標來表達，是球貝塞爾函數與球諧函數的乘積：
...
根據球貝塞爾函數的[封閉方程式](../Page/貝塞爾函數#性質.md "wikilink")，

\[\int_0^{\infty}\ x^2 j_{\alpha}(k_1 x) j_{\alpha}(k_2 x)\ dx = \frac{\pi}{2k_1^2}\delta(k_1-k_2)\]；

其中，\(\alpha>0\)，\(\delta_{k}\)为[克罗内克δ](../Page/克罗内克δ.md "wikilink")。
...
那麼，離散的[能級](../Page/能級.md "wikilink")\(E_{nl}\)為
...
根據貝塞爾函數的[正交歸一性](../Page/正交歸一性.md "wikilink")[方程式](../Page/貝塞爾函數#性質.md "wikilink")，

\[\int_0^1 x J_\alpha(x \xi_{m\alpha}) J_\alpha(x \xi_{n\alpha}) dx = \frac{\delta_{mn}}{2} J_{\alpha+1}(\xi_{n\alpha})^2\]；

其中，\(\alpha > - 1\)，\(\delta_{mn}\)为[克罗内克δ](../Page/克罗内克δ.md "wikilink")，\(\xi_{n\alpha}\)表示\(J_\alpha(x)\)的第\(n\)個0點。
...
三維均向[諧振子的位勢為](../Page/諧振子.md "wikilink")

\[V(r) = \tfrac{1}{2} \mu  \omega^2 r^2\]；

其中，\(\omega\)是[角頻率](../Page/角頻率.md "wikilink")。

用[階梯算符的方法](../Page/量子諧振子#N維諧振子.md "wikilink")，可以證明N維諧振子的能量是
...
回想\(u(r) = r R(r)\)，則徑向薛丁格方程式有一個[歸一化的解答](../Page/歸一化.md "wikilink")：

\[R_{nl}(r) =N_{nl} \, r^{l} \, e^{ - \frac{1}{2}\gamma r^2}\; L^{(l+\frac{1}{2})}_{\frac{1}{2}(n - l)}(\gamma r^2)\]；

其中，函數\(L^{(\alpha)}_k(\gamma r^2)\)是[广义拉盖尔多项式](../Page/拉盖尔多项式#广义拉盖尔多项式.md "wikilink")，\(N_{nl}\)是歸一化常數：
...
首先，將徑向坐標[無因次化](../Page/無因次.md "wikilink")，設定變數\(y= \sqrt{\gamma}r\)；其中，\(\gamma \equiv \frac{\mu \omega}{\hbar}\)。則方程式(5)變為

\[\left[{d^2 \over dy^2} - {l(l+1) \over y^2} - y^2 + 2n - 3 \right] v(y) = 0\]；<span style="position:absolute;right:15%">(6)</span>
...
\[\int^\infty_0 r^2 |R_{nl}(r)|^2 \, dr = 1\]。
...
應用广义拉盖尔多项式的[正交歸一性](../Page/正交歸一性.md "wikilink")，這方程式簡化為
...
應用[伽瑪函數的數學特性](../Page/伽瑪函數.md "wikilink")，同時注意\(n\)與\(l\)的奇偶性相同，可以導引出其它形式的歸一常數。伽瑪函數變為
...
在這裏用到了[雙階乘](../Page/雙階乘.md "wikilink") ()的定義。
...
類氫原子只含有一個[原子核與一個](../Page/原子核.md "wikilink")[電子](../Page/電子.md "wikilink")，是個簡單的[二體系統](../Page/二體問題.md "wikilink")。兩個物體之間，互相作用的位勢遵守[庫侖定律](../Page/庫侖定律.md "wikilink")：

\[V(r) = - \frac{1}{4 \pi \epsilon_0} \frac{Ze^2}{r}\]；

其中，\(\epsilon_0\)是[真空電容率](../Page/真空電容率.md "wikilink")，\(Z\)是[原子序](../Page/原子序.md "wikilink")，\(e\)是[單位電荷量](../Page/單位電荷量.md "wikilink")，\(r\)是電子離[原子核的徑向距離](../Page/原子核.md "wikilink")。
...
其中，\(a_{\mu} = {{4\pi\varepsilon_0\hbar^2}\over{\mu e^2}}\)。\(a_{\mu}\)近似於[波耳半徑](../Page/波耳模型.md "wikilink")\(a_0\)。假若，原子核的質量是無限大的，則\(a_\mu = a_0\)，並且，約化質量等於電子的質量，\(\mu=m_e\)。\(L_{n-l-1}^{2l+1}\)是广义拉盖尔多项式，定義為\[1\]
...
為了滿足\(R_{nl}(r)\)的邊界條件，\(n\)必須是正值整數，能量也離散為[能級](../Page/能級.md "wikilink")\(E_{n} = - \left(\frac{Z^2\mu e^4}{32 \pi^2\epsilon_0^2\hbar^2}\right) \frac{1}{n^2}=\frac{ - 13.6Z^2}{n^2}\ (eV)\)。隨著量子數的不同，函數\(R_{nl}(r)\)與\(Y_{lm}\)都會有對應的改變。為了要結束广义拉盖尔多项式的[遞迴關係](../Page/遞迴關係.md "wikilink")，必須要求\(l < n\)。
...
為了要簡化薛丁格方程式，設定能量與長度的[原子單位](../Page/原子單位.md "wikilink") ()
...
1.  \(W<0\)：量子態是[束縛態](../Page/束縛態.md "wikilink")，其本徵函數是[平方可積函數](../Page/平方可積函數.md "wikilink")。量子化的\(W\)造成了離散的能量譜。
2.  \(W\ge 0\)：量子態是[散射態](../Page/散射態.md "wikilink")，其本徵函數不是平方可積函數。

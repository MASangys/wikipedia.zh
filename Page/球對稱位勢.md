...
3.  \(V(r)\propto r^2\)：研討三維[均向性](https://zh.wikipedia.org/wiki/均向性 "wikilink")[諧振子的實例](../Page/諧振子.md "wikilink")。在量子力學裏，是少數幾個存在簡單的[解析解的量子模型](https://zh.wikipedia.org/wiki/解析解 "wikilink")。
4.  \(V(r)\propto 1/r\)：關於[類氫原子的](../Page/類氫原子.md "wikilink")[束縛態的實例](https://zh.wikipedia.org/wiki/束縛態 "wikilink")，也有簡單的解析解。
...
類氫原子只含有一個[原子核與一個](../Page/原子核.md "wikilink")[電子](https://zh.wikipedia.org/wiki/電子 "wikilink")，是個簡單的[二體系統](../Page/二體問題.md "wikilink")。兩個物體之間，互相作用的位勢遵守[庫侖定律](https://zh.wikipedia.org/wiki/庫侖定律 "wikilink")：

\[V(r) = - \frac{1}{4 \pi \epsilon_0} \frac{Ze^2}{r}\]；

其中，\(\epsilon_0\)是[真空電容率](https://zh.wikipedia.org/wiki/真空電容率 "wikilink")，\(Z\)是[原子序](https://zh.wikipedia.org/wiki/原子序 "wikilink")，\(e\)是[單位電荷量](https://zh.wikipedia.org/wiki/單位電荷量 "wikilink")，\(r\)是電子離[原子核的徑向距離](../Page/原子核.md "wikilink")。

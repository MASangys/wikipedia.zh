> 本文内容由[球諧函數表](https://zh.wikipedia.org/wiki/球諧函數表)转换而来。


這裏列出[球諧函數](https://zh.wikipedia.org/wiki/球諧函數 "wikilink") \(Y_{l}^{m}\) ，以方程式表示為

\[Y_\ell^m( \theta , \varphi ) = \sqrt{{(2\ell+1)\over 4\pi}{(\ell-m)!\over (\ell+m)!}}  \, P_\ell^m ( \cos{\theta} ) \, e^{i m \varphi }\] ；

其中，\(l\) 為正值整數，\(m\) 為小於或等於 \(l\) 的正值整數，\(P_\ell ^{m}\) 是[伴隨勒讓德多項式](https://zh.wikipedia.org/wiki/伴隨勒讓德多項式 "wikilink")，以方程式表示為

\[P_\ell ^{m} (x)= (-1)^m (1-x^2)^{m/2} \frac{\mathrm{d}^m P_\ell (x)}{\mathrm{d}x^m}\] 。

表內有些方程式也給出[直角坐標版本](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")。[球坐標與](https://zh.wikipedia.org/wiki/球坐標 "wikilink")[直角坐標之間的變換關係是](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")
...
={1\over 4}\sqrt{15\over 2\pi}\cdot{(x - iy)^2 \over r^{2}}\]

\[Y_{2}^{-1}(\theta,\varphi)
={1\over 2}\sqrt{15\over 2\pi}\cdot e^{-i\varphi}\cdot\sin\theta\cdot\cos\theta\quad
={1\over 2}\sqrt{15\over 2\pi}\cdot{(x - iy)z \over r^{2}}\]

\[Y_{2}^{0}(\theta,\varphi)
={1\over 4}\sqrt{5\over \pi}\cdot(3\cos^{2}\theta-1)\quad
={1\over 4}\sqrt{5\over \pi}\cdot{(-x^{2}-y^{2}+2z^{2})\over r^{2}}\]
...
[Category:特殊超幾何函數](https://zh.wikipedia.org/wiki/Category:特殊超幾何函數 "wikilink") [Category:数学列表](https://zh.wikipedia.org/wiki/Category:数学列表 "wikilink")
這裏列出[球諧函數](../Page/球諧函數.md "wikilink") \(Y_{l}^{m}\) ，以方程式表示為
...
是[伴隨勒讓德多項式](../Page/伴隨勒讓德多項式.md "wikilink")，以方程式表示為

\[P_\ell ^{m} (x)= (-1)^m (1-x^2)^{m/2} \frac{\mathrm{d}^m P_\ell (x)}{\mathrm{d}x^m}\]
。

表內有些方程式也給出[直角坐標版本](../Page/直角坐標.md "wikilink")。[球坐標與](../Page/球坐標.md "wikilink")[直角坐標之間的變換關係是](../Page/直角坐標.md "wikilink")

**球面** （）是[三维空间中完全圆形的](https://zh.wikipedia.org/wiki/立体几何 "wikilink")[几何物体](../Page/几何学.md "wikilink")，它是[圆球的表面](../Page/球_\(数学\).md "wikilink")（类似于在二维空间中，“[圆](../Page/圆.md "wikilink") ”包围着“[圆盘](../Page/圆盘.md "wikilink")”那样）。
...
尽管在数学之外，术语“球面”和“球”有时可互换使用，但在[数学](../Page/数学.md "wikilink")中是明确区分的：*球面*是一种嵌在三维[欧几里得空间](../Page/欧几里得空间.md "wikilink")内的二维封闭曲面，而*球*是一种三维图形，其包括球面和球面*内部*的一切（**闭球**），不过更常见的定义是只包括球面*内部*的所有点，*不包括*球面上的点（**开球**）。这种区别并不总是保持不变，尤其是在旧的数学文献里，sphere（球面）被当作固体。这与在[平面](../Page/平面.md "wikilink")上混用术语“圆”（circle）和“圆盘”（disk）的情况类似。

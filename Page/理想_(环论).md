...
理想把[整数的某些子集](../Page/整数.md "wikilink")，例如[偶数或](https://zh.wikipedia.org/wiki/偶数 "wikilink")3的倍数组成的集合给一般化了。两个偶数相加或相减结果仍是偶数，偶数与任意整数相乘的结果也仍是偶数；这些[闭包和吸收的性质正是理想的定义](../Page/闭包_\(数学\).md "wikilink")。理想可以被用来构造[商环](../Page/商环.md "wikilink")，这类似于在[群论里](../Page/群论.md "wikilink")，[正规子群可以被用来构造](../Page/正规子群.md "wikilink")[商群](../Page/商群.md "wikilink")。
...
<!-- end list -->
  ...
  - **[准素理想](https://zh.wikipedia.org/wiki/准素理想 "wikilink")**：环R的真理想I。若∀R上的理想P，有P<sup>2</sup>
    ⊆ I ⇒ P ⊆ I，称I是R的**准素理想**。

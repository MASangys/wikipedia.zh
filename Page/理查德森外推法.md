[数值分析中](https://zh.wikipedia.org/wiki/数值分析 "wikilink")，**理查德森外推法**(Richardson
extrapolation)用以改善[级数序列收敛效率](../Page/级数.md "wikilink")，它是在20世纪前期由英国数学家，物理学家，气象学家[Lewis
Fry
Richardson提出的](https://zh.wikipedia.org/wiki/Lewis_Fry_Richardson "wikilink")。在数值分析领域，Richardson外推法有很多实际应用，如[隆贝格积分方法](https://zh.wikipedia.org/wiki/隆贝格积分 "wikilink")，是在[梯形公式的基础上应用Richardson外推法导出的](../Page/梯形公式.md "wikilink")；还有用于求解[常微分方程的](../Page/常微分方程.md "wikilink")[Bulirsch–Stoer算法](https://zh.wikipedia.org/wiki/Bulirsch–Stoer算法 "wikilink")。
...
\(D^{\ast}(h)\)代替了\(D(h)\)，为\(D\)的新的数值近似。新近似相比最初形式具有更高阶的误差项，数值精度由此提高，此方法即为**理查德森外推法**。
...
则由式(1)可知\(p = 2, q = 4\),
\(h_2 = 2 h, r = \left( \frac{1}{2} \right)^p = \frac{1}{4}\) 代入公式：
...
## 参考文献
  ...
  - *Extrapolation Methods. Theory and Practice* by C. Brezinski and M.
    Redivo Zaglia, North-Holland, 1991.

## 外部链接

  - [Module for Richardson's
    Extrapolation](https://web.archive.org/web/20070531044601/http://math.fullerton.edu/mathews/n2003/RichardsonExtrapMod.html),
    fullerton.edu
  - [Fundamental Methods of Numerical Extrapolation With
    Applications](http://ocw.mit.edu/NR/rdonlyres/Mathematics/18-304Spring-2006/D69D4111-2100-443D-A75D-5D5BE7B4FAA2/0/xtrpltn_liu_xpnd.pdf),
    mit.edu
  - [Richardson-Extrapolation](http://www.math.ubc.ca/~feldman/m256/richard.pdf)
  - [Richardson extrapolation on a website of Robert Israel (University
    of British
    Columbia)](http://www.math.ubc.ca/~israel/m215/rich/rich.html)

...
所以我們只需要考慮基本的環，即不是其他環的子集的環。它們都生成自某個基本元素 *a*。給最初群的每個元素一個[頂點](https://zh.wikipedia.org/wiki/頂點 "wikilink")。對于每個基本元素，連接 *e* 到 *a*, *a* 到 a², ... a<sup>*n-1*</sup> 到 a<sup>*n*</sup>, ... 直到回到 *e*。結果是環圖。

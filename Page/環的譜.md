在[抽象代數學和](https://zh.wikipedia.org/wiki/抽象代數 "wikilink")[代數幾何學中](https://zh.wikipedia.org/wiki/代數幾何 "wikilink")，一個[交換環](https://zh.wikipedia.org/wiki/環 "wikilink")\(A\)的**譜**是指其[素理想全體形成的集合](../Page/素理想.md "wikilink")，記作\(\mathrm{Spec}(A)\)。它被賦予扎里斯基拓撲和結構層，從而成爲[局部賦環空間](../Page/賦環空間.md "wikilink")。
...
一般而言，\(\mathrm{Spec}(A)\)內的元素一一對應到\(X\)內的不可約閉集。考慮全體素理想的好處之一，在於可以藉此在概形上運用[安德烈·韋伊的一般點](https://zh.wikipedia.org/wiki/安德烈·韋伊 "wikilink")（generic

在[编码理论](../Page/编码理论.md "wikilink")中，**生成矩阵**（）是一个[矩阵](../Page/矩阵.md "wikilink")，该矩阵的行是的一组[基](../Page/基_\(線性代數\).md "wikilink")。所有码字都是该矩阵的行的[线性组合](https://zh.wikipedia.org/wiki/线性组合 "wikilink")，也就是说，线性码是其生成矩阵的[行空间](../Page/行空间与列空间.md "wikilink")。

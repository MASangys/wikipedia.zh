在[靜電學裏](../Page/靜電學.md "wikilink")，**電勢能**（）是處於[電場的](../Page/電場.md "wikilink")[電荷分佈所具有的](../Page/電荷.md "wikilink")[勢能](../Page/勢能.md "wikilink")，與電荷分佈在系統內部的組態有關。電勢能的單位是[焦耳](../Page/焦耳.md "wikilink")。電勢能與[電勢不同](../Page/電勢.md "wikilink")。電勢定義為處於電場的電荷所具有的電勢能每[單位電荷](../Page/單位電荷.md "wikilink")。電勢的單位是[伏特](../Page/伏特.md "wikilink")。

電勢能的數值不具有絕對意義，只具有相對意義。所以，必須先設定一個電勢能為零的參考系統。當物理系統內的每一個點電荷都互相分開很遠（分開距離為無窮遠），都相對靜止不動時，這物理系統通常可以設定為電勢能等於零的參考系統。\[1\]假設一個物理系統裏的每一個點電荷，從無窮遠緩慢地被遷移到其所在位置，總共所做的[機械功為](../Page/機械功.md "wikilink")
\(W\) ，則這物理系統的電勢能 \(U\) 為
...
思考兩個點電荷所組成的物理系統。假設第一個點電荷 \(q_1\) 的位置為坐標系的[原點](../Page/原點.md "wikilink")
\(\mathbf{O}\) ，則根據[庫侖定律](../Page/庫侖定律.md "wikilink")，點電荷 \(q_1\) 施加於位置為
\(\mathbf{r}\) 的第二個點電荷 \(q_2\) 的[電場力為](../Page/電場力.md "wikilink")
...
\[U= \frac{1}{2}\sum_{i=1}^n q_i \phi(\mathbf{r}_i)\] 。
  ...
  - 上述方程式假設電介質是[自由空間](../Page/自由空間.md "wikilink")，其[電容率為](../Page/電容率.md "wikilink")
...
應用[散度定理](../Page/散度定理.md "wikilink")，可以將這方程式右手邊第一個項目，從體積積分變為面積積分：
...
假設 \(\mathbb{V}\)
趨向於無窮大空間，則這面積積分趨向於零。再應用一則關於[狄拉克δ函數的](../Page/狄拉克δ函數.md "wikilink")[向量恆等式](../Page/向量恆等式.md "wikilink")

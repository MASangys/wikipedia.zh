[Felder_um_Dipol.jpg](https://zh.wikipedia.org/wiki/File:Felder_um_Dipol.jpg "fig:Felder_um_Dipol.jpg")
**电基本振子**(Electric Short Dipole)又称电流元,
指一段理想高频电流直导线,其长度l远小于波长λ并且其半径r远小于l,同时振子沿线的电流I处处等幅并且同相。这样的电流元可构成现实当中更复杂的[天线](../Page/天线.md "wikilink"),
因而电基本振子的辐射特性是研究更复杂天线辐射特性的基础。\[1\]
...
在近区场[坡印廷矢量的均值](https://zh.wikipedia.org/wiki/坡印廷矢量 "wikilink")
电基本振子的远区场表达式为：

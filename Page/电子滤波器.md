...
**电子滤波器**（）可执行[信号处理功能的](https://zh.wikipedia.org/wiki/信号处理 "wikilink")[电子线路元件或裝置](https://zh.wikipedia.org/wiki/电子线路 "wikilink")，它专门用于去除信号中不想要的成分或者增强所需成分。
...
电子濾波器有[音频滤波器](https://zh.wikipedia.org/wiki/音频滤波器 "wikilink")（）與**[雜訊濾波器](https://zh.wikipedia.org/wiki/雜訊濾波器 "wikilink")**（）等應用裝置，可以是：
  ...
  - [類比的或者](https://zh.wikipedia.org/wiki/類比訊號 "wikilink")[數位的](https://zh.wikipedia.org/wiki/數碼系統 "wikilink")，(大陆称为，模拟的或者数字的)
...
最古老的电子滤波器形式是使用[电阻和](../Page/电阻.md "wikilink")[电容或者](https://zh.wikipedia.org/wiki/电容 "wikilink")[电阻和](../Page/电阻.md "wikilink")[电感构建的无源模拟线性滤波器](../Page/电感.md "wikilink")，它们分别叫做RC和RL单极滤波器。
...
[framed實現的](https://zh.wikipedia.org/wiki/File:1st_Order_Lowpass_Filter_RC.svg "wikilink")[低通滤波器](../Page/低通滤波器.md "wikilink")\]\]
最简单的线性滤波器的电子实现是[电阻](../Page/电阻.md "wikilink")、[电感和](../Page/电感.md "wikilink")[电容的组合](https://zh.wikipedia.org/wiki/电容 "wikilink")。这些滤波器有[RC](../Page/RC電路.md "wikilink")、[RL](../Page/RL电路.md "wikilink")、[LC和](../Page/LC电路.md "wikilink")[RLC等多种形式](../Page/RLC电路.md "wikilink")。所有这些类型的滤波器总称为*无源滤波器*，这是因为它们都不需外部电源供电。
...
在大概超过100
[MHz这样非常高的频率](https://zh.wikipedia.org/wiki/hertz "wikilink")，有时电感由一个单环或者金属片组成，电容由相邻的金属片组成，它们称为stubs。
...
[有源滤波器使用无源和有源放大元件组成](https://zh.wikipedia.org/wiki/有源滤波器 "wikilink")，[运算放大器经常用于有源滤波器设计](../Page/运算放大器.md "wikilink")。有源滤波器能够不使用电感就实现高[Q因子和](https://zh.wikipedia.org/wiki/Q因子 "wikilink")[谐振](https://zh.wikipedia.org/wiki/谐振 "wikilink")。但是，它们的频率上限受制于所用放大器的带宽。
...
[数字信号处理可以用于廉价地构建不同类型的滤波器](../Page/数字信号处理.md "wikilink")。信号经过采样、[模数转换转变成数字流](https://zh.wikipedia.org/wiki/模数转换 "wikilink")，经常使用运行在[中央处理器或者特殊的](../Page/中央处理器.md "wikilink")[数字信号处理器的计算机程序而不是硬件](https://zh.wikipedia.org/wiki/数字信号处理器 "wikilink")[算法来计算输出的数字流](../Page/算法.md "wikilink")，它的输出然后通过[数模转换转变成信号](https://zh.wikipedia.org/wiki/数模转换 "wikilink")。在转换过程中可能会产生噪声，但是对于许多有用的滤波器来说它们可以控制和限制的。由于涉及到采样，所以输入信号必须限定在一定的频率，否则就会产生[混疊](../Page/混疊.md "wikilink")。
...
另外一种实现从800MHz到5GHz[微波频率滤波的方法是使用一个](https://zh.wikipedia.org/wiki/微波 "wikilink")[钇和](../Page/钇.md "wikilink")[铁化合作用制造的](https://zh.wikipedia.org/wiki/铁 "wikilink")[单晶](https://zh.wikipedia.org/wiki/单晶 "wikilink")[钇铁石榴石球](https://zh.wikipedia.org/wiki/钇铁石榴石 "wikilink")（YIGF或者钇铁石榴石滤波器）。石榴石位于[晶体管驱动的金属带上](../Page/晶体管.md "wikilink")，一个小型的环形[天线连到球体顶端](../Page/天线.md "wikilink")。[电磁场将会改变石榴石允许通过的频率](../Page/电磁场.md "wikilink")。这种方法的一个优点是能够通过改变[磁场强度在很宽的范围内调整频率](https://zh.wikipedia.org/wiki/磁场 "wikilink")。

#### 原子滤波器

对于更高频率和更高精度要求，需要使用原子震动。[原子钟使用](https://zh.wikipedia.org/wiki/原子钟 "wikilink")[铯](../Page/铯.md "wikilink")[激励器作为超高](https://zh.wikipedia.org/wiki/激励器 "wikilink")*Q*滤波器稳定主振荡器。另外一个用于带有微弱无线电信号的高固定频率场合的方法是使用[红宝石激励器tapped延时线](../Page/红宝石.md "wikilink")。

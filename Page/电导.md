**電導**（）是表示一個物體或電路，從某一點到另外一點，傳輸[電流能力強弱的一種測量值](https://zh.wikipedia.org/wiki/電流 "wikilink")，與物體的[電導率和幾何形狀和尺寸有關](../Page/電導率.md "wikilink")。

现在[国际单位制对这个数值的单位为](../Page/国际单位制.md "wikilink")**[西门子](https://zh.wikipedia.org/wiki/西门子_\(单位\) "wikilink")**（Siemens，缩写“S”）。在过去，电导的单位为「姆歐」（Mho，由Ohm即[欧姆这个词的字母顺序颠倒而得](https://zh.wikipedia.org/wiki/欧姆 "wikilink")，或以上下颠倒的Ω来表示）。
...
請注意，當[阻抗是複值時](../Page/阻抗.md "wikilink")，這些關係方程式不成立。這時，電導與[電納](https://zh.wikipedia.org/wiki/電納 "wikilink")\(B\,\!\)和[導納](https://zh.wikipedia.org/wiki/導納 "wikilink")\(Y\,\!\)的關係方程式為

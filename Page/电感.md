**電感**（）是[閉合迴路的一種屬性](https://zh.wikipedia.org/wiki/閉合迴路 "wikilink")，即當通過閉合迴路的[電流改變時](https://zh.wikipedia.org/wiki/電流 "wikilink")，會出現[電動勢來抵抗電流的改變](../Page/電動勢.md "wikilink")。如果這種現象出現在自身迴路中，那麼這種電感稱為**自感**（），是閉合迴路自己本身的屬性。假設一個閉合迴路的電流改變，由於感應作用在另外一個閉合迴路中產生電動勢，這種電感稱為**互感**（）。電感以方程式表達為

\[\mathcal{E} = - L { \mathrm{d}i \over \mathrm{d}t}\]；

其中，\(\mathcal{E}\)是電動勢，\(L\)是電感，\(i\)是電流，\(t\)是時間。

術語「電感」是1886年由[奥利弗·赫维赛德命名](https://zh.wikipedia.org/wiki/奥利弗·赫维赛德 "wikilink")\[1\]。通常自感是以字母「L」標記，這可能是為了紀念物理學家[海因里希·楞次的貢獻](../Page/海因里希·楞次.md "wikilink")\[2\]\[3\]。互感是以字母「M」標記，是其英文（Mutual
Inductance）的第一個字母。採用[國際單位制](https://zh.wikipedia.org/wiki/國際單位制 "wikilink")，電感的單位是[亨利](https://zh.wikipedia.org/wiki/亨利_\(單位\) "wikilink")（），標記為「H」，是因美國科學家[約瑟·亨利命名](../Page/約瑟·亨利.md "wikilink")。1 H
=
1 [Wb](https://zh.wikipedia.org/wiki/韋伯_\(单位\) "wikilink")/[A](../Page/安培.md "wikilink")。

[電感器是專門用在](https://zh.wikipedia.org/wiki/電感器 "wikilink")[電路裏實現電感的](https://zh.wikipedia.org/wiki/電路 "wikilink")[電路元件](https://zh.wikipedia.org/wiki/電路元件 "wikilink")。[螺線管是一種簡單的電感器](../Page/螺線管.md "wikilink")，指的是多重捲繞的導線（稱為「線圈」），內部可以是空心的，或者有一個金屬芯。[螺線管的電感是自感](../Page/螺線管.md "wikilink")。[變壓器是兩個耦合的線圈形成的電感器](https://zh.wikipedia.org/wiki/變壓器 "wikilink")，由於具有互感屬性，是一種基本[磁路元件](../Page/磁路.md "wikilink")。在電路圖中電感的電路符號多半以L開頭，例如，L01、L02、L100、L201等。
...
如右圖所示，流動於閉合迴路的含時電流\(i(t)\)所產生的含時磁通量\(\Phi (i)\)，根據[法拉第電磁感應定律](https://zh.wikipedia.org/wiki/法拉第電磁感應定律 "wikilink")，會促使閉合迴路本身出現感應電動勢\(\mathcal{E}\)：
...
电感的作用是抵抗电流的变化，但是这种作用与[电阻阻碍电流的流動是有区别的](../Page/电阻.md "wikilink")。电阻阻碍电流的流動的特徵是消耗[电能](https://zh.wikipedia.org/wiki/电能 "wikilink")，而电感则纯粹是抵抗电流的变化。当电流增加时电感抵抗电流的增加；当电流减小时电感抵抗电流的减小。电感抵抗电流变化的过程并不消耗电能，當电流增加时它會将[能量以](../Page/能量.md "wikilink")[磁场的形式暂时储存起来](https://zh.wikipedia.org/wiki/磁场 "wikilink")，等到电流减小时它又會将磁场的能量释放出来，其效應就是抵抗电流的变化。
...
如右圖所示，\(n\)個[電感器串聯在一起](https://zh.wikipedia.org/wiki/電感器 "wikilink")。現將電源連接於這串聯電路的兩端。按照[電感的定義](https://zh.wikipedia.org/wiki/電感 "wikilink")，第\(k\)個電感器兩端的電壓\(v_k\)等於其電感\(L_k\)乘以通過的電流的變率\(\frac{\mathrm{d}i_k}{\mathrm{d}t}\)：

\[v_k=L_k \frac{\mathrm{d}i_k}{\mathrm{d}t}\]。

按照[克希荷夫電流定律](https://zh.wikipedia.org/wiki/克希荷夫電流定律 "wikilink")，從電源（[直流電或](../Page/直流電.md "wikilink")[交流電](../Page/交流電.md "wikilink")）給出的電流\(i\)等於通過每一個電感器的電流\(i_k\)。所以，
...
由於電感器產生的[磁場會與其鄰近電感器的纏繞線圈發生耦合](../Page/磁場.md "wikilink")，很難避免緊鄰的電感器彼此互相影響。物理量[互感](https://zh.wikipedia.org/wiki/互感 "wikilink")\(M\)能夠給出對於這影響的衡量。
...
如右圖所示，兩個[電感器串聯互助在一起](https://zh.wikipedia.org/wiki/電感器 "wikilink")。將電源連接於這串聯電路的兩端。應用[基爾霍夫電壓定律](https://zh.wikipedia.org/wiki/基爾霍夫電壓定律 "wikilink")，按照[點規定](../Page/點規定.md "wikilink")，可以得到
...
如右圖所示，\(n\)個[電感器並聯在一起](https://zh.wikipedia.org/wiki/電感器 "wikilink")，類似前面所述方法，可以計算出其等效電感\(L_{eq}\)為

\[\frac{1}{L_{eq}} =\frac{1}{L_1} +\frac{1}{L_2}+ \cdots +\frac{1}{L_n}\]。

由於電感器產生的[磁場會與其鄰近電感器的纏繞線圈發生耦合](../Page/磁場.md "wikilink")，很難避免緊鄰的電感器彼此互相影響。物理量[互感](https://zh.wikipedia.org/wiki/互感 "wikilink")\(M\)能夠給出對於這影響的衡量。上述方程式描述\(n\)個電感器無互感並聯的理想案例。
...
如右圖所示，兩個[電感器並聯互助在一起](https://zh.wikipedia.org/wiki/電感器 "wikilink")。將電源連接於這並聯電路的兩端。應用[基爾霍夫電壓定律](https://zh.wikipedia.org/wiki/基爾霍夫電壓定律 "wikilink")，按照點規定，可以得到

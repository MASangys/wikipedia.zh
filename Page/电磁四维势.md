**电磁四维势**（英文：）是[电磁理论中的一个](https://zh.wikipedia.org/wiki/电磁理论 "wikilink")[协变](https://zh.wikipedia.org/wiki/协变 "wikilink")[四维矢量](https://zh.wikipedia.org/wiki/四维矢量 "wikilink")，它在[国际单位制中的单位是](../Page/国际单位制.md "wikilink")[伏特](../Page/伏特.md "wikilink")·秒/米（在[厘米-克-秒制中的单位是](../Page/厘米-克-秒制.md "wikilink")[馬克士威](https://zh.wikipedia.org/wiki/馬克士威（單位） "wikilink")/厘米），它的定义为（括号中表示在厘米-克-秒制中的形式，下同）
...
将这两个势写在一起的原因是\(A_{\alpha}\)是协变的，这意味着它在任意的曲面坐标变换下和一个标量的[梯度变换方式相同](../Page/梯度.md "wikilink")，即如\(\frac{\partial \psi}{\partial x^{\alpha}}\,,\)的变换形式。这样四维势的[内积](https://zh.wikipedia.org/wiki/内积 "wikilink")

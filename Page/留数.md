在[复分析中](https://zh.wikipedia.org/wiki/复分析 "wikilink")，**留数**是一个正比于一个[亚纯函数某一](../Page/亚纯函数.md "wikilink")[奇点周围的](https://zh.wikipedia.org/wiki/奇点 "wikilink")[路径积分的复数](https://zh.wikipedia.org/wiki/路径积分 "wikilink")。（更一般地，对于任何除去离散点集{*a*<sub>*k*</sub>}之外[全纯的函数](../Page/全纯函数.md "wikilink")\(f: \mathbb{C} \setminus \{a_k\} \rightarrow \mathbb{C}\)都可以计算其留数，即便是离散点集中含有[本质奇点](../Page/本质奇点.md "wikilink")）留数可以是很容易计算的，一旦知道了留数，就可以通过[留数定理来计算更复杂的路径积分](../Page/留数定理.md "wikilink")。
...
设复平面内有一[穿孔圆盘](https://zh.wikipedia.org/wiki/环形#复结构 "wikilink")*D* = {*z*
: 0 \< |*z* − *c*| \<
...
如果函数*f*在整个圆盘{ |*z* − *c*| \< *R*
}内可以[延拓为](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")[全纯函数](../Page/全纯函数.md "wikilink")，则Res(*f*,
*c*) = 0。反过来不总成立。

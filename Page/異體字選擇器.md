...
[u845b-k.svg](https://zh.wikipedia.org/wiki/File:u845b-k.svg "fig:u845b-k.svg")的葛}}\]\] [u845b.svg](https://zh.wikipedia.org/wiki/File:u845b.svg "fig:u845b.svg")的葛}}\]\] [Unicode是一個抽象字形的文字集合](https://zh.wikipedia.org/wiki/Unicode "wikilink")，它沒有描繪出每個字形的樣式，同樣意義的字符常會被賦予相同的編碼。因此，在好些情況裏，我們有必要區分不同的[字形](../Page/字形.md "wikilink")\[2\]\[3\]。

須注意的是，譬如[拉丁字母](../Page/拉丁字母.md "wikilink")「a」是否有從頂部向右延伸的線，通常不屬於不同字形之間的差異，因為可以通過更改[電腦字型來修改](https://zh.wikipedia.org/wiki/電腦字型 "wikilink")。可是，在[中日韓統一表意文字](../Page/中日韓統一表意文字.md "wikilink")中，本來根據[Unicode的認同原則應該統合的漢字](https://zh.wikipedia.org/wiki/中日韓統一表意文字#認同原則與字源分離原則 "wikilink")[異體字字形](https://zh.wikipedia.org/wiki/異體字 "wikilink")，卻在一些國家或地方的電腦應用標準裏，經常被視為是「另一個字」的字形。擧例說，「-{値}-」與「-{值}-」字形差異細微，讀音、意義都一樣，一般書寫和閱讀時都不會視為兩個不同的字，理論上可以合併。可是，在國家或地區裏，此二字在某些情況裏會被當作相異，比如在人名登記時，「林-{値}-喜」與「林-{值}-喜」是不同的人，該國家或地區的原來字符集已區分作兩個字。因此，根据情況，有時我們得在上保存不同字形的區別，例如：

  - 在大部份操作系統中，[文件名是純文本](https://zh.wikipedia.org/wiki/文件名 "wikilink")，不能區別在文本中不能區分的東西。
  - [輸入法可以輸入的字符串一般都是純文本](https://zh.wikipedia.org/wiki/輸入法 "wikilink")\[4\]。即使用戶可以選擇不同[字型](../Page/字型.md "wikilink")來顯示，卻要花上額外時間去處理。（現在，隨着輸入法技術的進步，問題已略有改善。例如[Windows Vista開始可以區分](https://zh.wikipedia.org/wiki/Microsoft_Windows_Vista "wikilink")「」的「[葛](https://zh.wikipedia.org/wiki/File:u845b-k.svg "fig:葛")」和「」的「[葛](https://zh.wikipedia.org/wiki/File:u845b.svg "fig:葛")」了\[5\]，不過「[葛](https://zh.wikipedia.org/wiki/File:u845b-k.svg "fig:葛")」與「[葛](https://zh.wikipedia.org/wiki/File:u845b.svg "fig:葛")」在Unicode編碼上並無區別\[6\]，造成了不少麻煩。）
...
爲了應付這類情況，早期Unicode碰到在有關國家或地區既有碼表已分別編碼的字，像「-{値}-」與「-{值}-」，就會放棄認同原則，改以[字源分離原則來把兩個字形分別編碼](https://zh.wikipedia.org/wiki/中日韓統一表意文字#認同原則與字源分離原則 "wikilink")。但若當時有關國家或地區沒有把異體字分別編碼，像日本的JIS90只收錄了一個「葛」字，Unicode就不會分別編碼。同一原因，「直、殖、植」等字皆沒有像「-{値}-」與「-{值}-」般分別編碼。這種自相矛盾的做法，長年來備受漢字文字學界的批評。
...
**Standardized Variants錄入的字集和數量**
  ...
  - [顏文字](https://zh.wikipedia.org/wiki/顏文字 "wikilink")：702個（文本類型和圖形文字的類型351個）\[12\]

...
因為所有簡單多邊形都可切割為一個[三角形和另一個簡單多邊形](../Page/三角形.md "wikilink")。考慮一個簡單多邊形\(P\)，及跟\(P\)有一條共同邊的三角形\(T\)。若\(P\)符合皮克公式，則只要證明\(P\)加上\(T\)的\(PT\)亦符合皮克公式（I），與及三角形符合皮克公式（II），就可根據[數學歸納法](https://zh.wikipedia.org/wiki/數學歸納法 "wikilink")，對於所有簡單多邊形皮克公式都是成立的。
...
Georg Alexander
Pick，1859年生於[維也納](../Page/維也納.md "wikilink")，1943年死於[特萊西恩施塔特集中營](https://zh.wikipedia.org/wiki/特萊西恩施塔特集中營 "wikilink")。

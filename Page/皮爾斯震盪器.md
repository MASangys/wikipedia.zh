...
皮爾斯震盪器衍生自[考畢子振盪器](https://zh.wikipedia.org/wiki/考畢子振盪器 "wikilink")。現今使用石英晶體進行振盪以產生時鐘訊號的數位電路，幾乎均使用皮爾斯震盪器電路，因為它電路簡單，工作有效而穩定，優於其它型態的石英晶體振盪電路。 皮爾斯震盪器所需零件很少: 一個反相器、一個電阻、一個石英晶體、兩個小電容。石英晶體在此扮演高選擇度的濾波元件。 此外，很多 IC 已內建反相器與電阻，只要在外部加上石英晶體與兩個電容就可以工作。 由於石英晶體頻率穩定，此電路成本又很低，因此廣泛用於各種消費電子產品之中～
...
[回授](../Page/反馈.md "wikilink")[電阻](https://zh.wikipedia.org/wiki/電阻 "wikilink") R<sub>1</sub> 可以看成是反相器的偏壓電阻，令反相器工作在線性區域而成為高增益的反相放大器，並確保振盪的發生。
...
有時會在反相器的輸出與石英晶體與電容的π型網路間，額外串入一個電阻，把輸出與π形網路隔離開來。此電阻會與 *C*<sub>2</sub> 造成些許額外的相移。\[3\]
...
因此，為達到正確的振盪頻率，電路設計者應確保電路上的負載電容符合石英晶體的負載電容規格。在計算負載電容時，電路的[雜散電容](https://zh.wikipedia.org/wiki/雜散電容 "wikilink")，例如電路板銅箔間的電容，IC 接腳的電容等，均需納入考慮。

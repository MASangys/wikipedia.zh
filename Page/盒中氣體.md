...
對於正質量或零質量的[盒中粒子](https://zh.wikipedia.org/wiki/盒中粒子 "wikilink")，其[量子態是以一組](../Page/量子態.md "wikilink")[量子數來](https://zh.wikipedia.org/wiki/量子數 "wikilink")[枚舉的](https://zh.wikipedia.org/wiki/枚舉 "wikilink")。在三維空間裏，這一組量子數是正整數\(\mathbf{n}=(n_x,\,n_y,\,n_z)\,\!\)；其中，\(x,\,y,\,z\,\!\)是三維空間的坐標軸標籤。量子態的波函數的[波數向量](../Page/波數.md "wikilink")\(\mathbf{k}=(k_x,\,k_y,\,k_z)\,\!\)是

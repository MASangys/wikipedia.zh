[DC_injection_brake.jpg](https://zh.wikipedia.org/wiki/File:DC_injection_brake.jpg "fig:DC_injection_brake.jpg")
**直流剎車**是一種減緩[交流馬達速度的方式](../Page/交流馬達.md "wikilink")，先將[交流電源移除](../Page/交流.md "wikilink")，再將直流電壓注入馬達中，產生剎車的[力矩](../Page/力矩.md "wikilink")\[1\]。若馬達是由市電供電，直流剎車可以是一個獨立的模組，若馬達是由[變頻器驅動](../Page/變頻器.md "wikilink")，一般會使用內建的直流剎車機能。

## 應用及動作原理

[Gleichstrombremse_1.svg](https://zh.wikipedia.org/wiki/File:Gleichstrombremse_1.svg "fig:Gleichstrombremse_1.svg")

當馬達的交流電壓移除時，轉子會繼續轉動，會因為[摩擦力使速度漸漸變慢](../Page/摩擦力.md "wikilink")，最後停止。若是大功率的馬達或是[轉動慣量很大](../Page/轉動慣量.md "wikilink")，可能會需要相當長的時間才能停止，若是應用需求，停止時間要短，或是需要有緊急停止的安全特性，就可以用直流剎車的方式，讓馬達較快速的停止。
...
[變頻器中也有直流剎車機能](../Page/變頻器.md "wikilink")，不過應用方式和上述的有些差異。
...
變頻器的直流剎車一般可以設定啟動時及停止時直流剎車的時間，剎車轉矩則是用剎車電流來控制，不過因為電流仍由變頻器的[IGBT流出](../Page/IGBT.md "wikilink")，因此若電流過大，也可能出現過電流的故障，其至損壞[IGBT](../Page/IGBT.md "wikilink")。
...
2.  [CN102694500A
    变频器及其感应电动机的转速搜寻装置](http://www.google.com/patents/CN102694500A?cl=zh)

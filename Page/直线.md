[Linear_functions2.PNG](https://zh.wikipedia.org/wiki/File:Linear_functions2.PNG "fig:Linear_functions2.PNG") 。\]\] **直線**，是一個點在[平面](../Page/平面.md "wikilink")或[空間沿著一定方向和其相反方向運動的軌跡](https://zh.wikipedia.org/wiki/空間 "wikilink")，是不彎曲的線。直線是[幾何學的基本概念](https://zh.wikipedia.org/wiki/幾何學 "wikilink")，在不同的幾何學體系中有著不同的描述。在這裡主要描述[歐幾里得空間中的直線](https://zh.wikipedia.org/wiki/歐幾里得空間 "wikilink")。其他[曲率](../Page/曲率.md "wikilink")非零狀況下的直線，請參考[非歐幾里得幾何](https://zh.wikipedia.org/wiki/非歐幾里得幾何 "wikilink")。

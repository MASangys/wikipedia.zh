...
。\]\]
**直線**，是一個點在[平面或](../Page/平面.md "wikilink")[空間沿著一定方向和其相反方向運動的軌跡](../Page/空間.md "wikilink")，是不彎曲的線。直線是[幾何學的基本概念](../Page/幾何學.md "wikilink")，在不同的幾何學體系中有著不同的描述。在這裡主要描述[歐幾里得空間中的直線](../Page/歐幾里得空間.md "wikilink")。其他[曲率非零狀況下的直線](../Page/曲率.md "wikilink")，請參考[非歐幾里得幾何](../Page/非歐幾里得幾何.md "wikilink")。

[歐幾里得幾何研究](../Page/歐幾里得幾何.md "wikilink")[曲率為零的空間下狀況](../Page/曲率.md "wikilink")，它並未對點、直線、平面、空間給出定義，而是通過公理來描述點線面的關係。
[歐幾里得幾何中的直線可以看作是一個點的集合](../Page/歐幾里得幾何.md "wikilink")，這個集合中的任意一點都在這個集合中的其他任意兩點所確定的直綫上。
...
在[解析幾何中](../Page/解析幾何.md "wikilink")，我們常用[線性方程描述一條直線](../Page/線性方程.md "wikilink")。
...
這表示示形式並不是唯一的，但習慣上常限制 \(A \ge 0\) 及 \(\gcd(A,B,C)=1\)
。在此限制下，同一條直線只有一種表達形式。

在這形式下，直線的斜率是 \(-\frac{A}{B}\) ，*x*-截距是 \(-\frac{C}{A}\) ，*y*-截距是
\(-\frac{C}{B}\) 。
...
對於任何直線，一般式都能以兩個非[平行平面定義](../Page/平行.md "wikilink")：
...
一般情況下，點與直线的距离，是指點到直線的最短距離，即[垂直距離](../Page/垂直.md "wikilink")。

在二維直角坐標中，直線 \(Ax+By+C=0\) 與點 \((p,q)\) 的最短距離為

\[d=\frac{\left| Ap+Bq+C \right|}{\sqrt{A^2+B^2}}\]

給出向量式 \(\mathbf{r} = \mathbf{a} + \lambda \mathbf{u}\) 和 點
...
給出向量式 \(\mathbf{r} = \mathbf{a} + \lambda \mathbf{u}\) 和點
\(\mathbf{p} = \begin{bmatrix}
    p\\
    q\\
    r\\
...
不考慮重合的情形，在二維平面中，兩條相交直線可以[相交或](../Page/相交.md "wikilink")[平行](../Page/平行.md "wikilink")。
...
這時兩線的相交點可從[克萊姆法則求得](../Page/克萊姆法則.md "wikilink")
...
在三維空間中，不考慮重合的情形，兩條直線可以[相交](../Page/相交.md "wikilink")、[平行或](../Page/平行.md "wikilink")[歪斜](../Page/歪斜.md "wikilink")（異面）。
...
\end{alignat}\) ，二者相交的條件是
  ...
  -
    \(\begin{vmatrix} A_1 & B_1 \\A_2 & B_2 \end{vmatrix}\) 、
    \(\begin{vmatrix} B_1 & C_1 \\B_2 & C_2 \end{vmatrix}\) 及
    \(\begin{vmatrix} C_1 & A_1 \\C_2 & A_2 \end{vmatrix}\) 不全為 \(0\) ，且
...
\[x=-\frac{\begin{vmatrix} D_1 & B_1 \\D_2 & B_2 \end{vmatrix}}{\begin{vmatrix} A_1 & B_1 \\A_2 & B_2 \end{vmatrix}}=\frac{\begin{vmatrix} B_1 & F_1 \\B_2 & F_2 \end{vmatrix}}{\begin{vmatrix} B_1 & C_1 \\B_2 & C_2 \end{vmatrix}}\]
，
\(y=\frac{\begin{vmatrix} A_1 & D_1 \\A_2 & D_2 \end{vmatrix}}{\begin{vmatrix} A_1 & B_1 \\A_2 & B_2 \end{vmatrix}}=-\frac{\begin{vmatrix} E_1 & A_1 \\E_2 & A_2 \end{vmatrix}}{\begin{vmatrix} C_1 & A_1 \\C_2 & A_2 \end{vmatrix}}\)
，
\(z=\frac{\begin{vmatrix} C_1 & E_1 \\C_2 & E_2 \end{vmatrix}}{\begin{vmatrix} C_1 & A_1 \\C_2 & A_2 \end{vmatrix}}=-\frac{\begin{vmatrix} F_1 & C_1 \\F_2 & C_2 \end{vmatrix}}{\begin{vmatrix} B_1 & C_1 \\B_2 & C_2 \end{vmatrix}}\)
。

### 两条相交直线的夹角

若兩線[相交](../Page/相交.md "wikilink")，則會形成[夾角](../Page/夾角.md "wikilink")。兩線之間的夾角，通常指不大於90°的一隻。

在二維平面上，給定直线 \(y=mx+b\) ，該線與*x*-軸的夾角為

\[\tan \theta = \left| m \right|\] 。

給定兩條直线 \(y=m_1x+b_1\) 和 \(y=m_2x+b_2\)
，二者互相垂直[當且僅當](../Page/當且僅當.md "wikilink")
...
給定相交直线向量式 \(\mathbf{r} = \mathbf{a_1} + \lambda \mathbf{u_1}\) 和
\(\mathbf{r} = \mathbf{a_2} + \mu \mathbf{u_2}\) ，則有
...
y &&\; = \;&& m_2x &&\; + \;&& b_2 \\
z &&\; = \;&& n_2x &&\; + \;&& c_2
\end{alignat}\) ，二者互相垂直[當且僅當](../Page/當且僅當.md "wikilink")
...
二維情況下，两条[相交直线的距离必然為](../Page/相交.md "wikilink") \(0\) 。

若有两條[平行直线](../Page/平行.md "wikilink") \(Ax+By+C_1=0\) 及 \(Ax+By+C_2=0\)
，則有距離

\[d=\frac{\left| C_1-C_2 \right|}{\sqrt{A^2+B^2}}\]。

給定平行向量式 \(\mathbf{r} = \mathbf{a_1} + \lambda \mathbf{u}\) 和
\(\mathbf{r} = \mathbf{a_2} + \mu \mathbf{u}\) ，則有

\[d=\frac{\left|(\mathbf{a_1}-\mathbf{a_2}) \times \mathbf{u}\right|}{\left|\mathbf{u}\right|}\]。

三維情況下，两条[相交直线的距离同樣必然為](../Page/相交.md "wikilink") \(0\) 。

若有两條[平行直线](../Page/平行.md "wikilink") \(\begin{alignat}{7}
Ax &&\; - \;&& By &&\; + \;&& D_1 \;&& = \;&& 0 & \\
Cy &&\; - \;&& Az &&\; + \;&& E_1 \;&& = \;&& 0 & \\
Bz &&\; - \;&& Cx &&\; + \;&& F_1 \;&& = \;&& 0
\end{alignat}\) 及 \(\begin{alignat}{7}
...
給定平行直線向量式 \(\mathbf{r} = \mathbf{a_1} + \lambda \mathbf{u}\) 和
\(\mathbf{r} = \mathbf{a_2} + \mu\mathbf{u}\) ，則有

\[d=\frac{\left|(\mathbf{a_1}-\mathbf{a_2}) \times \mathbf{u}\right|}{\left|\mathbf{u}\right|}\]。

兩條[歪斜直線](../Page/歪斜.md "wikilink")（即既非相交，亦非平行）有方程 \(\begin{alignat}{7}
A_1x &&\; - \;&& B_1y &&\; + \;&& D_1 \;&& = \;&& 0 & \\
C_1y &&\; - \;&& A_1z &&\; + \;&& E_1 \;&& = \;&& 0 & \\
B_1z &&\; - \;&& C_1x &&\; + \;&& F_1 \;&& = \;&& 0
\end{alignat}\) 及 \(\begin{alignat}{7}
...
給定歪斜直線向量式 \(\mathbf{r} = \mathbf{a_1} + \lambda \mathbf{u_1}\) 和
\(\mathbf{r} = \mathbf{a_2} + \mu\mathbf{u_2}\) ，則有距離
...
## 相關條目
  ...
  - [點](../Page/點.md "wikilink")
  - [平面](../Page/平面.md "wikilink")
  - [相交](../Page/相交.md "wikilink")
  - [平行](../Page/平行.md "wikilink")
  - [歪斜](../Page/歪斜.md "wikilink")

## 參考資料

  - 俞正光、李永乐、詹汉生编，《线性代数与解析几何》，清华大学出版社。
  - 吕林根，《解析几何》，高等教育出版社。
  - [Line](http://mathworld.wolfram.com/Line.html) ，*Wolfram
    [MathWorld](../Page/MathWorld.md "wikilink")*。
  - [Equations of a Straight
    Line](http://www.cut-the-knot.org/Curriculum/Calculus/StraightLine.shtml)
    ，*Cut-the-Knot*。

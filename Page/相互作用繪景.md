[thumb](../Page/FILE:Dirac_4.jpg.md "wikilink")\]\]
在[量子力學裏](../Page/量子力學.md "wikilink")，**相互作用繪景**（interaction
picture），是在[薛丁格繪景與](../Page/薛丁格繪景.md "wikilink")[海森堡繪景之間的一種表述](../Page/海森堡繪景.md "wikilink")，為紀念物理學者[保羅·狄拉克而又命名為](../Page/保羅·狄拉克.md "wikilink")**狄拉克繪景**。在這繪景裏，描述量子系統的[態向量與表達](../Page/態向量.md "wikilink")[可觀察量的](../Page/可觀察量.md "wikilink")[算符都會隨著](../Page/算符.md "wikilink")[時間流易而演化](../Page/時間.md "wikilink")。有些實際案例會涉及到因相互作用而使得量子態與可觀察量發生改變，這類案例通常會使用狄拉克繪景。

狄拉克繪景與[薛丁格繪景](../Page/薛丁格繪景.md "wikilink")、[海森堡繪景不同](../Page/海森堡繪景.md "wikilink")。在薛丁格繪景裏，描述量子系統的[態向量隨著時間流易而演化](../Page/態向量.md "wikilink")。在海森堡繪景裏，表達[可觀察量的](../Page/可觀察量.md "wikilink")[算符會隨著時間流易而演化](../Page/算符.md "wikilink")。
...
通過對於[基底的一種](../Page/基底.md "wikilink")，算符和態向量在狄拉克繪景裏的形式與在薛丁格繪景裏的形式相關聯。

在量子力學裏，對於大多數案例的[哈密頓量](../Page/哈密頓量.md "wikilink")，通常無法找到[薛丁格方程式的精確解](../Page/薛丁格方程式.md "wikilink")，只有少數案例可以找到精確解。因此，為了要能夠解析其它沒有精確解的案例，必須將薛丁格繪景裏的[哈密頓量](../Page/哈密頓量.md "wikilink")\(H_{\mathcal{S}}\,\!\)分成兩個部分，\[4\]
...
假若對於某些案例，\(H_{0,\,{\mathcal{S}}}\,\!\)應該設定為含時，則[時間演化算符的公式會變得較為複雜](../Page/薛丁格繪景#時間演化算符.md "wikilink")：\[5\]
...
[對易](../Page/對易.md "wikilink")，不論在薛丁格繪景裏或在狄拉克繪景裏，\(H_{0,\,{\mathcal{S}}}\,\!\)與\(H_{0,\,\mathcal{I}}\,\!\)的形式都是一樣：}\\,\\\!</math>也可能含時。假設\(H_{0,\,{\mathcal{S}}}\,\!\)含時並且對易，則時間演化算符\(U(t)\,\!\)的公式不再是\[6\]
...
與算符類似，在薛丁格繪景裏的[密度矩陣也可以變換到在狄拉克繪景裏](../Page/密度矩陣.md "wikilink")。設定\(\rho_{\mathcal{I}}\,\!\)和\(\rho_{\mathcal{S}}\,\!\)分別為在狄拉克繪景裏和在薛丁格繪景裏的密度矩陣。假若，處於量子態\(|\psi_n\rang\,\!\)的機率是\(p_n\,\!\)，則
...
假若\(H_{0}\,\!\)有精確解，而\(H_{1,\,{\mathcal{S}}}(t)\,\!\)是一個弱小的微擾，則可很便利地採用狄拉克繪景，使用[時變微擾理論來計算](../Page/微擾理論.md "wikilink")\(H_{1,\,{\mathcal{S}}}(t)\,\!\)所產生對於整個系統的影響。例如，在[費米黃金定則的導引裏](../Page/費米黃金定則.md "wikilink")\[9\]，或在推導時\[10\]，通常都會用到狄拉克繪景。

...
1.判断[特征值是否相等](https://zh.wikipedia.org/wiki/特征值 "wikilink")；
2.判断[行列式是否相等](../Page/行列式.md "wikilink")；
3.判断[跡是否相等](../Page/跡.md "wikilink")；
4.判断[秩是否相等](https://zh.wikipedia.org/wiki/秩 "wikilink")；
以上条件可以作为判断矩阵是否相似的必要条件，而非充分条件。

## 严格定义

两个系数[域为](https://zh.wikipedia.org/wiki/域 "wikilink")*K*的*n*×*n*的[矩阵](../Page/矩阵.md "wikilink")*A*与*B*为域*L*上的**相似矩阵**[当且仅当存在一个系数](../Page/当且仅当.md "wikilink")[域为](https://zh.wikipedia.org/wiki/域 "wikilink")*L*的*n*×*n*的[可逆矩阵](../Page/逆矩阵.md "wikilink")*P*，使得：
...
*A*和*B*“**酉相似**”。[谱定理证明了每个](../Page/谱定理.md "wikilink")[正规矩阵都酉相似于某个](../Page/正规矩阵.md "wikilink")[对角矩阵](https://zh.wikipedia.org/wiki/对角矩阵 "wikilink")。
...
这种现象的原因有两个：
  ...
  - [映射](https://zh.wikipedia.org/wiki/映射 "wikilink")*X* \(\mapsto\)

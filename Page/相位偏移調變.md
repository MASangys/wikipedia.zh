**相位偏移調變**，又稱**相位鍵移**（PSK，Phase-Shift Keying）是一種利用[相位差異的](https://zh.wikipedia.org/wiki/相位 "wikilink")[訊號來傳送資料的](https://zh.wikipedia.org/wiki/訊號 "wikilink")[調變](../Page/調變.md "wikilink")方式。該傳送訊號必須為[正交](../Page/正交.md "wikilink")訊號，其[基底更須為單位化訊號](https://zh.wikipedia.org/wiki/基底 "wikilink")。

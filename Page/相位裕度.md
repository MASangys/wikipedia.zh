...
通常开环相位延迟（相对于输入）随频率变化，逐步增加到超过180°，此频率下输出信号（相对于输入）[反相](https://zh.wikipedia.org/wiki/相位 "wikilink")。PM为正值，但会随着频率上升而下降，在截止频率（PM = 0）反相。频率继续增加，在高于截止频率后PM为负值（PM \< 0）。在存在[负反馈](../Page/负反馈.md "wikilink")时，[环路增益](../Page/环路增益.md "wikilink")超过1的情况下PM为零或负值时会导致系统不稳定。因此PM为正是能保证该电路正常工作（不振荡）的“安全裕度”。这不仅适用于放大器电路，同样适用于不同[负载条件](https://zh.wikipedia.org/wiki/负载 "wikilink")（如无功负载）下的。在最简单的形式中，涉及有非[抗性反馈的理想](../Page/电抗.md "wikilink")[负反馈](../Page/负反馈.md "wikilink")电压放大器，在放大器的[开环电压增益等于所需](https://zh.wikipedia.org/wiki/开环增益 "wikilink")[闭环直流电压](../Page/反馈.md "wikilink")[增益](../Page/增益.md "wikilink")时测定相位裕度。\[1\]

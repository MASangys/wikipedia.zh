...
目前，[GNU/Linux通过高级软件包管理机制](https://zh.wikipedia.org/wiki/GNU/Linux "wikilink")，一定程度上解决了相依性地狱问题。较著名的有[Debian阵营的](../Page/Debian.md "wikilink")[APT](https://zh.wikipedia.org/wiki/高级包装工具 "wikilink")\[1\]和[Redhat阵营的](https://zh.wikipedia.org/wiki/Redhat "wikilink")[Yum](https://zh.wikipedia.org/wiki/Yum "wikilink")\[2\]。

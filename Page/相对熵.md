**相对熵**（relative entropy）又称为**KL散度**（**Kullback–Leibler divergence**，簡稱**KLD**）\[1\]，信息散度（information divergence），信息增益（information gain）。
...
對於[連續隨機變量](https://zh.wikipedia.org/wiki/連續隨機變量 "wikilink")，其概率分佈*P*和*Q*可按積分方式定義為 \[2\]

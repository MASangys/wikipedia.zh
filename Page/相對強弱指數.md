...
RSI在1978年6月由[美國機械工程師威列斯](https://zh.wikipedia.org/wiki/美國 "wikilink")·威爾德（）提出的技術分析方法，發表在美國《*Commodities*》雜誌中（現為《*Futures*》雜誌），並收錄於同年推出的《*New
...
根據的測量結果，當n=14時，指數最具代表性。他指出當某[證券的RSI升至](../Page/證券.md "wikilink")70時，代表該證券已被[超買](https://zh.wikipedia.org/wiki/超買 "wikilink")（Overbought），投資者應考慮出售該證券。相反，當證券RSI跌至30時，代表證券被[超賣](https://zh.wikipedia.org/wiki/超賣 "wikilink")（Oversold），投資者應購入該證券。
...
**卡特勒相對強弱指數**（Culter's
RSI）摒棄了繁瑣的[指數移動平均法](https://zh.wikipedia.org/wiki/移動平均#指數移動平均 "wikilink")，改用[簡單移動平均法來計算出U及D的平均值](https://zh.wikipedia.org/wiki/移動平均#簡單移動平均 "wikilink")，而兩種方法所計算出的結果差別並不顯著，因此為較多人所採用。

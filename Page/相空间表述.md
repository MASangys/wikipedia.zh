**相空间表述**是[量子力学的一种表述](../Page/量子力学.md "wikilink")。在这一表述中，系统的状态是在[相空间中描述的](../Page/相空间.md "wikilink")，[位置与](../Page/位置向量.md "wikilink")[动量被放在同等重要的位置](../Page/动量.md "wikilink")。在量子力学常用的[薛定谔绘景中则只会采用](../Page/薛定谔绘景.md "wikilink")[动量表象或是位置表象中的一种](../Page/位置空间与动量空间.md "wikilink")。相空间表述两个关键的特点是：量子态是以描述的而非[波函数](../Page/波函数.md "wikilink")、态矢或是[密度矩阵](../Page/密度矩阵.md "wikilink")；算符间的乘法被取代。

相空间表述理论是由于1946年在其博士学位论文中提出的\[1\]。也在3年后独立导出该理论\[2\]。他们所提出的理论都建构于[赫尔曼·外尔](../Page/赫尔曼·外尔.md "wikilink")\[3\]以及[尤金·维格纳](../Page/尤金·维格纳.md "wikilink")\[4\]早先的构想。
...
相空间表述所基于的一些概念目前已在数学领域得到了进一步发展，如代数以及[非交换几何](../Page/非交换几何.md "wikilink")。
...
需要注意的是，尽管形式存在一定的类似性，但考虑到[概率第三公理的要求](../Page/概率公理#第三公理.md "wikilink")并非一种[联合分布](../Page/联合分布.md "wikilink")，因为其所表征的区域中的状态并不一定相互排斥。此外，尽管会违反[概率第一公理](../Page/概率公理#第一公理.md "wikilink")，即使系统处于纯态时，在特殊情况下，如系统处于[相干态](../Page/相干态.md "wikilink")时，其值也可能为。
...
能量的[本征态分布一般称作](../Page/本征态.md "wikilink")“星积本征态”或是“星积本征函数”，对应的能量值则被称为“星积本征值”。它们是对应含时[薛定谔方程的星积本征值方程的解](../Page/薛定谔方程.md "wikilink")\[21\]\[22\]：

\[H \star W = E \cdot W\] 式中为哈密顿量。它是一个普通相空间函数，通常与经典力学中的哈密顿量相同。

## 时间演化

相空间的时间演化可以通过对[刘维尔方程进行量子改造得到](../Page/刘维尔定理_\(哈密顿力学\)#刘维尔方程.md "wikilink")\[23\]\[24\]\[25\]。这个方程是通过对进行维格纳变换得到的。
...
式中{{ , }}为。其为[对易算符经过维格纳变换后的结果](../Page/对易算符.md "wikilink")，而{ ,
}则为经典力学中的[泊松括号](../Page/泊松括号.md "wikilink")。\[26\]
...
[量子隧穿效应是一种典型的量子效应](../Page/量子隧穿效应.md "wikilink")。在发生隧穿时，粒子在不具备足够飞跃势垒的能量时，仍能像有一个“隧道”一样穿过势垒。这一效应在经典力学中并没有对应的效应。

在[证明论中](../Page/证明论.md "wikilink")，**相继式**（sequent）是对在规定[演绎的](../Page/演绎推理.md "wikilink")[演算的时候经常用到的可证明性的形式陈述](https://zh.wikipedia.org/wiki/演算 "wikilink")。
...
但是上述解释只用于教学目的。因为在证明论中的形式证明是纯粹的[语法上的](../Page/语法.md "wikilink")，相继式的[语义只由提供实际的](https://zh.wikipedia.org/wiki/语义 "wikilink")[推理规则的演算的性质给出](../Page/推理规则.md "wikilink")。
...
在很多情况下，相继式还假定由[多重集或](../Page/多重集.md "wikilink")[集合组成](https://zh.wikipedia.org/wiki/集合 "wikilink")。所以你可以漠视公式的次序甚至数目。对于经典[命题逻辑这不导致问题](https://zh.wikipedia.org/wiki/命题演算 "wikilink")，因为你能从一组前提中得出的结论不依赖于这些数据。但是在[亚结构逻辑中这就变得很重要了](../Page/亚结构逻辑.md "wikilink")。
...
历史上，相继式是[Gerhard
Gentzen介入用来规定他著名的](https://zh.wikipedia.org/wiki/Gerhard_Gentzen "wikilink")[相继式演算](../Page/相继式演算.md "wikilink")。在他的德语出版物中他使用了单词"Sequenz"。但是，在英语中，单词"[序列](../Page/序列.md "wikilink")"已经用来翻译德语的"Folge"并在数学中经常出现。术语"相继式"被建立用做这个德语表达的替代翻译。

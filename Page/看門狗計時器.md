...
看門狗計時器也可能觸發、觸動控制系統，使控制系統轉入安全狀態，例如關閉馬達、關閉[高壓電輸出](../Page/高壓電.md "wikilink")，以及關閉其他具有潛在危險的[子系統](https://zh.wikipedia.org/wiki/子系統 "wikilink")（Subsystem），直到系統錯誤、故障被解決排除為止。

舉例而言，一個看門狗計時器是由一個 x
bit（[位元](../Page/位元.md "wikilink")）的[計數器與一個](https://zh.wikipedia.org/wiki/計數器 "wikilink")
y
MHz（百萬[赫茲](https://zh.wikipedia.org/wiki/赫茲 "wikilink")）的[時脈信號所構成](https://zh.wikipedia.org/wiki/時脈 "wikilink")。如此，計時器若在\(\frac{2^x}{y \cdot 10^6}\)秒內沒有被清除，看門狗計時器就會對系統發出重置、重新開機或關閉信號。

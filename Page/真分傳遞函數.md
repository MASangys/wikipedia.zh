**真分傳遞函數**（proper transfer
function）為[控制理论的術語](../Page/控制理论.md "wikilink")，是指[傳遞函數分子多項式的次數不超過分母多項式的次數](https://zh.wikipedia.org/wiki/傳遞函數 "wikilink")。若分子的次數[小於分母的次數](https://zh.wikipedia.org/wiki/小於 "wikilink")，則稱為**嚴格真分傳遞函數**（strictly
...
## 參考資料
  ...
  - [Transfer
    functions](https://web.archive.org/web/20160304220240/https://courses.engr.illinois.edu/ece486/documents/set5.pdf)
    - ECE 486: Control Systems Spring 2015, University of Illinois
  - [ELEC ENG 4CL4: Control System Design Notes for Lecture
    \#9](http://www.ece.mcmaster.ca/~ibruce/courses/EE4CL4_lecture9.pdf),
    2004, Dr. Ian C. Bruce, McMaster University

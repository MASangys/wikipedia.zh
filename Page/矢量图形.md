[VectorGraphicsExample.jpg](https://zh.wikipedia.org/wiki/File:VectorGraphicsExample.jpg "fig:VectorGraphicsExample.jpg")较差，但是矢量图可以不降低[品質地无限放大](https://zh.wikipedia.org/wiki/品質 "wikilink")。\]\] **矢量图形**是[计算机图形学](../Page/计算机图形学.md "wikilink")中用[点](../Page/点.md "wikilink")、[直线](../Page/直线.md "wikilink")或者[多边形](../Page/多边形.md "wikilink")等基于数学方程的几何图元表示[图像](https://zh.wikipedia.org/wiki/图像 "wikilink")。矢量图形与使用[像素](../Page/像素.md "wikilink")表示图像的[位图](../Page/位图.md "wikilink")不同。

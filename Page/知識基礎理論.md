> 本文内容由[知識基礎理論](https://zh.wikipedia.org/wiki/知識基礎理論)转换而来。


**知識基礎理論**（**Knowledge-based theory of the firm**，**KBT**）是一種將[知識視為](https://zh.wikipedia.org/wiki/知識 "wikilink")[企業重要](https://zh.wikipedia.org/wiki/企業 "wikilink")[資源的理論](https://zh.wikipedia.org/wiki/資源 "wikilink")。

## 理論概述

知識有別於[數據](https://zh.wikipedia.org/wiki/數據 "wikilink")（Data）與[資訊](https://zh.wikipedia.org/wiki/資訊 "wikilink")（Information），是一種經過系統化、結構化之直覺、經驗與事實【Davenport， 1998】；知識組成的元素包含了資訊（information）、[科技](https://zh.wikipedia.org/wiki/科技 "wikilink")（technology）、[關鍵技術](https://zh.wikipedia.org/wiki/關鍵技術 "wikilink")（know how）及技巧 （skill）；藉由[知識可以增加企業產品產出的](https://zh.wikipedia.org/wiki/知識 "wikilink")[價值](https://zh.wikipedia.org/wiki/價值 "wikilink")，並且取得[競爭上的優勢](https://zh.wikipedia.org/wiki/競爭 "wikilink")；知識可區分為外顯知識（explicit knowledge）及內隱知識（tacit knowledge），外顯知識可透過文字、規則或是語言來傳遞，內隱知識存在於個體 之中；而知識的來源大多存在於個體中，而生產必須結合不同及特定的知識。因此企業最主要的工作是創造及運用知識。
...
由於KBT將知識視為企業最大的資源，而企業運作的目的也是要創造並運用知識因此有學者認為應該透過[學習組織](https://zh.wikipedia.org/wiki/學習組織 "wikilink")（Learning Organization）來強化企業的知識基礎（Knowledge-based）（e.g.Senge,1990），有的學者則是指出在此觀點下整合各種不同獨立知識的困難（e.g.Kogut and Zander,1992），有的學者則是指出組織必須擁有吸收的能力，必須能夠吸收組織外的知識【Cohen and Levinthal，1990】。
...
2.  整合的能力（Capacity for aggregation）：已存在的知識可以藉由吸收（absorption）的方式與新的知識融合成一體；而知識可以透過[共通語言](https://zh.wikipedia.org/wiki/共通語言 "wikilink")（common language）的解釋大幅強化知識聚合的效率。
...
[Category:知識](https://zh.wikipedia.org/wiki/Category:知識 "wikilink") [Category:企業](https://zh.wikipedia.org/wiki/Category:企業 "wikilink")
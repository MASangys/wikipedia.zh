...
\[\mu'_n=\int_{-\infty}^\infty (x - c)^n\,f(x)\,dx\]。如果f(x)是概率密度函数，则容易看出相对于值0的1阶矩是连续随机变量的[数学期望](../Page/数学期望.md "wikilink")。
...
在方差等定義中，[期望也稱為隨機變量的](../Page/期望.md "wikilink")“中心”。顯然，任何隨機變量的1階中心矩為0。

## 方差（Variance）

隨機變量的[方差定義為其](../Page/方差.md "wikilink")2階中心矩：

\[\operatorname{Var}(x) = \int_{-\infty}^\infty \left[x - E(x)\right]^2 \,f(x)\,dx\]

## 偏態（Skewness）

隨機變量的[偏態定義為其](../Page/偏態.md "wikilink")3階中心矩：

\[S (x) = \int_{-\infty}^\infty [x - E(x)]^3 \,f(x)\,dx\]

## 峰態（Kurtosis）

隨機變量的[峰態定義為其](../Page/峰態.md "wikilink")4階中心矩：
...
## 參見
  ...
  - [矩 (物理学)](../Page/矩_\(物理学\).md "wikilink")

## 外部連結

  - [Mathworld
    Website](http://mathworld.wolfram.com/topics/Moments.html)

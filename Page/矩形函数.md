...
矩形函数的[傅立叶变换](../Page/傅立叶变换.md "wikilink")，
...
我们可以将[三角形函数定义为两个矩形函数的](../Page/三角形函数.md "wikilink")[卷积](../Page/卷积.md "wikilink")：
...
并且它的[动差生成函数为](../Page/动差生成函数.md "wikilink")，

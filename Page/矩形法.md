[微积分中](../Page/微积分.md "wikilink")，**矩形法**是一种计算[定积分近似值的方法](../Page/定积分.md "wikilink")，其思想是求若干个矩形的面积之和，这些矩形的高由函数值来决定。\[1\]

将[积分区间](../Page/积分区间.md "wikilink") \((a,b)\) 划分为 \(n\)
个长度相等的子区间，每个子区间的长度为
\(\Delta x =\frac{b-a}{n}\)
。这些[矩形左上角](../Page/矩形.md "wikilink")、右上角或顶边中点在被积[函数图像上](../Page/函数图像.md "wikilink")。这样，这些矩形的面积之和就约等于定积分的近似值。有：
...
## 另见
  ...
  - [梯形法](../Page/梯形法.md "wikilink")
  - [辛普森法](../Page/辛普森法.md "wikilink")

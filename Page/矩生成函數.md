[动差又被称为](../Page/动差.md "wikilink")[矩](../Page/矩.md "wikilink")。[隨機變數](../Page/隨機變數.md "wikilink")*X*
的**動差生成函數**或**矩母函数**（）定義為：
...
如果*X*具有连续[概率密度函数](../Page/概率密度函数.md "wikilink")*f*(*x*)，则它的动差生成函数由下式给出：
...
其中\(m_i\)是第*i*个[矩](../Page/矩.md "wikilink")。\(M_X(-t)\)是*f*(*x*)的[双边拉普拉斯变换](../Page/双边拉普拉斯变换.md "wikilink")。

不管[概率分布是不是连续](../Page/概率分布.md "wikilink")，动差生成函数都可以用[黎曼-斯蒂尔吉斯积分给出](../Page/黎曼-斯蒂尔吉斯积分.md "wikilink")：
...
对于分量为[实数的](../Page/实数.md "wikilink")[向量值随机变量](../Page/随机向量.md "wikilink")**X**，动差生成函数为：

\[M_X(\mathbf{t}) = \operatorname{E}\left( e^{\langle \mathbf{t}, \mathbf{X}\rangle}\right)\]

其中**t**是一个向量，\(\langle \mathbf{t} , \mathbf{X}\rangle\)
是[数量积](../Page/数量积.md "wikilink")。
...
一些其它在概率论中常见的[积分变换也与动差生成函数有关](../Page/积分变换.md "wikilink")，包括[特征函数以及](../Page/特征函数_\(概率论\).md "wikilink")[概率生成函数](../Page/概率生成函数.md "wikilink")。

[累积量生成函数是动差生成函数的对数](../Page/累积量生成函数.md "wikilink")。

## 参见

  - [阶乘动差生成函数](../Page/阶乘动差生成函数.md "wikilink")
  - [速率函数](../Page/速率函数.md "wikilink")

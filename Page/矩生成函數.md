[动差又被称为](https://zh.wikipedia.org/wiki/动差 "wikilink")[矩](https://zh.wikipedia.org/wiki/矩 "wikilink")。[隨機變數](https://zh.wikipedia.org/wiki/隨機變數 "wikilink")*X*
的**動差生成函數**或**矩母函数**（）定義為：
...
不管[概率分布是不是连续](../Page/概率分布.md "wikilink")，动差生成函数都可以用[黎曼-斯蒂尔吉斯积分给出](https://zh.wikipedia.org/wiki/黎曼-斯蒂尔吉斯积分 "wikilink")：
...
对于分量为[实数的](../Page/实数.md "wikilink")[向量值随机变量](https://zh.wikipedia.org/wiki/随机向量 "wikilink")**X**，动差生成函数为：

\[M_X(\mathbf{t}) = \operatorname{E}\left( e^{\langle \mathbf{t}, \mathbf{X}\rangle}\right)\]

其中**t**是一个向量，\(\langle \mathbf{t} , \mathbf{X}\rangle\)
是[数量积](https://zh.wikipedia.org/wiki/数量积 "wikilink")。
...
一些其它在概率论中常见的[积分变换也与动差生成函数有关](../Page/积分变换.md "wikilink")，包括[特征函数以及](../Page/特征函数_\(概率论\).md "wikilink")[概率生成函数](https://zh.wikipedia.org/wiki/概率生成函数 "wikilink")。

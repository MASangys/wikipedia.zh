...
这是从所有*n*×*n*矩阵的空间到[一般线性群](../Page/一般线性群.md "wikilink")（所有非奇异方阵所组成的群）的映射。实际上，这个映射是[满射](../Page/满射.md "wikilink")，就是说每一个非奇异方阵都可以写成某个矩阵的指数。[矩阵对数](../Page/矩阵对数.md "wikilink")就是这个映射的逆映射。
...
对于非齐次的情况，我们可以用[积分因子](../Page/积分因子.md "wikilink")的方法（类似于[参数变换的方法](https://zh.wikipedia.org/wiki/参数变换 "wikilink")）。我们找到形为***y***<sub>p</sub>(*t*)
= exp(*tA*)***z***(*t*)一个特解：

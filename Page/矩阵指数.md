**矩阵指数**是[方块矩阵的一种](../Page/方块矩阵.md "wikilink")[矩阵函数](../Page/矩阵函数.md "wikilink")，与[指数函数类似](../Page/指数函数.md "wikilink")。矩阵指数给出了矩阵[李代数与对应的](https://zh.wikipedia.org/wiki/李代数 "wikilink")[李群之间的关系](../Page/李群.md "wikilink")。

设*X*为*n*×*n*的[实数或](../Page/实数.md "wikilink")[复数](https://zh.wikipedia.org/wiki/复数 "wikilink")[矩阵](../Page/矩阵.md "wikilink")。*X*的指数，用*e*<sup>*X*</sup>或exp(*X*)来表示，是由以下[幂级数所给出的](../Page/幂级数.md "wikilink")*n*×*n*矩阵：
...
我们可以从指数级数的定义直接得到矩阵指数的如下性质\[1\]：
  ...
  - exp(*X*<sup>T</sup>) = (exp
    *X*)<sup>T</sup>，其中*X*<sup>T</sup>表示*X*的[转置](https://zh.wikipedia.org/wiki/转置 "wikilink")。从中可以推出，如果*X*是[对称矩阵](https://zh.wikipedia.org/wiki/对称矩阵 "wikilink")，则*e*<sup>*X*</sup>也是对称矩阵；如果*X*是[斜对称矩阵](https://zh.wikipedia.org/wiki/斜对称矩阵 "wikilink")，则*e*<sup>*X*</sup>是[正交矩阵](../Page/正交矩阵.md "wikilink")。
...
<!-- end list -->
  ...
  - 如果是[可逆矩阵](https://zh.wikipedia.org/wiki/可逆矩阵 "wikilink")，那么
...
\[e^Xe^Y=e^Z,\]
其中\(Z\)可以通过\(X\)和\(Y\)的交换子的级数（[贝克尔-坎贝尔-豪斯多夫公式](https://zh.wikipedia.org/wiki/贝克尔-坎贝尔-豪斯多夫公式 "wikilink")）来计算：\[5\]
...
注意矩阵的指数总是[非奇异方阵](https://zh.wikipedia.org/wiki/非奇异方阵 "wikilink")。*e*<sup>*X*</sup>的[逆矩阵由](../Page/逆矩阵.md "wikilink")*e*<sup>−*X*</sup>给出。这与复数的指数总是非零的事实类似。这样，矩阵指数就给出了一个映射：
...
定义了一般线性群中的一条[光滑曲线](https://zh.wikipedia.org/wiki/光滑 "wikilink")，当*t* =
0时穿过单位元。实际上，这给出了一般线性群的一个[单参数子群](https://zh.wikipedia.org/wiki/单参数子群 "wikilink")，这是由于：
...
这也允许了我们计算[可对角化矩阵的指数](../Page/可对角化矩阵.md "wikilink")。如果\(A = UDU^{-1}\)，且*D*是对角矩阵，则\(e^A = U e^D U^{-1}\)。用[西尔维斯特公式](https://zh.wikipedia.org/wiki/西尔维斯特公式 "wikilink")，也可以得到相同的结果。
...
对于非齐次的情况，我们可以用[积分因子的方法](../Page/积分因子.md "wikilink")（类似于[参数变换的方法](https://zh.wikipedia.org/wiki/参数变换 "wikilink")）。我们找到形为***y***<sub>p</sub>(*t*)
= exp(*tA*)***z***(*t*)一个特解：

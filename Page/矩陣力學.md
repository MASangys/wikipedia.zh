**矩陣力學**是[量子力學其中一種的表述形式](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，它是由[海森堡](https://zh.wikipedia.org/wiki/海森堡 "wikilink")、[玻恩和](https://zh.wikipedia.org/wiki/玻恩 "wikilink")[约尔当](https://zh.wikipedia.org/wiki/帕斯库尔·约当 "wikilink")（P. Jordan）於1925年完成的。矩陣力學的思想出發點是針對[波耳模型中許多觀點](https://zh.wikipedia.org/wiki/波耳模型 "wikilink")，諸如[電子的](https://zh.wikipedia.org/wiki/電子 "wikilink")[軌道](https://zh.wikipedia.org/wiki/軌道 "wikilink")、[頻率等](https://zh.wikipedia.org/wiki/頻率 "wikilink")，都不是可以直接觀察的。反之，在實驗中經常接觸到的是光譜線的頻率、強度、偏極化，以及[能階](https://zh.wikipedia.org/wiki/能階 "wikilink")。[海森堡計劃創造一個理論](https://zh.wikipedia.org/wiki/海森堡 "wikilink")，只是用光譜線的頻率、強度、偏極化等觀念。他的做法是受到[愛因斯坦在](https://zh.wikipedia.org/wiki/愛因斯坦 "wikilink")[相對論中對時間](https://zh.wikipedia.org/wiki/相對論 "wikilink")、空間作“操作定義”分析的影響。

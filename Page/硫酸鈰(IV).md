**硫酸铈(IV)**（化学式：**Ce(SO<sub>4</sub>)<sub>2</sub>**），是[稀土元素](https://zh.wikipedia.org/wiki/稀土元素 "wikilink")[铈](../Page/铈.md "wikilink")的[硫酸盐](https://zh.wikipedia.org/wiki/硫酸盐 "wikilink")，是一种颜色为黄色或者接近与橙色的化学物品。常态下得到的硫酸铈(IV)一般以无水的Ce(SO<sub>4</sub>)<sub>2</sub>或者含若干个结晶水的

**磁力連結**（Magnet URI
scheme），是[对等网络中进行信息检索和下载文档的](https://zh.wikipedia.org/wiki/对等网络 "wikilink")[电脑程序](https://zh.wikipedia.org/wiki/电脑程序 "wikilink")。和基于“位置”连接的[统一资源定位符不同](../Page/统一资源定位符.md "wikilink")，磁力连结是基于[元数据](../Page/元数据.md "wikilink")（metadata）文件内容，属于[统一资源名称](../Page/统一资源名称.md "wikilink")。也就是说，磁力连结不基于文档的[IP地址或定位符](../Page/IP地址.md "wikilink")，而是在[分布式数据库中](https://zh.wikipedia.org/wiki/分布式数据库 "wikilink")，通过[散列函数值来识别](https://zh.wikipedia.org/wiki/散列函数 "wikilink")、[搜索来下载文档](https://zh.wikipedia.org/wiki/搜索 "wikilink")。因为不依赖一个处于启动状态的主机来下载文档，所以特别适用没有中心服务器的[对等网络](https://zh.wikipedia.org/wiki/对等网络 "wikilink")。尽管它符合[开源标准](../Page/开源标准.md "wikilink")，却被垄断信息资源和监控用户行为的个人、组织、企业和政府拒之门外。
...
磁力連結的这部分最重要。用于寻找和验证包含着磁力連結中的文件。
  ...
  - [TTH](https://zh.wikipedia.org/wiki/哈希树 "wikilink")（Tiger Tree散列函数）

TigerTree散列函数被用在包括和在内的几个网络中。

`xt=urn:tree:tiger:[ `[`TTH`](https://zh.wikipedia.org/wiki/哈希树 "wikilink")` `[`Hash`](../Page/散列函數.md "wikilink")`（``）]`
...
这种散列函数包含一个[SHA-1散列函数和一个](https://zh.wikipedia.org/wiki/SHA_家族#SHA-0.E5.92.8CSHA-1 "wikilink")[TTH散列函数](https://zh.wikipedia.org/wiki/哈希树 "wikilink")，用"."隔开。

[Gnutella和](../Page/Gnutella.md "wikilink")使用。

`xt=urn:bitprint:[ `[`SHA-1`](../Page/SHA-1.md "wikilink")` `[`Hash`](../Page/散列函數.md "wikilink")`（``）].[ `[`TTH`](https://zh.wikipedia.org/wiki/哈希树 "wikilink")` `[`Hash`](../Page/散列函數.md "wikilink")`（``）]`
...
这类链接被[Gnutella还有](../Page/Gnutella.md "wikilink")[G2应用程序使用](https://zh.wikipedia.org/wiki/G2 "wikilink")，基於RFC
2168。
...
Tracker
[URL](https://zh.wikipedia.org/wiki/URL "wikilink").用于在不需要[分散式雜湊表支持下下载](../Page/分散式雜湊表.md "wikilink")[BitTorrent资源](../Page/BitTorrent_\(协议\).md "wikilink")。

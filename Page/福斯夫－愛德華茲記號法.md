**福斯夫－愛德華茲記號法**（Forsyth–Edwards Notation），簡稱*FEN*，是蘇格蘭人David
Forsyth發明的[國際象棋可完整敘述局面的記譜法](https://zh.wikipedia.org/wiki/國際象棋 "wikilink")，也可用於[中國象棋](https://zh.wikipedia.org/wiki/中國象棋 "wikilink")

## 記譜規則

  - 使用[ASCII字符串代码](../Page/ASCII.md "wikilink")，代码意义依次是：
      ...
      - 半回合计数（Halfmove
        clock）：以阿拉伯數字表示，從最後一次吃子或移動兵開始計算的回合數，用於判斷五十回合自然限著和局。

**秀爾演算法**（），以數學家[彼得·秀爾](../Page/彼得·秀爾.md "wikilink")命名，是一個在1994年發現的，針對[整數分解這題目的的](https://zh.wikipedia.org/wiki/整數分解 "wikilink")[量子演算法](https://zh.wikipedia.org/wiki/量子演算法 "wikilink")（在[量子計算機上面運作的](https://zh.wikipedia.org/wiki/量子計算機 "wikilink")[演算法](https://zh.wikipedia.org/wiki/演算法 "wikilink")）。比較不正式的說，它解決題目如下：給定一個整數*N*，找出他的[質因數](../Page/質因數.md "wikilink")。 在一個[量子計算機上面](https://zh.wikipedia.org/wiki/量子計算機 "wikilink")，要分解整數*N*，秀爾演算法的運作需要[多項式時間](../Page/多項式時間.md "wikilink")（時間是log *N*的某個多項式這麼長，log *N*在這裡的意義是輸入的檔案長度）。更精確的說，這個演算法花費的時間，展示出質因數分解問題可以使用量子計算機以多項式時間解出，因此在[複雜度類](https://zh.wikipedia.org/wiki/複雜度類 "wikilink")**[BQP](https://zh.wikipedia.org/wiki/BQP "wikilink")**裡面。這比起傳統已知最快的因數分解演算法，[普通數域篩選法](https://zh.wikipedia.org/wiki/普通數域篩選法 "wikilink")，其花費[次指數時間](https://zh.wikipedia.org/wiki/指數時間 "wikilink") -- 大約，還要快了一個指數的差異。

在[Unicode中](https://zh.wikipedia.org/wiki/Unicode "wikilink")，**私人使用区**（簡稱：私用區；，簡稱：PUA）指其解释未在Unicode标准中指定，而是由合作用户之间的私人协议决定其用途的一系列码位。\[1\] 目前定义了三个私人使用区：一个在基本多语言平面（U+E000-U+F8FF）中，另外两个几乎包含了整个第15和第16平面（分别为U+F0000-U+FFFFD，U+100000-U+10FFFD）。\[2\]
...
## 使用实例
  ...
  - [GB 18030和](../Page/GB_18030.md "wikilink")[GBK使用私人使用区临时编码Unicode标准之外的字符](https://zh.wikipedia.org/wiki/GBK "wikilink")。
  - [爱沙尼亚语言研究院](../Page/爱沙尼亚语言研究院.md "wikilink")使用私人使用区编码Unicode标准未收录的拉丁字母和西里尔字母。\[3\]
  - [機讀編目格式標準](../Page/機讀編目格式標準.md "wikilink")MARC 21使用私人使用区编码未被Unicode收录的东亚字符。
...
1.  Unicode Consortium. [Glossary of Unicode Terms: "Private Use Area (PUA)"](http://unicode.org/glossary/#private_use_area)
2.
3.
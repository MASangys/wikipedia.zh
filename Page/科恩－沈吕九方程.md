**科恩－沈吕九方程**（，简称**科恩－沈方程**）在[密度泛函理论里面指的是与真实体系相关的虚拟体系所满足的](https://zh.wikipedia.org/wiki/密度泛函理论 "wikilink")[薛定谔方程](../Page/薛定谔方程.md "wikilink")。该虚拟体系中的粒子（通常是[电子](../Page/电子.md "wikilink")）在无相互作用的有效势场中运动，粒子密度在空间各点均与真实系统相同。\[1\]\[2\]科恩－沈吕九方程中的有效势通常用
\(v_{\rm s}(\mathbf r)\) 或 \(v_{\rm eff}(\mathbf r)\))
来表示，称为科恩－沈势。虚拟系统中的粒子是彼此无相互作用的[费米子](../Page/费米子.md "wikilink")，因此科恩－沈方程的精确解为单个斯莱特行列式，行列式中的轨道则称为科恩－沈轨道，每一个科恩－沈轨道都可以表示为原子轨道的线性组合，也可以按照基函数展开。科恩－沈方程的形式如下：
...
式中 \(\varepsilon_i\) 为科恩－沈轨道 \(\phi_i\) 的轨道能。含有 \(N\)
个粒子的科恩－沈系统的电子密度则由下式给出：
...
科恩－沈方程于 1965
年由[加利福尼亚大学圣迭戈分校的](https://zh.wikipedia.org/wiki/加利福尼亚大学圣迭戈分校 "wikilink")[沃尔特·科恩与](../Page/沃尔特·科恩.md "wikilink")[沈吕九提出并以他们的名字命名](https://zh.wikipedia.org/wiki/沈吕九 "wikilink")。
...
式中 \(T_s\) 是科恩－沈[动能项](../Page/动能.md "wikilink")，可以用科恩－沈轨道表出如下：
...
科恩－沈轨道能 \(\varepsilon_i\)
并没有明确的物理含义。它与体系总能量的关系由下式给出（参见[库普曼斯定理](../Page/库普曼斯定理.md "wikilink")）：

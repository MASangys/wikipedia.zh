科恩－苏泽兰算法（Cohen-Sutherland），是[计算机图形学直线段裁剪算法的一种](../Page/计算机图形学.md "wikilink")，由丹·科恩（Dan
Cohen）和伊凡·苏泽兰（Ivan Sutherland）两人提出。
...
[Cohen-Sutherland
img3.png](https://zh.wikipedia.org/wiki/File:Cohen-Sutherland_img3.png "fig:Cohen-Sutherland img3.png")

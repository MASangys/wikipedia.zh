...
它最早出現在[海里格·冯·科赫的論文](https://zh.wikipedia.org/wiki/海里格·冯·科赫 "wikilink")《關於一條連續而無切線，可由初等幾何構作的曲線》（1904年，法語原題：*Sur
...
\(\frac{2\sqrt{3}(s^2)}{5}\)，其中\(s\)是原來三角形的邊長。每條科赫曲線的長度是無限大，它是[連續而](https://zh.wikipedia.org/wiki/連續 "wikilink")[無處可微的曲線](https://zh.wikipedia.org/wiki/無處可微 "wikilink")。

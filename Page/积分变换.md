**積分變換**（integral
transform）是[數學中作用于函数的](https://zh.wikipedia.org/wiki/數學 "wikilink")[算子](../Page/算子.md "wikilink")，用以處理[微分方程等問題](../Page/微分方程.md "wikilink")。常見的有[傅里葉變換](https://zh.wikipedia.org/wiki/傅里葉變換 "wikilink")﹑[拉普拉斯變換等](https://zh.wikipedia.org/wiki/拉普拉斯變換 "wikilink")。

## 概述

以一[變數為](../Page/變數.md "wikilink") \(t\)
的[函數](https://zh.wikipedia.org/wiki/函數 "wikilink") \(f(t)\)
為例，\(f(t)\) 經過一積分轉換 \(T\) 得到 \(Tf(u)\)：

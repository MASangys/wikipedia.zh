...
其中\(C\)是一个[常数](../Page/常数.md "wikilink")。于是，

\[y(x) = \frac{\int  b(x) M(x)\, dx + C}{M(x)}.\,\]

为了求出函数\(M(x)\)，我们把(3)的左面用[乘法定则展开](../Page/乘法定则.md "wikilink")：
...
等式(5)是[对数导数的形式](../Page/对数导数.md "wikilink")。解这个方程，得：
...
利用[复合函数求导法则](../Page/复合函数求导法则.md "wikilink")，可得：
...
利用[分离变量法](../Page/分离变量法.md "wikilink")，可得：

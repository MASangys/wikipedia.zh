...
\[\int\frac{1}{\pm x^2\mp\alpha^2}\mbox{d}x = \frac{\ln\left(\dfrac{x\mp\alpha}{ x\pm\alpha}\right)}{2\alpha}+C\]
...
[Category:積分表](https://zh.wikipedia.org/wiki/Category:積分表 "wikilink")

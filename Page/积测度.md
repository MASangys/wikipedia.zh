...
设\((X_1, \Sigma_1)\)和\((X_2, \Sigma_2)\)是两个[测度空间](../Page/测度空间.md "wikilink")，就是说\(\Sigma_1\)和\(\Sigma_2\)分别是在\(X_1\)和\(X_2\)上的[σ代数](https://zh.wikipedia.org/wiki/σ代数 "wikilink")，又设\(\mu_1\)和\(\mu_2\)是其上的测度。以\(\Sigma_1 \times \Sigma_2\)记形如\(B_1 \times B_2\)的[子集产生的](../Page/子集.md "wikilink")[笛卡儿积](../Page/笛卡儿积.md "wikilink")\(X_1 \times X_2\)上的σ代数，其中\(B_1 \in \Sigma_1\)及\(B_2 \in \Sigma_2\)。

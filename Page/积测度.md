[数学中](../Page/数学.md "wikilink")，给出[可测空间和其上的](https://zh.wikipedia.org/wiki/可测空间 "wikilink")[测度](../Page/测度.md "wikilink")，可以获得**积可测空间**和其上的**积测度**。概念上近似于[集的](https://zh.wikipedia.org/wiki/集 "wikilink")[笛卡儿积和两个](../Page/笛卡儿积.md "wikilink")[拓扑空间的](../Page/拓扑空间.md "wikilink")[积拓扑](https://zh.wikipedia.org/wiki/积拓扑 "wikilink")。

设\((X_1, \Sigma_1)\)和\((X_2, \Sigma_2)\)是两个[测度空间](https://zh.wikipedia.org/wiki/测度空间 "wikilink")，就是说\(\Sigma_1\)和\(\Sigma_2\)分别是在\(X_1\)和\(X_2\)上的[σ代数](https://zh.wikipedia.org/wiki/σ代数 "wikilink")，又设\(\mu_1\)和\(\mu_2\)是其上的测度。以\(\Sigma_1 \times \Sigma_2\)记形如\(B_1 \times B_2\)的[子集产生的](../Page/子集.md "wikilink")[笛卡儿积](../Page/笛卡儿积.md "wikilink")\(X_1 \times X_2\)上的σ代数，其中\(B_1 \in \Sigma_1\)及\(B_2 \in \Sigma_2\)。

**程序设计方法学**是讨论[程序的性质以及](https://zh.wikipedia.org/wiki/程序 "wikilink")[程序设计的理论和方法的一门学科](../Page/程序设计.md "wikilink")，是研究和构造程序的过程的学问，是研究关于问题的分析，环境的模拟，概念的获取，需求定义的描述，以及把这种描述变换细化和编码成机器可以接受的表示的一般的方法。

## 程序设计方法学发展历史

### 产生背景

  - 1950年代—1960年代初，手工艺式的程序设计方法，[高德纳把程序称为艺术品](../Page/高德纳.md "wikilink")。
  ...
  - 1968年，[北大西洋公约组织](https://zh.wikipedia.org/wiki/北大西洋公约组织 "wikilink")（NATO）在[西德召开了第一次](../Page/西德.md "wikilink")[软件工程会议](../Page/软件工程.md "wikilink")，分析了危机的局面，研究了问题的根源，第一次提出了用[工程学的办法解决软件研制和生产的问题](../Page/工程学.md "wikilink")，本次会议可以算做是软件发展史上的一个重要的里程碑。
...
### “程序正确性证明”的研究
  ...
  - 1967年，[Floyd提出用](https://zh.wikipedia.org/wiki/Robert_W._Floyd "wikilink")“
    [断言法](https://zh.wikipedia.org/wiki/断言法 "wikilink")”证明框图程序的正确性。
  ...
  - 1974年，人们利用[模态逻辑验证](../Page/模态逻辑.md "wikilink")[并行程序的正确性](https://zh.wikipedia.org/wiki/并行程序 "wikilink")。
  - 关于程序正确性证明的争论：
...
[逻辑程序设计和](https://zh.wikipedia.org/wiki/逻辑程序设计 "wikilink")[函数程序设计代表一种新的研究方向](https://zh.wikipedia.org/wiki/函数程序设计 "wikilink")。[Prolog是以](../Page/Prolog.md "wikilink")[谓词逻辑的](https://zh.wikipedia.org/wiki/谓词逻辑 "wikilink")[子集](../Page/子集.md "wikilink")（Hoare子句）为基础的一种形式系统。Prolog的执行过程就是执行逻辑上消解算法的过程。
...
[软件工程主要应用工程的方法和技术研究软件开发与维护的方法](../Page/软件工程.md "wikilink")、工具和管理的一门计算机科学与工程学交叉的学科

...
H. A. van der Vorst
提出的用于数值求解非对称[线性方程组的](../Page/线性方程组.md "wikilink")[迭代方法](../Page/迭代方法.md "wikilink")。它是[双共轭梯度法](../Page/双共轭梯度法.md "wikilink")（BiCG）的一个变种，比双共轭梯度法本身以及诸如[共轭梯度平方法](../Page/共轭梯度平方法.md "wikilink")（CGS）等其他变种有更快速和更平滑的收敛性。它是一种
[Krylov 子空间方法](../Page/Krylov_子空间.md "wikilink")。
...
[预处理通常被用来加速迭代方法的收敛](../Page/预处理.md "wikilink")。要使用预处理子
...
## 相关主题
  ...
  - [双共轭梯度法](../Page/双共轭梯度法.md "wikilink")

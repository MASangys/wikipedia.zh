在[数值线性代数](../Page/数值线性代数.md "wikilink")中，**稳定双共轭梯度法**（，通常简称为）是一种由荷兰数学家
H. A. van der Vorst
提出的用于数值求解非对称[线性方程组](../Page/线性方程组.md "wikilink")的[迭代方法](https://zh.wikipedia.org/wiki/迭代方法 "wikilink")。它是[双共轭梯度法](https://zh.wikipedia.org/wiki/双共轭梯度法 "wikilink")（BiCG）的一个变种，比双共轭梯度法本身以及诸如[共轭梯度平方法](https://zh.wikipedia.org/wiki/共轭梯度平方法 "wikilink")（CGS）等其他变种有更快速和更平滑的收敛性。它是一种

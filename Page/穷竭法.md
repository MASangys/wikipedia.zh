...
[阿基米德](../Page/阿基米德.md "wikilink")使用穷竭法来计算[圆](../Page/圆.md "wikilink")周所围住的面积，具体说来就是用一个面积越来越大，[边](../Page/边.md "wikilink")数越来越多的[多边形](../Page/多边形.md "wikilink")来填充这个圆。当多边形的边数越来越多时，其面积与圆半径的平方之商可以任意接近π，由此证明半径为r的圆周所围面积为πr<sup>2</sup>，其中[π定义为圆的周径之比](https://zh.wikipedia.org/wiki/π "wikilink")(C/d)或圆面积与半径平方之比(A/r²).

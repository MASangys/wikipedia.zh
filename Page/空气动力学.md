...
当流体流动速度小于[音速时](../Page/音速.md "wikilink")，我们称之为亚音速流动。更进一步，当[马赫数](https://zh.wikipedia.org/wiki/马赫数 "wikilink")（即流体速度与音速之比）小于
...
当流体速度接近或略超过音速（即[马赫数约等于](https://zh.wikipedia.org/wiki/马赫数 "wikilink")1时），我们称之为跨音速流动。跨音速流动的典型特征是[激波和](../Page/激波.md "wikilink")[膨胀波](https://zh.wikipedia.org/wiki/膨胀波 "wikilink")。在其区域内，流体的各种性质发生剧烈变化，幅度之大，以至于我们可以认为通过激波的流体是不连续的。
...
除航空航天外，空气动力学在其他领域也有非常重要的应用。在包括[汽车在内的所有交通工具的设计中](../Page/汽车.md "wikilink")，它都是一个很重要的因素。大型建筑物涉及到风载荷，市内空气动力学研究城市的[微气候环境](https://zh.wikipedia.org/wiki/微氣候 "wikilink")，环境空气动力学研究[大气环流和飞行对生态系统的影响](../Page/大氣環流.md "wikilink")。还有[引擎设计所涉及的热流和内流也是空气动力学非常重要的一个方面](../Page/发动机.md "wikilink")。
...
## 参见
  ...
  - [List of aerospace engineering
    topics](https://zh.wikipedia.org/wiki/:en:List_of_aerospace_engineering_topics "wikilink")
  - [List of engineering
    topics](https://zh.wikipedia.org/wiki/:en:List_of_engineering_topics "wikilink")
  - [Automotive
    aerodynamics](https://zh.wikipedia.org/wiki/:en:Automotive_aerodynamics "wikilink")
  ...
  - [Nose cone
    design](https://zh.wikipedia.org/wiki/:en:Nose_cone_design "wikilink")
  - [伯努利定律](../Page/伯努利定律.md "wikilink")
  - [纳维-斯托克斯方程](../Page/纳维-斯托克斯方程.md "wikilink")
  - [Center of
    pressure](https://zh.wikipedia.org/wiki/:en:Center_of_pressure "wikilink")

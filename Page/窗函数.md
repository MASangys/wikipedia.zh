在[信号处理中](../Page/信号处理.md "wikilink")，**窗函数**（）是一种除在给定[区间之外取值均为](../Page/区间.md "wikilink")0的实[函数](../Page/函数.md "wikilink")。譬如：在给定区间内为[常数而在区间外为](../Page/常数.md "wikilink")0的窗函数被形象地称为**矩形窗**。**任何函数与窗函数之积仍为窗函数，**所以相乘的结果就像透过窗口“看”其他函数一样。窗函数在[頻譜分析](../Page/頻譜分析.md "wikilink")、[滤波器设计](../Page/滤波器设计.md "wikilink")、波束形成、以及音频数据压缩（如在[Ogg
Vorbis音频格式中](../Page/Ogg_Vorbis.md "wikilink")）等方面有广泛的应用。'''

## 频谱分析

从理论上可以得出函数 \(\cos(\omega t)\,\)
的[傅立叶变换除了在频率](../Page/傅立叶变换.md "wikilink")
\(\pm \omega\,\) 之外处处为
...
在[信號處理中](../Page/信號處理.md "wikilink")，透過某些操作，可以利用信號和噪聲之間性質的差異，來提高信號某些方面的品質。當某個正弦信號隨機地疊加的破壞性噪聲，頻譜分析能區別的信號與噪聲的分量，往往能使檢測信號的某些特性更容易，如測量振幅和頻率。比如說，若將大多數的正弦信號能量集中於一個頻率附近，並將噪聲均勻分布，能有效的改善[信噪比](../Page/信噪比.md "wikilink")（）。**處理增益**通常用來描述SNR改善的程度。頻譜分析的處理增益取決於窗函數的**噪聲頻寬（B）**和潛在的**扇形損失**。這些效果可能部分抵消，因為窗函數有最少的扇形自然有最大的滲漏。
...
在一些應用中，最好不使用窗函數。例如：
  ...
  - 在衝擊模型測試中，當分析[暫態信號](../Page/暫態.md "wikilink")，如重錘打擊產生的激發信號（**脈衝激發技術**）時，大部分能量位於記錄的開頭。若使用非矩形的窗，會無謂的減弱大部分能量和傳播[頻率響應](../Page/頻率響應.md "wikilink")。
  - 上述的一種推廣，當測量[自窗口信號](../Page/自窗口信號.md "wikilink")，如[脈衝](../Page/脈衝.md "wikilink")，[衝擊響應](../Page/衝擊響應.md "wikilink")，正弦[叢發](../Page/叢發.md "wikilink")，連續變頻叢發，噪聲叢發時，這樣的信號使用模態分析。在這種情況下應用窗函數只會惡化信噪比。

<!-- end list -->

  - 測量一個週期T的[虛擬隨機噪聲](../Page/虛擬隨機噪聲.md "wikilink")（PRN）激發信號，​​並使用相同的記錄週期T時。PRN信號是週期性的，因此，該信號的所有頻譜分量將會與FFT區間中心重合而無洩漏。
...
<!-- end list -->
  ...
  - 在[正交分頻多工](../Page/正交分頻多工.md "wikilink")(OFDM)接收器中，輸入信號不經窗函數，被直接乘以FFT。的頻率子載波（也稱為符號）被設計為恰好對齊FFT頻率區間。一個Cyclic
    prefix通常添加到所傳輸的信號，使得肇因於[多徑的](../Page/多徑.md "wikilink")[頻率](../Page/頻率.md "wikilink")[選擇性衰落可用](../Page/選擇性衰落.md "wikilink")[圓周摺積模擬](../Page/圓周摺積.md "wikilink")，從而避免了在OFDM中相當於[頻譜洩漏的](../Page/頻譜洩漏.md "wikilink")[符號間干擾](../Page/符號間干擾.md "wikilink")。
...
[Hann窗有时也称为](../Page/Hann窗.md "wikilink") "Hanning" 窗（“汉宁窗”），以与 Hamming
窗的名稱類似。但是这是不對的，因为这兩个窗是分别根據 [Julius von
Hann](../Page/Julius_von_Hann.md "wikilink") 和 [Richard
Hamming](../Page/Richard_Hamming.md "wikilink") 的名字命名的。
Hann窗又称升餘弦窗。Hann窗可以看作是3个矩形时间窗的頻譜之和，或者说是 3个 sinc(t)

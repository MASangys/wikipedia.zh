...
IIFEs are also useful for establishing private methods for accessible functions while still exposing some properties for later use.\[16\] The following example comes from Alman's post on IIFEs.\[17\]
...
"Immediately-invoked function expression" as a term describes a design pattern which has also been referred to as a "self-executing anonymous function."\[18\]\[19\] However, immediately-invoked functions need not be anonymous and [ECMAScript](../Page/ECMAScript.md "wikilink") 5's strict mode forbids `arguments.callee`,\[20\] making the latter term less accurate.\[21\]\[22\]

In lambda-calculus, this construct was referred to as "redex", for reducible expression, see [Reduction strategy (code optimization)](https://zh.wikipedia.org/wiki/Reduction_strategy_\(code_optimization\) "wikilink").

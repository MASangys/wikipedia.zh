...
**立方和**是數學公式的一種，它屬於[因式分解](../Page/因式分解.md "wikilink")、[乘法公式](../Page/乘法公式.md "wikilink")及[恆等式](https://zh.wikipedia.org/wiki/恆等式 "wikilink")，被普遍使用。立方和是指一個[立方數](../Page/立方數.md "wikilink")，加上另一個立方數，即是它們的總和。公式如下：\[1\]
...
\[=(x + y) \left[ (x + y)^2 - 3xy \right] \,\!\]
\((x + y)^2\)可透過[和平方](../Page/和平方.md "wikilink")公式，得到：

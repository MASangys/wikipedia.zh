**端到端加密** (**End-to-end encryption**，**E2EE**)是一个只有参与通讯的用户可以读取信息的[通信系统](../Page/数据传输.md "wikilink")。总的来说，它可以防止潜在的窃听者——包括 电信供应商、[互联网服务供应商](../Page/互联网服务供应商.md "wikilink")甚至是该通讯系统的提供者——获取能够用以[解密通讯的](https://zh.wikipedia.org/wiki/加密 "wikilink")[密钥](../Page/密钥.md "wikilink")。\[1\] 此类系统被设计为可以防止潜在的[监视](../Page/監視.md "wikilink") 或篡改企图，因为没有密钥的第三方难以破译系统中传输或储存的数据。 举例来说，使用端到端加密的通讯提供商，将无法将其客户的通讯数据提供给当局。\[2\]
...
一些非E2EE的通讯系统，例如[拉维毕特和](https://zh.wikipedia.org/wiki/拉维毕特 "wikilink") Hushmail宣称提供了"端到端"的加密，但实际上并没有。\[6\] 而另一些系统，例如 [Telegram](../Page/Telegram.md "wikilink") 和 [谷歌Allo](../Page/Google_Allo.md "wikilink")，由于没有默认启用端到端加密而受到了批评。\[7\]\[8\]

一些加密的[文件备份和](../Page/备份.md "wikilink")[文件共享服务提供](../Page/檔案分享.md "wikilink") 客户端加密。但这并不能称作端到端加密，因为此类服务并不是用来在用户之间交换信息的。 但在很多场合，这两个术语经常被混用。

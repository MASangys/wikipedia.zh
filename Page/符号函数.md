**符號函數**（**Sign
function**，簡稱**sgn**）是一個[邏輯函數](https://zh.wikipedia.org/wiki/邏輯 "wikilink")，用以判斷[實數的正](https://zh.wikipedia.org/wiki/實數 "wikilink")[負號](https://zh.wikipedia.org/wiki/負數 "wikilink")。為避免和英文讀音相似的[正弦函數](https://zh.wikipedia.org/wiki/正弦函數 "wikilink")（sine）混淆，它亦稱為**Signum
function**。其定義為：
...
0以外。复数*z*的符号函数，是[复平面上中心为](../Page/复平面.md "wikilink")[原点的](https://zh.wikipedia.org/wiki/原点 "wikilink")[单位圆上距离](../Page/单位圆.md "wikilink")*z*最近的点。那么，对于*z*
≠ 0，有：

\[\sgn z = \exp(i\arg z)\,,\]
其中arg表示[辐角](https://zh.wikipedia.org/wiki/辐角 "wikilink")。

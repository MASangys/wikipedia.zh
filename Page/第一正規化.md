**第一正規化**（1NF，中國譯作「-{zh;zh-hant;zh-hans|第一范式}-」、臺灣及香港譯作「-{zh;zh-hant;zh-hans|第一正規化}-」）是[資料庫正規化中所使用的一種](../Page/資料庫正規化.md "wikilink")[正規形式](../Page/正規形式.md "wikilink")。第一正規化是為了要排除
*重複群*
...
大多數的 [RDBMS](../Page/RDBMS.md "wikilink") (關聯式資料庫)
...
.281NF.29](../Page/de:Normalisierung_\(Datenbank\)#Erste_Normalform_.281NF.29.md "wikilink")

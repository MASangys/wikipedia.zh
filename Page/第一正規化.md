**第一正規化**（1NF，中國譯作「-{zh;zh-hant;zh-hans|第一范式}-」、臺灣及香港譯作「-{zh;zh-hant;zh-hans|第一正規化}-」）是[資料庫正規化中所使用的一種](https://zh.wikipedia.org/wiki/資料庫正規化 "wikilink")[正規形式](https://zh.wikipedia.org/wiki/正規形式 "wikilink")。第一正規化是為了要排除
*重複群*
...
大多數的 [RDBMS](https://zh.wikipedia.org/wiki/RDBMS "wikilink") (關聯式資料庫)
允許使用者在定義資料表的時候不去指定主鍵，不過這麼一來這種資料表就不符合第一正規化了。
...
## 参见
  ...
  - [system](https://en.wikipedia.org/wiki/Attribute-value_system%5BAttribute-value)\]

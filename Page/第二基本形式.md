...
这里 \(\nabla_v w\) 表示周围空间的[共变导数](https://zh.wikipedia.org/wiki/共变导数 "wikilink")，*n* 超曲面上一个法向量场。如果[仿射联络是](https://zh.wikipedia.org/wiki/仿射联络 "wikilink")[无挠的](https://zh.wikipedia.org/wiki/挠率张量 "wikilink")，则第二基本形式是对称的。

**第二层隧道协议**（，縮寫為L2TP)是一种[虚拟隧道协议](https://zh.wikipedia.org/wiki/虚拟隧道协议 "wikilink")，通常用于[虚拟专用网](https://zh.wikipedia.org/wiki/虚拟专用网 "wikilink")。L2TP协议自身不提供[加密與可靠性驗證的功能](https://zh.wikipedia.org/wiki/加密 "wikilink")，可以和[安全协议](../Page/安全协议.md "wikilink")搭配使用，从而实现数据的加密传输。经常与L2TP协议搭配的加密协议是[IPsec](../Page/IPsec.md "wikilink")，当这两个协议搭配使用时，通常合称L2TP/IPsec。

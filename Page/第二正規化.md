**第二正規化**（2NF，大陸譯作「-{zh;zh-hant;zh-hans|第二范式}-」、臺灣及香港譯作「-{zh;zh-hant;zh-hans|第二正規化}-」）是[資料庫正規化中所使用的一種](../Page/資料庫正規化.md "wikilink")[正規形式](../Page/正規形式.md "wikilink")。它的規則是要求資料表裡的所有資料都要和該資料表的[鍵](../Page/關係鍵.md "wikilink")（主键与候选键）有[完全依赖关系](../Page/依赖关系.md "wikilink")：每个非键属性必须独立于任意一个候选键的任意一部分属性。如果有哪些資料只和一个鍵的一部份有關的話，就得把它們獨立出來變成另一個資料表。如果一個資料表的键只有單個欄位的話，它就一定符合第二正規化。

一個資料表符合第二正規化[若且唯若](../Page/若且唯若.md "wikilink")
...
接下來的步驟是要確保所有不是鍵的欄位都和彼此沒有相依關係，這就叫做[第三正規化](../Page/第三正規化.md "wikilink")。
...
(2NF)](../Page/de:Normalisierung_\(Datenbank\)#Zweite_Normalform_\(2NF\).md "wikilink")

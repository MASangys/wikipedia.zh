在[数学中](../Page/数学.md "wikilink")，假設在一个[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")\(X\)上定義一个[等价关系](../Page/等价关系.md "wikilink")（用\(\sim\)來表示），则\(X\)中的某個元素\(a\)的**等价类**就是在\(X\)中等价于\(a\)的所有元素所形成的[子集](../Page/子集.md "wikilink"):
...
对于任何等价关系，都有从\(X\)到\(X / \mathrm{\sim}\)的一个**规范投影映射**\(\pi\)，给出为\(\pi(x) = [x]\)。这个映射总是[满射的](../Page/满射.md "wikilink")。在\(X\)有某种额外结构的情况下，考虑保持这个结构的等价关系，接着称这个结构是[良好定义的](https://zh.wikipedia.org/wiki/良好定义 "wikilink")，而商集在自然方式下继承了这个结构而成为同一个[范畴的对象](https://zh.wikipedia.org/wiki/范畴论_\(数学\) "wikilink")；从\(a\)到\([a]\)的[映射则是在这个范畴内的](https://zh.wikipedia.org/wiki/映射 "wikilink")[满态射](../Page/态射.md "wikilink")。参见[同余关系](https://zh.wikipedia.org/wiki/同余关系 "wikilink")。
...
## 例子
  ...
  - 考虑在整数集合\(\mathbb{Z}\)上的“[模](../Page/模.md "wikilink")\(2\)”
    ...
    \(x \sim y\)当且仅当\(x - y\)是[偶数](https://zh.wikipedia.org/wiki/偶数 "wikilink")。这个关系精确的引发两个等价类:
...
<!-- end list -->
  ...
  - 任何[函数](../Page/函数.md "wikilink")\(f: X \rightarrow Y\)定义在X上的等价关系，通过\(x_{1} \sim x_{2}\)
    [当且仅当](../Page/当且仅当.md "wikilink")\(f(x_{1}) = f(x_{2})\)。\(x\)的等价类是在\(X\)中被映射到\(f(x)\)的所有元素的集合，就是说，类\([x]\)是\(f(x)\)的[逆像](https://zh.wikipedia.org/wiki/像 "wikilink")。这个等价关系叫做\(f\)的[核](https://zh.wikipedia.org/wiki/函数的核 "wikilink")。

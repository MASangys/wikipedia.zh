**等周定理**，又稱**等周不等式**，是一个几何中的不等式定理，说明了欧几里得平面上的封闭图形的周长以及其面积之间的关系。其中的“等周”指的是周界的长度相等。等周定理說明在[周界长度相等的封闭几何](https://zh.wikipedia.org/wiki/周界 "wikilink")[形狀之中](../Page/形狀.md "wikilink")，以[圓形的](https://zh.wikipedia.org/wiki/圓 "wikilink")[面積最大](https://zh.wikipedia.org/wiki/面積 "wikilink")；另一個說法是面積相等的几何形狀之中，以圓形的周界长度最小。這兩種說法是等價的。它可以以[不等式表達](https://zh.wikipedia.org/wiki/不等式 "wikilink")：若\(P\)為封闭[曲線的周界长](https://zh.wikipedia.org/wiki/曲線 "wikilink")，\(A\)為曲線所包圍的區域面積，\(4 \pi A \le P^2\)。
...
[Isoperimetric_inequality_illustr1.svg](https://zh.wikipedia.org/wiki/File:Isoperimetric_inequality_illustr1.svg "fig:Isoperimetric_inequality_illustr1.svg")的封閉曲線的話，能以「翻折」[凹的部分以成為凸的圖形](https://zh.wikipedia.org/wiki/凹 "wikilink")，以增加面積，而周长不变\]\]
...
1901年，[赫爾維茨憑](https://zh.wikipedia.org/wiki/赫爾維茨 "wikilink")[傅里叶级数和](../Page/傅里叶级数.md "wikilink")[格林定理給出一個純解析的證明](https://zh.wikipedia.org/wiki/格林定理 "wikilink")。

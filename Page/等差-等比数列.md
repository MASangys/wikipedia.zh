在[数学上](../Page/数学.md "wikilink")，**等差-等比数列**(**arithmetico-geometric
sequence**)是一个[等差数列与一个](../Page/等差数列.md "wikilink")[等比数列相乘的积](../Page/等比数列.md "wikilink")。
...
则是[等差数列的项](../Page/等差数列.md "wikilink")，其首项為\(a\)，公差\(d\)。
...
在中间的项中使用[等比数列的求和公式](../Page/等比数列.md "wikilink")。最后左右两边同除以(1 −
*r*)，得到最终结果。
...
如果*r*在上述范围之外，则该级数不是[发散级数就是](../Page/发散级数.md "wikilink")[交错级数](https://zh.wikipedia.org/wiki/交错级数 "wikilink")。

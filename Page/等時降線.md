[_Tautochrone_curve.gif](https://zh.wikipedia.org/wiki/File:_Tautochrone_curve.gif "fig:_Tautochrone_curve.gif")
**等時降線**（或）是一種[曲線](https://zh.wikipedia.org/wiki/曲線 "wikilink")，將一質點放置在此曲線上任一點使其自由下滑（不計阻力）至最低點所需的時間皆相等。此曲線的解是[擺線](https://zh.wikipedia.org/wiki/擺線 "wikilink")，而下滑所需的時間與擺線繞轉圓的半徑平方根成正比，與[重力場強度的平方根成反比](https://zh.wikipedia.org/wiki/重力場 "wikilink")。

## 等時降落問題

等時降落問題（）即為尋找等時降線的問題。等時降落問題最早由[惠更斯解出](https://zh.wikipedia.org/wiki/惠更斯 "wikilink")。在他1673年出版的著作裡，利用了幾何的方法證明了此線的解為一擺線，而此問題後來也被利用來解決最速降線問題1690年，[伯努利用](https://zh.wikipedia.org/wiki/伯努利 "wikilink")[微積分推導出了](https://zh.wikipedia.org/wiki/微積分 "wikilink")[最速降線問題的解亦為擺線](../Page/最速降線問題.md "wikilink")。不久以後，[拉格朗日與](https://zh.wikipedia.org/wiki/拉格朗日 "wikilink")[歐拉也運用了解析法解出了等時降落問題](https://zh.wikipedia.org/wiki/歐拉 "wikilink")。

## 解析

將質點放在一曲線上，則質點下滑的時間與最低點和釋放點之間的長度無關。[簡諧運動也具有類似的性質](../Page/簡諧運動.md "wikilink")。如果一個質點只受到一個定點方向，與兩點間距離成正比的力作用，則此物體自由釋放後將會做簡諧運動，且無論釋放點的位置，此質點作簡諧運動的週期皆相同。故我們可以假設在等時降線上運動的物體與作簡諧運動的物體有相似的行為，即
...
## 參考
  ...
  -
[de:Zykloide\#Die Tautochronie der
Zykloide](https://zh.wikipedia.org/wiki/de:Zykloide#Die_Tautochronie_der_Zykloide "wikilink")

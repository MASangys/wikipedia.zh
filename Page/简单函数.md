...
嚴格的講，一个简单函数是[可测集合的](https://zh.wikipedia.org/wiki/可测集合 "wikilink")[指示函数](../Page/指示函数.md "wikilink")的有限[线性组合](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。更加精确地，设(*X*, Σ)为[可测空间](https://zh.wikipedia.org/wiki/σ代数 "wikilink")。设*A*<sub>1</sub>，……，*A*<sub>*n*</sub> ∈ Σ 皆为可测集合，并设*a*<sub>1</sub>，……，*a*<sub>*n*</sub> 皆为[实数](../Page/实数.md "wikilink")或[复数](https://zh.wikipedia.org/wiki/复数 "wikilink")。简单函数是以下形式的函数：

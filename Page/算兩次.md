在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，**算兩次**是一個常用的[證明技巧](https://zh.wikipedia.org/wiki/證明#常見的證明技巧 "wikilink")，常在證明[恆等式時被提到](https://zh.wikipedia.org/wiki/恆等式 "wikilink")。其思想是，對一個具體的量用方法甲來計算，得到的答案是A，而用方法乙則得到B，那麼等式A
=

**算术-几何平均值不等式**，簡稱**算几不等式**，是一个常见而基本的[不等式](https://zh.wikipedia.org/wiki/不等式 "wikilink")，表现了[算术平均数和](https://zh.wikipedia.org/wiki/算术平均数 "wikilink")[几何平均数之间恒定的不等关系](../Page/几何平均数.md "wikilink")。设\(x_1,x_2, \ldots, x_n\)为
\(n\)
个正[实数](../Page/实数.md "wikilink")，它们的**[算术平均数](https://zh.wikipedia.org/wiki/算术平均数 "wikilink")**是\(\mathbf{A}_n =  \frac{x_1 + x_2 + \cdots + x_n}{n}\)，它们的**[几何平均数](../Page/几何平均数.md "wikilink")**是
...
\(n\)，不等式并不容易证明。1729年，[英国](https://zh.wikipedia.org/wiki/英国 "wikilink")[数学家](../Page/数学家.md "wikilink")[麦克劳林最早给出了一般情况的证明](https://zh.wikipedia.org/wiki/麦克劳林 "wikilink")，用的是[调整法](https://zh.wikipedia.org/wiki/调整法 "wikilink")，然而这个证明并不严谨，是错误的。

### 柯西的证明

1821年，法国数学家[柯西在他的著作](https://zh.wikipedia.org/wiki/柯西 "wikilink")《[分析教程](https://zh.wikipedia.org/wiki/分析教程 "wikilink")》中给出了一个使用**[逆向归纳法](../Page/数学归纳法.md "wikilink")**的证明\[1\]：
...
\(b_1  = \frac{{c_1 }}{{c_2 }},b_2  = \frac{{c_2 }}{{c_3 }},\cdots,b_n  = \frac{{c_n }}{{c_1 }}\)，运用[排序不等式得到](https://zh.wikipedia.org/wiki/排序不等式 "wikilink")：

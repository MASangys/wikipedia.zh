**算术-几何平均值不等式**，簡稱**算几不等式**，是一个常见而基本的[不等式](https://zh.wikipedia.org/wiki/不等式 "wikilink")，表现[算术平均数和](https://zh.wikipedia.org/wiki/算术平均数 "wikilink")[几何平均数](../Page/几何平均数.md "wikilink")之间恒定的不等关系。设\(x_1,x_2, \ldots, x_n\)为
\(n\)
...
\(n\)，不等式并不容易证明。1729年，[英国](https://zh.wikipedia.org/wiki/英国 "wikilink")[数学家](../Page/数学家.md "wikilink")[麦克劳林最早给出一般情况的证明](https://zh.wikipedia.org/wiki/麦克劳林 "wikilink")，用的是[调整法](https://zh.wikipedia.org/wiki/调整法 "wikilink")，然而这个证明并不严谨，是错误的。
...
算术-几何平均不等式可以看成是一维[向量](../Page/向量.md "wikilink")的系数的平均数不等式。对于二维的矩阵，一样有类似的不等式：
对于系数都是正实数的矩阵

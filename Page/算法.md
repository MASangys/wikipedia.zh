...
形式化算法的概念部分源自尝试解决[希尔伯特提出的](../Page/大卫·希尔伯特.md "wikilink")[判定问题](https://zh.wikipedia.org/wiki/可判定性 "wikilink")，並在其后尝试定义\[10\]或者\[11\]中成形。这些尝试包括[库尔特·哥德尔](../Page/库尔特·哥德尔.md "wikilink")、[雅克·埃尔布朗和](../Page/雅克·埃尔布朗.md "wikilink")[斯蒂芬·科尔·克莱尼分别于](../Page/斯蒂芬·科尔·克莱尼.md "wikilink")1930年、1934年和1935年提出的[遞歸函數](https://zh.wikipedia.org/wiki/遞歸_\(計算機科學\) "wikilink")，[阿隆佐·邱奇於](../Page/阿隆佐·邱奇.md "wikilink")1936年提出的[λ演算](https://zh.wikipedia.org/wiki/λ演算 "wikilink")，1936年的[Formulation
...
算法是计算机处理信息的本质，因为计算机程序本质上是一个算法来告诉计算机确切的步骤来执行一个指定的任务，如计算职工的薪水或打印学生的成绩单。一般地，当算法在处理信息时，会从[输入设备或数据的存储地址读取数据](https://zh.wikipedia.org/wiki/输入设备 "wikilink")，把结果写入[输出设备或某个存储地址供以后再调用](../Page/输出设备.md "wikilink")。

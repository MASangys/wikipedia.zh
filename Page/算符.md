...
其中，\(I\)是「單位算符」──變換[群的](../Page/群.md "wikilink")[單位元](../Page/單位元.md "wikilink")，\(\epsilon\)是微小參數，\(A\)是專門用來設定平移變換[群的](../Page/群.md "wikilink")[生成元](https://zh.wikipedia.org/wiki/生成元 "wikilink")。
...
物理算符的數學性質是很重要的研讀論題。更多相關內容，請參閱條目[C\*-代数與](../Page/C*-代数.md "wikilink")[蓋爾范德-奈馬克定理](https://zh.wikipedia.org/wiki/蓋爾范德-奈馬克定理 "wikilink")（Gelfand-Naimark
theorem）。

## 量子力學

在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，算符的功能被發揮得淋漓盡致。量子力學的數學表述建立於算符的概念。量子系統的[量子態可以用](../Page/量子態.md "wikilink")[態向量設定](../Page/態向量.md "wikilink")，態向量是[向量空間的](https://zh.wikipedia.org/wiki/向量空間 "wikilink")[單位範數](https://zh.wikipedia.org/wiki/範數 "wikilink")[向量](../Page/向量.md "wikilink")。在向量空間內，量子算符作用於量子態，使它變換成另一個量子態。由於物體的態向量[範數應該保持不變](https://zh.wikipedia.org/wiki/範數 "wikilink")，量子算符必須是[么正算符](https://zh.wikipedia.org/wiki/么正算符 "wikilink")。假若變換前的量子態與變換後的量子態，除了乘法數值以外，兩個量子態相同，則稱此量子態為[本徵態](https://zh.wikipedia.org/wiki/本徵態 "wikilink")，稱此乘法數值為[本徵值](https://zh.wikipedia.org/wiki/本徵值 "wikilink")。\[1\]

物理實驗中可以觀測到的[物理量稱為](../Page/物理量.md "wikilink")[可觀察量](../Page/可觀察量.md "wikilink")。每一個可觀察量，都有其對應的算符。可觀察量的算符也許會有很多本徵值與本徵態。根據[統計詮釋](https://zh.wikipedia.org/wiki/統計詮釋 "wikilink")，每一次測量的結果只能是其中的一個本徵值，而且，測得這本徵值的機會呈機率性，量子系統的量子態也會改變為對應於本徵值的本徵態。\[2\]
...
\end{align}\)
|電磁場（\(\mathbf{A}\)是[磁向量勢](https://zh.wikipedia.org/wiki/磁向量勢 "wikilink")）

\(\mathbf{\hat{p}} = -i \hbar \nabla - q\mathbf{A}\) |-valign="top"
\!rowspan="3"| [動能算符](https://zh.wikipedia.org/wiki/動能 "wikilink") |
平移運動
...
總[能量算符](https://zh.wikipedia.org/wiki/能量算符 "wikilink") |N/A
|含時位勢：
\(\hat{E} = i \hbar \frac{\partial }{\partial t}\)

不含時位勢：
\(\hat{E} = E\) |-valign="top" \!
[哈密頓算符](https://zh.wikipedia.org/wiki/哈密頓算符 "wikilink") |N/A
...
|-valign="top" \! [自旋算符](https://zh.wikipedia.org/wiki/自旋算符 "wikilink")
...
是[自旋1/2粒子的](https://zh.wikipedia.org/wiki/自旋1/2 "wikilink")[包立矩陣](https://zh.wikipedia.org/wiki/包立矩陣 "wikilink")。
...
\end{align}\) |-valign="top" \!
[躍遷矩](https://zh.wikipedia.org/wiki/躍遷矩 "wikilink")（電）
...
Physik](https://zh.wikipedia.org/wiki/de:Operator_\(Mathematik\)#Operatoren_der_Physik "wikilink")

**类成员函数指针**（member function pointer），是C++语言的一类指针数据类型，用于存储一个指定[类具有给定的形参列表与返回值类型的成员函数的访问信息](../Page/类_\(计算机科学\).md "wikilink")。
...
1.  ["Inheritance Keywords" in MSDN](http://msdn.microsoft.com/en-us/library/ck561bfk.aspx)
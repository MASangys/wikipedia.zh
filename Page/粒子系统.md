...
每个粒子系统都有用于其中每个粒子的特定规则，通常这些规则涉及到粒子生命周期的[插值过程](../Page/插值.md "wikilink")。例如，许多系统在粒子生命周期中对粒子的[阿尔法值即透明性进行插值直到粒子湮灭](https://zh.wikipedia.org/wiki/阿尔法通道 "wikilink")。
...
Max](https://zh.wikipedia.org/wiki/3D_Studio_Max "wikilink")、[Maya](../Page/Maya.md "wikilink")
以及 [Blender](../Page/Blender.md "wikilink")
等。这些编辑程序使艺术家能够立即看到他们设定的特性或者规则下粒子系统的表现，另外还有一些[插件能够提供增强的粒子系统效果](../Page/插件.md "wikilink")，例如
[AfterBurn](https://zh.wikipedia.org/wiki/AfterBurn "wikilink") 以及用于流体的
[RealFlow](https://zh.wikipedia.org/wiki/RealFlow "wikilink")。而2D的粒子特效軟體中[particleIllusion最為出色](https://zh.wikipedia.org/wiki/particleIllusion "wikilink")，因為他的渲染比一般的3D軟體快較為平面化。[Combustion](https://zh.wikipedia.org/wiki/Autodesk_Media_and_Entertainment#Combustion "wikilink")
...
## 外部链接
  ...
  - [Particle Systems: A Technique for Modeling a Class of Fuzzy
    ...
    Graphics](https://zh.wikipedia.org/wiki/ACM_Transactions_on_Graphics "wikilink"),
    April 1983)

**粘土游戏引擎**（KlayGE）是一个[开放源代码的](../Page/开放源代码.md "wikilink")，[跨平台的](https://zh.wikipedia.org/wiki/跨平台 "wikilink")，基于插件结构的[游戏引擎](../Page/游戏引擎.md "wikilink")。该引擎从2003年开始研发，设计目的是用最先进的技术武装引擎，使游戏的[开发](https://zh.wikipedia.org/wiki/软件开发 "wikilink")、[测试](https://zh.wikipedia.org/wiki/测试 "wikilink")、[移植得到简化](https://zh.wikipedia.org/wiki/遊戲移植 "wikilink")。

## 协议

KlayGE按照[GPL](https://zh.wikipedia.org/wiki/GPL "wikilink")
...
### 图形
  ...
  - 支持[PN
    Triangles技术](https://zh.wikipedia.org/wiki/PN_Triangles "wikilink")，在运行期自动光滑低模
  - 着色
...
### 工具
  ...
  - OpenGL兼容性检测工具
  - [HDR压缩器](https://zh.wikipedia.org/wiki/HDR "wikilink")，支持[cubemap和](https://zh.wikipedia.org/wiki/:en:Cube_mapping "wikilink")2D
    HDR[纹理的压缩](https://zh.wikipedia.org/wiki/纹理 "wikilink")
...
### 程序特性
  ...
  - [KlayGE是](https://zh.wikipedia.org/wiki/KlayGE "wikilink")[开放源代码的](../Page/开放源代码.md "wikilink")，包含了100%的引擎、工具的源代码。

...
## 提升中央處理器性能的方法
  ...
  - 加入其它功能，如I/O和計時器
  - 加入向量處理器（[SIMD](https://zh.wikipedia.org/wiki/SIMD "wikilink")），如[VIS](https://zh.wikipedia.org/wiki/VIS "wikilink")[AltiVec](https://zh.wikipedia.org/wiki/AltiVec "wikilink")、[SSE](../Page/SSE.md "wikilink")（Streaming SIMD Extensions）

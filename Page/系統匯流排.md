...
為了提供更多低成本的模組化元件，記憶體與輸入輸出匯流排（和所需的控制與電力匯流排）有時會被組合成單獨一體的系統匯流排。\[4\]電腦要小到可以塞進一個櫃子中，模組化與成本就變得很重要（就如同顧客對於降價的期待）。[迪吉多](../Page/迪吉多.md "wikilink")使用大量生產[迷你電腦來進一步降低成本](https://zh.wikipedia.org/wiki/迷你電腦 "wikilink")，將[存儲器映射輸入輸出放入記憶體匯流排](https://zh.wikipedia.org/wiki/存儲器映射輸入輸出 "wikilink")，如此一來，裝置就可以對應到記憶體中的位置。在大約1969年時，這被實現在[PDP-11](../Page/PDP-11.md "wikilink")的中，排除了分離式輸入輸出匯流排的需求。\[5\]即使電腦沒有存儲器映射輸入輸出，如[PDP-8](https://zh.wikipedia.org/wiki/PDP-8 "wikilink")，也很快的與系統匯流排被實現出來，也允許模組被插入任意的插槽中。\[6\]一些作者聲稱這是新式流線型電腦架構的樣式。\[7\]許多早期的微電腦（一般有著單獨一顆積體電路型式的中央處理器）擁有單一的系統匯流排被建造出來，起始於大約1975年的[Altair
...
standard
796。\[9\]於1989年，[昇陽電腦](../Page/昇陽電腦.md "wikilink")開發用來支援更小的擴充卡。\[10\]實現[對稱多處理的最容易的方式是插入更多的中央處理器於共享的系統匯流排上](https://zh.wikipedia.org/wiki/對稱多處理 "wikilink")，這個方法被使用於1980年代。然而，共享匯流排很快的就變成瓶頸所在，並且有更多更複雜的連接技術被探索。\[11\]
...
主要匯流排的作用是在中央處理器、主記憶體、輸入輸出裝置間溝通資料，被稱為[前端匯流排](https://zh.wikipedia.org/wiki/前端匯流排 "wikilink")，而[後端匯流排則是用來存取第二階快取](https://zh.wikipedia.org/wiki/後端匯流排 "wikilink")。現代的個人及伺服電腦使用高效率的內部連接技術，如[HyperTransport](../Page/HyperTransport.md "wikilink")和[Intel
QuickPath

...
系统關係图也可以用許多不同的圖案來表示外部的實體，可能是[卵形](https://zh.wikipedia.org/wiki/卵形 "wikilink")、[简笔人物画](../Page/简笔人物画.md "wikilink")、[图像](https://zh.wikipedia.org/wiki/图像 "wikilink")、[美工圖案](../Page/美工圖案.md "wikilink")等圖案來表示其意義。決策樹和資料儲存一般會用在。

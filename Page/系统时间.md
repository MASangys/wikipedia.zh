...
[计算机科学与](../Page/计算机科学.md "wikilink")[计算机编程中](https://zh.wikipedia.org/wiki/计算机编程 "wikilink"),
**系统时间**表示在计算机系统中的时间与日期。通常用**系统时钟**（system clock）从某个的嘀嗒数（number of
ticks）。例如，[类Unix系统采用](../Page/类Unix系统.md "wikilink")[世界标准时](https://zh.wikipedia.org/wiki/世界标准时 "wikilink")1970年1月1日00:00:00开始的秒数（不考虑[闰秒](../Page/闰秒.md "wikilink")）作为[UNIX时间](../Page/UNIX时间.md "wikilink")。[Windows
API使用](../Page/Windows_API.md "wikilink")`SYSTEMTIME`表示年月日时分秒毫秒；使用`FILETIME`表示自世界标准时1601年1月1日00:00:00开始的100[纳秒为单位的时钟嘀嗒数](https://zh.wikipedia.org/wiki/纳秒 "wikilink")。
...
1.  Ralf Brown, "Int 0x1A, AH=0x00" in [Ralf Brown's Interrupt
    List](https://zh.wikipedia.org/wiki/Ralf_Brown's_Interrupt_List "wikilink"),
    2000, <http://www.delorie.com/djgpp/doc/rbinter/ix/1A/00.html>

2.  Ralf Brown, "Int 0x1A, AH=0x02" in [Ralf Brown's Interrupt
    List](https://zh.wikipedia.org/wiki/Ralf_Brown's_Interrupt_List "wikilink"),
    2000, <http://www.delorie.com/djgpp/doc/rbinter/ix/1A/02.html>

3.  Ralf Brown, "Int 0x1A, AH=0x04" in [Ralf Brown's Interrupt
    List](https://zh.wikipedia.org/wiki/Ralf_Brown's_Interrupt_List "wikilink"),
    2000, <http://www.delorie.com/djgpp/doc/rbinter/ix/1A/04.html>
...
6.  Ralf Brown, "Int 0x21, AH=0x2c" in [Ralf Brown's Interrupt
    List](https://zh.wikipedia.org/wiki/Ralf_Brown's_Interrupt_List "wikilink"),
    2000, <http://www.delorie.com/djgpp/doc/rbinter/ix/21/2C.html>

7.  Ralf Brown, "Int 0x21, AH=0x2a" in [Ralf Brown's Interrupt
    List](https://zh.wikipedia.org/wiki/Ralf_Brown's_Interrupt_List "wikilink"),
    2000, <http://www.delorie.com/djgpp/doc/rbinter/ix/21/2A.html>
...
22. ["DateTime.Now
    ...
    in *[MSDN](https://zh.wikipedia.org/wiki/MSDN "wikilink")*
    (Microsoft, 2010) last updated July 2010.

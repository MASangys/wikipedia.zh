...
其中，一次方項、[平方項及](../Page/平方.md "wikilink")[立方項之和的公式如下](https://zh.wikipedia.org/wiki/立方 "wikilink")︰
...
其中，前幾項為︰
  ...
  - \(\zeta(2)=\sum^{\infty}_{k=1} \frac{1}{k^2}=\frac{\pi^2}{6}\)
...
### 指數函數
  ...
  - \(\sum_{k=0}^\infty k\frac{z^k}{k!} = z e^z\)
    （參見[Poisson分佈的](https://zh.wikipedia.org/wiki/Poisson分佈 "wikilink")[數學期望](https://zh.wikipedia.org/wiki/數學期望 "wikilink")）
  - \(\sum_{k=0}^\infty k^2 \frac{z^k}{k!} = (z + z^2) e^z\)
    （參見[Poisson分佈的](https://zh.wikipedia.org/wiki/Poisson分佈 "wikilink")[二階矩](https://zh.wikipedia.org/wiki/矩 "wikilink")）
...
### [二項式係數](../Page/二項式係數.md "wikilink")
  ...
  - \((1+z)^\alpha = \sum_{k=0}^\infty {\alpha \choose k} z^k, |z|<1\)
    （參見[二項式定理](https://zh.wikipedia.org/wiki/二項式定理 "wikilink")）
  - \[4\]
    \(\sum_{k=0}^\infty {{\alpha+k-1} \choose k} z^k = \frac{1}{(1-z)^\alpha}, |z|<1\)
  - \[5\]
    \(\sum_{k=0}^\infty \frac{1}{k+1}{2k \choose k} z^k = \frac{1-\sqrt{1-4z}}{2z}, |z|\leq\frac{1}{4}\)（[卡塔蘭數的](https://zh.wikipedia.org/wiki/卡塔蘭數 "wikilink")[母函數](https://zh.wikipedia.org/wiki/母函數 "wikilink")）
  - \[6\]
    \(\sum_{k=0}^\infty {2k \choose k} z^k = \frac{1}{\sqrt{1-4z}}, |z|<\frac{1}{4}\)（[中心二項式係數的](https://zh.wikipedia.org/wiki/中心二項式係數 "wikilink")[母函數](https://zh.wikipedia.org/wiki/母函數 "wikilink")）
  - \[7\]
...
## [三角函數](https://zh.wikipedia.org/wiki/三角函數 "wikilink")
  ...
  -
    [正弦及](../Page/正弦.md "wikilink")[餘弦的求和詳見](../Page/餘弦.md "wikilink")[Fourier級數](https://zh.wikipedia.org/wiki/傅立葉級數 "wikilink")。
...
[Riemann Zeta
Function](http://mathworld.wolfram.com/RiemannZetaFunction.html)" from
[MathWorld](../Page/MathWorld.md "wikilink"), equation 52</ref>
...
使用[部分分式分解方法](../Page/部分分式分解.md "wikilink")，能夠將任何關於\(n\)的[有理函數的無限項級數都被化簡為一個](../Page/有理函數.md "wikilink")[多伽瑪函數的有限項級數](https://zh.wikipedia.org/wiki/多伽瑪函數 "wikilink")。\[12\]這個方法也被應用於[有理函數的有限項級數中](../Page/有理函數.md "wikilink")，使得即便所求[級數的項數極多](https://zh.wikipedia.org/wiki/級數 "wikilink")，其計算也能在[常數時間內完成](../Page/常數時間.md "wikilink")。
...
[Category:數學用表](https://zh.wikipedia.org/wiki/Category:數學用表 "wikilink")
...
3.
4.  [Theoretical computer science cheat
    sheet](http://www.tug.org/texshowcase/cheat.pdf)

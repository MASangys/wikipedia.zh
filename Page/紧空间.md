在[数学](../Page/数学.md "wikilink")中，如果[欧几里得空间](../Page/欧几里得空间.md "wikilink")**R**<sup>*n*</sup>的[子集](../Page/子集.md "wikilink")是[闭合的并且是](../Page/闭集.md "wikilink")[有界的](../Page/有界集合.md "wikilink")，那么称它是**-{A|zh-hans:紧致;zh-hant:緊緻}-**的。例如，在**R**中，闭合[单位区间](https://zh.wikipedia.org/wiki/单位区间 "wikilink")\[0, 1\]是紧致的，但[整数](../Page/整数.md "wikilink")集合**Z**不是（它不是有界的），半开区间\[0, 1)也不是（它不是闭合的）。

更现代的方式是称一个[拓扑空间](../Page/拓扑空间.md "wikilink")为**紧致**的，如果它的[开覆盖都有](https://zh.wikipedia.org/wiki/开覆盖 "wikilink")[有限子覆盖](https://zh.wikipedia.org/wiki/有限集合 "wikilink")。[海涅-博雷尔定理](../Page/海涅-博雷尔定理.md "wikilink")证明了这个定义对欧几里得空间子集等价于“闭合且有界”。

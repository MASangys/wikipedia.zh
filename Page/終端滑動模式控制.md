**終端滑動模式控制**（terminal sliding
modes）簡稱TSM，是在1990年代早期發明的新型[滑動模式控制](https://zh.wikipedia.org/wiki/滑動模式控制 "wikilink")，是由NASA[喷气推进实验室的Venkataraman和Gulatis所發明](../Page/喷气推进实验室.md "wikilink")\[1\]，屬於[強健的](../Page/鲁棒控制.md "wikilink")[非線性控制](https://zh.wikipedia.org/wiki/非線性控制 "wikilink")。
...
_{n-1}}(t)\)其中\(s_{0}(t)=x_{1}(t)\)及\(\gamma _{i}=\frac{p_{i}}{q_{i}}, i=1,2,...,n-1\)
. \(p_{i}, q_{i}\)為正的奇數，且\(p_{i}\leq q_{i}\).

## 參考資料

  - Venkataraman, S., Gulati, S., Control of Nonlinear Systems Using

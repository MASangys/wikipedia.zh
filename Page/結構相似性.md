...
index）是一種用以衡量兩張[數位影像相似程度的指標](https://zh.wikipedia.org/wiki/數位影像 "wikilink")。當兩張影像其中一張為無[失真影像](../Page/失真.md "wikilink")，另一張為[失真後的影像](../Page/失真.md "wikilink")，二者的**結構相似性**可以看成是失真影像的影像品質衡量指標。相較於傳統所使用的影像品質衡量指標，像是[峰值信噪比](../Page/峰值信噪比.md "wikilink")（英文：**PSNR**），**結構相似性**在影像品質的衡量上更能符合人眼對影像品質的判斷\[2\]\[3\]。
...
結構相似性指標有其限制，對於影像出現[位移](../Page/位移.md "wikilink")、[縮放](https://zh.wikipedia.org/wiki/縮放 "wikilink")、[旋轉](https://zh.wikipedia.org/wiki/旋轉 "wikilink")（皆屬於非結構性的失真）的情況無法有效的運作。為解決此問題，另已發展出在[小波域進行運算的結構相似性指標](../Page/小波分析.md "wikilink")，稱作[複小波結構相似性指標](https://zh.wikipedia.org/wiki/複小波結構相似性指標 "wikilink")\[9\]（英文：**complex

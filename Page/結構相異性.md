**結構相異性**(structural dissimilarity)，有鑑於最小平方誤差(Mean Square error)和
峰值信噪比(Peak signal-to-noise ratio)無法完全反應人類視覺上所感受的誤差，在 2004
年被提出來的新的誤差測量方法。
...
2.  Zhou Wang, Alan C. Bovik, Hamid R. Sheikh, and Eero P. Simoncelli,
    "Image quality assessment: from error visibility to structural
    similairty," IEEE Transactions on Image Processing, vol. 13, no. 4,
    pp. 600−612, Apr. 2004.
...
IGBT結合了[場效電晶體閘極易驅動的特性與](https://zh.wikipedia.org/wiki/場效電晶體 "wikilink")[雙極性電晶體耐高電流與低導通電壓壓降特性](https://zh.wikipedia.org/wiki/雙極性電晶體 "wikilink")，IGBT通常用於中高容量功率場合，如切換式[電源供應器](../Page/電源供應器.md "wikilink")、[馬達控制與](https://zh.wikipedia.org/wiki/馬達控制 "wikilink")[電磁爐](../Page/電磁爐.md "wikilink")。大型的IGBT模組應用於數百安培與六千[伏特](../Page/伏特.md "wikilink")的電力系統領域，其模組內部包含數個單一IGBT元件與保護電路。

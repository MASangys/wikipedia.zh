...
IGBT結合了[場效電晶體閘極易驅動的特性與](https://zh.wikipedia.org/wiki/場效電晶體 "wikilink")[雙極性電晶體耐高電流與低導通電壓壓降特性](https://zh.wikipedia.org/wiki/雙極性電晶體 "wikilink")，IGBT通常用於中高容量功率場合，如[切換式電源供應器](https://zh.wikipedia.org/wiki/切換式電源供應器 "wikilink")、[馬達控制與](https://zh.wikipedia.org/wiki/馬達控制器 "wikilink")[電磁爐](../Page/電磁爐.md "wikilink")。大型的IGBT[模組應用於數百安培與六千伏特的電力系統領域](https://zh.wikipedia.org/wiki/功率模組 "wikilink")，其模組內部包含數個單一IGBT元件與保護電路。

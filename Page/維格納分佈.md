...
是由1963年的[諾貝爾物理學獎得主](../Page/諾貝爾物理學獎.md "wikilink")[尤金·维格纳](../Page/尤金·维格纳.md "wikilink")，于1932年首次引用的一個新的[方程式](../Page/方程式.md "wikilink")。

眾所皆知，[傅立葉變換對於研究穩態](../Page/傅立葉變換.md "wikilink")(時間獨立)的訊號(波形)是一項非常有用的工具，然而，訊號(波形)一般來說在時間上並非是獨立的，這樣的訊號或是波形傅立葉變換並無法有效地完全分析其特性，因此對於一個非穩態的訊號完全分析需要測量出時間以及頻率上的表現。本頁面介紹的數學函數是[時頻分析中的基礎方法](../Page/時頻分析.md "wikilink")，在1980年，Claasen，Mecklenbrauker對WDF做了更進一步的研究。除此之外，線性時頻分析中，STFT、Gabor
transform和WDF扮演了相當重要的角色，其中WDF對於分析很多非穩態的隨機訊號都有很好的表現，例如：[量子力學](../Page/量子力學.md "wikilink")、[光學](../Page/光學.md "wikilink")、[聲學](../Page/聲學.md "wikilink")、[通訊](../Page/通訊.md "wikilink")、[生物工程](../Page/生物工程.md "wikilink")、[訊號處理和](../Page/訊號處理.md "wikilink")[影像處理](../Page/影像處理.md "wikilink")。有時也被用在分析地震的資料，以及處理聲音的相位失真。
...
在[聲納和](../Page/聲納.md "wikilink")[雷達系統中](../Page/雷達.md "wikilink")，傳送出去的聲波的反射波可以用來偵測目標物的位置跟速度，在很多情形下，收到的訊號因為[都普勒位移](../Page/都普勒位移.md "wikilink")，所以跟原本的訊號並不一樣。Woodward(1953)
改寫了原本的公式
...
2.  使用[離散傅立葉變換](../Page/離散傅立葉變換.md "wikilink") 複雜度：\(TN{\log _2}N\)
3.  使用[Chirp-Z 轉換](../Page/Chirp-Z_轉換.md "wikilink") 複雜度 :
    \(TN{\log _2}N\)，通常為使用[離散傅立葉變換的](../Page/離散傅立葉變換.md "wikilink")2\~3倍，但限制比使用[離散傅立葉變換少](../Page/離散傅立葉變換.md "wikilink")
...
**視窗型韋格納分佈**（），在[韋格納分佈中](../Page/韋格納分佈.md "wikilink")，當x(t)為無限長訊號時，WDF很難去實現它。所以在積分中加入一個新的函數
...
原始[韋格納分佈定義](../Page/韋格納分佈.md "wikilink")
\({W_x}\left( {t,f} \right) = \int_{ - \infty }^\infty {x\left( {t + \tau /2} \right) \cdot } {x^*}\left( {t - \tau /2} \right)\,{e^{ - j2\pi \,\tau \,f}} \cdot d\tau\)
...
2.  可能不符合[譜密度](../Page/譜密度.md "wikilink")(Power spectral density)的定義。
3.  一些好用的數學運算性質會消失。

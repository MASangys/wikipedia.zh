...
**維琴尼亞·薩提爾（）**（）是一名來自美國的家族治療先驅，她原先是一名教師、[社會工作者](https://zh.wikipedia.org/wiki/社會工作師 "wikilink")，後開創並發展了屬於自己的[薩提爾模式（The
Satir
Model）](https://zh.wikipedia.org/wiki/薩提爾模式 "wikilink")，並運用於家族治療中。她相信，不論外在條件如何，在這個世界上，沒有人是無法做出改變的。她也相信，人類可以實現其所想要實現的，可以更正向、更有效率地運用自己。而這樣的信念也促使她去往世界各地開展工作坊，以帶去希望、新的觀點，以及家族治療的新取向。\[1\]
...
## 重要著作
  ...
  - 與[John
    Grinder](https://zh.wikipedia.org/wiki/John_Grinder "wikilink")、[Richard
    Bandler合著](https://zh.wikipedia.org/wiki/Richard_Bandler "wikilink")《與家庭一同改變》（Changing
    with familes，1979）
...
## 外部連結
  ...
  - [Virginia Satir group to promote Virginia Satir's work in
    ...
    by [Phil
    Stubbington](https://zh.wikipedia.org/wiki/Phil_Stubbington "wikilink")

...
<!-- end list -->
  ...
  - [WakeOnLan (AquilaTech)](http://www.AquilaTech.com/Products/WakeOnLan/) - 一套具備完整WOL功效特點的程式，也屬免費的Windows版軟體，該程式可以執行：喚醒、關機、[Ping](../Page/Ping.md "wikilink")、一次將所屬範疇內的所有電腦都一起關機等動作。（此程式需要[.NET執行環境](https://zh.wikipedia.org/wiki/微软.NET "wikilink")）

...
[網路](https://zh.wikipedia.org/wiki/网络搜索引擎 "wikilink")[搜索引擎等站点通过爬蟲軟體更新自身的](https://zh.wikipedia.org/wiki/搜索引擎 "wikilink")或其對其他網站的索引。網路爬蟲可以將自己所訪問的頁面保存下來，以便搜索引擎事後生成供用戶搜索。

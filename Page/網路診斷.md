**網路診斷**（****）是近代發展的一種新的[網路測量與推論方法](https://zh.wikipedia.org/wiki/網路 "wikilink")，透過可收集到的有限資訊來推估無法觀測的網路資訊，主要分成[主動診斷](https://zh.wikipedia.org/wiki/主動診斷 "wikilink")(active
tomography)與[被動診斷](https://zh.wikipedia.org/wiki/被動診斷 "wikilink")(passive
tomography)兩類問題。被動診斷是資料從個別節點蒐集，去尋找路徑上的資訊，問題在估計起始節點至終端節點之流量矩陣。主動診斷是藉由設置接收節點，向接收節點發送大量的封包，根據接收節點收集到的測量數據，分析網路內部有興趣的參數或識別網路[拓撲結構](https://zh.wikipedia.org/wiki/拓撲 "wikilink")。而衍生出來的[統計問題稱為](https://zh.wikipedia.org/wiki/統計 "wikilink")[統計反向問題](https://zh.wikipedia.org/wiki/統計反向問題 "wikilink")(Statistical
Inverse Problem)。
...
從起始節點傳送封包，並觀察終端節點封包通過情況。傳送封包主要有兩種情況，一種為一次只傳送到一個接收的端點，稱為[單一傳送](https://zh.wikipedia.org/wiki/單一傳送 "wikilink")；另一種為封包傳送到特定的一些接收端點，稱為[多重傳送](https://zh.wikipedia.org/wiki/多重傳送 "wikilink")。然而這兩種傳送方式較沒有彈性，且無法使用不同的流量或不同時間下觀察網域，因此Xi
et al. (2006)及Lawrence et al. (2006)針對**彈性傳送(flexicast)**封包的情況作探討。

此種觀察封包傳送情況來對網路做推論產生了[統計反向問題](https://zh.wikipedia.org/wiki/統計反向問題 "wikilink")，即利用觀察結果來診斷連結中的分配或特徵。有許多統計方法可解決此類推論問題，Castro
...
et
al.(1999)首先研究，在假設連結遺失為獨立的[伯努利分配下](https://zh.wikipedia.org/wiki/伯努利分配下 "wikilink")，利用最大概似法來估計多重傳送的樹狀網路中連結遺失率；他們亦證明此估計量具備[強烈一致性](https://zh.wikipedia.org/wiki/強烈一致性 "wikilink")，並透過最大概似估計量之漸近常態性來推導出這些估計的比率會收斂到真正的比率。

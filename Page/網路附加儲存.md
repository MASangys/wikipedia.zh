...
目前NAS可大略分為「專注儲存型」(Storage NAS)以及「整合平台型」(Platform NAS)兩種，後者即為具備自身作業系統。就平台式NAS而言，現今全球著名品牌為[華芸科技](../Page/華芸科技.md "wikilink")（ASUSTOR）、普安科技(Infortrend)、[詮力科技](https://zh.wikipedia.org/wiki/詮力 "wikilink")（ITE2）、[威聯通科技](https://zh.wikipedia.org/wiki/威聯通 "wikilink") （QNAP）、與[群暉科技](../Page/群暉科技.md "wikilink")（Synology）、[樺賦科技](http://www.thecus.com)(又稱色卡司)（Thecus）等。

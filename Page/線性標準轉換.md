...
LCT)也稱作"ABCD轉換。在漢米爾頓力學中，線性標準轉換是積分變換的一個代表家族，並且能夠將許多經典的轉換進行廣義化，例如[傅立葉變換](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")、[分數傅立葉變換](../Page/分數傅立葉變換.md "wikilink")、[拉普拉斯變換](https://zh.wikipedia.org/wiki/拉普拉斯變換 "wikilink")、[菲涅爾轉換](../Page/菲涅爾轉換.md "wikilink")([Fresnel

線性正則變換是一種積分變換，在1970年代被提出。線性正則變換是廣義化的[傅立葉變換](../Page/傅立葉變換.md "wikilink")、[分數傅立葉變換](../Page/分數傅立葉變換.md "wikilink")、[菲涅耳轉換](../Page/菲涅耳轉換.md "wikilink")([:en:Fresnel
transform](../Page/:en:Fresnel_transform.md "wikilink"))、[拉普拉斯轉換](../Page/拉普拉斯轉換.md "wikilink")。

## 中文譯名、別名

Linear canonical
transformation常見中文譯名的有線性正則變換、線性完整轉換或[线性标准转换](../Page/线性标准转换.md "wikilink")。
...
\[O^{(cos\alpha ,sin\alpha ,-sin\alpha ,cos\alpha)}_F \left\{ f(t) \right\} =  \sqrt{e^{-j\alpha}} \cdot O^{\alpha }_F \left\{ f(t) \right \}\]
  ...
  -
    其中當\(\alpha=\frac{\pi}{2},\, -\alpha=\frac{\pi}{2}\)時分別是[傅立葉變換和反傅立葉變換](../Page/傅立葉變換.md "wikilink"):
...
### [菲涅耳轉換](../Page/菲涅耳轉換.md "wikilink")([:en:Fresnel transform](../Page/:en:Fresnel_transform.md "wikilink"))
...
線性正則轉換的應用包括[時頻分析](../Page/時頻分析.md "wikilink")、[光學分析](../Page/光學.md "wikilink")、[濾波器設計和](../Page/濾波器.md "wikilink")[雷達系統等](../Page/雷達.md "wikilink")。
...
### 時頻分析
  ...
  -
    ...
    一信號  \(x(t)\,\) 
    及其線性正則變換 \(X_{(a,b,c,d)}(u)\,\) 的[維格納分佈分別表示為](../Page/維格納分佈.md "wikilink") \(W_{X}(t,f)\,\) 和 \(W_{X_{(a,b,c,d)}}(u,v)\,\) ，
    它們在時頻域的分布有以下關係:
    \[W_{X_{(a,b,c,d)}}(u,v)=W_{X}(dt-bf,-ct+af)\]
    \[W_{X_{(a,b,c,d)}}(au+bv,cu+dv)=W_{X}(t,f)\]

### [濾波器設計](../Page/濾波器.md "wikilink")
...
<!-- end list -->
  ...
  - [電磁波在空氣中的傳播](../Page/電磁波.md "wikilink")
...
<!-- end list -->
  ...
  - [凸透鏡](../Page/凸透鏡.md "wikilink")

<!-- end list -->

  -
    一[波長為](../Page/波長.md "wikilink") λ 、[波數](../Page/波數.md "wikilink") \(k=\frac{2\pi}{\lambda}\) 的[單色光](../Page/單色光.md "wikilink") \(U_i(x,\, y)\) 穿透一[焦距為](../Page/焦距.md "wikilink") f、[折射率](../Page/折射率.md "wikilink") 
    n、厚度為  Δ  的[凸透鏡時](../Page/凸透鏡.md "wikilink")，其分布可表示為
...
[積分變換](../Page/積分變換.md "wikilink")

[傅立葉變換](../Page/傅立葉變換.md "wikilink")

[分數傅立葉變換](../Page/分數傅立葉變換.md "wikilink")

[:en:Fresnel transform](../Page/:en:Fresnel_transform.md "wikilink")
...
[en:Linear canonical
transformation](../Page/en:Linear_canonical_transformation.md "wikilink")

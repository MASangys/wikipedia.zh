...
<!-- end list -->
  ...
  -
    一[波長為](https://zh.wikipedia.org/wiki/波長 "wikilink") λ 、[波數](../Page/波數.md "wikilink") \(k=\frac{2\pi}{\lambda}\) 的[單色光](https://zh.wikipedia.org/wiki/單色光 "wikilink") \(U_i(x,\, y)\) 穿透一[焦距為](../Page/焦距.md "wikilink") f、[折射率](../Page/折射率.md "wikilink") 
    n、厚度為  Δ

在[線性代數裡](../Page/線性代數.md "wikilink")，[向量空間的一組元素中](../Page/向量空間.md "wikilink")，若沒有[向量可用](../Page/向量.md "wikilink")**有限個**其他向量的[線性組合所表示](../Page/線性組合.md "wikilink")，则稱為**線-{}-性無關**或**線-{}-性獨立**（），反之稱為**線性相關**（）。例如在三維[歐幾里得空間](../Page/歐幾里得空間.md "wikilink")**R**<sup>3</sup>的三個向量(1,
0, 0)，(0, 1, 0)和(0, 0, 1)線性無關。但(2, −1, 1)，(1, 0, 1)和(3, −1,
2)線性相關，因為第三個是前兩個的和。

## 定義

假設*V*是在[域](../Page/域.md "wikilink")*K*上的向量空間。如果*v*<sub>1</sub>,
...
解这个方程组（例如使用[高斯消元法](../Page/高斯消元法.md "wikilink")），可得：
...
由于它们都是[非平凡解](../Page/非平凡解.md "wikilink")，因此这些向量是线性相关的。

## 参考文献

  - [Siegfried Bosch](../Page/Siegfried_Bosch.md "wikilink"): *Lineare
    Algebra.* 5. Auflage, Springer, Berlin/Heidelberg 2014, ISBN
    978-3-642-55259-5, Kapitel 1.5.

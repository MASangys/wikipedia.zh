在[線性代數裡](https://zh.wikipedia.org/wiki/線性代數 "wikilink")，[向量空間的一組元素中](https://zh.wikipedia.org/wiki/向量空間 "wikilink")，若沒有[向量可用](../Page/向量.md "wikilink")**有限個**其他向量的[線性組合所表示](https://zh.wikipedia.org/wiki/線性組合 "wikilink")，则稱為**線-{}-性無關**或**線-{}-性獨立**（），反之稱為**線性相關**（）。例如在三維[歐幾里得空間](https://zh.wikipedia.org/wiki/歐幾里得空間 "wikilink")**R**<sup>3</sup>的三個向量(1,
0, 0)，(0, 1, 0)和(0, 0, 1)線性無關。但(2, −1, 1)，(1, 0, 1)和(3, −1,
2)線性相關，因為第三個是前兩個的和。

## 定義

假設*V*是在[域](https://zh.wikipedia.org/wiki/域 "wikilink")*K*上的向量空間。如果*v*<sub>1</sub>,
*v*<sub>2</sub>, ..., *v*<sub>*n*</sub> 是*V*的向量，稱它們為*線性相關*，如果從域K
中有非全零的元素*a*<sub>1</sub>, *a*<sub>2</sub>, ...,
*a*<sub>*n*</sub>，使得
...
如果*K*中不存在這樣的元素，那麼*v*<sub>1</sub>, *v*<sub>2</sub>, ...,
*v*<sub>*n*</sub>是*線性無關*。

對*線性無關*可以給出更直接的定義。向量*v*<sub>1</sub>, *v*<sub>2</sub>, ...,
*v*<sub>*n*</sub>*線性無關*，若且唯若它們滿足以下條件：如果*a*<sub>1</sub>, *a*<sub>2</sub>,
..., *a*<sub>*n*</sub>是*K*的元素，適合：

  -
    *a*<sub>1</sub>*v*<sub>1</sub> + *a*<sub>2</sub>*v*<sub>2</sub> +
    ... + *a*<sub>*n*</sub>*v*<sub>*n*</sub> = 0，
...
设*V*是实变量*t*的所有[函数的](../Page/函数.md "wikilink")[向量空间](../Page/向量空间.md "wikilink")。则*V*内的函数*e<sup>t</sup>*和*e*<sup>2*t*</sup>是线性无关的。
...
## 参考文献
  ...
  - [Siegfried
    Bosch](https://zh.wikipedia.org/wiki/Siegfried_Bosch "wikilink"):
    *Lineare Algebra.* 5. Auflage, Springer, Berlin/Heidelberg 2014,
    ISBN 978-3-642-55259-5, Kapitel 1.5.

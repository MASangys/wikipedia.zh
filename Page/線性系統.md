**線性系統**是一數學模型，是指用[線性運算子組成的](https://zh.wikipedia.org/wiki/線性運算子 "wikilink")[系統](../Page/系統.md "wikilink")\[1\]。相較於[非線性系統](https://zh.wikipedia.org/wiki/非線性系統 "wikilink")，線性系統的特性比較簡單。例如以下的系統即為一線性系統：
...
其中\(\alpha \,\)及\(\beta \,\)為任意[純量](https://zh.wikipedia.org/wiki/純量 "wikilink")。
...
一線性系統的**時變脉冲響應** *h*(*t*<sub>2</sub>,*t*<sub>1</sub>)定義為系統對於在*t* =
*t*<sub>1</sub>
時間的單一[脉冲](https://zh.wikipedia.org/wiki/脉冲函数 "wikilink")，在*t*
= *t*<sub>2</sub> 時間的響應。若系統的輸入為

\[x(t) = \delta(t-t_1) \,\]

其中 δ(*t*)
表示[狄拉克δ函數](https://zh.wikipedia.org/wiki/狄拉克δ函數 "wikilink")，而其對應的系統輸出為
...
任何連續時間系統的輸出都可以表示為輸入信號和時變脈衝響應的時變[卷積](https://zh.wikipedia.org/wiki/卷積 "wikilink")（convolution
integral）：

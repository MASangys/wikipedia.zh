**線性非移變系統理論**建立在[圖訊號處理中對](../Page/圖訊號處理.md "wikilink")**線性非移變系統**的定義上，致力於承襲[線性非時變系統理論在操作上的便利性](../Page/線性非時變系統.md "wikilink")。

## 圖位移（Graph Shift）

對於一個N點的圖\(G\)（可為有向，但通常有限、不重邊），可定義圖位移\(S\)，為一線性映射從[圖訊號時域](../Page/圖訊號.md "wikilink")[映射到圖訊號時域](../Page/映射.md "wikilink")，可表為一N階方陣
。
...
**線性非移變系統**是[圖訊號處理中](../Page/圖訊號處理.md "wikilink")，有最簡單結構的系統。其性質可最大限度地和[數位訊號處理中的](../Page/數位訊號處理.md "wikilink")[線性非時變系統對照](../Page/線性非時變系統.md "wikilink")，並發展出與之類似的運算，達到想要的訊號處理效果。
...
其中\(V^{-1}\)為圖論傅立葉轉換矩陣，\(V\)即為逆傅立葉轉換矩陣，\(D_{\hat{s}_2}\)表示一[對角矩陣](../Page/對角矩陣.md "wikilink")，其[主對角線的元素為](../Page/主對角線.md "wikilink")\(\hat{s}_2\)

### 平移

平移在[圖訊號時域中亦因為沒有好的順序關係](../Page/圖訊號.md "wikilink")，無法被良好的直接定義。

但因一般[數位訊號處理的平移運算等價於將訊號與一個單位脈衝訊號摺積](../Page/數位訊號處理.md "wikilink")，其推廣定義可以利用此性質
...
## 參考
  ...
  - **A. Sandryhaila and Jose M. F. Moura**, Discrete Signal Processing
    on Graphs,
    [<http://arxiv.org/abs/1210.4752>](../Page/arxiv:1210.4752.md "wikilink")
  - **David I Shuman, Sunil K. Narang, Pascal Frossard, Antonio Ortega,
    ...
    Other Irregular Domains,
    [<http://arxiv.org/abs/1211.0053>](../Page/arxiv:1211.0053.md "wikilink")

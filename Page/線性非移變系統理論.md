...
對於一個N點的圖\(G\)（可為有向，但通常有限、不重邊），可定義圖位移\(S\)，為一線性映射從[圖訊號時域](../Page/圖訊號.md "wikilink")[映射到圖訊號時域](https://zh.wikipedia.org/wiki/映射 "wikilink")，可表為一N階方陣
。
...
## 參考
  ...
  - **A. Sandryhaila and Jose M. F. Moura**, Discrete Signal Processing
    on Graphs,
    [<http://arxiv.org/abs/1210.4752>](https://zh.wikipedia.org/wiki/arxiv:1210.4752 "wikilink")
  - **David I Shuman, Sunil K. Narang, Pascal Frossard, Antonio Ortega,
    ...
    [<http://arxiv.org/abs/1211.0053>](https://zh.wikipedia.org/wiki/arxiv:1211.0053 "wikilink")

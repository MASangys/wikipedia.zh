...
language）的等价程序。[源代码](../Page/源代码.md "wikilink")一般为高阶语言（High-level
...
系統编写的](https://zh.wikipedia.org/wiki/A-0_系統 "wikilink")。但是1957年由任職於[IBM](../Page/IBM.md "wikilink")的美國電腦科學家[约翰·巴科斯](https://zh.wikipedia.org/wiki/约翰·巴科斯 "wikilink")（John
Warner
Backus）领导的[FORTRAN則是第一個被實作出具備完整功能的编译器](https://zh.wikipedia.org/wiki/FORTRAN "wikilink")。1960年，[COBOL](../Page/COBOL.md "wikilink")成为一种较早的能在多种架构下被编译的语言。

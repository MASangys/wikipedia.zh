...
对 [CW复形](../Page/CW复形.md "wikilink")（或等价地，只用多方体 I<sup>n</sub>）有同伦提升性质的纤维化称为**塞尔纤维化**，[让-皮埃尔·塞尔在其博士论文中部分提出了这个概念](https://zh.wikipedia.org/wiki/让-皮埃尔·塞尔 "wikilink")。这篇论文牢固地在[代数拓扑学中建立了](https://zh.wikipedia.org/wiki/代数拓扑学 "wikilink")[谱序列的使用](https://zh.wikipedia.org/wiki/谱序列 "wikilink")，并将纤维丛与纤维化的概念从[层中清晰地分离出来](../Page/层_\(数学\).md "wikilink")（这两个概念在早期[让·勒雷](../Page/让·勒雷.md "wikilink")的处理中是不清晰的）。因为一个层（想象为一个[艾达尔空间](https://zh.wikipedia.org/wiki/艾达尔空间 "wikilink")）可以视为一个[局部同胚](https://zh.wikipedia.org/wiki/局部同胚 "wikilink")，那时候这些概念是密切相连的。

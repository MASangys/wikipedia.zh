...
configuration**）\[1\]，也称作**按约定编程**\[2\]，是一种软件[设计范式](../Page/设计范式.md "wikilink")，旨在减少[软件开发人员需做决定的数量](../Page/软件设计师.md "wikilink")，获得简单的好处，而又不失灵活性。
...
标注来说明](../Page/Java_标注.md "wikilink")（参见下面提供的JavaBeans规范）。
...
PHP，[Grails](../Page/Grails_\(Framework\).md "wikilink")\[6\]，[Grok](../Page/Grok_\(web_framework\).md "wikilink")，[Zend
Framework](../Page/Zend_Framework.md "wikilink")，[CakePHP](../Page/CakePHP.md "wikilink")，[symfony](../Page/symfony.md "wikilink")，[Maven](../Page/Apache_Maven.md "wikilink")，[ASP.NET
MVC](../Page/ASP.NET_MVC.md "wikilink")，[Web2py](../Page/Web2py.md "wikilink")（MVC），[Apache
Wicket](../Page/Apache_Wicket.md "wikilink")。

这是一个古老的概念,
甚至在[Java类库中也可以找出这一概念的踪迹](../Page/Java.md "wikilink")。例如，[JavaBean规范非常多的依赖这一概念](../Page/JavaBean.md "wikilink")。下面摘录[JavaBeans](../Page/JavaBean.md "wikilink")
1.1版规范的一段:\[7\]

> 按照一般的规则，我们不希望造出一个奇怪的java.beans.everything类，其他类需要从该类派生。而是希望在运行时[JavaBeans为一般的对象提供缺省的行为特征](../Page/JavaBean.md "wikilink")，但是允许对象通过继承特定的java.beans.something接口来覆盖缺省的行为特征的一部分。\[8\]
...
8.  "As a general rule we don't want to invent an enormous
    ...
    Instead we'd like the [JavaBeans](../Page/JavaBean.md "wikilink")

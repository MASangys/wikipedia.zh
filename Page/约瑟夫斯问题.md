**約瑟夫斯問題**（有时也称为**約瑟夫斯置換**），是一个出现在[计算机科学和](../Page/计算机科学.md "wikilink")[数学中的问题](../Page/数学.md "wikilink")。在计算机[编程的算法中](https://zh.wikipedia.org/wiki/编程 "wikilink")，类似问题又称为**约瑟夫环**。
...
## 外部链接
  ...
  - [cut-the-knot上的](https://zh.wikipedia.org/wiki/cut-the-knot "wikilink")[约瑟夫斯游戏](http://www.cut-the-knot.org/recurrence/flavius.shtml)（Java
    Applet）

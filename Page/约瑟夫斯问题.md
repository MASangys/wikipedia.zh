**約瑟夫斯問題**（有时也称为**約瑟夫斯置換**），是一个出现在[计算机科学和](../Page/计算机科学.md "wikilink")[数学中的问题](../Page/数学.md "wikilink")。在计算机[编程的算法中](../Page/编程.md "wikilink")，类似问题又称为**约瑟夫环**。
...
这个问题是以-{zh-hant:[弗拉維奧·約瑟夫斯](../Page/弗拉維奧·約瑟夫斯.md "wikilink");zh-hans:[弗拉维奥·约瑟夫](../Page/弗拉维奥·约瑟夫斯.md "wikilink")}-命名的，他是1世纪的一名犹太历史学家。他在自己的日记中写道，他和他的40个战友被罗马军队包围在洞中。他们讨论是自杀还是被俘，最终决定自杀，并以抽签的方式决定谁杀掉谁。约瑟夫斯和另外一个人是最后两个留下的人。约瑟夫斯说服了那个人，他们将向罗马军队投降，不再自杀。约瑟夫斯把他的存活归因于运气或天意，他不知道是哪一个。\[1\]
...
对于\(k<n\)，可以将上述方法推广，将杀掉第*k*、*2k*、……、\(\lfloor n/k \rfloor\)个人视为一个步骤，然后把号码改变，可得如下递推公式,
运行时间为\(O(k\log n)\)。
...
## 参考文献
  ...
  - [Thomas H. Cormen](../Page/Thomas_H._Cormen.md "wikilink"), [Charles
    ...
    Chapter 14: Augmenting Data Structures, pp.318.

## 外部链接

  - [cut-the-knot上的](../Page/cut-the-knot.md "wikilink")[约瑟夫斯游戏](http://www.cut-the-knot.org/recurrence/flavius.shtml)（Java
    Applet）

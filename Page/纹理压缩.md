**纹理压缩**(**Texture
compression**)是一种专为在[三维计算机图形](../Page/三维计算机图形.md "wikilink")渲染系统中存储纹理而使用的[图像压缩](../Page/图像压缩.md "wikilink")技术。与普通图像压缩算法的不同之处在于，纹理压缩算法为[纹素](../Page/纹素.md "wikilink")的[隨機存取做了优化](https://zh.wikipedia.org/wiki/隨機存取 "wikilink")。
...
绝大多数支持[OpenGL](../Page/OpenGL.md "wikilink")和[OpenGL
ES的](../Page/OpenGL_ES.md "wikilink")[显卡](https://zh.wikipedia.org/wiki/显卡 "wikilink")，尤其是[移动设备](../Page/移动设备.md "wikilink")上的显卡，都支持一种或多种压缩格式（主要以[扩展的形式](https://zh.wikipedia.org/wiki/OpenGL#.E6.89.A9.E5.B1.95 "wikilink")）。

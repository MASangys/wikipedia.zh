...
**线性整流函数**（Rectified Linear Unit, **ReLU**）,又称**修正线性单元**, 是一种[人工神经网络](../Page/人工神经网络.md "wikilink")中常用的激勵函数（activation function），通常指代以[斜坡函数](../Page/斜坡函数.md "wikilink")及其变种为代表的非线性函数。

...
LTI系统理论善于描述了许多重要的系统。至少相对于时间变化的和/或非线性的情况下最LTI系统被认为是“容易”来分析。任何可以被模拟为常系数线性齐次[微分方程](../Page/微分方程.md "wikilink")系统是LTI系统。这类系统的实例是[电路](../Page/电路.md "wikilink")由[电阻器S](https://zh.wikipedia.org/wiki/電阻器 "wikilink")，[电感s和](../Page/电感元件.md "wikilink")[电容器](../Page/电容器.md "wikilink")S（RLC电路）的。理想的弹簧 - 质量 - 阻尼系统也是LTI系统，并且在数学上是等效的RLC电路。

**线性滤波器**用于时变输入信号的[线性运算](https://zh.wikipedia.org/wiki/线性运算 "wikilink")（[:en:linear
operator](https://zh.wikipedia.org/wiki/:en:linear_operator "wikilink")）。线性滤波器在[电子学和](../Page/电子学.md "wikilink")[数字信号处理中应用非常普遍](../Page/数字信号处理.md "wikilink")（参见[电子滤波器中的文章](../Page/电子滤波器.md "wikilink")），它们也用于[机械工程和其它技术领域](../Page/机械工程.md "wikilink")。
...
几种常见的线性滤波器：
  ...
  - 阻止一个狭窄频率范围通过的特殊带阻滤波器[陷波滤波器](https://zh.wikipedia.org/wiki/陷波滤波器 "wikilink")（[:en:notch
    filter](https://zh.wikipedia.org/wiki/:en:notch_filter "wikilink")）。
...
所有类型的线性滤波器都可以完全用[频率响应和](../Page/频率响应.md "wikilink")[相位响应来描述](https://zh.wikipedia.org/wiki/相位响应 "wikilink")，它们唯一地定义了[脉冲响应](https://zh.wikipedia.org/wiki/脉冲响应 "wikilink")，反之亦然。从数学的观点来看，连续时间脉冲[冲激响应可以用线性](../Page/冲激响应.md "wikilink")[微分方程描述](../Page/微分方程.md "wikilink")，它们的脉冲响应是方程的[格林函数](https://zh.wikipedia.org/wiki/格林函数 "wikilink")（Green's
function）。连续时间滤波器可以用脉冲响应的[拉普拉斯变换表示](https://zh.wikipedia.org/wiki/拉普拉斯变换 "wikilink")，这种方法根据[复平面内拉普拉斯变换](../Page/复平面.md "wikilink")[极点和](https://zh.wikipedia.org/wiki/极点 "wikilink")[零点的样式就可以很容易地分析滤波器的所有特性](../Page/零点.md "wikilink")。对于离散时间信号，也可以类似地分析脉冲响应的[Z变换](https://zh.wikipedia.org/wiki/Z变换 "wikilink")。
...
经典的无限脉冲响应滤波器的类型有：
  ...
  - [贝塞耳滤波器](https://zh.wikipedia.org/wiki/贝塞耳滤波器 "wikilink")（[:en:Bessel
    filter](https://zh.wikipedia.org/wiki/:en:Bessel_filter "wikilink")）
  - [巴特沃斯滤波器](../Page/巴特沃斯滤波器.md "wikilink")（Butterworth filter）
  - [切比雪夫滤波器](../Page/切比雪夫滤波器.md "wikilink")（Chebyshev filter）
  - [椭圆函数滤波器](https://zh.wikipedia.org/wiki/椭圆函数滤波器 "wikilink")（elliptic
    filter）

这些描述都是指滤波器的*数学*特性，也就是频率和相位响应，它们都可以用模拟电路实现，例如，使用[有源滤波器](https://zh.wikipedia.org/wiki/有源滤波器 "wikilink")[Sallen
Key滤波器](https://zh.wikipedia.org/wiki/Sallen_Key滤波器 "wikilink")（[:en:Sallen
Key
filter](https://zh.wikipedia.org/wiki/:en:Sallen_Key_filter "wikilink")）布局。它们也可以用作[数字信号处理系统中的算法](../Page/数字信号处理.md "wikilink")。

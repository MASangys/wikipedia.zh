...
*S* 的生成空间也可定义为 *S* 中元素的所有有限[线性组合组成的集合](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。因为容易验证：*S* 中向量的有限线性组合的集合是包含 *S* 的一个向量空间，反之任何包含 *S* 的向量空间必然都包含 *S* 中向量的有限组合，故两个定义是等价的。

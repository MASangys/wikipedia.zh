...
在[数学中](../Page/数学.md "wikilink")，**线性近似**就是用[线性函数对普通](../Page/线性函数.md "wikilink")[函数进行近似](../Page/函数.md "wikilink")。这个线性函数称为[仿射函数](../Page/仿射变换.md "wikilink")。
...
处的[切线](../Page/切线.md "wikilink")，因此这个过程也叫作**切线近似**。
...
导数](../Page/Fréchet_导数.md "wikilink")。

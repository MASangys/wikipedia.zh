...
线性预测编码通常用于语音的重新合成，它是电话公司使用的声音压缩格式，如[GSM](../Page/GSM.md "wikilink")标准就在使用这种格式。它还用作[安全](../Page/安全.md "wikilink")无线通信中的格式，在安全的无线通信中，声音必须进行[数字化](../Page/数字化.md "wikilink")、[加密然后通过狭窄的语音信道传输](https://zh.wikipedia.org/wiki/加密 "wikilink")。

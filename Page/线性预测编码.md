**线性预测编码**（）是主要用于[音频信号处理与](../Page/音频信号处理.md "wikilink")[语音处理中根据](../Page/语音处理.md "wikilink")[线性预测模型的信息用](../Page/线性预测.md "wikilink")[压缩形式表示](../Page/数据压缩.md "wikilink")[数字](https://zh.wikipedia.org/wiki/数字 "wikilink")[语音](https://zh.wikipedia.org/wiki/语音 "wikilink")[信号](https://zh.wikipedia.org/wiki/信号 "wikilink")[谱包络](https://zh.wikipedia.org/wiki/谱包络 "wikilink")（spectral
...
根据[斯坦福大学Robert](https://zh.wikipedia.org/wiki/斯坦福大学 "wikilink") M.
...
Burg略述了[最大熵的实现方法](https://zh.wikipedia.org/wiki/最大熵 "wikilink")。1969年Itakura与Saito提出了部分相关（partial
correlation）的概念, May Glen Culler提议进行实时语音压缩，B. S.
Atal在[美国声学协会年会上展示了一个LPC语音编码器](https://zh.wikipedia.org/wiki/美国声学协会 "wikilink")。1971年[Philco-Ford展示了使用](https://zh.wikipedia.org/wiki/Philco-Ford "wikilink")16位LPC硬件的实时LPC并且卖出了四个。

1972年[美國國防部](https://zh.wikipedia.org/wiki/美國國防部 "wikilink")[國防高等研究計劃署](../Page/國防高等研究計劃署.md "wikilink")（DARPA）的[Bob
Kahn与](https://zh.wikipedia.org/wiki/Bob_Kahn "wikilink")[林肯實驗室](../Page/林肯實驗室.md "wikilink")（Lincoln
...
Voice
Protocol在Culler](https://zh.wikipedia.org/wiki/Network_Voice_Protocol "wikilink")-Harrison、ISI、SRI与LL之间以3500位/秒的速度实现。最后在1978年，BBN的Vishwanath
et al.开发了第一个变速LPC算法。
...
有许多更加高级的表示方法，如[对数面积比](https://zh.wikipedia.org/wiki/对数面积比 "wikilink")（log
area ratio，LAR）、[线谱对](https://zh.wikipedia.org/wiki/线谱对 "wikilink")（line
spectral
pairs，LSP）分解以及[反射系数等](../Page/反射系数.md "wikilink")。在这些方法中，LSP由于它能够保证预测器的稳定性、并且小的系数偏差带来的谱误差也是局部的这些特性，所以得到了广泛应用。

## 应用

线性预测编码通常用于语音的重新合成，它是电话公司使用的声音压缩格式，如[GSM标准就在使用这种格式](../Page/GSM.md "wikilink")。它还用作[安全无线通信中的格式](../Page/安全.md "wikilink")，在安全的无线通信中，声音必须进行[数字化](../Page/数字化.md "wikilink")、[加密然后通过狭窄的语音信道传输](https://zh.wikipedia.org/wiki/加密 "wikilink")。
...
1980年流行的[Speak &
Spell教育玩具中使用了一个](https://zh.wikipedia.org/wiki/Speak_&_Spell "wikilink")10阶的线性预测编码。
...
## 参见
  ...
  - [赤池信息量準則](https://zh.wikipedia.org/wiki/赤池信息量準則 "wikilink")（Akaike

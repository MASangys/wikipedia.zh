...
是一种寻找[目标函数](https://zh.wikipedia.org/wiki/目标函数 "wikilink")
...
应该沿着这个方向移动的步长。下降方向可以通过多种方法计算，比如[梯度下降法](https://zh.wikipedia.org/wiki/梯度下降法 "wikilink")，[牛顿法和](../Page/牛顿法.md "wikilink")。计算出的步长不一定是精确的。

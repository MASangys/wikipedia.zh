...
线程池的[伸缩性对性能有较大的影响](../Page/伸缩性.md "wikilink")。
...
[Windows操作系统的](../Page/Windows操作系统.md "wikilink")[API提供了一套线程池的实现接口](../Page/Windows_API.md "wikilink")。\[1\]可以方便地创建、使用线程池。Windows线程池API被设计为一组协同对象，
其中有些对象表示工作单位、计时器、异步I/O 等等。使用下述用户模式的对象来管理线程池及相关的数据：

  - 线程池对象（pool object）包含了一组工作线程（worker
    threads）。每个[进程可以创建多个线程池对象](../Page/进程.md "wikilink")，也可以直接使用进程缺省的线程池。
...
## 参看
  ...
  - [并发](../Page/并发.md "wikilink")
  - [并行](../Page/并行.md "wikilink")
  - [对象池模式](../Page/对象池模式.md "wikilink")

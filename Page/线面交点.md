...
在[解析几何](../Page/解析几何.md "wikilink")中, 一条[直线](../Page/直线.md "wikilink")与一个[平面](../Page/平面.md "wikilink")的交点可能是[空集](../Page/空集.md "wikilink")、一个[点](../Page/点.md "wikilink")或一条直线。在计算机图形学、运动规划和碰撞检测中，经常需要分析相交类型，以及计算出点坐标或线的方程。

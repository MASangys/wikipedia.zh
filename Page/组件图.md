[Policy_Admin_Component_Diagram.PNG](https://zh.wikipedia.org/wiki/File:Policy_Admin_Component_Diagram.PNG "fig:Policy_Admin_Component_Diagram.PNG")  在[统一建模语言](../Page/统一建模语言.md "wikilink")中，**组件图**表示组件是如何互相组织以构建更大的组件或是[软件系统的](https://zh.wikipedia.org/wiki/软件系统 "wikilink")。 他们被用来标示任意复杂系统的结构。

...
## 组合数学中的著名问题
  ...
  - [中国邮差问题](https://zh.wikipedia.org/wiki/中国邮差问题 "wikilink")：由中国组合数学家[管梅谷教授提出](https://zh.wikipedia.org/wiki/管梅谷 "wikilink")。邮递员要穿过城市的每一条路至少一次，怎样行走走过的路程最短？这不是一个[NP完全问题](../Page/NP完全.md "wikilink")，存在多项式复杂度算法：先求出度为奇数的点，用匹配算法算出这些点间的连接方式，然后再用[欧拉路径算法求解](https://zh.wikipedia.org/wiki/欧拉路径 "wikilink")。這也是[圖論的問題](https://zh.wikipedia.org/wiki/圖論 "wikilink")。

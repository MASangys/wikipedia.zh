...
Catmull和](https://zh.wikipedia.org/wiki/Edwin_Catmull "wikilink")[Jim
Clark](../Page/吉姆·克拉克_\(企業家\).md "wikilink")，还有Daniel Doo和Malcom
Sabin在1978年同时引入。在1995年之前该方法没有什么进展，直到Ulrich Reif解决了细分曲面在特殊点附近的行为。
...
有几种细化方案：
  ...
  - **Loop**
    是二次三角形[box样条的推广](https://zh.wikipedia.org/wiki/box样条 "wikilink")，由Charles
    Loop发明。（可以用于三角形网格）
  - **蝶型** 因为该方案的形状得名
  - **中边（Midedge）**
...
## 外部链接
  ...
  - [Geri's
    ...
    [Pixar](https://zh.wikipedia.org/wiki/Pixar "wikilink") completed in
    1997 that introduced subdivision surfaces (along with cloth
    simulation)

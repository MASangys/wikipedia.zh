在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，**結合律**(associative
laws)是[二元運算可以有的一個性質](https://zh.wikipedia.org/wiki/二元運算 "wikilink")，意指在一個包含有二個以上的可結合運算子的表示式，只要[算子的位置沒有改變](../Page/算子.md "wikilink")，其運算的順序就不會對運算出來的值有影響。亦即，重新排列表示式中的[括號並不會改變其值](https://zh.wikipedia.org/wiki/括號 "wikilink")。例如：
...
一些可結合的運算的例子如下。
  ...
  - 在[算術中](https://zh.wikipedia.org/wiki/算術 "wikilink")，[實數的](https://zh.wikipedia.org/wiki/實數 "wikilink")[加法和](../Page/加法.md "wikilink")[乘法都是可結合的](../Page/乘法.md "wikilink")，即：
...
x,y,z\\in\\Z. </math>
  ...
  - 因為[線性變換是個可表示成矩陣的函數](https://zh.wikipedia.org/wiki/線性變換 "wikilink")，其中的函數複合則可以用[矩陣乘法來表示](../Page/矩陣乘法.md "wikilink")，立即可知矩陣乘法為可結合的。

<!-- end list -->

  - [集合的](https://zh.wikipedia.org/wiki/集合 "wikilink")[交集和](../Page/交集.md "wikilink")[聯集為可結合的](https://zh.wikipedia.org/wiki/聯集 "wikilink")：
...
在此一運算下，運算的順序是**有**影響的。[減法](https://zh.wikipedia.org/wiki/減法 "wikilink")、[除法和](../Page/除法.md "wikilink")[冪都是不可結合運算的簡單例子](../Page/冪.md "wikilink")：

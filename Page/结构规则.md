在[证明论中](../Page/证明论.md "wikilink")，**结构规则**是不提及任何[逻辑连结词的](https://zh.wikipedia.org/wiki/逻辑连结词 "wikilink")[推理规则](../Page/推理规则.md "wikilink")，它直接操作于判断或[相继式](../Page/相继式.md "wikilink")。结构规则通常模仿逻辑的元理论性质。拒绝一个或多个结构规则的逻辑被归类为[亚结构逻辑](../Page/亚结构逻辑.md "wikilink")。
...
在[十字转门的左侧](https://zh.wikipedia.org/wiki/十字转门 "wikilink")，和
...
\[\frac{\Gamma \vdash A, A, \Sigma}{\Gamma \vdash A, \Sigma}\]。在使用[归结原理的](../Page/归结原理.md "wikilink")[自动定理证明中也叫做](https://zh.wikipedia.org/wiki/自动定理证明 "wikilink")**因子化**。
...
最著名的结构规则叫做**[切](../Page/切消定理.md "wikilink")**。证明论理论家花了相当的努力来证实切规则在各种逻辑中是多余的。更严格的说，证实了切只是(某种意义上)简化证明的工具，不能增加可以证明的定理。成功消除了切规则叫做**[切消定理](../Page/切消定理.md "wikilink")**，直接有关于规范化[计算](https://zh.wikipedia.org/wiki/计算 "wikilink")(参见[lambda
演算](https://zh.wikipedia.org/wiki/lambda_演算 "wikilink"))的哲学；它经常对给定逻辑的[判定的](https://zh.wikipedia.org/wiki/判定 "wikilink")[复杂性给出好的指示](https://zh.wikipedia.org/wiki/复杂性 "wikilink")。

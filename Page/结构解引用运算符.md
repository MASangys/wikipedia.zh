...
[C语言与](../Page/C语言.md "wikilink")[C++的](../Page/C++.md "wikilink")`->`运算符。其功能是获取运算符左侧的[指针所指向的对象的某个成员](../Page/指针_\(信息学\).md "wikilink")（）。例如：
...
该运算符的[优先级较高](../Page/運算符優先級.md "wikilink")，与[函数调用运算符](../Page/函数调用运算符.md "wikilink")`(
)`、[数组下标运算符](../Page/数组下标运算符.md "wikilink")`[
]`、[通过引用选择成员运算符](../Page/通过引用选择成员运算符.md "wikilink")`.`相同。也是自左向右结合。即`p->a->b`等价于`(p->a)->b`。

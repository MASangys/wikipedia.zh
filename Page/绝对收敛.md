**绝对收敛**是[数学中](../Page/数学.md "wikilink")[无穷级数和](https://zh.wikipedia.org/wiki/无穷级数 "wikilink")[广义积分的一种性质](https://zh.wikipedia.org/wiki/广义积分 "wikilink")。一个数项[级数或一个](../Page/级数.md "wikilink")[积分绝对收敛当且仅当级数的每一项或者积分的函数取](../Page/积分.md "wikilink")[绝对值](../Page/绝对值.md "wikilink")（或[范数](../Page/范数.md "wikilink")）後仍然收敛或可积。比如，一个[实数项或](../Page/实数.md "wikilink")[复数项级数](https://zh.wikipedia.org/wiki/复数 "wikilink")
\(\sum_n a_n\)绝对收敛当且仅当\(\sum_{n=0}^\infty \left|a_n\right| < \infty\)。某个函数\(f(x)\)的[广义积分或](https://zh.wikipedia.org/wiki/广义积分 "wikilink")[瑕积分](https://zh.wikipedia.org/wiki/瑕积分 "wikilink")\(\int_I f(x) \mathrm{d}x\)是绝对收敛的，当且仅当取绝对值或范数後的函数的积分收敛：\(\int_I |f(x) |\mathrm{d}x < \infty\)。一个积分绝对收敛的函数也称为**绝对可积**函数。

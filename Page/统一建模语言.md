...
### 开源软件和自由软件中
  ...
  - Poseidon for UML，专业UML工具，提供免费的社区版（Community Edition）。从[开源项目](https://zh.wikipedia.org/wiki/开源 "wikilink")[ArgoUML](../Page/ArgoUML.md "wikilink")而来。请参见（[主页](http://www.gentleware.com/)）。
...
## 外部链接
  ...
  - [Unified Modeling Language](http://www.foldoc.org/foldoc/foldoc.cgi?query=Unified+Modeling+Language) at [FOLDOC](https://zh.wikipedia.org/wiki/FOLDOC "wikilink")

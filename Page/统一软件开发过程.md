**統一軟體開發過程**（，縮寫為RUP）是一種[软件工程](../Page/软件工程.md "wikilink")[方法](../Page/方法学.md "wikilink")，為[迭代式軟體開發流程](https://zh.wikipedia.org/wiki/迭代式开发 "wikilink")。最早由Rational Software公司開發，因此冠上公司名稱。Rational Software公司後來被IBM併購，成為IBM之下的一個部門，因此又稱IBM-Rational Unified Process。

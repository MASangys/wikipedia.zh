...
Wiener）在二十世纪四十年代提出的一种[滤波器](https://zh.wikipedia.org/wiki/滤波器 "wikilink")，并在1949年出版.
...
与设计一个特定[频率响应所用的通常滤波器设计理论不同](../Page/频率响应.md "wikilink")，维纳滤波器从另外一个不同的角度实现滤波器。仅仅在[频域进行滤波的滤波器](https://zh.wikipedia.org/wiki/频域 "wikilink")，仍然会有噪声通过滤波器。维纳设计方法需要额外的关于原始信号所包含频谱以及噪声的信息，维纳滤波器具有以下一些特点：

1.  假设：信号以及附加噪声都是已知频谱特性或者[自相关和](https://zh.wikipedia.org/wiki/自相关 "wikilink")[互相关的](../Page/互相关.md "wikilink")[随机过程](../Page/随机过程.md "wikilink")

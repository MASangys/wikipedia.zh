...
维纳过程的地位在纯数学中与在应用数学中同等重要。在纯数学中，维纳过程导致了对连续[鞅理论的研究](https://zh.wikipedia.org/wiki/鞅 "wikilink")，是刻画一系列重要的复杂过程的基本工具。它在[随机分析](https://zh.wikipedia.org/wiki/随机分析 "wikilink")、[扩散过程和](https://zh.wikipedia.org/wiki/扩散 "wikilink")[位势论领域的研究中是不可或缺的](../Page/位势论.md "wikilink")。在应用数学中，维纳过程可以描述[高斯](../Page/高斯函数.md "wikilink")[白噪声的积分形式](https://zh.wikipedia.org/wiki/白噪声 "wikilink")。在[电子工程中](../Page/电子工程.md "wikilink")，维纳过程是建立噪音的数学模型的重要部分。[控制论中](https://zh.wikipedia.org/wiki/控制论 "wikilink")，维纳过程可以用来表示不可知因素。

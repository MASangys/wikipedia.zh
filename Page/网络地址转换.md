**網絡地址轉換**又称**網絡掩蔽**、**掩蔽**（，縮寫：），在[計算機網絡中是一種在](https://zh.wikipedia.org/wiki/計算機網絡 "wikilink")封包通過[路由器或](../Page/路由器.md "wikilink")[防火牆時重寫來源](https://zh.wikipedia.org/wiki/防火牆 "wikilink")或目的地址的技術。這種技術被普遍使用在有多台主機但只通過一個公有IP地址訪問[因特網的私有網絡中](https://zh.wikipedia.org/wiki/因特網 "wikilink")。它是一個方便且得到了廣泛應用的技術。當然，也讓主機之間的通信變得複雜，導致了通信效率的降低。
...
## 参见
  ...
  - [电信级NAT](https://zh.wikipedia.org/wiki/电信级NAT "wikilink")

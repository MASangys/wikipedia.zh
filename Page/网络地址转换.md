...
[Nat1.svg](https://zh.wikipedia.org/wiki/File:Nat1.svg "fig:Nat1.svg") [Nat2.svg](https://zh.wikipedia.org/wiki/File:Nat2.svg "fig:Nat2.svg") 1990年代中期，是作为一种解决[IPv4地址短缺以避免保留IP地址困难的方案而流行起来的](https://zh.wikipedia.org/wiki/IPv4位址枯竭 "wikilink")。网络地址转换在很多国家广泛使用。所以NAT就成了家庭和小型办公室网络连接上的路由器的一个标准特征，因为对他们来说，申请独立的IP地址的代价要高于所带来的效益。

在一些[操作系统上](../Page/操作系统.md "wikilink")，**网络块设备**是一种[设备节点](https://zh.wikipedia.org/wiki/设备节点 "wikilink")，其内容由远程计算机提供。网络块设备通常用于访问非物理安装于本地计算机上，而在远程的存储设备。例如，本地计算机可访问连接于另一台计算机上的[硬盘](../Page/硬盘.md "wikilink")。

...
在現代通訊網路中，語音、視頻和資料等資訊不再以類比信號的方式傳送，而是以[封包](https://zh.wikipedia.org/wiki/封包 "wikilink")(packet
...
網路處理器廣泛應用於：
  ...
  - [路由器](../Page/路由器.md "wikilink")，軟體路由器和[網路交換器](../Page/網路交換器.md "wikilink")(Router
    and Switches)
  - [防火墙 (计算机)](https://zh.wikipedia.org/wiki/防火墙_\(计算机\) "wikilink")
    (Firewalls)
...
<!-- end list -->
  ...
  - [Cavium
    Networks](https://zh.wikipedia.org/wiki/Cavium_Networks "wikilink")
      - OCTEON CN5860晶片\[2\]
          - 16個核（MIPS64核心）
          - 時脈約600MHz～1GHz
          - 用電15～40W。
...
<div style="-moz-column-count:3; column-count:3;">
  ...
  - [Applied Micro Circuits
    Corporation](https://zh.wikipedia.org/wiki/Applied_Micro_Circuits_Corporation "wikilink")
  - [Bay
    Microsystems](https://zh.wikipedia.org/wiki/Bay_Microsystems "wikilink")
  - [Broadcom](https://zh.wikipedia.org/wiki/Broadcom "wikilink")
  - [Cavium
    Networks](https://zh.wikipedia.org/wiki/Cavium_Networks "wikilink")
  ...
  - [LSI
    Corporation](https://zh.wikipedia.org/wiki/LSI_Corporation "wikilink")

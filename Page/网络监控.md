**网络监控**（**Network
monitoring**）是指持续监控[计算机网络网络是否存在缓慢或故障组件](../Page/计算机网络.md "wikilink")，并在故障、中断等情况下通知[網絡管理員](https://zh.wikipedia.org/wiki/網絡管理員 "wikilink")（通过[电子邮件](../Page/电子邮件.md "wikilink")、[簡訊或其他警示法](../Page/簡訊.md "wikilink")）的系统。网络监控是[网络管理的一部分](../Page/网络管理.md "wikilink")。

## 细节

[入侵检测系统是监控网络](../Page/入侵检测系统.md "wikilink")，应对外部的威胁，而网络监控系统监控网络中因过载或崩溃的服务器、网络连接或其他设备引起的问题。

例如，为测定一个[網頁伺服器的状态](../Page/網頁伺服器.md "wikilink")，监控软件可能定期发送一个[HTTP请求以获取页面](../Page/超文本传输协议.md "wikilink")。对于[电子邮件服务器](../Page/电子邮件.md "wikilink")，可能是通过[SMTP发送一封测试邮件](../Page/简单邮件传输协议.md "wikilink")，并通过[IMAP或](https://zh.wikipedia.org/wiki/IMAP "wikilink")[POP3接收](../Page/郵局協定.md "wikilink")。
...
## 参见
  ...
  -
  -
  - [系统监视器](https://zh.wikipedia.org/wiki/系统监视器 "wikilink")

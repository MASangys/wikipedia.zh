...
微软开发了网页快讯格式，而且在下出版了一个规范。\[7\]该规范不由任何独立标准机构发表。截至2012年，Internet Explorer 8和9（及IE 10桌面版）是仅有的原生支持网页快讯的浏览器，虽然[Mozilla Firefox可以通过一个](../Page/Firefox.md "wikilink")Webchunks支持它。\[8\]

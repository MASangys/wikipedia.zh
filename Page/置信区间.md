在[统计学中](../Page/统计学.md "wikilink")，一个[概率样本的](../Page/樣本_\(統計學\).md "wikilink")**置信区间**（，），是对产生这个样本的[总体的](../Page/总体.md "wikilink")**参数分布**（）中的某一个未知参数值，以**区间**形式给出的估计。相对于**点估计**（）用**一个**样本统计量来估计参数值，置信区间还蕴含了估计的精确度的信息。在现代机器学习中越来越常用的**置信集合**（）概念是置信区间在多维分析的推广\[1\]。

置信区间在频率学派中间使用，其在[贝叶斯统计中的对应概念是](../Page/贝叶斯统计.md "wikilink")（）。两者建立在不同的概念基础上的，贝叶斯统计将分布的位置参数视为随机变量，并对给定观测到的数据之后未知参数的后验分布进行描述，故无论对随机样本还是已观测数据，构造出来的可信区间，其可信水平都**是**一个合法的概率\[2\]；而置信区间的置信水平，只在考虑随机样本时可以被理解为一个概率。
...
一般来说，置信区间的构造需要先找到一个**枢轴变量**（，或称），其表达式依赖于样本以及带估计的未知参数(但**不能**依赖于总体的其它未知参数)，其分布**不依赖于**任何未知参数。

下面以上述例2为例，说明如何利用枢轴变量构造置信区间。对于一个正态分布的随机样本\({X_1,\ldots,X_n}\)，可以证明(此证明对初学者并不容易)如下统计量**互相独立**：

  -
    \(\bar{X}=\frac1n \sum_{i=1}^n X_i\) 和
    \(S^2=\frac{\sum_{i=1}^n\left(X_i-\bar{X}\right)^2}{n-1}\)

它们的分布是：

  -
    \(\frac{\bar{X}-\mu}{\sigma}\sim N(0,1)\) 和
    \((n-1)\frac{S^2}{\sigma^2} \sim \chi^2_{n-1}\)

所以根据[t分布的定义](../Page/t分布.md "wikilink")，有
...
有时，置信区间可以用来进行参数检验。例如在上面的例1中构造的**双边**\(1-\alpha\)水平置信区间，可以用来检验具有相应的**显著水平为\(\alpha\)**的**双边**对立假设，具体地说是如下检验：
...
## 参考书目
  ...
  - [羅納德·費雪](../Page/羅納德·費雪.md "wikilink") (1956) *Statistical Methods
    and Scientific Inference.* Oliver and Boyd, Edinburgh. (See p. 32.)
  - 弗罗因德 (1962) *Mathematical Statistics* Prentice Hall, Englewood
    Cliffs, NJ. (See pp. 227–228.)
  - [伊安·海金](../Page/伊安·海金.md "wikilink") (1965) *Logic of Statistical
    Inference.* Cambridge University Press, Cambridge
  - 齐平 (1962) *Introduction to Statistical Inference.* D. Van Nostrand,
    Princeton, NJ.
  - [杰克·基弗](../Page/杰克·基弗.md "wikilink")(1977) ["Conditional Confidence
    Statements and Confidence Estimators (with
    discussion)"](http://links.jstor.org/sici?sici=0162-1459%28197712%2972%3A360%3C789%3ACCSACE%3E2.0.CO%3B2-9)
    *Journal of the American Statistical Association,* **72,** 789–827.
  - [泽西·内曼](../Page/泽西·内曼.md "wikilink") (1937) ["Outline of a Theory of
    Statistical Estimation Based on the Classical Theory of
    Probability"](http://links.jstor.org/sici?sici=0080-4614%2819370830%29236%3A767%3C333%3AOOATOS%3E2.0.CO%3B2-6)
    *Philosophical Transactions of the Royal Society of London A,*
    **236,** 333–380. (Seminal work.)
  - G.K.罗宾逊 (1975) ["Some Counterexamples to the Theory of Confidence
    Intervals."](http://links.jstor.org/sici?sici=0006-3444%28197504%2962%3A1%3C155%3ASCTTTO%3E2.0.CO%3B2-4)
...
[Category:市场研究](https://zh.wikipedia.org/wiki/Category:市场研究 "wikilink")
[Category:选举学](https://zh.wikipedia.org/wiki/Category:选举学 "wikilink")
[Category:生物统计学](https://zh.wikipedia.org/wiki/Category:生物统计学 "wikilink")
[Category:测量](https://zh.wikipedia.org/wiki/Category:测量 "wikilink")

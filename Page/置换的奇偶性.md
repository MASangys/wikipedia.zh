...
在[数学中](../Page/数学.md "wikilink")，当*X*是一个至少有两个元素的[有限集合时](https://zh.wikipedia.org/wiki/有限集合 "wikilink")，*X*的[置换](https://zh.wikipedia.org/wiki/置换 "wikilink")（即从*X*到*X*的[双射](../Page/双射.md "wikilink")）可分为大小相同的两类：**奇置换**与**偶置换**。如果*X*固定了任何一个[全序](https://zh.wikipedia.org/wiki/全序 "wikilink")，*X*的一个**置换\(\sigma\)的奇偶性**可以定义为\(\sigma\)中反向对个数的奇偶性。所谓反向对即*X*中二元组\(x,y\)使得\(x<y\)且\(\sigma(x)>\sigma(y)\)。这里\(\sigma(x)\)为置换\(\sigma\)中第\(x\)位的元素。

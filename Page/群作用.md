...
120°[旋轉](https://zh.wikipedia.org/wiki/旋轉 "wikilink")“作用”在這個三角形的頂點的集合上。\]\]

[数学上](../Page/数学.md "wikilink")，[对称群描述物体的所有](../Page/空間對稱群.md "wikilink")[对称性](https://zh.wikipedia.org/wiki/对称性 "wikilink")。这是通过**群作用**的概念来形式化的：[群的每个元素作为一个](../Page/群.md "wikilink")[双射](../Page/双射.md "wikilink")（或者对称作用）作用在某个[集合上](https://zh.wikipedia.org/wiki/集合 "wikilink")。在这个情况下，群称为**置换群**（特别是在群有限或者不是[线性空间时](https://zh.wikipedia.org/wiki/线性空间 "wikilink")）或者**变换群**（特别是当这个集合是线性空间而群作为**线性变换**作用在集合上时）。一个群*G*的置换表示是群作为一个集合的[置换群的](https://zh.wikipedia.org/wiki/置换 "wikilink")[群表示](https://zh.wikipedia.org/wiki/群表示 "wikilink")（通常该集合有限），并且可以表述为[置换矩阵](../Page/置换矩阵.md "wikilink")，一般在有限的情形作此考虑－这和作用在有序的[线性空间基上是一样的](https://zh.wikipedia.org/wiki/线性空间基 "wikilink")。

## 定义

若\(\mathrm{G}\)为一个[群而](../Page/群.md "wikilink")\(\mathrm{X}\)为一个[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")，则\(\mathrm{G}\)在\(\mathrm{X}\)上的一个(左)
**群作用**是一个[二元函数](https://zh.wikipedia.org/wiki/二元函数 "wikilink")
...
2.  \(e \cdot x = x\)对于每个\(x \in \mathrm{X}\)成立
    (\(e\)代表\(\mathrm{G}\)的[么元](https://zh.wikipedia.org/wiki/么元 "wikilink"))
...
## 样例
  ...
  - 任意群*G*在任意集合*X*上的**群作用定义为  对任意*g*属于*G*以及任意*x*属于*X*；换句话说，每个群元素对应
    *X*上的[恒等置换](https://zh.wikipedia.org/wiki/恒等函数 "wikilink")。\[1\]

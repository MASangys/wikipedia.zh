[Group_action_on_equilateral_triangle.svg](https://zh.wikipedia.org/wiki/File:Group_action_on_equilateral_triangle.svg "fig:Group_action_on_equilateral_triangle.svg")，通過把所有頂點映射到另一個頂點，繞三角形中心逆時針 120°[旋轉](https://zh.wikipedia.org/wiki/旋轉 "wikilink")“作用”在這個三角形的頂點的集合上。\]\]

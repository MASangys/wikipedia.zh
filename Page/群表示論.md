在[群論中](https://zh.wikipedia.org/wiki/群論 "wikilink")，**群表示論**（**group
representation
theory**）是一个非常重要的理論。它包含了[（局部）緊緻群](../Page/拓扑群.md "wikilink")、[李群](../Page/李群.md "wikilink")、[李代數及](../Page/李代數.md "wikilink")[群概形的表示等種種分支](../Page/群概形.md "wikilink")，近來無限維表示理論也漸露頭角。表示理論在[量子物理與數學的各領域中均有重要應用](https://zh.wikipedia.org/wiki/量子物理 "wikilink")。
...
形式地說，一個群\(G\)的表示乃一同態
\(\rho: G \rightarrow \mathrm{GL}(V)\)，其中\(V\)為給定的有限維[向量空間](https://zh.wikipedia.org/wiki/向量空間 "wikilink")，係數佈於一個[域](https://zh.wikipedia.org/wiki/域 "wikilink")\(F\)，通常取\(F = \mathbb{C}\)，但在一般域（如[局部域或](../Page/局部域.md "wikilink")[有限域](../Page/有限域.md "wikilink")）上的表示也有重要應用。\(\mathrm{GL}(V)\)表從\(V\)上的自同構，或對一給定的基底來說，是\(n = \dim V\)階可逆方陣的集合。若\(\mathrm{Ker}(\rho)\)是平凡的，則稱此表現是**忠實**的。

若所考慮的群\(G\)帶有額外的結構（如[拓撲群](https://zh.wikipedia.org/wiki/拓撲群 "wikilink")、[李群或](../Page/李群.md "wikilink")[群概形](../Page/群概形.md "wikilink")），我們通常要求\(\rho\)滿足相應的條件（如連續性、可微性或者要求它是[概形間的態射](https://zh.wikipedia.org/wiki/概形 "wikilink")）；在有限群及緊緻群以外的情況，通常也須考慮無窮維表示。
...
給定\(G\)的一個表示，可以得到一個**特徵標**\(\chi: G \rightarrow F\)，它是個[類函數](https://zh.wikipedia.org/wiki/類函數 "wikilink")。特徵標理論在有限群分類中佔關鍵地位；在緊緻群上，特徵標滿足[舒爾正交關係](https://zh.wikipedia.org/wiki/舒爾正交關係 "wikilink")，又根據**彼得-外爾定理**，不可約表現的特徵標相對於
...
迄今已知的物理定律通常在某個李群的作用下保持不變，如空間的旋轉群\(\mathrm{SO}(3)\)或其覆蓋\(\mathrm{Spin}(3)\)，其不可約表示關係到[角動量的量子化](https://zh.wikipedia.org/wiki/角動量 "wikilink")。進一步的例子是：任何與狹義相對論相容的量子力學系統都帶有\(G := AH\)（[半直積](https://zh.wikipedia.org/wiki/半直積 "wikilink")）的[酉表示](https://zh.wikipedia.org/wiki/酉表示 "wikilink")，其中\(A\)是時空的平移而\(H\)是
[勞侖茲變換群](https://zh.wikipedia.org/wiki/勞侖茲變換 "wikilink")，藉著研究\(G\)的不可約酉表示，可分類粒子的質量和[自旋](../Page/自旋.md "wikilink")。

...
聯結主義的中心原則是使用，簡單且經常一致的單元互聯網絡，來描述心理現象。聯結及單元的形式可以從模型到模型修改。例如，網絡的單元及聯結可以分別表示人腦中的[神經元及](https://zh.wikipedia.org/wiki/神经元 "wikilink")[突觸](../Page/突触.md "wikilink")。

### 擴散激活

在大多数聯結主义模型中，网络会随着时间而变化。聯結主义模型的一个密切且普遍的方面是*激活* 。任何时候，网络中的单元都会有個激活，而该激活是表示该单元某些方面的数值。例如，如果模型中的单位是神经元，则激活可以表示神经元产生[动作电位](../Page/动作电位.md "wikilink")峰值的[概率](../Page/概率.md "wikilink") 。激活通常会傳遞到与其聯結的所有其他单元。扩散激活一直是神经网络模型的特征，而其在[认知心理学家使用的聯結主義模型中也很常見](../Page/認知心理學.md "wikilink")。
...
大多数神经网络模型中的变化来自：
  ...
  - *单元的解释* ：单元可以解释为神经元或神经元组。
  - *激活的定义* ：激活可以通过多种方式进行定义。例如，在[玻尔兹曼机](../Page/玻尔兹曼机.md "wikilink")中，激活被解释为产生动作电位尖峰的概率，并通过[逻辑函数确定输入到单元的总和](../Page/邏輯函數.md "wikilink")。
  - *学习演算法* ：不同的网络以不同的方式修改其聯結。通常，聯結权重會隨時間的改變，用於該變化的数学定义都称为“学习演算法”。

聯結主义者一致认为，与[前馈神经网络](https://zh.wikipedia.org/wiki/前馈神经网络 "wikilink") （无循环的有向网络，称为[DAG](https://zh.wikipedia.org/wiki/有向无环图 "wikilink") ）相比，[遞迴神经网络](../Page/递归神经网络.md "wikilink") （其中的网络聯結可以形成有向循环的有向网络）是更好的大脑模型。许多遞迴聯結主義模型也纳入了[动力学系统理论](../Page/动态系统理论.md "wikilink") 。许多研究者，例如聯結主义者[Paul Smolensky](https://zh.wikipedia.org/wiki/保羅·斯莫林斯基 "wikilink") ，皆认为聯結主义模型将朝着完全地[连续](../Page/连续函数.md "wikilink")、高维度、[非线性的](../Page/非線性系統.md "wikilink")[动态系统方式发展](../Page/动力系统.md "wikilink")。
...
聯結主义可以追溯到一个世纪以上的思想，在20世紀中後期之前，這些思想仍只是猜測。
...
许多造成PDP发展的研究都是在1970年代完成，但是直到1980年代出版了《 并行分布式处理：认知微观结构的探索》第一卷（基础）及第二卷（心理和生物学模型），作者為[詹姆斯·L·麦克莱兰德](https://zh.wikipedia.org/wiki/詹姆斯·麦克兰德 "wikilink") ，[戴维·E·鲁梅尔哈特和PDP研究小组](https://zh.wikipedia.org/wiki/大卫·鲁梅尔哈特 "wikilink")*，*PDP才開始流行。 如今，这些书被认为是有著巨大影響的聯結主义著作，雖然书中未使用過“聯結主义”一词，但仍普遍視PDP等同於聯結主义。

### 早期工作

PDP的直接根源是研究人员的[感知器](../Page/感知器.md "wikilink")理论，例如1950年代和1960年代的[弗蘭克·羅森布拉特](https://zh.wikipedia.org/wiki/弗兰克·罗森布拉特 "wikilink") (Frank Rosenblatt)。但是，由[马文·明斯基和](../Page/马文·闵斯基.md "wikilink")[西摩爾·派普特](../Page/西摩爾·派普特.md "wikilink")在1969年出版的《 *感知機* 》一书，使感知器模型变得非常不得人心。它詳述了单层（无隐藏层）感知器计算功能的局限性，甚至無法執行如[异或問題](../Page/逻辑异或.md "wikilink") （exclusive disjunction，如判斷這是蘋果還是桔子，但不是二者皆是）這樣的簡單功能。 PDP书籍克服了这一限制，因为它表明多层次的非线性神经网络更加強大，可以用於大量的函數陣列。 \[10\]

許多早期的研究人員提倡聯結主义風格的模型，例如1940年代和1950年代的[沃伦·麦卡洛克](../Page/沃伦·麦卡洛克.md "wikilink")、[沃尔特·皮茨](https://zh.wikipedia.org/wiki/沃尔特·皮茨 "wikilink") （ [MP神经元](https://zh.wikipedia.org/wiki/人工神经元 "wikilink") ）、[唐纳德·赫布](../Page/唐纳德·赫布.md "wikilink")和卡爾·拉什利。McCulloch和Pitts則展示了神经系统如何实现[一阶逻辑](../Page/一阶逻辑.md "wikilink") ：其经典论文《神經活動中內在思想的邏輯演算》（1943）對深深影響了這方面的發展，而他们受到了[尼古拉斯·拉舍夫斯基](https://zh.wikipedia.org/wiki/尼古拉斯·拉舍夫斯基（Nicolas_Rashevsky） "wikilink")（ Nicolas Rashevsky） 在1930年代的重要成果之影响。赫布对神经功能的推测做出了巨大贡献，并提出了一种叫做[赫布學習的学习原则](../Page/赫布理论.md "wikilink") ，一直使用至今。拉什利（Lashley）主张采用分散式表示法，這是因為他在多年的[病变实验中](https://zh.wikipedia.org/wiki/病灶 "wikilink")，並未發現任何類似於局部[印跡的东西](https://zh.wikipedia.org/wiki/恩格拉姆（神经心理学） "wikilink")。

### PDP以外的联结主义

雖然PDP是聯結主義的主要形式，但還有其他理論工作也應歸類為聯結主義。

许多聯結主义的原理可以追溯到[心理学](../Page/心理学.md "wikilink")的早期工作，例如[威廉•詹姆斯](../Page/威廉·詹姆士.md "wikilink")。 \[11\]基于人脑知识的心理学理论在19世纪后期很流行。早在1869年，神经学家約翰·休格林·傑克遜([John Hughlings Jackson)就主张多層次分散式系统](https://zh.wikipedia.org/wiki/傑克森 "wikilink")。在此基础上， [赫伯特·斯宾塞](../Page/赫伯特·斯宾塞.md "wikilink")的*《心理学原理* 》第3版（1872年）和[西格蒙德·弗洛伊德](../Page/西格蒙德·弗洛伊德.md "wikilink")的《*科学心理学计划》*（1895年）提出了聯結主义或原型聯結主义理论，而這些往往只是推測性的理論。到了20世纪初，[愛德華·桑戴克進行了嘗試建立聯結型網絡的實驗](../Page/愛德華·桑代克.md "wikilink")。

[哈耶克独立在](../Page/弗里德里希·哈耶克.md "wikilink")1920年發表的一篇論文中獨立構思了赫本突觸學習模型，並將該模型發展成由構建成全球腦理論，由更大的地圖系統和記憶網絡的赫本突觸網絡所構成 。弗兰克·罗森布拉特（Frank Rosenblatt）在其感知器论文中引用了哈耶克的突破性成果。
...
随着聯結主义在1980年代后期变得越来越流行，一些研究人员（包括[杰瑞·福多](../Page/杰瑞·福多.md "wikilink")，[史迪芬·平克](../Page/史迪芬·平克.md "wikilink")等）对此表示反對。他们认为，随着当时的发展，聯結主义威胁到经典的[计算主义方法](https://zh.wikipedia.org/wiki/心灵计算理论 "wikilink")，並抹去认知科学和心理学领域正在取得的进步。计算主义是认知主义的一种特殊形式，认为心理活动是[计算性的](../Page/计算_\(计算机科学\).md "wikilink")，也就是说，大脑通过对[图灵机](../Page/图灵机.md "wikilink")之类的符号，执行纯粹的形式运算来进行操作。一些研究人员认为，聯結主義的趋势代表着[聯想主義的回归](https://zh.wikipedia.org/wiki/結社主義 "wikilink")，以及对[思想语言概念的放弃](../Page/心語假說.md "wikilink")，而他们對此不以為然。與此相反，聯結主义趋势使得聯結主义对其他研究者具有吸引力。

聯結主义和计算主义不必然矛盾，但是在1980年代末和1990年代初的辩论，导致了两种方法之间的对立。在整个辩论中，一些研究人员认为，尽管尚未就此问题完全达成共识，但是聯結主义和计算主义可完全兼容。两种方法的差异包括：

  - 计算主义者假定符号模型在结构上与底層的大脑结构相似，而聯結主义者则进行“低级”建模，以确保其模型类似于神经结构。
  - 一般來說，計算主義者專注於关注外在符号的结构（[心智模型](../Page/心智模型.md "wikilink")）和内部操纵的[句法](../Page/句法.md "wikilink")规则，而聯結论者则关注从环境刺激中学习，并以神经元之间的聯結形式存储此信息。
  - 计算主义者认为内部心理活动由对外在符号的操纵组成，而聯結主义者认为对外在符号的操纵會提供不良的心理活动模型。
  - 计算主义者通常会假設存在[特定领域的符号子系统](https://zh.wikipedia.org/wiki/领域特异性 "wikilink")，用於支持在特定认知领域（例如语言、意图、数字）中的学习，而聯結论者则提出一組很小的，或是一种非常通用的学习机制。

儘管存在這些差異，一些理論家提出，聯結主義架構只是有機大腦碰巧實現符號操作系統的一種方式。這在邏輯上是可能的，因為眾所周知，聯結主義模型可以實現，以計算主義模型中所使用的那種符號來操作系統，如果它們要解釋人類執行以符號操作任務的能力，則確實必須做到這一點。但爭論的焦點在於這種符號操作是否構成了一般認知的基礎，所以這並不是對計算主義的潛在辯護。儘管如此，例如，計算性描述可能是對邏輯認知的高級描述。

爭論主要集中在邏輯論點上，即聯結主義網絡是否能產生，這種在推理中觀察到的句法結構。儘管是使用了不可能在大腦中完成的過程，，但這論點後來仍被實現，因此爭論仍在持續。截至2016年,神經生理學進展和一般神經網絡的理解的進步，導致了很多此類的早期問題得以成功地建模,因此，關於基本認知的爭論在很大程度上取決於讚成聯結主義的神經科學家。 。然而，這些近期的發展尚未在心理學或心靈哲學等其他領域中達成共識。

近年來，動態系統流行於[心靈哲學領域](https://zh.wikipedia.org/wiki/心靈哲學 "wikilink")，為這一爭論提供了新的視角; 一些作者現在認為，聯結主義和計算主義之間的任何分裂，更確切地說是計算主義和動態系統之間的分裂。

2014年， [DeepMind](../Page/DeepMind.md "wikilink")的 [Alex Graves等人发表了一系列论文](https://zh.wikipedia.org/wiki/亚历克斯·格雷夫斯（计算机科学家） "wikilink")，描述了一种新型的深度神经网络结构，称为[神经图灵机](https://zh.wikipedia.org/wiki/神经图灵机 "wikilink") \[12\]该结构能够读取磁带上的符号，并将符号存储在記憶體中。关系网络是DeepMind发行的另一个深度网络模块，能够创建类似客體的表徵形式，并操纵它们来回答复杂的问题。关系网络和神经图灵机进一步证明了聯結主义和计算主义不必矛盾。
...
## 参见
  ...
  -
  - [控制論](https://zh.wikipedia.org/wiki/控制论 "wikilink")（Cybernetics）

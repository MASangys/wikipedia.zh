...
為了讓平行移動的概念更加清楚，我們考慮一種等價的移動方法：使切向量黏在北極點且整體座標系固定的情況下，旋轉球體使得北極點沿著曲線移動（後續將會知道，這是[列维-奇维塔联络的移動方式](../Page/列维-奇维塔联络.md "wikilink")）。如圖所示，雖然切向量移動的起點和終點是一樣的，但沿著不同的曲線移動的話，它最終指向的方向也會不一樣，這現象反映了球體的曲率。（有趣的是，古中國發明的[指南車](https://zh.wikipedia.org/wiki/指南車 "wikilink")，它的行為就跟在*平行移動*下的切向量沒兩樣。）
...
在空間轉換下，[張量的表述方法可以反映在空間變換下不變的性質](../Page/張量.md "wikilink")，其中[共變導數正好可以用來取代方向導數](https://zh.wikipedia.org/wiki/共變導數 "wikilink")。共變導數藉由一個**聯絡**（他的分量形式是[克里斯托福符號Γ](https://zh.wikipedia.org/wiki/克里斯托福符號 "wikilink")），讓不同但無窮接近的兩個切空間中的切向量，可以轉換到同一個切空間中，如此一來兩向量就可以相加相減，使得此種導數概念可以被定義出來。
...
以下將提及的是“线性”或“仿射”联络。
  ...
  - 用[主丛和](../Page/主丛.md "wikilink")[李代数值構成的](https://zh.wikipedia.org/wiki/李代数 "wikilink")[微分形式](../Page/微分形式.md "wikilink")；見[联络形式和](../Page/联络形式.md "wikilink")[嘉当联络](../Page/嘉当联络.md "wikilink")。
  - 最抽象的定義大概是[亚历山大·格罗滕迪克所建议的方法](../Page/亚历山大·格罗滕迪克.md "wikilink")。在這方法中，联络被视为[对角线中无穷小邻域的](https://zh.wikipedia.org/wiki/对角线 "wikilink")[下降数据](https://zh.wikipedia.org/wiki/下降_\(类理论\) "wikilink")。

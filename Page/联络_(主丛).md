...
如果主丛*P*是[标架丛](../Page/标架丛.md "wikilink")，或更一般地如果他有一个（），则此联络是[仿射联络的一个例子](https://zh.wikipedia.org/wiki/仿射联络 "wikilink")，曲率不仅不变，由焊接形式*θ*的加法结构，也要考虑到它是*P*上一个**R**<sup>n</sup>-值1-形式。特别地，*P*上的[挠率形式](https://zh.wikipedia.org/wiki/挠率形式 "wikilink")，是一个 **R**<sup>n</sup>-值2-形式Θ定义为

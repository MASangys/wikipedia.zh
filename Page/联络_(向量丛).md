...
## 例子
  ...
  - 一个经典[共变导数或](https://zh.wikipedia.org/wiki/共变导数 "wikilink")[仿射联络在](https://zh.wikipedia.org/wiki/仿射联络 "wikilink") *M* 的[切丛](../Page/切丛.md "wikilink")上，或更一般地在切丛与其对偶[余切丛](../Page/余切丛.md "wikilink")的[张量丛上](https://zh.wikipedia.org/wiki/张量丛 "wikilink")，定义了一个联络。

**聚类分析**（）亦称为**-{zh-cn:群集;
zh-tw:聚類;}-分析**，是对于统计[数据分析的一门技术](../Page/数据分析.md "wikilink")，在许多领域受到广泛应用，包括[机器学习](../Page/机器学习.md "wikilink")，[数据挖掘](../Page/数据挖掘.md "wikilink")，[模式识别](../Page/模式识别.md "wikilink")，[图像分析以及](../Page/图像分析.md "wikilink")[生物信息](../Page/生物信息.md "wikilink")。聚类是把相似的对象通过静态[分类的方法分成不同的组别或者更多的](../Page/分类.md "wikilink")[子集](../Page/子集.md "wikilink")（subset），这样让在同一个子集中的成员对象都有相似的一些属性，常见的包括在[坐标系中更加短的空间距离等](../Page/坐标系.md "wikilink")。

一般把数据聚类归纳为一种[非監督式學習](../Page/非監督式學習.md "wikilink")。
...
基于密度的聚类算法，是为了挖掘有任意形状特性的类别而发明的。此算法把一个类别视为数据集中大于某阈值的一个区域。[DBSCAN和](../Page/DBSCAN.md "wikilink")[OPTICS是两个典型的算法](../Page/OPTICS.md "wikilink")。

许多聚类算法在执行之前，需要指定从输入数据集中产生的分类个数。除非事先准备好一个合适的值，否则必须决定一个大概值，关于这个问题已经有一些现成的技术。

## 距离测量

在结构性聚类中，关键性的一步就是要选择测量的距离。一个简单的测量就是使用[曼哈顿距离](../Page/曼哈顿距离.md "wikilink")，它相当于每个变量的绝对差值之和。该名字的由来起源于在纽约市区测量街道之间的距离就是由人步行的步数来确定的。

一个更为常见的测量是[欧式空间距离](../Page/欧式空间距离.md "wikilink")，他的算法是找到一个空间，来计算每个空间中点到原点的距离，然后对所有距离进行换算。

常用的几个距离计算方法：

  - [欧式距离](../Page/欧几里得度量.md "wikilink")（2-norm距离）
  - [曼哈顿距离](../Page/曼哈顿距离.md "wikilink")（Manhattan distance, 1-norm距离）
  - infinity norm
  - [马氏距离](../Page/马氏距离.md "wikilink")
...
<!-- end list -->
  ...
  - [The on-line textbook: Information Theory, Inference, and Learning
    ...
    [David J.C. MacKay](../Page/David_J.C._MacKay.md "wikilink")
  ...
  - Romesburg, H. Clarles, *Cluster Analysis for Researchers*, 2004, 340
    ...
    Co.](../Page/Krieger_Pub._Co..md "wikilink").. A Japanese language
    translation is available from [Uchida Rokakuho Publishing
    Co.](../Page/Uchida_Rokakuho_Publishing_Co..md "wikilink"), Ltd.,
    Tokyo, Japan.
...
## 外部链接
  ...
  - for another presentation of hierarchical, k-means and fuzzy c-means
    ...
    [Gaussians](../Page/normal_distribution.md "wikilink").
...
#### 免费类
  ...
  - The [flexclust
    ...
    for [R](../Page/R_\(programming_language\).md "wikilink")
  - [COMPACT - Comparative Package for Clustering
    Assessment](http://adios.tau.ac.il/compact/)（in Matlab）
  - [YALE (Yet Another Learning
    Environment)](../Page/YALE.md "wikilink"): freely available
    [open-source](../Page/open_source.md "wikilink") software for data
    pre-processing, [knowledge
    discovery](../Page/knowledge_discovery.md "wikilink"), [data
    mining](../Page/data_mining.md "wikilink"), [machine
    learning](../Page/machine_learning.md "wikilink"), visualization,
    etc. also including a plugin for clustering, fully integrating
    [Weka](../Page/Weka_\(machine_learning\).md "wikilink"), easily
    extendible, and featuring a graphical user interface as well as a
    XML-based scripting language for data mining;
  ...
  - [Weka](../Page/Weka_\(machine_learning\).md "wikilink") : Weka
...
#### 商业类
  ...
  - [Peltarion Synapse](../Page/Peltarion_Synapse.md "wikilink")（using
    [self-organizing
    maps](../Page/self-organizing_map.md "wikilink")）[2](http://www.peltarion.com)

**股息貼現模型**（，[縮寫](../Page/縮寫.md "wikilink")：**DDM**），是[现金流折现模型的一种特殊形式](https://zh.wikipedia.org/wiki/现金流折现模型 "wikilink")，仅用于为[公司的股权资产定价](../Page/有限公司.md "wikilink")。其用於以投資者角度估算公司[股票價格的合理值](../Page/股票.md "wikilink")，原理就是把預期將來派發的一系列[股息按利率貼現成現值](../Page/股息.md "wikilink")，一系列股息的淨現值的總和相加即為該股票的**合理價值**。這條方程又可稱爲**戈登增長模型**。以學者[邁倫·J.戈登命名](https://zh.wikipedia.org/wiki/邁倫·J.戈登 "wikilink")，因爲學術界傳統認爲戈登在1959年首先提出這模型，但實際上其理論基礎可追溯至1938年由經濟學家[約翰·伯爾·威廉姆斯發表的文章](https://zh.wikipedia.org/wiki/約翰·伯爾·威廉姆斯 "wikilink")《投資價值理論》\[1\]。
...
如前所述，股息貼現模型产生于1938年，由[美国经济学家](../Page/美国.md "wikilink")[約翰·伯爾·威廉姆斯最早提出](https://zh.wikipedia.org/wiki/約翰·伯爾·威廉姆斯 "wikilink")。当时投资者买进[股票的主要目的确实是获得](../Page/股票.md "wikilink")[股息](../Page/股息.md "wikilink")，股票的股息率经常被用来和[债券的孳息率做对比](../Page/债券.md "wikilink")。但是，自从20世纪中期以后，由于[税收上的考虑](https://zh.wikipedia.org/wiki/税收 "wikilink")，上市公司逐渐减少了股息的发放，转而倾向于保留大部分收益用作再投资，以避免股东缴纳高昂的[股息税](https://zh.wikipedia.org/wiki/股息税 "wikilink")。当公司需要把一部分资金分配给股东的时候，往往采取[股票回购的方式](https://zh.wikipedia.org/wiki/股票回购 "wikilink")，而非发放股息。这种情况是股息貼現模型无法应对的。
...
但是，由於[優先股的股息是固定且必須派發的](../Page/優先股.md "wikilink")，再者優先股亦無到期日，其回報形式類似於[永久年金或者](https://zh.wikipedia.org/wiki/永久年金 "wikilink")[債券](https://zh.wikipedia.org/wiki/債券 "wikilink")，因此股息貼現模型可適用於評估優先股的價值\[9\]。因爲優先股股息數額固定，換言之g等於0，未來股息總和的現值就相當於股價，其計算公式即是：

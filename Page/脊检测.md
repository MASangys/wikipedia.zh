...
脊集合與谷集合表現了一個函數直覺上的幾何資訊，因此可以提供一種對於函數特徵的簡潔呈現。[圖像分析及](https://zh.wikipedia.org/wiki/圖像分析 "wikilink")[電腦視覺為了獲得相片中物件延伸特性的資訊](https://zh.wikipedia.org/wiki/電腦視覺 "wikilink")，利用了脊集合與谷集合的特性而有脊检测及谷检测。相關的應用像是在[分水嶺演算法中被使用以進行](https://zh.wikipedia.org/wiki/分水嶺_\(演算法\) "wikilink")[圖像分割](https://zh.wikipedia.org/wiki/圖像分割 "wikilink")，或是利用相片中的脊與谷去計算物件可能的形狀等等。此種幾何資訊的表示方式，若只有進行單一尺度的計算，容易會受到雜訊的干擾。根據[尺度空間理論](https://zh.wikipedia.org/wiki/尺度空間 "wikilink")，多重尺度的脊與谷可以透過相片經過[高斯金字塔的預先處理獲得](../Page/高斯金字塔.md "wikilink")，藉此應該可以產生對於物件更穩定的描述。

## 二維相片中單一尺度的脊與谷的微分幾何定義

令
\(f(x, y)\)為一個二維函數，而\(L\)為\(f(x, y)\)的[尺度空間表示](https://zh.wikipedia.org/wiki/尺度空間 "wikilink")，此種表示可以透過\(f(x, y)\)與高斯函數的[摺積獲得](https://zh.wikipedia.org/wiki/摺積 "wikilink")。
...
進一步帶入[海森矩陣中](https://zh.wikipedia.org/wiki/海森矩陣 "wikilink")。
...
-\cos \beta & \sin \beta
\end{bmatrix}\]
不難看出\(L_{pp}, L_{qq}\)即為海森矩陣的[特徵值](https://zh.wikipedia.org/wiki/特徵值 "wikilink")，而旋轉矩陣的旋轉角度可以由海森矩陣的[特徵向量所決定](https://zh.wikipedia.org/wiki/特徵向量 "wikilink")。
...
其中 \(t\) 為[尺度空間表示中的尺度](https://zh.wikipedia.org/wiki/尺度空間 "wikilink").
...
脊與谷第一次被使用在數位影像的領域中是在由[Haralick於](https://zh.wikipedia.org/wiki/Haralick "wikilink")1983\[7\]及Crowley於1984對於[高斯金字塔的想法](../Page/高斯金字塔.md "wikilink")\[8\]\[9\]

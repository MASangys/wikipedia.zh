**脚本语言**（）是为了缩短传统的「编写、编译、链接、运行」（edit-compile-link-run）过程而创建的计算机[编程语言](https://zh.wikipedia.org/wiki/编程 "wikilink")。早期的脚本语言经常被称为[批处理语言或](../Page/批处理.md "wikilink")[工作控制语言](https://zh.wikipedia.org/wiki/工作控制语言 "wikilink")。一个脚本通常是解释运行而非编译。脚本語言通常都有簡單、易學、易用的特性，目的就是希望能讓[程式設計師快速完成](https://zh.wikipedia.org/wiki/程式設計師 "wikilink")[程式的編寫工作](../Page/计算机程序.md "wikilink")。而[巨集語言則可視為脚本語言的分支](https://zh.wikipedia.org/wiki/巨集語言 "wikilink")，兩者也有實質上的相同之處。

虽然许多脚本语言都超越了计算机简单任务自动化的领域，成熟到可以编写精巧的程序，但仍然还是被称为脚本。几乎所有计算机系统的各个层次都有一种脚本语言。包括操作系统层，如[计算机游戏](https://zh.wikipedia.org/wiki/计算机游戏 "wikilink")，[网络应用程序](../Page/网络应用程序.md "wikilink")，字处理文档，网络[软件等](../Page/软件.md "wikilink")。在许多方面，高级[编程语言和](../Page/编程语言.md "wikilink")**脚本语言**之间互相交叉，二者之间没有明确的界限。

## 起源

脚本語言是一种[電腦程式語言](https://zh.wikipedia.org/wiki/電腦程式語言 "wikilink")，因此也能讓開發者藉以編寫出讓電腦聽命行事的程式。以簡單的方式快速完成某些複雜的事情通常是創造腳本語言的重要原則，基於這項原則，使得腳本語言通常比[C語言](https://zh.wikipedia.org/wiki/C語言 "wikilink")、[C++語言或](https://zh.wikipedia.org/wiki/C++語言 "wikilink")
[Java之類的](../Page/Java.md "wikilink")[系統程式語言要簡單容易](https://zh.wikipedia.org/wiki/系統程式語言 "wikilink")，也讓腳本語言另有一些屬於腳本語言的特性：\[1\]
...
一个脚本可以使得本来要用[键盘进行的相互式操作自动化](https://zh.wikipedia.org/wiki/键盘 "wikilink")。一个[Shell脚本主要由原本需要在](https://zh.wikipedia.org/wiki/Shell "wikilink")[命令行输入的命令组成](https://zh.wikipedia.org/wiki/命令行 "wikilink")，或在一个[文本编辑器中](../Page/文本编辑器.md "wikilink")，用户可以使用脚本来把一些常用的操作组合成一组序列。主要用来书写这种脚本的语言叫做脚本语言。很多脚本语言实际上已经超过简单的用户命令序列的指令，还可以编写更复杂的程序。
...
具体包括：
  ...
  - [4NT](https://zh.wikipedia.org/wiki/4NT "wikilink") / [Take
    Command](https://zh.wikipedia.org/wiki/Take_Command "wikilink")
  ...
  - [Cmd.exe
    batch](https://zh.wikipedia.org/wiki/Cmd.exe "wikilink")（[Windows](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink"),
    [OS/2](https://zh.wikipedia.org/wiki/OS/2 "wikilink")）
  - [Command.com
    batch](https://zh.wikipedia.org/wiki/Command.com "wikilink")（[DOS](../Page/DOS.md "wikilink")）
...
具体包括：
  ...
  - [Action Code
    Script](https://zh.wikipedia.org/wiki/Action_Code_Script "wikilink")
  - [ActionScript](../Page/ActionScript.md "wikilink")
  - [AutoLISP](https://zh.wikipedia.org/wiki/AutoLISP "wikilink")
  - [BlobbieScript](https://zh.wikipedia.org/wiki/BlobbieScript "wikilink")
    [1](http://www.wocmud.org/Carnage/blobbieScript/)
  - [Emacs Lisp](../Page/Emacs_Lisp.md "wikilink")
  - [Game Maker
    Language](https://zh.wikipedia.org/wiki/Game_Maker_Language "wikilink")
  ...
  - [Matlab Embedded
    Language](https://zh.wikipedia.org/wiki/Matlab_Embedded_Language "wikilink")
  - [Maya Embedded
    Language](https://zh.wikipedia.org/wiki/Maya_Embedded_Language "wikilink")
...
具体包括：
  ...
  - [ColdFusion](https://zh.wikipedia.org/wiki/ColdFusion "wikilink")（Application
    Server）
...
具体包括：
  ...
  - [Ch](https://zh.wikipedia.org/wiki/Ch_interpreter "wikilink")（C/C++
    interpreter）
  - [Dao](https://zh.wikipedia.org/wiki/道语言 "wikilink")
  - [ECMAScript亦称](../Page/ECMAScript.md "wikilink")[DMDScript](https://zh.wikipedia.org/wiki/DMDScript "wikilink"),
  ...
  - [Lua](../Page/Lua.md "wikilink")
  - [RBScript](https://zh.wikipedia.org/wiki/RBScript "wikilink")（REALbasic
    Script）
...
### 其它
  ...
  - [BeanShell](https://zh.wikipedia.org/wiki/BeanShell "wikilink")（scripting
    for Java）
  - [CobolScript](https://zh.wikipedia.org/wiki/CobolScript "wikilink")
  - [Escapade (server side
    scripting)](https://zh.wikipedia.org/wiki/Escapade "wikilink")
  ...
  - [Shorthand
    Language](https://zh.wikipedia.org/wiki/Shorthand_Language "wikilink")
  ...
  - [Visual
    DialogScript](https://zh.wikipedia.org/wiki/Visual_DialogScript "wikilink")
...
language](https://zh.wikipedia.org/wiki/Domain-specific_programming_language "wikilink")

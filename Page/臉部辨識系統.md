...
目前人脸识别的算法可以分类为：
  ...
  - 基于[人脸特征点的识别算法](https://zh.wikipedia.org/wiki/人脸特征点 "wikilink")（feature-based
    recognition algorithms）。
  - 基于整幅人脸图像的识别算法（appearance-based recognition algorithms）。
  - 基于[模板的识别算法](https://zh.wikipedia.org/wiki/模板 "wikilink")（template-based
    recognition algorithms）。
  - 利用[神经网络进行识别的算法](https://zh.wikipedia.org/wiki/神经网络 "wikilink")（recognition
    algorithms using neural network）。
  - 利用[支持向量机进行识别的算法](../Page/支持向量机.md "wikilink")（recognition algorithms
    using SVM）。
...
[交通警察提醒牌_人脸识别.jpg](https://zh.wikipedia.org/wiki/File:交通警察提醒牌_人脸识别.jpg "fig:交通警察提醒牌_人脸识别.jpg")交通警察的人脸识别提醒牌\]\]
人脸识别的应用主要有：
  ...
  - [相机](https://zh.wikipedia.org/wiki/相机 "wikilink")：新型的[数码相机已内建人脸识别功能以辅助拍摄人物时](../Page/数码相机.md "wikilink")[对焦](../Page/对焦.md "wikilink")。
  - [智能手機](https://zh.wikipedia.org/wiki/智能手機 "wikilink")：解鎖手機、識別使用者，如[Android](../Page/Android.md "wikilink")
    4.0以上，iPhone X。
  - [人证核验一体机](https://zh.wikipedia.org/wiki/人证核验一体机 "wikilink")：核验持证人和证件照是不是同一个人，主要用在酒店前台、税务局、医院等。

## 相关计算机语言

  - [MatLab](../Page/MATLAB.md "wikilink")：Matlab\[2\]是一种独立的编程语言，它有自己的框架和[集成开发环境](../Page/集成开发环境.md "wikilink")（IDE），具有更强大的工作空间。该[编程语言提供了广泛的工具](../Page/编程语言.md "wikilink")，你可以使用它们轻松处理更多技术编程任务。图像识别和面部处理是Matlab可以处理的一些任务。Matlab提供了一系列用于矩阵计算的内置工具。必须注意的是，图像识别和[矩阵计算是齐头并进的](https://zh.wikipedia.org/wiki/矩阵运算 "wikilink")。Matlab中可用的一些工具以执行复杂的图像处理任务，例如裁剪、旋转、掩蔽等。
  - Python：目前，Python被认为一种目前最流行的编程语言。其简单性和多功能性是许多程序员喜欢使用它的一些原因。尽管很简单，但Python是一种可以依赖于执行复杂任务的语言。它可用于创建图像处理和识别功能。
  - [C](https://zh.wikipedia.org/wiki/C语言 "wikilink") / [C
    ++](../Page/C++.md "wikilink") /
    [C＃](../Page/C♯.md "wikilink")：它们功能强大，可以做任何事情，包括创建图像处理和识别功能。C系列编程语言提供了两种创建图像处理功能的选项。使用者可以选择从头开始对所有代码进行编码，从而手动编写代码。第二种选择是使用专为这些编程语言设计的现有库。这些库包括OpenGL、EmguCV、OpenCV等等。它们具有用于图像识别的智能图像处理功能。
  - [JAVA](../Page/Java.md "wikilink")：像C和C
    ++一样，永远不要低估Java编程语言的强大功能\[3\]。这种语言足以执行复杂的功能。它可用于创建图像处理和图像识别的应用程序。
  - [OpenCV](../Page/OpenCV.md "wikilink")：开源计算机视觉（OpenCV）\[4\]是一种用于实时处理的高级工具。它也是一种跨平台工具，因此可以集成到任何编程语言中，以执行图像处理和识别功能。它可以与C、C
    ++、Java、Python和Android编程语言集成。
...
[Category:模式识别](https://zh.wikipedia.org/wiki/Category:模式识别 "wikilink")

[Category:生物识别技术](https://zh.wikipedia.org/wiki/Category:生物识别技术 "wikilink")

1.  StanZ.Li．Handbook of face
    recognition：LibraryofCongressCataloging-in-PublicationData，2004052453
2.
3.
4.
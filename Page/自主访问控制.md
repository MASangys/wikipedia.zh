在[计算机安全](../Page/计算机安全.md "wikilink")中，**自主访问控制**由《可信计算机系统评估准则》<ref> {{ cite book
...
1.  <http://fedoraproject.org/wiki/Features/RemoveSETUID> – Fedora 15 set to remove SETUID in favor of (Linux kernel) capabilities
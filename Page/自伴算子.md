...
在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，**自伴算子**，又稱為**自伴算符**，或**厄米算符**（），是一種等於自己的[厄米共軛的](https://zh.wikipedia.org/wiki/厄米共軛 "wikilink")[算符](../Page/算符.md "wikilink")。給予算符\(\hat{O}\,\!\)和其[伴隨算符](https://zh.wikipedia.org/wiki/伴隨算符 "wikilink")\(\hat{O}^{\dagger}\,\!\)，假設\(\hat{O}=\hat{O}^{\dagger}\,\!\)

在[信息论中](../Page/信息论.md "wikilink")，**自信息**（），由[克勞德·夏農提出](https://zh.wikipedia.org/wiki/克勞德·夏農 "wikilink")，是与概率空间中的單一事件或离散随机变量的值相关的資訊量的量度。它用信息的單位表示，例如
...
\(C\)是两个[独立事件](https://zh.wikipedia.org/wiki/统计独立性 "wikilink")

**自动密钥密码**是[密码学中的一种加密算法](../Page/密码学.md "wikilink")，与[维吉尼亚密码类似](../Page/维吉尼亚密码.md "wikilink")，区别在于[密钥不同](../Page/密钥.md "wikilink")。它的密钥开头是一个关键词，之后则是[明文的重复](https://zh.wikipedia.org/wiki/明文 "wikilink")。\[1\]

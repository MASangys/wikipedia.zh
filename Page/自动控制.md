...
**自動化控制**（）屬於[自動化技術的一門](https://zh.wikipedia.org/wiki/自動化技術 "wikilink")，廣義來說，通常是指不需藉著人力親自操作機器或機構，而能利用動物以外的其他裝置元件或能源，來達成人類所期盼執行的工作。更狹義地說即是以生化、機電、電腦、通訊、水力、蒸汽等科學知識與應用工具，進行設計來代替人力或減輕人力或簡化人類工作程序的機構機制，皆可稱之\[1\]。
...
自动控制是[工程科学的一个分支](https://zh.wikipedia.org/wiki/工程科学 "wikilink")。它涉及利用[反馈原理的对动态系统的自动影响](../Page/反馈.md "wikilink")，以使得输出值接近我们想要的值。从方法的角度看，它以数学的[系统理论为基础](https://zh.wikipedia.org/wiki/系统理论 "wikilink")。我们今天称作自动控制的是二十世纪中叶产生的控制论的一个分支。基础的结论是由[诺伯特·维纳](https://zh.wikipedia.org/wiki/诺伯特·维纳 "wikilink")、[鲁道夫·卡尔曼提出的](../Page/鲁道夫·卡尔曼.md "wikilink")。
...
自动控制有着一段引人入胜的历史。最初的[控制器在公元前](https://zh.wikipedia.org/wiki/控制器 "wikilink")300年的[古希腊就被发明了出来](../Page/古希腊.md "wikilink")。来自[埃及的古希腊工程师](../Page/埃及.md "wikilink")[科泰西比奥斯的](https://zh.wikipedia.org/wiki/科泰西比奥斯 "wikilink")[水鐘就是通过浮子控制的](https://zh.wikipedia.org/wiki/水鐘 "wikilink")。[比赞兹在公元前](https://zh.wikipedia.org/wiki/比赞兹 "wikilink")250年发明了油灯，通过浮子来控制油-{面}-的高度。
...
线性[常微分方程是](../Page/常微分方程.md "wikilink")[时域内的基础的连续模型](https://zh.wikipedia.org/wiki/时域 "wikilink")。通过引入一些变量，我们可以得到[状态空间模型](../Page/状态空间.md "wikilink")（只含有一阶求导），状态空间模型描述了系统的所有动力学特性，包括其内部无法测得，而且也不是输出值的量。
...
[伯德图可使](https://zh.wikipedia.org/wiki/伯德图 "wikilink")[传递函数显而易见](../Page/传递函数.md "wikilink")。
...
自動化控制系統的研究，幾乎涵蓋所有應用科學知識與技術的結合，領域範圍及牽涉的科學知識與應用工具相當廣泛，作为交叉学科，自动控制与其他很多学科有关联，尤其是[数学和](../Page/数学.md "wikilink")[信息学](https://zh.wikipedia.org/wiki/信息学 "wikilink")，在[制造](https://zh.wikipedia.org/wiki/制造 "wikilink")，[医药](https://zh.wikipedia.org/wiki/医药 "wikilink")，[交通](../Page/交通.md "wikilink")，[机器人](../Page/机器人.md "wikilink")，以及[经济学](../Page/经济学.md "wikilink")，[社会学中的应用也都非常广泛](../Page/社会学.md "wikilink")。[飞机和](https://zh.wikipedia.org/wiki/飞机 "wikilink")[船舶中的自动驾驶](https://zh.wikipedia.org/wiki/船舶 "wikilink")，[汽车中的防抱死和速度控制器也都是典型的应用](../Page/汽车.md "wikilink")。
...
生產自動化控制，即是利用自動化的生產設備，一貫作業的生產方式，從事有效率的產品生產，我們稱之為工廠自動化控制。例如：
  ...
  - [電子工業](https://zh.wikipedia.org/wiki/電子工業 "wikilink")：產出各式各樣的消費電子產品，如[電視機](https://zh.wikipedia.org/wiki/電視機 "wikilink")、[伴唱機](https://zh.wikipedia.org/wiki/伴唱機 "wikilink")、[照相機等](../Page/照相機.md "wikilink")。
...
[辦公室自動化控制](../Page/辦公室.md "wikilink")，即利用軟體程式技術及應用，將辦公室的文書資料或文書檔案，做有效率的管理，並結合[傳真機](https://zh.wikipedia.org/wiki/傳真機 "wikilink")、[電話機](https://zh.wikipedia.org/wiki/電話機 "wikilink")、[影印機](https://zh.wikipedia.org/wiki/影印機 "wikilink")、[電腦等迅速地處理文書資料或文書檔案](https://zh.wikipedia.org/wiki/電腦 "wikilink")，以提供承辦人或決策主管參考。\[8\]

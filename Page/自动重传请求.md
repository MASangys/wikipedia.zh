...
Controller，[RNC](https://zh.wikipedia.org/wiki/RNC "wikilink")），使用安置在协议数据单元（Protocol
Data
Unit，[PDU](https://zh.wikipedia.org/wiki/PDU "wikilink")）前的序号来作为是否有封包丢失的依据，有不少的延迟时间。

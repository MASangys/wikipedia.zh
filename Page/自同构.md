...
## 例子
  ...
  - 在[集合論中](https://zh.wikipedia.org/wiki/集合論 "wikilink")，一個集合*X*的元素的任一個[置換是一個自同構](../Page/置換.md "wikilink")。*X*的自同構群也稱為*X*上的[對稱群](https://zh.wikipedia.org/wiki/對稱群 "wikilink")。
  ...
  - 群自同構是一個群到自身的[群同態](../Page/群同態.md "wikilink")。非正式而言，這是一個使得結構不變的群元素置換。對任何群*G*，有一個自然群同態*G*
    →
    Aut(*G*)，其[像是](https://zh.wikipedia.org/wiki/像_\(數學\) "wikilink")[內自同構群Inn](https://zh.wikipedia.org/wiki/內自同構群 "wikilink")(*G*)，其[核是](https://zh.wikipedia.org/wiki/核_\(代數\) "wikilink")*G*的[中心](https://zh.wikipedia.org/wiki/中心_\(群論\) "wikilink")。因此若*G*有[平凡中心](https://zh.wikipedia.org/wiki/平凡群 "wikilink")，則可以嵌入到其自同構群之中。<ref name=Pahl>

</ref>

  - 在[線性代數中](https://zh.wikipedia.org/wiki/線性代數 "wikilink")，[向量空間](https://zh.wikipedia.org/wiki/向量空間 "wikilink")*V*的一個自同態是一個[線性算子](https://zh.wikipedia.org/wiki/線性變換 "wikilink")
    *V* →
    *V*。一個自同構是*V*上的一個可逆線性算子。當向量空間*V*是有限維的，其自同構群即是[一般線性群GL](https://zh.wikipedia.org/wiki/一般線性群 "wikilink")(*V*)。
  ...
  - 在[幾何學中](https://zh.wikipedia.org/wiki/幾何學 "wikilink")，空間的一個自同構有時稱為空間的。一些特定名詞也會使用：
      ...
      - 在[黎曼曲面範疇中](../Page/黎曼曲面.md "wikilink")，一個自同構是一個曲面到自身的映射（也稱為[共形映射](../Page/共形映射.md "wikilink")）。例如[黎曼球面的自同構是](../Page/黎曼球面.md "wikilink")[莫比烏斯變換](https://zh.wikipedia.org/wiki/莫比烏斯變換 "wikilink")。
...
群自同構的一個最早期的例子，是[愛爾蘭](https://zh.wikipedia.org/wiki/愛爾蘭 "wikilink")[數學家](https://zh.wikipedia.org/wiki/數學家 "wikilink")[威廉·哈密頓在](../Page/威廉·哈密頓.md "wikilink")1856年給出。在他的中，他發現了一個2階的自同構，\[3\]
寫道：
...
對群而言，[內自同構就是群本身的元素的](../Page/內自同構.md "wikilink")[共軛作用](https://zh.wikipedia.org/wiki/共軛類#作為群作用的共軛類 "wikilink")。對一個群*G*的每個元素*a*，以*a*共軛是一個運算*φ*<sub>*a*</sub>
: *G* → *G*，定義為*φ*<sub>*a*</sub>(*g*) =
*aga*<sup>−1</sup>（或*a*<sup>−1</sup>*ga*；用法各異）。易知以*a*共軛是一個群自同構。內自同構組成
Aut(*G*)的一個[正規子群](https://zh.wikipedia.org/wiki/正規子群 "wikilink")，記作Inn(*G*)。

其他的自同構稱為[外自同構](https://zh.wikipedia.org/wiki/外自同構 "wikilink")。[商群Aut](../Page/商群.md "wikilink")(*G*)

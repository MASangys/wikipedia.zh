...
雖然在原子核的[靜止參考系](https://zh.wikipedia.org/wiki/靜止參考系 "wikilink") () ，並沒有磁場；在電子的靜止參考系，有磁場存在。暫時假設電子的靜止參考系為[慣性參考系](https://zh.wikipedia.org/wiki/慣性參考系 "wikilink")，則根據[狹義相對論](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink")\[1\]，磁場 \(\mathbf{B}\,\!\) 是
...
其中，\(\gamma=\frac{g_s q_e}{2m}\,\!\) 是[迴轉磁比率](https://zh.wikipedia.org/wiki/迴轉磁比率 "wikilink") () ，\(\mathbf{S}\,\!\) 是自旋，\(g_s\,\!\) 是[電子自旋g因數](https://zh.wikipedia.org/wiki/電子自旋g因數 "wikilink")，\(q_e\,\!\) 是[電荷量](https://zh.wikipedia.org/wiki/電荷量 "wikilink")。

...
的[本徵函數](../Page/本徵函數.md "wikilink")形成的[基底](https://zh.wikipedia.org/wiki/基底 "wikilink")，使
\(H'\,\!\)
...
特別注意，當 \(l=0\,\!\)
時，這方程式會遇到[除以零](../Page/除以零.md "wikilink")的不可定義運算；雖然[分子項目](../Page/分數.md "wikilink")
\(j(j+1) - l(l+1) - 3/4=0\,\!\)
也等於零。零除以零，仍舊無法計算這方程式的值。很幸運地，在[精細結構](../Page/精細結構.md "wikilink")能量微擾的計算裏，這不可定義問題自動地會消失。事實上，當
\(l=0\,\!\)

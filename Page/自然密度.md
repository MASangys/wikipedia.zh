**自然密度**（），又称**渐进密度**（），是[数论中度量](../Page/数论.md "wikilink")[自然数](../Page/自然数.md "wikilink")[子集大小的工具之一](../Page/子集.md "wikilink")。

## 简介

以[平方数集和](../Page/平方数.md "wikilink")[自然数集的大小关系为例](../Page/自然数.md "wikilink")：
...
考虑自然数的一个子集\(A\)和[整数](../Page/整数.md "wikilink")[区间](https://zh.wikipedia.org/wiki/区间 "wikilink")\([1,n]\)：
  ...
  -
    如果从整数[区间](https://zh.wikipedia.org/wiki/区间 "wikilink")\([1,n]\)中[随机选取一个整数](https://zh.wikipedia.org/wiki/随机 "wikilink")，那么这个整数属于\(A\)的[概率应该等于](../Page/概率.md "wikilink")\(A\)与整数区间\([1,n]\)的交集中的所有元素在整数区间\([1,n]\)中的占比。当\(n\)趋近于[无穷时](../Page/无穷.md "wikilink")，若上述概率也趋近于某个[极限](../Page/极限_\(数学\).md "wikilink")，则将该极限定义为\(A\)的自然密度。
    \(A\)的自然密度也可以被理解为：任取一个自然数，该自然数属于\(A\)的概率。

自然密度（以及一些其他类型的密度）也是的研究对象。

与[施尼勒尔曼密度不同](../Page/施尼勒尔曼密度.md "wikilink")，并不是任何自然数的子集都有自然密度。这是自然密度的一个不足之处。
...
设\(A\)
是自然数集\(\mathbb{N}=\{1,2,\ldots\}\)的一个子集。对任何\(n\in\mathbb{N}\)，定义\(A(n)=\{1,2,\ldots,n\} \cap A\)，\(a(n)=|A(n)|\)。
...
其中\(\limsup\)是[上极限](../Page/上极限和下极限.md "wikilink")。
\(\overline{d}(A)\)也可简称为\(A\)的**上密度**。 
...
## 性质
  ...
  - [无平方数因数的数的集合的自然密度为](../Page/无平方数因数的数.md "wikilink")\(\frac{6}{\pi^2}\)。更一般地，无\(n\)次方因数的数的集合的自然密度为\(\frac{1}{\zeta(n)}\)，其中\(\zeta(n)\)是[黎曼ζ函數](../Page/黎曼ζ函數.md "wikilink")。
  - [过剩数集合具有非零的自然密度](../Page/过剩数.md "wikilink")\[3\]。Marc
    Deléglise在1998年证明了过剩数和[完全数的集合的自然密度在](../Page/完全数.md "wikilink")0.2474与0.2480之间\[4\]。
...
<!-- end list -->
  ...
  - 同样，所有[十进制表示法中以](../Page/十进制.md "wikilink")\(1\)开头的自然数的集合也不具有自然密度。其上自然密度为\(\frac 59\)而其下自然密度为\(\frac 19\)。\[5\]

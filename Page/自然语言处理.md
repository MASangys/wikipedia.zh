**自然語言處理**（，[缩写作](../Page/缩写.md "wikilink")
****）是[人工智慧和](../Page/人工智慧.md "wikilink")[語言學領域的分支學科](../Page/語言學.md "wikilink")。此領域探討如何處理及運用[自然語言](../Page/自然語言.md "wikilink")；自然語言處理包括多方面和步骤，基本有认知、理解、生成等部分。

自然語言認知和理解是讓電腦把输入的[語言变成有意思的符号和关系](../Page/語言.md "wikilink")，然后根据目的再處理。自然語言生成系統则是把計算機數據轉化為自然語言。

## 歷史

自然語言處理大體是從1950年代開始，雖然更早期也有作為。1950年，[图灵發表論文](../Page/图灵.md "wikilink")「」，提出現在所謂的「[圖靈測試](../Page/圖靈測試.md "wikilink")」作為判斷智能的條件。

1954年的涉及全部超過60句俄文成為英文。研究人員聲稱三到五年之內即可解決機器翻譯的問題。\[1\]不過實際進展遠低於預期，1966年的發現十年研究未達預期目標，機器翻譯的研究經費遭到大幅削減。一直到1980年代末期，[統計機器翻譯系統發展出來](../Page/統計機器翻譯.md "wikilink")，機器翻譯的研究才得以更上一層樓。

1960年代發展特別成功的NLP系統包括——一個詞彙設限、運作於受限如「[積木世界](../Page/積木世界.md "wikilink")」的一種自然語言系統，以及1964-1966年[约瑟夫·维森鲍姆模擬](../Page/约瑟夫·维森鲍姆.md "wikilink")「[個人中心治療](../Page/個人中心治療.md "wikilink")」而設計的——幾乎未運用人類思想和感情的訊息，有時候卻能呈現令人訝異地類似人之間的互動。「病人」提出的問題超出ELIZA
...
一直到1980年代，多數自然語言處理系統是以一套複雜、人工訂定的規則為基礎。不過從1980年代末期開始，語言處理引進了[機器學習的演算法](../Page/機器學習.md "wikilink")，NLP產生革新。成因有兩個：運算能力穩定增加（參見[摩爾定律](../Page/摩爾定律.md "wikilink")）；以及[喬姆斯基](../Page/喬姆斯基.md "wikilink")
語言學理論漸漸喪失主導（例如[轉換-生成文法](../Page/轉換-生成文法.md "wikilink")）。該理論的架構不傾向於[語料庫](../Page/語料庫.md "wikilink")——機器學習處理語言所用方法的基礎。有些最早期使用的機器學習演算法，例如[決策樹](../Page/決策樹.md "wikilink")，是硬性的、「如果-則」規則組成的系統，類似當時既有的人工訂定的規則。不過將[隱馬爾可夫模型引入NLP](../Page/隱馬爾可夫模型.md "wikilink")，並且研究日益聚焦於軟性的、以[機率做決定的](../Page/機率.md "wikilink")[統計模型](../Page/統計模型.md "wikilink")，基礎是將輸入資料裡每一個特性賦予代表其份量的數值。許多[語音識別現今依賴的](../Page/語音識別.md "wikilink")即是一種統計模型的例子。這種模型通常足以處理非預期的輸入數據，尤其是輸入有錯誤（真實世界的數據總免不了），並且在整合到包含多個子任務的較大系統時，結果比較可靠。

許多早期的成功屬於[機器翻譯領域](../Page/機器翻譯.md "wikilink")，尤其歸功IBM的研究，漸次發展出更複雜的統計模型。這些系統得以利用加拿大和歐盟現有的[語料庫](../Page/語料庫.md "wikilink")，因為其法律規定政府的會議必須翻譯成所有的官方語言。不過，其他大部分系統必須特別打造自己的語料庫，一直到現在這都是限制其成功的一個主要因素，於是大量的研究致力於從有限的數據更有效地學習。

近來的研究更加聚焦於[非監督式學習和](../Page/非監督式學習.md "wikilink")的演算法。這種演算法，能夠從沒有人工註解理想答案的資料裡學習。大體而言，這種學習比[監督學習困難](../Page/監督學習.md "wikilink")，並且在同量的數據下，通常產生的結果較不準確。不過沒有註解的數據量極巨（包含了[全球資訊網](../Page/全球資訊網.md "wikilink")），彌補了較不準確的缺點。

近年來, [深度學習技巧紛紛出爐](../Page/深度學習.md "wikilink")\[2\]\[3\]
在自然語言處理方面獲得最尖端的成果，例如語言模型\[4\]、語法分析\[5\]\[6\]等等。

## 任務和限制

理論上，NLP是一種很吸引人的人機交互方式。早期的语言处理系统如[SHRDLU](../Page/SHRDLU.md "wikilink")，当它们处于一个有限的“积木世界”，运用有限的词汇表会话时，工作得相当好。这使得研究员们对此系统相当乐观，然而，当把这个系统拓展到充满了现实世界的含糊与不确定性的环境中时，他们很快丧失了信心。
...
## 自然語言處理的主要範疇
  ...
  - [文本朗讀](../Page/文本朗讀.md "wikilink")（Text to
    speech）/[語音合成](../Page/語音合成.md "wikilink")（Speech
    synthesis）
  - [語音識別](../Page/語音識別.md "wikilink")（Speech recognition）
  - [中文自动分词](../Page/中文自动分词.md "wikilink")（Chinese word segmentation）
  - [词性标注](../Page/词性标注.md "wikilink")（Part-of-speech tagging）
  - [句法分析](../Page/句法分析.md "wikilink")（Parsing）
  - [自然語言生成](../Page/自然語言生成.md "wikilink")（Natural language generation）
  - [文本分类](../Page/文本分类.md "wikilink")（Text categorization）
  - [信息检索](../Page/信息检索.md "wikilink")（Information retrieval）
...
<!-- end list -->
  ...
  - [機器翻譯](../Page/機器翻譯.md "wikilink")（Machine translation）
...
<!-- end list -->
  ...
  - [自動摘要](../Page/自動摘要.md "wikilink")（Automatic summarization）
...
<!-- end list -->
  ...
  - [命名实体识别](../Page/命名实体识别.md "wikilink")（Named entity recognition）
...
### 單詞的邊界界定
  ...
  -
    在口語中，詞與詞之間通常是連貫的，而界定字詞邊界通常使用的辦法是取用能讓給定的上下文最為通順且在文法上無誤的一種最佳組合。在書寫上，[漢語也沒有詞與詞之間的邊界](../Page/漢語.md "wikilink")。
...
### 句法的模糊性
  ...
  -
    [自然語言的](../Page/自然語言.md "wikilink")[文法通常是](../Page/文法.md "wikilink")[模稜兩可的](../Page/模稜兩可.md "wikilink")，針對一個句子通常可能會[剖析](../Page/語法分析器.md "wikilink")（Parse）出多棵[剖析樹](../Page/剖析樹.md "wikilink")（Parse
    Tree），而我們必須要仰賴[語意及前後文的資訊才能在其中選擇一棵最為適合的剖析樹](../Page/語意.md "wikilink")。

### 有瑕疵的或不規範的輸入

  -
    例如語音處理時遇到外國口音或地方口音，或者在文本的處理中處理拼寫，語法或者[光學字元識別](../Page/光學字元識別.md "wikilink")（OCR）的錯誤。
...
統計自然語言處理運用了[推測學](../Page/推測學.md "wikilink")、[機率](../Page/機率.md "wikilink")、[統計的方法來解決上述](../Page/統計.md "wikilink")，尤其是針對容易高度模糊的長串句子，當套用實際文法進行分析產生出成千上萬筆可能性時所引發之難題。處理這些高度模糊句子所採用消歧的方法通常運用到[語料庫以及](../Page/語料庫.md "wikilink")[馬可夫模型](../Page/馬可夫模型.md "wikilink")（Markov
models）。統計自然語言處理的技術主要由同樣自[人工智慧下與學習行為相關的子領域](../Page/人工智慧.md "wikilink")：[機器學習及](../Page/機器學習.md "wikilink")[資料採掘所演進而成](../Page/資料採掘.md "wikilink")。
...
## 参见
  ...
  - [受限自然語言](../Page/受限自然語言.md "wikilink")

  - [信息抽取](../Page/信息抽取.md "wikilink")

  - [資訊檢索](../Page/資訊檢索.md "wikilink")

  - [自然語言理解](../Page/自然語言理解.md "wikilink")

  - [潛在語義索引](../Page/潛在語義索引.md "wikilink")

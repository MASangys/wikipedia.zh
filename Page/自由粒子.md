在[物理學裏](https://zh.wikipedia.org/wiki/物理學 "wikilink")，**自由粒子**是不被位勢束縛的[粒子](https://zh.wikipedia.org/wiki/粒子 "wikilink")。在[經典力學裏](https://zh.wikipedia.org/wiki/經典力學 "wikilink")，一個自由粒子所感受到外來的[淨力是](../Page/淨力.md "wikilink")0。

假若，一個粒子的[能量大於在任何地點](../Page/能量.md "wikilink")\(x\,\!\)的[位勢](https://zh.wikipedia.org/wiki/位勢 "wikilink")，\(E > V(x) \,\!\)，不會被位勢束縛，則稱此粒子為**自由粒子**。更強版的定義，還要求位勢為常數\(V(x)=V_0 \,\!\)。假若，一維空間分為幾個區域，只有在每個區域內，位勢為常數；在區域與區域之間，位勢不相等，則稱此粒子為**半自由粒子**。自由粒子或半自由粒子的能量大於位勢，\(E > V(x) \,\!\)，不會被位勢束縛，能量不是[離散能量譜的特殊值](https://zh.wikipedia.org/wiki/離散量 "wikilink")，而是大於或等於\(V_0\,\!\)的任意值。
...
在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，一個自由粒子的動量與能量不必須擁有特定的值。自由粒子的波函數以[波包函數表示為](../Page/波包.md "wikilink")
...
[相對論性的自由粒子的量子行為](https://zh.wikipedia.org/wiki/相對論 "wikilink")，需要用特別的方程專門描述：
  ...
  - [克莱因-戈尔登方程描述](../Page/克莱因-戈尔登方程.md "wikilink")[中性的](https://zh.wikipedia.org/wiki/中性粒子 "wikilink")，[自旋為零的](../Page/自旋.md "wikilink")，相對論性的自由粒子的量子行為。
  - [狄拉克方程描述相對論性的](https://zh.wikipedia.org/wiki/狄拉克方程 "wikilink")[電子](https://zh.wikipedia.org/wiki/電子 "wikilink")（[自旋為](../Page/自旋.md "wikilink")\(1/2\,\!\)）的量子行為。

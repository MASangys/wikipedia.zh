> 本文内容由[自由逻辑](https://zh.wikipedia.org/wiki/自由逻辑)转换而来。
...
在[经典逻辑](../Page/经典逻辑.md "wikilink")中，有些定理明确的假定在[论域中必须有东西](https://zh.wikipedia.org/wiki/论域 "wikilink")。考虑下列经典的有效定理。
...
非形式的，如果 F 是‘ =y’, G 是‘是天马’，而我们代换 y 为‘天马’，则 (4) 就允许我们从‘同一于天马的所有东西都是天马’推出某些东西同一于天马。问题来自把变量代换为无指派(nondesignating)的常量: 事实上，我们在[一阶逻辑](../Page/一阶逻辑.md "wikilink")的标准公式中不能这么做，因为这里没有无指派常量。古典上，∃x(x=y) 是通过特殊化(就是前面的(3))而演绎自开放等价公理 y=y。

...
**自相关**（），也叫**序列相关**\[1\]，是一个[信号于其自身在不同时间点的](../Page/信号_\(信息论\).md "wikilink")[互相关](../Page/互相关.md "wikilink")。非正式地来说，它就是两次观察之间的相似度对它们之间的时间差的函数。它是找出重复模式（如被噪声掩盖的周期信号），或识别隐含在信号[谐波频率中](https://zh.wikipedia.org/wiki/谐波 "wikilink")[消失的基頻的数学工具](../Page/消失的基頻.md "wikilink")。它常用于[信号处理中](https://zh.wikipedia.org/wiki/信号处理 "wikilink")，用来分析函数或一系列值，如[時域信号](https://zh.wikipedia.org/wiki/時域 "wikilink")。
...
多[维自相关定义类似](../Page/維度.md "wikilink")。例如，在[三维中](https://zh.wikipedia.org/wiki/三維空間 "wikilink")，
平方可和的[离散信号的自相关就会是](https://zh.wikipedia.org/wiki/离散信号 "wikilink")
...
<!-- end list -->
  ...
  - 连续型实自相关函数的峰值在[原点取得](https://zh.wikipedia.org/wiki/原点 "wikilink")，即对于任何延时
    *τ*，均有
...
<!-- end list -->
  ...
  - 连续时间[白噪声信号的自相关函数是一个](https://zh.wikipedia.org/wiki/白噪声 "wikilink")[δ函数](https://zh.wikipedia.org/wiki/δ函数 "wikilink")，在除
    τ = 0 之外的所有点均为0。

<!-- end list -->

  - [维纳-辛钦定理表明](https://zh.wikipedia.org/wiki/维纳-辛钦定理 "wikilink")，自相关函数和[功率谱密度函数是一对](https://zh.wikipedia.org/wiki/功率谱密度 "wikilink")[傅里叶变换对](../Page/傅里叶变换.md "wikilink")：

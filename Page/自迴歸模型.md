...
其中：\(c\)是[常數項](https://zh.wikipedia.org/wiki/常數 "wikilink")；\(\varepsilon_t\)被假設為[平均數等於](https://zh.wikipedia.org/wiki/平均數 "wikilink")0，[標準差](../Page/標準差.md "wikilink")等於\(\sigma\)的[隨機誤差值](https://zh.wikipedia.org/wiki/隨機 "wikilink")；\(\sigma\)被假設為對於任何的\(t\)都不變。

...
過往的Xeon跟Core一樣分為三個系列，另有加速卡Xeon Phi。只有部份Xeon E3、Xeon E、Xeon W提供內置[繪圖核心](https://zh.wikipedia.org/wiki/繪圖核心 "wikilink")，其餘均沒有iGPU。

四位數字型號的第一個數字代表最大的處理器數目，有單路、雙路、四路和八路。第二個數字代表[CPU插座](../Page/CPU插座.md "wikilink")類型，共有四種規格，第一代產品1、2、4、6、8分別代表[BGA 1284](https://zh.wikipedia.org/wiki/BGA_1284 "wikilink")、[LGA 1155](https://zh.wikipedia.org/wiki/LGA_1155 "wikilink")、[LGA 1356](../Page/LGA_1356.md "wikilink")、[LGA 2011和](../Page/LGA_2011.md "wikilink")[LGA 1567](../Page/LGA_1567.md "wikilink")。
...
一些DIY玩家會購買Xeon E3-1230代替Core i7，因為E3-12X0型號（E3-1260L除外）沒有iGPU（因为此类玩家多会另外购置显卡而不是采用iGPU），價錢較便宜。\[1\]在一般的主機板使用，ECC功能會被停用，PCI-E線道只能使用16條，而非全部20條。但從Xeon E3 V5開始，E3系列處理器已不支援Intel的桌上型晶片組，必須搭配Intel的伺服器晶片組才可使用。
...
Xeon E5共有五個子系列，入門的單路處理器系列E5-1400，高端的單路處理器系列E5-1600，入門級雙路處理器系列E5-2400，主流級雙路、四路處理器系列E5-2600及E5-4600，前兩者採用[LGA 1356](../Page/LGA_1356.md "wikilink")，後兩者採用[LGA 2011](../Page/LGA_2011.md "wikilink")。
...
**Nehalem-EX**內為八核心，支援HT技術，因此達十六執行緒。L3 Cache容量估計達16MB至32MB，內建電晶體更多達二十三億個。 [EX4_Chipset.png](https://zh.wikipedia.org/wiki/File:EX4_Chipset.png "fig:EX4_Chipset.png")

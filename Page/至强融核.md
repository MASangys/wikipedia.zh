...
程序设计工具包括[OpenMP](../Page/OpenMP.md "wikilink")，[OpenCL](../Page/OpenCL.md "wikilink")\[23\]。[Cilk](https://zh.wikipedia.org/wiki/Cilk "wikilink")/[Cilk Plus与英特尔的专门版的Fortran](https://zh.wikipedia.org/wiki/Cilk_Plus "wikilink"), C++编译器\[24\]与数学库。\[25\]Knights Corner指令集的文档可从英特尔网站获得。\[26\]\[27\]\[28\]

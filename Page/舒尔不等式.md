**舒尔不等式**说明，对于所有的非负实数*x*、*y*、*z*和[实数](../Page/实数.md "wikilink")*t*，都有：

\[x^t (x-y)(x-z) + y^t (y-z)(y-x) + z^t (z-x)(z-y) \ge 0\]

当且仅当*x = y =
z*，或其中两个数相等而另外一个为零时，等号“=”成立。当*t*是正的偶数时，不等式对所有的实数*x*、*y*和*z*都成立。
...
假设*a、b、c*是正的实数。如果*（a，b，c）*和*（x，y，z）*是[顺序的](../Page/顺序.md "wikilink")，则以下的不等式成立：
...
当*x* = *a*、*y* = *b*、*z* = *c*、*k* = 1、ƒ(*m*) =
*m*<sup>*r*</sup>时，即化为舒尔不等式。\[1\]

## 参考文献

[Category:代数不等式](https://zh.wikipedia.org/wiki/Category:代数不等式 "wikilink")

1.  Vornicu, Valentin; *Olimpiada de Matematica... de la provocare la
    experienta*; GIL Publishing House; Zalau, Romania.
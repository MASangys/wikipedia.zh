在[线性代数中](../Page/线性代数.md "wikilink")，**舒尔分解**或**舒尔上三角化**是一种[矩阵分解方法](https://zh.wikipedia.org/wiki/矩阵分解 "wikilink")，得名于[德国](../Page/德国.md "wikilink")[数学家](../Page/数学家.md "wikilink")。
...
\[A = Q U Q^{-1}\]
即任何一个*n*阶复方阵A酉相似于一个*n*阶上三角矩阵U。因为A，U相似，所以两者有相同的[特征值](https://zh.wikipedia.org/wiki/特征值 "wikilink")，且相同特征值的[代数重数也相同](https://zh.wikipedia.org/wiki/代数重数 "wikilink")。又因U是上三角矩阵，所以U的对角元素实际上是A的所有特征值。

该定理表明，存在**C**<sup>*n*</sup>的一个[线性子空间序列](../Page/线性子空间.md "wikilink"){0}
= *V*<sub>0</sub> ⊂ *V*<sub>1</sub> ⊂ ... ⊂ *V<sub>n</sub>* =
**C**<sup>*n*</sup>，使得其中的每一个都是A（看成[线性变换](https://zh.wikipedia.org/wiki/线性变换 "wikilink")）的[不变子空间](../Page/不变子空间.md "wikilink")。且存在**C**<sup>*n*</sup>（指定标准[内积](https://zh.wikipedia.org/wiki/内积 "wikilink")）的一组单位酉正交基，使得前i个基向量张成上述序列中第i个子空间。\[4\]

## 定理的证明

### 以线性变换思想

把矩阵A看成是有限维[酉空间](https://zh.wikipedia.org/wiki/酉空间 "wikilink")**C**<sup>*n*</sup>上的[线性变换](https://zh.wikipedia.org/wiki/线性变换 "wikilink")，它有[特征值](https://zh.wikipedia.org/wiki/特征值 "wikilink")*λ*，所对应的[特征子空间为](https://zh.wikipedia.org/wiki/特征子空间 "wikilink")*V<sub>λ</sub>*，令*V<sub>λ</sub>*<sup>⊥</sup>
为它的[正交补空间](../Page/正交补.md "wikilink")。分别取两个空间的一组单位正交基(Z<sub>1</sub>，Z<sub>2</sub>)，它们构成原空间的一组单位正交基，则线性变换A在这组基下的矩阵表出为：
...
给定矩阵A和B，则存在[酉矩阵Q](../Page/酉矩阵.md "wikilink")、Z，上三角矩阵S、T，使得\(A=QSZ^{-1}\)和\(B=QTZ^{-1}\)同时成立。这被称为广义舒尔分解，有时也被称为QZ分解。\[10\]

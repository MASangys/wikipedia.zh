在[数学](../Page/数学.md "wikilink")中，**舒尔引理**（）是[群](../Page/群.md "wikilink")与[代数](../Page/代数.md "wikilink")的[表示论](../Page/表示论.md "wikilink")中一个初等但非常有用的命题。在群的情形是说，如果*M*与*N*是群*G*的两个有限维[不可约表示](https://zh.wikipedia.org/wiki/不可约表示 "wikilink")，*φ*是从*M*到*N*的与[群作用](../Page/群作用.md "wikilink")可交换的线性映射，那么*φ*
...
舒尔引理经常用于下面这个特例。假设*R*是复数域**C**上的[代数](../Page/代数.md "wikilink")以及*M* =

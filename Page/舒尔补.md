在[线性代数与](../Page/线性代数.md "wikilink")[矩阵论中](https://zh.wikipedia.org/wiki/矩阵论 "wikilink")，一个[矩阵的](../Page/矩阵.md "wikilink")[子矩阵之](../Page/子式和余子式.md "wikilink")**舒尔补**是一个与其[余子阵同样大小的矩阵](../Page/子式和余子式.md "wikilink")，定义如下：假设一个

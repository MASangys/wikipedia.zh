...
\(u(x, y, t)_t+v(x, t)_x+1.0*u(x, y, t)*(u(x, y, t)_x) = 0\)

\(v(x, t)_{xt}+u(x, y, t)_{xx}*v(x, t)+2*u(x, y, t)_x*v(x, t)_x+u(x, y, t)*(v(x, t)_{xx}+u(x, y, t)_{xx}+u(x, y, t)_{xxxx}+u(x, y, t)_{yy} = 0\)
...
1.  N. Taghizadeha, M. Mirzazadeha, or, Filiz Tascanb：The first-integral
    method applied to the Eckhaus equation,Applied Mathematics
    Letters,Volume 25, Issue 5, May 2012, Pages 798–802
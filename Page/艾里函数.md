...
命名的[特殊函数](https://zh.wikipedia.org/wiki/特殊函数 "wikilink")，他在1838年研究[光学的时候遇到了这个函数](../Page/光学.md "wikilink")。Ai(*x*)的记法是Harold
Jeffreys引进的。Ai(*x*)与相关函数Bi(*x*)（也称为艾里函数），是以下[微分方程的解](../Page/微分方程.md "wikilink")：
...
\end{align}\]
在这里，\[{\Gamma}\]表示[伽玛函数](https://zh.wikipedia.org/wiki/伽玛函数 "wikilink")。可以推出Ai(*x*)和Bi(*x*)的[朗斯基行列式是](../Page/朗斯基行列式.md "wikilink")\(\frac{1}{\pi}\)
。
...
当自变量是负数时，艾里函数与[贝塞尔函数之间有以下的关系](../Page/贝塞尔函数.md "wikilink")：

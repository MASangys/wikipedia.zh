**艾里函数**（Ai(*x*)），[英国](../Page/英国.md "wikilink")[英格蘭](../Page/英格蘭.md "wikilink")[天文学家](../Page/天文学家.md "wikilink")、[數學家](../Page/數學家.md "wikilink")[喬治·比德爾·艾里](../Page/喬治·比德爾·艾里.md "wikilink")
命名的[特殊函数](../Page/特殊函数.md "wikilink")，他在1838年研究[光学的时候遇到了这个函数](../Page/光学.md "wikilink")。Ai(*x*)的记法是Harold
...
虽然这个函数不是绝对[可积的](../Page/勒贝格积分.md "wikilink")（当*t*趋于+∞时积分表达式不趋于零），这个[广义积分还是收敛的](../Page/广义积分.md "wikilink")，因为它快速振动的正数和负数部分倾向于互相抵消（这可以用[分部积分法来检验](../Page/分部积分法.md "wikilink")）。

把\[y= Ai(x)\]求导，我们可以发现它满足以下的微分方程：

\[y'' - xy = 0 . \,\!\]

这个方程有两个[线性独立的解](../Page/线性独立.md "wikilink")。除了\[Ai(x)\]以外，另外一个解称为第二艾里函数，记为\(Bi(x)\)。它定义为当*x*趋于−∞时，振幅与\(Ai(x)\)相等，但相位与\(Ai(x)\)相差\(\frac{\pi}{2}\)
的函数：
...
\end{align}\]
在这里，\[{\Gamma}\]表示[伽玛函数](../Page/伽玛函数.md "wikilink")。可以推出Ai(*x*)和Bi(*x*)的[朗斯基行列式是](../Page/朗斯基行列式.md "wikilink")\(\frac{1}{\pi}\)
。
...
当自变量是正数时，艾里函数与[变形贝塞尔函数之间有以下的关系](../Page/贝塞尔函数#变形贝塞尔函数.md "wikilink")：
...
[Scorer函数是](../Page/Scorer函数.md "wikilink")\(y'' - xy = 1/\pi\)的解，它也可以用艾里函数来表示：

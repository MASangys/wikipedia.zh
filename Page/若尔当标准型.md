...
matrix)，這矩陣接近[对角矩阵](https://zh.wikipedia.org/wiki/对角矩阵 "wikilink")：除了主[对角线和主对角线上方元素之外](https://zh.wikipedia.org/wiki/对角线 "wikilink")，其餘都是零且主對角線上方的對角線的係數若不為零-{只}-能為\(1\)，且這\(1\)左方和下方的係數（都在主對角線上）有相同的值。[谱定理和](../Page/谱定理.md "wikilink")[正规矩阵都是若尔当标准型的特殊情况](../Page/正规矩阵.md "wikilink")，因為可以被對角化(diagonalizable)。若尔当矩阵理论说明了任何一个[系数](https://zh.wikipedia.org/wiki/系数 "wikilink")[域为](https://zh.wikipedia.org/wiki/域 "wikilink")\(\mathbb{K}\)的[方块矩阵](../Page/方块矩阵.md "wikilink")\(M\)如果[特征值都在](https://zh.wikipedia.org/wiki/特征值 "wikilink")\(\mathbb{K}\)中，那么必然和某个若尔当标准型[相似](https://zh.wikipedia.org/wiki/相似矩阵 "wikilink")。或者说，如果一个有限維[向量空間上的](https://zh.wikipedia.org/wiki/向量空間 "wikilink")[自同态線性映射的](../Page/自同态.md "wikilink")[特征值都在系数域](https://zh.wikipedia.org/wiki/特征值 "wikilink")\(\mathbb{K}\)中，那么它可以在某个[基底下表示成若尔当标准型](https://zh.wikipedia.org/wiki/基底 "wikilink")。

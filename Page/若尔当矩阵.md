在[数学](../Page/数学.md "wikilink")中，特别是[矩阵论裡](https://zh.wikipedia.org/wiki/矩阵论 "wikilink")，**若尔当矩阵**是[矩阵](../Page/矩阵.md "wikilink")的一种，又称**若尔当块**（作为另一个矩阵的一部分时）。当[系数取在某个](https://zh.wikipedia.org/wiki/系数 "wikilink")[环](../Page/环_\(代数\).md "wikilink")\(\displaystyle R\)
上时（其中的[零元和](https://zh.wikipedia.org/wiki/单位元 "wikilink")[乘法](../Page/乘法.md "wikilink")[单位元分别记为](https://zh.wikipedia.org/wiki/单位元 "wikilink")[0](../Page/0.md "wikilink")和[1](../Page/1.md "wikilink")），若尔当矩阵可以写成如下形式：

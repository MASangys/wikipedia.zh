[右](https://zh.wikipedia.org/wiki/File:RAID_MATRIX.png "fig:右") **英特尔快速存储技术（RST）**，前身为在2012年出现的**Matrix RAID**，是一个由[固件](../Page/韌體.md "wikilink")、[硬件](../Page/硬件.md "wikilink")和[软件](../Page/软件.md "wikilink")组成的[RAID](../Page/RAID.md "wikilink")系统。 该软件监控RAID功能的重要部分，例如已连接设备的[S.M.A.R.T.](../Page/S.M.A.R.T..md "wikilink")参数；能够检测设备和RAID是否运行在正常状态。[芯片组](../Page/芯片组.md "wikilink")和[BIOS](../Page/BIOS.md "wikilink")版本必须符合RST版本，这是因为旧版本在S.M.A.R.T监控支持方面可能会有些问题。当然，RST支持的芯片组也会随着每次RST的更新而改变。
...
英特尔快速存储技术支持[Windows 7和更新版本的](https://zh.wikipedia.org/wiki/Windows_7 "wikilink")[Windows系统](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")。旧的英特尔Matrix RAID仅支持[Windows XP 系统](https://zh.wikipedia.org/wiki/Microsoft_Windows_XP "wikilink")。

...
英特爾原來的8051系列的開發利用 [NMOS](https://zh.wikipedia.org/wiki/NMOS "wikilink")
技術，但後來的版本中，在其名称加入字母C（例如，80C51），確定使用
[CMOS技术](https://zh.wikipedia.org/wiki/CMOS "wikilink")，这样比NMOS节能源。这使它们更适合于电池供电设备。

## 主要功能及特性

8051在单一的封装中提供很多功能（包括CPU,RAM,ROM,输入输出，中断，时钟等）。

8051能夠達到以一般[工業配線盤更小的體積](https://zh.wikipedia.org/wiki/工業配線盤 "wikilink")，來達成[自動控制作業](https://zh.wikipedia.org/wiki/自動控制 "wikilink")，如感測訊號的擷取、循序控制等，它皆能輕易的完成。
...
[Intel_8051_arch.svg](https://zh.wikipedia.org/wiki/File:Intel_8051_arch.svg "fig:Intel_8051_arch.svg")
  ...
  - 1
    組[全雙工](https://zh.wikipedia.org/wiki/全雙工 "wikilink")[串列埠](https://zh.wikipedia.org/wiki/串列埠 "wikilink"){{〈}}UART{{〉}}。
...
## 89C2051
  ...
  - 在2.7 V - 6V 均可运作
  - 静态模式下支持的[时钟频率](https://zh.wikipedia.org/wiki/时钟 "wikilink"): 0 Hz to
    24 MHz
  - 两重对程序的加锁位
  - 内部的 [RAM](https://zh.wikipedia.org/wiki/隨機存取記憶體 "wikilink") 大小为 128
    x 8 Bit.
  - 15 个可[编程的](https://zh.wikipedia.org/wiki/编程 "wikilink")
    [I/O](https://zh.wikipedia.org/wiki/I/O "wikilink") 口线
...
Intel原廠發行過的型號
  ...
  - 8031、8032
      - 無 ROM，只有
        [RAM](https://zh.wikipedia.org/wiki/隨機存取記憶體 "wikilink")（資料記憶體），需外接程式記憶體，EA須接地。
...
<!-- end list -->
  ...
  - 8751、8752
      - 此為[EPROM型](https://zh.wikipedia.org/wiki/EPROM "wikilink")，在IC包裝（晶片的外殼）上有設置有石英玻璃的透明窗口者，可用工業級的紫外線燈，照射窗口內的晶片10\~30分鐘以清除資料，就能再重新燒錄。此型為工程師設計用或小量生產打樣用。由於有窗口的陶瓷包裝比較貴，所以其後也有出品無窗口的[樹脂包裝](https://zh.wikipedia.org/wiki/樹脂 "wikilink")，因為對晶片廠而言，不管有沒有窗口，裡面的晶片都一樣，故稱無窗口的為
        [OTP](https://zh.wikipedia.org/wiki/可擦除可規劃式唯讀記憶體#OTP_EPROM "wikilink")（一次燒錄型）的8751。因為對使用者而言，OTP的使用方式，就跟[PROM一樣](https://zh.wikipedia.org/wiki/PROM "wikilink")，所以也有人稱為
        PROM 型的 8751。

### 衍生型號

為Intel授權其他廠商[智慧財產權核心](https://zh.wikipedia.org/wiki/智慧財產權核心 "wikilink")（IP
core）衍生開發的型號
...
<!-- end list -->
  ...
  - AT89S51、AT89S52
      - 有 ROM（[EEPROM](https://zh.wikipedia.org/wiki/EEPROM "wikilink")
        或 [Flash memory](../Page/闪存.md "wikilink")），可重複燒錄，用電氣信號清除
        (5V)，可用 [ISP Flash Microcontroller
        Programmer](https://zh.wikipedia.org/wiki/ISP_Flash_Microcontroller_Programmer "wikilink")
...
## 外部連結
  ...
  - [e8051](https://web.archive.org/web/20110207140553/http://e8051.com/)
    -
    一種軟核型態，專用於[FPGA或](https://zh.wikipedia.org/wiki/FPGA "wikilink")[ASIC的高速型](../Page/特殊應用積體電路.md "wikilink")8051

[Van_der_Corput_sequence_999.svg](https://zh.wikipedia.org/wiki/File:Van_der_Corput_sequence_999.svg "fig:Van_der_Corput_sequence_999.svg") **范德科皮特序列**（）是定义在[单位区间上的一维](https://zh.wikipedia.org/wiki/单位区间 "wikilink")，由荷兰数学家于1935年提出。将以基数b表示的[自然数](../Page/自然数.md "wikilink")列反转后便可得到范德科皮特序列。

使用基数b可将自然数*n*表示为

\[n=\sum_{k=0}^{L-1}d_k(n)b^k,\] 其中第k位为*d*<sub>*k*</sub>(*n*)，满足0 ≤ *d*<sub>*k*</sub>(*n*) \< *b*。

**范德华方程**（**van der Waals
equation**）（一译**范德-{}-瓦耳斯方程**），简称**范氏方程**，是[荷兰](../Page/荷兰.md "wikilink")[物理学家](../Page/物理学家.md "wikilink")[范德华于](https://zh.wikipedia.org/wiki/范德华 "wikilink")1873年提出的一种[实际气体状态方程](https://zh.wikipedia.org/wiki/狀態方程 "wikilink")。范氏方程是对[理想气体状态方程的一种改进](../Page/理想气体状态方程.md "wikilink")，特点在于将被[理想气体模型所忽略的的气体分子自身大小和分子之间的相互作用力考虑进来](../Page/理想氣體.md "wikilink")，以便更好地描述气体的[宏观物理性质](https://zh.wikipedia.org/wiki/宏观 "wikilink")。
...
在第二个方程裡
  ...
  - \(N_A\)
    为[阿伏加德罗常數](https://zh.wikipedia.org/wiki/阿伏加德罗常數 "wikilink").
...
在上述方程中必须严格区分总体平均性质和单个分子的性质。譬如，第一个方程中的\(v\)是每个分子平均占有空间的大小（可以理解成分子平均“势力范围”的大小），而\(b'\)则为单个分子本身“包含”的体积（若为单原子分子如[稀有气体](../Page/稀有气体.md "wikilink")，\(b'\)就是[原子半径内包含的体积](../Page/原子半径.md "wikilink")）。
...
在这里，每个分子的“占有体积”\(v\)被所谓“排斥体积”\(v-b\)代替，反映了分子在空间中不能重叠。若气体被压缩至体积接近分子体积之和（即分子间空隙\(v-b\)趋向于0），那么其压强将趋于[无穷大](../Page/无穷.md "wikilink")。

下一步，我们考虑原子对之间的引力。引力的存在会使分子的平均[亥姆霍兹自由能下降](https://zh.wikipedia.org/wiki/亥姆霍兹自由能 "wikilink")，减少量正比于流体的[密度](../Page/密度.md "wikilink")。但压强的大小满足热力学关系
...
在气体[压强不太高的情况下](../Page/压强.md "wikilink")，以下事实成立：

  - 排斥体积\(b\)的影响相对\(V\)而言极小，可以忽略；以[二氧化碳](../Page/二氧化碳.md "wikilink")（<chem>CO2</chem>）为例，在标准状况（0°C，1[标准大气压](../Page/气压.md "wikilink")）下，1[mol](../Page/摩尔_\(单位\).md "wikilink")<chem>CO2</chem>体积\(V\)为
    22414cm³，而相应的\(b=43\)cm³，比\(V\)小3个数量级；
...
右图所示为用范氏方程模拟的<chem>CO2</chem>在不同温度下的*p-V*
等温线，从中可以明显看出范氏方程对液化过程的模拟（注意：若用理想气体状态方程作上述模拟，得到的只是一系列[双曲线](../Page/双曲线.md "wikilink")，因为在等温条件下理想气体状态方程就退化为[玻意耳-马略特定律](../Page/玻意耳-马略特定律.md "wikilink")——*pV*=常数）。<chem>CO2</chem>气体的临界温度为\(T_C=31\)°C\(=304\)K。

  - 70°C
    时的曲线（右图中蓝线）形状仍与[玻意耳定律的结果](../Page/罗伯特·波义耳.md "wikilink")（双曲线）类似，尽管位置要略低；
  ...
  - 图中13°C 和 21°C
    对应的曲线只有两拐点以外的部分是与物理实际相符的。当气体被进一步压缩至比右拐点对应体积更小时，气体将进入液化区，在液化过程中实际气体的p-V线应是一段“平台”，而不是如图所示的“驼峰”型。但完全液化后，液态<chem>CO2</chem>的压强却仍能被图中曲线恰当地反映，此时曲线随体积的减小而剧烈上升，这一定程度上反映了液体的[不可压缩性](https://zh.wikipedia.org/wiki/不可压缩性 "wikilink")。另外，我们从图中能得到的另一个信息就是“液化平台”的长度随温度的下降而增加；
...
式中\(A\)为亥姆霍兹自由能，\(\hat{c}_v\)是无量纲的[定容热容](https://zh.wikipedia.org/wiki/定容热容 "wikilink")，\(\Phi\)是待定的[熵常数](../Page/熵.md "wikilink")。上述方程将\(A\)用它的[自然变量](https://zh.wikipedia.org/wiki/自然变量 "wikilink")\(V\)和\(T\)表示，所以系统的所有热力学信息已全部知道。其力学状态方程就是前面导出的范氏方程
...
\=Nk\\left\[
\\ln\\left(\\frac{(V-Nb)T^{\\hat{c}_V}}{N\\Phi}\\right)+\\hat{c}_V+1
\\right\]</math>
...
其他[热力学势和](https://zh.wikipedia.org/wiki/热力学函数 "wikilink")[化学势也可用类似的方程给出](../Page/化学势.md "wikilink")，但任何势函数若要用压强\(P\)表示都需要求解一个三阶多项式，使结果的形式变得很繁杂。所以，将[焓和](../Page/焓.md "wikilink")[吉布斯能用它们相应的自然变量表示的结果都是复杂的](../Page/吉布斯能.md "wikilink")（因为\(P\)是它们的自然变量之一）。
...
在[流体力学中](../Page/流体力学.md "wikilink")，范氏方程可以作为可压缩流体（如液态[高分子材料](../Page/高分子材料.md "wikilink")）的[PVT状态方程](https://zh.wikipedia.org/wiki/PVT状态方程 "wikilink")。这种情况下，由于[比容](https://zh.wikipedia.org/wiki/比容 "wikilink")\(V\)变化不大，可将方程简化为：
...
## 外部链接
  ...
  - [不同气体的范氏常数*a*
    和*b*](https://web.archive.org/web/20060504071400/http://www.ac.wwu.edu/%7Evawter/PhysicsNet/Topics/Thermal/vdWaalEquatOfState.html)

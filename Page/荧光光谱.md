**荧光光谱**是指某些物质经某波长入射[光照射后](../Page/光.md "wikilink")，分子从能级S<sub>a</sub>被激发至能级S<sub>b</sub>，并在很短时间内[去激发从S](https://zh.wikipedia.org/wiki/去激发 "wikilink")<sub>b</sub>返回S<sub>a</sub>，发出[波长长于入射光的](../Page/波长.md "wikilink")[荧光](../Page/荧光.md "wikilink")。

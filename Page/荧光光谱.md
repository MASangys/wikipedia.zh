...
S<sub>b</sub>的[辐射](../Page/辐射.md "wikilink")寿命为（此处参考[指数衰减](../Page/指数衰减.md "wikilink")）

\[\tau_R=\frac{1}{A_{ba}}\]
此仅当吸收的光子和随后发射的[光子](../Page/光子.md "wikilink")相同时候有效，即全部吸收的光能量通过辐射过程全部发出光子消耗掉。
...
去激发同样可能由于碰撞或和[溶剂](../Page/溶剂.md "wikilink")分子的混合导致，以速率k<sub>Q</sub>\[Q\]发生。和其他过程不同，考虑碰撞时此猝熄是一个双分子过程。

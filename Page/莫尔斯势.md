...
以物理学家[Philip M.
Morse的名字命名的](https://zh.wikipedia.org/wiki/Philip_M._Morse "wikilink")**Morse势**是一种对于[双原子分子间](https://zh.wikipedia.org/wiki/双原子分子 "wikilink")[势能的简易解析模型](../Page/势能.md "wikilink")。
一方面，对Morse势求解[薛定谔方程具有解析解](../Page/薛定谔方程.md "wikilink")，方便分析问题；另一方面，由于它隐含地包括了键断裂这种现象，对于分子[振动的微细结构的具有良好的近似](https://zh.wikipedia.org/wiki/振动 "wikilink")。Morse势包含有谐振子模型所缺乏的特性，那就是非成键态。相对[量子谐振子模型](https://zh.wikipedia.org/wiki/量子谐振子 "wikilink")，Morse势更加真实，因为它能够描述[非谐效应](https://zh.wikipedia.org/wiki/非谐效应 "wikilink")，倍频，以及组合频率。倍频发生在n

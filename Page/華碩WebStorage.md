...
### 線上備份
  ...
  - 可以設定多台備份電腦。
  - 版本控制功能,提供最近的多個版本，可以再從Web介面去存取。

### 同步

將檔案放到資料夾內，可在各裝置間同步，同時提供最近的多個版本。

## 特點

### 加密

使用[AES技術加密](../Page/高级加密标准.md "wikilink")。

### 線上掃毒

上傳檔案後，線上掃毒，並給予標示（Web）。

### 動態密碼

在本機端及web端，可以使用One Time Password（OTP）功能。
...
## 外部連結
  ...
  -
  - [ASUS WebStorage Blog](http://twblog.asuswebstorage.com/)

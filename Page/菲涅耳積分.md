...
**菲涅耳積分**，常被寫作
*S*(*x*)和*C*(*x*)。以[奧古斯丁·菲涅耳為名](https://zh.wikipedia.org/wiki/奧古斯丁·菲涅耳 "wikilink")。
...
*C*和*S*的值當變數趨近於無窮大時，可用複變分析的方法求得。用以下這個函數的[路徑積分](https://zh.wikipedia.org/wiki/路徑積分 "wikilink")：
...
當*R*趨近於無窮大時，路徑積分沿弧形的部分將趨近於零\[1\]，而實數軸部分的積分將可由[高斯積分](https://zh.wikipedia.org/wiki/高斯積分 "wikilink")

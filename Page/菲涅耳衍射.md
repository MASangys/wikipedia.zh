...
在[光學裏](https://zh.wikipedia.org/wiki/光學 "wikilink")，**菲涅耳衍射**（Fresnel
diffraction）指的是[光波在近場區域的](https://zh.wikipedia.org/wiki/光波 "wikilink")[衍射](../Page/衍射.md "wikilink")。[菲涅耳衍射積分式可以用來計算光波在近場區域的傳播](https://zh.wikipedia.org/wiki/#菲涅耳衍射積分式 "wikilink")，因法國物理學者[奥古斯丁·菲涅耳而命名](../Page/奥古斯丁·菲涅耳.md "wikilink")，是[基爾霍夫衍射公式的近似](../Page/基爾霍夫衍射公式.md "wikilink")。\[1\]
...
是入射波的[波長](https://zh.wikipedia.org/wiki/波長 "wikilink")。

假若 \(F \gtrsim 1\)
，則衍射波是處於近場，可以使用[菲涅耳衍射積分式來計算其物理性質](https://zh.wikipedia.org/wiki/#菲涅耳衍射積分式 "wikilink")。
...
假設照射光波於開有孔徑的不透明擋板，則會有衍射圖樣出現於觀察屏。根據[惠更斯-菲涅耳原理](https://zh.wikipedia.org/wiki/惠更斯-菲涅耳原理 "wikilink")，從孔徑內部任意點次波源Q發射出的圓球面次波，在觀察屏點P的波擾
\(\psi(x,y,z)\) 為
...
其中，\(\mathbf{r}=(x,y,z)\)
是點P的[直角坐標](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")，\(\mathbf{r}'=(x',y',0)\)
是點Q的直角坐標，\(\lambda\) 是波長，\(\mathbb{S}\) 是積分平面（孔徑），\(\psi(x',y',0)\)
是位於點次波源Q的波擾，\(\mathbf{R}\) 是從點Q到點P的位移向量，\(R\) 是 \(\mathbf{R}\)
的數值大小，\(K(\chi)\) 是傾斜因子，\(\chi\)
是垂直於孔徑平面的[法向量與](https://zh.wikipedia.org/wiki/法向量 "wikilink")
\(\mathbf{R}\) 之間的夾角。
...
可以以[泰勒級數表示為](https://zh.wikipedia.org/wiki/泰勒級數 "wikilink")
...
，相位部分僅取至線性項目，這只有當觀察屏與孔徑之間的距離超遠時才成立，請參閱條目[夫朗和斐繞射](https://zh.wikipedia.org/wiki/夫朗和斐繞射 "wikilink")。菲涅耳衍射與夫琅禾费衍射不同的地方，主要是菲涅耳衍射將波前的曲率納入考量，這是為了要精確計算相互干涉的波擾彼此之間的相對相位。
...
改採[極坐標](https://zh.wikipedia.org/wiki/極坐標 "wikilink")
\((\rho',\theta')\) ，
...
波擾 \(\psi(x,y,z)\)
可以寫為[卷積形式](https://zh.wikipedia.org/wiki/卷積 "wikilink")：
...
[權重係數](https://zh.wikipedia.org/wiki/權重 "wikilink")，應用線性系統的性質，可以將積分式寫為
...
的[狄拉克δ函數所做出的響應](https://zh.wikipedia.org/wiki/狄拉克δ函數 "wikilink")，因此稱為[脈衝響應](https://zh.wikipedia.org/wiki/脈衝響應 "wikilink")。\[11\]
...
由於菲涅耳衍射機制，原子波入射於由物質形成的相互平行凸脊陣列，會被[鏡面反射](https://zh.wikipedia.org/wiki/鏡面反射 "wikilink")。這效應可以用來實現[原子反射鏡](https://zh.wikipedia.org/wiki/原子反射鏡 "wikilink")。\[12\]

## 參閱

  - [菲涅耳積分](../Page/菲涅耳積分.md "wikilink")
  - [菲涅耳波帶](https://zh.wikipedia.org/wiki/菲涅耳波帶 "wikilink")（Fresnel
    zone）
...
2.  實際而言，在先前一個步驟裏做了一個近似，即假定 \(e^{i k r}/r\)
    是真實波，但這不是向量[亥姆霍茲方程式的解答](https://zh.wikipedia.org/wiki/亥姆霍茲方程式 "wikilink")，而是純量亥姆霍茲方程式的解答。請參閱條目[純量波近似](https://zh.wikipedia.org/wiki/純量波近似 "wikilink")（scalar
    wave approximation）。
3.
4.

**渲染農場**（），或称**着色农场**，是[伺服器農場的其中一種應用](https://zh.wikipedia.org/wiki/伺服器農場 "wikilink")，主要是用來作為[三維](https://zh.wikipedia.org/wiki/三維 "wikilink")[電腦繪圖執行大量成像工作的](https://zh.wikipedia.org/wiki/電腦繪圖 "wikilink")[计算机集群](https://zh.wikipedia.org/wiki/计算机集群 "wikilink")，運用多台電腦建立出[平行處理的運算單元](https://zh.wikipedia.org/wiki/平行處理 "wikilink")，加速運算效能，通常用於畫面著色、影格合成、[模擬布料](https://zh.wikipedia.org/wiki/模擬 "wikilink")、[物理運算結果](https://zh.wikipedia.org/wiki/物理 "wikilink")。

## 系統配置

### 系統架構

基本上渲染農場以[乙太網路為基礎架構](https://zh.wikipedia.org/wiki/乙太網路 "wikilink")，將渲染[伺服器](https://zh.wikipedia.org/wiki/伺服器 "wikilink")、分配伺服器及資料伺服器串聯。為避免網路的瓶頸，渲染伺服器通常以8台為單位，用一組[集線器串聯](../Page/集線器.md "wikilink")，資料伺服器以4
port Giga網路卡分配運算所需資料，最大32台渲染伺服器，如果64台渲染伺服器就必須有兩張4 port的Giga網路卡串接。

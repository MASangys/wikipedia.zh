...
基本上渲染農場以[乙太網路為基礎架構](https://zh.wikipedia.org/wiki/乙太網路 "wikilink")，將渲染[伺服器](https://zh.wikipedia.org/wiki/伺服器 "wikilink")、分配伺服器及資料伺服器串聯。為避免網路的瓶頸，渲染伺服器通常以8台為單位，用一組[集線器](../Page/集線器.md "wikilink")串聯，資料伺服器以4

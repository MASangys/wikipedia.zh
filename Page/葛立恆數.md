...
[馬丁·加德納於](https://zh.wikipedia.org/wiki/馬丁·加德納 "wikilink")1977年11月在美國[科學人雜誌的](https://zh.wikipedia.org/wiki/科學人 "wikilink")「數學遊戲」專欄將此數刊登出來，1980年被金氏世界紀錄訂為在正式數學[證明中出現過最大的數](../Page/證明.md "wikilink")。

## 問題背景

[GrahamCube.svg](https://zh.wikipedia.org/wiki/File:GrahamCube.svg "fig:GrahamCube.svg")
葛立恆數與[拉姆齊理論有關](https://zh.wikipedia.org/wiki/拉姆齊理論 "wikilink")：考慮一個\(n\)維的[超立方体](https://zh.wikipedia.org/wiki/超立方体 "wikilink")，在連結所有頂點後，將形成一個\(2^n\)個頂點的[完全圖](../Page/完全圖.md "wikilink")。將這個圖的每條邊填上紅色或藍色。求\(n\)的最小值，才使得所有填法中都必定存在一個在同一平面上有四個頂點的單色完全子圖。

在1971年Graham與Rothschild證明了此題之解\(N^*\)的上下界為\(6 \le N^* \le N\)，其中\(N\)是一個極大但明確定義的數字\(F^7(12) = F(F(F(F(F(F(F(12)))))))\)，用[高德納箭號表示法](../Page/高德納箭號表示法.md "wikilink")，\(F\)可表示為\(F(n) = 2 \uparrow^n 3\)；[康威鏈式箭號表示法也可以表示此數的大略範圍](../Page/康威鏈式箭號表示法.md "wikilink")，此數介於\(4 \rightarrow 2 \rightarrow 8 \rightarrow 2\)與\(2 \rightarrow 3 \rightarrow 9 \rightarrow 2\)之間\[1\]，\(N^*\)的上界在2014年藉由Hales–Jewett數的上界而降為\(2 \uparrow \uparrow \uparrow 6\)\[2\]；下界則在2003年由Geoffrey
Exoo提高為11\[3\]，並由Jerome
Barkley在2008年進一步的提高為13\[4\]。因此目前所知最佳的\(N^*\)上下界為\(13 \le N^* \le 2 \uparrow \uparrow \uparrow 6\)。
...
Grahama](https://zh.wikipedia.org/wiki/pl:Notacja_strzałkowa#Liczba_Grahama "wikilink")
...
4.
5.  [馬丁·加德納](https://zh.wikipedia.org/wiki/馬丁·加德納 "wikilink") (1977)
    ["In which joining sets of points leads into diverse (and diverting)

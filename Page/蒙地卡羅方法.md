**蒙特卡罗方法**（），也称**统计模拟方法**，是1940年代中期由于科学技术的发展和[电子计算机的发明](../Page/电子计算机.md "wikilink")，而提出的一种以概率统计理论为指导的数值计算方法。是指使用[随机数](../Page/随机数.md "wikilink")（或更常见的[伪随机数](https://zh.wikipedia.org/wiki/伪随机数 "wikilink")）来解决很多计算问题的方法。

**蔡勒公式**（Zeller's
congruence），是一種計算任何一日屬一星期中哪一日的[演算法](https://zh.wikipedia.org/wiki/演算法 "wikilink")，由德國數學家推算出來。
...
可能为负数，所以当出现负数的情况下不能直接mod
7。编写成代码的时候如果两个操作数中只有一个负数，求模的结果取决于机器，也就是说某些情况下w在一些机器上为负数，但是在某一些机器上w不一定为负数（例如：21%-5的结果取决于机器，可能得到1或-4），对于产生负数这种情况可将原来公式分为两步：
...
若要計算的日期是在1582年10月4日或之前的[儒略曆實施年代](../Page/儒略曆.md "wikilink")，公式則為：
...
這是因[羅馬](https://zh.wikipedia.org/wiki/羅馬 "wikilink")[教宗](../Page/教宗.md "wikilink")[額我略十三世頒布新曆法](../Page/額我略十三世.md "wikilink")([公曆](https://zh.wikipedia.org/wiki/公曆 "wikilink"))，把1582年10月4日的後一天改為1582年10月15日。此一公式也要注意前述附註中出现负数的情况。

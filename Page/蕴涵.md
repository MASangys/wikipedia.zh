**蕴涵**（implication或entailment）在[命题逻辑和](../Page/命题逻辑.md "wikilink")[谓词逻辑中用来描述在两个句子或句子的集合之间的联系](https://zh.wikipedia.org/wiki/谓词逻辑 "wikilink")。
...
理想上，[语义蕴涵](https://zh.wikipedia.org/wiki/逻辑的语义 "wikilink")（semantic
consequence）和逻辑蕴涵（syntactic
consequence）[等价](https://zh.wikipedia.org/wiki/等价 "wikilink")，但这不总是可行。（参见[哥德尔不完备定理](../Page/哥德尔不完备定理.md "wikilink")，它陈述了包含为真但不能证明的句子的一些语言（比如[算术](../Page/算术.md "wikilink")））。在这种情况下，把等价分成两部分是有用的：
...
在很多情况下，蕴涵符合于[实质蕴涵](https://zh.wikipedia.org/wiki/实质蕴涵 "wikilink")：就是说，\(A, X \models Y\)当且仅当\(A \models X \to Y\)。但是在一些[多值逻辑中这不是真的](../Page/多值逻辑.md "wikilink")。

...
## 例子
  ...
  - Unix/Linux系统中的[Xterm](https://zh.wikipedia.org/wiki/Xterm "wikilink")、rxvt、aterm、Eterm、wterm、gnome-terminal、[Konsole](../Page/Konsole.md "wikilink")、[OS X终端](https://zh.wikipedia.org/wiki/终端_\(OS_X\) "wikilink")

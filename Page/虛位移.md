...
在[分析力學裏](https://zh.wikipedia.org/wiki/分析力學 "wikilink")，保持時間不變，**虛位移**是符合[約束條件的無窮小](https://zh.wikipedia.org/wiki/約束條件 "wikilink")[位移](../Page/位移.md "wikilink")。由於任何物理運動都需要經過時間的演進才會有實際的位移，所以稱保持時間不變的位移為虛位移\[1\]。

...
在這篇文章裏，[位移指的是](../Page/位移.md "wikilink")[平移運動所造成的位移或](https://zh.wikipedia.org/wiki/平移運動 "wikilink")[旋轉運動所造成的](https://zh.wikipedia.org/wiki/旋轉運動 "wikilink")[角位移](../Page/位移.md "wikilink")；作用力指的是力量或[力矩](../Page/力矩.md "wikilink")。虛位移不是實際的位移，而是一種虛構的、理論上的位移，是一種只涉及位置，不涉及時間的變化。每一個[虛位移既是](../Page/虛位移.md "wikilink")[自變量](https://zh.wikipedia.org/wiki/自變量 "wikilink")（），又是任意設定的。任意性是一個很重要的特性，在數學關係式裏，能夠推導出許多重要的結果。例如，思考下述[矩陣方程式](https://zh.wikipedia.org/wiki/矩陣 "wikilink")：
...
在[動力學裏](../Page/動力學.md "wikilink")，虛功原理會被推廣為[達朗貝爾原理](../Page/達朗貝爾原理.md "wikilink")。這原理是[拉格朗日力學的理論基礎](https://zh.wikipedia.org/wiki/拉格朗日力學 "wikilink")。更詳盡細節，請參閱相關條目。

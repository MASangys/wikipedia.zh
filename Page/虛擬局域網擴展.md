...
VXLAN可以為網路提供以下作用：
  ...
  - 解決 [TOR](https://zh.wikipedia.org/wiki/TOR "wikilink") 交換機 [MAC表耗盡問題](https://zh.wikipedia.org/wiki/MAC表 "wikilink")。二層網路出現後，不僅要記錄數據中心二層設備的 MAC 位址，還得記錄其他數據中心二層範圍內的位址，這包括了海量的虛擬機器的 MAC 位址，這增加了 TOR [MAC表的需求](https://zh.wikipedia.org/wiki/MAC表 "wikilink")。但目前的交換機晶片遠遠無法滿足此一需求。

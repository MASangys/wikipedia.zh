**虚拟机**（），在[计算机科学中的](../Page/计算机科学.md "wikilink")[体系结构裏](https://zh.wikipedia.org/wiki/体系结构 "wikilink")，是指一种特殊的[软件](../Page/软件.md "wikilink")，可以在[计算机平台和](../Page/系统平台.md "wikilink")[終端用戶之间建立一种环境](https://zh.wikipedia.org/wiki/終端用戶 "wikilink")，而終端用戶则是基于这个軟體所建立的环境来操作[软件](../Page/软件.md "wikilink")。
...
例如：[Docker](https://zh.wikipedia.org/wiki/Docker "wikilink")
...
当然，不是每个VM用户都必须运行CMS；有些用户选择在一个或者多个虚拟机上运行某种「OS/360」（或者「MVS」），来提供传统上的[批处理任务](https://zh.wikipedia.org/wiki/批处理任务 "wikilink")。今天，IBM[大型机还在使用VM](https://zh.wikipedia.org/wiki/大型机 "wikilink")，许多虚拟机上运行的是[Linux操作系统](../Page/Linux.md "wikilink")。
...
下列的軟體產品可以用來虛擬硬體，故可用於各種作業系統之上。
  ...
  - [KVM是一種](https://zh.wikipedia.org/wiki/Kernel-based_Virtual_Machine "wikilink")[Linux
    kernel模組](https://zh.wikipedia.org/wiki/Linux_kernel "wikilink")，可以修正QEMU
...
下面的表格比较了一些[虚拟机软件的基本信息](https://zh.wikipedia.org/wiki/虚拟机软件 "wikilink")。请注意，这里说的是[系统虚拟机](https://zh.wikipedia.org/wiki/系统虚拟机 "wikilink")。[Java虚拟机之类的](../Page/Java虚拟机.md "wikilink")[程序虚拟机不算在内](https://zh.wikipedia.org/wiki/程序虚拟机 "wikilink")。
...
<tr class="odd">
<td><p><a href="https://zh.wikipedia.org/wiki/Proxmox_VE" title="wikilink">Proxmox VE</a></p></td>

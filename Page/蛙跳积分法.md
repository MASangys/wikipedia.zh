**蛙跳积分法**是一种对[微分方程进行积分的简单方法](../Page/微分方程.md "wikilink")，尤其是在[动力系统的情况下](../Page/动力系统.md "wikilink")。这个方法在不同学科中有不同的名字。特别是它与**速度Verlet**方法等同，后者是[Verlet积分法中的一个变体](https://zh.wikipedia.org/wiki/Verlet积分法 "wikilink")。

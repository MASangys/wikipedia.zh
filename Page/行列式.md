...
[Joseph-Louis_Lagrange.jpeg](https://zh.wikipedia.org/wiki/File:Joseph-Louis_Lagrange.jpeg "fig:Joseph-Louis_Lagrange.jpeg") 1750年，[瑞士的](https://zh.wikipedia.org/wiki/瑞士 "wikilink")[加布里尔·克莱姆首先在他的](https://zh.wikipedia.org/wiki/加布里尔·克拉默 "wikilink")《代数曲线分析引论》给出了元一次方程组求解的法则，用于确定经过五个点的一般[二次曲线的系数](https://zh.wikipedia.org/wiki/二次曲线 "wikilink")，但并没有给出证明\[46\]。其中行列式的计算十分复杂，因为是定义在[奇置换和偶置换上的](../Page/置换的奇偶性.md "wikilink")\[47\]。
...
46. [加布里尔·克拉默](https://zh.wikipedia.org/wiki/加布里尔·克拉默 "wikilink")*Introduction à l'analyse des lignes courbes algébraique* 1750

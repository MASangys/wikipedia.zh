...
若\(A\)和\(B\)是[集合](../Page/集合.md "wikilink")，则\(A\)在\(B\)中的-{zh-cn:**相对补集**;
...
:\*若\(\R\)是[实数集合](../Page/实数.md "wikilink")，\(\Q\)是[有理数集合](../Page/有理数.md "wikilink")，则\(\R-\Q\)为[无理数集合](../Page/无理数.md "wikilink")。

下列命题给出一些相对补集同[并集和](../Page/并集.md "wikilink")[交集等集合论](../Page/交集.md "wikilink")[运算相关的一些常用性质](../Page/运算.md "wikilink")。

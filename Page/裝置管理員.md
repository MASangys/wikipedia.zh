...
\-{zh-cn:设备管理器;zh-tw:裝置管理員;}-提供了在[图形用户界面中管理电脑](https://zh.wikipedia.org/wiki/GUI "wikilink")-{zh-cn:硬件;zh-tw:硬體;}--{zh-cn:设备;zh-tw:裝置;}-的方法，然而在有些场合中需要通过脚本化方法管理-{zh-cn:硬件;zh-tw:硬體;}-，[微软为此提供了一个专用的命令行工具](../Page/微软.md "wikilink")——DevCon\[1\]（尽管还有其他可在脚本中控制硬件的方法如

...
研究中常用的理论、公式以及方法包括[柯西积分定理](../Page/柯西积分定理.md "wikilink")、[柯西积分公式](https://zh.wikipedia.org/wiki/柯西积分公式 "wikilink")、[留数定理](../Page/留数定理.md "wikilink")、[洛朗级数展开等](../Page/洛朗级数.md "wikilink")。複變分析的应用领域较为广泛，在其它数学分支和[物理学中也起着重要的作用](../Page/物理学.md "wikilink")。包括[数论](../Page/数论.md "wikilink")、[应用数学](https://zh.wikipedia.org/wiki/应用数学 "wikilink")、[流体力学](../Page/流体力学.md "wikilink")、[热力学和](../Page/热力学.md "wikilink")[电动力学](https://zh.wikipedia.org/wiki/电动力学 "wikilink")。
...
复变函数为全纯函数的[充分必要条件是复变函数的实部和虚部同时满足](../Page/充分必要条件.md "wikilink")[柯西-黎曼方程](https://zh.wikipedia.org/wiki/柯西-黎曼方程 "wikilink")\[3\]：
...
设**\(C\)**为\(D\)的[边界](../Page/边界_\(拓扑学\).md "wikilink")。则可以推得每个在*\(D\)*[内部的点](https://zh.wikipedia.org/wiki/内部_\(数学\) "wikilink")\(a\)：
...
特別地，全纯函數都是無限次可微的\[6\]，性質對實可微函數而言普遍不成立。大部分初等函數（[多項式](../Page/多項式.md "wikilink")、[指數函數](https://zh.wikipedia.org/wiki/指數函數 "wikilink")、[三角函數](https://zh.wikipedia.org/wiki/三角函數 "wikilink")）都是全纯函數。常用的方法有[泰勒级数展开等](../Page/泰勒级数.md "wikilink")。
...
\[f(z)-{R \over (z-a)}\]
在[圆盘](../Page/圆盘.md "wikilink")\(0<|z-a|<\delta\)内具有[解析](../Page/解析函数.md "wikilink")[原函数的唯一值](https://zh.wikipedia.org/wiki/原函数 "wikilink")\(R\)
...
在[复分析中](https://zh.wikipedia.org/wiki/复分析 "wikilink")，**留数定理**是用来计算[解析函数沿着闭曲线的](../Page/解析函数.md "wikilink")[路径积分的一个有力的工具](https://zh.wikipedia.org/wiki/路径积分 "wikilink")，也可以用来计算[实函数的积分](../Page/实函数.md "wikilink")。它是[柯西积分定理和](../Page/柯西积分定理.md "wikilink")[柯西积分公式的推广](https://zh.wikipedia.org/wiki/柯西积分公式 "wikilink")。

假设*U*是[复平面上的一个](../Page/复平面.md "wikilink")[单连通](https://zh.wikipedia.org/wiki/单连通 "wikilink")[开子集](https://zh.wikipedia.org/wiki/开子集 "wikilink")，*a*<sub>1</sub>、……、*a*<sub>*n*</sub>是复平面上有限个点，*f*是定义在*U*
\\

**複小波變換**是針對標準[離散傅立葉轉換在複數上的延伸形式](https://zh.wikipedia.org/wiki/離散傅立葉轉換 "wikilink")。事實上，複小波變換是一個二維的小波轉換，並且可以提供多尺度、有用的影像結構特性的分析。此外，他也具備了振幅不會隨著平移而改變的特性。然而，這種轉換具備了一個缺點，就是相對於原本的[離散傅立葉轉換](https://zh.wikipedia.org/wiki/離散傅立葉轉換 "wikilink")，會有多餘的
\(2^d\)(這裡的\(d\)是指原始被傳遞訊號的維度)維度存在。

一般而言，複小波變換最早被使用是在1995年，由J.M.Lina和L.
Gagnon，基於Daubechies正交濾波器的架構，用以進行影像處理\[1\]\[2\]。並於1997年被[劍橋大學的Nick](https://zh.wikipedia.org/wiki/劍橋大學 "wikilink")
Kingsbury教授歸納出一個較為一般性的形式。 \[3\]\[4\]\[5\]
...
## 外部連結
  ...
  - [An MPhil thesis: Complex wavelet transforms and their
    applications](https://web.archive.org/web/20160303195941/http://www.wavelet.org/phpBB2/viewtopic.php?t=7584)
  - [CWT for EMG analysis](http://eprints.soton.ac.uk/11007/)
  - [Multidimensional, mapping-based complex wavelet
    transforms](http://ieeexplore.ieee.org/xpl/freeabs_all.jsp?arnumber=1369333)

**複振器**是一種用來產生在兩種狀態間變化的系統的[電子](../Page/電子學.md "wikilink")[電路](../Page/電路.md "wikilink")，譬如說[振盪器](../Page/振盪器.md "wikilink")、[定时器](../Page/定时器.md "wikilink")、[触发器等等](../Page/触发器.md "wikilink")。最常見的形式是用來產生[方波的非穩態振盪器](../Page/方波.md "wikilink")。
...
<!-- end list -->
  ...
  - **單穩態**複振器（monostable
    multivibrator），它所處的兩種狀態中有一種是穩態。這種電路會在外部訊號觸發時落入非穩態，但是在非穩態持續一段時間後還是會回到穩態。這種電路適用於對外部事件產生持續固定長度的訊號，也有人稱這一類的電路叫[单稳态触发器](../Page/单稳态触发器.md "wikilink")（**One
...
[Transistor_Bistable_interactive_animated-en.svg](https://zh.wikipedia.org/wiki/File:Transistor_Bistable_interactive_animated-en.svg "fig:Transistor_Bistable_interactive_animated-en.svg")
  ...
  - **雙穩態**複振器（bistable
    multivibrator），這種電路的兩種狀態都是穩態。如果沒有特定訊號觸發的話，它會一直處在其中一種狀態。若是有特定訊號觸發，此電路可以由一種狀態轉變到另一種狀態。它可以在建立基礎的記憶元件，如電腦中的[記憶體或是中央處理器內部的](../Page/記憶體.md "wikilink")[暫存器](../Page/暫存器.md "wikilink")。此電路也被稱為[正反器或](../Page/正反器.md "wikilink")[閂鎖](../Page/閂鎖.md "wikilink")。有一種類似的電路是[施密特触发器](../Page/施密特触发器.md "wikilink")。

最簡單的複振器是由兩個交互偶合的[電晶體構成的](../Page/電晶體.md "wikilink")，並在電路中使用不同的[RC電路以決定處於不同狀態的時間](../Page/RC電路.md "wikilink")。

複振器常見於需要產生[方波或定寬時脈的系統中](../Page/方波.md "wikilink")，不過簡單的電路也意味著不夠精確的時脈控制，因此在時間因素非常重要的系統中較少見到複振器。

[555計時器是一種廣泛使用的](../Page/555計時器.md "wikilink")[積體電路版本的複振器](../Page/積體電路.md "wikilink")。555計時器中使用了更精密的設計以解決一般複振器定時不準的問題。
...
由於種種不隱定因素對複振器振盪週期的影響，因此在實作中通常使用更精確的計時[積體電路取代單純的複振器電路](../Page/積體電路.md "wikilink")。

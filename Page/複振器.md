**複振器**是一種用來產生在兩種狀態間變化的系統的[電子](https://zh.wikipedia.org/wiki/電子學 "wikilink")[電路](https://zh.wikipedia.org/wiki/電路 "wikilink")，譬如說[振盪器](https://zh.wikipedia.org/wiki/振盪器 "wikilink")、[定时器](https://zh.wikipedia.org/wiki/定时器 "wikilink")、[触发器](../Page/触发器.md "wikilink")等等。最常見的形式是用來產生[方波](../Page/方波.md "wikilink")的非穩態振盪器。

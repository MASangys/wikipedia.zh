> 本文内容由[視窗](https://zh.wikipedia.org/wiki/視窗)转换而来。


{{ Otheruses|other=微软推出的一款-{zh-hant:作業; zh-hans:操作}-系统|Microsoft Windows }} [Window_(windowing_system).svg](https://zh.wikipedia.org/wiki/File:Window_\(windowing_system\).svg "fig:Window_(windowing_system).svg") [Gnome-2.16-screenshot.png](https://zh.wikipedia.org/wiki/File:Gnome-2.16-screenshot.png "fig:Gnome-2.16-screenshot.png")上的兩個-{zh-hant:程式; zh-hans:程序}-窗口，其中一个窗口与另一个的一部分重叠。（圖為[Ubuntu作業系統](https://zh.wikipedia.org/wiki/ubuntu "wikilink")）\]\]

**視窗**是在[使用者界面上的一個可見的範圍](https://zh.wikipedia.org/wiki/人機界面 "wikilink")。視窗一般都是[長方形的](https://zh.wikipedia.org/wiki/长方形 "wikilink")。它包含著各種[控件](../Page/控件.md "wikilink")，是用作輸入和輸出的界面。雖然視窗一般用於[圖形使用者界面](../Page/图形用户界面.md "wikilink")，但又有時用於[命令行界面](../Page/命令行界面.md "wikilink")的。而一個使用視窗為主要用戶界面的系統則稱為[視窗系統](../Page/視窗系統.md "wikilink")。這個想法源於[施乐帕洛阿尔托研究中心](https://zh.wikipedia.org/wiki/施乐帕洛阿尔托研究中心 "wikilink")。
...
視窗是數種圖形使用者界面中的一種重要的widget。當中有[VMS的](https://zh.wikipedia.org/wiki/OpenVMS "wikilink")[DEC Windows](https://zh.wikipedia.org/wiki/Common_Desktop_Environment "wikilink")、[GNU](../Page/GNU.md "wikilink")/[Unix-like系統的](https://zh.wikipedia.org/wiki/Unix-like "wikilink")[X Window系統](https://zh.wikipedia.org/wiki/X_Window系统 "wikilink")、[Microsoft Windows和](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")[Open Windows](https://zh.wikipedia.org/wiki/Open_Windows "wikilink")。

## 历史

[Expander.png](https://zh.wikipedia.org/wiki/File:Expander.png "fig:Expander.png")的文件“另存为……”对话框\]\] 这个概念是由(由 [道格拉斯·恩格尔巴特](../Page/道格拉斯·恩格尔巴特.md "wikilink") 领导）开发实现的。\[1\] 他们最早的系统支持多窗口，但没明显的方法显示它们的分界线（比如窗口边框、标题栏等）。\[2\]

研究在 [Xerox](https://zh.wikipedia.org/wiki/Xerox "wikilink") 公司的 [Palo Alto](https://zh.wikipedia.org/wiki/Palo_Alto,_California "wikilink") 研究中心 / [PARC](../Page/帕羅奧多研究中心.md "wikilink") （由 [艾伦·凯](../Page/艾伦·凯.md "wikilink")领导）中继续。他们使用了重叠的窗口。\[3\]

在1980年代，PARC 提出术语"[WIMP](https://zh.wikipedia.org/wiki/WIMP "wikilink")"，分别代表了窗口、图标、菜单、指针。

那时[Apple与PARC进行了简单的合作](https://zh.wikipedia.org/wiki/Apple_Inc. "wikilink")。Apple 根据 PARC 的界面开发了自己的新界面。它首次应用是在 [Apple的 Lisa上](../Page/Apple_Lisa.md "wikilink")，此后用于 [Macintosh](https://zh.wikipedia.org/wiki/Macintosh "wikilink") 电脑。与此同时，[Microsoft在为](https://zh.wikipedia.org/wiki/Microsoft "wikilink")"Mac"开发办公软件。之后他们在 Apple 系统的基础上开发了自己的窗口系统。\[4\]

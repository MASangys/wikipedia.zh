在[视覺研究中](https://zh.wikipedia.org/wiki/视知觉 "wikilink")，**视觉短期记忆** **（VSTM）**是三大記憶系統之一，其餘系統還包括[圖像記憶和](https://zh.wikipedia.org/wiki/圖像記憶 "wikilink")[长期記憶](../Page/长期记忆.md "wikilink") 。視覺短期記憶是一种[短期记忆](../Page/短期记忆.md "wikilink") ，但仅限于视觉领域内的信息。
...
有一些证据表明中级视觉儲存( Intermediate visual store )具有[圖像記憶和VSTM的特征](https://zh.wikipedia.org/wiki/圖像記憶 "wikilink")。 \[3\]该中级存储器具有高容量（最多15个项目）和較长的存储追踪持续时间（最多4秒）。它与VSTM共存但並不相同，视觉刺激可以覆盖其视觉存储的内容（Pinto等，2013）。进一步的研究表明其過程涉及[视觉区域V4的参与](../Page/视觉皮层.md "wikilink")。 \[4\]

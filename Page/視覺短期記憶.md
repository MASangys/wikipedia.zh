在[视覺研究中](https://zh.wikipedia.org/wiki/视知觉 "wikilink")，**视觉短期记忆** **（VSTM）**是三大記憶系統之一，其餘系統包括[圖像記憶和](https://zh.wikipedia.org/wiki/圖像記憶 "wikilink")[长期記憶](../Page/长期记忆.md "wikilink") 。 視覺短期記憶是一种[短期记忆](../Page/短期记忆.md "wikilink") ，但仅限于视觉领域内的信息。

視覺短期記憶指在长时间内非永久性地存储视觉信息的記憶。 [视觉空间画板是巴德利提出的](../Page/巴德利工作記憶模型.md "wikilink")[工作记忆理论模型中的視覺短期記憶子组件](https://zh.wikipedia.org/wiki/工作记忆 "wikilink")。圖像记忆很脆弱，會快速衰减，且无法积极维持，而视觉短期记忆不易受后续刺激影響，可以持续数秒。另一方面，視覺短期記憶与长期记忆的主要区别在于其容量極為有限。

## 概述

在20世纪70年代早期，引入难以言语化且不太可能存于[长期记忆](../Page/长期记忆.md "wikilink")的[刺激](https://zh.wikipedia.org/wiki/兴奋 "wikilink")，為VSTM的研究帶來了革命性的變革\[1\] 。其基本实验技术要求观察者指出，在短时间分隔的两个矩阵或圖形\[2\]是否相同。結果發現，观察者能够报告所发生的变化，結果显着高于偶然性的水平，表明他们至少能够在第二次刺激呈现之前，在纯粹的视觉存储中编码第一刺激的外觀。然而，由于所使用的刺激复杂，且变化的性质相对不受控制，这些实验留下了各种问题。

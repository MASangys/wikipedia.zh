> 本文内容由[視覺短期記憶](https://zh.wikipedia.org/wiki/視覺短期記憶)转换而来。
...
術語「視覺短期記憶」指的是在长时间内非永久性地存储视觉信息的記憶。[视觉空间画板是巴德利提出的](../Page/巴德利工作記憶模型.md "wikilink")[工作记忆理论模型中的視覺短期記憶子组件](https://zh.wikipedia.org/wiki/工作记忆 "wikilink")。圖像记忆相當脆弱，會快速衰减，无法积极维持。與之不同，视觉短期记忆不易受后续刺激影響，可以持续数秒。另一方面，視覺短期記憶与长期记忆有個主要区别，視覺短期記憶的容量極為有限。

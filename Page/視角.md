[Angle_of_view.svg](https://zh.wikipedia.org/wiki/File:Angle_of_view.svg "fig:Angle_of_view.svg") 在攝影學中，**視角**(angle of view)是在一般環境中，相機可以接收影像的角度範圍，也可以常被稱為[視野](https://zh.wikipedia.org/wiki/視野 "wikilink")。

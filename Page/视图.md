**檢視表** (View)
是在[關聯式資料庫中](../Page/關聯式資料庫.md "wikilink")，將一組[查詢指令構成的結果集](../Page/查詢.md "wikilink")，組合成可查詢的資料表的一種資料庫物件。與[資料表不同的是](../Page/資料表.md "wikilink")，資料表是一種實體結構(Physical
...
檢視表具有下列的好處：
  ...
  - 簡化查詢，[資料庫管理員可以將高度複雜的查詢](../Page/資料庫管理員.md "wikilink")，包裝在檢視表中，外部程式只需要直接存取該檢視表即可取出需要的資料。
  - 在檢視表中先行執行運算。
...
## 参见
  ...
  - [数据库表](../Page/数据库表.md "wikilink")
  - [结构化查询语言](../Page/结构化查询语言.md "wikilink")

...
在[物理学中](../Page/物理学.md "wikilink")，**角动量**是与物体的[位置向量和](../Page/位置向量.md "wikilink")[动量相关的](../Page/动量.md "wikilink")[物理量](../Page/物理量.md "wikilink")。對於某慣性參考系的原點\(\mathbf{O}\)，物體的角動量是物体的[位置向量和](../Page/位置向量.md "wikilink")[动量的](../Page/动量.md "wikilink")[叉積](https://zh.wikipedia.org/wiki/叉積 "wikilink")，通常写做\(\mathbf{L}\)。角动量是[矢量](https://zh.wikipedia.org/wiki/矢量 "wikilink")。
...
若物體（或系統）所受外力矩和為零，則物體（系統）的角動量守恆。例如靜電力或萬有引力均是徑向力，因此不會產生力矩。行星運動的交互作用力源自於萬有引力，故行星運動滿足角動量守恆，所對應的就是[开普勒定律中的](../Page/开普勒定律.md "wikilink")[第二定律](https://zh.wikipedia.org/wiki/开普勒第二定律 "wikilink")。
...
經典力學內角動量是可以取任意連續值會導致[熱力學上一些](https://zh.wikipedia.org/wiki/熱力學 "wikilink")[弔詭](https://zh.wikipedia.org/wiki/弔詭 "wikilink")。角動量量子化給這些問題完美的答案，這也是角動量量子化有其必要性的證據之一。
...
\[E=\frac{L_z^2}{2 I}\]
\(L_z\)是分子旋轉的角動量，\(I\)是[轉動慣量和原子的距离平方成正比](../Page/轉動慣量.md "wikilink")。從運用統計力學的[配分函數](https://zh.wikipedia.org/wiki/配分函數 "wikilink")

...
此方法是由[立陶宛物理學家](https://zh.wikipedia.org/wiki/立陶宛 "wikilink")於20世紀發明。在量子力學以及[量子場論領域中](https://zh.wikipedia.org/wiki/量子場論 "wikilink")，形似的符號表示法尚有[費曼圖與](https://zh.wikipedia.org/wiki/費曼圖 "wikilink")[潘洛斯圖形符號](../Page/潘洛斯圖形符號.md "wikilink")。這些圖樣包含有[箭頭與](https://zh.wikipedia.org/wiki/箭頭 "wikilink")[頂點](https://zh.wikipedia.org/wiki/頂點 "wikilink")，有些還有[量子數的標記](https://zh.wikipedia.org/wiki/量子數 "wikilink")。

## 狄拉克符號與朱西斯角動量圖的等價

### 角動量量子態

單一粒子帶有總[角動量量子數](https://zh.wikipedia.org/wiki/角動量量子數 "wikilink")*j*與總[磁量子數](https://zh.wikipedia.org/wiki/磁量子數 "wikilink")*m*
= *j*, *j* − 1, ..., −*j* + 1,
−*j*，其[量子態向量以](../Page/量子態.md "wikilink")[狄拉克符號的右矢](https://zh.wikipedia.org/wiki/狄拉克符號 "wikilink")（Ket）標記為，其圖形則為單箭頭的箭號。有一相對應的左矢（Bra）為，其圖形為雙箭頭的箭號，指向與右矢相反。
...
箭號指向頂點或從頂點指出，分別為
  ...
  - [標準表象](https://zh.wikipedia.org/wiki/古典群 "wikilink")（standard
    representation）以一條離開頂點的指向線段表示，
  - 反標準表象（contrastandard representation）則是以一條進入頂點的指向線段表示。

箭號一個一個相接續。在反標準表象中，採用[時間反轉算符](https://zh.wikipedia.org/wiki/時間反轉 "wikilink")*T*。*T*算符是[么正的](https://zh.wikipedia.org/wiki/么正 "wikilink")，也就是其[厄米伴算符](https://zh.wikipedia.org/wiki/厄米伴算符 "wikilink")*T*<sup>†</sup>等於其反算符*T*<sup>−1</sup>，即*T*<sup>†</sup>
= *T*<sup>−1</sup>。其作用在[位置算符時](../Page/位置算符.md "wikilink")，結果保持不變：
...
[自旋算符也變為負值](../Page/自旋.md "wikilink")：

\[T \hat{\mathbf{S}} T^\dagger  = - \hat{\mathbf{S}}\]

既然[軌域](https://zh.wikipedia.org/wiki/軌域 "wikilink")[角動量算符](../Page/角動量算符.md "wikilink")**L**
= **x** × **p**，在*T*算符作用後也會變為負值：
...
時間反轉算符*T*的結果可見於上式*T*。對外積縮併計算來縮，正向時間與反向時間沒有差別，因此圖形符號表示是相同的，皆為一無指向的線段，其上僅標示*j*：
[AM_diagrams_outer_product_contraction.svg](https://zh.wikipedia.org/wiki/File:AM_diagrams_outer_product_contraction.svg "fig:AM_diagrams_outer_product_contraction.svg")
...
### 註釋
  ...
  - These authors use the theta variant *ϑ* for the time reversal
    operator, here we use *T*.

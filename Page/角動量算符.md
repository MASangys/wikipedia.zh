在[量子力學裏](../Page/量子力學.md "wikilink")，**角動量算符**（）是一種[算符](../Page/算符_\(物理学\).md "wikilink")，類比於經典的[角動量](../Page/角動量.md "wikilink")。在[原子物理學涉及](../Page/原子物理學.md "wikilink")[旋轉對稱性](../Page/旋轉對稱性.md "wikilink")（）的理論裏，角動量算符佔有中心的角色。角動量，[動量](../Page/動量.md "wikilink")，與[能量是物體運動的三個基本特性](../Page/能量.md "wikilink")\[1\]。

## 簡介

角動量促使在旋轉方面的運動得以數量化。在孤立系統裏，如同能量和動量，角動量是[守恆的](../Page/角動量守恆.md "wikilink")。在量子力學裏，角動量算符的概念是必要的，因為角動量的計算實現於描述量子系統的[波函數](../Page/波函數.md "wikilink")，而不是經典地實現於一點或一[剛體](../Page/剛體.md "wikilink")。在量子尺寸世界，分析的對象都是以波函數或[量子幅來描述其](../Page/量子幅.md "wikilink")[機率性行為](../Page/機率性.md "wikilink")，而不是[命定性](../Page/命定性.md "wikilink")()行為。

## 數學定義

在[經典力學裏](../Page/經典力學.md "wikilink")，角動量
\(\mathbf{L}=(L_x,\ L_y,\ L_z)\,\!\) 定義為位置
\(\mathbf{r}=(x,\ y,\ z)\,\!\) 與動量 \(\mathbf{p}=(p_x,\ p_y,\ p_z)\,\!\)
的[叉積](../Page/叉積.md "wikilink")：

\[\mathbf{L}\ \stackrel{def}{=}\ \mathbf{r}\times\mathbf{p}\,\!\] 。

在量子力學裏，對應的角動量算符 \(\hat{\mathbf{L}}\,\!\)
定義為[位置算符](../Page/位置算符.md "wikilink")
\(\hat{\mathbf{r}}\,\!\) 與[動量算符](../Page/動量算符.md "wikilink")
\(\hat{\mathbf{p}}\,\!\) 的叉積：
...
其中，\(\nabla\,\!\) 是[梯度算符](../Page/梯度.md "wikilink")。

## 角動量是厄米算符

在量子力學裏，每一個[可觀察量所對應的](../Page/可觀察量.md "wikilink")[算符都是](../Page/算符.md "wikilink")[厄米算符](../Page/厄米算符.md "wikilink")。角動量是一個可觀察量，所以，角動量算符應該也是厄米算符。讓我們現在證明這一點，思考角動量算符的
x-分量 \(\hat{L}_x\,\!\) ：

\[\hat{L}_x=\hat{y}\hat{p}_z - \hat{z}\hat{p}_y\,\!\] 。

其[伴隨算符](../Page/伴隨算符.md "wikilink") \(L_x^{\dagger}\,\!\) 為

\[\hat{L}_x^{\dagger}=(\hat{y}\hat{p}_z - \hat{z}\hat{p}_y)^{\dagger}=\hat{p}_z^\dagger\hat{y}^{\dagger} - \hat{p}_y^+\hat{z}^{\dagger}\,\!\]
。 由於 \(\hat{y}\,\!\) 、\(\hat{z}\,\!\) 、\(\hat{p}_y\,\!\)
、\(\hat{p}_z\,\!\) ，都是厄米算符，

\[\hat{L}_x^{\dagger}=\hat{p}_z\hat{y} - \hat{p}_y\hat{z}\,\!\] 。

由於 \(\hat{p}_z\,\!\) 與 \(\hat{y}\,\!\) 之間、\(\hat{p}_y\,\!\) 與
\(\hat{z}\,\!\) 之間分別相互[對易](../Page/對易關係.md "wikilink")，所以，

\[\hat{L}_x^{\dagger}=\hat{y}\hat{p}_z - \hat{z}\hat{p}_y=\hat{L}_x\,\!\]
。

因此，\(\hat{L}_x\,\!\) 是一個厄米算符。類似地，\(\hat{L}_y\,\!\) 與 \(\hat{L}_z\,\!\)
...
兩個算符 \(\hat{A}\,\!\) 與 \(\hat{B}\,\!\)
的[交換算符](../Page/交換算符.md "wikilink")
\([\hat{A},\ \hat{B}]\,\!\) ，表示出它們之間的[對易關係](../Page/對易關係.md "wikilink")。

### 角動量算符與自己的對易關係

思考 \(\hat{L}_x\,\!\) 與 \(\hat{L}_y\,\!\)
的[交換算符](../Page/交換算符.md "wikilink")，
...
由於兩者的對易關係不等於 0 ， \(L_x\,\!\) 與 \(L_y\,\!\)
彼此是[不相容可觀察量](../Page/可觀察量#不相容可觀察量.md "wikilink")。\(\hat{L}_x\,\!\)
與 \(\hat{L}_y\,\!\) 絕對不會有共同的基底量子態。一般而言，\(\hat{L}_x\,\!\)
的[本徵態與](../Page/本徵態.md "wikilink") \(\hat{L}_y\,\!\) 的本徵態不同。

給予一個量子系統，量子態為 \(|\psi\rangle\,\!\) 。對於可觀察量算符 \(\hat{L}_x\,\!\) ，所有本徵值為
\(\ell_{xi}\,\!\) 的本徵態 \(|f_i\rangle,\quad i=1,\ 2,\ 3,\ \cdots\,\!\)
，形成了一組基底量子態。量子態 \(|\psi\rangle\,\!\)
可以表達為這基底量子態的[線性組合](../Page/線性組合.md "wikilink")：\(|\psi\rangle=\sum_i \ |f_i\rangle\langle f_i|\psi\rangle\,\!\)
。對於可觀察量算符 \(\hat{L}_y\,\!\) ，所有本徵值為 \(\ell_{yi}\,\!\) 的本徵態
\(|g_i\rangle,\quad i=1,\ 2,\ 3,\ \cdots\,\!\) ，形成了另外一組基底量子態。量子態
\(|\psi\rangle\,\!\)
可以表達為這基底量子態的線性組合：\(|\psi\rangle=\sum_i \ |g_i\rangle\langle g_i|\psi\rangle\,\!\)
。

根據[哥本哈根詮釋](../Page/哥本哈根詮釋.md "wikilink")，[量子測量可以用](../Page/量子測量.md "wikilink")[量子態塌縮機制來詮釋](../Page/波函數塌縮.md "wikilink")。假若，我們測量可觀察量
\(L_x\,\!\) ，得到的測量值為其本徵值 \(\ell_{xi}\,\!\)
，則量子態[機率地](../Page/機率.md "wikilink")[塌縮為本徵態](../Page/波函數塌縮.md "wikilink")
\(|f_i\rangle\,\!\) 。假若，我們立刻再測量可觀察量 \(L_x\,\!\) ，得到的答案必定是
\(\ell_{xi}\,\!\) ，量子態仍舊處於 \(|f_i\rangle\,\!\) 。可是，假若，我們改為測量可觀察量
\(L_y\,\!\) ，則量子態不會停留於本徵態 \(|f_i\rangle\,\!\) ，而會塌縮為 \(\hat{L}_y\,\!\)
的本徵態。假若，得到的測量值為其本徵值 \(\ell_{yj}\,\!\)
，則量子態[機率地](../Page/機率.md "wikilink")[塌縮為本徵態](../Page/波函數塌縮.md "wikilink")
\(|g_j\rangle\,\!\) 。
...
\(L_x\,\!\) 的不確定性與 \(L_y\,\!\) 的不確定性的乘積 \(\Delta L_x\ \Delta L_y \,\!\)
，必定大於或等於 \(\frac{\hbar |\langle L_z\rangle|}{2}\,\!\) 。
...
\(\hat{L}^2 \,\!\) 與 \(\hat{L}_z\,\!\)
是[對易的](../Page/對易關係.md "wikilink")，\(L^2 \,\!\) 與
\(L_z\,\!\)
彼此是[相容可觀察量](../Page/可觀察量#不相容可觀察量.md "wikilink")，兩個算符有共同的本徵態。根據[不確定性原理](../Page/不確定性原理.md "wikilink")，我們可以同時地測量到
\(L^2 \,\!\) 與 \(L_z\,\!\) 的本徵值。
...
\(\hat{L}^2\,\!\) 與 \(\hat{L}_x\,\!\) 之間、\(\hat{L}^2\,\!\) 與
\(\hat{L}_y\,\!\) 之間，都分別擁有類似的物理特性。

### 哈密頓算符與角動量算符之間的對易關係

思考[哈密頓算符](../Page/哈密頓算符.md "wikilink") \(\hat{H}\,\!\) 與
\(\hat{L}_z\,\!\) 的交換算符，
...
\(\hat{H}\,\!\) 與 \(\hat{L}_z\,\!\)
是[對易的](../Page/對易關係.md "wikilink")，\(H\,\!\) 與
\(L_z\,\!\)
彼此是[相容可觀察量](../Page/可觀察量#不相容可觀察量.md "wikilink")，兩個算符擁有共同的本徵態。根據[不確定性原理](../Page/不確定性原理.md "wikilink")，我們可以同時地測量到
\(H\,\!\) 與 \(L_z\,\!\) 的同樣的本徵值。
...
其中，\(\{\ ,\ \}\,\!\)
是[帕松括號](../Page/帕松括號.md "wikilink")，\(\epsilon_{ijk}\,\!\)
是[列維-奇維塔符號](../Page/列維-奇維塔符號.md "wikilink")，\(i\,\!\) 、\(j\,\!\)
、\(k\,\!\) ，代表直角坐標 \((x,\ y,\ z)\,\!\) 。

## 本徵值與本徵函數

採用[球坐標](../Page/球坐標.md "wikilink")。展開角動量算符的方程式：
...
其中，\(\mathbf{e}_r\,\!\) 、\(\mathbf{e}_\theta\,\!\)
、\(\mathbf{e}_\phi\,\!\) ，分別為徑向單位向量、天頂角單位向量、與方位角單位向量。

轉換回[直角坐標](../Page/直角坐標.md "wikilink")，
...
其中，\(\mathbf{e}_x\,\!\) 、\(\mathbf{e}_y\,\!\) 、\(\mathbf{e}_z\,\!\) ，分別為
x-單位向量、y-單位向量、與 z-單位向量。
...
滿足算符 \(\hat{L}^2\,\!\)
的[本徵函數是](../Page/本徵函數.md "wikilink")[球諧函數](../Page/球諧函數.md "wikilink")
\(Y_{\ell m}\,\!\) ：

\[\hat{L}^2 Y_{\ell m}= \ell(\ell+1)\hbar^2 Y_{\ell m}\,\!\] ；

其中，[本徵值](../Page/本徵值.md "wikilink") \(\ell\,\!\) 是正整數。
...
其中，\(i\,\!\)
是[虛數單位](../Page/虛數單位.md "wikilink")，\(P_{\ell m}(\cos{\theta})\,\!\)
...
球諧函數滿足[正交歸一性](../Page/正交歸一性.md "wikilink")：

\[\int_{0}^{2\pi}\int_{0}^{\pi}\ Y_{\ell_1 m_1}Y_{\ell_2 m_2}\sin(\theta)d\theta d\phi=\delta_{\ell_1 \ell_2}\delta_{m_1m_2}\,\!\]
。 這樣，角動量算符的本徵函數，形成一組[單範正交基](../Page/單範正交基.md "wikilink")。任意波函數
\(\psi(\theta,\,\phi)\,\!\)
都可以表達為這單範正交基的[線性組合](../Page/線性組合.md "wikilink")：
...
1.  Introductory Quantum Mechanics, Richard L. Liboff, 2nd Edition, ISBN
    0201547155
2.
...
在[經典力學裏](https://zh.wikipedia.org/wiki/經典力學 "wikilink")，角動量
\(\mathbf{L}=(L_x,\ L_y,\ L_z)\,\!\) 定義為位置
\(\mathbf{r}=(x,\ y,\ z)\,\!\) 與動量 \(\mathbf{p}=(p_x,\ p_y,\ p_z)\,\!\)
的[叉積](https://zh.wikipedia.org/wiki/叉積 "wikilink")：
...
在量子力學裏，每一個[可觀察量所對應的](../Page/可觀察量.md "wikilink")[算符都是](../Page/算符.md "wikilink")[厄米算符](https://zh.wikipedia.org/wiki/厄米算符 "wikilink")。角動量是一個可觀察量，所以，角動量算符應該也是厄米算符。讓我們現在證明這一點，思考角動量算符的
x-分量 \(\hat{L}_x\,\!\) ：

\[\hat{L}_x=\hat{y}\hat{p}_z - \hat{z}\hat{p}_y\,\!\] 。

其[伴隨算符](https://zh.wikipedia.org/wiki/伴隨算符 "wikilink")
\(L_x^{\dagger}\,\!\) 為
...
\(\hat{z}\,\!\)
之間分別相互[對易](https://zh.wikipedia.org/wiki/對易關係 "wikilink")，所以，
...
兩個算符 \(\hat{A}\,\!\) 與 \(\hat{B}\,\!\)
的[交換算符](https://zh.wikipedia.org/wiki/交換算符 "wikilink")
\([\hat{A},\ \hat{B}]\,\!\)
，表示出它們之間的[對易關係](https://zh.wikipedia.org/wiki/對易關係 "wikilink")。
...
彼此是[不相容可觀察量](https://zh.wikipedia.org/wiki/可觀察量#不相容可觀察量 "wikilink")。\(\hat{L}_x\,\!\)
與 \(\hat{L}_y\,\!\) 絕對不會有共同的基底量子態。一般而言，\(\hat{L}_x\,\!\)
的[本徵態與](https://zh.wikipedia.org/wiki/本徵態 "wikilink")
\(\hat{L}_y\,\!\) 的本徵態不同。
...
根據[哥本哈根詮釋](../Page/哥本哈根詮釋.md "wikilink")，[量子測量可以用](../Page/量子測量.md "wikilink")[量子態塌縮機制來詮釋](https://zh.wikipedia.org/wiki/波函數塌縮 "wikilink")。假若，我們測量可觀察量
...
\(\hat{L}^2 \,\!\) 與 \(\hat{L}_z\,\!\)
是[對易的](https://zh.wikipedia.org/wiki/對易關係 "wikilink")，\(L^2 \,\!\)
與 \(L_z\,\!\)
彼此是[相容可觀察量](https://zh.wikipedia.org/wiki/可觀察量#不相容可觀察量 "wikilink")，兩個算符有共同的本徵態。根據[不確定性原理](https://zh.wikipedia.org/wiki/不確定性原理 "wikilink")，我們可以同時地測量到
\(L^2 \,\!\) 與 \(L_z\,\!\) 的本徵值。
...
思考[哈密頓算符](https://zh.wikipedia.org/wiki/哈密頓算符 "wikilink")
\(\hat{H}\,\!\) 與 \(\hat{L}_z\,\!\) 的交換算符，

\[[\hat{H},\ \hat{L}_z]=\left[i\hbar\frac{\partial}{\partial t},\ \hat{x}\hat{p}_y - \hat{y}\hat{p}_x\right]=0\,\!\]
，

\(\hat{H}\,\!\) 與 \(\hat{L}_z\,\!\)
是[對易的](https://zh.wikipedia.org/wiki/對易關係 "wikilink")，\(H\,\!\)
與 \(L_z\,\!\)
彼此是[相容可觀察量](https://zh.wikipedia.org/wiki/可觀察量#不相容可觀察量 "wikilink")，兩個算符擁有共同的本徵態。根據[不確定性原理](https://zh.wikipedia.org/wiki/不確定性原理 "wikilink")，我們可以同時地測量到
\(H\,\!\) 與 \(L_z\,\!\) 的同樣的本徵值。
...
其中，\(\{\ ,\ \}\,\!\)
是[帕松括號](https://zh.wikipedia.org/wiki/帕松括號 "wikilink")，\(\epsilon_{ijk}\,\!\)
...
滿足算符 \(\hat{L}^2\,\!\)
的[本徵函數是](../Page/本徵函數.md "wikilink")[球諧函數](https://zh.wikipedia.org/wiki/球諧函數 "wikilink")
\(Y_{\ell m}\,\!\) ：

\[\hat{L}^2 Y_{\ell m}= \ell(\ell+1)\hbar^2 Y_{\ell m}\,\!\] ；

其中，[本徵值](https://zh.wikipedia.org/wiki/本徵值 "wikilink") \(\ell\,\!\)
是正整數。
...
。
這樣，角動量算符的本徵函數，形成一組[單範正交基](https://zh.wikipedia.org/wiki/單範正交基 "wikilink")。任意波函數
\(\psi(\theta,\,\phi)\,\!\)
都可以表達為這單範正交基的[線性組合](https://zh.wikipedia.org/wiki/線性組合 "wikilink")：

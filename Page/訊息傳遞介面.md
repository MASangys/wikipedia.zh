...
主要的MPI-1模型不包括共享内存概念，MPI-2-{只}-有有限的分布共享内存概念。 但是MPI程序经常在共享内存的机器上运行。在MPI模型周边设计程序比在NUMA架构下设计要好因为MPI鼓励内存本地化。
...
大多數訊息傳遞介面的實現為[函式庫](../Page/函式庫.md "wikilink")，亦不需要[編譯器](../Page/編譯器.md "wikilink")支持。

## 例子

由多[行程](../Page/行程.md "wikilink")來執行Hello World：
...
## 實現
  ...
  - Open MPI－ 是[自由軟件和](https://zh.wikipedia.org/wiki/自由軟件 "wikilink")[開放源碼實現](https://zh.wikipedia.org/wiki/開放源碼 "wikilink")。\[1\] [走鵑](https://zh.wikipedia.org/wiki/走鵑_\(超級電腦\) "wikilink")（2008年6月-2009年11月[TOP500](../Page/TOP500.md "wikilink")第一快的超級電腦）\[2\]及[京](https://zh.wikipedia.org/wiki/京_\(超級電腦\) "wikilink")（2011年6月至今第一快的超級電腦）也使用Open MPI。\[3\] \[4\]
  - Intel MPI－[Intel基於開放源碼的MPICH](https://zh.wikipedia.org/wiki/Intel "wikilink")2與MVAPICH2研發成的MPI。\[5\]
...
## 外部連結
  ...
  - [Open MPI內部結構](http://www.aosabook.org/en/openmpi.html)（The Architecture of Open Source Applications, Volume II - ISBN 9781105571817）

{{-}}

[Category:并发计算](https://zh.wikipedia.org/wiki/Category:并发计算 "wikilink") [Category:应用程序接口](https://zh.wikipedia.org/wiki/Category:应用程序接口 "wikilink")

1.  [Open MPI: Open Source High Performance Computing](http://www.open-mpi.org/)
2.
3.
4.
5.  [Intel MPI Library - Intel Software Network](http://www.intel.com/go/mpi/)
6.  [Platform MPI](http://www.platform.com/cluster-computing/platform-mpi)
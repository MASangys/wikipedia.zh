**誤動作等级**（STL）是對於架設在[安全系統](../Page/安全.md "wikilink")（[安全相關系統或](https://zh.wikipedia.org/wiki/安全相關系統 "wikilink")[安全關鍵系統](https://zh.wikipedia.org/wiki/安全關鍵系統 "wikilink")）中的[安全機能](../Page/安全機能.md "wikilink")，對誤動作次數的要求。STL
1表示[安全機能會出現的誤動作次數最多](../Page/安全機能.md "wikilink")，誤動作等级最高，表示會出現的誤動作最少。誤動作等级沒有上限的限制。

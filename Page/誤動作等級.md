**誤動作等级**（STL）是對於架設在[安全系統](../Page/安全.md "wikilink")（[安全相關系統或](https://zh.wikipedia.org/wiki/安全相關系統 "wikilink")[安全關鍵系統](https://zh.wikipedia.org/wiki/安全關鍵系統 "wikilink")）中的[安全機能](https://zh.wikipedia.org/wiki/安全機能 "wikilink")，對誤動作次數的要求。STL
1表示[安全機能會出現的誤動作次數最多](https://zh.wikipedia.org/wiki/安全機能 "wikilink")，誤動作等级最高，表示會出現的誤動作最少。誤動作等级沒有上限的限制。
...
STL（誤動作等级）是一種安全機能的性能水平[度量](../Page/度量.md "wikilink")，度量其誤動作的頻繁程度\[1\]。依[IEC
61508](../Page/IEC_61508.md "wikilink")、、ISA S84\[2\]及EN
50204\[3\]等安全標準中有提到一些會因為STL而獲益的典型系性。誤動作等级可以讓使用安全機能的終端客戶有可以量化的指標，有助於客戶訂定期望的安全機能可用性水準。誤動作等级可以針對整個安全迴路訂定，也可以只針對個別的元件。
...
安全機能可以達到的STL等級是依其安全機能的失效安全機率（PFS）而定。失效安全機率和[失效安全無關](../Page/失效安全.md "wikilink")，是指因安全系統內部問題，造成安全機能在不應動作時動作的機率。以下的表說明PFS數值以及對應的誤動作等級。
...
## 外部連結
  ...
  - [Spurious Trip Level analysis and
    certification](http://risknowlogy.com/portfolio/plant-availability-analysis/)
  - [IEC Functional safety zone](http://www.iec.ch/functionalsafety)
  - [IEC What is functional
    safety?](http://www.iec.ch/functionalsafety/explained/)
  - [Overview of
    IEC 61508](http://www2.theiet.org/oncomms/sector/computing/Articles/Object/58D25FCD-6153-46BD-ADAF910D2C4B69D4)
  - [SIL and Functional Safety in a
    Nutshell](http://risknowlogy.com/product/sil-functional-safety-nutshell/)
    - eBook introducing SIL and Functional Safety
...
1.  [Evaluation of Spurious Trip Rate of SIS dependent on demand
    rate](http://www.wseas.us/e-library/conferences/2015/Tenerife/MATH/MATH-01.pdf)
2.  ANSI/ISA-84.00.01-2004 Part 1 (IEC 61511-1 Mod) Functional Safety:
    Safety Instrumented Systems for the Process Industry Sector
3.  EN 50204 - Electrical apparatus for the detection and measurement of

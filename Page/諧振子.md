...
[古典力學中](https://zh.wikipedia.org/wiki/古典力學 "wikilink")，一個**諧振子**（）乃一個系統，當其從平衡位置[位移](../Page/位移.md "wikilink")，會感受到一個恢復[力](../Page/力.md "wikilink")\(F\)正比於位移\(x\)，並遵守[虎克定律](https://zh.wikipedia.org/wiki/虎克定律 "wikilink")：

\[F = -k x \,\]
其中\(k\)是一個正值[常數](https://zh.wikipedia.org/wiki/常數 "wikilink")。

如果\(F\)是系統僅受的力，則系統稱作**簡諧振子**（簡單和諧振子）。而其進行[簡諧運動](../Page/簡諧運動.md "wikilink")——正中央為平衡點的[正弦或](../Page/正弦.md "wikilink")[餘弦的](../Page/餘弦.md "wikilink")[振動](https://zh.wikipedia.org/wiki/振動 "wikilink")，且[振幅與](https://zh.wikipedia.org/wiki/振幅 "wikilink")[頻率都是常數](https://zh.wikipedia.org/wiki/頻率 "wikilink")（頻率跟振幅無關）。
...
力學上的例子包括了[單擺](https://zh.wikipedia.org/wiki/單擺 "wikilink")（限於小角度位移之近似）、連接到[彈簧的質量體](https://zh.wikipedia.org/wiki/彈簧 "wikilink")，以及[聲學系統](https://zh.wikipedia.org/wiki/聲學 "wikilink")。其他的相類系統包括了電學諧振子（electrical
harmonic
oscillator，參見[RLC電路](https://zh.wikipedia.org/wiki/RLC電路 "wikilink")）。
...
其中[振幅](https://zh.wikipedia.org/wiki/振幅 "wikilink")\(A \,\)以及[相位](https://zh.wikipedia.org/wiki/相位 "wikilink")\(\phi \,\)可透過[初始條件來決定](https://zh.wikipedia.org/wiki/初始條件 "wikilink")。
...
其中\(A_{0}\)是驅動振幅而\(\omega\)是驅動頻率，針對的是一弦波式的驅動機制。這樣的系統出現在[交流LC](../Page/交流電.md "wikilink")（[電感L](https://zh.wikipedia.org/wiki/電感 "wikilink")-[電容C](../Page/電容.md "wikilink")）電路以及理想化的彈簧系統（沒有內部力學阻力或外部的[空氣阻力](https://zh.wikipedia.org/wiki/空氣阻力 "wikilink")）。
...
為[阻抗](https://zh.wikipedia.org/wiki/力學阻抗 "wikilink")（impedance）或[線性響應函數](https://zh.wikipedia.org/wiki/線性響應函數 "wikilink")（linear
...
為相對於驅動力（相位定為0）的振動[相位](https://zh.wikipedia.org/wiki/相位 "wikilink")。
...
### 重要項
  ...
  - [頻率](https://zh.wikipedia.org/wiki/頻率 "wikilink")：單位時間內系統執行的循環總數量（通常以[赫茲](https://zh.wikipedia.org/wiki/赫茲 "wikilink")
    = 1/秒為量度）。
  - [角頻率](https://zh.wikipedia.org/wiki/角頻率 "wikilink")：\(\omega = 2 \pi f\)
  - [相位](https://zh.wikipedia.org/wiki/相位 "wikilink")：系统完成了循环的多少（开始时，系统的相位为零；完成了循环的一半时，系统的相位为\(\pi\)）。

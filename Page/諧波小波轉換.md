...
Domain）上。諧波小波轉換結合了[短時距傅立葉變換和](../Page/短時距傅立葉變換.md "wikilink")[連續小波轉換兩者之優點的訊號分析工具](../Page/連續小波轉換.md "wikilink")，而其離散版本則可以用[快速傅立葉變換做有效率的運算](https://zh.wikipedia.org/wiki/快速傅立葉變換 "wikilink")。
...
根據前文對\(W(\omega)\)的定義，或是透過直接計算傅立葉轉換對，我們也可以得到縮放和平移後的一系列諧波小波在[頻域上的表示法](../Page/頻域.md "wikilink")：
...
隨著\(j\)的階數比0越來越小，頻帶的振幅將越來越高、越來越窄，一路向頻率為0的位置延伸。而根據[多解析度分析的理論](../Page/多解析度分析.md "wikilink")，我們可以將這些階數小於0的頻帶全部收為一個頻帶，並定義為-1階（\(j = -1\)）。它涵蓋了DC到\(2\pi\)的頻帶範圍。以[小波轉換的術語來說](https://zh.wikipedia.org/wiki/小波轉換 "wikilink")，這樣具低通濾波性質的函式，被稱之為縮放函數（Scaling

...
在[美国](../Page/美国.md "wikilink")，Norton（Symantec）是市占率第一的防毒软件，而与之竞争的[McAfee](https://zh.wikipedia.org/wiki/McAfee "wikilink")、[Trend Micro分占第二](https://zh.wikipedia.org/wiki/Trend_Micro "wikilink")、三名位置。在臺灣及中國，其最強大的對手為[卡巴斯基](https://zh.wikipedia.org/wiki/Kaspersky_Anti-Virus "wikilink")。

在[數學裏](https://zh.wikipedia.org/wiki/數學 "wikilink")，特別是在[變分法裏](https://zh.wikipedia.org/wiki/變分法 "wikilink")，**變分法基本引理**（）是一種專門用來變換問題表述的[引理](https://zh.wikipedia.org/wiki/引理 "wikilink")，可以將問題從[弱版表述](https://zh.wikipedia.org/wiki/弱版表述 "wikilink")（）（[變分形式](https://zh.wikipedia.org/wiki/變分法 "wikilink")）改變為強版表述（[微分形式](../Page/微分.md "wikilink")）。
...
因為只要存在一個不滿足 \(\int_a^b f(x) \, h(x) \, dx = 0 \,\!\) 的 \(h(x)\) ，就可以證明
\(f(x)=0\,\!\) ，因此我們只須證明其中一個特例。
...
\[0 = \int_a^b f(x) h(x) \; dx = \int_a^b r(x) f(x)^2 \; dx\,\!\] 。 因為
\(r(x)\,\!\) 在 \((a,\ b)\,\!\) 是正值，所以\(f(x)\,\!\) 必須恆等於 0 ，與假設
\(f(x)\neq 0\,\!\) 矛盾。
...
的[極值是](https://zh.wikipedia.org/wiki/極值 "wikilink")[歐拉-拉格朗日方程式](../Page/歐拉-拉格朗日方程.md "wikilink")

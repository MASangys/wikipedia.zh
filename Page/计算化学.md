**计算化学**（computational
chemistry）是[理论化学的一个分支](../Page/理论化学.md "wikilink")，主要目的是利用有效的[数学近似以及](https://zh.wikipedia.org/wiki/近似演算法 "wikilink")[电脑程序计算](https://zh.wikipedia.org/wiki/电脑程序 "wikilink")[分子的性质](../Page/分子.md "wikilink")，例如[总能量](https://zh.wikipedia.org/wiki/总能量 "wikilink")、[偶极矩](https://zh.wikipedia.org/wiki/偶极矩 "wikilink")、[四极矩](https://zh.wikipedia.org/wiki/四极矩 "wikilink")、[振动频率](https://zh.wikipedia.org/wiki/振动频率 "wikilink")、[反应活性等](https://zh.wikipedia.org/wiki/反应活性 "wikilink")，并用以解释一些具体的化学问题。计算化学这个名词有时也用来表示[计算机科学与](../Page/计算机科学.md "wikilink")[化学的交叉学科](https://zh.wikipedia.org/wiki/化学 "wikilink")。
...
计算化学的子学科主要包括：
  ...
  - 研究化学结构与性质之间的关系
    （参见[定量构效关系](../Page/定量构效关系.md "wikilink")(QSAR)及[定量构性关系](https://zh.wikipedia.org/wiki/定量构性关系 "wikilink")(QSPR)）
  - 根据对作用力模拟对化学结构进行理论阐释
  - 计算机辅助化合物合成
  - 计算机辅助特性分子设计（例如[计算机辅助药物设计](https://zh.wikipedia.org/wiki/计算机辅助药物设计 "wikilink")）

2013年因**「為複雜化學系統創造了多尺度模型」**，[马丁·卡普拉斯](../Page/马丁·卡普拉斯.md "wikilink")、[邁可·列維特和](../Page/邁可·列維特.md "wikilink")[阿里耶·瓦舍尔一同獲得](../Page/阿里耶·瓦舍尔.md "wikilink")[諾貝爾化學獎](https://zh.wikipedia.org/wiki/諾貝爾化學獎 "wikilink")。\[1\]

## 第一原理方法

[第一原理方法](https://zh.wikipedia.org/wiki/第一原理 "wikilink")（*ab
...
电子结构可以通过求解定态[薛定谔方程](../Page/薛定谔方程.md "wikilink")（也成为不含时[薛定谔方程](../Page/薛定谔方程.md "wikilink")）得到。求解过程常使用[原子轨道线性组合](../Page/原子轨道线性组合.md "wikilink")（LCAO）得到的[基组来进行近似](https://zh.wikipedia.org/wiki/量子化学中的基组 "wikilink")。通过这种近似，[薛定谔方程可以转化为一个](../Page/薛定谔方程.md "wikilink")"简单"的电子[哈密顿量的](https://zh.wikipedia.org/wiki/哈密顿量 "wikilink")[本征值方程](https://zh.wikipedia.org/wiki/本征值 "wikilink")。该方程的解为[离散集](https://zh.wikipedia.org/wiki/离散集 "wikilink")。解得的[本征值是分子结构的函数](https://zh.wikipedia.org/wiki/本征值 "wikilink")。这种对应关系称为[势能面](https://zh.wikipedia.org/wiki/势能面 "wikilink")。

[Hartree-Fock是最常见的一种](https://zh.wikipedia.org/wiki/Hartree-Fock方程 "wikilink")[第一原理电子结构计算](https://zh.wikipedia.org/wiki/第一原理 "wikilink")。在Hartree-Fock近似中，每个电子在其余电子的平均势中运动，但是不知道这些电子的位置。当电子离得很近时，即使是用平均方法考虑电子间的库仑相互作用，电子也不能相互避开，因此在Hartree-Fock中高估了电子排斥。[Hartree-Fock方程需采用](https://zh.wikipedia.org/wiki/Hartree-Fock方程 "wikilink")[变分法求解](../Page/变分法.md "wikilink")，所得的近似能量永远等于或高于真实能量，随着基函数的增加，Hartree-Fock能量无限趋近于[Hartree-Fock极限能](https://zh.wikipedia.org/wiki/Hartree-Fock极限 "wikilink")。

[很多方法先进行Hartree](https://zh.wikipedia.org/wiki/后Hartree-Fock方法 "wikilink")-Fock计算，随后对电子的瞬时相关对此进行修正。相应能量的降低称为[电子相关能](https://zh.wikipedia.org/wiki/电子相关 "wikilink")。这些方法称为[后Hartree-Fock方法](https://zh.wikipedia.org/wiki/后Hartree-Fock方法 "wikilink")，包括[多体微扰理论](../Page/多体微扰理论.md "wikilink")、[耦合簇理论](https://zh.wikipedia.org/wiki/耦合簇理论 "wikilink")（Coupled
Cluster） 等。

[量子蒙特卡罗](https://zh.wikipedia.org/wiki/量子蒙特卡罗 "wikilink")（QMC）
...
的许多常用[泛函均包含由实验数据拟合而来的参数](../Page/泛函.md "wikilink")。但在解决分子的电子结构问题时也常将[密度泛函理论被当做](https://zh.wikipedia.org/wiki/密度泛函理论 "wikilink")[第一原理方法](https://zh.wikipedia.org/wiki/第一原理 "wikilink")。密度泛函理论使用[电子密度而不是](https://zh.wikipedia.org/wiki/电子密度 "wikilink")[波函数来表述体系能量](../Page/波函数.md "wikilink")。在DFT计算中，[哈密顿量的一项](https://zh.wikipedia.org/wiki/哈密顿量 "wikilink")，[交换-相关泛函](https://zh.wikipedia.org/wiki/交换-相关泛函 "wikilink")，采用近似形式。

当采取的近似足够小的时候，[第一原理电子结构方法的结果可以无限趋近准确值](https://zh.wikipedia.org/wiki/第一原理 "wikilink")。但是，与真实值的偏差往往并不随近似的减少而单调递减，有时最简单的计算反而会有更准确的结果。[第一原理计算的主要缺点是运算量巨大](https://zh.wikipedia.org/wiki/第一原理 "wikilink")，往往需要大量的计算时间、内存和磁盘空间。HF方法的计算量随体系的增大以
*N<sup>4</sup>* 增长（*N*
是[基函数的数目](https://zh.wikipedia.org/wiki/基函数 "wikilink")）–计算两倍大的体系需要16倍的时间–电子相关方法的增长速度更快（DFT计算大约以
*N<sup>3</sup>* 增长，相比之下是效率最高的电子相关方法）。

计算化学方法也可以用来解决[固体物理的问题](https://zh.wikipedia.org/wiki/固体物理 "wikilink")。晶体的电子结构通常用[能带结构来表示](../Page/能带结构.md "wikilink")。第一原理和半经验方法得到的轨道能量可以进一步应用于能带结构的计算当中。
...
[第一原理电子结构方法的常可分为](https://zh.wikipedia.org/wiki/第一原理 "wikilink")：
  ...
  - [耦合簇理论](https://zh.wikipedia.org/wiki/耦合簇理论 "wikilink")（Coupled
    Cluster）
...
在[玻恩-奥本海默近似下对](https://zh.wikipedia.org/wiki/玻恩-奥本海默近似 "wikilink")[原子核坐标变量与电子变量进行](../Page/原子核.md "wikilink")[分离后](https://zh.wikipedia.org/wiki/分离 "wikilink")，与核[自由度相关的波包通过与含时](https://zh.wikipedia.org/wiki/自由度 "wikilink")[薛定谔方程全](../Page/薛定谔方程.md "wikilink")[哈密顿量相关的](https://zh.wikipedia.org/wiki/哈密顿量 "wikilink")[演化算符进行传播](https://zh.wikipedia.org/wiki/演化算符 "wikilink")。而在以能量本征态为基础的另一套方法中，含时[薛定谔方程则通过](../Page/薛定谔方程.md "wikilink")进行求解。原子间相互作用势由[势能面描述](https://zh.wikipedia.org/wiki/势能面 "wikilink")，一般情况下，势能面之间通过[振动耦合项相互耦合](https://zh.wikipedia.org/wiki/振动耦合项 "wikilink")。
...
[分子动力学使用牛顿运动定律研究系统的含时特性](../Page/分子动力学.md "wikilink")，包括振动或布朗运动。大部分情况经常加入一些经典力学的描述。分子动力学与[密度泛函理论的结合称作](https://zh.wikipedia.org/wiki/密度泛函理论 "wikilink")[Car-Parrinello方法](https://zh.wikipedia.org/wiki/Car-Parrinello方法 "wikilink")。
...
很多情况下，对大分子体系的处理可以完全避免使用量子化学计算。[分子力学模拟使用古典力学模型](https://zh.wikipedia.org/wiki/分子力学 "wikilink")（例如[谐振子](https://zh.wikipedia.org/wiki/谐振子 "wikilink")）描述化合物的能量。分子力学模型的所有常数均通过实验数据或[第一原理计算结果得到](https://zh.wikipedia.org/wiki/第一原理 "wikilink")。参数和方程的优化结果称为[分子力场](../Page/分子力场.md "wikilink")。

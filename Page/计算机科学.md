...
虽然计算机科学被认定为正式学术学科的历史很短暂，但仍对[科学和](../Page/科学.md "wikilink")[社会作出了很多基础贡献](../Page/社会.md "wikilink")。包括：
  ...
  - [電腦成像廣泛用於](../Page/電腦成像.md "wikilink")[娛樂](https://zh.wikipedia.org/wiki/娛樂 "wikilink")，包括電視、電影、廣告、[動畫](https://zh.wikipedia.org/wiki/動畫 "wikilink")、[電子遊戲等](https://zh.wikipedia.org/wiki/電子遊戲 "wikilink")。
...
并发性（concurrency）是系统的一种性质，这类系统可以同时执行多个可能互相交互的计算。一些数学模型，如[Petri网](../Page/Petri网.md "wikilink")、[进程演算和](https://zh.wikipedia.org/wiki/进程演算 "wikilink")[PRAM模型](https://zh.wikipedia.org/wiki/PRAM模型 "wikilink")，被建立以用于通用并发计算。分布式系统将并发性的思想扩展到了多台由网络连接的计算机。同一分布式系统中的计算机拥有自己的私有内存，它们之间经常交换信息以达到一个共同的目的。

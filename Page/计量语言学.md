**计量语言学**（Quantitative Linguistics）是[语言学](../Page/语言学.md "wikilink")中[数理语言学](../Page/数理语言学.md "wikilink")的一个分支，主要用[数理统计方法研究和描述](https://zh.wikipedia.org/wiki/数理统计 "wikilink")[自然语言](https://zh.wikipedia.org/wiki/自然语言 "wikilink")，形成系统的语言理论。计量语言学的一个主要流派为[协同语言学](https://zh.wikipedia.org/wiki/协同语言学 "wikilink")（Synergetic linguistics）。计量语言学基于语言各层面的实证数据，因此经常采用语料库语言学和计算语言学的实证数据。
...
[Category:计量语言学](https://zh.wikipedia.org/wiki/Category:计量语言学 "wikilink") [Category:定量研究](https://zh.wikipedia.org/wiki/Category:定量研究 "wikilink")
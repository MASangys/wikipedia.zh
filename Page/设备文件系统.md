**设备文件**在[类Unix系统中是一个设备驱动程序的界面](../Page/类Unix系统.md "wikilink")，并被存储在[文件系统中](../Page/文件系统.md "wikilink")，就像常规文件。

在[微软的](../Page/微软.md "wikilink")[MS-DOS](../Page/MS-DOS.md "wikilink")、OS-2和[Windows等](https://zh.wikipedia.org/wiki/Windows "wikilink")[操作系统中也有专门的设备文件](../Page/操作系统.md "wikilink")。它们允许应用程序使用设备驱动程序，通过标准[输入输出系统调用与驱动程序交互](https://zh.wikipedia.org/wiki/输入输出 "wikilink")，从而简化了许多任务，也带来了于设备特性、功能无关的用户级I/O。

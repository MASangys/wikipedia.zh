...
**设计自动化标准委员会**（）是由[IEEE中对设计自动化感兴趣的人结成的子学会](../Page/电气电子工程师学会.md "wikilink")、IEEE计算机社团（Computer Society）和[IEEE标准协会](https://zh.wikipedia.org/wiki/IEEE标准协会 "wikilink")（）共同组成。该组织负责监管有关[计算机辅助设计](../Page/计算机辅助设计.md "wikilink")（即设计自动化）的IEEE标准。它也是IEEE计算机社团的一部分\[1\]

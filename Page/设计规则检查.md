> 本文内容由[设计规则检查](https://zh.wikipedia.org/wiki/设计规则检查)转换而来。


**设计规则检查**（）是[电子设计自动化的一个重要组成部分](https://zh.wikipedia.org/wiki/电子设计自动化 "wikilink")，它决定了指定[集成电路](../Page/集成电路.md "wikilink")芯片的[物理版图是否满足推荐的参数要求](../Page/集成电路版图.md "wikilink")，这个要求即设计规则。

## 设计规则

[The_three_basic_DRC_checks.svg](https://zh.wikipedia.org/wiki/File:The_three_basic_DRC_checks.svg "fig:The_three_basic_DRC_checks.svg") 设计规则是一系列由半导体制造厂商提供的参数，确保设计者能够画出正确的掩模板。

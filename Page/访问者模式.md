...
访问者模式使得我们可以在传统的[单分派语言](https://zh.wikipedia.org/wiki/单分派 "wikilink")（如[Smalltalk](../Page/Smalltalk.md "wikilink")、[Java和](../Page/Java.md "wikilink")[C++](../Page/C++.md "wikilink")）中模拟[双分派技术](https://zh.wikipedia.org/wiki/双分派 "wikilink")。对于支持[多分派的语言](https://zh.wikipedia.org/wiki/多分派 "wikilink")（如[CLOS](https://zh.wikipedia.org/wiki/CLOS "wikilink")），访问者模式已经内置于语言特性之中了，从而不再重要。

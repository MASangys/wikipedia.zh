...
**语义网[堆栈](../Page/堆栈.md "wikilink")**（）或称**语义网[蛋糕](../Page/蛋糕.md "wikilink")*****、**语义网[千层饼](https://zh.wikipedia.org/wiki/千层饼 "wikilink")**（***）指[语义网的](../Page/语义网.md "wikilink")[体系架构](https://zh.wikipedia.org/wiki/体系架构_\(计算机科学\) "wikilink")。
...
堆栈图中的底部层面，包括超文本网络方面众所周知的那些技术以及一些未加改动的技术，奠定了语义网的基础。
  ...
  - [XML是一种](../Page/XML.md "wikilink")[标记语言](https://zh.wikipedia.org/wiki/标记语言 "wikilink")（置标语言），使得我们能够创建由[结构化数据构成的](https://zh.wikipedia.org/wiki/结构化 "wikilink")[文档](https://zh.wikipedia.org/wiki/文档_\(计算机科学\) "wikilink")。语义网将把[含义赋予结构化数据](https://zh.wikipedia.org/wiki/含义_\(语义学\) "wikilink")
...
中间的那些层面-{}-包含的是那些[W3C已经加以标准化的技术](https://zh.wikipedia.org/wiki/W3C "wikilink")，旨在使语义应用程序得以构建。
  ...
  - [资源描述框架](https://zh.wikipedia.org/wiki/RDF "wikilink")（，[RDF](https://zh.wikipedia.org/wiki/RDF "wikilink")）是一种框架，用于采用一种称为[三元组的形式来创建声明](https://zh.wikipedia.org/wiki/三元组 "wikilink")。RDF使得我们能够采用图形的形式来表达资源的有关信息，因为语义网有时又被称为“[Giant
    Global
    Graph](https://zh.wikipedia.org/wiki/:en:Giant_Global_Graph "wikilink")”（[巨大全球图](../Page/巨大全球图.md "wikilink")，GGG）。
  - [RDF
    Schema](https://zh.wikipedia.org/wiki/:en:RDF_Schema "wikilink")（RDF模式，[RDFS](https://zh.wikipedia.org/wiki/RDFS "wikilink")，RDF-S）旨在为RDF提供基础[词表](https://zh.wikipedia.org/wiki/词表 "wikilink")（基本词汇）。例如，采用了RDFS，就有可能创建出由类和属性组成的层级结构。
  - [网络本体语言](../Page/网络本体语言.md "wikilink")（，OWL）通过添加更多用于描述RDF声明之语义的构造（结构），从而对RDFS进行扩展。OWL允许声明额外的约束，如[基数](https://zh.wikipedia.org/wiki/基数 "wikilink")、取值的限制，或者[可传递性之类有关属性的特征](https://zh.wikipedia.org/wiki/可传递性 "wikilink")。OWL建立在[描述逻辑的基础之上](https://zh.wikipedia.org/wiki/描述逻辑 "wikilink")，因而为语义网带来了[推理能力](../Page/推理.md "wikilink")。
...
顶部层面则包含的是那些目前尚未实现标准化的或者仅仅包含的是为了实现语义网而应当加以实现的想法或概念。
  ...
  - [密码学对于确保和验证语义网声明来自于值得信赖的可靠来源方面具有重要意义](../Page/密码学.md "wikilink")。借助于RDF声明适当的[数字签名](https://zh.wikipedia.org/wiki/数字签名 "wikilink")，即可实现这一点。
  - 对于派生出来的声明的信任将会得到两个方面的支持：(a)
    验证[前提来自于可信赖的原始资料](https://zh.wikipedia.org/wiki/前提 "wikilink")；(b)
    在派生新的信息之时依赖于[形式逻辑](https://zh.wikipedia.org/wiki/形式逻辑 "wikilink")。

**語意記憶**（[Semantic memory](https://zh.wikipedia.org/wiki/Semantic_memory "wikilink")），又稱**語義記憶**、**字義記憶**，是一種記憶的型態。它是一種對於一般知識的事實與概念的了解，透過語言、文字、數字、演算法等抽象性的了解來形成記憶。語意記憶通常是經由[情節記憶發展而來](https://zh.wikipedia.org/wiki/情節記憶 "wikilink")，是一種客觀性的知識，與個人經驗無關。
...
## 外部連結
  ...
  - [S-Space Package](http://code.google.com/p/airhead-research/), an open source Java library that includes several semantic memory implementations,such as PEN and IS for generating [Statistical semantics](https://zh.wikipedia.org/wiki/Statistical_semantics "wikilink") from a text corpus
...
[分类:记忆](https://zh.wikipedia.org/wiki/分类:记忆 "wikilink") [分类:语义学](https://zh.wikipedia.org/wiki/分类:语义学 "wikilink")
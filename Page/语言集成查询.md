...
[匿名型別](https://zh.wikipedia.org/wiki/匿名型別 "wikilink")（Anonymous
type）是C\# 3.0與Visual Basic
9.0新增的功能，它允許開發人員可以使用不具型別的方式建立新的資料結構，而真正的型別在編譯時期，由C\#
(或VB)
...
下列的言語支持LINQ。
  ...
  - [Visual Basic
    2008](https://zh.wikipedia.org/wiki/Visual_Basic_2008 "wikilink")（9.0）

註：[C++/CLI尚未支援LINQ](https://zh.wikipedia.org/wiki/C++/CLI "wikilink")。但是有第三方的C++套件\[1\]，以及第三方的[PHP套件](../Page/PHP.md "wikilink")\[2\]

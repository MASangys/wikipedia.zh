**诱导公式**（）是[数学](../Page/数学.md "wikilink")[三角函数中将](../Page/三角函数.md "wikilink")[角度比较大的三角函数利用](https://zh.wikipedia.org/wiki/角度 "wikilink")[角度的](https://zh.wikipedia.org/wiki/角度 "wikilink")[周期性](https://zh.wikipedia.org/wiki/周期 "wikilink")，转换为角度比较小的[三角函数的变形公式](../Page/三角函数.md "wikilink")。诱导公式分为以下六类：
...
可用如下口诀将联系记忆起来：“**奇变偶不变，符号看[象限](https://zh.wikipedia.org/wiki/象限 "wikilink")**”。意思为，当\(k\)为[奇数时](https://zh.wikipedia.org/wiki/奇数 "wikilink")，\(\sin\)变为\(\cos\)，\(\cos\)变为\(\sin\)，\(\tan\)变为\(\cot\)，\(\cot\)变为\(\tan\)，\(\sec\)变为\(\csc\)，\(\csc\)变为\(\sec\)；而\(k\)为[偶数时](https://zh.wikipedia.org/wiki/偶数 "wikilink")，三角函数则不变换。对于正负号，则要看最后-{}-角所在的象限进行判断，可以使用如下口诀：**CAST**，也可以使用**ASTC**
(All Students Take Calculus) 用来记忆。

  - 第一象限的 A 即是 All（全部皆正）。
  - 第二象限的 S 即是 **Sin**e &
    Co**S**ecant（[正弦以及](../Page/正弦.md "wikilink")[余割为正](../Page/餘割.md "wikilink")）。
  - 第三象限的 T 即是 **Tan**gent &
    **Cot**angent（[正切以及](https://zh.wikipedia.org/wiki/正切函数 "wikilink")[余切为正](https://zh.wikipedia.org/wiki/余切 "wikilink")）。
  - 第四象限的 C 即是 **Cos**ine &
    Se**C**ant（[余弦以及](../Page/餘弦定理.md "wikilink")[正割为正](../Page/正割.md "wikilink")）。

**诱导公式**（）是[数学](../Page/数学.md "wikilink")[三角函数中将](../Page/三角函数.md "wikilink")[角度比较大的三角函数利用](../Page/角度.md "wikilink")[角度的](../Page/角度.md "wikilink")[周期性](../Page/周期.md "wikilink")，转换为角度比较小的[三角函数的变形公式](../Page/三角函数.md "wikilink")。诱导公式分为以下六类：
...
## 公式三（函数的[奇偶性](../Page/奇函数与偶函数.md "wikilink")）
...
可用如下口诀将联系记忆起来：“**奇变偶不变，符号看[象限](../Page/象限.md "wikilink")**”。意思为，当\(k\)为[奇数时](../Page/奇数.md "wikilink")，\(\sin\)变为\(\cos\)，\(\cos\)变为\(\sin\)，\(\tan\)变为\(\cot\)，\(\cot\)变为\(\tan\)，\(\sec\)变为\(\csc\)，\(\csc\)变为\(\sec\)；而\(k\)为[偶数时](../Page/偶数.md "wikilink")，三角函数则不变换。对于正负号，则要看最后-{}-角所在的象限进行判断，可以使用如下口诀：**CAST**，也可以使用**ASTC**
(All Students Take Calculus) 用来记忆。
  ...
  - 第三象限的 T 即是 **Tan**gent &
    **Cot**angent（[正切以及](../Page/正切函数.md "wikilink")[余切为正](../Page/余切.md "wikilink")）。
  - 第四象限的 C 即是 **Cos**ine &

**[诺特定理](../Page/埃米·诺特.md "wikilink")**是[理论物理的中心结果之一](https://zh.wikipedia.org/wiki/理论物理 "wikilink")，它表达了连续[对称性和](https://zh.wikipedia.org/wiki/对称性 "wikilink")[守恒定律](../Page/守恒定律.md "wikilink")的一一对应。例如，物理定律不随着时间而改变，这表示它们有关于时间的某种对称性。如果我们想象一下，譬如重力的强度每天都有所改变，我们就会违反能量守恒定律，因为我们可以在重力弱的那天把重物举起，然后在重力强的时候放下来，这样就得到了比我们开始输入的能量更多的能量。
...
设我们有一个n维[流形](../Page/流形.md "wikilink")M以及一个目标流形T。令\(\mathcal{C}\)为从M到T的[光滑函数](../Page/光滑函数.md "wikilink")组成的[位形空间](https://zh.wikipedia.org/wiki/位形空间 "wikilink")。（更一般的情况下，我们可以有一个M上的[纤维丛](../Page/纤维丛.md "wikilink")的光滑截面）
...
要得到通常版本的诺特定理，我们需要对[作用量](../Page/作用量.md "wikilink")作额外的限制。我们假设S\[φ\]是M上的如下函数的积分
...
设我们给出[边界条件](https://zh.wikipedia.org/wiki/边界条件 "wikilink")，也即，在M为[紧致的情况下φ在边界的取值](https://zh.wikipedia.org/wiki/紧致 "wikilink")，或者在x趋向∞时，φ的极限。则\(\mathcal{C}\)的由满足如下两个条件的的φ组成的子空间就是[在壳解的子空间](https://zh.wikipedia.org/wiki/在壳 "wikilink")，其一是φ的S的[泛函导数](../Page/泛函导数.md "wikilink")为零，也即：
...
若这在[在壳和](https://zh.wikipedia.org/wiki/在壳 "wikilink")[离壳都成立](https://zh.wikipedia.org/wiki/离壳 "wikilink")，我们称*Q*生成一个离壳对称性。若只在在壳情况成立，称*Q*生成在壳对称性。 然后，我们称*Q*是[单参数](../Page/单参数群.md "wikilink")[对称性](https://zh.wikipedia.org/wiki/对称性 "wikilink")[李群](../Page/李群.md "wikilink")的生成元。
...
\int_{\partial N}ds_\mu\frac{\partial\mathcal{L}}{\partial(\partial_\mu\phi)}Q[\phi]\) |- | | \(=\int_{\partial N}ds_\mu\frac{\partial\mathcal{L}}{\partial(\partial_\mu\phi)}Q[\phi].\) |} 因为这对于所有*N*成立，我们有

**[诺特定理](../Page/埃米·诺特.md "wikilink")**是[理论物理的中心结果之一](https://zh.wikipedia.org/wiki/理论物理 "wikilink")，它表达了连续[对称性和](https://zh.wikipedia.org/wiki/对称性 "wikilink")[守恒定律的一一对应](../Page/守恒定律.md "wikilink")。例如，物理定律不随着时间而改变，这表示它们有关于时间的某种对称性。如果我们想象一下，譬如重力的强度每天都有所改变，我们就会违反能量守恒定律，因为我们可以在重力弱的那天把重物举起，然后在重力强的时候放下来，这样就得到了比我们开始输入的能量更多的能量。

诺特定理对于所有基于[作用量原理的](../Page/作用量.md "wikilink")[物理定律是成立的](https://zh.wikipedia.org/wiki/物理定律 "wikilink")。它得名于20世纪初的数学家[埃米·诺特](../Page/埃米·诺特.md "wikilink")。诺特定理和[量子力学深刻相关](../Page/量子力学.md "wikilink")，因为它仅用[经典力学的原理就可以认出和](../Page/经典力学.md "wikilink")[海森堡测不准原理相关的物理量](https://zh.wikipedia.org/wiki/海森堡测不准原理 "wikilink")（譬如[位置和](https://zh.wikipedia.org/wiki/位置 "wikilink")[动量](../Page/动量.md "wikilink")）。
...
上述命题中的“对称性”一词精确一点来说是指物理定律在满足某种技术要求的一维[李群作用下所满足的](../Page/李群.md "wikilink")[协变性](https://zh.wikipedia.org/wiki/协变变换 "wikilink")。[物理量的](../Page/物理量.md "wikilink")[守恒定律通常用](../Page/守恒定律.md "wikilink")[连续性方程表达](https://zh.wikipedia.org/wiki/连续性方程 "wikilink")。

定理的形式化命题仅从不变性条件就导出和一个守恒的物理量相应的[流的表达式](https://zh.wikipedia.org/wiki/流 "wikilink")。该守恒量称为*诺特荷*，而该流称为*诺特流*。诺特流至多相差一个无[散度向量场](../Page/散度.md "wikilink")。
...
在[量子场论中](../Page/量子场论.md "wikilink")，和诺特定理相似，[沃德－高桥恒等式](https://zh.wikipedia.org/wiki/沃德－高桥恒等式 "wikilink")（Ward-Takahashi）产生出更多的守恒定律，例如从[电势和](https://zh.wikipedia.org/wiki/电势 "wikilink")[向量势的](https://zh.wikipedia.org/wiki/向量势 "wikilink")[规范不变性得出](https://zh.wikipedia.org/wiki/规范不变性 "wikilink")[电荷的守恒](https://zh.wikipedia.org/wiki/电荷 "wikilink")。

诺特荷也被用于计算[静态黑洞的](https://zh.wikipedia.org/wiki/静态黑洞 "wikilink")[熵](../Page/熵.md "wikilink")。

## 证明

设我们有一个n维[流形M以及一个目标流形T](../Page/流形.md "wikilink")。令\(\mathcal{C}\)为从M到T的[光滑函数组成的](../Page/光滑函数.md "wikilink")[位形空间](https://zh.wikipedia.org/wiki/位形空间 "wikilink")。（更一般的情况下，我们可以有一个M上的[纤维丛的光滑截面](../Page/纤维丛.md "wikilink")）

物理学中这样的"M"的例子包括：

  - [经典力学上](../Page/经典力学.md "wikilink")，[哈密顿表述中](../Page/哈密顿力学.md "wikilink")，M是一个一维流形**R**，代表时间而目标空间是广义位置的[空间的](https://zh.wikipedia.org/wiki/空间 "wikilink")[余切丛](../Page/余切丛.md "wikilink")。
  - [场论中](https://zh.wikipedia.org/wiki/场论 "wikilink")，M是[时空流形](../Page/时空.md "wikilink")，而目标空间是场在任何给定可取的值的集合。例如，如果有m个[实值](../Page/实数.md "wikilink")[标量场](https://zh.wikipedia.org/wiki/标量场 "wikilink")，φ<sub>1</sub>,...,φ<sub>m</sub>，则目标流形是**R**<sup>m</sup>。若流形是一个实向量场，则目标流形[同构于](../Page/同构.md "wikilink")**R**<sup>3</sup>。
...
设我们给出[边界条件](https://zh.wikipedia.org/wiki/边界条件 "wikilink")，也即，在M为[紧致的情况下φ在边界的取值](https://zh.wikipedia.org/wiki/紧致 "wikilink")，或者在x趋向∞时，φ的极限。则\(\mathcal{C}\)的由满足如下两个条件的的φ组成的子空间就是[在壳解的子空间](https://zh.wikipedia.org/wiki/在壳 "wikilink")，其一是φ的S的[泛函导数为零](../Page/泛函导数.md "wikilink")，也即：

\[\frac{\delta}{\delta \phi(x)}S[\phi]=0\]
其二是φ满足给定边界条件。（参看[稳定作用量原理](../Page/最小作用量原理.md "wikilink")）

现在，假设我们有一个[无穷小变换](../Page/无穷小变换.md "wikilink")，定义在\(\mathcal{C}\)上，它由一个[泛函](../Page/泛函.md "wikilink")[求导Q生成](https://zh.wikipedia.org/wiki/求导 "wikilink")，满足
...
若这在[在壳和](https://zh.wikipedia.org/wiki/在壳 "wikilink")[离壳都成立](https://zh.wikipedia.org/wiki/离壳 "wikilink")，我们称*Q*生成一个离壳对称性。若只在在壳情况成立，称*Q*生成在壳对称性。
然后，我们称*Q*是[单参数](../Page/单参数群.md "wikilink")[对称性](https://zh.wikipedia.org/wiki/对称性 "wikilink")[李群的生成元](../Page/李群.md "wikilink")。

现在，对于每个*N*，因为[欧拉-拉格朗日方程](https://zh.wikipedia.org/wiki/欧拉-拉格朗日方程 "wikilink")，[在壳](https://zh.wikipedia.org/wiki/在壳 "wikilink")（只有在壳）上，我们有
...
这被称为和该[对称性相关的](https://zh.wikipedia.org/wiki/对称性 "wikilink")**诺特流（Noether
current）**。该连续性方程说明如果对这个流在[空间式切片上](https://zh.wikipedia.org/wiki/空间式 "wikilink")[积分](../Page/积分.md "wikilink")，就可以得到称为[诺特荷的](https://zh.wikipedia.org/wiki/诺特荷 "wikilink")[守恒量](../Page/守恒定律.md "wikilink")（当然，必须假定M非[紧致时](https://zh.wikipedia.org/wiki/紧致 "wikilink")，该流趋向无穷远处时下降足够快）。
...
上面的两个例子都是在一维流形（时间）上的。下面我们来看一个时空中的例子，我们考虑(3＋1)-[闵可夫斯基时空中的无质量有一个四次势的标量场的](https://zh.wikipedia.org/wiki/闵可夫斯基时空 "wikilink")[共形变换](https://zh.wikipedia.org/wiki/共形变换 "wikilink")。
...
（另外：如果要找出该方程的[沃德-高桥版本](https://zh.wikipedia.org/wiki/沃德-高桥 "wikilink")，你会遇到[异常问题](https://zh.wikipedia.org/wiki/异常_\(物理\) "wikilink")。）
...
## 参考
  ...
  - [关于诺特定理的文章（英文）](http://math.ucr.edu/home/baez/noether.html)，作者[John
    Baez](https://zh.wikipedia.org/wiki/John_Baez "wikilink")
  ...
  - [诺特关于对称性和守恒定律之间的深刻关系的发现](https://web.archive.org/web/20110514080739/http://www.physics.ucla.edu/~cwp/articles/noether.asg/noether.html)，作者[Nina
    Byers](https://zh.wikipedia.org/wiki/Nina_Byers "wikilink")

...
在另一個方向，有個著名的結果是如果\(X,Y\subseteq\mathbb{R}^n\)是[博雷爾集](../Page/博雷爾集.md "wikilink")，則其積的郝斯多夫維度有上界：\(X\)的郝斯多夫維度加上\(Y\)的[上填充維度](https://zh.wikipedia.org/wiki/填充維度 "wikilink")，此結果在Mattila (1995)討論.

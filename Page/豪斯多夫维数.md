**豪斯多夫维数**又称作**[豪斯多夫](../Page/费利克斯·豪斯多夫.md "wikilink")-[贝塞科维奇维数](https://zh.wikipedia.org/wiki/亞伯蘭·薩摩洛維奇·貝西科維奇 "wikilink")**（）或**[分形维数](https://zh.wikipedia.org/wiki/分形维数 "wikilink")**，它是由数学家[豪斯多夫于](https://zh.wikipedia.org/wiki/豪斯多夫 "wikilink")1918年引入的。通过豪斯多夫维数可以定義任意[度量空間的](../Page/度量空间.md "wikilink")[子集之](../Page/子集.md "wikilink")[維數](../Page/維度.md "wikilink")，包括像是[分形](../Page/分形.md "wikilink")（）等复杂的[集合](https://zh.wikipedia.org/wiki/集合 "wikilink")。对于简单的[几何形狀比如线](https://zh.wikipedia.org/wiki/几何 "wikilink")、长方形、长方体等豪斯多夫维数等同于它们通常的几何维度或者说[拓扑维度](https://zh.wikipedia.org/wiki/拓扑维度 "wikilink")。通常来说一个物体的豪斯多夫维数不像拓扑维度一样总是一个[自然数而可能会是一个非整的](../Page/自然数.md "wikilink")[有理数或者](../Page/有理数.md "wikilink")[无理数](https://zh.wikipedia.org/wiki/无理数 "wikilink")。
...
\[H^d_\delta(E) = \inf\Bigl\{\sum_{i=1}^\infty (\operatorname{diam}\;U_i)^d: \bigcup_{i=1}^\infty U_i\supseteq E,\,\operatorname{diam}\;U_i<\delta\Bigr\}.\]
并且能被集族\((A_j)_k\)所覆盖。 则的豪斯多夫[外测度被定义为](../Page/外测度.md "wikilink")：

\[H^d(E) = \lim_{\delta \rightarrow 0} H^d_\delta(E).\] **豪斯多夫维数**：
豪斯多夫维数被定义为豪斯多夫外测度从零变为非零值跳跃点对应的值。严格的定义为：
...
在另一個方向，有個著名的結果是如果\(X,Y\subseteq\mathbb{R}^n\)是[博雷爾集](../Page/博雷爾集.md "wikilink")，則其積的郝斯多夫維度有上界：\(X\)的郝斯多夫維度加上\(Y\)的[上填充維度](https://zh.wikipedia.org/wiki/填充維度 "wikilink")，此結果在Mattila
(1995)討論.

## 计算

豪斯多夫维数是不容易直接计算的，一般的可以通过**[计盒维数](../Page/计盒维数.md "wikilink")**（Box-counting
dimension）估计到它的一个上界，而且可以通过**局部维数**（点维数，Local dimension）估计到它的一个下界。
...
事實上，如果\(\psi_i\)都是[压缩映射](../Page/压缩映射.md "wikilink")，那麼存在唯一的[非空](https://zh.wikipedia.org/wiki/非空 "wikilink")[緊緻集合](https://zh.wikipedia.org/wiki/緊緻 "wikilink")\(A\)滿足上上式。這個定理可將[巴拿赫的](https://zh.wikipedia.org/wiki/Stefan_Banach "wikilink")[巴拿赫不动点定理應用在](../Page/巴拿赫不动点定理.md "wikilink")[完备度量空间](../Page/完备空间.md "wikilink")（\(\mathbb{R}^n\)的非空緊緻子集和[郝斯多夫距離](https://zh.wikipedia.org/wiki/豪斯多夫距离 "wikilink")）。\[3\]

### 開集條件

為了計算某些特定情況時的郝斯多夫維數，我們需要定義開集條件（open set condition 簡稱
OSC）：我們說映射\(\psi_i,\,i=1,\dots,m\)滿足開集條件如果[非空](https://zh.wikipedia.org/wiki/非空 "wikilink")[有界](https://zh.wikipedia.org/wiki/有界 "wikilink")[開集\(V\)使得](https://zh.wikipedia.org/wiki/開集合 "wikilink")
...
**定理**.
假設壓縮映射\(\psi_i,\,i=1,\dots,m\)滿足開集條件，並且其縮放比例分別為\(r_1,\dots,r_n\in(0,1)\)。則對於唯一滿足\(\textstyle A = \bigcup_{i=1}^m \psi_i (A)\)的集合，其郝斯多夫維數\(s\)滿足\[4\]

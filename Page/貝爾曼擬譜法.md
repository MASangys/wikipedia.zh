**貝爾曼擬譜法**（Bellman pseudospectral method）是針對[最优控制的](https://zh.wikipedia.org/wiki/最优控制 "wikilink")[擬譜法](../Page/擬譜法.md "wikilink")，以[貝爾曼方程](../Page/貝爾曼方程.md "wikilink")為基礎，是提出中的一部份\[1\]。此方法得名自[理查德·貝爾曼](../Page/理查德·貝爾曼.md "wikilink")，是由開始使用\[2\]\[3\]，一開始是用來求解多尺度的最佳控制問題，後來擴展到一般最佳問題的次佳解。

...
[Bezier_curve.svg](https://zh.wikipedia.org/wiki/File:Bezier_curve.svg "fig:Bezier_curve.svg") 在[數學的](https://zh.wikipedia.org/wiki/數學 "wikilink")[數值分析領域中](https://zh.wikipedia.org/wiki/數值分析 "wikilink")，**貝茲曲線**（，亦作「贝塞尔」）是[计算机圖形學中相當重要的](https://zh.wikipedia.org/wiki/计算机圖形學 "wikilink")[參數曲線](https://zh.wikipedia.org/wiki/參數曲線 "wikilink")。更高[維度](../Page/維度.md "wikilink")的廣泛化貝茲曲線就稱作[貝茲曲面](https://zh.wikipedia.org/wiki/貝茲曲面 "wikilink")，其中[貝茲三角是一種特殊的實例](https://zh.wikipedia.org/wiki/貝茲三角 "wikilink")。

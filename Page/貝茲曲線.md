...
在[數學的](https://zh.wikipedia.org/wiki/數學 "wikilink")[數值分析領域中](https://zh.wikipedia.org/wiki/數值分析 "wikilink")，**貝茲曲線**（，亦作「贝塞尔」）是[计算机圖形學中相當重要的](https://zh.wikipedia.org/wiki/计算机圖形學 "wikilink")[參數曲線](https://zh.wikipedia.org/wiki/參數曲線 "wikilink")。更高[維度的廣泛化貝茲曲線就稱作](../Page/維度.md "wikilink")[貝茲曲面](https://zh.wikipedia.org/wiki/貝茲曲面 "wikilink")，其中[貝茲三角是一種特殊的實例](https://zh.wikipedia.org/wiki/貝茲三角 "wikilink")。
...
且其等同於[線性插值](https://zh.wikipedia.org/wiki/線性插值 "wikilink")。
...
[TrueType字型就運用了以](../Page/TrueType.md "wikilink")[貝茲樣條組成的二次貝茲曲線](https://zh.wikipedia.org/wiki/貝茲樣條 "wikilink")。
...
現代的成象系統，如[PostScript](../Page/PostScript.md "wikilink")、[Asymptote和](../Page/Asymptote.md "wikilink")[Metafont](https://zh.wikipedia.org/wiki/Metafont "wikilink")，運用了以[貝茲樣條組成的三次貝茲曲線](https://zh.wikipedia.org/wiki/貝茲樣條 "wikilink")，用來描繪曲線輪廓。
...
又稱作*n*階的[伯恩斯坦基底多項式](https://zh.wikipedia.org/wiki/伯恩斯坦多項式 "wikilink")，定義0<sup>0</sup>
= 1。

點**P**<sub>*i*</sub>稱作貝茲曲線的**控制點**。[多邊形以帶有](https://zh.wikipedia.org/wiki/多邊形 "wikilink")[線的貝茲點連接而成](https://zh.wikipedia.org/wiki/線 "wikilink")，起始於**P**<sub>0</sub>並以**P**<sub>*n*</sub>終止，稱作**貝茲多邊形**（或**控制多邊形**）。貝茲多邊形的[凸包](../Page/凸包.md "wikilink")（convex
hull）包含有貝茲曲線。
...
这些运动轨迹使用[de
Casteljau演算法计算出贝塞尔曲线](https://zh.wikipedia.org/wiki/de_Casteljau演算法 "wikilink")。\[1\]

## 升階

*n*次貝茲曲線可以轉換為一個形狀完全相同的*n+1*次貝茲曲線。 這在軟體只支援特定階次的貝茲曲線時很有用。
例如，[Cairo只支援三次貝茲曲線](https://zh.wikipedia.org/wiki/cairo_\(繪圖\) "wikilink")，你就可以用升階的方法在Cairo畫出二次貝茲曲線。
...
在部分架構中，下以程式碼也可由[動態规划進行最佳化](https://zh.wikipedia.org/wiki/動態规划 "wikilink")。舉例來說，*dt*是一個常數，*cx*
\*
*t*則等同於每次反覆就修改一次常數。經反覆應用這種最佳化後，迴圈可被重寫為沒有任何乘法（雖然這個過程不是[穩定數值的](https://zh.wikipedia.org/wiki/數值穩定性 "wikilink")）。
...
計算曲線上的點時需要多次計算\(\mathbf{B}(t)\)，因此事先計算好\(\mathbf{C}_j\)會比較實際；然而要小心高階曲線可能會缺乏[數值穩定性](https://zh.wikipedia.org/wiki/數值穩定性 "wikilink")（需使用[De
Casteljau演算法來處理](https://zh.wikipedia.org/wiki/De_Casteljau演算法 "wikilink")）。注意其[empty
product為](https://zh.wikipedia.org/wiki/empty_product "wikilink")1。
...
有理貝茲增加可調節的權重，以提供更近似於隨意的形狀。分子是加權的伯恩斯坦形式貝茲曲線，而分母是加權的[伯恩斯坦多項式的總和](https://zh.wikipedia.org/wiki/伯恩斯坦多項式 "wikilink")。
...
## 參閱
  ...
  - [string
    art](https://zh.wikipedia.org/wiki/string_art "wikilink")，Bézier
    curves are also formed by many common forms of string art, where
    strings are looped across a frame of nails.
...
### 来源
  ...
  - [Donald
    ...
    *Metafont: the Program*, Addison-Wesley 1986, pp. 123-131. Excellent
    discussion of implementation details; available for free as part of

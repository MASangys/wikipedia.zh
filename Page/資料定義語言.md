...
Language，DDL）是[SQL語言集中負責資料結構定義與](../Page/SQL.md "wikilink")[資料庫物件定義的語言](https://zh.wikipedia.org/wiki/資料庫物件 "wikilink")，由`CREATE`、`ALTER`與`DROP`三個語法所組成，最早是由Codasyl（Conference

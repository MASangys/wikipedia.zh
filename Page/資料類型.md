...
所有在電腦中，基於數位電子學的底層資料，都是以[位元](../Page/位元.md "wikilink")（0 或 1）表示。其中資料的最小的定址單位，稱為[位元組](https://zh.wikipedia.org/wiki/位元組 "wikilink")（通常是[八位元](https://zh.wikipedia.org/wiki/Octet "wikilink")，以八個位元為一組）。[機器碼指令處理的單位](https://zh.wikipedia.org/wiki/機器碼 "wikilink")，稱作[字長](https://zh.wikipedia.org/wiki/字長_\(電腦科學\) "wikilink")（至 2007 年止，一般為 32 或 64 位元）大部分對字長的指令解譯，主要以[二進制為主](https://zh.wikipedia.org/wiki/二進制 "wikilink")，如一個 32 位元的字長，可以表示從 0 至 \(2^{32}-1\) 的無符號整數值，或者表示從 \(-2^{31}\) 至 \(2^{31}-1\) 的有符號整數值。由於有了[二的補數](https://zh.wikipedia.org/wiki/二的補數 "wikilink")，機器語言和機器大多不需要區分無符號和有符號資料類型。存在著特殊的算術指令，對字長中的位元使用不同的解釋，以此作為[浮點數](https://zh.wikipedia.org/wiki/浮點數 "wikilink")。

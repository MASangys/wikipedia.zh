**賦環空間** （ringed space）
在數學上係指一個[拓撲空間配上一個](https://zh.wikipedia.org/wiki/拓撲空間 "wikilink")[交換環層](https://zh.wikipedia.org/wiki/層_\(數學\) "wikilink")，其中特別重要的一類是**局部賦環空間**。此概念在現代的[代數幾何學佔重要角色](https://zh.wikipedia.org/wiki/代數幾何 "wikilink")。
...
全體賦環空間構成一個[範疇](https://zh.wikipedia.org/wiki/範疇論 "wikilink")，\((X, \mathcal{O}_X)\)到\((Y, \mathcal{O}_Y)\)的[態射是一組](https://zh.wikipedia.org/wiki/態射 "wikilink")\((f, f^\sharp)\)，其中\(f: X \rightarrow Y\)是連續映射，\(f^\sharp: \mathcal{O}_Y \rightarrow f_* \mathcal{O}_X\)是環層的態射（
...
## 例子
  ...
  - 設\(X\)為任一拓撲空間，\(\mathcal{O}_X : U \mapsto C(U)\)（\(C(U)\)表 U
    上的[連續函數](https://zh.wikipedia.org/wiki/連續函數 "wikilink")），則\((X, \mathcal{O}_X)\)

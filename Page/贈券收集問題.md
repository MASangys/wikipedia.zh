**贈券收集問題**是[機率論中的著名題目](../Page/機率論.md "wikilink")，其目的在解答以下問題：
...
假設*T*是收集所有*n*種贈券的次数，\(t_i\)是在收集了第*i-1*種贈券以後，到收集到第*i*種贈券所花的次数，那麼*T*和\(t_i\)都是[隨機變量](../Page/隨機變量.md "wikilink")。在收集到*i-1*種贈券後能再找到「新」一種贈券的概率是\(p_i = \frac{n - i + 1}{n}\)，所以\(t_i\)是一種[幾何分佈](../Page/幾何分佈.md "wikilink")，並有[期望值](../Page/期望值.md "wikilink")\(\frac{1}{p_i}\)。根據期望值的線性性質，
...
\text{as}  \ n \to \infty,\]
其中\(\gamma \approx 0.5772156649\)是[歐拉-馬歇羅尼常數](../Page/歐拉-馬歇羅尼常數.md "wikilink").

那麼，可用[馬爾可夫不等式求取機率的上限](../Page/馬爾可夫不等式.md "wikilink")：
...
最末一行的等式來自[黎曼ζ函數的](../Page/黎曼ζ函數.md "wikilink")[巴塞爾問題](../Page/巴塞爾問題.md "wikilink")。此式繼而可用[切比雪夫不等式求取機率上限](../Page/切比雪夫不等式.md "wikilink")：
...
另一種解決贈券收集問題的方法是用[生成函數](../Page/生成函數.md "wikilink")。
...
若某一刻已若干種贈券，再收集到一張已重覆的贈券的機率是*p*，那麼，再收集到*m*張已重覆的贈券的機率就是\(p^m\)。則就此部分而言，有關*m*的[概率母函数](../Page/概率母函数.md "wikilink")（PGF）是

\[G(z)=\sum_{m=0}^\infty p^mz^m = 1 + p z + p^2 z^2 + p^3 z^3 + \cdots = \frac{1}{1 - p z}\]

若將上述收集過程分割為多個階段，則整個收集過程所花的時間的[概率母函数為各部分的乘積](../Page/概率母函数.md "wikilink")，亦即
...
\frac{n-(n-1)}{n} z.\]
那麼，根據機率生成函數的特性，總收集次數*T*的[期望值是](../Page/期望值.md "wikilink")
...
用機率生成函數可同時求取[變異量](../Page/變異量.md "wikilink")。變異量可寫作
...
## 參考文獻
  ...
  - Paul Erdős and Alfréd Rényi, *On a classical problem of probability
    theory*, Magyar Tud. Akad. Mat. Kutato Int. Kozl, 1961.
  ...
  - Donald J. Newman and Lawrence Shepp, *The Double Dixie Cup Problem*,
    *American Mathematical Monthly*, Vol. 67, No. 1 (Jan., 1960), pp.
    58–61.
  - Philippe Flajolet, Danièle Gardy, Loÿs Thimonier *[Birthday paradox,
    coupon collectors, caching algorithms and self-organizing
    search.](http://algo.inria.fr/flajolet/Publications/alloc2.ps.gz)*,
    *Discrete Applied Mathematics*, Vol. 39, (1992), pp. 207–229

## 外部連結

  - "[Coupon Collector
    Problem](http://demonstrations.wolfram.com/CouponCollectorProblem/)"
    by Ed Pegg, Jr., the Wolfram Demonstrations Project. Mathematica
    package.
  - [Coupon Collector
    Problem](http://www-stat.stanford.edu/~susan/surprise/Collector.html),
    Java applet.
  - *[How Many Singles, Doubles, Triples, Etc., Should The Coupon
    Collector
    Expect?](http://www.math.rutgers.edu/~zeilberg/mamarim/mamarimhtml/coupon.html)*,
    a short note by Doron Zeilberger.

**贝尔数**以[埃里克·坦普尔·贝尔命名](https://zh.wikipedia.org/wiki/埃里克·坦普尔·贝尔 "wikilink")，是[組合數學中的一組](https://zh.wikipedia.org/wiki/組合數學 "wikilink")[整數](https://zh.wikipedia.org/wiki/整數 "wikilink")[數列](https://zh.wikipedia.org/wiki/數列 "wikilink")，開首是（[OEIS的A](https://zh.wikipedia.org/wiki/OEIS "wikilink")000110數列）：[Bell_Number.png](https://zh.wikipedia.org/wiki/File:Bell_Number.png "fig:Bell_Number.png")
...
truth](https://zh.wikipedia.org/wiki/Vacuous_truth "wikilink")，因为空集实际上没有成員），而它們的並是空集本身。所以空集是它的唯一劃分。
...
\[B_n=\frac{1}{e}\sum_{k=0}^\infty \frac{k^n}{k!}\][期望值為](../Page/期望值.md "wikilink")1的[泊松分數的](https://zh.wikipedia.org/wiki/泊松分數 "wikilink")*n*次矩。

> 本文内容由[责任链模式](https://zh.wikipedia.org/wiki/责任链模式)转换而来。
...
## 另見
  ...
  - [Interception pattern](https://zh.wikipedia.org/wiki/Interception_pattern "wikilink")
  - [Interceptor pattern](https://zh.wikipedia.org/wiki/Interceptor_pattern "wikilink")
  - [Single responsibility principle](https://zh.wikipedia.org/wiki/Single_responsibility_principle "wikilink")

## 外部链接

  - Article "[The Chain of Responsibility pattern's pitfalls and improvements](http://www.javaworld.com/javaworld/jw-08-2004/jw-0816-chain.html)" by [Michael Xinsheng Huang](https://zh.wikipedia.org/wiki/Michael_Xinsheng_Huang "wikilink")
  - Article "[Follow the Chain of Responsibility](http://www.javaworld.com/javaworld/jw-08-2003/jw-0829-designpatterns.html)" by [David Geary](https://zh.wikipedia.org/wiki/David_Geary "wikilink")
  - Article "[Pattern Summaries: Chain of Responsibility](http://developer.com/java/other/article.php/631261)" by [Mark Grand](https://zh.wikipedia.org/wiki/Mark_Grand "wikilink")

...
这里*g* 是[弱相互作用](../Page/弱相互作用.md "wikilink")的耦合常数, 和 *m*<sub>W</sub>
是[W玻色子的质量](https://zh.wikipedia.org/wiki/W玻色子 "wikilink").

在标准模型中, 费米常数和 [希格斯场真空期望值](https://zh.wikipedia.org/wiki/希格斯场 "wikilink")
关系是：\(v = (\sqrt{2}G_\text{F})^\text{-1/2} \simeq 246.22 \; \textrm{GeV}\)\[2\]
...
\[\frac{\hbar}{\tau_\mu}=\frac{G_F^2 m_\mu^5}{192 \pi^2}F(\rho) \biggl[1+H_1(\rho)\frac{ \widehat{\alpha}(m_\mu) }{\pi} + H_2(\rho)\frac{ \widehat{\alpha}^2(m_\mu) }{\pi^2} \biggl],\]
  ...
  -
    ...
    <math>H_1(\\rho) = \\frac{25}{8} - \\frac{\\pi^2}{2}- \\Big(
    9+4\\pi^2+ 12\\ln \\rho \\Big) \\rho

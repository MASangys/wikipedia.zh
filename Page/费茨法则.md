[Fitts_law.png](https://zh.wikipedia.org/wiki/File:Fitts_law.png "fig:Fitts_law.png") **费茨法则** 是一个[人机交互](../Page/人机交互.md "wikilink")以及[人体工程学中人类活动的模型](https://zh.wikipedia.org/wiki/人体工程学 "wikilink")，它预测了快速移动到目标区域所需的时间是目标区域的距离和目标区域的大小的函数。费茨法则多用于表现 *指*、*点* 这个动作的概念模型，无论是用手或者手指进行物理接触，抑或是在电脑屏幕上用假想的设备（例如鼠标）进行虚拟的触碰。 该法则由 [Paul Fitts](https://zh.wikipedia.org/wiki/:en:Paul_Fitts "wikilink") 于 1954 年提出。

## 模型

费茨法则可以用多种不同的公式进行表达。比较通用的是用于一维运动的 Shannon 公式（由[MacKenzie](http://www.yorku.ca/mack%7CScott)，[约克大学教授提出](https://zh.wikipedia.org/wiki/约克大学 "wikilink")，并因为其与[香农定理的相似而命名](https://zh.wikipedia.org/wiki/香农定理 "wikilink")）。
...
## 参考文献
  ...
  - I. Scott MacKenzie and William A. S. Buxton (1992). Extending Fitts' law to two-dimensional tasks. Proceedings of [ACM](https://zh.wikipedia.org/wiki/:en:Association_for_Computing_Machinery "wikilink") CHI 1992 Conference on Human Factors in Computing Systems, pp. 219–226. <http://doi.acm.org/10.1145/142750.142794>
  ...
  - Stuart K. Card, Thomas P. Moran, [Allen Newell](https://zh.wikipedia.org/wiki/:en:Allen_Newell "wikilink") (1983). The Psychology of Human-Computer Interaction.
...
## 外部链接
  ...
  - [Peer-reviewed Encyclopedia entry on Fitts' Law](http://www.interaction-design.org/encyclopedia/fitts_law.html) by Mehmet Gokturk
  - [Fittsbits - A game investigating Fitts' Law](https://web.archive.org/web/20081221020051/http://www.rodo.nl/fittsbits/) by Willem Vervuurt and Laura Cuijpers (this game, a Web-based experiment, is no longer available)
  ...
  - [Fitts' Law in Microsoft Office User Interface](http://blogs.msdn.com/jensenh/archive/2006/08/22/711808.aspx) by Jensen Harris

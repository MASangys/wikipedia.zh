**费马引理**是[实分析中的一个定理](https://zh.wikipedia.org/wiki/实分析 "wikilink")，以[皮埃尔·德·费马命名](https://zh.wikipedia.org/wiki/皮埃尔·德·费马 "wikilink")。通过证明函数的每一个极值都是[驻点](../Page/驻点.md "wikilink")（函数的[导数在该点为零](../Page/导数.md "wikilink")），该定理给出了一个求出[可微函数的](../Page/可微函数.md "wikilink")[最大值和](https://zh.wikipedia.org/wiki/最大值 "wikilink")[最小值的方法](https://zh.wikipedia.org/wiki/最小值 "wikilink")。因此，利用费马引理，求函数的极值的问题便化为解[方程的问题](../Page/方程.md "wikilink")。

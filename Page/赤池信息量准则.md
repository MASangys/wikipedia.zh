**赤池信息量准则**（，简称**AIC**）是評估統计模型的复杂度和衡量[统计模型](../Page/统计.md "wikilink")「擬合」資料之优良性（，白話：合身的程度）的一种标准，是由[日本统计学家](../Page/日本.md "wikilink")[赤池弘次创立和发展的](../Page/赤池弘次.md "wikilink")。赤池信息量准则建立在[信息熵的概念基础上](../Page/熵_\(信息论\).md "wikilink")。
...
其中：*K*是[参数的数量](../Page/参数.md "wikilink")，L是[似然函数](../Page/似然函数.md "wikilink")。

假设条件是模型的误差服从独立正态分布。

让*n*为观察数，*RSS*为[残差](../Page/残差.md "wikilink")[平方和](../Page/平方和.md "wikilink")，那么AIC变为：
...
在[样本小的情况下](../Page/样本.md "wikilink")，AIC转变为AICc：
...
## 另见
  ...
  - [贝叶斯信息准则](../Page/贝叶斯信息准则.md "wikilink")
  - [奥卡姆剃刀](../Page/奥卡姆剃刀.md "wikilink")
  - [施瓦兹准则](../Page/施瓦兹准则.md "wikilink")

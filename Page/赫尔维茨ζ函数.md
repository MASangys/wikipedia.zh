[Hurwitz_zeta_function.gif](https://zh.wikipedia.org/wiki/File:Hurwitz_zeta_function.gif "fig:Hurwitz_zeta_function.gif")
...
此级数在S空间的[紧空间子集中均匀收敛成为一个](../Page/紧空间.md "wikilink")[整函数](../Page/整函数.md "wikilink")。

## 积分式

赫尔维茨ζ函数可以表示为下列[梅林变换](https://zh.wikipedia.org/wiki/梅林变换 "wikilink")
...
对于 \(0\le x\le 1\) and s \> 1成立，其中 \(\text{Li}_s (z)\)代表
[多重对数](https://zh.wikipedia.org/wiki/多重对数 "wikilink").
...
因此赫尔维茨ζ函数的[泰勒级数可表示为](../Page/泰勒级数.md "wikilink"):
...
正整数m的赫尔维茨ζ函数与 [多伽玛函数有下列关系](../Page/多伽玛函数.md "wikilink"):

\[\psi^{(m)}(z)= (-1)^{m+1} m! \zeta (m+1,z) \ .\] For negative integer
−*n* the values are related to the [Bernoulli
polynomials](https://zh.wikipedia.org/wiki/Bernoulli_polynomials "wikilink"):\[3\]

\[\zeta(-n,x) = - \frac{B_{n+1}(x)}{n+1} \ .\]

The
[巴恩斯ζ函数是赫尔维茨ζ函数的推广](https://zh.wikipedia.org/wiki/巴恩斯ζ函数 "wikilink")。

The
[勒奇超越函数也是赫尔维茨ζ函数的推广](https://zh.wikipedia.org/wiki/勒奇超越函数 "wikilink"):
...
赫尔维茨ζ函数与[超几何函数的关系](../Page/超几何函数.md "wikilink")：

\[\zeta(s,a)=a^{-s}\cdot{}_{s+1}F_s(1,a_1,a_2,\ldots a_s;a_1+1,a_2+1,\ldots a_s+1;1)\]其中
\(a_1=a_2=\ldots=a_s=a\text{ and }a\notin\N\text{ and }s\in\N^+.\)

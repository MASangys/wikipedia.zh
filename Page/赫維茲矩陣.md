...
另外，在[工程学](../Page/工程学.md "wikilink")及中的**赫維茲矩陣**（Hurwitz matrix）或**赫維茲穩定矩陣**（Hurwitz stable matrix），是指每個[特征值其實部都為負值的矩陣](https://zh.wikipedia.org/wiki/特征值 "wikilink")。
...
在[工程学](../Page/工程学.md "wikilink")及中，方块矩阵\(A\)稱為**穩定矩陣**（stable matrix）、**赫維茲矩陣**（Hurwitz matrix）若矩阵\(A\)的每個[特征值其實部都為負值](https://zh.wikipedia.org/wiki/特征值 "wikilink")，也就是

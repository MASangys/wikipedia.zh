...
[合流超几何函数](https://zh.wikipedia.org/wiki/合流超几何函数 "wikilink")（Kummer函数）可以用超几何函数的极限表示如下
...
theorem），可以由超几何函数的[积分表示得到](https://zh.wikipedia.org/wiki/#积分表示 "wikilink")。[范德蒙恒等式是它的特殊情形](https://zh.wikipedia.org/wiki/范德蒙恒等式 "wikilink")。
=== =-1 ===

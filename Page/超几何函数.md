...
因此，所有合流超几何函数的特例，例如[贝塞尔函数](../Page/贝塞尔函数.md "wikilink")都可以表示成超几何函数的极限。
...
theorem），可以由超几何函数的[积分表示得到](https://zh.wikipedia.org/wiki/#积分表示 "wikilink")。[范德蒙恒等式](../Page/范德蒙恒等式.md "wikilink")是它的特殊情形。
=== =-1 ===

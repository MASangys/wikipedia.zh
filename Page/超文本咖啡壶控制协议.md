...
**超文本咖啡壶控制协议**（，缩写**HTCPCP**）是由[IETF虚构的一种协议](https://zh.wikipedia.org/wiki/IETF "wikilink")。这个协议在文档RFC
2324\[1\]（1998年4月1日发布）中定义，是一个[恶搞RFC](https://zh.wikipedia.org/wiki/恶搞RFC "wikilink")。

该协议被设计为一个类似[HTTP的协议](https://zh.wikipedia.org/wiki/HTTP "wikilink")，可以用于控制、监测和诊断[咖啡壶](https://zh.wikipedia.org/wiki/咖啡壶 "wikilink")，后来也被拓展到[茶壶](../Page/茶壶.md "wikilink")；该协议有时也可以视作一种早期的[物联网实验](../Page/物联网.md "wikilink")。
...
## 兼容性
  ...
  - 有数个[bug报告抱怨说](https://zh.wikipedia.org/wiki/bug "wikilink")[Mozilla不支持这个协议](../Page/Mozilla.md "wikilink")\[2\]。

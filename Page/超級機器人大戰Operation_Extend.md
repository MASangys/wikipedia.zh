...
#### 初期
  ...
  - [VF-25F 彌賽亞](../Page/VF-25彌賽亞.md "wikilink")（超時空要塞Frontier）
  - 霸王鮮果汁（NG騎士檸檬汽水&40）
  - [GUNDAM](https://zh.wikipedia.org/wiki/RX-78系列機動戰士 "wikilink")（機動戰士GUNDAM）
  - 英格倫1號機（機動警察）
  - [紅蓮螺巖](https://zh.wikipedia.org/wiki/天元突破紅蓮螺巖登場兵器列表 "wikilink")（天元突破紅蓮螺巖）
  - 重裝長牙獅（索斯機械獸）
...
#### 第4章配信後追加登場機體
  ...
  - 哥修羅（熱血最強）
  - 大帝王（完全勝利）
  - GUNDAMEz8（機動戰士GUNDAM 第08MS小隊）
  - GUNDAMNT-1 ALEX（機動戰士GUNDAM0080 口袋中的戰爭）
...
與過去的格子狀地圖方式不同、使用『NEO』系統的圓圈狀移動方式、並且將它當作新系統放入其中。
  ...
  - 地形
    除了加上《NEO》「陸」「空」地型外，也增加「宇宙」地型、即使在宇宙空間也能進行戰鬥\[3\]。地圖構成上，在「宇宙」及「地」的地圖上，就算只有宇宙適性、沒有空適性也能夠在宇宙上移動。與《NEO》同樣只會表示適應或不適應、但欠缺像是其他系列作中較詳細（命中率、回避率補正等）的適性表示。在「空」及「宇宙」的移動所消費的能量也會比「陸」還大。
  - 精神指令

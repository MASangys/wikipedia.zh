...
### 封面登場機體
  ...
  - 艾斯特巴利斯（OG Frame·明人機）（機動戰艦撫子）
  - GEAR戰士電童（GEAR戰士電童）
  - GUNDAMDOUBLE X（機動新世紀GUNDAMX）
  - [NEO蓋特1](https://zh.wikipedia.org/wiki/真蓋特機器人對NEO蓋特機器人#蓋特機器人 "wikilink")（真蓋特機器人對NEO蓋特機器人）

## 原創角色

本作可以選主角的性別，機體方面只有一部。另外所有角色的聲優均為OG版本登場。

  -
    選擇男性時的預設名字。於《OG》中則與菲歐娜為兄妹關係。

  -
    選擇女性時的預設名字。於《OG》中則與勞爾為兄妹關係。

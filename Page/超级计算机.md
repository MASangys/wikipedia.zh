[Cray_2_Arts_et_Metiers_dsc03940.jpg](https://zh.wikipedia.org/wiki/File:Cray_2_Arts_et_Metiers_dsc03940.jpg "fig:Cray_2_Arts_et_Metiers_dsc03940.jpg") **超级计算机**（），指能够执行一般[个人电脑](../Page/个人电脑.md "wikilink")无法处理的大资料量与高速运算的计算机，规格与性能比个人计算机强大许多。现有的超级计算机运算速度大都可以达到每秒一[兆](../Page/兆.md "wikilink")（万亿，非百万）次以上。「超级计算」（）這名詞第一次出現，是在1929年《[纽约世界报](https://zh.wikipedia.org/wiki/纽约世界报 "wikilink")》关于[IBM](../Page/IBM.md "wikilink")为[哥伦比亚大学](../Page/哥伦比亚大学.md "wikilink")建造大型[報表机](https://zh.wikipedia.org/wiki/報表机 "wikilink")（）的报导。\[1\]

1960年代，超级计算机由[麥可·徐](https://zh.wikipedia.org/wiki/麥可·徐 "wikilink")（Michael Tsui）在Control Data Corporation裡设计出来并领先市场直到1970年代克雷创立自己的公司──[克雷研究](https://zh.wikipedia.org/wiki/克雷研究 "wikilink")。凭着他的新设计，他控制了整个超级计算机市场，并占据颠峰位置长达五年（1985年－1990年）。到了1980年代，正值小型计算机市场萌芽阶段，大量小型对手加入竞争。在1990年代中期，很多对手受不了市场的冲击而消声匿迹。今天，超级计算机成了一种由像[IBM](../Page/IBM.md "wikilink")及[惠普](../Page/惠普.md "wikilink")等大型计算机公司所特意设计的计算机。虽然这些公司通过不断并购其他公司而增强了自己的经验，克雷研究依然是超级计算机领域的巨头之一。
...
超级计算机常用于需要大量运算的工作，譬如天气预测、气候研究\[2\]、[运算化学](https://zh.wikipedia.org/wiki/运算化学 "wikilink")、[分子模型](https://zh.wikipedia.org/wiki/分子模型 "wikilink")、[天體物理模拟](https://zh.wikipedia.org/wiki/天體物理 "wikilink")\[3\]、汽車設計模擬\[4\]、[密码分析](../Page/密码分析.md "wikilink")等。 [缩略图](https://zh.wikipedia.org/wiki/File:MEGWARE.CLIC.jpg "fig:缩略图")\]\] [缩略图](https://zh.wikipedia.org/wiki/File:University_of_Manchester_Atlas,_January_1963.JPG "fig:缩略图")

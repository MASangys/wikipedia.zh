...
因超级计算机而开发的技术：
  ...
  - [-{zh-cn:矢量;
    zh-tw:向量;}-处理器和](https://zh.wikipedia.org/wiki/矢量处理器 "wikilink")[张量处理器](../Page/张量处理器.md "wikilink")

...
在[數學裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，距離是個稱之為[度量的函數](../Page/度量.md "wikilink")，為物理距離這個概念之推廣。度量是個函數，依據一組特定的規則作用，且有具體的方法可用來描述一些空間內的元素互相「接近」或「遠離」。除了[歐氏空間內常見的](https://zh.wikipedia.org/wiki/歐氏空間 "wikilink")[距離定義外](https://zh.wikipedia.org/wiki/歐幾里得距離 "wikilink")，在[圖論與](https://zh.wikipedia.org/wiki/圖論 "wikilink")[統計學等](https://zh.wikipedia.org/wiki/統計學 "wikilink")[數學領域裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，亦存在其他的「距離」概念。在大多數的情形下，「從\(A\)至\(B\)的距離」與「從\(B\)至\(A\)的距離」的意義是相同的。
...
同樣地，給定[三維空間裡的兩個點](https://zh.wikipedia.org/wiki/三維空間 "wikilink")\((x_1,y_1,z_1)\)
與\((x_2,y_2,z_2)\)，其間之距離為：

\[d=\sqrt{(\Delta x)^2+(\Delta y)^2+(\Delta z)^2}=\sqrt{(x_2-x_1)^2+(y_2-y_1)^2+(z_2-z_1)^2}.\]
這些公式可以很容易地透過建構[直角三角形](../Page/直角三角形.md "wikilink")，並利用[勾股定理來導出](../Page/勾股定理.md "wikilink")。在平面上，可取得平行於[座標軸的兩股長求出斜邊長](https://zh.wikipedia.org/wiki/座標軸 "wikilink")；在三維空間裡，可由垂直於平面的一股與將第一個直角三角形的斜邊作為另一股來求解。在研究複雜的幾何時，此類距離稱之為**歐幾里得距離**，因為此類距離用到的勾股定理，於[非歐幾何內並不成立](https://zh.wikipedia.org/wiki/非歐幾何 "wikilink")。此一距離公式亦可延伸用來取得[弧長公式](https://zh.wikipedia.org/wiki/弧長 "wikilink")。
...
p 不一定要是[整數](https://zh.wikipedia.org/wiki/整數 "wikilink")，但不可以小於
1，不然[三角不等式不會成立](../Page/三角不等式.md "wikilink")。

2-範數距離為[歐幾里得距離](https://zh.wikipedia.org/wiki/歐幾里得距離 "wikilink")，是[勾股定理在兩維以上空間之推廣](../Page/勾股定理.md "wikilink")。2-範數距離為兩個點間使用[直尺量測時所得之數值](../Page/直尺.md "wikilink")，為距離的「直觀」概念。
...
間的歐幾里得距離可寫成[變分法的形式](https://zh.wikipedia.org/wiki/變分法 "wikilink")，其距離為下列積分的最小值：
...
物體間可以有不同的距離定義。例如，天體間的距離即有表面間距離與中心間距離兩種。[近地軌道的物體適用前者](https://zh.wikipedia.org/wiki/近地軌道 "wikilink")，並以[高度標示該物體與地球表面的距離](https://zh.wikipedia.org/wiki/高度 "wikilink")；其他如[地球與](../Page/地球.md "wikilink")[月球間之距離](../Page/月球.md "wikilink")，則適用後者。
...
在[點](https://zh.wikipedia.org/wiki/點 "wikilink")、[直線與](https://zh.wikipedia.org/wiki/直線 "wikilink")[平面之間的距離多採上述的第一種定義](../Page/平面.md "wikilink")。這些物件在[笛卡兒座標系下的距離公式列舉如下](https://zh.wikipedia.org/wiki/笛卡兒座標系 "wikilink")：
...
當需要處理的新物件為更廣義的物件（不再只是個點）時，不可擴展性、[曲率限制與非局部互動等額外概念需要被加入距離的概念之內](../Page/曲率.md "wikilink")。兩個流形間的距離為一[純量](https://zh.wikipedia.org/wiki/純量 "wikilink")，可由最小化廣義距離泛函（表示兩個流形間的轉換）而導出：
...
的軌跡。其中的\(\lambda\)為[拉格朗日乘數](https://zh.wikipedia.org/wiki/拉格朗日乘數 "wikilink")，用來確保聚合物的長度在轉換的過程中維持不變。若兩個聚合物不可擴展，則兩者間之轉換最小距離不會只有直線運動，即使是在歐幾里得度量之上。此類廣義距離可適用於[蛋白質折疊的問題上](https://zh.wikipedia.org/wiki/蛋白質折疊 "wikilink")\[1\]\[2\]。此類廣義距離可類比[弦論裡的](https://zh.wikipedia.org/wiki/弦論 "wikilink")[南部-後藤作用量](https://zh.wikipedia.org/wiki/南部-後藤作用量 "wikilink")，但無法完全地對應，因為三維空間裡的歐幾里得距離不等價於古典相對論弦中最小化的時空距離。
...
舉例而言，兩個實數\(x\)與\(y\)間的距離通常定義為：\(d(x,y)=\left \vert x-y \right \vert\)。此一定義滿足上述三個條件，且會對應至[實數線上的標準](../Page/實數線.md "wikilink")[拓撲](https://zh.wikipedia.org/wiki/拓撲 "wikilink")。不過，集合上的距離是可選擇的，例如下面的定義：\(d(x,y)=0\)，若\(x=y\)，否則為
1。此一定義亦符合度量的三個條件，但會形成一個完全不同的拓撲，稱之為「[離散拓撲](https://zh.wikipedia.org/wiki/離散拓撲 "wikilink")」；在此一定義裡，數字間無法隨意地接近。

### 圖論

在[圖論裡](https://zh.wikipedia.org/wiki/圖論 "wikilink")，兩個頂點間的[距離為這些](https://zh.wikipedia.org/wiki/距離_\(圖論\) "wikilink")[頂點間最短](https://zh.wikipedia.org/wiki/頂點 "wikilink")[路徑之長度](https://zh.wikipedia.org/wiki/路徑_\(圖論\) "wikilink")。

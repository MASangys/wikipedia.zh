...
在[點](https://zh.wikipedia.org/wiki/點 "wikilink")、[直線與](https://zh.wikipedia.org/wiki/直線 "wikilink")[平面](../Page/平面.md "wikilink")之間的距離多採上述的第一種定義。這些物件在[笛卡兒座標系下的距離公式列舉如下](https://zh.wikipedia.org/wiki/笛卡兒座標系 "wikilink")：

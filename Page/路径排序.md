...
在[量子场论中经常需要对算符进行时间排序](../Page/量子场论.md "wikilink")，这一操作用原算符
...
取决于算符是[玻色子体系的还是](../Page/玻色子.md "wikilink")[费米子体系的](../Page/费米子.md "wikilink")。对玻色子体系总是取正号。对于费米子体系取决于前述置换的奇偶性，对偶置换取正号，对奇置换取负号。

...
路徑積分表述也把量子現像和随機現像联系起來。為1970年代[量子場論和概括](https://zh.wikipedia.org/wiki/量子場論 "wikilink")[二級相變附近](https://zh.wikipedia.org/wiki/二級相變 "wikilink")[序參數波動的](https://zh.wikipedia.org/wiki/序參數 "wikilink")[統計場論統一奠下基礎](https://zh.wikipedia.org/wiki/統計場論 "wikilink")。[薛定諤方程式是](https://zh.wikipedia.org/wiki/薛定諤方程式 "wikilink")[虛擴散系數的](https://zh.wikipedia.org/wiki/虛數 "wikilink")[擴散方程](https://zh.wikipedia.org/wiki/擴散方程 "wikilink")，而路徑積分表述是把所有可能的[随機移動路徑加起來的方法的](../Page/隨機漫步.md "wikilink")[解析延拓](https://zh.wikipedia.org/wiki/解析延拓 "wikilink")。因此路徑積分表述在應用於量子力學前，已經在[布朗運動和](https://zh.wikipedia.org/wiki/布朗運動 "wikilink")[擴散問題上被應用](https://zh.wikipedia.org/wiki/擴散 "wikilink")。

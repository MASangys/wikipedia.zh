[量子力學的](../Page/量子力學.md "wikilink")**路徑積分表述**（）是一個從[經典力學裡的](../Page/經典力學.md "wikilink")[作用原則延伸出來對量子物理的一種概括和公式化的方法](../Page/作用量.md "wikilink")。它以包括两點間所有路徑的和或泛函積分而得到的[量子幅來取代經典力學裡的單一路徑](../Page/量子幅.md "wikilink")。

路径积分表述的基本思想可以追溯到[諾伯特·維納](../Page/諾伯特·維納.md "wikilink")，他介绍的[维纳积分解决扩散和](../Page/维纳过程.md "wikilink")[布朗运动的问题](../Page/布朗运动.md "wikilink")\[1\]。在1933年他的论文中，由[保罗·狄拉克把这个基本思想被扩展到量子力学中的利用](../Page/保罗·狄拉克.md "wikilink")[拉格朗日算符](../Page/拉格朗日量.md "wikilink")\[2\]\[3\]
。路徑積分表述是理論物理學家[理查德·費曼在](../Page/理查德·費曼.md "wikilink")1948年發展出來。一些早期結果是在[约翰·惠勒指导下的費曼的博士论文中在早些时候已经被摸索出](../Page/约翰·惠勒.md "wikilink")。

因爲路徑積分的表述法顯然地把時間和空間同等處理，它成為以後[理論物理學發展的重要工具之一](../Page/理論物理學.md "wikilink")。

路徑積分表述也把量子現像和随機現像联系起來。為1970年代[量子場論和概括](../Page/量子場論.md "wikilink")[二級相變附近](../Page/二級相變.md "wikilink")[序參數波動的](../Page/序參數.md "wikilink")[統計場論統一奠下基礎](../Page/統計場論.md "wikilink")。[薛定諤方程式是](../Page/薛定諤方程式.md "wikilink")[虛擴散系數的](../Page/虛數.md "wikilink")[擴散方程](../Page/擴散方程.md "wikilink")，而路徑積分表述是把所有可能的[随機移動路徑加起來的方法的](../Page/隨機漫步.md "wikilink")[解析延拓](../Page/解析延拓.md "wikilink")。因此路徑積分表述在應用於量子力學前，已經在[布朗運動和](../Page/布朗運動.md "wikilink")[擴散問題上被應用](../Page/擴散.md "wikilink")。
...
一個量子粒子在時刻\(t_a\)到\(t_b\)間從位置\(x_a\)運動到\(x_b\)的量子概率幅是：
...
此公式的物理理解為：從\((t_a,x_a)\)出發，在時刻\(t_b > t>t_a\)先穿過位置\(x\)再到達\((t_b,x_b)\)路徑的總量子幅是两段路徑量子幅的積；而從\((t_a,x_a)\)到\((t_b,x_b)\)的量子幅是所有這種路徑的和。

### 時間切片

假設粒子在時刻\(t_a\)到\(t_b\)間從位置\(x_a\)運動到\(x_b\)。那可以把之間的時間平均分割成個別的時間區間：\(t_a = t_0 < t_1 < t_2 < \cdots < t_{n-1} < t_{n} = t_b\)。每一段的時間是\(\Delta = \frac{t_b-t_a}{n}\)。
在時刻\(t_{j-1}\)和\(t_{j}\)間粒子的量子幅是：
...
\end{align}\]
因為\(\hat{p}\)和\(\hat{x}\)是互不交换的算符，所以必須運用它們的[交换子關係](../Page/交换子.md "wikilink")：\([\hat{p},\hat{x}]=i\hbar\)把\(H(\hat{p},\hat{x})\)修成所有的\(\hat{p}\)在\(\hat{x}\)左方的正常順序：

\[e^{-i\frac{\Delta}{\hbar} H(\hat{p},\hat{x})} = :e^{-i\frac{\Delta}{\hbar} H(\hat{p},\hat{x})}: + O(\Delta^2)\]
做時間切片的作用是：當取切片數趨向無限大的极限時（\(\Delta\rightarrow 0\)），原本非正常順序的哈密頓算符可以以正常順序版代替。在正常順序算符下，\(\hat{p}\)和\(\hat{x}\)從算符簡化成普通[複數](../Page/複數.md "wikilink")。
因此
...
\[S = \int \frac{\dot{x}^2}{2} dt\] 可以插入路徑積分裡做直接計算。
暫時把指數函數内i去掉可容許比較簡易的理解計算。以後可以用[威克轉動回到原式](../Page/威克轉動.md "wikilink")：
...
\(\mathcal{D}x\)是以上時間切成有限片的積分。連乘裡每一項都是平均值為\(x(t)\)[方差為c的高斯函數](../Page/方差.md "wikilink")。多重積分是相鄰時間高斯函數\(G_\epsilon\)的卷積：

\[G(x-y;T) = G_\epsilon * G_\epsilon * G_\epsilon \cdots G_\epsilon\]
這裡面共包含\(T/\epsilon\)個卷積。[傅里葉變換下卷積變成普通乘積](../Page/傅里葉變換.md "wikilink")：

...
Services**，簡稱**RRAS**）是[微軟的](https://zh.wikipedia.org/wiki/微軟 "wikilink")[Windows伺服器系統所提供的一個服務元件](https://zh.wikipedia.org/wiki/Windows伺服器系統 "wikilink")。這元件本來由[Cisco編寫](https://zh.wikipedia.org/wiki/Cisco "wikilink")，並授權微軟在其產品中使用。

...
**路由器**（，又稱**路徑器**）是一种[電訊](https://zh.wikipedia.org/wiki/電訊 "wikilink")[网络设备](https://zh.wikipedia.org/wiki/网络 "wikilink")，提供[路由與](../Page/路由.md "wikilink")[轉送兩種重要機制](https://zh.wikipedia.org/wiki/轉送 "wikilink")，可以決定[封包從來源端到目的端所經過的路由路徑](https://zh.wikipedia.org/wiki/封包 "wikilink")（host到host之間的傳輸路徑），这个过程称为路由；將路由器輸入端的封包移送至適當的路由器輸出端（在路由器內部進行），這稱為轉送。路由工作在[OSI模型的第三层](../Page/OSI模型.md "wikilink")——即[网络层](../Page/网络层.md "wikilink")，例如[网际协议](../Page/网际协议.md "wikilink")（IP）。
...
1970年代中期至1980年代，多功能的小型计算机充当路由器。[ARPAnet](https://zh.wikipedia.org/wiki/ARPAnet "wikilink")（互联网的前身）称之为接口信息处理机。尽管多功能小型计算机可以胜任路由工作，但现代高速路由器却由专门的高性能计算机充当，它加入额外的硬件以便更高速地执行普通路由功能例如数据包转发，以及特殊功能例如[IPsec加密](../Page/IPsec.md "wikilink")。
...
将客户连接到Internet的路由器被称为[边缘路由器](https://zh.wikipedia.org/wiki/边缘路由器 "wikilink")(edge
router)。只负责与其他路由器之间（例如ISP的网络）传递数据的路由器被称为[核心路由器](https://zh.wikipedia.org/wiki/核心路由器 "wikilink")。

一台路由器可以用来至少连接两个网络。一种特殊类型的路由器（单臂路由器，[one-armed-router](https://zh.wikipedia.org/wiki/one-armed-router "wikilink")）用来在多个[虚拟局域网](../Page/虚拟局域网.md "wikilink")(Virtual
...
路由器也被当作Internet-{zh-hans:网关;zh-tw:閘道器}-，主要用在小型网络中如家庭或小型办公室。这种设备使用的Internet连接往往是一直在线的宽带连接如[线缆调制解调器和](https://zh.wikipedia.org/wiki/线缆调制解调器 "wikilink")[DSL](https://zh.wikipedia.org/wiki/DSL "wikilink")。这种路由器连接两个网络——[WAN和LAN](https://zh.wikipedia.org/wiki/WAN "wikilink")——并有自己的路由表。尽管在家庭应用中并不需要太多路由功能（因为只存在两条路——WAN和LAN），但这些小型路由器仍然支持[RIP](https://zh.wikipedia.org/wiki/路由信息協議 "wikilink")。额外地，这种路由器还支持[DHCP](https://zh.wikipedia.org/wiki/DHCP "wikilink")、[NAT](https://zh.wikipedia.org/wiki/NAT "wikilink")、[DMZ和](../Page/DMZ.md "wikilink")[防火墙功能](../Page/防火墙.md "wikilink")，也有一些支持内容过滤和[VPN](https://zh.wikipedia.org/wiki/VPN "wikilink")。通常这种路由器和线缆或DSL[调制解调器协同工作](../Page/调制解调器.md "wikilink")，但调制解调功能也可以内建在这种路由器中。这种路由器往往同时具有阻止特定外部请求的安全特性。
...
只要安裝相關的軟件，使普通的[電腦也可以变成路由器](https://zh.wikipedia.org/wiki/電腦 "wikilink")。當中有以下較為常用的軟件：
  ...
  - [Basic Internet Routing
    Daemon](https://zh.wikipedia.org/wiki/Basic_Internet_Routing_Daemon "wikilink")
  ...
  - [GNU Zebra](https://zh.wikipedia.org/wiki/GNU_Zebra "wikilink") [(
    www.zebra.org )](http://www.zebra.org)
  ...
  - [m0n0wall](https://zh.wikipedia.org/wiki/m0n0wall "wikilink") [(
    m0n0.ch/wall )](http://m0n0.ch/wall/)
...
ERS-8600\]\]
  ...
  - [美國](https://zh.wikipedia.org/wiki/美國 "wikilink")
      ...
      - [阿爾卡特-朗訊](https://zh.wikipedia.org/wiki/阿爾卡特-朗訊 "wikilink")
        ([Alcatel-Lucent](https://zh.wikipedia.org/wiki/Alcatel-Lucent "wikilink"))
      - [蘋果公司](https://zh.wikipedia.org/wiki/蘋果公司 "wikilink")（[Apple](https://zh.wikipedia.org/wiki/Apple "wikilink")）
      - [亞美亞](https://zh.wikipedia.org/wiki/亞美亞 "wikilink")
        ([Avaya](https://zh.wikipedia.org/wiki/Avaya "wikilink"))
      ...
      - [極進網路](https://zh.wikipedia.org/wiki/極進網路 "wikilink")（[Extreme
        Networks](https://zh.wikipedia.org/wiki/Extreme_Networks "wikilink"))
      - [博科通訊系統](https://zh.wikipedia.org/wiki/博科通訊系統 "wikilink")([Brocade
        Communications
        Systems](https://zh.wikipedia.org/wiki/Brocade_Communications_Systems "wikilink"))
  - [日本](../Page/日本.md "wikilink")
      - [巴比祿](https://zh.wikipedia.org/wiki/巴比祿 "wikilink")（[Buffalo](https://zh.wikipedia.org/wiki/Buffalo "wikilink")）
  - [台灣](https://zh.wikipedia.org/wiki/台灣 "wikilink")
      ...
      - [阿里山龍頭實業有限公司](https://zh.wikipedia.org/wiki/阿里山龍頭實業有限公司 "wikilink")
        與 中國[磊科](https://zh.wikipedia.org/wiki/磊科 "wikilink")
        合作（[Netis](https://zh.wikipedia.org/wiki/Netis "wikilink")）
  ...
  - [中國](https://zh.wikipedia.org/wiki/中國大陆 "wikilink")
      - [睿因科技有限公司](https://zh.wikipedia.org/wiki/睿因科技有限公司 "wikilink")
        （WAV-LINK）
      ...
      - [中興通訊](https://zh.wikipedia.org/wiki/中興通訊 "wikilink")
        ([ZTE](https://zh.wikipedia.org/wiki/ZTE "wikilink"))
      ...
      - [普联技术](https://zh.wikipedia.org/wiki/普联技术 "wikilink")
        （[TP-LINK](https://zh.wikipedia.org/wiki/TP-LINK "wikilink")）
...
## 外部連結
  ...
  - [Network
    Router协议详细资料](https://web.archive.org/web/20051118161921/http://www.networkdictionary.com/chinese/hardware/NetworkRouter.php)

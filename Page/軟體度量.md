...
軟體的開發過程相當複雜，其方法論及目標都有高度的變異性，因此很難定義軟體質或是量的數據，並確定一個有效的和及時的計量方式，尤其要在軟體的細部設計前進行相關的預估，更加困難。另一個困難、常產生爭議的是度量的定義，以及各度量之間的重要性\[2\]\[3\]。
...
6.  [ProjectCodeMeter (2010) "ProjectCodeMeter Users Manual"
    page 65](http://www.projectcodemeter.com/cost_estimation/images/files/PCMProManual.pdf)

7.

8.

9.  [NASA Metrics Planning and Reporting Working Group
    (MPARWG)](http://earthdata.nasa.gov/our-community/esdswg/metrics-planning-and-reporting-mparwg)


10. [USC Center for Systems and Software
    Engineering](http://sunset.usc.edu/csse/research/COCOMOII/cocomo_main.html)
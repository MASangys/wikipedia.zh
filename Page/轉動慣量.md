[Samuel_Dixon_Niagara.jpg](https://zh.wikipedia.org/wiki/File:Samuel_Dixon_Niagara.jpg "fig:Samuel_Dixon_Niagara.jpg")者手里端着长杆，为了靠转动惯量保持平衡，对抗转动运动。圖為[撒姆爾·迪克森](https://zh.wikipedia.org/wiki/撒姆爾·迪克森 "wikilink")（Samuel Dixon）於1890年穿過尼加拉河的相片。\]\] 在经典力學中，**轉動慣量**又稱**[慣性矩](https://zh.wikipedia.org/wiki/慣性矩 "wikilink")**（），通常以\(I\)\[1\]表示，[國際單位制為](https://zh.wikipedia.org/wiki/國際單位制 "wikilink")\[kg\]·\[m<sup>2</sup>\]。轉動慣量是一個物體對於其旋轉運動的[慣性](../Page/慣性.md "wikilink")大小的量度。一個剛體對於某轉軸的轉動慣量決定了對於這物體繞著這轉軸進行某種角加速度運動所需要施加的力矩。轉動慣量在[转动力学中的角色相當於線性動力學中的](https://zh.wikipedia.org/wiki/转动力学 "wikilink")[質量](https://zh.wikipedia.org/wiki/質量 "wikilink")，描述[角動量](https://zh.wikipedia.org/wiki/角動量 "wikilink")、[角速度](../Page/角速度.md "wikilink")、[力矩](../Page/力矩.md "wikilink")和[角加速度等數個量之間的關係](https://zh.wikipedia.org/wiki/角加速度 "wikilink")。

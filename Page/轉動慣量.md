[Samuel_Dixon_Niagara.jpg](https://zh.wikipedia.org/wiki/File:Samuel_Dixon_Niagara.jpg "fig:Samuel_Dixon_Niagara.jpg")者手里端着长杆，为了靠转动惯量保持平衡，对抗转动运动。圖為[撒姆爾·迪克森](../Page/撒姆爾·迪克森.md "wikilink")（Samuel
Dixon）於1890年穿過尼加拉河的相片。\]\]
在经典力學中，**轉動慣量**又稱**[慣性矩](../Page/慣性矩.md "wikilink")**（），通常以\(I\)\[1\]表示，[國際單位制為](../Page/國際單位制.md "wikilink")\[kg\]·\[m<sup>2</sup>\]。轉動慣量是一個物體對於其旋轉運動的[慣性大小的量度](../Page/慣性.md "wikilink")。一個剛體對於某轉軸的轉動慣量決定了對於這物體繞著這轉軸進行某種角加速度運動所需要施加的力矩。轉動慣量在[转动力学中的角色相當於線性動力學中的](../Page/转动力学.md "wikilink")[質量](../Page/質量.md "wikilink")，描述[角動量](../Page/角動量.md "wikilink")、[角速度](../Page/角速度.md "wikilink")、[力矩和](../Page/力矩.md "wikilink")[角加速度等數個量之間的關係](../Page/角加速度.md "wikilink")。

## 定义

[Маховик.jpg](https://zh.wikipedia.org/wiki/File:Маховик.jpg "fig:Маховик.jpg")擁有很大的轉動慣量，可以用來使機械運轉順滑。\]\]
對於一個[質點](../Page/質點.md "wikilink")，\(I=mr^2\)，其中\(m\)是其[質量](../Page/質量.md "wikilink")，\(r\)是質點和轉軸的垂直距離。

對於一個有多個質點的系統，\(I = \sum_{i=1}^N {m_i r_i^2}\)。

对于[剛體](../Page/剛體.md "wikilink")，可以用無限個質點的轉動慣量和，即用[積分計算其轉動慣量](../Page/積分.md "wikilink")，\(I = \int {\rho r^2}dV\)，其中\(\rho\)是密度，\(dV\)是微量體積。

## 相关概念

### 定轴转动动力学方程

在直線運動，\(F=ma\)。在旋轉運動，則有\({\tau} = I{\alpha}\)，其中\({\tau}\)是[力矩](../Page/力矩.md "wikilink")，\({\alpha}\)是[角加速度](../Page/角加速度.md "wikilink")。

### 定轴转动动能

一般物件的[動能是](../Page/動能.md "wikilink")\(K=\frac{1}{2} mv^2\)。將速度\(v\)和質量\(m\)，用轉動力學的定義取代：
...
[平行軸定理是說](../Page/平行軸定理.md "wikilink")，如果一個質量為\(m\)的物件，以某條經過质心\(A\)點的直線為軸，其轉動慣量為\(I_A\)。在空間取點\(B\)，使得\(AB\)垂直於原本的軸。那麼如果以經過\(B\)、平行於原本的軸的直線為軸，\(AB\)的距離為\(d\)，則\(I_B = I_A + md^2\)。

### 垂直轴定理

[垂直轴定理是说](../Page/垂直轴定理.md "wikilink")，如果一个平面物件，以该平面内两条互相垂直、交于\(A\)点的直线为轴，转动惯量分别为\(I_1\)、\(I_2\)，则它以过\(A\)点且垂直于该平面的直线为轴的转动惯量\(I_3 = I_1 + I_2\)。

### 伸展定则

[伸展定则是说](../Page/伸展定则.md "wikilink")，如果一个物件中的任一质点沿平行于某条轴的方向发生任意位移，该物件对该轴的转动惯量不变。

## 慣性張量

對於三維空間中任意一参考點\(Q\)與以此参考點為原點的[直角坐標系](../Page/直角坐標系.md "wikilink")\(Qxyz\)，一個剛體的**慣性張量**\(\mathbf{I}\,\!\)是
...
[ComputeAngularMomentum01.JPG](https://zh.wikipedia.org/wiki/File:ComputeAngularMomentum01.JPG "fig:ComputeAngularMomentum01.JPG")
如圖\(A\)，一個剛體對於質心\(G\)與以點\(G\)為原點的[直角座標系](../Page/直角座標系.md "wikilink")\(Gxyz\)的角動量\(\mathbf{L}_G\,\!\)定義為
...
a)參考圖B，讓\((x\,',\ y\,',\ z\,')\,\!\)、\((x,\ y,\ z)\,\!\)分別為微小質量\(dm\,\!\)對質心\(G\)與原點\(O\)的相對位置：
...
[ArbitraryAxis01.JPG](https://zh.wikipedia.org/wiki/File:ArbitraryAxis01.JPG "fig:ArbitraryAxis01.JPG")
參視圖C，設定點\(O\)為直角座標系的原點，點\(Q\)為三維空間裏任意一點，\(Q\)不等於\(O\)。思考一個剛體，對於\(OQ\)-軸的轉動慣量是

\[I_{OQ}\ =\int\ \rho^2 \ dm\ =\ \int \ \left| \boldsymbol{\eta}\times\mathbf{r}\right|^2 \ dm\,\!\]。

這裏，\(\rho\,\!\)是微小質量\(dm\,\!\)離\(OQ\)-軸的垂直距離，\(\boldsymbol{\eta}\,\!\)是沿著\(OQ\)-軸的[單位向量](../Page/單位向量.md "wikilink")，\(\mathbf{r}=(x,\ y,\ z)\,\!\)是微小質量\(dm\,\!\)的位置。
...
因為慣性張量\(\mathbf{I}\,\!\)是個[實值的三維](../Page/實數.md "wikilink")[對稱矩陣](../Page/對稱矩陣.md "wikilink")，我們可以用對角線化，將慣量積變為零，使慣性張量成為一個[對角矩陣](../Page/對角矩陣.md "wikilink")\[2\]。所得到的三個[特徵值必是正實值](../Page/特徵值.md "wikilink")；三個[特徵向量必定互相](../Page/特徵向量.md "wikilink")[正交](../Page/正交.md "wikilink")。

換另外一種方法，我們需要解析特徵方程式

\[\mathbf{I}\ \boldsymbol{\omega}=\lambda\;\boldsymbol{\omega}\,\!\]。<span style="position:absolute;right:15%">（8）</span>

也就是以下[行列式等於零的的](../Page/行列式.md "wikilink")[三次方程式](../Page/三次方程.md "wikilink")：
...
這方程式的三個根\(\lambda_1\,\!\)、\(\lambda_2\,\!\)、\(\lambda_3\,\!\)都是正實的特徵值。將特徵值代入方程式（8），再加上[方向餘弦方程式](../Page/方向餘弦.md "wikilink")，
...
這裏，\(\bar{v}\,\!\)是剛體質心的速度，\(v\,\!\)是微小質量\(dm\,\!\)相對於質心的速度。在方程式裏，等號右邊第一個項目是剛體[平移運動的動能](../Page/平移運動.md "wikilink")，第二個項目是剛體[旋轉運動的動能](../Page/旋轉運動.md "wikilink")\(K\,\!'\,\!\)。由於這旋轉運動是繞著質心轉動的，
...
應用[向量恆等式](../Page/向量恆等式.md "wikilink")，可以得到
...
[Moment_of_inertia_rod_center.svg](https://zh.wikipedia.org/wiki/File:Moment_of_inertia_rod_center.svg "fig:Moment_of_inertia_rod_center.svg")
[Moment_of_inertia_rod_end.svg](https://zh.wikipedia.org/wiki/File:Moment_of_inertia_rod_end.svg "fig:Moment_of_inertia_rod_end.svg")
利用[線密度](../Page/線密度.md "wikilink")可輕易計算出細長棒子沿[質心](../Page/質心.md "wikilink")（CM）自轉的转动惯量。
...
## 相關條目
  ...
  - 橫截面的慣性矩：[截面二次軸矩](../Page/截面二次軸矩.md "wikilink")
  - 星球质量分布指标：[无量纲转动惯量](../Page/无量纲转动惯量.md "wikilink")
  - [转动惯量列表](../Page/转动惯量列表.md "wikilink")
  - [角動量](../Page/角動量.md "wikilink")
  - [飛輪矩](../Page/飛輪矩.md "wikilink")
...
<references/>
  ...
  - Beer, Ferdinand; E. Russell Johnston, Jr., William E. Clausen
    ...
    McGraw-Hill, ISBN 978-0-07-230492-3
...
[Category:動力学](https://zh.wikipedia.org/wiki/Category:動力学 "wikilink")

在[数学](../Page/数学.md "wikilink")中，**随机矩阵**（也称为**概率矩阵**、**转移矩阵**\[1\]、**替代矩阵**、或**马尔可夫矩阵**）是用来描述一个[马尔可夫链](../Page/马尔可夫链.md "wikilink")的转变的[矩阵](../Page/矩阵.md "wikilink")
。它的每一项都是一个表示[概率](../Page/概率.md "wikilink")的非负[实数](../Page/实数.md "wikilink")。它适用于[概率论](https://zh.wikipedia.org/wiki/概率论 "wikilink")、[统计学](../Page/统计学.md "wikilink")和[线性代数](../Page/线性代数.md "wikilink")，也在[计算机科学](../Page/计算机科学.md "wikilink")和[群体遗传学](../Page/群体遗传学.md "wikilink")中使用。
有几种不同的定义和类型随机矩阵：
...
如果在一个时间步长内从 \(i\) 到 \(j\) 移动的[概率](../Page/概率.md "wikilink")为

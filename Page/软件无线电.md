...
基本的SDR系统可以由装备有[声卡或其他](../Page/声卡.md "wikilink")[模数转换器的](https://zh.wikipedia.org/wiki/模数转换器 "wikilink")[个人计算机组成](https://zh.wikipedia.org/wiki/个人计算机 "wikilink")，之前是某种形式的。大量的[信号处理被交给通用处理器](https://zh.wikipedia.org/wiki/信号处理 "wikilink")，而不是在专用硬件（[电子电路](https://zh.wikipedia.org/wiki/电子电路 "wikilink")）中完成。这种设计产生一种[无线电装置](https://zh.wikipedia.org/wiki/无线电装置 "wikilink")，它可以仅仅基于所使用的软件来接收和发送广泛不同的无线电协议（有时也称为波形）。
...
软件无线电的通用硬件平台设计通常采用[总线形式](../Page/总线.md "wikilink")。软件无线电的硬件平台比PC要求高得多,它需要宽带射频前端、宽带A/D/A转换器、高速DSP器件等。为了进行高速A/D/A变换及数字信号处理，软件无线电系统必须多个[CPU](https://zh.wikipedia.org/wiki/CPU "wikilink")[并行工作](https://zh.wikipedia.org/wiki/并行 "wikilink")。另外，数字信号处理数据要高速交换，[系统总线必须具有极高的](https://zh.wikipedia.org/wiki/系统总线 "wikilink")[I/O传输速率](https://zh.wikipedia.org/wiki/I/O "wikilink")。在目前符合要求的[系统总线中](https://zh.wikipedia.org/wiki/系统总线 "wikilink")，技术最成熟，通用性最好，且得到的支持最广泛。VME提供多个CPU并行处理，支持独立的32位[数据总线和](https://zh.wikipedia.org/wiki/数据总线 "wikilink")[地址总线](https://zh.wikipedia.org/wiki/地址总线 "wikilink")，速率达40Mb/s(甚至320Mb/s)，是软件无线电的首选总线方式。
...
## 外部链接
  ...
  - [PocoCapsule SDR and
    JTRS-SCA](https://web.archive.org/web/20071119031318/http://www.pocomatic.com/docs/whitepapers/sdr/)

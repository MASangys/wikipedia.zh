...
[压力测试常常和](https://zh.wikipedia.org/wiki/壓力測試_\(軟體\) "wikilink")[性能测试相混淆](https://zh.wikipedia.org/wiki/性能测试 "wikilink")。它们主要不同点是，压力测试要求进行超过规定性能指标的测试。例如一个网站设计容量是100个人同时点击，压力测试就要是采用120个同时点击的条件测试。
...
### 软件测试活动
  ...
  - [壓力測試](https://zh.wikipedia.org/wiki/壓力測試_\(軟體\) "wikilink")

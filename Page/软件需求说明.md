...
2.  采用[用例](../Page/用例.md "wikilink")分析的表达方式，常见的利用UML工具来管理，比如Rose，EA等等 \[4\]
...
[Category:软件工程](https://zh.wikipedia.org/wiki/Category:软件工程 "wikilink") [Category:软件需求](https://zh.wikipedia.org/wiki/Category:软件需求 "wikilink")

1.  [830-1984 - IEEE Guide to Software Requirements Specifications](http://dx.doi.org/10.1109%2FIEEESTD.1984.119205)
2.  GB9385-88 计算机软件需求说明编制指南
3.  [GB/T9385-2008 《计算机软件需求说明编制指南》](http://www.nits.org.cn/getIndex.req?action=quary&req=modulenvpromote&id=1240&type=1&moduleId=845&sid=43)
4.  张秋余 杨玥 王雪 王鹏 贾志龙 基于用例的需求建模方法 《计算机工程与设计》 2006年19期
5.  [Guide to the Software Engineering Body of Knowledge V3.0 SWEBOK V3.0](http://www.computer.org/portal/web/swebok/swebokv3)
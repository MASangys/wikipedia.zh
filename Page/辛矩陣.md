在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，**辛矩阵**是指一個\(2n \times 2n\)的[矩阵M](../Page/矩阵.md "wikilink")（通常佈於[實數或](https://zh.wikipedia.org/wiki/實數 "wikilink")[複數域上](https://zh.wikipedia.org/wiki/複數 "wikilink")），使之滿足

\[M^T \Omega M = \Omega\,\]。
其中\(M^T\)表\(M\)的[轉置矩陣](https://zh.wikipedia.org/wiki/轉置矩陣 "wikilink")，而\(\Omega\)是一個固定的可逆[斜對稱矩陣](https://zh.wikipedia.org/wiki/斜對稱矩陣 "wikilink")；這類矩陣在適當的變化後皆能表為
...
[行列式值等於一](../Page/行列式.md "wikilink")，且其[逆矩陣等於](https://zh.wikipedia.org/wiki/逆矩陣 "wikilink")\(-\Omega\)。

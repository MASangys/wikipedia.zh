...
通常將域F取為實數域\(\mathbb{R}\)、複數域\(\mathbb{C}\)或非阿基米德[局部域](../Page/局部域.md "wikilink")，如[p進數域](https://zh.wikipedia.org/wiki/p進數 "wikilink")\(\mathbb{Q}_p\)。此時辛群Sp(2n,F)是維度等於\(n(2n+1)\)的連通[代數群](../Page/代數群.md "wikilink")。\(\mathrm{Sp}(2n,\mathbb{C})\)是[單連通的](../Page/單連通.md "wikilink")，而\(\mathrm{Sp}(2n,\mathbb{R})\)的[基本群則同構於](../Page/基本群.md "wikilink")\(\mathbb{Z}\)。

\(\mathrm{Sp}(2n,F)\)的李代數可以刻劃為滿足下列條件的2n階方陣\(A\)：

\[\Omega A + A^T \Omega = 0\]
其中\(A^T\)表示\(A\)的[轉置矩陣](https://zh.wikipedia.org/wiki/轉置矩陣 "wikilink")，而\(\Omega\)是下述反對稱矩陣
...
緊辛群 \(\mathrm{Sp}(n)\) 定義為
\(\mathrm{H}^n\)（\(\mathbb{H}\)表[四元數](https://zh.wikipedia.org/wiki/四元數 "wikilink")）上保持標準[埃爾米特形式](https://zh.wikipedia.org/wiki/埃爾米特形式 "wikilink")
...
的[共軛轉置](https://zh.wikipedia.org/wiki/共軛轉置 "wikilink")（在此取[四元數之共軛運算](https://zh.wikipedia.org/wiki/四元數 "wikilink")）。李括積由矩陣之交換子給出。

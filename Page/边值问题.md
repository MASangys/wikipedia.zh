...
在[微分方程中](../Page/微分方程.md "wikilink")，**边值问题**是一个微分方程和一组称之为边界条件的**[约束条件](https://zh.wikipedia.org/wiki/约束条件 "wikilink")**。边值问题的解通常是符合约束条件的微分方程的解。

物理学中经常遇到边值问题，例如[波动方程等](../Page/波动方程.md "wikilink")。許多重要的边值问题屬於[Sturm-Liouville問題](https://zh.wikipedia.org/wiki/Sturm-Liouville理論 "wikilink")。這類問題的分析會和[微分算子的](../Page/微分算子.md "wikilink")[本徵函數有關](../Page/本徵函數.md "wikilink")。

在实际应用中，边值问题应当是[适定的](https://zh.wikipedia.org/wiki/适定 "wikilink")（即：存在解，解唯一且解會隨著初始值連續的變化）。許多[偏微分方程領域的理論提出是為要證明科學及工程應用的許多边值问题都是适定問題](../Page/偏微分方程.md "wikilink")。
...
边值条件也可以根據边值问题對應的微分[算子來分類](../Page/算子.md "wikilink")：若是使用[椭圆算子](../Page/椭圆算子.md "wikilink")，則問題為椭圆边值问题；使用[雙曲線算子](https://zh.wikipedia.org/wiki/雙曲線算子 "wikilink")，則問題為雙曲線边值问题。依微分算子還可以將問題再細分為線性及非線性等。

> 本文内容由[边界粒子法](https://zh.wikipedia.org/wiki/边界粒子法)转换而来。
...
边界粒子法可以采用高阶基本解或径向基函数通解、调和函数\[5\]及Trefftz 函数\[6\]等作为插值基函数求解Helmholtz方程\[7\]、Possion方程\[8\]及薄板弯曲等问题\[9\]。由于其只在边界布点的优势，边界粒子法在只有仅部分边界数据可测的数学物理反问题计算中具有一定优势。目前边界粒子法已经成功用于Possion方程\[10\]及非齐次Helmholtz方程\[11\]的柯西反问题。
...
## 拓展延伸
  ...
  - [Boundary Particle Method](https://web.archive.org/web/20160303222653/http://www.ccms.ac.cn/fuzj/Boundary%20Particle%20Method.htm)

## 免费软件及Matlab程序代码

  - [Winker plate bending analysis](https://web.archive.org/web/20160303225250/http://www.ccms.ac.cn/fuzj/download/BPM-Winkler%20Plate.rar)
  - [BPM toolbox for inverse Cauchy problems](http://www.ccms.ac.cn/shijh/bpmtoolbox.zip)
...
3.  Chen W, Meshfree boundary particle method applied to Helmholtz problems. Engineering Analysis with Boundary Elements 2002,26(7): 577–581.
4.  Chen W, Fu ZJ, Jin BT, A truly boundary-only meshfree method for inhomogeneous problems based on recursive composite multiple reciprocity technique. Engineering Analysis with Boundary Elements 2010,34(3): 196–205.
...
7.
8.
9.  Fu ZJ, Chen W, Yang W, Winkler plate bending problems by a truly boundary-only boundary particle method. Computational Mechanics 2009,44(6): 757–563.
10. Fu ZJ, Chen W, Zhang CZ, Boundary particle method for Cauchy inhomogeneous potential problems. Inverse Problems in Science and Engineering 2012,20(2): 189–207.
11. Chen W, Fu ZJ, Boundary particle method for inverse Cauchy problems of inhomogeneous Helmholtz equations. Journal of Marine Science and Technology–Taiwan 2009,17(3): 157–163.
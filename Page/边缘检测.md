...
在Canny创造性的工作中，他研究了设计一个用于边缘检测最优预[平滑滤波器中的问题](https://zh.wikipedia.org/wiki/smoothing "wikilink")，后来他说明这个滤波器能够很好地被一阶[高斯导数核优化](../Page/高斯函数.md "wikilink")。另外Canny引入了非最大抑制概念，它是说边缘定义为在梯度方向具有最大梯度值的点。

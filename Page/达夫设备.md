...
此版代码摘自[比雅尼·斯特劳斯特鲁普著](../Page/比雅尼·斯特劳斯特鲁普.md "wikilink")《[C++程序设计语言](https://zh.wikipedia.org/wiki/C++程式語言_\(書\) "wikilink")》一书的“这段代码有何用？（what
does this code
...
## 延伸阅读
  ...
  - [比雅尼·斯特劳斯特鲁普](../Page/比雅尼·斯特劳斯特鲁普.md "wikilink"),
    *[C++程序设计语言第三版](https://zh.wikipedia.org/wiki/C++程式語言_\(書\) "wikilink")*.

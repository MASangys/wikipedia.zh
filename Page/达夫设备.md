在[计算机科学](../Page/计算机科学.md "wikilink")领域，**达夫设备**（[英文](https://zh.wikipedia.org/wiki/英文 "wikilink")：**Duff's
device**）是串行复制（serial
copy）的一种，通过[汇编语言](../Page/汇编语言.md "wikilink")编程时一常用方法，实现[展开循环](../Page/循环展开.md "wikilink")，进而提高执行效率。这一方法据信为当时供职于[卢卡斯影业](../Page/卢卡斯影业.md "wikilink")的于1983年11月发明，并可能是迄今为止利用[C语言](https://zh.wikipedia.org/wiki/C语言 "wikilink")特性所作的最巧妙的实现。
...
此版代码摘自[比雅尼·斯特劳斯特鲁普](../Page/比雅尼·斯特劳斯特鲁普.md "wikilink")著《[C++程序设计语言](../Page/C++程式語言_\(書\).md "wikilink")》一书的“这段代码有何用？（what
does this code
do?）”练习部分，而他之所以如此修改，很可能是因考虑到编程新手一般对[存储器映射输出](../Page/存储器映射输入输出.md "wikilink")[寄存器](../Page/寄存器.md "wikilink")一无所知。值得一提的是，针对串行复制的需求，标准C语言库提供了[memcpy函数](https://zh.wikipedia.org/wiki/memcpy "wikilink")，而其效率不会比斯特劳斯鲁普版的达夫设备低，并可能包含了针对特定架构的优化，从而进一步大幅提升执行效率\[3\]\[4\]。

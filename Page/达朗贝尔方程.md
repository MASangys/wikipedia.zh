在经典[电动力学中](https://zh.wikipedia.org/wiki/电动力学 "wikilink")，将描述[电磁波的](../Page/电磁波.md "wikilink")[势所满足的一个](https://zh.wikipedia.org/wiki/势 "wikilink")[微分方程组称作](../Page/微分方程.md "wikilink")**达朗贝尔方程**（英文：**d'Alembert
...
由\(\boldsymbol{B}\)的[无源性可以引入磁矢势](../Page/散度.md "wikilink")\(\boldsymbol{A}\)，有\(\boldsymbol{B}=\boldsymbol{\nabla}\times \boldsymbol{A}\)，代入麦克斯韦方程组的第一式得\(\boldsymbol{\nabla}\times \left(\boldsymbol{E}+\frac{\partial\boldsymbol{A}}{\partial t}\right)=0\)。这说明[矢量](https://zh.wikipedia.org/wiki/矢量 "wikilink")\(\boldsymbol{E}+\frac{\partial\boldsymbol{A}}{\partial t}\)是[无旋场](https://zh.wikipedia.org/wiki/无旋场 "wikilink")，可以用[标量势](https://zh.wikipedia.org/wiki/标量势 "wikilink")\(\varphi\)的负[梯度描述](../Page/梯度.md "wikilink")：
...
此即达朗贝尔方程，其自由项为[电流密度和](../Page/电流密度.md "wikilink")[电荷密度](https://zh.wikipedia.org/wiki/电荷密度 "wikilink")。

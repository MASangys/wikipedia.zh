...
**运动学**（kinematics）是[力学](../Page/力学.md "wikilink")的一门分支，专门描述物体的[運動](../Page/運動_\(物理學\).md "wikilink")，即物体在[空间中的位置随](https://zh.wikipedia.org/wiki/空间 "wikilink")[时间](../Page/时间.md "wikilink")的演进而作的改变，完全不考慮[作用力或](https://zh.wikipedia.org/wiki/作用力 "wikilink")[质量](../Page/质量.md "wikilink")等等影响運動的因素。運動学与\[\[力動學|{\\Delta t}</math> ；
...
求解曲线运动问题时，选择合适的坐标系是一项非常重要的步骤。运动所遭遇到的约束、或作用力的几何特性，往往是决定合适坐标的主要因素。假设，限制一粒串珠只能绕圆环移动，那麼，以[圆](../Page/圆.md "wikilink")心为[顶点](https://zh.wikipedia.org/wiki/顶点 "wikilink")，包含串珠与圆环的另一点的[角](https://zh.wikipedia.org/wiki/角 "wikilink")，其[角弧可能是合适的坐标](https://zh.wikipedia.org/wiki/角度 "wikilink")。类似地，假设施加於質點的作用力是[连心力](https://zh.wikipedia.org/wiki/连心力 "wikilink")，則合适的坐标系可能是[极坐标系](../Page/极坐标系.md "wikilink")。

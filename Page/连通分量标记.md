...
连通分量标记通常在计算机视觉领域中对二值图像的连通区域进行检测，也可以处理彩色图像和更高维的数据。\[1\]\[2\]当将其集成到[图像识别系统或者是](https://zh.wikipedia.org/wiki/图像识别 "wikilink")[人机交互](../Page/人机交互.md "wikilink")系统是，该算法也起到重要作用。\[3\]\[4\]

**迪菲-赫爾曼密鑰交換**（，縮寫為D-H） 是一种[安全协议](../Page/安全协议.md "wikilink")。它可以让双方在完全没有对方任何预先信息的条件下通过不安全[信道](../Page/信道.md "wikilink")建立起一个[密钥](../Page/密钥.md "wikilink")。这个密钥可以在后续的通讯中作为[对称密钥来](https://zh.wikipedia.org/wiki/对称密钥 "wikilink")[加密通讯内容](https://zh.wikipedia.org/wiki/加密 "wikilink")。公鑰交換的概念最早由[瑞夫·墨克](../Page/瑞夫·墨克.md "wikilink")（）提出，而這個密鑰交換方法，由[惠特菲爾德·迪菲](../Page/惠特菲爾德·迪菲.md "wikilink")（）和[馬丁·赫爾曼](../Page/馬丁·赫爾曼.md "wikilink")（）在1976年首次發表。馬丁·赫爾曼曾主張這個密鑰交換方法，應被稱為**迪菲-赫爾曼-墨克密鑰交換**（）。
...
## 引用
  ...
  - [An Overview of Public Key Cryptography](http://www.comsoc.org/livepubs/ci1/public/anniv/pdfs/hellman.pdf) Martin E. Hellman, IEEE Communications Magazine, May 2002, pp:42–49. (123kB PDF file)

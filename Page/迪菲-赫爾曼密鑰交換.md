**迪菲-赫爾曼密鑰交換**（，縮寫為D-H）
是一种[安全协议](../Page/安全协议.md "wikilink")。它可以让双方在完全没有对方任何预先信息的条件下通过不安全[信道](../Page/信道.md "wikilink")建立起一个[密钥](../Page/密钥.md "wikilink")。这个密钥可以在后续的通讯中作为[对称密钥来](https://zh.wikipedia.org/wiki/对称密钥 "wikilink")[加密通讯内容](https://zh.wikipedia.org/wiki/加密 "wikilink")。公鑰交換的概念最早由[瑞夫·墨克](../Page/瑞夫·墨克.md "wikilink")（）提出，而這個密鑰交換方法，由[惠特菲爾德·迪菲](../Page/惠特菲爾德·迪菲.md "wikilink")（）和[馬丁·赫爾曼](../Page/馬丁·赫爾曼.md "wikilink")（）在1976年首次發表。馬丁·赫爾曼曾主張這個密鑰交換方法，應被稱為**迪菲-赫爾曼-墨克密鑰交換**（）。
...
*a*。这个问题就是著名的[离散对数](../Page/离散对数.md "wikilink")问题。注意*g*则不需要很大,
...
*q*可以用来计算素数*p=2q+1*，这样的*p*称为[安全素数](../Page/安全素数.md "wikilink")，因为使用它之后*G*的阶只能被2和*q*整除。*g*有时被选择成*G*的*q*阶子群的生成元，而不是*G*本身的生成元，这样*g<sup>a</sup>*的[勒让德符号](../Page/勒让德符号.md "wikilink")将不会显示出*a*的低位。

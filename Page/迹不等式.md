在[数学](../Page/数学.md "wikilink")中，有很多关于[希尔伯特空间](../Page/希尔伯特空间.md "wikilink")上的[矩阵](../Page/矩阵.md "wikilink")和[线性算子的](https://zh.wikipedia.org/wiki/线性算子 "wikilink")[不等式](https://zh.wikipedia.org/wiki/不等式 "wikilink")。本文主要论述和[矩阵的迹有关的一些重要的算子不等式](https://zh.wikipedia.org/wiki/矩阵的迹 "wikilink")。\[1\]\[2\]\[3\]\[4\]

## 基本定义

另**H**<sub>*n*</sub>表示*n*×*n*埃尔米特矩阵空间， **H**<sub>*n*</sub><sup>+</sup>表示全体*n*×*n*[半正定埃尔米特矩阵](https://zh.wikipedia.org/wiki/半正定矩阵 "wikilink")，**H**<sub>*n*</sub><sup>++</sup>表示全体*n*×*n*[正定埃尔米特矩阵](../Page/正定矩阵.md "wikilink")。对于无限维希尔伯特空间上的算子，则需要是迹算子或[埃尔米特算子](https://zh.wikipedia.org/wiki/埃尔米特算子 "wikilink")，简单起见，此处我们只讨论矩阵。
...
函数 \(f\) 是 算子**凹的** 如果 \(-f\) 是算子凸的，即上面关于 \(f\) 不等式符号反过来成立。

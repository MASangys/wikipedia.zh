**逆小波轉換**(inverse wavelet
transform)為[小波轉換的反函數](../Page/小波分析.md "wikilink")，小波轉換大致分為三類
...
\(\psi_1(t)\)為\(\psi(t)\)的雙效函數(dual
function)，滿足以下[正交](../Page/正交.md "wikilink")(orthogonal)特性
...
[DWT.png](https://zh.wikipedia.org/wiki/File:DWT.png "fig:DWT.png")
...
證明於參考條目中
因此只要\(g_1[n],h_1[n]\)符合上述條件就能將經過離散小波轉換的\(x_{1,L}[n],x_{1,H}[n]\)重建為x\[n\]
...
1.  [Jian-Jiun Ding (2014) Time-Frequency Analysis and Wavelet
    Transform](http://djj.ee.ntu.edu.tw/TFW.htm)

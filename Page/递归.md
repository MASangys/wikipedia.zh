...
zh-hk:遞迴;}-**，在[数学与](../Page/数学.md "wikilink")[计算机科学中](../Page/计算机科学.md "wikilink")，是指在[函数的定义中使用函数自身的方法](../Page/函数.md "wikilink")。递归一词还较常用于描述以[自相似方法重复事物的过程](https://zh.wikipedia.org/wiki/自相似 "wikilink")。例如，当两面镜子相互之间近似平行时，镜中嵌套的图像是以无限递归的形式出现的。也可以理解为自我复制的过程。
...
数学中常见的以递归形式定义的案例参见函数、[集合以及](https://zh.wikipedia.org/wiki/集合 "wikilink")[分形等](../Page/分形.md "wikilink")。
...
[natural
numbers](https://zh.wikipedia.org/wiki/natural_numbers "wikilink"):
...
此集合稱為，可導出之命題之集合，因為在數學基礎方法中，依非建立性法構建的命題之集合，可能大於由[公理系統及](https://zh.wikipedia.org/wiki/公理系統 "wikilink")[推理規則所遞歸構建出之集合](https://zh.wikipedia.org/wiki/推理規則 "wikilink")，詳細請參見

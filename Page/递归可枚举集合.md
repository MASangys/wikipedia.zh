**递归可枚举集合**（）是[可计算性理论或更狭义的](../Page/可计算性理论.md "wikilink")[递归论中的一个概念](../Page/递归论.md "wikilink")。[可数集合](https://zh.wikipedia.org/wiki/可数集合 "wikilink")**被称为是递归可枚举、计算可枚举的、半可判定的或可证明的，如果
...
[RE](https://zh.wikipedia.org/wiki/RE_\(复杂性\) "wikilink")。
...
可数集合 \(S\)
是递归可枚举的，如果存在一个[偏](https://zh.wikipedia.org/wiki/偏函数 "wikilink")[可计算函数](../Page/可计算函数.md "wikilink")
\(f\) 使得
...
\[\mathrm{dom}(f) = S\]
(注意这是偏函数的域的两种可能意义之一，是在递归论中所偏好的定义域。参见在[偏函数中的讨论](https://zh.wikipedia.org/wiki/偏函数 "wikilink")。)
...
可数集合 \(S\)
被叫做**递归可枚举的**，如果存在着一个[偏](https://zh.wikipedia.org/wiki/偏函数 "wikilink")[可计算函数](../Page/可计算函数.md "wikilink")
...
因为[邱奇-图灵论题声称可计算函数被](https://zh.wikipedia.org/wiki/邱奇-图灵论题 "wikilink")[图灵机和其他](../Page/图灵机.md "wikilink")[计算模型等价的定义](https://zh.wikipedia.org/wiki/计算模型 "wikilink")，我们陈述定义为
...
## 例子
  ...
  - [递归可枚举语言是在](../Page/递归可枚举语言.md "wikilink")[形式语言的](../Page/形式语言.md "wikilink")[字母表上所有可能词的集合中的递归可枚举集合](https://zh.wikipedia.org/wiki/字母表_\(计算机科学\) "wikilink")。
  - [Matiyasevich
    定理声称所有的递归可枚举集合都是](https://zh.wikipedia.org/wiki/Matiyasevich_定理 "wikilink")[丢番图集合](https://zh.wikipedia.org/wiki/丢番图集合 "wikilink")。
  ...
  - 对于偏可计算函数 \(\phi\)的哥德尔数\(i\)，则集合
    ...
    \(\langle i,x \rangle\)
    [康拖尔配对函数](https://zh.wikipedia.org/wiki/康拖尔配对函数 "wikilink"))
...
补集二者是递归可枚举集合。递归可枚举集合一个可计算函数下的[原像是递归可枚举集合](https://zh.wikipedia.org/wiki/原像 "wikilink")。

## 引用

  - Rogers, H. *The Theory of Recursive Functions and Effective
    Computability*, [MIT
    Press](https://zh.wikipedia.org/wiki/MIT_Press "wikilink"). ISBN

**通用閘道器介面**（**C**ommon **G**ateway **I**nterface/**CGI**）是一种重要的[互联网](../Page/互联网.md "wikilink")技术，可以让一个客户端，从[网页浏览器](../Page/网页浏览器.md "wikilink")向[服务器](../Page/服务器.md "wikilink")上的程序请求数据。CGI描述了服务器和请求处理程序之间传输数据的一种标准。

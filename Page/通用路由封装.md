**通用路由封装**（，縮寫：**GRE**）是一种可以在虚拟[点对点链路中](https://zh.wikipedia.org/wiki/点对点 "wikilink")[封装多种](https://zh.wikipedia.org/wiki/封装 "wikilink")[网络层协议的](../Page/网络层.md "wikilink")[隧道协议](../Page/隧道协议.md "wikilink")。由[思科系统开发](../Page/思科系统.md "wikilink")，在中定义。

## 协议栈举例

| [OSI模型分层](../Page/OSI模型.md "wikilink")                      | [协议](../Page/网络传输协议.md "wikilink")                      |
| ----------------------------------------------------------- | ------------------------------------------------------- |

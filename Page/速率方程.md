**化学反应速率方程**是利用[反应物](https://zh.wikipedia.org/wiki/反应物 "wikilink")[浓度或](https://zh.wikipedia.org/wiki/浓度 "wikilink")[分压计算](https://zh.wikipedia.org/wiki/分压 "wikilink")[化学反应的](../Page/化学反应.md "wikilink")[反应速率的方程](https://zh.wikipedia.org/wiki/反应速率 "wikilink")。\[1\]对于一个化学反应
\(mA + nB \rightarrow C\)，化学反应速率方程（与复杂反应速率方程相比较）的一般形式写作：\[2\]

\[r= -\frac{1}{m} \frac{d[A]}{dt} =k \ [A]^{x} [B]^{y}\]

在这个方程中，\([X]\)表示一种给定的反应物\(X\)的[活度](https://zh.wikipedia.org/wiki/活度 "wikilink")，单位通常为[摩尔每升](https://zh.wikipedia.org/wiki/摩尔 "wikilink")（mol/L），但在实际计算中有时也用[浓度代替](https://zh.wikipedia.org/wiki/浓度 "wikilink")（若该反应物为气体，表示分压，单位为[帕斯卡](../Page/帕斯卡.md "wikilink")
(Pa）。\(k\)表示这一反应的[速率常数](../Page/速率常数.md "wikilink")，与[温度](../Page/温度.md "wikilink")、[离子活度](https://zh.wikipedia.org/wiki/活度 "wikilink")、[光照](../Page/光化学.md "wikilink")、固体反应物的接触面积、反应[活化能等因素有关](https://zh.wikipedia.org/wiki/活化能 "wikilink")，通常可通过[阿累尼乌斯方程计算出来](https://zh.wikipedia.org/wiki/阿累尼乌斯方程 "wikilink")，也可通过实验测定。
...
[可逆反应](https://zh.wikipedia.org/wiki/可逆反应 "wikilink")（又称平衡反应、对行反应、对峙反应）指的是反应物与产物形成[化学平衡的反应](../Page/化学平衡.md "wikilink")，其中正向和逆向反应同时进行，而且反应速率相等。它可以用下面的方程式来表示：\(sA + tB \rightleftharpoons uX + vY\)假设正向反应速率为
...
对行反应的例子有：
  ...
  - [邻苯二甲酸酐与](../Page/邻苯二甲酸酐.md "wikilink")[异辛醇反应生成](https://zh.wikipedia.org/wiki/异辛醇 "wikilink")[邻苯二甲酸二异辛酯的反应](https://zh.wikipedia.org/wiki/邻苯二甲酸二异辛酯 "wikilink")。
...
连续反应的例子有：
  ...
  - 4-氨基[偶氮苯用](../Page/偶氮苯.md "wikilink")[发烟硫酸](https://zh.wikipedia.org/wiki/发烟硫酸 "wikilink")[磺化时发生的反应](https://zh.wikipedia.org/wiki/磺化 "wikilink")：
...
以上只是几种基本的复合反应类型，除此以外，还有很多情况是上述几种基本复合反应的混合。请有兴趣的读者参见[酶动力学](../Page/酶动力学.md "wikilink")、[米氏方程和](https://zh.wikipedia.org/wiki/米氏方程 "wikilink")[酶抑制剂等文章](../Page/酶抑制剂.md "wikilink")。
...
1.  微分法：对 \(\ -\frac{d[A]}{dt} = k[A]^n\)
    求[对数](https://zh.wikipedia.org/wiki/对数 "wikilink")，得到：
...
cyfradd](https://zh.wikipedia.org/wiki/cy:Cyfradd_adwaith#Hafaliadau_cyfradd "wikilink")
...
1.  [IUPAC](https://zh.wikipedia.org/wiki/IUPAC "wikilink")[金皮书对](https://zh.wikipedia.org/wiki/金皮书 "wikilink")“反应速率”（rate

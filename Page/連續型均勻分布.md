...
**連續型均匀分布**，如果连续型[随机变量](../Page/随机变量.md "wikilink")\(\mathit{X}\)具有如下的[概率密度函数](https://zh.wikipedia.org/wiki/概率密度函数 "wikilink")，则称\(\mathit{X}\)服从\([a,b]\)上的均匀分布（uniform
distribution）,记作\(X \sim U[a,b]\)
...
[期望值和](../Page/期望值.md "wikilink")[中值](https://zh.wikipedia.org/wiki/中值 "wikilink")：
...
[su:Sebaran seragam\#Kasus
kontinyu](https://zh.wikipedia.org/wiki/su:Sebaran_seragam#Kasus_kontinyu "wikilink")

...
逻辑等价经常混淆于[实质等价](https://zh.wikipedia.org/wiki/实质等价 "wikilink")。前者是在[元语言中的一个陈述](https://zh.wikipedia.org/wiki/元语言 "wikilink")，断言关于[目标语言中的陈述](https://zh.wikipedia.org/wiki/形式系统 "wikilink")*p*和*q*的某个事情。而*p*和*q*的实质等价（常写为"*p*
↔ *q*"）自身是在目标语言中另一个陈述。但它们是有联系的，*p*和*q*是语法等价的，当且仅当*p* ↔
*q*是一个[定理](../Page/定理.md "wikilink")，而*p*和*q*是语义等价的，[当且仅当](../Page/当且仅当.md "wikilink")*p*
↔ *q*是[重言式](https://zh.wikipedia.org/wiki/重言式 "wikilink")。

...
**達朗貝爾原理**（）是因其發現者[法國物理學家與數學家](https://zh.wikipedia.org/wiki/法國 "wikilink")[讓·達朗貝爾而命名](https://zh.wikipedia.org/wiki/达朗贝尔 "wikilink")。達朗貝爾原理闡明，對於任意物理系統，所有[慣性力或施加的外力](../Page/慣性力.md "wikilink")，經過符合[約束條件的](https://zh.wikipedia.org/wiki/約束條件 "wikilink")[虛位移](../Page/虛位移.md "wikilink")，所作的[虛功的總和等於零](../Page/虛功.md "wikilink")\[1\]：

\[\sum_{i}\ (\mathbf{F}_{i}+\mathbf{I}_i)\cdot \delta \mathbf{r}_i = 0\,\!\]；
其中，\(\mathbf{I}_i= - m_i\mathbf{a}_i\,\!\)是粒子\(P_i\,\!\)感受到的慣性力，\(m_i\,\!\)和\(\mathbf{a}_i\,\!\)分別是粒子\(P_i\,\!\)的[質量和](https://zh.wikipedia.org/wiki/質量 "wikilink")[加速度](../Page/加速度.md "wikilink")，\(\mathbf{F}_i\,\!\)是施加於粒子\(P_i\,\!\)的外力（不包括[約束力](https://zh.wikipedia.org/wiki/約束條件 "wikilink")）、\(\delta \mathbf{r}_i\,\!\)是符合系統[約束的虛位移](https://zh.wikipedia.org/wiki/約束 "wikilink")。

[靜力學的](https://zh.wikipedia.org/wiki/靜力學 "wikilink")[虛功原理在](https://zh.wikipedia.org/wiki/虛功原理 "wikilink")[動力學的版本是達朗貝爾原理](../Page/動力學.md "wikilink")。假若一個物理系統的每一個約束條件都只約束[位置或時間](https://zh.wikipedia.org/wiki/位置 "wikilink")，而不約束[速度](../Page/速度.md "wikilink")，則稱此物理系統為[完整系統](../Page/完整系統.md "wikilink")。達朗貝爾原理比[哈密頓原理的適用範圍更廣闊](../Page/哈密頓原理.md "wikilink")，可以用於不僅是完整系統。
...
達朗貝爾原理又可表達為：對於任意物理系統，所有有效力，經過符合[約束條件的](https://zh.wikipedia.org/wiki/約束條件 "wikilink")[虛位移](../Page/虛位移.md "wikilink")，所作的[虛功的總合等於零](../Page/虛功.md "wikilink")，
...
其中，\(\mathbf{F}_i\,\!\)是施加於剛體的外力，\(m\,\!\)是剛體的質量，\(\mathbf{a}\,\!\)是剛體質心的加速度，\(\mathbf{M}_i\,\!\)是每一個外力\(\mathbf{F}_i\,\!\)對於剛體[質心的](../Page/質心.md "wikilink")[力矩](../Page/力矩.md "wikilink")、\(\boldsymbol{\mathcal{I}}\,\!\)是對於剛體質心的[慣性張量](https://zh.wikipedia.org/wiki/慣性張量 "wikilink")，\(\boldsymbol{\alpha}\,\!\)是剛體的[角加速度](https://zh.wikipedia.org/wiki/角加速度 "wikilink")。

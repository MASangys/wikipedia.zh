[Jean_d'Alembert.jpeg](https://zh.wikipedia.org/wiki/File:Jean_d'Alembert.jpeg "fig:Jean_d'Alembert.jpeg")\]\]
**達朗貝爾原理**（）是因其發現者[法國物理學家與數學家](../Page/法國.md "wikilink")[讓·達朗貝爾而命名](../Page/达朗贝尔.md "wikilink")。達朗貝爾原理闡明，對於任意物理系統，所有[慣性力或施加的外力](../Page/慣性力.md "wikilink")，經過符合[約束條件的](../Page/約束條件.md "wikilink")[虛位移](../Page/虛位移.md "wikilink")，所作的[虛功的總和等於零](../Page/虛功.md "wikilink")\[1\]：

\[\sum_{i}\ (\mathbf{F}_{i}+\mathbf{I}_i)\cdot \delta \mathbf{r}_i = 0\,\!\]；
其中，\(\mathbf{I}_i= - m_i\mathbf{a}_i\,\!\)是粒子\(P_i\,\!\)感受到的慣性力，\(m_i\,\!\)和\(\mathbf{a}_i\,\!\)分別是粒子\(P_i\,\!\)的[質量和](../Page/質量.md "wikilink")[加速度](../Page/加速度.md "wikilink")，\(\mathbf{F}_i\,\!\)是施加於粒子\(P_i\,\!\)的外力（不包括[約束力](../Page/約束條件.md "wikilink")）、\(\delta \mathbf{r}_i\,\!\)是符合系統[約束的虛位移](../Page/約束.md "wikilink")。

[靜力學的](../Page/靜力學.md "wikilink")[虛功原理在](../Page/虛功原理.md "wikilink")[動力學的版本是達朗貝爾原理](../Page/動力學.md "wikilink")。假若一個物理系統的每一個約束條件都只約束[位置或時間](../Page/位置.md "wikilink")，而不約束[速度](../Page/速度.md "wikilink")，則稱此物理系統為[完整系統](../Page/完整系統.md "wikilink")。達朗貝爾原理比[哈密頓原理的適用範圍更廣闊](../Page/哈密頓原理.md "wikilink")，可以用於不僅是完整系統。

因為達朗貝爾原理，在一個動力系統裏，約束力所作的虛功自動抵消，也就是說，不需要顧慮約束力所作的虛功。

## 導論

思考由一群粒子構成的一個物理系統。按照[牛頓運動定律](../Page/牛頓運動定律.md "wikilink")\[2\]，

\[\mathbf{F}_{i}^{(T)} = m_i \mathbf{a}_i\,\!\]；

其中，\(\mathbf{F}_{i}^{(T)}\,\!\)是所有施加於粒子\(P_i\,\!\)的作用力的[合力](../Page/合力.md "wikilink")（包括約束力）。
...
達朗貝爾原理又可表達為：對於任意物理系統，所有有效力，經過符合[約束條件的](../Page/約束條件.md "wikilink")[虛位移](../Page/虛位移.md "wikilink")，所作的[虛功的總合等於零](../Page/虛功.md "wikilink")，
...
在此特別列出幾個案例，展示出約束力所做的符合約束條件的虛功的總合是零：
  ...
  - [剛體的約束條件是一種](../Page/剛體.md "wikilink")[完整約束](../Page/完整系統.md "wikilink")，以方程式表達，\((\mathbf{r}_i-\mathbf{r}_j)^2=L_{ij}^2\)；其中，剛體內部的粒子\(P_i\)、\(P_j\)的位置分別為\(\mathbf{r}_i\)、\(\mathbf{r}_j\)，它們之間的距離\(L_{ij}\)是個常數。所以，兩個粒子的虛位移\(\delta\mathbf{r}_i\)、\(\delta\mathbf{r}_j\)之間的關係為
...
[拉格朗日力學是對經典力學的一種不同的表述](../Page/拉格朗日力學.md "wikilink")。拉格朗日方程式是拉格朗日力學的基要方程式，可以用來描述物體的運動，特別適用於理論物理的研究。拉格朗日方程式的功能等價於[牛頓力學中的](../Page/牛頓力學.md "wikilink")[牛頓第二定律](../Page/牛頓第二定律.md "wikilink")。

從達朗貝爾原理，可以推導出拉格朗日方程式\[6\]。設定粒子\(P_i\,\!\)的位置\(\mathbf{r}_i\,\!\)為[廣義坐標](../Page/廣義坐標.md "wikilink")\(q_1,q_2,\cdots ,q_n\,\!\)與時間\(t\,\!\)的函數：
...
思考這個系統的[動能](../Page/動能.md "wikilink")\(T\,\!\)，
...
假設這系統是[單演系統](../Page/單演系統.md "wikilink")，也就是說，這系統的廣義力與[廣義位勢](../Page/廣義位勢.md "wikilink")\(V\,\!\)之間的關係式為
...
[廣義位勢也是系統的](../Page/廣義位勢.md "wikilink")[勢能](../Page/勢能.md "wikilink")。注意到[拉格朗日量](../Page/拉格朗日量.md "wikilink")\(L\,\!\)定義為系統的動能減去勢能：
...
假設這系統是[保守系統](../Page/保守系統.md "wikilink")，也就是說，這系統的廣義力與[位勢](../Page/位勢.md "wikilink")\(V\,\!\)之間的關係式為
...
根據對於剛體的[牛頓第二定律](../Page/牛頓第二定律.md "wikilink")，一個運動中的剛體，其運動方程式為

\[\sum_i \ \mathbf{F}_i=m \mathbf{a}\,\!\]、

\[\sum_i\ \mathbf{M}_i= \boldsymbol{\mathcal{I}}\boldsymbol{\alpha}\,\!\]；

其中，\(\mathbf{F}_i\,\!\)是施加於剛體的外力，\(m\,\!\)是剛體的質量，\(\mathbf{a}\,\!\)是剛體質心的加速度，\(\mathbf{M}_i\,\!\)是每一個外力\(\mathbf{F}_i\,\!\)對於剛體[質心的](../Page/質心.md "wikilink")[力矩](../Page/力矩.md "wikilink")、\(\boldsymbol{\mathcal{I}}\,\!\)是對於剛體質心的[慣性張量](../Page/慣性張量.md "wikilink")，\(\boldsymbol{\alpha}\,\!\)是剛體的[角加速度](../Page/角加速度.md "wikilink")。
...
在[工程力學裏](../Page/工程力學.md "wikilink")，**達朗貝爾慣性力原理**闡明：剛體的慣性力與所有作用於剛體的外力的合力等於零，剛體的慣性力矩與所有作用於剛體的力矩的合力矩等於零。\[7\]。這原理可以幫助分析正在運動中的某連桿所感受到的作用力。

請注意，慣性力必須作用於質心；而慣性力矩是[力偶矩](../Page/力偶矩.md "wikilink")，可以作用於物體的任何一位置。靠著達朗貝爾慣性力原理，動力系統可以變為像靜力系統一樣的解析。這方法的優點是，在等價的靜力系統裏，可以選擇任何一點（不只是質心）來計算力矩。這時常會導至較簡易的運算。因為，如果選擇出正確的力矩作用點，在計算力矩時，可以忽略許多作用力（這些作用力與選擇點同直線）。

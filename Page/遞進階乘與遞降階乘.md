在[数学中](../Page/数学.md "wikilink")，**階乘冪**（）是基于[自然數](https://zh.wikipedia.org/wiki/自然數 "wikilink")[数列积的一种运算](../Page/数列.md "wikilink")，分為**遞進階乘**（）和**遞降階乘**（），或稱**上升階乘**和**下降階乘**，
...
[葛立恒](https://zh.wikipedia.org/wiki/葛立恒 "wikilink")、[高德纳与](../Page/高德纳.md "wikilink")在《[具体数学](https://zh.wikipedia.org/wiki/具体数学 "wikilink")》一书中，則引进符號
...
另外，值得一提的是遞進階乘实际上是排列
\(P^x_n\)，详见[排列](https://zh.wikipedia.org/wiki/排列 "wikilink")。
...
显然，遞進階乘与遞降階乘作为 *n* 个连续整数的积，它定能被 *n*
[整除](https://zh.wikipedia.org/wiki/整除 "wikilink")，即
...
[差分方程里常使用遞降階乘](https://zh.wikipedia.org/wiki/差分方程 "wikilink")。其应用与[微积分学中的](../Page/微积分学.md "wikilink")[泰勒定理非常相似](https://zh.wikipedia.org/wiki/泰勒定理 "wikilink")，不过将微分替换为对应的差分。只是在差分中，遞降階乘

...
Document**)**問題**是一個發生於[微軟](https://zh.wikipedia.org/wiki/微軟 "wikilink")[Windows系列](https://zh.wikipedia.org/wiki/Microsoft_Windows "wikilink")[作業系統的一個保安問題](https://zh.wikipedia.org/wiki/作業系統 "wikilink")。問題與一款名為「Looked」及其變種的[蠕蟲有關](../Page/電腦蠕蟲.md "wikilink")。
...
3.  檢查[機碼](https://zh.wikipedia.org/wiki/機碼 "wikilink")
    HKLM\\SOFTWARE\\Soft\\DownloadWWW 是否存在，若有的話，再檢查"auto"值的資料是否為"1"。

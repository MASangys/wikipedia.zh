**邊緣銳化 (Edge crispening)**是[影像處理的](https://zh.wikipedia.org/wiki/影像處理 "wikilink")[濾波器](https://zh.wikipedia.org/wiki/濾波器 "wikilink")，能夠加強影像或是影片的邊緣[對比度](https://zh.wikipedia.org/wiki/對比度 "wikilink")。在視覺上，具有清晰邊界的影像較受使用者喜愛。 [Usm-unsharp-mask.jpg](https://zh.wikipedia.org/wiki/File:Usm-unsharp-mask.jpg "fig:Usm-unsharp-mask.jpg")

**对数几率回归（也称“逻辑回归”）**（），即对数几率模型（，也译作“逻辑模型”、“评定模型”、“分类评定模型”）是[离散选择法模型之一](https://zh.wikipedia.org/wiki/离散选择法 "wikilink")，属于[多重变量分析范畴](https://zh.wikipedia.org/wiki/多重变量分析 "wikilink")，是[社会学](../Page/社会学.md "wikilink")、[生物统计学](https://zh.wikipedia.org/wiki/生物统计学 "wikilink")、[临床](https://zh.wikipedia.org/wiki/臨床研究 "wikilink")、[数量心理学](https://zh.wikipedia.org/wiki/数量心理学 "wikilink")、[计量经济学](../Page/计量经济学.md "wikilink")、[市场营销等](../Page/市场营销.md "wikilink")[统计实证分析的常用方法](https://zh.wikipedia.org/wiki/统计 "wikilink")。
...
其中参数\(\beta\)常用[最大似然估計](https://zh.wikipedia.org/wiki/最大似然估計 "wikilink")。

## IIA假设

“***Independent and irrelevant
alternatives***”假设，也称作“IIA效应”，指Logit模型中的各个可选项是独立的不相关的。
...
### 满足IIA假设的优点
  ...
  - 各个类别的[子集的一般化的](../Page/子集.md "wikilink")[估计](https://zh.wikipedia.org/wiki/估计 "wikilink")
  - 大大节省时间
  - 可选项数目很多的时候尤其如此
...
## 参考书目
  ...
  - Amemiya, T., 1985, Advanced
    [Econometrics](https://zh.wikipedia.org/wiki/Econometrics "wikilink")，Harvard
    University Press.
  - Hosmer, D. W. and S. Lemeshow: Applied logistic regression. New

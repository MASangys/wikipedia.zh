**逻辑门**是在[集成電路上的基本組件](https://zh.wikipedia.org/wiki/集成電路 "wikilink")。简单的邏輯閘可由[晶体管组成](../Page/晶体管.md "wikilink")。這些晶体管的组合可以使代表两种信号的高低电平在通过它们之后产生高电平或者低电平的[信号](https://zh.wikipedia.org/wiki/信号 "wikilink")。高、低电平可以分别代表逻辑上的“真”与“假”或[二进制当中的](https://zh.wikipedia.org/wiki/二进制 "wikilink")1和0，从而实现邏輯运算。常见的逻辑门包括“與”閘，“或”閘，“非”閘，“異或”閘（也稱：互斥或）等等。
...
常用的邏輯閘有兩種常用的表示法，他們皆由[ANSI](https://zh.wikipedia.org/wiki/美國國家標準協會 "wikilink")（[美國國家標準協會](https://zh.wikipedia.org/wiki/美國國家標準協會 "wikilink")）／[IEEE](https://zh.wikipedia.org/wiki/Institute_of_Electrical_and_Electronics_Engineers "wikilink")（[電機電子工程師學會](https://zh.wikipedia.org/wiki/電機電子工程師學會 "wikilink")）
...
Y32.14跟一些早期工業用的符號為基礎，再重新由[IEEE跟](https://zh.wikipedia.org/wiki/Institute_of_Electrical_and_Electronics_Engineers "wikilink")[IEC（](https://zh.wikipedia.org/wiki/International_Electrotechnical_Commission "wikilink")[國際電工委員會）做微調而成](https://zh.wikipedia.org/wiki/國際電工委員會 "wikilink")；在每個符號中皆可以發現有矩形的外框圍著所代表的字，且相較於舊的表示法，他可以涵蓋更多的邏輯閘\[1\]。ICE的標準也被轉換成其他的表示法，像是歐洲的（[歐洲標準委員會](https://zh.wikipedia.org/wiki/歐洲標準委員會 "wikilink")）60617-12:1999、英國的（由[英國標準學會制定](https://zh.wikipedia.org/wiki/英國標準學會 "wikilink")）
EN 60617-12:1999跟德國的DIN EN 60617-12:1998。

IEEE Std 91-1984跟IEC
60617-12的共同目標是提供一套有系統符號來描述複雜的邏輯功能跟數位電路。這些邏輯的功能相較於AND閘和OR閘更加的複雜，例如中等大小的[4位元計數器或大型的](https://zh.wikipedia.org/wiki/4位元計數器 "wikilink")[微處理器](https://zh.wikipedia.org/wiki/微處理器 "wikilink")。
...
在1980年代，示意圖成為主要的方式用來設計[印刷電路板以及客製化IC](https://zh.wikipedia.org/wiki/印刷電路板 "wikilink")（例如[邏輯陣列](https://zh.wikipedia.org/wiki/Gate_array "wikilink")）。而現在，客製化IC和[現場可程式邏輯門陣列](https://zh.wikipedia.org/wiki/現場可程式邏輯門陣列 "wikilink")（[field-programmable
gate
array](../Page/现场可编程逻辑门阵列.md "wikilink")）通常是用[硬體描述語言（](https://zh.wikipedia.org/wiki/硬體描述語言 "wikilink")[Hardware
...
[查爾斯·桑德斯·皮爾士](https://zh.wikipedia.org/wiki/查爾斯·桑德斯·皮爾士 "wikilink")(1880–81的冬天)指出[NOR閘可以單獨使用](https://zh.wikipedia.org/wiki/反或閘 "wikilink")(或者[NAND閘也可以](https://zh.wikipedia.org/wiki/反及閘 "wikilink"))來產生其他邏輯閘的所有功能，不過他的這個研究一直到1933年才發表。\[3\]在1913年，[Henry
M.
Sheffer第一個發表](https://zh.wikipedia.org/wiki/Henry_M._Sheffer "wikilink")[NAND閘可以做出全部的功能的證明](https://zh.wikipedia.org/wiki/反及閘 "wikilink")，也因此NAND閘的邏輯運算有時候也稱為[謝費爾豎線](https://zh.wikipedia.org/wiki/謝費爾豎線 "wikilink")([Sheffer
stroke](https://zh.wikipedia.org/wiki/Sheffer_stroke "wikilink"))；[NOR閘有時叫Peirce](https://zh.wikipedia.org/wiki/反或閘 "wikilink")'s
...
3.  Peirce, C. S. (manuscript winter of 1880–81), "A Boolean Algebra
    ...
    Papers](https://zh.wikipedia.org/wiki/Charles_Sanders_Peirce_bibliography#CP "wikilink")*
    v. 4, paragraphs 12–20. Reprinted 1989 in *[Writings of Charles S.
    Peirce](https://zh.wikipedia.org/wiki/Charles_Sanders_Peirce_bibliography#W "wikilink")*

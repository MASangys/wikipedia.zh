...
参照[滤子的定义](../Page/滤子.md "wikilink")。给定点x，其邻域系\(\mathfrak{U}(x)\)恰构成了一个滤子，称为**邻域滤子**。

## 邻域基

点\(x\)的**邻域基**或**局部基**\(\mathcal{B}(x)\)，就是邻域滤子\(\mathfrak{U}(x)\)的**[滤子基](../Page/滤子基.md "wikilink")**。它是\(\mathfrak{U}(x)\)的子集，满足：每个x的邻域
\(U\) 都存在\(B \in \mathcal{B}(x)\)，使\(B \subseteq U\)。
...
<!-- end list -->
  ...
  - 若拓扑空间*X*是[不可分拓扑](../Page/不可分拓扑.md "wikilink")，则任何点 *x*
    的邻域系是整个空间\(\mathcal{V}(x) = \{ X \}\)

<!-- end list -->

  - 在[度量空间中](../Page/度量空间.md "wikilink")，对于任何点 *x*，围绕 *x* 有半径 1/*n*
    的[开球序列形成](../Page/开球.md "wikilink")[可数邻域基](../Page/可数集合.md "wikilink")
    \(\mathcal{B}(x) = \{ B_{1/n}(x) ; n \in \mathbb N^* \}\)。这意味着所有度量空间都是[第一可数的](../Page/第一可数空间.md "wikilink")。

<!-- end list -->

  - 在[半赋范空间中](../Page/半赋范空间.md "wikilink")，就是带有由[半范数引发的](../Page/半范数.md "wikilink")[拓扑的向量空间](../Page/拓扑.md "wikilink")，所有邻域系统可以通过点
    0 的邻域系统的[平移来构造](../Page/平移.md "wikilink")，

\[\mathcal{V}(x) = \mathcal{V}(0) + x\]。

  -
    这是因为向量加法在引发的拓扑中是分离连续的。所以这个拓扑确定自它的在原点的邻域系。更一般的说，只要拓扑是通过[平移不变度量或](../Page/平移不变度量.md "wikilink")[伪度量定义的以上结论就是真的](../Page/伪度量.md "wikilink")。
...
<!-- end list -->
  ...
  - 拓扑空间 *X* 中所有点 *x* 的局部基的并集是 *X*
    的[基](../Page/基_\(拓扑学\).md "wikilink")。

## 参见

  - [邻域](../Page/邻域.md "wikilink")
  - [基 (拓扑学)](../Page/基_\(拓扑学\).md "wikilink")
  - [局部凸拓扑向量空间](../Page/局部凸拓扑向量空间.md "wikilink")

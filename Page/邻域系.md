...
点\(x\)的**邻域基**或**局部基**\(\mathcal{B}(x)\)，就是邻域滤子\(\mathfrak{U}(x)\)的**[滤子基](https://zh.wikipedia.org/wiki/滤子基 "wikilink")**。它是\(\mathfrak{U}(x)\)的子集，满足：每个x的邻域
...
<!-- end list -->
  ...
  - 若拓扑空间*X*是[不可分拓扑](https://zh.wikipedia.org/wiki/不可分拓扑 "wikilink")，则任何点
    *x* 的邻域系是整个空间\(\mathcal{V}(x) = \{ X \}\)

<!-- end list -->

  - 在[度量空间中](../Page/度量空间.md "wikilink")，对于任何点 *x*，围绕 *x* 有半径 1/*n*
    的[开球序列形成](https://zh.wikipedia.org/wiki/开球 "wikilink")[可数邻域基](https://zh.wikipedia.org/wiki/可数集合 "wikilink")
    \(\mathcal{B}(x) = \{ B_{1/n}(x) ; n \in \mathbb N^* \}\)。这意味着所有度量空间都是[第一可数的](https://zh.wikipedia.org/wiki/第一可数空间 "wikilink")。

<!-- end list -->

  - 在[半赋范空间中](https://zh.wikipedia.org/wiki/半赋范空间 "wikilink")，就是带有由[半范数引发的](https://zh.wikipedia.org/wiki/半范数 "wikilink")[拓扑的向量空间](https://zh.wikipedia.org/wiki/拓扑 "wikilink")，所有邻域系统可以通过点
...
<!-- end list -->
  ...
  - 拓扑空间 *X* 中所有点 *x* 的局部基的并集是 *X*
    的[基](https://zh.wikipedia.org/wiki/基_\(拓扑学\) "wikilink")。

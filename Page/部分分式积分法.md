**部分分式积分法**，即通过将原[函数拆分为](../Page/函数.md "wikilink")[部分分式来简化](https://zh.wikipedia.org/wiki/部分分式 "wikilink")[积分步骤](../Page/积分.md "wikilink")，是计算积分时的一个常用技巧。任何[有理函数都可拆分为多个](../Page/有理数.md "wikilink")[多项式和部分分式的和](https://zh.wikipedia.org/wiki/多项式 "wikilink")，每个部分分式中的[分子次数小于](../Page/分子.md "wikilink")[分母](https://zh.wikipedia.org/wiki/分母 "wikilink")，然后根据[积分表及利用其他积分技巧](../Page/积分表.md "wikilink")，将每个部分分式积分，就得到原函数的积分。

**郵局協议**（，缩写：**POP**）是[TCP/IP协议族中的一员](https://zh.wikipedia.org/wiki/TCP/IP "wikilink")，由-{}-RFC
1939-{}-定义。此协议主要用于支持使用[客户端远程管理在](https://zh.wikipedia.org/wiki/客户端 "wikilink")[服务器上的](../Page/服务器.md "wikilink")[电子邮件](../Page/电子邮件.md "wikilink")。最新版本為**POP3**，全名“Post

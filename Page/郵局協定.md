**郵局協议**（**Post Office
Protocol**，簡稱**POP**）是[TCP/IP协议族中的一员](https://zh.wikipedia.org/wiki/TCP/IP "wikilink")，由
RFC 1939
定义。本协议主要用于支持使用[客户端远程管理在](https://zh.wikipedia.org/wiki/客户端 "wikilink")[服务器上的](../Page/服务器.md "wikilink")[电子邮件](../Page/电子邮件.md "wikilink")。最新版本為**POP3**，全名“Post
Office Protocol - Version
3”，而提供了[SSL加密的POP](https://zh.wikipedia.org/wiki/SSL "wikilink")3协议被称为**POP3S**。

POP支持[离线邮件处理](https://zh.wikipedia.org/wiki/在线和离线 "wikilink")。其具体过程是：邮件发送到服务器上，电子邮件客户端调用邮件客户机程序以连接服务器，并下载所有未阅读的电子邮件。这种离线访问模式是一种存储转发服务，将邮件从邮件服务器端送到个人[终端机器上](https://zh.wikipedia.org/wiki/终端 "wikilink")，一般是[PC机或MAC](../Page/PC.md "wikilink")。一旦邮件发送到PC机或[MAC上](https://zh.wikipedia.org/wiki/Macintosh "wikilink")，邮件服务器上的邮件将会被删除。但目前的POP3邮件服务器大都可以“只下载邮件，服务器端并不删除”，也就是改进的POP3协议。
...
## 相關
  ...
  - [IMAP（Internet Message Access
    Protocol）](https://zh.wikipedia.org/wiki/IMAP "wikilink")
  - [SMTP（Simple Mail Transfer
    Protocol）](https://zh.wikipedia.org/wiki/簡單郵件傳輸協議 "wikilink")

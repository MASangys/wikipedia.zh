**酉群**，又叫**幺正群**，是[李群的一种](../Page/李群.md "wikilink")。在[群论中](../Page/群论.md "wikilink")，\(n\)阶**酉群**（）是\(n\times n\)[酉矩阵组成的](../Page/酉矩阵.md "wikilink")[群](../Page/群.md "wikilink")，群乘法是[矩阵乘法](https://zh.wikipedia.org/wiki/矩阵乘法 "wikilink")。酉群记作\(\text{U}(n)\)，是[一般线性群](../Page/一般线性群.md "wikilink")\(\text{GL}(n, \mathbf{C})\)的一个子群。

在最简单情形\(n = 1\)，群\(\text{U}(1)\)相当于[圆群](https://zh.wikipedia.org/wiki/圆群 "wikilink")，由所有[绝对值为](../Page/绝对值.md "wikilink")1的[复数在乘法下组成的群](https://zh.wikipedia.org/wiki/复数 "wikilink")。所有酉群都包含一个这样的子群。

酉群\(\text{U}(n)\)是一个\(n^2\)维实[李群](../Page/李群.md "wikilink")。\(\text{U}(n)\)的[李代数由所有复](https://zh.wikipedia.org/wiki/李代数 "wikilink")\(n\times n\)[斜埃尔米特矩阵组成](../Page/斜埃尔米特矩阵.md "wikilink")，[李括号为](https://zh.wikipedia.org/wiki/李括号 "wikilink")[交换子](https://zh.wikipedia.org/wiki/交换子 "wikilink")。

**一般酉群**(也称为**酉相似群**）由所有复矩阵\(A\)使得
\(A^*A\)是[恒同矩阵非零复数倍](https://zh.wikipedia.org/wiki/恒同矩阵 "wikilink")，这就是酉群与恒同矩阵的正数倍的乘积。

## 性质

因为酉矩阵的[行列式是模长](../Page/行列式.md "wikilink")1复数，行列式给出了一个[群同态](https://zh.wikipedia.org/wiki/群同态 "wikilink")

\[\det\colon \mathrm{U}(n) \to \mathrm{U}(1)\]
这个同态的[核是行列式为单位的酉矩阵集合](https://zh.wikipedia.org/wiki/核_\(群论\) "wikilink")，这个子群称为**[特殊酉群](../Page/特殊酉群.md "wikilink")**，记作\(\text{SU}(n)\)。我们有李群的[短正合列](https://zh.wikipedia.org/wiki/短正合列 "wikilink")：

\[1\to\mathrm{SU}(n)\to\mathrm{U}(n)\to\mathrm{U}(1)\to 1\,\]。
这个短正合列[分裂](https://zh.wikipedia.org/wiki/裂正合 "wikilink")，故\(\text{U}(n)\)可以写成\(\text{SU}(n)\)与\(\text{U}(1)\)的[半直积](../Page/半直积.md "wikilink")。这里\(\text{U}(1)\)是\(\text{U}(n)\)中由\(\mbox{diag} (e^{i\theta},1,1,\cdots,1)\)形式的矩阵组成的子群。

酉群\(\text{U}(n)\)对\(n > 1\)是[非交换的](https://zh.wikipedia.org/wiki/非阿贝尔群 "wikilink")。\(\text{U}(n)\)的[中心是数量矩阵](https://zh.wikipedia.org/wiki/群的中心 "wikilink")\(\lambda I\)，这里\(\lambda \in \text{U}(1)\)。这由[舒尔引理得来](../Page/舒尔引理.md "wikilink")。这样中心同构于\(\text{U}(1)\)。因为\(\text{U}(n)\)的中心是一个1维阿贝尔[正规子群](../Page/正规子群.md "wikilink")，酉群不是[半单的](https://zh.wikipedia.org/wiki/半单群 "wikilink")。
...
作为一个拓扑空间，\(\text{U}(n)\)是[紧](../Page/紧空间.md "wikilink")[连通空间](../Page/连通空间.md "wikilink")。因为\(\text{U}(n)\)是\(M_n(\mathbf{C})\)的一个有界闭子集，然后[海涅-博雷尔定理可知紧性](../Page/海涅-博雷尔定理.md "wikilink")。欲证\(\text{U}(n)\)是连通的，回忆到任何酉矩阵\(A\)能被另一个酉矩阵\(S\)[对角化](https://zh.wikipedia.org/wiki/对角化 "wikilink")。任何对角酉矩阵的对角线上都是绝对值为1的复数。从而我们可以写成
...
酉群不是[单连通的](https://zh.wikipedia.org/wiki/单连通 "wikilink")；对所有\(n\)，\(\text{U}(n)\)的[基本群是无限循环群](../Page/基本群.md "wikilink")
...
在形式的层次上，这可从[埃尔米特形式分解为实部与虚部看出](https://zh.wikipedia.org/wiki/埃尔米特形式 "wikilink")：
实部是对称的（或正交），虚部是斜正交（辛）——他们由複结构联系（这便是一致性）。在一个[殆凯勒流形上](https://zh.wikipedia.org/wiki/殆凯勒流形 "wikilink")，可以将这个分解写成\(h=g + i\omega\)，这里\(h\)是埃尔米特形式，\(g\)是[黎曼度量](https://zh.wikipedia.org/wiki/黎曼度量 "wikilink")，\(i\)是[殆复结构](../Page/殆复流形.md "wikilink")，而\(\omega\)是[殆辛结构](https://zh.wikipedia.org/wiki/殆辛流形 "wikilink")。
...
用[G-结构的语言来说](../Page/G-结构.md "wikilink")，一个具有\(\mathrm{U}(n)\)-结构的流形是一个[殆埃米尔特流形](https://zh.wikipedia.org/wiki/殆埃米尔特流形 "wikilink")。

## 推广

从[李群的观点来看](../Page/李群.md "wikilink")，典型酉群是[斯坦伯格群](https://zh.wikipedia.org/wiki/斯坦伯格群_\(李理论\) "wikilink")\({}^2\!A_n\)的实形式，后者是由一般线性群的“图表自同构”（翻转[Dynkin
diagram](https://zh.wikipedia.org/wiki/:en:Dynkin_diagram "wikilink")
...
就像实数上的[对称形式](https://zh.wikipedia.org/wiki/对称形式 "wikilink")，埃尔米特形式由[符号确定](https://zh.wikipedia.org/wiki/二次型的符号 "wikilink")，所有都是[酉合同于对角线上](../Page/合同矩阵.md "wikilink")\(p\)个元素为1，\(q\)个\(-1\)的[对角矩阵](https://zh.wikipedia.org/wiki/对角矩阵 "wikilink")。非退化假设等价于
...
定义酉群的方程是一些\(k\)上的[多项式方程](https://zh.wikipedia.org/wiki/多项式 "wikilink")（但不是在\(k\)上）：对标准形式
\(\Phi=I\)，这些方程由矩阵\(A^*A=I\)给出，这里\(A^*=\overline A^t\)是[共轭转置](../Page/共轭转置.md "wikilink")。给定另外一个形式，它们是\(A^*\Phi A=\Phi\)。从而酉群一个[代数群](https://zh.wikipedia.org/wiki/代数群 "wikilink")，它在一个\(k\)-代数\(R\)上的点由
...
1.  [弗拉基米尔·阿诺尔德](https://zh.wikipedia.org/wiki/弗拉基米尔·阿诺尔德 "wikilink")《经典力学中的数学方法（*Mathematical

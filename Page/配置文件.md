在[计算机科学](../Page/计算机科学.md "wikilink")领域，是一种[计算机文件](https://zh.wikipedia.org/wiki/计算机文件 "wikilink")，可以为一些[计算机程序](../Page/计算机程序.md "wikilink")配置[参数和](https://zh.wikipedia.org/wiki/參數_\(程式設計\) "wikilink")[初始设置](../Page/初始化.md "wikilink")。

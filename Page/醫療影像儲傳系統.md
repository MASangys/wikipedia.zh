...
在[影像診斷學中](https://zh.wikipedia.org/wiki/影像診斷學 "wikilink")，**醫學影像存檔與通信系統**（，）是一種專門用來儲存、取得、傳送與展示醫療影像的電腦或網路系統，PACS一詞由博士提出。
...
由於各家醫學儀器器材供應商雖然支援[DICOM格式影像](../Page/DICOM.md "wikilink")，但是均有小部分修改，因此在PACS領域中最困難的部份為解譯[DICOM格式影像](../Page/DICOM.md "wikilink")。各家的PACS供應商所提供之PACS均必須能夠解讀不同醫學儀器器材之DICOM格式影像，也因此促生了的建立。

## 架構

標準的PACS網路架構主要包括中央伺服器，其中包括儲存醫學影像的資料庫。中央伺服器利用[廣域網路或是](https://zh.wikipedia.org/wiki/广域网 "wikilink")[區域網連結一個以上的終端機](https://zh.wikipedia.org/wiki/區域網 "wikilink")，終端機可用來提供或是使用醫學影像。而網基(Web-based)的PACS也逐漸越來越普及，這些PACS利用[Internet的相關技術](../Page/互联网.md "wikilink")，如[虛擬私人網路或](../Page/虛擬私人網路.md "wikilink")[SSL](https://zh.wikipedia.org/wiki/SSL "wikilink")，來進行影像的傳輸。
...
PACS作為不同系統間的溝通介面能夠提供一致性且穩定的資料集，其中有幾項好處：
  ...
  - 存在PACS的資料能夠以獨一無二的病患識別碼（如：美國的[社會安全號碼](../Page/社會安全號碼.md "wikilink")、NHS
    number）來儲存，以便將不同醫院間，甚至採用不同病患識別碼的的病患醫學影像系統資料做整合。
...
PACS的準則於1982年第一次由放射醫師討論，並且許多放射師一起創造了PACS一词。PACS一词第一次使用則是心血管放射醫師Andre
Duerinckx博士于1981年，并於1983年發表\[1\]。而Samuel Dwyer博士則將PACS一词的推廣歸功於Judith M.
Prewitt博士\[2\]。

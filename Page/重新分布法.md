...
method）等別稱\[1\]。以[時頻譜或](../Page/时频谱.md "wikilink")[短時距傅立葉變換而言](../Page/短時距傅立葉變換.md "wikilink")，重新分布法可藉由估算局部的[瞬時頻率以及](../Page/瞬時頻率.md "wikilink")[群延遲](https://zh.wikipedia.org/wiki/群延遲 "wikilink")，使模糊的時頻資料點重新定位並清晰化。當訊號可藉由分析視窗進行時域和頻域的分離時，這項時頻座標的重新映射是相當精準的。

## 概述

[
一把未插電的[貝斯](../Page/電貝斯.md "wikilink")（[基頻約](../Page/基本頻率.md "wikilink")73.4赫茲）在撥弦的過程中錄下、重新分布後得到的[时频谱](../Page/时频谱.md "wikilink")。從左上方數個脊狀突起的頻率分布，可觀察出這個音頻訊號在撥弦當下所產生的各個[谐波](https://zh.wikipedia.org/wiki/谐波 "wikilink")。此時頻譜是利用長度為65.7毫秒、外型參數\(\alpha\)為12的[凯泽窗計算所得](../Page/凯泽窗.md "wikilink")。](https://zh.wikipedia.org/wiki/File:Reassigned_spectrogral_surface_of_bass_pluck.png "fig: 一把未插電的貝斯（基頻約73.4赫茲）在撥弦的過程中錄下、重新分布後得到的时频谱。從左上方數個脊狀突起的頻率分布，可觀察出這個音頻訊號在撥弦當下所產生的各個谐波。此時頻譜是利用長度為65.7毫秒、外型參數\\alpha為12的凯泽窗計算所得。")
...
在音頻訊號分析中，[时频谱是最常用的](../Page/时频谱.md "wikilink")法；這可能是因為該方法長久以來為學界所熟知，且能夠避免產生不易解讀的「交叉項」（cross-terms）。不過，計算時頻譜所須使用的視窗函數使得分析結果必須在時域或頻域的解析度中做一取捨，也就是時頻譜在時域及頻域的解析度必定至少有其中一者不理想。這項時頻表示的重新分布法便是透過先把資料映射至較接近原始訊號之真實[支撑區域的座標](../Page/支撑集.md "wikilink")，以將時頻譜或其它時頻表示下較模糊的資料點重新定位並聚焦。
...
相對於時頻譜，[維格納–魏爾分布則是另一種解析度較高的時頻表示法](../Page/維格納準概率分佈.md "wikilink")；本質上，維格納–魏爾分布的做法與短時距傅立葉變換類似，惟其選擇的視窗函數與訊號之間有完好的對應。維格納–魏爾分布在時域和頻域中皆可得到高解析度，但它同時也具有高度的[非線性和非局部性等特質](../Page/非線性系統.md "wikilink")，因此對[雜訊相當敏感且容易產生覆蓋訊號本身的交叉項](../Page/雜訊.md "wikilink")，使得含有多成分的訊號分析後的資訊難以解讀。

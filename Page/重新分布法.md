**重新分布法**（）是一種銳化[訊號之](https://zh.wikipedia.org/wiki/訊號_\(資訊理論\) "wikilink")[時頻表示的方法](../Page/時頻分析.md "wikilink")，藉由將資料映射至較靠近原始訊號之真實[支撐區域的時頻座標來實現](../Page/支撑集.md "wikilink")。此方法曾被不同學者獨立提出，並有**重映射**（remapping）、**時頻重新分布**（time-frequency
reassignment）以及**修正滑動視窗法**（modified moving-window
method）等別稱\[1\]。以[時頻譜或](https://zh.wikipedia.org/wiki/时频谱 "wikilink")[短時距傅立葉變換而言](../Page/短時距傅立葉變換.md "wikilink")，重新分布法可藉由估算局部的[瞬時頻率以及](../Page/瞬時頻率.md "wikilink")[群延遲](https://zh.wikipedia.org/wiki/群延遲 "wikilink")，使模糊的時頻資料點重新定位並清晰化。當訊號可藉由分析視窗進行時域和頻域的分離時，這項時頻座標的重新映射是相當精準的。

## 概述

[
一把未插電的[貝斯](../Page/電貝斯.md "wikilink")（[基頻約](../Page/基本頻率.md "wikilink")73.4赫茲）在撥弦的過程中錄下、重新分布後得到的[时频谱](https://zh.wikipedia.org/wiki/时频谱 "wikilink")。從左上方數個脊狀突起的頻率分布，可觀察出這個音頻訊號在撥弦當下所產生的各個[谐波](https://zh.wikipedia.org/wiki/谐波 "wikilink")。此時頻譜是利用長度為65.7毫秒、外型參數\(\alpha\)為12的[凯泽窗計算所得](https://zh.wikipedia.org/wiki/凯泽窗 "wikilink")。](https://zh.wikipedia.org/wiki/File:Reassigned_spectrogral_surface_of_bass_pluck.png "fig: 一把未插電的貝斯（基頻約73.4赫茲）在撥弦的過程中錄下、重新分布後得到的时频谱。從左上方數個脊狀突起的頻率分布，可觀察出這個音頻訊號在撥弦當下所產生的各個谐波。此時頻譜是利用長度為65.7毫秒、外型參數\\alpha為12的凯泽窗計算所得。")

許多[信号的能量分布都具有隨著時間和頻率變化的特性](../Page/信号_\(信息论\).md "wikilink")。舉例而言，任何有起始或者结束的音頻訊號之能量分布都將隨著時間改變，而大多數聲音的能量不論在時間上還是頻率上都有相當大的變化；[時頻分析便經常用於尋找此類訊號的特徵](../Page/時頻分析.md "wikilink")，這種分析法將原為[一維的時域訊號轉換為](https://zh.wikipedia.org/wiki/一维空间 "wikilink")[二維的時域](../Page/二维空间.md "wikilink")–頻域函數。而經分析轉換後的結果便稱為，它可以用於描述一個訊號隨時間的頻譜能量分布變化，就像樂譜描述樂曲中高低音隨時間的變化一样。

在音頻訊號分析中，[时频谱是最常用的](https://zh.wikipedia.org/wiki/时频谱 "wikilink")法；這可能是因為該方法長久以來為學界所熟知，且能夠避免產生不易解讀的「交叉項」（cross-terms）。不過，計算時頻譜所須使用的視窗函數使得分析結果必須在時域或頻域的解析度中做一取捨，也就是時頻譜在時域及頻域的解析度必定至少有其中一者不理想。這項時頻表示的重新分布法便是透過先把資料映射至較接近原始訊號之真實[支撑區域的座標](../Page/支撑集.md "wikilink")，以將時頻譜或其它時頻表示下較模糊的資料點重新定位並聚焦。

## 時頻譜

時頻譜為最為人所熟知的時頻表示法之一，其定義為[短時距傅立葉變換值的平方](../Page/短時距傅立葉變換.md "wikilink")：

\(SP_x(t,f)=|X(t,f)|^2=\left|\int_{-\infty}^{\infty} w(t-\tau)x(\tau)e^{-j2\pi f \tau}d\tau\right|^2.\)

雖然短時距的[相位頻譜確實含有與訊號相關的重要時態資訊](https://zh.wikipedia.org/wiki/相位 "wikilink")，但這些資訊通常難以解讀，故一般而言在短時距頻譜分析中只考慮其短時距[強度頻譜](https://zh.wikipedia.org/wiki/量_\(数学\) "wikilink")。以時頻表示法而言，時頻譜具有相對較差的解析度。它在時域與頻域的解析度取決於分析時所選擇的視窗函數，且其中一者愈清晰將導致另一者愈模糊。

相對於時頻譜，[維格納–魏爾分布則是另一種解析度較高的時頻表示法](../Page/維格納準概率分佈.md "wikilink")；本質上，維格納–魏爾分布的做法與短時距傅立葉變換類似，惟其選擇的視窗函數與訊號之間有完好的對應。維格納–魏爾分布在時域和頻域中皆可得到高解析度，但它同時也具有高度的[非線性和非局部性等特質](https://zh.wikipedia.org/wiki/非線性系統 "wikilink")，因此對[雜訊相當敏感且容易產生覆蓋訊號本身的交叉項](../Page/雜訊.md "wikilink")，使得含有多成分的訊號分析後的資訊難以解讀。

利用[雙線性轉換得到時頻表示的](../Page/雙線性轉換.md "wikilink")[科恩系列分布函數則可視為](https://zh.wikipedia.org/wiki/科恩系列分布 "wikilink")「平滑化」的維格納–魏爾分布。它藉由一平滑[核降低分布對於雜訊的敏感度](../Page/积分变换.md "wikilink")，並抑制交叉項的產生，但此舉將使時域和頻域的分布模糊化；這不僅會降低頻譜的解析度，同時也可能使原始維格納準機率分布中實際上沒有能量的區域得到非零的能量值。
...
重新分布法首先由小寺邦彥（Kunihiko Kodera）、羅傑·干德林（Roger Gendrin）和克勞地·德·凡德瑞（Claude de
Villedary）三人提出，並命名為「**修正滑動視窗法**」（Modified Moving-Window
Method）\[4\]。他們的方法為每個資料點指定一組新的時頻座標，使其更佳反映原始訊號的能量分布，進而改善了標準滑動視窗法（等同於時頻譜）的時頻解析度。
...
當一個訊號的強度頻譜為\(M(t,\omega)\)，且其時間上較相位上的變化來得慢時，上述重建式中積分值最主要的貢獻來源即滿足下列穩相條件（phase
stationarity condition）的\(t,\omega\)及其鄰近區域：
...
然而，偏微分的值可以利用[有限差分法來估計](../Page/有限差分法.md "wikilink")。舉例而言，在相位頻譜上兩個鄰近的時間點（\(t+\Delta t/ 2\)、\(t-\Delta t/ 2\)）取值、並將兩值相減後除以時間差\(\Delta t\)，便可得到該處頻譜於時域的偏微分估計值（頻域亦同理）：
...
道格拉斯·尼爾森（Douglas
Nelson）也曾獨立於小寺邦彥等人，開發了利用短時距相位頻譜的偏微分來改善時頻譜之解析度的類似方法\[5\]。稍加推導便可容易地證明他提出的「跨頻譜平面」（cross-spectral
surface）所計算之偏微分近似值和前述的有限差分法無異。

弗朗索瓦·俄歇（François Auger）及派翠克·弗朗德蘭（Patrick
Flandrin）則指出，小寺邦彥等人所提出的時頻譜重新分布法可透過下述的一般化，延用於任一[科恩系列的時頻表示法](../Page/科恩系列分佈.md "wikilink")：
...
[Long-window_reassigned_spectrogram_of_speech.png](https://zh.wikipedia.org/wiki/File:Long-window_reassigned_spectrogram_of_speech.png "fig:Long-window_reassigned_spectrogram_of_speech.png")
[Short-window_reassigned_spectrogram_of_speech.png](https://zh.wikipedia.org/wiki/File:Short-window_reassigned_spectrogram_of_speech.png "fig:Short-window_reassigned_spectrogram_of_speech.png")
...
若某特定的短時距頻譜分析視窗可用於拆解訊號中不同頻率的成分，則每個濾波器經短時距傅立葉變換後的脈衝響應便是（至多一項）單一主要訊號成分（即能量最大）經濾波後的結果，故\(X(t,\omega_0)\)之相位值對時間的偏微分值，即相等於頻率\(\omega_0\)下主要成分之相位值對時間的偏微分值。因此，若某瞬時頻率為\(\omega_{n}(t)\)的訊號成分\(x_n(t)\)
在\(\omega_0\)附近為主要成分時，則該成分的瞬時頻率可透過原始訊號經短時距傅立葉變換後位於\(\omega_0\)的相位值求得，即：
...
## 延伸閱讀
  ...
  - S. A. Fulop and K. Fitz, *A spectrogram for the twenty-first
    century*, Acoustics Today, vol. 2, no. 3, pp. 26–33, 2006.
  - S. A. Fulop and K. Fitz, *Algorithms for computing the
    time-corrected instantaneous frequency (reassigned) spectrogram,
    with applications*, Journal of the Acoustical Society of America,
    vol. 119, pp. 360 – 371, Jan 2006.

## 外部連結

  - [TFTB — Time-Frequency ToolBox](http://tftb.nongnu.org/)
  - [SPEAR - Sinusoidal Partial Editing Analysis and
    Resynthesis](http://www.klingbeil.com/spear/)
  - [Loris - Open-source software for sound modeling and
    morphing](http://www.cerlsoundgroup.org/Loris/)
  - [SRA - A web-based research tool for spectral and roughness analysis
    of sound
    signals](http://musicalgorithms.ewu.edu/algorithms/roughness.html)
  - [Sparse time-frequency representations -
    PNAS](http://pnas.org/content/103/16/6094.long)
...
3.  P. Flandrin, F. Auger, and E. Chassande-Mottin, *Time-frequency
    reassignment: From principles to algorithms*, in Applications in
    Time-Frequency Signal Processing (A. Papandreou-Suppappola, ed.),
    ch. 5, pp. 179 – 203, CRC Press, 2003.

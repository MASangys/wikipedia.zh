...
具有[量子特性的系統](../Page/量子.md "wikilink")（通常為[雙態系統](../Page/雙態系統.md "wikilink")，如自旋1/2粒子），選定兩個相互[正交的](../Page/正交.md "wikilink")[本徵態](https://zh.wikipedia.org/wiki/本徵態 "wikilink")，分別以\(|0 \rangle\)（採[狄拉克標記右括向量表示](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")）和\(|1 \rangle\)代表。當對此系統做[投影式量子測量時](../Page/量子測量.md "wikilink")，會得到的結果必為這兩個本徵態之一，以特定機率比例出現。此外，這兩個本徵態可以[複數係數做](https://zh.wikipedia.org/wiki/複數 "wikilink")[線性疊加得到諸多新的量子態](https://zh.wikipedia.org/wiki/態疊加原理 "wikilink")
...
若設定\(|0 \rangle\)、\(|1 \rangle\)順沿[直角坐標系的z方向](https://zh.wikipedia.org/wiki/直角坐標系 "wikilink")，則有諸多表示法。可採上述[向量形式如](../Page/向量.md "wikilink")[狄拉克標記的右括向量](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")，亦可將之表為行矩陣；另外有[密度矩陣形式](../Page/密度矩陣.md "wikilink")，可表為右括向量乘以左括向量，或表為[方块矩阵](../Page/方块矩阵.md "wikilink")，可見如下：
...
**量子三元**（qutrit）是量子位元的推廣，有些應用採取之。量子三元以[狄拉克標記右括向量表示可寫為](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")\(|0 \rangle\)、\(|1 \rangle\)、\(|2 \rangle\)。一個[自旋為](../Page/自旋.md "wikilink")1的粒子，其自旋自由度有三，所對應的[本徵值為](https://zh.wikipedia.org/wiki/本徵值 "wikilink")+1,
0, -1，此粒子即可用作量子三元。

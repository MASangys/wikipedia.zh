**量子密鑰分發**（）是利用[量子力学](../Page/量子力学.md "wikilink")特性实现[密码协议的](https://zh.wikipedia.org/wiki/密码协议 "wikilink")方法。它使通信的双方能够产生并分享一个随机的、安全的[密钥](../Page/密钥.md "wikilink")，来加密和解密[訊息](https://zh.wikipedia.org/wiki/訊息 "wikilink")。它常常被误称为[量子密碼學](../Page/量子密碼學.md "wikilink")，因为它是[量子密碼學](../Page/量子密碼學.md "wikilink")任务中最著名的例子。
...
[量子通訊中](https://zh.wikipedia.org/wiki/量子通訊 "wikilink")，訊息编码为量子态，或称[量子比特](../Page/量子位元.md "wikilink")，与此相对，经典通信中，訊息编码为[比特](https://zh.wikipedia.org/wiki/位 "wikilink")。通常，[光子](../Page/光子.md "wikilink")被用来制备量子态。[量子密码学利用量子态的特性来确保安全性](https://zh.wikipedia.org/wiki/量子密码学 "wikilink")。量子密钥分发有不同的实现方法，但根据所利用量子态特性的不同，可以分为两大类。
  ...
  - 基于製備和测量的协议 :
    与[经典物理不同](https://zh.wikipedia.org/wiki/经典物理 "wikilink")，测量是量子力学不可分割的组成部分。一般来讲，测量一个未知的量子态会以某种形式改变该量子的状态。这被称为量子的不确定性，它的一些基本结论有[维尔纳·海森堡](../Page/维尔纳·海森堡.md "wikilink")的[不确定性原理](../Page/不确定性原理.md "wikilink")，[信息干扰理论和](https://zh.wikipedia.org/wiki/信息干扰理论 "wikilink")[不可克隆原理](../Page/不可克隆原理.md "wikilink")。这些性质可以被利用来检测通訊过程中的任何窃听（窃听必然需要测量），更重要的是，能够计算被截获訊息的数量。

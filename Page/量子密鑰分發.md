...
[查理斯·貝內特](https://zh.wikipedia.org/wiki/查理斯·貝內特 "wikilink")（Charles Bennett）與[吉勒·布拉薩](https://zh.wikipedia.org/wiki/吉勒·布拉薩 "wikilink")（Gilles Brassard）於1984年发表的论文中提到的量子密码分发协议，后来被称为[BB84协议](https://zh.wikipedia.org/wiki/BB84协议 "wikilink")\[2\]。其实任意两组[共轭状态都可以用于该协议](https://zh.wikipedia.org/wiki/共轭物理量 "wikilink")，而且大多数BB84的基于[光纤的实现都使用相位编码状态](https://zh.wikipedia.org/wiki/光纤 "wikilink")。BB84协议是最早描述如何利用光子的[偏振态来传输訊息的](https://zh.wikipedia.org/wiki/极化 "wikilink")。发送者（通常称为Alice）和接收者（通常称为Bob）用量子信道来传输量子态。如果用光子作为量子态载体，对应的量子信道可以是光纤或者简单的[自由空间](https://zh.wikipedia.org/wiki/真空 "wikilink")。另外他们还需要一条公共经典信道，比如无线电或因特网。公共信道的安全性不需考虑，BB84协议在设计时已考虑到了两种信道都被第三方（通常称为Eve）[窃听的可能](https://zh.wikipedia.org/wiki/窃听 "wikilink")。

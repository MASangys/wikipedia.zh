**量子密鑰分發**（）是利用[量子力学特性实现](../Page/量子力学.md "wikilink")[密码协议的](https://zh.wikipedia.org/wiki/密码协议 "wikilink")方法。它使通信的双方能够产生并分享一个随机的、安全的[密钥](../Page/密钥.md "wikilink")，来加密和解密[訊息](https://zh.wikipedia.org/wiki/訊息 "wikilink")。它常常被误称为[量子密碼學](../Page/量子密碼學.md "wikilink")，因为它是[量子密碼學任务中最著名的例子](../Page/量子密碼學.md "wikilink")。

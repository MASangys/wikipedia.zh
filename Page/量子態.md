[Stern-Gerlach_experiment_zh.png](https://zh.wikipedia.org/wiki/File:Stern-Gerlach_experiment_zh.png "fig:Stern-Gerlach_experiment_zh.png")儀器的磁場方向為z-軸，入射的銀原子束可以被分裂成兩道銀原子束，每一道銀原子束代表一種量子態，上旋\(|\uparrow\rangle\)或下旋\(|\downarrow\rangle\)。\[1\]\]\]
在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，**量子態**（）指的是量子系統的狀態。[態向量可以用來抽象地表示量子態](../Page/態向量.md "wikilink")。\[2\]採用[狄拉克標記](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")，態向量表示為[右矢](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")\(|\psi\rangle\)；其中，在符號內部的希臘字母\(\psi\)可以是任何符號，字母，數字，或單字。例如，在計算[氫原子](../Page/氫原子.md "wikilink")[能譜時](../Page/發射光譜.md "wikilink")，能級與[主量子數](../Page/主量子數.md "wikilink")\(n\)有關，所以，每個量子態的態向量可以表示為\(|n \rangle\)。

一般而言，量子態可以是[純態或](../Page/純態.md "wikilink")[混合態](https://zh.wikipedia.org/wiki/混合態 "wikilink")。上述案例是純態。混合態是由很多純態組成的機率混合。不同的組合可能會組成同樣的混合態。當量子態是混合態時，可以用[密度矩陣做數學描述](../Page/密度矩陣.md "wikilink")，這密度矩陣實際給出的是[機率](https://zh.wikipedia.org/wiki/機率 "wikilink")，不是[密度](../Page/密度.md "wikilink")。純態也可以用密度矩陣表示。
...
在測量一個量子系統之前，量子理論通常只給出測量結果的機率分佈，這機率分佈的形式完全由量子態、相關的[可觀察量來決定](../Page/可觀察量.md "wikilink")。對於純態或混合態，都可以從密度矩陣計算出這機率分佈。
...
實驗的過程可以按照先後順序細分為製備與測量兩個步驟。在[統計實驗](https://zh.wikipedia.org/wiki/統計實驗 "wikilink")（statistical
experiment）裏，雖然以同樣的方法製備多個物理系統，然後以同樣的方法進行測量，仍舊不能可靠地獲得出同樣的結果，但是，假若經過很多次重複地製備與測量，則會發覺，同樣結果的出現頻率會收斂至某固定值。量子力學也具有類似特性，雖然每一次測量能夠很準確地獲得粒子運動地數據，但不能準確預測對於可觀察量做單次測量而獲得的結果，只能夠給出各種可能獲得的結果與獲得這結果的機率分佈，這是因為製備步驟必須遵守[不確定性原理](https://zh.wikipedia.org/wiki/不確定性原理 "wikilink")。\[7\]
...
在量子力學裏，數學運算時常用到[線性算符](https://zh.wikipedia.org/wiki/線性算符 "wikilink")、[內積](https://zh.wikipedia.org/wiki/內積 "wikilink")、[對偶空間與](https://zh.wikipedia.org/wiki/對偶空間 "wikilink")[厄米共軛等概念](https://zh.wikipedia.org/wiki/厄米共軛 "wikilink")。為了讓運算更加簡易、更加抽象，為了讓使用者不需要選擇表現空間，[保羅·狄拉克發明了](https://zh.wikipedia.org/wiki/保羅·狄拉克 "wikilink")[狄拉克標記](https://zh.wikipedia.org/wiki/狄拉克標記 "wikilink")。這種標記法能夠精準地表示各種各樣的量子態與其相關運算，簡略表述如下：
  ...
  - 左矢\(\lang\phi|\)與右矢\(|\psi\rangle\)的內積，可以寫為\(\lang \phi|\psi\rang\)。這內積的物理意義為在量子態\(|\phi\rangle\)裏找到量子態\(|\psi\rangle\)的[機率幅](../Page/機率幅.md "wikilink")。\[10\]
...
其中，\(c_i=\lang e_i |\psi \rang\)是複係數，是在量子態\(|e_i\rang\)裏找到量子態\(|\psi\rangle\)的[機率幅](../Page/機率幅.md "wikilink")。\[13\]
...
其中，\(c_i=\lang e_i |\psi \rang\)是複係數，是在量子態\(|e_i\rang\)裏找到量子態\(|\psi\rangle\)的[機率幅](../Page/機率幅.md "wikilink")。\[15\]
...
定義[投影算符](../Page/投影.md "wikilink")\(\hat{\Lambda}_i\)為
...
內積\(\lang x|\psi\rang\)就是[波動力學的](../Page/波動力學.md "wikilink")[波函數](https://zh.wikipedia.org/wiki/波函數 "wikilink")\(\psi(x)\)：

\[\psi(x)\ \stackrel{def}{=}\ \lang x|\psi\rang\]。

### 態疊加原理

[Ebohr1_IP.svg](https://zh.wikipedia.org/wiki/File:Ebohr1_IP.svg "fig:Ebohr1_IP.svg")，照射在一座有兩條狹縫\(b\)與\(c\)的不透明擋牆\(S2\)。在擋牆的後面，設立了一個照相底片或某種偵測屏障\(F\)，用來紀錄到達\(F\)的任何位置\(d\)的[光波數據](https://zh.wikipedia.org/wiki/光波 "wikilink")。最右邊黑白相間的條紋，顯示出光波在偵測屏障\(F\)的干涉圖樣\]\]
假設某量子系統的量子態可能是\(|\alpha\rangle\)或\(|\beta\rangle\)這兩個不同的歸一化量子態，則這量子系統也可能處於它們線性疊加而成的量子態\(c_\alpha|\alpha\rang+c_\beta|\beta\rang\)（可能尚未歸一化）。假設\(\theta\)為實數，則雖然量子態\(e^{i\theta}|\beta\rang\)與\(|\beta\rang\)對應於同樣的量子態，他們並無法互相替換。例如，\(|\alpha\rang+|\beta\rang\)和\(|\alpha\rang+e^{i\theta}|\beta\rang\)是兩個不同的量子態。但是，\(|\alpha\rang+|\beta\rang\)和\(e^{i\theta}(|\alpha\rang+|\beta\rang)\)對應於同一個量子態。因此可以這樣說，整體的[相位因子並不具有物理意義](../Page/相位因子.md "wikilink")，但相對的相位因子具有重要的物理意義。

例如，在[雙縫實驗裏](../Page/雙縫實驗.md "wikilink")，[光子的量子態是兩個不同量子態的疊加](../Page/光子.md "wikilink")。其中一個量子態是通過狹縫\(b\)。另外一個量子態是通過狹縫\(c\)。光子抵達偵測屏障的位置\(d\)，這位置離開兩條狹縫的距離之差值\(bd-cd\)，與兩個量子態的相對相位有關。由於這相對相位，在偵測屏障的某些位置，會造成相长[干涉](https://zh.wikipedia.org/wiki/干涉 "wikilink")，在另外一些位置，會造成相消干涉。

...
2.  一個厄米矩陣可以么正式地[對角化](../Page/對角矩陣.md "wikilink")（*參見[譜定理](https://zh.wikipedia.org/wiki/譜定理 "wikilink")（Spectral
    theorem）*），產生了本徵向量的一組[正交歸一基](https://zh.wikipedia.org/wiki/正交歸一性 "wikilink")，可以架構出系統的態空間。一般來說，系統的狀態可以寫為任何厄米算符的[線性組合](https://zh.wikipedia.org/wiki/線性組合 "wikilink")。如此在物理上的意義即為任何狀態可以表示為一可觀測量其本徵態的疊加。
...
在[量子去相干於二十世紀末出現之前](https://zh.wikipedia.org/wiki/量子去相干 "wikilink")，量子力學及[哥本哈根詮釋一直存在一個重大的觀念性問題](../Page/哥本哈根詮釋.md "wikilink")。那就是沒有一個明確的準則來判別怎樣的物理交互作用屬於「測量」並且會造成波函數崩潰。[薛丁格的貓即是最好的例子](https://zh.wikipedia.org/wiki/薛丁格的貓 "wikilink")。現在，對於[弱測量的了解以及什麼程度的交互作用或測量足以摧毀量子相干性有了定量的分析](https://zh.wikipedia.org/wiki/弱測量 "wikilink")，因此在量子去相干理論的架構下，一些問題已經可以被理解。但對於構成測量的一些面向，物理學家仍然沒有一致的認同。

### 測量是否真的決定狀態？

測量是否決定一個狀態在不同的量子詮釋下有不同的答案。(這也與對波函數崩潰的理解有很大的關聯。)舉例來說，在[哥本哈根詮釋大多數的版本中](../Page/哥本哈根詮釋.md "wikilink")，測量會決定一個系統的狀態，並且在測量後系統的態一定是測量中得到的。但根據[多世界詮釋](https://zh.wikipedia.org/wiki/多世界詮釋 "wikilink")，測量在不同的世界有不同的結果，所以測量後其他的可能狀態仍然存於不同的世界中。
...
定域性原理要求任何資訊皆不能以超越[光速的速度傳遞](../Page/光速.md "wikilink")(詳見[狹義相對論](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink"))。實驗上我們知道，如果量子力學是決定性的(藉由[隱變數理論](https://zh.wikipedia.org/wiki/隱變數理論 "wikilink"))，那麼它必須是非定域性的，因此違反定域性原理(詳見[貝爾定理](https://zh.wikipedia.org/wiki/貝爾定理 "wikilink")、[EPR佯謬](https://zh.wikipedia.org/wiki/EPR佯謬 "wikilink"))。然而，物理學家對於量子力學是非決定性、非定域性或著兩者皆是，仍然沒有定論。\[3\]

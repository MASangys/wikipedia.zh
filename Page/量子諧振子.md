...
最先六個解（*n* =
0到5）展示在右圖。函數\(H_n\)為[埃爾米特多項式](https://zh.wikipedia.org/wiki/埃爾米特多項式 "wikilink")：
...
0）不為零，而是\(\hbar\omega/2\)，被稱為「基態能量」或[零點能量](../Page/零點能量.md "wikilink")。在基態中，根據量子力學，一振子執行所謂的「[零振動](https://zh.wikipedia.org/wiki/零振動 "wikilink")」（null
oscillations）且其平均動能是正值。這樣的現象意義重大但並不那麼顯而易見，因為通常能量的零點並非一個有意義的物理量，因為可以任意選擇；有意義的是能量差。雖然如此，基態能量有許多的意涵，特別是在[量子重力](https://zh.wikipedia.org/wiki/量子重力 "wikilink")。最後一個理由式能階值是等距的，不像[波耳模型或](https://zh.wikipedia.org/wiki/波耳模型 "wikilink")[盒中粒子問題那樣](https://zh.wikipedia.org/wiki/盒中粒子 "wikilink")。

注意到基態的機率密度集中在原點。這表示粒子多數時間處在勢阱的底部，合乎對於一幾乎不帶能量之狀態的預期。當能量增加時，機率密度變成集中在「古典轉向點」（classical
turning
points），其中狀態能量等同於勢能。這樣的結果與古典諧振子相一致；古典的描述下，粒子多數時間處在（而更有機會被發現在）轉向點，因為在此處粒子速度最慢。因此滿足[對應原理](https://zh.wikipedia.org/wiki/對應原理 "wikilink")。

### 階梯算符方法

前述的冪級數解雖然直觀，但顯得相當繁複。[階梯算符方法起自](../Page/階梯算符.md "wikilink")[保羅·狄拉克](https://zh.wikipedia.org/wiki/保羅·狄拉克 "wikilink")，允許抽像求得能量本徵值，而不用直接解微分方程式。此外，此法很容易推廣到更複雜的問題，尤其是在[量子場論中](https://zh.wikipedia.org/wiki/量子場論 "wikilink")。跟從此方法，定義算符*a*與其[伴隨算符](https://zh.wikipedia.org/wiki/伴隨算符 "wikilink")（adjoint）*a*<sup>†</sup>：
...
\(E - \hbar \omega\)的本徵態，而*a*<sup>†</sup>作用在能量為*E*的本徵態，產生出另一個能量為\(E + \hbar \omega\)的本徵態。因為這樣，*a*稱作[降算符而](https://zh.wikipedia.org/wiki/降算符 "wikilink")*a*<sup>†</sup>稱作[升算符](https://zh.wikipedia.org/wiki/升算符 "wikilink")。兩者合稱[階梯算符](../Page/階梯算符.md "wikilink")。在[量子場論中](https://zh.wikipedia.org/wiki/量子場論 "wikilink")，*a*與*a*<sup>†</sup>也分別稱作[消滅算符與](https://zh.wikipedia.org/wiki/消滅算符 "wikilink")[創生算符](https://zh.wikipedia.org/wiki/創生算符 "wikilink")，以其分別摧毀與創造粒子——對應於能量量子。
...
一維諧振子很容易地推廣到\(N\)維。在一維中，粒子的位置是由單一[座標](https://zh.wikipedia.org/wiki/座標 "wikilink")*x*來指定的。在\(N\)維中，這由\(N\)個位置座標所取代，以\(x_1,\,x_2,\,\dots,\,x_N\)標示。對應每個位置座標有個[動量](https://zh.wikipedia.org/wiki/動量 "wikilink")，標示為*p*<sub>1</sub>,
...,
*p*<sub>*N*</sub>。這些算符之間的[正則對易關係為](https://zh.wikipedia.org/wiki/正則對易關係 "wikilink")
...
\[{L_k}^{(l+{1\over 2})}(2\nu r^2)\]是\(k\)階[广义拉盖尔多项式](https://zh.wikipedia.org/wiki/拉盖尔多项式#广义拉盖尔多项式 "wikilink")
()，\(k\)是個正整數，

...
不同於[电子计算机](../Page/电子计算机.md "wikilink")（或稱傳統電腦），量子計算用來存儲數據的對象是[量子位元](../Page/量子位元.md "wikilink")，它使用量子演算法來進行數據操作。
...
2018年6月，英特爾宣布開發出新款量子晶片，使用五十纳米的量子位元做運算，並已在接近攝氏零下273度的[絕對零度中進行測試](https://zh.wikipedia.org/wiki/絕對零度 "wikilink")。\[24\]

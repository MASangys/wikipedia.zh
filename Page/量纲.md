...
[Dimension_example_2.png](https://zh.wikipedia.org/wiki/File:Dimension_example_2.png "fig:Dimension_example_2.png") 设在水平面上有一质量为\(m\)的物体，受一水平力\(F\)的作用加速滑动，加速度为\(a\)，物体与水平面之间的滑动摩擦因数为\(\mu\)，重力加速度大小为\(g\)。则根据[牛顿力学知识](https://zh.wikipedia.org/wiki/牛顿力学 "wikilink")，可以写出以下关系式：
...
如，在推导[牛顿与](https://zh.wikipedia.org/wiki/牛顿_\(单位\) "wikilink")[达因](../Page/达因.md "wikilink")之间的换算关系时，我们已知\(\dim F = \mathrm{LMT^{-2}}\)，又知道牛顿使用[国际单位制](../Page/国际单位制.md "wikilink")（千克米秒制），达因使用[厘米克秒制](https://zh.wikipedia.org/wiki/厘米克秒制 "wikilink")，1m=100cm，1kg=1000g,于是

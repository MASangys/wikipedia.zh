**金兹堡-朗道方程**，或**金兹堡-朗道理论**，是由[维塔利·金兹堡和](../Page/维塔利·金兹堡.md "wikilink")[列夫·朗道在](../Page/列夫·朗道.md "wikilink")1950年提出的一个描述[超导现象的理论](../Page/超导.md "wikilink")\[1\]。早期的金兹堡-朗道方程只是一个[唯象的数学模型](../Page/唯象理论.md "wikilink")，从宏观的角度描述了[第一类超导体](../Page/第一类超导体.md "wikilink")。1957年，苏联物理学家[阿列克谢·阿布里科索夫基于金兹堡](../Page/阿列克谢·阿布里科索夫.md "wikilink")-朗道理论提出了[第二类超导体的概念](../Page/第二类超导体.md "wikilink")\[2\]。1959年，结合[BCS理论](../Page/BCS理论.md "wikilink")，从微观角度严格证明了金兹堡-朗道理论是BCS理论的一种极限情况\[3\]。为了表彰金兹堡和阿布里科索夫对超导理论的贡献，他们与研究[超流理论的](../Page/超流.md "wikilink")[安东尼·莱格特共同获得了](../Page/安东尼·莱格特.md "wikilink")2003年的[诺贝尔物理学奖](../Page/诺贝尔物理学奖.md "wikilink")。

## 理论

金兹堡－朗道方程是由金兹堡和朗道在朗道的[二级相变理论的基础上提出的](../Page/二级相变.md "wikilink")\[4\]。他们断言超导态可以通过一个[复](../Page/複數.md "wikilink")[序参量](../Page/序参量.md "wikilink")（complex
order parameter）ψ(**r**)
来表征。这个形似[波函数的序参量测量的是超导体在低于超导转变温度T](../Page/波函数.md "wikilink")<sub>c</sub>时的超导有序度（"degree
of superconducting
order"），在BCS理论的框架中可以视为描述[库柏对质量中心位置的单粒子波函数](../Page/库柏对.md "wikilink")\[5\]。在临界相变点附近，超导体的[自由能密度](../Page/自由能.md "wikilink")
\(f\) 可被展开为如下形式：
...
\(f_{n0} + \frac{h^2}{8\pi}\)。\(m^*\)表示[有效质量](../Page/有效质量.md "wikilink")，\(e^*\)表示有效[电荷](../Page/电荷.md "wikilink")，**A**
是[磁矢势](../Page/磁矢势.md "wikilink")，\(H\)为[磁场强度](../Page/磁場#B場與H場.md "wikilink")。在后续的实验中，人们发现
...
第二个叫做**穿透深度***λ*。这个概念最初是由伦敦兄弟在他们的[伦敦理论中提出的](../Page/伦敦方程.md "wikilink")。如果使用金兹堡-朗道模型中的参数来表示，穿透深度可以写作：
...
现今被称为**金兹堡-朗道参数**。朗道提出，[第一类超导体应满足](../Page/第一类超导体.md "wikilink")
...
## 相关条目
  ...
  -
  - [磁畴](../Page/磁畴.md "wikilink")

  -
  -
  - [磁通量量子](../Page/磁通量量子.md "wikilink")

  -
  - [Gross-Pitaevskii方程](../Page/Gross-Pitaevskii方程.md "wikilink")

  - [反应-扩散系统](../Page/反应-扩散系统.md "wikilink")

  - [塞伯格-维腾理论](../Page/塞伯格-维腾理论.md "wikilink")

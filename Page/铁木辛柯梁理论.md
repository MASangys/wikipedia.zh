...
切变系数由[泊松比确定](https://zh.wikipedia.org/wiki/泊松比 "wikilink")。更严格的表达方法由多位科学家完成，包括[斯蒂芬·铁木辛柯](https://zh.wikipedia.org/wiki/斯蒂芬·铁木辛柯 "wikilink")、雷蒙德·明德林（Raymond D. Mindlin）、考珀（G. R. Cowper）和约翰·哈钦森（John W. Hutchinson）等。工程实践中，斯蒂芬·铁木辛柯的表达一般状况下足够好。\[6\]

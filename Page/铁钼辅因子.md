> 本文内容由[铁钼辅因子](https://zh.wikipedia.org/wiki/铁钼辅因子)转换而来。


[右](https://zh.wikipedia.org/wiki/File:FeMoco_cluster.svg "fig:右") **FeMo**辅因子（FeMoco）是[固氮酶](../Page/固氮酶.md "wikilink")中核心的辅因子。 固氮酶是通过固氮过程催化将大气氮气转化为氨(NH3)的酶。 其中含有金属的辅因子及所谓的铁幕辅因子。 它的化学式为Fe<sub>7</sub>MoS<sub>9</sub>C。
...
从电子顺磁共振结果可以发现铁钼辅因子的静态有着s=3/2的自旋态。 通过单电子还原铁钼辅因子显示出电子顺磁共振沉默。深入挖掘电子在蛋白质中的转移过程、可以得到一个更精确的飞秒级辅因子的动力学模型。DFT计算结果显示了其氧化态为Mo<sup>IV</sup>-2Fe<sup>II</sup>-5Fe<sup>III</sup>-C<sup>4−</sup>-H<sup>+</sup>, 但到目前为止还没有实验性的数据可以证实其确切的氧化态.\[1\]
...
[Category:簇合物化学](https://zh.wikipedia.org/wiki/Category:簇合物化学 "wikilink") [Category:铁-硫蛋白](https://zh.wikipedia.org/wiki/Category:铁-硫蛋白 "wikilink") [Category:鐵化合物](https://zh.wikipedia.org/wiki/Category:鐵化合物 "wikilink") [Category:金属蛋白](https://zh.wikipedia.org/wiki/Category:金属蛋白 "wikilink") [Category:硫化合物](https://zh.wikipedia.org/wiki/Category:硫化合物 "wikilink")

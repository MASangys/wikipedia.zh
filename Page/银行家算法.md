**银行家算法**（Banker's
Algorithm）是一个避免[死锁](../Page/死锁.md "wikilink")（Deadlock）的著名算法，是由[艾兹格·迪杰斯特拉在](https://zh.wikipedia.org/wiki/艾兹格·迪杰斯特拉 "wikilink")1965年为T.H.E系统设计的一种避免死結產生的演算法。它以银行借贷系统的分配策略为基础，判断并保证系统的安全运行。
...
### 书籍
  ...
  - 《操作系统概念（Operating System
    Concepts）》第六版[1](https://books.google.com.hk/books?hl=zh-TW&id=bohQAAAAMAAJ&dq=Operating+System+Concepts+sixth+edition&q=bank+algorithm&pgis=1&redir_esc=y)

> 本文内容由[閉源軟體](https://zh.wikipedia.org/wiki/閉源軟體)转换而来。


相对[开放源代码](../Page/开放源代码.md "wikilink")而言，為**封闭源代码软件**的简称。 -{只}-要[源代码](../Page/源代码.md "wikilink")不容易取得，就被视为**闭源软件**。

**违反**以下任意一条，即为闭源软件：

  - [自由再散布](https://zh.wikipedia.org/wiki/自由再散布 "wikilink")（Free Distribution）：允许获得源代码的人可自由再将此源代码散布。

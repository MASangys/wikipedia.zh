在[流體動力學上](../Page/流體動力學.md "wikilink")，**開爾文環流定理**（，由[第一代開爾文男爵威廉·湯姆森於](../Page/第一代開爾文男爵威廉·湯姆森.md "wikilink")1869年發表\[1\]，因此以他命名）描述在徹體力[保守的](../Page/保守力.md "wikilink")[正壓](../Page/正壓.md "wikilink")[理想流體中閉合曲線](../Page/理想流體.md "wikilink")（包圍相同的流體元）的[環流在流體運動時並不會隨時間而改變](../Page/環量.md "wikilink")\[2\]。其數學描述為

\[\frac{\mathrm{D}\Gamma}{\mathrm{D}t} = 0\]

其中\(\Gamma\)為材料圍線\(C(t)\)的[環流](../Page/環量.md "wikilink")。用更簡單的話來說，這條定理所指的是，若觀察閉合圍線並注意它一段時間（注意所有流體元的運動）的話，則始終兩者間的環流相等。
...
## 参见
  ...
  - [亥姆霍兹定理 (流体力学)](../Page/亥姆霍兹定理_\(流体力学\).md "wikilink")
...
1.
2.  Kundu, P and Cohen, I: *Fluid Mechanics*, page 130. Academic Press
    2002
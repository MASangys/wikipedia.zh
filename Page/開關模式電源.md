...
**開關模式電源**（****，簡稱**SMPS**），又稱**交換式電源**、**开关变换器**，是一种高频化[电能转换装置](../Page/变流技术.md "wikilink")，是[電源供應器的一種](../Page/電源供應.md "wikilink")。其功能是将一個位準的[電壓](../Page/電壓.md "wikilink")，透過不同形式的架構轉換為用戶端所需求的電壓或[電流](https://zh.wikipedia.org/wiki/電流 "wikilink")。开关电源的輸入多半是交流電源（例如[市電](../Page/市電.md "wikilink")）或是直流電源，而輸出多半是需要直流電源的設備，例如[个人电脑](../Page/个人电脑.md "wikilink")，而开关电源就進行兩者之間[電壓及](../Page/電壓.md "wikilink")[電流的轉換](https://zh.wikipedia.org/wiki/電流 "wikilink")。

开关电源不同於[线性电源](https://zh.wikipedia.org/wiki/线性电源 "wikilink")，开关电源利用的切換電晶體多半是在全開模式（[饱和区](https://zh.wikipedia.org/wiki/饱和区 "wikilink")）及全閉模式（[截止区](https://zh.wikipedia.org/wiki/截止区 "wikilink")）之間切換，這兩個模式都有低[耗散的特點](../Page/耗散.md "wikilink")，切換之間的轉換會有較高的耗散，但時間很短，因此比較節省能源，產生廢熱較少。理想上，开关电源本身是不會消耗電能的。[電壓穩壓是透過調整電晶體導通及斷路的時間來達到](../Page/稳压器.md "wikilink")。相反的，線性電源在產生輸出電壓的過程中，電晶體工作在[放大区](https://zh.wikipedia.org/wiki/放大区 "wikilink")，本身也會消耗電能。开关电源的高轉換效率是其一大優點，而且因為开关电源工作频率高，可以使用小尺寸、輕重量的變壓器，因此开关电源也會比線性電源的尺寸要小，重量也會比較輕。

若电源的高效率、體積及重量是考慮重點時，开关电源比線性電源要好。不過开关电源比較複雜，內部電晶體會頻繁切換，若切換電流尚加以處理，可能會產生[雜訊及](../Page/雜訊.md "wikilink")[電磁干擾影響其他設備](https://zh.wikipedia.org/wiki/電磁干擾 "wikilink")，而且若开关电源沒有特別設計，其電源[功率因数可能不高](../Page/功率因数.md "wikilink")。
...
实际上，现代的电路中，开关电源电路和线性电源电路在大多数情况下，是组合使用的——使用开关电源进行初步的变换，给纹波、精度要求不高的电路使用；同时，使用[低壓差穩壓器](../Page/低壓差穩壓器.md "wikilink")（[LDO](https://zh.wikipedia.org/wiki/LDO "wikilink")）获取精密的、低纹波（噪声）的电压供诸如[运算放大器](../Page/运算放大器.md "wikilink")（OP-AMP），[模数转换器](https://zh.wikipedia.org/wiki/模数转换器 "wikilink")（A/D
Converter）使用。

## 类型及拓扑

开关电源的拓扑指开关电源电路的构成形式。一般是根据输出地线与输入地线有无[电气隔离](https://zh.wikipedia.org/wiki/电气隔离 "wikilink")，分为**隔离**及**非隔离**变换器。非隔离即输入端与输出端相通，没有隔离措施，常见的DC/DC变换器大多是这种类型。所谓隔离是指输入端与输出端在电路上不是直接联通的，使用[隔离变压器通过](https://zh.wikipedia.org/wiki/变压器#隔离变压器 "wikilink")[电磁变换方式进行能量传递](../Page/电磁学.md "wikilink")，输入端和输出端之间是完全电气隔离的。通常来说，为了保护使用者的人身安全，使用[主要供电
(市电)或输入电压高于](https://zh.wikipedia.org/wiki/家用电源列表 "wikilink")[安全电压](https://zh.wikipedia.org/wiki/触电 "wikilink")（目前公认是36伏特）的开关电源必须是隔离式。

### 非隔離型拓撲

非隔離式變換器是最為簡單的交換式電源結構，它們的電源變換方式為「直流-直流」變換。根據電壓變換類型，分為三種基本類型：[升壓斬波器](https://zh.wikipedia.org/wiki/升壓斬波器 "wikilink")（Boost
Chopper，又稱Boost變換器，Boost
Converter）、[降壓斬波器](https://zh.wikipedia.org/wiki/降壓斬波器 "wikilink")（Buck
Chopper，又稱Buck變換器，Buck
Converter）以及[降壓-升壓斬波器](https://zh.wikipedia.org/wiki/降壓-升壓斬波器 "wikilink")（Buck-Boost
...
<tbody>
<tr class="odd">
<td><p><a href="https://zh.wikipedia.org/wiki/返馳式變換器" title="wikilink">返馳式變換器</a><br />
...
<tr class="even">
<td><p><a href="https://zh.wikipedia.org/wiki/順向式變換器" title="wikilink">順向式變換器</a><br />
...
从转移函数上，可分为[PID和](https://zh.wikipedia.org/wiki/PID控制 "wikilink")[Bang-Bang控制](https://zh.wikipedia.org/wiki/Bang-Bang控制 "wikilink")
  ...
  - PID控制：采用[锯齿波产生器和补偿网络构建的一阶或二阶PID控制系统](https://zh.wikipedia.org/wiki/锯齿波 "wikilink")。

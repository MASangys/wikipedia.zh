...
目前-{zh-hant:USB隨身碟;zh-hans:USB闪存盘}-是這些裝置事實上的標準名稱。許多主要的廠商，如[SanDisk](../Page/SanDisk.md "wikilink")、[Lexar](../Page/Lexar.md "wikilink")、[Kingston與經銷商使用隨身碟來描述它們](../Page/Kingston.md "wikilink")。然而，從過去到現在有數不清的品牌名稱與術語來描述隨身碟，讓廠商不容易[行銷產品](../Page/行銷.md "wikilink")，且顧客也不容易尋找適合的產品，有些常常被使用的名字事實上是某公司的註冊商標（例如disgo\[19\]）。

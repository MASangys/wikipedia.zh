[数学](../Page/数学.md "wikilink")上，在一個[拓撲空間裡](https://zh.wikipedia.org/wiki/拓撲空間 "wikilink")，子集*S* 的**闭包**是指由*S* 的所有点及*S* 的[極限點所組成的一個集合](https://zh.wikipedia.org/wiki/極限點 "wikilink")；直觀上來說，即為所有「靠近」*S*　的點所組成的集合。在子集*S*　的閉包內的點稱為*S* 的**閉包點**。闭包的概念在許多方面能與[内部](../Page/内部.md "wikilink")的概念相類比。

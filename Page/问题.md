請問如何刪除ios上的描述檔 因為長按了也沒叉叉 到設定也說要移除密碼（不是手機密碼試過） 請各位可以幫我解決嗎困擾了好久
...
同样问题(Problem)可以不同的形式表达出来（Question），就问题的本性而言，这些的不同的表达是等价的，可称为等价问题；也可以通过问题等价的特性，变换问题的表达方式，以便于问题解决者处理问题，比如[费马大定理](../Page/费马大定理.md "wikilink")的就是通过不断的变换问题表达方式处理和解决的。
...
有认为
  ...
  - [知识](../Page/知识.md "wikilink")主要是对[系统组织的问题的](https://zh.wikipedia.org/wiki/系统 "wikilink")[解答](http://en.wikipedia.org/wiki/Answer)集合，而；
  - [研究](../Page/研究.md "wikilink")是解决问题的有组织的活动；
...
## 相关
  ...
  - [Sometimes the question is more important than the answer](http://www.infomotions.com/musings/search-strategies/)
  ...
  - [卡尔·波普尔](../Page/卡尔·波普尔.md "wikilink")关于知识的增长方式的讨论
...
[Category:问题](https://zh.wikipedia.org/wiki/Category:问题 "wikilink") [Category:认知](https://zh.wikipedia.org/wiki/Category:认知 "wikilink")
...
inequality）表明[L<sup>p</sup>空间是一个](../Page/L（p）空间.md "wikilink")[赋范向量空间](../Page/赋范向量空间.md "wikilink")。设
\(S\)
...
闵可夫斯基不等式是 \(L^p(S)\)
中的[三角不等式](../Page/三角不等式.md "wikilink")。它可以用[赫尔德不等式来证明](../Page/赫尔德不等式.md "wikilink")。和赫尔德不等式一样，闵可夫斯基不等式取[可数测度可以写成](../Page/可数测度.md "wikilink")[序列或](../Page/序列.md "wikilink")[向量的特殊形式](../Page/向量.md "wikilink")：
...
的[维数](../Page/维数.md "wikilink")）改成[复数同样成立](../Page/复数.md "wikilink")。

在[数学](../Page/数学.md "wikilink")中，如果[实数](../Page/实数.md "wikilink")域上的某个函数可以用[半开区间上的](../Page/區間.md "wikilink")[指示函数](../Page/指示函数.md "wikilink")的有限次[线性组合来表示](https://zh.wikipedia.org/wiki/线性组合 "wikilink")，那么这个函数就是**阶跃函数**，或者叫**[赫维赛德函数](https://zh.wikipedia.org/wiki/奥利弗·赫维赛德 "wikilink")**。换一种不太正式的说法就是，阶跃函数是有限段分段常数函数的组合。

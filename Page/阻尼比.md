...
阻尼比常用ζ表示\[1\]，是二階[微分方程](../Page/微分方程.md "wikilink")[步階響應及](https://zh.wikipedia.org/wiki/步階響應 "wikilink")[頻率響應的參數之一](https://zh.wikipedia.org/wiki/頻率響應 "wikilink")。在[控制理論及](https://zh.wikipedia.org/wiki/控制理論 "wikilink")[諧振子中相當重要](../Page/諧振子.md "wikilink")。
...
利用[簡諧運動的](../Page/簡諧運動.md "wikilink")[自然頻率](https://zh.wikipedia.org/wiki/自然頻率 "wikilink")\(\omega_n = \sqrt{k/m}\)及以上的阻尼比定義，可以將二階微分方程式改寫如下：
...
若二階係系統的\(\zeta < 1\)（欠阻尼系統），系統有二個[共軛零點](https://zh.wikipedia.org/wiki/共軛 "wikilink")，其實部為\(\alpha\)，因此其指數衰減率參數\(\alpha\)表示振盪後[指數衰減的速度](https://zh.wikipedia.org/wiki/指數衰減 "wikilink")。低阻尼比表示其衰減速度慢，因此許多欠阻尼的系統可以振盪較長的時間\[3\]。像高品質的[音叉其阻尼比很小](../Page/音叉.md "wikilink")，因此敲擊後振盪可以持續很長的時間，衰減的速度很慢。

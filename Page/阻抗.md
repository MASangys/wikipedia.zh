...
具體而言，阻抗定義為電壓與電流的[頻域](../Page/頻域.md "wikilink")比率\[1\]。阻抗的大小 \(Z_m\) 是電壓振幅與電流振幅的絕對值比率，阻抗的相位 \(\theta\) 是電壓與電流的[相位差](https://zh.wikipedia.org/wiki/相位 "wikilink")。採用[國際單位制](https://zh.wikipedia.org/wiki/國際單位制 "wikilink")，阻抗的單位是[歐姆](../Page/歐姆.md "wikilink")（Ω），與[電阻的單位相同](https://zh.wikipedia.org/wiki/電阻 "wikilink")。阻抗的[倒數是](https://zh.wikipedia.org/wiki/倒數 "wikilink")[導納](https://zh.wikipedia.org/wiki/導納 "wikilink")，即電流與電壓的[頻域](../Page/頻域.md "wikilink")比率。導納的單位是[西門子 (單位)](https://zh.wikipedia.org/wiki/西門子_\(單位\) "wikilink")（舊單位是[姆歐](https://zh.wikipedia.org/wiki/姆歐 "wikilink")）。

英文術語「impedance」是由物理學者[奧利弗·黑維塞](../Page/奧利弗·黑維塞.md "wikilink")於1886年發表論文《電工》給出\[2\]\[3\]。於1893年，[電機工程師](../Page/電機工程學.md "wikilink")[亞瑟·肯乃利](https://zh.wikipedia.org/wiki/亞瑟·肯乃利 "wikilink")（）最先以複數表示阻抗\[4\]。
...
[General_AC_circuit_small_letter.png](https://zh.wikipedia.org/wiki/File:General_AC_circuit_small_letter.png "fig:General_AC_circuit_small_letter.png") \(Z\) 的兩端，並且驅動電流 \(i(t)\) 於電路。\]\]  藉著歐姆定律，可以了解阻抗的內涵\[5\]：
...
[Impedance_symbol_comparison.svg](https://zh.wikipedia.org/wiki/File:Impedance_symbol_comparison.svg "fig:Impedance_symbol_comparison.svg") 為了簡化計算，正弦電壓波 \(v(t)\) 和正弦電流波 \(i(t)\) 通常以指數形式表示為\[6\]

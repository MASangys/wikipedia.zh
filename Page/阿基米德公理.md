在[抽象代数和](../Page/抽象代数.md "wikilink")[分析学中](https://zh.wikipedia.org/wiki/分析学 "wikilink")，以古希腊数学家[阿基米德命名的](../Page/阿基米德.md "wikilink")**阿基米德公理**（又称**阿基米德性质**），是一些赋范的[群](../Page/群.md "wikilink")、[域和](../Page/域_\(數學\).md "wikilink")[代数结构具有的一个性质](../Page/代数结构.md "wikilink")。粗略地讲，它是指没有无穷大或无穷小的元素的性质。由于它出现在阿基米德的《论球体和圆柱体》的公理五，1883年，奧地利數學家赋予它这个名字\[1\]。

这个概念源于古希腊对[量的理论](https://zh.wikipedia.org/wiki/量_\(数学\) "wikilink")；如[大卫·希尔伯特的几何公理](../Page/大卫·希尔伯特.md "wikilink")，[有序群](https://zh.wikipedia.org/wiki/有序群 "wikilink")、[有序域和](../Page/有序域.md "wikilink")[局部域的理论在现代数学中仍然起着重要的作用](../Page/局部域.md "wikilink")。

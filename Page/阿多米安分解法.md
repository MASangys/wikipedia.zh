...
[Burgers_Fisher_equation_tanh_Adomian_plot.gif](https://zh.wikipedia.org/wiki/File:Burgers_Fisher_equation_tanh_Adomian_plot.gif "fig:Burgers_Fisher_equation_tanh_Adomian_plot.gif") Burgers-Fisher方程：
...
\[u[3] = -(1/3)*t^3*tanh(x)*(3-16*tanh(x)^2+26*tanh(x)^4-13*tanh(x)^6-3*tanh(x)^2*(1-tanh(x)^2)+(2*(1-tanh(x)^2))*tanh(x)^4)\] 近似解：
...
[Dym_equation_Admain_plot_cosh.gif](https://zh.wikipedia.org/wiki/File:Dym_equation_Admain_plot_cosh.gif "fig:Dym_equation_Admain_plot_cosh.gif") 迪姆方程：

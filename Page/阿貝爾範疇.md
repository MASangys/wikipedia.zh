...
## 基本性質
  ...
  - 承上，阿貝爾範疇也是[上模](https://zh.wikipedia.org/wiki/上模 "wikilink")；\(\mathrm{Hom}(G,A)\)可以詮釋為\(\mathcal{A}\)的對象。若\(\mathcal{A}\)
    [完備](https://zh.wikipedia.org/wiki/完備範疇 "wikilink")，\(G\)的有限生成假設可以移除。
...
阿貝爾範疇源於[亞歷山大·格羅滕迪克知名的](https://zh.wikipedia.org/wiki/亞歷山大·格羅滕迪克 "wikilink")*東北論文*，該論文發表於1950年代，當時存在兩套不同的[上同調理論](https://zh.wikipedia.org/wiki/上同調 "wikilink")：群上同調與層上同調，兩者性質相近而定義迥異。格羅滕迪克將兩套理論以阿貝爾範疇上的[導函子統合](https://zh.wikipedia.org/wiki/導函子 "wikilink")：一者是[拓撲空間](https://zh.wikipedia.org/wiki/拓撲空間 "wikilink")\(X\)上的阿貝爾層範疇，一者則是[群](../Page/群.md "wikilink")\(G\)的\(G\)-[模範疇](../Page/模.md "wikilink")，導出上同調的函子分別是\(\mathcal{F} \mapsto \Gamma(X, \mathcal{F})\)與\(M \mapsto M^G\)。

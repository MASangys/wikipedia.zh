[Hadamards_gamma_function_plot.png](https://zh.wikipedia.org/wiki/File:Hadamards_gamma_function_plot.png "fig:Hadamards_gamma_function_plot.png")

在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，**阿達馬伽瑪函數**或**阿達馬的伽瑪函數**（Hadamard's
gamma
function）是除了[伽瑪函數之外的另一種](https://zh.wikipedia.org/wiki/伽瑪函數 "wikilink")[階乘的擴展定義方式](../Page/階乘.md "wikilink")，以[雅克·阿达马命名](../Page/雅克·阿达马.md "wikilink")。此[函數可以視為將階乘的參數向左平移](https://zh.wikipedia.org/wiki/函數 "wikilink")1，並且在階乘的非整數部分插值，但是有別於歐拉伽瑪函數將階乘擴展到[實數和複數的定義](https://zh.wikipedia.org/wiki/實數 "wikilink")。阿達馬的伽瑪函數的定義為：
...
其中\(\tfrac{1}{\Gamma(1-x)}\to 0\)在\(x\)趨近[正整數時趨近為](https://zh.wikipedia.org/wiki/正整數 "wikilink")0。

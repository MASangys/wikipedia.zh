**降次积分法**是求高次函数[积分的一种技巧](../Page/积分.md "wikilink")。先用[换元积分法](../Page/换元积分法.md "wikilink")、[三角换元法](../Page/三角换元法.md "wikilink")、[分部积分法](https://zh.wikipedia.org/wiki/分部积分法 "wikilink")、[部分分式法等方法求出降次公式](https://zh.wikipedia.org/wiki/部分分式法 "wikilink")，将原函数（如I<sub>n</sub>）用低次的函数形式（如I<sub>n-2</sub>）表示。然后将n代成想求的数，逐步降次，直至降至0或1为止，借助[积分表得出结果](../Page/积分表.md "wikilink")。

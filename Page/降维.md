...
降维可进一步细分为[变量选择和](../Page/特征选择.md "wikilink")[特征提取两大方法](https://zh.wikipedia.org/wiki/特征提取 "wikilink")。
...
[变量选择假定数据中包含大量冗余或无关变量](../Page/特征选择.md "wikilink")（或称特征、属性、指标等），旨在从原有变量中找出主要变量。现代统计学中对变量选择的研究文献，大多集中于，其中最具代表性的方法包括：
  ...
  - [Elastic net](https://zh.wikipedia.org/wiki/Elastic_net "wikilink")
    (和提出)

  - [SCAD](https://zh.wikipedia.org/wiki/SCAD "wikilink")
    ([范剑青和](../Page/范剑青.md "wikilink")提出)

  - [SURE
    screening](https://zh.wikipedia.org/wiki/SURE_screening "wikilink")
    ([范剑青和](../Page/范剑青.md "wikilink")[吕金翅提出](https://zh.wikipedia.org/wiki/吕金翅 "wikilink"))

  - [PLUS](https://zh.wikipedia.org/wiki/PLUS "wikilink")
    ([张存惠提出](https://zh.wikipedia.org/wiki/张存惠 "wikilink"))

...
1995年，[尼爾·斯洛恩和](../Page/尼爾·斯洛恩.md "wikilink")[西蒙·普勞夫定義了超階乘](https://zh.wikipedia.org/wiki/西蒙·普勞夫 "wikilink")（superfactorial）為首n個階乘的積。即sf(n)=1\!×2\!×3\!×...×n\!。一般來說
...
Infinity*定義了另一個超階乘，寫作\(n\mathrm{S}\!\!\!\!\!\;\,{!}\)（\(n\mathrm{S}\!\!\!\!\!\;\,{!}\)實際上應該是\!和S重疊在一起）：\(n\mathrm{S}\!\!\!\!\!\;\,{!}  = n ^{(4)} n\)，<sup>(4)</sup>表示[hyper4](https://zh.wikipedia.org/wiki/超運算 "wikilink")，使用[高德納箭號表示法即](../Page/高德納箭號表示法.md "wikilink")\(n\mathrm{S}\!\!\!\!\!\;\,{!}  = (n!) \uparrow \uparrow (n!)\)。這個數列：

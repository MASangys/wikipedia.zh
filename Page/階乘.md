...
在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，正整数的**階乘**（）是所有[小於及等於該數的](https://zh.wikipedia.org/wiki/小於 "wikilink")[正整數的](https://zh.wikipedia.org/wiki/正整數 "wikilink")[積](https://zh.wikipedia.org/wiki/積 "wikilink")，計為，例如5的階乘計為，其值為[120](https://zh.wikipedia.org/wiki/120 "wikilink")：

\[5! = 5 \times 4 \times 3 \times  2  \times  1 = 120 \,.\]
並定義，1的階乘為1、0的階乘亦為1，其中，0的階乘表示一個[空積](https://zh.wikipedia.org/wiki/空積 "wikilink"){{\#tag:ref|Graham，Knuth
...
階乘應用在許多數學領域中，最常應用在組合學、代數學和[数学分析中](../Page/数学分析.md "wikilink")。在組合學中，階乘代表的意義為n個相異物件任意排列的數量，例如前述例子，其代表了5個相異物件共有120種排列法。在正整數的情形下，n的階乘又可以稱為n的[排列數](https://zh.wikipedia.org/wiki/排列數 "wikilink")。
...
Youths](https://zh.wikipedia.org/wiki/Ancient_Society_of_College_Youths "wikilink"),
to which society the "Dedicatory" is
addressed.|group="註"}}|name="Stedman 1677"}}, pp. 6–9.|name="Stedman
1677 pp.
...
Kramp在](https://zh.wikipedia.org/wiki/Christian_Kramp "wikilink")1808年使用{{\#tag:ref|Higgins
...
有幾個獨立的理由認為這個定義是和諧的。 其中包括：
  ...
  - 在的情況，定義為「沒有任何數字相乘的結果」，所以更廣泛之慣例的例子是以不存在任何[因數的乘法單位元素來當作其解](../Page/因數.md "wikilink")。（參閱[空積](https://zh.wikipedia.org/wiki/空積 "wikilink")）
...
計算n\!時，當n不太大時，普通的[科學計算機都可以計算](https://zh.wikipedia.org/wiki/計算器 "wikilink")，能夠處理不超過\(10^{100}\)（[古高爾](https://zh.wikipedia.org/wiki/古高爾 "wikilink")）數值的計算機可以計算至69\!，而[雙精度浮點數的計算機則可計算至](../Page/雙精度浮點數.md "wikilink")170\!。

當n很大時，可以用[斯特林公式估計](https://zh.wikipedia.org/wiki/斯特林公式 "wikilink")：
...
除了非負整數之外，還可以為非整數值定義階乘函數，但這需要使用更高級的[數值分析方法](https://zh.wikipedia.org/wiki/數值分析 "wikilink")。
...
[upright=1.8](https://zh.wikipedia.org/wiki/File:Factorial05.jpg "wikilink")
可以透過Γ函數來計算[複數的階乘](https://zh.wikipedia.org/wiki/複數 "wikilink")。右圖顯示了複數階乘之模與輻角的等值線
...
負整數的階乘可透過階乘的[遞迴定義](https://zh.wikipedia.org/wiki/遞迴 "wikilink") *n* ×
(*n* − 1)\!}}逆推而得：
...
並且\(\Gamma(I)=I\)，其中，\(I\)是單位矩陣、\(A\)是一個[方陣](https://zh.wikipedia.org/wiki/方陣 "wikilink")，同時\(A!\)是一個[非奇異矩陣](https://zh.wikipedia.org/wiki/非奇異矩陣 "wikilink")\[8\]。
...
另一種定义扩展是[阿達馬伽瑪函數](https://zh.wikipedia.org/wiki/阿達馬伽瑪函數 "wikilink")，但由於其不在所有實數上皆能滿足階乘的遞迴定義，只有在正整數上滿足階乘的遞迴定義
*n* × (*n* − 1)\!}}因此比較少被拿出來討論。
...
所謂的[四次阶乘](https://zh.wikipedia.org/wiki/四次阶乘 "wikilink")（又称**四重阶乘**）
...
1995年，[尼爾·斯洛恩和](../Page/尼爾·斯洛恩.md "wikilink")[西蒙·普勞夫定義了超級階乘](https://zh.wikipedia.org/wiki/西蒙·普勞夫 "wikilink")（superfactorial）為首n個階乘的積。即sf(n)=1\!×2\!×3\!×...×n\!。一般來說
...
\[\mathrm{sf}(n)
 ...
 = 1^n\cdot2^{n-1}\cdot3^{n-2}\cdots(n-1)^2\cdot n^1.\] 前幾項的超級階乘為：
  ...
  -
    ...
    [288](https://zh.wikipedia.org/wiki/288 "wikilink"), 34560,
    24883200, ...

#### 另一種定義

[柯利弗德·皮寇弗在他的書](../Page/柯利弗德·皮寇弗.md "wikilink")*Key to
Infinity*定義了另一個超級階乘，寫作\(n\mathrm{S}\!\!\!\!\!\;\,{!}\)（\(n\mathrm{S}\!\!\!\!\!\;\,{!}\)實際上應該是\!和S重疊在一起）：\(n\mathrm{S}\!\!\!\!\!\;\,{!}  = n ^{(4)} n\)，<sup>(4)</sup>表示[hyper4](https://zh.wikipedia.org/wiki/超運算 "wikilink")，使用[高德納箭號表示法即](../Page/高德納箭號表示法.md "wikilink")\(n\mathrm{S}\!\!\!\!\!\;\,{!}  = (n!) \uparrow \uparrow (n!)\)。這個數列：
...
目前[質數階乘只能用](../Page/質數階乘.md "wikilink")[遞迴方式定義](https://zh.wikipedia.org/wiki/遞迴 "wikilink")，因為尚未找到一個能用基本函數表示所有[質數的](https://zh.wikipedia.org/wiki/質數 "wikilink")[函數或一條包含所有](https://zh.wikipedia.org/wiki/函數 "wikilink")[質數的](https://zh.wikipedia.org/wiki/質數 "wikilink")[曲線](https://zh.wikipedia.org/wiki/曲線 "wikilink")
...
其中,
*π(n)*是[質數計數函數](https://zh.wikipedia.org/wiki/素數計數函數 "wikilink")，小於或等於某個實數n的質數的個數的函數≤*n*。
...
\[n!^{{(n-1)!}^!} = n!_{}^{(n-1)!^{{(n-2)!}^{.\,^{.\,^{.\,^{{3!}^{{2!}^{1!}}}}}}}}\]
  ...
  -
    前幾個阶乘阶幂為：
      -
        1, 2, [36](https://zh.wikipedia.org/wiki/36 "wikilink"),

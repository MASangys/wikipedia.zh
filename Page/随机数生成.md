...
generator）是通过一些[算法](../Page/算法.md "wikilink")、物理訊號、環境[噪音等来产生看起來似乎沒有關聯性的](../Page/噪音.md "wikilink")[數列的方法或裝置](https://zh.wikipedia.org/wiki/數列 "wikilink")。丟[硬幣](../Page/硬幣.md "wikilink")、丟[骰子](../Page/骰子.md "wikilink")、[洗牌就是生活上常見的隨機數產生方式](https://zh.wikipedia.org/wiki/洗牌 "wikilink")。

大部分[计算机上的](https://zh.wikipedia.org/wiki/计算机 "wikilink")[偽随机数](https://zh.wikipedia.org/wiki/偽随机数 "wikilink")，并不是真正的随机数，只是重复的周期比较大的數列，是按一定的[算法和种子值生成的](../Page/算法.md "wikilink")。

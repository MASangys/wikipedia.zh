...
隐函数的一个常见类型是[反函数](https://zh.wikipedia.org/wiki/反函数 "wikilink")。若*f*是一个函数，那么*f*的反函数记作*f*<sup>−1</sup>,
是给出下面方程解的函数
...
1.  [对数函数](https://zh.wikipedia.org/wiki/对数函数 "wikilink") ln(*x*)
    给出方程*x* − *e*<sup>*y*</sup> = 0或等价的*x* = *e*<sup>*y*</sup>的解
    *y* = ln(*x*)。 这里 *f*(*y*) = *e*<sup>*y*</sup> 并且
    *f*<sup>−1</sup>(*x*) = ln(*x*)。
2.  [朗伯W函數則可以解出](https://zh.wikipedia.org/wiki/朗伯W函數 "wikilink") *x* −
    *y* *e*<sup>*y*</sup> = 0的*y*值。
...
代數函數在[數學分析和](https://zh.wikipedia.org/wiki/數學分析 "wikilink")[代数几何中扮演重要角色](../Page/代数几何.md "wikilink")，我們再拿單位圓方程式來當作代數函數的範例：
...
### 方法一
  ...
  - 把n元隐函数看作(n+1)元函数，通过[多元函数的](https://zh.wikipedia.org/wiki/多元函数 "wikilink")[偏导数的商求得n元隐函数的导数](../Page/偏导数.md "wikilink")。

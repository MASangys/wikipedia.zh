...
设*f* : **R**<sup>*n+m*</sup> →
**R**<sup>*m*</sup>为一个[连续可微函数](../Page/连续可微.md "wikilink")。这里**R**<sup>*n+m*</sup>被看作是两个空间的[直积](../Page/直积.md "wikilink")：**R**<sup>*n*</sup>×**R**<sup>*m*</sup>，于是**R**<sup>*n+m*</sup>中的一个元素写成
...
## 参见
  ...
  - [压缩映射定理](../Page/压缩映射定理.md "wikilink")

[Interlace_zoom.gif](https://zh.wikipedia.org/wiki/File:Interlace_zoom.gif "fig:Interlace_zoom.gif") **隔行扫描**（）是一种将图像显示在扫描式的显示设备上的方法，例如[阴极射线管](../Page/阴极射线管.md "wikilink")（CRT）。在同样[帧率](../Page/帧率.md "wikilink")的情况下，这种方法比起[逐行扫描引起的视觉闪烁比较小](https://zh.wikipedia.org/wiki/逐行扫描 "wikilink")。扫描设备交换扫描[偶数行和](https://zh.wikipedia.org/wiki/偶数 "wikilink")[奇数行](https://zh.wikipedia.org/wiki/奇数 "wikilink")。在[PAL制式](../Page/PAL制式.md "wikilink")和[NTSC制式](../Page/NTSC制式.md "wikilink")中，都是先扫描奇数行，即奇数。

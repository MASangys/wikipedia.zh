在[數學中](../Page/數學.md "wikilink")，**雅可比橢圓函數**是由[卡爾·雅可比在](../Page/卡爾·雅可比.md "wikilink")1830年左右研究的一類[橢圓函數](../Page/橢圓函數.md "wikilink")。這類函數可用於[擺之類的應用問題](../Page/擺.md "wikilink")，並具有與[三角函數相似的性質](../Page/三角函數.md "wikilink")。
...
視此矩形為[複數平面的一部分](../Page/複數.md "wikilink")，\(s \,\) 是原點，\(c\,\) 是實軸上的一點
\(K,d \,\) 是 \(K+{\rm{i}}K'\,\)，\(n\,\) 是 \({\rm{i}}K'\,\)。\(K\,\) 與
\({\rm{i}}K'\,\) 稱作四分之一週期。

十二個橢圓函數分別記為
\({\rm{sc}} , {\rm{sd}} , {\rm{sn}} , {\rm{cs}} , {\rm{cd}} , {\rm{cn}} , {\rm{ds}} , {\rm{dc}} , {\rm{dn}} , {\rm{ns}} , {\rm{nc}} , {\rm{nd}} \,\)。為方便起見，取變數
\(p, q \,\)意指矩形上的任一對頂點，則函數 \(pq\,\)
是唯一滿足以下性質的週期[亞純函數](../Page/亞純函數.md "wikilink")
...
| 函數                      | 週期                                  | 零點                                              | 極點                                     | [留數](../Page/留數.md "wikilink")    |
| ----------------------- | ----------------------------------- | ----------------------------------------------- | -------------------------------------- | --------------------------------- |
...
以上定義略顯抽象，更具體的定義是將之表為某類[橢圓積分之逆](../Page/橢圓積分.md "wikilink")。設
...
雅可比椭圆函数也可以用[Θ函數来定义](../Page/Θ函數.md "wikilink")。如果我们把\(\vartheta(0;\tau)\)简写为\(\vartheta\)，把\(\vartheta_{01}(0;\tau), \vartheta_{10}(0;\tau), \vartheta_{11}(0;\tau)\)分别简写为\(\vartheta_{01}, \vartheta_{10}, \vartheta_{11}\)（Theta常数），那么[椭圆模](../Page/椭圆模.md "wikilink")*k*是\(k=({\vartheta_{10} \over \vartheta})^2\)。如果我们设\(u = \pi \vartheta^2 z\)，我们便有：
...
由此可見 (cn,sn,dn) 描出[射影空間](../Page/射影空間.md "wikilink")
\(\mathbb{P}^3(\mathbb{C})\)
中兩個二次[曲面之交](../Page/曲面.md "wikilink")，這同構於一條[橢圓曲線](../Page/橢圓曲線.md "wikilink")。曲線上的[群運算由下列加法公式描述](../Page/群.md "wikilink")：

在[數學中](https://zh.wikipedia.org/wiki/數學 "wikilink")，**雅可比橢圓函數**是由[卡爾·雅可比在](../Page/卡爾·雅可比.md "wikilink")1830年左右研究的一類[橢圓函數](https://zh.wikipedia.org/wiki/橢圓函數 "wikilink")。這類函數可用於[擺之類的應用問題](../Page/擺.md "wikilink")，並具有與[三角函數相似的性質](https://zh.wikipedia.org/wiki/三角函數 "wikilink")。

## 介紹

[width322px](https://zh.wikipedia.org/wiki/File:JacobiFunctionAbstract.png "fig:width322px")
雅可比橢圓函數有十二種，各對映到某個矩形的頂點連線。此諸頂點記作 \(s\,\) \(c\,\) \(d\,\) \(n\,\)。

視此矩形為[複數平面的一部分](https://zh.wikipedia.org/wiki/複數 "wikilink")，\(s \,\)
是原點，\(c\,\) 是實軸上的一點 \(K,d \,\) 是 \(K+{\rm{i}}K'\,\)，\(n\,\) 是
\({\rm{i}}K'\,\)。\(K\,\) 與 \({\rm{i}}K'\,\) 稱作四分之一週期。

十二個橢圓函數分別記為
\({\rm{sc}} , {\rm{sd}} , {\rm{sn}} , {\rm{cs}} , {\rm{cd}} , {\rm{cn}} , {\rm{ds}} , {\rm{dc}} , {\rm{dn}} , {\rm{ns}} , {\rm{nc}} , {\rm{nd}} \,\)。為方便起見，取變數
\(p, q \,\)意指矩形上的任一對頂點，則函數 \(pq\,\)
是唯一滿足以下性質的週期[亞純函數](https://zh.wikipedia.org/wiki/亞純函數 "wikilink")

  - \(p\,\) 是單零點，\(q\,\) 是單極點。
  - \(pq\,\) 在 \(\vec{pq}\) 方向的週期等於 \(p,q\,\) 距離的兩倍。對另兩個從
    \(p \,\)出發的方向，\(pq \,\)亦滿足同樣性質。
...
以上定義略顯抽象，更具體的定義是將之表為某類[橢圓積分之逆](https://zh.wikipedia.org/wiki/橢圓積分 "wikilink")。設
...
\[\operatorname {dn}\; u = \sqrt {1-m\sin^2 \phi}.\,\] 這裡的
\(m \in \mathbb{R}\) 是自由變元，通常取 \(0 \leq m \leq 1\)。
...
雅可比椭圆函数也可以用[Θ函數来定义](../Page/Θ函數.md "wikilink")。如果我们把\(\vartheta(0;\tau)\)简写为\(\vartheta\)，把\(\vartheta_{01}(0;\tau), \vartheta_{10}(0;\tau), \vartheta_{11}(0;\tau)\)分别简写为\(\vartheta_{01}, \vartheta_{10}, \vartheta_{11}\)（Theta常数），那么[椭圆模](https://zh.wikipedia.org/wiki/椭圆模 "wikilink")*k*是\(k=({\vartheta_{10} \over \vartheta})^2\)。如果我们设\(u = \pi \vartheta^2 z\)，我们便有：
...
由此可見 (cn,sn,dn) 描出[射影空間](https://zh.wikipedia.org/wiki/射影空間 "wikilink")
\(\mathbb{P}^3(\mathbb{C})\)
中兩個二次[曲面之交](../Page/曲面.md "wikilink")，這同構於一條[橢圓曲線](https://zh.wikipedia.org/wiki/橢圓曲線 "wikilink")。曲線上的[群運算由下列加法公式描述](../Page/群.md "wikilink")：
...
三个基本的雅可比椭圆函数的[导数为](../Page/导数.md "wikilink")：
...
根据以上的加法定理，可知它们是以下非线性[常微分方程的解](../Page/常微分方程.md "wikilink")：
...
<!-- end list -->
  ...
  - E. T. Whittaker and G. N. Watson *A Course of Modern Analysis*,
    (1940, 1996) Cambridge University Press. ISBN 0-521-58807-3

<!-- end list -->

  - Alfred George Greenhill, [The applications of elliptic
    functions](http://www.archive.org/details/applicationselli00greerich)
    (London, New York, Macmillan, 1892)
  - H. Hancock [Lectures on the theory of elliptic
    functions](http://www.archive.org/details/lecturestheorell00hancrich)
    (New York, J. Wiley & sons, 1910)
  - A. C. Dixon [The elementary properties of the elliptic functions,
    with examples](http://www.archive.org/details/117736039) (Macmillan,
    1894)

...
在[代数几何中](../Page/代数几何.md "wikilink")，[代数曲线的](https://zh.wikipedia.org/wiki/代数曲线 "wikilink")**雅可比行列式**表示[雅可比簇](https://zh.wikipedia.org/wiki/雅可比簇 "wikilink")：伴随该曲线的一个[代數群](../Page/代數群.md "wikilink")，曲线可以嵌入其中。
...
这个矩阵的第 \(i\)行是由梯度函数的[转置](https://zh.wikipedia.org/wiki/转置 "wikilink")
\(y_i (i=1,\cdots,m)\)表示的

如果 \(p\)是\(\mathbb{R}^n\) 中的一点，\(F\)在
\(p\)点可微分，根據[數學分析](https://zh.wikipedia.org/wiki/數學分析 "wikilink")，
...
由[球坐标系到直角坐标系的转化由](https://zh.wikipedia.org/wiki/球坐标系 "wikilink")
...
\(J_F(x_0)\)的[特征值相關](https://zh.wikipedia.org/wiki/特征值 "wikilink")。
...
在某个给定点的雅可比行列式提供了
\(F\)在接近该点时的表现的重要信息。例如，如果[连续可微函数](https://zh.wikipedia.org/wiki/连续可微函数 "wikilink")
\(F\)在
\(p\)点的雅可比行列式不是零，那么它在该点附近具有[反函数](https://zh.wikipedia.org/wiki/反函数 "wikilink")。这称为[反函数定理](../Page/反函数定理.md "wikilink")。更进一步，如果
\(p\)点的雅可比行列式是[正数](https://zh.wikipedia.org/wiki/正数 "wikilink")，则 \(F\)在
\(p\)点的取向不变；如果是负数，则
...
根據[反函數定理](https://zh.wikipedia.org/wiki/反函數定理 "wikilink")，一個*可逆函數*（存在[反函數的函數](../Page/反函數.md "wikilink")）的[雅可比矩陣的](https://zh.wikipedia.org/wiki/雅可比矩陣 "wikilink")[逆矩陣即為該函數的](https://zh.wikipedia.org/wiki/逆矩陣 "wikilink")*[反函數](../Page/反函數.md "wikilink")*的[雅可比矩陣](https://zh.wikipedia.org/wiki/雅可比矩陣 "wikilink")。即，若函數
\(F: \mathbb{R}^n\rightarrow\mathbb{R}^n\)在點
\(p\in\mathbb{R}^n\)的雅可比矩陣是連續且可逆的，則 \(F\)在點
\(p\)的某一[鄰域內也是可逆的](https://zh.wikipedia.org/wiki/鄰域 "wikilink")，且有

\[J_{F^{-1}}\circ f=J^{-1}_{F}\]
成立。相反，倘若雅可比行列式在某一個點**不為**零，那麽該函數在這個點的某一鄰域內*可逆*（存在[反函數](../Page/反函數.md "wikilink")）。

一個[多項式函數的可逆性與非經證明的](https://zh.wikipedia.org/wiki/多項式函數 "wikilink")[雅可比猜想有關](../Page/雅可比猜想.md "wikilink")。其斷言，如果函數的雅可比行列式為一個非零實數（相當於其不存在**[複零點](https://zh.wikipedia.org/wiki/零點 "wikilink")**），則該函數可逆且其反函數也為一個多項式。

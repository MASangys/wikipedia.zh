...
<!-- end list -->
  ...
  - 表單
    提供簡易產生滑鼠移過彈出[選單的方式](../Page/選單.md "wikilink")。
...
## 外部連結
  ...
  - [yui-ext - Jack Slocum's Yahoo\! UI Extensions
    Library](http://www.yui-ext.com/)
  - [Yahoo\! User Interface Blog](http://yuiblog.com/)
  - [ydn-javascript Yahoo\!
    group](http://groups.yahoo.com/group/ydn-javascript)
  - [SourceForge project page](http://sourceforge.net/projects/yui)
  - [Yahoo\! Design Patterns
    Library](https://web.archive.org/web/20080229011119/http://developer.yahoo.com/ypatterns/)

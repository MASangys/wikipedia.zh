...
例如：[加法和](../Page/加法.md "wikilink")[乘法运算遵循人们看时候带吃熟知的](../Page/乘法.md "wikilink")[交换律](https://zh.wikipedia.org/wiki/交换律 "wikilink")、[结合律和](../Page/结合律.md "wikilink")[分配律](../Page/分配律.md "wikilink")；而"小于等于"关系满足[自反性](https://zh.wikipedia.org/wiki/自反性 "wikilink")、[反对称性和](https://zh.wikipedia.org/wiki/反对称性 "wikilink")[传递性](https://zh.wikipedia.org/wiki/传递性 "wikilink")。
...
:\*\(A \cap B \subseteq A\)
  ...
  - [最小元](https://zh.wikipedia.org/wiki/最小元 "wikilink")（[底](https://zh.wikipedia.org/wiki/底 "wikilink")）：
    \(\varnothing\)
...
分別是加法和乘法的[单位元](https://zh.wikipedia.org/wiki/单位元 "wikilink")，\(\varnothing\)
和 \(\mathcal{U}\)
也分別是并集和交集的[单位元](https://zh.wikipedia.org/wiki/单位元 "wikilink")。
...
下列命题说明对任意集合 \(S\)，\(S\)
的[幂集按照包含来排列是个](https://zh.wikipedia.org/wiki/幂集 "wikilink")[有界格](https://zh.wikipedia.org/wiki/有界格 "wikilink")；因此，结合上述的分配律和补集律，它是一个[布尔代数](../Page/布尔代数.md "wikilink")。

...
effect**）是指[导体中有](https://zh.wikipedia.org/wiki/导体 "wikilink")[交流电或者](https://zh.wikipedia.org/wiki/交流电 "wikilink")[交变电磁场时](https://zh.wikipedia.org/wiki/交变电磁场 "wikilink")，导体内部的[电流分布不均匀的一种现象](../Page/电流.md "wikilink")。随着与导体表面的距离逐渐增加，导体内的[电流密度呈](../Page/电流密度.md "wikilink")[指数递减](https://zh.wikipedia.org/wiki/指数 "wikilink")，即导体内的电流会集中在导体的表面。从与电流方向[垂直的横切面来看](../Page/垂直.md "wikilink")，导体的中心部分几乎没有电流流过，只在导体边缘的部分会有电流。简单而言就是电流集中在导体的“皮肤”部分，所以称为**集膚效應**。产生这种效应的原因主要是变化的[电磁场在导体内部产生了涡旋电场](../Page/电磁场.md "wikilink")，与原来的电流相抵消。
...
Heaviside）将其推广到任何形状的导体。趋肤效应使得导体的[电阻随着交流电的](../Page/电阻.md "wikilink")[频率增加而增加](https://zh.wikipedia.org/wiki/频率 "wikilink")，并导致导线传输电流时效率减低，耗费金属资源。在[无线电频率的设计](https://zh.wikipedia.org/wiki/无线电 "wikilink")、[微波线路和电力传输系统方面都要考虑到趋肤效应的影响](https://zh.wikipedia.org/wiki/微波 "wikilink")。
...
其中，\(J_s\)是导体表面的电流密度，\(x\)表示电流与导体表面的距离，\(\delta\)是一个和导体的[电阻率以及交流电的频率有关的](../Page/电阻率.md "wikilink")[系数](https://zh.wikipedia.org/wiki/系数 "wikilink")，称为[趋肤深度](https://zh.wikipedia.org/wiki/趋肤深度 "wikilink")。
...
其中：
  ...
  -
    ...
    \(\mu_0 \cdot \mu_r\)，其中\(\mu_0\)是[真空磁导率](../Page/真空磁导率.md "wikilink")，\(\mu_r\)是导体的[相对磁导率](https://zh.wikipedia.org/wiki/相对磁导率 "wikilink")
...
在[圆柱坐标系](https://zh.wikipedia.org/wiki/圆柱坐标系 "wikilink")(*r*, θ,
...
一种减缓趋肤效应的方法是采用所谓的[利兹线](https://zh.wikipedia.org/wiki/利兹线 "wikilink")（源自[德语](../Page/德语.md "wikilink")：*Litzendraht*，意为“编织起来的线”）。利兹线采用将多条金属导线相互缠绕的方法，使得电磁场能够比较均匀地分布，这样各导线上的电流分布就会较为平均。使用利兹线后，产生显著趋肤效应的频率可以从数千[赫兹提高到数兆](../Page/赫兹.md "wikilink")[赫兹](../Page/赫兹.md "wikilink")。利兹线一般应用在高频交流电的传输中，可以同时减缓趋肤效应和邻近效应。
...
趋肤效应使得交变电流只通过导体的表面，因此电流只在其表面产生热效应。[钢铁工业中利用趋肤效应来为](https://zh.wikipedia.org/wiki/钢铁 "wikilink")[钢进行](../Page/钢.md "wikilink")[表面淬火](https://zh.wikipedia.org/wiki/表面淬火 "wikilink")，使钢材表面的[硬度增大](https://zh.wikipedia.org/wiki/硬度 "wikilink")。

趋肤效应也可以描述为：导体中交变[电磁场的强度随着进入导体的深度而呈指数递减](../Page/电磁场.md "wikilink")，因此在[防晒霜中混入导体微粒](https://zh.wikipedia.org/wiki/防晒霜 "wikilink")（一般是[氧化锌和](https://zh.wikipedia.org/wiki/氧化锌 "wikilink")[氧化钛](https://zh.wikipedia.org/wiki/氧化钛 "wikilink")），就能使阳光中的[紫外线](../Page/紫外线.md "wikilink")（高频[电磁波](https://zh.wikipedia.org/wiki/电磁波 "wikilink")）的强度减低。这便是物理防晒的原理之一。此外，趋肤效应也是[电磁屏蔽的方法之一](https://zh.wikipedia.org/wiki/电磁屏蔽 "wikilink")，利用趋肤效应可以阻止高频电磁波透入良导体而作成电磁屏蔽装置，这也是电梯里手机信号不好的原因。

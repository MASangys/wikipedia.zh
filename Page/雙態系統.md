...
在[量子力學裏](https://zh.wikipedia.org/wiki/量子力學 "wikilink")，**雙態系統**是一種擁有兩個互相獨立的[量子態的量子系統](../Page/量子態.md "wikilink")。更正式地說，雙態系統的[希爾伯特空間是二維的](https://zh.wikipedia.org/wiki/希爾伯特空間 "wikilink")，[自由度是](https://zh.wikipedia.org/wiki/自由度 "wikilink")2。注意，这并不是指该系统只有两个量子态，因为根据量子力学公设[态叠加原理](../Page/态叠加原理.md "wikilink")，系统可以处于这两个独立量子态的任意叠加态。
...
[氨分子的位於頂點的](../Page/氨.md "wikilink")[氮原子可以處於兩種量子態](../Page/氮.md "wikilink")，在由三個[氫原子設定的平面的上面](../Page/氫原子.md "wikilink")，稱為「上」量子態，或是這平面的下面，稱為「下」量子態。所以，氨分子是一個雙態系統。由於上量子態與下量子態的能級相等，這雙態系統[簡併](https://zh.wikipedia.org/wiki/簡併 "wikilink")。在一個垂直於氫原子平面的[電場](../Page/電場.md "wikilink")\(\mathbf{E}=\mathcal{E} \hat{\mathbf{z}}\,\!\)裏，由於氨分子具有從氮原子指向氫原子的[電偶極矩](https://zh.wikipedia.org/wiki/電偶極矩 "wikilink")\(\mathbf{p}=p \hat{\mathbf{z}}\,\!\)，造成了上量子態與下量子態的能級分裂。因為這作用，必須添加\(- \mathbf{p}\mathbf{E}\,\!\)這項目在哈密頓算符\(H\,\!\)裏。假若原本的能級為\(E_0\,\!\)，上量子態的能級會增加為\(E_0+|p|\mathcal{E}\,\!\)；而下量子態的能級會降低為\(E_0 - |p|\mathcal{E}\,\!\)。所以，雙態系統變成不簡併系統。

### 量子計算機

在[量子資訊科學裡](https://zh.wikipedia.org/wiki/量子資訊科學 "wikilink")，[量子位元概念的基礎是雙態系統模型](../Page/量子位元.md "wikilink")。任何[量子計算操作是一個統一的操作在](../Page/量子计算机.md "wikilink")[布洛赫球面旋轉狀態向量](../Page/布洛赫球面.md "wikilink")。

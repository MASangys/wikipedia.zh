在[數位信號處理和離散時間的](https://zh.wikipedia.org/wiki/數位信號處理 "wikilink")[控制理論中](https://zh.wikipedia.org/wiki/控制理論 "wikilink")，**雙線性變換**
(即
**[Tustin變換](https://zh.wikipedia.org/wiki/Arnold_Tustin "wikilink")**)被用來在連續時間系統與離散時間系統做轉換。

雙線性變換是一種特別的[共行映射](https://zh.wikipedia.org/wiki/共行映射 "wikilink")(即[莫比烏斯變換](https://zh.wikipedia.org/wiki/莫比烏斯變換 "wikilink"))，常被用來將[線性非時變系統濾波器在連續時域的](../Page/线性时不变系统理论.md "wikilink")[傳遞函數](https://zh.wikipedia.org/wiki/傳遞函數 "wikilink")
\(H_a(s) \\)轉換成線性且平移不變濾波器在離散時域的[傳遞函數](https://zh.wikipedia.org/wiki/傳遞函數 "wikilink")
\(H_d(z) \\)。將[S平面中位置在](https://zh.wikipedia.org/wiki/S平面 "wikilink")\(j \omega \\)軸的點映射到[複數平面上的](https://zh.wikipedia.org/wiki/複數平面 "wikilink")[單位圓](https://zh.wikipedia.org/wiki/單位圓 "wikilink")
\(|z| = 1 \\)。其他的應用還有扭曲任何的離散時間線性系統的[頻率響應](https://zh.wikipedia.org/wiki/頻率響應 "wikilink")(例如用來估計人類聽覺系統的非線性頻率解析度)或是被用在離散域以取代一個系統經過一階全通濾波器的單位延遲\(\left( z^{-1} \right) \\)。

這種變換保有[穩定性且將連續時間濾波器的](../Page/有界輸入有界輸出穩定性.md "wikilink")[頻率響應](https://zh.wikipedia.org/wiki/頻率響應 "wikilink")
\(H_a(j \omega_a) \\)中每一點映射到離散時間濾波器的頻率響應\(H_d(e^{j \omega_d T}) \\)中所對應的點，雖然頻率會有點不同，這部分會在之後的[頻率扭曲中解釋](https://zh.wikipedia.org/wiki/#頻率扭曲 "wikilink")。對於類比濾波器的頻率響應中所看到的特徵，在數位濾波器的頻率響應中都有相同增益和相位平移的對應特徵，雖然頻率可能會有點不同，在低頻時很難觀察到但在頻率接近[奈奎斯特頻率時就相當明顯](https://zh.wikipedia.org/wiki/奈奎斯特頻率 "wikilink")。
...
同樣地，如果有一個連續時間的濾波器，其傳遞函數的[零點落在](https://zh.wikipedia.org/wiki/零點 "wikilink")[複數](https://zh.wikipedia.org/wiki/複數 "wikilink")[S平面的左半邊](https://zh.wikipedia.org/wiki/S平面 "wikilink")，此濾波器則有[最小相位性質](https://zh.wikipedia.org/wiki/最小相位 "wikilink")。如果有一個離散時間且有因果性的濾波器，其傳遞函數的[零點落在](https://zh.wikipedia.org/wiki/零點 "wikilink")[複數Z平面的單位圓內](https://zh.wikipedia.org/wiki/複數 "wikilink")，此濾波器則有最小相位性質。透過相同的映射性質，可以保證有最小相位性質的連續時間濾波器被轉換成離散時間濾波器後也保有最小性質。

## 例子

以一個簡單的[低通](https://zh.wikipedia.org/wiki/低通濾波器 "wikilink")[RC電路當例子](../Page/RC電路.md "wikilink")，這種連續時間濾波器的傳遞函數為
...
為了要計算連續時間濾波器的頻率響應，會去計算[傳遞函數](https://zh.wikipedia.org/wiki/傳遞函數 "wikilink")
\(H_a(s) \\)在\(j \omega \\)軸上的值(\(s = j \omega \\))。相同地，為了要計算離散時間濾波器的頻率響應，會去計算在單位圓上[傳遞函數](https://zh.wikipedia.org/wiki/傳遞函數 "wikilink")

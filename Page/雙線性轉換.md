...
同樣地，如果有一個連續時間的濾波器，其傳遞函數的[零點落在](https://zh.wikipedia.org/wiki/零點 "wikilink")[複數](https://zh.wikipedia.org/wiki/複數 "wikilink")[S平面的左半邊](https://zh.wikipedia.org/wiki/S平面 "wikilink")，此濾波器則有[最小相位性質](../Page/最小相位.md "wikilink")。如果有一個離散時間且有因果性的濾波器，其傳遞函數的[零點落在](https://zh.wikipedia.org/wiki/零點 "wikilink")[複數Z平面的單位圓內](https://zh.wikipedia.org/wiki/複數 "wikilink")，此濾波器則有最小相位性質。透過相同的映射性質，可以保證有最小相位性質的連續時間濾波器被轉換成離散時間濾波器後也保有最小性質。

...
 \(\nabla^4\)
為四階的 [Nabla算子](../Page/Nabla算子.md "wikilink")，或是[拉普拉斯算子的平方](../Page/拉普拉斯算子.md "wikilink")，稱為雙調和**算子**。
在 n 維座標下，以[爱因斯坦求和约定可寫成](../Page/爱因斯坦求和约定.md "wikilink") \(\)\(\)\(\)
...
雙調和方程式的解為雙調和函數。任何[調和函數都是雙調和函數](https://zh.wikipedia.org/wiki/調和函數 "wikilink")，但雙調和函數不一定是[調和函數](https://zh.wikipedia.org/wiki/調和函數 "wikilink")。
在二維極坐標中，雙調和方程為
...
可用[分離變數法求解](../Page/分離變數法.md "wikilink")，其解為  。

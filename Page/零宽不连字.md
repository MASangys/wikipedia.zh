...
**零宽不连字**
([英文](https://zh.wikipedia.org/wiki/英文 "wikilink")：**zero-width
non-joiner**，[縮寫](../Page/縮寫.md "wikilink")：**ZWNJ**)是一个[不打印字符](../Page/控制字符.md "wikilink")，放在电子文本的两个字符之间，抑制本来会发生的[连字](https://zh.wikipedia.org/wiki/连字 "wikilink")，而是以这两个字符原本的字形来绘制。[Unicode中的零宽不连字字符映射为](https://zh.wikipedia.org/wiki/Unicode "wikilink")，[HTML](../Page/HTML.md "wikilink")[字符值引用为](https://zh.wikipedia.org/wiki/字符值引用 "wikilink")：
‌
...
[卡纳达文中](https://zh.wikipedia.org/wiki/卡纳达文 "wikilink")，ನ್ 和 ನ 会组成
ನ್ನ，但插入零宽不连字符以后，会变成 ನ್‌ನ。这个样式可用于以卡纳达文中的非卡纳达语词汇。如 Facebook
会排成 ಫೇಸ್‌ಬುಕ್，即使可能会排成 ಫೇಸ್ಬುಕ್。
...
## 外部链接
  ...
  - [Using the ZWNJ in
    Persian](https://web.archive.org/web/20120708235820/http://persian.nmelrc.org/persianword/zwnj.htm)

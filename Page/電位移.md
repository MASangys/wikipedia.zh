在[電磁學裏](https://zh.wikipedia.org/wiki/電磁學 "wikilink")，**電位移**是出現於[馬克士威方程組的一種](../Page/馬克士威方程組.md "wikilink")[向量場](https://zh.wikipedia.org/wiki/向量場 "wikilink")，可以用來解釋[電介質內](https://zh.wikipedia.org/wiki/電介質 "wikilink")[自由電荷所產生的效應](https://zh.wikipedia.org/wiki/自由電荷 "wikilink")。電位移\(\mathbf{D}\)以方程式定義為\[1\]

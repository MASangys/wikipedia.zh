...
除了速度之外，ENIAC最引人注目的就是它的体积和复杂性。ENIAC包含了17468个[真空管](../Page/真空管.md "wikilink")、7200个晶体[二极管](https://zh.wikipedia.org/wiki/二极管 "wikilink")、1500个[继电器](../Page/继电器.md "wikilink")、10000个[电容器](../Page/电容器.md "wikilink")，还有大约五百万个手工[焊接](../Page/焊接.md "wikilink")头。它的重量达27[吨](https://zh.wikipedia.org/wiki/公吨 "wikilink")（30[美吨](https://zh.wikipedia.org/wiki/美吨 "wikilink")），体积大约是2.4[m](https://zh.wikipedia.org/wiki/公尺 "wikilink")×0.9m×30m（8×3×100[英尺](https://zh.wikipedia.org/wiki/英尺 "wikilink")），占地167[平方米](../Page/平方米.md "wikilink")（1800[平方英尺](https://zh.wikipedia.org/wiki/平方英尺 "wikilink")），耗电150[千瓦](https://zh.wikipedia.org/wiki/千瓦 "wikilink")\[12\]\[13\]（导致有传言说，每当这台计算机启动的时候，[费城的灯都变暗了](https://zh.wikipedia.org/wiki/费城 "wikilink")\[14\]）。[IBM](../Page/IBM.md "wikilink")的卡片阅读器用于输入，打卡器用于输出。使用IBM会计机（比如[IBM 405](https://zh.wikipedia.org/wiki/IBM_405 "wikilink")）可将这些卡片用于离线产生输出。
...
通过将两个累加器用线连接起来，可以实现[双精度计算](https://zh.wikipedia.org/wiki/双精度 "wikilink")，不过累加器进行电路时序控制，防止三个或更多的累加器被连接起来导致精度更高。ENIAC中的四个累加器被一个特殊的“乘法器”单元所控制，每秒可进行385次乘法操作。还有五个累加器被一个特殊的“除法器/平方-平方根器”单元，每秒可进行四十次除法运算或三次求[平方根](../Page/平方根.md "wikilink")运算。

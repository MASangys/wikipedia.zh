...
**電子數值積分計算機**（），由其縮寫，簡稱為**伊尼亞克**（，，也可称**埃尼阿克**）\[1\]\[2\]是世界上第一台通用[计算机](https://zh.wikipedia.org/wiki/计算机 "wikilink")。它是[图灵完全的电子计算机](https://zh.wikipedia.org/wiki/图灵完全 "wikilink")，能够重新编程，解决各种计算问题\[3\]。

ENIAC为[美国陆军的弹道研究实验室](../Page/美国陆军.md "wikilink")（BRL）所使用，用于计算[火炮的](https://zh.wikipedia.org/wiki/火炮 "wikilink")[火力表](https://zh.wikipedia.org/wiki/外弹道 "wikilink")\[4\]\[5\]。ENIAC在1946年公布的时候，就被当时的新闻赞誉为“巨脑”。它的计算速度比机电机器提高了一千倍。这是一个飞跃，之前没有任何一台单独的机器达到过这个速度。它的数学能力和通用的可编程能力，令当时的科学家和实业家非常激动。发明它的人为了进一步推广这些新思想，举办了一系列关于[计算机体系结构的讲座](https://zh.wikipedia.org/wiki/计算机体系结构 "wikilink")。
...
ENIAC是宾夕法尼亚大学的约翰·莫齐利和J.·Presper·埃克特构思和设计的\[10\]。协助开发的设计工程师团队包括罗伯特·F·肖（函数表）、[朱传榘](https://zh.wikipedia.org/wiki/朱传榘 "wikilink")（除法器/平方-平方根器）、托马斯·凯特·夏普勒斯（主程序器）、阿瑟·伯克斯（乘法器）、哈利·Huskey（读取器/打印器），还有杰克·戴维斯（累加器）。ENIAC在1987年被评为[IEEE里程碑之一](https://zh.wikipedia.org/wiki/IEEE "wikilink")\[11\]。
...
除了速度之外，ENIAC最引人注目的就是它的体积和复杂性。ENIAC包含了17468个[真空管](../Page/真空管.md "wikilink")、7200个晶体[二极管](https://zh.wikipedia.org/wiki/二极管 "wikilink")、1500个[继电器](../Page/继电器.md "wikilink")、10000个[电容器](../Page/电容器.md "wikilink")，还有大约五百万个手工[焊接头](../Page/焊接.md "wikilink")。它的重量达27[吨](https://zh.wikipedia.org/wiki/公吨 "wikilink")（30[美吨](https://zh.wikipedia.org/wiki/美吨 "wikilink")），体积大约是2.4[m](https://zh.wikipedia.org/wiki/公尺 "wikilink")×0.9m×30m（8×3×100[英尺](https://zh.wikipedia.org/wiki/英尺 "wikilink")），占地167[平方米](../Page/平方米.md "wikilink")（1800[平方英尺](https://zh.wikipedia.org/wiki/平方英尺 "wikilink")），耗电150[千瓦](https://zh.wikipedia.org/wiki/千瓦 "wikilink")\[12\]\[13\]（导致有传言说，每当这台计算机启动的时候，[费城的灯都变暗了](https://zh.wikipedia.org/wiki/费城 "wikilink")\[14\]）。[IBM的卡片阅读器用于输入](../Page/IBM.md "wikilink")，打卡器用于输出。使用IBM会计机（比如[IBM
...
通过将两个累加器用线连接起来，可以实现[双精度计算](https://zh.wikipedia.org/wiki/双精度 "wikilink")，不过累加器进行电路时序控制，防止三个或更多的累加器被连接起来导致精度更高。ENIAC中的四个累加器被一个特殊的“乘法器”单元所控制，每秒可进行385次乘法操作。还有五个累加器被一个特殊的“除法器/平方-平方根器”单元，每秒可进行四十次除法运算或三次求[平方根运算](../Page/平方根.md "wikilink")。
...
ENIAC使用普通的八脚[电子管](https://zh.wikipedia.org/wiki/电子管 "wikilink")，十进制累加器用[6SN7](https://zh.wikipedia.org/wiki/6SN7 "wikilink")[触发器制成](../Page/触发器.md "wikilink")，6L7、6SJ7、6SA7，和6AC7用于逻辑功能。无数的[6L6和](https://zh.wikipedia.org/wiki/6L6 "wikilink")[6V6用作线路驱动器](https://zh.wikipedia.org/wiki/6V6 "wikilink")，驱动着脉冲从机架组件间通过电缆传递。
...
Z3和Colossus计算机都是独立于彼此，并且独立于ABC和ENIAC开发的。Z3计算机毁于1943年盟军轰炸柏林。Colossus计算机是英国战争成就的一部分。它们的存在直到1970年才为公众所知，虽然它们的能力仍然只有开发它们的英国相关人员以及被邀请的美国人才知道。这些机器中，只有两台一直在英国[政府通信总部](https://zh.wikipedia.org/wiki/政府通信总部 "wikilink")（GCHQ）使用到了1960年，其余的都在1945年毁坏了。ABC计算机是在约翰·阿塔纳索夫被征召去[华盛顿为美国海军做物理研究后](../Page/华盛顿哥伦比亚特区.md "wikilink")，被[艾奥瓦州立大学拆掉了](https://zh.wikipedia.org/wiki/艾奥瓦州立大学 "wikilink")。相比之下，ENIAC在1946年大展它的能力，“吸引了全世界的想象力”\[27\]。或许正因如此，更古老的计算机历史与这个时期相比，在其覆盖和分析上并不是很全面。
...
宾夕法尼亚大学工程和应用科学学院拥有ENIAC原始的四十个面板中的四个，和三个函数表中的一个。[史密森尼学会在](../Page/史密森尼学会.md "wikilink")[美國國家歷史博物館拥有五个面板](https://zh.wikipedia.org/wiki/美國國家歷史博物館 "wikilink")。[伦敦科学博物馆展览着一个面板](../Page/科学博物馆_\(伦敦\).md "wikilink")。[密歇根大学在Ann](../Page/密歇根大学.md "wikilink")
Arbor校园拥有阿瑟·伯克斯抢救的四个面板。位于美国[马里兰州](../Page/马里兰州.md "wikilink")[阿伯丁试验场的美国陆军军械博物馆](../Page/阿伯丁试验场.md "wikilink")，也就是ENIAC使用的地方，拥有一个函数表。另外还有一个面板在位于美国[得克萨斯州](https://zh.wikipedia.org/wiki/得克萨斯州 "wikilink")[普莱诺市的佩罗系统展览](../Page/普莱诺_\(得克萨斯州\).md "wikilink")。
...
<!-- end list -->
  ...
  - [Eckert, J.
    Presper](https://zh.wikipedia.org/wiki/J._Presper_Eckert "wikilink"),
    *The ENIAC* (in Nicholas Metropolis, [J.
    Howlett](https://zh.wikipedia.org/wiki/Jack_Howlett "wikilink"),
...
<!-- end list -->
  ...
  - [Eckert, J.
    Presper](https://zh.wikipedia.org/wiki/J._Presper_Eckert "wikilink")
    and [John
    Mauchly](https://zh.wikipedia.org/wiki/John_Mauchly "wikilink"),
    1946, *Outline of plans for development of electronic computers*, 6
    pages. (The founding document in the electronic computer industry.)
...
<!-- end list -->
  ...
  - [Mauchly,
    John](https://zh.wikipedia.org/wiki/John_Mauchly "wikilink"), *The
    ENIAC* (in Metropolis, Nicholas, [Howlett,
    Jack](https://zh.wikipedia.org/wiki/Jack_Howlett "wikilink"); Rota,
    Gian-Carlo. 1980, *A History of Computing in the Twentieth Century*,
    [Academic
    Press](https://zh.wikipedia.org/wiki/Academic_Press "wikilink"), New
    York, , pp. 541–550, "Original versions of these papers were
    presented at the International Research Conference on the History of
    Computing, held at the [Los Alamos Scientific
    Laboratory](https://zh.wikipedia.org/wiki/Los_Alamos_Scientific_Laboratory "wikilink"),
    10–15 June 1976.")
...
## 延伸阅读
  ...
  - Hally, Mike. *Electronic Brains: Stories from the Dawn of the
    Computer Age*, [Joseph
    Henry](https://zh.wikipedia.org/wiki/Joseph_Henry "wikilink") Press,
    2005.

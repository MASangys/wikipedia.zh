[Capacitor.png](https://zh.wikipedia.org/wiki/File:Capacitor.png "fig:Capacitor.png")兩端的[電位差](https://zh.wikipedia.org/wiki/電位差 "wikilink")，正電荷與負電荷會分別累積於兩片平行薄板導體。\]\]
在[電路學裡](../Page/電路學.md "wikilink")，給定[電壓](../Page/電壓.md "wikilink")，[電容器儲存](https://zh.wikipedia.org/wiki/電容器 "wikilink")[電荷的能力](../Page/電荷.md "wikilink")，稱為**電容**（），標記為**C**。採用[國際單位制](https://zh.wikipedia.org/wiki/國際單位制 "wikilink")，電容的單位是[法拉](../Page/法拉.md "wikilink")（），標記為**F**。電路圖中多半以C開頭標示電容，例：C01、C02、C03、C100等。

平行板[電容器是一種簡單的電容器](https://zh.wikipedia.org/wiki/電容器 "wikilink")，是由互相平行、以空間或[介電質隔離的兩片薄板](../Page/介電質.md "wikilink")[導體構成](https://zh.wikipedia.org/wiki/導體 "wikilink")。假設這兩片導板分別載有負電荷與正電荷，所載有的電荷量分別為\(-Q\,\!\)、\(+Q\,\!\)，兩片導板之間的電位差為\(V\)，則這電容器的電容\(C\)為
...
許多常用的電介質，其[電容率會隨著外電場的變化而改變](https://zh.wikipedia.org/wiki/電容率 "wikilink")，是外電場的函數。[鐵電性物質就是這種電介質](https://zh.wikipedia.org/wiki/鐵電性 "wikilink")。使用這種電介質的電容器，其電容會比較複雜。例如，當這種電容器在充電時，電荷與電壓（電位差）的關係為
...
當頻率為[光學頻率時](https://zh.wikipedia.org/wiki/光學 "wikilink")，[半導體的電容會展示出類似固體的能帶結構](https://zh.wikipedia.org/wiki/半導體 "wikilink")。精密的[調制光譜學](https://zh.wikipedia.org/wiki/調制光譜學 "wikilink")（）測量方法，使用[壓力或其它種](https://zh.wikipedia.org/wiki/壓力 "wikilink")[應力來調制晶體結構](../Page/應力.md "wikilink")，然後觀測光波的吸收或反射的相關變化。這方法貢獻出很多關於這些物質的性質的結果\[13\]。
...
任意兩個相鄰導體，除非長久保持很近的距離，其電容通常很微小，但仍舊可以被視為電容器。這不受歡迎的效應稱為「雜散電容」。原本各自孤立的電路，由於雜散電容的作用，可能會讓兩個電路互相干擾對方的信號，這效應稱為[串擾](https://zh.wikipedia.org/wiki/串擾 "wikilink")。雜散電容是電路在[短波波段正常操作的限制因子](../Page/短波.md "wikilink")。

[Capacitor.png](https://zh.wikipedia.org/wiki/File:Capacitor.png "fig:Capacitor.png")兩端的[電位差](../Page/電位差.md "wikilink")，正電荷與負電荷會分別累積於兩片平行薄板導體。\]\]
在[電路學裡](../Page/電路學.md "wikilink")，給定[電壓](../Page/電壓.md "wikilink")，[電容器儲存](../Page/電容器.md "wikilink")[電荷的能力](../Page/電荷.md "wikilink")，稱為**電容**（），標記為**C**。採用[國際單位制](../Page/國際單位制.md "wikilink")，電容的單位是[法拉](../Page/法拉.md "wikilink")（），標記為**F**。電路圖中多半以C開頭標示電容，例：C01、C02、C03、C100等。

平行板[電容器是一種簡單的電容器](../Page/電容器.md "wikilink")，是由互相平行、以空間或[介電質隔離的兩片薄板](../Page/介電質.md "wikilink")[導體構成](../Page/導體.md "wikilink")。假設這兩片導板分別載有負電荷與正電荷，所載有的電荷量分別為\(-Q\,\!\)、\(+Q\,\!\)，兩片導板之間的電位差為\(V\)，則這電容器的電容\(C\)為

\[C = \frac{Q}{V}\]。

1法拉等於1[庫侖每](../Page/庫侖.md "wikilink")[伏特](../Page/伏特.md "wikilink")，即電容為1法拉的電容器，在正常操作範圍內，每增加1伏特的電位差可以多儲存1庫侖的電荷。
...
电容的单位是法拉，简称“法”，单位符号为“F”，是[国际单位制导出单位](../Page/国际单位制导出单位.md "wikilink")\[1\]。一般來說，1法拉算是很大的電容，大多數用於[電子電路的電容器](../Page/電子電路.md "wikilink")，其電容會小於法拉幾個數量級，因此，常用的單位有較小的「微法拉」（microfarad，μF），等於\(10^{-6}\)法拉；以及「纳法拉」（nanofarad，nF），等於\(10^{-9}\)法拉；以及更小的「皮法拉」（picofarad，pF），等於\(10^{-12}\)法拉。
...
應用[高斯定律](../Page/高斯定律.md "wikilink")（詳盡細節，請參閱條目[電位移](../Page/電位移#應用範例.md "wikilink")），在兩片導板之間的[電場](../Page/電場.md "wikilink")\(E\)為

\[E=\sigma/\varepsilon= Q/\varepsilon A\]；

其中，\(\varepsilon\)是介質的[電容率](../Page/電容率.md "wikilink")。
...
[Ferroelectric_polarisation.svg](https://zh.wikipedia.org/wiki/File:Ferroelectric_polarisation.svg "fig:Ferroelectric_polarisation.svg")\(P\)對電場\(E\)的曲線顯示出[遲滯現象](../Page/遲滯現象.md "wikilink")。\]\]
許多常用的電介質，其[電容率會隨著外電場的變化而改變](../Page/電容率.md "wikilink")，是外電場的函數。[鐵電性物質就是這種電介質](../Page/鐵電性.md "wikilink")。使用這種電介質的電容器，其電容會比較複雜。例如，當這種電容器在充電時，電荷與電壓（電位差）的關係為
...
這電場將電介質電極化，從而增加導板儲存電荷的能力。如右圖所示，對於鐵電性物質，[電極化強度對電場曲線顯示出](../Page/電極化強度.md "wikilink")[遲滯現象](../Page/遲滯現象.md "wikilink")\[3\]\[4\]。這是一個非線性關係。

假設[電極化強度](../Page/電極化強度.md "wikilink")\(P\)與電場、電壓的關係為
...
儲存於電容器的微分[能量為](../Page/能量.md "wikilink")
...
[掃描非線性介質顯微鏡](../Page/掃描非線性介質顯微鏡.md "wikilink")（）的探針掃描於鐵電性物質表面所測量到的非線性電容，可以用來研究鐵電性物質的鐵電疇（）結構\[5\]。

有些[半導體元件的電容可以用電壓控制](../Page/半導體元件.md "wikilink")。例如，當[變容二極體的逆向偏壓增加時](../Page/變容二極體.md "wikilink")，空乏層厚度也會增加，因而使得電容降低\[6\]。

### 頻率依賴性電容器

假若電容器兩端驅動的含時電壓變化太快，則電介質的電極化強度可能會無法跟上訊號。從微觀層次解釋這機制，在電介質內部，決定電容率的微小[電偶極子無法瞬時地移動](../Page/電偶極子.md "wikilink")，因此，當施加的交流電壓的頻率增加時，電偶極子只能給出有限的響應，從而造成[電容率降低](../Page/電容率.md "wikilink")。電容率與頻率的關係稱為[介電色散](../Page/介電色散.md "wikilink")（），是由[介電弛豫](../Page/介電弛豫.md "wikilink")（）過程所主控，像[德拜弛豫](../Page/德拜弛豫.md "wikilink")（）。從更基本的微觀分析來計算，例如對於介質內的電偶極子行為的微觀分析，處於暫態狀況，電位移場可以表達為（更詳盡細節，請參閱[電極化率](../Page/電極化率.md "wikilink")）

\[\boldsymbol D (t) = \frac{\varepsilon_0}{\sqrt{2\pi}} \int_{-\infty}^t \mathrm{d}t' \ \varepsilon_r (t-t') \boldsymbol E (t')\]；

其中，\(\varepsilon_0\)是[電常數](../Page/電常數.md "wikilink")，\(\varepsilon_r\ \stackrel{def}{=}\ \varepsilon/\varepsilon_0\)是[相對電容率](../Page/相對電容率.md "wikilink")。

相對電容率的時間依賴可以用[線性響應函數](../Page/線性響應函數.md "wikilink")（）來描述\[7\]。上述方程式顯示出相對電容率的時間依賴所產生的滯後響應。這積分式的積分域從整個過去歷史一直延伸至現時。假設每當\(\Delta t < 0\,\!\)時，\(\varepsilon_r(\Delta t) = 0\,\!\)，則這積分的上限可以延伸至無窮大：

\[\boldsymbol D (t) = \frac{\varepsilon_0}{\sqrt{2\pi}} \int_{-\infty}^\infty \mathrm{d}t' \ \varepsilon_r (t-t') \boldsymbol E (t')\]。

對於時間做[傅立葉變換](../Page/傅立葉變換.md "wikilink")，根據[摺積定理](../Page/摺積定理.md "wikilink")，可以得到

\[\boldsymbol D(\omega) = \varepsilon_0 \varepsilon_r(\omega)\boldsymbol E (\omega)\]；

其中，\(\omega\)是[角頻率](../Page/角頻率.md "wikilink")。

\(\varepsilon_r(\omega)\)是[複函數](../Page/複函數.md "wikilink")，其虛值部分與介質的電場能量吸收有關。更詳盡細節，請參閱條目[電容率](../Page/電容率#複值電容率.md "wikilink")。由於電容與電容率成正比，電容也具有這頻率行為。對於時間做傅立葉變換於高斯定律：
...
其中，\(j\)是[虛數單位](../Page/虛數單位.md "wikilink")，\(G(\omega)\)、\(C(\omega)\)、\(V(\omega)\)、\(Z(\omega)\)、分別是角頻率空間的[電導](../Page/電導.md "wikilink")、電容、電壓、複值[阻抗](../Page/阻抗.md "wikilink")。
...
其中，\(\varepsilon_{r}' (\omega)\)是實值部分，\(\varepsilon_{r}'' (\omega)\)是虛值部分，\(C(\omega)\)是填滿電介質時的複值電容，\(C_0\)是沒有電介質時的電容（即平行板電容器的兩片導板之間是[自由空間時的電容](../Page/自由空間.md "wikilink")）。

[深能級暫態譜學](../Page/深能級暫態譜學.md "wikilink")（）利用電容的時間響應來研究[半導體的深能級缺陷](../Page/半導體.md "wikilink")\[9\]。按照能級在半導體[能隙的位置](../Page/能隙.md "wikilink")，缺陷分類為淺能級缺陷和深能級缺陷。淺能級缺陷的能級離[導帶或](../Page/導帶.md "wikilink")[價帶的](../Page/價帶.md "wikilink")[能帶邊緣比較近](../Page/能帶.md "wikilink")，在0.1eV以內，處於這能級的電子或電洞很容易因熱運動而變成自由電子或自由電洞；一般而言，深能級缺陷離能帶邊緣比較遠，超過0.1eV。但也有些物質的深能級缺陷離能帶邊緣雖然只有0.001eV，仍舊能夠顯示出深能級缺陷的通常性質\[10\]。

[金屬氧化物半導體電容器](../Page/金屬氧化物半導體電容器.md "wikilink")（）是另一個電容與頻率有關的例子。對於這案例，[少數載流子的緩慢生成意味著在高頻率狀況](../Page/載流子.md "wikilink")，只有[多數載流子的響應能夠貢獻出電容](../Page/載流子.md "wikilink")，而在低頻率狀況，兩種載流子的響應都能夠貢獻出電容\[11\]\[12\]。

當頻率為[光學頻率時](../Page/光學.md "wikilink")，[半導體的電容會展示出類似固體的能帶結構](../Page/半導體.md "wikilink")。精密的[調制光譜學](../Page/調制光譜學.md "wikilink")（）測量方法，使用[壓力或其它種](../Page/壓力.md "wikilink")[應力來調制晶體結構](../Page/應力.md "wikilink")，然後觀測光波的吸收或反射的相關變化。這方法貢獻出很多關於這些物質的性質的結果\[13\]。
...
對於多個導體的案例，或當兩個導體所帶淨電荷量不等於零的案例，方程式\(C=Q/V\)不成立。為了處理這案例，[詹姆斯·馬克士威提出了](../Page/詹姆斯·馬克士威.md "wikilink")「電位係數」和「感應係數」（）的概念\[14\]。假設三個導體分別帶有電荷量\(Q_1\)、\(Q_2\)、\(Q_3\)，則這三個導體的[電位](../Page/電位.md "wikilink")\(V_1\)、\(V_2\)、\(V_3\)分別為
...
解析這[線性方程組](../Page/線性方程組.md "wikilink")，可以得到電荷量分別為
...
[赫爾曼·馮·亥姆霍茲和](../Page/赫爾曼·馮·亥姆霍茲.md "wikilink")[威廉·湯姆森證明這些電位係數與感應係數都具有對稱性](../Page/威廉·湯姆森.md "wikilink")\[15\]：
...
在[電路學裏](../Page/電路學.md "wikilink")，電容通常是術語「互電容」（）的簡稱，即兩個鄰近導體（像平行板電容器的兩片薄板）之間的電容。另外還有一種電路學性質術語「自電容」（），即單獨導體的電位每增加1V所需的電荷量。設定這電位等於零的參考點為一個理論球殼導體，其半徑為無窮遠，其球心與單獨導體同位置。假設這單獨導體是半徑為\(R\)的球形導體，則其球表面電位為
...
[范德格拉夫起電機頂端的圓球形金屬導體](../Page/范德格拉夫起電機.md "wikilink")，其半徑通常為20 cm，這金屬導體的自電容為
...
任意兩個相鄰導體，除非長久保持很近的距離，其電容通常很微小，但仍舊可以被視為電容器。這不受歡迎的效應稱為「雜散電容」。原本各自孤立的電路，由於雜散電容的作用，可能會讓兩個電路互相干擾對方的信號，這效應稱為[串擾](../Page/串擾.md "wikilink")。雜散電容是電路在[短波波段正常操作的限制因子](../Page/短波.md "wikilink")。

為了消除跟遠方形成的雜散電容，可以將電路裝置於金屬機殼內，再將金屬機殼跟[地線連結](../Page/地線.md "wikilink")。

## 簡單系統的電容

欲求得一個系統的電容，必須先解析[拉普拉斯方程式](../Page/拉普拉斯方程式.md "wikilink")\(\nabla^2\phi=0\)，並且滿足其邊界條件，即在每一個導體表面的電位\(\phi\)為某不同的已設定常數。對於具有高對稱性的案例，這方法很簡單。但是，對於較複雜案例，可能不存在以基本函數表示的解答。

對於準二維問題，不同的幾何構形之間可以用解析函數互相[映射](../Page/映射.md "wikilink")。詳盡細節，請參閱條目[施瓦茨-克里斯托費爾映射](../Page/施瓦茨-克里斯托費爾映射.md "wikilink")
...
<td><p><a href="https://zh.wikipedia.org/wiki/File:Plate_CapacitorII.svg" title="fig:Plate_CapacitorII.svg">Plate_CapacitorII.svg</a> <span class="math inline"><em>ε</em></span>: 介質的<a href="../Page/電容率.md" title="wikilink">電容率</a></p></td>
</tr>
<tr class="even">
<td><p>同軸電纜</p></td>
<td><p><span class="math inline">$\frac{2\pi \varepsilon l}{\ln ( R_2/R_1) }$</span></p></td>
<td><p><a href="https://zh.wikipedia.org/wiki/File:Cylindrical_CapacitorII.svg" title="fig:Cylindrical_CapacitorII.svg">Cylindrical_CapacitorII.svg</a> <span class="math inline"><em>ε</em></span>: 介質的<a href="../Page/電容率.md" title="wikilink">電容率</a></p></td>
</tr>
<tr class="odd">
...
<span class="math inline"><em>K</em></span>: <a href="../Page/橢圓積分.md" title="wikilink">橢圓積分</a><br />
...
<td><p><a href="https://zh.wikipedia.org/wiki/File:Spherical_Capacitor.svg" title="fig:Spherical_Capacitor.svg">Spherical_Capacitor.svg</a> <span class="math inline"><em>ε</em></span>: 介質的<a href="../Page/電容率.md" title="wikilink">電容率</a></p></td>
</tr>
<tr class="odd">
...
<span class="math inline"><em>γ</em></span>：<a href="../Page/歐拉-馬歇羅尼常數.md" title="wikilink">歐拉-馬歇羅尼常數</a></p></td>
</tr>
<tr class="even">
...
17. [新南威爾斯大學物理系講義](../Page/新南威爾斯大學.md "wikilink")：[電容與電介質](http://www.phys.unsw.edu.au/COURSES/FIRST_YEAR/pdf%20files/5Capacitanceanddielectr.pdf)

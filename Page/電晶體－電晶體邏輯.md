...
[7400.jpg](https://zh.wikipedia.org/wiki/File:7400.jpg "fig:7400.jpg") TTL最主要是由N組[電阻](https://zh.wikipedia.org/wiki/電阻 "wikilink")、[電晶體](https://zh.wikipedia.org/wiki/電晶體 "wikilink")、[二極體構成的偏壓電路所組合出來](https://zh.wikipedia.org/wiki/二極體 "wikilink")，在線性放大器的角度來看就是數個CE（共射極）電路或是CC（共集極）電路所組成。當然這只是比喻並非實際，畢竟在[數位邏輯的世界就是只有](https://zh.wikipedia.org/wiki/數位邏輯 "wikilink")0跟1，也就是關或開。

在[经典电磁学裏](../Page/经典电磁学.md "wikilink")，當給[電介質施加一個](https://zh.wikipedia.org/wiki/電介質 "wikilink")[電場時](../Page/電場.md "wikilink")，由於電介質內部正負[電荷的相對位移](../Page/電荷.md "wikilink")，會產生[電偶極子](https://zh.wikipedia.org/wiki/電偶極子 "wikilink")，這現象稱為**電極化**（）。施加的電場可能是外電場，也可能是嵌入[電介質內部的自由電荷所產生的電場](https://zh.wikipedia.org/wiki/電介質 "wikilink")。因為電極化而產生的電偶極子稱為“感應電偶極子”，其[電偶極矩稱為](https://zh.wikipedia.org/wiki/電偶極矩 "wikilink")“感應電偶極矩”。

電極化強度又稱為「電極化矢量」，定義為電介質內的電偶極矩[密度](../Page/密度.md "wikilink")，也就是單位體積的電偶極矩。這定義所指的電偶極矩包括永久電偶極矩和感應電偶極矩。它的[國際單位制度量單位是](https://zh.wikipedia.org/wiki/國際單位制 "wikilink")[庫侖每](https://zh.wikipedia.org/wiki/庫侖 "wikilink")[平方米](../Page/平方米.md "wikilink")（coulomb/m<sup>2</sup>），表示为矢量
**P**。\[1\]
...
这表明 **P**-场与[磁化强度](https://zh.wikipedia.org/wiki/磁化强度 "wikilink")
**M**-场是完全类似的：

\[\mathbf M={d\mathbf m \over dV},\quad\mathbf m=\iiint \mathbf M\, dV\]

对于由一个外加电场引起的 **P**
值的计算，必须已知电介质的[电极化率](https://zh.wikipedia.org/wiki/电极化率 "wikilink")
χ（见下文）。
...
[電磁學所講述的](https://zh.wikipedia.org/wiki/電磁學 "wikilink")[物理量大多都是](../Page/物理量.md "wikilink")[巨觀的平均值](https://zh.wikipedia.org/wiki/巨觀 "wikilink")，像電場平均值、偶極子密度平均值、電極化強度平均值等等，都是取於一個超大於原子尺寸的區域。只有這樣，科學家才能夠研究一個電介質的連續近似。而當研究[微觀問題時](../Page/微觀.md "wikilink")，對於在電介質內的單獨粒子，其[極化性跟電極化率平均值](../Page/極化性.md "wikilink")、電極化強度平均值的關係，可以用[克勞修斯-莫索提方程式來表達](https://zh.wikipedia.org/wiki/克勞修斯-莫索提方程式 "wikilink")。

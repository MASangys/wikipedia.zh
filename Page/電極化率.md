...
）來衡量。電極化率又可以用來計算物質的[電容率](https://zh.wikipedia.org/wiki/電容率 "wikilink")。因此，電極化率會影響這物質內各種其它可能發生的現象，像[電容器的](https://zh.wikipedia.org/wiki/電容器 "wikilink")[電容](../Page/電容.md "wikilink")、光波傳播於物質內部的[光速](../Page/光速.md "wikilink")等等。

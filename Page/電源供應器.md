...
**電腦電源供應單元**（，常直接以**電源供應器**稱之，簡稱**PSU**或**电源**）香港又稱**火牛**，(乃電牛也，電力供應者，源於早期變壓器造型似牛)。，是[電腦的一種電能轉換類的電源](https://zh.wikipedia.org/wiki/電腦 "wikilink")（有別於[電池供電類的電源](../Page/电池.md "wikilink")），負責將标准[交流電轉成低压穩定的](../Page/交流電.md "wikilink")[直流電](../Page/直流電.md "wikilink")，給電腦內其它的組件所使用。目前一般的電腦電源供應器都是[開關模式電源](../Page/開關模式電源.md "wikilink")，輸入電壓自動適應用家所在地點[市電參數](../Page/市電.md "wikilink")（而某些產品可能需要用家調整電壓切換開關）。
...
计算机电源将从[墙上插座获得的](../Page/家用交流電源插頭與插座.md "wikilink")[交流電转到为计算机处理器及外围设备使用的低電壓](../Page/交流電.md "wikilink")[直流電](../Page/直流電.md "wikilink")。由於不同組件所需的電壓不同，因此電源供應器需提供數個直流電壓；而電腦中各組件都需要穩定連續的直流電壓，因此電源供應器內必須配備電壓調節器/穩定器（[穩壓器](https://zh.wikipedia.org/wiki/穩壓器 "wikilink")），來提供精確的穩定的電壓值，來確保電腦各組件的正常運作。「電源軌」/“电源通道”（power
...
第一代微型计算机、家用電腦的电源供應器，是使用沉重的降压[变压器配合整流器](../Page/变压器.md "wikilink")、濾波元件和穩壓器組成的[線性電壓調節器](../Page/線性電壓調節器.md "wikilink")。而现代计算机則使用[開關模式電源](../Page/開關模式電源.md "wikilink")（SMPS）：[市電直接進行整流和濾波以後](../Page/市電.md "wikilink")，經高頻開關器件（像是[功率級BJT或](https://zh.wikipedia.org/wiki/双极性晶体管 "wikilink")）与铁氧体芯高频降壓变压器組成的隔離型DC-DC轉換裝置降低為數種直流電壓，再經穩壓、濾波裝置輸出供電腦使用的電能。开关型电源相对等效的线性电源要轻得多，成本更低，并且更有效率。\[1\]
...
由於是「一直開著」的設計，在發生[短路情況時](../Page/短路.md "wikilink")，要么[保險絲](../Page/保險絲.md "wikilink")/熔斷器燒斷或爆開，要么有開關模式的電源會頻繁斷電，需要等上一段時間然後嘗試重新開機。一些電源供應器頻繁地重新開機時會使電腦發出可聞的聲音，像是周邊裝置的「tick-tock」聲以及主機板[蜂鳴器的蜂鳴聲等等](https://zh.wikipedia.org/wiki/蜂鳴器 "wikilink")。
...
C14標準的交流電源連接器](https://zh.wikipedia.org/wiki/IEC_60320_C14 "wikilink")，相對交流電源連接器的另一面則引出多股附有連接器的電線組。可能還會帶有交流電源開關或是輸入交流電壓切換開關（也可能兩者均有）。
...
<!-- end list -->
  ...
  - 交流輸入：
      - 一個[IEC
        60320](https://zh.wikipedia.org/wiki/IEC_60320 "wikilink")（C13/C14）規範的連接器（插座與插頭）用作[市電輸入](../Page/市電.md "wikilink")。
...
mini](https://zh.wikipedia.org/wiki/Mac_mini "wikilink")、Intel
...
2.x版規範中的主機板電源連接器插座孔位俯視圖，上方是標準24針連接器插座，下方是「P4」的4針外掛CPU供電插座。\[22\]對於8針的外掛CPU供電插座，多出的4根針腳排布與原來4針的一樣，差別僅在於插座孔位的防呆設計](https://zh.wikipedia.org/wiki/File:ATX_PS_signals.svg "wikilink")
...
一般的安規[認證標誌](https://zh.wikipedia.org/wiki/認證標誌 "wikilink")（會因為銷售地區不同而有不同的認證）有[UL](../Page/保险商实验室.md "wikilink")（UL
60950-1）、[GS](https://zh.wikipedia.org/wiki/德國安全認證 "wikilink")、[TÜV](https://zh.wikipedia.org/wiki/TÜV組織 "wikilink")/cTUVus、[NEMKO](https://zh.wikipedia.org/wiki/NEMKO "wikilink")、[SEMKO](https://zh.wikipedia.org/wiki/SEMKO "wikilink")、DEMKO、FIMKO、[CCC](../Page/中國強制性產品認證.md "wikilink")/CUL、[CSA](https://zh.wikipedia.org/wiki/加拿大標準協會 "wikilink")、、GOST
R、BSMI以及[EN60950-1](https://zh.wikipedia.org/wiki/EN60950-1 "wikilink"):2006
+ A11 + A1 +
A12等。而一般的[電磁干擾認證標誌有](https://zh.wikipedia.org/wiki/電磁干擾 "wikilink")[FCC](https://zh.wikipedia.org/wiki/聯邦通信委員會 "wikilink")、[CE標誌以及C](../Page/歐洲合格認證.md "wikilink")-Click。在歐洲以及印度販售的電源供應器必須符合CE的標準並附帶CE標誌。另外，也有[RoHS環保標誌](../Page/危害性物質限制指令.md "wikilink")、[80

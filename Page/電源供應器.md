...
由於是「一直開著」的設計，在發生[短路情況時](../Page/短路.md "wikilink")，要么[保險絲](../Page/保險絲.md "wikilink")/熔斷器燒斷或爆開，要么有開關模式的電源會頻繁斷電，需要等上一段時間然後嘗試重新開機。一些電源供應器頻繁地重新開機時會使電腦發出聲音，像是周邊裝置的「tick-tock」聲以及主機板[蜂鳴器的蜂鳴聲等等](https://zh.wikipedia.org/wiki/蜂鳴器 "wikilink")。
...
NUC這樣的迷你主機會附帶一個20W至200W的電源[變壓器](../Page/变压器.md "wikilink")，筆電上也配備俗稱「火牛」的[變壓器供充電及無電池情形下使用](../Page/变压器.md "wikilink")，不過它們使用的一般是19V～24V直流輸入的規格（也有一部分仍是12V輸出規格），12V、5V、3.3V以及其它非ATX標準的電壓之轉換在主機板上完成\[19\]，這些已不屬於ATX規格的範疇。有些外置的電源供應器還能通過一些匯流排協定傳輸像是電流、電壓、功率等參數的資料到電腦主機板上供監測用，比如[戴爾的一些](../Page/戴爾.md "wikilink")[筆電](../Page/筆記型電腦.md "wikilink")，其配備的變壓器有1-Wire[匯流排與筆電電源的連接埠中特定腳位連接](../Page/总线.md "wikilink")（這樣的設計也使得其可能不相容副廠的變壓器）。\[20\]

...
**電腦電源供應單元**（，常直接以**電源供應器**稱之，簡稱**PSU**或**电源**）香港又稱**火牛**，(乃電牛也，電力供應者，源於早期變壓器造型似牛)。，是[電腦的一種電能轉換類的電源](https://zh.wikipedia.org/wiki/電腦 "wikilink")（有別於[電池供電類的電源](../Page/电池.md "wikilink")），負責將标准[交流電](../Page/交流電.md "wikilink")轉成低压穩定的[直流電](../Page/直流電.md "wikilink")，給電腦內其它的組件所使用。目前一般的電腦電源供應器都是[開關模式電源](../Page/開關模式電源.md "wikilink")，輸入電壓自動適應用家所在地點[市電](../Page/市電.md "wikilink")參數（而某些產品可能需要用家調整電壓切換開關）。

現時常用的[ATX規格](../Page/ATX規格.md "wikilink")PC電源供應器輸入電壓一般為100V至250V之間自動適應，輸入交流電頻率頻率50Hz或60Hz，輸出12V、5V及3.3V三種穩定的直流電壓。最新的ATX規格是2008年中發表的ATX
2.31版。

## 功能

计算机电源将从[墙上插座获得的](../Page/家用交流電源插頭與插座.md "wikilink")[交流電](../Page/交流電.md "wikilink")转到为计算机处理器及外围设备使用的低電壓[直流電](../Page/直流電.md "wikilink")。由於不同組件所需的電壓不同，因此電源供應器需提供數個直流電壓；而電腦中各組件都需要穩定連續的直流電壓，因此電源供應器內必須配備電壓調節器/穩定器（[穩壓器](https://zh.wikipedia.org/wiki/穩壓器 "wikilink")），來提供精確的穩定的電壓值，來確保電腦各組件的正常運作。「電源軌」/“电源通道”（power
...
System
Infrastructure，SSI）制定。SSI由英特爾、[戴爾](../Page/戴爾.md "wikilink")電腦、[惠普](../Page/惠普.md "wikilink")電腦以及其它設計製造伺服器的公司參與，目的是制定[伺服器的](../Page/服务器.md "wikilink")[行業標準](../Page/标准.md "wikilink")。EPS標準由ATX標準衍生而來，目前EPS標準規格的最新版本是2.93版。
...
<!-- end list -->
  ...
  - 交流輸入：
      - 一個[IEC
        60320](https://zh.wikipedia.org/wiki/IEC_60320 "wikilink")（C13/C14）規範的連接器（插座與插頭）用作[市電](../Page/市電.md "wikilink")輸入。
...
Image:PC PSU Noise Test Setup.svg|[漣波](../Page/漣波.md "wikilink")測試接線圖

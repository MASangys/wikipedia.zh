...
物理學家時常會用三維的[向量場來表達](https://zh.wikipedia.org/wiki/向量場 "wikilink")[電場和](../Page/電場.md "wikilink")[磁場](../Page/磁場.md "wikilink")。這些向量場在時空的每一點都有一個定義值，被認為是空間坐標和時間坐標的函數。電場和磁場分別寫為
...
[自由空間的電場和磁場](../Page/自由空間.md "wikilink")，不論是在靜電學裏，靜磁學裏或[電動力學裏](https://zh.wikipedia.org/wiki/電動力學 "wikilink")，都遵守[馬克士威方程組](../Page/馬克士威方程組.md "wikilink")\[1\]：
...
對於[線性物質](https://zh.wikipedia.org/wiki/線性 "wikilink")，馬克士威方程組內的電常數和磁常數，必須分別改換為線性物質的[電容率和](https://zh.wikipedia.org/wiki/電容率 "wikilink")[磁導率](https://zh.wikipedia.org/wiki/磁導率 "wikilink")。有些更複雜的物質，由於電磁場的作用，會給出更複雜的響應。這些性質可以用[張量來表示](../Page/張量.md "wikilink")。假若電磁場變化很快，張量可能會含時間。假若電磁場的場振幅很大，張量也可能會跟電磁場有關，顯示出非線性或非局域的物質響應。更詳盡細節，請參閱[光的色散和](https://zh.wikipedia.org/wiki/光的色散 "wikilink")[非線性光學](https://zh.wikipedia.org/wiki/非線性光學 "wikilink")。
...
移動的參考系S<sub>2</sub>時，可以用[勞侖茲變換來變換電場和磁場](https://zh.wikipedia.org/wiki/勞侖茲變換 "wikilink")，其方程式為
...
這並不意味分別處於兩個不同參考系的觀察者，所觀察到的是兩種完全不同的事件；它們所觀察到的是以兩種不同方式描述的同樣的事件。愛因斯坦在他的1905年論文裏所提到的[移動中的磁鐵與導體問題](../Page/移動中的磁鐵與導體問題.md "wikilink")，是個經典例子。如圖右所示，假若環狀[導線固定不動](https://zh.wikipedia.org/wiki/導線 "wikilink")，而[磁鐵以等速移動](../Page/磁鐵.md "wikilink")，則穿過環狀導線的[磁通量會隨著時間而改變](../Page/磁通量.md "wikilink")。按照[法拉第電磁感應定律](https://zh.wikipedia.org/wiki/法拉第電磁感應定律 "wikilink")，會產生[感應電動勢和伴隨的電場](../Page/電動勢.md "wikilink")，因而造成電流流動於環狀導線。可是，假若磁鐵固定不動，改由環狀導線以等速移動，則在環狀導線內部的電荷會因為感受到勞倫茲力而產生[動生電動勢和伴隨的電場](https://zh.wikipedia.org/wiki/動生電動勢 "wikilink")，因而造成電流流動於環狀導線。假設，對於這兩個案例，移動的速率相等，而方向相反。則感應出的電流是一樣的。

## 勢場表述

在解析有些電磁學問題時，物理學家會暫時不計算電場或磁場，而先計算伴隨的電勢或磁勢。[電勢](../Page/電勢.md "wikilink")
\(V\) 為純量，又被稱為純勢；磁勢 \(\mathbf A\)
為向量，又被稱為向量勢，或[磁矢勢](https://zh.wikipedia.org/wiki/磁矢勢 "wikilink")。從這些位勢，可以得到電場和磁場：
...
值得慶幸地是有一種方法可以簡化這兩個勢場方程式。由於勢場不是唯一定義的，只要最後計算得到正確的電場和磁場就行。這性質稱為[規範自由](https://zh.wikipedia.org/wiki/規範場論 "wikilink")。對於這兩個勢場方程式，選擇參數為位置和時間的任意函數
...
這規範自由可以用來簡化方程式。最常見的規範自由有兩種。一種是[庫侖規範](https://zh.wikipedia.org/wiki/庫侖規範 "wikilink")（），選擇
...
例如，假使於下午一時，在紐約的電荷稍微移動了一下，那麼在完全同樣時間，一位假想觀察者在上海會測量出電勢有所改變。這現象似乎違背了[狹義相對論](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink")，因為狹義相對論禁止以超過[光速之速度來傳輸資訊](../Page/光速.md "wikilink")、信號或任何實體。然而，由於沒有任何觀察者曾經測量到電勢，他們只能測量到電場，而電場是由電勢和磁矢勢共同決定的。所以，由於磁矢勢方程式為含時的，電場遵守狹義相對論要求的速度限制。所有可觀測量都與相對論一致。

另外一種常見的規範自由是[勞侖次規範](https://zh.wikipedia.org/wiki/勞侖次規範 "wikilink")。選擇
\(\lambda(\mathbf{r},t)\) 的值來使得
...
電場和磁場可以綜合起來，形成一個[反對稱性二階協變](https://zh.wikipedia.org/wiki/反對稱關係 "wikilink")[張量](../Page/張量.md "wikilink")，稱為[電磁張量](../Page/電磁張量.md "wikilink")，寫為
...
。採用[愛因斯坦求和約定](https://zh.wikipedia.org/wiki/愛因斯坦求和約定 "wikilink")，這程序表達為
...
階[對偶張量](https://zh.wikipedia.org/wiki/對偶張量 "wikilink")（）
...
對於[曲線坐標](https://zh.wikipedia.org/wiki/曲線坐標 "wikilink")（）
\(x^{\alpha}\)
的[協變導數](https://zh.wikipedia.org/wiki/協變導數 "wikilink")，\(J^\beta = \begin{pmatrix} \rho c & J_x & J_y & J_z \end{pmatrix}\)
是[四維電流密度](https://zh.wikipedia.org/wiki/四維電流密度 "wikilink")。

假設 \(x^{\alpha}\)
為[直角坐標](https://zh.wikipedia.org/wiki/直角坐標 "wikilink")，\(x^{\alpha}=(ct,x,y,z)\)

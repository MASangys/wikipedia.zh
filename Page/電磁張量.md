...
bivector）**）是一個描述一物理系統中[電磁場的數學客體](https://zh.wikipedia.org/wiki/電磁場 "wikilink")，所根據的是馬克士威的[電磁學理論](https://zh.wikipedia.org/wiki/電磁學 "wikilink")。場張量是在[赫爾曼·閔可夫斯基提出](https://zh.wikipedia.org/wiki/赫爾曼·閔可夫斯基 "wikilink")[狹義相對論的四維](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink")[張量形式之後被首次使用](../Page/張量.md "wikilink")。
...
場張量\(F^{\alpha\beta} \,\)與對偶張量的乘積則為一[偽純量不變量](https://zh.wikipedia.org/wiki/偽純量 "wikilink")（pseudoscalar
invariant）：
...
為了要導出電磁張量的所有矩陣元素，我們需要定義（[時空](https://zh.wikipedia.org/wiki/時空 "wikilink")）導數算符（derivative
operator）：
...
以及[4-向量勢](https://zh.wikipedia.org/wiki/電磁四維向量勢 "wikilink")：
...
告訴了我們電場向量的散度等於[電荷密度除以](../Page/電荷密度.md "wikilink")[電容率](https://zh.wikipedia.org/wiki/電容率 "wikilink")\(\epsilon_0\)，而動電方程式（electrodynamic
equation）

\[\vec{\nabla} \times \vec{B} - \frac{1}{c^2} \frac{ \partial \vec{E}}{\partial t} = \mu_0 \vec{J}\]
也就是磁場向量的[旋度減掉電場隨著時間變動](../Page/旋度.md "wikilink")（取時間微分），等於電流密度乘以[磁導率](https://zh.wikipedia.org/wiki/磁導率 "wikilink")\(\mu_0\)。
...
告訴了我們沒有「真實」存在的磁荷（[磁單極](https://zh.wikipedia.org/wiki/磁單極 "wikilink")），而動磁方程式（magnetodynamics
equation）
...
場張量其得名理由是因為電磁場須遵守張量轉換定律；（非[重力場](https://zh.wikipedia.org/wiki/重力場 "wikilink")）物理定律具有這樣的普適性質，在[狹義相對論誕生之後就被普遍認識到](https://zh.wikipedia.org/wiki/狹義相對論 "wikilink")。相對論要求所有（非重力場的）物理定律在所有座標系統中都應具有相同形式，這導致[張量的引入](../Page/張量.md "wikilink")。張量形式也使得物理定律能有優美的數學表示方式。舉例來說，電磁學的[馬克士威方程組可以用場張量寫成](../Page/馬克士威方程組.md "wikilink")：
...
在[廣義相對論的](../Page/廣義相對論.md "wikilink")[彎曲時空中](https://zh.wikipedia.org/wiki/彎曲時空 "wikilink")，這些定律可用（許多物理學家覺得）吸引人的方式來推廣——就是將偏微分改成[協變微分](https://zh.wikipedia.org/wiki/協變微分 "wikilink")：
...
在[量子電動力學中的](../Page/量子電動力學.md "wikilink")[拉格朗日量是從相對論建立的古典拉格朗日量所延伸](../Page/拉格朗日量.md "wikilink")：\(\mathcal{L}=\bar\psi(i\hbar c \, \gamma^\alpha D_\alpha - mc^2)\psi -\frac{1}{4 \mu_0}F_{\alpha\beta}F^{\alpha\beta},\)以將[光子以及](../Page/光子.md "wikilink")[電子的](https://zh.wikipedia.org/wiki/電子 "wikilink")[創生](https://zh.wikipedia.org/wiki/創生 "wikilink")（creation）與[湮滅](https://zh.wikipedia.org/wiki/湮滅 "wikilink")（annihilation）整合進來。

在[量子場論中](https://zh.wikipedia.org/wiki/量子場論 "wikilink")，電磁場強度張量被當作是[規範場強度張量的範本](https://zh.wikipedia.org/wiki/規範場 "wikilink")。此一項搭配上局域交互作用拉格朗日量（local

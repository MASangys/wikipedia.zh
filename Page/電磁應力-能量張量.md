...
其中
  ...
  -
    ...
    \(F_{\alpha\beta}\!\),
    [度規張量](https://zh.wikipedia.org/wiki/度規張量 "wikilink")
    \(g_{\alpha\beta}\!\)，以及
...
[介電材料中的電磁應力](https://zh.wikipedia.org/wiki/介電 "wikilink")-能量張量則較不為人所了解，並且其為未解決的的主題。
(however see Pfeifer et al., Rev. Mod. Phys. 79, 1197 (2007))

能量-動量張量的其中元素（或說分量）\(T^{\alpha\beta}\!\)代表了電磁場的[四維動量](https://zh.wikipedia.org/wiki/四維動量 "wikilink")，其第α個分量——\(P^{\alpha}\!\)通過一[超平面](https://zh.wikipedia.org/wiki/超平面 "wikilink")(hyperplane)「*x*<sup>β</sup>
=

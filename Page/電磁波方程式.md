...
［公尺／秒］，是電磁波傳播於[自由空間](../Page/自由空間.md "wikilink")的速度。
...
[奈米到](https://zh.wikipedia.org/wiki/奈米 "wikilink")2500 奈米波長的電磁波。使用這種儀器，可以得知物體、氣體或甚至恆星的詳細物理性質。這是[天文物理學的必備儀器](https://zh.wikipedia.org/wiki/天文物理學 "wikilink")。例如，[氫原子](../Page/氫原子.md "wikilink")會發射波長為21.12公分的無線電波。

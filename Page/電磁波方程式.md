在[電磁學裏](https://zh.wikipedia.org/wiki/電磁學 "wikilink")，**電磁波方程式**（英語：Electromagnetic
wave
equation）乃是描述[電磁波傳播於](https://zh.wikipedia.org/wiki/電磁波 "wikilink")[介質或](https://zh.wikipedia.org/wiki/介質 "wikilink")[真空的二階](https://zh.wikipedia.org/wiki/真空 "wikilink")[微分方程式](https://zh.wikipedia.org/wiki/微分方程式 "wikilink")。電磁波的波源是局域化的含時[電荷密度和](../Page/電荷密度.md "wikilink")[電流密度](https://zh.wikipedia.org/wiki/電流密度 "wikilink")，假若波源為零，則電磁波方程式約化為二階。這方程式的形式，以[電場](../Page/電場.md "wikilink")\(\mathbf{E}\,\!\)和[磁場](../Page/磁場.md "wikilink")\(\mathbf{B}\,\!\)來表達為
...
由於[光波就是電磁波](https://zh.wikipedia.org/wiki/光波 "wikilink")，\(c\,\!\)也是光波傳播的速度，稱為[光速](../Page/光速.md "wikilink")。在真空裏，\(c=c_0=299,792,458\,\!\)
［公尺／秒］，是電磁波傳播於[自由空間的速度](../Page/自由空間.md "wikilink")。

## 歷史

在[詹姆斯·麦克斯韦的](https://zh.wikipedia.org/wiki/詹姆斯·麦克斯韦 "wikilink")1864年論文《[電磁場的動力學理論](../Page/電磁場的動力學理論.md "wikilink")》內，麦克斯韦將[位移電流與其它已成立的電磁方程式合併](../Page/位移電流.md "wikilink")，因而得到了描述電磁波的[波動方程式](https://zh.wikipedia.org/wiki/波動方程式 "wikilink")。最令人振奮的是，這方程式所描述的波動的波速等於光波的速度。他這樣說\[1\]
：
...
追根究底，局域化的含時[電荷密度和](../Page/電荷密度.md "wikilink")[電流密度是電磁波的波源](https://zh.wikipedia.org/wiki/電流密度 "wikilink")。在有波源的情形下，馬克士威方程組可以寫成一個非齊次的電磁波方程式的形式。正是因為波源的存在，使得偏微分方程式變為非齊次。
...
函數\(g(\mathbf{k}\cdot\mathbf{r} - \omega t)\,\!\)描述一個波動，隨著時間的演化，朝著\(\mathbf{k}\,\!\)的方向傳播於空間。將函數\(g(\mathbf{k}\cdot\mathbf{r} - \omega t)\,\!\)代入純量波動方程式(7)，可得到角頻率與[波數的](../Page/波數.md "wikilink")[色散關係](https://zh.wikipedia.org/wiki/色散關係 "wikilink")：
...
[Sine_and_Cosine.svg](https://zh.wikipedia.org/wiki/File:Sine_and_Cosine.svg "fig:Sine_and_Cosine.svg")和[餘弦函數的曲線是不同相位的正弦曲線](https://zh.wikipedia.org/wiki/餘弦函數 "wikilink")。\]\]
假設，函數\(g\,\!\)的波形為[正弦波](https://zh.wikipedia.org/wiki/正弦波 "wikilink")：
...
[奈米到](https://zh.wikipedia.org/wiki/奈米 "wikilink")2500 奈米波長的電磁波。使用這種儀器，可以得知物體、氣體或甚至恆星的詳細物理性質。這是[天文物理學的必備儀器](https://zh.wikipedia.org/wiki/天文物理學 "wikilink")。例如，[氫原子會發射波長為](../Page/氫原子.md "wikilink")21.12公分的無線電波。
...
如圖右，思考一條由半徑為\(a\,\!\)的無窮長的直導線，和半徑為\(b\,\!\)的無窮長的圓柱導電管，所組成的[共軸傳輸線](https://zh.wikipedia.org/wiki/波導 "wikilink")。假設這傳輸線與z-軸平行。由於共軸傳輸線的內部有一條直導線，不是空心的，它可以傳輸\(E_z=0\,\!\)和\(B_z=0\,\!\)的電磁橫波，採用[圓柱坐標](https://zh.wikipedia.org/wiki/圓柱坐標 "wikilink")\((s, \phi, z)\,\!\)，在傳輸線的內部空間，電場和磁場分別為\[2\]

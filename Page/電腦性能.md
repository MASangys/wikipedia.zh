...
依上下文的不同，電腦性能的「良好」可能包括以下項目中的一項或幾項：
  ...
  - 電腦系統或應用程式的[高可用性](https://zh.wikipedia.org/wiki/高可用性 "wikilink")
  - 快速（或高壓縮率）的[数据压缩及解壓縮](../Page/数据压缩.md "wikilink")
  - 高或是快速的[資料傳輸時間](https://zh.wikipedia.org/wiki/資料傳輸 "wikilink")

[電腦軟體的性能](https://zh.wikipedia.org/wiki/電腦軟體 "wikilink")，特別是[應用軟體的反應時間](https://zh.wikipedia.org/wiki/應用軟體 "wikilink")，是[軟體品質的內容之一](https://zh.wikipedia.org/wiki/軟體品質 "wikilink")，在[人机交互中也很重要](../Page/人机交互.md "wikilink")。
...
由於測試電腦的速度及性能需執行許多的程式，因此開發了[基準測試軟體整合這些程式](https://zh.wikipedia.org/wiki/基準測試 "wikilink")。以下是一個重要的量測資料：
  ...
  - [效能功耗比](../Page/效能功耗比.md "wikilink")－[平行系統](https://zh.wikipedia.org/wiki/并行计算 "wikilink")（例如[Google的機房](../Page/Google.md "wikilink")）的設計者會依效能功耗比來選擇CPU，因為CPU功耗的成本大於CPU本身的成本。
...
CPU設計者常需要實現一組特定的指令集，因此無法調整N。有時設計者會藉由大幅提升f，但不會犧牲C太多的方式提昇性能（例如用更深的[流水線或更快的](https://zh.wikipedia.org/wiki/流水線 "wikilink")[快取](https://zh.wikipedia.org/wiki/快取 "wikilink")），所得的是speed-demon的CPU設計。有時設計者會藉由大幅提升CPI（例如利用超序執行、[超純量CPU](../Page/超純量.md "wikilink")、大容量快取、高擊中率的快取、提昇[分支預測](https://zh.wikipedia.org/wiki/分支預測 "wikilink")、等技術），但不會犧牲f太多的方式提昇性能，所得的是brainiac的CPU設計\[3\]。針對特定的指令集（因此N不變）及固定的半導體製程，單一線程的最大性能（1/t）需要在上述二個技術中作一平衡\[4\]。

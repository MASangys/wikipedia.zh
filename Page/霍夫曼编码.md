...
**霍夫曼編碼**（），又譯為**哈夫曼编码**、**赫夫曼编码**，是一種用於[无损数据压缩的](../Page/无损数据压缩.md "wikilink")[熵編碼](../Page/熵編碼.md "wikilink")（權編碼）[演算法](../Page/演算法.md "wikilink")。由美國計算機科學家[大衛·霍夫曼](../Page/大衛·霍夫曼.md "wikilink")（）在1952年發明。

## 簡介

在[计算机](../Page/计算机.md "wikilink")[資料處理中](../Page/資料處理.md "wikilink")，霍夫曼編碼使用[變長編碼表對源符號](../Page/變長編碼表.md "wikilink")（如文件中的一個字母）進行編碼，其中[變長編碼表是通過一種評估來源符號出現機率的方法得到的](../Page/變長編碼表.md "wikilink")，出現機率高的字母使用較短的編碼，反之出現機率低的則使用較長的編碼，這便使編碼之後的字符串的平均長度、[期望值降低](../Page/期望值.md "wikilink")，從而達到[無損壓縮數據的目的](../Page/無損壓縮.md "wikilink")。

例如，在英文中，e的出現[機率最高](../Page/機率.md "wikilink")，而z的出現概率則最低。當利用霍夫曼編碼對一篇英文進行壓縮時，e極有可能用一個[位元來表示](../Page/位元.md "wikilink")，而z則可能花去25個[位元](../Page/位元.md "wikilink")（不是26）。用普通的表示方法時，每個英文字母均占用一個[字節](../Page/字節.md "wikilink")，即8個[位元](../Page/位元.md "wikilink")。二者相比，e使用了一般編碼的1/8的長度，z則使用了3倍多。倘若我們能實現對於英文中各個字母出現概率的較準確的估算，就可以大幅度提高無損壓縮的比例。

霍夫曼樹又稱最優二叉樹，是一種帶權路徑長度最短的[二叉樹](../Page/二叉樹.md "wikilink")。所謂樹的帶權路徑長度，就是樹中所有的葉結點的權值乘上其到根結點的路徑長度（若根結點爲0層，葉結點到根結點的路徑長度爲葉結點的層數）。樹的路徑長度是從樹根到每一結點的路徑長度之和，記爲WPL=（W1\*L1+W2\*L2+W3\*L3+...+Wn\*Ln），N個權值Wi（i=1,2,...n）構成一棵有N個葉結點的二叉樹，相應的葉結點的路徑長度爲Li（i=1,2,...n）。可以證明霍夫曼樹的WPL是最小的。

## 歷史

1951年，霍夫曼在[麻省理工學院](../Page/麻省理工學院.md "wikilink")（MIT）攻讀博士學位，他和修讀[信息論課程的同學得選擇是完成學期報告還是期末](../Page/信息論.md "wikilink")[考試](../Page/考試.md "wikilink")。導師[羅伯特·法諾](../Page/羅伯特·法諾.md "wikilink")（Robert
Fano）出的學期報告題目是：尋找最有效的二進制編碼。由於無法證明哪個已有編碼是最有效的，霍夫曼放棄對已有編碼的研究，轉向新的探索，最終發現了基於有序頻率[二叉樹編碼的想法](../Page/二叉樹.md "wikilink")，並很快證明了這個方法是最有效的。霍夫曼使用自底向上的方法構建二叉樹，避免了次優算法[香農-范諾編碼](../Page/香農-范諾編碼.md "wikilink")（Shannon–Fano
...
實現[霍夫曼編碼的方式主要是創建一個](../Page/霍夫曼編碼.md "wikilink")[二元樹和其節點](../Page/二元樹.md "wikilink")。這些樹的節點可以儲存在[陣列裡](../Page/陣列.md "wikilink")，[陣列的大小為符號](../Page/陣列.md "wikilink")（symbols）數的大小**n**，而節點分别是終端節點（葉節點）與非終端節點（內部節點）。
...
3.指向父節點的[鏈結](../Page/連結串列.md "wikilink")（Link to its parent node）

而非終端節點內有四個欄位：

1.權重（Weight、Probabilities、Frequency）

2.指向兩個子節點的[鏈結](../Page/連結串列.md "wikilink")（Links to two child node）

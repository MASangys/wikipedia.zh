在[计算机科学中](../Page/计算机科学.md "wikilink")，**靜態庫**（），或称**靜態函式庫**，是一個外部函式與變數的集合體。靜態函式庫的檔案內容，通常包含一堆程式設計師自定的變數與函式，其內容不像[動態連結庫那麼複雜](../Page/動態連結庫.md "wikilink")，在編譯期間由[編譯器與](../Page/編譯器.md "wikilink")[連結器將它整合至應用程式內](../Page/連結器.md "wikilink")，並製作成[目的檔以及可以獨立運作的](../Page/目的碼.md "wikilink")[執行檔](../Page/執行檔.md "wikilink")。而這個執行檔與編譯執行檔的程序，都是一種程式的靜態建立（static
...
只需保证在开发者的计算机有正确的[库文件](../Page/函式庫.md "wikilink")，在以二进制发布时不需考虑在使用者的计算机上库文件是否存在及[版本问题](../Page/版本.md "wikilink")，可避免[DLL地狱等问题](../Page/DLL地狱.md "wikilink")。

### 缺点

生成的[可执行文件体积较大](../Page/可执行文件.md "wikilink")。当初正是为了避免此问题，才开发了[动态库技术](../Page/动态链接库.md "wikilink")。

## 实现及使用

靜態函式庫可以用簡單的[C語言或是](../Page/C語言.md "wikilink")[C++程式碼去建立它](../Page/C++.md "wikilink")。這兩個程式語言提供關鍵字指定函式與變數是否為外部（external）或是內部（internal）連結，此外，還提供其他的特性。
...
### [Visual C++](../Page/Visual_C++.md "wikilink")
...
## 参见
  ...
  - [载入器](../Page/载入器.md "wikilink")
  - [共享库](../Page/共享库.md "wikilink")
  - [动态链接库](../Page/动态链接库.md "wikilink")
  - [外部变量](../Page/外部变量.md "wikilink")
  - [目标文件](../Page/目标文件.md "wikilink")
  - [预绑定](../Page/预绑定.md "wikilink")

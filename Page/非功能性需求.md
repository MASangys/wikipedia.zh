在[系統工程及](https://zh.wikipedia.org/wiki/系統工程 "wikilink")[需求工程中](../Page/需求工程.md "wikilink")，**非功能性需求**（）是指依一些條件判斷系統運作情形或其特性，而不是針對系統特定行為的[需求](../Page/需求分析.md "wikilink")。和非功能性需求相對的是[功能需求](../Page/功能需求.md "wikilink")，後者會定義系統特定的行為或功能。非功能性需求也可以視為為了滿足客戶業務需求而需要符合，但又不在功能性需求以内的特性。
...
2.  發展品質（Evolution
    qualities），和軟體系統結構及開發過程有關的品質，例如[軟體可測試性](../Page/軟體可測試性.md "wikilink")、可維護性、可擴展性、可伸縮性（scalability）等\[2\]\[3\]。
...
以下是一些非功能性需求的例子：
  ...
  - 復原或可復原性（例如[平均修復時間MTTR](../Page/平均修復時間.md "wikilink")）

  - [可靠度](https://zh.wikipedia.org/wiki/可靠度 "wikilink")（例如[平均故障間隔MTBF](../Page/平均故障間隔.md "wikilink")）
...
## 相關條目
  ...
  - [ISO/IEC
    9126](https://zh.wikipedia.org/wiki/ISO/IEC_9126 "wikilink")

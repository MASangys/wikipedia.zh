在[系統工程及](https://zh.wikipedia.org/wiki/系統工程 "wikilink")[需求工程](../Page/需求工程.md "wikilink")中，**非功能性需求**（）是指依一些條件判斷系統運作情形或其特性，而不是針對系統特定行為的[需求](../Page/需求分析.md "wikilink")。和非功能性需求相對的是[功能需求](../Page/功能需求.md "wikilink")，後者會定義系統特定的行為或功能。非功能性需求也可以視為為了滿足客戶業務需求而需要符合，但又不在功能性需求以内的特性。

...
BASIC和GW-BASIC）、[JOSS](https://zh.wikipedia.org/wiki/JOSS "wikilink")、[FOCAL](https://zh.wikipedia.org/wiki/FOCAL "wikilink")、[MUMPS](https://zh.wikipedia.org/wiki/MUMPS "wikilink")、[TELCOMP](https://zh.wikipedia.org/wiki/TELCOMP "wikilink")、[COBOL](../Page/COBOL.md "wikilink")、[机器语言](../Page/机器语言.md "wikilink")、早期的[汇编语言](../Page/汇编语言.md "wikilink")（不包括过程化的metaoperators）、[汇编调试器和一些](https://zh.wikipedia.org/wiki/汇编调试器 "wikilink")[脚本语言](../Page/脚本语言.md "wikilink")（比如MS-DOS
batch文件语言）。

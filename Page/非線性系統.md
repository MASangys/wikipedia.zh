在[物理科學](../Page/物理科學.md "wikilink")中，如果描述某個[系統](../Page/系統.md "wikilink")的方程其輸入（自變數）與輸出（應變數）不成[正比](../Page/比例.md "wikilink")，則稱為**非線性系統**。由於自然界中大部分的系統本質上都是非線性的，因此許多[工程師](../Page/工程师.md "wikilink")、[物理學家](../Page/物理学家.md "wikilink")、[數學家和其他](../Page/数学家.md "wikilink")[科學家對於非線性問題的研究都極感興趣](https://zh.wikipedia.org/wiki/科学家 "wikilink")。非線性系統和[線性系統](../Page/線性系統.md "wikilink")最大的差別在於，非線性系統可能會導致混沌、不可預測，或是不直觀的結果。

一般來說，非線性系統的行為在[數學上是用一組非線性聯立方程來描述的](../Page/数学.md "wikilink")。非線性[方程](../Page/方程.md "wikilink")裡含有由[未知數構成的非一次](../Page/方程.md "wikilink")[多項式](../Page/多項式.md "wikilink")；換句話說，一個非線性方程並不能寫成其未知數的[線性組合](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。而非線性[微分方程](../Page/微分方程.md "wikilink")，則是指方程裡含有未知[函數及其](../Page/函数.md "wikilink")[導函數的乘冪不等於一的項](../Page/导数.md "wikilink")。在判定一個方程是線性或非線性時，只需考慮未知數（或未知函數）的部分，不需要檢查方程中是否有已知的非線性項。例如在微分方程中，若所有的未知函數、未知導函數皆為一次，即使出現由某個已知[變數](../Page/變數.md "wikilink")所構成的非線性函數，我們仍稱它是一個線性微分方程。
...
\[\frac{du}{d x} + u^2=0\,\]， 而等號左邊並不是 *u* 的線性映射。若把此式的 *u*<sup>2</sup> 換成 *u*，則會變成線性方程（[指數衰減](../Page/指数衰减.md "wikilink")）。

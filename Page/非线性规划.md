在[数学](../Page/数学.md "wikilink")中，**非线性规划**是求解由一系列未知[实函数](../Page/实函数.md "wikilink")组成的[组](../Page/方程组.md "wikilink")[方程](../Page/方程.md "wikilink")和[不等](../Page/不等.md "wikilink")式（统称为[约束](../Page/約束_\(數學\).md "wikilink")）定义的[最佳化問題](https://zh.wikipedia.org/wiki/最佳化問題 "wikilink")，伴随着一个要被最大化或最小化的目标[函数](../Page/函数.md "wikilink")，只是一些约束或目标函数是[非線性的](https://zh.wikipedia.org/wiki/非線性 "wikilink")。\[1\]
它是[最优化](../Page/最优化.md "wikilink")处理非线性问题的一个子领域。
...
若目標函數*f*為線性，約束的[空间為](../Page/欧几里得空间.md "wikilink")[多胞形](https://zh.wikipedia.org/wiki/多胞形 "wikilink")，此問題是[线性规划](../Page/线性规划.md "wikilink")問題，可以用許多著名的线性规划解來求解。

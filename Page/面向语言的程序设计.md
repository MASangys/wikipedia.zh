...
Programming，LOP），指一种[程序设计范型](https://zh.wikipedia.org/wiki/程序设计范型 "wikilink")，通过[元编程](../Page/元编程.md "wikilink")而非[通用编程语言](../Page/通用编程语言.md "wikilink")解决问题。程序员首先为问题编写一种或多种[领域特定语言](https://zh.wikipedia.org/wiki/领域特定语言 "wikilink")，然后再在这些语言中解决问题。这个概念具体描述于Martin

...
distribution）是[可靠性分析和](https://zh.wikipedia.org/wiki/可靠性分析 "wikilink")[寿命检验的理论基础](https://zh.wikipedia.org/wiki/寿命检验 "wikilink")。
...
1\. 1927年，[Fréchet](https://zh.wikipedia.org/wiki/Fréchet "wikilink")
(1927)首先给出这一分布的定义。

2\.
1933年，[Rosin和](https://zh.wikipedia.org/wiki/Rosin "wikilink")[Rammler在研究碎末的分布时](https://zh.wikipedia.org/wiki/Rammler "wikilink")，第一次应用了威布尔分布（Rosin,
P.; Rammler, E. (1933), "The Laws Governing the Fineness of Powdered
Coal", Journal of the Institute of Fuel 7: 29 - 36.）。

3\. 1951年，瑞典工程师、数学家[Waloddi
Weibull](https://zh.wikipedia.org/wiki/Waloddi_Weibull "wikilink")（1887-1979）详细解释了这一分布，于是，该分布便以他的名字命名为Weibull
Distribution。

## 定义

从[概率论和](https://zh.wikipedia.org/wiki/概率论 "wikilink")[统计学](../Page/统计学.md "wikilink")角度看，Weibull
Distribution是连续性的概率分布，其概率密度为：
...
parameter）。显然，它的累积分布函数是扩展的指数分布函数，而且，Weibull
distribution与很多分布都有关系。如，当k=1，它是指数分布；k=2时，是Rayleigh
distribution（[瑞利分布](../Page/瑞利分布.md "wikilink")）。

**韦达定理**給出[多項式方程的](https://zh.wikipedia.org/wiki/多項式方程 "wikilink")[根與](https://zh.wikipedia.org/wiki/根_\(数学\) "wikilink")[係數的关系](https://zh.wikipedia.org/wiki/係數 "wikilink")，又稱為**根與係數**。[定理陳述如下](../Page/定理.md "wikilink")：
...
在[一元二次方程的特例中](../Page/一元二次方程.md "wikilink")，两個根的和等于方程的一次项系数除以二次项系数的[相反数](https://zh.wikipedia.org/wiki/相反数 "wikilink")；两個根的乘积等于方程的[常数项除以二次项系数](https://zh.wikipedia.org/wiki/常数 "wikilink")。

设\(x_1, x_2\)是一元二次方程\(ax^2+bx+c=0\)的两根，那么：

\[x_1+x_2=-\frac{b}{a}, x_1x_2=\frac{c}{a}\]

韦达定理的[逆定理同样成立](https://zh.wikipedia.org/wiki/定理#逆定理 "wikilink")。仍然以一元二次方程為例：給定一個一元二次方程。如果有两个数，它們的和等于該方程的一次项系数除以二次项系数的相反数，它們的积又等于該方程的常数项除以二次项系数，那么它們就是該方程的兩根。
...
由[乘法原理](https://zh.wikipedia.org/wiki/乘法原理 "wikilink")：

**音频压缩**（区别于**动态压缩**）属于[数据压缩的一种](../Page/数据压缩.md "wikilink")，用以減少[音訊](https://zh.wikipedia.org/wiki/音訊 "wikilink")[流媒体的傳輸頻寬需求與](../Page/流媒体.md "wikilink")[音訊檔案的儲存大小](https://zh.wikipedia.org/wiki/音訊檔案 "wikilink")。按压缩方法可以分为无损压缩和有损压缩。
...
Shorten是一种比较早的无损压缩格式；后来出现的有[Free Lossless Audio
Codec](https://zh.wikipedia.org/wiki/Free_Lossless_Audio_Codec "wikilink")（FLAC）、[Apple
Lossless](../Page/Apple_Lossless.md "wikilink")（ALAC）、[Monkey's
Audio](../Page/Monkey's_Audio.md "wikilink")（APE）和[WavPack](../Page/WavPack.md "wikilink")（WV）。
...
例如音樂工作者修改樂曲內容，有損壓縮較適合用在最後的使用者上，最常见的有损压缩算法如

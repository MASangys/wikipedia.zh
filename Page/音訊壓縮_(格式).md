**音频压缩**（区别于**动态压缩**）属于[数据压缩的一种](../Page/数据压缩.md "wikilink")，用以減少[音訊](../Page/音訊.md "wikilink")[流媒体的傳輸頻寬需求與](../Page/流媒体.md "wikilink")[音訊檔案的儲存大小](../Page/音訊檔案.md "wikilink")。按压缩方法可以分为无损压缩和有损压缩。
...
Codec](../Page/Free_Lossless_Audio_Codec.md "wikilink")（FLAC）、[Apple

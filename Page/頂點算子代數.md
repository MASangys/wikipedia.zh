**頂點代數**（vertex algebra）又稱\[1\]**頂點算子代數**（vertex operator algebra），是[共形場論](../Page/共形場論.md "wikilink")（保角場論）之代數結構。其應用包括[怪兽月光理论](https://zh.wikipedia.org/wiki/怪兽月光理论 "wikilink")（Monstrous moonshine）與。

1986 年，Richard Borcherds 受二維共形場論中用以插入[場之頂點算子啓發](https://zh.wikipedia.org/wiki/場 "wikilink")，提出頂點算子代數結構。 重要例子有：

  - 晶格頂點算子代數（用以研究[晶格共形場論](https://zh.wikipedia.org/wiki/晶格共形場論 "wikilink")），
  - 來自之表示之頂點算子代數 （用以研究 [Wess-Zumino-Witten 模型](https://zh.wikipedia.org/wiki/Wess-Zumino-Witten_模型 "wikilink")），
  - 來自仿射 [Virasoro 代數之表示之Virasoro](https://zh.wikipedia.org/wiki/Virasoro_代數 "wikilink") 頂點算子代數 （可用以研究[極小模型](https://zh.wikipedia.org/wiki/極小模型 "wikilink")），
  - I. Frenkel-J.Lepowsky-A.Meurman（於1988年）構造 之（Moonshine module）*V*<sup>♮</sup>。

定義頂點算子代數之各公理抽象自物理學人所謂之（Chiral algebra），其嚴格數學定義\[2\]由 Beilinson 與 Drinfeld 提出。

[thumb](https://zh.wikipedia.org/wiki/file:Sequential_function_chart.png "wikilink")
**順序功能流程圖**（）簡稱**SFC**，是為[可程式邏輯控制器](https://zh.wikipedia.org/wiki/可程式邏輯控制器 "wikilink")（PLC）開發的圖形程式語言，是[IEC_61131-3標準定義的五種語言之一](../Page/IEC_61131-3.md "wikilink")。順序功能流程圖是以為基礎\[1\]，而後者又以[Petri网為基礎](../Page/Petri网.md "wikilink")\[2\]。

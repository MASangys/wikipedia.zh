...
形式地說，預可加範疇是在交換群的[么半範疇上](../Page/么半範疇.md "wikilink")[濃化的範疇](https://zh.wikipedia.org/wiki/濃化_\(範疇\) "wikilink")。預加法範疇有時亦稱**Ab-範疇**，其中的**Ab**是交換群範疇的縮寫。舊文獻有時也將預加法範疇稱為加法範疇；在此則採當代觀點，區別預加法範疇與[可加範疇](../Page/可加範疇.md "wikilink")。
...
設\(\mathcal{C}, \mathcal{D}\)為範疇，且\(\mathcal{D}\)為預加法範疇，則[函子範疇](https://zh.wikipedia.org/wiki/函子範疇 "wikilink")\(\mathrm{Fct}(\mathcal{C},\mathcal{D})\)也構成預可加範疇，原因在於[自然變換能自然地相加](../Page/自然變換.md "wikilink")。若\(\mathcal{C}\)也是預加法範疇，則其間的加法函子範疇\(\mathrm{Add}(\mathcal{C},\mathcal{D})\)也是預可加範疇。
...
[ru:Категория
модулей](https://zh.wikipedia.org/wiki/ru:Категория_модулей "wikilink")

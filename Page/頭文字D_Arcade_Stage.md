...
## 系列列表
  ...
  - 頭文字D Arcade Stage 8 インフィニティ（街机游戏）
  - 頭文字D Arcade Stage Zero（街机游戏）※目前运营中的街机版
...
### 公道最速伝説/公道列伝（故事模式）
  ...
  -
    ...
    另外，哪怕不战胜所有山道的所有对手，二回战也会变成雨战。在「公道最速伝説」中 **全峠制覇（全山道制霸） **后角色头像右下角会追加星星。全峠制覇是不需要进行雨战也可以达成的。
    该模式于『6 AA』、『8 インフィニティ』中被大幅更新了。
...
### 挑戦状（挑战书）
  ...
  -
    ...
    其流程为插入游戏卡并选择进入模式选择画面后，此前打败过的游戏角色将会递送过来挑战书。
    接受挑战后，游戏则会自动选择全国对战，赛道随机，对手为挑战书上的角色。胜利后将大幅度增加角色装扮栏，但对 Rank 则无任何影响。
    胜利后将继续进入正常的全国对战，但输掉的话游戏将自动结束。
    \*未确认该模式下的游戏角色为COM还是真正的玩家。

在[電腦視覺中](https://zh.wikipedia.org/wiki/電腦視覺 "wikilink")，顯著性是一種圖像分割的模式，而**顯著圖**（）是顯示每個[像素](../Page/像素.md "wikilink")獨特性的圖像。顯著圖的目標在於將一般圖像的表示簡化或是改變為更容易分析的樣式。舉例來說，某個像素在一張[彩色圖中具有較高的](https://zh.wikipedia.org/wiki/彩色圖 "wikilink")[灰階](https://zh.wikipedia.org/wiki/灰階 "wikilink")，其會在顯著圖中以較為明顯的方式被顯示出來。
...
圖像顯著性是圖像中重要的視覺特徵，體現出人眼對圖像各區域的重視程度，自從[Laurent Itti在](https://zh.wikipedia.org/wiki/Laurent_Itti "wikilink")1998年發表的論文\[1\]後，產生了大量的顯著性映射方法。圖像顯著性也廣泛運用在壓縮，編碼，圖像邊緣加強，顯著性目標分割和提取等方面。

## 視覺顯著性檢測\[2\]

視覺注意機制，即面對一個場景時，人類自動地對感興趣區域進行處理而選擇性地忽略不感興趣區域，這些人們感興趣區域被稱之為顯著性區域。

[視覺顯著性檢測(英語：Visual Saliency Detection)](https://zh.wikipedia.org/wiki/視覺顯著性檢測 "wikilink")，指透過演算法模擬人的視覺，提取出圖像中的顯著性區域。
...
[Category:图像处理](https://zh.wikipedia.org/wiki/Category:图像处理 "wikilink") [Category:计算机视觉](https://zh.wikipedia.org/wiki/Category:计算机视觉 "wikilink")

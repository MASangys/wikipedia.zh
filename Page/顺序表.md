> 本文内容由[顺序表](https://zh.wikipedia.org/wiki/顺序表)转换而来。


**顺序表**是在[计算机内存中以](https://zh.wikipedia.org/wiki/计算机内存 "wikilink")[数组](../Page/数组.md "wikilink")的形式保存的[线性表](https://zh.wikipedia.org/wiki/线性表 "wikilink")，是指用一组[地址](../Page/地址.md "wikilink")连续的[存储单元依次存储数据元素的线性结构](https://zh.wikipedia.org/wiki/存储单元 "wikilink")。

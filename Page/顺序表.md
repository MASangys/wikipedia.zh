**顺序表**是在[计算机内存中以](https://zh.wikipedia.org/wiki/计算机内存 "wikilink")[数组的形式保存的](../Page/数组.md "wikilink")[线性表](https://zh.wikipedia.org/wiki/线性表 "wikilink")，是指用一组[地址连续的](../Page/地址.md "wikilink")[存储单元依次存储数据元素的线性结构](https://zh.wikipedia.org/wiki/存储单元 "wikilink")。

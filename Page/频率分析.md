**频率分析**在[数学](../Page/数学.md "wikilink")、[物理学和](../Page/物理学.md "wikilink")[信号处理中是一种分解](https://zh.wikipedia.org/wiki/信号处理 "wikilink")[函数](../Page/函数.md "wikilink")、[波形](https://zh.wikipedia.org/wiki/波形 "wikilink")、或者[信号的频率组成](https://zh.wikipedia.org/wiki/信号 "wikilink")，以获取[频谱的方法](../Page/频谱.md "wikilink")。

[English-slf.png](https://zh.wikipedia.org/wiki/File:English-slf.png "fig:English-slf.png")
[Wikipedia_HTML5.png](https://zh.wikipedia.org/wiki/File:Wikipedia_HTML5.png "fig:Wikipedia_HTML5.png")的字詞分布情况，[字型越大](https://zh.wikipedia.org/wiki/電腦字型 "wikilink")，代表該字詞出現的機率就越大。\]\]

在[密码学中](../Page/密码学.md "wikilink")，**频率分析**是指研究字母或者字母组合在文本中出现的频率。应用频率分析可以破解[古典密码](https://zh.wikipedia.org/wiki/古典密码学 "wikilink")。
...
在一个简单的[替换密码中](https://zh.wikipedia.org/wiki/替换密码 "wikilink")，[明文中的每一个字母都被另一个字母替换](https://zh.wikipedia.org/wiki/明文 "wikilink"),而且明文中相同的字母在转换为密文时总是被同一个字母所替换。比如，所有的`e`都会被替换成
...
第一個已知頻率分析（事實上，是任何一種密碼分析）的解釋是在9世紀時，[阿拉伯](https://zh.wikipedia.org/wiki/阿拉伯 "wikilink")[博學家](https://zh.wikipedia.org/wiki/博學家 "wikilink")－[肯迪所著的](https://zh.wikipedia.org/wiki/肯迪 "wikilink")《手稿上破譯加密消息》之上。\[1\]
它對於[古蘭經的文本研究發現](https://zh.wikipedia.org/wiki/古蘭經 "wikilink")[阿拉伯文有一個特別的字母頻率](https://zh.wikipedia.org/wiki/阿拉伯文 "wikilink")。其使用快速蔓延，類似的系統在[文藝復興時期的歐洲國家十分流行](https://zh.wikipedia.org/wiki/文藝復興 "wikilink")。1474年，[Cicco
Simonetta](http://en.wikipedia.org/wiki/Cicco_Simonetta)
寫了一本手冊，上有關於破譯已加密的[拉丁語和](https://zh.wikipedia.org/wiki/拉丁語 "wikilink")[意大利語文本](https://zh.wikipedia.org/wiki/意大利語 "wikilink")。\[2\]

密碼學家為加強[簡單替換加密](https://zh.wikipedia.org/wiki/替換式密碼 "wikilink")，使用了數項措施，包括：

  - 使用“[諧音替換法](https://zh.wikipedia.org/wiki/替換式密碼#諧音替換法 "wikilink")” -
    使用某幾個不太常用的字母替代最常見的字母（例如，在英語密文中，X和Y都可以代表明文E）；
  - 使用“[多字母替換加密](https://zh.wikipedia.org/wiki/多字母替換加密 "wikilink")” -
    使用另一組文字作密錢來加密密鑰 -
    參見[多字母替換加密](https://zh.wikipedia.org/wiki/替換式密碼#多字母替換加密 "wikilink")([萊昂·巴蒂斯塔·阿爾伯蒂可能是第一個這樣做的人](https://zh.wikipedia.org/wiki/萊昂·巴蒂斯塔·阿爾伯蒂 "wikilink")）；及
...
頻率分析只需基本了解明文字母的統計，以及一些解決問題的能力，而且此方法可用人手解譯。在[第二次世界大戰期間](https://zh.wikipedia.org/wiki/第二次世界大戰 "wikilink")，[英國與](https://zh.wikipedia.org/wiki/英國 "wikilink")[美國同時使用各大報紙上](https://zh.wikipedia.org/wiki/美國 "wikilink")[字謎和密碼比賽來招募解碼專家](https://zh.wikipedia.org/wiki/字謎 "wikilink")。[軸心國中使用了某些很容易遭頻率分析破解的密碼](https://zh.wikipedia.org/wiki/軸心國 "wikilink")（例如日本第二次世界大戰時的領事密碼）。機械替換加密或解密亦於第二次世界大戰之時開始使用。現時，頻率分析基本上全由電腦來完成，因此，現時替換式密碼很容易就被破解。
...
1.  [Ibrahim A.
    Al-Kadi](https://zh.wikipedia.org/wiki/Ibrahim_A._Al-Kadi "wikilink")‧《密碼學的起源：阿拉伯國家的貢獻》，*[Cryptologia](http://en.wikipedia.org/wiki/Cryptologia)*,

**余弦**是[三角函数的一种](../Page/三角函数.md "wikilink")。它的定义域是整个实数集，值域是\([-1,1]\)。它是[周期函数](../Page/周期函数.md "wikilink")，其最小正周期为\(2\pi\)。在自变量为\(2n\pi\)（\(n\)为整数）时，该函数有极大值1；在自变量为\((2n+1)\pi\)时，该函数有极小值-1。余弦函数是[偶函数](../Page/偶函数.md "wikilink")，其图像关于y轴对称。
...
在[直角三角形中](../Page/直角三角形.md "wikilink")，一个锐角\(\angle A\)的**余弦**定义为它的邻边与斜边的比值，也就是：

\[\cos \theta = \frac {\mathrm{b}}{\mathrm{c}}\,\!\]

可以發現其定義和[正割函數互為](../Page/正割函數.md "wikilink")[倒數](../Page/倒數.md "wikilink")。
...
这就是余弦的[微分方程定义](../Page/微分方程.md "wikilink")。
...
**[余弦定理](../Page/余弦定理.md "wikilink")**（也叫做余弦公式）是[勾股定理的扩展](../Page/勾股定理.md "wikilink")：
...
如果这个角不包含在这两个边之间，三角形可能不是唯一的（边-边-角[全等歧义](../Page/全等.md "wikilink")）。小心余弦定律的这种歧义情况。

**余弦**是[三角函数的一种](../Page/三角函数.md "wikilink")。它的定义域是整个实数集，值域是\([-1,1]\)。它是[周期函数](../Page/周期函数.md "wikilink")，其最小正周期为\(2\pi\)。在自变量为\(2n\pi\)（\(n\)为整数）时，该函数有极大值1；在自变量为\((2n+1)\pi\)时，该函数有极小值-1。余弦函数是[偶函数](https://zh.wikipedia.org/wiki/偶函数 "wikilink")，其图像关于y轴对称。
...
**[余弦定理](https://zh.wikipedia.org/wiki/余弦定理 "wikilink")**（也叫做余弦公式）是[勾股定理的扩展](../Page/勾股定理.md "wikilink")：

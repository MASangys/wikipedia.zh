...
在[概率论中](https://zh.wikipedia.org/wiki/概率论 "wikilink")，**马尔可夫不等式**给出了[随机变量](../Page/随机变量.md "wikilink")的函数大于等于某正数的概率的上界。虽然它以俄国数学家[安德雷·马尔可夫](../Page/安德雷·马尔可夫.md "wikilink")命名，但该不等式曾出现在一些更早的文献中，其中包括马尔可夫的老师--[巴夫尼提·列波维奇·切比雪夫](../Page/巴夫尼提·列波维奇·切比雪夫.md "wikilink")。

[Markov_Inequality.svg](https://zh.wikipedia.org/wiki/File:Markov_Inequality.svg "fig:Markov_Inequality.svg")
在[概率论中](https://zh.wikipedia.org/wiki/概率论 "wikilink")，**马尔可夫不等式**给出了[随机变量的函数大于等于某正数的概率的上界](../Page/随机变量.md "wikilink")。虽然它以俄国数学家[安德雷·马尔可夫命名](../Page/安德雷·马尔可夫.md "wikilink")，但该不等式曾出现在一些更早的文献中，其中包括马尔可夫的老师--[巴夫尼提·列波维奇·切比雪夫](../Page/巴夫尼提·列波维奇·切比雪夫.md "wikilink")。

马尔可夫不等式把概率关联到[数学期望](https://zh.wikipedia.org/wiki/数学期望 "wikilink")，给出了随机变量的[累积分布函数一个宽泛但仍有用的界](../Page/累积分布函数.md "wikilink")。
...
[切比雪夫不等式使用變異數來作為一隨機變數超過平均值機率的上限](../Page/切比雪夫不等式.md "wikilink")，可以用下式表示：
...
1.
2.  E.M. Stein, R. Shakarchi, "Real Analysis, Measure Theory,
    Integration, & Hilbert Spaces", vol. 3, 1st ed., 2005, p.91
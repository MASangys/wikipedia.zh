...
*K<sub>v</sub>*是馬達速度常數，其單位為[RPM](https://zh.wikipedia.org/wiki/每分鐘轉速 "wikilink")/[V](../Page/伏特.md "wikilink")（不要和表示千伏特的*kV*混淆）\[2\]。[無刷馬達的K](../Page/永磁同步馬達.md "wikilink")<sub>v</sub>是馬達無載的轉速除以在馬達線圈上的峰端電壓（[反電動勢](https://zh.wikipedia.org/wiki/反電動勢 "wikilink")，非RMS電壓）。例如，一個無載時K<sub>v</sub>,

**馬達尺寸常數***K<sub>M</sub>*、**[反電動勢常數](../Page/反電動勢.md "wikilink")***K<sub>v</sub>*及**轉矩常數***K<sub>T</sub>*都是常用來描述[馬達特性的數值](../Page/馬達.md "wikilink")。.

## 馬達常數

*K<sub>M</sub>*是**馬達常數**\[1\]或**馬達尺寸常數**。若用[國際單位制表示](../Page/國際單位制.md "wikilink")，其單位為[N](../Page/牛頓.md "wikilink")⋅[m](../Page/公尺.md "wikilink")/sqrt([W](../Page/瓦特.md "wikilink")))：

\[K_\mathrm{M} =\frac{\tau}{\sqrt{P}}\]

其中

  - \(\scriptstyle \tau\)為馬達[轉矩](../Page/轉矩.md "wikilink")。（SI制單位為N·m）
...
*K<sub>v</sub>*是馬達速度常數，其單位為[RPM](../Page/每分鐘轉速.md "wikilink")/[V](../Page/伏特.md "wikilink")（不要和表示千伏特的*kV*混淆）\[2\]。[無刷馬達的K](../Page/永磁同步馬達.md "wikilink")<sub>v</sub>是馬達無載的轉速除以在馬達線圈上的峰端電壓（[反電動勢](../Page/反電動勢.md "wikilink")，非RMS電壓）。例如，一個無載時K<sub>v</sub>,
5,700 rpm/V的馬達，若供電電壓為11.1 V，其轉速為63,270 rpm（5,700 rpm/V × 11.1 V）。
...
也可以將馬達的[磁通整合到上述公式中](../Page/磁通.md "wikilink")\[10\]：
...
## 外部連結
  ...
  - [DC
    Motors](http://www.electricmotors.machinedesign.com/guiEdits/Content/bdeee3/bdeee3_5.aspx),
    Electric motor reference center
...
2.  [United Hobbies: "Kv rating
    explained"](https://unitedhobbies.com/UNITEDHOBBIES/store/wikishow.asp?idwiki=4)

...
chain，縮寫為**DTMC**\[1\]），因俄國數學家[安德烈·马尔可夫](https://zh.wikipedia.org/wiki/马尔可夫 "wikilink")（）得名，为[狀態空間中经过从一个状态到另一个状态的转换的](../Page/狀態空間_\(計算機科學\).md "wikilink")[随机过程](../Page/随机过程.md "wikilink")。该过程要求具备“无记忆”的性质：下一状态的概率分布只能由当前状态决定，在时间序列中它前面的事件均与之无关。这种特定类型的“无记忆性”称作[馬可夫性質](https://zh.wikipedia.org/wiki/馬可夫性質 "wikilink")。马尔科夫链作为实际过程的统计模型具有许多应用。
...
这是[Frobenius-Perron
equation的一个版本](https://zh.wikipedia.org/wiki/Frobenius-Perron_equation "wikilink")。这时可能存在一个或多个状态分布\(\pi\)满足

\[\pi(X) = \int P(X|Y)\,\pi(Y)\,dY\]

其中\(Y\)只是为了便于对变量积分的一个名义。这样的分布\(\pi\)被称作是“[平稳分布](https://zh.wikipedia.org/wiki/平稳分布 "wikilink")”（Stationary
Distribution）或者“[稳态分布](https://zh.wikipedia.org/wiki/稳态分布 "wikilink")”（Steady-state
Distribution）。一个平稳分布是一个对应于[特征值为](https://zh.wikipedia.org/wiki/特征值 "wikilink")\(1\)的条件分布函数的[特征方程](https://zh.wikipedia.org/wiki/特征方程 "wikilink")。
...
若状态空间是[有限的](https://zh.wikipedia.org/wiki/有限 "wikilink")，则转移概率分布可以[矩阵表示](../Page/矩阵.md "wikilink")，该矩阵称为转移矩阵，记为**P**。其中处于\((i,j)\)的元素等于
...
**e**的倍数，其[特征值为](https://zh.wikipedia.org/wiki/特征值 "wikilink")1。如果有多个单位特征向量那么相应稳态的加权和也是稳态。但对于马尔可夫链来说，我们更关心的是作为一些对初始分布的序列分布的极限的稳态。
...
theorem所指出的](https://zh.wikipedia.org/wiki/Perron-Frobenius_theorem "wikilink")。
...
scheme被熟知为[伯努利过程](https://zh.wikipedia.org/wiki/伯努利过程 "wikilink")
...
这个条件也被称为[细致平衡](https://zh.wikipedia.org/wiki/细致平衡 "wikilink")（detailed
balance）条件。
...
仅有两个可能状态的伯努利方案是[伯努利过程](https://zh.wikipedia.org/wiki/伯努利过程 "wikilink")。
...
[谷歌所使用的网页排序算法](https://zh.wikipedia.org/wiki/谷歌 "wikilink")（[PageRank](../Page/PageRank.md "wikilink")）就是由马尔可夫链定义的。如果\(N\)
...
马尔可夫链也有众多的[生物学应用](../Page/生物学.md "wikilink")，特别是[增殖过程](https://zh.wikipedia.org/wiki/增殖过程 "wikilink")，可以帮助模拟生物增殖过程的建模。[隐蔽马尔可夫模型还被用于](https://zh.wikipedia.org/wiki/隐蔽马尔可夫模型 "wikilink")[生物信息学](../Page/生物信息学.md "wikilink")，用以编码区域或基因预测（見[哈代-溫伯格定律](https://zh.wikipedia.org/wiki/哈代-溫伯格定律 "wikilink")。）
...
[马尔可夫在](https://zh.wikipedia.org/wiki/马尔可夫 "wikilink")1906年首先做出了这类过程。而将此一般化到[可数无限](https://zh.wikipedia.org/wiki/可数无限 "wikilink")[状态空间是由俄國數學家](../Page/状态空间.md "wikilink")[柯尔莫果洛夫](https://zh.wikipedia.org/wiki/柯尔莫果洛夫 "wikilink")（）在1936年给出的。马尔可夫链与[布朗运动以及](../Page/布朗运动.md "wikilink")[遍历假说这两个](https://zh.wikipedia.org/wiki/遍历假说 "wikilink")[二十世纪初期](https://zh.wikipedia.org/wiki/二十世纪 "wikilink")[物理学重要课题是相联系的](../Page/物理学.md "wikilink")，但马尔可夫寻求的似乎不仅于数学动机，名义上是对于纵属事件[大数法则的扩张](https://zh.wikipedia.org/wiki/大数法则 "wikilink")。

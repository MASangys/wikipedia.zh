...
在[數學](https://zh.wikipedia.org/wiki/數學 "wikilink")，特別在[微積分](https://zh.wikipedia.org/wiki/微積分學 "wikilink")，[函數在一點处的一階](https://zh.wikipedia.org/wiki/函數 "wikilink")[導數為零](https://zh.wikipedia.org/wiki/導數 "wikilink")，该点即函数的**驻点**（**Stationary
...
在[變分法裏](https://zh.wikipedia.org/wiki/變分法 "wikilink")，歐拉-拉格朗日方程式是從其對應的[泛函的平穩點推導出的一種](../Page/泛函.md "wikilink")[微分方程式](https://zh.wikipedia.org/wiki/微分方程式 "wikilink")。設定

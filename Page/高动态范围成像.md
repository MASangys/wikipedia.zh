...
[St_Kentigerns_Church_HDR_(8226826999).jpg](https://zh.wikipedia.org/wiki/File:St_Kentigerns_Church_HDR_\(8226826999\).jpg "fig:St_Kentigerns_Church_HDR_(8226826999).jpg") **高动态范围成像**（，[简称](../Page/縮寫.md "wikilink")或），在[计算机图形学](../Page/计算机图形学.md "wikilink")与[电影](../Page/电影.md "wikilink")[摄影术中](https://zh.wikipedia.org/wiki/摄影术 "wikilink")，是用来实现比普通数位图像技术更大曝光[动态范围](https://zh.wikipedia.org/wiki/动态范围 "wikilink")（即更大的明暗差别）的一组技术。高动态范围成像的目的就是要正确地表示真实世界中从太阳光直射到最暗的阴影这样大的范围亮度。

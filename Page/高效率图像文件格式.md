**高效率图像文件格式**（****；也称**高效图像文件格式**\[1\]）是一个用于单张图像或图像序列的[檔案格式](../Page/檔案格式.md "wikilink")。它由[运动图像专家组](../Page/MPEG.md "wikilink")（MPEG）开发，并在[MPEG-H](../Page/MPEG-H.md "wikilink") Part 12（ISO/IEC 23008-12）中定义。
...
为了节约存储空间，HEIF封装的HEVC编码的图像可以用于压缩全分辨率图像，同时保留一个较低分辨率的[JPEG](../Page/JPEG.md "wikilink")副本（例如4K分辨率或更低）用于屏幕显示。

数码相机和智能手机可以使用HEIF来实现单文件存储连拍、焦点堆叠或曝光堆叠的照片。与此类似，拍摄的视频与静态图像也可以存储在同一个HEIF文件中。HEIF还可以将任何图像集合存储在单个文件中，从而可以轻松分享。

### 网页和接入互联网的图像应用程序

[HTML5](../Page/HTML5.md "wikilink").2的[图片元素](https://www.w3.org/TR/html52/semantics-embedded-content.html#the-picture-element)提供了为同一图像指示多个替代方案的能力，网页浏览器可以选择最适合其目的的一份。网页和连接的应用程序使用HEIF的一个动机是减少网页和图像内容的下载时间。
...
根据上述设计原则，HEIF文件可以存储下列数据类型：\[5\]
  ...
  - **图像元数据（Image Metadata）：**存储同一个HEIF文件中存储图像的[EXIF](../Page/EXIF.md "wikilink")、[XMP](../Page/XMP.md "wikilink")等元数据。
...
| GIF          | 89a                                                                                                                                                       | [1](http://www.w3.org/Graphics/GIF/spec-gif89a.txt)                                                                                                |
...
| BPG          | 0.9.5                                                                                                                                                     | [2](http://bellard.org/bpg/bpg_spec.txt)                                                                                                           |
...
The most important features that enable controlling the playback of an HEIF file are listed below. Some of these features were introduced in the ISOBMFF or [ISO/IEC 14496-15](../Page/MPEG-4.md "wikilink") and are explicitly inherited by HEIF, while other features were specifically designed for the HEIF standard.
...
HEIF指定了一种结构格式，从中可以派生特定编解码器的图像格式。HEIF还包括封装图像的图像和图像序列以符合[高效率视频编码](../Page/高效率视频编码.md "wikilink")（HEVC，ISO/IEC 23008-2 | ITU-T Rec. H.265）的规范。该标准的未来版本可能包括其他视频和静态图像媒体编解码器。

## HEVC图像文件格式

HEIF标准包括封装[HEVC编码的图像和图像序列为HEIF兼容文件的规范](../Page/高效率视频编码.md "wikilink")。该规范包含以下几个方面：

  - The sample entry format and the sample format of HEVC image sequence tracks are identical to those of the HEVC video tracks specified in [ISO/IEC 14496-15](../Page/MPEG-4.md "wikilink"). For compatibility with HEVC-capable video players, it is therefore advisable to create both an HEVC image sequence track and an HEVC video track that refer to the same coded images.
...
<!-- end list -->
  ...
  - [Microsoft](https://zh.wikipedia.org/wiki/Microsoft "wikilink") [Windows 10](../Page/Windows_10.md "wikilink")（[version 1803](../Page/Windows_10版本历史.md "wikilink") 预览版，build 17123）\[9\]，在此前需要通過安裝名為CopyTrans HEIC for Windows的解碼器來實現對HEIF/HEIC的支援，或者安裝其它支援HEIF/HEIC的圖像管理器。\[10\]

<!-- end list -->

  - [macOS](https://zh.wikipedia.org/wiki/macOS "wikilink") [High Sierra](https://zh.wikipedia.org/wiki/macOS_High_Sierra "wikilink")\[11\]
  - [iOS](https://zh.wikipedia.org/wiki/iOS "wikilink") [11](https://zh.wikipedia.org/wiki/iOS_11 "wikilink")\[12\]\[13\]
...
<!-- end list -->
  ...
  - [Adobe Lightroom](https://zh.wikipedia.org/wiki/Adobe_Lightroom "wikilink")\[15\]（仅限macOS High Sierra、iOS 11+及Android 9+）
  - [Adobe Photoshop CC](https://zh.wikipedia.org/wiki/Adobe_Photoshop_CC "wikilink")\[16\]
  - [GIMP](../Page/GIMP.md "wikilink")\[17\]
  - [ImageMagick](../Page/ImageMagick.md "wikilink")
  - [Zoner Photo Studio X](https://zh.wikipedia.org/wiki/Zoner_Photo_Studio "wikilink")\[18\]\[19\]\[20\]
...
<!-- end list -->
  ...
  - [Nokia为网页浏览器提供一个开源](https://zh.wikipedia.org/wiki/Nokia "wikilink")[JavaScript](../Page/JavaScript.md "wikilink") HEIF解码器\[21\]
...
[Category:2015年面世](https://zh.wikipedia.org/wiki/Category:2015年面世 "wikilink") [Category:图形文件格式](https://zh.wikipedia.org/wiki/Category:图形文件格式 "wikilink") [Category:图像压缩](https://zh.wikipedia.org/wiki/Category:图像压缩 "wikilink") [Category:MPEG](https://zh.wikipedia.org/wiki/Category:MPEG "wikilink")
...
16.  2018 releases of Photoshop CC|website=helpx.adobe.com|language=en|access-date=2019-01-23}}

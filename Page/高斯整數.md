...
**高斯整數**是[實數和](../Page/實數.md "wikilink")[虛數部分都是](../Page/虛數.md "wikilink")[整數的](../Page/整數.md "wikilink")[複數](../Page/複數.md "wikilink")。所有高斯整數組成了一個[整域](../Page/整域.md "wikilink")，寫作\(\mathbf{Z}[i]\)，是個不可以轉成[有序環的](../Page/有序環.md "wikilink")[歐幾里德域](../Page/歐幾里德域.md "wikilink")。

\[\mathbf{Z}[i] = \{ a + bi \mid a, b \in \mathbb{Z} \}\]

高斯整數的[范数都是非負整數](../Page/范数_\(域论\).md "wikilink")，定義為
...
高斯整数形成了一个[唯一分解整环](../Page/唯一分解整环.md "wikilink")，其[可逆元为](../Page/可逆元.md "wikilink")\(1, -1, i, -i\)。

\[\mathbf{Z}[i]\]的[素元素又称为](../Page/素元素.md "wikilink")**高斯[素数](../Page/素数.md "wikilink")**。
...
高斯整数环是\(\mathbf{Z}\)在[高斯有理数](../Page/高斯有理数.md "wikilink")[域中的](../Page/域.md "wikilink")[整闭包](../Page/整闭包.md "wikilink")，由实数部分和虚数部分都是[有理数的复数组成](../Page/有理数.md "wikilink")。

### 作为欧几里德环

在图中很容易看到，每一个[复数与最近的高斯整数的距离最多为](../Page/复数.md "wikilink")\(\frac{\sqrt 2}{2}\)个单位。因此，\(\mathbf{Z}[i]\)是一个[欧几里德环](../Page/欧几里德环.md "wikilink")，其中\(v(z) = N(z)\)。

## 未解决的问题

[高斯圆问题是中心为原点](../Page/高斯圆问题.md "wikilink")、半径为给定值的圆内有多少[格点的问题](../Page/格点.md "wikilink")。它本身并不是关于高斯整数的，但等价于确定范数小于某个给定值的高斯整数的数目。

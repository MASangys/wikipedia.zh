...
曲面上某个区域的高斯曲率的[曲面积分称为](../Page/曲面积分.md "wikilink")**总曲率**。[测地](../Page/测地线.md "wikilink")[三角形](../Page/三角形.md "wikilink")（即黎曼球面几何中的三角形）的总曲率等于它的内角和与\(\pi\)的差。正曲率曲面上的三角形的内角和大于\(\pi\)，而负曲率曲面上的三角形的内角和小于\(\pi\)。零曲率曲面上（如[欧几里得平面](https://zh.wikipedia.org/wiki/欧几里得平面 "wikilink")），其内角和等于\(\pi\)。
...
在现代[微分几何中](../Page/微分几何.md "wikilink")，"曲面"抽象的看来是一个二维[微分流形](../Page/微分流形.md "wikilink")。将这个观点和[曲面的经典理论联系起来的是将抽象曲面](https://zh.wikipedia.org/wiki/曲面微分几何 "wikilink")[嵌入到](https://zh.wikipedia.org/wiki/嵌入 "wikilink")**R**<sup>3</sup>中，并用第一基本形式赋予[黎曼度量](https://zh.wikipedia.org/wiki/黎曼度量 "wikilink")。假设这个嵌入在**R**<sup>3</sup>中的像是曲面*S*。*局域等度*就是**R**<sup>3</sup>中的开区域之间的[微分同胚](../Page/微分同胚.md "wikilink")*f*:
*U* → *V*，限制到*S* ∩
*U*就是到自己的像的[等度变换](https://zh.wikipedia.org/wiki/等度变换 "wikilink")。**绝妙定理**可以如下表述：

  -
    嵌入到**R**<sup>3</sup>的光滑曲面的高斯曲率在局域等度下不变。

例如[圆柱面的高斯曲率为](https://zh.wikipedia.org/wiki/圆柱面 "wikilink")0，和"展开"后得到的平面是一样的。\[1\]另一方面，因为半径为*R*的[球面有正常数曲率](../Page/球面.md "wikilink")*R*<sup>−2</sup>而平面有常数曲率0，这两个曲面不是等度的，即使局部也不行。因此即使是一部分球面的平面表示也会扭曲距离。所以没有[测绘映射是完美的](https://zh.wikipedia.org/wiki/测绘映射 "wikilink")。
...
<!-- end list -->
  ...
  - **[希尔伯特定理](https://zh.wikipedia.org/wiki/希尔伯特定理 "wikilink")**
    (1901年)断言在**R**<sup>3</sup>中不存在常负高斯曲率的完全解析(*C*<sup>*ω*</sup>)正则曲面。事实上，对于浸入到**R**<sup>3</sup>的*C*<sup>2</sup>曲面也成立，但是对于*C*<sup>1</sup>-曲面却不成立。[伪球面有常负高斯曲率](https://zh.wikipedia.org/wiki/伪球面 "wikilink")，除了在其[尖点](https://zh.wikipedia.org/wiki/尖点 "wikilink")。\[3\]
...
\[K  = \lim_{r \rarr 0} [\pi r^2  - \mbox{A}(r)] \cdot \frac{12}{\pi r^4}\]
  ...
  - 高斯曲率可以用**[克里斯托费尔记号](https://zh.wikipedia.org/wiki/克里斯托费尔记号 "wikilink")**表达:
    \[4\]

...
**高斯积分**（），有时也被称为**概率积分**，是[高斯函数](../Page/高斯函数.md "wikilink")（*e*<sup>−*x*<sup>2</sup></sup>）在整个[實數線上的](../Page/實數線.md "wikilink")[积分](../Page/积分.md "wikilink")。它是依[德国](../Page/德国.md "wikilink")[数学家兼](../Page/数学家.md "wikilink")[物理学家](../Page/物理学家.md "wikilink")[卡爾·弗里德里希·高斯之姓氏所命名](../Page/卡爾·弗里德里希·高斯.md "wikilink")。
...
尽管误差函数不存在[初等函数](../Page/初等函数.md "wikilink")，但可以通过[Risch算法证明](../Page/Risch算法.md "wikilink")，高斯积分可以通过[多元微积分方法分析求解](../Page/多元微积分.md "wikilink")。下面这个[不定积分](../Page/不定积分.md "wikilink")

\[\int e^{-x^2}\,dx,\] 无法用初等函数表示，但可以计算[定积分](../Page/定积分.md "wikilink")

\[\int_{-\infty}^\infty e^{-x^2}\,dx\]
任意[高斯函数的定积分为](../Page/高斯函数.md "wikilink")
...
使用[富比尼定理以上双重积分可以被看作是](../Page/富比尼定理.md "wikilink")[直角坐标系上一个顶点为](../Page/直角坐标系.md "wikilink"){(−*a*,
*a*), (*a*, *a*), (*a*, −*a*), (−*a*,
−*a*)}的正方形的面积积分\(\int e^{-(x^2+y^2)}\,d(x,y)\)。

由于对任何实数来说指数函数均大于0，因此对于这个正方形内的[内切圆的积分必须小于](../Page/内切圆.md "wikilink")\(I(a)^2\)。类似地正方形的[外接圆积分必须大于](../Page/外接圆.md "wikilink")\(I(a)^2\)。通过从直角坐标系转化到[极坐标系](../Page/极坐标系.md "wikilink")\(x=r\,\cos \theta\),
...
使用[夹擠定理获得高斯积分](../Page/夹擠定理.md "wikilink")
...
通过替代变量它可以变成一个[欧拉积分](../Page/欧拉积分.md "wikilink")
...
任一[高斯函数的积分都可以用以下的公式计算](../Page/高斯函数.md "wikilink")：
...
令\(A\)为一个对称的、[正定的](../Page/正定矩阵.md "wikilink")（因而[可逆](../Page/可逆矩阵.md "wikilink")）\(n \times n\)
...
这里的 σ 表示的是有序集 {1, ..., 2*N*} 的不同[排列](../Page/排列.md "wikilink")。等式右边的系数是对
...
也可以先[分部积分](../Page/分部积分.md "wikilink")，然后找出[递推关系之后求解](../Page/递推关系.md "wikilink")。

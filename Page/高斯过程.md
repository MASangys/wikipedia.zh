在[概率论和](https://zh.wikipedia.org/wiki/概率论 "wikilink")[统计学](../Page/统计学.md "wikilink")中，**高斯过程**（）是[观测值出现在一个连续域](../Page/随机变量.md "wikilink")（例如时间或空间）的[随机过程](../Page/随机过程.md "wikilink")。在高斯过程中，连续输入空间中每个点都是与一个[正态分布](../Page/正态分布.md "wikilink")的[随机变量](../Page/随机变量.md "wikilink")相关联。此外，这些随机变量的每个有限集合都有一个[多元正态分布](../Page/多元正态分布.md "wikilink")，换句话说他们的任意有限[线性组合是一个正态分布](https://zh.wikipedia.org/wiki/线性组合 "wikilink")。高斯过程的分布是所有那些（無限多个）随机变量的联合分布，正因如此，它是连续域（例如时间或空间）上[函数](../Page/函数.md "wikilink")的分布。
...
**X**<sub>t<sub>1</sub>,...,t<sub>1</sub></sub>=(*X*<sub>t<sub>1</sub></sub>,...,*X*<sub>t<sub>k</sub></sub>)

是一个[多元正态分布](../Page/多元正态分布.md "wikilink")，这等同于说(*X*<sub>t<sub>1</sub></sub>,...,*X*<sub>t<sub>k</sub></sub>)的任一[线性组合是一单变量](https://zh.wikipedia.org/wiki/线性组合 "wikilink")[正態分佈](https://zh.wikipedia.org/wiki/正態分佈 "wikilink")。更準確地，取樣函數*X*<sub>*t*</sub> 的任一線性[泛函](../Page/泛函.md "wikilink")均會得出[正態分佈](https://zh.wikipedia.org/wiki/正態分佈 "wikilink")。可以寫成*X* \~ GP(*m*,*K*)，即[隨機函數](https://zh.wikipedia.org/wiki/隨機函數 "wikilink")*X* 以高斯過程（GP）方式分佈，且其平均數函數為*m* 及其[協方差函數為](https://zh.wikipedia.org/wiki/協方差函數 "wikilink")*K*。\[2\]當輸入向量*t*為二維或多維時，高斯過程亦可能被稱為。\[3\]

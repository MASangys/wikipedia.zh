...
选出一个新的加密标准是非常必要的，这是因为DES使用的是56位的密钥，相对来说太小，越来越容易受到[暴力攻击](https://zh.wikipedia.org/wiki/暴力破解法 "wikilink")。此外，DES主要被设计用于硬件以及不这么快的软件实现上\[1\]。三重DES避免了加密密钥过小的问题，但是非常缓慢，甚至使用专门的硬件依然如此，它不适用于资源有限的平台。而且它可能受到潜在的安全问题的影响，这个问题和它使用了（在今天看来相对较小的）64位的[块大小有关](../Page/块大小.md "wikilink")。
...
其中的一些设计方案在[密码分析中落选](../Page/密码分析.md "wikilink")，原因是存在微小的缺陷甚至是存在致命的攻击方式，而另一些则是因为在不同环境中不良的性能表现或者是比其他的候选算法表现更差。NIST举行了两次会议讨论这些提交的方案(1998年8月AES1，1999年3月AES2)。在1999年8月，他们宣布\[4\]，他们将候选名单从15个缩减至5个：，[RC6](../Page/RC6.md "wikilink")，[Rijndael](../Page/高级加密标准.md "wikilink")，[Serpent](../Page/Serpent.md "wikilink")，以及[Twofish](../Page/Twofish.md "wikilink")。这五个算法，通常称为“AES决赛算法”（AES
finalist）\[5\]，都由著名的、在社区中被尊敬的密码学家们所设计。 AES2会议投票如下：
...
2000年8月2日，NIST宣布\[6\]拟将[Rijndael作为建议的AES标准](../Page/高级加密标准.md "wikilink")，并于2001年2月28日通过在[聯邦公報上发布公告作为FIPS草案征求意见](../Page/聯邦公報.md "wikilink")\[7\]，以此推进将其作为官方标准的进程。2001年11月，NIST宣布，[AES被批准为](../Page/高级加密标准.md "wikilink")[FIPS
PUB](https://zh.wikipedia.org/wiki/聯邦資料處理標準 "wikilink") 197。
...
## 外部链接
  ...
  - [A historical overview of the
    process](http://csrc.nist.gov/archive/aes/)可以在[NIST网站上找到](../Page/國家標準技術研究所.md "wikilink")。
...
[Category:密码学竞赛](https://zh.wikipedia.org/wiki/Category:密码学竞赛 "wikilink")

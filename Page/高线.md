[Triangle.Orthocenter.svg](https://zh.wikipedia.org/wiki/File:Triangle.Orthocenter.svg "fig:Triangle.Orthocenter.svg") 在[数学](../Page/数学.md "wikilink")中，[三角形](../Page/三角形.md "wikilink")的**高线**（或称**高**、**垂线**）是指过它的一个[顶点并](https://zh.wikipedia.org/wiki/顶点 "wikilink")[垂直](../Page/垂直.md "wikilink")于对边的[直线](../Page/直线.md "wikilink")，或这条直线上从顶点到与对边所在直线的交点之间的[线段](../Page/线段.md "wikilink")。高线与对边的交点称为**垂足**。过一个顶点的高线的长度被称为三角形在这个顶点上的**高**，而对应的对边称为**底边**，其长度称为**底**。

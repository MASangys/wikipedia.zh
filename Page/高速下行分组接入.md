**高速下行分组接入**（，縮寫為）是一种[移动通信协议](https://zh.wikipedia.org/wiki/移动通信 "wikilink")，又称为**3.5G**（3½G），属于[W-CDMA技术的延伸](https://zh.wikipedia.org/wiki/W-CDMA "wikilink")。该协议在[W-CDMA下行链路中提供](https://zh.wikipedia.org/wiki/W-CDMA "wikilink")[分组数据业务](https://zh.wikipedia.org/wiki/分组数据 "wikilink")，在一个5MHz[载波上的传输速率可达](https://zh.wikipedia.org/wiki/载波 "wikilink")8-10
Mbit/s（如采用[MIMO技术](../Page/MIMO.md "wikilink")，则可达20
Mbit/s）。在具体实现中，采用了[自適應調變和編碼](https://zh.wikipedia.org/wiki/自適應調變和編碼 "wikilink")（[AMC](https://zh.wikipedia.org/wiki/AMC "wikilink")）、多输入多输出（[MIMO](../Page/MIMO.md "wikilink")）、混合自动重传请求（[HARQ](https://zh.wikipedia.org/wiki/HARQ "wikilink")）、快速[调度](https://zh.wikipedia.org/wiki/调度 "wikilink")、快速小区选择等技术。
...
2.  快速调度方法。HSDPA中包调度是直接由[基站控制的](../Page/基站.md "wikilink")，而不是像W-CDMA
    release99中是由[RNC控制的](https://zh.wikipedia.org/wiki/RNC "wikilink")。更靠近空中接口及更短的帧长度使得基站调度更快更有效。基站调度所需信息包括信道质量、终端容量、QoS等级和可获得的功率／码源等。
3.  快速重传方法。在W-CDMA
...
## 终端
  ...
  - [诺基亚于](../Page/诺基亚.md "wikilink")2007年第一季度发布第一台HSDPA终端设备[诺基亚
    N95](https://zh.wikipedia.org/wiki/诺基亚_N95 "wikilink")，将达到3.6
    Mbit下行速度。
  - [宏達電](https://zh.wikipedia.org/wiki/宏達電 "wikilink")2006年发布了首款HSDPA的PPC手机HTC
    Hermes（HTC TyTN，Dopod CHT9000），2007年又陆续发布了HTC Kaiser（HTC TyTN
    II），HTC Nike（HTC Touch Dual）等。目前其出售的的所有W-CDMA手机均支持HSDPA。
  ...
  - [中兴在澳大利亚发布了第一款手机](https://zh.wikipedia.org/wiki/中兴 "wikilink")，被[贴牌为Telstra](https://zh.wikipedia.org/wiki/贴牌 "wikilink")
    850。
  ...
  - [苹果公司出售的iPhone手机](https://zh.wikipedia.org/wiki/苹果公司 "wikilink")（除iPhone
    2G外）均支持HSDPA服务。

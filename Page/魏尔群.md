在[數學裡](https://zh.wikipedia.org/wiki/數學 "wikilink")，尤其是在[李群的理論中](../Page/李群.md "wikilink")，一[根系的](https://zh.wikipedia.org/wiki/根系 "wikilink")**魏尔群**是指經由[正交於根之](../Page/正交.md "wikilink")[超平面的鏡面而產生之根系的](https://zh.wikipedia.org/wiki/超平面 "wikilink")[等距同構群之](https://zh.wikipedia.org/wiki/等距同構 "wikilink")[子群](../Page/子群.md "wikilink")。例如，根系A<sub>2</sub>包含中心為原點之正六邊形的角。根系的對稱之整個群因此是有12[階的](../Page/階_\(群論\).md "wikilink")[二面體群](../Page/二面體群.md "wikilink")。魏尔群產生於將六邊形平分成兩半的線之鏡射；其為6階的二面體群。

[半單](https://zh.wikipedia.org/wiki/半單 "wikilink")[李群](../Page/李群.md "wikilink")、半單[李代數和半單](../Page/李代數.md "wikilink")[線性代數群等之魏尔群為群或代數之根系的魏尔群](https://zh.wikipedia.org/wiki/線性代數群 "wikilink")。
...
:=
Φ∩*v*<sup>+</sup>包含著Φ正好一半的根。當然Φ<sup>+</sup>和*v*有關，但只要*v*待在同一個魏尔腔裡，Φ<sup>+</sup>就不會改變。根據上述選擇的根系之[基為在Φ](https://zh.wikipedia.org/wiki/根系 "wikilink")<sup>+</sup>內的*簡單根*，即其不能被寫成於Φ<sup>+</sup>內另外兩個根之和的根。因此，魏尔腔、Φ<sup>+</sup>和其基決定了另一個，且魏尔群在每一狀況下都為簡單傳遞。下面的圖示描繪了根系A<sub>2</sub>的六個魏尔腔，一選定的*v*及其超平面*v*<sup>∧</sup>(以虛線表示)及正根α、β和γ。此例中的基為{α,γ}。

[<File:Weyl_chambers.png>](https://zh.wikipedia.org/wiki/File:Weyl_chambers.png "fig:File:Weyl_chambers.png")

魏尔群為[考克斯特群的一特例](../Page/考克斯特群.md "wikilink")。這表示其有一特殊種類的[展現](https://zh.wikipedia.org/wiki/群的展現 "wikilink")，其中每一產生子*x<sub>i</sub>*均為二階，且有異於*x<sub>i</sub><sup>2</sup>*的關係(*x*<sub>*i*</sub>*x*<sub>*j*</sub>)<sup>*m*<sub>*ij*</sub></sup>。產生子是由簡單根所給出的鏡射，且*m<sub>ij</sub>*依據根*i*和*j*之間的角度為90度、120度、135度或150度等不同(即根據其在[鄧肯圖內為不相連](https://zh.wikipedia.org/wiki/根系 "wikilink")、以單邊相連、以雙邊相連、以三邊相連)而分別為2、3、4及6。一魏尔群元素的*長度*為可以以最少字展現其以標準產生子表示之元素的長度。

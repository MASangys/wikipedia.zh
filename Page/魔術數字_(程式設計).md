...
這個範例則使用[函式來包裝整段計算](https://zh.wikipedia.org/wiki/函式 "wikilink")[民國紀年的邏輯](../Page/民國紀年.md "wikilink")，函式內則直接保留數值1911。
這樣做的好處是在程式中可藉由getMinguoYear()這個函式名稱更容易了解程式意圖，並對未來若需支援其他國家時保留彈性。
例如，需要使用[日本曆時](../Page/日本曆.md "wikilink")，可只抽換函式部分而不動到程式所有參考年份運算的地方。

另外，在
一些程式語言中，[1與](../Page/1.md "wikilink")[0經常直接作為](../Page/0.md "wikilink")「真」、「假」的意義（[布林值](https://zh.wikipedia.org/wiki/布林值 "wikilink")）使用，有時候也不被認為是魔術數字。

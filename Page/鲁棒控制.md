...
在这一阶段提出了H<sub>∞</sub>设计问题的解法，所用的数学工具非常繁琐，并不像问题本身那样具有明确的工程意义。直到1988年Doyle等人在全美控制年会上发表了著名的DGKF论文，证明了H<sub>∞</sub>设计问题的解可以通过适当的代数[Riccati方程](../Page/Riccati方程.md "wikilink")得到。DGKF的论文标志着H∞控制理论的成熟。迄今为止，H<sub>∞</sub>设计方法主要是DGKF等人的解法。不仅如此，这些设计理论的开发者还同美国的The
Math
Works公司合作，开发了[MATLAB](../Page/MATLAB.md "wikilink")中鲁棒控制软件工具箱（Robust

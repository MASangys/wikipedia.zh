**鸡尾酒排序**，也就是**定向冒泡排序**，**雞尾酒攪拌排序**，**攪拌排序**（也可以視作[選擇排序的一種變形](../Page/選擇排序.md "wikilink")），**漣漪排序**，**來回排序**或**快乐小時排序**，是[冒泡排序的一種变形](../Page/冒泡排序.md "wikilink")。此演算法与[冒泡排序的不同處在於排序時是以双向在序列中進行排序](../Page/冒泡排序.md "wikilink")。
...
## 額外連結
  ...
  - [Implementations of cocktail sort in several different programming
    languages](../Page/:wikisource:Cocktail_Sort.md "wikilink")

**鸭子类型**（）在[程序设计](../Page/程序设计.md "wikilink")中是[动态类型的一种风格](../Page/類型系統.md "wikilink")。在这种风格中，一个对象有效的语义，不是由继承自特定的类或实现特定的接口，而是由"当前[方法](../Page/方法_\(電腦科學\).md "wikilink") 和属性的集合"决定。这个概念的名字来源于由[James Whitcomb Riley提出的](https://zh.wikipedia.org/wiki/James_Whitcomb_Riley "wikilink")[鸭子测试](../Page/鸭子测试.md "wikilink")（见下面的“[历史](https://zh.wikipedia.org/wiki/#历史 "wikilink")”章节），“鸭子测试”可以这样表述：

...
在香港，由於居住了大量來自[中國內地及來自各洲不同國籍及種族的人士](https://zh.wikipedia.org/wiki/中國內地 "wikilink")，當地的私營免費電視台[無綫電視](https://zh.wikipedia.org/wiki/無綫電視 "wikilink")，在兩條以模擬視頻傳送的中、英文頻道在每晚黃金時間，相當比例的節目（新聞報導、時事節目和由[香港電台電視部製作的節目除外](https://zh.wikipedia.org/wiki/香港電台電視部 "wikilink")）都用上麗音作雙語廣播（至於數碼電視廣播的頻道，則以傳送多條[AC-3位流以作配合](https://zh.wikipedia.org/wiki/AC-3 "wikilink")；另外，公營[港台電視](../Page/港台電視.md "wikilink")的模擬廣播頻道只有立體聲廣播，而沒有多種語言廣播的安排）；然而，由於香港政府已決定於2020年終止模擬電視廣播\[1\]，屆時麗音廣播技術也會停止在香港使用。
...
麗音廣播的基本原理如下:
  ...
  - 音效採用14-bit量子化和32 kHz的取樣頻率（相比[雷射唱片的](https://zh.wikipedia.org/wiki/雷射唱片 "wikilink")16-bit量子化和44.1 kHz的取樣頻率）。

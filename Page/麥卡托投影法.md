...
下列公式定义在使用墨卡托投影的地图中，从[纬线](https://zh.wikipedia.org/wiki/纬线 "wikilink")*φ*和[经线](https://zh.wikipedia.org/wiki/经线 "wikilink")*λ*（其中*λ*<sub>0</sub>是地图的中央经线）如何推导为[坐标系中的](https://zh.wikipedia.org/wiki/坐标系 "wikilink")[点坐标](../Page/点.md "wikilink")*x*和*y*。
...
比例尺与纬度*φ*的[正割成比例](../Page/正割.md "wikilink")，越趋向[极地](https://zh.wikipedia.org/wiki/极地 "wikilink")（*φ* = ±90°）面积变形越大。此外，由公式可知，极点处的*y*值为正负无穷大。

## 公式推导

[Usgs_map_mercator.svg](https://zh.wikipedia.org/wiki/File:Usgs_map_mercator.svg "fig:Usgs_map_mercator.svg")
假设[地球为正球形](../Page/地球.md "wikilink")。（实际上并非为正球形，而是有[扁率的](https://zh.wikipedia.org/wiki/扁率 "wikilink")，但制作小比例尺地图时误差可忽略不计。若需更精确，可插入等角[纬线](https://zh.wikipedia.org/wiki/纬线 "wikilink")。）我们需要将经纬度坐标（*λ*, *φ*）转换为[笛卡尔坐标](https://zh.wikipedia.org/wiki/笛卡尔 "wikilink")(*x*, *y*)，求以赤道为基准的切柱面投影（即*x* = *λ*），并保持形状不变，故：
...
## 参见
  ...
  - [通用横轴墨卡托投影](https://zh.wikipedia.org/wiki/通用横轴墨卡托投影 "wikilink")（UTM）

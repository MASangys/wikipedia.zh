...
是[絕對溫標](../Page/絕對溫標.md "wikilink") ）并且 α = -μ/*kT* （ μ
是[化學勢](../Page/化學勢.md "wikilink")）

最後我們得到:

\[N_i = \frac{g_i}{e^{(\epsilon_i-\mu)/kT}}\]

由于量子统计在数学处理上非常困难，因此在处理实际问题时经常引入一些近似条件，使[费米-狄拉克统计和](../Page/费米-狄拉克统计.md "wikilink")[玻色-爱因斯坦统计退化成为经典的](../Page/玻色-爱因斯坦统计.md "wikilink")**麦克斯韦-玻尔兹曼统计**。

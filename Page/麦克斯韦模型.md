**麦克斯韦模型**（）是用于描述材料[粘弹性的一种模型](https://zh.wikipedia.org/wiki/粘弹性 "wikilink")。麦克斯韦由一个纯弹性的[弹簧和一个纯黏性的](../Page/弹簧.md "wikilink")[黏壶](https://zh.wikipedia.org/wiki/黏壶 "wikilink")（阻尼器）[串联而成](https://zh.wikipedia.org/wiki/串联 "wikilink")，其中的弹簧符合[胡克定律](../Page/胡克定律.md "wikilink")，用于描述材料的[弹性方面性质](https://zh.wikipedia.org/wiki/弹性 "wikilink")；而黏壶符合[牛顿流体特征](../Page/牛顿流体.md "wikilink")，代表[黏性方面性质](https://zh.wikipedia.org/wiki/黏性 "wikilink")\[1\]。1867年，[詹姆斯·麦克斯韦提出了这一模型](https://zh.wikipedia.org/wiki/詹姆斯·麦克斯韦 "wikilink")，符合这一模型的流体也被称为麦克斯韦流体。如果将弹簧和黏壶并联，则被称为[开尔文-沃伊特模型](https://zh.wikipedia.org/wiki/开尔文-沃伊特模型 "wikilink")\[2\]。
...
其中 *E*表示[弹性模量而](https://zh.wikipedia.org/wiki/弹性模量 "wikilink")*η*是材料的黏度。
[Maxwell_diagram.svg](https://zh.wikipedia.org/wiki/File:Maxwell_diagram.svg "fig:Maxwell_diagram.svg")
...
\(\frac {\sigma(t)} {E\varepsilon_0}\) upon dimensionless time
\(\frac{E}{\eta} t\):

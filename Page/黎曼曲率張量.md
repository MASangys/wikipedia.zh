在[微分几何](../Page/微分几何.md "wikilink")中，**黎曼曲率张量**或**黎曼張量**是表达[黎曼流形](../Page/黎曼流形.md "wikilink")的曲率的标准方式，更普遍的，它可以表示有[仿射联络的](https://zh.wikipedia.org/wiki/仿射联络 "wikilink")[流形](../Page/流形.md "wikilink")的曲率 ,包括无扭率或有[撓率的](https://zh.wikipedia.org/wiki/聯絡的撓率 "wikilink")。曲率张量通过[列维-奇维塔联络](../Page/列维-奇维塔联络.md "wikilink")(更一般的，一个[仿射联络](https://zh.wikipedia.org/wiki/仿射联络 "wikilink"))\(\nabla\)(或者叫[协变导数](https://zh.wikipedia.org/wiki/协变导数 "wikilink"))由下式给出:

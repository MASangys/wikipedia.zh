...
对于一在[区间](https://zh.wikipedia.org/wiki/区间 "wikilink")\(\lbrack a, b \rbrack\)上之给定非负函数\(f(x)\)，我们想要确定\(f(x)\)所代表的[曲线](../Page/曲线.md "wikilink")与\(X\)[坐标轴所夹图形的](https://zh.wikipedia.org/wiki/坐标轴 "wikilink")[面积](../Page/面积.md "wikilink")，我们可以将此记为

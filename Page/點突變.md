...
**點突變**（）是[突變的一種類型](https://zh.wikipedia.org/wiki/突變 "wikilink")，在遗传材料[DNA或](../Page/脱氧核糖核酸.md "wikilink")[RNA中](../Page/核糖核酸.md "wikilink")，會使單一個[鹼基](https://zh.wikipedia.org/wiki/鹼基 "wikilink")[核苷酸替換成另一種](../Page/核苷酸.md "wikilink")[核苷酸](../Page/核苷酸.md "wikilink")。通常这个术语也包括只有作用於單一鹼基對的[插入或](https://zh.wikipedia.org/wiki/插入_\(遺傳學\) "wikilink")[刪除](https://zh.wikipedia.org/wiki/刪除_\(遺傳學\) "wikilink")。
...
### 功能的分类
  ...
  - （nonsense
    mutation）：使原本可製造[蛋白質的密碼變成停止密碼](https://zh.wikipedia.org/wiki/蛋白質 "wikilink")。

  - [错义突变](https://zh.wikipedia.org/wiki/错义突变 "wikilink")（missense
    mutation）：使密碼所對應的氨基酸改變。

...
在**數學**上，特別是在[調和分析與](../Page/調和分析.md "wikilink")[拓撲群的理論中](https://zh.wikipedia.org/wiki/拓撲群 "wikilink")，**龐特里雅金對偶定理**解釋了[傅立葉變換的一般性質](https://zh.wikipedia.org/wiki/傅立葉變換 "wikilink")。它統合了[實數線上或有限](https://zh.wikipedia.org/wiki/實數 "wikilink")[阿貝爾群上的一些結果](https://zh.wikipedia.org/wiki/阿貝爾群 "wikilink")，如：

...
在[数值分析领域中](https://zh.wikipedia.org/wiki/数值分析 "wikilink")，**龙格现象**是在一组等间插值点上使用具有高次多项式的多项式插值时出现的区间边缘处的振荡问题。
...
1.   available at
    [www.archive.org](https://zh.wikipedia.org/wiki/iarchive:zeitschriftfrma12runggoog "wikilink")
2.
...
{{/box-header|Google
       |Portal:Google/简介|}}  {{/box-footer|}}

<div style="float:left; width:60%;">

{{/box-header|特选条目|Portal:Google/特选条目|}}  {{/box-footer|}}

{{/box-header|特選图片|Portal:Google/特選图片|}}  {{/box-footer|}}

{{/box-header|你知道吗|Portal:Google/你知道吗|}}  {{/box-footer|}}

{{/box-header|歡迎參與|Portal:Google/歡迎參與|}}  {{/box-footer|}}
...
{{/box-header|搜索|Portal:Google/搜索|}}  {{/box-footer|}}

{{/box-header|分类|Portal:Google/分类|}}  {{/box-footer|}}

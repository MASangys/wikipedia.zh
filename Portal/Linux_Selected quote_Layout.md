> 本文内容由[Portal:Linux/Selected quote/Layout](https://zh.wikipedia.org/wiki/Portal:Linux/Selected_quote/Layout)转换而来。
...
<tr class="odd">
<td><p>|</p>
<div style="text-align:right;margin-right:10px;margin-bottom:1px;">
<p><strong><a href="https://zh.wikipedia.org/wiki/Portal:Linux/Selected_quote" title="wikilink">更多精选名句...</a></strong></p>
</div ></td>
</tr>
</tbody>
</table>
...
This template is to be used per the instructions at [Portal:Linux/Selected quote](https://zh.wikipedia.org/wiki/Portal:Linux/Selected_quote "wikilink").
  ...
  - **Source** is exactly what it seems. Cite your source, if possible.

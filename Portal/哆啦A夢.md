...
<big style="font-size:150%;">歡迎光臨中文維基哆啦A夢主題首頁！
</big>

</div>

{{/box-header|简介|Portal:哆啦A夢/简介|}}  {{/box-footer|}}
...
{{/box-header|分类|Portal:哆啦A夢/分类|}}  {{/box-footer|}}

</div>

<div style="float:right; width:34%">

{{/box-header|常用道具|Portal:哆啦A夢/哆啦A夢常用法寶|}}  {{/box-footer|}}

</div>

{{/box-header|主角|Portal:哆啦A夢/主角|}}  {{/box-footer|}}

{{/box-header|用戶框|Portal:哆啦A夢/用戶框|}}  {{/box-footer|}}
...
{{/box-header|相關主題|Portal:哆啦A夢/相關主題}}  {{/box-footer}}

...
<tbody>
<tr class="odd">
<td><div style="width:65px; vertical-align:top; padding-top:15px;">
<p><a href="https://zh.wikipedia.org/wiki/File:Clipboard.svg" title="fig:Clipboard.svg">Clipboard.svg</a></p>
</div>
<p><br />
</p></td>
<td><p>每一个人可以有助于使这个项目获得成功。请随意提出对任何条目的要求，以提升捕鱼条目议题，或是在讨论页面讨论一下你的未来写作计划，和我们一起将尽我们最大的努力让这些发生。您的参与，无论是仅仅修改一下拼写错误这样的简单贡献，还是合并相关的条目，甚至是创建捕鱼相关的条目，都十分的感谢。为了进一步扩充这个优秀的主题，我们需要这些有益的行动，不论是多么简单或者是十分的复杂。使用下面的按钮以获得更深入的指导，或者也许你想将你认为可能会对这个计划有所帮助的相关想法记录下来。</p>
<p>祝编安……</p></td>
</tr>
</tbody>
</table>

...
{{/box-header|醫學主题|Portal:醫學/简介|}}  {{/box-footer|}}
...
{{/box-header|分类|Portal:醫學/分类|}}  {{/box-footer|}}

{{/box-header|相關主題|Portal:醫學/相關主題|}}  {{/box-footer|}}

{{/box-header|维基专题|Portal:醫學/维基专题|}}  {{/box-footer|}}

{{/box-header|维基媒体计划|Portal:醫學/维基媒体计划|}}  {{/box-footer|}}
